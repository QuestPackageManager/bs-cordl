...
public:
  ...
  /// @brief Method .ctor, addr 0x3bb3f14, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method HideBigAvatar, addr 0x3bb3e24, size 0x90, virtual false, abstract: false, final false
  inline void HideBigAvatar();

  static inline ::GlobalNamespace::MultiplayerConnectedPlayerFacade* New_ctor();

  /// @brief Method PauseSpawning, addr 0x3bb3c9c, size 0xa4, virtual false, abstract: false, final false
  inline void PauseSpawning();

  /// @brief Method ResumeSpawning, addr 0x3bb3d40, size 0xa4, virtual false, abstract: false, final false
  inline void ResumeSpawning();

  /// @brief Method SetSongStartSyncTime, addr 0x3bb3b44, size 0x18, virtual false, abstract: false, final false
  inline void SetSongStartSyncTime(int64_t songStartSyncTime);

  /// @brief Method __ForceStopSong, addr 0x3bb3de4, size 0x34, virtual false, abstract: false, final false
  inline void __ForceStopSong();

  /// @brief Method __GetPlayerAvatar, addr 0x3bb3eb4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bb3f00, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_introAnimator, addr 0x3bb3b2c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerConnectedPlayerIntroAnimator> get_introAnimator();

  /// @brief Method get_outroAnimator, addr 0x3bb3b34, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_outroAnimator();

  /// @brief Method get_scoreDiffText, addr 0x3bb3b3c, size 0x8, virtual false, abstract: false, final false
