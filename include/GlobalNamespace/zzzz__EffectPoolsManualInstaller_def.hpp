...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x3bf8404, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bf864c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
