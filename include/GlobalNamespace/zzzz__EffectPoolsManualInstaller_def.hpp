...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x249a27c, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x249a4c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
