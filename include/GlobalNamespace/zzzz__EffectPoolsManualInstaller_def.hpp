...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x3c0133c, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c01584, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
