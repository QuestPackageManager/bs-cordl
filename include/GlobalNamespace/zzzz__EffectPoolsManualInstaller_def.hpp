...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x584d3e8, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584d648, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
