...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x262e5ec, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262e834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
