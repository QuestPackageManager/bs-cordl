...
public:
  ...
  /// @brief Method ManualInstallBindings, addr 0x58c2320, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c2580, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
