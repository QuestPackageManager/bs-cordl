...
/// @brief Method Pause, addr 0x5801d40, size 0x38, virtual true, abstract: false, final true
inline void Pause() ;

/// @brief Method Resume, addr 0x5801db0, size 0x38, virtual true, abstract: false, final true
inline void Resume() ;

/// @brief Method WillResume, addr 0x5801d78, size 0x38, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5801de8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPauseEvent, addr 0x5801938, size 0xac, virtual true, abstract: false, final true
inline void add_didPauseEvent(::System::Action*  value) ;

/// @brief Method add_didResumeEvent, addr 0x5801be8, size 0xac, virtual true, abstract: false, final true
inline void add_didResumeEvent(::System::Action*  value) ;

/// @brief Method add_willResumeEvent, addr 0x5801a90, size 0xac, virtual true, abstract: false, final true
inline void add_willResumeEvent(::System::Action*  value) ;

/// @brief Method get_isPaused, addr 0x5801930, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_didPauseEvent, addr 0x58019e4, size 0xac, virtual true, abstract: false, final true
inline void remove_didPauseEvent(::System::Action*  value) ;

/// @brief Method remove_didResumeEvent, addr 0x5801c94, size 0xac, virtual true, abstract: false, final true
inline void remove_didResumeEvent(::System::Action*  value) ;

/// @brief Method remove_willResumeEvent, addr 0x5801b3c, size 0xac, virtual true, abstract: false, final true
