...
public:
  ...
  /// @brief Method get_IsDataHighConfidence, addr 0x5dc66e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x5dc66d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_ShouldUseSystemGestureMaterial, addr 0x5dc66f0, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldUseSystemGestureMaterial();

  /// @brief Method set_IsDataHighConfidence, addr 0x5dc66e8, size 0x8, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x5dc66d8, size 0x8, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_ShouldUseSystemGestureMaterial, addr 0x5dc66f8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x5dc5bcc, size 0x114, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ForceRebind, addr 0x5dc63b0, size 0x8, virtual false, abstract: false, final false
  inline void ForceRebind();

  /// @brief Method Initialize, addr 0x5dc5e74, size 0x53c, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRMeshRenderer* New_ctor();

  /// @brief Method ShouldInitialize, addr 0x5dc5d80, size 0xf4, virtual false, abstract: false, final false
  inline bool ShouldInitialize();

  /// @brief Method Start, addr 0x5dc5ce0, size 0xa0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5dc63b8, size 0x298, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5dc6650, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Matrix4x4 getStaticF__openXRFixup();

  /// @brief Method get_IsDataHighConfidence, addr 0x5dc5bac, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x5dc5b9c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_IsInitialized, addr 0x5dc5b8c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_ShouldUseSystemGestureMaterial, addr 0x5dc5bbc, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldUseSystemGestureMaterial();

  static inline void setStaticF__openXRFixup(::UnityEngine::Matrix4x4 value);

  /// @brief Method set_IsDataHighConfidence, addr 0x5dc5bb4, size 0x8, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x5dc5ba4, size 0x8, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_IsInitialized, addr 0x5dc5b94, size 0x8, virtual false, abstract: false, final false
  inline void set_IsInitialized(bool value);

  /// @brief Method set_ShouldUseSystemGestureMaterial, addr 0x5dc5bc4, size 0x8, virtual false, abstract: false, final false
  inline void set_ShouldUseSystemGestureMaterial(bool value);
