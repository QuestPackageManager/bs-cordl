...
public:
  ...
  /// @brief Method ManualUpdate, addr 0x58b6cf8, size 0xac, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::Saber* New_ctor();

  /// @brief Method OverridePositionAndRotation, addr 0x58b6da4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b6e1c, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bladeSpeed, addr 0x58b6cd0, size 0x18, virtual false, abstract: false, final false
  inline float_t get_bladeSpeed();

  /// @brief Method get_bladeSpeedForLogic, addr 0x58b6cb8, size 0x18, virtual false, abstract: false, final false
  inline float_t get_bladeSpeedForLogic();

  /// @brief Method get_handlePos, addr 0x58b6c64, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_handlePos();

  /// @brief Method get_movementDataForLogic, addr 0x58b6ce8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SaberMovementData* get_movementDataForLogic();

  /// @brief Method get_movementDataForVisualEffects, addr 0x58b6cf0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SaberMovementData* get_movementDataForVisualEffects();

  /// @brief Method get_saberBladeBottomPos, addr 0x58b6c7c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_saberBladeBottomPos();

  /// @brief Method get_saberBladeBottomPosForLogic, addr 0x58b6c94, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_saberBladeBottomPosForLogic();

  /// @brief Method get_saberBladeBottomPosForVisualEffects, addr 0x58b6cac, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_saberBladeBottomPosForVisualEffects();

  /// @brief Method get_saberBladeTopPos, addr 0x58b6c70, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_saberBladeTopPos();

  /// @brief Method get_saberBladeTopPosForLogic, addr 0x58b6c88, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_saberBladeTopPosForLogic();

  /// @brief Method get_saberBladeTopPosForVisualEffects, addr 0x58b6ca0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_saberBladeTopPosForVisualEffects();

  /// @brief Method get_saberType, addr 0x58b6c4c, size 0x18, virtual false, abstract: false, final false
