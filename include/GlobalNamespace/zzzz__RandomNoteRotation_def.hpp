...
public:
  ...
  /// @brief Method Awake, addr 0x2401908, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x2401ac0, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDestroy, addr 0x24019c0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2401ae8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
