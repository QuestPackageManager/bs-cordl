...
public:
  ...
  /// @brief Method Awake, addr 0x26237a8, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x2623960, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDestroy, addr 0x2623860, size 0x100, virtual false, abstract: false, final false
