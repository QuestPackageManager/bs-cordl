...
public:
  ...
  /// @brief Method Awake, addr 0x572cf58, size 0xbc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x572d11c, size 0x28, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDestroy, addr 0x572d014, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572d144, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
