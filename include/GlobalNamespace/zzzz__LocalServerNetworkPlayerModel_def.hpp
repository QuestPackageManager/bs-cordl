...
class CORDL_TYPE LocalServerNetworkPlayerModel_LocalServerJoinMatchmakingPartyConfig : public ::GlobalNamespace::NetworkPlayerModel_1_JoinMatchmakingPartyConfig<::GlobalNamespace::LocalServerConnectionManager*> {
public:
// Declarations
...
/// @brief Method .ctor, addr 0x5b1f190, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _cachedConnectToServerParams, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get__cachedConnectToServerParams, put=__cordl_internal_set__cachedConnectToServerParams)) ::GlobalNamespace::LocalServerConnectionManager_LocalServerConnectionManagerConnectToServerParams*  _cachedConnectToServerParams;

/// @brief Field _cachedStartClientParams, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__cachedStartClientParams, put=__cordl_internal_set__cachedStartClientParams)) ::GlobalNamespace::LocalServerConnectionManager_LocalServerConnectionManagerStartClientParams*  _cachedStartClientParams;
...
/// @brief Method GetConnectToServerParams, addr 0x5b1ef84, size 0xc8, virtual true, abstract: false, final false
inline ::GlobalNamespace::IConnectionInitParams_1<::GlobalNamespace::LocalServerConnectionManager*>* GetConnectToServerParams(::GlobalNamespace::BeatmapLevelSelectionMask  selectionMask, ::GlobalNamespace::GameplayServerConfiguration  configuration, ::StringW  secret, ::StringW  code) ;

/// @brief Method GetStartClientParams, addr 0x5b1f04c, size 0xa8, virtual true, abstract: false, final false
inline ::GlobalNamespace::IConnectionInitParams_1<::GlobalNamespace::LocalServerConnectionManager*>* GetStartClientParams(::GlobalNamespace::BeatmapLevelSelectionMask  selectionMask, ::GlobalNamespace::GameplayServerConfiguration  configuration) ;

static inline ::GlobalNamespace::LocalServerNetworkPlayerModel* New_ctor() ;

/// @brief Method RefreshPublicServers, addr 0x5b1eef8, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b1f0f4, size 0x9c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_code, addr 0x5b1eda0, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_code() ;

/// @brief Method get_configuration, addr 0x5b1ee00, size 0x7c, virtual true, abstract: false, final false
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_partyOwnerId, addr 0x5b1edf8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_partyOwnerId() ;

/// @brief Method get_secret, addr 0x5b1ed48, size 0x58, virtual true, abstract: false, final false
inline ::StringW get_secret() ;

/// @brief Method get_selectionMask, addr 0x5b1ee7c, size 0x7c, virtual true, abstract: false, final false
