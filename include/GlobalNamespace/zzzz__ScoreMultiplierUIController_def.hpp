...
public:
  ...
  /// @brief Method HandleMultiplierDidChange, addr 0x58713c4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x58711dc, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58711d8, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterForEvents, addr 0x5870ffc, size 0x1dc, virtual false, abstract: false, final false
  inline void RegisterForEvents();

  /// @brief Method Start, addr 0x5870f24, size 0xd8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterFromEvents, addr 0x58711e0, size 0x13c, virtual false, abstract: false, final false
  inline void UnregisterFromEvents();

  /// @brief Method Update, addr 0x587131c, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5871480, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
