...
public:
  ...
  /// @brief Method HandleMultiplierDidChange, addr 0x3ba978c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x3ba9608, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3ba9604, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterForEvents, addr 0x3ba9470, size 0x194, virtual false, abstract: false, final false
  inline void RegisterForEvents();

  /// @brief Method Start, addr 0x3ba938c, size 0xe4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterFromEvents, addr 0x3ba960c, size 0x100, virtual false, abstract: false, final false
  inline void UnregisterFromEvents();

  /// @brief Method Update, addr 0x3ba970c, size 0x80, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ba9858, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
