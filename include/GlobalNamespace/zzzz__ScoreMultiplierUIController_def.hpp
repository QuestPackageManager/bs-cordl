...
public:
  ...
  /// @brief Method HandleMultiplierDidChange, addr 0x57982f4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x579810c, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5798108, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterForEvents, addr 0x5797f2c, size 0x1dc, virtual false, abstract: false, final false
  inline void RegisterForEvents();

  /// @brief Method Start, addr 0x5797e54, size 0xd8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterFromEvents, addr 0x5798110, size 0x13c, virtual false, abstract: false, final false
  inline void UnregisterFromEvents();

  /// @brief Method Update, addr 0x579824c, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57983b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
