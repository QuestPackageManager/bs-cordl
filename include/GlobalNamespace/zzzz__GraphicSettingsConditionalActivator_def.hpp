...
/// @brief Method GetGraphicsActivatorType, addr 0x576d958, size 0xa0, virtual false, abstract: false, final false
inline bool GetGraphicsActivatorType() ;

static inline ::GlobalNamespace::GraphicSettingsConditionalActivator* New_ctor() ;

/// @brief Method Start, addr 0x576d908, size 0x50, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x576d9f8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
