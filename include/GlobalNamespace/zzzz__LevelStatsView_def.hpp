...
public:
  ...
  /// @brief Method Hide, addr 0x3b0ae34, size 0x24, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::GlobalNamespace::LevelStatsView* New_ctor();

  /// @brief Method ShowStats, addr 0x3b0ae58, size 0x2c, virtual false, abstract: false, final false
  inline void ShowStats(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey, ::GlobalNamespace::PlayerData* playerData);

  /// @brief Method ShowStats, addr 0x3b0ae84, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b0aff4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
