...
public:
  ...
  /// @brief Method Hide, addr 0x2574d40, size 0x24, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::GlobalNamespace::LevelStatsView* New_ctor();

  /// @brief Method ShowStats, addr 0x2574d64, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2574ef0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
