...
public:
  ...
  /// @brief Method Hide, addr 0x5a24d70, size 0x24, virtual false, abstract: false, final false
  inline void Hide();
  ...
  /// @brief Method .ctor, addr 0x5a24f30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
