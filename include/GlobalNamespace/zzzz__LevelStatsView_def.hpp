...
public:
  ...
  /// @brief Method Hide, addr 0x256bd44, size 0x24, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::GlobalNamespace::LevelStatsView* New_ctor();

  /// @brief Method ShowStats, addr 0x256bd68, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x256bef4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
