...
public:
  ...
  /// @brief Method ILevelPackProductDataContainer<OculusLevelProductCollectionModel.LevelPackProductData,OculusLevelProductCollectionModel.LevelProductData>.SetLevelPackProductData, addr 0x3683f1c,
  ...
  /// @brief Method .ctor, addr 0x3683f24, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelPackProductData, addr 0x3683f0c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_LevelPackProductData* get_levelPackProductData();

  /// @brief Method get_levelPackRedirectionData, addr 0x3683f14, size 0x8, virtual false, abstract: false, final false
