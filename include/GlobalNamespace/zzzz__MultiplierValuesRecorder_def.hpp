...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2621efc, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleScoreControllerMultiplierDidChange, addr 0x2621e00, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2621cf8, size 0x108, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x2621c08, size 0xf0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2621f08, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_multiplierValues, addr 0x2621c00, size 0x8, virtual false, abstract: false, final false
