...
public:
  ...
  /// @brief Method Awake, addr 0x25c957c, size 0x100, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteDidStartJump, addr 0x25c9818, size 0xc, virtual false, abstract: false, final false
  inline void HandleNoteDidStartJump();

  /// @brief Method HandleNoteMovementDidInit, addr 0x25c980c, size 0xc, virtual false, abstract: false, final false
  inline void HandleNoteMovementDidInit();

  static inline ::GlobalNamespace::NoteTrailEffect* New_ctor();

  /// @brief Method OnDestroy, addr 0x25c967c, size 0x12c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Update, addr 0x25c97a8, size 0x64, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x25c9824, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
