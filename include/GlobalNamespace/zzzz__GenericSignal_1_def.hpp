...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GenericSignal_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GenericSignal_1(GenericSignal_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GenericSignal_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GenericSignal_1(GenericSignal_1const&) = delete;
