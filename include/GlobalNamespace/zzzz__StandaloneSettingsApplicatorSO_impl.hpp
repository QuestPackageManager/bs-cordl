...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::StandaloneSettingsApplicatorSO::*)(
    ::UnityEngine::Vector2Int, ::BeatSaber::GameSettings::WindowMode)>(&::GlobalNamespace::StandaloneSettingsApplicatorSO::ApplyWindowSettings)> {
  constexpr static std::size_t size = 0x60;
  constexpr static std::size_t addrs = 0x26c5e74;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::StandaloneSettingsApplicatorSO::*)()>(
  ...
  constexpr static std::size_t addrs = 0x26c5ed4;
...
inline void GlobalNamespace::StandaloneSettingsApplicatorSO::ApplyWindowSettings(::UnityEngine::Vector2Int resolution, ::BeatSaber::GameSettings::WindowMode windowMode) {
