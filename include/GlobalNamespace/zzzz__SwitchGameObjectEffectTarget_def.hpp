...
// Write type traits
MARK_REF_T(::GlobalNamespace::SwitchGameObjectEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SwitchGameObjectEffectTarget*, "", "SwitchGameObjectEffectTarget");
...
public:
  ...
  /// @brief Method SetFloat, addr 0x5997fec, size 0xd8, virtual false, abstract: false, final false
  inline void SetFloat(float_t value);

  /// @brief Method SetValue, addr 0x5997fe8, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x59980c4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59980c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SwitchGameObjectEffectTarget) == 0x30, "Size mismatch!");
