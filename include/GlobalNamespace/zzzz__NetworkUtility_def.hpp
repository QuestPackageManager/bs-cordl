...
public:
  ...
  /// @brief Method DecryptName, addr 0x327c594, size 0x38c, virtual false, abstract: false, final false
  static inline ::StringW DecryptName(::StringW text);

  /// @brief Method EncryptName, addr 0x327c210, size 0x384, virtual false, abstract: false, final false
  static inline ::StringW EncryptName(::StringW text);

  /// @brief Method GenerateId, addr 0x327c920, size 0x9c, virtual false, abstract: false, final false
  static inline ::StringW GenerateId();

  /// @brief Method GetHashBase64, addr 0x327c9bc, size 0x1c4, virtual false, abstract: false, final false
  static inline ::StringW GetHashBase64(::StringW input);

  /// @brief Method Init, addr 0x327c128, size 0xe8, virtual false, abstract: false, final false
