...
/// @brief Method .ctor, addr 0x5752a30, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x5752a24, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method <get_localizedAudioClip>b__0, addr 0x5752a34, size 0x20, virtual false, abstract: false, final false
...
/// @brief Field _lastLocalizedAudioClipInfo, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__lastLocalizedAudioClipInfo, put=__cordl_internal_set__lastLocalizedAudioClipInfo)) ::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*  _lastLocalizedAudioClipInfo;

/// @brief Field _localizedAudioClipInfo, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__localizedAudioClipInfo, put=__cordl_internal_set__localizedAudioClipInfo)) ::ArrayW<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*,::Array<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*>*>  _localizedAudioClipInfo;
...
constexpr ::ArrayW<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*,::Array<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*>*> const& __cordl_internal_get__localizedAudioClipInfo() const;

constexpr ::ArrayW<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*,::Array<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*>*>& __cordl_internal_get__localizedAudioClipInfo() ;
...
constexpr void __cordl_internal_set__localizedAudioClipInfo(::ArrayW<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*,::Array<::GlobalNamespace::LocalizedAudioClipSO_LocalizedAudioClipInfo*>*>  value) ;

/// @brief Method .ctor, addr 0x5752a28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_localizedAudioClip, addr 0x5752910, size 0x114, virtual false, abstract: false, final false
