...
public:
  ...
  /// @brief Method AppendCsvDebugString, addr 0x5e03fd0, size 0x170, virtual false, abstract: false, final false
  inline bool AppendCsvDebugString(::StringW debugString);

  /// @brief Method Awake, addr 0x5e03d10, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method EnterVrMode, addr 0x5e03d20, size 0x11c, virtual false, abstract: false, final false
  inline void EnterVrMode();

  /// @brief Method GetLatestMetricsSnapshot, addr 0x5e042b0, size 0x1d0, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::GlobalNamespace::OVRMetricsToolSDK_MetricsSnapshot> GetLatestMetricsSnapshot();

  /// @brief Method Initialize, addr 0x5e039ac, size 0x364, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method LeaveVrMode, addr 0x5e03e4c, size 0x114, virtual false, abstract: false, final false
  inline void LeaveVrMode();

  static inline ::GlobalNamespace::OVRMetricsToolSDK* New_ctor();

  /// @brief Method OnApplicationPause, addr 0x5e03fc4, size 0xc, virtual false, abstract: false, final false
  inline void OnApplicationPause(bool pause);

  /// @brief Method OnDestroy, addr 0x5e03e3c, size 0x10, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetOverlayDebugString, addr 0x5e04140, size 0x170, virtual false, abstract: false, final false
  inline bool SetOverlayDebugString(::StringW debugString);

  /// @brief Method Shutdown, addr 0x5e03f60, size 0x64, virtual false, abstract: false, final false
  inline void Shutdown();

  /// @brief Method .ctor, addr 0x5e04480, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Instance, addr 0x5e03868, size 0x144, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRMetricsToolSDK> get_Instance();

  /// @brief Method ovrMetricsTool_AppendCsvDebugString, addr 0x5e035d0, size 0x9c, virtual false, abstract: false, final false
  static inline bool ovrMetricsTool_AppendCsvDebugString(::StringW debugString);

  /// @brief Method ovrMetricsTool_EnterVrMode, addr 0x5e03564, size 0x6c, virtual false, abstract: false, final false
  static inline bool ovrMetricsTool_EnterVrMode();

  /// @brief Method ovrMetricsTool_GetLatestEventJson, addr 0x5e03708, size 0x88, virtual false, abstract: false, final false
  static inline ::StringW ovrMetricsTool_GetLatestEventJson();

  /// @brief Method ovrMetricsTool_Initialize, addr 0x5e034c8, size 0x9c, virtual false, abstract: false, final false
  static inline bool ovrMetricsTool_Initialize(::System::IntPtr jvm, ::System::IntPtr jni, ::System::IntPtr context);

  /// @brief Method ovrMetricsTool_LeaveVrMode, addr 0x5e03790, size 0x6c, virtual false, abstract: false, final false
  static inline bool ovrMetricsTool_LeaveVrMode();

  /// @brief Method ovrMetricsTool_SetOverlayDebugString, addr 0x5e0366c, size 0x9c, virtual false, abstract: false, final false
  static inline bool ovrMetricsTool_SetOverlayDebugString(::StringW debugString);

  /// @brief Method ovrMetricsTool_Shutdown, addr 0x5e037fc, size 0x6c, virtual false, abstract: false, final false
