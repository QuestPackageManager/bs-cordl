...
public:
  ...
  /// @brief Method Start, addr 0x58b3408, size 0x50, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58b3458, size 0xbc, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58b3514, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
