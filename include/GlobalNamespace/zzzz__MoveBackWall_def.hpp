...
public:
  ...
  /// @brief Method Start, addr 0x24f55f8, size 0x54, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x24f564c, size 0xbc, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x24f5708, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
