...
public:
  ...
  /// @brief Method .ctor addr 0x2160468 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Start>b__8_0 addr 0x2160470 size 0x44 virtual false final false
...
public:
  ...
  /// @brief Method add_didSelectCellWithIdxEvent addr 0x215fa60 size 0xb0 virtual false final false
  inline void add_didSelectCellWithIdxEvent(::System::Action_1<int32_t>* value);

  /// @brief Method remove_didSelectCellWithIdxEvent addr 0x215fb10 size 0xb0 virtual false final false
  inline void remove_didSelectCellWithIdxEvent(::System::Action_1<int32_t>* value);

  /// @brief Method get_gameplayModifiersData addr 0x215fbc0 size 0x1c0 virtual false final false
  ...
  /// @brief Method Start addr 0x215fd80 size 0x1a0 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x215ff20 size 0xd4 virtual false final false
  inline void OnDestroy();

  /// @brief Method GetSelectedGameplayModifierMask addr 0x215fff4 size 0xd0 virtual false final false
  inline ::GlobalNamespace::GameplayModifierMask GetSelectedGameplayModifierMask();

  /// @brief Method SelectCellWithGameplayModifierMask addr 0x21600c4 size 0x30 virtual false final false
  inline void SelectCellWithGameplayModifierMask(::GlobalNamespace::GameplayModifierMask gameplayModifierMask);

  /// @brief Method GetIdxForGameplayModifierMask addr 0x21600f4 size 0x184 virtual false final false
  inline int32_t GetIdxForGameplayModifierMask(::GlobalNamespace::GameplayModifierMask gameplayModifierMask);

  /// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx addr 0x2160278 size 0x24 virtual false final false
  ...
  /// @brief Method .ctor addr 0x216029c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <get_gameplayModifiersData>b__7_0 addr 0x21602a4 size 0x160 virtual false final false
