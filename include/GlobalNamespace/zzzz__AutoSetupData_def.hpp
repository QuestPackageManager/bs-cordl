...
public:
  ...
  /// @brief Method .ctor, addr 0x593e7a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AutoSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AutoSetupData(AutoSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AutoSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AutoSetupData(AutoSetupDataconst&) = delete;
