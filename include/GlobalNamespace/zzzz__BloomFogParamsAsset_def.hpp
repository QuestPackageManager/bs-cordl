...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomFogParamsAsset*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomFogParamsAsset*, "", "BloomFogParamsAsset");
...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x59075c0, size 0xb4, virtual true, abstract: false, final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  static inline ::GlobalNamespace::BloomFogParamsAsset* New_ctor();

  constexpr ::GlobalNamespace::BloomFogParamsBehaviour* const& __cordl_internal_get__template() const;
  ...
  /// @brief Method .ctor, addr 0x5907674, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x59075b8, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BloomFogParamsAsset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BloomFogParamsAsset(BloomFogParamsAsset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BloomFogParamsAsset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BloomFogParamsAsset(BloomFogParamsAssetconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BloomFogParamsAsset) == 0x20, "Size mismatch!");
