...
public:
  ...
  /// @brief Method HandleTransitionDidFinish, addr 0x3ae120c, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3ae113c, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnValidate, addr 0x3ae12c0, size 0xe0, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Start, addr 0x3ae10ac, size 0x90, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ae13a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
