...
public:
  ...
  /// @brief Method get_activePlayersAtGameStart addr 0xe51d9c size 0x260 virtual false final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>* get_activePlayersAtGameStart();

  /// @brief Method get_activePlayerSpecificSettingsAtGameStart addr 0xe51ffc size 0x8 virtual false final false
  ...
  /// @brief Method set_activePlayerSpecificSettingsAtGameStart addr 0xe52004 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe5200c size 0x8 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0xe52014 size 0x28 virtual false final false
  ...
  /// @brief Method Serialize addr 0xe5203c size 0x36c virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xe52438 size 0x158 virtual true final true
