...
public:
  ...
  /// @brief Method InstallBindings, addr 0x5833e70, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5833fd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
