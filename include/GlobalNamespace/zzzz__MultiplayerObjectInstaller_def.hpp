...
public:
  ...
  /// @brief Method InstallBindings, addr 0x260dcc0, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260de04, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
