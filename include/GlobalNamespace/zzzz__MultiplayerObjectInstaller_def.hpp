...
public:
  ...
  /// @brief Method InstallBindings, addr 0x272c2b8, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272c3fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
