...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatmapDataObstaclesAndBombsTransform____c__DisplayClass0_0::*)()>(
  ...
  constexpr static std::size_t addrs = 0x223a678;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
  ...
  constexpr static std::size_t addrs = 0x223a788;
...
inline ::GlobalNamespace::__BeatmapDataObstaclesAndBombsTransform____c__DisplayClass0_0* GlobalNamespace::__BeatmapDataObstaclesAndBombsTransform____c__DisplayClass0_0::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::__BeatmapDataObstaclesAndBombsTransform____c__DisplayClass0_0*>());
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
  ...
  constexpr static std::size_t addrs = 0x223a544;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataObstaclesAndBombsTransform*>::get(), "CreateTransformedData", std::vector<Il2CppClass*>{},
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::GlobalNamespace::BeatmapDataItem*, ::GlobalNamespace::__GameplayModifiers__EnabledObstacleType, bool)>(
  ...
  constexpr static std::size_t addrs = 0x223a680;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataObstaclesAndBombsTransform*>::get(), "ShouldUseBeatmapDataItem", std::vector<Il2CppClass*>{},
