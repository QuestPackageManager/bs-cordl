...
/// @brief Method AdjustPositionWithOffsetDirection, addr 0x31b3f48, size 0x1b8, virtual false, abstract: false, final false
...
/// @brief Method Awake, addr 0x31b3160, size 0x1c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method BuildAnimationCurvePath, addr 0x31b3918, size 0x574, virtual false, abstract: false, final false
inline bool BuildAnimationCurvePath() ;

/// @brief Method HandleBeatmapObjectSpawnControllerDidInit, addr 0x31b4954, size 0x4, virtual false, abstract: false, final false
inline void HandleBeatmapObjectSpawnControllerDidInit() ;

static inline ::GlobalNamespace::BeatmapObjectsAvoidance* New_ctor() ;

/// @brief Method OnDestroy, addr 0x31b35a8, size 0x110, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetupAndRun, addr 0x31b3268, size 0x340, virtual false, abstract: false, final false
inline void SetupAndRun() ;

/// @brief Method Start, addr 0x31b317c, size 0xec, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x31b36b8, size 0x260, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x31b4958, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
