...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameplayModifierParamsSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameplayModifierParamsSO*, "", "GameplayModifierParamsSO");
...
public:
  // Declarations
  __declspec(property(get = get_requires)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> _cordl_requires;
  ...
  __declspec(property(get = __cordl_internal_get__mutuallyExclusives, put = __cordl_internal_set__mutuallyExclusives)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>>
      _mutuallyExclusives;

  /// @brief Field _requiredBy, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__requiredBy, put = __cordl_internal_set__requiredBy)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> _requiredBy;

  /// @brief Field _requires, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__requires, put = __cordl_internal_set__requires)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> _requires;
  ...
  __declspec(property(get = get_mutuallyExclusives)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> mutuallyExclusives;

  __declspec(property(get = get_requiredBy)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> requiredBy;
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> const& __cordl_internal_get__mutuallyExclusives() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>>& __cordl_internal_get__mutuallyExclusives();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> const& __cordl_internal_get__requiredBy() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>>& __cordl_internal_get__requiredBy();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> const& __cordl_internal_get__requires() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>>& __cordl_internal_get__requires();
  ...
  constexpr void __cordl_internal_set__mutuallyExclusives(::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> value);

  constexpr void __cordl_internal_set__requiredBy(::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>> value);
...
static_assert(sizeof(::GlobalNamespace::GameplayModifierParamsSO) == 0x50, "Size mismatch!");
