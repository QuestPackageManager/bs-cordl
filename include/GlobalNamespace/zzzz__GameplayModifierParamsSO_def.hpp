...
/// @brief Field _mutuallyExclusives, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__mutuallyExclusives, put=__cordl_internal_set__mutuallyExclusives)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>,::Array<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>>*>  _mutuallyExclusives;

/// @brief Field _requiredBy, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__requiredBy, put=__cordl_internal_set__requiredBy)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>,::Array<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>>*>  _requiredBy;

/// @brief Field _requires, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__requires, put=__cordl_internal_set__requires)) ::ArrayW<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>,::Array<::UnityW<::GlobalNamespace::GameplayModifierParamsSO>>*>  _requires;
...
/// @brief Method .ctor, addr 0x360fa28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_descriptionLocalizationKey, addr 0x360f9e8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_descriptionLocalizationKey() ;

/// @brief Method get_icon, addr 0x360f9f0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Sprite> get_icon() ;

/// @brief Method get_isInBeta, addr 0x360fa20, size 0x8, virtual false, abstract: false, final false
inline bool get_isInBeta() ;

/// @brief Method get_modifierNameLocalizationKey, addr 0x360f9e0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_modifierNameLocalizationKey() ;

/// @brief Method get_multiplier, addr 0x360fa10, size 0x8, virtual false, abstract: false, final false
inline float_t get_multiplier() ;

/// @brief Method get_multiplierConditionallyValid, addr 0x360fa18, size 0x8, virtual false, abstract: false, final false
inline bool get_multiplierConditionallyValid() ;

/// @brief Method get_mutuallyExclusives, addr 0x360f9f8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_requiredBy, addr 0x360fa08, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_requires, addr 0x360fa00, size 0x8, virtual false, abstract: false, final false
