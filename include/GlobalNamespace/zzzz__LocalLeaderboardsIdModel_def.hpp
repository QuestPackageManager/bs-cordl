...
public:
  // Declarations
  /// @brief Method GetLocalLeaderboardID, addr 0x2701180, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2701188, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
