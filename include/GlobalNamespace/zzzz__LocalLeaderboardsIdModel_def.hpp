...
public:
  // Declarations
  /// @brief Method GetLocalLeaderboardID, addr 0x2705000, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2705008, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
