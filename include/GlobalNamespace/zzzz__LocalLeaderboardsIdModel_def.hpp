...
public:
// Declarations
/// @brief Method GetLocalLeaderboardID, addr 0x3658f94, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3658f9c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
