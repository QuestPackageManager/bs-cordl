...
public:
  // Declarations
  /// @brief Method GetLocalLeaderboardID, addr 0x14a8364, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14a836c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
