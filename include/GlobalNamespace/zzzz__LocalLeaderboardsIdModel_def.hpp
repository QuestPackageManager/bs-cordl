...
public:
  // Declarations
  /// @brief Method GetLocalLeaderboardID, addr 0x27011a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27011b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
