...
public:
  ...
  /// @brief Method Destroy, addr 0x39c652c, size 0x4, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Dispose, addr 0x39c65ac, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::DefaultUnityXRHapticsHandler* New_ctor(::UnityEngine::XR::XRNode node);

  /// @brief Method StopHaptics, addr 0x39c657c, size 0x30, virtual true, abstract: false, final true
  inline void StopHaptics();

  /// @brief Method TriggerHapticPulse, addr 0x39c6530, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39c6504, size 0x28, virtual false, abstract: false, final false
