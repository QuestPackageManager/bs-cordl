...
public:
  ...
  /// @brief Method .ctor, addr 0x218aa04, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::XR::XRNode node);

  /// @brief Method Destroy, addr 0x218aa2c, size 0x4, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method TriggerHapticPulse, addr 0x218aa30, size 0x4c, virtual true, abstract: false, final true
  inline void TriggerHapticPulse(float_t strength, float_t duration);

  /// @brief Method StopHaptics, addr 0x218aa7c, size 0x30, virtual true, abstract: false, final true
  inline void StopHaptics();

  /// @brief Method Dispose, addr 0x218aaac, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();
