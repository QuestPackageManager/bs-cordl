...
public:
  ...
  /// @brief Method Destroy, addr 0x39cbc70, size 0x4, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Dispose, addr 0x39cbcf0, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::DefaultUnityXRHapticsHandler* New_ctor(::UnityEngine::XR::XRNode node);

  /// @brief Method StopHaptics, addr 0x39cbcc0, size 0x30, virtual true, abstract: false, final true
  inline void StopHaptics();

  /// @brief Method TriggerHapticPulse, addr 0x39cbc74, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39cbc48, size 0x28, virtual false, abstract: false, final false
