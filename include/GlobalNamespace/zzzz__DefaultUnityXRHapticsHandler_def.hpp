...
public:
  ...
  /// @brief Method Destroy, addr 0x39c9434, size 0x4, virtual false, abstract: false, final false
  inline void Destroy();

  /// @brief Method Dispose, addr 0x39c94b4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::DefaultUnityXRHapticsHandler* New_ctor(::UnityEngine::XR::XRNode node);

  /// @brief Method StopHaptics, addr 0x39c9484, size 0x30, virtual true, abstract: false, final true
  inline void StopHaptics();

  /// @brief Method TriggerHapticPulse, addr 0x39c9438, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39c940c, size 0x28, virtual false, abstract: false, final false
