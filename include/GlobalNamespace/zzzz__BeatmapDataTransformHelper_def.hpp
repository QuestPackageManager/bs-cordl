...
public:
  // Declarations
  /// @brief Method AddTestBurstSlider, addr 0x360a8f0, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTestSlider, addr 0x360aa24, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTransformedBeatmapData, addr 0x360a690, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method IsObstaclesMergingNeeded, addr 0x360a8e4, size 0xc, virtual false, abstract: false, final false
