...
public:
  // Declarations
  /// @brief Method AddTestBurstSlider, addr 0x14a1c8c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTestSlider, addr 0x14a1d78, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTransformedBeatmapData, addr 0x14a1a44, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method IsObstaclesMergingNeeded, addr 0x14a1c80, size 0xc, virtual false, abstract: false, final false
