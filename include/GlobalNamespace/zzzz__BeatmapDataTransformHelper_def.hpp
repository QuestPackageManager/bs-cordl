...
public:
  // Declarations
  /// @brief Method AddTestBurstSlider, addr 0x35dfa8c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method AddTestSlider, addr 0x35dfbc0, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateTransformedBeatmapData, addr 0x35df82c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method IsObstaclesMergingNeeded, addr 0x35dfa80, size 0xc, virtual false, abstract: false, final false
