...
public:
  // Declarations
  /// @brief Method CreateTransformedBeatmapData addr 0x21cd58c size 0x198 virtual false final false
  ...
  /// @brief Method AddTestBurstSlider addr 0x21cd81c size 0xe4 virtual false final false
  ...
  /// @brief Method AddTestSlider addr 0x21cd900 size 0x17c virtual false final false
  ...
  /// @brief Method IsObstaclesMergingNeeded addr 0x21cd810 size 0xc virtual false final false
