...
/// @brief Field _gameplayAdditionalInformation, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameplayAdditionalInformation, put=__cordl_internal_set__gameplayAdditionalInformation)) ::GlobalNamespace::GameplayAdditionalInformationSetupData*  _gameplayAdditionalInformation;
...
/// @brief Method InstallBindings, addr 0x5851c10, size 0x3f8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5852008, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
