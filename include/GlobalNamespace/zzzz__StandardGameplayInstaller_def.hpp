...
public:
  ...
  /// @brief Method InstallBindings, addr 0x262abcc, size 0x364, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262af30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
