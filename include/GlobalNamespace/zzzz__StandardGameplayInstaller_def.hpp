...
public:
  ...
  /// @brief Method InstallBindings, addr 0x274911c, size 0x364, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2749480, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
