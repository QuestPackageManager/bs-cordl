...
public:
  ...
  /// @brief Method get_entitlementLabel, addr 0x2369a8c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_entitlementLabel();

  /// @brief Method get_productLabel, addr 0x2369a94, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_productLabel();

  /// @brief Method get_levelId, addr 0x2369a9c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2369aa4, size 0x3c, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData, ____entitlementLabel) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData, ____productLabel) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData, ____levelId) == 0x20, "Offset mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__levelProductsData,
                      put = __cordl_internal_set__levelProductsData))::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*,
  ...
  constexpr void
  __cordl_internal_set__levelProductsData(::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*, ::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*>*> value);
  ...
  /// @brief Method get_productLabel, addr 0x2369ae0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_productLabel();

  /// @brief Method get_levelPackId, addr 0x2369ae8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelPackId();

  /// @brief Method get_packLevelPriceDiscountMul, addr 0x2369af0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_packLevelPriceDiscountMul();

  /// @brief Method get_packIndex, addr 0x2369af8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_packIndex();

  /// @brief Method get_levelProductsData, addr 0x2369b00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2369b08, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTo, addr 0x2369ba0, size 0x20, virtual true, abstract: false, final true
...
static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData, ____productLabel) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData, ____packId) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData, ____packLevelPriceDiscountMul) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData, ____levelProductsData) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData, ____packIndex) == 0x30, "Offset mismatch!");
...
public:
  ...
  /// @brief Method get_targetLevelPackId, addr 0x2369bc0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_targetLevelPackId();

  /// @brief Method get_shouldOwnLevelPackId, addr 0x2369bc8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_shouldOwnLevelPackId();

  /// @brief Method get_redirectedProductLabel, addr 0x2369bd0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_redirectedProductLabel();

  /// @brief Method get_validUntilDate, addr 0x2369bd8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2369be0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData, ____targetLevelPackId) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData, ____shouldOwnLevelPackId) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData, ____redirectedProductLabel) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData, ____validUntilDate) == 0x28, "Offset mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__levelPackProductsData,
                      put = __cordl_internal_set__levelPackProductsData))::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*,
  ...
  __declspec(property(get = __cordl_internal_get__levelPackRedirectionData,
                      put = __cordl_internal_set__levelPackRedirectionData))::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*,
  ...
  /// @brief Method get_levelPackProductsData, addr 0x2369a7c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_levelPackRedirectionData, addr 0x2369a84, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::SonyLevelProductModelSO, ____levelPackProductsData) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SonyLevelProductModelSO, ____levelPackRedirectionData) == 0x20, "Offset mismatch!");
