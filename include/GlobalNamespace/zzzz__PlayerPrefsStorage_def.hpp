...
public:
  // Declarations
  /// @brief Method FileExists, addr 0x22a2384, size 0xc, virtual false, abstract: false, final false
  inline bool FileExists(::StringW filePath);

  /// @brief Method Initialize, addr 0x22a2300, size 0x4, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method LoadFile, addr 0x22a2304, size 0x80, virtual false, abstract: false, final false
  inline bool LoadFile(::StringW filePath, ::ByRef<::StringW> value);

  static inline ::GlobalNamespace::PlayerPrefsStorage* New_ctor();

  /// @brief Method .ctor, addr 0x22a2390, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
