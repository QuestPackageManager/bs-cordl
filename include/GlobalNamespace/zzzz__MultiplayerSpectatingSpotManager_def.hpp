...
public:
  ...
  /// @brief Method .ctor, addr 0x3be19dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_defaultSpot>b__3_0, addr 0x3be19e4, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetAdjacentSpot, addr 0x3be1660, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIndexBySpot, addr 0x3be1714, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterSpectatingSpot, addr 0x3be0c50, size 0x164, virtual false, abstract: false, final false
  inline void RegisterSpectatingSpot(::GlobalNamespace::IMultiplayerSpectatingSpot* spectatingSpot);

  /// @brief Method SpotOnHasBeenRemoved, addr 0x3be1798, size 0x124, virtual false, abstract: false, final false
  inline void SpotOnHasBeenRemoved(::GlobalNamespace::IMultiplayerSpectatingSpot* spectatingSpot);

  /// @brief Method UpdateIndexBySpotDictionary, addr 0x3be14ec, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3be18bc, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_defaultSpot, addr 0x3be138c, size 0x160, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IMultiplayerSpectatingSpot* get_defaultSpot();

  /// @brief Method get_spectatingSpots, addr 0x3be1384, size 0x8, virtual false, abstract: false, final false
