...
public:
  ...
  /// @brief Method ChangeNoteCutDirection, addr 0x2244054, size 0x8, virtual false, abstract: false, final false
  inline void ChangeNoteCutDirection(::GlobalNamespace::NoteCutDirection newCutDirection);

  /// @brief Method ChangeToBurstSliderHead, addr 0x2243ea4, size 0x30, virtual false, abstract: false, final false
  inline void ChangeToBurstSliderHead();

  /// @brief Method ChangeToGameNote, addr 0x2243ed4, size 0x10, virtual false, abstract: false, final false
  inline void ChangeToGameNote();

  /// @brief Method CopyWith, addr 0x2243b8c, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBasicNoteData, addr 0x22439e0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBombNoteData, addr 0x2243924, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateBurstSliderNoteData, addr 0x2243aac, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCopy, addr 0x2243778, size 0xd4, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method MarkAsSliderHead, addr 0x2243ee4, size 0x38, virtual false, abstract: false, final false
  inline void MarkAsSliderHead();

  /// @brief Method MarkAsSliderTail, addr 0x2243f1c, size 0x38, virtual false, abstract: false, final false
  inline void MarkAsSliderTail();

  /// @brief Method Mirror, addr 0x2243fd0, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method ResetNoteFlip, addr 0x2243fc4, size 0xc, virtual false, abstract: false, final false
  inline void ResetNoteFlip();

  /// @brief Method SetBeforeJumpNoteLineLayer, addr 0x2243e9c, size 0x8, virtual false, abstract: false, final false
  inline void SetBeforeJumpNoteLineLayer(::GlobalNamespace::NoteLineLayer lineLayer);

  /// @brief Method SetCutDirectionAngleOffset, addr 0x2243fbc, size 0x8, virtual false, abstract: false, final false
  inline void SetCutDirectionAngleOffset(float_t cutDirectionAngleOffset);

  /// @brief Method SetNoteFlipToNote, addr 0x2243f54, size 0x68, virtual false, abstract: false, final false
  inline void SetNoteFlipToNote(::GlobalNamespace::NoteData* targetNote);

  /// @brief Method SetNoteToAnyCutDirection, addr 0x2244048, size 0xc, virtual false, abstract: false, final false
  inline void SetNoteToAnyCutDirection();

  /// @brief Method SubtypeIdentifier, addr 0x2243920, size 0x4, virtual false, abstract: false, final false
  static inline int32_t SubtypeIdentifier(::GlobalNamespace::ColorType colorType);

  /// @brief Method TransformNoteAOrBToRandomType, addr 0x224405c, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x224384c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beforeJumpNoteLineLayer, addr 0x2243700, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_beforeJumpNoteLineLayer();

  /// @brief Method get_colorType, addr 0x22436a0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_cutDirection, addr 0x22436b0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteCutDirection get_cutDirection();

  /// @brief Method get_cutDirectionAngleOffset, addr 0x2243730, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cutDirectionAngleOffset();

  /// @brief Method get_cutSfxVolumeMultiplier, addr 0x2243740, size 0x8, virtual false, abstract: false, final false
  inline float_t get_cutSfxVolumeMultiplier();

  /// @brief Method get_flipLineIndex, addr 0x2243710, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_flipLineIndex();

  /// @brief Method get_flipYSide, addr 0x2243720, size 0x8, virtual false, abstract: false, final false
  inline float_t get_flipYSide();

  /// @brief Method get_gameplayType, addr 0x2243680, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_GameplayType get_gameplayType();

  /// @brief Method get_isArcHead, addr 0x2243750, size 0x8, virtual false, abstract: false, final false
  inline bool get_isArcHead();

  /// @brief Method get_isArcTail, addr 0x2243764, size 0x8, virtual false, abstract: false, final false
  inline bool get_isArcTail();

  /// @brief Method get_lineIndex, addr 0x22436e0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_noteLineLayer, addr 0x22436f0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_noteLineLayer();

  /// @brief Method get_scoringType, addr 0x2243690, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_ScoringType get_scoringType();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x2243678, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_timeToNextColorNote, addr 0x22436c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeToNextColorNote();

  /// @brief Method get_timeToPrevColorNote, addr 0x22436d0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeToPrevColorNote();

  /// @brief Method set_beforeJumpNoteLineLayer, addr 0x2243708, size 0x8, virtual false, abstract: false, final false
  inline void set_beforeJumpNoteLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_colorType, addr 0x22436a8, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::ColorType value);

  /// @brief Method set_cutDirection, addr 0x22436b8, size 0x8, virtual false, abstract: false, final false
  inline void set_cutDirection(::GlobalNamespace::NoteCutDirection value);

  /// @brief Method set_cutDirectionAngleOffset, addr 0x2243738, size 0x8, virtual false, abstract: false, final false
  inline void set_cutDirectionAngleOffset(float_t value);

  /// @brief Method set_cutSfxVolumeMultiplier, addr 0x2243748, size 0x8, virtual false, abstract: false, final false
  inline void set_cutSfxVolumeMultiplier(float_t value);

  /// @brief Method set_flipLineIndex, addr 0x2243718, size 0x8, virtual false, abstract: false, final false
  inline void set_flipLineIndex(int32_t value);

  /// @brief Method set_flipYSide, addr 0x2243728, size 0x8, virtual false, abstract: false, final false
  inline void set_flipYSide(float_t value);

  /// @brief Method set_gameplayType, addr 0x2243688, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayType(::GlobalNamespace::NoteData_GameplayType value);

  /// @brief Method set_isArcHead, addr 0x2243758, size 0xc, virtual false, abstract: false, final false
  inline void set_isArcHead(bool value);

  /// @brief Method set_isArcTail, addr 0x224376c, size 0xc, virtual false, abstract: false, final false
  inline void set_isArcTail(bool value);

  /// @brief Method set_lineIndex, addr 0x22436e8, size 0x8, virtual false, abstract: false, final false
  inline void set_lineIndex(int32_t value);

  /// @brief Method set_noteLineLayer, addr 0x22436f8, size 0x8, virtual false, abstract: false, final false
  inline void set_noteLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_scoringType, addr 0x2243698, size 0x8, virtual false, abstract: false, final false
  inline void set_scoringType(::GlobalNamespace::NoteData_ScoringType value);

  /// @brief Method set_timeToNextColorNote, addr 0x22436c8, size 0x8, virtual false, abstract: false, final false
  inline void set_timeToNextColorNote(float_t value);

  /// @brief Method set_timeToPrevColorNote, addr 0x22436d8, size 0x8, virtual false, abstract: false, final false
