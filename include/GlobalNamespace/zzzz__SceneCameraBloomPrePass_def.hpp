...
// Write type traits
MARK_REF_T(::GlobalNamespace::SceneCameraBloomPrePass*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SceneCameraBloomPrePass*, "", "SceneCameraBloomPrePass");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5869fa8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SceneCameraBloomPrePass) == 0x38, "Size mismatch!");
