...
public:
  ...
  /// @brief Method AddLogger, addr 0x57c2f48, size 0xb4, virtual false, abstract: false, final false
  inline void AddLogger(::GlobalNamespace::IBeatSaberLogger* logger);

  /// @brief Method Log, addr 0x57c2ffc, size 0x180, virtual true, abstract: false, final true
  inline void Log(::StringW message);

  /// @brief Method Log, addr 0x57c317c, size 0x18c, virtual true, abstract: false, final true
  inline void Log(::StringW message, ::System::Object* context);

  /// @brief Method LogError, addr 0x57c3618, size 0x184, virtual true, abstract: false, final true
  inline void LogError(::StringW message);

  /// @brief Method LogError, addr 0x57c379c, size 0x18c, virtual true, abstract: false, final true
  inline void LogError(::StringW message, ::System::Object* context);

  /// @brief Method LogException, addr 0x57c3928, size 0x184, virtual true, abstract: false, final true
  inline void LogException(::System::Exception* exception);

  /// @brief Method LogException, addr 0x57c3aac, size 0x18c, virtual true, abstract: false, final true
  inline void LogException(::System::Exception* exception, ::System::Object* context);

  /// @brief Method LogWarning, addr 0x57c3308, size 0x184, virtual true, abstract: false, final true
  inline void LogWarning(::StringW message);

  /// @brief Method LogWarning, addr 0x57c348c, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x57c2f40, size 0x8, virtual false, abstract: false, final false
