...
/// @brief Method AddLogger, addr 0x5752e20, size 0xb4, virtual false, abstract: false, final false
inline void AddLogger(::GlobalNamespace::IBeatSaberLogger*  logger) ;

/// @brief Method Log, addr 0x5752ed4, size 0x180, virtual true, abstract: false, final true
inline void Log(::StringW  message) ;

/// @brief Method Log, addr 0x5753054, size 0x18c, virtual true, abstract: false, final true
inline void Log(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogError, addr 0x57534f0, size 0x184, virtual true, abstract: false, final true
inline void LogError(::StringW  message) ;

/// @brief Method LogError, addr 0x5753674, size 0x18c, virtual true, abstract: false, final true
inline void LogError(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogException, addr 0x5753800, size 0x184, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception) ;

/// @brief Method LogException, addr 0x5753984, size 0x18c, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::System::Object*  context) ;

/// @brief Method LogWarning, addr 0x57531e0, size 0x184, virtual true, abstract: false, final true
inline void LogWarning(::StringW  message) ;

/// @brief Method LogWarning, addr 0x5753364, size 0x18c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5752e18, size 0x8, virtual false, abstract: false, final false
