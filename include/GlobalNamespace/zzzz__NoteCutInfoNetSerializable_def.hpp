...
/// @brief Method Deserialize, addr 0x367e418, size 0x158, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x367e968, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x367ea3c, size 0x208, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteCutInfoNetSerializable* Init(float_t  saberSpeed, bool  cutWasOk, ::UnityEngine::Vector3  saberDir, ::UnityEngine::Vector3  cutPoint, ::UnityEngine::Vector3  cutNormal, ::GlobalNamespace::NoteData_GameplayType  gameplayType, ::GlobalNamespace::ColorType  colorType, ::GlobalNamespace::NoteLineLayer  lineLayer, int32_t  noteLineIndex, float_t  noteTime, float_t  timeToNextColorNote, ::UnityEngine::Vector3  notePosition, ::UnityEngine::Quaternion  noteRotation, ::UnityEngine::Vector3  noteScale, ::UnityEngine::Vector3  moveVec) ;

static inline ::GlobalNamespace::NoteCutInfoNetSerializable* New_ctor() ;

/// @brief Method Obtain, addr 0x367e3ac, size 0x6c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::NoteCutInfoNetSerializable* Obtain() ;

/// @brief Method Serialize, addr 0x367e650, size 0x1c4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x367e90c, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;
