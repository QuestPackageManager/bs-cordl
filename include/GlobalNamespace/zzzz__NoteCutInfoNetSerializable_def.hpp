...
public:
  ...
  /// @brief Method Deserialize, addr 0x1504a40, size 0x118, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x1504e2c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x1504f10, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x15049dc, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteCutInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x1504c20, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1504dcc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
