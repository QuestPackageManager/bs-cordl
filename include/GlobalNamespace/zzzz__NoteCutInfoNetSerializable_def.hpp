...
public:
  ...
  /// @brief Method Deserialize, addr 0x271eae8, size 0x118, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x271ef74, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x271f050, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x271ea84, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteCutInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x271ecc8, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x271ef14, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
