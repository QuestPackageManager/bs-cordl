...
public:
  ...
  /// @brief Method Deserialize, addr 0x27264a4, size 0x118, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x2726930, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x2726a0c, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x2726440, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::NoteCutInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x2726684, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27268d0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
