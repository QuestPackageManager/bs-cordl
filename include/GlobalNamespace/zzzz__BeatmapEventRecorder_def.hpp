...
public:
  ...
  /// @brief Method Begin, addr 0x57ca6c4, size 0x4, virtual false, abstract: false, final false
  inline void Begin(::GlobalNamespace::BeatmapCallbacksController* callbackController);

  /// @brief Method CaptureFrame, addr 0x57ca784, size 0xec, virtual false, abstract: false, final false
  inline void CaptureFrame();

  /// @brief Method ClearCallbacks, addr 0x57ca914, size 0x30, virtual false, abstract: false, final false
  inline void ClearCallbacks();

  /// @brief Method Finish, addr 0x57ca870, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateTableReport, addr 0x57ca944, size 0x540, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleBeatmapEvent, addr 0x57cae84, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupCallbacks, addr 0x57ca6c8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ca640, size 0x84, virtual false, abstract: false, final false
