...
public:
  ...
  /// @brief Method Begin, addr 0x58ece9c, size 0x4, virtual false, abstract: false, final false
  inline void Begin(::GlobalNamespace::BeatmapCallbacksController* callbackController);

  /// @brief Method CaptureFrame, addr 0x58ecf5c, size 0xec, virtual false, abstract: false, final false
  inline void CaptureFrame();

  /// @brief Method ClearCallbacks, addr 0x58ed0ec, size 0x30, virtual false, abstract: false, final false
  inline void ClearCallbacks();

  /// @brief Method Finish, addr 0x58ed048, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts> Finish();

  /// @brief Method GenerateTableReport, addr 0x58ed11c, size 0x540, virtual false, abstract: false, final false
  static inline ::StringW GenerateTableReport(::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts> samples);

  /// @brief Method HandleBeatmapEvent, addr 0x58ed65c, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupCallbacks, addr 0x58ecea0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ece18, size 0x84, virtual false, abstract: false, final false
