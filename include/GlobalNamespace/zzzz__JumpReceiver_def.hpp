...
public:
  ...
  /// @brief Method OnNotify, addr 0x5712448, size 0x148, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5712590, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_jumpToDestinationValid, addr 0x5712438, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_jumpToDestinationValid, addr 0x5712440, size 0x8, virtual false, abstract: false, final false
