...
public:
  ...
  /// @brief Method OnNotify, addr 0x585be30, size 0x148, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x585bf78, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_jumpToDestinationValid, addr 0x585be20, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_jumpToDestinationValid, addr 0x585be28, size 0x8, virtual false, abstract: false, final false
