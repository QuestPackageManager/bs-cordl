...
public:
  ...
  /// @brief Method ResetManufacturerName, addr 0x5716aa8, size 0x8, virtual false, abstract: false, final false
  inline void ResetManufacturerName();

  /// @brief Method SetupController, addr 0x5716770, size 0x34, virtual false, abstract: false, final false
  inline bool SetupController(::UnityEngine::XR::InputDevice device, ::UnityEngine::MonoBehaviour* coroutineRunner);

  /// @brief Method TryToUpdateManufacturerName, addr 0x57167a4, size 0x188, virtual false, abstract: false, final false
  inline bool TryToUpdateManufacturerName(::UnityEngine::XR::InputDevice device);

  /// @brief Method UpdateHapticsHandler, addr 0x571692c, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5712a5c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_hapticsHandler, addr 0x5716750, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IUnityXRHapticsHandler* get_hapticsHandler();

  /// @brief Method get_manufacturer, addr 0x5716760, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::VRControllerManufacturer get_manufacturer();

  /// @brief Method set_hapticsHandler, addr 0x5716758, size 0x8, virtual false, abstract: false, final false
  inline void set_hapticsHandler(::GlobalNamespace::IUnityXRHapticsHandler* value);

  /// @brief Method set_manufacturer, addr 0x5716768, size 0x8, virtual false, abstract: false, final false
