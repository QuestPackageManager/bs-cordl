...
/// @brief Field <hapticsHandler>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__hapticsHandler_k__BackingField, put=__cordl_internal_set__hapticsHandler_k__BackingField)) ::GlobalNamespace::IUnityXRHapticsHandler*  _hapticsHandler_k__BackingField;

/// @brief Field <manufacturer>k__BackingField, offset 0x38, size 0x4 
 __declspec(property(get=__cordl_internal_get__manufacturer_k__BackingField, put=__cordl_internal_set__manufacturer_k__BackingField)) ::GlobalNamespace::VRControllerManufacturer  _manufacturer_k__BackingField;
...
static inline ::GlobalNamespace::UnityXRController* New_ctor(::UnityEngine::XR::XRNode  node, ::UnityEngine::InputSystem::InputAction*  positionAction, ::UnityEngine::InputSystem::InputAction*  rotationAction, ::UnityEngine::InputSystem::InputAction*  thumbstickAction) ;

/// @brief Method ResetManufacturerName, addr 0x56a8bbc, size 0x8, virtual false, abstract: false, final false
inline void ResetManufacturerName() ;

/// @brief Method SetupController, addr 0x56a8884, size 0x34, virtual false, abstract: false, final false
inline bool SetupController(::UnityEngine::XR::InputDevice  device, ::UnityEngine::MonoBehaviour*  coroutineRunner) ;

/// @brief Method TryToUpdateManufacturerName, addr 0x56a88b8, size 0x188, virtual false, abstract: false, final false
inline bool TryToUpdateManufacturerName(::UnityEngine::XR::InputDevice  device) ;

/// @brief Method UpdateHapticsHandler, addr 0x56a8a40, size 0x17c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56a4b94, size 0xbc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::XR::XRNode  node, ::UnityEngine::InputSystem::InputAction*  positionAction, ::UnityEngine::InputSystem::InputAction*  rotationAction, ::UnityEngine::InputSystem::InputAction*  thumbstickAction) ;

/// @brief Method get_hapticsHandler, addr 0x56a8864, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IUnityXRHapticsHandler* get_hapticsHandler() ;

/// @brief Method get_manufacturer, addr 0x56a8874, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::VRControllerManufacturer get_manufacturer() ;

/// @brief Method set_hapticsHandler, addr 0x56a886c, size 0x8, virtual false, abstract: false, final false
inline void set_hapticsHandler(::GlobalNamespace::IUnityXRHapticsHandler*  value) ;

/// @brief Method set_manufacturer, addr 0x56a887c, size 0x8, virtual false, abstract: false, final false
