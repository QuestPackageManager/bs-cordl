...
public:
  ...
  /// @brief Method CreateController, addr 0x39c71d4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ca024, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_orientationActionReference, addr 0x39ca004, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> get_orientationActionReference();

  /// @brief Method get_positionActionReference, addr 0x39c9ff4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> get_positionActionReference();

  /// @brief Method get_thumbstickActionReference, addr 0x39ca014, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::InputSystem::InputActionReference> get_thumbstickActionReference();

  /// @brief Method set_orientationActionReference, addr 0x39ca00c, size 0x8, virtual false, abstract: false, final false
  inline void set_orientationActionReference(::UnityEngine::InputSystem::InputActionReference* value);

  /// @brief Method set_positionActionReference, addr 0x39c9ffc, size 0x8, virtual false, abstract: false, final false
  inline void set_positionActionReference(::UnityEngine::InputSystem::InputActionReference* value);

  /// @brief Method set_thumbstickActionReference, addr 0x39ca01c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ResetManufacturerName, addr 0x39c9fec, size 0x8, virtual false, abstract: false, final false
  inline void ResetManufacturerName();

  /// @brief Method SetupController, addr 0x39c9ce4, size 0x34, virtual false, abstract: false, final false
  inline bool SetupController(::UnityEngine::XR::InputDevice device, ::UnityEngine::MonoBehaviour* coroutineRunner);

  /// @brief Method TryToUpdateManufacturerName, addr 0x39c9d18, size 0x150, virtual false, abstract: false, final false
  inline bool TryToUpdateManufacturerName(::UnityEngine::XR::InputDevice device);

  /// @brief Method UpdateHapticsHandler, addr 0x39c9e68, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39c9c18, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_hapticsHandler, addr 0x39c9c00, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IUnityXRHapticsHandler* get_hapticsHandler();

  /// @brief Method get_manufacturerName, addr 0x39c9c08, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::UnityXRHelper_VRControllerManufacturerName get_manufacturerName();

  /// @brief Method set_manufacturerName, addr 0x39c9c10, size 0x8, virtual false, abstract: false, final false
