...
public:
  ...
  /// @brief Method Awake, addr 0x2667f70, size 0x60, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleAdvancedHudToggleChanged, addr 0x2668658, size 0x50, virtual false, abstract: false, final false
  inline void HandleAdvancedHudToggleChanged(bool on);

  /// @brief Method HandleArcVisibilityDropdownDidSelectCellWithIdx, addr 0x2668544, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleHeadsetHapticIntensityControllerValueDidChange, addr 0x26685ec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLightReductionAmountSelected, addr 0x2668634, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoTextsAndHudsToggleChanged, addr 0x2668708, size 0x50, virtual false, abstract: false, final false
  inline void HandleNoTextsAndHudsToggleChanged(bool on);

  /// @brief Method HandleNoteJumpDurationTypeSettingsDropdownDidSelectCellWithIdx, addr 0x26686a8, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteJumpFixedDurationSettingsControllerValueDidChange, addr 0x26686e4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteJumpStartBeatOffsetPositionSelected, addr 0x2668610, size 0x24, virtual false, abstract: false, final false
  inline void HandleNoteJumpStartBeatOffsetPositionSelected(int32_t idx, float_t startBeatOffset);

  /// @brief Method HandlePlayerHeightSettingsControllerValueDidChange, addr 0x26685c8, size 0x24, virtual false, abstract: false, final false
  inline void HandlePlayerHeightSettingsControllerValueDidChange(float_t value);

  /// @brief Method HandleSFXVolumeSettingsControllerValueDidChange, addr 0x26684fc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSaberTrailIntensitySettingsControllerValueDidChange, addr 0x26685a4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x26683dc, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x26683a4, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2667fd0, size 0x3d4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x2667a04, size 0x348, virtual true, abstract: false, final true
  inline void Refresh();

  /// @brief Method RefreshArcsWarning, addr 0x266841c, size 0xe0, virtual false, abstract: false, final false
  inline void RefreshArcsWarning(::GlobalNamespace::ArcVisibilityType arcVisibilityType, bool forceRebuild);

  /// @brief Method RefreshNoteJumpUI, addr 0x26683e0, size 0x3c, virtual false, abstract: false, final false
  inline void RefreshNoteJumpUI(::GlobalNamespace::NoteJumpDurationTypeSettings noteJumpDurationTypeSettings);

  /// @brief Method SetData, addr 0x2666e04, size 0x24, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::PlayerData* playerData);

  /// @brief Method SetIsDirty, addr 0x2668520, size 0x24, virtual false, abstract: false, final false
  inline void SetIsDirty();

  /// @brief Method SetLayout, addr 0x26666b4, size 0x24, virtual false, abstract: false, final false
  inline void SetLayout(::GlobalNamespace::__PlayerSettingsPanelController__PlayerSettingsPanelLayout layout);

  /// @brief Method SetSectionDisabled, addr 0x2667f08, size 0x68, virtual false, abstract: false, final false
  inline void SetSectionDisabled(::UnityEngine::CanvasGroup* sectionCanvasGroup, bool disable);

  /// @brief Method UnsubscribeAllUICallbacks, addr 0x26683a8, size 0x34, virtual false, abstract: false, final false
  inline void UnsubscribeAllUICallbacks();

  /// @brief Method <OnEnable>b__42_0, addr 0x26687c0, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_0(bool on);

  /// @brief Method <OnEnable>b__42_1, addr 0x26687e4, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_1(bool on);

  /// @brief Method <OnEnable>b__42_2, addr 0x2668808, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_2(bool on);

  /// @brief Method <OnEnable>b__42_3, addr 0x266882c, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_3(bool on);

  /// @brief Method <OnEnable>b__42_4, addr 0x2668850, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_4(bool on);

  /// @brief Method <OnEnable>b__42_5, addr 0x2668874, size 0x44, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_5(bool on);

  /// @brief Method <OnEnable>b__42_6, addr 0x26688b8, size 0x24, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_6(bool on);

  /// @brief Method <OnEnable>b__42_7, addr 0x26688dc, size 0x3d4, virtual false, abstract: false, final false
  inline void _OnEnable_b__42_7();

  /// @brief Method <OnEnable>b__42_8, addr 0x2668cb0, size 0x14fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2668758, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangePlayerSettingsEvent, addr 0x2666f9c, size 0x9c, virtual false, abstract: false, final false
  inline void add_didChangePlayerSettingsEvent(::System::Action* value);

  /// @brief Method get_playerSpecificSettings, addr 0x266617c, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangePlayerSettingsEvent, addr 0x2667e6c, size 0x9c, virtual false, abstract: false, final false
