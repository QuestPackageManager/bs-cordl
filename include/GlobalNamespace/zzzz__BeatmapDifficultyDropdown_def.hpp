...
public:
  ...
  /// @brief Method <Start>b__11_0, addr 0x26598a8, size 0x44, virtual false, abstract: false, final false
  inline ::StringW _Start_b__11_0(::System::Tuple_2<::GlobalNamespace::BeatmapDifficultyMask, ::StringW>* x);

  /// @brief Method .ctor, addr 0x26598a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetIdxForBeatmapDifficultyMask, addr 0x265976c, size 0xa4, virtual false, abstract: false, final false
  inline int32_t GetIdxForBeatmapDifficultyMask(::GlobalNamespace::BeatmapDifficultyMask beatmapDifficultyMask);

  /// @brief Method GetSelectedBeatmapDifficultyMask, addr 0x265966c, size 0xd0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficultyMask GetSelectedBeatmapDifficultyMask();

  /// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx, addr 0x2659810, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2659598, size 0xd4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectCellWithBeatmapDifficultyMask, addr 0x265973c, size 0x30, virtual false, abstract: false, final false
  inline void SelectCellWithBeatmapDifficultyMask(::GlobalNamespace::BeatmapDifficultyMask beatmapDifficultyMask);

  /// @brief Method Start, addr 0x26593f8, size 0x1a0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2659834, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectCellWithIdxEvent, addr 0x26590a8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectCellWithIdxEvent(::System::Action_1<int32_t>* value);

  /// @brief Method get_beatmapDifficultyData, addr 0x2659208, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_includeAllDifficulties, addr 0x26593e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_includeAllDifficulties();

  /// @brief Method remove_didSelectCellWithIdxEvent, addr 0x2659158, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSelectCellWithIdxEvent(::System::Action_1<int32_t>* value);

  /// @brief Method set_includeAllDifficulties, addr 0x26593ec, size 0xc, virtual false, abstract: false, final false
