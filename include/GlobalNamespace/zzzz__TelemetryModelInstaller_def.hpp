...
public:
// Declarations
/// @brief Method InstallBindings, addr 0x367924c, size 0x74, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::TelemetryModelInstaller* New_ctor() ;

/// @brief Method .ctor, addr 0x36792c0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
