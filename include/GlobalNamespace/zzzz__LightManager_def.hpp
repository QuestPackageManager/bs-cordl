...
/// @brief Field _directionalLightColors, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__directionalLightColors, put=__cordl_internal_set__directionalLightColors)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _directionalLightColors;
...
/// @brief Field _directionalLightDirections, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__directionalLightDirections, put=__cordl_internal_set__directionalLightDirections)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _directionalLightDirections;
...
/// @brief Field _directionalLightPositions, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__directionalLightPositions, put=__cordl_internal_set__directionalLightPositions)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _directionalLightPositions;
...
/// @brief Field _pointLightPositions, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__pointLightPositions, put=__cordl_internal_set__pointLightPositions)) ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>  _pointLightPositions;
...
/// @brief Method OnCameraPreRender, addr 0x56b53c0, size 0x628, virtual false, abstract: false, final false
inline void OnCameraPreRender(::UnityEngine::Camera*  currentCamera) ;

/// @brief Method OnDestroy, addr 0x56b59e8, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x56b52d0, size 0xf0, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x56b51e0, size 0xf0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method ResetColors, addr 0x56b59ec, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b5ad4, size 0xdc, virtual false, abstract: false, final false
inline void _ctor() ;
