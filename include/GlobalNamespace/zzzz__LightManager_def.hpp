...
public:
  ...
  /// @brief Method OnCameraPreRender, addr 0x57232ac, size 0x628, virtual false, abstract: false, final false
  inline void OnCameraPreRender(::UnityEngine::Camera* currentCamera);

  /// @brief Method OnDestroy, addr 0x57238d4, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x57231bc, size 0xf0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57230cc, size 0xf0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResetColors, addr 0x57238d8, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57239c0, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor();
