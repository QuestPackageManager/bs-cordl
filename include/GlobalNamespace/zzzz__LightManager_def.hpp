...
public:
  ...
  /// @brief Method OnCameraPreRender, addr 0x39e07f4, size 0x544, virtual false, abstract: false, final false
  inline void OnCameraPreRender(::UnityEngine::Camera* camera);

  /// @brief Method OnDestroy, addr 0x39e0d38, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x39e0710, size 0xe4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39e062c, size 0xe4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResetColors, addr 0x39e0d3c, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e0e20, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
