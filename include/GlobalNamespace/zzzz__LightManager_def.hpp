...
public:
  ...
  __declspec(property(get = __cordl_internal_get__directionalLightColors, put = __cordl_internal_set__directionalLightColors)) ::ArrayW<::UnityEngine::Vector4> _directionalLightColors;
  ...
  __declspec(property(get = __cordl_internal_get__directionalLightDirections, put = __cordl_internal_set__directionalLightDirections)) ::ArrayW<::UnityEngine::Vector4> _directionalLightDirections;
  ...
  __declspec(property(get = __cordl_internal_get__directionalLightPositions, put = __cordl_internal_set__directionalLightPositions)) ::ArrayW<::UnityEngine::Vector4> _directionalLightPositions;

  /// @brief Field _directionalLightRadii, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__directionalLightRadii, put = __cordl_internal_set__directionalLightRadii)) ::ArrayW<float_t> _directionalLightRadii;
  ...
  __declspec(property(get = __cordl_internal_get__pointLightColors, put = __cordl_internal_set__pointLightColors)) ::ArrayW<::UnityEngine::Vector4> _pointLightColors;
  ...
  __declspec(property(get = __cordl_internal_get__pointLightPositions, put = __cordl_internal_set__pointLightPositions)) ::ArrayW<::UnityEngine::Vector4> _pointLightPositions;
  ...
  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__directionalLightColors();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__directionalLightDirections() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__directionalLightDirections();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__directionalLightPositions() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__directionalLightPositions();

  constexpr ::ArrayW<float_t> const& __cordl_internal_get__directionalLightRadii() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__directionalLightRadii();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__pointLightColors() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__pointLightColors();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__pointLightPositions() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__pointLightPositions();
  ...
  constexpr void __cordl_internal_set__directionalLightColors(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__directionalLightDirections(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__directionalLightPositions(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__directionalLightRadii(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__pointLightColors(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__pointLightPositions(::ArrayW<::UnityEngine::Vector4> value);
...
static_assert(sizeof(::GlobalNamespace::LightManager) == 0x58, "Size mismatch!");
