...
public:
  ...
  /// @brief Method .ctor, addr 0x270a614, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method SetConnectedPlayerSongTime, addr 0x270ad70, size 0x38, virtual false, abstract: false, final false
  inline void SetConnectedPlayerSongTime(int64_t syncTime, float_t songTime);

  /// @brief Method Start, addr 0x270ac04, size 0xc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSong, addr 0x2708f6c, size 0x178, virtual false, abstract: false, final false
  inline void StartSong(int64_t songStartSyncTime);

  /// @brief Method StopSong, addr 0x2709260, size 0xc, virtual false, abstract: false, final false
  inline void StopSong();

  /// @brief Method Update, addr 0x270ac10, size 0x160, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x270ada8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isReady, addr 0x270abfc, size 0x8, virtual true, abstract: false, final true
  inline bool get_isReady();

  /// @brief Method get_lastFrameDeltaSongTime, addr 0x270abd4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_lastFrameDeltaSongTime();

  /// @brief Method get_songEndTime, addr 0x270abe4, size 0xc, virtual true, abstract: false, final true
  inline float_t get_songEndTime();

  /// @brief Method get_songLength, addr 0x270abf0, size 0xc, virtual true, abstract: false, final true
  inline float_t get_songLength();

  /// @brief Method get_songTime, addr 0x270abc4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_lastFrameDeltaSongTime, addr 0x270abdc, size 0x8, virtual false, abstract: false, final false
  inline void set_lastFrameDeltaSongTime(float_t value);

  /// @brief Method set_songTime, addr 0x270abcc, size 0x8, virtual false, abstract: false, final false
