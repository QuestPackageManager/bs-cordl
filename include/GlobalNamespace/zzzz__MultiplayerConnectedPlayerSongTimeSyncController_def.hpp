...
/// @brief Method .ctor, addr 0x5811a68, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method SetConnectedPlayerSongTime, addr 0x58121cc, size 0x38, virtual false, abstract: false, final false
inline void SetConnectedPlayerSongTime(int64_t  syncTime, float_t  songTime) ;

/// @brief Method Start, addr 0x5812040, size 0xc, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartSong, addr 0x5810198, size 0x14c, virtual false, abstract: false, final false
inline void StartSong(int64_t  songStartSyncTime) ;

/// @brief Method StopSong, addr 0x5810468, size 0xc, virtual false, abstract: false, final false
inline void StopSong() ;

/// @brief Method Update, addr 0x581204c, size 0x180, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5812204, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isReady, addr 0x5812030, size 0x8, virtual true, abstract: false, final true
inline bool get_isReady() ;

/// @brief Method get_lastFrameDeltaSongTime, addr 0x5812000, size 0x8, virtual true, abstract: false, final true
inline float_t get_lastFrameDeltaSongTime() ;

/// @brief Method get_songEndTime, addr 0x5812010, size 0xc, virtual true, abstract: false, final true
inline float_t get_songEndTime() ;

/// @brief Method get_songLength, addr 0x581201c, size 0xc, virtual true, abstract: false, final true
inline float_t get_songLength() ;

/// @brief Method get_songTime, addr 0x5811ff0, size 0x8, virtual true, abstract: false, final true
inline float_t get_songTime() ;

/// @brief Method get_state, addr 0x5812038, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IAudioTimeSource_State get_state() ;

/// @brief Method get_timeScale, addr 0x5812028, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_lastFrameDeltaSongTime, addr 0x5812008, size 0x8, virtual false, abstract: false, final false
inline void set_lastFrameDeltaSongTime(float_t  value) ;

/// @brief Method set_songTime, addr 0x5811ff8, size 0x8, virtual false, abstract: false, final false
