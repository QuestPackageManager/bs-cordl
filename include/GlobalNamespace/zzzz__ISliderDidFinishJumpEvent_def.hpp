...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISliderDidFinishJumpEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISliderDidFinishJumpEvent(ISliderDidFinishJumpEventconst&) = delete;
