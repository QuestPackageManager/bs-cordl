...
public:
  ...
  /// @brief Method .ctor, addr 0x3704c50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AppStaticSettingsSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AppStaticSettingsSO(AppStaticSettingsSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AppStaticSettingsSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AppStaticSettingsSO(AppStaticSettingsSOconst&) = delete;
