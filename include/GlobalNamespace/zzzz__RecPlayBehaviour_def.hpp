...
public:
  ...
  /// @brief Method .ctor, addr 0x57d83d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CleanUp, addr 0x57d81c8, size 0x10c, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Configure, addr 0x57d8030, size 0x198, virtual false, abstract: false, final false
  inline void Configure();

  /// @brief Method CreateAutoLevelRecording, addr 0x57d78dc, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRecordingPath, addr 0x57d75f0, size 0x180, virtual false, abstract: false, final false
  static inline ::StringW CreateRecordingPath(::GlobalNamespace::BeatmapKey key);

  /// @brief Method Init, addr 0x57d74d0, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x57d82fc, size 0x10, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LoadLevelRecording, addr 0x57d7770, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x57d8310, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x57d830c, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Play, addr 0x57d7a3c, size 0x304, virtual false, abstract: false, final false
  inline void Play();

  /// @brief Method Record, addr 0x57d7da4, size 0xcc, virtual false, abstract: false, final false
  inline void Record();

  /// @brief Method SavePlayerPoseFrames, addr 0x57d7f60, size 0xd0, virtual false, abstract: false, final false
  static inline void SavePlayerPoseFrames(::StringW path, ::ByRef<::BeatSaber::RecPlay::PlayerPoseFrames> frames);

  /// @brief Method SaveRecording, addr 0x57d7ed4, size 0x8c, virtual false, abstract: false, final false
  inline void SaveRecording();

  /// @brief Method Update, addr 0x57d82d4, size 0x28, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <Play>g__ExtractLocalPose|14_0, addr 0x57d7d40, size 0x64, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose _Play_g__ExtractLocalPose_14_0(::UnityEngine::Transform* transform);

  /// @brief Method <Record>g__ExtractGlobalPose|15_0, addr 0x57d7e70, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d8328, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
