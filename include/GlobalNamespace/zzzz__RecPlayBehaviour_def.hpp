...
public:
  ...
  /// @brief Method .ctor, addr 0x3b29190, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CleanUp, addr 0x3b28f40, size 0x108, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method Configure, addr 0x3b28d98, size 0x1a8, virtual false, abstract: false, final false
  inline void Configure();

  /// @brief Method CreateAutoLevelRecording, addr 0x3b28540, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRecordingPath, addr 0x3b28270, size 0x174, virtual false, abstract: false, final false
  static inline ::StringW CreateRecordingPath(::GlobalNamespace::BeatmapKey key);

  /// @brief Method Init, addr 0x3b28140, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x3b29070, size 0x10, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LoadLevelRecording, addr 0x3b283e4, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b29084, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x3b29080, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Play, addr 0x3b28698, size 0x390, virtual false, abstract: false, final false
  inline void Play();

  /// @brief Method Record, addr 0x3b28abc, size 0xf8, virtual false, abstract: false, final false
  inline void Record();

  /// @brief Method SavePlayerPoseFrames, addr 0x3b28ccc, size 0xcc, virtual false, abstract: false, final false
  static inline void SavePlayerPoseFrames(::StringW path, ::ByRef<::BeatSaber::RecPlay::PlayerPoseFrames> frames);

  /// @brief Method SaveRecording, addr 0x3b28c48, size 0x84, virtual false, abstract: false, final false
  inline void SaveRecording();

  /// @brief Method Update, addr 0x3b29048, size 0x28, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <Play>g__ExtractLocalPose|14_0, addr 0x3b28a28, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose _Play_g__ExtractLocalPose_14_0(::UnityEngine::Transform* transform);

  /// @brief Method <Record>g__ExtractGlobalPose|15_0, addr 0x3b28bb4, size 0x94, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose _Record_g__ExtractGlobalPose_15_0(::UnityEngine::Transform* transform);

  /// @brief Method <SavePlayerPoseFrames>g__FileWriteAllText|26_0, addr 0x3b2909c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b290d0, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
