...
//  Writing Method size for method: ::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo.get_bannerImage
template <>
...
//  Writing Method size for method: ::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo.get_bannerPromoText
template <>
...
//  Writing Method size for method: ::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo._ctor
template <>
...
inline ::GlobalNamespace::IPreviewBeatmapLevel* GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo::get_previewBeatmapLevel() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo*>::get(), "get_previewBeatmapLevel",
                                               std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::IPreviewBeatmapLevel*, false>(this, ___internal_method);
}
inline ::UnityEngine::Sprite* GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo::get_bannerImage() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo*>::get(), "get_bannerImage",
                                               std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
  return ::cordl_internals::RunMethodRethrow<::UnityEngine::Sprite*, false>(this, ___internal_method);
}
inline ::StringW GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo::get_bannerPromoText() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo*>::get(), "get_bannerPromoText",
                                               std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
...
inline void GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo*>::get(), ".ctor",
                                               std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
