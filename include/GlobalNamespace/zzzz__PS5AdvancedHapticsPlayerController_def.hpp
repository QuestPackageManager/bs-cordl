...
public:
  ...
  /// @brief Method <PlayContinuousHapticPreset>b__0, addr 0x39c60d0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39c5fec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <PlayOneShotHapticPreset>b__0, addr 0x39c617c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39c5ff4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanPlayHapticPreset, addr 0x39c5ef4, size 0x14, virtual true, abstract: false, final true
  inline bool CanPlayHapticPreset(::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset, ::UnityEngine::XR::XRNode node);

  /// @brief Method Initialize, addr 0x39c5b28, size 0x4, virtual true, abstract: false, final true
  inline void Initialize();

  static inline ::GlobalNamespace::PS5AdvancedHapticsPlayerController* New_ctor();

  /// @brief Method OnHapticPlayFinishedCallback, addr 0x39c5ffc, size 0x58, virtual false, abstract: false, final false
  inline void OnHapticPlayFinishedCallback(::GlobalNamespace::HapticsAudioClipPlayer* player);

  /// @brief Method PlayContinuousHapticPreset, addr 0x39c5d20, size 0x1d4, virtual false, abstract: false, final false
  inline void PlayContinuousHapticPreset(::UnityEngine::XR::XRNode node, ::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset);

  /// @brief Method PlayHapticFeedback, addr 0x39c5b2c, size 0x24, virtual true, abstract: false, final true
  inline void PlayHapticFeedback(::UnityEngine::XR::XRNode node, ::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset);

  /// @brief Method PlayOneShotHapticPreset, addr 0x39c5b50, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39c6054, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
