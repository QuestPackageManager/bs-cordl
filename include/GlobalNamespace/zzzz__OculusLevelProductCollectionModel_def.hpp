...
public:
  ...
  /// @brief Method .ctor, addr 0x26e989c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e98bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_additionalSkus, addr 0x26e98ac, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_AdditionalSkus* get_additionalSkus();

  /// @brief Method get_levelId, addr 0x26e98b4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_levelId();

  /// @brief Method get_sku, addr 0x26e98a4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e98e4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_additionalSkus, addr 0x26e98cc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_AdditionalSkus* get_additionalSkus();

  /// @brief Method get_levelPackId, addr 0x26e98d4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_levelPackId();

  /// @brief Method get_levelProductsData, addr 0x26e98dc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_sku, addr 0x26e98c4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_sku();
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e9980, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_redirectedSku, addr 0x26e9970, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_redirectedSku();

  /// @brief Method get_shouldOwnLevelPackId, addr 0x26e9968, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_shouldOwnLevelPackId();

  /// @brief Method get_targetLevelPackId, addr 0x26e9960, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_targetLevelPackId();

  /// @brief Method get_validUntilDate, addr 0x26e9978, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLevelPackProductData, addr 0x26e9734, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLevelPackRedirectionData, addr 0x26e9824, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLevelProductData, addr 0x26e96bc, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_LevelProductData* GetLevelProductData(::StringW levelId);

  /// @brief Method GetLevelSku, addr 0x26e97ac, size 0x78, virtual false, abstract: false, final false
  inline ::StringW GetLevelSku(::StringW assetFile);

  /// @brief Method InsertAdditionalSkuIfValid, addr 0x26e95f8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e8b28, size 0xad0, virtual false, abstract: false, final false
