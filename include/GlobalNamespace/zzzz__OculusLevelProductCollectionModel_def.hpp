...
public:
  ...
  /// @brief Method .ctor, addr 0x26e7ea0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e7ec0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_additionalSkus, addr 0x26e7eb0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_AdditionalSkus* get_additionalSkus();

  /// @brief Method get_levelId, addr 0x26e7eb8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_levelId();

  /// @brief Method get_sku, addr 0x26e7ea8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26e7ee8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_additionalSkus, addr 0x26e7ed0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_AdditionalSkus* get_additionalSkus();

  /// @brief Method get_levelPackId, addr 0x26e7ed8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_levelPackId();

  /// @brief Method get_levelProductsData, addr 0x26e7ee0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_sku, addr 0x26e7ec8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_sku();
...
public:
  ...
  /// @brief Method get_redirectedSku, addr 0x26e7f74, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_redirectedSku();

  /// @brief Method get_shouldOwnLevelPackId, addr 0x26e7f6c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_shouldOwnLevelPackId();

  /// @brief Method get_targetLevelPackId, addr 0x26e7f64, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_targetLevelPackId();

  /// @brief Method get_validUntilDate, addr 0x26e7f7c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetLevelPackProductData, addr 0x26e7d38, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLevelPackRedirectionData, addr 0x26e7e28, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLevelProductData, addr 0x26e7cc0, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OculusLevelProductCollectionModel_LevelProductData* GetLevelProductData(::StringW levelId);

  /// @brief Method GetLevelSku, addr 0x26e7db0, size 0x78, virtual false, abstract: false, final false
  inline ::StringW GetLevelSku(::StringW assetFile);

  /// @brief Method InsertAdditionalSkuIfValid, addr 0x26e7bfc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e712c, size 0xad0, virtual false, abstract: false, final false
