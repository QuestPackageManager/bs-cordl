...
class CORDL_TYPE BeatSaberConnectedPlayerManager : public ::GlobalNamespace::ConnectedPlayerManager_3<::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData> {
public:
// Declarations
...
/// @brief Field _beatSaberMessageSerializer, offset 0x120, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatSaberMessageSerializer, put=__cordl_internal_set__beatSaberMessageSerializer)) ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::BeatSaberConnectedPlayerManager_BeatSaberMessageType,::GlobalNamespace::IBeatSaberConnectedPlayer*>*  _beatSaberMessageSerializer;
...
/// @brief Method DisposeGameSpecificResources, addr 0x31d2934, size 0x88, virtual true, abstract: false, final false
inline void DisposeGameSpecificResources() ;

/// @brief Method HandleGameSpecificConnected, addr 0x31d2638, size 0x28, virtual true, abstract: false, final false
inline void HandleGameSpecificConnected() ;

/// @brief Method HandleGameSpecificPlayerAdded, addr 0x31d2660, size 0x4, virtual true, abstract: false, final false
inline void HandleGameSpecificPlayerAdded(::GlobalNamespace::BeatSaberConnectedPlayer*  player) ;

/// @brief Method HandleGameSpecificPlayerIdentityUpdate, addr 0x31d2664, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method HandlePlayerAvatarUpdate, addr 0x31d285c, size 0xd8, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::BeatSaberConnectedPlayerManager* New_ctor(::GlobalNamespace::IConnectionManager*  connectionManager, ::GlobalNamespace::IConnectedPlayerFactory_3<::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData>*  connectedPlayerFactory) ;

static inline ::GlobalNamespace::BeatSaberConnectedPlayerManager* New_ctor(::BGNet::Core::ITimeProvider*  timeProvider, ::BGNet::Core::ITaskUtility*  taskUtility, ::GlobalNamespace::IConnectionManager*  connectionManager, ::GlobalNamespace::IConnectedPlayerFactory_3<::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData>*  connectedPlayerFactory) ;

/// @brief Method SetLocalPlayerAvatar, addr 0x31d2780, size 0xdc, virtual false, abstract: false, final false
inline void SetLocalPlayerAvatar(::GlobalNamespace::MultiplayerAvatarsData  multiplayerAvatarsData) ;

constexpr ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::BeatSaberConnectedPlayerManager_BeatSaberMessageType,::GlobalNamespace::IBeatSaberConnectedPlayer*>* const& __cordl_internal_get__beatSaberMessageSerializer() const;

constexpr ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::BeatSaberConnectedPlayerManager_BeatSaberMessageType,::GlobalNamespace::IBeatSaberConnectedPlayer*>*& __cordl_internal_get__beatSaberMessageSerializer() ;
...
constexpr void __cordl_internal_set__beatSaberMessageSerializer(::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::BeatSaberConnectedPlayerManager_BeatSaberMessageType,::GlobalNamespace::IBeatSaberConnectedPlayer*>*  value) ;
...
/// @brief Method .ctor, addr 0x31d2380, size 0xb8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IConnectionManager*  connectionManager, ::GlobalNamespace::IConnectedPlayerFactory_3<::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData>*  connectedPlayerFactory) ;

/// @brief Method .ctor, addr 0x31d2438, size 0x200, virtual false, abstract: false, final false
inline void _ctor(::BGNet::Core::ITimeProvider*  timeProvider, ::BGNet::Core::ITaskUtility*  taskUtility, ::GlobalNamespace::IConnectionManager*  connectionManager, ::GlobalNamespace::IConnectedPlayerFactory_3<::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData>*  connectedPlayerFactory) ;

/// @brief Method add_playerAvatarChangedEvent, addr 0x31d2200, size 0xc0, virtual false, abstract: false, final false
inline void add_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IBeatSaberConnectedPlayer*>*  value) ;

/// @brief Method remove_playerAvatarChangedEvent, addr 0x31d22c0, size 0xc0, virtual false, abstract: false, final false
