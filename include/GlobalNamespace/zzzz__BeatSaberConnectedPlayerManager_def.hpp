...
public:
  ...
  /// @brief Method DisposeGameSpecificResources, addr 0x320e570, size 0xb4, virtual true, abstract: false, final false
  inline void DisposeGameSpecificResources();

  /// @brief Method HandleGameSpecificConnected, addr 0x320e27c, size 0x24, virtual true, abstract: false, final false
  inline void HandleGameSpecificConnected();

  /// @brief Method HandleGameSpecificPlayerAdded, addr 0x320e2a0, size 0x4, virtual true, abstract: false, final false
  inline void HandleGameSpecificPlayerAdded(::GlobalNamespace::BeatSaberConnectedPlayer* player);

  /// @brief Method HandleGameSpecificPlayerIdentityUpdate, addr 0x320e2a4, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method HandlePlayerAvatarUpdate, addr 0x320e498, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetLocalPlayerAvatar, addr 0x320e3c0, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320df98, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IConnectionManager* connectionManager,
                    ::GlobalNamespace::IConnectedPlayerFactory_3<::GlobalNamespace::IBeatSaberConnectedPlayer*, ::GlobalNamespace::BeatSaberConnectedPlayer*,
                                                                 ::GlobalNamespace::BeatSaberPlayerIdentityPacketData>* connectedPlayerFactory);

  /// @brief Method .ctor, addr 0x320e050, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method add_playerAvatarChangedEvent, addr 0x320de18, size 0xc0, virtual false, abstract: false, final false
  inline void add_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IBeatSaberConnectedPlayer*>* value);

  /// @brief Method remove_playerAvatarChangedEvent, addr 0x320ded8, size 0xc0, virtual false, abstract: false, final false
