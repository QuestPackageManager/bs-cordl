...
public:
  ...
  /// @brief Method Start, addr 0x5875890, size 0x118, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58759a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
