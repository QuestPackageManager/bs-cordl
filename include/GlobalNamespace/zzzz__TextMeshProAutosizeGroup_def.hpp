...
public:
  ...
  /// @brief Method Start, addr 0x572d310, size 0x118, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x572d428, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
