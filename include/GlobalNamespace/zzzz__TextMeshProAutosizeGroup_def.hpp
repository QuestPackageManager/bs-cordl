...
public:
  ...
  /// @brief Method Start, addr 0x39f5234, size 0x104, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x39f5338, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
