...
public:
  ...
  /// @brief Method AddRenderPasses, addr 0x5e0b624, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x5e0b238, size 0x1a4, virtual true, abstract: false, final false
  inline void Create();

  /// @brief Method DestroySafe, addr 0x5e0b6c4, size 0x8c, virtual false, abstract: false, final false
  static inline void DestroySafe(::UnityEngine::Object* obj);

  /// @brief Method Dispose, addr 0x5e0b5e8, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0b750, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
