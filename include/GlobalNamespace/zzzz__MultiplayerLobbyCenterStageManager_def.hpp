...
public:
  ...
  /// @brief Method ActivateCenterStageManager, addr 0x3c121d0, size 0x20, virtual false, abstract: false, final false
  inline void ActivateCenterStageManager();

  /// @brief Method DeactivateCenterStageManager, addr 0x3c12470, size 0x20, virtual false, abstract: false, final false
  inline void DeactivateCenterStageManager();

  /// @brief Method Init, addr 0x3c121c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RecalculateCenterPosition, addr 0x3c121f0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c125c8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
