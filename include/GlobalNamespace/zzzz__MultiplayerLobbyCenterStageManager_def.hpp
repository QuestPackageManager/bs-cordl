...
public:
  ...
  /// @brief Method ActivateCenterStageManager, addr 0x5868b0c, size 0x24, virtual false, abstract: false, final false
  inline void ActivateCenterStageManager();

  /// @brief Method DeactivateCenterStageManager, addr 0x5868c60, size 0x24, virtual false, abstract: false, final false
  inline void DeactivateCenterStageManager();

  /// @brief Method Init, addr 0x5868b04, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RecalculateCenterPosition, addr 0x5868b30, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5868c84, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
