...
public:
  ...
  /// @brief Method ActivateCenterStageManager, addr 0x3c0f578, size 0x20, virtual false, abstract: false, final false
  inline void ActivateCenterStageManager();

  /// @brief Method DeactivateCenterStageManager, addr 0x3c0f818, size 0x20, virtual false, abstract: false, final false
  inline void DeactivateCenterStageManager();

  /// @brief Method Init, addr 0x3c0f570, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RecalculateCenterPosition, addr 0x3c0f598, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c0f970, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
