...
public:
  ...
  /// @brief Method InstantiateMixedRealityBackgroundCameraGameObject, addr 0x40820a0, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateMixedRealityForegroundCameraGameObject, addr 0x4082120, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x4081fdc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40821a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
