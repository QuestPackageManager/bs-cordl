...
// Write type traits
MARK_REF_T(::GlobalNamespace::OculusInvitePlatformHandler*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OculusInvitePlatformHandler*, "", "OculusInvitePlatformHandler");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OculusInvitePlatformHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OculusInvitePlatformHandler(OculusInvitePlatformHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OculusInvitePlatformHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OculusInvitePlatformHandler(OculusInvitePlatformHandlerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::OculusInvitePlatformHandler) == 0x10, "Size mismatch!");
