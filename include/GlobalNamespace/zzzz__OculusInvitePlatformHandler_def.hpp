...
public:
  ...
  /// @brief Method OpenInvitePanel, addr 0x13031c8, size 0x60, virtual true, abstract: false, final true
  inline void OpenInvitePanel();

  /// @brief Method .ctor, addr 0x1303228, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isSupported, addr 0x13031c0, size 0x8, virtual true, abstract: false, final true
