...
public:
  ...
  /// @brief Method get_isSupported, addr 0x1299c24, size 0x8, virtual true, abstract: false, final true
  inline bool get_isSupported();

  /// @brief Method OpenInvitePanel, addr 0x1299c2c, size 0x60, virtual true, abstract: false, final true
  inline void OpenInvitePanel();

  static inline ::GlobalNamespace::OculusInvitePlatformHandler* New_ctor();

  /// @brief Method .ctor, addr 0x1299c8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
