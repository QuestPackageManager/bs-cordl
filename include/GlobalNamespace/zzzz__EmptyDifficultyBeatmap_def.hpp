...
namespace GlobalNamespace {
struct __EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20;
}
namespace GlobalNamespace {
...
namespace GlobalNamespace {
struct __EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21;
}
namespace GlobalNamespace {
class IBeatmapLevel;
}
...
MARK_VAL_T(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21);
MARK_VAL_T(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20);
// Type: ::<GetBeatmapDataBasicInfoAsync>d__20
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 64, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4277)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 869 }),
// TypeDefinitionIndex(TypeDefinitionIndex(3397)), TypeDefinitionIndex(TypeDefinitionIndex(3389)), TypeDefinitionIndex(TypeDefinitionIndex(4290)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3389), inst: 4952 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(4410)) CS Name: ::EmptyDifficultyBeatmap::<GetBeatmapDataBasicInfoAsync>d__20
struct CORDL_TYPE __EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext addr 0x21fd9cc size 0x220 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x21fdbec size 0x58 virtual true final true
  ...
  constexpr __EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20(int32_t __1__state,
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20, 0x30>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20, __u__1) == 0x28, "Offset mismatch!");

} // namespace GlobalNamespace
// Type: ::<GetBeatmapDataAsync>d__21
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 64, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 873 }), TypeDefinitionIndex(TypeDefinitionIndex(3397)), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(3397), inst: 873 }), TypeDefinitionIndex(TypeDefinitionIndex(3389)), TypeDefinitionIndex(TypeDefinitionIndex(4292))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4411)) CS
// Name: ::EmptyDifficultyBeatmap::<GetBeatmapDataAsync>d__21
struct CORDL_TYPE __EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext addr 0x21fdc44 size 0x220 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x21fde64 size 0x58 virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
  ...
  constexpr __EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21(int32_t __1__state,
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21, 0x30>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21, __u__1) == 0x28, "Offset mismatch!");
...
public:
  // Declarations
  using _GetBeatmapDataAsync_d__21 = ::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21;

  using _GetBeatmapDataBasicInfoAsync_d__20 = ::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20;
  ...
  /// @brief Method get_level addr 0x21fd718 size 0x8 virtual true final true
  inline ::GlobalNamespace::IBeatmapLevel* get_level();

  /// @brief Method get_parentDifficultyBeatmapSet addr 0x21fd720 size 0x8 virtual true final true
  inline ::GlobalNamespace::IDifficultyBeatmapSet* get_parentDifficultyBeatmapSet();

  /// @brief Method get_difficulty addr 0x21fd728 size 0x8 virtual true final true
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method get_difficultyRank addr 0x21fd730 size 0x8 virtual true final true
  inline int32_t get_difficultyRank();

  /// @brief Method get_noteJumpMovementSpeed addr 0x21fd738 size 0x8 virtual true final true
  inline float_t get_noteJumpMovementSpeed();

  /// @brief Method get_noteJumpStartBeatOffset addr 0x21fd740 size 0x8 virtual true final true
  inline float_t get_noteJumpStartBeatOffset();

  /// @brief Method get_beatmapDataBasicInfo addr 0x21fd748 size 0x8 virtual false final false
  inline ::GlobalNamespace::IBeatmapDataBasicInfo* get_beatmapDataBasicInfo();

  /// @brief Method GetBeatmapDataBasicInfoAsync addr 0x21fd750 size 0xf0 virtual true final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::IBeatmapDataBasicInfo*>* GetBeatmapDataBasicInfoAsync();

  /// @brief Method GetBeatmapDataAsync addr 0x21fd840 size 0xf0 virtual true final true
  ...
  /// @brief Method .ctor addr 0x21fd930 size 0x9c virtual false final false
  inline void _ctor();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::EmptyDifficultyBeatmap, 0x38>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::EmptyDifficultyBeatmap, ____beatmapData) == 0x30, "Offset mismatch!");
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataAsync_d__21, "", "EmptyDifficultyBeatmap/<GetBeatmapDataAsync>d__21");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__EmptyDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__20, "", "EmptyDifficultyBeatmap/<GetBeatmapDataBasicInfoAsync>d__20");
