...
public:
  ...
  /// @brief Method SetColors, addr 0x58f0608, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f07c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
