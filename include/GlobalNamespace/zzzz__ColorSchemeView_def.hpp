...
public:
  ...
  /// @brief Method SetColors, addr 0x5817a2c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5817be4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
