...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorSchemeView*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorSchemeView*, "", "ColorSchemeView");
...
public:
  ...
  /// @brief Method SetColors, addr 0x591eb18, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591ecd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ColorSchemeView) == 0x58, "Size mismatch!");
