...
public:
  ...
  __declspec(property(get = __cordl_internal_get__environmentColor0BoostImage, put = __cordl_internal_set__environmentColor0BoostImage))::UnityW<::UnityEngine::UI::Image> _environmentColor0BoostImage;

  /// @brief Field _environmentColor1BoostImage, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__environmentColor1BoostImage, put = __cordl_internal_set__environmentColor1BoostImage))::UnityW<::UnityEngine::UI::Image> _environmentColor1BoostImage;
  ...
  /// @brief Method SetColors, addr 0x265af30, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265b0e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
