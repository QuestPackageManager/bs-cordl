...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::IMultiplayerObservable::*)()>(
...
inline float_t GlobalNamespace::IMultiplayerObservable::get_offsetSyncTime() {
