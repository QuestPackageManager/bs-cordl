...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int64_t (::GlobalNamespace::IMultiplayerObservable::*)()>(&::GlobalNamespace::IMultiplayerObservable::get_offsetSyncTime)> {
