...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightmapDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightmapDataSO*, "", "LightmapDataSO");
...
static_assert(sizeof(::GlobalNamespace::LightmapDataSO) == 0x28, "Size mismatch!");
