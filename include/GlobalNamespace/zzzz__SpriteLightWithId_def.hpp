...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x39e4f88, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e50cc, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x39e4f6c, size 0x1c, virtual false, abstract: false, final false
