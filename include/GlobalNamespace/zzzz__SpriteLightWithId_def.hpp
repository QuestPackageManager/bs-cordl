...
/// @brief Field _multiplyColorByAlpha, offset 0x54, size 0x4 
 __declspec(property(get=__cordl_internal_get__multiplyColorByAlpha, put=__cordl_internal_set__multiplyColorByAlpha)) ::GlobalNamespace::SpriteLightWithId_MultiplyColorByAlphaType  _multiplyColorByAlpha;
...
/// @brief Method ColorWasSet, addr 0x56bcd08, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bce58, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x56bccf0, size 0x18, virtual false, abstract: false, final false
