...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x22d6c18, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d6d5c, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x22d6bfc, size 0x1c, virtual false, abstract: false, final false
