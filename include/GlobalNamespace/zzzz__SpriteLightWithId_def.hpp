...
MARK_REF_T(::GlobalNamespace::SpriteLightWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpriteLightWithId_MultiplyColorByAlphaType, "", "SpriteLightWithId/MultiplyColorByAlphaType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpriteLightWithId*, "", "SpriteLightWithId");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::SpriteLightWithId_MultiplyColorByAlphaType) == 0x4, "Size mismatch!");
