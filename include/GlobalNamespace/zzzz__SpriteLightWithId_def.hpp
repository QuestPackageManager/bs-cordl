...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x572abf4, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572ad44, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x572abdc, size 0x18, virtual false, abstract: false, final false
