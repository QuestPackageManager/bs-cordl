...
public:
  // Declarations
  /// @brief Method LoadPreview, addr 0x26c44b4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadSong, addr 0x26c4604, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadPreview, addr 0x26c455c, size 0xa8, virtual false, abstract: false, final false
  static inline void UnloadPreview(::GlobalNamespace::AudioClipAsyncLoader* _, ::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method UnloadSong, addr 0x26c2dc4, size 0x1c8, virtual false, abstract: false, final false
