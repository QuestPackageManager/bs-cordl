...
public:
  ...
  /// @brief Method .ctor, addr 0x35e7710, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allBeatmapCharacteristics, addr 0x35e7708, size 0x8, virtual false, abstract: false, final false
