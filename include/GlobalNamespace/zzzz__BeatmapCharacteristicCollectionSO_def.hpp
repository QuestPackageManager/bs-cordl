...
public:
  ...
  /// @brief Method .ctor, addr 0x26b4c30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allBeatmapCharacteristics, addr 0x26b4c28, size 0x8, virtual false, abstract: false, final false
