...
public:
  ...
  /// @brief Method .ctor, addr 0x370c72c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allBeatmapCharacteristics, addr 0x370c724, size 0x8, virtual false, abstract: false, final false
