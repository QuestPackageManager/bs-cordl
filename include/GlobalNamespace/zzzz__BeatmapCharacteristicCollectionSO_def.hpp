...
public:
  ...
  /// @brief Method .ctor, addr 0x26b39e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allBeatmapCharacteristics, addr 0x26b39dc, size 0x8, virtual false, abstract: false, final false
