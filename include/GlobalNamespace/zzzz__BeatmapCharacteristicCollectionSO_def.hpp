...
public:
  ...
  /// @brief Method .ctor, addr 0x12dee8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allBeatmapCharacteristics, addr 0x12dee84, size 0x8, virtual false, abstract: false, final false
