...
public:
  ...
  /// @brief Method Activate, addr 0x26dc904, size 0x214, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method Deactivate, addr 0x26dcc0c, size 0x1a0, virtual false, abstract: false, final false
