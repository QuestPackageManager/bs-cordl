...
public:
  ...
  /// @brief Method Activate, addr 0x360e4b0, size 0x224, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method Deactivate, addr 0x360e7cc, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x360ea70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
