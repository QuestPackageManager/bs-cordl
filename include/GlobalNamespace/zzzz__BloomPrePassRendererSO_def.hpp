...
public:
  ...
  /// @brief Method .ctor, addr 0x39dfc2c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x39dec60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x39deac8, size 0x198, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CreateBloomPrePassRenderTextureIfNeeded, addr 0x39dab40, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableBloomFog, addr 0x39db9d4, size 0x1c, virtual false, abstract: false, final false
  inline void DisableBloomFog();

  /// @brief Method EnableBloomFog, addr 0x39db830, size 0x1c, virtual false, abstract: false, final false
  inline void EnableBloomFog();

  /// @brief Method GetCameraParams, addr 0x39da9cc, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x39da58c, size 0x140, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method MatrixLerp, addr 0x39df9fc, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x39deac4, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39deaa8, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PrepareLightsMeshRendering, addr 0x39dec68, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderAllLights, addr 0x39df15c, size 0x788, virtual false, abstract: false, final false
  inline void RenderAllLights(::UnityEngine::Matrix4x4 viewMatrix, ::UnityEngine::Matrix4x4 projectionMatrix, float_t linesWidth);

  /// @brief Method RenderAndSetData, addr 0x39dae30, size 0xa00, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCustomStereoCameraEyeOffset, addr 0x39df978, size 0x6c, virtual false, abstract: false, final false
  inline void SetCustomStereoCameraEyeOffset(float_t stereoCameraEyeOffset);

  /// @brief Method SetDataToShaders, addr 0x39db84c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateBloomFogParams, addr 0x39df9e4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39dfab4, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
