...
public:
// Declarations
/// @brief Method GetSize, addr 0x5721e28, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "limitAlpha", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "useCollision", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "minAlpha", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "maxAlpha", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "startAlpha", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "endAlpha", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "length", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "calculatedLength", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "multiplyLengthByAlphaBloomFogMultiplier", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "multiplyLengthByAlphaMultiplier", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "center", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "lightWidthMultiplier", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "startWidth", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "endWidth", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "boostToWhite", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "bloomFogIntensityMultiplier", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "color", ty: "::UnityEngine::Color", modifiers: "", def_value: None }, CppParam { name: "localToWorldMatrix", ty: "::UnityEngine::Matrix4x4", modifiers: "", def_value: None }]
constexpr BloomPrePassRendererSO_InputData(float_t  limitAlpha, float_t  useCollision, float_t  minAlpha, float_t  maxAlpha, float_t  startAlpha, float_t  endAlpha, float_t  length, float_t  calculatedLength, float_t  multiplyLengthByAlphaBloomFogMultiplier, float_t  multiplyLengthByAlphaMultiplier, float_t  center, float_t  lightWidthMultiplier, float_t  startWidth, float_t  endWidth, float_t  boostToWhite, float_t  bloomFogIntensityMultiplier, ::UnityEngine::Color  color, ::UnityEngine::Matrix4x4  localToWorldMatrix) noexcept;
...
/// @brief Method .ctor, addr 0x5721e30, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field inputData, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_inputData, put=__cordl_internal_set_inputData)) ::ArrayW<::GlobalNamespace::BloomPrePassRendererSO_InputData,::Array<::GlobalNamespace::BloomPrePassRendererSO_InputData>*>  inputData;
...
/// @brief Method Dispose, addr 0x5720cd8, size 0xc8, virtual true, abstract: false, final true
inline void Dispose() ;

static inline ::GlobalNamespace::BloomPrePassRendererSO_LightsRenderingData* New_ctor() ;

/// @brief Method Prepare, addr 0x572176c, size 0x3d8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5720958, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _lightsRenderingData, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightsRenderingData, put=__cordl_internal_set__lightsRenderingData)) ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::BloomPrePassRendererSO_LightsRenderingData*>*  _lightsRenderingData;
...
/// @brief Field _preallocationData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__preallocationData, put=__cordl_internal_set__preallocationData)) ::ArrayW<::GlobalNamespace::BloomPrePassRendererSO_PreallocationData*,::Array<::GlobalNamespace::BloomPrePassRendererSO_PreallocationData*>*>  _preallocationData;
...
/// @brief Method Cleanup, addr 0x57207fc, size 0x15c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method CreateBloomPrePassRenderTextureIfNeeded, addr 0x571c654, size 0x2fc, virtual false, abstract: false, final false
...
/// @brief Method DisableBloomFog, addr 0x571d480, size 0x24, virtual false, abstract: false, final false
inline void DisableBloomFog() ;

/// @brief Method EnableBloomFog, addr 0x571d2a8, size 0x28, virtual false, abstract: false, final false
inline void EnableBloomFog() ;

/// @brief Method GetCameraParams, addr 0x571c4fc, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x571c108, size 0x16c, virtual false, abstract: false, final false
inline void Init() ;

/// @brief Method MatrixLerp, addr 0x57216b0, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x57207f8, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x57207cc, size 0x2c, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PrepareLightsMeshRendering, addr 0x572095c, size 0x37c, virtual false, abstract: false, final false
...
/// @brief Method RenderAllLights, addr 0x5720da0, size 0x808, virtual false, abstract: false, final false
inline void RenderAllLights(::UnityEngine::Matrix4x4  viewMatrix, ::UnityEngine::Matrix4x4  projectionMatrix, float_t  linesWidth) ;

/// @brief Method RenderAndSetData, addr 0x571c950, size 0x958, virtual false, abstract: false, final false
...
/// @brief Method SetCustomStereoCameraEyeOffset, addr 0x572160c, size 0x90, virtual false, abstract: false, final false
inline void SetCustomStereoCameraEyeOffset(float_t  stereoCameraEyeOffset) ;

/// @brief Method SetDataToShaders, addr 0x571d2d0, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method UpdateBloomFogParams, addr 0x572169c, size 0x14, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::BloomPrePassRendererSO_LightsRenderingData*>* const& __cordl_internal_get__lightsRenderingData() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::BloomPrePassRendererSO_LightsRenderingData*>*& __cordl_internal_get__lightsRenderingData() ;

constexpr ::ArrayW<::GlobalNamespace::BloomPrePassRendererSO_PreallocationData*,::Array<::GlobalNamespace::BloomPrePassRendererSO_PreallocationData*>*> const& __cordl_internal_get__preallocationData() const;
...
constexpr void __cordl_internal_set__lightsRenderingData(::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::BloomPrePassLightTypeSO>,::GlobalNamespace::BloomPrePassRendererSO_LightsRenderingData*>*  value) ;

constexpr void __cordl_internal_set__preallocationData(::ArrayW<::GlobalNamespace::BloomPrePassRendererSO_PreallocationData*,::Array<::GlobalNamespace::BloomPrePassRendererSO_PreallocationData*>*>  value) ;

/// @brief Method .ctor, addr 0x5721b44, size 0xa0, virtual false, abstract: false, final false
inline void _ctor() ;
