...
public:
  // Declarations
  /// @brief Method GetSize, addr 0x57205c0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x57205c8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x571f470, size 0xc8, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::BloomPrePassRendererSO_LightsRenderingData* New_ctor();

  /// @brief Method Prepare, addr 0x571ff04, size 0x3d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x571f0f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x571ef94, size 0x15c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CreateBloomPrePassRenderTextureIfNeeded, addr 0x571adec, size 0x2fc, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableBloomFog, addr 0x571bc18, size 0x24, virtual false, abstract: false, final false
  inline void DisableBloomFog();

  /// @brief Method EnableBloomFog, addr 0x571ba40, size 0x28, virtual false, abstract: false, final false
  inline void EnableBloomFog();

  /// @brief Method GetCameraParams, addr 0x571ac94, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x571a8a0, size 0x16c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method MatrixLerp, addr 0x571fe48, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x571ef90, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x571ef64, size 0x2c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PrepareLightsMeshRendering, addr 0x571f0f4, size 0x37c, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderAllLights, addr 0x571f538, size 0x808, virtual false, abstract: false, final false
  inline void RenderAllLights(::UnityEngine::Matrix4x4 viewMatrix, ::UnityEngine::Matrix4x4 projectionMatrix, float_t linesWidth);

  /// @brief Method RenderAndSetData, addr 0x571b0e8, size 0x958, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCustomStereoCameraEyeOffset, addr 0x571fda4, size 0x90, virtual false, abstract: false, final false
  inline void SetCustomStereoCameraEyeOffset(float_t stereoCameraEyeOffset);

  /// @brief Method SetDataToShaders, addr 0x571ba68, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateBloomFogParams, addr 0x571fe34, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57202dc, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
