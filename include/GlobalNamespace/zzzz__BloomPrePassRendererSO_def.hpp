...
public:
  ...
  /// @brief Method .ctor, addr 0x39e86dc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x39e7710, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x39e7578, size 0x198, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CreateBloomPrePassRenderTextureIfNeeded, addr 0x39e35f0, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method DisableBloomFog, addr 0x39e4484, size 0x1c, virtual false, abstract: false, final false
  inline void DisableBloomFog();

  /// @brief Method EnableBloomFog, addr 0x39e42e0, size 0x1c, virtual false, abstract: false, final false
  inline void EnableBloomFog();

  /// @brief Method GetCameraParams, addr 0x39e347c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x39e303c, size 0x140, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method MatrixLerp, addr 0x39e84ac, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x39e7574, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39e7558, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PrepareLightsMeshRendering, addr 0x39e7718, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderAllLights, addr 0x39e7c0c, size 0x788, virtual false, abstract: false, final false
  inline void RenderAllLights(::UnityEngine::Matrix4x4 viewMatrix, ::UnityEngine::Matrix4x4 projectionMatrix, float_t linesWidth);

  /// @brief Method RenderAndSetData, addr 0x39e38e0, size 0xa00, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCustomStereoCameraEyeOffset, addr 0x39e8428, size 0x6c, virtual false, abstract: false, final false
  inline void SetCustomStereoCameraEyeOffset(float_t stereoCameraEyeOffset);

  /// @brief Method SetDataToShaders, addr 0x39e42fc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateBloomFogParams, addr 0x39e8494, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e8564, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
