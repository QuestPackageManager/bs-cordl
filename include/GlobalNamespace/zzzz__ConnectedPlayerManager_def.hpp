...
namespace GlobalNamespace {
struct __ConnectedPlayerManager___InitializePlayerEncryption_d__129;
}
namespace GlobalNamespace {
...
MARK_VAL_T(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129);
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(15167)), TypeDefinitionIndex(TypeDefinitionIndex(12851)),
// TypeDefinitionIndex(TypeDefinitionIndex(12648))} Self: TypeDefinitionIndex(TypeDefinitionIndex(12619)) CS Name: ::ConnectedPlayerManager::ConnectedPlayer*
...
public:
  ...
  /// @brief Field _playerAvatar, offset 0x68, size 0x70
  __declspec(property(get = __get__playerAvatar, put = __set__playerAvatar))::GlobalNamespace::MultiplayerAvatarData _playerAvatar;

  /// @brief Field _publicEncryptionKey, offset 0xd8, size 0x8
  ...
  /// @brief Field _latency, offset 0xf0, size 0x8
  __declspec(property(get = __get__latency, put = __set__latency))::GlobalNamespace::RollingAverage* _latency;
  ...
  constexpr ::GlobalNamespace::MultiplayerAvatarData& __get__playerAvatar();

  constexpr ::GlobalNamespace::MultiplayerAvatarData const& __get__playerAvatar() const;
  ...
  constexpr ::GlobalNamespace::RollingAverage*& __get__latency();

  constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::RollingAverage*> const& __get__latency() const;

  constexpr void __set__latency(::GlobalNamespace::RollingAverage* value);

  /// @brief Method get_connection addr 0xdaad4c size 0x8 virtual false final false
  inline ::GlobalNamespace::IConnection* get_connection();

  /// @brief Method get_connectionId addr 0xdaad54 size 0x8 virtual false final false
  inline uint8_t get_connectionId();

  /// @brief Method get_remoteConnectionId addr 0xdaad5c size 0x8 virtual false final false
  inline uint8_t get_remoteConnectionId();

  /// @brief Method get_isConnected addr 0xdaad64 size 0x8 virtual true final true
  inline bool get_isConnected();

  /// @brief Method get_isConnectionOwner addr 0xdaad6c size 0x8 virtual true final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isKicked addr 0xdaad74 size 0x8 virtual true final true
  inline bool get_isKicked();

  /// @brief Method get_disconnectedReason addr 0xdaad7c size 0x8 virtual true final true
  inline ::GlobalNamespace::DisconnectedReason get_disconnectedReason();

  /// @brief Method get_sortIndex addr 0xdaad84 size 0x8 virtual true final true
  inline int32_t get_sortIndex();

  /// @brief Method get_userId addr 0xdaad8c size 0x8 virtual true final true
  inline ::StringW get_userId();

  /// @brief Method get_userName addr 0xdaad94 size 0x8 virtual true final true
  inline ::StringW get_userName();

  /// @brief Method get_isMe addr 0xdaad9c size 0x8 virtual true final true
  inline bool get_isMe();

  /// @brief Method get_hasValidLatency addr 0xdaada4 size 0x30 virtual true final true
  inline bool get_hasValidLatency();

  /// @brief Method get_currentLatency addr 0xdaadd4 size 0x24 virtual true final true
  inline float_t get_currentLatency();

  /// @brief Method get_offsetSyncTime addr 0xdaadf8 size 0x50 virtual true final true
  inline float_t get_offsetSyncTime();

  /// @brief Method get_multiplayerAvatarData addr 0xdaae48 size 0x10 virtual true final true
  inline ::GlobalNamespace::MultiplayerAvatarData get_multiplayerAvatarData();

  /// @brief Method get_publicEncryptionKey addr 0xdaae58 size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_publicEncryptionKey();

  /// @brief Method get_random addr 0xdaae60 size 0x8 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_random();

  /// @brief Method get_isDirectConnection addr 0xda54d8 size 0x10 virtual false final false
  inline bool get_isDirectConnection();

  /// @brief Method get_encryptionState addr 0xdaae68 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xdaae70 size 0x100 virtual false final false
  ...
  /// @brief Method CreateLocalPlayer addr 0xda9030 size 0xc0 virtual false final false
  ...
  /// @brief Method CreateDirectlyConnectedPlayer addr 0xda9158 size 0x1e0 virtual false final false
  ...
  /// @brief Method CreateRemoteConnectedPlayer addr 0xda9df8 size 0xd0 virtual false final false
  ...
  /// @brief Method GetPlayerConnectedPacket addr 0xda5374 size 0x70 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerConnectedPacket* GetPlayerConnectedPacket();

  /// @brief Method GetPlayerIdentityPacket addr 0xda5630 size 0xb8 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket* GetPlayerIdentityPacket();

  /// @brief Method GetPlayerStatePacket addr 0xda8d30 size 0x60 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerStatePacket* GetPlayerStatePacket();

  /// @brief Method GetPlayerAvatarPacket addr 0xda8e20 size 0x88 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket* GetPlayerAvatarPacket();

  /// @brief Method GetPlayerSortOrderPacket addr 0xda55c8 size 0x68 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerSortOrderPacket* GetPlayerSortOrderPacket();

  /// @brief Method Disconnect addr 0xda4c50 size 0x148 virtual false final false
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method UpdateLatency addr 0xdaaca4 size 0x1c virtual false final false
  inline void UpdateLatency(float_t latency);

  /// @brief Method UpdateSortIndex addr 0xda8f90 size 0x20 virtual false final false
  inline bool UpdateSortIndex(int32_t index);

  /// @brief Method SetKicked addr 0xda8c44 size 0xc virtual false final false
  inline void SetKicked();

  /// @brief Method UpdateIdentity addr 0xdaa050 size 0x5c virtual false final false
  inline void UpdateIdentity(::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket* packet);

  /// @brief Method UpdateState addr 0xdaa20c size 0x1c virtual false final false
  inline void UpdateState(::GlobalNamespace::__ConnectedPlayerManager__PlayerStatePacket* packet);

  /// @brief Method UpdateAvatar addr 0xdaa2f0 size 0x24 virtual false final false
  inline void UpdateAvatar(::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket* packet);

  /// @brief Method SetEncryptionState addr 0xdab014 size 0x8 virtual false final false
  inline void SetEncryptionState(::GlobalNamespace::__EncryptionUtility__IEncryptionState* encryptionState);

  /// @brief Method HasState addr 0xdab01c size 0xc virtual true final true
  inline bool HasState(::StringW state);

  /// @brief Method SetPlayerState addr 0xdab028 size 0x8 virtual false final false
  inline void SetPlayerState(::GlobalNamespace::PlayerStateHash playerState);

  /// @brief Method SetPlayerAvatar addr 0xdab030 size 0x18 virtual false final false
  inline void SetPlayerAvatar(::GlobalNamespace::MultiplayerAvatarData avatarData);

  /// @brief Method ToString addr 0xdab048 size 0x17c virtual true final false
...
public:
  ...
  /// @brief Field _playerAvatar, offset: 0x68, size: 0x70, def value: None
  ::GlobalNamespace::MultiplayerAvatarData ____playerAvatar;

  /// @brief Field _publicEncryptionKey, offset: 0xd8, size: 0x8, def value: None
  ::ArrayW<uint8_t, ::Array<uint8_t>*> ____publicEncryptionKey;

  /// @brief Field _random, offset: 0xe0, size: 0x8, def value: None
  ::ArrayW<uint8_t, ::Array<uint8_t>*> ____random;

  /// @brief Field _encryptionState, offset: 0xe8, size: 0x8, def value: None
  ::GlobalNamespace::__EncryptionUtility__IEncryptionState* ____encryptionState;

  /// @brief Field _latency, offset: 0xf0, size: 0x8, def value: None
  ::GlobalNamespace::RollingAverage* ____latency;

  /// @brief Field kFixedSyncTimeOffset offset 0xffffffff size 0x4
  static constexpr float_t kFixedSyncTimeOffset{ 0.033333335 };

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer, 0xf8>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer, ____playerAvatar) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer, ____publicEncryptionKey) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer, ____random) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer, ____encryptionState) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer, ____latency) == 0xf0, "Offset mismatch!");
...
public:
  ...
  /// @brief Method get_pool addr 0xda7c38 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PlayerConnectedPacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab1c4 size 0x60 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab224 size 0x68 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xda9ec8 size 0x54 virtual true final true
  inline void Release();

  /// @brief Method Init addr 0xdaaf70 size 0x14 virtual false final false
  ...
  /// @brief Method .ctor addr 0xdab28c size 0x8 virtual false final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15167)), TypeDefinitionIndex(TypeDefinitionIndex(12851)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Field playerAvatar, offset 0x20, size 0x70
  __declspec(property(get = __get_playerAvatar, put = __set_playerAvatar))::GlobalNamespace::MultiplayerAvatarData playerAvatar;

  /// @brief Field random, offset 0x90, size 0x8
  __declspec(property(get = __get_random, put = __set_random))::GlobalNamespace::ByteArrayNetSerializable* random;

  /// @brief Field publicEncryptionKey, offset 0x98, size 0x8
  ...
  constexpr ::GlobalNamespace::MultiplayerAvatarData& __get_playerAvatar();

  constexpr ::GlobalNamespace::MultiplayerAvatarData const& __get_playerAvatar() const;
  ...
  /// @brief Method get_pool addr 0xda7c78 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab294 size 0x58 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab2ec size 0x88 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xdab374 size 0x6c virtual true final true
  inline void Release();

  /// @brief Method Init addr 0xdaaf84 size 0x5c virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket* Init(::GlobalNamespace::PlayerStateHash states, ::GlobalNamespace::MultiplayerAvatarData avatar,
  ...
  /// @brief Method .ctor addr 0xdab3e0 size 0xe4 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field playerAvatar, offset: 0x20, size: 0x70, def value: None
  ::GlobalNamespace::MultiplayerAvatarData ___playerAvatar;

  /// @brief Field random, offset: 0x90, size: 0x8, def value: None
  ::GlobalNamespace::ByteArrayNetSerializable* ___random;

  /// @brief Field publicEncryptionKey, offset: 0x98, size: 0x8, def value: None
  ::GlobalNamespace::ByteArrayNetSerializable* ___publicEncryptionKey;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket, 0xa0>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket, ___random) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager__PlayerIdentityPacket, ___publicEncryptionKey) == 0x98, "Offset mismatch!");
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15167)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  // Declarations
  /// @brief Field playerAvatar, offset 0x10, size 0x70
  __declspec(property(get = __get_playerAvatar, put = __set_playerAvatar))::GlobalNamespace::MultiplayerAvatarData playerAvatar;
  ...
  /// @brief Method get_pool addr 0xda7db8 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab4c4 size 0xc virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab4d0 size 0x48 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xdab518 size 0x54 virtual true final true
  inline void Release();

  /// @brief Method Init addr 0xdaafe8 size 0x20 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket* Init(::GlobalNamespace::MultiplayerAvatarData avatar);

  static inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket* New_ctor();

  /// @brief Method .ctor addr 0xdab56c size 0x8 virtual false final false
  inline void _ctor();
...
public:
  /// @brief Field playerAvatar, offset: 0x10, size: 0x70, def value: None
  ::GlobalNamespace::MultiplayerAvatarData ___playerAvatar;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__ConnectedPlayerManager__PlayerAvatarPacket, 0x80>, "Size mismatch!");
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(12851))}
...
public:
  ...
  /// @brief Method get_pool addr 0xda7df8 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PlayerStatePacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab574 size 0xc virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab580 size 0x20 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xdab5a0 size 0x54 virtual true final true
  inline void Release();

  /// @brief Method Init addr 0xdaafe0 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0xdab5f4 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_pool addr 0xda7cf8 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PlayerSortOrderPacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab5fc size 0x40 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab63c size 0x44 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xdaa670 size 0x54 virtual true final true
  inline void Release();

  /// @brief Method Init addr 0xdab008 size 0xc virtual false final false
  ...
  /// @brief Method .ctor addr 0xdab680 size 0x8 virtual false final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(12648))}
...
public:
  ...
  /// @brief Method get_pool addr 0xda7cb8 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PlayerDisconnectedPacket*>* get_pool();

  /// @brief Method Init addr 0xda9450 size 0x8 virtual false final false
  ...
  /// @brief Method Serialize addr 0xdab688 size 0x14 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab69c size 0x20 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xdaa3bc size 0x54 virtual true final true
  inline void Release();

  static inline ::GlobalNamespace::__ConnectedPlayerManager__PlayerDisconnectedPacket* New_ctor();

  /// @brief Method .ctor addr 0xdab6bc size 0x10 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_pool addr 0xda7d78 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__KickPlayerPacket*>* get_pool();

  /// @brief Method Init addr 0xda8c3c size 0x8 virtual false final false
  ...
  /// @brief Method Serialize addr 0xdab6cc size 0x14 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab6e0 size 0x20 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0xdaa4f0 size 0x54 virtual true final true
  inline void Release();

  static inline ::GlobalNamespace::__ConnectedPlayerManager__KickPlayerPacket* New_ctor();

  /// @brief Method .ctor addr 0xdab700 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Field syncTime, offset 0x10, size 0x4
  __declspec(property(get = __get_syncTime, put = __set_syncTime)) float_t syncTime;
  ...
  constexpr float_t& __get_syncTime();

  constexpr float_t const& __get_syncTime() const;

  constexpr void __set_syncTime(float_t value);

  /// @brief Method get_pool addr 0xda7d38 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__SyncTimePacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab708 size 0x20 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab728 size 0x28 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init addr 0xdaaac4 size 0x8 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__SyncTimePacket* Init(float_t syncTime);

  /// @brief Method Release addr 0xdaa818 size 0x54 virtual true final true
  inline void Release();

  static inline ::GlobalNamespace::__ConnectedPlayerManager__SyncTimePacket* New_ctor();

  /// @brief Method .ctor addr 0xdab750 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  /// @brief Field syncTime, offset: 0x10, size: 0x4, def value: None
  float_t ___syncTime;
...
public:
  // Declarations
  /// @brief Field pingTime, offset 0x10, size 0x4
  __declspec(property(get = __get_pingTime, put = __set_pingTime)) float_t pingTime;
  ...
  constexpr float_t& __get_pingTime();

  constexpr float_t const& __get_pingTime() const;

  constexpr void __set_pingTime(float_t value);

  /// @brief Method get_pool addr 0xda5184 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PingPacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab758 size 0x20 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab778 size 0x28 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init addr 0xda5288 size 0x8 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PingPacket* Init(float_t pingTime);

  /// @brief Method Release addr 0xdaaa68 size 0x54 virtual true final true
  inline void Release();

  static inline ::GlobalNamespace::__ConnectedPlayerManager__PingPacket* New_ctor();

  /// @brief Method .ctor addr 0xdab7a0 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  /// @brief Field pingTime, offset: 0x10, size: 0x4, def value: None
  float_t ___pingTime;
...
public:
  ...
  /// @brief Method get_pool addr 0xda7e38 size 0x40 virtual false final false
  static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::__ConnectedPlayerManager__PongPacket*>* get_pool();

  /// @brief Method Serialize addr 0xdab7a8 size 0x20 virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0xdab7c8 size 0x28 virtual true final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init addr 0xdaaabc size 0x8 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__PongPacket* Init(float_t pingTime);

  /// @brief Method Release addr 0xdaac50 size 0x54 virtual true final true
  inline void Release();

  static inline ::GlobalNamespace::__ConnectedPlayerManager__PongPacket* New_ctor();

  /// @brief Method .ctor addr 0xdab7f0 size 0x8 virtual false final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3395)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 772 }),
// TypeDefinitionIndex(TypeDefinitionIndex(12651)), TypeDefinitionIndex(TypeDefinitionIndex(3389)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 890 })} Self:
// TypeDefinitionIndex(TypeDefinitionIndex(12632)) CS Name: ::ConnectedPlayerManager::<InitializePlayerEncryption>d__129
struct CORDL_TYPE __ConnectedPlayerManager___InitializePlayerEncryption_d__129 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext addr 0xdab7f8 size 0x4e8 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0xdabe4c size 0xc virtual true final true
  ...
  constexpr __ConnectedPlayerManager___InitializePlayerEncryption_d__129(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder,
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __ConnectedPlayerManager___InitializePlayerEncryption_d__129();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, 0x50>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, __4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, player) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, _isClient_5__2) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, __u__1) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, __u__2) == 0x48, "Offset mismatch!");
...
public:
  // Declarations
  using _InitializePlayerEncryption_d__129 = ::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129;
  ...
  __declspec(property(get = __get__syncTimeOffset, put = __set__syncTimeOffset))::GlobalNamespace::RollingAverage* _syncTimeOffset;
  ...
  /// @brief Field _localPlayerAvatar, offset 0xc0, size 0x70
  __declspec(property(get = __get__localPlayerAvatar, put = __set__localPlayerAvatar))::GlobalNamespace::MultiplayerAvatarData _localPlayerAvatar;

  /// @brief Field _encryptionKeys, offset 0x130, size 0x8
  ...
  /// @brief Field _encryptionRandom, offset 0x138, size 0x8
  ...
  /// @brief Field _localPlayer, offset 0x140, size 0x8
  ...
  /// @brief Field _lastConnectionId, offset 0x148, size 0x1
  __declspec(property(get = __get__lastConnectionId, put = __set__lastConnectionId)) uint8_t _lastConnectionId;

  /// @brief Field _lastPollTime, offset 0x14c, size 0x4
  __declspec(property(get = __get__lastPollTime, put = __set__lastPollTime)) float_t _lastPollTime;

  /// @brief Field _lastPollFrame, offset 0x150, size 0x4
  __declspec(property(get = __get__lastPollFrame, put = __set__lastPollFrame)) int32_t _lastPollFrame;

  /// @brief Field _lastPingTime, offset 0x154, size 0x4
  __declspec(property(get = __get__lastPingTime, put = __set__lastPingTime)) float_t _lastPingTime;

  /// @brief Field _messageSerializer, offset 0x158, size 0x8
  ...
  __declspec(property(get = get_runTime)) float_t runTime;
  ...
  constexpr ::GlobalNamespace::RollingAverage*& __get__syncTimeOffset();

  constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::RollingAverage*> const& __get__syncTimeOffset() const;
  ...
  constexpr ::GlobalNamespace::MultiplayerAvatarData& __get__localPlayerAvatar();

  constexpr ::GlobalNamespace::MultiplayerAvatarData const& __get__localPlayerAvatar() const;
  ...
  constexpr float_t& __get__lastPollTime();

  constexpr float_t const& __get__lastPollTime() const;
  ...
  constexpr float_t& __get__lastPingTime();

  constexpr float_t const& __get__lastPingTime() const;
  ...
  /// @brief Method GetNextConnectionId addr 0xda49fc size 0x40 virtual false final false
  inline uint8_t GetNextConnectionId();

  /// @brief Method RemoveAllPlayers addr 0xda4b00 size 0x8c virtual false final false
  inline void RemoveAllPlayers(::GlobalNamespace::DisconnectedReason reason);

  /// @brief Method RemovePlayer addr 0xda4b8c size 0xc4 virtual false final false
  ...
  /// @brief Method AddPlayer addr 0xda4ee8 size 0x29c virtual false final false
  inline void AddPlayer(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* player);

  /// @brief Method GetPlayer addr 0xda4a3c size 0xc4 virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* GetPlayer(uint8_t connectionId);

  /// @brief Method GetPlayer addr 0xda57c8 size 0xf4 virtual false final false
  ...
  /// @brief Method GetPlayer addr 0xda58bc size 0xcc virtual false final false
  inline ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* GetPlayer(::StringW userId);

  /// @brief Method GetConnectedPlayer addr 0xda5988 size 0x58 virtual false final false
  inline ::GlobalNamespace::IConnectedPlayer* GetConnectedPlayer(int32_t index);

  /// @brief Method add_connectedEvent addr 0xda59e0 size 0x9c virtual false final false
  inline void add_connectedEvent(::System::Action* value);

  /// @brief Method remove_connectedEvent addr 0xda5a7c size 0x9c virtual false final false
  inline void remove_connectedEvent(::System::Action* value);

  /// @brief Method add_initializedEvent addr 0xda5b18 size 0x9c virtual false final false
  inline void add_initializedEvent(::System::Action* value);

  /// @brief Method remove_initializedEvent addr 0xda5bb4 size 0x9c virtual false final false
  inline void remove_initializedEvent(::System::Action* value);

  /// @brief Method add_disconnectedEvent addr 0xda5c50 size 0xb0 virtual false final false
  inline void add_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_disconnectedEvent addr 0xda5d00 size 0xb0 virtual false final false
  inline void remove_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_connectionFailedEvent addr 0xda5db0 size 0xb0 virtual false final false
  inline void add_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_connectionFailedEvent addr 0xda5e60 size 0xb0 virtual false final false
  inline void remove_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_playerConnectedEvent addr 0xda5f10 size 0xb0 virtual false final false
  inline void add_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerConnectedEvent addr 0xda5fc0 size 0xb0 virtual false final false
  inline void remove_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerDisconnectedEvent addr 0xda6070 size 0xb0 virtual false final false
  inline void add_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerDisconnectedEvent addr 0xda6120 size 0xb0 virtual false final false
  inline void remove_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerStateChangedEvent addr 0xda61d0 size 0xb0 virtual false final false
  inline void add_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerStateChangedEvent addr 0xda6280 size 0xb0 virtual false final false
  inline void remove_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerAvatarChangedEvent addr 0xda6330 size 0xb0 virtual false final false
  inline void add_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerAvatarChangedEvent addr 0xda63e0 size 0xb0 virtual false final false
  inline void remove_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerOrderChangedEvent addr 0xda6490 size 0xb0 virtual false final false
  inline void add_playerOrderChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerOrderChangedEvent addr 0xda6540 size 0xb0 virtual false final false
  inline void remove_playerOrderChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerLatencyInitializedEvent addr 0xda65f0 size 0xb0 virtual false final false
  inline void add_playerLatencyInitializedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerLatencyInitializedEvent addr 0xda66a0 size 0xb0 virtual false final false
  inline void remove_playerLatencyInitializedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_syncTimeInitializedEvent addr 0xda6750 size 0x9c virtual false final false
  inline void add_syncTimeInitializedEvent(::System::Action* value);

  /// @brief Method remove_syncTimeInitializedEvent addr 0xda67ec size 0x9c virtual false final false
  inline void remove_syncTimeInitializedEvent(::System::Action* value);

  /// @brief Method get_isConnectionOwner addr 0xda6888 size 0xa4 virtual false final false
  inline bool get_isConnectionOwner();

  /// @brief Method get_isConnectedOrConnecting addr 0xda692c size 0x28 virtual false final false
  inline bool get_isConnectedOrConnecting();

  /// @brief Method get_isConnected addr 0xda4d98 size 0xa4 virtual false final false
  inline bool get_isConnected();

  /// @brief Method get_isConnecting addr 0xda6954 size 0xa4 virtual false final false
  inline bool get_isConnecting();

  /// @brief Method get_isDisconnecting addr 0xda69f8 size 0xa4 virtual false final false
  inline bool get_isDisconnecting();

  /// @brief Method get_localPlayer addr 0xda6a9c size 0x8 virtual false final false
  inline ::GlobalNamespace::IConnectedPlayer* get_localPlayer();

  /// @brief Method get_connectedPlayerCount addr 0xda6aa4 size 0x48 virtual false final false
  inline int32_t get_connectedPlayerCount();

  /// @brief Method get_syncTime addr 0xda6aec size 0x28 virtual false final false
  inline float_t get_syncTime();

  /// @brief Method get_syncTimeInitialized addr 0xda6b14 size 0x34 virtual false final false
  inline bool get_syncTimeInitialized();

  /// @brief Method get_runTime addr 0xda51c4 size 0xc4 virtual false final false
  inline float_t get_runTime();

  static inline ::GlobalNamespace::ConnectedPlayerManager* New_ctor(::GlobalNamespace::IConnectionManager* connectionManager);

  /// @brief Method .ctor addr 0xda6b48 size 0xbc virtual false final false
  ...
  /// @brief Method .ctor addr 0xda6c04 size 0x1034 virtual false final false
  ...
  /// @brief Method PollUpdate addr 0xda81c0 size 0x178 virtual false final false
  inline void PollUpdate(int32_t frameCount);

  /// @brief Method PollLateUpdateOptional addr 0xda84f0 size 0x2c virtual false final false
  inline void PollLateUpdateOptional();

  /// @brief Method RegisterSerializer addr 0xda851c size 0x68 virtual false final false
  ...
  /// @brief Method UnregisterSerializer addr 0xda8584 size 0x68 virtual false final false
  ...
  /// @brief Method Dispose addr 0xda85ec size 0x584 virtual true final true
  inline void Dispose();

  /// @brief Method Disconnect addr 0xda4e3c size 0xac virtual false final false
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method KickPlayer addr 0xda8b70 size 0xcc virtual false final false
  inline void KickPlayer(::StringW userId, ::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method SetLocalPlayerState addr 0xda8c50 size 0xe0 virtual false final false
  inline void SetLocalPlayerState(::StringW state, bool setState);

  /// @brief Method SetLocalPlayerAvatar addr 0xda8d90 size 0x90 virtual false final false
  inline void SetLocalPlayerAvatar(::GlobalNamespace::MultiplayerAvatarData multiplayerAvatarData);

  /// @brief Method SetLocalPlayerSortIndex addr 0xda8ea8 size 0x10 virtual false final false
  inline void SetLocalPlayerSortIndex(int32_t sortIndex);

  /// @brief Method SetPlayerSortIndex addr 0xda8eb8 size 0xd8 virtual false final false
  inline void SetPlayerSortIndex(::GlobalNamespace::IConnectedPlayer* player, int32_t sortIndex);

  /// @brief Method ResetLocalState addr 0xda7e78 size 0x28 virtual false final false
  inline void ResetLocalState();

  /// @brief Method HandleInitialized addr 0xda8fb0 size 0x1c virtual false final false
  inline void HandleInitialized();

  /// @brief Method HandleConnected addr 0xda7ea0 size 0x2e8 virtual false final false
  inline void HandleConnected();

  /// @brief Method HandleDisconnected addr 0xda90f0 size 0x4c virtual false final false
  inline void HandleDisconnected(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method HandleConnectionFailed addr 0xda913c size 0x1c virtual false final false
  inline void HandleConnectionFailed(::GlobalNamespace::ConnectionFailedReason reason);

  /// @brief Method HandleConnectionConnected addr 0xda8188 size 0x38 virtual false final false
  inline void HandleConnectionConnected(::GlobalNamespace::IConnection* connection);

  /// @brief Method HandleConnectionDisconnected addr 0xda9338 size 0x118 virtual false final false
  ...
  /// @brief Method HandleNetworkReceive addr 0xda9544 size 0x4fc virtual false final false
  ...
  /// @brief Method SendImmediately addr 0xda5290 size 0xe4 virtual false final false
  inline void SendImmediately(::LiteNetLib::Utils::INetSerializable* message, bool onlyFirstDegree);

  /// @brief Method SendImmediatelyExcludingPlayer addr 0xda53e4 size 0xf4 virtual false final false
  ...
  /// @brief Method SendImmediatelyToPlayer addr 0xda54e8 size 0xe0 virtual false final false
  ...
  /// @brief Method SendImmediatelyFromPlayer addr 0xda9458 size 0xec virtual false final false
  ...
  /// @brief Method SendImmediatelyFromPlayerToPlayer addr 0xda56e8 size 0xe0 virtual false final false
  ...
  /// @brief Method FlushReliableQueue addr 0xda8338 size 0xdc virtual false final false
  inline void FlushReliableQueue();

  /// @brief Method FlushUnreliableQueue addr 0xda8414 size 0xdc virtual false final false
  inline void FlushUnreliableQueue();

  /// @brief Method WriteOne addr 0xda9a40 size 0x7c virtual false final false
  ...
  /// @brief Method WriteOneEncrypted addr 0xda9bb4 size 0x178 virtual false final false
  ...
  /// @brief Method Write addr 0xda9abc size 0xf8 virtual false final false
  inline void Write(::LiteNetLib::Utils::NetDataWriter* writer, ::LiteNetLib::Utils::INetSerializable* packet);

  /// @brief Method HandleServerPlayerConnected addr 0xda9d2c size 0xcc virtual false final false
  ...
  /// @brief Method HandlePlayerIdentityUpdate addr 0xda9f1c size 0x134 virtual false final false
  ...
  /// @brief Method InitializePlayerEncryption addr 0xdaa0ac size 0xa0 virtual false final false
  inline void InitializePlayerEncryption(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* player);

  /// @brief Method HandlePlayerStateUpdate addr 0xdaa14c size 0xc0 virtual false final false
  ...
  /// @brief Method HandlePlayerAvatarUpdate addr 0xdaa228 size 0xc8 virtual false final false
  ...
  /// @brief Method HandleServerPlayerDisconnected addr 0xdaa314 size 0xa8 virtual false final false
  ...
  /// @brief Method HandleKickPlayerPacket addr 0xdaa410 size 0xe0 virtual false final false
  ...
  /// @brief Method HandlePlayerSortOrderUpdate addr 0xdaa544 size 0x12c virtual false final false
  ...
  /// @brief Method HandleSyncTimePacket addr 0xdaa6c4 size 0x154 virtual false final false
  ...
  /// @brief Method HandlePing addr 0xdaa86c size 0x1fc virtual false final false
  ...
  /// @brief Method HandlePong addr 0xdaaacc size 0x184 virtual false final false
  ...
  /// @brief Method Log addr 0xdaacc0 size 0x8c virtual false final false
...
public:
  ...
  ::GlobalNamespace::RollingAverage* ____syncTimeOffset;
  ...
  /// @brief Field _localPlayerAvatar, offset: 0xc0, size: 0x70, def value: None
  ::GlobalNamespace::MultiplayerAvatarData ____localPlayerAvatar;

  /// @brief Field _encryptionKeys, offset: 0x130, size: 0x8, def value: None
  ::GlobalNamespace::IDiffieHellmanKeyPair* ____encryptionKeys;

  /// @brief Field _encryptionRandom, offset: 0x138, size: 0x8, def value: None
  ::ArrayW<uint8_t, ::Array<uint8_t>*> ____encryptionRandom;

  /// @brief Field _localPlayer, offset: 0x140, size: 0x8, def value: None
  ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* ____localPlayer;

  /// @brief Field _lastConnectionId, offset: 0x148, size: 0x1, def value: None
  uint8_t ____lastConnectionId;

  /// @brief Field _lastPollTime, offset: 0x14c, size: 0x4, def value: None
  float_t ____lastPollTime;

  /// @brief Field _lastPollFrame, offset: 0x150, size: 0x4, def value: None
  int32_t ____lastPollFrame;

  /// @brief Field _lastPingTime, offset: 0x154, size: 0x4, def value: None
  float_t ____lastPingTime;

  /// @brief Field _messageSerializer, offset: 0x158, size: 0x8, def value: None
  ...
  /// @brief Field kEncryptedMessageBit offset 0xffffffff size 0x1
  static constexpr uint8_t kEncryptedMessageBit{ static_cast<uint8_t>(0x80u) };
  ...
  /// @brief Field kTimeSensitiveAllowedReceiveWindow offset 0xffffffff size 0x4
  ...
  /// @brief Field kPingUpdateFrequency offset 0xffffffff size 0x4
  static constexpr float_t kPingUpdateFrequency{ 2.0 };

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::ConnectedPlayerManager, 0x160>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____localPlayerAvatar) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____encryptionKeys) == 0x130, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____encryptionRandom) == 0x138, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____localPlayer) == 0x140, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____lastConnectionId) == 0x148, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____lastPollTime) == 0x14c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____lastPollFrame) == 0x150, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____lastPingTime) == 0x154, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ConnectedPlayerManager, ____messageSerializer) == 0x158, "Offset mismatch!");
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__ConnectedPlayerManager___InitializePlayerEncryption_d__129, "", "ConnectedPlayerManager/<InitializePlayerEncryption>d__129");
