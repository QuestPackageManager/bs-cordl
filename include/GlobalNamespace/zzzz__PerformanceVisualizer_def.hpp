...
// [RequireComponent(typeof(Tayx.Graphy.GraphyManager), typeof(UnityEngine.Canvas))]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PerformanceVisualizer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PerformanceVisualizer(PerformanceVisualizer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PerformanceVisualizer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PerformanceVisualizer(PerformanceVisualizerconst&) = delete;
