...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15869), inst: 3377 }), TypeDefinitionIndex(TypeDefinitionIndex(10244)),
// TypeDefinitionIndex(TypeDefinitionIndex(15869))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15873)) CS Name: ::Vector2IntSO*
...
public:
  ...
  /// @brief Method .ctor, addr 0xe28ad8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
