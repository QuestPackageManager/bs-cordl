...
template<typename T>
inline ::GlobalNamespace::PacketPool_1<T>* GlobalNamespace::ThreadStaticPacketPool_1<T>::get_pool()  {
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::ThreadStaticPacketPool_1<T>::ThreadStaticPacketPool_1()   {
}
