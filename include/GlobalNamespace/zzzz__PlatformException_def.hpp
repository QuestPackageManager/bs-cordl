...
public:
  ...
  /// @brief Method .ctor, addr 0x28eecf0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28eecdc, size 0x14, virtual false, abstract: false, final false
