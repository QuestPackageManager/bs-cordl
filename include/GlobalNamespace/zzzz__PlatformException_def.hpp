...
public:
  ...
  /// @brief Method .ctor, addr 0x2bf3a70, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bf3a5c, size 0x14, virtual false, abstract: false, final false
