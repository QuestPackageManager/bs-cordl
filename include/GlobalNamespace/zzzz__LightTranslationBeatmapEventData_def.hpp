...
public:
  ...
  /// @brief Method ChangeTranslation, addr 0x31c69c4, size 0x8, virtual false, abstract: false, final false
  inline void ChangeTranslation(float_t translation, float_t distribution);

  /// @brief Method GetCopy, addr 0x31c69cc, size 0xac, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x31c6a78, size 0x178, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0x31c69ac, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c68d4, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_distribution, addr 0x31c68c4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distribution();

  /// @brief Method get_nextSameTypeEventData, addr 0x31c6838, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightTranslationBeatmapEventData* get_nextSameTypeEventData();

  /// @brief Method get_previousSameTypeEventData, addr 0x31c67bc, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LightTranslationBeatmapEventData* get_previousSameTypeEventData();

  /// @brief Method get_translation, addr 0x31c68b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_distribution, addr 0x31c68cc, size 0x8, virtual false, abstract: false, final false
  inline void set_distribution(float_t value);

  /// @brief Method set_translation, addr 0x31c68bc, size 0x8, virtual false, abstract: false, final false
