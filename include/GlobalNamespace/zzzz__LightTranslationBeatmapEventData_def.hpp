...
public:
  ...
  /// @brief Method ChangeTranslation, addr 0xf477dc, size 0x8, virtual false, abstract: false, final false
  inline void ChangeTranslation(float_t translation, float_t distribution);

  /// @brief Method GetCopy, addr 0xf477e4, size 0xb4, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0xf47898, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0xf477c4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf476e8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_distribution, addr 0xf476d8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distribution();

  /// @brief Method get_translation, addr 0xf476c8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_distribution, addr 0xf476e0, size 0x8, virtual false, abstract: false, final false
  inline void set_distribution(float_t value);

  /// @brief Method set_translation, addr 0xf476d0, size 0x8, virtual false, abstract: false, final false
