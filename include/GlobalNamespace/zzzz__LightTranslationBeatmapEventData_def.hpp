...
public:
  ...
  /// @brief Method ChangeTranslation, addr 0x22443ac, size 0x8, virtual false, abstract: false, final false
  inline void ChangeTranslation(float_t translation, float_t distribution);

  /// @brief Method GetCopy, addr 0x22443b4, size 0xa8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x224445c, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0x2244394, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22442b4, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_distribution, addr 0x22442a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distribution();

  /// @brief Method get_translation, addr 0x2244294, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_distribution, addr 0x22442ac, size 0x8, virtual false, abstract: false, final false
  inline void set_distribution(float_t value);

  /// @brief Method set_translation, addr 0x224429c, size 0x8, virtual false, abstract: false, final false
