...
public:
  ...
  /// @brief Method ChangeTranslation, addr 0xe6ed58, size 0x8, virtual false, abstract: false, final false
  inline void ChangeTranslation(float_t translation, float_t distribution);

  /// @brief Method GetCopy, addr 0xe6ed60, size 0xb4, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0xe6ee14, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0xe6ed40, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6ec64, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_distribution, addr 0xe6ec54, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distribution();

  /// @brief Method get_translation, addr 0xe6ec44, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_distribution, addr 0xe6ec5c, size 0x8, virtual false, abstract: false, final false
  inline void set_distribution(float_t value);

  /// @brief Method set_translation, addr 0xe6ec4c, size 0x8, virtual false, abstract: false, final false
