...
public:
  ...
  /// @brief Method ChangeTranslation, addr 0xe55004, size 0x8, virtual false, abstract: false, final false
  inline void ChangeTranslation(float_t translation, float_t distribution);

  /// @brief Method GetCopy, addr 0xe5500c, size 0xb4, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0xe550c0, size 0x160, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0xe54fec, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe54f10, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_distribution, addr 0xe54f00, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distribution();

  /// @brief Method get_translation, addr 0xe54ef0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_distribution, addr 0xe54f08, size 0x8, virtual false, abstract: false, final false
  inline void set_distribution(float_t value);

  /// @brief Method set_translation, addr 0xe54ef8, size 0x8, virtual false, abstract: false, final false
