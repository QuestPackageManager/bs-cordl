...
DEFINE_IL2CPP_GEN_CLASS(::GlobalNamespace::OVRObjectPool_HashSetScope_1, "", "OVRObjectPool/HashSetScope`1");
...
public:
  ...
  /// @brief Method .ctor, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
  inline void _ctor(::by_ref<::System::Collections::Generic::HashSet_1<T>*> set);
