...
// Ctor Parameters [CppParam { name: "_tasks", ty: "::GlobalNamespace::OVRObjectPool_ListScope_1<::GlobalNamespace::OVRTask_1<T>>", modifiers: "", def_value: None }, CppParam { name: "_results", ty: "::GlobalNamespace::OVRObjectPool_ListScope_1<T>", modifiers: "", def_value: None }]
