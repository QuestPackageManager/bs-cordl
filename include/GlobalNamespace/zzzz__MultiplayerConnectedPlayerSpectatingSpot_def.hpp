...
public:
  ...
  /// @brief Method add_hasBeenRemovedEvent addr 0x225d31c size 0xb0 virtual true final true
  inline void add_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>* value);

  /// @brief Method remove_hasBeenRemovedEvent addr 0x225d3cc size 0xb0 virtual true final true
  inline void remove_hasBeenRemovedEvent(::System::Action_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>* value);

  /// @brief Method add_isObservedChangedEvent addr 0x225d47c size 0xb0 virtual false final false
  inline void add_isObservedChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_isObservedChangedEvent addr 0x225d52c size 0xb0 virtual false final false
  inline void remove_isObservedChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method get_observable addr 0x225d5dc size 0x8 virtual true final true
  inline ::GlobalNamespace::IMultiplayerObservable* get_observable();

  /// @brief Method set_observable addr 0x225d5e4 size 0x8 virtual false final false
  inline void set_observable(::GlobalNamespace::IMultiplayerObservable* value);

  /// @brief Method get_spotName addr 0x225d5ec size 0xa4 virtual true final true
  inline ::StringW get_spotName();

  /// @brief Method get_isMain addr 0x225d690 size 0x8 virtual true final true
  inline bool get_isMain();

  /// @brief Method Start addr 0x225d698 size 0x1f4 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x225d9f0 size 0x1a4 virtual false final false
  inline void OnDestroy();

  /// @brief Method SetIsObserved addr 0x225db94 size 0x20 virtual true final true
  inline void SetIsObserved(bool isObserved);

  /// @brief Method ReloadBasedOnPlayerCurrentState addr 0x225dbb4 size 0x174 virtual false final false
  inline void ReloadBasedOnPlayerCurrentState(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method HandlePlayerStateChanged addr 0x225dd28 size 0x4 virtual false final false
  inline void HandlePlayerStateChanged(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method HandlePlayerDisconnected addr 0x225dd2c size 0x4 virtual false final false
  ...
  /// @brief Method .ctor addr 0x225dd30 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method IMultiplayerSpectatingSpot.get_transform addr 0x225dd38 size 0x8 virtual true final true
