...
/// @brief Method MoveNext, addr 0x5d4307c, size 0x274, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5d432f0, size 0x3c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::GlobalNamespace::OVRTaskBuilder_1<::GlobalNamespace::OVRPlugin_Result>", modifiers: "", def_value: None }, CppParam { name: "future", ty: "uint64_t", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::YieldAwaitable_YieldAwaiter", modifiers: "", def_value: None }]
constexpr OVRFuture__When_d__0(int32_t  __1__state, ::GlobalNamespace::OVRTaskBuilder_1<::GlobalNamespace::OVRPlugin_Result>  __t__builder, uint64_t  future, ::System::Threading::CancellationToken  cancellationToken, ::System::Runtime::CompilerServices::YieldAwaitable_YieldAwaiter  __u__1) noexcept;
...
/// @brief Method When, addr 0x5d42ce0, size 0xc4, virtual false, abstract: false, final false
...
/// @brief Method <When>g__CheckCancellationAndThrow|0_1, addr 0x5d42eb0, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method <When>g__LogIfNotSuccess|0_0, addr 0x5d42da4, size 0x10c, virtual false, abstract: false, final false
