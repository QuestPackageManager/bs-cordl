...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CustomLevelPathHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CustomLevelPathHelper(CustomLevelPathHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CustomLevelPathHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CustomLevelPathHelper(CustomLevelPathHelperconst&) = delete;
