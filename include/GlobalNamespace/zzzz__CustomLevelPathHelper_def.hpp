...
public:
// Declarations
/// @brief Method IsHiddenDirectory, addr 0x3648bc8, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3648c84, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
