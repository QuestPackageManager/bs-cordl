...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnityPlayerLoopMarker_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnityPlayerLoopMarker_1(UnityPlayerLoopMarker_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnityPlayerLoopMarker_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnityPlayerLoopMarker_1(UnityPlayerLoopMarker_1const&) = delete;
