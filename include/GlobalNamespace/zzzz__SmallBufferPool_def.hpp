...
public:
  ...
  /// @brief Method GetBuffer, addr 0x326df68, size 0x2b0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetBuffer(int32_t length);

  static inline ::GlobalNamespace::SmallBufferPool* New_ctor();

  /// @brief Method ReleaseBuffer, addr 0x328175c, size 0x4, virtual false, abstract: false, final false
  inline void ReleaseBuffer(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer);

  /// @brief Method ReleaseBuffer, addr 0x326df4c, size 0x1c, virtual false, abstract: false, final false
  inline void ReleaseBuffer(::ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> buffer);

  /// @brief Method ReleaseBufferInternal, addr 0x3281760, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3281930, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
