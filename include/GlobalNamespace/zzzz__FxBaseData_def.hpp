...
// Write type traits
MARK_REF_T(::GlobalNamespace::FxBaseData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FxBaseData*, "", "FxBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x371948c, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FxBaseData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FxBaseData(FxBaseData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FxBaseData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FxBaseData(FxBaseDataconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::FxBaseData) == 0x18, "Size mismatch!");
