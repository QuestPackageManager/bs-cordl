...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CustomBeatmapLevelCollection::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::CustomBeatmapLevelCollection*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
constexpr ::GlobalNamespace::IBeatmapLevelCollection* GlobalNamespace::CustomBeatmapLevelCollection::i___GlobalNamespace__IBeatmapLevelCollection() noexcept {
  return static_cast<::GlobalNamespace::IBeatmapLevelCollection*>(static_cast<void*>(this));
}
constexpr ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::CustomPreviewBeatmapLevel*>*&
GlobalNamespace::CustomBeatmapLevelCollection::__cordl_internal_get__customPreviewBeatmapLevels() {
...
GlobalNamespace::CustomBeatmapLevelCollection::__cordl_internal_get__customPreviewBeatmapLevels() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____customPreviewBeatmapLevels;
}
constexpr void
GlobalNamespace::CustomBeatmapLevelCollection::__cordl_internal_set__customPreviewBeatmapLevels(::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::CustomPreviewBeatmapLevel*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::CustomBeatmapLevelCollection::New_ctor(::ArrayW<::GlobalNamespace::CustomPreviewBeatmapLevel*, ::Array<::GlobalNamespace::CustomPreviewBeatmapLevel*>*> customPreviewBeatmapLevels) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::CustomBeatmapLevelCollection*>(customPreviewBeatmapLevels));
}
inline void
