...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::ReferenceCountingCache_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::ReferenceCountingCache_2, "", "ReferenceCountingCache`2");
