...
public:
  ...
  /// @brief Method <.ctor>b__3_0, addr 0x13b2540, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__3_0(::Oculus::Platform::Message_1<::Oculus::Platform::Models::LeaderboardEntryList*>* _);

  /// @brief Method .ctor, addr 0x13b2538, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddOculusRequest>b__0, addr 0x13b2544, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13b1f7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetScores>g__Callback|0, addr 0x13b25a8, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13b2290, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UploadScore>b__0, addr 0x13b2900, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13b24cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddOculusRequest, addr 0x13b1e90, size 0xec, virtual false, abstract: false, final false
  inline void AddOculusRequest(::Oculus::Platform::Request* oculusRequest, ::GlobalNamespace::HMAsyncRequest* asyncRequest);

  /// @brief Method CheckMessageForValidRequest, addr 0x13b1f84, size 0x98, virtual false, abstract: false, final false
  inline bool CheckMessageForValidRequest(::Oculus::Platform::Message* message);

  /// @brief Method GetScores, addr 0x13b201c, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method UploadScore, addr 0x13b2298, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13b1d68, size 0x120, virtual false, abstract: false, final false
  inline void _ctor();
