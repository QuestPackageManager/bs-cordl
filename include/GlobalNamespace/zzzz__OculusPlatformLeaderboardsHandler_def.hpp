...
public:
  ...
  /// @brief Method <.ctor>b__3_0, addr 0x14a7c1c, size 0x4, virtual false, abstract: false, final false
  inline void __ctor_b__3_0(::Oculus::Platform::Message_1<::Oculus::Platform::Models::LeaderboardEntryList*>* _);

  /// @brief Method .ctor, addr 0x14a7c14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddOculusRequest>b__0, addr 0x14a7c20, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14a7658, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetScores>g__Callback|0, addr 0x14a7c84, size 0x358, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14a796c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UploadScore>b__0, addr 0x14a7fdc, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14a7ba8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddOculusRequest, addr 0x14a756c, size 0xec, virtual false, abstract: false, final false
  inline void AddOculusRequest(::Oculus::Platform::Request* oculusRequest, ::GlobalNamespace::HMAsyncRequest* asyncRequest);

  /// @brief Method CheckMessageForValidRequest, addr 0x14a7660, size 0x98, virtual false, abstract: false, final false
  inline bool CheckMessageForValidRequest(::Oculus::Platform::Message* message);

  /// @brief Method GetScores, addr 0x14a76f8, size 0x274, virtual true, abstract: false, final false
  ...
  /// @brief Method UploadScore, addr 0x14a7974, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14a7444, size 0x120, virtual false, abstract: false, final false
  inline void _ctor();
