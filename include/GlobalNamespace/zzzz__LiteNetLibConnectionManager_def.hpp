...
public:
  ...
  /// @brief Method .ctor, addr 0x22d26e0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d26f0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d2700, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d2710, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Accept, addr 0x22d27a0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d275c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::ConnectionRequest* request, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method get_endPoint, addr 0x22d2740, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Net::IPEndPoint* get_endPoint();

  /// @brief Method get_isConnectionOwner, addr 0x22d2738, size 0x8, virtual false, abstract: false, final false
  inline bool get_isConnectionOwner();

  /// @brief Method get_userId, addr 0x22d2728, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x22d2730, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Disconnect, addr 0x22d2a04, size 0x1c, virtual true, abstract: false, final true
  inline void Disconnect();

  /// @brief Method Equals, addr 0x22d28cc, size 0x118, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x22d28a0, size 0x2c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::LiteNetLibConnectionManager_NetPeerConnection* other);

  /// @brief Method GetHashCode, addr 0x22d29e4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Send, addr 0x22d2818, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22d27d4, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* netPeer, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method get_isConnectionOwner, addr 0x22d27cc, size 0x8, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_userId, addr 0x22d27bc, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x22d27c4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d2a7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_hasConnectionOwner>b__70_0, addr 0x22d2a84, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22d2a9c, size 0x428, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22d2ec4, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22d2f2c, size 0x42c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22d3358, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AcceptAllPendingRequests, addr 0x22d1d1c, size 0xe8, virtual false, abstract: false, final false
  inline void AcceptAllPendingRequests();

  /// @brief Method BackgroundDisconnectSentry, addr 0x22d1e50, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BackgroundDisconnectSentry();

  /// @brief Method BackgroundShutdownSentry, addr 0x22d1f14, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BackgroundShutdownSentry();

  /// @brief Method CheckSentryState, addr 0x22d0644, size 0x50, virtual false, abstract: false, final false
  inline void CheckSentryState();

  /// @brief Method ConnectToEndPoint, addr 0x22d0950, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePendingConnection, addr 0x22d0b34, size 0x128, virtual false, abstract: false, final false
  inline void CreatePendingConnection(::LiteNetLib::NetPeer* peer, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method Disconnect, addr 0x22d0e38, size 0x8, virtual true, abstract: false, final true
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method DisconnectInternal, addr 0x22d0e40, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x22d0c5c, size 0x24, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x22d0cc0, size 0x178, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* DisposeAsync();

  /// @brief Method DisposeInternal, addr 0x22d0c80, size 0x40, virtual false, abstract: false, final false
  inline void DisposeInternal();

  /// @brief Method FromLiteNetDeliveryMethod, addr 0x22d1cd0, size 0x10, virtual false, abstract: false, final false
  static inline ::BGNet::Core::DeliveryMethod FromLiteNetDeliveryMethod(::LiteNetLib::DeliveryMethod deliveryMethod);

  /// @brief Method GetConnection, addr 0x22d11e8, size 0x58, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IConnection* GetConnection(int32_t index);

  /// @brief Method GetConnection, addr 0x22d1c0c, size 0xc4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LiteNetLibConnectionManager_NetPeerConnection* GetConnection(::LiteNetLib::NetPeer* peer);

  /// @brief Method GetConnectionMessage, addr 0x22d0a40, size 0xf4, virtual false, abstract: false, final false
  inline ::LiteNetLib::Utils::NetDataWriter* GetConnectionMessage();

  /// @brief Method GetLogFormatConnection, addr 0x22d20f0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLogFormatUserInfo, addr 0x22d2160, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW GetLogFormatUserInfo(::StringW userName, ::StringW userId, ::System::Net::IPEndPoint* ipEndPoint);

  /// @brief Method HasConnectionToEndPoint, addr 0x22d12ec, size 0xb4, virtual false, abstract: false, final false
  inline bool HasConnectionToEndPoint(::System::Net::IPEndPoint* endPoint);

  /// @brief Method HasPendingConnectionToEndPoint, addr 0x22d13a0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsConnectedToUser, addr 0x22d1240, size 0xac, virtual false, abstract: false, final false
  inline bool IsConnectedToUser(::StringW userId);

  /// @brief Method LiteNetLib.INetEventListener.OnConnectionRequest, addr 0x22d1690, size 0x150, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnConnectionRequest(::LiteNetLib::ConnectionRequest* request);

  /// @brief Method LiteNetLib.INetEventListener.OnNetworkError, addr 0x22d1670, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnNetworkLatencyUpdate, addr 0x22d168c, size 0x4, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnNetworkLatencyUpdate(::LiteNetLib::NetPeer* peer, int32_t latencyMs);

  /// @brief Method LiteNetLib.INetEventListener.OnNetworkReceive, addr 0x22d1b44, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnNetworkReceiveUnconnected, addr 0x22d1ce0, size 0x3c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnPeerConnected, addr 0x22d1454, size 0x21c, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnPeerConnected(::LiteNetLib::NetPeer* peer);

  /// @brief Method LiteNetLib.INetEventListener.OnPeerDisconnected, addr 0x22d1900, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method Log, addr 0x22d1fd8, size 0x8c, virtual false, abstract: false, final false
  inline void Log(::StringW msg);

  /// @brief Method LogError, addr 0x22d2064, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x22d0060, size 0x80, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  /// @brief Method PollUpdate, addr 0x22d05a8, size 0x9c, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method RemoveConnection, addr 0x22d1958, size 0x1ec, virtual false, abstract: false, final false
  inline void RemoveConnection(::LiteNetLib::NetPeer* netPeer, ::LiteNetLib::DisconnectReason reason);

  /// @brief Method SendToAll, addr 0x22d03f4, size 0x8c, virtual true, abstract: false, final true
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x22d0498, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method SendUnconnectedMessage, addr 0x22d0580, size 0x28, virtual false, abstract: false, final false
  inline void SendUnconnectedMessage(::System::Net::IPEndPoint* remoteEndPoint, ::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method StartBackgroundSentry, addr 0x22d0f9c, size 0x24c, virtual false, abstract: false, final false
  inline void StartBackgroundSentry();

  /// @brief Method ToConnectionFailedReason, addr 0x22d1e3c, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ConnectionFailedReason ToConnectionFailedReason(::LiteNetLib::DisconnectReason disconnectReason);

  /// @brief Method ToDisconnectedReason, addr 0x22d1e04, size 0x38, virtual false, abstract: false, final false
  inline ::GlobalNamespace::DisconnectedReason ToDisconnectedReason(::LiteNetLib::DisconnectReason disconnectReason);

  /// @brief Method ToLiteNetDeliveryMethod, addr 0x22d0480, size 0x18, virtual false, abstract: false, final false
  static inline ::LiteNetLib::DeliveryMethod ToLiteNetDeliveryMethod(::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method TryAccept, addr 0x22d17e0, size 0x54, virtual false, abstract: false, final false
  inline void TryAccept(::LiteNetLib::ConnectionRequest* request, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method TryDisconnect, addr 0x22d1834, size 0xcc, virtual false, abstract: false, final false
  inline void TryDisconnect(::LiteNetLib::DisconnectReason reason);

  /// @brief Method TryStartNetManager, addr 0x22d0f04, size 0x98, virtual false, abstract: false, final false
  inline bool TryStartNetManager(int32_t port, bool enableBackgroundSentry);

  /// @brief Method UpdateStatistics, addr 0x22d0694, size 0x2bc, virtual false, abstract: false, final false
  inline void UpdateStatistics();

  /// @brief Method <DisposeAsync>b__98_0, addr 0x22d21bc, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d0160, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x22d01f8, size 0x1fc, virtual false, abstract: false, final false
  inline void _ctor(::BGNet::Core::ITimeProvider* timeProvider, ::BGNet::Core::ITaskUtility* taskUtility);

  /// @brief Method add_onConnectedEvent, addr 0x22cf3ac, size 0x9c, virtual true, abstract: false, final true
  inline void add_onConnectedEvent(::System::Action* value);

  /// @brief Method add_onConnectionConnectedEvent, addr 0x22cf7a4, size 0xb0, virtual true, abstract: false, final true
  inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method add_onConnectionDisconnectedEvent, addr 0x22cf904, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onConnectionFailedEvent, addr 0x22cf644, size 0xb0, virtual true, abstract: false, final true
  inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_onDisconnectedEvent, addr 0x22cf4e4, size 0xb0, virtual true, abstract: false, final true
  inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_onInitializedEvent, addr 0x22cf274, size 0x9c, virtual true, abstract: false, final true
  inline void add_onInitializedEvent(::System::Action* value);

  /// @brief Method add_onReceiveUnconnectedDataEvent, addr 0x22cfbc4, size 0xb0, virtual false, abstract: false, final false
  inline void add_onReceiveUnconnectedDataEvent(::System::Action_2<::System::Net::IPEndPoint*, ::LiteNetLib::Utils::NetDataReader*>* value);

  /// @brief Method add_onReceivedDataEvent, addr 0x22cfa64, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onStatisticsUpdatedEvent, addr 0x22cfd24, size 0x9c, virtual false, abstract: false, final false
  inline void add_onStatisticsUpdatedEvent(::GlobalNamespace::NetworkStatisticsState_NetworkStatisticsUpdateDelegate* value);

  /// @brief Method get_connectionCount, addr 0x22cffe4, size 0x48, virtual true, abstract: false, final true
  inline int32_t get_connectionCount();

  /// @brief Method get_connectionRequestHandler, addr 0x22d002c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IConnectionRequestHandler* get_connectionRequestHandler();

  /// @brief Method get_encryptionLayer, addr 0x22d0058, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PacketEncryptionLayer* get_encryptionLayer();

  /// @brief Method get_hasConnectionOwner, addr 0x22cfeac, size 0x108, virtual false, abstract: false, final false
  inline bool get_hasConnectionOwner();

  /// @brief Method get_isClient, addr 0x22cffc4, size 0x10, virtual false, abstract: false, final false
  inline bool get_isClient();

  /// @brief Method get_isConnected, addr 0x22cfe6c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting, addr 0x22cfe7c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnecting();

  /// @brief Method get_isConnectionOwner, addr 0x22cfe9c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isDisconnecting, addr 0x22cfe8c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisconnecting();

  /// @brief Method get_isDisposed, addr 0x22cffd4, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisposed();

  /// @brief Method get_isServer, addr 0x22cffb4, size 0x10, virtual false, abstract: false, final false
  inline bool get_isServer();

  /// @brief Method get_port, addr 0x22d0034, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_port();

  /// @brief Method get_unconnectedPacketHeader, addr 0x22d0050, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_unconnectedPacketHeader();

  /// @brief Method get_userId, addr 0x22cfe5c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x22cfe64, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();
  ...
  /// @brief Method remove_onConnectedEvent, addr 0x22cf448, size 0x9c, virtual true, abstract: false, final true
  inline void remove_onConnectedEvent(::System::Action* value);

  /// @brief Method remove_onConnectionConnectedEvent, addr 0x22cf854, size 0xb0, virtual true, abstract: false, final true
  inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method remove_onConnectionDisconnectedEvent, addr 0x22cf9b4, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectionFailedEvent, addr 0x22cf6f4, size 0xb0, virtual true, abstract: false, final true
  inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_onDisconnectedEvent, addr 0x22cf594, size 0xb0, virtual true, abstract: false, final true
  inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_onInitializedEvent, addr 0x22cf310, size 0x9c, virtual true, abstract: false, final true
  inline void remove_onInitializedEvent(::System::Action* value);

  /// @brief Method remove_onReceiveUnconnectedDataEvent, addr 0x22cfc74, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onReceivedDataEvent, addr 0x22cfb14, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onStatisticsUpdatedEvent, addr 0x22cfdc0, size 0x9c, virtual false, abstract: false, final false
