...
public:
  ...
  /// @brief Method .ctor, addr 0x327a8a4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x327a8b0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x327a8bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x327a8c8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Accept, addr 0x327a494, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x327a914, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_compatibilityVersion, addr 0x327a90c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_endPoint, addr 0x327a8f4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Net::IPEndPoint* get_endPoint();

  /// @brief Method get_isConnectionOwner, addr 0x327a8ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_isConnectionOwner();

  /// @brief Method get_userId, addr 0x327a8dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x327a8e4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Disconnect, addr 0x3279954, size 0x18, virtual true, abstract: false, final true
  inline void Disconnect();

  /// @brief Method Equals, addr 0x327aa1c, size 0x114, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x327a9d4, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::LiteNetLibConnectionManager_NetPeerConnection* other);

  /// @brief Method GetHashCode, addr 0x327ab30, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Send, addr 0x327a944, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x327a4ac, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_compatibilityVersion, addr 0x327a93c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_isConnectionOwner, addr 0x327a934, size 0x8, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_userId, addr 0x327a924, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x327a92c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();
...
public:
  ...
  /// @brief Method .ctor, addr 0x327aba0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_hasConnectionOwner>b__71_0, addr 0x327aba4, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x327abb8, size 0x458, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x327b010, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x327b07c, size 0x454, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x327b4d0, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AcceptAllPendingRequests, addr 0x327a38c, size 0x108, virtual false, abstract: false, final false
  inline void AcceptAllPendingRequests();

  /// @brief Method BackgroundDisconnectSentry, addr 0x327a508, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BackgroundDisconnectSentry();

  /// @brief Method BackgroundShutdownSentry, addr 0x327a5bc, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BackgroundShutdownSentry();

  /// @brief Method CheckSentryState, addr 0x3278444, size 0x4c, virtual false, abstract: false, final false
  inline void CheckSentryState();

  /// @brief Method ConnectToEndPoint, addr 0x3278764, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePendingConnection, addr 0x3278930, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method Disconnect, addr 0x3278cb8, size 0x8, virtual true, abstract: false, final true
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method DisconnectInternal, addr 0x3278e68, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x3278a64, size 0x24, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x3278ad8, size 0x1e0, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method DisposeInternal, addr 0x3278a88, size 0x50, virtual false, abstract: false, final false
  inline void DisposeInternal();

  /// @brief Method FromLiteNetDeliveryMethod, addr 0x327a340, size 0x10, virtual false, abstract: false, final false
  static inline ::BGNet::Core::DeliveryMethod FromLiteNetDeliveryMethod(::LiteNetLib::DeliveryMethod deliveryMethod);

  /// @brief Method GetConnection, addr 0x3279478, size 0x64, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IConnection* GetConnection(int32_t index);

  /// @brief Method GetConnection, addr 0x327a274, size 0xcc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LiteNetLibConnectionManager_NetPeerConnection* GetConnection(::LiteNetLib::NetPeer* peer);

  /// @brief Method GetConnectionMessage, addr 0x3278820, size 0x110, virtual false, abstract: false, final false
  inline ::LiteNetLib::Utils::NetDataWriter* GetConnectionMessage();

  /// @brief Method GetLogFormatConnection, addr 0x327a788, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLogFormatUserInfo, addr 0x327a7fc, size 0x90, virtual false, abstract: false, final false
  static inline ::StringW GetLogFormatUserInfo(::StringW userName, ::StringW userId, ::System::Net::IPEndPoint* ipEndPoint);

  /// @brief Method HasConnectionToEndPoint, addr 0x3279590, size 0xd4, virtual false, abstract: false, final false
  inline bool HasConnectionToEndPoint(::System::Net::IPEndPoint* endPoint);

  /// @brief Method HasPendingConnectionToEndPoint, addr 0x3279664, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsConnectedToUser, addr 0x32794dc, size 0xb4, virtual false, abstract: false, final false
  inline bool IsConnectedToUser(::StringW userId);

  /// @brief Method LiteNetLib.INetEventListener.OnConnectionRequest, addr 0x327998c, size 0x194, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnConnectionRequest(::LiteNetLib::ConnectionRequest* request);

  /// @brief Method LiteNetLib.INetEventListener.OnNetworkError, addr 0x327996c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnNetworkLatencyUpdate, addr 0x3279988, size 0x4, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnNetworkLatencyUpdate(::LiteNetLib::NetPeer* peer, int32_t latencyMs);

  /// @brief Method LiteNetLib.INetEventListener.OnNetworkReceive, addr 0x327a1a0, size 0xd4, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnNetworkReceiveUnconnected, addr 0x327a350, size 0x3c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnPeerConnected, addr 0x3279738, size 0x21c, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnPeerConnected(::LiteNetLib::NetPeer* peer);

  /// @brief Method LiteNetLib.INetEventListener.OnPeerDisconnected, addr 0x3279c50, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method Log, addr 0x327a670, size 0x8c, virtual false, abstract: false, final false
  inline void Log(::StringW msg);

  /// @brief Method LogError, addr 0x327a6fc, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x3277d2c, size 0x84, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  /// @brief Method PollUpdate, addr 0x32783a8, size 0x9c, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method RemoveConnection, addr 0x3279f9c, size 0x204, virtual false, abstract: false, final false
  inline void RemoveConnection(::LiteNetLib::NetPeer* netPeer, ::LiteNetLib::DisconnectReason reason);

  /// @brief Method SendToAll, addr 0x32781ec, size 0x90, virtual true, abstract: false, final true
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x3278294, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method SendUnconnectedMessage, addr 0x3278384, size 0x24, virtual false, abstract: false, final false
  inline void SendUnconnectedMessage(::System::Net::IPEndPoint* remoteEndPoint, ::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method StartBackgroundSentry, addr 0x3278fd4, size 0x2c4, virtual false, abstract: false, final false
  inline void StartBackgroundSentry();

  /// @brief Method ToConnectionFailedReason, addr 0x327a4f4, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ConnectionFailedReason ToConnectionFailedReason(::LiteNetLib::DisconnectReason disconnectReason);

  /// @brief Method ToDisconnectedReason, addr 0x327a4bc, size 0x38, virtual false, abstract: false, final false
  inline ::GlobalNamespace::DisconnectedReason ToDisconnectedReason(::LiteNetLib::DisconnectReason disconnectReason);

  /// @brief Method ToLiteNetDeliveryMethod, addr 0x327827c, size 0x18, virtual false, abstract: false, final false
  static inline ::LiteNetLib::DeliveryMethod ToLiteNetDeliveryMethod(::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method TryAccept, addr 0x3279b20, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryDisconnect, addr 0x3279b7c, size 0xd4, virtual false, abstract: false, final false
  inline void TryDisconnect(::LiteNetLib::DisconnectReason reason);

  /// @brief Method TryStartNetManager, addr 0x3278f34, size 0xa0, virtual false, abstract: false, final false
  inline bool TryStartNetManager(int32_t port, bool enableBackgroundSentry);

  /// @brief Method UpdateStatistics, addr 0x3278490, size 0x2d4, virtual false, abstract: false, final false
  inline void UpdateStatistics();

  /// @brief Method <DisposeAsync>b__101_0, addr 0x327a88c, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3277e38, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3277ed8, size 0x204, virtual false, abstract: false, final false
  inline void _ctor(::BGNet::Core::ITimeProvider* timeProvider, ::BGNet::Core::ITaskUtility* taskUtility);

  /// @brief Method add_onConnectedEvent, addr 0x3276f50, size 0xac, virtual true, abstract: false, final true
  inline void add_onConnectedEvent(::System::Action* value);

  /// @brief Method add_onConnectionConnectedEvent, addr 0x32773a8, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method add_onConnectionDisconnectedEvent, addr 0x3277528, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onConnectionFailedEvent, addr 0x3277228, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_onDisconnectedEvent, addr 0x32770a8, size 0xc0, virtual true, abstract: false, final true
  inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_onInitializedEvent, addr 0x3276df8, size 0xac, virtual true, abstract: false, final true
  inline void add_onInitializedEvent(::System::Action* value);

  /// @brief Method add_onReceiveUnconnectedDataEvent, addr 0x3277828, size 0xc0, virtual false, abstract: false, final false
  inline void add_onReceiveUnconnectedDataEvent(::System::Action_2<::System::Net::IPEndPoint*, ::LiteNetLib::Utils::NetDataReader*>* value);

  /// @brief Method add_onReceivedDataEvent, addr 0x32776a8, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onStatisticsUpdatedEvent, addr 0x32779a8, size 0xac, virtual false, abstract: false, final false
  inline void add_onStatisticsUpdatedEvent(::GlobalNamespace::NetworkStatisticsState_NetworkStatisticsUpdateDelegate* value);

  /// @brief Method get_compatibilityVersion, addr 0x3277d24, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_connectionCount, addr 0x3277c98, size 0x50, virtual true, abstract: false, final true
  inline int32_t get_connectionCount();

  /// @brief Method get_connectionRequestHandler, addr 0x3277ce8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IConnectionRequestHandler* get_connectionRequestHandler();

  /// @brief Method get_encryptionLayer, addr 0x3277d1c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PacketEncryptionLayer* get_encryptionLayer();

  /// @brief Method get_hasConnectionOwner, addr 0x3277b50, size 0x118, virtual false, abstract: false, final false
  inline bool get_hasConnectionOwner();

  /// @brief Method get_isClient, addr 0x3277c78, size 0x10, virtual false, abstract: false, final false
  inline bool get_isClient();

  /// @brief Method get_isConnected, addr 0x3277b10, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting, addr 0x3277b20, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnecting();

  /// @brief Method get_isConnectionOwner, addr 0x3277b40, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isDisconnecting, addr 0x3277b30, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisconnecting();

  /// @brief Method get_isDisposed, addr 0x3277c88, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisposed();

  /// @brief Method get_isServer, addr 0x3277c68, size 0x10, virtual false, abstract: false, final false
  inline bool get_isServer();

  /// @brief Method get_port, addr 0x3277cf0, size 0x24, virtual false, abstract: false, final false
  inline int32_t get_port();

  /// @brief Method get_unconnectedPacketHeader, addr 0x3277d14, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_unconnectedPacketHeader();

  /// @brief Method get_userId, addr 0x3277b00, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x3277b08, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();
  ...
  /// @brief Method remove_onConnectedEvent, addr 0x3276ffc, size 0xac, virtual true, abstract: false, final true
  inline void remove_onConnectedEvent(::System::Action* value);

  /// @brief Method remove_onConnectionConnectedEvent, addr 0x3277468, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method remove_onConnectionDisconnectedEvent, addr 0x32775e8, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectionFailedEvent, addr 0x32772e8, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_onDisconnectedEvent, addr 0x3277168, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_onInitializedEvent, addr 0x3276ea4, size 0xac, virtual true, abstract: false, final true
  inline void remove_onInitializedEvent(::System::Action* value);

  /// @brief Method remove_onReceiveUnconnectedDataEvent, addr 0x32778e8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onReceivedDataEvent, addr 0x3277768, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onStatisticsUpdatedEvent, addr 0x3277a54, size 0xac, virtual false, abstract: false, final false
