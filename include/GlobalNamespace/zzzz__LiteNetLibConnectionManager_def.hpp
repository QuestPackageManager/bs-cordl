...
public:
  ...
  /// @brief Method .ctor, addr 0x22d6ae0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d6af0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d6b00, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d6b10, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Accept, addr 0x22d6ba0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d6b5c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::ConnectionRequest* request, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method get_endPoint, addr 0x22d6b40, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Net::IPEndPoint* get_endPoint();

  /// @brief Method get_isConnectionOwner, addr 0x22d6b38, size 0x8, virtual false, abstract: false, final false
  inline bool get_isConnectionOwner();

  /// @brief Method get_userId, addr 0x22d6b28, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x22d6b30, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Disconnect, addr 0x22d6e04, size 0x1c, virtual true, abstract: false, final true
  inline void Disconnect();

  /// @brief Method Equals, addr 0x22d6ccc, size 0x118, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x22d6ca0, size 0x2c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::LiteNetLibConnectionManager_NetPeerConnection* other);

  /// @brief Method GetHashCode, addr 0x22d6de4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Send, addr 0x22d6c18, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22d6bd4, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::NetPeer* netPeer, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method get_isConnectionOwner, addr 0x22d6bcc, size 0x8, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_userId, addr 0x22d6bbc, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x22d6bc4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();
...
public:
  ...
  /// @brief Method .ctor, addr 0x22d6e7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_hasConnectionOwner>b__70_0, addr 0x22d6e84, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22d6e9c, size 0x428, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22d72c4, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22d732c, size 0x42c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22d7758, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AcceptAllPendingRequests, addr 0x22d611c, size 0xe8, virtual false, abstract: false, final false
  inline void AcceptAllPendingRequests();

  /// @brief Method BackgroundDisconnectSentry, addr 0x22d6250, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BackgroundDisconnectSentry();

  /// @brief Method BackgroundShutdownSentry, addr 0x22d6314, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* BackgroundShutdownSentry();

  /// @brief Method CheckSentryState, addr 0x22d4a44, size 0x50, virtual false, abstract: false, final false
  inline void CheckSentryState();

  /// @brief Method ConnectToEndPoint, addr 0x22d4d50, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePendingConnection, addr 0x22d4f34, size 0x128, virtual false, abstract: false, final false
  inline void CreatePendingConnection(::LiteNetLib::NetPeer* peer, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method Disconnect, addr 0x22d5238, size 0x8, virtual true, abstract: false, final true
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method DisconnectInternal, addr 0x22d5240, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x22d505c, size 0x24, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x22d50c0, size 0x178, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* DisposeAsync();

  /// @brief Method DisposeInternal, addr 0x22d5080, size 0x40, virtual false, abstract: false, final false
  inline void DisposeInternal();

  /// @brief Method FromLiteNetDeliveryMethod, addr 0x22d60d0, size 0x10, virtual false, abstract: false, final false
  static inline ::BGNet::Core::DeliveryMethod FromLiteNetDeliveryMethod(::LiteNetLib::DeliveryMethod deliveryMethod);

  /// @brief Method GetConnection, addr 0x22d55e8, size 0x58, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IConnection* GetConnection(int32_t index);

  /// @brief Method GetConnection, addr 0x22d600c, size 0xc4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LiteNetLibConnectionManager_NetPeerConnection* GetConnection(::LiteNetLib::NetPeer* peer);

  /// @brief Method GetConnectionMessage, addr 0x22d4e40, size 0xf4, virtual false, abstract: false, final false
  inline ::LiteNetLib::Utils::NetDataWriter* GetConnectionMessage();

  /// @brief Method GetLogFormatConnection, addr 0x22d64f0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLogFormatUserInfo, addr 0x22d6560, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW GetLogFormatUserInfo(::StringW userName, ::StringW userId, ::System::Net::IPEndPoint* ipEndPoint);

  /// @brief Method HasConnectionToEndPoint, addr 0x22d56ec, size 0xb4, virtual false, abstract: false, final false
  inline bool HasConnectionToEndPoint(::System::Net::IPEndPoint* endPoint);

  /// @brief Method HasPendingConnectionToEndPoint, addr 0x22d57a0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsConnectedToUser, addr 0x22d5640, size 0xac, virtual false, abstract: false, final false
  inline bool IsConnectedToUser(::StringW userId);

  /// @brief Method LiteNetLib.INetEventListener.OnConnectionRequest, addr 0x22d5a90, size 0x150, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnConnectionRequest(::LiteNetLib::ConnectionRequest* request);

  /// @brief Method LiteNetLib.INetEventListener.OnNetworkError, addr 0x22d5a70, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnNetworkLatencyUpdate, addr 0x22d5a8c, size 0x4, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnNetworkLatencyUpdate(::LiteNetLib::NetPeer* peer, int32_t latencyMs);

  /// @brief Method LiteNetLib.INetEventListener.OnNetworkReceive, addr 0x22d5f44, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnNetworkReceiveUnconnected, addr 0x22d60e0, size 0x3c, virtual true, abstract: false, final true
  ...
  /// @brief Method LiteNetLib.INetEventListener.OnPeerConnected, addr 0x22d5854, size 0x21c, virtual true, abstract: false, final true
  inline void LiteNetLib_INetEventListener_OnPeerConnected(::LiteNetLib::NetPeer* peer);

  /// @brief Method LiteNetLib.INetEventListener.OnPeerDisconnected, addr 0x22d5d00, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method Log, addr 0x22d63d8, size 0x8c, virtual false, abstract: false, final false
  inline void Log(::StringW msg);

  /// @brief Method LogError, addr 0x22d6464, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x22d4460, size 0x80, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  /// @brief Method PollUpdate, addr 0x22d49a8, size 0x9c, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method RemoveConnection, addr 0x22d5d58, size 0x1ec, virtual false, abstract: false, final false
  inline void RemoveConnection(::LiteNetLib::NetPeer* netPeer, ::LiteNetLib::DisconnectReason reason);

  /// @brief Method SendToAll, addr 0x22d47f4, size 0x8c, virtual true, abstract: false, final true
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x22d4898, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method SendUnconnectedMessage, addr 0x22d4980, size 0x28, virtual false, abstract: false, final false
  inline void SendUnconnectedMessage(::System::Net::IPEndPoint* remoteEndPoint, ::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method StartBackgroundSentry, addr 0x22d539c, size 0x24c, virtual false, abstract: false, final false
  inline void StartBackgroundSentry();

  /// @brief Method ToConnectionFailedReason, addr 0x22d623c, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ConnectionFailedReason ToConnectionFailedReason(::LiteNetLib::DisconnectReason disconnectReason);

  /// @brief Method ToDisconnectedReason, addr 0x22d6204, size 0x38, virtual false, abstract: false, final false
  inline ::GlobalNamespace::DisconnectedReason ToDisconnectedReason(::LiteNetLib::DisconnectReason disconnectReason);

  /// @brief Method ToLiteNetDeliveryMethod, addr 0x22d4880, size 0x18, virtual false, abstract: false, final false
  static inline ::LiteNetLib::DeliveryMethod ToLiteNetDeliveryMethod(::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method TryAccept, addr 0x22d5be0, size 0x54, virtual false, abstract: false, final false
  inline void TryAccept(::LiteNetLib::ConnectionRequest* request, ::StringW userId, ::StringW userName, bool isConnectionOwner);

  /// @brief Method TryDisconnect, addr 0x22d5c34, size 0xcc, virtual false, abstract: false, final false
  inline void TryDisconnect(::LiteNetLib::DisconnectReason reason);

  /// @brief Method TryStartNetManager, addr 0x22d5304, size 0x98, virtual false, abstract: false, final false
  inline bool TryStartNetManager(int32_t port, bool enableBackgroundSentry);

  /// @brief Method UpdateStatistics, addr 0x22d4a94, size 0x2bc, virtual false, abstract: false, final false
  inline void UpdateStatistics();

  /// @brief Method <DisposeAsync>b__98_0, addr 0x22d65bc, size 0x524, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d4560, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x22d45f8, size 0x1fc, virtual false, abstract: false, final false
  inline void _ctor(::BGNet::Core::ITimeProvider* timeProvider, ::BGNet::Core::ITaskUtility* taskUtility);

  /// @brief Method add_onConnectedEvent, addr 0x22d37ac, size 0x9c, virtual true, abstract: false, final true
  inline void add_onConnectedEvent(::System::Action* value);

  /// @brief Method add_onConnectionConnectedEvent, addr 0x22d3ba4, size 0xb0, virtual true, abstract: false, final true
  inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method add_onConnectionDisconnectedEvent, addr 0x22d3d04, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onConnectionFailedEvent, addr 0x22d3a44, size 0xb0, virtual true, abstract: false, final true
  inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_onDisconnectedEvent, addr 0x22d38e4, size 0xb0, virtual true, abstract: false, final true
  inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_onInitializedEvent, addr 0x22d3674, size 0x9c, virtual true, abstract: false, final true
  inline void add_onInitializedEvent(::System::Action* value);

  /// @brief Method add_onReceiveUnconnectedDataEvent, addr 0x22d3fc4, size 0xb0, virtual false, abstract: false, final false
  inline void add_onReceiveUnconnectedDataEvent(::System::Action_2<::System::Net::IPEndPoint*, ::LiteNetLib::Utils::NetDataReader*>* value);

  /// @brief Method add_onReceivedDataEvent, addr 0x22d3e64, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onStatisticsUpdatedEvent, addr 0x22d4124, size 0x9c, virtual false, abstract: false, final false
  inline void add_onStatisticsUpdatedEvent(::GlobalNamespace::NetworkStatisticsState_NetworkStatisticsUpdateDelegate* value);

  /// @brief Method get_connectionCount, addr 0x22d43e4, size 0x48, virtual true, abstract: false, final true
  inline int32_t get_connectionCount();

  /// @brief Method get_connectionRequestHandler, addr 0x22d442c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IConnectionRequestHandler* get_connectionRequestHandler();

  /// @brief Method get_encryptionLayer, addr 0x22d4458, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PacketEncryptionLayer* get_encryptionLayer();

  /// @brief Method get_hasConnectionOwner, addr 0x22d42ac, size 0x108, virtual false, abstract: false, final false
  inline bool get_hasConnectionOwner();

  /// @brief Method get_isClient, addr 0x22d43c4, size 0x10, virtual false, abstract: false, final false
  inline bool get_isClient();

  /// @brief Method get_isConnected, addr 0x22d426c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting, addr 0x22d427c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnecting();

  /// @brief Method get_isConnectionOwner, addr 0x22d429c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isDisconnecting, addr 0x22d428c, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisconnecting();

  /// @brief Method get_isDisposed, addr 0x22d43d4, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisposed();

  /// @brief Method get_isServer, addr 0x22d43b4, size 0x10, virtual false, abstract: false, final false
  inline bool get_isServer();

  /// @brief Method get_port, addr 0x22d4434, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_port();

  /// @brief Method get_unconnectedPacketHeader, addr 0x22d4450, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_unconnectedPacketHeader();

  /// @brief Method get_userId, addr 0x22d425c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x22d4264, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();
  ...
  /// @brief Method remove_onConnectedEvent, addr 0x22d3848, size 0x9c, virtual true, abstract: false, final true
  inline void remove_onConnectedEvent(::System::Action* value);

  /// @brief Method remove_onConnectionConnectedEvent, addr 0x22d3c54, size 0xb0, virtual true, abstract: false, final true
  inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method remove_onConnectionDisconnectedEvent, addr 0x22d3db4, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectionFailedEvent, addr 0x22d3af4, size 0xb0, virtual true, abstract: false, final true
  inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_onDisconnectedEvent, addr 0x22d3994, size 0xb0, virtual true, abstract: false, final true
  inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_onInitializedEvent, addr 0x22d3710, size 0x9c, virtual true, abstract: false, final true
  inline void remove_onInitializedEvent(::System::Action* value);

  /// @brief Method remove_onReceiveUnconnectedDataEvent, addr 0x22d4074, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_onReceivedDataEvent, addr 0x22d3f14, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onStatisticsUpdatedEvent, addr 0x22d41c0, size 0x9c, virtual false, abstract: false, final false
