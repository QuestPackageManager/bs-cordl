...
public:
  ...
  /// @brief Method ClearPlatformOverride, addr 0x328ce94, size 0x4c, virtual false, abstract: false, final false
  static inline void ClearPlatformOverride();

  /// @brief Method GetHardwareCategory, addr 0x328cee4, size 0xbc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::HardwareCategory GetHardwareCategory();

  /// @brief Method GetHardwareCategoryWithEditorOverride, addr 0x328cee0, size 0x4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::HardwareCategory GetHardwareCategoryWithEditorOverride();

  /// @brief Method GetPlatformOverride, addr 0x328cde4, size 0x58, virtual false, abstract: false, final false
  static inline bool GetPlatformOverride(::by_ref<::GlobalNamespace::HardwareCategory> hardwareCategory);

  /// @brief Method SetPlatformOverride, addr 0x328ce3c, size 0x58, virtual false, abstract: false, final false
