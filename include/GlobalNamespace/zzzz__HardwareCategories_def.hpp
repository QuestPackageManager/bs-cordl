...
public:
  // Declarations
  /// @brief Method GetHardwareCategory, addr 0x31f75c0, size 0x78, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::HardwareCategory GetHardwareCategory();

  /// @brief Method GetHardwareCategoryWithEditorOverride, addr 0x31f75bc, size 0x4, virtual false, abstract: false, final false
