...
public:
  ...
  /// @brief Method PollUpdate, addr 0x326ecc8, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326ef2c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_utilization, addr 0x326ef08, size 0x24, virtual true, abstract: false, final true
