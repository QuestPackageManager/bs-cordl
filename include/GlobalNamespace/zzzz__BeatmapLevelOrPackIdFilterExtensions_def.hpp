...
public:
  // Declarations
  /// @brief Method ShouldAllowEmpty, addr 0x368d670, size 0x8, virtual false, abstract: false, final false
  static inline bool ShouldAllowEmpty(::GlobalNamespace::BeatmapLevelOrPackIdFilter filter);

  /// @brief Method ShouldAllowLevels, addr 0x368d65c, size 0x8, virtual false, abstract: false, final false
  static inline bool ShouldAllowLevels(::GlobalNamespace::BeatmapLevelOrPackIdFilter filter);

  /// @brief Method ShouldAllowPacks, addr 0x368d648, size 0x8, virtual false, abstract: false, final false
