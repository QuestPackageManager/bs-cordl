...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5292)), TypeDefinitionIndex(TypeDefinitionIndex(5296)), TypeDefinitionIndex(TypeDefinitionIndex(8778)),
// TypeDefinitionIndex(TypeDefinitionIndex(9190)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8778), inst: 1721 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5290)) CS
...
public:
  ...
  /// @brief Method get_clipCaps, addr 0x23421fc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method CreatePlayable, addr 0x2342204, size 0x13c, virtual true, abstract: false, final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  static inline ::GlobalNamespace::GhostEffectAsset* New_ctor();

  /// @brief Method .ctor, addr 0x2342340, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
