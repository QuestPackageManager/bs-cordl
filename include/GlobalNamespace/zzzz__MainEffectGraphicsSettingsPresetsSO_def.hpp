...
// Write type traits
MARK_REF_T(::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO*);
MARK_REF_T(::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO_Preset*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO*, "", "MainEffectGraphicsSettingsPresetsSO");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO_Preset*, "", "MainEffectGraphicsSettingsPresetsSO/Preset");
...
static_assert(sizeof(::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO_Preset) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies MainEffectGraphicsSettingsPresetsSO::Preset, NamedPresetsSO
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__presets, put = __cordl_internal_set__presets)) ::ArrayW<::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO_Preset*> _presets;

  __declspec(property(get = get_namedPresets)) ::ArrayW<::GlobalNamespace::NamedPreset*> namedPresets;

  __declspec(property(get = get_presets)) ::ArrayW<::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO_Preset*> presets;

  static inline ::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO* New_ctor();

  constexpr ::ArrayW<::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO_Preset*> const& __cordl_internal_get__presets() const;

  constexpr ::ArrayW<::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO_Preset*>& __cordl_internal_get__presets();
...
static_assert(sizeof(::GlobalNamespace::MainEffectGraphicsSettingsPresetsSO) == 0x20, "Size mismatch!");
