...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IsPackBetterBuyThanLevelResult, "", "IsPackBetterBuyThanLevelResult");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::IsPackBetterBuyThanLevelResult) == 0x4, "Size mismatch!");
