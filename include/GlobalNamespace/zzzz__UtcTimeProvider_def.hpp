...
public:
  ...
  /// @brief Method GetTicks, addr 0x22a4554, size 0xb0, virtual true, abstract: false, final true
  inline int64_t GetTicks();

  /// @brief Method GetTimeMs, addr 0x22b5af8, size 0x2c, virtual true, abstract: false, final true
  inline int64_t GetTimeMs();

  static inline ::GlobalNamespace::UtcTimeProvider* New_ctor();

  /// @brief Method .ctor, addr 0x22b5b24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
