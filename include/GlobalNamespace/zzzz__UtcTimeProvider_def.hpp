...
public:
  ...
  /// @brief Method GetTicks, addr 0x3338e58, size 0xb8, virtual true, abstract: false, final true
  inline int64_t GetTicks();

  /// @brief Method GetTimeMs, addr 0x333ff28, size 0x2c, virtual true, abstract: false, final true
  inline int64_t GetTimeMs();

  static inline ::GlobalNamespace::UtcTimeProvider* New_ctor();

  /// @brief Method .ctor, addr 0x333ff54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
