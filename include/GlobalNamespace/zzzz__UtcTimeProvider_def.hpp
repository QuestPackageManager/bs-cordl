...
// Write type traits
MARK_REF_T(::GlobalNamespace::UtcTimeProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UtcTimeProvider*, "", "UtcTimeProvider");
...
public:
  ...
  /// @brief Method GetTicks, addr 0x333b1e0, size 0xb8, virtual true, abstract: false, final true
  inline int64_t GetTicks();

  /// @brief Method GetTimeMs, addr 0x33422b0, size 0x2c, virtual true, abstract: false, final true
  inline int64_t GetTimeMs();

  static inline ::GlobalNamespace::UtcTimeProvider* New_ctor();

  /// @brief Method .ctor, addr 0x33422dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UtcTimeProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UtcTimeProvider(UtcTimeProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UtcTimeProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UtcTimeProvider(UtcTimeProviderconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::UtcTimeProvider) == 0x10, "Size mismatch!");
