...
public:
  ...
  /// @brief Method SetValue, addr 0x3b9c0d0, size 0xa0, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x3b9c170, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b9c210, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
