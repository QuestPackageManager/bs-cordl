...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::SceneManagement::Scene, bool)>(
  ...
  constexpr static std::size_t addrs = 0x1f9208c;
...
template <typename T>
inline ::System::Collections::Generic::IEnumerable_1<T>* GlobalNamespace::UnityScenesHelper::FindComponentsOfTypeInScene(::UnityEngine::SceneManagement::Scene activeScene, bool includeInactive) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::UnityScenesHelper*>::get(), "FindComponentsOfTypeInScene",
