...
public:
  ...
  /// @brief Method LateUpdate, addr 0x5854b8c, size 0x4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::FloatTextureProcessor3DMaterialSwitchEffectTarget* New_ctor();

  /// @brief Method OnValidate, addr 0x5854ae0, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetFloat, addr 0x58549b8, size 0x124, virtual false, abstract: false, final false
  inline void SetFloat(float_t value);

  /// @brief Method SetMaterialsIfNeeded, addr 0x5854ae4, size 0xa8, virtual false, abstract: false, final false
  inline void SetMaterialsIfNeeded();

  /// @brief Method SetValue, addr 0x58549b4, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x5854adc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5854b90, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
