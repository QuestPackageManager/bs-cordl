...
/// @brief Field _gridElementControllers, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__gridElementControllers, put=__cordl_internal_set__gridElementControllers)) ::ArrayW<::UnityW<::GlobalNamespace::GridElementController>,::Array<::UnityW<::GlobalNamespace::GridElementController>>*>  _gridElementControllers;

/// @brief Field _materialArray, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__materialArray, put=__cordl_internal_set__materialArray)) ::ArrayW<::UnityW<::UnityEngine::Material>,::Array<::UnityW<::UnityEngine::Material>>*>  _materialArray;
...
/// @brief Method LateUpdate, addr 0x57e2c94, size 0x4, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::FloatTextureProcessor3DMaterialSwitchEffectTarget* New_ctor() ;

/// @brief Method OnValidate, addr 0x57e2be8, size 0x4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetFloat, addr 0x57e2ac0, size 0x124, virtual false, abstract: false, final false
inline void SetFloat(float_t  value) ;

/// @brief Method SetMaterialsIfNeeded, addr 0x57e2bec, size 0xa8, virtual false, abstract: false, final false
inline void SetMaterialsIfNeeded() ;

/// @brief Method SetValue, addr 0x57e2abc, size 0x4, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x57e2be4, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57e2c98, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
