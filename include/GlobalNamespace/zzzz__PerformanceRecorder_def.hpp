...
/// @brief Field <CallbackController>k__BackingField, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__CallbackController_k__BackingField, put=__cordl_internal_set__CallbackController_k__BackingField)) ::GlobalNamespace::BeatmapCallbacksController*  _CallbackController_k__BackingField;
...
/// @brief Field <GameplayModifiers>k__BackingField, offset 0x38, size 0x2 
 __declspec(property(get=__cordl_internal_get__GameplayModifiers_k__BackingField, put=__cordl_internal_set__GameplayModifiers_k__BackingField)) ::GlobalNamespace::GameplayModifierMask  _GameplayModifiers_k__BackingField;

/// @brief Field <ObjectManager>k__BackingField, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__ObjectManager_k__BackingField, put=__cordl_internal_set__ObjectManager_k__BackingField)) ::GlobalNamespace::BeatmapObjectManager*  _ObjectManager_k__BackingField;
...
/// @brief Field <RecPlayState>k__BackingField, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__RecPlayState_k__BackingField, put=__cordl_internal_set__RecPlayState_k__BackingField)) ::GlobalNamespace::RecPlayBehaviour_State*  _RecPlayState_k__BackingField;

/// @brief Field <SceneSetupData>k__BackingField, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__SceneSetupData_k__BackingField, put=__cordl_internal_set__SceneSetupData_k__BackingField)) ::GlobalNamespace::GameplayCoreSceneSetupData*  _SceneSetupData_k__BackingField;

/// @brief Field <SettingsManager>k__BackingField, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__SettingsManager_k__BackingField, put=__cordl_internal_set__SettingsManager_k__BackingField)) ::GlobalNamespace::SettingsManager*  _SettingsManager_k__BackingField;
...
/// @brief Field <TimeSync>k__BackingField, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__TimeSync_k__BackingField, put=__cordl_internal_set__TimeSync_k__BackingField)) ::UnityW<::GlobalNamespace::AudioTimeSyncController>  _TimeSync_k__BackingField;
...
/// @brief Field _beatmapEventTweenRecorder, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapEventTweenRecorder, put=__cordl_internal_set__beatmapEventTweenRecorder)) ::GlobalNamespace::BeatmapEventTweenRecorder*  _beatmapEventTweenRecorder;

/// @brief Field _beatmapItems, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapItems, put=__cordl_internal_set__beatmapItems)) ::ArrayW<::GlobalNamespace::BeatmapDataItem*,::Array<::GlobalNamespace::BeatmapDataItem*>*>  _beatmapItems;
...
/// @brief Method Awake, addr 0x5762c90, size 0xc, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ClearRecordingData, addr 0x5762ca0, size 0xec, virtual false, abstract: false, final false
inline void ClearRecordingData() ;

/// @brief Method CollectFrameData, addr 0x5763460, size 0x258, virtual false, abstract: false, final false
inline void CollectFrameData() ;

/// @brief Method GenerateReports, addr 0x5762d90, size 0x6cc, virtual false, abstract: false, final false
inline void GenerateReports() ;

static inline ::GlobalNamespace::PerformanceRecorder* New_ctor() ;

/// @brief Method OnDisable, addr 0x5762d8c, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5762c9c, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x576345c, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method WriteFileReport, addr 0x5763e48, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5764398, size 0x100, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_CallbackController, addr 0x5762c70, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapCallbacksController* get_CallbackController() ;

/// @brief Method get_GamePause, addr 0x5762c40, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IGamePause* get_GamePause() ;

/// @brief Method get_GameplayModifiers, addr 0x5762c20, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifierMask get_GameplayModifiers() ;

/// @brief Method get_ObjectManager, addr 0x5762c60, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapObjectManager* get_ObjectManager() ;

/// @brief Method get_PlayerSpecificSettings, addr 0x5762c10, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettings* get_PlayerSpecificSettings() ;

/// @brief Method get_RecPlayState, addr 0x5762c30, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::RecPlayBehaviour_State* get_RecPlayState() ;

/// @brief Method get_SceneSetupData, addr 0x5762c50, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_SceneSetupData() ;

/// @brief Method get_SettingsManager, addr 0x5762c00, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::SettingsManager* get_SettingsManager() ;

/// @brief Method get_StartEnabled, addr 0x5762bf0, size 0x8, virtual false, abstract: false, final false
inline bool get_StartEnabled() ;

/// @brief Method get_TimeSync, addr 0x5762c80, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::AudioTimeSyncController> get_TimeSync() ;

/// @brief Method set_CallbackController, addr 0x5762c78, size 0x8, virtual false, abstract: false, final false
inline void set_CallbackController(::GlobalNamespace::BeatmapCallbacksController*  value) ;

/// @brief Method set_GamePause, addr 0x5762c48, size 0x8, virtual false, abstract: false, final false
inline void set_GamePause(::GlobalNamespace::IGamePause*  value) ;

/// @brief Method set_GameplayModifiers, addr 0x5762c28, size 0x8, virtual false, abstract: false, final false
inline void set_GameplayModifiers(::GlobalNamespace::GameplayModifierMask  value) ;

/// @brief Method set_ObjectManager, addr 0x5762c68, size 0x8, virtual false, abstract: false, final false
inline void set_ObjectManager(::GlobalNamespace::BeatmapObjectManager*  value) ;

/// @brief Method set_PlayerSpecificSettings, addr 0x5762c18, size 0x8, virtual false, abstract: false, final false
inline void set_PlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings*  value) ;

/// @brief Method set_RecPlayState, addr 0x5762c38, size 0x8, virtual false, abstract: false, final false
inline void set_RecPlayState(::GlobalNamespace::RecPlayBehaviour_State*  value) ;

/// @brief Method set_SceneSetupData, addr 0x5762c58, size 0x8, virtual false, abstract: false, final false
inline void set_SceneSetupData(::GlobalNamespace::GameplayCoreSceneSetupData*  value) ;

/// @brief Method set_SettingsManager, addr 0x5762c08, size 0x8, virtual false, abstract: false, final false
inline void set_SettingsManager(::GlobalNamespace::SettingsManager*  value) ;

/// @brief Method set_StartEnabled, addr 0x5762bf8, size 0x8, virtual false, abstract: false, final false
inline void set_StartEnabled(bool  value) ;

/// @brief Method set_TimeSync, addr 0x5762c88, size 0x8, virtual false, abstract: false, final false
