...
public:
  ...
  /// @brief Method Awake, addr 0x3b23dc8, size 0xc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GenerateReports, addr 0x3b23f74, size 0x438, virtual false, abstract: false, final false
  inline void GenerateReports();

  static inline ::GlobalNamespace::PerformanceRecorder* New_ctor();

  /// @brief Method OnDisable, addr 0x3b23f70, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3b23dd4, size 0xc8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x3b243ac, size 0x184, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method WriteFileReport, addr 0x3b24bd0, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b250bc, size 0xe0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_GamePause, addr 0x3b23d68, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IGamePause* get_GamePause();

  /// @brief Method get_GameplayModifiers, addr 0x3b23da8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifierMask get_GameplayModifiers();

  /// @brief Method get_PlayerSpecificSettings, addr 0x3b23d98, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_PlayerSpecificSettings();

  /// @brief Method get_RrecPlayState, addr 0x3b23db8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RecPlayBehaviour_State* get_RrecPlayState();

  /// @brief Method get_SceneSetupData, addr 0x3b23d78, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_SceneSetupData();

  /// @brief Method get_SettingsManager, addr 0x3b23d88, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SettingsManager* get_SettingsManager();

  /// @brief Method get_StartEnabled, addr 0x3b23d54, size 0x8, virtual false, abstract: false, final false
  inline bool get_StartEnabled();

  /// @brief Method set_GamePause, addr 0x3b23d70, size 0x8, virtual false, abstract: false, final false
  inline void set_GamePause(::GlobalNamespace::IGamePause* value);

  /// @brief Method set_GameplayModifiers, addr 0x3b23db0, size 0x8, virtual false, abstract: false, final false
  inline void set_GameplayModifiers(::GlobalNamespace::GameplayModifierMask value);

  /// @brief Method set_PlayerSpecificSettings, addr 0x3b23da0, size 0x8, virtual false, abstract: false, final false
  inline void set_PlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method set_RrecPlayState, addr 0x3b23dc0, size 0x8, virtual false, abstract: false, final false
  inline void set_RrecPlayState(::GlobalNamespace::RecPlayBehaviour_State* value);

  /// @brief Method set_SceneSetupData, addr 0x3b23d80, size 0x8, virtual false, abstract: false, final false
  inline void set_SceneSetupData(::GlobalNamespace::GameplayCoreSceneSetupData* value);

  /// @brief Method set_SettingsManager, addr 0x3b23d90, size 0x8, virtual false, abstract: false, final false
  inline void set_SettingsManager(::GlobalNamespace::SettingsManager* value);

  /// @brief Method set_StartEnabled, addr 0x3b23d5c, size 0xc, virtual false, abstract: false, final false
