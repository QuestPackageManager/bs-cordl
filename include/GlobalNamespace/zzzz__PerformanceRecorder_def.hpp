...
public:
  ...
  /// @brief Method Awake, addr 0x57d2db8, size 0xc, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClearRecordingData, addr 0x57d2dc8, size 0xec, virtual false, abstract: false, final false
  inline void ClearRecordingData();

  /// @brief Method CollectFrameData, addr 0x57d3578, size 0x250, virtual false, abstract: false, final false
  inline void CollectFrameData();

  /// @brief Method GenerateReports, addr 0x57d2eb8, size 0x6bc, virtual false, abstract: false, final false
  inline void GenerateReports();

  static inline ::GlobalNamespace::PerformanceRecorder* New_ctor();

  /// @brief Method OnDisable, addr 0x57d2eb4, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57d2dc4, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x57d3574, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method WriteFileReport, addr 0x57d3f58, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d44a8, size 0x100, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CallbackController, addr 0x57d2d98, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapCallbacksController* get_CallbackController();

  /// @brief Method get_GamePause, addr 0x57d2d68, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IGamePause* get_GamePause();

  /// @brief Method get_GameplayModifiers, addr 0x57d2d48, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifierMask get_GameplayModifiers();

  /// @brief Method get_ObjectManager, addr 0x57d2d88, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapObjectManager* get_ObjectManager();

  /// @brief Method get_PlayerSpecificSettings, addr 0x57d2d38, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_PlayerSpecificSettings();

  /// @brief Method get_RecPlayState, addr 0x57d2d58, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RecPlayBehaviour_State* get_RecPlayState();

  /// @brief Method get_SceneSetupData, addr 0x57d2d78, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_SceneSetupData();

  /// @brief Method get_SettingsManager, addr 0x57d2d28, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SettingsManager* get_SettingsManager();

  /// @brief Method get_StartEnabled, addr 0x57d2d18, size 0x8, virtual false, abstract: false, final false
  inline bool get_StartEnabled();

  /// @brief Method get_TimeSync, addr 0x57d2da8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::AudioTimeSyncController> get_TimeSync();

  /// @brief Method set_CallbackController, addr 0x57d2da0, size 0x8, virtual false, abstract: false, final false
  inline void set_CallbackController(::GlobalNamespace::BeatmapCallbacksController* value);

  /// @brief Method set_GamePause, addr 0x57d2d70, size 0x8, virtual false, abstract: false, final false
  inline void set_GamePause(::GlobalNamespace::IGamePause* value);

  /// @brief Method set_GameplayModifiers, addr 0x57d2d50, size 0x8, virtual false, abstract: false, final false
  inline void set_GameplayModifiers(::GlobalNamespace::GameplayModifierMask value);

  /// @brief Method set_ObjectManager, addr 0x57d2d90, size 0x8, virtual false, abstract: false, final false
  inline void set_ObjectManager(::GlobalNamespace::BeatmapObjectManager* value);

  /// @brief Method set_PlayerSpecificSettings, addr 0x57d2d40, size 0x8, virtual false, abstract: false, final false
  inline void set_PlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method set_RecPlayState, addr 0x57d2d60, size 0x8, virtual false, abstract: false, final false
  inline void set_RecPlayState(::GlobalNamespace::RecPlayBehaviour_State* value);

  /// @brief Method set_SceneSetupData, addr 0x57d2d80, size 0x8, virtual false, abstract: false, final false
  inline void set_SceneSetupData(::GlobalNamespace::GameplayCoreSceneSetupData* value);

  /// @brief Method set_SettingsManager, addr 0x57d2d30, size 0x8, virtual false, abstract: false, final false
  inline void set_SettingsManager(::GlobalNamespace::SettingsManager* value);

  /// @brief Method set_StartEnabled, addr 0x57d2d20, size 0x8, virtual false, abstract: false, final false
  inline void set_StartEnabled(bool value);

  /// @brief Method set_TimeSync, addr 0x57d2db0, size 0x8, virtual false, abstract: false, final false
