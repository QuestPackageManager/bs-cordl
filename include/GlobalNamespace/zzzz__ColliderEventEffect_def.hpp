...
public:
  ...
  /// @brief Method SetValue, addr 0x3b941b4, size 0x8, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method Start, addr 0x3b94138, size 0x1c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TriggerValue, addr 0x3b941bc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b941c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_effectCollider, addr 0x3b94128, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_effectCollider();

  /// @brief Method get_value, addr 0x3b94130, size 0x8, virtual false, abstract: false, final false
