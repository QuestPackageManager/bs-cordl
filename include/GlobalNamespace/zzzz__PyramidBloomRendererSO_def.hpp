...
/// @brief Field _legacyAutoExposureGlobalKeyword, offset 0x40, size 0x10 
 __declspec(property(get=__cordl_internal_get__legacyAutoExposureGlobalKeyword, put=__cordl_internal_set__legacyAutoExposureGlobalKeyword)) ::UnityEngine::Rendering::GlobalKeyword  _legacyAutoExposureGlobalKeyword;

/// @brief Field _material, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__material, put=__cordl_internal_set__material)) ::UnityW<::UnityEngine::Material>  _material;

/// @brief Field _pyramid, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__pyramid, put=__cordl_internal_set__pyramid)) ::ArrayW<::GlobalNamespace::PyramidBloomRendererSO_Level,::Array<::GlobalNamespace::PyramidBloomRendererSO_Level>*>  _pyramid;
...
/// @brief Method OnDisable, addr 0x56ab2e0, size 0x24, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x56ab1c0, size 0x120, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RenderBloom, addr 0x56ab304, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method RenderBloom, addr 0x56ab394, size 0x880, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56abc14, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;
