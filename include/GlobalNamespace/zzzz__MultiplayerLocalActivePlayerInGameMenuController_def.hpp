...
/// @brief Method HandleInGameMenuViewControllerDidPressDisconnectButton, addr 0x5803100, size 0x1c, virtual false, abstract: false, final false
inline void HandleInGameMenuViewControllerDidPressDisconnectButton() ;

/// @brief Method HandleInGameMenuViewControllerDidPressGiveUpButton, addr 0x58030c4, size 0x3c, virtual false, abstract: false, final false
inline void HandleInGameMenuViewControllerDidPressGiveUpButton() ;

/// @brief Method HandleInGameMenuViewControllerDidPressResumeButton, addr 0x58030c0, size 0x4, virtual false, abstract: false, final false
inline void HandleInGameMenuViewControllerDidPressResumeButton() ;

/// @brief Method HandleInputFocusWasCaptured, addr 0x58030bc, size 0x4, virtual false, abstract: false, final false
inline void HandleInputFocusWasCaptured() ;

/// @brief Method HandleMenuButtonTriggered, addr 0x58030b8, size 0x4, virtual false, abstract: false, final false
inline void HandleMenuButtonTriggered() ;

/// @brief Method HandleStateChanged, addr 0x580311c, size 0x1dc, virtual false, abstract: false, final false
inline void HandleStateChanged(::GlobalNamespace::MultiplayerController_State  state) ;

/// @brief Method HideInGameMenu, addr 0x5802478, size 0x1b4, virtual false, abstract: false, final false
inline void HideInGameMenu() ;

static inline ::GlobalNamespace::MultiplayerLocalActivePlayerInGameMenuController* New_ctor() ;

/// @brief Method OnApplicationPause, addr 0x5802ec0, size 0xc, virtual false, abstract: false, final false
inline void OnApplicationPause(bool  pauseStatus) ;

/// @brief Method OnDestroy, addr 0x5802830, size 0x48c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method ShowInGameMenu, addr 0x5802ecc, size 0x158, virtual false, abstract: false, final false
inline void ShowInGameMenu() ;

/// @brief Method Start, addr 0x58020f8, size 0x380, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x58032f8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didGiveUpEvent, addr 0x5801dec, size 0xac, virtual false, abstract: false, final false
inline void add_didGiveUpEvent(::System::Action*  value) ;

/// @brief Method add_requestsDisconnectEvent, addr 0x5801f44, size 0xac, virtual false, abstract: false, final false
inline void add_requestsDisconnectEvent(::System::Action*  value) ;

/// @brief Method get_canChangeMenuState, addr 0x58020a4, size 0x54, virtual false, abstract: false, final false
inline bool get_canChangeMenuState() ;

/// @brief Method get_gameMenuIsShown, addr 0x580209c, size 0x8, virtual false, abstract: false, final false
inline bool get_gameMenuIsShown() ;

/// @brief Method remove_didGiveUpEvent, addr 0x5801e98, size 0xac, virtual false, abstract: false, final false
inline void remove_didGiveUpEvent(::System::Action*  value) ;

/// @brief Method remove_requestsDisconnectEvent, addr 0x5801ff0, size 0xac, virtual false, abstract: false, final false
