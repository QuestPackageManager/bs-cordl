...
public:
  ...
  /// @brief Method .ctor, addr 0x2505774, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x2505764, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::PropertyName get_id();

  /// @brief Method get_jumpDestination, addr 0x250576c, size 0x8, virtual false, abstract: false, final false
