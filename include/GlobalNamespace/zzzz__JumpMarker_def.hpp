...
/// @brief Method .ctor, addr 0x5713c98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x5713c88, size 0x8, virtual true, abstract: false, final true
inline ::UnityEngine::PropertyName get_id() ;

/// @brief Method get_jumpDestination, addr 0x5713c90, size 0x8, virtual false, abstract: false, final false
