...
public:
  ...
  /// @brief Method .ctor, addr 0x2257c4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x2257c3c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::PropertyName get_id();

  /// @brief Method get_jumpDestination, addr 0x2257c44, size 0x8, virtual false, abstract: false, final false
