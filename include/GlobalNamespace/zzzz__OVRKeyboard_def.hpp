...
public:
  ...
  /// @brief Method GetKeyboardState, addr 0x4019bc8, size 0x148, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRKeyboard_TrackedKeyboardState GetKeyboardState();

  /// @brief Method GetSystemKeyboardInfo, addr 0x4019d10, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method StopKeyboardTracking, addr 0x4019df8, size 0x50, virtual false, abstract: false, final false
