...
public:
  ...
  /// @brief Method .ctor addr 0xdb7dc0 size 0x30 virtual false final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::QuickStartOneSongGameplayServerFiniteStateMachine, 0x80>, "Size mismatch!");
