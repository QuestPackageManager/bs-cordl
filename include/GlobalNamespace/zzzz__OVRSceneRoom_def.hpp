...
public:
  ...
  /// @brief Method MoveNext, addr 0x5d92bf8, size 0x11a4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5d93d9c, size 0x3c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Awake, addr 0x5d923c4, size 0x138, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x5d924fc, size 0x11c, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  /// @brief Method LoadRoom, addr 0x5d8e3fc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Log, addr 0x5d926d4, size 0xac, virtual false, abstract: false, final false
  inline void Log(::StringW message);

  /// @brief Method LogError, addr 0x5d9282c, size 0xac, virtual false, abstract: false, final false
  inline void LogError(::StringW message);

  /// @brief Method LogWarning, addr 0x5d92780, size 0xac, virtual false, abstract: false, final false
  inline void LogWarning(::StringW message);

  static inline ::GlobalNamespace::OVRSceneRoom* New_ctor();

  /// @brief Method OnDestroy, addr 0x5d92618, size 0xbc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method <LoadRoom>g__GetPlane|19_1, addr 0x5d92b78, size 0x80, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRScenePlane> _LoadRoom_g__GetPlane_19_1(::System::Guid uuid);

  /// @brief Method <LoadRoom>g__TryGetPlane|19_0, addr 0x5d92a80, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d928d8, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Ceiling, addr 0x5d923a4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Ceiling();

  /// @brief Method get_Floor, addr 0x5d92394, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Floor();

  /// @brief Method get_Walls, addr 0x5d923b4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Ceiling, addr 0x5d923ac, size 0x8, virtual false, abstract: false, final false
  inline void set_Ceiling(::GlobalNamespace::OVRScenePlane* value);

  /// @brief Method set_Floor, addr 0x5d9239c, size 0x8, virtual false, abstract: false, final false
  inline void set_Floor(::GlobalNamespace::OVRScenePlane* value);

  /// @brief Method set_Walls, addr 0x5d923bc, size 0x8, virtual false, abstract: false, final false
