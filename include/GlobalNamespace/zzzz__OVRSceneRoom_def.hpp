...
/// @brief Method MoveNext, addr 0x5d20c10, size 0x11a4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x5d21db4, size 0x3c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::GlobalNamespace::OVRTaskBuilder_1<bool>", modifiers: "", def_value: None }, CppParam { name: "floor", ty: "::System::Guid", modifiers: "", def_value: None }, CppParam { name: "ceiling", ty: "::System::Guid", modifiers: "", def_value: None }, CppParam { name: "walls", ty: "::ArrayW<::System::Guid,::Array<::System::Guid>*>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::OVRSceneRoom>", modifiers: "", def_value: None }, CppParam { name: "__7__wrap1", ty: "::GlobalNamespace::OVRObjectPool_HashSetScope_1<::System::Guid>", modifiers: "", def_value: None }, CppParam { name: "_anchors_5__3", ty: "::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*", modifiers: "", def_value: None }, CppParam { name: "__7__wrap3", ty: "::GlobalNamespace::OVRObjectPool_ListScope_1<::GlobalNamespace::OVRAnchor>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::GlobalNamespace::OVRTask_1_Awaiter<bool>", modifiers: "", def_value: None }, CppParam { name: "__7__wrap4", ty: "::GlobalNamespace::OVRObjectPool_ListScope_1<bool>", modifiers: "", def_value: None }, CppParam { name: "__7__wrap5", ty: "::GlobalNamespace::OVRObjectPool_ListScope_1<::GlobalNamespace::OVRTask_1<bool>>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::GlobalNamespace::OVRTask_1_Awaiter<::System::Collections::Generic::List_1<bool>*>", modifiers: "", def_value: None }]
...
/// @brief Method Awake, addr 0x5d203dc, size 0x138, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method IOVRSceneComponent.Initialize, addr 0x5d20514, size 0x11c, virtual true, abstract: false, final true
inline void IOVRSceneComponent_Initialize() ;

/// @brief Method LoadRoom, addr 0x5d1c414, size 0xf4, virtual false, abstract: false, final false
...
/// @brief Method Log, addr 0x5d206ec, size 0xac, virtual false, abstract: false, final false
inline void Log(::StringW  message) ;

/// @brief Method LogError, addr 0x5d20844, size 0xac, virtual false, abstract: false, final false
inline void LogError(::StringW  message) ;

/// @brief Method LogWarning, addr 0x5d20798, size 0xac, virtual false, abstract: false, final false
inline void LogWarning(::StringW  message) ;

static inline ::GlobalNamespace::OVRSceneRoom* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5d20630, size 0xbc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method <LoadRoom>g__GetPlane|19_1, addr 0x5d20b90, size 0x80, virtual false, abstract: false, final false
static inline ::UnityW<::GlobalNamespace::OVRScenePlane> _LoadRoom_g__GetPlane_19_1(::System::Guid  uuid) ;

/// @brief Method <LoadRoom>g__TryGetPlane|19_0, addr 0x5d20a98, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d208f0, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Ceiling, addr 0x5d203bc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Ceiling() ;

/// @brief Method get_Floor, addr 0x5d203ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::OVRScenePlane> get_Floor() ;

/// @brief Method get_Walls, addr 0x5d203cc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Ceiling, addr 0x5d203c4, size 0x8, virtual false, abstract: false, final false
inline void set_Ceiling(::GlobalNamespace::OVRScenePlane*  value) ;

/// @brief Method set_Floor, addr 0x5d203b4, size 0x8, virtual false, abstract: false, final false
inline void set_Floor(::GlobalNamespace::OVRScenePlane*  value) ;

/// @brief Method set_Walls, addr 0x5d203d4, size 0x8, virtual false, abstract: false, final false
