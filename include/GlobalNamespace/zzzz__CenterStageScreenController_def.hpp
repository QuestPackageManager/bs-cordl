...
/// @brief Method HandleLobbyGameStateControllerSelectedLevelGameplaySetupDataChanged, addr 0x57314e4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method Hide, addr 0x57312a4, size 0x13c, virtual false, abstract: false, final false
inline void Hide() ;

/// @brief Method HideCountdown, addr 0x57313e0, size 0x44, virtual false, abstract: false, final false
inline void HideCountdown(bool  instant) ;

static inline ::GlobalNamespace::CenterStageScreenController* New_ctor() ;

/// @brief Method SetCountdownEndTime, addr 0x5731460, size 0x58, virtual false, abstract: false, final false
inline void SetCountdownEndTime(int64_t  countdownEndTime) ;

/// @brief Method SetNextGameplaySetupData, addr 0x573114c, size 0x158, virtual false, abstract: false, final false
inline void SetNextGameplaySetupData(::GlobalNamespace::ILevelGameplaySetupData*  levelGameplaySetupData) ;

/// @brief Method Setup, addr 0x5730f5c, size 0x30, virtual false, abstract: false, final false
inline void Setup(bool  showModifiers) ;

/// @brief Method Show, addr 0x5730f8c, size 0x194, virtual false, abstract: false, final false
inline void Show() ;

/// @brief Method ShowCountdown, addr 0x5731424, size 0x3c, virtual false, abstract: false, final false
inline void ShowCountdown(int64_t  countdownEndTime) ;

/// @brief Method ShowCountdownColorPreset, addr 0x57314b8, size 0x2c, virtual false, abstract: false, final false
inline void ShowCountdownColorPreset(bool  animated) ;

/// @brief Method ShowLobbyColorPreset, addr 0x5731120, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57314e8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_countdownShown, addr 0x5730f4c, size 0x8, virtual false, abstract: false, final false
inline bool get_countdownShown() ;

/// @brief Method set_countdownShown, addr 0x5730f54, size 0x8, virtual false, abstract: false, final false
