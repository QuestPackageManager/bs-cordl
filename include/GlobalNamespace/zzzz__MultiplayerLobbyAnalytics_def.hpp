...
public:
  ...
  /// @brief Method Awake, addr 0x25fdb58, size 0x178, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetEventTypeFromLobbyType, addr 0x25fe000, size 0x80, virtual false, abstract: false, final false
  inline ::StringW GetEventTypeFromLobbyType(::GlobalNamespace::__GameServerLobbyFlowCoordinator__LobbyType lobbyType);

  /// @brief Method HandleGameServerLobbyFlowCoordinatorDidFinish, addr 0x25fe080, size 0x114, virtual false, abstract: false, final false
  inline void HandleGameServerLobbyFlowCoordinatorDidFinish();

  /// @brief Method HandleGameServerLobbyFlowCoordinatorDidOpenInvitePanel, addr 0x25fe374, size 0x114, virtual false, abstract: false, final false
  inline void HandleGameServerLobbyFlowCoordinatorDidOpenInvitePanel();

  /// @brief Method HandleGameServerLobbyFlowCoordinatorDidSetupEvent, addr 0x25fde94, size 0x16c, virtual false, abstract: false, final false
  inline void HandleGameServerLobbyFlowCoordinatorDidSetupEvent();

  /// @brief Method HandleGameServerLobbyFlowCoordinatorStartGameOrReady, addr 0x25fe260, size 0x114, virtual false, abstract: false, final false
  inline void HandleGameServerLobbyFlowCoordinatorStartGameOrReady();

  /// @brief Method LogClick, addr 0x25fe194, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25fdcd0, size 0x1c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25fe488, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
