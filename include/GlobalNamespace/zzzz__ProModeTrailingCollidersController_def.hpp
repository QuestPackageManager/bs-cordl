...
public:
  ...
  /// @brief Method HandleNoteDidMoveInJumpPhase, addr 0x579c4f4, size 0x15c, virtual false, abstract: false, final false
  inline void HandleNoteDidMoveInJumpPhase();

  static inline ::GlobalNamespace::ProModeTrailingCollidersController* New_ctor();

  /// @brief Method OnDestroy, addr 0x579c3e8, size 0x10c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x579c348, size 0xa0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x579c650, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
