...
public:
  ...
  /// @brief Method HandleNoteDidMoveInJumpPhase, addr 0x2524308, size 0x170, virtual false, abstract: false, final false
  inline void HandleNoteDidMoveInJumpPhase();

  static inline ::GlobalNamespace::ProModeTrailingCollidersController* New_ctor();

  /// @brief Method OnDestroy, addr 0x2524238, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x25241a0, size 0x98, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2524478, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
