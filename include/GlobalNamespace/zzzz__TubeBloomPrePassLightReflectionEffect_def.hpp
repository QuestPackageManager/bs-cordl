...
/// @brief Method SetActive, addr 0x57eee44, size 0xbc, virtual false, abstract: false, final false
inline void SetActive(bool  enabled, ::UnityEngine::Color  mainLightColor) ;

/// @brief Method SetCollisionLength, addr 0x57eeff0, size 0x224, virtual false, abstract: false, final false
inline void SetCollisionLength(bool  rayHitGeometry, ::UnityEngine::RaycastHit  hit) ;

/// @brief Method SetData, addr 0x57eef00, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ef218, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _mainTubeBloomPrePassLight, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__mainTubeBloomPrePassLight, put=__cordl_internal_set__mainTubeBloomPrePassLight)) ::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*  _mainTubeBloomPrePassLight;
...
/// @brief Field _tubeBloomPrePassLightBounces, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__tubeBloomPrePassLightBounces, put=__cordl_internal_set__tubeBloomPrePassLightBounces)) ::ArrayW<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*>*>  _tubeBloomPrePassLightBounces;

/// @brief Method Awake, addr 0x57ee950, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method LateUpdate, addr 0x57ee9cc, size 0x1c8, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::TubeBloomPrePassLightReflectionEffect* New_ctor() ;

/// @brief Method RaycastAndSetLightLength, addr 0x57eeb94, size 0x2b0, virtual false, abstract: false, final false
inline bool RaycastAndSetLightLength(::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*  bounce, ::UnityEngine::Vector3  rayWorldOrigin, ::UnityEngine::Vector3  rayDirection, ::ByRef<::UnityEngine::Vector3>  hitWorldPosition, ::ByRef<::UnityEngine::Vector3>  hitReflection, ::ByRef<float_t>  length, ::ByRef<float_t>  endAlpha) ;
...
constexpr ::ArrayW<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*>*> const& __cordl_internal_get__tubeBloomPrePassLightBounces() const;

constexpr ::ArrayW<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*>*>& __cordl_internal_get__tubeBloomPrePassLightBounces() ;
...
constexpr void __cordl_internal_set__tubeBloomPrePassLightBounces(::ArrayW<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*>*>  value) ;

/// @brief Method .ctor, addr 0x57ef214, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _tubeBloomPrePassLightBounces, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*,::Array<::GlobalNamespace::TubeBloomPrePassLightReflectionEffect_TubeBloomPrePassLightWithHitPoint*>*>  ____tubeBloomPrePassLightBounces;
