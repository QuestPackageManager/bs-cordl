...
public:
  ...
  /// @brief Method SetActive, addr 0x3ba6cf8, size 0xbc, virtual false, abstract: false, final false
  inline void SetActive(bool enabled, ::UnityEngine::Color mainLightColor);

  /// @brief Method SetCollisionLength, addr 0x3ba6ec8, size 0x27c, virtual false, abstract: false, final false
  inline void SetCollisionLength(bool rayHitGeometry, ::UnityEngine::RaycastHit hit);

  /// @brief Method SetData, addr 0x3ba6db4, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba714c, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x3ba6804, size 0x80, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LateUpdate, addr 0x3ba6884, size 0x1c4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::TubeBloomPrePassLightReflectionEffect* New_ctor();

  /// @brief Method RaycastAndSetLightLength, addr 0x3ba6a48, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba7144, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
