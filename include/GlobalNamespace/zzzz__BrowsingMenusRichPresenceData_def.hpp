...
public:
  ...
  /// @brief Method .ctor, addr 0x58ffb98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_apiName, addr 0x58ffaf8, size 0x44, virtual true, abstract: false, final true
  inline ::StringW get_apiName();

  /// @brief Method get_localizedDescription, addr 0x58ffb3c, size 0x5c, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BrowsingMenusRichPresenceData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BrowsingMenusRichPresenceData(BrowsingMenusRichPresenceData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BrowsingMenusRichPresenceData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BrowsingMenusRichPresenceData(BrowsingMenusRichPresenceDataconst&) = delete;
