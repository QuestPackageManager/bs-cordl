...
public:
  // Declarations
  /// @brief Method Init, addr 0x3325928, size 0x6c, virtual false, abstract: false, final false
  static inline void Init();

  static inline ::GlobalNamespace::BoolCvar* New_ctor(::StringW name, bool initialValue);

  /// @brief Method .ctor, addr 0x3325994, size 0x8c, virtual false, abstract: false, final false
