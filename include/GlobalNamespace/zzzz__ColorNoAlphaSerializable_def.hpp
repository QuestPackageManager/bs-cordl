...
public:
  ...
  /// @brief Method Deserialize, addr 0x1509580, size 0x5c, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x15096e8, size 0x7c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x15095e4, size 0x104, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::ColorNoAlphaSerializable other);

  /// @brief Method GetHashCode, addr 0x1509764, size 0x84, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Serialize, addr 0x1509530, size 0x50, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x15097e8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1509524, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x15095e0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x15095dc, size 0x4, virtual false, abstract: false, final false
