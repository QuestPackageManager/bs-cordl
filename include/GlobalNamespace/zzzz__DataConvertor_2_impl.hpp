...
constexpr ::System::Collections::Generic::Dictionary_2<::System::Type*, ::GlobalNamespace::DataItemConvertor_2<T, TParam>*>*&
GlobalNamespace::DataConvertor_2<T, TParam>::__cordl_internal_get__convertors() {
...
GlobalNamespace::DataConvertor_2<T, TParam>::__cordl_internal_get__convertors() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____convertors;
}
template <typename T, typename TParam>
constexpr void GlobalNamespace::DataConvertor_2<T, TParam>::__cordl_internal_set__convertors(
    ::System::Collections::Generic::Dictionary_2<::System::Type*, ::GlobalNamespace::DataItemConvertor_2<T, TParam>*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename T, typename TParam> inline T GlobalNamespace::DataConvertor_2<T, TParam>::ProcessItem(::System::Object* item, TParam param) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DataConvertor_2<T, TParam>*>::get(), "ProcessItem", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Object*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TParam>::get() })));
...
template <typename T, typename TParam> inline void GlobalNamespace::DataConvertor_2<T, TParam>::AddConvertor(::GlobalNamespace::DataItemConvertor_2<T, TParam>* dataItemConvertor) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DataConvertor_2<T, TParam>*>::get(), "AddConvertor", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::DataItemConvertor_2<T, TParam>*>::get() })));
...
template <typename T, typename TParam> inline ::GlobalNamespace::DataConvertor_2<T, TParam>* GlobalNamespace::DataConvertor_2<T, TParam>::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::DataConvertor_2<T, TParam>*>());
}
