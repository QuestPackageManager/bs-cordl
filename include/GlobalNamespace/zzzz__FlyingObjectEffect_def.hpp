...
public:
  ...
  /// @brief Method InitAndPresent, addr 0x3b83b14, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x3b83bfc, size 0x3c8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b83fc4, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_didFinishEvent, addr 0x3b83b0c, size 0x8, virtual false, abstract: false, final false
