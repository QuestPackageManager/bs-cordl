...
// Write type traits
MARK_REF_T(::GlobalNamespace::FlyingObjectEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlyingObjectEffect*, "", "FlyingObjectEffect");
...
public:
  ...
  /// @brief Method Update, addr 0x5982978, size 0x3c0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5982d38, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_didFinishEvent, addr 0x5982888, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::FlyingObjectEffect) == 0x88, "Size mismatch!");
