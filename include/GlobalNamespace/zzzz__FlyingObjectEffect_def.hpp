...
/// @brief Field _didFinishEvent, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__didFinishEvent, put=__cordl_internal_set__didFinishEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::IFlyingObjectEffectDidFinishEvent*>*  _didFinishEvent;
...
/// @brief Method InitAndPresent, addr 0x57d4cb8, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x57d4da0, size 0x3c0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x57d5160, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_didFinishEvent, addr 0x57d4cb0, size 0x8, virtual false, abstract: false, final false
