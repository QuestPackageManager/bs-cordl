...
public:
  ...
  /// @brief Method SetScenes, addr 0x2298018, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2298028, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
