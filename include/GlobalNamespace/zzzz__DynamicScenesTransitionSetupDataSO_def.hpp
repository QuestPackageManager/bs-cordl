...
public:
  ...
  /// @brief Method SetScenes, addr 0x229a8a4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229a8b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
