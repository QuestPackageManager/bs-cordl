...
public:
  ...
  /// @brief Method DidActivate, addr 0x25601e0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25601e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
