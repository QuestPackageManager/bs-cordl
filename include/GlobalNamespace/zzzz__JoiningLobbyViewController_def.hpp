...
public:
  ...
  /// @brief Method DidActivate, addr 0x5731090, size 0x100, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HideLoading, addr 0x5731050, size 0x40, virtual false, abstract: false, final false
  inline void HideLoading();

  /// @brief Method Init, addr 0x573101c, size 0x34, virtual false, abstract: false, final false
  inline void Init(::StringW text);

  static inline ::GlobalNamespace::JoiningLobbyViewController* New_ctor();

  /// @brief Method <DidActivate>b__8_0, addr 0x5731194, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5731190, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didCancelEvent, addr 0x5730ec4, size 0xac, virtual false, abstract: false, final false
  inline void add_didCancelEvent(::System::Action* value);

  /// @brief Method remove_didCancelEvent, addr 0x5730f70, size 0xac, virtual false, abstract: false, final false
