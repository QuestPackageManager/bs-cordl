...
public:
  ...
  /// @brief Method .ctor addr 0x2225310 size 0x8 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::PS4NetworkPlayerModel, 0x90>, "Size mismatch!");
