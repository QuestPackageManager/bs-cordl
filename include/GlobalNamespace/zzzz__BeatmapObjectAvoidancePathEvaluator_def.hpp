...
public:
  ...
  /// @brief Method GetCurrentPathPosition, addr 0x31b26fc, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31b26e4, size 0x18, virtual false, abstract: false, final false
