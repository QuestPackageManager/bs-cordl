...
public:
  ...
  /// @brief Method GetCurrentPathPosition, addr 0x225faf8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225fa80, size 0x78, virtual false, abstract: false, final false
