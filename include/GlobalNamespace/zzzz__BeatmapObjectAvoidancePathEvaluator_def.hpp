...
public:
  ...
  /// @brief Method GetCurrentPathPosition, addr 0xe8a570, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe8a4f8, size 0x78, virtual false, abstract: false, final false
