...
public:
  ...
  /// @brief Method GetCurrentPathPosition, addr 0x1058308, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1058290, size 0x78, virtual false, abstract: false, final false
