...
public:
  ...
  /// @brief Method GetCurrentPathPosition, addr 0x225bff8, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225bf80, size 0x78, virtual false, abstract: false, final false
