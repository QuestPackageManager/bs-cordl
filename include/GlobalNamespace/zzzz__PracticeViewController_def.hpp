...
public:
  ...
  /// @brief Method MoveNext, addr 0x5734be0, size 0x534, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5735114, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CancelSongLoading, addr 0x57344ec, size 0x40, virtual false, abstract: false, final false
  inline void CancelSongLoading();

  /// @brief Method DidActivate, addr 0x573459c, size 0x160, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x573487c, size 0xd0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method GetSongTime, addr 0x5734a40, size 0x60, virtual false, abstract: false, final false
  inline float_t GetSongTime();

  /// @brief Method HandlePlayButtonPressed, addr 0x5734b54, size 0x88, virtual false, abstract: false, final false
  inline void HandlePlayButtonPressed();

  /// @brief Method HandleSongStartSliderValueDidChange, addr 0x5734b20, size 0x34, virtual false, abstract: false, final false
  inline void HandleSongStartSliderValueDidChange(::HMUI::RangeValuesTextSlider* slider, float_t value);

  /// @brief Method Init, addr 0x5734380, size 0x16c, virtual false, abstract: false, final false
  inline void Init(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey, ::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method LoadSong, addr 0x57346fc, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method PlayPreview, addr 0x573494c, size 0xf4, virtual false, abstract: false, final false
  inline void PlayPreview();

  /// @brief Method SetLoader, addr 0x5734aa0, size 0x80, virtual false, abstract: false, final false
  inline void SetLoader(bool loading);

  /// @brief Method SetSongLength, addr 0x573452c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5734bdc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressPlayButtonEvent, addr 0x5734220, size 0xac, virtual false, abstract: false, final false
  inline void add_didPressPlayButtonEvent(::System::Action* value);

  /// @brief Method get_practiceSettings, addr 0x5734378, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method remove_didPressPlayButtonEvent, addr 0x57342cc, size 0xac, virtual false, abstract: false, final false
