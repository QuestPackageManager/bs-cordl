...
public:
  ...
  /// @brief Method InstallBindings, addr 0x5882e54, size 0xb60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58839c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
