...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59bb820, size 0xb7c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59bc3a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
