...
public:
  ...
  /// @brief Method InstallBindings, addr 0x2709c38, size 0x9dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270a650, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
