...
public:
  ...
  /// @brief Method InstallBindings, addr 0x26f1508, size 0x9dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f1f20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
