...
public:
  ...
  /// @brief Method InstallBindings, addr 0x3bb97b4, size 0xa48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bba238, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
