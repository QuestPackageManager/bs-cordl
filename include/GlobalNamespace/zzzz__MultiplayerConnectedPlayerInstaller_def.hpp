...
public:
  ...
  /// @brief Method InstallBindings, addr 0x25f26f0, size 0x9dc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f3108, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
