...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerHeightToJumpOffsetYProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerHeightToJumpOffsetYProvider(PlayerHeightToJumpOffsetYProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerHeightToJumpOffsetYProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerHeightToJumpOffsetYProvider(PlayerHeightToJumpOffsetYProviderconst&) = delete;
