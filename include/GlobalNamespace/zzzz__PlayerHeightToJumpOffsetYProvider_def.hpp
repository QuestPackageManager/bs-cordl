...
public:
  ...
  /// @brief Method Dispose, addr 0x3be8f84, size 0xcc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandlePlayerHeightDidChange, addr 0x3be8f4c, size 0x38, virtual false, abstract: false, final false
  inline void HandlePlayerHeightDidChange(float_t playerHeight);

  /// @brief Method Initialize, addr 0x3be8e24, size 0xf4, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method JumpOffsetYForPlayerHeight, addr 0x3be8f18, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3be9050, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_jumpOffsetY, addr 0x3be8e1c, size 0x8, virtual true, abstract: false, final true
