...
/// @brief Method Dispose, addr 0x5842968, size 0x110, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandlePlayerHeightDidChange, addr 0x584292c, size 0x3c, virtual false, abstract: false, final false
inline void HandlePlayerHeightDidChange(float_t  playerHeight) ;

/// @brief Method Initialize, addr 0x58427b4, size 0x140, virtual true, abstract: false, final true
inline void Initialize() ;

/// @brief Method JumpOffsetYForPlayerHeight, addr 0x58428f4, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5842a78, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_jumpOffsetY, addr 0x58427ac, size 0x8, virtual true, abstract: false, final true
