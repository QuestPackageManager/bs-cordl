...
/// @brief Method Dispose, addr 0x58b6920, size 0x110, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandlePlayerHeightDidChange, addr 0x58b68e4, size 0x3c, virtual false, abstract: false, final false
inline void HandlePlayerHeightDidChange(float_t  playerHeight) ;

/// @brief Method Initialize, addr 0x58b676c, size 0x140, virtual true, abstract: false, final true
inline void Initialize() ;

/// @brief Method JumpOffsetYForPlayerHeight, addr 0x58b68ac, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58b6a30, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_jumpOffsetY, addr 0x58b6764, size 0x8, virtual true, abstract: false, final true
