...
public:
  ...
  /// @brief Method Dispose, addr 0x3be8fcc, size 0xcc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandlePlayerHeightDidChange, addr 0x3be8f94, size 0x38, virtual false, abstract: false, final false
  inline void HandlePlayerHeightDidChange(float_t playerHeight);

  /// @brief Method Initialize, addr 0x3be8e6c, size 0xf4, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method JumpOffsetYForPlayerHeight, addr 0x3be8f60, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3be9098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_jumpOffsetY, addr 0x3be8e64, size 0x8, virtual true, abstract: false, final true
