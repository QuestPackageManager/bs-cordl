...
public:
  ...
  /// @brief Method get_jumpOffsetY addr 0x2261628 size 0x8 virtual true final true
  inline float_t get_jumpOffsetY();

  /// @brief Method Initialize addr 0x2261630 size 0xf8 virtual true final true
  inline void Initialize();

  /// @brief Method Dispose addr 0x2261794 size 0xd0 virtual true final true
  inline void Dispose();

  /// @brief Method HandlePlayerHeightDidChange addr 0x226175c size 0x38 virtual false final false
  inline void HandlePlayerHeightDidChange(float_t playerHeight);

  /// @brief Method JumpOffsetYForPlayerHeight addr 0x2261728 size 0x34 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2261864 size 0x8 virtual false final false
  inline void _ctor();
