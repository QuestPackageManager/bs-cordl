...
public:
  ...
  /// @brief Method .ctor, addr 0x2282658, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_textStyle, addr 0x2282650, size 0x8, virtual false, abstract: false, final false
