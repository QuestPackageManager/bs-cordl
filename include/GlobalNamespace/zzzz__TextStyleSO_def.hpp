...
public:
  ...
  /// @brief Method .ctor, addr 0x22432c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_textStyle, addr 0x22432b8, size 0x8, virtual false, abstract: false, final false
