...
// Write type traits
MARK_REF_T(::GlobalNamespace::TextStyleSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TextStyleSO*, "", "TextStyleSO");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextStyleSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextStyleSO(TextStyleSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextStyleSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextStyleSO(TextStyleSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::TextStyleSO) == 0x28, "Size mismatch!");
