...
public:
  ...
  /// @brief Method .ctor, addr 0x2281474, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_textStyle, addr 0x228146c, size 0x8, virtual false, abstract: false, final false
