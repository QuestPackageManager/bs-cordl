...
public:
  ...
  /// @brief Method Deserialize, addr 0x1417d00, size 0x64, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x1417dbc, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x1417d74, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::Color32Serializable other);

  /// @brief Method GetHashCode, addr 0x1417e64, size 0x68, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Serialize, addr 0x1417ca0, size 0x60, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x1417ecc, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x1417c98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1417d6c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x1417d64, size 0x8, virtual false, abstract: false, final false
