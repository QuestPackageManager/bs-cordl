...
public:
  ...
  /// @brief Method Deserialize, addr 0x137fa38, size 0x64, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x137faf4, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x137faac, size 0x48, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::Color32Serializable other);

  /// @brief Method GetHashCode, addr 0x137fb9c, size 0x68, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method Serialize, addr 0x137f9d8, size 0x60, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x137fc04, size 0x8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x137f9d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x137faa4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x137fa9c, size 0x8, virtual false, abstract: false, final false
