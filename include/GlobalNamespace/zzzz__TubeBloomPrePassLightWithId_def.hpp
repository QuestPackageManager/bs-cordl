...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x565c464, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x565c4bc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x565c448, size 0x1c, virtual false, abstract: false, final false
