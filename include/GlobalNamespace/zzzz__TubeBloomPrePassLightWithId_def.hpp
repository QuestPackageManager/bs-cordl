...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x39ea6bc, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ea714, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x39ea69c, size 0x20, virtual false, abstract: false, final false
