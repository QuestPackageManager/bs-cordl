...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatSaberNetworkUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatSaberNetworkUtility(BeatSaberNetworkUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatSaberNetworkUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatSaberNetworkUtility(BeatSaberNetworkUtilityconst&) = delete;
