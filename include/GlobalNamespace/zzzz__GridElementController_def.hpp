...
/// @brief Method Awake, addr 0x5d9b228, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ConvertPositionToObjectSpace, addr 0x5d9b3a4, size 0x48, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 ConvertPositionToObjectSpace(::UnityEngine::Vector3  worldSpacePivotPosition) ;

/// @brief Method Initialize, addr 0x5d9b22c, size 0x178, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::GlobalNamespace::GridElementController* New_ctor() ;

/// @brief Method SetGridMaterial, addr 0x5d9b3ec, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d9b414, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
