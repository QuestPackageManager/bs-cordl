...
public:
  ...
  /// @brief Method Awake, addr 0x5e0d234, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ConvertPositionToObjectSpace, addr 0x5e0d3b0, size 0x48, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 ConvertPositionToObjectSpace(::UnityEngine::Vector3 worldSpacePivotPosition);

  /// @brief Method Initialize, addr 0x5e0d238, size 0x178, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::GridElementController* New_ctor();

  /// @brief Method SetGridMaterial, addr 0x5e0d3f8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0d420, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
