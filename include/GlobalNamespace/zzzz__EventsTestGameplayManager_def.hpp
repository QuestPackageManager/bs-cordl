...
/// @brief Method ConvertBeatToTime, addr 0x586cf78, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5869ecc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <AddEventsForLightGroup>b__0, addr 0x586cf90, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x586c4a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <AddInstantToggleEventsForLightGroup>b__0, addr 0x586cfc0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x586c4a4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <AddToggleEventsForLightGroup>b__0, addr 0x586cff0, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x586c4a8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method AddEventsForLightGroup, addr 0x586a788, size 0x8e8, virtual false, abstract: false, final false
inline void AddEventsForLightGroup(int32_t  lightGroupId) ;

/// @brief Method AddInstantToggleEventsForLightGroup, addr 0x586b5f8, size 0x47c, virtual false, abstract: false, final false
inline void AddInstantToggleEventsForLightGroup(int32_t  lightGroupId) ;

/// @brief Method AddTestBox, addr 0x586ba74, size 0xa2c, virtual false, abstract: false, final false
inline void AddTestBox() ;

/// @brief Method AddToggleEventsForLightGroup, addr 0x586b070, size 0x588, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x5869d88, size 0x144, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x5869ed4, size 0x8b4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x586c4ac, size 0xacc, virtual false, abstract: false, final false
inline void _ctor() ;
