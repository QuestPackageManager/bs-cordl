...
public:
  ...
  /// @brief Method ConvertBeatToTime, addr 0x3ba3b58, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ba0ec8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddEventsForLightGroup>b__0, addr 0x3ba3b70, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba34dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddInstantToggleEventsForLightGroup>b__0, addr 0x3ba3ba0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba34e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddToggleEventsForLightGroup>b__0, addr 0x3ba3bd0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba34ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddEventsForLightGroup, addr 0x3ba17d0, size 0x948, virtual false, abstract: false, final false
  inline void AddEventsForLightGroup(int32_t lightGroupId);

  /// @brief Method AddInstantToggleEventsForLightGroup, addr 0x3ba26a8, size 0x460, virtual false, abstract: false, final false
  inline void AddInstantToggleEventsForLightGroup(int32_t lightGroupId);

  /// @brief Method AddTestBox, addr 0x3ba2b08, size 0x9d4, virtual false, abstract: false, final false
  inline void AddTestBox();

  /// @brief Method AddToggleEventsForLightGroup, addr 0x3ba2118, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x3ba0d88, size 0x140, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3ba0ef0, size 0x8e0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ba34f4, size 0x664, virtual false, abstract: false, final false
  inline void _ctor();
