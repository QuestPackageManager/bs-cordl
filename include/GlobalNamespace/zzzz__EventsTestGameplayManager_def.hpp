...
public:
  ...
  /// @brief Method ConvertBeatToTime, addr 0x586b6cc, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5868620, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddEventsForLightGroup>b__0, addr 0x586b6e4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586abf4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddInstantToggleEventsForLightGroup>b__0, addr 0x586b714, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586abf8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddToggleEventsForLightGroup>b__0, addr 0x586b744, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586abfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddEventsForLightGroup, addr 0x5868edc, size 0x8e8, virtual false, abstract: false, final false
  inline void AddEventsForLightGroup(int32_t lightGroupId);

  /// @brief Method AddInstantToggleEventsForLightGroup, addr 0x5869d4c, size 0x47c, virtual false, abstract: false, final false
  inline void AddInstantToggleEventsForLightGroup(int32_t lightGroupId);

  /// @brief Method AddTestBox, addr 0x586a1c8, size 0xa2c, virtual false, abstract: false, final false
  inline void AddTestBox();

  /// @brief Method AddToggleEventsForLightGroup, addr 0x58697c4, size 0x588, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x58684dc, size 0x144, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5868628, size 0x8b4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x586ac00, size 0xacc, virtual false, abstract: false, final false
  inline void _ctor();
