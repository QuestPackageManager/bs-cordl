...
public:
  ...
  /// @brief Method ConvertBeatToTime, addr 0x25d5abc, size 0x18, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25d2dac, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <AddEventsForLightGroup>b__0, addr 0x25d5ad4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d5448, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddInstantToggleEventsForLightGroup>b__0, addr 0x25d5b04, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d5450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AddToggleEventsForLightGroup>b__0, addr 0x25d5b34, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d5458, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__beatmapEventDataBoxGroupLists,
                      put = __cordl_internal_set__beatmapEventDataBoxGroupLists))::ArrayW<::GlobalNamespace::BeatmapEventDataBoxGroupList*,
                                                                                          ::Array<::GlobalNamespace::BeatmapEventDataBoxGroupList*>*> _beatmapEventDataBoxGroupLists;
  ...
  /// @brief Method AddEventsForLightGroup, addr 0x25d3650, size 0x960, virtual false, abstract: false, final false
  inline void AddEventsForLightGroup(int32_t lightGroupId);

  /// @brief Method AddInstantToggleEventsForLightGroup, addr 0x25d4570, size 0x47c, virtual false, abstract: false, final false
  inline void AddInstantToggleEventsForLightGroup(int32_t lightGroupId);

  /// @brief Method AddTestBox, addr 0x25d49ec, size 0xa5c, virtual false, abstract: false, final false
  inline void AddTestBox();

  /// @brief Method AddToggleEventsForLightGroup, addr 0x25d3fb0, size 0x5c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x25d2c94, size 0x118, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x25d2dd4, size 0x87c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x25d5460, size 0x65c, virtual false, abstract: false, final false
  inline void _ctor();
