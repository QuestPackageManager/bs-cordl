...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::SongPackMasksModel_LocalizedText::*)()>(&::GlobalNamespace::SongPackMasksModel_LocalizedText::get_text)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x36416ac;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SongPackMasksModel_LocalizedText::*)(::StringW, bool)>(&::GlobalNamespace::SongPackMasksModel_LocalizedText::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x3641448;
...
::cordl_internals::setStaticField<::GlobalNamespace::SongPackMasksModel_LocalizedText, "empty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SongPackMasksModel_LocalizedText>::get>(std::forward<::GlobalNamespace::SongPackMasksModel_LocalizedText>(value));
}
...
return ::cordl_internals::getStaticField<::GlobalNamespace::SongPackMasksModel_LocalizedText, "empty", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SongPackMasksModel_LocalizedText>::get>();
}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SongPackMasksModel_MaskInfo::*)(::GlobalNamespace::SongPackMasksModel_LocalizedText, ::GlobalNamespace::SongPackMask)>(&::GlobalNamespace::SongPackMasksModel_MaskInfo::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x3641454;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SongPackMasksModel_MaskInfo>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::SongPackMasksModel_LocalizedText>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::SongPackMask>::get()}
                    )));
    return ___internal_method;
  }
};
...
// Ctor Parameters [CppParam { name: "localizedText", ty: "::GlobalNamespace::SongPackMasksModel_LocalizedText", modifiers: "", def_value: Some("{}") }, CppParam { name: "mask", ty: "::GlobalNamespace::SongPackMask", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::SongPackMasksModel_MaskInfo::SongPackMasksModel_MaskInfo(::GlobalNamespace::SongPackMasksModel_LocalizedText  localizedText, ::GlobalNamespace::SongPackMask  mask) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SongPackMasksModel::*)(::GlobalNamespace::SongPackMasksModelSO*, ::GlobalNamespace::BeatmapLevelsModel*)>(&::GlobalNamespace::SongPackMasksModel::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3640bc4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SongPackMasksModel::*)()>(&::GlobalNamespace::SongPackMasksModel::Init)> {
  ...
  constexpr static std::size_t addrs = 0x3640c60;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::SongPackMasksModel_LocalizedText (::GlobalNamespace::SongPackMasksModel::*)(::StringW)>(&::GlobalNamespace::SongPackMasksModel::ToLocalizedName)> {
  constexpr static std::size_t size = 0xb8;
  constexpr static std::size_t addrs = 0x3641464;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::SongPackMask (::GlobalNamespace::SongPackMasksModel::*)(::StringW)>(&::GlobalNamespace::SongPackMasksModel::ToSongPackMask)> {
  ...
  constexpr static std::size_t addrs = 0x36411c4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::SongPackMasksModel_LocalizedText (::GlobalNamespace::SongPackMasksModel::*)(::GlobalNamespace::SongPackMask)>(&::GlobalNamespace::SongPackMasksModel::GetSongPackMaskText)> {
  constexpr static std::size_t size = 0x88;
  constexpr static std::size_t addrs = 0x364151c;
...
constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::SongPackMasksModel_MaskInfo>*& GlobalNamespace::SongPackMasksModel::__cordl_internal_get__songPackSerializedNameToMaskInfoDict()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____songPackSerializedNameToMaskInfoDict;
}
constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::SongPackMasksModel_MaskInfo>* const& GlobalNamespace::SongPackMasksModel::__cordl_internal_get__songPackSerializedNameToMaskInfoDict() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____songPackSerializedNameToMaskInfoDict;
}
constexpr void GlobalNamespace::SongPackMasksModel::__cordl_internal_set__songPackSerializedNameToMaskInfoDict(::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::SongPackMasksModel_MaskInfo>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SongPackMask,::StringW>* const& GlobalNamespace::SongPackMasksModel::__cordl_internal_get__songPackMaskToSerializedNameDict() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____songPackMaskToSerializedNameDict;
}
...
::cordl_internals::setStaticField<::GlobalNamespace::SongPackMasksModel_MaskInfo, "kEmptyMaskInfo", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SongPackMasksModel*>::get>(std::forward<::GlobalNamespace::SongPackMasksModel_MaskInfo>(value));
}
inline ::GlobalNamespace::SongPackMasksModel_MaskInfo GlobalNamespace::SongPackMasksModel::getStaticF_kEmptyMaskInfo()  {
return ::cordl_internals::getStaticField<::GlobalNamespace::SongPackMasksModel_MaskInfo, "kEmptyMaskInfo", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SongPackMasksModel*>::get>();
}
