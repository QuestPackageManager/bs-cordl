...
public:
  ...
  /// @brief Method WriteNet, addr 0xebecb0, size 0x174, virtual true, abstract: false, final true
  inline void WriteNet(::LiteNetLib::NetLogLevel level, ::StringW str, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> args);

  /// @brief Method .ctor, addr 0xebee24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
