...
public:
  ...
  /// @brief Method get_isPartyOwner addr 0x235b85c size 0x8 virtual true final true
  inline bool get_isPartyOwner();

  /// @brief Method set_isPartyOwner addr 0x235b864 size 0xc virtual true final true
  inline void set_isPartyOwner(bool value);

  /// @brief Method get_isActive addr 0x235b870 size 0x8 virtual true final true
  inline bool get_isActive();

  /// @brief Method set_isActive addr 0x235b878 size 0xc virtual true final true
  inline void set_isActive(bool value);

  /// @brief Method get_isReady addr 0x235b884 size 0x8 virtual true final true
  inline bool get_isReady();

  /// @brief Method set_isReady addr 0x235b88c size 0xc virtual true final true
  inline void set_isReady(bool value);

  /// @brief Method get_isInLobby addr 0x235b898 size 0x8 virtual true final true
  inline bool get_isInLobby();

  /// @brief Method set_isInLobby addr 0x235b8a0 size 0xc virtual true final true
  inline void set_isInLobby(bool value);

  static inline ::GlobalNamespace::LobbyPlayerData* New_ctor();

  /// @brief Method .ctor addr 0x235b8ac size 0x4 virtual false final false
  inline void _ctor();
