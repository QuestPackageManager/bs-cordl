...
public:
  ...
  /// @brief Method Deserialize, addr 0x326e578, size 0x20, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x326e5f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x326e5a0, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x326e564, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x326e600, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x326e520, size 0x44, virtual false, abstract: false, final false
