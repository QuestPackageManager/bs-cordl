...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerStatePacket*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerStatePacket*, "", "PlayerStatePacket");
...
public:
  ...
  /// @brief Method Deserialize, addr 0x332db54, size 0x20, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x332dbd4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x332db7c, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x332db40, size 0xc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x332dbdc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x332dafc, size 0x44, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerStatePacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerStatePacket(PlayerStatePacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerStatePacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerStatePacket(PlayerStatePacketconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::PlayerStatePacket) == 0x20, "Size mismatch!");
