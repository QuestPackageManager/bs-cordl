...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5880468, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeCallback, addr 0x58801ac, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x587fcfc, size 0x3e0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x58803dc, size 0xc, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method Resume, addr 0x58803e8, size 0x8, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method Start, addr 0x587f92c, size 0x3d0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58800dc, size 0xd0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58803f0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_connectedPlayerNoteWasCutEvent, addr 0x587f62c, size 0xc0, virtual true, abstract: false, final true
  inline void add_connectedPlayerNoteWasCutEvent(::System::Action_1<::GlobalNamespace::NoteCutInfoNetSerializable*>* value);

  /// @brief Method add_connectedPlayerNoteWasMissedEvent, addr 0x587f7ac, size 0xc0, virtual true, abstract: false, final true
  inline void add_connectedPlayerNoteWasMissedEvent(::System::Action_1<::GlobalNamespace::NoteMissInfoNetSerializable*>* value);

  /// @brief Method add_connectedPlayerNoteWasSpawnedEvent, addr 0x587f1ac, size 0xc0, virtual true, abstract: false, final true
  inline void add_connectedPlayerNoteWasSpawnedEvent(::System::Action_1<::GlobalNamespace::NoteSpawnInfoNetSerializable*>* value);

  /// @brief Method add_connectedPlayerObstacleWasSpawnedEvent, addr 0x587f32c, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_connectedPlayerSliderWasSpawnedEvent, addr 0x587f4ac, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_connectedPlayerNoteWasCutEvent, addr 0x587f6ec, size 0xc0, virtual true, abstract: false, final true
  inline void remove_connectedPlayerNoteWasCutEvent(::System::Action_1<::GlobalNamespace::NoteCutInfoNetSerializable*>* value);

  /// @brief Method remove_connectedPlayerNoteWasMissedEvent, addr 0x587f86c, size 0xc0, virtual true, abstract: false, final true
  inline void remove_connectedPlayerNoteWasMissedEvent(::System::Action_1<::GlobalNamespace::NoteMissInfoNetSerializable*>* value);

  /// @brief Method remove_connectedPlayerNoteWasSpawnedEvent, addr 0x587f26c, size 0xc0, virtual true, abstract: false, final true
  inline void remove_connectedPlayerNoteWasSpawnedEvent(::System::Action_1<::GlobalNamespace::NoteSpawnInfoNetSerializable*>* value);

  /// @brief Method remove_connectedPlayerObstacleWasSpawnedEvent, addr 0x587f3ec, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_connectedPlayerSliderWasSpawnedEvent, addr 0x587f56c, size 0xc0, virtual true, abstract: false, final true
