...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x26ee9c0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method InvokeCallback, addr 0x26ee720, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x26ee298, size 0x3c8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x26ee930, size 0xc, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method Resume, addr 0x26ee93c, size 0x8, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method Start, addr 0x26edee0, size 0x3b8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x26ee660, size 0xc0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x26ee944, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_connectedPlayerNoteWasCutEvent, addr 0x26edc20, size 0xb0, virtual true, abstract: false, final true
  inline void add_connectedPlayerNoteWasCutEvent(::System::Action_1<::GlobalNamespace::NoteCutInfoNetSerializable*>* value);

  /// @brief Method add_connectedPlayerNoteWasMissedEvent, addr 0x26edd80, size 0xb0, virtual true, abstract: false, final true
  inline void add_connectedPlayerNoteWasMissedEvent(::System::Action_1<::GlobalNamespace::NoteMissInfoNetSerializable*>* value);

  /// @brief Method add_connectedPlayerNoteWasSpawnedEvent, addr 0x26ed800, size 0xb0, virtual true, abstract: false, final true
  inline void add_connectedPlayerNoteWasSpawnedEvent(::System::Action_1<::GlobalNamespace::NoteSpawnInfoNetSerializable*>* value);

  /// @brief Method add_connectedPlayerObstacleWasSpawnedEvent, addr 0x26ed960, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_connectedPlayerSliderWasSpawnedEvent, addr 0x26edac0, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_connectedPlayerNoteWasCutEvent, addr 0x26edcd0, size 0xb0, virtual true, abstract: false, final true
  inline void remove_connectedPlayerNoteWasCutEvent(::System::Action_1<::GlobalNamespace::NoteCutInfoNetSerializable*>* value);

  /// @brief Method remove_connectedPlayerNoteWasMissedEvent, addr 0x26ede30, size 0xb0, virtual true, abstract: false, final true
  inline void remove_connectedPlayerNoteWasMissedEvent(::System::Action_1<::GlobalNamespace::NoteMissInfoNetSerializable*>* value);

  /// @brief Method remove_connectedPlayerNoteWasSpawnedEvent, addr 0x26ed8b0, size 0xb0, virtual true, abstract: false, final true
  inline void remove_connectedPlayerNoteWasSpawnedEvent(::System::Action_1<::GlobalNamespace::NoteSpawnInfoNetSerializable*>* value);

  /// @brief Method remove_connectedPlayerObstacleWasSpawnedEvent, addr 0x26eda10, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_connectedPlayerSliderWasSpawnedEvent, addr 0x26edb70, size 0xb0, virtual true, abstract: false, final true
