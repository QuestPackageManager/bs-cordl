...
public:
  ...
  /// @brief Method OnDisable, addr 0x572ce64, size 0x30, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x572ca64, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572ce94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
