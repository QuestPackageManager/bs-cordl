...
public:
  ...
  /// @brief Method OnDisable, addr 0x5d1aad8, size 0xe8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5d1a9f0, size 0xe8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnFusionToggleChanged, addr 0x5d1afbc, size 0xb0, virtual false, abstract: false, final false
  inline void OnFusionToggleChanged(bool newValue);

  /// @brief Method Update, addr 0x5d1abc0, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateLineRenderer, addr 0x5d1abc4, size 0x50, virtual false, abstract: false, final false
  inline void UpdateLineRenderer();

  /// @brief Method UpdateLineRendererForHand, addr 0x5d1ac14, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d1b06c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
