...
public:
  // Declarations
  /// @brief Method ToTrackingSpacePose addr 0x27119bc size 0x12c virtual false final false
  static inline ::GlobalNamespace::OVRPose ToTrackingSpacePose(::UnityEngine::Transform* transform, ::UnityEngine::Camera* camera);

  /// @brief Method ToWorldSpacePose addr 0x271947c size 0x50 virtual false final false
  static inline ::GlobalNamespace::OVRPose ToWorldSpacePose(::GlobalNamespace::OVRPose trackingSpacePose);

  /// @brief Method ToWorldSpacePose addr 0x270cf7c size 0x1b8 virtual false final false
  ...
  /// @brief Method ToNonAlloc addr 0x0 size 0xffffffffffffffff virtual false final false
  ...
  /// @brief Method ToNativeArray addr 0x0 size 0xffffffffffffffff virtual false final false
