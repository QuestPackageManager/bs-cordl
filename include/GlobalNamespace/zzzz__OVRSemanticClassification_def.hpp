...
/// @brief Method Awake, addr 0x5d22e4c, size 0xd8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method Contains, addr 0x5d22d34, size 0x118, virtual false, abstract: false, final false
inline bool Contains(::StringW  label) ;

/// @brief Method IOVRSceneComponent.Initialize, addr 0x5d22f24, size 0x150, virtual true, abstract: false, final true
inline void IOVRSceneComponent_Initialize() ;

static inline ::GlobalNamespace::OVRSemanticClassification* New_ctor() ;

/// @brief Method ValidateAndUpgradeLabels, addr 0x5d23074, size 0x458, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d234cc, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_Labels, addr 0x5d22d2c, size 0x8, virtual false, abstract: false, final false
