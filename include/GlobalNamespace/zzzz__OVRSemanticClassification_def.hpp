...
public:
  ...
  /// @brief Method get_Labels, addr 0x27a77c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::StringW>* get_Labels();

  /// @brief Method Contains, addr 0x27a77c8, size 0x160, virtual false, abstract: false, final false
  inline bool Contains(::StringW label);

  /// @brief Method Awake, addr 0x27a7928, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method IOVRSceneComponent.Initialize, addr 0x27a79f8, size 0x11c, virtual true, abstract: false, final true
  inline void IOVRSceneComponent_Initialize();

  static inline ::GlobalNamespace::OVRSemanticClassification* New_ctor();

  /// @brief Method .ctor, addr 0x27a7b14, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
