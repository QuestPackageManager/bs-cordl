...
public:
  ...
  /// @brief Method MoveNext, addr 0x402a864, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x402a8fc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x402a904, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x402a93c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x402a860, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x402a838, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyOverride, addr 0x402a664, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Enqueue, addr 0x40299e8, size 0x198, virtual false, abstract: false, final false
  inline void Enqueue(::UnityEngine::Transform* interactorRootTransform, ::GlobalNamespace::OVRPlugin_Posef interactorRootPose);

  /// @brief Method LateApply, addr 0x40297c8, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x402a7a0, size 0x98, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method RevertInteractorOverrides, addr 0x402a740, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x402a3a8, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x402aa58, size 0xd0, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::OVRVirtualKeyboard_BaseInputSource* New_ctor();

  /// @brief Method OnUpdatedAnchors, addr 0x402aa34, size 0xc, virtual false, abstract: false, final false
  inline void OnUpdatedAnchors(::GlobalNamespace::OVRCameraRig* obj);

  /// @brief Method Update, addr 0x402aa40, size 0x18, virtual true, abstract: false, final true
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x402a944, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method UpdateInput, addr 0x402ab88, size 0x18c, virtual true, abstract: false, final false
  inline void UpdateInput();
  ...
  /// @brief Method .ctor, addr 0x4029b80, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TriggerIsPressed, addr 0x402ab28, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <UpdateInput>b__6_0, addr 0x402b0a0, size 0x20, virtual false, abstract: false, final false
  inline bool _UpdateInput_b__6_0(::GlobalNamespace::OVRBone* b);

  /// @brief Method <UpdateInput>b__6_1, addr 0x402b0c0, size 0x20, virtual false, abstract: false, final false
  inline bool _UpdateInput_b__6_1(::GlobalNamespace::OVRBone* b);

  /// @brief Method .ctor, addr 0x402b098, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method UpdateInput, addr 0x402ad14, size 0x328, virtual true, abstract: false, final false
  inline void UpdateInput();
  ...
  /// @brief Method .ctor, addr 0x4029be0, size 0x1bc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <LoadRuntimeVirtualKeyboardMesh>b__68_0, addr 0x402b144, size 0x8c, virtual false, abstract: false, final false
  inline bool _LoadRuntimeVirtualKeyboardMesh_b__68_0(::StringW p);

  /// @brief Method <PopulateCollision>b__70_0, addr 0x402b1d0, size 0x68, virtual false, abstract: false, final false
  inline bool _PopulateCollision_b__70_0(::UnityEngine::MeshFilter* mesh);

  /// @brief Method .ctor, addr 0x402b13c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyHideFlags, addr 0x4028664, size 0x7c, virtual false, abstract: false, final false
  static inline void ApplyHideFlags(::UnityEngine::Transform* t);

  /// @brief Method Awake, addr 0x40267cc, size 0x51c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ChangeTextContext, addr 0x40281a8, size 0xe0, virtual false, abstract: false, final false
  inline void ChangeTextContext(::StringW textContext);

  /// @brief Method ChangeTextContextInternal, addr 0x4026714, size 0xb8, virtual false, abstract: false, final false
  inline void ChangeTextContextInternal(::StringW textContext);

  /// @brief Method ComputeLocation, addr 0x4027684, size 0xb8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_VirtualKeyboardLocationInfo ComputeLocation(::UnityEngine::Transform* transform);

  /// @brief Method DestroyKeyboard, addr 0x4026fe0, size 0x15c, virtual false, abstract: false, final false
  inline void DestroyKeyboard();

  /// @brief Method HideKeyboard, addr 0x402744c, size 0x14, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method LateUpdate, addr 0x40297ac, size 0x1c, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LoadRuntimeVirtualKeyboardMesh, addr 0x4028288, size 0x3dc, virtual false, abstract: false, final false
  inline bool LoadRuntimeVirtualKeyboardMesh();

  /// @brief Method MaxElement, addr 0x4028ab8, size 0x14, virtual false, abstract: false, final false
  inline float_t MaxElement(::UnityEngine::Vector3 vec);

  static inline ::GlobalNamespace::OVRVirtualKeyboard* New_ctor();

  /// @brief Method OnBackspace, addr 0x4029fac, size 0x238, virtual false, abstract: false, final false
  inline void OnBackspace();

  /// @brief Method OnCommitText, addr 0x4029d9c, size 0x200, virtual false, abstract: false, final false
  inline void OnCommitText(::StringW text);

  /// @brief Method OnDestroy, addr 0x4026ce8, size 0x2f8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x4027448, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x402713c, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnEnter, addr 0x402a1e4, size 0xd8, virtual false, abstract: false, final false
  inline void OnEnter();

  /// @brief Method OnEvent, addr 0x4028078, size 0x130, virtual true, abstract: false, final true
  inline void OnEvent(::GlobalNamespace::OVRPlugin_EventDataBuffer eventDataBuffer);

  /// @brief Method OnKeyboardHidden, addr 0x402a2d4, size 0x14, virtual false, abstract: false, final false
  inline void OnKeyboardHidden();

  /// @brief Method OnKeyboardShown, addr 0x402a2bc, size 0x18, virtual false, abstract: false, final false
  inline void OnKeyboardShown();

  /// @brief Method OnTextCommitFieldChange, addr 0x4029f9c, size 0x10, virtual false, abstract: false, final false
  inline void OnTextCommitFieldChange(::StringW textContext);

  /// @brief Method PopulateCollision, addr 0x40286e0, size 0x22c, virtual false, abstract: false, final false
  inline void PopulateCollision();

  /// @brief Method SendVirtualKeyboardDirectInput, addr 0x4027fb0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method SendVirtualKeyboardInput, addr 0x4027db8, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method SendVirtualKeyboardRayInput, addr 0x4027a00, size 0x3b8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetKeyboardVisibility, addr 0x4028964, size 0x154, virtual false, abstract: false, final false
  inline void SetKeyboardVisibility(bool visible);

  /// @brief Method ShowKeyboard, addr 0x4027140, size 0x308, virtual false, abstract: false, final false
  inline void ShowKeyboard();

  /// @brief Method SyncKeyboardLocation, addr 0x402773c, size 0x2c4, virtual false, abstract: false, final false
  inline void SyncKeyboardLocation();

  /// @brief Method Update, addr 0x4028acc, size 0x30, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateAnimationState, addr 0x4029034, size 0x778, virtual false, abstract: false, final false
  inline void UpdateAnimationState();

  /// @brief Method UpdateInputs, addr 0x4028afc, size 0x538, virtual false, abstract: false, final false
  inline void UpdateInputs();

  /// @brief Method UpdateVisibleState, addr 0x402890c, size 0x58, virtual false, abstract: false, final false
  inline void UpdateVisibleState();

  /// @brief Method UseSuggestedLocation, addr 0x4027460, size 0x224, virtual false, abstract: false, final false
  inline void UseSuggestedLocation(::GlobalNamespace::OVRVirtualKeyboard_KeyboardPosition position);

  /// @brief Method <LoadRuntimeVirtualKeyboardMesh>b__68_1, addr 0x402a43c, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x402a2e8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_Backspace, addr 0x402605c, size 0x9c, virtual false, abstract: false, final false
  inline void add_Backspace(::System::Action* value);

  /// @brief Method add_CommitText, addr 0x4025efc, size 0xb0, virtual false, abstract: false, final false
  inline void add_CommitText(::System::Action_1<::StringW>* value);

  /// @brief Method add_Enter, addr 0x4026194, size 0x9c, virtual false, abstract: false, final false
  inline void add_Enter(::System::Action* value);

  /// @brief Method add_KeyboardHidden, addr 0x4026404, size 0x9c, virtual false, abstract: false, final false
  inline void add_KeyboardHidden(::System::Action* value);

  /// @brief Method add_KeyboardShown, addr 0x40262cc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Collider, addr 0x402653c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Collider> get_Collider();

  /// @brief Method get_TextCommitField, addr 0x402654c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_Backspace, addr 0x40260f8, size 0x9c, virtual false, abstract: false, final false
  inline void remove_Backspace(::System::Action* value);

  /// @brief Method remove_CommitText, addr 0x4025fac, size 0xb0, virtual false, abstract: false, final false
  inline void remove_CommitText(::System::Action_1<::StringW>* value);

  /// @brief Method remove_Enter, addr 0x4026230, size 0x9c, virtual false, abstract: false, final false
  inline void remove_Enter(::System::Action* value);

  /// @brief Method remove_KeyboardHidden, addr 0x40264a0, size 0x9c, virtual false, abstract: false, final false
  inline void remove_KeyboardHidden(::System::Action* value);

  /// @brief Method remove_KeyboardShown, addr 0x4026368, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Collider, addr 0x4026544, size 0x8, virtual false, abstract: false, final false
  inline void set_Collider(::UnityEngine::Collider* value);

  /// @brief Method set_TextCommitField, addr 0x4026554, size 0x1c0, virtual false, abstract: false, final false
