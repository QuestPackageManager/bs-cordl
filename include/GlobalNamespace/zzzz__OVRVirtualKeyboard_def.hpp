...
public:
  ...
  /// @brief Method .ctor addr 0x279e4f0 size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x279e518 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x279e51c size 0x9c virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x279e5b8 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x279e5c0 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x279e600 size 0x8 virtual true final true
...
public:
  ...
  /// @brief Method Enqueue addr 0x279d634 size 0x1cc virtual false final false
  inline void Enqueue(::UnityEngine::Transform* interactorRootTransform, ::GlobalNamespace::__OVRPlugin__Posef interactorRootPose);

  /// @brief Method LateApply addr 0x279d3f8 size 0x23c virtual false final false
  inline void LateApply(::UnityEngine::MonoBehaviour* coroutineRunner);

  /// @brief Method Reset addr 0x279e450 size 0xa0 virtual false final false
  inline void Reset();

  /// @brief Method RevertInteractorOverrides addr 0x279e3e8 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerator* RevertInteractorOverrides();

  /// @brief Method ApplyOverride addr 0x279e30c size 0xdc virtual false final false
  ...
  /// @brief Method .ctor addr 0x279e03c size 0xa0 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor addr 0x279e608 size 0xf4 virtual false final false
  inline void _ctor();

  /// @brief Method OnUpdatedAnchors addr 0x279e6fc size 0xc virtual false final false
  inline void OnUpdatedAnchors(::GlobalNamespace::OVRCameraRig* obj);

  /// @brief Method Update addr 0x279e708 size 0x18 virtual true final true
  inline void Update();

  /// @brief Method UpdateInput addr 0x0 size 0xffffffffffffffff virtual true final false
  inline void UpdateInput();

  /// @brief Method Dispose addr 0x279e720 size 0xd4 virtual true final true
  inline void Dispose();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7598)), TypeDefinitionIndex(TypeDefinitionIndex(7588)), TypeDefinitionIndex(TypeDefinitionIndex(8052)),
// TypeDefinitionIndex(TypeDefinitionIndex(8050))} Self: TypeDefinitionIndex(TypeDefinitionIndex(8053)) CS Name: ::OVRVirtualKeyboard::ControllerInputSource*
...
public:
  ...
  /// @brief Method get_TriggerIsPressed addr 0x279e7f4 size 0x60 virtual false final false
  ...
  /// @brief Method .ctor addr 0x279d800 size 0x68 virtual false final false
  ...
  /// @brief Method UpdateInput addr 0x279e854 size 0x18c virtual true final false
  inline void UpdateInput();
...
public:
  ...
  /// @brief Method .ctor addr 0x279ed78 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <UpdateInput>b__6_0 addr 0x279ed80 size 0x20 virtual false final false
  inline bool _UpdateInput_b__6_0(::GlobalNamespace::OVRBone* b);

  /// @brief Method <UpdateInput>b__6_1 addr 0x279eda0 size 0x20 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x279d868 size 0x1c4 virtual false final false
  ...
  /// @brief Method UpdateInput addr 0x279e9e0 size 0x334 virtual true final false
  inline void UpdateInput();
...
public:
  ...
  /// @brief Method .ctor addr 0x279ee24 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <LoadRuntimeVirtualKeyboardMesh>b__68_0 addr 0x279ee2c size 0x8c virtual false final false
  inline bool _LoadRuntimeVirtualKeyboardMesh_b__68_0(::StringW p);

  /// @brief Method <PopulateCollision>b__70_0 addr 0x279eeb8 size 0x68 virtual false final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8046)), TypeDefinitionIndex(TypeDefinitionIndex(10225)), TypeDefinitionIndex(TypeDefinitionIndex(7567))}
...
public:
  ...
  /// @brief Method add_CommitText addr 0x2799bc4 size 0xb0 virtual false final false
  inline void add_CommitText(::System::Action_1<::StringW>* value);

  /// @brief Method remove_CommitText addr 0x2799c74 size 0xb0 virtual false final false
  inline void remove_CommitText(::System::Action_1<::StringW>* value);

  /// @brief Method add_Backspace addr 0x2799d24 size 0x9c virtual false final false
  inline void add_Backspace(::System::Action* value);

  /// @brief Method remove_Backspace addr 0x2799dc0 size 0x9c virtual false final false
  inline void remove_Backspace(::System::Action* value);

  /// @brief Method add_Enter addr 0x2799e5c size 0x9c virtual false final false
  inline void add_Enter(::System::Action* value);

  /// @brief Method remove_Enter addr 0x2799ef8 size 0x9c virtual false final false
  inline void remove_Enter(::System::Action* value);

  /// @brief Method add_KeyboardShown addr 0x2799f94 size 0x9c virtual false final false
  inline void add_KeyboardShown(::System::Action* value);

  /// @brief Method remove_KeyboardShown addr 0x279a030 size 0x9c virtual false final false
  inline void remove_KeyboardShown(::System::Action* value);

  /// @brief Method add_KeyboardHidden addr 0x279a0cc size 0x9c virtual false final false
  inline void add_KeyboardHidden(::System::Action* value);

  /// @brief Method remove_KeyboardHidden addr 0x279a168 size 0x9c virtual false final false
  inline void remove_KeyboardHidden(::System::Action* value);

  /// @brief Method get_Collider addr 0x279a204 size 0x8 virtual false final false
  inline ::UnityEngine::Collider* get_Collider();

  /// @brief Method set_Collider addr 0x279a20c size 0x8 virtual false final false
  inline void set_Collider(::UnityEngine::Collider* value);

  /// @brief Method get_TextCommitField addr 0x279a214 size 0x8 virtual false final false
  inline ::UnityEngine::UI::InputField* get_TextCommitField();

  /// @brief Method set_TextCommitField addr 0x279a21c size 0x1c4 virtual false final false
  inline void set_TextCommitField(::UnityEngine::UI::InputField* value);

  /// @brief Method Awake addr 0x279a498 size 0x524 virtual false final false
  inline void Awake();

  /// @brief Method OnDestroy addr 0x279a9bc size 0x2fc virtual false final false
  inline void OnDestroy();

  /// @brief Method OnEnable addr 0x279ae14 size 0x4 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x279b12c size 0x4 virtual false final false
  inline void OnDisable();

  /// @brief Method UseSuggestedLocation addr 0x279b144 size 0x224 virtual false final false
  inline void UseSuggestedLocation(::GlobalNamespace::__OVRVirtualKeyboard__KeyboardPosition position);

  /// @brief Method SendVirtualKeyboardRayInput addr 0x279b6dc size 0x328 virtual false final false
  ...
  /// @brief Method SendVirtualKeyboardDirectInput addr 0x279bc1c size 0xd0 virtual false final false
  ...
  /// @brief Method OnEvent addr 0x279bcec size 0x130 virtual true final true
  inline void OnEvent(::GlobalNamespace::__OVRPlugin__EventDataBuffer eventDataBuffer);

  /// @brief Method ChangeTextContext addr 0x279be1c size 0xe0 virtual false final false
  inline void ChangeTextContext(::StringW textContext);

  /// @brief Method LoadRuntimeVirtualKeyboardMesh addr 0x279befc size 0x3d8 virtual false final false
  inline bool LoadRuntimeVirtualKeyboardMesh();

  /// @brief Method ApplyHideFlags addr 0x279c2d4 size 0x7c virtual false final false
  static inline void ApplyHideFlags(::UnityEngine::Transform* t);

  /// @brief Method PopulateCollision addr 0x279c350 size 0x224 virtual false final false
  inline void PopulateCollision();

  /// @brief Method ShowKeyboard addr 0x279ae18 size 0x314 virtual false final false
  inline void ShowKeyboard();

  /// @brief Method SetKeyboardVisibility addr 0x279c5cc size 0x150 virtual false final false
  inline void SetKeyboardVisibility(bool visible);

  /// @brief Method HideKeyboard addr 0x279b130 size 0x14 virtual false final false
  inline void HideKeyboard();

  /// @brief Method DestroyKeyboard addr 0x279acb8 size 0x15c virtual false final false
  inline void DestroyKeyboard();

  /// @brief Method MaxElement addr 0x279c71c size 0x14 virtual false final false
  inline float_t MaxElement(::UnityEngine::Vector3 vec);

  /// @brief Method ComputeLocation addr 0x279b368 size 0xb8 virtual false final false
  inline ::GlobalNamespace::__OVRPlugin__VirtualKeyboardLocationInfo ComputeLocation(::UnityEngine::Transform* transform);

  /// @brief Method Update addr 0x279c730 size 0x30 virtual false final false
  inline void Update();

  /// @brief Method LateUpdate addr 0x279d3dc size 0x1c virtual false final false
  inline void LateUpdate();

  /// @brief Method SendVirtualKeyboardInput addr 0x279ba04 size 0x218 virtual false final false
  ...
  /// @brief Method UpdateInputs addr 0x279c760 size 0x524 virtual false final false
  inline void UpdateInputs();

  /// @brief Method SyncKeyboardLocation addr 0x279b420 size 0x2bc virtual false final false
  inline void SyncKeyboardLocation();

  /// @brief Method UpdateAnimationState addr 0x279cc84 size 0x758 virtual false final false
  inline void UpdateAnimationState();

  /// @brief Method OnCommitText addr 0x279da2c size 0x200 virtual false final false
  inline void OnCommitText(::StringW text);

  /// @brief Method OnTextCommitFieldChange addr 0x279dc2c size 0x10 virtual false final false
  inline void OnTextCommitFieldChange(::StringW textContext);

  /// @brief Method ChangeTextContextInternal addr 0x279a3e0 size 0xb8 virtual false final false
  inline void ChangeTextContextInternal(::StringW textContext);

  /// @brief Method OnBackspace addr 0x279dc3c size 0x238 virtual false final false
  inline void OnBackspace();

  /// @brief Method OnEnter addr 0x279de74 size 0xd8 virtual false final false
  inline void OnEnter();

  /// @brief Method OnKeyboardShown addr 0x279df4c size 0x18 virtual false final false
  inline void OnKeyboardShown();

  /// @brief Method OnKeyboardHidden addr 0x279df64 size 0x14 virtual false final false
  inline void OnKeyboardHidden();

  /// @brief Method UpdateVisibleState addr 0x279c574 size 0x58 virtual false final false
  inline void UpdateVisibleState();

  static inline ::GlobalNamespace::OVRVirtualKeyboard* New_ctor();

  /// @brief Method .ctor addr 0x279df78 size 0xc4 virtual false final false
  inline void _ctor();

  /// @brief Method <LoadRuntimeVirtualKeyboardMesh>b__68_1 addr 0x279e0dc size 0x230 virtual false final false
