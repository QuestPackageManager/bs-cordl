...
public:
  ...
  /// @brief Method Apply, addr 0x3b2eba0, size 0x18, virtual true, abstract: false, final true
  inline void Apply(::GlobalNamespace::SceneType sceneType, ::StringW optionalEnvironmentSerializedName);

  /// @brief Method ApplyGraphicsSettings, addr 0x3b2ebb8, size 0x30, virtual false, abstract: false, final false
  inline void ApplyGraphicsSettings(::GlobalNamespace::SceneType sceneType, ::StringW optionalEnvironmentSerializedName);

  /// @brief Method ApplyMainSettings, addr 0x3b2ebe8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b2ed08, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
