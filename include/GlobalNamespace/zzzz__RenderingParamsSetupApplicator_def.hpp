...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RenderingParamsSetupApplicator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RenderingParamsSetupApplicator(RenderingParamsSetupApplicator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RenderingParamsSetupApplicator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RenderingParamsSetupApplicator(RenderingParamsSetupApplicatorconst&) = delete;
