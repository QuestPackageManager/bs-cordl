...
public:
  ...
  /// @brief Method LazyInitializeMaterials, addr 0x2953274, size 0xbc, virtual false, abstract: false, final false
  inline void LazyInitializeMaterials();

  static inline ::GlobalNamespace::KawaseBloomMainEffectSO* New_ctor();

  /// @brief Method OnDisable, addr 0x2953330, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2953258, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PreRender, addr 0x2953350, size 0x64, virtual true, abstract: false, final false
  inline void PreRender();

  /// @brief Method Render, addr 0x295343c, size 0x210, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x295364c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_hasPostProcessEffect, addr 0x2953250, size 0x8, virtual true, abstract: false, final false
