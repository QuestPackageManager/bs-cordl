...
public:
  ...
  /// @brief Method FixedUpdate, addr 0x58640ac, size 0x140, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate, addr 0x58641ec, size 0x48, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::FlyingGameHUDRotation* New_ctor();

  /// @brief Method Start, addr 0x5863fcc, size 0xe0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5864234, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
