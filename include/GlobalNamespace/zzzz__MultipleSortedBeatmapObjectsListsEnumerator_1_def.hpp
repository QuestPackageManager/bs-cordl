...
/// @brief Field <node>5__2, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__node_5__2, put=__cordl_internal_set__node_5__2)) ::GlobalNamespace::MultipleSortedBeatmapObjectsListsEnumerator_1_BeatmapObjectListNode<T>*  _node_5__2;
...
/// @brief Field _priorityQueue, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__priorityQueue, put=__cordl_internal_set__priorityQueue)) ::Priority_Queue::StablePriorityQueue_1<::GlobalNamespace::MultipleSortedBeatmapObjectsListsEnumerator_1_BeatmapObjectListNode<T>*>*  _priorityQueue;
