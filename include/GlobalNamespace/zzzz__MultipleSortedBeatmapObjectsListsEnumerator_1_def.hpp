...
template <typename T> class __MultipleSortedBeatmapObjectsListsEnumerator_1__BeatmapObjectListNode;
}
namespace GlobalNamespace {
template <typename T> class __MultipleSortedBeatmapObjectsListsEnumerator_1___GetEnumerator_d__4;
}
...
template <typename T>
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15235))]
...
template <typename T>
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2507)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2507), inst: 5286
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(10729)) CS Name: ::MultipleSortedBeatmapObjectsListsEnumerator`1::<GetEnumerator>d__4<T>*
...
public:
  ...
  __cordl_internal_get__priorityQueue() const;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::__MultipleSortedBeatmapObjectsListsEnumerator_1__BeatmapObjectListNode, "",
