...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionSlider2DSelectableStateController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoTransitionSlider2DSelectableStateController(NoTransitionSlider2DSelectableStateController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionSlider2DSelectableStateController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoTransitionSlider2DSelectableStateController(NoTransitionSlider2DSelectableStateControllerconst&) = delete;
