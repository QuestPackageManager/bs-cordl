...
public:
  ...
  /// @brief Method get_levelID addr 0x12a0078 size 0x8 virtual false final false
  inline ::StringW get_levelID();

  /// @brief Method set_levelID addr 0x12a0080 size 0x8 virtual false final false
  inline void set_levelID(::StringW value);

  /// @brief Method get_beatmapCharacteristicSerializedName addr 0x12a0088 size 0x8 virtual false final false
  inline ::StringW get_beatmapCharacteristicSerializedName();

  /// @brief Method set_beatmapCharacteristicSerializedName addr 0x12a0090 size 0x8 virtual false final false
  inline void set_beatmapCharacteristicSerializedName(::StringW value);

  /// @brief Method get_difficulty addr 0x12a0098 size 0x8 virtual false final false
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method set_difficulty addr 0x12a00a0 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x12a00a8 size 0x8 virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x12a00b0 size 0x3c virtual false final false
  ...
  /// @brief Method LiteNetLib.Utils.INetSerializable.Deserialize addr 0x12a00ec size 0x50 virtual true final true
  inline void LiteNetLib_Utils_INetSerializable_Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method LiteNetLib.Utils.INetSerializable.Serialize addr 0x12a014c size 0x4c virtual true final true
  inline void LiteNetLib_Utils_INetSerializable_Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Equals addr 0x12a01a0 size 0x70 virtual true final true
  inline bool Equals(::GlobalNamespace::BeatmapIdentifierNetSerializable* other);

  /// @brief Method Equals addr 0x12a0210 size 0x10c virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x12a031c size 0x64 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method ToString addr 0x12a0380 size 0x90 virtual true final false
