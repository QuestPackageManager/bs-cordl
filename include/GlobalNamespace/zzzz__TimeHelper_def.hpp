...
public:
  ...
  /// @brief Method Awake, addr 0x39c361c, size 0x94, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FixedUpdate, addr 0x39c36b0, size 0x94, virtual false, abstract: false, final false
  inline void FixedUpdate();

  static inline ::GlobalNamespace::TimeHelper* New_ctor();

  /// @brief Method Update, addr 0x39c3744, size 0x170, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method __SetTime, addr 0x39c38b4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39c3900, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_deltaTime, addr 0x39c3448, size 0x48, virtual false, abstract: false, final false
  static inline float_t get_deltaTime();

  /// @brief Method get_fixedDeltaTime, addr 0x39c34e4, size 0x48, virtual false, abstract: false, final false
  static inline float_t get_fixedDeltaTime();

  /// @brief Method get_interpolationFactor, addr 0x39c3580, size 0x48, virtual false, abstract: false, final false
  static inline float_t get_interpolationFactor();

  /// @brief Method get_time, addr 0x39c33ac, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_deltaTime, addr 0x39c3490, size 0x54, virtual false, abstract: false, final false
  static inline void set_deltaTime(float_t value);

  /// @brief Method set_fixedDeltaTime, addr 0x39c352c, size 0x54, virtual false, abstract: false, final false
  static inline void set_fixedDeltaTime(float_t value);

  /// @brief Method set_interpolationFactor, addr 0x39c35c8, size 0x54, virtual false, abstract: false, final false
  static inline void set_interpolationFactor(float_t value);

  /// @brief Method set_time, addr 0x39c33f4, size 0x54, virtual false, abstract: false, final false
