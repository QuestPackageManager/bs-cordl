...
public:
  ...
  /// @brief Method Awake, addr 0x570d910, size 0x54, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method EncodeTimeAsVector, addr 0x570dac4, size 0x1c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 EncodeTimeAsVector(float_t time);

  /// @brief Method FixedUpdate, addr 0x570d964, size 0x90, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetFrameCount, addr 0x570da58, size 0x44, virtual false, abstract: false, final false
  inline int32_t GetFrameCount();

  /// @brief Method GetShaderTimeValue, addr 0x570da9c, size 0x28, virtual false, abstract: false, final false
  static inline float_t GetShaderTimeValue();

  static inline ::GlobalNamespace::TimeHelper* New_ctor();

  /// @brief Method SetCommandBufferTimeProperties, addr 0x570dae0, size 0xd8, virtual false, abstract: false, final false
  inline void SetCommandBufferTimeProperties(::UnityEngine::Rendering::CommandBuffer* commandBuffer);

  /// @brief Method SetTime, addr 0x570d1d0, size 0xe0, virtual false, abstract: false, final false
  inline void SetTime(float_t time);

  /// @brief Method Update, addr 0x570d9f4, size 0x64, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x570dbb8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_DeltaTime, addr 0x570d8c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_DeltaTime();

  /// @brief Method get_FixedDeltaTime, addr 0x570d8d8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_FixedDeltaTime();

  /// @brief Method get_InterpolationFactor, addr 0x570d8e8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_InterpolationFactor();

  /// @brief Method get_Time, addr 0x570d8b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Time();

  /// @brief Method get_TimeHelperOffset, addr 0x570d8f8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DeltaTime, addr 0x570d8d0, size 0x8, virtual false, abstract: false, final false
  inline void set_DeltaTime(float_t value);

  /// @brief Method set_FixedDeltaTime, addr 0x570d8e0, size 0x8, virtual false, abstract: false, final false
  inline void set_FixedDeltaTime(float_t value);

  /// @brief Method set_InterpolationFactor, addr 0x570d8f0, size 0x8, virtual false, abstract: false, final false
  inline void set_InterpolationFactor(float_t value);

  /// @brief Method set_Time, addr 0x570d8c0, size 0x8, virtual false, abstract: false, final false
  inline void set_Time(float_t value);

  /// @brief Method set_TimeHelperOffset, addr 0x570d904, size 0xc, virtual false, abstract: false, final false
