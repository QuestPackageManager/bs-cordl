...
// Write type traits
MARK_REF_T(::GlobalNamespace::IReadonlyCutScoreBuffer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IReadonlyCutScoreBuffer*, "", "IReadonlyCutScoreBuffer");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IReadonlyCutScoreBuffer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IReadonlyCutScoreBuffer(IReadonlyCutScoreBufferconst&) = delete;
