...
public:
  ...
  /// @brief Method HandleShowServerCodeButtonPressed, addr 0x26895b4, size 0x10, virtual false, abstract: false, final false
  inline void HandleShowServerCodeButtonPressed();

  static inline ::GlobalNamespace::ServerCodeView* New_ctor();

  /// @brief Method OnDisable, addr 0x2689598, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2689500, size 0x98, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshText, addr 0x2689460, size 0xa0, virtual false, abstract: false, final false
  inline void RefreshText(bool showCode);

  /// @brief Method SetCode, addr 0x2689454, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26895c4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
