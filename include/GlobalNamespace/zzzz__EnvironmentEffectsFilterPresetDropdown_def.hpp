...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4621)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5602), inst: 4736 }),
// TypeDefinitionIndex(TypeDefinitionIndex(5602))} Self: TypeDefinitionIndex(TypeDefinitionIndex(5603)) CS Name: ::EnvironmentEffectsFilterPresetDropdown*
