...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5698), inst: 4637 }), TypeDefinitionIndex(TypeDefinitionIndex(4736)),
// TypeDefinitionIndex(TypeDefinitionIndex(5698))} Self: TypeDefinitionIndex(TypeDefinitionIndex(5699)) CS Name: ::EnvironmentEffectsFilterPresetDropdown*
...
public:
  // Declarations
  /// @brief Method GetNamedValues addr 0x2166444 size 0x128 virtual true final false
  ...
  /// @brief Method .ctor addr 0x216656c size 0x48 virtual false final false
  inline void _ctor();
