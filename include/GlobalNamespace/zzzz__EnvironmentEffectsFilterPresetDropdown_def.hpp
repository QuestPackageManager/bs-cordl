...
public:
// Declarations
/// @brief Method GetNamedValues, addr 0x586f51c, size 0x130, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x586f64c, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;
