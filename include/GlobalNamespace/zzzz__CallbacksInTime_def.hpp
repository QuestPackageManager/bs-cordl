...
public:
  ...
  /// @brief Method AddCallback, addr 0x3aea188, size 0x2f0, virtual false, abstract: false, final false
  inline void AddCallback(::GlobalNamespace::BeatmapDataCallbackWrapper* callbackWrapper);

  /// @brief Method CallCallbacks, addr 0x3ae8f8c, size 0xcc, virtual false, abstract: false, final false
  inline void CallCallbacks(::GlobalNamespace::BeatmapDataItem* beatmapDataItem);

  /// @brief Method CallCallbacks, addr 0x3aea478, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveCallback, addr 0x3ae8bb4, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3aea0b0, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(float_t aheadTime);

  /// @brief Method get_isEmpty, addr 0x3ae8da0, size 0x8c, virtual false, abstract: false, final false
