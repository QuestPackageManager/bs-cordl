...
public:
  ...
  /// @brief Method Awake, addr 0x40415dc, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRProgressIndicator* New_ctor();

  /// @brief Method Update, addr 0x40415fc, size 0x6c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x4041668, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
