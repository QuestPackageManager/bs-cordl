...
public:
  ...
  /// @brief Method PlayAnimation, addr 0x57108a8, size 0x2bc, virtual false, abstract: false, final false
  inline void PlayAnimation();

  /// @brief Method Start, addr 0x57108a4, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5710b64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
