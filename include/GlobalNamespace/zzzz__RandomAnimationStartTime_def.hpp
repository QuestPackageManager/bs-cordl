...
public:
  ...
  /// @brief Method PlayAnimation, addr 0x585a2f4, size 0x2bc, virtual false, abstract: false, final false
  inline void PlayAnimation();

  /// @brief Method Start, addr 0x585a2f0, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x585a5b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
