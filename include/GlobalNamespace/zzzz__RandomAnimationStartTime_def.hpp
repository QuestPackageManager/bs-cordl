...
public:
  ...
  /// @brief Method Start, addr 0x23de9a8, size 0x2e4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x23dec8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
