...
public:
  ...
  /// @brief Method Start, addr 0x39c375c, size 0x2d8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x39c3a34, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
