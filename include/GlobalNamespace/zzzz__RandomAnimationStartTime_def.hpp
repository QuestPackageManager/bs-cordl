...
/// @brief Method PlayAnimation, addr 0x56a29e0, size 0x2bc, virtual false, abstract: false, final false
inline void PlayAnimation() ;

/// @brief Method Start, addr 0x56a29dc, size 0x4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x56a2c9c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
