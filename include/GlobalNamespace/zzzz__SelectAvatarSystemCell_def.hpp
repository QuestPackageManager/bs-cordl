...
public:
  ...
  /// @brief Method MoveNext, addr 0x5745410, size 0x66c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5745a7c, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5745a84, size 0x2c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5745d48, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Activate, addr 0x5736d5c, size 0xb0, virtual false, abstract: false, final false
  inline void Activate();

  /// @brief Method Deactivate, addr 0x5736e0c, size 0x8c, virtual false, abstract: false, final false
  inline void Deactivate();

  /// @brief Method HandleLoadedSelectionViewDidPressCreateButton, addr 0x57453e8, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressCreateButton();

  /// @brief Method HandleLoadedSelectionViewDidPressEditButton, addr 0x57453c8, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressEditButton();

  /// @brief Method HandleLoadedSelectionViewDidPressPreferredButton, addr 0x57453a8, size 0x20, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressPreferredButton();

  /// @brief Method Load, addr 0x5737440, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x574530c, size 0x4, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ReloadIsCreated, addr 0x5736cbc, size 0xa0, virtual false, abstract: false, final false
  inline void ReloadIsCreated();

  /// @brief Method SetSelectedAvatarSystem, addr 0x5736c10, size 0xac, virtual false, abstract: false, final false
  inline void SetSelectedAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method TryActivateOnEnable, addr 0x5745310, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5745408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didRequestCreationOfAvatarEvent, addr 0x5737200, size 0xc0, virtual false, abstract: false, final false
  inline void add_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didRequestEditOfAvatarEvent, addr 0x57372c0, size 0xc0, virtual false, abstract: false, final false
  inline void add_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didSetAvatarSystemPreferredEvent, addr 0x5737380, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSetAvatarSystemPreferredEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didRequestCreationOfAvatarEvent, addr 0x574524c, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didRequestEditOfAvatarEvent, addr 0x574518c, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didSetAvatarSystemPreferredEvent, addr 0x57450cc, size 0xc0, virtual false, abstract: false, final false
