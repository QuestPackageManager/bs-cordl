...
struct __GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14;
}
namespace GlobalNamespace {
class ColorScheme;
}
...
namespace GlobalNamespace {
struct __GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15;
}
namespace GlobalNamespace {
...
MARK_VAL_T(::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15);
MARK_VAL_T(::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14);
// Type: ::<LoadTransformedBeatmapDataAsync>d__14
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 64, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 873 }), TypeDefinitionIndex(TypeDefinitionIndex(3396)),
// TypeDefinitionIndex(TypeDefinitionIndex(3389)), TypeDefinitionIndex(TypeDefinitionIndex(4292))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6105)) CS Name:
// ::GameplayCoreSceneSetupData::<LoadTransformedBeatmapDataAsync>d__14
struct CORDL_TYPE __GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext addr 0x21c8a04 size 0x1c8 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x21c8bcc size 0xc virtual true final true
  ...
  constexpr __GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder,
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14, 0x30>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14, __u__1) == 0x28, "Offset mismatch!");
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3389)), TypeDefinitionIndex(TypeDefinitionIndex(3397)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 873
// }), TypeDefinitionIndex(TypeDefinitionIndex(4292)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 873 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(6106)) CS
// Name: ::GameplayCoreSceneSetupData::<GetTransformedBeatmapDataAsync>d__15
struct CORDL_TYPE __GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext addr 0x21c8bd8 size 0x410 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x21c8fe8 size 0x58 virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
  ...
  constexpr __GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15(int32_t __1__state,
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15, 0x30>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15, __u__1) == 0x28, "Offset mismatch!");
...
public:
  // Declarations
  using _GetTransformedBeatmapDataAsync_d__15 = ::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15;

  using _LoadTransformedBeatmapDataAsync_d__14 = ::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14;
  ...
  /// @brief Field _transformedBeatmapData, offset 0x60, size 0x8
  ...
  /// @brief Method get_transformedBeatmapData addr 0x21c87bc size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21c87c4 size 0x88 virtual false final false
  ...
  /// @brief Method LoadTransformedBeatmapDataAsync addr 0x21c884c size 0xc8 virtual false final false
  inline ::System::Threading::Tasks::Task* LoadTransformedBeatmapDataAsync();

  /// @brief Method GetTransformedBeatmapDataAsync addr 0x21c8914 size 0xf0 virtual false final false
...
public:
  ...
  /// @brief Field _transformedBeatmapData, offset: 0x60, size: 0x8, def value: None
  ::GlobalNamespace::IReadonlyBeatmapData* ____transformedBeatmapData;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::GameplayCoreSceneSetupData, 0x68>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::GameplayCoreSceneSetupData, ____transformedBeatmapData) == 0x60, "Offset mismatch!");
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__15, "", "GameplayCoreSceneSetupData/<GetTransformedBeatmapDataAsync>d__15");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__14, "", "GameplayCoreSceneSetupData/<LoadTransformedBeatmapDataAsync>d__14");
