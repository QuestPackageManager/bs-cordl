...
public:
  ...
  /// @brief Method MoveNext, addr 0x590b744, size 0xa78, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x590c1bc, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ApplyDisableUpdateAlwaysConfiguration, addr 0x590b5a8, size 0x7c, virtual false, abstract: false, final false
  inline void ApplyDisableUpdateAlwaysConfiguration();

  /// @brief Method LoadTransformedBeatmapDataAsync, addr 0x590b624, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method TransformBeatmapData, addr 0x590b6d8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590b334, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapLevelData, addr 0x590b314, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IBeatmapLevelData* get_beatmapLevelData();

  /// @brief Method get_songAudioClip, addr 0x590b304, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::AudioClip> get_songAudioClip();

  /// @brief Method get_transformedBeatmapData, addr 0x590b324, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IReadonlyBeatmapData* get_transformedBeatmapData();

  /// @brief Method set_beatmapLevelData, addr 0x590b31c, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevelData(::GlobalNamespace::IBeatmapLevelData* value);

  /// @brief Method set_songAudioClip, addr 0x590b30c, size 0x8, virtual false, abstract: false, final false
  inline void set_songAudioClip(::UnityEngine::AudioClip* value);

  /// @brief Method set_transformedBeatmapData, addr 0x590b32c, size 0x8, virtual false, abstract: false, final false
