...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::RecordingToolManager::*)()>(&::GlobalNamespace::RecordingToolManager::get_showRecordingToolScene)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolManager::*)(::GlobalNamespace::RecordingToolConfigurationProcessor*, ::GlobalNamespace::BeatmapCharacteristicCollection*, ::Zenject::DiContainer*, ::GlobalNamespace::MenuTransitionsHelper*, ::GlobalNamespace::EnvironmentsListModel*, ::GlobalNamespace::PlayerDataModel*)>(&::GlobalNamespace::RecordingToolManager::_ctor)> {
  constexpr static std::size_t size = 0xe0;
  constexpr static std::size_t addrs = 0x576a400;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 6>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::RecordingToolConfigurationProcessor*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::BeatmapCharacteristicCollection*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::DiContainer*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::MenuTransitionsHelper*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::EnvironmentsListModel*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::PlayerDataModel*>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolManager::*)()>(&::GlobalNamespace::RecordingToolManager::Run)> {
  ...
  constexpr static std::size_t addrs = 0x576a4e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::RecordingSettings* (::GlobalNamespace::RecordingToolManager::*)()>(&::GlobalNamespace::RecordingToolManager::SetupNextSettings)> {
  constexpr static std::size_t size = 0x360;
  constexpr static std::size_t addrs = 0x576a7b4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolManager::*)(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO*, ::GlobalNamespace::LevelCompletionResults*)>(&::GlobalNamespace::RecordingToolManager::_Run_b__15_0)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x576ab14;
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, processor, beatmapCharacteristicCollection, diContainer, menuTransitionsHelper, environmentsListModel, playerDataModel);
}
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::RecordingSettings*, false>(this, ___internal_method);
}
inline void GlobalNamespace::RecordingToolManager::_Run_b__15_0(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO*  StandardLevelScenesTransitionSetupDataSO, ::GlobalNamespace::LevelCompletionResults*  LevelCompletionResults)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RecordingToolManager*>::get(),
                        "<Run>b__15_0",
                        std::span<const Il2CppClass* const, 0>(),
...
inline ::GlobalNamespace::RecordingToolManager* GlobalNamespace::RecordingToolManager::New_ctor(::GlobalNamespace::RecordingToolConfigurationProcessor*  processor, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection, ::Zenject::DiContainer*  diContainer, ::GlobalNamespace::MenuTransitionsHelper*  menuTransitionsHelper, ::GlobalNamespace::EnvironmentsListModel*  environmentsListModel, ::GlobalNamespace::PlayerDataModel*  playerDataModel)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::RecordingToolManager*>(processor, beatmapCharacteristicCollection, diContainer, menuTransitionsHelper, environmentsListModel, playerDataModel));
}
// Ctor Parameters []
