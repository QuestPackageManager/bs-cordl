...
// Write type traits
MARK_REF_T(::GlobalNamespace::ILobbyStateDataModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ILobbyStateDataModel*, "", "ILobbyStateDataModel");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ILobbyStateDataModel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILobbyStateDataModel(ILobbyStateDataModelconst&) = delete;
