...
// Write type traits
MARK_REF_T(::GlobalNamespace::VideoProjectionBehavior_VideoProjectionEffect___c__DisplayClass8_0*);
MARK_REF_T(::GlobalNamespace::VideoProjectionEffect*);
MARK_REF_T(::GlobalNamespace::VideoProjectionEffect_BeatmapEditorVideoProjectionBehavior*);
MARK_REF_T(::GlobalNamespace::VideoProjectionEffect_GameplayVideoProjectionBehavior*);
MARK_REF_T(::GlobalNamespace::VideoProjectionEffect_InitData*);
MARK_REF_T(::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior*);
MARK_VAL_T(::GlobalNamespace::VideoProjectionBehavior_VideoProjectionEffect__LoadPreviewCoverAsset_d__9);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VideoProjectionBehavior_VideoProjectionEffect___c__DisplayClass8_0*, "", "VideoProjectionEffect/VideoProjectionBehavior/<>c__DisplayClass8_0");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VideoProjectionEffect*, "", "VideoProjectionEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VideoProjectionEffect_BeatmapEditorVideoProjectionBehavior*, "", "VideoProjectionEffect/BeatmapEditorVideoProjectionBehavior");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VideoProjectionEffect_GameplayVideoProjectionBehavior*, "", "VideoProjectionEffect/GameplayVideoProjectionBehavior");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VideoProjectionEffect_InitData*, "", "VideoProjectionEffect/InitData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior*, "", "VideoProjectionEffect/VideoProjectionBehavior");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::VideoProjectionBehavior_VideoProjectionEffect__LoadPreviewCoverAsset_d__9, "", "VideoProjectionEffect/VideoProjectionBehavior/<LoadPreviewCoverAsset>d__9");
...
public:
  ...
  /// @brief Method .ctor, addr 0x599d9cc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <LoadVideoFromModel>b__0, addr 0x599ded8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x599de30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x599def8, size 0x2c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x599e1c0, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::VideoProjectionBehavior_VideoProjectionEffect__LoadPreviewCoverAsset_d__9) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method Dispose, addr 0x599d9e0, size 0xd8, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method LoadPreviewCoverAsset, addr 0x599de34, size 0xa4, virtual false, abstract: false, final false
  inline void LoadPreviewCoverAsset();

  /// @brief Method LoadVideoFromModel, addr 0x599db74, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadCoverAsset, addr 0x599dab8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x599d9d4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method Dispose, addr 0x599e1c8, size 0x28, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method HandleBeatmapEvent, addr 0x599e1f0, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x599d78c, size 0x224, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::VideoProjectionEffect_BeatmapEditorVideoProjectionBehavior) == 0x58, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x599d64c, size 0x140, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IReadonlyBeatmapData* beatmapData, ::GlobalNamespace::VideoProjectionDataModelSO* dataModel, ::GlobalNamespace::SongTimeSyncedVideoPlayer* videoPlayer,
                    ::GlobalNamespace::BasicBeatmapEventType videoEventType, ::GlobalNamespace::BeatmapLevel* beatmapLevel);
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::VideoProjectionEffect_GameplayVideoProjectionBehavior) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x599d9b0, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x599d540, size 0x10c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x599d9c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::VideoProjectionEffect) == 0x60, "Size mismatch!");
