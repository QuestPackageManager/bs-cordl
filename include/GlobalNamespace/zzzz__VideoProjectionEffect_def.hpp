...
/// @brief Method .ctor, addr 0x57f0c3c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <LoadVideoFromModel>b__0, addr 0x57f1148, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f10a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x57f1168, size 0x2c8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x57f1430, size 0x8, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>", modifiers: "", def_value: None }]
constexpr VideoProjectionBehavior_VideoProjectionEffect__LoadPreviewCoverAsset_d__9(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior*  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>  __u__1) noexcept;
...
/// @brief Field _model, offset 0x30, size 0x8 
...
/// @brief Field _videoClipHandle, offset 0x18, size 0x18 
 __declspec(property(get=__cordl_internal_get__videoClipHandle, put=__cordl_internal_set__videoClipHandle)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityW<::UnityEngine::Video::VideoClip>>  _videoClipHandle;
...
/// @brief Method Dispose, addr 0x57f0c50, size 0xd8, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method LoadPreviewCoverAsset, addr 0x57f10a4, size 0xa4, virtual false, abstract: false, final false
inline void LoadPreviewCoverAsset() ;

/// @brief Method LoadVideoFromModel, addr 0x57f0de4, size 0x2bc, virtual false, abstract: false, final false
inline void LoadVideoFromModel(int32_t  eventValue) ;

static inline ::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior* New_ctor(::GlobalNamespace::VideoProjectionDataModelSO*  dataModel, ::GlobalNamespace::SongTimeSyncedVideoPlayer*  videoPlayer, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method UnloadCoverAsset, addr 0x57f0d28, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f0c44, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _videoClipHandle, offset: 0x18, size: 0x18, def value: None
...
/// @brief Field _model, offset: 0x30, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior, ____model) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior, ____videoPlayer) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior, ____beatmapLevel) == 0x40, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::VideoProjectionEffect_VideoProjectionBehavior, 0x48>, "Size mismatch!");
...
/// @brief Method Dispose, addr 0x57f1438, size 0x28, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method HandleBeatmapEvent, addr 0x57f1460, size 0x10c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  data) ;

static inline ::GlobalNamespace::VideoProjectionEffect_BeatmapEditorVideoProjectionBehavior* New_ctor(::GlobalNamespace::IReadonlyBeatmapData*  beatmapData, ::GlobalNamespace::VideoProjectionDataModelSO*  dataModel, ::GlobalNamespace::SongTimeSyncedVideoPlayer*  videoPlayer, ::GlobalNamespace::BasicBeatmapEventType  videoEventType, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;
...
/// @brief Method .ctor, addr 0x57f09fc, size 0x224, virtual false, abstract: false, final false
...
/// @brief Field _callbackWrapper, offset: 0x50, size: 0x8, def value: None
 ::GlobalNamespace::BeatmapDataCallbackWrapper*  ____callbackWrapper;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::VideoProjectionEffect_BeatmapEditorVideoProjectionBehavior, ____beatmapCallbacksController) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::VideoProjectionEffect_BeatmapEditorVideoProjectionBehavior, ____callbackWrapper) == 0x50, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::VideoProjectionEffect_BeatmapEditorVideoProjectionBehavior, 0x58>, "Size mismatch!");
...
public:
// Declarations
static inline ::GlobalNamespace::VideoProjectionEffect_GameplayVideoProjectionBehavior* New_ctor(::GlobalNamespace::IReadonlyBeatmapData*  beatmapData, ::GlobalNamespace::VideoProjectionDataModelSO*  dataModel, ::GlobalNamespace::SongTimeSyncedVideoPlayer*  videoPlayer, ::GlobalNamespace::BasicBeatmapEventType  videoEventType, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method .ctor, addr 0x57f08bc, size 0x140, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IReadonlyBeatmapData*  beatmapData, ::GlobalNamespace::VideoProjectionDataModelSO*  dataModel, ::GlobalNamespace::SongTimeSyncedVideoPlayer*  videoPlayer, ::GlobalNamespace::BasicBeatmapEventType  videoEventType, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::VideoProjectionEffect_GameplayVideoProjectionBehavior, 0x48>, "Size mismatch!");
...
/// @brief Field _videoProjectionDataModel, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__videoProjectionDataModel, put=__cordl_internal_set__videoProjectionDataModel)) ::UnityW<::GlobalNamespace::VideoProjectionDataModelSO>  _videoProjectionDataModel;

static inline ::GlobalNamespace::VideoProjectionEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57f0c20, size 0x18, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57f07b0, size 0x10c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57f0c38, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
