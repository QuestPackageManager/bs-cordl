...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "OVRMixedRealityCaptureConfiguration", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OVRMixedRealityCaptureConfiguration(OVRMixedRealityCaptureConfigurationconst&) = delete;
