...
public:
  ...
  /// @brief Method CreateBurstSliderData, addr 0x2246930, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSliderData, addr 0x22467f8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCopy, addr 0x2246548, size 0x158, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method Mirror, addr 0x2246a64, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCutDirectionAngleOffset, addr 0x2246b60, size 0xc, virtual false, abstract: false, final false
  inline void SetCutDirectionAngleOffset(float_t headCutDirectionAngleOffset, float_t tailCutDirectionAngleOffset);

  /// @brief Method SetHasHeadNote, addr 0x2246b38, size 0xc, virtual false, abstract: false, final false
  inline void SetHasHeadNote(bool hasHeadNote);

  /// @brief Method SetHasTailNote, addr 0x2246b44, size 0xc, virtual false, abstract: false, final false
  inline void SetHasTailNote(bool hasTailNote);

  /// @brief Method SetHeadBeforeJumpLineLayer, addr 0x2246b50, size 0x8, virtual false, abstract: false, final false
  inline void SetHeadBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer lineLayer);

  /// @brief Method SetTailBeforeJumpLineLayer, addr 0x2246b58, size 0x8, virtual false, abstract: false, final false
  inline void SetTailBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer lineLayer);

  /// @brief Method SubtypeIdentifier, addr 0x22467f4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22466a0, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorType, addr 0x22463f0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_hasHeadNote, addr 0x2246410, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasHeadNote();

  /// @brief Method get_hasTailNote, addr 0x2246484, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasTailNote();

  /// @brief Method get_headBeforeJumpLineLayer, addr 0x2246454, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_headBeforeJumpLineLayer();

  /// @brief Method get_headControlPointLengthMultiplier, addr 0x2246424, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headControlPointLengthMultiplier();

  /// @brief Method get_headCutDirection, addr 0x2246464, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteCutDirection get_headCutDirection();

  /// @brief Method get_headCutDirectionAngleOffset, addr 0x2246474, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headCutDirectionAngleOffset();

  /// @brief Method get_headLineIndex, addr 0x2246434, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_headLineIndex();

  /// @brief Method get_headLineLayer, addr 0x2246444, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_headLineLayer();

  /// @brief Method get_midAnchorMode, addr 0x2246518, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderMidAnchorMode get_midAnchorMode();

  /// @brief Method get_sliceCount, addr 0x2246528, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sliceCount();

  /// @brief Method get_sliderType, addr 0x2246400, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderData_Type get_sliderType();

  /// @brief Method get_squishAmount, addr 0x2246538, size 0x8, virtual false, abstract: false, final false
  inline float_t get_squishAmount();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x22463e8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_tailBeforeJumpLineLayer, addr 0x22464e8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_tailBeforeJumpLineLayer();

  /// @brief Method get_tailControlPointLengthMultiplier, addr 0x22464c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailControlPointLengthMultiplier();

  /// @brief Method get_tailCutDirection, addr 0x22464f8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteCutDirection get_tailCutDirection();

  /// @brief Method get_tailCutDirectionAngleOffset, addr 0x2246508, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailCutDirectionAngleOffset();

  /// @brief Method get_tailLineIndex, addr 0x22464b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tailLineIndex();

  /// @brief Method get_tailLineLayer, addr 0x22464d8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_tailLineLayer();

  /// @brief Method get_tailRotation, addr 0x22464a8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tailRotation();

  /// @brief Method get_tailTime, addr 0x2246498, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailTime();

  /// @brief Method set_colorType, addr 0x22463f8, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::ColorType value);

  /// @brief Method set_hasHeadNote, addr 0x2246418, size 0xc, virtual false, abstract: false, final false
  inline void set_hasHeadNote(bool value);

  /// @brief Method set_hasTailNote, addr 0x224648c, size 0xc, virtual false, abstract: false, final false
  inline void set_hasTailNote(bool value);

  /// @brief Method set_headBeforeJumpLineLayer, addr 0x224645c, size 0x8, virtual false, abstract: false, final false
  inline void set_headBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_headControlPointLengthMultiplier, addr 0x224642c, size 0x8, virtual false, abstract: false, final false
  inline void set_headControlPointLengthMultiplier(float_t value);

  /// @brief Method set_headCutDirection, addr 0x224646c, size 0x8, virtual false, abstract: false, final false
  inline void set_headCutDirection(::GlobalNamespace::NoteCutDirection value);

  /// @brief Method set_headCutDirectionAngleOffset, addr 0x224647c, size 0x8, virtual false, abstract: false, final false
  inline void set_headCutDirectionAngleOffset(float_t value);

  /// @brief Method set_headLineIndex, addr 0x224643c, size 0x8, virtual false, abstract: false, final false
  inline void set_headLineIndex(int32_t value);

  /// @brief Method set_headLineLayer, addr 0x224644c, size 0x8, virtual false, abstract: false, final false
  inline void set_headLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_midAnchorMode, addr 0x2246520, size 0x8, virtual false, abstract: false, final false
  inline void set_midAnchorMode(::GlobalNamespace::SliderMidAnchorMode value);

  /// @brief Method set_sliceCount, addr 0x2246530, size 0x8, virtual false, abstract: false, final false
  inline void set_sliceCount(int32_t value);

  /// @brief Method set_sliderType, addr 0x2246408, size 0x8, virtual false, abstract: false, final false
  inline void set_sliderType(::GlobalNamespace::SliderData_Type value);

  /// @brief Method set_squishAmount, addr 0x2246540, size 0x8, virtual false, abstract: false, final false
  inline void set_squishAmount(float_t value);

  /// @brief Method set_tailBeforeJumpLineLayer, addr 0x22464f0, size 0x8, virtual false, abstract: false, final false
  inline void set_tailBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_tailControlPointLengthMultiplier, addr 0x22464d0, size 0x8, virtual false, abstract: false, final false
  inline void set_tailControlPointLengthMultiplier(float_t value);

  /// @brief Method set_tailCutDirection, addr 0x2246500, size 0x8, virtual false, abstract: false, final false
  inline void set_tailCutDirection(::GlobalNamespace::NoteCutDirection value);

  /// @brief Method set_tailCutDirectionAngleOffset, addr 0x2246510, size 0x8, virtual false, abstract: false, final false
  inline void set_tailCutDirectionAngleOffset(float_t value);

  /// @brief Method set_tailLineIndex, addr 0x22464c0, size 0x8, virtual false, abstract: false, final false
  inline void set_tailLineIndex(int32_t value);

  /// @brief Method set_tailLineLayer, addr 0x22464e0, size 0x8, virtual false, abstract: false, final false
  inline void set_tailLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_tailRotation, addr 0x22464b0, size 0x8, virtual false, abstract: false, final false
  inline void set_tailRotation(int32_t value);

  /// @brief Method set_tailTime, addr 0x22464a0, size 0x8, virtual false, abstract: false, final false
