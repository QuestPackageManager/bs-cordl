...
public:
  ...
  /// @brief Method CreateBurstSliderData, addr 0x31c924c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSliderData, addr 0x31c9134, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCopy, addr 0x31c8f54, size 0x140, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method Mirror, addr 0x31c9374, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method SetHasHeadNote, addr 0x31c9440, size 0x8, virtual false, abstract: false, final false
  inline void SetHasHeadNote(bool hasHeadNote);

  /// @brief Method SetHasTailNote, addr 0x31c9448, size 0x8, virtual false, abstract: false, final false
  inline void SetHasTailNote(bool hasTailNote);

  /// @brief Method SetHeadBeforeJumpLineLayer, addr 0x31c9450, size 0x8, virtual false, abstract: false, final false
  inline void SetHeadBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer lineLayer);

  /// @brief Method SetHeadCutDirectionAngleOffset, addr 0x31c9460, size 0x8, virtual false, abstract: false, final false
  inline void SetHeadCutDirectionAngleOffset(float_t headCutDirectionAngleOffset);

  /// @brief Method SetTailBeforeJumpLineLayer, addr 0x31c9458, size 0x8, virtual false, abstract: false, final false
  inline void SetTailBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer lineLayer);

  /// @brief Method SetTailCutDirectionAngleOffset, addr 0x31c9468, size 0x8, virtual false, abstract: false, final false
  inline void SetTailCutDirectionAngleOffset(float_t tailCutDirectionAngleOffset);

  /// @brief Method SubtypeIdentifier, addr 0x31c9130, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31c9094, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorType, addr 0x31c8dec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_cuttableSliceCount, addr 0x31c8f2c, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_cuttableSliceCount();

  /// @brief Method get_hasHeadNote, addr 0x31c8e0c, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasHeadNote();

  /// @brief Method get_hasTailNote, addr 0x31c8e7c, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasTailNote();

  /// @brief Method get_headBeforeJumpLineLayer, addr 0x31c8e4c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_headBeforeJumpLineLayer();

  /// @brief Method get_headControlPointLengthMultiplier, addr 0x31c8e1c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headControlPointLengthMultiplier();

  /// @brief Method get_headCutDirection, addr 0x31c8e5c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteCutDirection get_headCutDirection();

  /// @brief Method get_headCutDirectionAngleOffset, addr 0x31c8e6c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headCutDirectionAngleOffset();

  /// @brief Method get_headLineIndex, addr 0x31c8e2c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_headLineIndex();

  /// @brief Method get_headLineLayer, addr 0x31c8e3c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_headLineLayer();

  /// @brief Method get_midAnchorMode, addr 0x31c8f0c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderMidAnchorMode get_midAnchorMode();

  /// @brief Method get_sliceCount, addr 0x31c8f1c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sliceCount();

  /// @brief Method get_sliderType, addr 0x31c8dfc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SliderData_Type get_sliderType();

  /// @brief Method get_squishAmount, addr 0x31c8f44, size 0x8, virtual false, abstract: false, final false
  inline float_t get_squishAmount();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x31c8de4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_tailBeforeJumpLineLayer, addr 0x31c8edc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_tailBeforeJumpLineLayer();

  /// @brief Method get_tailControlPointLengthMultiplier, addr 0x31c8ebc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailControlPointLengthMultiplier();

  /// @brief Method get_tailCutDirection, addr 0x31c8eec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteCutDirection get_tailCutDirection();

  /// @brief Method get_tailCutDirectionAngleOffset, addr 0x31c8efc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailCutDirectionAngleOffset();

  /// @brief Method get_tailLineIndex, addr 0x31c8eac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tailLineIndex();

  /// @brief Method get_tailLineLayer, addr 0x31c8ecc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_tailLineLayer();

  /// @brief Method get_tailRotation, addr 0x31c8e9c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_tailRotation();

  /// @brief Method get_tailTime, addr 0x31c8e8c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailTime();

  /// @brief Method set_colorType, addr 0x31c8df4, size 0x8, virtual false, abstract: false, final false
  inline void set_colorType(::GlobalNamespace::ColorType value);

  /// @brief Method set_hasHeadNote, addr 0x31c8e14, size 0x8, virtual false, abstract: false, final false
  inline void set_hasHeadNote(bool value);

  /// @brief Method set_hasTailNote, addr 0x31c8e84, size 0x8, virtual false, abstract: false, final false
  inline void set_hasTailNote(bool value);

  /// @brief Method set_headBeforeJumpLineLayer, addr 0x31c8e54, size 0x8, virtual false, abstract: false, final false
  inline void set_headBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_headControlPointLengthMultiplier, addr 0x31c8e24, size 0x8, virtual false, abstract: false, final false
  inline void set_headControlPointLengthMultiplier(float_t value);

  /// @brief Method set_headCutDirection, addr 0x31c8e64, size 0x8, virtual false, abstract: false, final false
  inline void set_headCutDirection(::GlobalNamespace::NoteCutDirection value);

  /// @brief Method set_headCutDirectionAngleOffset, addr 0x31c8e74, size 0x8, virtual false, abstract: false, final false
  inline void set_headCutDirectionAngleOffset(float_t value);

  /// @brief Method set_headLineIndex, addr 0x31c8e34, size 0x8, virtual false, abstract: false, final false
  inline void set_headLineIndex(int32_t value);

  /// @brief Method set_headLineLayer, addr 0x31c8e44, size 0x8, virtual false, abstract: false, final false
  inline void set_headLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_midAnchorMode, addr 0x31c8f14, size 0x8, virtual false, abstract: false, final false
  inline void set_midAnchorMode(::GlobalNamespace::SliderMidAnchorMode value);

  /// @brief Method set_sliceCount, addr 0x31c8f24, size 0x8, virtual false, abstract: false, final false
  inline void set_sliceCount(int32_t value);

  /// @brief Method set_sliderType, addr 0x31c8e04, size 0x8, virtual false, abstract: false, final false
  inline void set_sliderType(::GlobalNamespace::SliderData_Type value);

  /// @brief Method set_squishAmount, addr 0x31c8f4c, size 0x8, virtual false, abstract: false, final false
  inline void set_squishAmount(float_t value);

  /// @brief Method set_tailBeforeJumpLineLayer, addr 0x31c8ee4, size 0x8, virtual false, abstract: false, final false
  inline void set_tailBeforeJumpLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_tailControlPointLengthMultiplier, addr 0x31c8ec4, size 0x8, virtual false, abstract: false, final false
  inline void set_tailControlPointLengthMultiplier(float_t value);

  /// @brief Method set_tailCutDirection, addr 0x31c8ef4, size 0x8, virtual false, abstract: false, final false
  inline void set_tailCutDirection(::GlobalNamespace::NoteCutDirection value);

  /// @brief Method set_tailCutDirectionAngleOffset, addr 0x31c8f04, size 0x8, virtual false, abstract: false, final false
  inline void set_tailCutDirectionAngleOffset(float_t value);

  /// @brief Method set_tailLineIndex, addr 0x31c8eb4, size 0x8, virtual false, abstract: false, final false
  inline void set_tailLineIndex(int32_t value);

  /// @brief Method set_tailLineLayer, addr 0x31c8ed4, size 0x8, virtual false, abstract: false, final false
  inline void set_tailLineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_tailRotation, addr 0x31c8ea4, size 0x8, virtual false, abstract: false, final false
  inline void set_tailRotation(int32_t value);

  /// @brief Method set_tailTime, addr 0x31c8e94, size 0x8, virtual false, abstract: false, final false
