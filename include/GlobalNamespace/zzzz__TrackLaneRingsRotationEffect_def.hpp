...
public:
  ...
  /// @brief Method .ctor, addr 0x59a28dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddRingRotationEffect, addr 0x59a28f0, size 0xf0, virtual false, abstract: false, final false
  inline void AddRingRotationEffect(float_t angle, float_t step, int32_t propagationSpeed, float_t flexySpeed);

  /// @brief Method Awake, addr 0x59a2774, size 0x168, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FixedUpdate, addr 0x59a29e0, size 0x19c, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetFirstRingDestinationRotationAngle, addr 0x59a2d44, size 0x38, virtual false, abstract: false, final false
  inline float_t GetFirstRingDestinationRotationAngle();

  /// @brief Method GetFirstRingRotationAngle, addr 0x59a2d0c, size 0x38, virtual false, abstract: false, final false
  inline float_t GetFirstRingRotationAngle();

  static inline ::GlobalNamespace::TrackLaneRingsRotationEffect* New_ctor();

  /// @brief Method RecycleRingRotationEffect, addr 0x59a2b7c, size 0xb4, virtual false, abstract: false, final false
  inline void RecycleRingRotationEffect(::GlobalNamespace::TrackLaneRingsRotationEffect_RingRotationEffect* ringRotationEffect);

  /// @brief Method SpawnRingRotationEffect, addr 0x59a2c30, size 0xdc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::TrackLaneRingsRotationEffect_RingRotationEffect* SpawnRingRotationEffect();

  /// @brief Method Start, addr 0x59a28e0, size 0x10, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59a2d7c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
