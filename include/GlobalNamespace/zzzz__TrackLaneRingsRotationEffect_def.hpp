...
public:
  ...
  /// @brief Method .ctor, addr 0x3b9c360, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddRingRotationEffect, addr 0x3b9c378, size 0xe0, virtual false, abstract: false, final false
  inline void AddRingRotationEffect(float_t angle, float_t step, int32_t propagationSpeed, float_t flexySpeed);

  /// @brief Method Awake, addr 0x3b9c1ec, size 0x174, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FixedUpdate, addr 0x3b9c458, size 0x160, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method GetFirstRingDestinationRotationAngle, addr 0x3b9c764, size 0x38, virtual false, abstract: false, final false
  inline float_t GetFirstRingDestinationRotationAngle();

  /// @brief Method GetFirstRingRotationAngle, addr 0x3b9c72c, size 0x38, virtual false, abstract: false, final false
  inline float_t GetFirstRingRotationAngle();

  static inline ::GlobalNamespace::TrackLaneRingsRotationEffect* New_ctor();

  /// @brief Method RecycleRingRotationEffect, addr 0x3b9c5b8, size 0xa4, virtual false, abstract: false, final false
  inline void RecycleRingRotationEffect(::GlobalNamespace::TrackLaneRingsRotationEffect_RingRotationEffect* ringRotationEffect);

  /// @brief Method SpawnRingRotationEffect, addr 0x3b9c65c, size 0xd0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::TrackLaneRingsRotationEffect_RingRotationEffect* SpawnRingRotationEffect();

  /// @brief Method Start, addr 0x3b9c368, size 0x10, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b9c79c, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
