...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightRotationBeatmapEventDataProcessor*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightRotationBeatmapEventDataProcessor*, "", "LightRotationBeatmapEventDataProcessor");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightRotationBeatmapEventDataProcessor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightRotationBeatmapEventDataProcessor(LightRotationBeatmapEventDataProcessor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightRotationBeatmapEventDataProcessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightRotationBeatmapEventDataProcessor(LightRotationBeatmapEventDataProcessorconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LightRotationBeatmapEventDataProcessor) == 0x10, "Size mismatch!");
