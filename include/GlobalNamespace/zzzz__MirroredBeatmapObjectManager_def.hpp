...
public:
  ...
  /// @brief Method Finalize, addr 0x25195a0, size 0x360, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleDidHideAllBeatmapObjects, addr 0x251a248, size 0x6f4, virtual false, abstract: false, final false
  inline void HandleDidHideAllBeatmapObjects(bool hide);

  /// @brief Method HandleNoteWasDespawned, addr 0x2519b14, size 0x17c, virtual false, abstract: false, final false
  inline void HandleNoteWasDespawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteWasSpawned, addr 0x2519900, size 0x214, virtual false, abstract: false, final false
  inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleObstacleWasDespawned, addr 0x2519e24, size 0xc0, virtual false, abstract: false, final false
  inline void HandleObstacleWasDespawned(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleObstacleWasSpawned, addr 0x2519c90, size 0x98, virtual false, abstract: false, final false
  inline void HandleObstacleWasSpawned(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleSliderWasDespawned, addr 0x251a188, size 0xc0, virtual false, abstract: false, final false
  inline void HandleSliderWasDespawned(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method HandleSliderWasSpawned, addr 0x2519ee4, size 0x98, virtual false, abstract: false, final false
  inline void HandleSliderWasSpawned(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method Init, addr 0x251918c, size 0x414, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251a994, size 0x148, virtual false, abstract: false, final false
  inline void _ctor();
