...
public:
  ...
  /// @brief Method Finalize, addr 0x578f4b8, size 0x2f0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleDidHideAllBeatmapObjects, addr 0x57901b4, size 0x520, virtual false, abstract: false, final false
  inline void HandleDidHideAllBeatmapObjects(bool hide);

  /// @brief Method HandleNoteWasDespawned, addr 0x578f9cc, size 0x1b4, virtual false, abstract: false, final false
  inline void HandleNoteWasDespawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteWasSpawned, addr 0x578f7a8, size 0x224, virtual false, abstract: false, final false
  inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleObstacleWasDespawned, addr 0x578fdac, size 0xd8, virtual false, abstract: false, final false
  inline void HandleObstacleWasDespawned(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleObstacleWasSpawned, addr 0x578fb80, size 0xb8, virtual false, abstract: false, final false
  inline void HandleObstacleWasSpawned(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleSliderWasDespawned, addr 0x57900dc, size 0xd8, virtual false, abstract: false, final false
  inline void HandleSliderWasDespawned(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method HandleSliderWasSpawned, addr 0x578fe84, size 0xb8, virtual false, abstract: false, final false
  inline void HandleSliderWasSpawned(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method Init, addr 0x578f054, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method __InvalidateBombNotePool, addr 0x57907ec, size 0xa0, virtual false, abstract: false, final false
  inline void __InvalidateBombNotePool();

  /// @brief Method __InvalidateGameNotePools, addr 0x579072c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x579088c, size 0x1dc, virtual false, abstract: false, final false
  inline void _ctor();
