...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x58cd4dc, size 0x28, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NoteSpawnData) == 0x28, "Size mismatch!");
