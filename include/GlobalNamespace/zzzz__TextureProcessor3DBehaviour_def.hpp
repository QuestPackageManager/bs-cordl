...
public:
  ...
  /// @brief Method OnPlayableDestroy, addr 0x59092c4, size 0x7a8, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x5908ec0, size 0x404, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5909a6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextureProcessor3DBehaviour", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextureProcessor3DBehaviour(TextureProcessor3DBehaviour&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextureProcessor3DBehaviour", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextureProcessor3DBehaviour(TextureProcessor3DBehaviourconst&) = delete;
