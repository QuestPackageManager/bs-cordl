...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalInactivePlayerInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalInactivePlayerInstaller*, "", "MultiplayerLocalInactivePlayerInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59c8138, size 0x4ac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59c85f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalInactivePlayerInstaller) == 0x48, "Size mismatch!");
