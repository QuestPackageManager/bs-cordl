...
public:
  ...
  /// @brief Method InstallBindings, addr 0x588f750, size 0x48c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x588fbdc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
