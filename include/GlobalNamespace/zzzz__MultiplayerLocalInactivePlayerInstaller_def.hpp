...
public:
  ...
  /// @brief Method InstallBindings, addr 0x246a840, size 0x310, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x246ab9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
