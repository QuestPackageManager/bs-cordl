...
public:
  ...
  /// @brief Method InstallBindings, addr 0x24d232c, size 0x310, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24d2688, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
