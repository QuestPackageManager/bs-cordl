...
public:
  ...
  /// @brief Method .ctor, addr 0x6290828, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disabledColor, addr 0x6290804, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_disabledColor();

  /// @brief Method get_highlightedColor, addr 0x62907ec, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_highlightedColor();

  /// @brief Method get_normalColor, addr 0x62907e0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_normalColor();

  /// @brief Method get_pressedColor, addr 0x62907f8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_pressedColor();

  /// @brief Method get_selectedAndHighlightedColor, addr 0x629081c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_selectedAndHighlightedColor();

  /// @brief Method get_selectedColor, addr 0x6290810, size 0xc, virtual false, abstract: false, final false
