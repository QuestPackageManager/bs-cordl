...
// Ctor Parameters [CppParam { name: "globalPropertyName", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "materialPropertyNameCouples", ty: "::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple>*>", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple::Noise3DTexturesGenerator_MaterialTextureParamsCouple(::StringW  globalPropertyName, ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple>*>  materialPropertyNameCouples) noexcept  {
...
// Ctor Parameters [CppParam { name: "texturePropertyName", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "material", ty: "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::Noise3DTexturesGenerator_MaterialPropertyNameCouple::Noise3DTexturesGenerator_MaterialPropertyNameCouple(::StringW  texturePropertyName, ::UnityW<::UnityEngine::Material>  material) noexcept  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::Noise3DTexturesGenerator::*)()>(&::GlobalNamespace::Noise3DTexturesGenerator::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x5d9856c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*> (*)(int32_t, int32_t, int32_t, float_t, int32_t, float_t)>(&::GlobalNamespace::Noise3DTexturesGenerator::CreateNoisePixels)> {
  ...
  constexpr static std::size_t addrs = 0x5d98788;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::Noise3DTexturesGenerator::*)()>(&::GlobalNamespace::Noise3DTexturesGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5d98ac4;
...
constexpr ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>*>& GlobalNamespace::Noise3DTexturesGenerator::__cordl_internal_get__data()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____data;
}
constexpr ::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>*> const& GlobalNamespace::Noise3DTexturesGenerator::__cordl_internal_get__data() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____data;
}
constexpr void GlobalNamespace::Noise3DTexturesGenerator::__cordl_internal_set__data(::ArrayW<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple,::Array<::GlobalNamespace::Noise3DTexturesGenerator_MaterialTextureParamsCouple>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
