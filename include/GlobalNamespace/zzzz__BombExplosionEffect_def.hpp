...
public:
  ...
  /// @brief Method Awake, addr 0x25b0a28, size 0x2c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::BombExplosionEffect* New_ctor();

  /// @brief Method SpawnExplosion, addr 0x25b0a54, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b0b10, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
