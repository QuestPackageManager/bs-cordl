...
public:
  ...
  /// @brief Method Awake, addr 0x3b801f0, size 0x2c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::BombExplosionEffect* New_ctor();

  /// @brief Method SpawnExplosion, addr 0x3b8021c, size 0xbc, virtual false, abstract: false, final false
  inline void SpawnExplosion(::UnityEngine::Vector3 pos);

  /// @brief Method SpawnExplosionWithOffset, addr 0x3b802d8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b80364, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
