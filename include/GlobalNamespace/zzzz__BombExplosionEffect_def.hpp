...
public:
  ...
  /// @brief Method Awake, addr 0x24257a8, size 0x2c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::BombExplosionEffect* New_ctor();

  /// @brief Method SpawnExplosion, addr 0x24257d4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2425890, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
