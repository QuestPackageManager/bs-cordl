...
public:
  ...
  /// @brief Method Awake, addr 0x5844960, size 0x28, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::BombExplosionEffect* New_ctor();

  /// @brief Method SpawnExplosion, addr 0x5844988, size 0xa0, virtual false, abstract: false, final false
  inline void SpawnExplosion(::UnityEngine::Vector3 pos);

  /// @brief Method SpawnExplosionWithOffset, addr 0x5844a28, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5844af4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
