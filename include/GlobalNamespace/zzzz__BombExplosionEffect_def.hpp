...
public:
  ...
  /// @brief Method Awake, addr 0x597defc, size 0x28, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::BombExplosionEffect* New_ctor();

  /// @brief Method SpawnExplosion, addr 0x597df24, size 0xa0, virtual false, abstract: false, final false
  inline void SpawnExplosion(::UnityEngine::Vector3 pos);

  /// @brief Method SpawnExplosionWithOffset, addr 0x597dfc4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x597e090, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
