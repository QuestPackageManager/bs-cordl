...
public:
  ...
  /// @brief Method Awake, addr 0x3bb060c, size 0xe4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleColorHueDidChange, addr 0x3bb08bc, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleColorSaturationOrValueDidChange, addr 0x3bb0848, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bb06f0, size 0x158, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshSlidersColors, addr 0x3bb05a4, size 0x30, virtual false, abstract: false, final false
  inline void RefreshSlidersColors();

  /// @brief Method RefreshSlidersValues, addr 0x3bb05d4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bb0928, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorDidChangeEvent, addr 0x3bb03e4, size 0xb0, virtual false, abstract: false, final false
  inline void add_colorDidChangeEvent(::System::Action_2<::UnityEngine::Color, ::GlobalNamespace::ColorChangeUIEventType>* value);

  /// @brief Method get_color, addr 0x3bb0544, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method remove_colorDidChangeEvent, addr 0x3bb0494, size 0xb0, virtual false, abstract: false, final false
  inline void remove_colorDidChangeEvent(::System::Action_2<::UnityEngine::Color, ::GlobalNamespace::ColorChangeUIEventType>* value);

  /// @brief Method set_color, addr 0x3bb0558, size 0x4c, virtual false, abstract: false, final false
