...
public:
  ...
  /// @brief Method ApplyAndGetData, addr 0x3b71ee8, size 0xbc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::CreateServerFormData ApplyAndGetData();

  /// @brief Method DidActivate, addr 0x3b71de8, size 0x100, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::CreateServerViewController* New_ctor();

  /// @brief Method Setup, addr 0x3b71da4, size 0x44, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::MultiplayerModeSettings* multiplayerModeSettings);

  /// @brief Method <DidActivate>b__10_0, addr 0x3b71fac, size 0x58, virtual false, abstract: false, final false
  inline void _DidActivate_b__10_0();

  /// @brief Method <DidActivate>b__10_1, addr 0x3b72004, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b71fa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b71c3c, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_2<bool, ::GlobalNamespace::CreateServerFormData>* value);

  /// @brief Method get_multiplayerModeSettings, addr 0x3b71d9c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerModeSettings* get_multiplayerModeSettings();

  /// @brief Method remove_didFinishEvent, addr 0x3b71cec, size 0xb0, virtual false, abstract: false, final false
