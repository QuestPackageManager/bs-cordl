...
/// @brief Method ApplyGlobalSettings, addr 0x5cebec8, size 0x38, virtual false, abstract: false, final false
inline void ApplyGlobalSettings() ;

/// @brief Method EnsureInitialized, addr 0x5cebdcc, size 0xfc, virtual false, abstract: false, final false
inline void EnsureInitialized() ;

/// @brief Method EnsureShaderInitialized, addr 0x5cebfc4, size 0x160, virtual false, abstract: false, final false
static inline void EnsureShaderInitialized(::ByRef<::UnityEngine::Shader*>  shader, ::StringW  shaderName, ::StringW  replaceShaderName) ;

/// @brief Method GetOverlayCanvasSettings, addr 0x5cebc98, size 0x134, virtual false, abstract: false, final false
static inline ::UnityW<::GlobalNamespace::OVROverlayCanvasSettings> GetOverlayCanvasSettings() ;

/// @brief Method GetShader, addr 0x5cebf00, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method OnValidate, addr 0x5cec124, size 0x4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method UsingBuiltInRenderPipeline, addr 0x5cebf30, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5cec128, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityW<::GlobalNamespace::OVROverlayCanvasSettings> getStaticF__instance() ;

/// @brief Method get_Instance, addr 0x5cebbf4, size 0xa4, virtual false, abstract: false, final false
