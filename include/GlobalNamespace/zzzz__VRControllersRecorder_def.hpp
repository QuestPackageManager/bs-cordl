...
public:
  // Declarations
  /// @brief Method BindToType, addr 0x26967e4, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2695b44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2696868, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2694ff4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x26970f4, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2696f14, size 0x1e0, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::__VRControllersRecorder__Keyframe* other);

  /// @brief Method FromSerializable, addr 0x269699c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x2697190, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x2696bb0, size 0x184, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__VRControllersRecorder__Keyframe* ReadFrom(::System::IO::BinaryReader* reader);

  /// @brief Method ToConstructorString, addr 0x2696d34, size 0x1e0, virtual true, abstract: false, final true
  inline ::StringW ToConstructorString();

  /// @brief Method ToSerializable, addr 0x2694ffc, size 0x98, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable* ToSerializable();

  /// @brief Method WriteTo, addr 0x2696b00, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2694b84, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Pose leftController, ::UnityEngine::Pose rightController, ::UnityEngine::Pose head, float_t time);

  /// @brief Method .ctor, addr 0x26968e8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_headPose, addr 0x26968c0, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_headPose();

  /// @brief Method get_leftControllerPose, addr 0x2696870, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_leftControllerPose();

  /// @brief Method get_rightControllerPose, addr 0x2696898, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <WriteTo>b__12_0, addr 0x26975c4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26975bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddKeyframe, addr 0x2694bf4, size 0xa8, virtual false, abstract: false, final false
  inline void AddKeyframe(::GlobalNamespace::__VRControllersRecorder__Keyframe* keyframe);

  /// @brief Method FromSavedData, addr 0x26957a4, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x269596c, size 0x14c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__VRControllersRecorder__State* ReadFrom(::System::IO::BinaryReader* reader);

  /// @brief Method Upgrade, addr 0x2697490, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x26950d4, size 0x158, virtual false, abstract: false, final false
  inline void WriteTo(::System::IO::BinaryWriter* writer);
  ...
  /// @brief Method .ctor, addr 0x2693780, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x26972ac, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2697408, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x269739c, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::GlobalNamespace::__VRControllersRecorder__Keyframe*>* keyframes, ::UnityEngine::Pose leftControllerOffset,
                    ::UnityEngine::Pose rightControllerOffset, uint32_t version);

  /// @brief Method get_keyframes, addr 0x2697480, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::__VRControllersRecorder__Keyframe*>* get_keyframes();

  /// @brief Method get_version, addr 0x2697488, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckNodes, addr 0x2692fd0, size 0x258, virtual false, abstract: false, final false
  inline void CheckNodes();

  /// @brief Method CreateAnimationClipFromRecording, addr 0x2695b80, size 0xbf8, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::AnimationClip> CreateAnimationClipFromRecording(::StringW recordingFilePath);

  /// @brief Method GetBinaryFormatter, addr 0x2695ab8, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryFormatter* GetBinaryFormatter();

  /// @brief Method GetSavedData, addr 0x2694dc0, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleControllerAnchorUpdate, addr 0x2693800, size 0x194, virtual false, abstract: false, final false
  inline void HandleControllerAnchorUpdate(::GlobalNamespace::VRController* controller, ::UnityEngine::Pose poseOffset);

  /// @brief Method LateUpdate, addr 0x2694d80, size 0x10, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method Load, addr 0x2693228, size 0x558, virtual false, abstract: false, final false
  inline bool Load();

  /// @brief Method LoadSavedData, addr 0x2695714, size 0x90, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__VRControllersRecorder__SavedData* LoadSavedData(::System::IO::Stream* dataStream);

  /// @brief Method LoadState, addr 0x2695278, size 0x98, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__VRControllersRecorder__State* LoadState(::System::IO::Stream* stream);

  /// @brief Method LoadState, addr 0x26953c4, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadStateWithDefaultOffset, addr 0x2695674, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2693994, size 0xec, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PlaybackTick, addr 0x2693f30, size 0x7c8, virtual false, abstract: false, final false
  inline void PlaybackTick();

  /// @brief Method ReadHeader, addr 0x269522c, size 0x4c, virtual false, abstract: false, final false
  static inline uint32_t ReadHeader(::System::IO::BinaryReader* reader);

  /// @brief Method RecordTick, addr 0x26947fc, size 0x388, virtual false, abstract: false, final false
  inline void RecordTick();

  /// @brief Method Save, addr 0x2693a80, size 0x3a8, virtual false, abstract: false, final false
  inline void Save();

  /// @brief Method SerializeSavedData, addr 0x2695b4c, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultSettings, addr 0x2693e28, size 0x84, virtual false, abstract: false, final false
  inline void SetDefaultSettings();

  /// @brief Method SetInGamePlaybackDefaultSettings, addr 0x2693eac, size 0x84, virtual false, abstract: false, final false
  inline void SetInGamePlaybackDefaultSettings();

  /// @brief Method SetPositionAndRotation, addr 0x26946f8, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x2692974, size 0x65c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x2694c9c, size 0xe4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method WriteHeader, addr 0x2695094, size 0x40, virtual false, abstract: false, final false
  static inline void WriteHeader(::System::IO::BinaryWriter* writer);

  /// @brief Method WriteTo, addr 0x2694d90, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2696778, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_changeToNonVRCamera, addr 0x269296c, size 0x8, virtual false, abstract: false, final false
  inline bool get_changeToNonVRCamera();

  /// @brief Method get_currentPoses, addr 0x2692720, size 0x210, virtual false, abstract: false, final false
  inline ::System::ValueTuple_3<::UnityEngine::Pose, ::UnityEngine::Pose, ::UnityEngine::Pose> get_currentPoses();

  /// @brief Method get_mode, addr 0x2692938, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__VRControllersRecorder__Mode get_mode();

  /// @brief Method get_path, addr 0x2695310, size 0xb4, virtual false, abstract: false, final false
  inline ::StringW get_path();

  /// @brief Method get_recordingFileName, addr 0x2692958, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_recordingFileName();

  /// @brief Method get_recordingTextAsset, addr 0x2692948, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::TextAsset> get_recordingTextAsset();

  /// @brief Method set_changeToNonVRCamera, addr 0x2692960, size 0xc, virtual false, abstract: false, final false
  inline void set_changeToNonVRCamera(bool value);

  /// @brief Method set_mode, addr 0x2692930, size 0x8, virtual false, abstract: false, final false
  inline void set_mode(::GlobalNamespace::__VRControllersRecorder__Mode value);

  /// @brief Method set_recordingFileName, addr 0x2692950, size 0x8, virtual false, abstract: false, final false
  inline void set_recordingFileName(::StringW value);

  /// @brief Method set_recordingTextAsset, addr 0x2692940, size 0x8, virtual false, abstract: false, final false
