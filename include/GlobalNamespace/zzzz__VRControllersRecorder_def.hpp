...
public:
  // Declarations
  /// @brief Method BindToType, addr 0x3b1533c, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b146fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3b153c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3b13bd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Equals, addr 0x3b15bf4, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3b15a08, size 0x1ec, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::VRControllersRecorder_Keyframe* other);

  /// @brief Method FromSerializable, addr 0x3b154f0, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x3b15c90, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x3b156b4, size 0x174, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::VRControllersRecorder_Keyframe* ReadFrom(::System::IO::BinaryReader* reader);

  /// @brief Method ToConstructorString, addr 0x3b15828, size 0x1e0, virtual true, abstract: false, final true
  inline ::StringW ToConstructorString();

  /// @brief Method ToSerializable, addr 0x3b13bdc, size 0x90, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SavedData_VRControllersRecorder_KeyframeSerializable* ToSerializable();

  /// @brief Method WriteTo, addr 0x3b15604, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b13768, size 0x70, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Pose leftController, ::UnityEngine::Pose rightController, ::UnityEngine::Pose head, float_t time);

  /// @brief Method .ctor, addr 0x3b15440, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_headPose, addr 0x3b15418, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_headPose();

  /// @brief Method get_leftControllerPose, addr 0x3b153c8, size 0x28, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_leftControllerPose();

  /// @brief Method get_rightControllerPose, addr 0x3b153f0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <WriteTo>b__12_0, addr 0x3b160ac, size 0x14, virtual false, abstract: false, final false
  inline void _WriteTo_b__12_0(::System::IO::BinaryWriter* binaryWriter, ::GlobalNamespace::VRControllersRecorder_Keyframe* keyframe);

  /// @brief Method .ctor, addr 0x3b160a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddKeyframe, addr 0x3b137d8, size 0xa4, virtual false, abstract: false, final false
  inline void AddKeyframe(::GlobalNamespace::VRControllersRecorder_Keyframe* keyframe);

  /// @brief Method FromSavedData, addr 0x3b1436c, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x3b1452c, size 0x148, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::VRControllersRecorder_State* ReadFrom(::System::IO::BinaryReader* reader);

  /// @brief Method Upgrade, addr 0x3b15f88, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteTo, addr 0x3b13cac, size 0x150, virtual false, abstract: false, final false
  inline void WriteTo(::System::IO::BinaryWriter* writer);
  ...
  /// @brief Method .ctor, addr 0x3b1238c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3b15dac, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b15f00, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b15e94, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::GlobalNamespace::VRControllersRecorder_Keyframe*>* keyframes, ::UnityEngine::Pose leftControllerOffset,
                    ::UnityEngine::Pose rightControllerOffset, uint32_t version);

  /// @brief Method get_keyframes, addr 0x3b15f78, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::VRControllersRecorder_Keyframe*>* get_keyframes();

  /// @brief Method get_version, addr 0x3b15f80, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckNodes, addr 0x3b11cd4, size 0x25c, virtual false, abstract: false, final false
  inline void CheckNodes();

  /// @brief Method CreateAnimationClipFromRecording, addr 0x3b14738, size 0xb98, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::AnimationClip> CreateAnimationClipFromRecording(::StringW recordingFilePath);

  /// @brief Method GetBinaryFormatter, addr 0x3b14674, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Runtime::Serialization::Formatters::Binary::BinaryFormatter* GetBinaryFormatter();

  /// @brief Method GetSavedData, addr 0x3b139a0, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleControllerAnchorUpdate, addr 0x3b1240c, size 0x190, virtual false, abstract: false, final false
  inline void HandleControllerAnchorUpdate(::GlobalNamespace::VRController* controller, ::UnityEngine::Pose poseOffset);

  /// @brief Method LateUpdate, addr 0x3b13960, size 0x10, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method Load, addr 0x3b11f30, size 0x45c, virtual false, abstract: false, final false
  inline bool Load();

  /// @brief Method LoadSavedData, addr 0x3b142dc, size 0x90, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::VRControllersRecorder_SavedData* LoadSavedData(::System::IO::Stream* dataStream);

  /// @brief Method LoadState, addr 0x3b13e48, size 0x98, virtual false, abstract: false, final false
  inline ::GlobalNamespace::VRControllersRecorder_State* LoadState(::System::IO::Stream* stream);

  /// @brief Method LoadState, addr 0x3b13f94, size 0x2a8, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadStateWithDefaultOffset, addr 0x3b1423c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b1259c, size 0xe4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PlaybackTick, addr 0x3b12b4c, size 0x7c0, virtual false, abstract: false, final false
  inline void PlaybackTick();

  /// @brief Method ReadHeader, addr 0x3b13dfc, size 0x4c, virtual false, abstract: false, final false
  static inline uint32_t ReadHeader(::System::IO::BinaryReader* reader);

  /// @brief Method RecordTick, addr 0x3b13410, size 0x358, virtual false, abstract: false, final false
  inline void RecordTick();

  /// @brief Method Save, addr 0x3b12680, size 0x3c4, virtual false, abstract: false, final false
  inline void Save();

  /// @brief Method SerializeSavedData, addr 0x3b14704, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDefaultSettings, addr 0x3b12a44, size 0x84, virtual false, abstract: false, final false
  inline void SetDefaultSettings();

  /// @brief Method SetInGamePlaybackDefaultSettings, addr 0x3b12ac8, size 0x84, virtual false, abstract: false, final false
  inline void SetInGamePlaybackDefaultSettings();

  /// @brief Method SetPositionAndRotation, addr 0x3b1330c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x3b11648, size 0x68c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3b1387c, size 0xe4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method WriteHeader, addr 0x3b13c6c, size 0x40, virtual false, abstract: false, final false
  static inline void WriteHeader(::System::IO::BinaryWriter* writer);

  /// @brief Method WriteTo, addr 0x3b13970, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b152d0, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_changeToNonVRCamera, addr 0x3b11640, size 0x8, virtual false, abstract: false, final false
  inline bool get_changeToNonVRCamera();

  /// @brief Method get_currentPoses, addr 0x3b113f4, size 0x210, virtual false, abstract: false, final false
  inline ::System::ValueTuple_3<::UnityEngine::Pose, ::UnityEngine::Pose, ::UnityEngine::Pose> get_currentPoses();

  /// @brief Method get_mode, addr 0x3b1160c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::VRControllersRecorder_Mode get_mode();

  /// @brief Method get_path, addr 0x3b13ee0, size 0xb4, virtual false, abstract: false, final false
  inline ::StringW get_path();

  /// @brief Method get_recordingFileName, addr 0x3b1162c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_recordingFileName();

  /// @brief Method get_recordingTextAsset, addr 0x3b1161c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::TextAsset> get_recordingTextAsset();

  /// @brief Method set_changeToNonVRCamera, addr 0x3b11634, size 0xc, virtual false, abstract: false, final false
  inline void set_changeToNonVRCamera(bool value);

  /// @brief Method set_mode, addr 0x3b11604, size 0x8, virtual false, abstract: false, final false
  inline void set_mode(::GlobalNamespace::VRControllersRecorder_Mode value);

  /// @brief Method set_recordingFileName, addr 0x3b11624, size 0x8, virtual false, abstract: false, final false
  inline void set_recordingFileName(::StringW value);

  /// @brief Method set_recordingTextAsset, addr 0x3b11614, size 0x8, virtual false, abstract: false, final false
