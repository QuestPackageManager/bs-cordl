...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x35ec1e4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__3_0, addr 0x35ec794, size 0x20, virtual false, abstract: false, final false
  inline bool __ctor_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::EventData* e);

  /// @brief Method .ctor, addr 0x35ec790, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertBeatToRotation, addr 0x35ebbe4, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x35ec69c, size 0x8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SpawnRotationForEventValue, addr 0x35ec130, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ebd98, size 0x398, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*>* events);

  /// @brief Method .ctor, addr 0x35ec1f0, size 0x4ac, virtual false, abstract: false, final false
