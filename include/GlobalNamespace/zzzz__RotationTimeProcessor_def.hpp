...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x26bb1a8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__3_0, addr 0x26bb75c, size 0x24, virtual false, abstract: false, final false
  inline bool __ctor_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::EventData* e);

  /// @brief Method .ctor, addr 0x26bb754, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ConvertBeatToRotation, addr 0x26babd0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x26bb65c, size 0x8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SpawnRotationForEventValue, addr 0x26bb0f8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bad78, size 0x380, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::IReadOnlyList_1<::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*>* events);

  /// @brief Method .ctor, addr 0x26bb1b4, size 0x4a8, virtual false, abstract: false, final false
