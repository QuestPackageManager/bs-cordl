...
public:
  ...
  /// @brief Method Dispose, addr 0x22c4358, size 0x404, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleHMDMounted, addr 0x22c4768, size 0x4, virtual false, abstract: false, final false
  inline void HandleHMDMounted();

  /// @brief Method HandleHMDUnmounted, addr 0x22c4764, size 0x4, virtual false, abstract: false, final false
  inline void HandleHMDUnmounted();

  /// @brief Method HandleInputFocusWasCaptured, addr 0x22c475c, size 0x4, virtual false, abstract: false, final false
  inline void HandleInputFocusWasCaptured();

  /// @brief Method HandleInputFocusWasReleased, addr 0x22c4760, size 0x4, virtual false, abstract: false, final false
  inline void HandleInputFocusWasReleased();

  /// @brief Method HandleVRFocusWasCaptured, addr 0x22c476c, size 0x4, virtual false, abstract: false, final false
  inline void HandleVRFocusWasCaptured();

  /// @brief Method HandleVRFocusWasReleased, addr 0x22c4770, size 0x4, virtual false, abstract: false, final false
  inline void HandleVRFocusWasReleased();

  /// @brief Method Initialize, addr 0x22c3f58, size 0x400, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22c4774, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_loggerPrefix, addr 0x22c3f18, size 0x40, virtual true, abstract: false, final true
