...
public:
  ...
  /// @brief Method MoveNext, addr 0x22f8448, size 0x288, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22f86d0, size 0xc, virtual true, abstract: false, final true
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4954)), TypeDefinitionIndex(TypeDefinitionIndex(10670)), TypeDefinitionIndex(TypeDefinitionIndex(10773))]
...
public:
  ...
  /// @brief Method get_leaderboardsModel, addr 0x22f78c0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LocalLeaderboardsModel* get_leaderboardsModel();

  /// @brief Method OnDisable, addr 0x22f78c8, size 0x84, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Setup, addr 0x22f794c, size 0xc, virtual false, abstract: false, final false
  inline void Setup(bool enableClear);

  /// @brief Method SetData, addr 0x22f7958, size 0x80, virtual true, abstract: false, final false
  inline void SetData(ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method DidActivate, addr 0x22f7a3c, size 0x1e0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x22f8020, size 0x10c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method OnDestroy, addr 0x22f812c, size 0x98, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshScopeSegmentedControl, addr 0x22f7c1c, size 0x2d4, virtual false, abstract: false, final false
  inline void RefreshScopeSegmentedControl();

  /// @brief Method HandleScopeSegmentedControlDidSelectCell, addr 0x22f7ef0, size 0x130, virtual false, abstract: false, final false
  inline void HandleScopeSegmentedControlDidSelectCell(::HMUI::SegmentedControl* segmentedControl, int32_t cellNumber);

  /// @brief Method ClearLeaderboardsAsync, addr 0x22f81c4, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ClearLeaderboardsAsync();

  /// @brief Method SetContent, addr 0x22f828c, size 0x78, virtual false, abstract: false, final false
  inline void SetContent(::StringW leaderboardID, ::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardType leaderboardType);

  /// @brief Method HandleNewScoreWasAddedToLeaderboard, addr 0x22f8304, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method Refresh, addr 0x22f79d8, size 0x64, virtual false, abstract: false, final false
  inline void Refresh();

  static inline ::GlobalNamespace::LocalLeaderboardViewController* New_ctor();

  /// @brief Method .ctor, addr 0x22f83ac, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <DidActivate>b__19_0, addr 0x22f83bc, size 0x8c, virtual false, abstract: false, final false
