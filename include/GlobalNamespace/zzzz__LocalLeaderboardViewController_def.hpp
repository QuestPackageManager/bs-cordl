...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b5a4dc, size 0x2ec, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b5a7c8, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Field _beatmapKey, offset 0xc8, size 0x18
  ...
  /// @brief Field _enableClear, offset 0xe1, size 0x1
  ...
  /// @brief Field _refreshIsNeeded, offset 0xe0, size 0x1
  ...
  /// @brief Method ClearLeaderboardsAsync, addr 0x3b5a260, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ClearLeaderboardsAsync();

  /// @brief Method DidActivate, addr 0x3b59af8, size 0x1d4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b5a0cc, size 0xf8, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleNewScoreWasAddedToLeaderboard, addr 0x3b5a398, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleScopeSegmentedControlDidSelectCell, addr 0x3b59f94, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b5a1c4, size 0x9c, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x3b59984, size 0x84, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Refresh, addr 0x3b59a94, size 0x64, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method RefreshScopeSegmentedControl, addr 0x3b59ccc, size 0x2c8, virtual false, abstract: false, final false
  inline void RefreshScopeSegmentedControl();

  /// @brief Method SetContent, addr 0x3b5a320, size 0x78, virtual false, abstract: false, final false
  inline void SetContent(::StringW leaderboardID, ::GlobalNamespace::LocalLeaderboardsModel_LeaderboardType leaderboardType);

  /// @brief Method SetData, addr 0x3b59a14, size 0x80, virtual true, abstract: false, final false
  inline void SetData(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method Setup, addr 0x3b59a08, size 0xc, virtual false, abstract: false, final false
  inline void Setup(bool enableClear);

  /// @brief Method <DidActivate>b__19_0, addr 0x3b5a450, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b5a440, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::GlobalNamespace::LocalLeaderboardsModel_LeaderboardType getStaticF__leaderboardType();

  /// @brief Method get_leaderboardsModel, addr 0x3b5997c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _beatmapKey, offset: 0xc8, size: 0x18, def value: None
  ::GlobalNamespace::BeatmapKey ____beatmapKey;

  /// @brief Field _refreshIsNeeded, offset: 0xe0, size: 0x1, def value: None
  bool ____refreshIsNeeded;

  /// @brief Field _enableClear, offset: 0xe1, size: 0x1, def value: None
...
static_assert(offsetof(::GlobalNamespace::LocalLeaderboardViewController, ____refreshIsNeeded) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LocalLeaderboardViewController, ____enableClear) == 0xe1, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::LocalLeaderboardViewController, 0xe8>, "Size mismatch!");
