...
public:
  ...
  /// @brief Method MoveNext, addr 0x23c70f0, size 0x288, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x23c7378, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ClearLeaderboardsAsync, addr 0x23c6e6c, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ClearLeaderboardsAsync();

  /// @brief Method DidActivate, addr 0x23c66e4, size 0x1e0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x23c6cc8, size 0x10c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleNewScoreWasAddedToLeaderboard, addr 0x23c6fac, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleScopeSegmentedControlDidSelectCell, addr 0x23c6b98, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x23c6dd4, size 0x98, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x23c6570, size 0x84, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Refresh, addr 0x23c6680, size 0x64, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method RefreshScopeSegmentedControl, addr 0x23c68c4, size 0x2d4, virtual false, abstract: false, final false
  inline void RefreshScopeSegmentedControl();

  /// @brief Method SetContent, addr 0x23c6f34, size 0x78, virtual false, abstract: false, final false
  inline void SetContent(::StringW leaderboardID, ::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardType leaderboardType);

  /// @brief Method SetData, addr 0x23c6600, size 0x80, virtual true, abstract: false, final false
  inline void SetData(ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method Setup, addr 0x23c65f4, size 0xc, virtual false, abstract: false, final false
  inline void Setup(bool enableClear);

  /// @brief Method <DidActivate>b__19_0, addr 0x23c7064, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23c7054, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardType getStaticF__leaderboardType();

  /// @brief Method get_leaderboardsModel, addr 0x23c6568, size 0x8, virtual false, abstract: false, final false
