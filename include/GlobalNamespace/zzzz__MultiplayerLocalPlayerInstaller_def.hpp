...
public:
  ...
  /// @brief Method InstallBindings, addr 0x262a6bc, size 0x238, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262a8f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
