...
public:
  ...
  /// @brief Method InstallBindings, addr 0x25061d0, size 0x238, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2506408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
