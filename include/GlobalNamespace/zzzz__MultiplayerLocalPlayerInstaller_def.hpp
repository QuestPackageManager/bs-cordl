...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalPlayerInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalPlayerInstaller*, "", "MultiplayerLocalPlayerInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59f7fd8, size 0x284, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59f825c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalPlayerInstaller) == 0x40, "Size mismatch!");
