...
public:
  ...
  /// @brief Method Awake, addr 0x2bcd068, size 0x314, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method BuildMaterials, addr 0x2bccb38, size 0x3a8, virtual false, abstract: false, final false
  inline void BuildMaterials();

  /// @brief Method BuildMeshes, addr 0x2bcc4b0, size 0x688, virtual false, abstract: false, final false
  inline void BuildMeshes();

  /// @brief Method DisableRenderers, addr 0x2bcd030, size 0x38, virtual false, abstract: false, final false
  inline void DisableRenderers();

  /// @brief Method EnableRenderers, addr 0x2bcd9a4, size 0x38, virtual false, abstract: false, final false
  inline void EnableRenderers();

  /// @brief Method GetTanFovAndOffsetForMonoEye, addr 0x2bcd574, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTanFovAndOffsetForStereoEye, addr 0x2bcd37c, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTriangleCount, addr 0x2bcc48c, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetTriangleCount();

  static inline ::GlobalNamespace::OVRVignette* New_ctor();

  /// @brief Method OnBeginCameraRendering, addr 0x2bcd9e4, size 0x8c, virtual false, abstract: false, final false
  inline void OnBeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method OnDisable, addr 0x2bccf84, size 0xac, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2bccee0, size 0xa4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPostRender, addr 0x2bcd9e0, size 0x4, virtual false, abstract: false, final false
  inline void OnPostRender();

  /// @brief Method OnPreCull, addr 0x2bcd9dc, size 0x4, virtual false, abstract: false, final false
  inline void OnPreCull();

  /// @brief Method Update, addr 0x2bcd634, size 0x370, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method VisibilityTest, addr 0x2bcd600, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bcda70, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
