...
public:
  ...
  /// @brief Method Awake, addr 0x5ddb294, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method BuildMaterials, addr 0x5ddac74, size 0x400, virtual false, abstract: false, final false
  inline void BuildMaterials();

  /// @brief Method BuildMeshes, addr 0x5dda56c, size 0x708, virtual false, abstract: false, final false
  inline void BuildMeshes();

  /// @brief Method DisableRenderers, addr 0x5ddb1cc, size 0xc8, virtual false, abstract: false, final false
  inline void DisableRenderers();

  /// @brief Method EnableRenderers, addr 0x5ddbda4, size 0x3c, virtual false, abstract: false, final false
  inline void EnableRenderers();

  /// @brief Method GetTanFovAndOffsetForMonoEye, addr 0x5ddb868, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTanFovAndOffsetForStereoEye, addr 0x5ddb6d8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTriangleCount, addr 0x5dda548, size 0x24, virtual false, abstract: false, final false
  inline int32_t GetTriangleCount();

  /// @brief Method Initialize, addr 0x5ddb298, size 0x440, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRVignette* New_ctor();

  /// @brief Method OnBeginCameraRendering, addr 0x5ddbde8, size 0x90, virtual false, abstract: false, final false
  inline void OnBeginCameraRendering(::UnityEngine::Rendering::ScriptableRenderContext context, ::UnityEngine::Camera* camera);

  /// @brief Method OnDisable, addr 0x5ddb11c, size 0xb0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5ddb074, size 0xa8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPostRender, addr 0x5ddbde4, size 0x4, virtual false, abstract: false, final false
  inline void OnPostRender();

  /// @brief Method OnPreCull, addr 0x5ddbde0, size 0x4, virtual false, abstract: false, final false
  inline void OnPreCull();

  /// @brief Method Update, addr 0x5ddb928, size 0x47c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method VisibilityTest, addr 0x5ddb8f4, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ddbe78, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
