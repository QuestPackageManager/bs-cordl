...
public:
  ...
  /// @brief Method OnDisable, addr 0x407bfe0, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x407bdd4, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x407bfec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
