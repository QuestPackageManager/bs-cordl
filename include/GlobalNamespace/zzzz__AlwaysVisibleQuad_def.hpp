...
public:
  ...
  /// @brief Method OnDisable, addr 0x4080f54, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x4080d48, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4080f60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
