...
public:
  ...
  /// @brief Method OnDisable, addr 0x2ad3e78, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2ad3c54, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ad3e84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
