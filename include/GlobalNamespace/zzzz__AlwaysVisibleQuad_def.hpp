...
public:
  ...
  /// @brief Method OnDisable, addr 0x4080edc, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x4080cd0, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4080ee8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
