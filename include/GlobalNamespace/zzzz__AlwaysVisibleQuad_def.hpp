...
public:
  ...
  /// @brief Method OnDisable, addr 0x2c077c4, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2c075a0, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2c077d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
