...
public:
  ...
  /// @brief Method OnDisable, addr 0x4080b74, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x4080968, size 0x20c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4080b80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
