...
public:
  ...
  /// @brief Method .ctor, addr 0x32aa430, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x32aa46c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x32aa494, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32aa4bc, size 0x5d0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x32aaa8c, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x32aaaf8, size 0x3d0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x32aaec8, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Disconnect, addr 0x32a99d4, size 0x8, virtual true, abstract: false, final true
  inline void Disconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method DisconnectInternal, addr 0x32a9ca0, size 0xc, virtual false, abstract: false, final false
  inline void DisconnectInternal(::GlobalNamespace::ConnectionFailedReason connectionFailedReason);

  /// @brief Method DisconnectInternal, addr 0x32a99dc, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x32a9930, size 0xa4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x32a988c, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::ValueTask DisposeAsync();

  /// @brief Method GameLiftConnectToServer, addr 0x32a9efc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConnection, addr 0x32a9cac, size 0xb8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IConnection* GetConnection(int32_t index);

  /// @brief Method GetGameLiftPlayerSessionInfo, addr 0x32a9df4, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method GetPublicServers, addr 0x32aa3d4, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnectToServerSuccess, addr 0x32a9fd4, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnected, addr 0x32a9d64, size 0x30, virtual false, abstract: false, final false
  inline void HandleConnected();

  /// @brief Method HandleConnectionConnected, addr 0x32a9d94, size 0x1c, virtual false, abstract: false, final false
  inline void HandleConnectionConnected(::GlobalNamespace::IConnection* connection);

  /// @brief Method HandleConnectionDisconnected, addr 0x32a9db0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleConnectionFailed, addr 0x32a9dcc, size 0xc, virtual false, abstract: false, final false
  inline void HandleConnectionFailed(::GlobalNamespace::ConnectionFailedReason failedReason);

  /// @brief Method HandleReceivedData, addr 0x32a9dd8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method PollUpdate, addr 0x32a91ec, size 0xa4, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method SendToAll, addr 0x32a905c, size 0xc0, virtual true, abstract: false, final true
  inline void SendToAll(::LiteNetLib::Utils::NetDataWriter* writer, ::BGNet::Core::DeliveryMethod deliveryMethod);

  /// @brief Method SendToAll, addr 0x32a911c, size 0xd0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32a9290, size 0xdc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32a936c, size 0x520, virtual false, abstract: false, final false
  ...
  /// @brief Method add_onConnectedEvent, addr 0x32a8238, size 0xac, virtual true, abstract: false, final true
  inline void add_onConnectedEvent(::System::Action* value);

  /// @brief Method add_onConnectionConnectedEvent, addr 0x32a8690, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method add_onConnectionDisconnectedEvent, addr 0x32a8810, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method add_onConnectionFailedEvent, addr 0x32a8510, size 0xc0, virtual true, abstract: false, final true
  inline void add_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_onDisconnectedEvent, addr 0x32a8390, size 0xc0, virtual true, abstract: false, final true
  inline void add_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_onInitializedEvent, addr 0x32a80e0, size 0xac, virtual true, abstract: false, final true
  inline void add_onInitializedEvent(::System::Action* value);

  /// @brief Method add_onReceivedDataEvent, addr 0x32a8990, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_code, addr 0x32a904c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_code();

  /// @brief Method get_compatibilityVersion, addr 0x32a8f60, size 0xa8, virtual true, abstract: false, final true
  inline ::StringW get_compatibilityVersion();

  /// @brief Method get_configuration, addr 0x32a9038, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayServerConfiguration get_configuration();

  /// @brief Method get_connectionCount, addr 0x32a8d68, size 0xa8, virtual true, abstract: false, final true
  inline int32_t get_connectionCount();

  /// @brief Method get_isConnected, addr 0x32a8d38, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting, addr 0x32a8d48, size 0x10, virtual true, abstract: false, final true
  inline bool get_isConnecting();

  /// @brief Method get_isConnectionOwner, addr 0x32a8e10, size 0xa8, virtual true, abstract: false, final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_isDisconnecting, addr 0x32a8d58, size 0x10, virtual true, abstract: false, final true
  inline bool get_isDisconnecting();

  /// @brief Method get_isDisposed, addr 0x32a8eb8, size 0xa8, virtual true, abstract: false, final true
  inline bool get_isDisposed();

  /// @brief Method get_playerSessionId, addr 0x32a9008, size 0x18, virtual false, abstract: false, final false
  inline ::StringW get_playerSessionId();

  /// @brief Method get_secret, addr 0x32a9054, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_secret();

  /// @brief Method get_selectionMask, addr 0x32a9020, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask();

  /// @brief Method get_userId, addr 0x32a8b10, size 0x114, virtual true, abstract: false, final true
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x32a8c24, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectedEvent, addr 0x32a82e4, size 0xac, virtual true, abstract: false, final true
  inline void remove_onConnectedEvent(::System::Action* value);

  /// @brief Method remove_onConnectionConnectedEvent, addr 0x32a8750, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionConnectedEvent(::System::Action_1<::GlobalNamespace::IConnection*>* value);

  /// @brief Method remove_onConnectionDisconnectedEvent, addr 0x32a88d0, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_onConnectionFailedEvent, addr 0x32a85d0, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onConnectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_onDisconnectedEvent, addr 0x32a8450, size 0xc0, virtual true, abstract: false, final true
  inline void remove_onDisconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_onInitializedEvent, addr 0x32a818c, size 0xac, virtual true, abstract: false, final true
  inline void remove_onInitializedEvent(::System::Action* value);

  /// @brief Method remove_onReceivedDataEvent, addr 0x32a8a50, size 0xc0, virtual true, abstract: false, final true
