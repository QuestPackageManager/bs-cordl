...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RemoteProcedureCall_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RemoteProcedureCall_4(RemoteProcedureCall_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RemoteProcedureCall_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RemoteProcedureCall_4(RemoteProcedureCall_4const&) = delete;
