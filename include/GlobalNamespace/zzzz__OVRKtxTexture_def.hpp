...
public:
  // Declarations
  /// @brief Method Load, addr 0x2b0ddd4, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b0e024, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
