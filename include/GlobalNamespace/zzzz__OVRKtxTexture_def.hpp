...
public:
  // Declarations
  /// @brief Method Load, addr 0x2b30460, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b306b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
