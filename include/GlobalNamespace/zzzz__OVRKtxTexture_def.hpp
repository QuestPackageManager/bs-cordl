...
public:
  // Declarations
  /// @brief Method Load, addr 0x5e60508, size 0x264, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e6076c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
