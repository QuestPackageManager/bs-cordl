...
public:
  // Declarations
  /// @brief Method Load, addr 0x282b70c, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x282b95c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
