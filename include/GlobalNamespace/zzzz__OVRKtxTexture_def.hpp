...
public:
  // Declarations
  /// @brief Method Load, addr 0x288bf44, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x288c194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
