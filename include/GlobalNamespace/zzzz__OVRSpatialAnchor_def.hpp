...
public:
  ...
  /// @brief Method get_StorageLocation addr 0x2791e38 size 0x8 virtual false final false
  inline ::GlobalNamespace::__OVRSpace__StorageLocation get_StorageLocation();

  /// @brief Method set_StorageLocation addr 0x2791e40 size 0x8 virtual false final false
  inline void set_StorageLocation(::GlobalNamespace::__OVRSpace__StorageLocation value);

  /// @brief Method get_MaxAnchorCount addr 0x2791e48 size 0x8 virtual false final false
  inline int32_t get_MaxAnchorCount();

  /// @brief Method set_MaxAnchorCount addr 0x2791e50 size 0x8 virtual false final false
  inline void set_MaxAnchorCount(int32_t value);

  /// @brief Method get_Timeout addr 0x2791e58 size 0x8 virtual false final false
  inline double_t get_Timeout();

  /// @brief Method set_Timeout addr 0x2791e60 size 0x8 virtual false final false
  inline void set_Timeout(double_t value);

  /// @brief Method get_Uuids addr 0x2791e68 size 0x8 virtual false final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::System::Guid>* get_Uuids();

  /// @brief Method set_Uuids addr 0x2791e70 size 0x184 virtual false final false
  inline void set_Uuids(::System::Collections::Generic::IReadOnlyList_1<::System::Guid>* value);

  /// @brief Method ToQueryOptions addr 0x2791ff4 size 0x114 virtual false final false
...
public:
  ...
  /// @brief Method get_Uuid addr 0x2792108 size 0xc virtual false final false
  inline ::System::Guid get_Uuid();

  /// @brief Method get_Localized addr 0x2792114 size 0x98 virtual false final false
  inline bool get_Localized();

  /// @brief Method get_Localizing addr 0x27921ac size 0xa4 virtual false final false
  inline bool get_Localizing();

  /// @brief Method get_Pose addr 0x2792250 size 0x12c virtual false final false
  inline ::UnityEngine::Pose get_Pose();

  /// @brief Method Localize addr 0x279237c size 0xd4 virtual false final false
  inline void Localize(::System::Action_2<::GlobalNamespace::__OVRSpatialAnchor__UnboundAnchor, bool>* onComplete, double_t timeout);

  /// @brief Method ValidateLocalization addr 0x2792538 size 0x19c virtual false final false
  inline void ValidateLocalization();

  /// @brief Method LocalizeAsync addr 0x2792450 size 0xe8 virtual false final false
  inline ::GlobalNamespace::OVRTask_1<bool> LocalizeAsync(double_t timeout);

  /// @brief Method AddStorableAndShareableComponents addr 0x27926d4 size 0xb0 virtual false final false
  inline void AddStorableAndShareableComponents();

  /// @brief Method BindTo addr 0x2792784 size 0x360 virtual false final false
  inline void BindTo(::GlobalNamespace::OVRSpatialAnchor* spatialAnchor);

  /// @brief Method .ctor addr 0x2792ae4 size 0xc virtual false final false
...
public:
  // Declarations
  /// @brief Method Log addr 0x2792af0 size 0x8c virtual false final false
  static inline void Log(::StringW message);

  /// @brief Method LogWarning addr 0x2792b7c size 0x8c virtual false final false
  static inline void LogWarning(::StringW message);

  /// @brief Method LogError addr 0x2792c08 size 0x8c virtual false final false
  static inline void LogError(::StringW message);

  /// @brief Method LogRequest addr 0x2792c94 size 0x4 virtual false final false
  static inline void LogRequest(uint64_t requestId, ::StringW message);

  /// @brief Method LogRequestResult addr 0x2792c98 size 0x4 virtual false final false
...
public:
  ...
  /// @brief Method ContinueTaskWith addr 0x0 size 0xffffffffffffffff virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2792d00 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetListToStoreTheShareRequest>b__41_0 addr 0x2792d08 size 0x3c virtual false final false
...
public:
  ...
  /// @brief Method add_OnLocalize addr 0x278d2f0 size 0xb0 virtual false final false
  inline void add_OnLocalize(::System::Action_1<::GlobalNamespace::__OVRSpatialAnchor__OperationResult>* value);

  /// @brief Method remove_OnLocalize addr 0x278d3a0 size 0xb0 virtual false final false
  inline void remove_OnLocalize(::System::Action_1<::GlobalNamespace::__OVRSpatialAnchor__OperationResult>* value);

  /// @brief Method get_Space addr 0x278d450 size 0x8 virtual false final false
  inline ::GlobalNamespace::OVRSpace get_Space();

  /// @brief Method set_Space addr 0x278d458 size 0x8 virtual false final false
  inline void set_Space(::GlobalNamespace::OVRSpace value);

  /// @brief Method get_Uuid addr 0x278d460 size 0xc virtual false final false
  inline ::System::Guid get_Uuid();

  /// @brief Method set_Uuid addr 0x278d46c size 0x8 virtual false final false
  inline void set_Uuid(::System::Guid value);

  /// @brief Method get_Created addr 0x278d474 size 0x10 virtual false final false
  inline bool get_Created();

  /// @brief Method get_PendingCreation addr 0x278d484 size 0x10 virtual false final false
  inline bool get_PendingCreation();

  /// @brief Method get_Localized addr 0x278d494 size 0x90 virtual false final false
  inline bool get_Localized();

  /// @brief Method InitializeFromExisting addr 0x278d524 size 0x20c virtual false final false
  inline void InitializeFromExisting(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method Save addr 0x278d998 size 0x10 virtual false final false
  inline void Save(::System::Action_2<::GlobalNamespace::OVRSpatialAnchor*, bool>* onComplete);

  /// @brief Method ToNativeArray addr 0x278da58 size 0x2a8 virtual false final false
  ...
  /// @brief Method Save addr 0x278d9a8 size 0xb0 virtual false final false
  ...
  /// @brief Method SaveAsync addr 0x278de64 size 0x8 virtual false final false
  inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync();

  /// @brief Method SaveAsync addr 0x278dd00 size 0x164 virtual false final false
  inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync(::GlobalNamespace::__OVRSpatialAnchor__SaveOptions saveOptions);

  /// @brief Method Save addr 0x278de6c size 0x2c0 virtual false final false
  ...
  /// @brief Method CopyAnchorListIntoListFromPool addr 0x278e12c size 0x78 virtual false final false
  ...
  /// @brief Method Share addr 0x278e1a4 size 0x7c virtual false final false
  ...
  /// @brief Method ShareAsync addr 0x278e220 size 0xd4 virtual false final false
  ...
  /// @brief Method Share addr 0x278e430 size 0x84 virtual false final false
  ...
  /// @brief Method ShareAsync addr 0x278e4b4 size 0x130 virtual false final false
  ...
  /// @brief Method Share addr 0x278e5e4 size 0x94 virtual false final false
  ...
  /// @brief Method ShareAsync addr 0x278e678 size 0x194 virtual false final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::__OVRSpatialAnchor__OperationResult> ShareAsync(::GlobalNamespace::OVRSpaceUser user1, ::GlobalNamespace::OVRSpaceUser user2,
                                                                                                         ::GlobalNamespace::OVRSpaceUser user3);

  /// @brief Method Share addr 0x278e80c size 0x9c virtual false final false
  ...
  /// @brief Method ShareAsync addr 0x278e8a8 size 0x1f0 virtual false final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::__OVRSpatialAnchor__OperationResult> ShareAsync(::GlobalNamespace::OVRSpaceUser user1, ::GlobalNamespace::OVRSpaceUser user2,
                                                                                                         ::GlobalNamespace::OVRSpaceUser user3, ::GlobalNamespace::OVRSpaceUser user4);

  /// @brief Method Share addr 0x278ea98 size 0x7c virtual false final false
  ...
  /// @brief Method ShareAsync addr 0x278eb14 size 0x88 virtual false final false
  ...
  /// @brief Method Share addr 0x278eb9c size 0x634 virtual false final false
  static inline void
  ...
  /// @brief Method ShareAsyncInternal addr 0x278e2f4 size 0x13c virtual false final false
  ...
  /// @brief Method GetListToStoreTheShareRequest addr 0x278f1d0 size 0x34c virtual false final false
  ...
  /// @brief Method AreSortedUserListsEqual addr 0x278f51c size 0x28c virtual false final false
  ...
  /// @brief Method Erase addr 0x278f7a8 size 0x10 virtual false final false
  inline void Erase(::System::Action_2<::GlobalNamespace::OVRSpatialAnchor*, bool>* onComplete);

  /// @brief Method Erase addr 0x278f7b8 size 0xb0 virtual false final false
  ...
  /// @brief Method EraseAsync addr 0x278f93c size 0x8 virtual false final false
  inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync();

  /// @brief Method EraseAsync addr 0x278f868 size 0xd4 virtual false final false
  inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync(::GlobalNamespace::__OVRSpatialAnchor__EraseOptions eraseOptions);

  /// @brief Method ThrowIfBound addr 0x278d730 size 0x130 virtual false final false
  static inline void ThrowIfBound(::System::Guid uuid);

  /// @brief Method InitializeUnchecked addr 0x278d860 size 0x138 virtual false final false
  inline void InitializeUnchecked(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method Start addr 0x278f9e8 size 0x18 virtual false final false
  inline void Start();

  /// @brief Method Update addr 0x278fc30 size 0x10 virtual false final false
  inline void Update();

  /// @brief Method LateUpdate addr 0x278fc40 size 0x50 virtual false final false
  inline void LateUpdate();

  /// @brief Method SaveBatchAnchors addr 0x278fc90 size 0x1ec virtual false final false
  static inline void SaveBatchAnchors();

  /// @brief Method ShareBatchAnchors addr 0x278fe7c size 0x26c virtual false final false
  static inline void ShareBatchAnchors();

  /// @brief Method OnDestroy addr 0x27900e8 size 0xb8 virtual false final false
  inline void OnDestroy();

  /// @brief Method GetTrackingSpacePose addr 0x27901a0 size 0xc8 virtual false final false
  inline ::GlobalNamespace::OVRPose GetTrackingSpacePose();

  /// @brief Method CreateSpatialAnchor addr 0x278fa00 size 0x230 virtual false final false
  inline void CreateSpatialAnchor();

  /// @brief Method TryGetPose addr 0x2790268 size 0x1e0 virtual false final false
  static inline bool TryGetPose(::GlobalNamespace::OVRSpace space, ByRef<::GlobalNamespace::OVRPose> pose);

  /// @brief Method UpdateTransform addr 0x278f944 size 0xa4 virtual false final false
  ...
  /// @brief Method InitializeOnLoad addr 0x2790448 size 0xf0 virtual false final false
  static inline void InitializeOnLoad();

  /// @brief Method InvokeMultiAnchorDelegate addr 0x2790ab4 size 0x550 virtual false final false
  ...
  /// @brief Method OnSpatialAnchorCreateComplete addr 0x2791004 size 0x20c virtual false final false
  ...
  /// @brief Method OnSpaceSaveComplete addr 0x2791210 size 0x4 virtual false final false
  static inline void OnSpaceSaveComplete(uint64_t requestId, ::GlobalNamespace::OVRSpace space, bool result, ::System::Guid uuid);

  /// @brief Method OnSpaceEraseComplete addr 0x2791214 size 0x4 virtual false final false
  ...
  /// @brief Method LoadUnboundAnchors addr 0x2791218 size 0xdc virtual false final false
  ...
  /// @brief Method LoadUnboundAnchorsAsync addr 0x27912f4 size 0x110 virtual false final false
  ...
  /// @brief Method OnSpaceQueryComplete addr 0x2791404 size 0x504 virtual false final false
  static inline void OnSpaceQueryComplete(uint64_t requestId, bool queryResult);

  /// @brief Method PopulateUnbound addr 0x2791908 size 0x374 virtual false final false
  static inline void PopulateUnbound(::System::Guid uuid, uint64_t space);

  /// @brief Method OnSpaceSetComponentStatusComplete addr 0x2791c7c size 0xe0 virtual false final false
  ...
  /// @brief Method OnSpaceListSaveComplete addr 0x2791d5c size 0x68 virtual false final false
  static inline void OnSpaceListSaveComplete(uint64_t requestId, ::GlobalNamespace::__OVRSpatialAnchor__OperationResult result);

  /// @brief Method OnShareSpacesComplete addr 0x2791dc4 size 0x68 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2791e2c size 0xc virtual false final false
  inline void _ctor();
