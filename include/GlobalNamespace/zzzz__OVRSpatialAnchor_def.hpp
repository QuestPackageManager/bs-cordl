...
public:
  ...
  /// @brief Method BindTo, addr 0x5d9efd0, size 0x328, virtual false, abstract: false, final false
  inline void BindTo(::GlobalNamespace::OVRSpatialAnchor* spatialAnchor);

  /// @brief Method Localize, addr 0x5d9f2f8, size 0xdc, virtual false, abstract: false, final false
  inline void Localize(::System::Action_2<::GlobalNamespace::OVRSpatialAnchor_UnboundAnchor, bool>* onComplete, double_t timeout);

  /// @brief Method LocalizeAsync, addr 0x5d9edf0, size 0x1e0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> LocalizeAsync(double_t timeout);

  /// @brief Method TryGetPose, addr 0x5d9eb34, size 0x2bc, virtual false, abstract: false, final false
  inline bool TryGetPose(::ByRef<::UnityEngine::Pose> pose);

  /// @brief Method .ctor, addr 0x5d9ca80, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method get_Localized, addr 0x5d9ea14, size 0x8c, virtual false, abstract: false, final false
  inline bool get_Localized();

  /// @brief Method get_Localizing, addr 0x5d9eaa0, size 0x94, virtual false, abstract: false, final false
  inline bool get_Localizing();

  /// @brief Method get_Pose, addr 0x5d9f3d4, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityEngine::Pose get_Pose();

  /// @brief Method get_Uuid, addr 0x5d9ea08, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method Log, addr 0x5d9f494, size 0x8c, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method LogError, addr 0x5d9f5ac, size 0x8c, virtual false, abstract: false, final false
  static inline void LogError(::StringW message);

  /// @brief Method LogRequest, addr 0x5d9f690, size 0x4, virtual false, abstract: false, final false
  static inline void LogRequest(uint64_t requestId, ::StringW message);

  /// @brief Method LogRequestOrError, addr 0x5d9f638, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method LogRequestResult, addr 0x5d9f694, size 0x4, virtual false, abstract: false, final false
  static inline void LogRequestResult(uint64_t requestId, bool result, ::StringW successMessage, ::StringW failureMessage);

  /// @brief Method LogWarning, addr 0x5d9f520, size 0x8c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ToQueryOptions, addr 0x5d9e3c4, size 0x5c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSpaceQuery_Options ToQueryOptions();

  /// @brief Method get_MaxAnchorCount, addr 0x5d9f6a8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MaxAnchorCount();

  /// @brief Method get_StorageLocation, addr 0x5d9f698, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSpace_StorageLocation get_StorageLocation();

  /// @brief Method get_Timeout, addr 0x5d9f6b8, size 0x8, virtual false, abstract: false, final false
  inline double_t get_Timeout();

  /// @brief Method get_Uuids, addr 0x5d9f6c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::System::Guid>* get_Uuids();

  /// @brief Method set_MaxAnchorCount, addr 0x5d9f6b0, size 0x8, virtual false, abstract: false, final false
  inline void set_MaxAnchorCount(int32_t value);

  /// @brief Method set_StorageLocation, addr 0x5d9f6a0, size 0x8, virtual false, abstract: false, final false
  inline void set_StorageLocation(::GlobalNamespace::OVRSpace_StorageLocation value);

  /// @brief Method set_Timeout, addr 0x5d9f6c0, size 0x8, virtual false, abstract: false, final false
  inline void set_Timeout(double_t value);

  /// @brief Method set_Uuids, addr 0x5d9f6d0, size 0x174, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetListToStoreTheShareRequest>b__33_0, addr 0x5d9f89c, size 0x38, virtual false, abstract: false, final false
  inline int32_t _GetListToStoreTheShareRequest_b__33_0(::GlobalNamespace::OVRSpaceUser x, ::GlobalNamespace::OVRSpaceUser y);

  /// @brief Method .ctor, addr 0x5d9f898, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <LoadUnboundAnchorsAsync>b__0, addr 0x5d9f8d8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d9f8d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5d9fb40, size 0x80c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5da034c, size 0x3c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5da0388, size 0x7b4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5da0b3c, size 0x3c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5da0b78, size 0x768, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5da12e0, size 0x3c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5da131c, size 0x7b8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5da1ad4, size 0x3c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5da1b10, size 0x28c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5da1d9c, size 0x3c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5da1dd8, size 0x3cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5da21a4, size 0x3c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AreSortedUserListsEqual, addr 0x5d9970c, size 0x29c, virtual false, abstract: false, final false
  ...
  /// @brief Method CopyAnchorListIntoListFromPool, addr 0x5d9dba0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchor, addr 0x5d9a6e4, size 0x188, virtual false, abstract: false, final false
  inline void CreateSpatialAnchor();

  /// @brief Method Erase, addr 0x5d9d48c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Erase, addr 0x5d9d47c, size 0x10, virtual false, abstract: false, final false
  inline void Erase(::System::Action_2<::UnityW<::GlobalNamespace::OVRSpatialAnchor>, bool>* onComplete);

  /// @brief Method EraseAnchorAsync, addr 0x5d99dc8, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::OVRResult_1<::GlobalNamespace::OVRAnchor_EraseResult>> EraseAnchorAsync();

  /// @brief Method EraseAnchorsAsync, addr 0x5d99e40, size 0x3d0, virtual false, abstract: false, final false
  ...
  /// @brief Method EraseAsync, addr 0x5d9dec4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync();

  /// @brief Method EraseAsync, addr 0x5d9d544, size 0x110, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> EraseAsync(::GlobalNamespace::OVRSpatialAnchor_EraseOptions eraseOptions);

  /// @brief Method FromOVRAnchor, addr 0x5d9c824, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method GetListToStoreTheShareRequest, addr 0x5d9941c, size 0x2f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTrackingSpacePose, addr 0x5d9b474, size 0x114, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose GetTrackingSpacePose();

  /// @brief Method InitializeFromExisting, addr 0x5d9cc18, size 0x224, virtual false, abstract: false, final false
  inline void InitializeFromExisting(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method InitializeOnLoad, addr 0x5d9b724, size 0xe0, virtual false, abstract: false, final false
  static inline void InitializeOnLoad();

  /// @brief Method InitializeUnchecked, addr 0x5d9a34c, size 0x290, virtual false, abstract: false, final false
  inline void InitializeUnchecked(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method InvokeMultiAnchorDelegate, addr 0x5d9be1c, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x5d9a890, size 0x54, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method LoadUnboundAnchors, addr 0x5d9d654, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadUnboundAnchorsAsync, addr 0x5d9d754, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadUnboundAnchorsAsync, addr 0x5d9c4cc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadUnboundAnchorsAsync, addr 0x5d9c3d4, size 0xf8, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTask_1<
      ::GlobalNamespace::OVRResult_2<::System::Collections::Generic::List_1<::GlobalNamespace::OVRSpatialAnchor_UnboundAnchor>*, ::GlobalNamespace::OVRAnchor_FetchResult>>
  ...
  /// @brief Method LoadUnboundSharedAnchorsAsync, addr 0x5d9c744, size 0xe0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTask_1<
      ::GlobalNamespace::OVRResult_2<::System::Collections::Generic::List_1<::GlobalNamespace::OVRSpatialAnchor_UnboundAnchor>*, ::GlobalNamespace::OVRSpatialAnchor_OperationResult>>
  ...
  /// @brief Method LoadUnboundSharedAnchorsAsync, addr 0x5d9c674, size 0xd0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTask_1<
      ::GlobalNamespace::OVRResult_2<::System::Collections::Generic::List_1<::GlobalNamespace::OVRSpatialAnchor_UnboundAnchor>*, ::GlobalNamespace::OVRSpatialAnchor_OperationResult>>
  ...
  /// @brief Method LoadUnboundSharedAnchorsAsync, addr 0x5d9c5a8, size 0xcc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTask_1<
      ::GlobalNamespace::OVRResult_2<::System::Collections::Generic::List_1<::GlobalNamespace::OVRSpatialAnchor_UnboundAnchor>*, ::GlobalNamespace::OVRSpatialAnchor_OperationResult>>
  ...
  /// @brief Method OnDestroy, addr 0x5d9b33c, size 0x138, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnShareSpacesComplete, addr 0x5d9cb84, size 0x94, virtual false, abstract: false, final false
  static inline void OnShareSpacesComplete(uint64_t requestId, ::GlobalNamespace::OVRSpatialAnchor_OperationResult result);

  /// @brief Method OnSpaceEraseComplete, addr 0x5d9e424, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSpaceListSaveComplete, addr 0x5d9e96c, size 0x94, virtual false, abstract: false, final false
  static inline void OnSpaceListSaveComplete(uint64_t requestId, ::GlobalNamespace::OVRSpatialAnchor_OperationResult result);

  /// @brief Method OnSpaceQueryComplete, addr 0x5d9e428, size 0x544, virtual false, abstract: false, final false
  static inline void OnSpaceQueryComplete(uint64_t requestId, bool queryResult);

  /// @brief Method OnSpaceSaveComplete, addr 0x5d9e420, size 0x4, virtual false, abstract: false, final false
  static inline void OnSpaceSaveComplete(uint64_t requestId, ::GlobalNamespace::OVRSpace space, bool result, ::System::Guid uuid);

  /// @brief Method OnSpaceSetComponentStatusComplete, addr 0x5d9ca8c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSpatialAnchorCreateComplete, addr 0x5d9c1f0, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Save, addr 0x5d9dc30, size 0x294, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method Save, addr 0x5d9ce3c, size 0x10, virtual false, abstract: false, final false
  inline void Save(::System::Action_2<::UnityW<::GlobalNamespace::OVRSpatialAnchor>, bool>* onComplete);

  /// @brief Method Save, addr 0x5d9ce4c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveAnchorAsync, addr 0x5d99d50, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::OVRResult_1<::GlobalNamespace::OVRAnchor_SaveResult>> SaveAnchorAsync();

  /// @brief Method SaveAnchorsAsync, addr 0x5d999a8, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveAsync, addr 0x5d9ded4, size 0x4f0, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveAsync, addr 0x5d9decc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync();

  /// @brief Method SaveAsync, addr 0x5d9cf04, size 0x184, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> SaveAsync(::GlobalNamespace::OVRSpatialAnchor_SaveOptions saveOptions);

  /// @brief Method SaveBatchAnchors, addr 0x5d9a8e4, size 0x1e8, virtual false, abstract: false, final false
  static inline void SaveBatchAnchors();

  /// @brief Method Share, addr 0x5d9ad34, size 0x608, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method Share, addr 0x5d9d0e4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x5d9d18c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x5d9d244, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x5d9d304, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method Share, addr 0x5d9d3d4, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x5d98b50, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x5d98f2c, size 0x4f0, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::OVRResult_1<::GlobalNamespace::OVRAnchor_ShareResult>>
  ...
  /// @brief Method ShareAsync, addr 0x5d982e0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x5d98388, size 0x7c8, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::OVRSpatialAnchor_OperationResult>
  ...
  /// @brief Method ShareAsync, addr 0x5d97b68, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x5d97d98, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsync, addr 0x5d97ec8, size 0x190, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::OVRSpatialAnchor_OperationResult> ShareAsync(::GlobalNamespace::OVRSpaceUser user1, ::GlobalNamespace::OVRSpaceUser user2,
                                                                                                      ::GlobalNamespace::OVRSpaceUser user3);

  /// @brief Method ShareAsync, addr 0x5d98058, size 0x1e8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<::GlobalNamespace::OVRSpatialAnchor_OperationResult> ShareAsync(::GlobalNamespace::OVRSpaceUser user1, ::GlobalNamespace::OVRSpaceUser user2,
                                                                                                      ::GlobalNamespace::OVRSpaceUser user3, ::GlobalNamespace::OVRSpaceUser user4);

  /// @brief Method ShareAsync, addr 0x5d98240, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareAsyncInternal, addr 0x5d97c40, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ShareBatchAnchors, addr 0x5d9aacc, size 0x268, virtual false, abstract: false, final false
  static inline void ShareBatchAnchors();

  /// @brief Method Start, addr 0x5d9a6b8, size 0x2c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method ThrowIfBound, addr 0x5d9a210, size 0x13c, virtual false, abstract: false, final false
  static inline void ThrowIfBound(::System::Guid uuid);

  /// @brief Method ToNativeArray, addr 0x5d9d8cc, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetPose, addr 0x5d9b588, size 0x19c, virtual false, abstract: false, final false
  static inline bool TryGetPose(::GlobalNamespace::OVRSpace space, ::ByRef<::GlobalNamespace::OVRPose> pose);

  /// @brief Method TryGetUnbound, addr 0x5d9c958, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5d9a86c, size 0x24, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateTransform, addr 0x5d9a5dc, size 0xdc, virtual false, abstract: false, final false
  inline void UpdateTransform();

  /// @brief Method WhenCreatedAsync, addr 0x5d9792c, size 0xb8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTask_1<bool> WhenCreatedAsync();

  /// @brief Method WhenLocalizedAsync, addr 0x5d97aac, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d9ea00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_OnLocalize, addr 0x5d97678, size 0x100, virtual false, abstract: false, final false
  inline void add_OnLocalize(::System::Action_1<::GlobalNamespace::OVRSpatialAnchor_OperationResult>* value);

  /// @brief Method add__onLocalize, addr 0x5d974d0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Created, addr 0x5d97778, size 0xd8, virtual false, abstract: false, final false
  inline bool get_Created();

  /// @brief Method get_Localized, addr 0x5d979e4, size 0xc8, virtual false, abstract: false, final false
  inline bool get_Localized();

  /// @brief Method get_PendingCreation, addr 0x5d978b4, size 0x78, virtual false, abstract: false, final false
  inline bool get_PendingCreation();

  /// @brief Method get_Space, addr 0x5d9d088, size 0x5c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSpace get_Space();

  /// @brief Method get_Uuid, addr 0x5d97854, size 0x60, virtual false, abstract: false, final false
  inline ::System::Guid get_Uuid();

  /// @brief Method get__anchor, addr 0x5d97650, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRAnchor get__anchor();

  /// @brief Method remove_OnLocalize, addr 0x5d97850, size 0x4, virtual false, abstract: false, final false
  inline void remove_OnLocalize(::System::Action_1<::GlobalNamespace::OVRSpatialAnchor_OperationResult>* value);

  /// @brief Method remove__onLocalize, addr 0x5d97590, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set__anchor, addr 0x5d97664, size 0x14, virtual false, abstract: false, final false
