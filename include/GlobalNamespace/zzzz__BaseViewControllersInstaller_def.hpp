...
public:
  ...
  /// @brief Method InstallBindings, addr 0x23cace4, size 0xac, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::BaseViewControllersInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x23cad90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
