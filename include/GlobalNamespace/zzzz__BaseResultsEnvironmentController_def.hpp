...
public:
  ...
  /// @brief Method Activate, addr 0x22bc774, size 0x24, virtual true, abstract: false, final false
  inline void Activate();

  /// @brief Method Deactivate, addr 0x22bc798, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22bc7bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
