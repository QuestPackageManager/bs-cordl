...
public:
  ...
  /// @brief Method EndEffect, addr 0x26dd9a8, size 0xc, virtual true, abstract: false, final false
  inline void EndEffect();

  static inline ::GlobalNamespace::SliderHapticFeedbackInteractionEffect* New_ctor();

  /// @brief Method Start, addr 0x26dd6e8, size 0x40, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x26dd960, size 0x48, virtual true, abstract: false, final false
  inline void StartEffect(float_t saberInteractionParam);

  /// @brief Method Update, addr 0x26dd830, size 0xd4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method Vibrate, addr 0x26dd920, size 0x40, virtual false, abstract: false, final false
  inline void Vibrate();
  ...
  /// @brief Method .ctor, addr 0x26dd9b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
