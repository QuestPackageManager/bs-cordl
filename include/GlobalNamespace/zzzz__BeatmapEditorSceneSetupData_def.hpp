...
public:
  ...
  /// @brief Method get_levelDirPath, addr 0x2347f90, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelDirPath();

  /// @brief Method get_levelAssetPath, addr 0x2347f98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2347fa0, size 0x2c, virtual false, abstract: false, final false
