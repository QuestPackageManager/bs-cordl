...
public:
  ...
  /// @brief Method .ctor, addr 0x3b35014, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW levelDirPath, ::StringW levelAssetPath);

  /// @brief Method get_levelAssetPath, addr 0x3b3500c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelAssetPath();

  /// @brief Method get_levelDirPath, addr 0x3b35004, size 0x8, virtual false, abstract: false, final false
