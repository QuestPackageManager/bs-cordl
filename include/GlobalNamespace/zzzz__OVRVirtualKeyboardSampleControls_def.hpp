...
public:
  // Declarations
  /// @brief Method RestoreTo, addr 0x40258d4, size 0xc8, virtual false, abstract: false, final false
  inline void RestoreTo(::GlobalNamespace::OVRVirtualKeyboard* keyboard);

  /// @brief Method .ctor, addr 0x4025df0, size 0xdc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DestroyKeyboard, addr 0x4025d0c, size 0xe4, virtual false, abstract: false, final false
  inline void DestroyKeyboard();

  /// @brief Method HideKeyboard, addr 0x4025cd0, size 0x3c, virtual false, abstract: false, final false
  inline void HideKeyboard();

  /// @brief Method MoveKeyboard, addr 0x4025af0, size 0x12c, virtual false, abstract: false, final false
  inline void MoveKeyboard();

  /// @brief Method MoveKeyboardFar, addr 0x4025c88, size 0x48, virtual false, abstract: false, final false
  inline void MoveKeyboardFar();

  /// @brief Method MoveKeyboardNear, addr 0x4025c40, size 0x48, virtual false, abstract: false, final false
  inline void MoveKeyboardNear();

  static inline ::GlobalNamespace::OVRVirtualKeyboardSampleControls* New_ctor();

  /// @brief Method OnDestroy, addr 0x40256f8, size 0x1dc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnHideKeyboard, addr 0x4025ecc, size 0x4, virtual false, abstract: false, final false
  inline void OnHideKeyboard();

  /// @brief Method ShowKeyboard, addr 0x40255f8, size 0x100, virtual false, abstract: false, final false
  inline void ShowKeyboard();

  /// @brief Method Start, addr 0x402543c, size 0x1bc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x4025ed0, size 0x274, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateButtonInteractable, addr 0x402599c, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4026464, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
