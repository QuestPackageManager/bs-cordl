...
MARK_GEN_REF_PTR_T(::GlobalNamespace::NetworkPlayerModel_1__GetOtherPlayers_d__61);
MARK_GEN_REF_PTR_T(::GlobalNamespace::NetworkPlayerModel_1__GetPartyPlayers_d__60);
MARK_GEN_REF_PTR_T(::GlobalNamespace::NetworkPlayerModel_1___c);
MARK_GEN_REF_PTR_T(::GlobalNamespace::NetworkPlayerModel_1___c__DisplayClass62_0);
...
static inline ::GlobalNamespace::NetworkPlayerModel_1_NetworkPlayer<T>* New_ctor(::GlobalNamespace::NetworkPlayerModel_1<T>*  playerModel, ::GlobalNamespace::IBeatSaberConnectedPlayer*  connectedPlayer) ;
...
static inline ::GlobalNamespace::NetworkPlayerModel_1_NetworkServer<T>* New_ctor(::GlobalNamespace::NetworkPlayerModel_1<T>*  playerModel, ::StringW  code, ::GlobalNamespace::BeatmapLevelSelectionMask  selectionMask, ::GlobalNamespace::GameplayServerConfiguration  configuration) ;
...
/// @brief Field <>7__wrap1, offset 0x30, size 0x18 
 __declspec(property(get=__cordl_internal_get___7__wrap1, put=__cordl_internal_set___7__wrap1)) ::System::Collections::Generic::List_1_Enumerator<::GlobalNamespace::NetworkPlayerModel_1_NetworkServer<T>*>  __7__wrap1;
...
/// @brief Field _partyPlayers, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__partyPlayers, put=__cordl_internal_set__partyPlayers)) ::System::Collections::Generic::List_1<::GlobalNamespace::NetworkPlayerModel_1_NetworkPlayer<T>*>*  _partyPlayers;
...
/// @brief Field _publicServers, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get__publicServers, put=__cordl_internal_set__publicServers)) ::System::Collections::Generic::List_1<::GlobalNamespace::NetworkPlayerModel_1_NetworkServer<T>*>*  _publicServers;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::NetworkPlayerModel_1__GetOtherPlayers_d__61, "", "NetworkPlayerModel`1/<GetOtherPlayers>d__61");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::NetworkPlayerModel_1__GetPartyPlayers_d__60, "", "NetworkPlayerModel`1/<GetPartyPlayers>d__60");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::NetworkPlayerModel_1___c, "", "NetworkPlayerModel`1/<>c");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::NetworkPlayerModel_1___c__DisplayClass62_0, "", "NetworkPlayerModel`1/<>c__DisplayClass62_0");
