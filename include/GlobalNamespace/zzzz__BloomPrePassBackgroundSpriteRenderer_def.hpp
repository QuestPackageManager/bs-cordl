...
public:
  ...
  /// @brief Method .ctor, addr 0x39db134, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x39db12c, size 0x8, virtual true, abstract: false, final false
