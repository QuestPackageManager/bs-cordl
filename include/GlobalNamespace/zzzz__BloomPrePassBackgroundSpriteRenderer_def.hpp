...
public:
  ...
  /// @brief Method .ctor, addr 0x23e90e8, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x23e90e0, size 0x8, virtual true, abstract: false, final false
