...
/// @brief Method .ctor, addr 0x56afea4, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_renderer, addr 0x56afe9c, size 0x8, virtual true, abstract: false, final false
