...
public:
  // Declarations
  /// @brief Field _bloomPrePassBackgroundColor, offset 0x40, size 0x8
  ...
  /// @brief Method ColorWasSet, addr 0x586c408, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586c424, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x586c3ec, size 0x1c, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundLightWithId, ____bloomPrePassBackgroundColor) == 0x40, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundLightWithId) == 0x48, "Size mismatch!");
