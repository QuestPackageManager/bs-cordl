...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x586edf4, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586ee10, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x586edd8, size 0x1c, virtual false, abstract: false, final false
