...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x39e0a64, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e0a84, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x39e0a44, size 0x20, virtual false, abstract: false, final false
