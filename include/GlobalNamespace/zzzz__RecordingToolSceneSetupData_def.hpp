...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingToolSceneSetupData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolSceneSetupData*, "", "RecordingToolSceneSetupData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x590dca4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecordingToolSceneSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecordingToolSceneSetupData(RecordingToolSceneSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecordingToolSceneSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecordingToolSceneSetupData(RecordingToolSceneSetupDataconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::RecordingToolSceneSetupData) == 0x18, "Size mismatch!");
