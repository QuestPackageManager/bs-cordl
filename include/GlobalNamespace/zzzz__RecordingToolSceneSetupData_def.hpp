...
public:
  ...
  /// @brief Method get_nextScenesTransitionSetupData, addr 0x2348edc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2348ee4, size 0x28, virtual false, abstract: false, final false
