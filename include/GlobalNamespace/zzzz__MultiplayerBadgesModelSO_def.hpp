...
/// @brief Method .ctor, addr 0x363780c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_negativeBadges, addr 0x3637804, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyList_1<::UnityW<::GlobalNamespace::MultiplayerBadgeDataSO>>* get_negativeBadges() ;

/// @brief Method get_positiveBadges, addr 0x36377fc, size 0x8, virtual false, abstract: false, final false
