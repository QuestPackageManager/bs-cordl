...
public:
  ...
  /// @brief Method HandleCameraPreRender, addr 0x23ee2a8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x23ee1bc, size 0xec, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x23ee058, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ee394, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
