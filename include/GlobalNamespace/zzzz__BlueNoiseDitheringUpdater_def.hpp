...
public:
  ...
  /// @brief Method OnEnable, addr 0x219f680, size 0x164, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x219f7e4, size 0xec, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method HandleCameraPreRender, addr 0x219f8d0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x219f9bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
