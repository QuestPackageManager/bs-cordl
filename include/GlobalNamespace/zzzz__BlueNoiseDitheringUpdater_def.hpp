...
public:
  ...
  /// @brief Method HandleCameraPreRender, addr 0x5722c64, size 0x60, virtual false, abstract: false, final false
  inline void HandleCameraPreRender(::UnityEngine::Camera* camera);

  /// @brief Method Init, addr 0x57229f4, size 0x18, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::IRandom* random);

  static inline ::GlobalNamespace::BlueNoiseDitheringUpdater* New_ctor();

  /// @brief Method OnDisable, addr 0x5722b74, size 0xf0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5722a0c, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5722de8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
