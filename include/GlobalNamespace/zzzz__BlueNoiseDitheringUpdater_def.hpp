...
public:
  ...
  /// @brief Method HandleCameraPreRender, addr 0x39eb524, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x39eb440, size 0xe4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39eb26c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39eb624, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
