...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(7645))]
...
public:
  ...
  // CppParam { name: "texture", ty: "::GlobalNamespace::OVRTextureData", modifiers: "", def_value: None }]
  constexpr OVRMaterialData(::UnityW<::UnityEngine::Shader> shader, int32_t textureId, ::GlobalNamespace::OVRTextureData texture) noexcept;
  ...
  /// @brief Field texture, offset: 0x10, size: 0x18, def value: None
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVRMaterialData, 0x28>, "Size mismatch!");
