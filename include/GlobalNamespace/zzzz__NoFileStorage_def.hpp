...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoFileStorage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoFileStorage(NoFileStorage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoFileStorage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoFileStorage(NoFileStorageconst&) = delete;
