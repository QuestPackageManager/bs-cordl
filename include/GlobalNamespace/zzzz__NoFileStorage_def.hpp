...
/// @brief Method DeleteFileAsync, addr 0x321e294, size 0x94, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task* DeleteFileAsync(::StringW  fileName, ::GlobalNamespace::StoragePreference  storageLocation) ;

/// @brief Method FileExistsAsync, addr 0x321e328, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method LoadFileAsync, addr 0x321e224, size 0x70, virtual true, abstract: false, final true
...
/// @brief Method SaveFileAsync, addr 0x321e190, size 0x94, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x321e398, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
