...
public:
  // Declarations
  /// @brief Method Dispatch, addr 0x3276c94, size 0xb0, virtual false, abstract: false, final false
  static inline void Dispatch(::GlobalNamespace::IStandaloneMonobehavior* standaloneMonoBehavior, ::System::Action* action);

  /// @brief Method DispatchAsync, addr 0x3276d44, size 0xb4, virtual false, abstract: false, final false
