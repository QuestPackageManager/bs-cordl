...
public:
  // Declarations
  /// @brief Method Dispatch, addr 0x3333ee8, size 0xb0, virtual false, abstract: false, final false
  static inline void Dispatch(::GlobalNamespace::IStandaloneMonobehavior* standaloneMonoBehavior, ::System::Action* action);

  /// @brief Method DispatchAsync, addr 0x3333f98, size 0xb4, virtual false, abstract: false, final false
