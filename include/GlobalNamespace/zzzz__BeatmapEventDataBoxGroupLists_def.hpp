...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapEventDataBoxGroupLists*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapEventDataBoxGroupLists*, "", "BeatmapEventDataBoxGroupLists");
...
public:
  ...
  /// @brief Method Insert, addr 0x3718284, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x37183ac, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncWithBeatmapData, addr 0x37185c8, size 0x150, virtual false, abstract: false, final false
  inline void SyncWithBeatmapData();

  /// @brief Method ToggleUpdateBeatmapDataOnInsert, addr 0x371846c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37181bc, size 0xc8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapEventDataBoxGroupLists", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapEventDataBoxGroupLists(BeatmapEventDataBoxGroupLists&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapEventDataBoxGroupLists", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapEventDataBoxGroupLists(BeatmapEventDataBoxGroupListsconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatmapEventDataBoxGroupLists) == 0x38, "Size mismatch!");
