...
public:
  ...
  /// @brief Method Insert, addr 0x13bcdf8, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x13bcef4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncWithBeatmapData, addr 0x13bd14c, size 0x18c, virtual false, abstract: false, final false
  inline void SyncWithBeatmapData();

  /// @brief Method ToggleUpdateBeatmapDataOnInsert, addr 0x13bcfb4, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13bcd50, size 0xa8, virtual false, abstract: false, final false
