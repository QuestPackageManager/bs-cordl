...
public:
  ...
  /// @brief Method Insert, addr 0x26ba6f4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x26ba800, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncWithBeatmapData, addr 0x26baa50, size 0x18c, virtual false, abstract: false, final false
  inline void SyncWithBeatmapData();

  /// @brief Method ToggleUpdateBeatmapDataOnInsert, addr 0x26ba8b8, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ba644, size 0xb0, virtual false, abstract: false, final false
