...
public:
  ...
  /// @brief Method Insert, addr 0x35ee274, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x35ee39c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method SyncWithBeatmapData, addr 0x35ee5b8, size 0x150, virtual false, abstract: false, final false
  inline void SyncWithBeatmapData();

  /// @brief Method ToggleUpdateBeatmapDataOnInsert, addr 0x35ee45c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ee1ac, size 0xc8, virtual false, abstract: false, final false
