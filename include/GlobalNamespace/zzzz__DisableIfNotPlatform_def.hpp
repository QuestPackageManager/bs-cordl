...
public:
  ...
  /// @brief Method Awake, addr 0x56375e0, size 0x108, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x56376e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
