...
public:
  ...
  /// @brief Method InstallBindings, addr 0x36abbf0, size 0x4cc, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::BeatSaberInit* New_ctor();

  /// @brief Method PreloadAsync, addr 0x36abb28, size 0xc8, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* PreloadAsync();

  /// @brief Method RepeatableSetupAsync, addr 0x36ab7f0, size 0x11c, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RepeatableSetupAsync();

  /// @brief Method TransitionToNextSceneAsync, addr 0x36ab988, size 0x40, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* TransitionToNextSceneAsync();

  /// @brief Method <TransitionToNextSceneAsync>g__GetDestinationOverride|13_0, addr 0x36ab9c8, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36adcf8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_settingsApplicator, addr 0x36ab7e8, size 0x8, virtual false, abstract: false, final false
