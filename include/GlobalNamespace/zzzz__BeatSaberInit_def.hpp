...
/// @brief Field _initialDestinationController, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__initialDestinationController, put=__cordl_internal_set__initialDestinationController)) ::UnityW<::BeatSaber::Destinations::InitialDestinationController>  _initialDestinationController;
...
/// @brief Field _questSettingsApplicator, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__questSettingsApplicator, put=__cordl_internal_set__questSettingsApplicator)) ::UnityW<::GlobalNamespace::SettingsApplicatorSO>  _questSettingsApplicator;

/// @brief Field _standaloneSettingsApplicator, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__standaloneSettingsApplicator, put=__cordl_internal_set__standaloneSettingsApplicator)) ::UnityW<::GlobalNamespace::SettingsApplicatorSO>  _standaloneSettingsApplicator;
...
/// @brief Field commandLineArguments, offset 0x80, size 0x18 
 __declspec(property(get=__cordl_internal_get_commandLineArguments, put=__cordl_internal_set_commandLineArguments)) ::BGLib::DotnetExtension::CommandLine::CommandLineParserResult  commandLineArguments;

 __declspec(property(get=get_settingsApplicator)) ::UnityW<::GlobalNamespace::SettingsApplicatorSO>  settingsApplicator;

/// @brief Method InstallBindings, addr 0x366f1f4, size 0x4cc, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::BeatSaberInit* New_ctor() ;

/// @brief Method PreloadAsync, addr 0x366f12c, size 0xc8, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* PreloadAsync() ;

/// @brief Method RepeatableSetupAsync, addr 0x366ed94, size 0x11c, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* RepeatableSetupAsync() ;

/// @brief Method TransitionToNextSceneAsync, addr 0x366ef2c, size 0x40, virtual true, abstract: false, final false
inline ::System::Threading::Tasks::Task* TransitionToNextSceneAsync() ;

/// @brief Method <TransitionToNextSceneAsync>g__GetDestinationOverride|13_0, addr 0x366ef6c, size 0x1c0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3671278, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_settingsApplicator, addr 0x366ed8c, size 0x8, virtual false, abstract: false, final false
