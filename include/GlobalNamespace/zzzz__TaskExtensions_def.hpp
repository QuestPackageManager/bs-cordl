...
namespace GlobalNamespace {
template <typename T> struct TaskExtensions__WaitWithTimeoutAsync_d__5_1;
}
namespace GlobalNamespace {
struct TaskExtensions__WaitWithTimeoutAsync_d__6;
}
namespace GlobalNamespace {
...
// Write type traits
MARK_REF_T(::GlobalNamespace::TaskExtensions*);
MARK_REF_T(::GlobalNamespace::TaskExtensions___c__DisplayClass3_0*);
MARK_GEN_REF_T_PTR(::GlobalNamespace::TaskExtensions___c__DisplayClass4_0_1);
...
MARK_GEN_VAL_T(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__5_1);
MARK_VAL_T(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TaskExtensions*, "", "TaskExtensions");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TaskExtensions___c__DisplayClass3_0*, "", "TaskExtensions/<>c__DisplayClass3_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::TaskExtensions___c__DisplayClass4_0_1, "", "TaskExtensions/<>c__DisplayClass4_0`1");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TaskExtensions__WaitAsyncInternal_d__3, "", "TaskExtensions/<WaitAsyncInternal>d__3");
DEFINE_IL2CPP_GEN_CLASS(::GlobalNamespace::TaskExtensions__WaitAsyncInternal_d__4_1, "", "TaskExtensions/<WaitAsyncInternal>d__4`1");
DEFINE_IL2CPP_GEN_CLASS(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__5_1, "", "TaskExtensions/<WaitWithTimeoutAsync>d__5`1");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, "", "TaskExtensions/<WaitWithTimeoutAsync>d__6");
// [CompilerGenerated]
...
public:
  ...
  TaskExtensions___c__DisplayClass3_0(TaskExtensions___c__DisplayClass3_0const&) = delete;
...
static_assert(sizeof(::GlobalNamespace::TaskExtensions___c__DisplayClass3_0) == 0x20, "Size mismatch!");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TaskExtensions___c__DisplayClass4_0_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TaskExtensions___c__DisplayClass4_0_1(TaskExtensions___c__DisplayClass4_0_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TaskExtensions___c__DisplayClass4_0_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TaskExtensions___c__DisplayClass4_0_1(TaskExtensions___c__DisplayClass4_0_1const&) = delete;
...
public:
  ...
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "task", ty: "::System::Threading::Tasks::Task*", modifiers: "", def_value: None, comment: None }, CppParam { name: "__7__wrap1",
  // ty: "::System::Threading::CancellationTokenRegistration", modifiers: "", def_value: None, comment: None }, CppParam { name: "__7__wrap2", ty: "::System::Object*", modifiers: "", def_value: None,
  // comment: None }, CppParam { name: "__7__wrap3", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "__u__1", ty:
  ...
  // "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None, comment: None }, CppParam { name: "__u__3", ty: "::System::Runtime::CompilerServices::ValueTaskAwaiter",
...
static_assert(sizeof(::GlobalNamespace::TaskExtensions__WaitAsyncInternal_d__3) == 0x78, "Size mismatch!");
...
public:
  ...
  // Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "__t__builder", ty:
  // "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<T>", modifiers: "", def_value: None, comment: None }, CppParam { name: "cancellationToken", ty:
  // "::System::Threading::CancellationToken", modifiers: "", def_value: None, comment: None }, CppParam { name: "task", ty: "::System::Threading::Tasks::Task_1<T>*", modifiers: "", def_value: None,
  // comment: None }, CppParam { name: "__7__wrap1", ty: "::System::Threading::CancellationTokenRegistration", modifiers: "", def_value: None, comment: None }, CppParam { name: "__7__wrap2", ty:
  ...
  // ty: "T", modifiers: "", def_value: None, comment: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::System::Threading::Tasks::Task_1<T>*>", modifiers:
  // "", def_value: None, comment: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<T>", modifiers: "", def_value: None, comment: None }, CppParam { name:
  // "__u__3", ty: "::System::Runtime::CompilerServices::ValueTaskAwaiter", modifiers: "", def_value: None, comment: None }]
...
template <typename T>
// Is value type: true
// CS Name: TaskExtensions/<WaitWithTimeoutAsync>d__5`1<T>
struct CORDL_TYPE TaskExtensions__WaitWithTimeoutAsync_d__5_1 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr TaskExtensions__WaitWithTimeoutAsync_d__5_1();

  // Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "__t__builder", ty:
  // "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<T>", modifiers: "", def_value: None, comment: None }, CppParam { name: "timeout", ty: "::System::TimeSpan", modifiers: "",
  // def_value: None, comment: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None, comment: None }, CppParam { name: "task", ty:
  // "::System::Threading::Tasks::Task_1<T>*", modifiers: "", def_value: None, comment: None }, CppParam { name: "_timeoutTokenSource_5__2", ty: "::System::Threading::CancellationTokenSource*",
  // modifiers: "", def_value: None, comment: None }, CppParam { name: "_combinedTokenSource_5__3", ty: "::System::Threading::CancellationTokenSource*", modifiers: "", def_value: None, comment: None
  // }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<T>", modifiers: "", def_value: None, comment: None }]
  constexpr TaskExtensions__WaitWithTimeoutAsync_d__5_1(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<T> __t__builder, ::System::TimeSpan timeout,
                                                        ::System::Threading::CancellationToken cancellationToken, ::System::Threading::Tasks::Task_1<T>* task,
                                                        ::System::Threading::CancellationTokenSource* _timeoutTokenSource_5__2, ::System::Threading::CancellationTokenSource* _combinedTokenSource_5__3,
...
// [CompilerGenerated]
// Dependencies System.Runtime.CompilerServices.AsyncTaskMethodBuilder, System.Runtime.CompilerServices.TaskAwaiter, System.Threading.CancellationToken, System.TimeSpan
namespace GlobalNamespace {
// Is value type: true
// CS Name: TaskExtensions/<WaitWithTimeoutAsync>d__6
struct CORDL_TYPE TaskExtensions__WaitWithTimeoutAsync_d__6 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr TaskExtensions__WaitWithTimeoutAsync_d__6();

  // Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None, comment: None }, CppParam { name: "__t__builder", ty:
  // "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None, comment: None }, CppParam { name: "timeout", ty: "::System::TimeSpan", modifiers: "", def_value:
  // None, comment: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None, comment: None }, CppParam { name: "task", ty:
  // "::System::Threading::Tasks::Task*", modifiers: "", def_value: None, comment: None }, CppParam { name: "_timeoutTokenSource_5__2", ty: "::System::Threading::CancellationTokenSource*", modifiers:
  // "", def_value: None, comment: None }, CppParam { name: "_combinedTokenSource_5__3", ty: "::System::Threading::CancellationTokenSource*", modifiers: "", def_value: None, comment: None }, CppParam
  // { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None, comment: None }]
  constexpr TaskExtensions__WaitWithTimeoutAsync_d__6(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, ::System::TimeSpan timeout,
                                                      ::System::Threading::CancellationToken cancellationToken, ::System::Threading::Tasks::Task* task,
                                                      ::System::Threading::CancellationTokenSource* _timeoutTokenSource_5__2, ::System::Threading::CancellationTokenSource* _combinedTokenSource_5__3,
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, timeout) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, cancellationToken) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, task) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, _timeoutTokenSource_5__2) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, _combinedTokenSource_5__3) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6, __u__1) == 0x48, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6) == 0x50, "Size mismatch!");
...
public:
  ...
  template <typename T> using _WaitWithTimeoutAsync_d__5_1 = ::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__5_1<T>;

  using _WaitWithTimeoutAsync_d__6 = ::GlobalNamespace::TaskExtensions__WaitWithTimeoutAsync_d__6;
  ...
  template <typename T>
  static inline ::System::Threading::Tasks::Task_1<T>* WaitWithTimeoutAsync(::System::Threading::Tasks::Task_1<T>* task, ::System::TimeSpan timeout,
                                                                            ::System::Threading::CancellationToken cancellationToken);
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::TaskExtensions) == 0x10, "Size mismatch!");
