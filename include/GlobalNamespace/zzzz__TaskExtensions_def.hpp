...
public:
  ...
  /// @brief Method <WaitAsyncInternal>b__0, addr 0x229ef08, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229ef00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x229ef5c, size 0x930, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x229f88c, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method WaitAsync, addr 0x229ed4c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitAsyncInternal, addr 0x229ee24, size 0xdc, virtual false, abstract: false, final false
