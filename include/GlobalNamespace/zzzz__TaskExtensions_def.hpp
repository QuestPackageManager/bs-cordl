...
namespace GlobalNamespace {
template <typename T> struct __TaskExtensions___WaitAsyncInternal_d__4_1;
}
namespace GlobalNamespace {
class __TaskExtensions____c__DisplayClass3_0;
}
namespace GlobalNamespace {
template <typename T> class __TaskExtensions____c__DisplayClass4_0_1;
}
...
public:
  ...
  /// @brief Method <WaitAsyncInternal>b__0, addr 0x226b8d8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226b8d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x226b92c, size 0x930, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x226c25c, size 0x68, virtual true, abstract: false, final true
  ...
  constexpr __TaskExtensions___WaitAsyncInternal_d__3(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder,
...
public:
  ...
  // def_value: None }]
  constexpr __TaskExtensions___WaitAsyncInternal_d__4_1(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<T> __t__builder,
...
public:
  ...
  template <typename T> using _WaitAsyncInternal_d__4_1 = ::GlobalNamespace::__TaskExtensions___WaitAsyncInternal_d__4_1<T>;
  ...
  /// @brief Method WaitAsync, addr 0x226b71c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method WaitAsyncInternal, addr 0x226b7f4, size 0xdc, virtual false, abstract: false, final false
