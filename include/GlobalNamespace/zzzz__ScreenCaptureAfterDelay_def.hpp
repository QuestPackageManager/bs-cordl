...
public:
  ...
  /// @brief Method .ctor, addr 0x408a930, size 0x60, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x408a994, size 0x1d0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::ScreenCaptureAfterDelay__Start_d__6* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x408ab64, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x408ab6c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x408aba4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x408a990, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x408a580, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleMainEffectControllerAfterImageEffectEvent, addr 0x408a684, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x408a5a8, size 0xdc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x408a520, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408a928, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
