...
/// @brief Method Deserialize, addr 0x3225460, size 0x80, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

static inline ::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable* New_ctor() ;

/// @brief Method Release, addr 0x32254e0, size 0xb0, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x32253b8, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x3225590, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_baseId, addr 0x322537c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::SyncStateId get_baseId() ;

/// @brief Method get_delta, addr 0x322539c, size 0x10, virtual true, abstract: false, final true
inline ::GlobalNamespace::NodePoseSyncState get_delta() ;

/// @brief Method get_pool, addr 0x3225338, size 0x44, virtual false, abstract: false, final false
static inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable*>* get_pool() ;

/// @brief Method get_timeOffsetMs, addr 0x322538c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_baseId, addr 0x3225384, size 0x8, virtual true, abstract: false, final true
inline void set_baseId(::GlobalNamespace::SyncStateId  value) ;

/// @brief Method set_delta, addr 0x32253ac, size 0xc, virtual true, abstract: false, final true
inline void set_delta(::GlobalNamespace::NodePoseSyncState  value) ;

/// @brief Method set_timeOffsetMs, addr 0x3225394, size 0x8, virtual true, abstract: false, final true
