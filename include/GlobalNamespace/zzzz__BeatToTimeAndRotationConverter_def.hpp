...
public:
  ...
  /// @brief Method BeatToRotation, addr 0x26ba8c4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ba898, size 0x2c, virtual false, abstract: false, final false
