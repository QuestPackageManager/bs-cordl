...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatToTimeAndRotationConverter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatToTimeAndRotationConverter*, "", "BeatToTimeAndRotationConverter");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatToTimeAndRotationConverter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatToTimeAndRotationConverter(BeatToTimeAndRotationConverter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatToTimeAndRotationConverter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatToTimeAndRotationConverter(BeatToTimeAndRotationConverterconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatToTimeAndRotationConverter) == 0x20, "Size mismatch!");
