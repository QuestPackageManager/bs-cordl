...
public:
  ...
  /// @brief Method BeatToRotation, addr 0x35ebbd0, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35ebbc8, size 0x8, virtual false, abstract: false, final false
