...
public:
  ...
  /// @brief Method .ctor, addr 0x3ba8b38, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x3ba8a3c, size 0x80, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::RecordingUIController* New_ctor();

  /// @brief Method Update, addr 0x3ba8abc, size 0x6c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ba8b28, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
