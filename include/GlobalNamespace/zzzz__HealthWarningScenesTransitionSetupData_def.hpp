...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HealthWarningScenesTransitionSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HealthWarningScenesTransitionSetupData(HealthWarningScenesTransitionSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HealthWarningScenesTransitionSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HealthWarningScenesTransitionSetupData(HealthWarningScenesTransitionSetupDataconst&) = delete;
