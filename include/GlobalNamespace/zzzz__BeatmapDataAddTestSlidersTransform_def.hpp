...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapDataAddTestSlidersTransform*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataAddTestSlidersTransform*, "", "BeatmapDataAddTestSlidersTransform");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapDataAddTestSlidersTransform", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapDataAddTestSlidersTransform(BeatmapDataAddTestSlidersTransform&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapDataAddTestSlidersTransform", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapDataAddTestSlidersTransform(BeatmapDataAddTestSlidersTransformconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataAddTestSlidersTransform) == 0x10, "Size mismatch!");
