...
public:
  // Declarations
  /// @brief Method CreateTransformedData addr 0x21cb668 size 0x320 virtual false final false
  ...
  /// @brief Method FindNextSameColorTypeNote addr 0x21cbd54 size 0x1ec virtual false final false
  ...
  /// @brief Method .ctor addr 0x21cbf40 size 0x8 virtual false final false
  inline void _ctor();
