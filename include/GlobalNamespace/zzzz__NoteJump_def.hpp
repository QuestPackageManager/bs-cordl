...
public:
  ...
  /// @brief Field _beatTime, offset 0xa0, size 0x4
  ...
  /// @brief Field _middleRotation, offset 0xb8, size 0x10
  ...
  /// @brief Field _missedMarkReported, offset 0xe4, size 0x1
  ...
  /// @brief Field _randomRotations, offset 0xf8, size 0x8
  ...
  /// @brief Field _rotateTowardsPlayer, offset 0x120, size 0x1
  ...
  /// @brief Field _startRotation, offset 0xa8, size 0x10
  ...
  /// @brief Field _startVerticalVelocity, offset 0xa4, size 0x4
  ...
  /// @brief Field _threeQuartersMarkReported, offset 0xe5, size 0x1
  ...
  /// @brief Field _yAvoidance, offset 0xdc, size 0x4
  ...
  /// @brief Field noteJumpDidFinishEvent, offset 0x50, size 0x8
  ...
  /// @brief Field noteJumpDidPassHalfEvent, offset 0x68, size 0x8
  ...
  /// @brief Field noteJumpDidPassMissedMarkerEvent, offset 0x58, size 0x8
  ...
  /// @brief Field noteJumpDidPassThreeQuartersEvent, offset 0x60, size 0x8
  ...
  /// @brief Field noteJumpDidUpdateProgressEvent, offset 0x70, size 0x8
...
public:
  ...
  /// @brief Field noteJumpDidFinishEvent, offset: 0x50, size: 0x8, def value: None
  ::System::Action* ___noteJumpDidFinishEvent;

  /// @brief Field noteJumpDidPassMissedMarkerEvent, offset: 0x58, size: 0x8, def value: None
  ::System::Action* ___noteJumpDidPassMissedMarkerEvent;

  /// @brief Field noteJumpDidPassThreeQuartersEvent, offset: 0x60, size: 0x8, def value: None
  ::System::Action_1<::UnityW<::GlobalNamespace::NoteJump>>* ___noteJumpDidPassThreeQuartersEvent;

  /// @brief Field noteJumpDidPassHalfEvent, offset: 0x68, size: 0x8, def value: None
  ::System::Action* ___noteJumpDidPassHalfEvent;

  /// @brief Field noteJumpDidUpdateProgressEvent, offset: 0x70, size: 0x8, def value: None
  ...
  /// @brief Field _endPos, offset: 0x84, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____endPos;

  /// @brief Field _jumpDuration, offset: 0x90, size: 0x4, def value: None
  float_t ____jumpDuration;

  /// @brief Field _moveVec, offset: 0x94, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____moveVec;

  /// @brief Field _beatTime, offset: 0xa0, size: 0x4, def value: None
  float_t ____beatTime;

  /// @brief Field _startVerticalVelocity, offset: 0xa4, size: 0x4, def value: None
  float_t ____startVerticalVelocity;

  /// @brief Field _startRotation, offset: 0xa8, size: 0x10, def value: None
  ::UnityEngine::Quaternion ____startRotation;

  /// @brief Field _middleRotation, offset: 0xb8, size: 0x10, def value: None
  ::UnityEngine::Quaternion ____middleRotation;

  /// @brief Field _endRotation, offset: 0xc8, size: 0x10, def value: None
  ::UnityEngine::Quaternion ____endRotation;

  /// @brief Field _gravity, offset: 0xd8, size: 0x4, def value: None
  float_t ____gravity;

  /// @brief Field _yAvoidance, offset: 0xdc, size: 0x4, def value: None
  float_t ____yAvoidance;

  /// @brief Field _missedTime, offset: 0xe0, size: 0x4, def value: None
  float_t ____missedTime;

  /// @brief Field _missedMarkReported, offset: 0xe4, size: 0x1, def value: None
  bool ____missedMarkReported;

  /// @brief Field _threeQuartersMarkReported, offset: 0xe5, size: 0x1, def value: None
  bool ____threeQuartersMarkReported;

  /// @brief Field _halfJumpMarkReported, offset: 0xe6, size: 0x1, def value: None
  bool ____halfJumpMarkReported;

  /// @brief Field _localPosition, offset: 0xe8, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____localPosition;

  /// @brief Field _randomRotations, offset: 0xf8, size: 0x8, def value: None
  ...
  /// @brief Field _rotateTowardsPlayer, offset: 0x120, size: 0x1, def value: None
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::NoteJump, 0x128>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::NoteJump, ___noteJumpDidFinishEvent) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ___noteJumpDidPassMissedMarkerEvent) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ___noteJumpDidPassThreeQuartersEvent) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ___noteJumpDidPassHalfEvent) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ___noteJumpDidUpdateProgressEvent) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____startPos) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____endPos) == 0x84, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____jumpDuration) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____moveVec) == 0x94, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____beatTime) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____startVerticalVelocity) == 0xa4, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____startRotation) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____middleRotation) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____endRotation) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____gravity) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____yAvoidance) == 0xdc, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____missedTime) == 0xe0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____missedMarkReported) == 0xe4, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____threeQuartersMarkReported) == 0xe5, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____halfJumpMarkReported) == 0xe6, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____localPosition) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____randomRotations) == 0xf8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____worldRotation) == 0x100, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____inverseWorldRotation) == 0x110, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteJump, ____rotateTowardsPlayer) == 0x120, "Offset mismatch!");
