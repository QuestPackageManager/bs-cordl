...
public:
  ...
  /// @brief Method InitIfNeeded, addr 0x2502b18, size 0x22c, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundTextureGradient* New_ctor();

  /// @brief Method OnDestroy, addr 0x2502dd4, size 0x24, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnValidate, addr 0x2502df8, size 0xa8, virtual true, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Render, addr 0x2502ecc, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x2502d44, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateGradientTexture, addr 0x2502d48, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2500da0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_tintColor, addr 0x2502b00, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_tintColor, addr 0x2502b0c, size 0xc, virtual false, abstract: false, final false
