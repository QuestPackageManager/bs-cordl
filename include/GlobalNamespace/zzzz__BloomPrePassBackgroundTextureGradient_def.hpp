...
public:
  ...
  /// @brief Method InitIfNeeded, addr 0x571de00, size 0x23c, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundTextureGradient* New_ctor();

  /// @brief Method OnDestroy, addr 0x571e0d4, size 0x24, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnValidate, addr 0x571e0f8, size 0xac, virtual true, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Render, addr 0x571e1d0, size 0x174, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x571e03c, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateGradientTexture, addr 0x571e040, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x571c1d0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_tintColor, addr 0x571dde8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_tintColor, addr 0x571ddf4, size 0xc, virtual false, abstract: false, final false
