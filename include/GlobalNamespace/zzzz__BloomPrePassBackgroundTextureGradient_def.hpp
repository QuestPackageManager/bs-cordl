...
public:
  ...
  /// @brief Method InitIfNeeded, addr 0x23f1150, size 0x22c, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundTextureGradient* New_ctor();

  /// @brief Method OnDestroy, addr 0x23f140c, size 0x24, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnValidate, addr 0x23f1430, size 0xa8, virtual true, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Render, addr 0x23f1504, size 0x1b8, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x23f137c, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateGradientTexture, addr 0x23f1380, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ef3d8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_tintColor, addr 0x23f1138, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_tintColor, addr 0x23f1144, size 0xc, virtual false, abstract: false, final false
