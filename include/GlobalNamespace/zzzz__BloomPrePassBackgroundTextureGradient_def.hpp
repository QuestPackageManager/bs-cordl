...
public:
  ...
  /// @brief Method InitIfNeeded, addr 0x586429c, size 0x23c, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundTextureGradient* New_ctor();

  /// @brief Method OnDestroy, addr 0x5864570, size 0x24, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnValidate, addr 0x5864594, size 0xac, virtual true, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Render, addr 0x586466c, size 0x1d0, virtual true, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x58644d8, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UpdateGradientTexture, addr 0x58644dc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5862808, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_tintColor, addr 0x5864284, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_tintColor, addr 0x5864290, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundTextureGradient) == 0x48, "Size mismatch!");
