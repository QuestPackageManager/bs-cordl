...
public:
  ...
  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.get_Type addr 0x2714a48 size 0x8 virtual true final true
  inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType IOVRAnchorComponent_OVRAnchorContainer__get_Type();

  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.get_Handle addr 0x2714a58 size 0x8 virtual true final true
  inline uint64_t IOVRAnchorComponent_OVRAnchorContainer__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.FromAnchor addr 0x2714a60 size 0x8 virtual true final true
  ...
  /// @brief Method get_IsNull addr 0x2714a74 size 0x10 virtual true final true
  inline bool get_IsNull();

  /// @brief Method get_IsEnabled addr 0x2714a84 size 0xa8 virtual true final true
  inline bool get_IsEnabled();

  /// @brief Method IOVRAnchorComponent<OVRAnchorContainer>.SetEnabledAsync addr 0x2714b2c size 0x50 virtual true final true
  ...
  /// @brief Method Equals addr 0x2714b7c size 0x10 virtual true final true
  inline bool Equals(::GlobalNamespace::OVRAnchorContainer other);

  /// @brief Method op_Equality addr 0x2714b8c size 0xc virtual false final false
  static inline bool op_Equality(::GlobalNamespace::OVRAnchorContainer lhs, ::GlobalNamespace::OVRAnchorContainer rhs);

  /// @brief Method op_Inequality addr 0x2714b98 size 0xc virtual false final false
  static inline bool op_Inequality(::GlobalNamespace::OVRAnchorContainer lhs, ::GlobalNamespace::OVRAnchorContainer rhs);

  /// @brief Method Equals addr 0x2714ba4 size 0x78 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x2714c1c size 0x4c virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method ToString addr 0x2714c68 size 0x84 virtual true final false
  inline ::StringW ToString();

  /// @brief Method get_Type addr 0x2714a50 size 0x8 virtual false final false
  inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType get_Type();

  /// @brief Method get_Handle addr 0x2714cec size 0x8 virtual false final false
  inline uint64_t get_Handle();

  /// @brief Method .ctor addr 0x2714a68 size 0xc virtual false final false
  inline void _ctor(::GlobalNamespace::OVRAnchor anchor);

  /// @brief Method get_Uuids addr 0x2714cf4 size 0xc4 virtual false final false
  inline ::ArrayW<::System::Guid, ::Array<::System::Guid>*> get_Uuids();

  /// @brief Method FetchChildrenAsync addr 0x2714db8 size 0x7c virtual false final false
