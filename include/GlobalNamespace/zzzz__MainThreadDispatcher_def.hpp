...
/// @brief Method DispatchOnMainThread, addr 0x570bf38, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method Tick, addr 0x570bf9c, size 0x114, virtual true, abstract: false, final true
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x570c0b0, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
