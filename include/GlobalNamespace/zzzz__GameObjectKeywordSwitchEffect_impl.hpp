...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem::*)()>(&::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x57e0820;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>::get(),
                        ".ctor",
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GameObjectKeywordSwitchEffect::*)(::GlobalNamespace::IReadonlyBeatmapData*)>(&::GlobalNamespace::GameObjectKeywordSwitchEffect::Initialize)> {
  ...
  constexpr static std::size_t addrs = 0x57e06d4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GameObjectKeywordSwitchEffect::*)()>(&::GlobalNamespace::GameObjectKeywordSwitchEffect::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x57e081c;
...
constexpr ::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*,::Array<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>*>& GlobalNamespace::GameObjectKeywordSwitchEffect::__cordl_internal_get__gameObjectKeywordItems()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameObjectKeywordItems;
}
constexpr ::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*,::Array<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>*> const& GlobalNamespace::GameObjectKeywordSwitchEffect::__cordl_internal_get__gameObjectKeywordItems() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____gameObjectKeywordItems;
}
constexpr void GlobalNamespace::GameObjectKeywordSwitchEffect::__cordl_internal_set__gameObjectKeywordItems(::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*,::Array<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
