...
inline bool IEquatableByReference_StateBuffer_TStateTable_TType_TState__TimestampedStateTable__Equals(::ByRef<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>  other) ;
...
constexpr ::GlobalNamespace::IEquatableByReference_1<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>* i___GlobalNamespace__IEquatableByReference_1___GlobalNamespace__StateBuffer_3_TimestampedStateTable_TStateTable_TType_TState__() ;
...
/// @brief Field _buffer, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__buffer, put=__cordl_internal_set__buffer)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  _buffer;
...
/// @brief Field _interpolator, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__interpolator, put=__cordl_internal_set__interpolator)) ::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable,TType,TState>*  _interpolator;
...
static inline ::GlobalNamespace::StateBuffer_3<TStateTable,TType,TState>* New_ctor(int32_t  size, ::GlobalNamespace::StateBuffer_3_InterpolationDelegate<TStateTable,TType,TState>*  interpolator, ::GlobalNamespace::StateBuffer_3_SmoothingDelegate<TStateTable,TType,TState>*  smoother) ;

constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*> const& __cordl_internal_get__buffer() const;

constexpr ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>& __cordl_internal_get__buffer() ;
...
constexpr void __cordl_internal_set__buffer(::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>,::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable,TType,TState>>*>  value) ;
