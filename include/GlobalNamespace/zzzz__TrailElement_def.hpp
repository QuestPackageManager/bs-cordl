...
/// @brief Method CopyFrom, addr 0x5da0c40, size 0x3c, virtual false, abstract: false, final false
inline void CopyFrom(::GlobalNamespace::TrailElement*  other) ;

static inline ::GlobalNamespace::TrailElement* New_ctor() ;

/// @brief Method SetData, addr 0x5da0c00, size 0x40, virtual false, abstract: false, final false
inline void SetData(::UnityEngine::Vector3  start, ::UnityEngine::Vector3  end, float_t  time) ;

/// @brief Method SetDistance, addr 0x5da0c7c, size 0x8, virtual false, abstract: false, final false
inline void SetDistance(float_t  value) ;

/// @brief Method UpdateLocalDistance, addr 0x5da0c84, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5da0d20, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
