...
// Write type traits
MARK_REF_T(::GlobalNamespace::TrailElement*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TrailElement*, "", "TrailElement");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TrailElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TrailElement(TrailElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TrailElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TrailElement(TrailElementconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::TrailElement) == 0x38, "Size mismatch!");
