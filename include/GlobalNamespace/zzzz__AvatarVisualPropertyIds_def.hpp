...
// Write type traits
MARK_REF_T(::GlobalNamespace::AvatarVisualPropertyIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AvatarVisualPropertyIds*, "", "AvatarVisualPropertyIds");
...
static_assert(sizeof(::GlobalNamespace::AvatarVisualPropertyIds) == 0x10, "Size mismatch!");
