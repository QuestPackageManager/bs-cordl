...
/// @brief Method GetHand, addr 0x5d44f34, size 0x10, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRPlugin_Hand GetHand() ;

/// @brief Method GetPointerRayTransform, addr 0x5d44ec4, size 0x8, virtual true, abstract: false, final true
inline ::UnityW<::UnityEngine::Transform> GetPointerRayTransform() ;

/// @brief Method InitializeControllerModels, addr 0x5d43d38, size 0x544, virtual false, abstract: false, final false
inline void InitializeControllerModels() ;

/// @brief Method InputFocusAquired, addr 0x5d44de8, size 0xc, virtual false, abstract: false, final false
inline void InputFocusAquired() ;

/// @brief Method InputFocusLost, addr 0x5d44df4, size 0x8, virtual false, abstract: false, final false
inline void InputFocusLost() ;

/// @brief Method IsActive, addr 0x5d44f2c, size 0x8, virtual true, abstract: false, final true
inline bool IsActive() ;

/// @brief Method IsPressed, addr 0x5d44dfc, size 0x64, virtual true, abstract: false, final true
inline bool IsPressed() ;

/// @brief Method IsReleased, addr 0x5d44e60, size 0x64, virtual true, abstract: false, final true
inline bool IsReleased() ;

/// @brief Method IsValid, addr 0x5d44ecc, size 0x60, virtual true, abstract: false, final true
inline bool IsValid() ;

static inline ::GlobalNamespace::OVRControllerHelper* New_ctor() ;

/// @brief Method OnDisable, addr 0x5d44358, size 0xdc, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5d4427c, size 0xdc, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnSceneChanged, addr 0x5d44434, size 0x5c, virtual false, abstract: false, final false
inline void OnSceneChanged(::UnityEngine::SceneManagement::Scene  unloading, ::UnityEngine::SceneManagement::Scene  loading) ;

/// @brief Method Start, addr 0x5d43cc4, size 0x74, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x5d44490, size 0x958, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdatePointerRay, addr 0x5d44f44, size 0xfc, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5d45040, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVRControllerHelper, 0xa8>, "Size mismatch!");
