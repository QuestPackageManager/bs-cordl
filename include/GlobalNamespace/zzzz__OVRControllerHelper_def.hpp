...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10152)), TypeDefinitionIndex(TypeDefinitionIndex(8866)), TypeDefinitionIndex(TypeDefinitionIndex(8492))}
...
public:
  ...
  /// @brief Method Start addr 0x262ff80 size 0x70 virtual false final false
  inline void Start();

  /// @brief Method InitializeControllerModels addr 0x262fff0 size 0x420 virtual false final false
  inline void InitializeControllerModels();

  /// @brief Method Update addr 0x2630410 size 0x6a4 virtual false final false
  inline void Update();

  /// @brief Method InputFocusAquired addr 0x2630ab4 size 0xc virtual false final false
  inline void InputFocusAquired();

  /// @brief Method InputFocusLost addr 0x2630ac0 size 0x8 virtual false final false
  inline void InputFocusLost();

  static inline ::GlobalNamespace::OVRControllerHelper* New_ctor();

  /// @brief Method .ctor addr 0x2630ac8 size 0x18 virtual false final false
  inline void _ctor();
