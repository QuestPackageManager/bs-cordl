...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<float_t (::GlobalNamespace::SaberSwingRatingCounter::*)()>(&::GlobalNamespace::SaberSwingRatingCounter::get_afterCutRating)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x3708808;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*)>(
  ...
  constexpr static std::size_t addrs = 0x3708810;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SaberSwingRatingCounter*>(),
                                                             { "RegisterDidChangeReceiver", {}, { ::i2c::type_of<::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*)>(
  ...
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x3708874;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SaberSwingRatingCounter*>(),
                                                             { "RegisterDidFinishReceiver", {}, { ::i2c::type_of<::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*)>(
  ...
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x37088d8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SaberSwingRatingCounter*>(),
                                                             { "UnregisterDidChangeReceiver", {}, { ::i2c::type_of<::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*)>(
  ...
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x370893c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SaberSwingRatingCounter*>(),
                                                             { "UnregisterDidFinishReceiver", {}, { ::i2c::type_of<::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)(::GlobalNamespace::ISaberMovementData*, ::UnityEngine::Vector3, ::UnityEngine::Quaternion,
  ...
  constexpr static std::size_t addrs = 0x37089a0;
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SaberSwingRatingCounter*>(),
                                                                                           { "Init",
                                                                                             {},
                                                                                             { ::i2c::type_of<::GlobalNamespace::ISaberMovementData*>(), ::i2c::type_of<::UnityEngine::Vector3>(),
                                                                                               ::i2c::type_of<::UnityEngine::Quaternion>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)(::GlobalNamespace::BladeMovementDataElement, ::GlobalNamespace::BladeMovementDataElement,
  ...
  constexpr static std::size_t addrs = 0x3708dd8;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(
            ::i2c::class_of<::GlobalNamespace::SaberSwingRatingCounter*>(),
            { "ProcessNewData", {}, { ::i2c::type_of<::GlobalNamespace::BladeMovementDataElement>(), ::i2c::type_of<::GlobalNamespace::BladeMovementDataElement>(), ::i2c::type_of<bool>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)()>(&::GlobalNamespace::SaberSwingRatingCounter::Finish)> {
  ...
  constexpr static std::size_t addrs = 0x3709730;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)()>(&::GlobalNamespace::SaberSwingRatingCounter::DrawGizmos)> {
  ...
  constexpr static std::size_t addrs = 0x37098f8;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::SaberSwingRatingCounter::*)()>(&::GlobalNamespace::SaberSwingRatingCounter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3709be0;
...
constexpr void GlobalNamespace::SaberSwingRatingCounter::__cordl_internal_set__saberMovementData(::GlobalNamespace::ISaberMovementData* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____saberMovementData = value;
}
...
constexpr ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*>* const&
...
GlobalNamespace::SaberSwingRatingCounter::__cordl_internal_set__didChangeReceivers(::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____didChangeReceivers = value;
}
...
constexpr ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*>* const&
...
GlobalNamespace::SaberSwingRatingCounter::__cordl_internal_set__didFinishReceivers(::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____didFinishReceivers = value;
}
...
inline void GlobalNamespace::SaberSwingRatingCounter::Init(::GlobalNamespace::ISaberMovementData* saberMovementData, ::UnityEngine::Vector3 notePosition, ::UnityEngine::Quaternion noteRotation,
  ...
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::SaberSwingRatingCounter*>(),
                                                                                         { "Init",
                                                                                           ...
                                                                                           { ::i2c::type_of<::GlobalNamespace::ISaberMovementData*>(), ::i2c::type_of<::UnityEngine::Vector3>(),
                                                                                             ::i2c::type_of<::UnityEngine::Quaternion>(), ::i2c::type_of<bool>(), ::i2c::type_of<bool>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, saberMovementData, notePosition, noteRotation, rateBeforeCut, rateAfterCut);
}
...
inline ::GlobalNamespace::SaberSwingRatingCounter* GlobalNamespace::SaberSwingRatingCounter::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::SaberSwingRatingCounter*>());
}
