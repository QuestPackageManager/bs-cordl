...
public:
  ...
  /// @brief Method MoveNext, addr 0x590d3bc, size 0x3f4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x590d7b0, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method BeforeScenesWillBeActivatedAsync, addr 0x590d2f8, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method <>n__0, addr 0x590d3b4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* __n__0();

  /// @brief Method .ctor, addr 0x590d3ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayAdditionalInformationSetupData, addr 0x590d2e8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayAdditionalInformationSetupData* get_gameplayAdditionalInformationSetupData();

  /// @brief Method get_gameplayCoreSceneSetupData, addr 0x590d2d8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_gameplayCoreSceneSetupData();

  /// @brief Method get_transformedBeatmapData, addr 0x590d2c0, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IReadonlyBeatmapData* get_transformedBeatmapData();

  /// @brief Method set_gameplayAdditionalInformationSetupData, addr 0x590d2f0, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayAdditionalInformationSetupData(::GlobalNamespace::GameplayAdditionalInformationSetupData* value);

  /// @brief Method set_gameplayCoreSceneSetupData, addr 0x590d2e0, size 0x8, virtual false, abstract: false, final false
