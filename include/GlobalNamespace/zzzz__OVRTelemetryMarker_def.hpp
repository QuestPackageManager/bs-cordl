...
public:
  ...
  /// @brief Method .ctor, addr 0x2a6bd94, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(bool sent, ::GlobalNamespace::__OVRPlugin__Qpl__ResultType result);

  /// @brief Method get_Result, addr 0x2a6be74, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__Qpl__ResultType get_Result();

  /// @brief Method get_Sent, addr 0x2a6be60, size 0x8, virtual false, abstract: false, final false
  inline bool get_Sent();

  /// @brief Method set_Result, addr 0x2a6be7c, size 0x8, virtual false, abstract: false, final false
  inline void set_Result(::GlobalNamespace::__OVRPlugin__Qpl__ResultType value);

  /// @brief Method set_Sent, addr 0x2a6be68, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddAnnotation, addr 0x2a6b9bc, size 0x50, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker AddAnnotation(::StringW annotationKey, ::StringW annotationValue);

  /// @brief Method AddPoint, addr 0x2a6bdec, size 0x50, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker AddPoint(::GlobalNamespace::__OVRTelemetry__MarkerPoint point);

  /// @brief Method Dispose, addr 0x2a6be3c, size 0x24, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Send, addr 0x2a6b82c, size 0x5c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker Send();

  /// @brief Method SendIf, addr 0x2a6bda4, size 0x48, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker SendIf(bool condition);

  /// @brief Method SetResult, addr 0x2a6b804, size 0x28, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker SetResult(::GlobalNamespace::__OVRPlugin__Qpl__ResultType result);

  /// @brief Method .ctor, addr 0x2a6bd54, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2a6b6b0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor(int32_t markerId, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method get_InstanceKey, addr 0x2a6bd4c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_InstanceKey();

  /// @brief Method get_MarkerId, addr 0x2a6bd44, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MarkerId();

  /// @brief Method get_Result, addr 0x2a6bd3c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__Qpl__ResultType get_Result();

  /// @brief Method get_Sent, addr 0x2a6bd2c, size 0x10, virtual false, abstract: false, final false
  inline bool get_Sent();

  /// @brief Method get_State, addr 0x2a6bd1c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState get_State();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable();

  /// @brief Method set_State, addr 0x2a6bd24, size 0x8, virtual false, abstract: false, final false
