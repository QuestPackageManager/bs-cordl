...
public:
  ...
  /// @brief Method get_Sent, addr 0x2793740, size 0x8, virtual false, abstract: false, final false
  inline bool get_Sent();

  /// @brief Method set_Sent, addr 0x2793748, size 0xc, virtual false, abstract: false, final false
  inline void set_Sent(bool value);

  /// @brief Method get_Result, addr 0x2793754, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__Qpl__ResultType get_Result();

  /// @brief Method set_Result, addr 0x279375c, size 0x8, virtual false, abstract: false, final false
  inline void set_Result(::GlobalNamespace::__OVRPlugin__Qpl__ResultType value);

  /// @brief Method .ctor, addr 0x2793674, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method set_State, addr 0x2793604, size 0x8, virtual false, abstract: false, final false
  inline void set_State(::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState value);

  /// @brief Method get_Sent, addr 0x279360c, size 0x10, virtual false, abstract: false, final false
  inline bool get_Sent();

  /// @brief Method get_Result, addr 0x279361c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__Qpl__ResultType get_Result();

  /// @brief Method get_MarkerId, addr 0x2793624, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_MarkerId();

  /// @brief Method get_InstanceKey, addr 0x279362c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method AddAnnotation, addr 0x279329c, size 0x50, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker AddAnnotation(::StringW annotationKey, ::StringW annotationValue);

  /// @brief Method Send, addr 0x279310c, size 0x5c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker Send();

  /// @brief Method SendIf, addr 0x2793684, size 0x48, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker SendIf(bool condition);

  /// @brief Method AddPoint, addr 0x27936cc, size 0x50, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRTelemetryMarker AddPoint(::GlobalNamespace::__OVRTelemetry__MarkerPoint point);

  /// @brief Method Dispose, addr 0x279371c, size 0x24, virtual true, abstract: false, final true
  inline void Dispose();
