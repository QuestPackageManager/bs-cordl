...
inline void GlobalNamespace::ListExtensions::setStaticF__random(::System::Random* value) {
  ::cordl_internals::setStaticField<::System::Random*, "_random", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ListExtensions*>::get>(
      std::forward<::System::Random*>(value));
}
inline ::System::Random* GlobalNamespace::ListExtensions::getStaticF__random() {
...
template <typename T> inline void GlobalNamespace::ListExtensions::ShuffleInPlace(::System::Collections::Generic::IList_1<T>* list) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ListExtensions*>::get(), "ShuffleInPlace",
                                               std::vector<Il2CppClass*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get() },
