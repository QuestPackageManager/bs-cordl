...
public:
  ...
  /// @brief Method Move, addr 0x3c0d6b8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method StartCountdown, addr 0x3c0d634, size 0x84, virtual false, abstract: false, final false
  inline void StartCountdown();

  /// @brief Method StopCountdown, addr 0x3c0d7f0, size 0xa0, virtual false, abstract: false, final false
  inline void StopCountdown(bool instant);

  /// @brief Method <Move>b__7_0, addr 0x3c0d898, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c0d890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
