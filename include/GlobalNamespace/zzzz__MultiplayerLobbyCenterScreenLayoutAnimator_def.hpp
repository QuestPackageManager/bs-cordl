...
public:
  ...
  /// @brief Method Move, addr 0x3c08744, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method StartCountdown, addr 0x3c086c0, size 0x84, virtual false, abstract: false, final false
  inline void StartCountdown();

  /// @brief Method StopCountdown, addr 0x3c0887c, size 0xa0, virtual false, abstract: false, final false
  inline void StopCountdown(bool instant);

  /// @brief Method <Move>b__7_0, addr 0x3c08924, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c0891c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
