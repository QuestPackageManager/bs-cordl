...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InlineLinkAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InlineLinkAttribute(InlineLinkAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InlineLinkAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InlineLinkAttribute(InlineLinkAttributeconst&) = delete;
