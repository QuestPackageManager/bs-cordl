...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionObjectiveResult*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionObjectiveResult*, "", "MissionObjectiveResult");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3751ee4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::MissionObjective* missionObjective, bool cleared, int32_t value);

  /// @brief Method get_cleared, addr 0x3751ec4, size 0x8, virtual false, abstract: false, final false
  inline bool get_cleared();

  /// @brief Method get_missionObjective, addr 0x3751eb4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MissionObjective* get_missionObjective();

  /// @brief Method get_value, addr 0x3751ed4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_cleared, addr 0x3751ecc, size 0x8, virtual false, abstract: false, final false
  inline void set_cleared(bool value);

  /// @brief Method set_missionObjective, addr 0x3751ebc, size 0x8, virtual false, abstract: false, final false
  inline void set_missionObjective(::GlobalNamespace::MissionObjective* value);

  /// @brief Method set_value, addr 0x3751edc, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MissionObjectiveResult) == 0x20, "Size mismatch!");
