...
public:
  ...
  /// @brief Method .ctor, addr 0x26d6e84, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::MissionObjective* missionObjective, bool cleared, int32_t value);

  /// @brief Method get_cleared, addr 0x26d6e60, size 0x8, virtual false, abstract: false, final false
  inline bool get_cleared();

  /// @brief Method get_missionObjective, addr 0x26d6e50, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MissionObjective* get_missionObjective();

  /// @brief Method get_value, addr 0x26d6e74, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_value();

  /// @brief Method set_cleared, addr 0x26d6e68, size 0xc, virtual false, abstract: false, final false
  inline void set_cleared(bool value);

  /// @brief Method set_missionObjective, addr 0x26d6e58, size 0x8, virtual false, abstract: false, final false
  inline void set_missionObjective(::GlobalNamespace::MissionObjective* value);

  /// @brief Method set_value, addr 0x26d6e7c, size 0x8, virtual false, abstract: false, final false
