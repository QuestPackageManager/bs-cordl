...
public:
  // Declarations
  /// @brief Method DidActivate, addr 0x23e978c, size 0x4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::GameServerBrowserFlowCoordinator* New_ctor();

  /// @brief Method .ctor, addr 0x23e9790, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
