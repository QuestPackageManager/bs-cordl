...
public:
  // Declarations
  /// @brief Method GetAnyJoystickMaxAxisDefaultImplementation, addr 0x57143e4, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMenuButtonDefaultImplementation, addr 0x5713bf4, size 0x78, virtual false, abstract: false, final false
  static inline bool GetMenuButtonDefaultImplementation();

  /// @brief Method GetMenuButtonDownDefaultImplementation, addr 0x5713c70, size 0x78, virtual false, abstract: false, final false
  static inline bool GetMenuButtonDownDefaultImplementation();

  /// @brief Method StopXR, addr 0x5714520, size 0x110, virtual false, abstract: false, final false
  static inline void StopXR(::GlobalNamespace::IVerboseLogger* logger);

  /// @brief Method TriggerValueDefaultImplementation, addr 0x5714358, size 0x8c, virtual false, abstract: false, final false
