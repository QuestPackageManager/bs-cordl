...
public:
  // Declarations
  /// @brief Method GetAnyJoystickMaxAxisDefaultImplementation, addr 0x24d94a8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMenuButtonDefaultImplementation, addr 0x24d8d18, size 0x78, virtual false, abstract: false, final false
  static inline bool GetMenuButtonDefaultImplementation();

  /// @brief Method GetMenuButtonDownDefaultImplementation, addr 0x24d8d94, size 0x78, virtual false, abstract: false, final false
  static inline bool GetMenuButtonDownDefaultImplementation();

  /// @brief Method StopXR, addr 0x24d95e0, size 0x100, virtual false, abstract: false, final false
  static inline void StopXR(::GlobalNamespace::IVerboseLogger* logger);

  /// @brief Method TriggerValueDefaultImplementation, addr 0x24d9428, size 0x80, virtual false, abstract: false, final false
