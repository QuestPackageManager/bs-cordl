...
public:
  // Declarations
  /// @brief Method TriggerValueDefaultImplementation addr 0x1fa4af8 size 0x80 virtual false final false
  static inline float_t TriggerValueDefaultImplementation(::UnityEngine::XR::XRNode node);

  /// @brief Method GetMenuButtonDefaultImplementation addr 0x1fa3e2c size 0x78 virtual false final false
  static inline bool GetMenuButtonDefaultImplementation();

  /// @brief Method GetMenuButtonDownDefaultImplementation addr 0x1fa3ea8 size 0x78 virtual false final false
  static inline bool GetMenuButtonDownDefaultImplementation();

  /// @brief Method GetAnyJoystickMaxAxisDefaultImplementation addr 0x1fa4b78 size 0x154 virtual false final false
