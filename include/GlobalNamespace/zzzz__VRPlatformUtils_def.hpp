...
public:
// Declarations
/// @brief Method GetAnyJoystickMaxAxisDefaultImplementation, addr 0x56a6500, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method GetMenuButtonDefaultImplementation, addr 0x56a5d18, size 0x78, virtual false, abstract: false, final false
static inline bool GetMenuButtonDefaultImplementation() ;

/// @brief Method GetMenuButtonDownDefaultImplementation, addr 0x56a5d94, size 0x78, virtual false, abstract: false, final false
static inline bool GetMenuButtonDownDefaultImplementation() ;

/// @brief Method StopXR, addr 0x56a663c, size 0x110, virtual false, abstract: false, final false
static inline void StopXR(::GlobalNamespace::IVerboseLogger*  logger) ;

/// @brief Method TriggerValueDefaultImplementation, addr 0x56a6474, size 0x8c, virtual false, abstract: false, final false
