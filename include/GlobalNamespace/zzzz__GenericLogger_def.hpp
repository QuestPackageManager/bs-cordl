...
public:
  ...
  /// @brief Method Dispose, addr 0x39572f4, size 0xf0, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x3957218, size 0xdc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Format, addr 0x3956f74, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW Format(::GlobalNamespace::IVerboseLogger* logger, ::StringW message);

  /// @brief Method Log, addr 0x3957060, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method LogWithTimestamp, addr 0x39570d8, size 0x140, virtual false, abstract: false, final false
