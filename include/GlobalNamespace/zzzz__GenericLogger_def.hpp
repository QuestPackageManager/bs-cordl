...
public:
  ...
  /// @brief Method Dispose, addr 0x23d2a68, size 0xc4, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x23d29b0, size 0xb8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Format, addr 0x23d2708, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW Format(::GlobalNamespace::IVerboseLogger* logger, ::StringW message);

  /// @brief Method Log, addr 0x23d27f4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method LogWithTimestamp, addr 0x23d286c, size 0x144, virtual false, abstract: false, final false
