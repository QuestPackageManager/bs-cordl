...
public:
  ...
  /// @brief Method Awake, addr 0x576ce54, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x576cf0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
