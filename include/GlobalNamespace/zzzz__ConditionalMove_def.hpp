...
public:
  ...
  /// @brief Method Awake, addr 0x570f06c, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x570f124, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
