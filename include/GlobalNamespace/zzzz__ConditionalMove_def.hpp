...
public:
  ...
  /// @brief Method Awake, addr 0x2696360, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x2696418, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
