...
public:
  ...
  /// @brief Method Awake, addr 0x23d8734, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x23d87ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
