...
/// @brief Method Deinit, addr 0x5841d44, size 0x8c, virtual false, abstract: false, final false
inline void Deinit() ;

/// @brief Method HandleGameEvent, addr 0x5841dd4, size 0x38, virtual false, abstract: false, final false
inline void HandleGameEvent() ;

/// @brief Method Init, addr 0x5841c4c, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5841e8c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _eventTextBindings, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__eventTextBindings, put=__cordl_internal_set__eventTextBindings)) ::ArrayW<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*,::Array<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*>*>  _eventTextBindings;

/// @brief Field _textFadeTransitions, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__textFadeTransitions, put=__cordl_internal_set__textFadeTransitions)) ::UnityW<::GlobalNamespace::TextFadeTransitions>  _textFadeTransitions;

/// @brief Method Awake, addr 0x5841bec, size 0x60, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::ShowTextOnGameEventController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5841cf4, size 0x50, virtual false, abstract: false, final false
inline void OnDestroy() ;

constexpr ::ArrayW<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*,::Array<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*>*> const& __cordl_internal_get__eventTextBindings() const;

constexpr ::ArrayW<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*,::Array<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*>*>& __cordl_internal_get__eventTextBindings() ;

constexpr ::UnityW<::GlobalNamespace::TextFadeTransitions> const& __cordl_internal_get__textFadeTransitions() const;

constexpr ::UnityW<::GlobalNamespace::TextFadeTransitions>& __cordl_internal_get__textFadeTransitions() ;

constexpr void __cordl_internal_set__eventTextBindings(::ArrayW<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*,::Array<::GlobalNamespace::ShowTextOnGameEventController_EventTextBinding*>*>  value) ;

constexpr void __cordl_internal_set__textFadeTransitions(::UnityW<::GlobalNamespace::TextFadeTransitions>  value) ;

/// @brief Method .ctor, addr 0x5841dd0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
