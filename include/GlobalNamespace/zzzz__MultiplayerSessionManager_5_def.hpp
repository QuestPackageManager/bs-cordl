...
static ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData> const Connected;

/// @brief Field Connecting value: I32(1)
static ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData> const Connecting;

/// @brief Field Disconnected value: I32(0)
static ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData> const Disconnected;

/// @brief Field Disconnecting value: I32(3)
static ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData> const Disconnecting;
...
/// @brief Field <>9, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9, put=setStaticF___9)) ::GlobalNamespace::MultiplayerSessionManager_5___c<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>*  __9;
...
static inline void setStaticF___9(::GlobalNamespace::MultiplayerSessionManager_5___c<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>*  value) ;
...
static inline ::GlobalNamespace::MultiplayerSessionManager_5___c__DisplayClass94_0<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>* New_ctor() ;
...
public:
// Declarations
using ConnectionState = ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType, TConnectedPlayerSessionManager, TConnectedPlayer, TConnectedPlayerImpl, TGameSpecificIdentityData>;
...
using __c__DisplayClass94_0 = ::GlobalNamespace::MultiplayerSessionManager_5___c__DisplayClass94_0<TMessageType, TConnectedPlayerSessionManager, TConnectedPlayer, TConnectedPlayerImpl, TGameSpecificIdentityData>;
...
/// @brief Field _connectionState, offset 0x5c, size 0x4 
 __declspec(property(get=__cordl_internal_get__connectionState, put=__cordl_internal_set__connectionState)) ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>  _connectionState;
...
/// @brief Field _packetSerializer, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__packetSerializer, put=__cordl_internal_set__packetSerializer)) ::GlobalNamespace::NetworkPacketSerializer_2<TMessageType,TConnectedPlayer>*  _packetSerializer;
...
/// @brief Field connectionOwnerStateChangedEvent, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_connectionOwnerStateChangedEvent, put=__cordl_internal_set_connectionOwnerStateChangedEvent)) ::System::Action_1<TConnectedPlayer>*  connectionOwnerStateChangedEvent;
...
inline void StartSession(TConnectedPlayerSessionManager  connectedPlayerManager, ::GlobalNamespace::IMultiplayerSessionManager_1_IMultiplayerSessionInitializer<TConnectedPlayer>*  multiplayerSessionInitializer) ;
...
constexpr ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData> const& __cordl_internal_get__connectionState() const;

constexpr ::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>& __cordl_internal_get__connectionState() ;
...
constexpr void __cordl_internal_set__connectionState(::GlobalNamespace::MultiplayerSessionManager_5_ConnectionState<TMessageType,TConnectedPlayerSessionManager,TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>  value) ;
...
constexpr ::GlobalNamespace::IMultiplayerSessionMessageProcessor_2<TMessageType,TConnectedPlayer>* i___GlobalNamespace__IMultiplayerSessionMessageProcessor_2_TMessageType_TConnectedPlayer_() noexcept;
