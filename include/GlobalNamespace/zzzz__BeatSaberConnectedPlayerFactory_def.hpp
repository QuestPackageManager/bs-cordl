...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatSaberConnectedPlayerFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatSaberConnectedPlayerFactory(BeatSaberConnectedPlayerFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatSaberConnectedPlayerFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatSaberConnectedPlayerFactory(BeatSaberConnectedPlayerFactoryconst&) = delete;
