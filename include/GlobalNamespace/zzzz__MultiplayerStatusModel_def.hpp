...
public:
  ...
  /// @brief Method .ctor, addr 0x26d48c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26d48c8, size 0x868, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26d5130, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method GetMultiplayerStatusAsync, addr 0x26d46b0, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetMultiplayerStatusAsyncInternal, addr 0x26d4778, size 0xe8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::MultiplayerStatusData*>* GetMultiplayerStatusAsyncInternal();

  /// @brief Method Init, addr 0x26d4680, size 0x18, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method IsAvailabilityTaskValid, addr 0x26d471c, size 0x5c, virtual false, abstract: false, final false
  inline bool IsAvailabilityTaskValid();

  static inline ::GlobalNamespace::MultiplayerStatusModel* New_ctor();

  /// @brief Method StartRequest, addr 0x26d4698, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d4860, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
