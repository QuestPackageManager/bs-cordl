...
public:
  ...
  /// @brief Method OnDestroy, addr 0x249fdfc, size 0x148, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x249fb7c, size 0x280, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x249ff44, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
