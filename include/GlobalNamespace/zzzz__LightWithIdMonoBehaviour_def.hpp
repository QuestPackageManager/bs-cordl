...
public:
  ...
  /// @brief Method OnDisable, addr 0x39e33b0, size 0x84, virtual true, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39e3324, size 0x4, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterLight, addr 0x39e3328, size 0x84, virtual false, abstract: false, final false
  inline void RegisterLight();

  /// @brief Method SetLightId, addr 0x39e3434, size 0xa8, virtual false, abstract: false, final false
  inline void SetLightId(int32_t newLightId);

  /// @brief Method Start, addr 0x39e33ac, size 0x4, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method __SetIsRegistered, addr 0x39e3310, size 0xc, virtual true, abstract: false, final true
  inline void __SetIsRegistered();

  /// @brief Method __SetIsUnRegistered, addr 0x39e331c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39e0cf0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isRegistered, addr 0x39e3308, size 0x8, virtual true, abstract: false, final true
  inline bool get_isRegistered();

  /// @brief Method get_lightId, addr 0x39e3300, size 0x8, virtual true, abstract: false, final true
