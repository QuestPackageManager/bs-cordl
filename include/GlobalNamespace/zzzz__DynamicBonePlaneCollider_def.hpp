...
public:
  // Declarations
  /// @brief Method OnValidate, addr 0x12cb998, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Collide, addr 0x12cb99c, size 0x188, virtual true, abstract: false, final false
  inline void Collide(ByRef<::UnityEngine::Vector3> particlePosition, float_t particleRadius);

  /// @brief Method OnDrawGizmosSelected, addr 0x12cbb24, size 0x160, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  static inline ::GlobalNamespace::DynamicBonePlaneCollider* New_ctor();

  /// @brief Method .ctor, addr 0x12cbc84, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
