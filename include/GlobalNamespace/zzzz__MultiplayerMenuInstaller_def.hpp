...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerMenuInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerMenuInstaller*, "", "MultiplayerMenuInstaller");
...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x59f8260, size 0xb8, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::MultiplayerMenuInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x59f8318, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerMenuInstaller) == 0x28, "Size mismatch!");
