...
/// @brief Field _burstSliderElementNoteHDPrefab, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderElementNoteHDPrefab, put=__cordl_internal_set__burstSliderElementNoteHDPrefab)) ::UnityW<::GlobalNamespace::NoteDebris>  _burstSliderElementNoteHDPrefab;

/// @brief Field _burstSliderElementNoteLWPrefab, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderElementNoteLWPrefab, put=__cordl_internal_set__burstSliderElementNoteLWPrefab)) ::UnityW<::GlobalNamespace::NoteDebris>  _burstSliderElementNoteLWPrefab;

/// @brief Field _burstSliderHeadNoteDebrisHDPrefab, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderHeadNoteDebrisHDPrefab, put=__cordl_internal_set__burstSliderHeadNoteDebrisHDPrefab)) ::UnityW<::GlobalNamespace::NoteDebris>  _burstSliderHeadNoteDebrisHDPrefab;

/// @brief Field _burstSliderHeadNoteDebrisLWPrefab, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderHeadNoteDebrisLWPrefab, put=__cordl_internal_set__burstSliderHeadNoteDebrisLWPrefab)) ::UnityW<::GlobalNamespace::NoteDebris>  _burstSliderHeadNoteDebrisLWPrefab;
...
/// @brief Field _noteDebrisHDConditionVariable, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteDebrisHDConditionVariable, put=__cordl_internal_set__noteDebrisHDConditionVariable)) ::UnityW<::GlobalNamespace::BoolSO>  _noteDebrisHDConditionVariable;

/// @brief Method InstallBindings, addr 0x58c7b84, size 0x208, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58c7d8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
