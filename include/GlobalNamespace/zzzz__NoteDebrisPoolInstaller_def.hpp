...
public:
  ...
  /// @brief Method InstallBindings, addr 0x23ce690, size 0x234, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::NoteDebrisPoolInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x23ce8c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
