...
public:
  ...
  /// @brief Method InstallBindings, addr 0x262a990, size 0x234, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262abc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
