...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoteDebrisPoolInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteDebrisPoolInstaller*, "", "NoteDebrisPoolInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59feae8, size 0x208, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fecf0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::NoteDebrisPoolInstaller) == 0x58, "Size mismatch!");
