...
/// @brief Method InstallBindings, addr 0x5851a00, size 0x208, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5851c08, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
