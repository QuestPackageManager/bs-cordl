...
public:
  ...
  /// @brief Method Awake, addr 0x569c67c, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::FPSCounter* New_ctor();

  /// @brief Method Update, addr 0x569c68c, size 0xd0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x569c75c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentFPS, addr 0x569c63c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentFPS();

  /// @brief Method get_droppedFrames, addr 0x569c66c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_droppedFrames();

  /// @brief Method get_highestFPS, addr 0x569c65c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_highestFPS();

  /// @brief Method get_lowestFPS, addr 0x569c64c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lowestFPS();

  /// @brief Method set_currentFPS, addr 0x569c644, size 0x8, virtual false, abstract: false, final false
  inline void set_currentFPS(int32_t value);

  /// @brief Method set_droppedFrames, addr 0x569c674, size 0x8, virtual false, abstract: false, final false
  inline void set_droppedFrames(int32_t value);

  /// @brief Method set_highestFPS, addr 0x569c664, size 0x8, virtual false, abstract: false, final false
  inline void set_highestFPS(int32_t value);

  /// @brief Method set_lowestFPS, addr 0x569c654, size 0x8, virtual false, abstract: false, final false
