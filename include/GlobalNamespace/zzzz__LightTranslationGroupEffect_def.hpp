...
MARK_REF_PTR_T(::GlobalNamespace::LightTranslationGroupEffect_InitData);
MARK_REF_PTR_T(::GlobalNamespace::LightTranslationGroupEffect___c__DisplayClass12_0);
...
public:
  ...
  /// @brief Method .ctor, addr 0x3b95604, size 0xd8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___elementId) == 0x14, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___xMirrored) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___yMirrored) == 0x19, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___zMirrored) == 0x1a, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___xTransform) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___yTransform) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___zTransform) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___xTranslationLimits) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___xDistributionLimits) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___yTranslationLimits) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___yDistributionLimits) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___zTranslationLimits) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect_InitData, ___zDistributionLimits) == 0x60, "Offset mismatch!");
...
public:
  ...
  /// @brief Method <GetTranslationEventHandler>b__0, addr 0x3b956dc, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b953ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect___c__DisplayClass12_0, ___translationLimits) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect___c__DisplayClass12_0, ___distributionLimits) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect___c__DisplayClass12_0, ___mirrored) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightTranslationGroupEffect___c__DisplayClass12_0, _____4__this) == 0x30, "Offset mismatch!");
...
public:
  ...
  /// @brief Method Cleanup, addr 0x3b95344, size 0x68, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method ComputeTranslation, addr 0x3b955b8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTranslationEventHandler, addr 0x3b95258, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method SetTranslation, addr 0x3b953b4, size 0x1c8, virtual false, abstract: false, final false
  inline void SetTranslation(float_t _);

  /// @brief Method SetTweenData, addr 0x3b9557c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b94684, size 0xbd4, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::LightTranslationGroupEffect_InitData*, "", "LightTranslationGroupEffect/InitData");
NEED_NO_BOX(::GlobalNamespace::LightTranslationGroupEffect___c__DisplayClass12_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::LightTranslationGroupEffect___c__DisplayClass12_0*, "", "LightTranslationGroupEffect/<>c__DisplayClass12_0");
