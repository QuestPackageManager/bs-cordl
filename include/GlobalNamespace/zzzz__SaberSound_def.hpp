...
public:
  ...
  /// @brief Method Start, addr 0x58b827c, size 0x2c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58b82a8, size 0x218, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58b84c0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
