...
public:
  ...
  /// @brief Method Start, addr 0x23c33f4, size 0x2c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x23c3420, size 0x1cc, virtual false, abstract: false, final false
  inline void Update();

  static inline ::GlobalNamespace::SaberSound* New_ctor();

  /// @brief Method .ctor, addr 0x23c35ec, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
