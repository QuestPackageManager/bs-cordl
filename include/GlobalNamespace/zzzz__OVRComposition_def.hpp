...
public:
  ...
  /// @brief Method ComputeCameraWorldSpacePose, addr 0x5df3918, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x5df3914, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5df373c, size 0x4, virtual false, abstract: false, final false
