...
public:
  ...
  /// @brief Method ComputeCameraTrackingSpacePose, addr 0x3f979f4, size 0x288, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose ComputeCameraTrackingSpacePose(::GlobalNamespace::OVRPlugin_CameraExtrinsics extrinsics);

  /// @brief Method ComputeCameraWorldSpacePose, addr 0x3f9798c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x3f97988, size 0x4, virtual true, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method RefreshCameraRig, addr 0x3f977d0, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3f9779c, size 0x34, virtual false, abstract: false, final false
