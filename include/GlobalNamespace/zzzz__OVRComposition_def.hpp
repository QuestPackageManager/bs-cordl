...
public:
  ...
  /// @brief Method ComputeCameraTrackingSpacePose, addr 0x5df175c, size 0x2ac, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose ComputeCameraTrackingSpacePose(::GlobalNamespace::OVRPlugin_CameraExtrinsics extrinsics);

  /// @brief Method ComputeCameraWorldSpacePose, addr 0x5df16f0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x5df16ec, size 0x4, virtual true, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method RefreshCameraRig, addr 0x5df1518, size 0x1d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5df1514, size 0x4, virtual false, abstract: false, final false
