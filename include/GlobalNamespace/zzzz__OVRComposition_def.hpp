...
public:
  ...
  /// @brief Method ComputeCameraTrackingSpacePose, addr 0x2b04534, size 0x288, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPose ComputeCameraTrackingSpacePose(::GlobalNamespace::__OVRPlugin__CameraExtrinsics extrinsics);

  /// @brief Method ComputeCameraWorldSpacePose, addr 0x2b044cc, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x2b044c8, size 0x4, virtual true, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method RefreshCameraRig, addr 0x2b04310, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b042dc, size 0x34, virtual false, abstract: false, final false
