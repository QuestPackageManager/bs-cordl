...
public:
  ...
  /// @brief Method LateUpdate, addr 0x577c270, size 0xe0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::MainAudioEffects* New_ctor();

  /// @brief Method ResumeNormalSound, addr 0x577c350, size 0x28, virtual false, abstract: false, final false
  inline void ResumeNormalSound();

  /// @brief Method Start, addr 0x577c23c, size 0x34, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TriggerLowPass, addr 0x577c378, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x577c3b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
