...
public:
  ...
  /// @brief Method Start, addr 0x22b7cc4, size 0x34, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method LateUpdate, addr 0x22b7cf8, size 0xbc, virtual false, abstract: false, final false
  inline void LateUpdate();

  /// @brief Method ResumeNormalSound, addr 0x22b7db4, size 0x28, virtual false, abstract: false, final false
  inline void ResumeNormalSound();

  /// @brief Method TriggerLowPass, addr 0x22b7ddc, size 0x3c, virtual false, abstract: false, final false
  inline void TriggerLowPass();

  static inline ::GlobalNamespace::MainAudioEffects* New_ctor();

  /// @brief Method .ctor, addr 0x22b7e18, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
