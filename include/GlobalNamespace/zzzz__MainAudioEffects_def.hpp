...
public:
  ...
  /// @brief Method LateUpdate, addr 0x56abd1c, size 0xe0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::MainAudioEffects* New_ctor();

  /// @brief Method ResumeNormalSound, addr 0x56abdfc, size 0x28, virtual false, abstract: false, final false
  inline void ResumeNormalSound();

  /// @brief Method Start, addr 0x56abce8, size 0x34, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method TriggerLowPass, addr 0x56abe24, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56abe60, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
