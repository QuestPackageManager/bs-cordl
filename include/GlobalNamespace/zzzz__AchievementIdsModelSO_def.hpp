...
public:
  ...
  /// @brief Method .ctor, addr 0x36f8c58, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementsIds, addr 0x36f8c50, size 0x8, virtual false, abstract: false, final false
