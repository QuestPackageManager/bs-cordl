...
public:
  ...
  /// @brief Method .ctor, addr 0x35fccd8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementsIds, addr 0x35fccd0, size 0x8, virtual false, abstract: false, final false
