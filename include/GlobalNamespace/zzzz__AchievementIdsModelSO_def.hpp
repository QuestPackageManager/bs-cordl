...
public:
  ...
  /// @brief Method .ctor, addr 0x26a17ec, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_achievementsIds, addr 0x26a17e4, size 0x8, virtual false, abstract: false, final false
