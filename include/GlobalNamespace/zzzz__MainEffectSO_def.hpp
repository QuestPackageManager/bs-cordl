...
public:
  ...
  /// @brief Method PreRender addr 0x268dde8 size 0x4 virtual true final false
  inline void PreRender();

  /// @brief Method Render addr 0x268ddec size 0x4 virtual true final false
  inline void Render(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest, float_t fade);

  /// @brief Method PostRender addr 0x268ddf0 size 0x4 virtual true final false
  inline void PostRender(float_t fade);

  /// @brief Method get_hasPostProcessEffect addr 0x268ddf4 size 0x8 virtual true final false
  inline bool get_hasPostProcessEffect();

  static inline ::GlobalNamespace::MainEffectSO* New_ctor();

  /// @brief Method .ctor addr 0x268d610 size 0x8 virtual false final false
  inline void _ctor();
