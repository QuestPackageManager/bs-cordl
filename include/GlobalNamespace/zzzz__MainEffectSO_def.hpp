...
public:
  ...
  /// @brief Method PostRender, addr 0x5d955d8, size 0x4, virtual true, abstract: false, final false
  inline void PostRender(float_t fade);

  /// @brief Method PreRender, addr 0x5d955d0, size 0x4, virtual true, abstract: false, final false
  inline void PreRender();

  /// @brief Method Render, addr 0x5d955d4, size 0x4, virtual true, abstract: false, final false
  inline void Render(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest, float_t fade);

  /// @brief Method .ctor, addr 0x5d94cd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_hasPostProcessEffect, addr 0x5d955dc, size 0x8, virtual true, abstract: false, final false
