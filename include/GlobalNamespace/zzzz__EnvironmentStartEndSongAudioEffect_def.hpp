...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnvironmentStartEndSongAudioEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentStartEndSongAudioEffect*, "", "EnvironmentStartEndSongAudioEffect");
// Dependencies EnvironmentContext, UnityEngine.AudioClip, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__songFailedAudioClips, put = __cordl_internal_set__songFailedAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>> _songFailedAudioClips;
  ...
  __declspec(property(get = __cordl_internal_get__songFinishedAudioClips, put = __cordl_internal_set__songFinishedAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>> _songFinishedAudioClips;
  ...
  /// @brief Method HandleGamePauseDidPause, addr 0x58b9ef0, size 0x24, virtual false, abstract: false, final false
  inline void HandleGamePauseDidPause();

  /// @brief Method HandleGamePauseDidResume, addr 0x58b9ecc, size 0x24, virtual false, abstract: false, final false
  inline void HandleGamePauseDidResume();

  /// @brief Method HandleLevelFailed, addr 0x58b9e10, size 0xbc, virtual false, abstract: false, final false
  inline void HandleLevelFailed();

  /// @brief Method LevelWillFinishWithinAheadTime, addr 0x58b9d8c, size 0x84, virtual false, abstract: false, final false
  inline void LevelWillFinishWithinAheadTime();

  static inline ::GlobalNamespace::EnvironmentStartEndSongAudioEffect* New_ctor();

  /// @brief Method OnDestroy, addr 0x58b97f4, size 0x2c8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x58b9308, size 0x4ec, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58b9abc, size 0x2d0, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__songFailedAudioClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__songFailedAudioClips();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__songFinishedAudioClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__songFinishedAudioClips();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>> const& __cordl_internal_get__songStartAudioClips() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::AudioClip>>& __cordl_internal_get__songStartAudioClips();
  ...
  constexpr void __cordl_internal_set__songFailedAudioClips(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value);
  ...
  constexpr void __cordl_internal_set__songFinishedAudioClips(::ArrayW<::UnityW<::UnityEngine::AudioClip>> value);
  ...
  /// @brief Method .ctor, addr 0x58b9f14, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EnvironmentStartEndSongAudioEffect) == 0x78, "Size mismatch!");
