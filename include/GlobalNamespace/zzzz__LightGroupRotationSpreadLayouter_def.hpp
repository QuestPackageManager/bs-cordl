...
public:
  ...
  /// @brief Method .ctor, addr 0x599a524, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightGroupRotationSpreadLayouter) == 0x38, "Size mismatch!");
