...
// Write type traits
MARK_REF_T(::GlobalNamespace::FirstPersonFlyingController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FirstPersonFlyingController*, "", "FirstPersonFlyingController");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__controllerModels, put = __cordl_internal_set__controllerModels)) ::ArrayW<::UnityW<::UnityEngine::GameObject>> _controllerModels;
  ...
  /// @brief Field _originalAllowXRRendering, offset 0x78, size 0x1
  __declspec(property(get = __cordl_internal_get__originalAllowXRRendering, put = __cordl_internal_set__originalAllowXRRendering)) bool _originalAllowXRRendering;
  ...
  /// @brief Method Inject, addr 0x591ceb0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x591c7a4, size 0x26c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x591c534, size 0x270, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Update, addr 0x591ca10, size 0x4a0, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>> const& __cordl_internal_get__controllerModels() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::GameObject>>& __cordl_internal_get__controllerModels();
  ...
  constexpr bool const& __cordl_internal_get__originalAllowXRRendering() const;

  constexpr bool& __cordl_internal_get__originalAllowXRRendering();
  ...
  constexpr void __cordl_internal_set__controllerModels(::ArrayW<::UnityW<::UnityEngine::GameObject>> value);
  ...
  constexpr void __cordl_internal_set__originalAllowXRRendering(bool value);
  ...
  /// @brief Method .ctor, addr 0x591cfac, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _originalAllowXRRendering, offset: 0x78, size: 0x1, def value: None
  bool ____originalAllowXRRendering;
...
static_assert(offsetof(::GlobalNamespace::FirstPersonFlyingController, ____originalAllowXRRendering) == 0x78, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::FirstPersonFlyingController) == 0x88, "Size mismatch!");
