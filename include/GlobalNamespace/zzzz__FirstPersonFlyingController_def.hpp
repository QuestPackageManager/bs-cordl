...
/// @brief Field _controllerModels, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__controllerModels, put=__cordl_internal_set__controllerModels)) ::ArrayW<::UnityW<::UnityEngine::GameObject>,::Array<::UnityW<::UnityEngine::GameObject>>*>  _controllerModels;
...
/// @brief Method Inject, addr 0x5749e94, size 0x10c, virtual false, abstract: false, final false
inline void Inject(::UnityEngine::Camera*  camera, ::GlobalNamespace::VRCenterAdjust*  centerAdjust, ::GlobalNamespace::VRController*  controller0, ::GlobalNamespace::VRController*  controller1, ::UnityEngine::SpatialTracking::TrackedPoseDriver*  trackedPoseDriver, bool  overrideDisableMovement, ::GlobalNamespace::PauseController*  pausedController) ;

static inline ::GlobalNamespace::FirstPersonFlyingController* New_ctor() ;

/// @brief Method OnDisable, addr 0x574944c, size 0x2d0, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x57490c8, size 0x2b0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Update, addr 0x574971c, size 0x49c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5749fa0, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
