...
public:
  ...
  /// @brief Method IsValid, addr 0x10c3078, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x10c306c, size 0xc, virtual false, abstract: false, final false
