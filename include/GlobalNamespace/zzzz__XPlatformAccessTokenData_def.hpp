...
/// @brief Method IsValid, addr 0x3280cd0, size 0x40, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method .ctor, addr 0x3280cc4, size 0xc, virtual false, abstract: false, final false
