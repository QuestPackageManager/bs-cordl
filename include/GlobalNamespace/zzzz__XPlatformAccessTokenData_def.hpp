...
public:
  ...
  /// @brief Method IsValid, addr 0x22dfcd0, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x22dfcc4, size 0xc, virtual false, abstract: false, final false
