...
public:
  ...
  /// @brief Method IsValid, addr 0xee4268, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0xee425c, size 0xc, virtual false, abstract: false, final false
