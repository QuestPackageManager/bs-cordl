...
public:
  ...
  /// @brief Method IsValid, addr 0x22e0cec, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x22e0ce0, size 0xc, virtual false, abstract: false, final false
