...
public:
  ...
  __declspec(property(get = __cordl_internal_get__platformEnvironment_k__BackingField,
                      put = __cordl_internal_set__platformEnvironment_k__BackingField))::GlobalNamespace::PlatformEnvironment _platformEnvironment_k__BackingField;
  ...
  constexpr ::GlobalNamespace::PlatformEnvironment& __cordl_internal_get__platformEnvironment_k__BackingField();

  constexpr ::GlobalNamespace::PlatformEnvironment const& __cordl_internal_get__platformEnvironment_k__BackingField() const;

  constexpr void __cordl_internal_set__platformEnvironment_k__BackingField(::GlobalNamespace::PlatformEnvironment value);

  /// @brief Method get_token, addr 0xe51d4c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_token();

  /// @brief Method set_token, addr 0xe51d54, size 0x8, virtual false, abstract: false, final false
  inline void set_token(::StringW value);

  /// @brief Method get_platformEnvironment, addr 0xe51d5c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlatformEnvironment get_platformEnvironment();

  /// @brief Method set_platformEnvironment, addr 0xe51d64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe51d6c, size 0x30, virtual false, abstract: false, final false
