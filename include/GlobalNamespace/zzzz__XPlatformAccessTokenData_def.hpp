...
public:
  ...
  /// @brief Method IsValid, addr 0xfbcdec, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0xfbcde0, size 0xc, virtual false, abstract: false, final false
