...
public:
  ...
  /// @brief Method IsValid, addr 0x22e6420, size 0x40, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method .ctor, addr 0x22e6414, size 0xc, virtual false, abstract: false, final false
