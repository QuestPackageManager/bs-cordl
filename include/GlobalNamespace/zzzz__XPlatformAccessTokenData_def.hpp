...
/// @brief Method IsValid, addr 0x3243a5c, size 0x40, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method .ctor, addr 0x3243a50, size 0xc, virtual false, abstract: false, final false
