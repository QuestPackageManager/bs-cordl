...
/// @brief Method AreSabersClashing, addr 0x58409d8, size 0x198, virtual false, abstract: false, final false
inline bool AreSabersClashing(::ByRef<::UnityEngine::Vector3>  clashingPoint) ;

/// @brief Method Init, addr 0x5845308, size 0x18, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::SaberManager*  saberManager) ;

static inline ::GlobalNamespace::SaberClashChecker* New_ctor() ;

/// @brief Method SegmentToSegmentDist, addr 0x5845320, size 0x278, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5845598, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
