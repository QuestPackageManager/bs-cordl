...
public:
  ...
  /// @brief Method AreSabersClashing, addr 0x58b2de0, size 0x198, virtual false, abstract: false, final false
  inline bool AreSabersClashing(::ByRef<::UnityEngine::Vector3> clashingPoint);

  /// @brief Method Init, addr 0x58b78f0, size 0x18, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::SaberManager* saberManager);

  static inline ::GlobalNamespace::SaberClashChecker* New_ctor();

  /// @brief Method SegmentToSegmentDist, addr 0x58b7908, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b7b80, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
