...
public:
  ...
  /// @brief Method MoveNext, addr 0x1096a8c, size 0xb8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__CoroutineHelpers___ExecuteAfterDelayCoroutine_d__0* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x1096b44, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x1096b4c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x1096b8c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x1096a88, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x10968e4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ExecuteAfterDelayCoroutine, addr 0x109686c, size 0x78, virtual false, abstract: false, final false
  static inline ::System::Collections::IEnumerator* ExecuteAfterDelayCoroutine(::System::Action* action, float_t timeSeconds);

  /// @brief Method StartSingleCoroutine, addr 0x109690c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method StopSingleCoroutine, addr 0x10969d0, size 0xb8, virtual false, abstract: false, final false
