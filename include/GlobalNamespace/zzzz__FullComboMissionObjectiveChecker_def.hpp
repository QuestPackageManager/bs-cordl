...
/// @brief Method HandleComboBreakingEventHappened, addr 0x580ab34, size 0x3c, virtual false, abstract: false, final false
inline void HandleComboBreakingEventHappened() ;

/// @brief Method Init, addr 0x580a8bc, size 0x168, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::FullComboMissionObjectiveChecker* New_ctor() ;

/// @brief Method OnDestroy, addr 0x580aa24, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x580ab70, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
