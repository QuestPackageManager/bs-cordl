...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::LightRotationGroupEffectManager::*)()>(&::GlobalNamespace::LightRotationGroupEffectManager::Start)> {
  constexpr static std::size_t size = 0x548;
  constexpr static std::size_t addrs = 0x585ae34;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::LightRotationGroupEffectManager::*)()>(&::GlobalNamespace::LightRotationGroupEffectManager::OnDestroy)> {
  constexpr static std::size_t size = 0x104;
  constexpr static std::size_t addrs = 0x585b37c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::LightRotationGroupEffectManager::*)()>(&::GlobalNamespace::LightRotationGroupEffectManager::_ctor)> {
  constexpr static std::size_t size = 0x78;
  constexpr static std::size_t addrs = 0x585b480;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightRotationGroup>,::Array<::UnityW<::GlobalNamespace::LightRotationGroup>>*>& GlobalNamespace::LightRotationGroupEffectManager::__cordl_internal_get__lightRotationGroups()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightRotationGroups;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightRotationGroup>,::Array<::UnityW<::GlobalNamespace::LightRotationGroup>>*> const& GlobalNamespace::LightRotationGroupEffectManager::__cordl_internal_get__lightRotationGroups() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightRotationGroups;
}
constexpr void GlobalNamespace::LightRotationGroupEffectManager::__cordl_internal_set__lightRotationGroups(::ArrayW<::UnityW<::GlobalNamespace::LightRotationGroup>,::Array<::UnityW<::GlobalNamespace::LightRotationGroup>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::LightRotationGroupEffect*>* const& GlobalNamespace::LightRotationGroupEffectManager::__cordl_internal_get__lightRotationGroupEffects() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightRotationGroupEffects;
}
constexpr void GlobalNamespace::LightRotationGroupEffectManager::__cordl_internal_set__lightRotationGroupEffects(::System::Collections::Generic::List_1<::GlobalNamespace::LightRotationGroupEffect*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
