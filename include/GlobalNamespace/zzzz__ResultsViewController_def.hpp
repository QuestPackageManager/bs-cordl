...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b6f004, size 0xb8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::ResultsViewController__StartFireworksAfterDelay_d__33* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b6f0bc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b6f0c4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b6f0fc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3b6f000, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b6ef40, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ContinueButtonPressed, addr 0x3b6ef68, size 0x48, virtual false, abstract: false, final false
  inline void ContinueButtonPressed();

  /// @brief Method DidActivate, addr 0x3b6e8b8, size 0x1a4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b6eea0, size 0xa0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Init, addr 0x3b6e890, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMenuDestinationRequest, addr 0x3b6edcc, size 0xd4, virtual false, abstract: false, final false
  inline void ProcessMenuDestinationRequest(::GlobalNamespace::MenuDestination* menuDestination);

  /// @brief Method RestartButtonPressed, addr 0x3b6efb0, size 0x48, virtual false, abstract: false, final false
  inline void RestartButtonPressed();

  /// @brief Method SetDataToUI, addr 0x3b6ea5c, size 0x300, virtual false, abstract: false, final false
  inline void SetDataToUI();

  /// @brief Method StartFireworksAfterDelay, addr 0x3b6ed5c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method add_continueButtonPressedEvent, addr 0x3b6e5c8, size 0xb0, virtual false, abstract: false, final false
  inline void add_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method add_restartButtonPressedEvent, addr 0x3b6e728, size 0xb0, virtual false, abstract: false, final false
  inline void add_restartButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method get_practice, addr 0x3b6e888, size 0x8, virtual false, abstract: false, final false
  inline bool get_practice();

  /// @brief Method remove_continueButtonPressedEvent, addr 0x3b6e678, size 0xb0, virtual false, abstract: false, final false
  inline void remove_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method remove_restartButtonPressedEvent, addr 0x3b6e7d8, size 0xb0, virtual false, abstract: false, final false
