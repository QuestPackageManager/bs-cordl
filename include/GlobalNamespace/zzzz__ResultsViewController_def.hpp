...
namespace GlobalNamespace {
class __ResultsViewController___StartFireworksAfterDelay_d__34;
}
...
MARK_REF_PTR_T(::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34);
// Type: ::<StartFireworksAfterDelay>d__34
...
public:
  ...
  /// @brief Method MoveNext, addr 0x256653c, size 0xbc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x25665f8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2566600, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2566640, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2566538, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2566130, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "__ResultsViewController___StartFireworksAfterDelay_d__34", modifiers: "const&", def_value: None }]
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34, 0x30>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34, ___delay) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34, _____4__this) == 0x28, "Offset mismatch!");
...
public:
  ...
  /// @brief Method ContinueButtonPressed, addr 0x25664c8, size 0x34, virtual false, abstract: false, final false
  inline void ContinueButtonPressed();

  /// @brief Method DidActivate, addr 0x2565674, size 0x1c8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x2566090, size 0xa0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method DisableResultEnvironmentController, addr 0x2566158, size 0x370, virtual false, abstract: false, final false
  inline void DisableResultEnvironmentController();

  /// @brief Method EnableResultsEnvironmentController, addr 0x2565b28, size 0x434, virtual false, abstract: false, final false
  inline void EnableResultsEnvironmentController();

  /// @brief Method Init, addr 0x256564c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMenuDestinationRequest, addr 0x2565fd4, size 0xbc, virtual false, abstract: false, final false
  inline void ProcessMenuDestinationRequest(::GlobalNamespace::MenuDestination* menuDestination);

  /// @brief Method RestartButtonPressed, addr 0x25664fc, size 0x34, virtual false, abstract: false, final false
  inline void RestartButtonPressed();

  /// @brief Method SetDataToUI, addr 0x256583c, size 0x2ec, virtual false, abstract: false, final false
  inline void SetDataToUI();

  /// @brief Method StartFireworksAfterDelay, addr 0x2565f5c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2566530, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_continueButtonPressedEvent, addr 0x2565384, size 0xb0, virtual false, abstract: false, final false
  inline void add_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method add_restartButtonPressedEvent, addr 0x25654e4, size 0xb0, virtual false, abstract: false, final false
  inline void add_restartButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method get_practice, addr 0x2565644, size 0x8, virtual false, abstract: false, final false
  inline bool get_practice();

  /// @brief Method remove_continueButtonPressedEvent, addr 0x2565434, size 0xb0, virtual false, abstract: false, final false
  inline void remove_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method remove_restartButtonPressedEvent, addr 0x2565594, size 0xb0, virtual false, abstract: false, final false
...
public:
  ...
  ::UnityW<::GlobalNamespace::ResultsEnvironmentManager> ____resultsEnvironmentManager;
...
NEED_NO_BOX(::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34*, "", "ResultsViewController/<StartFireworksAfterDelay>d__34");
