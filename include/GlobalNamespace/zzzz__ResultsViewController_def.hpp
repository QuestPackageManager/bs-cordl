...
public:
  ...
  /// @brief Method MoveNext, addr 0x265bdb0, size 0xbc, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__ResultsViewController___StartFireworksAfterDelay_d__34* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x265be6c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x265be74, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x265beb4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x265bdac, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x265b96c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ContinueButtonPressed, addr 0x265bd04, size 0x50, virtual false, abstract: false, final false
  inline void ContinueButtonPressed();

  /// @brief Method DidActivate, addr 0x265ae94, size 0x1c8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x265b8cc, size 0xa0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method DisableResultEnvironmentController, addr 0x265b994, size 0x370, virtual false, abstract: false, final false
  inline void DisableResultEnvironmentController();

  /// @brief Method EnableResultsEnvironmentController, addr 0x265b364, size 0x434, virtual false, abstract: false, final false
  inline void EnableResultsEnvironmentController();

  /// @brief Method Init, addr 0x265ae6c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessMenuDestinationRequest, addr 0x265b810, size 0xbc, virtual false, abstract: false, final false
  inline void ProcessMenuDestinationRequest(::GlobalNamespace::MenuDestination* menuDestination);

  /// @brief Method RestartButtonPressed, addr 0x265bd54, size 0x50, virtual false, abstract: false, final false
  inline void RestartButtonPressed();

  /// @brief Method SetDataToUI, addr 0x265b05c, size 0x308, virtual false, abstract: false, final false
  inline void SetDataToUI();

  /// @brief Method StartFireworksAfterDelay, addr 0x265b798, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265bda4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_continueButtonPressedEvent, addr 0x265aba4, size 0xb0, virtual false, abstract: false, final false
  inline void add_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method add_restartButtonPressedEvent, addr 0x265ad04, size 0xb0, virtual false, abstract: false, final false
  inline void add_restartButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method get_practice, addr 0x265ae64, size 0x8, virtual false, abstract: false, final false
  inline bool get_practice();

  /// @brief Method remove_continueButtonPressedEvent, addr 0x265ac54, size 0xb0, virtual false, abstract: false, final false
  inline void remove_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::ResultsViewController>>* value);

  /// @brief Method remove_restartButtonPressedEvent, addr 0x265adb4, size 0xb0, virtual false, abstract: false, final false
