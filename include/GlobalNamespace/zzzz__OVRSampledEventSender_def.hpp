...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRSampledEventSender*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRSampledEventSender*, "", "OVRSampledEventSender");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRSampledEventSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRSampledEventSender(OVRSampledEventSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRSampledEventSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OVRSampledEventSender(OVRSampledEventSenderconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::OVRSampledEventSender) == 0x40, "Size mismatch!");
