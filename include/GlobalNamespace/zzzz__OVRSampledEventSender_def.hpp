...
/// @brief Field _addAnnotationsFunc, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__addAnnotationsFunc, put=__cordl_internal_set__addAnnotationsFunc)) ::System::Func_2<::GlobalNamespace::OVRTelemetryMarker,::GlobalNamespace::OVRTelemetryMarker>*  _addAnnotationsFunc;
...
static inline ::GlobalNamespace::OVRSampledEventSender* New_ctor(int32_t  markerId, float_t  recordRecordChance, ::System::Func_2<::GlobalNamespace::OVRTelemetryMarker,::GlobalNamespace::OVRTelemetryMarker>*  addAnnotationsFunc) ;

/// @brief Method Send, addr 0x5d30228, size 0x30, virtual false, abstract: false, final false
inline void Send() ;

/// @brief Method ShouldSendEvent, addr 0x5d304a8, size 0x40, virtual false, abstract: false, final false
static inline bool ShouldSendEvent(float_t  chance) ;

/// @brief Method Start, addr 0x5d3039c, size 0x10c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x5d30218, size 0x10, virtual false, abstract: false, final false
