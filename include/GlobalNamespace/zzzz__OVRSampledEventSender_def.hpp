...
public:
  ...
  /// @brief Method Send, addr 0x5da2210, size 0x30, virtual false, abstract: false, final false
  inline void Send();

  /// @brief Method ShouldSendEvent, addr 0x5da2490, size 0x40, virtual false, abstract: false, final false
  static inline bool ShouldSendEvent(float_t chance);

  /// @brief Method Start, addr 0x5da2384, size 0x10c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5da2200, size 0x10, virtual false, abstract: false, final false
