...
public:
  ...
  /// @brief Method Awake, addr 0x2251334, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x2251404, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
