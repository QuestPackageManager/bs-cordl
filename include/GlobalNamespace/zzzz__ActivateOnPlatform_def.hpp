...
public:
  ...
  /// @brief Method Awake, addr 0x56388b8, size 0xd4, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x563898c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
