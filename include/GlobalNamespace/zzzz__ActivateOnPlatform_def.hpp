...
/// @brief Method Awake, addr 0x570cb80, size 0xd4, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x570cc54, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
