...
public:
  ...
  /// @brief Method Awake, addr 0x39b96ec, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x39b97bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
