...
public:
  ...
  /// @brief Method Awake, addr 0x569d6cc, size 0xd4, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x569d7a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
