...
public:
  ...
  /// @brief Method .ctor, addr 0x3ad0654, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetNoise, addr 0x3ad0544, size 0xf4, virtual false, abstract: false, final false
  inline float_t GetNoise(float_t time, float_t offset);

  /// @brief Method GetNoiseVec3, addr 0x3ad0204, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetNoiseVec3(float_t time);

  static inline ::GlobalNamespace::DroneHover* New_ctor();

  /// @brief Method Start, addr 0x3ad00bc, size 0x30, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3ad00ec, size 0x118, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateTiltTransform, addr 0x3ad0280, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ad0638, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
