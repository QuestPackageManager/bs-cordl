...
/// @brief Method .ctor, addr 0x5705590, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _compoundSins, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__compoundSins, put=__cordl_internal_set__compoundSins)) ::System::Collections::Generic::List_1<::GlobalNamespace::DroneHover_SineLayer*>*  _compoundSins;
...
/// @brief Method GetNoise, addr 0x5705478, size 0x100, virtual false, abstract: false, final false
inline float_t GetNoise(float_t  time, float_t  offset) ;

/// @brief Method GetNoiseVec3, addr 0x57050dc, size 0x80, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetNoiseVec3(float_t  time) ;

static inline ::GlobalNamespace::DroneHover* New_ctor() ;

/// @brief Method Start, addr 0x5704f3c, size 0x30, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x5704f6c, size 0x170, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTiltTransform, addr 0x570515c, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5705578, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
