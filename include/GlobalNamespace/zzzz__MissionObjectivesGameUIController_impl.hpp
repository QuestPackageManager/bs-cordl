...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionObjectivesGameUIController::*)()>(&::GlobalNamespace::MissionObjectivesGameUIController::Start)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x5871320;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionObjectivesGameUIController::*)()>(&::GlobalNamespace::MissionObjectivesGameUIController::OnDestroy)> {
  constexpr static std::size_t size = 0x110;
  constexpr static std::size_t addrs = 0x5871720;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionObjectivesGameUIController::*)()>(&::GlobalNamespace::MissionObjectivesGameUIController::HandleMissionObjectiveCheckersManagerObjectivesListDidChange)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5871830;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionObjectivesGameUIController::*)()>(&::GlobalNamespace::MissionObjectivesGameUIController::CreateUIElements)> {
  constexpr static std::size_t size = 0x368;
  constexpr static std::size_t addrs = 0x58713b8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionObjectivesGameUIController::*)()>(&::GlobalNamespace::MissionObjectivesGameUIController::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x5871834;
...
constexpr ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MissionObjectiveGameUIView>>*& GlobalNamespace::MissionObjectivesGameUIController::__cordl_internal_get__missionObjectiveGameUIViews()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____missionObjectiveGameUIViews;
}
constexpr ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MissionObjectiveGameUIView>>* const& GlobalNamespace::MissionObjectivesGameUIController::__cordl_internal_get__missionObjectiveGameUIViews() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____missionObjectiveGameUIViews;
}
constexpr void GlobalNamespace::MissionObjectivesGameUIController::__cordl_internal_set__missionObjectiveGameUIViews(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MissionObjectiveGameUIView>>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
