...
public:
  ...
  /// @brief Method <CollectFirstNLongestLevels>b__12_0, addr 0x32dd12c, size 0x74, virtual false, abstract: false, final false
  inline int32_t _CollectFirstNLongestLevels_b__12_0(::GlobalNamespace::BeatmapLevel* a, ::GlobalNamespace::BeatmapLevel* b);

  /// @brief Method .ctor, addr 0x32dd128, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CollectFirstNLongestLevels, addr 0x32dc998, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteAsync, addr 0x32dc190, size 0x1e8, virtual true, abstract: false, final false
  ...
  /// @brief Method GenerateCommandFile, addr 0x32dc378, size 0x620, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetLevelCharacteristic, addr 0x32dcb88, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32dcca0, size 0x434, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AllowsUnknownArguments, addr 0x32dc188, size 0x8, virtual true, abstract: false, final false
