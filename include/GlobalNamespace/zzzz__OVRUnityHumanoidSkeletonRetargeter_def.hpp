...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRHumanBodyBonesMappings_OVRUnityHumanoidSkeletonRetargeter_BodyTrackingBoneId, "",
                    "OVRUnityHumanoidSkeletonRetargeter/OVRHumanBodyBonesMappings/BodyTrackingBoneId");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRHumanBodyBonesMappings_OVRUnityHumanoidSkeletonRetargeter_FullBodyTrackingBoneId, "",
                    "OVRUnityHumanoidSkeletonRetargeter/OVRHumanBodyBonesMappings/FullBodyTrackingBoneId");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRUnityHumanoidSkeletonRetargeter_UpdateType, "", "OVRUnityHumanoidSkeletonRetargeter/UpdateType");
