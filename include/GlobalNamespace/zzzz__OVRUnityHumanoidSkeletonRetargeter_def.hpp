...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2448)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(10249)),
// TypeDefinitionIndex(TypeDefinitionIndex(10252)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2448), inst: 3342 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(7583)) CS
// Name: ::OVRUnityHumanoidSkeletonRetargeter::OVRSkeletonMetadata::BoneData*
...
public:
  ...
  /// @brief Method .ctor, addr 0x272f8c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0x272ecc8, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_BodyToBoneData, addr 0x272e95c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272e964, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272ab2c, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272c3f0, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRSkeleton* skeleton, bool useBindPose,
                    ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRSkeleton__BoneId, ::UnityEngine::HumanBodyBones>* customBoneIdToHumanBodyBone);

  /// @brief Method BuildBoneDataSkeleton, addr 0x272c578, size 0x8, virtual false, abstract: false, final false
  inline void BuildBoneDataSkeleton(::GlobalNamespace::OVRSkeleton* skeleton, bool useBindPose,
                                    ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRSkeleton__BoneId, ::UnityEngine::HumanBodyBones>* customBoneIdToHumanBodyBone);

  /// @brief Method AssembleSkeleton, addr 0x272f2cc, size 0x5fc, virtual false, abstract: false, final false
  inline void AssembleSkeleton(::GlobalNamespace::OVRSkeleton* skeleton, bool useBindPose,
                               ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRSkeleton__BoneId, ::UnityEngine::HumanBodyBones>* customBoneIdToHumanBodyBone);

  /// @brief Method FindBoneWithBoneId, addr 0x272f8d0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildBoneData, addr 0x272ed4c, size 0x580, virtual false, abstract: false, final false
  inline void BuildBoneData(::UnityEngine::Animator* animator);

  /// @brief Method BuildCoordinateAxesForAllBones, addr 0x272ac9c, size 0x4ec, virtual false, abstract: false, final false
  inline void BuildCoordinateAxesForAllBones();

  /// @brief Method FindFirstChild, addr 0x272fa7c, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateQuaternionForBoneDataWithRightVec, addr 0x272fb8c, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateQuaternionForBoneData, addr 0x272fd4c, size 0x17c, virtual false, abstract: false, final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(7581)), TypeDefinitionIndex(TypeDefinitionIndex(10252)),
// TypeDefinitionIndex(TypeDefinitionIndex(14853))] Self: TypeDefinitionIndex(TypeDefinitionIndex(7585)) CS Name: ::OVRUnityHumanoidSkeletonRetargeter::JointAdjustment*
...
public:
  ...
  /// @brief Method .ctor, addr 0x272a7d0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_SourceSkeletonData, addr 0x272a59c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata* get_SourceSkeletonData();

  /// @brief Method get_SourceSkeletonTPoseData, addr 0x272a5a4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata* get_SourceSkeletonTPoseData();

  /// @brief Method get_TargetSkeletonData, addr 0x272a5ac, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata* get_TargetSkeletonData();

  /// @brief Method get_AnimatorTargetSkeleton, addr 0x272a5b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> get_AnimatorTargetSkeleton();

  /// @brief Method get_CustomBoneIdToHumanBodyBone, addr 0x272a5bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_TargetTPoseRotations, addr 0x272a5c4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272a5cc, size 0x204, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Adjustments, addr 0x272a830, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BodySectionsToAlign, addr 0x272a838, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_BodySectionToPosition, addr 0x272a840, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,
                  ::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>
  get_BodySectionToPosition();

  /// @brief Method Start, addr 0x272a848, size 0xcc, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method ValidateGameObjectForUnityHumanoidRetargeting, addr 0x272a914, size 0xe0, virtual false, abstract: false, final false
  static inline void ValidateGameObjectForUnityHumanoidRetargeting(::UnityEngine::GameObject* go);

  /// @brief Method StoreTTargetPoseRotations, addr 0x272aa0c, size 0x120, virtual false, abstract: false, final false
  inline void StoreTTargetPoseRotations();

  /// @brief Method CreateCustomBoneIdToHumanBodyBoneMapping, addr 0x272a9f4, size 0x18, virtual false, abstract: false, final false
  inline void CreateCustomBoneIdToHumanBodyBoneMapping();

  /// @brief Method CopyBoneIdToHumanBodyBoneMapping, addr 0x272b188, size 0x1d8, virtual false, abstract: false, final false
  inline void CopyBoneIdToHumanBodyBoneMapping();

  /// @brief Method AdjustCustomBoneIdToHumanBodyBoneMapping, addr 0x272b360, size 0xc4, virtual false, abstract: false, final false
  inline void AdjustCustomBoneIdToHumanBodyBoneMapping();

  /// @brief Method RemoveMappingCorrespondingToHumanBodyBone, addr 0x272b424, size 0x1c4, virtual false, abstract: false, final false
  inline void RemoveMappingCorrespondingToHumanBodyBone(::UnityEngine::HumanBodyBones boneId);

  /// @brief Method Update, addr 0x272b5e8, size 0x34, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method RecomputeSkeletalOffsetsIfNecessary, addr 0x272b61c, size 0x18, virtual false, abstract: false, final false
  inline void RecomputeSkeletalOffsetsIfNecessary();

  /// @brief Method ComputeOffsetsUsingSkeletonComponent, addr 0x272bd0c, size 0x6e4, virtual false, abstract: false, final false
  inline void ComputeOffsetsUsingSkeletonComponent();

  /// @brief Method IsBodySectionInArray, addr 0x272c580, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method AlignTargetWithSource, addr 0x272b634, size 0x6d8, virtual false, abstract: false, final false
  inline void AlignTargetWithSource();

  /// @brief Method FindAdjustment, addr 0x272c5cc, size 0x50, virtual false, abstract: false, final false
