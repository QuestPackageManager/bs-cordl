...
public:
  ...
  /// @brief Method GetCommandLineArgs, addr 0x2401dd4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2401e5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
