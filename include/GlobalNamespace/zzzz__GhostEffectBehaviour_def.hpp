...
public:
  ...
  /// @brief Method EnableObjects, addr 0x5774234, size 0x114, virtual false, abstract: false, final false
  inline void EnableObjects(bool on);

  static inline ::GlobalNamespace::GhostEffectBehaviour* New_ctor();

  /// @brief Method OnBehaviourPlay, addr 0x57740a4, size 0x190, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method ProcessFrame, addr 0x5774348, size 0x478, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57747c0, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
