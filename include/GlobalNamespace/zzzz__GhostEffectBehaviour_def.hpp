...
public:
  ...
  /// @brief Method EnableObjects, addr 0x26b5ca0, size 0x114, virtual false, abstract: false, final false
  inline void EnableObjects(bool on);

  static inline ::GlobalNamespace::GhostEffectBehaviour* New_ctor();

  /// @brief Method OnBehaviourPlay, addr 0x26b5b10, size 0x190, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method ProcessFrame, addr 0x26b5db4, size 0x438, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b61ec, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
