...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x586f524, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586f554, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::DirectionalLightWithId) == 0x48, "Size mismatch!");
