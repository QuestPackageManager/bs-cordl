...
// Write type traits
MARK_REF_T(::GlobalNamespace::DirectionalLightWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DirectionalLightWithId*, "", "DirectionalLightWithId");
...
public:
  ...
  /// @brief Field _minIntensity, offset 0x4c, size 0x4
  __declspec(property(get = __cordl_internal_get__minIntensity, put = __cordl_internal_set__minIntensity)) float_t _minIntensity;

  /// @brief Method ColorWasSet, addr 0x586cb40, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586cb70, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DirectionalLightWithId", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DirectionalLightWithId(DirectionalLightWithId&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DirectionalLightWithId", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DirectionalLightWithId(DirectionalLightWithIdconst&) = delete;
  ...
  /// [SerializeField]
  /// @brief Field _minIntensity, offset: 0x4c, size: 0x4, def value: None
  float_t ____minIntensity;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::DirectionalLightWithId, ____light) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::DirectionalLightWithId, ____intensity) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::DirectionalLightWithId, ____minIntensity) == 0x4c, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::DirectionalLightWithId) == 0x50, "Size mismatch!");
