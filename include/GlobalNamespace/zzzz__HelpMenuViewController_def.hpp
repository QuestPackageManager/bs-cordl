...
/// @brief Field _privacyPolicyNoticeDisplayViewController, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__privacyPolicyNoticeDisplayViewController, put=__cordl_internal_set__privacyPolicyNoticeDisplayViewController)) ::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController>  _privacyPolicyNoticeDisplayViewController;
...
/// @brief Field didSelectHelpSubMenuEvent, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectHelpSubMenuEvent, put=__cordl_internal_set_didSelectHelpSubMenuEvent)) ::System::Action_1<::UnityW<::HMUI::ViewController>>*  didSelectHelpSubMenuEvent;

/// @brief Method DidActivate, addr 0x57a7930, size 0x548, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleHelpMenuSegmentedControlDidSelectCell, addr 0x57a7e78, size 0x90, virtual false, abstract: false, final false
...
constexpr ::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController> const& __cordl_internal_get__privacyPolicyNoticeDisplayViewController() const;

constexpr ::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController>& __cordl_internal_get__privacyPolicyNoticeDisplayViewController() ;
...
constexpr void __cordl_internal_set__privacyPolicyNoticeDisplayViewController(::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController>  value) ;
...
/// @brief Method .ctor, addr 0x57a7f08, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectHelpSubMenuEvent, addr 0x57a77b0, size 0xc0, virtual false, abstract: false, final false
inline void add_didSelectHelpSubMenuEvent(::System::Action_1<::UnityW<::HMUI::ViewController>>*  value) ;

/// @brief Method remove_didSelectHelpSubMenuEvent, addr 0x57a7870, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Field _privacyPolicyNoticeDisplayViewController, offset: 0x90, size: 0x8, def value: None
 ::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController>  ____privacyPolicyNoticeDisplayViewController;
...
static_assert(offsetof(::GlobalNamespace::HelpMenuViewController, ____privacyPolicyNoticeDisplayViewController) == 0x90, "Offset mismatch!");
