...
public:
  ...
  /// @brief Method DidActivate, addr 0x3b67334, size 0x5a4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleHelpMenuSegmentedControlDidSelectCell, addr 0x3b678d8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b6795c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectHelpSubMenuEvent, addr 0x3b671d4, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectHelpSubMenuEvent(::System::Action_1<::UnityW<::HMUI::ViewController>>* value);

  /// @brief Method remove_didSelectHelpSubMenuEvent, addr 0x3b67284, size 0xb0, virtual false, abstract: false, final false
