...
public:
  ...
  /// @brief Method DidActivate, addr 0x5817e08, size 0x548, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleHelpMenuSegmentedControlDidSelectCell, addr 0x5818350, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58183e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectHelpSubMenuEvent, addr 0x5817c88, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectHelpSubMenuEvent(::System::Action_1<::UnityW<::HMUI::ViewController>>* value);

  /// @brief Method remove_didSelectHelpSubMenuEvent, addr 0x5817d48, size 0xc0, virtual false, abstract: false, final false
