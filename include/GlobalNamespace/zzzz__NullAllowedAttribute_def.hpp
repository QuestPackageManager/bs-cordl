...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NullAllowedAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NullAllowedAttribute(NullAllowedAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NullAllowedAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NullAllowedAttribute(NullAllowedAttributeconst&) = delete;
