...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::PlayerNameEqualityComparer::*)(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*, ::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*)>(&::GlobalNamespace::PlayerNameEqualityComparer::Equals)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x3658fa0;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::PlayerNameEqualityComparer::*)(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*)>(&::GlobalNamespace::PlayerNameEqualityComparer::GetHashCode)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x3658fbc;
...
constexpr ::System::Collections::Generic::IEqualityComparer_1<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>* GlobalNamespace::PlayerNameEqualityComparer::i___System__Collections__Generic__IEqualityComparer_1___GlobalNamespace__PlatformLeaderboardsModel_LeaderboardScore__() noexcept {
return static_cast<::System::Collections::Generic::IEqualityComparer_1<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>*>(static_cast<void*>(this));
}
// Ctor Parameters []
