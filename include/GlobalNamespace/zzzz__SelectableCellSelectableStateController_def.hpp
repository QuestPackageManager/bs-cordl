...
public:
  // Declarations
  /// @brief Method HandleSelectableCellHighlightDidChange, addr 0x44d9700, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectableCellInteractableDidChange, addr 0x44d9678, size 0x88, virtual false, abstract: false, final false
  inline void HandleSelectableCellInteractableDidChange(::HMUI::Interactable* interactableCell, bool interactable);

  /// @brief Method HandleSelectableCellSelectionStateDidChange, addr 0x44d9704, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x44d9530, size 0x148, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x44d934c, size 0x158, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResolveState, addr 0x44d94a4, size 0x8c, virtual false, abstract: false, final false
  inline void ResolveState(::HMUI::SelectableCell* selectableCell, ::HMUI::SelectableCell_TransitionType transitionType);

  /// @brief Method .ctor, addr 0x44d9708, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
