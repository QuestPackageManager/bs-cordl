...
public:
  // Declarations
  /// @brief Method HandleSelectableCellHighlightDidChange, addr 0x2636b2c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSelectableCellInteractableDidChange, addr 0x2636aa4, size 0x88, virtual false, abstract: false, final false
  inline void HandleSelectableCellInteractableDidChange(::HMUI::Interactable* interactableCell, bool interactable);

  /// @brief Method HandleSelectableCellSelectionStateDidChange, addr 0x2636b30, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x2636950, size 0x154, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2636780, size 0x164, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResolveState, addr 0x26368e4, size 0x6c, virtual false, abstract: false, final false
  inline void ResolveState(::HMUI::SelectableCell* selectableCell, ::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method .ctor, addr 0x2636b34, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
