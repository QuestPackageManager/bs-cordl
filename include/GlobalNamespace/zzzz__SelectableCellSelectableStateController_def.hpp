...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13653)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5457), inst: 4967 }),
// TypeDefinitionIndex(TypeDefinitionIndex(5457))} Self: TypeDefinitionIndex(TypeDefinitionIndex(5460)) CS Name: ::SelectableCellSelectableStateController*
