...
public:
  ...
  /// @brief Method Update, addr 0x593b83c, size 0xf8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateLocalPositionY, addr 0x593b7b4, size 0x88, virtual false, abstract: false, final false
  inline void UpdateLocalPositionY(float_t dstPosY, bool animated, float_t animationDuration);

  /// @brief Method UpdateStageLockText, addr 0x593b934, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x593b954, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
