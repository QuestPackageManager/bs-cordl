...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x5908e04, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5908eb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x5908dfc, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TextureProcessor3DAsset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TextureProcessor3DAsset(TextureProcessor3DAsset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TextureProcessor3DAsset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TextureProcessor3DAsset(TextureProcessor3DAssetconst&) = delete;
