...
public:
  ...
  /// @brief Method SetColor, addr 0x58f1754, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f1778, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_button, addr 0x58f174c, size 0x8, virtual false, abstract: false, final false
