...
public:
  ...
  /// @brief Method SetColor, addr 0x3c2b9b0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c2b9d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_button, addr 0x3c2b9a8, size 0x8, virtual false, abstract: false, final false
