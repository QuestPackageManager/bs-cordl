...
public:
  ...
  /// @brief Method <Add>b__8_0, addr 0x3725fdc, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3725fd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x3725db4, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3725da4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic);

  /// @brief Method .ctor, addr 0x3725dac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic,
                    ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmap*>* previewDifficultyBeatmaps);

  /// @brief Method get_beatmapCharacteristic, addr 0x3721314, size 0x60, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapCharacteristic get_beatmapCharacteristic();

  /// @brief Method get_difficultyBeatmaps, addr 0x3725d9c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x37260c0, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapColorSchemeIdx, addr 0x3726098, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_beatmapColorSchemeIdx();

  /// @brief Method get_bombsCount, addr 0x37260b0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bombsCount();

  /// @brief Method get_cuttableBeatmapObjectsCount, addr 0x37260b8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cuttableBeatmapObjectsCount();

  /// @brief Method get_difficulty, addr 0x3726078, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method get_environmentNameIdx, addr 0x3726090, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_environmentNameIdx();

  /// @brief Method get_noteJumpMovementSpeed, addr 0x3726080, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpMovementSpeed();

  /// @brief Method get_noteJumpStartBeatOffset, addr 0x3726088, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpStartBeatOffset();

  /// @brief Method get_notesCount, addr 0x37260a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_notesCount();

  /// @brief Method get_obstaclesCount, addr 0x37260a8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x3726144, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorSchemeId, addr 0x37260d8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_colorSchemeId();

  /// @brief Method get_environmentColor0, addr 0x3726114, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor0();

  /// @brief Method get_environmentColor0Boost, addr 0x372612c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor0Boost();

  /// @brief Method get_environmentColor1, addr 0x3726120, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor1();

  /// @brief Method get_environmentColor1Boost, addr 0x3726138, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor1Boost();

  /// @brief Method get_obstaclesColor, addr 0x3726100, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_obstaclesColor();

  /// @brief Method get_overrideLights, addr 0x372610c, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideLights();

  /// @brief Method get_overrideNotes, addr 0x37260e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideNotes();

  /// @brief Method get_saberAColor, addr 0x37260e8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_saberAColor();

  /// @brief Method get_saberBColor, addr 0x37260f4, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IncrementVersion, addr 0x3725b88, size 0x10, virtual false, abstract: false, final false
  inline void IncrementVersion();

  static inline ::GlobalNamespace::BeatmapLevelSO* New_ctor();

  /// @brief Method SetCoverImage, addr 0x3725d84, size 0x8, virtual false, abstract: false, final false
  inline void SetCoverImage(::UnityEngine::Sprite* coverImage);

  /// @brief Method SetData, addr 0x3725b98, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIntegratedLufs, addr 0x3725d6c, size 0x8, virtual false, abstract: false, final false
  inline void SetIntegratedLufs(float_t integratedLufs);

  /// @brief Method SetPreviewAudioClip, addr 0x3725d74, size 0x8, virtual false, abstract: false, final false
  inline void SetPreviewAudioClip(::UnityEngine::AudioClip* audioClip);

  /// @brief Method SetPreviewDifficultyBeatmaps, addr 0x3725d64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSongDuration, addr 0x3725d7c, size 0x8, virtual false, abstract: false, final false
  inline void SetSongDuration(float_t songDuration);

  /// @brief Method __SetEnvironmentName, addr 0x3725b80, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3725d8c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allDirectionsEnvironmentName, addr 0x3725b58, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentName get_allDirectionsEnvironmentName();

  /// @brief Method get_beatsPerMinute, addr 0x3725b10, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beatsPerMinute();

  /// @brief Method get_colorSchemes, addr 0x3722114, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevelSO_ColorScheme*>* get_colorSchemes();

  /// @brief Method get_contentRating, addr 0x3725b70, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSensitivityFlag get_contentRating();

  /// @brief Method get_coverImage, addr 0x3725b60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_coverImage();

  /// @brief Method get_environmentName, addr 0x3725b50, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentName get_environmentName();

  /// @brief Method get_environmentNames, addr 0x3722070, size 0xa4, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::EnvironmentName>* get_environmentNames();

  /// @brief Method get_hasPrecalculatedData, addr 0x3722440, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasPrecalculatedData();

  /// @brief Method get_integratedLufs, addr 0x3725b18, size 0x8, virtual false, abstract: false, final false
  inline float_t get_integratedLufs();

  /// @brief Method get_levelAuthorName, addr 0x3725b08, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelAuthorName();

  /// @brief Method get_levelID, addr 0x3725ae8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelID();

  /// @brief Method get_previewDifficultyBeatmapSets, addr 0x3725b78, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_previewDuration, addr 0x3725b48, size 0x8, virtual false, abstract: false, final false
  inline float_t get_previewDuration();

  /// @brief Method get_previewStartTime, addr 0x3725b40, size 0x8, virtual false, abstract: false, final false
  inline float_t get_previewStartTime();

  /// @brief Method get_shuffle, addr 0x3725b30, size 0x8, virtual false, abstract: false, final false
  inline float_t get_shuffle();

  /// @brief Method get_shufflePeriod, addr 0x3725b38, size 0x8, virtual false, abstract: false, final false
  inline float_t get_shufflePeriod();

  /// @brief Method get_songAuthorName, addr 0x3725b00, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songAuthorName();

  /// @brief Method get_songDuration, addr 0x3725b28, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songDuration();

  /// @brief Method get_songName, addr 0x3725af0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songName();

  /// @brief Method get_songPreviewAudioClip, addr 0x3725b68, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AudioClip> get_songPreviewAudioClip();

  /// @brief Method get_songSubName, addr 0x3725af8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songSubName();

  /// @brief Method get_songTimeOffset, addr 0x3725b20, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songTimeOffset();

  /// @brief Method get_version, addr 0x3725ae0, size 0x8, virtual false, abstract: false, final false
