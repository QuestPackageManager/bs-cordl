...
public:
  ...
  /// @brief Method <Add>b__8_0, addr 0x26cdda4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26cdd9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x26cdb8c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26cdb38, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic);

  /// @brief Method .ctor, addr 0x26cdb60, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic,
                    ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmap*>* previewDifficultyBeatmaps);

  /// @brief Method get_beatmapCharacteristic, addr 0x26cdb28, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic();

  /// @brief Method get_difficultyBeatmaps, addr 0x26cdb30, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26cde7c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapColorSchemeIdx, addr 0x26cde54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_beatmapColorSchemeIdx();

  /// @brief Method get_bombsCount, addr 0x26cde6c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bombsCount();

  /// @brief Method get_cuttableBeatmapObjectsCount, addr 0x26cde74, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cuttableBeatmapObjectsCount();

  /// @brief Method get_difficulty, addr 0x26cde34, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method get_environmentNameIdx, addr 0x26cde4c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_environmentNameIdx();

  /// @brief Method get_noteJumpMovementSpeed, addr 0x26cde3c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpMovementSpeed();

  /// @brief Method get_noteJumpStartBeatOffset, addr 0x26cde44, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpStartBeatOffset();

  /// @brief Method get_notesCount, addr 0x26cde5c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_notesCount();

  /// @brief Method get_obstaclesCount, addr 0x26cde64, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26cdf60, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorSchemeId, addr 0x26cdef4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_colorSchemeId();

  /// @brief Method get_environmentColor0, addr 0x26cdf30, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor0();

  /// @brief Method get_environmentColor0Boost, addr 0x26cdf48, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor0Boost();

  /// @brief Method get_environmentColor1, addr 0x26cdf3c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor1();

  /// @brief Method get_environmentColor1Boost, addr 0x26cdf54, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor1Boost();

  /// @brief Method get_obstaclesColor, addr 0x26cdf1c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_obstaclesColor();

  /// @brief Method get_overrideLights, addr 0x26cdf28, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideLights();

  /// @brief Method get_overrideNotes, addr 0x26cdefc, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideNotes();

  /// @brief Method get_saberAColor, addr 0x26cdf04, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_saberAColor();

  /// @brief Method get_saberBColor, addr 0x26cdf10, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IncrementVersion, addr 0x26cd900, size 0x10, virtual false, abstract: false, final false
  inline void IncrementVersion();

  static inline ::GlobalNamespace::BeatmapLevelSO* New_ctor();

  /// @brief Method SetCoverImage, addr 0x26cdb10, size 0x8, virtual false, abstract: false, final false
  inline void SetCoverImage(::UnityEngine::Sprite* coverImage);

  /// @brief Method SetData, addr 0x26cd910, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIntegratedLufs, addr 0x26cdaf8, size 0x8, virtual false, abstract: false, final false
  inline void SetIntegratedLufs(float_t integratedLufs);

  /// @brief Method SetPreviewAudioClip, addr 0x26cdb00, size 0x8, virtual false, abstract: false, final false
  inline void SetPreviewAudioClip(::UnityEngine::AudioClip* audioClip);

  /// @brief Method SetPreviewDifficultyBeatmaps, addr 0x26cdaf0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSongDuration, addr 0x26cdb08, size 0x8, virtual false, abstract: false, final false
  inline void SetSongDuration(float_t songDuration);

  /// @brief Method __SetEnvironmentName, addr 0x26cd8f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26cdb18, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allDirectionsEnvironmentName, addr 0x26cd8d0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentName get_allDirectionsEnvironmentName();

  /// @brief Method get_beatsPerMinute, addr 0x26cd888, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beatsPerMinute();

  /// @brief Method get_colorSchemes, addr 0x26ca5b4, size 0x98, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevelSO_ColorScheme*>* get_colorSchemes();

  /// @brief Method get_contentRating, addr 0x26cd8e8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSensitivityFlag get_contentRating();

  /// @brief Method get_coverImage, addr 0x26cd8d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_coverImage();

  /// @brief Method get_environmentName, addr 0x26cd8c8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentName get_environmentName();

  /// @brief Method get_environmentNames, addr 0x26ca51c, size 0x98, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::EnvironmentName>* get_environmentNames();

  /// @brief Method get_hasPrecalculatedData, addr 0x26ca8dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasPrecalculatedData();

  /// @brief Method get_integratedLufs, addr 0x26cd890, size 0x8, virtual false, abstract: false, final false
  inline float_t get_integratedLufs();

  /// @brief Method get_levelAuthorName, addr 0x26cd880, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelAuthorName();

  /// @brief Method get_levelID, addr 0x26cd860, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelID();

  /// @brief Method get_previewDifficultyBeatmapSets, addr 0x26cd8f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_previewDuration, addr 0x26cd8c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_previewDuration();

  /// @brief Method get_previewStartTime, addr 0x26cd8b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_previewStartTime();

  /// @brief Method get_shuffle, addr 0x26cd8a8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_shuffle();

  /// @brief Method get_shufflePeriod, addr 0x26cd8b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_shufflePeriod();

  /// @brief Method get_songAuthorName, addr 0x26cd878, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songAuthorName();

  /// @brief Method get_songDuration, addr 0x26cd8a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songDuration();

  /// @brief Method get_songName, addr 0x26cd868, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songName();

  /// @brief Method get_songPreviewAudioClip, addr 0x26cd8e0, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AudioClip> get_songPreviewAudioClip();

  /// @brief Method get_songSubName, addr 0x26cd870, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songSubName();

  /// @brief Method get_songTimeOffset, addr 0x26cd898, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songTimeOffset();

  /// @brief Method get_version, addr 0x26cd858, size 0x8, virtual false, abstract: false, final false
