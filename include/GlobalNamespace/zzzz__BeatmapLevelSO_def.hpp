...
public:
  ...
  /// @brief Method <Add>b__8_0, addr 0x26d2184, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d217c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x26d1f6c, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d1f18, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic);

  /// @brief Method .ctor, addr 0x26d1f40, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic,
                    ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevelSO_PreviewDifficultyBeatmap*>* previewDifficultyBeatmaps);

  /// @brief Method get_beatmapCharacteristic, addr 0x26d1f08, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic();

  /// @brief Method get_difficultyBeatmaps, addr 0x26d1f10, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26d225c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapColorSchemeIdx, addr 0x26d2234, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_beatmapColorSchemeIdx();

  /// @brief Method get_bombsCount, addr 0x26d224c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bombsCount();

  /// @brief Method get_cuttableBeatmapObjectsCount, addr 0x26d2254, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cuttableBeatmapObjectsCount();

  /// @brief Method get_difficulty, addr 0x26d2214, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method get_environmentNameIdx, addr 0x26d222c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_environmentNameIdx();

  /// @brief Method get_noteJumpMovementSpeed, addr 0x26d221c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpMovementSpeed();

  /// @brief Method get_noteJumpStartBeatOffset, addr 0x26d2224, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteJumpStartBeatOffset();

  /// @brief Method get_notesCount, addr 0x26d223c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_notesCount();

  /// @brief Method get_obstaclesCount, addr 0x26d2244, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26d2340, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorSchemeId, addr 0x26d22d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_colorSchemeId();

  /// @brief Method get_environmentColor0, addr 0x26d2310, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor0();

  /// @brief Method get_environmentColor0Boost, addr 0x26d2328, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor0Boost();

  /// @brief Method get_environmentColor1, addr 0x26d231c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor1();

  /// @brief Method get_environmentColor1Boost, addr 0x26d2334, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_environmentColor1Boost();

  /// @brief Method get_obstaclesColor, addr 0x26d22fc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_obstaclesColor();

  /// @brief Method get_overrideLights, addr 0x26d2308, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideLights();

  /// @brief Method get_overrideNotes, addr 0x26d22dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideNotes();

  /// @brief Method get_saberAColor, addr 0x26d22e4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_saberAColor();

  /// @brief Method get_saberBColor, addr 0x26d22f0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method IncrementVersion, addr 0x26d1ce0, size 0x10, virtual false, abstract: false, final false
  inline void IncrementVersion();

  static inline ::GlobalNamespace::BeatmapLevelSO* New_ctor();

  /// @brief Method SetCoverImage, addr 0x26d1ef0, size 0x8, virtual false, abstract: false, final false
  inline void SetCoverImage(::UnityEngine::Sprite* coverImage);

  /// @brief Method SetData, addr 0x26d1cf0, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetIntegratedLufs, addr 0x26d1ed8, size 0x8, virtual false, abstract: false, final false
  inline void SetIntegratedLufs(float_t integratedLufs);

  /// @brief Method SetPreviewAudioClip, addr 0x26d1ee0, size 0x8, virtual false, abstract: false, final false
  inline void SetPreviewAudioClip(::UnityEngine::AudioClip* audioClip);

  /// @brief Method SetPreviewDifficultyBeatmaps, addr 0x26d1ed0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSongDuration, addr 0x26d1ee8, size 0x8, virtual false, abstract: false, final false
  inline void SetSongDuration(float_t songDuration);

  /// @brief Method __SetEnvironmentName, addr 0x26d1cd8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d1ef8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_allDirectionsEnvironmentName, addr 0x26d1cb0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentName get_allDirectionsEnvironmentName();

  /// @brief Method get_beatsPerMinute, addr 0x26d1c68, size 0x8, virtual false, abstract: false, final false
  inline float_t get_beatsPerMinute();

  /// @brief Method get_colorSchemes, addr 0x26ce994, size 0x98, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevelSO_ColorScheme*>* get_colorSchemes();

  /// @brief Method get_contentRating, addr 0x26d1cc8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSensitivityFlag get_contentRating();

  /// @brief Method get_coverImage, addr 0x26d1cb8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_coverImage();

  /// @brief Method get_environmentName, addr 0x26d1ca8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EnvironmentName get_environmentName();

  /// @brief Method get_environmentNames, addr 0x26ce8fc, size 0x98, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::EnvironmentName>* get_environmentNames();

  /// @brief Method get_hasPrecalculatedData, addr 0x26cecbc, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasPrecalculatedData();

  /// @brief Method get_integratedLufs, addr 0x26d1c70, size 0x8, virtual false, abstract: false, final false
  inline float_t get_integratedLufs();

  /// @brief Method get_levelAuthorName, addr 0x26d1c60, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelAuthorName();

  /// @brief Method get_levelID, addr 0x26d1c40, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelID();

  /// @brief Method get_previewDifficultyBeatmapSets, addr 0x26d1cd0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_previewDuration, addr 0x26d1ca0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_previewDuration();

  /// @brief Method get_previewStartTime, addr 0x26d1c98, size 0x8, virtual false, abstract: false, final false
  inline float_t get_previewStartTime();

  /// @brief Method get_shuffle, addr 0x26d1c88, size 0x8, virtual false, abstract: false, final false
  inline float_t get_shuffle();

  /// @brief Method get_shufflePeriod, addr 0x26d1c90, size 0x8, virtual false, abstract: false, final false
  inline float_t get_shufflePeriod();

  /// @brief Method get_songAuthorName, addr 0x26d1c58, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songAuthorName();

  /// @brief Method get_songDuration, addr 0x26d1c80, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songDuration();

  /// @brief Method get_songName, addr 0x26d1c48, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songName();

  /// @brief Method get_songPreviewAudioClip, addr 0x26d1cc0, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::AudioClip> get_songPreviewAudioClip();

  /// @brief Method get_songSubName, addr 0x26d1c50, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_songSubName();

  /// @brief Method get_songTimeOffset, addr 0x26d1c78, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songTimeOffset();

  /// @brief Method get_version, addr 0x26d1c38, size 0x8, virtual false, abstract: false, final false
