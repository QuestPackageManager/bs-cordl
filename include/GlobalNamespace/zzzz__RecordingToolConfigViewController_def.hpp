...
public:
  ...
  /// @brief Method DidActivate, addr 0x3af634c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af63d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
