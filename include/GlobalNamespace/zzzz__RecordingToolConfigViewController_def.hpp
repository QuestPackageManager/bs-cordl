...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingToolConfigViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolConfigViewController*, "", "RecordingToolConfigViewController");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecordingToolConfigViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecordingToolConfigViewController(RecordingToolConfigViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecordingToolConfigViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecordingToolConfigViewController(RecordingToolConfigViewControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::RecordingToolConfigViewController) == 0x88, "Size mismatch!");
