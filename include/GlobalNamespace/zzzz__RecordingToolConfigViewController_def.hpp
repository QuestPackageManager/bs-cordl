...
public:
  ...
  /// @brief Method DidActivate, addr 0x3af13d8, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af1460, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
