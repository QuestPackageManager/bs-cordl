...
/// @brief Method DidActivate, addr 0x57a7738, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a77d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
