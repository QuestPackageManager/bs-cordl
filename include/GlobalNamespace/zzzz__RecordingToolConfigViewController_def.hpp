...
public:
  ...
  /// @brief Method DidActivate, addr 0x255bfd4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x255c060, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
