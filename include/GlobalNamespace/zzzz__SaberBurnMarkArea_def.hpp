...
public:
  ...
  /// @brief Field _emitParams, offset 0xa8, size 0x90
  ...
  /// @brief Field _fadeOutMaterial, offset 0x138, size 0x8
  ...
  /// @brief Field _fadeOutStrengthShaderPropertyID, offset 0x58, size 0x4
  ...
  /// @brief Field _linePoints, offset 0x98, size 0x8
  ...
  /// @brief Method GetBurnMarkPos, addr 0x26d3770, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x26d3ab4, size 0x6a4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberBurnMarkArea* New_ctor();

  /// @brief Method OnDestroy, addr 0x26d330c, size 0x224, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x26d3650, size 0x120, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26d3530, size 0x120, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x26d2a4c, size 0x8c0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method WorldToCameraBurnMarkPos, addr 0x26d39b4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d4158, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _disableBlitTimer, offset: 0x48, size: 0x4, def value: None
  float_t ____disableBlitTimer;

  /// @brief Field _renderer, offset: 0x50, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Renderer> ____renderer;

  /// @brief Field _fadeOutStrengthShaderPropertyID, offset: 0x58, size: 0x4, def value: None
  ...
  /// @brief Field _camera, offset: 0x90, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Camera> ____camera;

  /// @brief Field _linePoints, offset: 0x98, size: 0x8, def value: None
  ...
  /// @brief Field _emitParams, offset: 0xa8, size: 0x90, def value: None
  ::UnityEngine::__ParticleSystem__EmitParams ____emitParams;

  /// @brief Field _fadeOutMaterial, offset: 0x138, size: 0x8, def value: None
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::SaberBurnMarkArea, 0x140>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____disableBlitTimer) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____renderer) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____fadeOutStrengthShaderPropertyID) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____sabers) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____plane) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____prevBurnMarkPos) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____prevBurnMarkPosValid) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____lineRenderers) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____camera) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____linePoints) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____renderTextures) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____emitParams) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberBurnMarkArea, ____fadeOutMaterial) == 0x138, "Offset mismatch!");
