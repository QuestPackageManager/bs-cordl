...
inline ::GlobalNamespace::PlayerIdentityPacket_1<TGameSpecificIdentityData>* Init(::GlobalNamespace::PlayerStateHash  states, ::ArrayW<uint8_t,::Array<uint8_t>*>  random, ::ArrayW<uint8_t,::Array<uint8_t>*>  publicEncryptionKey, TGameSpecificIdentityData  gameSpecificData) ;
