...
public:
  ...
  /// @brief Method Start addr 0x26c9be4 size 0xf8 virtual false final false
  inline void Start();

  /// @brief Method SetPresence addr 0x26ca048 size 0x198 virtual false final false
  inline void SetPresence();

  /// @brief Method ClearPresence addr 0x26ca708 size 0xb4 virtual false final false
  inline void ClearPresence();

  /// @brief Method LaunchInvitePanel addr 0x26ca900 size 0x10c virtual false final false
  inline void LaunchInvitePanel();

  /// @brief Method LaunchRosterPanel addr 0x26cac78 size 0xf0 virtual false final false
  inline void LaunchRosterPanel();

  /// @brief Method OnJoinIntentChangeNotif addr 0x26cafc0 size 0x35c virtual false final false
  inline void OnJoinIntentChangeNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceJoinIntent*>* message);

  /// @brief Method OnLeaveIntentChangeNotif addr 0x26cb32c size 0x268 virtual false final false
  inline void OnLeaveIntentChangeNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::GroupPresenceLeaveIntent*>* message);

  /// @brief Method OnInviteSentNotif addr 0x26cb594 size 0x3dc virtual false final false
  inline void OnInviteSentNotif(::Oculus::Platform::Message_1<::Oculus::Platform::Models::LaunchInvitePanelFlowResult*>* message);

  /// @brief Method OnGetDestinations addr 0x26cb970 size 0x360 virtual false final false
  inline void OnGetDestinations(::Oculus::Platform::Message_1<::Oculus::Platform::Models::DestinationList*>* message);

  /// @brief Method Update addr 0x26cbe3c size 0xe8 virtual false final false
  inline void Update();

  /// @brief Method ScrollThroughDestinations addr 0x26cbf54 size 0xd4 virtual false final false
  inline void ScrollThroughDestinations();

  /// @brief Method UpdateDestinationsConsole addr 0x26cbcd0 size 0x16c virtual false final false
  inline void UpdateDestinationsConsole();

  /// @brief Method OnLoggedInUser addr 0x26cc040 size 0xa8 virtual false final false
  inline void OnLoggedInUser(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>* message);

  /// @brief Method UpdateConsole addr 0x26c9cdc size 0xac virtual false final false
  inline void UpdateConsole(::StringW value);

  /// @brief Method PressAButton addr 0x26cbf24 size 0xc virtual false final false
  inline bool PressAButton();

  /// @brief Method PressBButton addr 0x26cbf30 size 0xc virtual false final false
  inline bool PressBButton();

  /// @brief Method PressXButton addr 0x26cbf3c size 0xc virtual false final false
  inline bool PressXButton();

  /// @brief Method PressYButton addr 0x26cbf48 size 0xc virtual false final false
  inline bool PressYButton();

  /// @brief Method PressUp addr 0x26cc028 size 0xc virtual false final false
  inline bool PressUp();

  /// @brief Method PressDown addr 0x26cc034 size 0xc virtual false final false
  inline bool PressDown();

  static inline ::GlobalNamespace::GroupPresenceSample* New_ctor();

  /// @brief Method .ctor addr 0x26cc0e8 size 0x84 virtual false final false
  inline void _ctor();

  /// @brief Method <Start>b__8_0 addr 0x26cc16c size 0x278 virtual false final false
  inline void _Start_b__8_0(::Oculus::Platform::Message_1<::Oculus::Platform::Models::PlatformInitialize*>* message);

  /// @brief Method <SetPresence>b__9_0 addr 0x26cc7f0 size 0xe4 virtual false final false
  inline void _SetPresence_b__9_0(::Oculus::Platform::Message* message);

  /// @brief Method <SetPresence>b__9_1 addr 0x26cca34 size 0x200 virtual false final false
  inline void _SetPresence_b__9_1(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>* message2);

  /// @brief Method <ClearPresence>b__10_0 addr 0x26ccc34 size 0xe4 virtual false final false
  inline void _ClearPresence_b__10_0(::Oculus::Platform::Message* message);

  /// @brief Method <ClearPresence>b__10_1 addr 0x26ccd18 size 0xb4 virtual false final false
  inline void _ClearPresence_b__10_1(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>* message2);

  /// @brief Method <LaunchInvitePanel>b__11_0 addr 0x26ccdcc size 0x48 virtual false final false
  inline void _LaunchInvitePanel_b__11_0(::Oculus::Platform::Message_1<::Oculus::Platform::Models::InvitePanelResultInfo*>* message);

  /// @brief Method <LaunchRosterPanel>b__12_0 addr 0x26cce14 size 0x48 virtual false final false
