...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerBadgeDataGoodCutsSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerBadgeDataGoodCutsSO*, "", "MultiplayerBadgeDataGoodCutsSO");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeDataGoodCutsSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerBadgeDataGoodCutsSO(MultiplayerBadgeDataGoodCutsSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeDataGoodCutsSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerBadgeDataGoodCutsSO(MultiplayerBadgeDataGoodCutsSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MultiplayerBadgeDataGoodCutsSO) == 0x38, "Size mismatch!");
