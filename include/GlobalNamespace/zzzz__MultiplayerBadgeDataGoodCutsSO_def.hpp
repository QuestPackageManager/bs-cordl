...
public:
  // Declarations
  /// @brief Method GetValue, addr 0x12ff9e0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12ffa08, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
