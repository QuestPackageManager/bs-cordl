...
/// @brief Method .ctor, addr 0x362c0e8, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  difficultyBeatmapId, ::StringW  platformLeaderboardId) ;

/// @brief Method get_difficultyBeatmapId, addr 0x362c174, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_difficultyBeatmapId() ;

/// @brief Method get_platformLeaderboardId, addr 0x362c16c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _leaderboardIds, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__leaderboardIds, put=__cordl_internal_set__leaderboardIds)) ::System::Collections::Generic::List_1<::GlobalNamespace::LeaderboardIdsSO_LeaderboardIdData*>*  _leaderboardIds;
...
/// @brief Method Add, addr 0x362c008, size 0xe0, virtual false, abstract: false, final false
inline void Add(::StringW  difficultyBeatmapId, ::StringW  platformLeaderboardId) ;

/// @brief Method ILeaderboardIdContainer.get_leaderboardIds, addr 0x362bf98, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x362c0f0, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_leaderboardIds, addr 0x362bfa0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_leaderboardIds, addr 0x362bfa8, size 0x60, virtual false, abstract: false, final false
