...
public:
  ...
  /// @brief Method Dispose, addr 0x266ac98, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x266ac1c, size 0x7c, virtual false, abstract: false, final false
