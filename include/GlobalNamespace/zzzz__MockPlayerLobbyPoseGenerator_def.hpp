...
public:
  ...
  /// @brief Method Dispose, addr 0x276a094, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x276a018, size 0x7c, virtual false, abstract: false, final false
