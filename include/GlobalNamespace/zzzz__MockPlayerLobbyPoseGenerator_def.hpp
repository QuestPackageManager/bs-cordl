...
public:
  ...
  /// @brief Method Dispose, addr 0x5a85c90, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x5a85c24, size 0x6c, virtual false, abstract: false, final false
