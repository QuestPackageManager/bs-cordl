...
/// @brief Method Dispose, addr 0x58d9844, size 0x10, virtual true, abstract: false, final false
inline void Dispose() ;
...
/// @brief Method .ctor, addr 0x58d97d8, size 0x6c, virtual false, abstract: false, final false
