...
public:
  ...
  /// @brief Method Dispose, addr 0x3c2aab4, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x3c2aa40, size 0x74, virtual false, abstract: false, final false
