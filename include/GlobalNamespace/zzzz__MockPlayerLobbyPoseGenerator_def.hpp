...
public:
  ...
  /// @brief Method Dispose, addr 0x594b7b0, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x594b744, size 0x6c, virtual false, abstract: false, final false
