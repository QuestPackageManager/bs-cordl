...
public:
  ...
  /// @brief Method Dispose, addr 0x2663c9c, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x2663c20, size 0x7c, virtual false, abstract: false, final false
