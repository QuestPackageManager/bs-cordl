...
public:
  ...
  /// @brief Method Dispose, addr 0x3c3cfb8, size 0x10, virtual true, abstract: false, final false
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x3c3cf44, size 0x74, virtual false, abstract: false, final false
