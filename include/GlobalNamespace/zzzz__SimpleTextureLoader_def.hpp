...
public:
  ...
  /// @brief Method MoveNext, addr 0x2250a48, size 0x270, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__SimpleTextureLoader___LoadTextureCoroutine_d__3* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2250d68, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2250d70, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2250db0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2250a2c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x2250cb8, size 0xb0, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x2250984, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method LoadTexture, addr 0x2250824, size 0xd0, virtual false, abstract: false, final false
  inline void LoadTexture(::StringW filePath, bool useCache, ::System::Action_1<::UnityW<::UnityEngine::Texture2D>>* finishedCallback);

  /// @brief Method LoadTextureCoroutine, addr 0x22508f4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22509ac, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
