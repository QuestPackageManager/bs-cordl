...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerPlayerStartState, "", "MultiplayerPlayerStartState");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Field InSync value: I32(0)
...
static_assert(sizeof(::GlobalNamespace::MultiplayerPlayerStartState) == 0x4, "Size mismatch!");
