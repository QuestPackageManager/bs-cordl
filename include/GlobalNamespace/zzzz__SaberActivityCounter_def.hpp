...
public:
// Declarations
/// @brief Field _averageWindowDuration, offset 0x20, size 0x4 
...
/// @brief Field _decreaseSpeed, offset 0x2c, size 0x4 
...
/// @brief Field _handMovementHistoryRecorder, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__handMovementHistoryRecorder, put=__cordl_internal_set__handMovementHistoryRecorder)) ::GlobalNamespace::MovementHistoryRecorder*  _handMovementHistoryRecorder;
...
/// @brief Field _increaseSpeed, offset 0x28, size 0x4 
...
/// @brief Field _movementSensitivityThreshold, offset 0x30, size 0x4 
...
/// @brief Field _saberMovementHistoryRecorder, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__saberMovementHistoryRecorder, put=__cordl_internal_set__saberMovementHistoryRecorder)) ::GlobalNamespace::MovementHistoryRecorder*  _saberMovementHistoryRecorder;

/// @brief Field _valuesPerSecond, offset 0x24, size 0x4 
...
/// @brief Method Awake, addr 0x5844a34, size 0xac, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleDidPauseEvent, addr 0x58452e4, size 0x8, virtual false, abstract: false, final false
inline void HandleDidPauseEvent() ;

/// @brief Method HandleSaberPositionsWereUpdated, addr 0x5844e14, size 0x4d0, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5844c38, size 0x1dc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5844ae0, size 0x158, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::GlobalNamespace::MovementHistoryRecorder* const& __cordl_internal_get__handMovementHistoryRecorder() const;
...
constexpr ::GlobalNamespace::MovementHistoryRecorder* const& __cordl_internal_get__saberMovementHistoryRecorder() const;
...
constexpr ::System::Action_1<float_t>* const& __cordl_internal_get_totalDistanceDidChangeEvent() const;
...
/// @brief Method .ctor, addr 0x58452ec, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_totalDistanceDidChangeEvent, addr 0x5844894, size 0xc0, virtual false, abstract: false, final false
inline void add_totalDistanceDidChangeEvent(::System::Action_1<float_t>*  value) ;

/// @brief Method get_handMovementAveragingValueRecorder, addr 0x5841bd0, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::AveragingValueRecorder* get_handMovementAveragingValueRecorder() ;

/// @brief Method get_leftHandMovementDistance, addr 0x5844a24, size 0x8, virtual false, abstract: false, final false
inline float_t get_leftHandMovementDistance() ;

/// @brief Method get_leftSaberMovementDistance, addr 0x5844a14, size 0x8, virtual false, abstract: false, final false
inline float_t get_leftSaberMovementDistance() ;

/// @brief Method get_rightHandMovementDistance, addr 0x5844a2c, size 0x8, virtual false, abstract: false, final false
inline float_t get_rightHandMovementDistance() ;

/// @brief Method get_rightSaberMovementDistance, addr 0x5844a1c, size 0x8, virtual false, abstract: false, final false
inline float_t get_rightSaberMovementDistance() ;

/// @brief Method get_saberMovementAveragingValueRecorder, addr 0x5841bb8, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::AveragingValueRecorder* get_saberMovementAveragingValueRecorder() ;

/// @brief Method remove_totalDistanceDidChangeEvent, addr 0x5844954, size 0xc0, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ____averageWindowDuration) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ____valuesPerSecond) == 0x24, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ____increaseSpeed) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ____decreaseSpeed) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ____movementSensitivityThreshold) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ____saberManager) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ____gamePause) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SaberActivityCounter, ___totalDistanceDidChangeEvent) == 0x48, "Offset mismatch!");
