...
public:
  ...
  /// @brief Method Awake, addr 0x58effa0, size 0x90, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNormalizedValueDidChange, addr 0x58f015c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58f0030, size 0x84, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPointerUp, addr 0x58f0184, size 0x40, virtual true, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method UpdateVisuals, addr 0x58f00b4, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f01c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorHueDidChangeEvent, addr 0x58efe20, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_colorHueDidChangeEvent, addr 0x58efee0, size 0xc0, virtual false, abstract: false, final false
