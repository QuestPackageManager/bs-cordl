...
/// @brief Field colorHueDidChangeEvent, offset 0x150, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorHueDidChangeEvent, put=__cordl_internal_set_colorHueDidChangeEvent)) ::System::Action_3<::UnityW<::GlobalNamespace::ColorHueSlider>,float_t,::GlobalNamespace::ColorChangeUIEventType>*  colorHueDidChangeEvent;
...
/// @brief Method Awake, addr 0x58f1970, size 0x90, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleNormalizedValueDidChange, addr 0x58f1b2c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x58f1a00, size 0x84, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnPointerUp, addr 0x58f1b54, size 0x40, virtual true, abstract: false, final false
inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method UpdateVisuals, addr 0x58f1a84, size 0xa8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58f1b94, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_colorHueDidChangeEvent, addr 0x58f17f0, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_colorHueDidChangeEvent, addr 0x58f18b0, size 0xc0, virtual false, abstract: false, final false
