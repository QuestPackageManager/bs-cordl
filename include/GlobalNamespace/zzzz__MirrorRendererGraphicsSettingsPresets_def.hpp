...
/// @brief Method .ctor, addr 0x36330b0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _presets, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__presets, put=__cordl_internal_set__presets)) ::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*>  _presets;
 ...
 __declspec(property(get=get_presets)) ::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*>  presets;

static inline ::GlobalNamespace::MirrorRendererGraphicsSettingsPresets* New_ctor() ;

constexpr ::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*> const& __cordl_internal_get__presets() const;
...
constexpr void __cordl_internal_set__presets(::ArrayW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*,::Array<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets_Preset*>*>  value) ;

/// @brief Method .ctor, addr 0x36330a8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_namedPresets, addr 0x36330a0, size 0x8, virtual true, abstract: false, final false
inline ::ArrayW<::GlobalNamespace::NamedPreset*,::Array<::GlobalNamespace::NamedPreset*>*> get_namedPresets() ;

/// @brief Method get_presets, addr 0x3633098, size 0x8, virtual false, abstract: false, final false
