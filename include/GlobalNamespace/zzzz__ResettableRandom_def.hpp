...
// Write type traits
MARK_REF_T(::GlobalNamespace::ResettableRandom*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ResettableRandom*, "", "ResettableRandom");
...
static_assert(sizeof(::GlobalNamespace::ResettableRandom) == 0x28, "Size mismatch!");
