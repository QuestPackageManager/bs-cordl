...
public:
  ...
  /// @brief Method Start addr 0x23c1424 size 0x94 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x23c1858 size 0xd4 virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleMissionObjectiveCheckersManagerObjectivesListDidChange addr 0x23c192c size 0x4 virtual false final false
  inline void HandleMissionObjectiveCheckersManagerObjectivesListDidChange();

  /// @brief Method CreateUIElements addr 0x23c14b8 size 0x3a0 virtual false final false
  inline void CreateUIElements();

  static inline ::GlobalNamespace::MissionObjectivesGameUIController* New_ctor();

  /// @brief Method .ctor addr 0x23c1930 size 0x10 virtual false final false
  inline void _ctor();
