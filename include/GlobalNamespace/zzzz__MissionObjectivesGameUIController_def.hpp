...
public:
  ...
  /// @brief Method CreateUIElements, addr 0x3bb5600, size 0x398, virtual false, abstract: false, final false
  inline void CreateUIElements();

  /// @brief Method HandleMissionObjectiveCheckersManagerObjectivesListDidChange, addr 0x3bb5a68, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bb5998, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3bb5568, size 0x98, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bb5a6c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
