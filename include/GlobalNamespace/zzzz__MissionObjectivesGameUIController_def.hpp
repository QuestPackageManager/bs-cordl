...
/// @brief Field _missionObjectiveGameUIViewPrefab, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__missionObjectiveGameUIViewPrefab, put=__cordl_internal_set__missionObjectiveGameUIViewPrefab)) ::UnityW<::GlobalNamespace::MissionObjectiveGameUIView>  _missionObjectiveGameUIViewPrefab;

/// @brief Field _missionObjectiveGameUIViews, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__missionObjectiveGameUIViews, put=__cordl_internal_set__missionObjectiveGameUIViews)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::MissionObjectiveGameUIView>>*  _missionObjectiveGameUIViews;
...
/// @brief Method CreateUIElements, addr 0x58713b8, size 0x368, virtual false, abstract: false, final false
inline void CreateUIElements() ;

/// @brief Method HandleMissionObjectiveCheckersManagerObjectivesListDidChange, addr 0x5871830, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5871720, size 0x110, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5871320, size 0x98, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x5871834, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
