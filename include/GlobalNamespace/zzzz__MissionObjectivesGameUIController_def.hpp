...
public:
  ...
  /// @brief Method CreateUIElements, addr 0x57fd2e4, size 0x368, virtual false, abstract: false, final false
  inline void CreateUIElements();

  /// @brief Method HandleMissionObjectiveCheckersManagerObjectivesListDidChange, addr 0x57fd75c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x57fd64c, size 0x110, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x57fd24c, size 0x98, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x57fd760, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
