...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x333921c, size 0x30, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::NetworkStatisticsDelta) == 0x68, "Size mismatch!");
