...
/// @brief Method .ctor, addr 0x5845804, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x5845708, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x584570c, size 0x10, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RefreshSabers, addr 0x58455e0, size 0x128, virtual false, abstract: false, final false
inline void RefreshSabers() ;

/// @brief Method SaberForType, addr 0x58457b4, size 0x4c, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::Saber> SaberForType(::GlobalNamespace::SaberType  saberType) ;

/// @brief Method Start, addr 0x58455c4, size 0x1c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x584571c, size 0x98, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5845800, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didUpdateSaberPositionsEvent, addr 0x5843ac4, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_leftSaber, addr 0x58455a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::Saber> get_leftSaber() ;

/// @brief Method get_rightSaber, addr 0x58455ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::Saber> get_rightSaber() ;

/// @brief Method remove_didUpdateSaberPositionsEvent, addr 0x5843c10, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_disableSabers, addr 0x58455b4, size 0x10, virtual false, abstract: false, final false
