...
// TypeDefinitionIndex(3402), inst: 777 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(4384)) CS Name: ::CustomPreviewBeatmapLevel::<GetCoverImageAsync>d__69
...
public:
  ...
  /// @brief Method SetStateMachine, addr 0x2347b84, size 0x58, virtual true, abstract: false, final true
  ...
  // None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>", modifiers: "", def_value: None }]
  constexpr __CustomPreviewBeatmapLevel___GetCoverImageAsync_d__69(int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::UnityW<::UnityEngine::Sprite>> __t__builder,
...
static_assert(offsetof(::GlobalNamespace::__CustomPreviewBeatmapLevel___GetCoverImageAsync_d__69, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomPreviewBeatmapLevel___GetCoverImageAsync_d__69, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomPreviewBeatmapLevel___GetCoverImageAsync_d__69, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomPreviewBeatmapLevel___GetCoverImageAsync_d__69, cancellationToken) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomPreviewBeatmapLevel___GetCoverImageAsync_d__69, __u__1) == 0x30, "Offset mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__spriteAsyncLoader_k__BackingField,
                      put = __cordl_internal_set__spriteAsyncLoader_k__BackingField))::GlobalNamespace::ISpriteAsyncLoader* _spriteAsyncLoader_k__BackingField;

  /// @brief Field <standardLevelInfoSaveData>k__BackingField, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get__standardLevelInfoSaveData_k__BackingField,
                      put = __cordl_internal_set__standardLevelInfoSaveData_k__BackingField))::GlobalNamespace::StandardLevelInfoSaveData* _standardLevelInfoSaveData_k__BackingField;

  /// @brief Field <customLevelPath>k__BackingField, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__customLevelPath_k__BackingField, put = __cordl_internal_set__customLevelPath_k__BackingField))::StringW _customLevelPath_k__BackingField;
  ...
  __declspec(property(get = __cordl_internal_get__songName_k__BackingField, put = __cordl_internal_set__songName_k__BackingField))::StringW _songName_k__BackingField;

  /// @brief Field <songSubName>k__BackingField, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__songSubName_k__BackingField, put = __cordl_internal_set__songSubName_k__BackingField))::StringW _songSubName_k__BackingField;

  /// @brief Field <songAuthorName>k__BackingField, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__songAuthorName_k__BackingField, put = __cordl_internal_set__songAuthorName_k__BackingField))::StringW _songAuthorName_k__BackingField;

  /// @brief Field <levelAuthorName>k__BackingField, offset 0x48, size 0x8
  __declspec(property(get = __cordl_internal_get__levelAuthorName_k__BackingField, put = __cordl_internal_set__levelAuthorName_k__BackingField))::StringW _levelAuthorName_k__BackingField;

  /// @brief Field <beatsPerMinute>k__BackingField, offset 0x50, size 0x4
  __declspec(property(get = __cordl_internal_get__beatsPerMinute_k__BackingField, put = __cordl_internal_set__beatsPerMinute_k__BackingField)) float_t _beatsPerMinute_k__BackingField;

  /// @brief Field <songTimeOffset>k__BackingField, offset 0x54, size 0x4
  __declspec(property(get = __cordl_internal_get__songTimeOffset_k__BackingField, put = __cordl_internal_set__songTimeOffset_k__BackingField)) float_t _songTimeOffset_k__BackingField;

  /// @brief Field <songDuration>k__BackingField, offset 0x58, size 0x4
  __declspec(property(get = __cordl_internal_get__songDuration_k__BackingField, put = __cordl_internal_set__songDuration_k__BackingField)) float_t _songDuration_k__BackingField;

  /// @brief Field <shuffle>k__BackingField, offset 0x5c, size 0x4
  __declspec(property(get = __cordl_internal_get__shuffle_k__BackingField, put = __cordl_internal_set__shuffle_k__BackingField)) float_t _shuffle_k__BackingField;

  /// @brief Field <shufflePeriod>k__BackingField, offset 0x60, size 0x4
  __declspec(property(get = __cordl_internal_get__shufflePeriod_k__BackingField, put = __cordl_internal_set__shufflePeriod_k__BackingField)) float_t _shufflePeriod_k__BackingField;

  /// @brief Field <previewStartTime>k__BackingField, offset 0x64, size 0x4
  __declspec(property(get = __cordl_internal_get__previewStartTime_k__BackingField, put = __cordl_internal_set__previewStartTime_k__BackingField)) float_t _previewStartTime_k__BackingField;

  /// @brief Field <previewDuration>k__BackingField, offset 0x68, size 0x4
  __declspec(property(get = __cordl_internal_get__previewDuration_k__BackingField, put = __cordl_internal_set__previewDuration_k__BackingField)) float_t _previewDuration_k__BackingField;
  ...
  __declspec(property(get = __cordl_internal_get__allDirectionsEnvironmentInfo_k__BackingField,
                      put = __cordl_internal_set__allDirectionsEnvironmentInfo_k__BackingField))::UnityW<::GlobalNamespace::EnvironmentInfoSO> _allDirectionsEnvironmentInfo_k__BackingField;

  /// @brief Field <environmentInfos>k__BackingField, offset 0x80, size 0x8
  __declspec(property(get = __cordl_internal_get__environmentInfos_k__BackingField,
                      put = __cordl_internal_set__environmentInfos_k__BackingField))::ArrayW<::UnityW<::GlobalNamespace::EnvironmentInfoSO>,
                                                                                             ::Array<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> _environmentInfos_k__BackingField;

  /// @brief Field <defaultCoverImage>k__BackingField, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get__defaultCoverImage_k__BackingField,
                      put = __cordl_internal_set__defaultCoverImage_k__BackingField))::UnityW<::UnityEngine::Sprite> _defaultCoverImage_k__BackingField;
  ...
  __declspec(property(get = __cordl_internal_get__beatmapOverrideColorSchemes_k__BackingField,
                      put = __cordl_internal_set__beatmapOverrideColorSchemes_k__BackingField))::ArrayW<::GlobalNamespace::ColorScheme*,
                                                                                                        ::Array<::GlobalNamespace::ColorScheme*>*> _beatmapOverrideColorSchemes_k__BackingField;
  ...
  __declspec(property(get = get_defaultCoverImage))::UnityW<::UnityEngine::Sprite> defaultCoverImage;
  ...
  constexpr ::GlobalNamespace::ISpriteAsyncLoader*& __cordl_internal_get__spriteAsyncLoader_k__BackingField();

  constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ISpriteAsyncLoader*> const& __cordl_internal_get__spriteAsyncLoader_k__BackingField() const;

  constexpr void __cordl_internal_set__spriteAsyncLoader_k__BackingField(::GlobalNamespace::ISpriteAsyncLoader* value);

  constexpr ::GlobalNamespace::StandardLevelInfoSaveData*& __cordl_internal_get__standardLevelInfoSaveData_k__BackingField();

  constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StandardLevelInfoSaveData*> const& __cordl_internal_get__standardLevelInfoSaveData_k__BackingField() const;

  constexpr void __cordl_internal_set__standardLevelInfoSaveData_k__BackingField(::GlobalNamespace::StandardLevelInfoSaveData* value);

  constexpr ::StringW& __cordl_internal_get__customLevelPath_k__BackingField();

  constexpr ::StringW const& __cordl_internal_get__customLevelPath_k__BackingField() const;

  constexpr void __cordl_internal_set__customLevelPath_k__BackingField(::StringW value);
  ...
  constexpr ::StringW& __cordl_internal_get__songName_k__BackingField();

  constexpr ::StringW const& __cordl_internal_get__songName_k__BackingField() const;

  constexpr void __cordl_internal_set__songName_k__BackingField(::StringW value);

  constexpr ::StringW& __cordl_internal_get__songSubName_k__BackingField();

  constexpr ::StringW const& __cordl_internal_get__songSubName_k__BackingField() const;

  constexpr void __cordl_internal_set__songSubName_k__BackingField(::StringW value);

  constexpr ::StringW& __cordl_internal_get__songAuthorName_k__BackingField();

  constexpr ::StringW const& __cordl_internal_get__songAuthorName_k__BackingField() const;

  constexpr void __cordl_internal_set__songAuthorName_k__BackingField(::StringW value);

  constexpr ::StringW& __cordl_internal_get__levelAuthorName_k__BackingField();

  constexpr ::StringW const& __cordl_internal_get__levelAuthorName_k__BackingField() const;

  constexpr void __cordl_internal_set__levelAuthorName_k__BackingField(::StringW value);

  constexpr float_t& __cordl_internal_get__beatsPerMinute_k__BackingField();

  constexpr float_t const& __cordl_internal_get__beatsPerMinute_k__BackingField() const;

  constexpr void __cordl_internal_set__beatsPerMinute_k__BackingField(float_t value);

  constexpr float_t& __cordl_internal_get__songTimeOffset_k__BackingField();

  constexpr float_t const& __cordl_internal_get__songTimeOffset_k__BackingField() const;

  constexpr void __cordl_internal_set__songTimeOffset_k__BackingField(float_t value);

  constexpr float_t& __cordl_internal_get__songDuration_k__BackingField();

  constexpr float_t const& __cordl_internal_get__songDuration_k__BackingField() const;

  constexpr void __cordl_internal_set__songDuration_k__BackingField(float_t value);

  constexpr float_t& __cordl_internal_get__shuffle_k__BackingField();

  constexpr float_t const& __cordl_internal_get__shuffle_k__BackingField() const;

  constexpr void __cordl_internal_set__shuffle_k__BackingField(float_t value);

  constexpr float_t& __cordl_internal_get__shufflePeriod_k__BackingField();

  constexpr float_t const& __cordl_internal_get__shufflePeriod_k__BackingField() const;

  constexpr void __cordl_internal_set__shufflePeriod_k__BackingField(float_t value);

  constexpr float_t& __cordl_internal_get__previewStartTime_k__BackingField();

  constexpr float_t const& __cordl_internal_get__previewStartTime_k__BackingField() const;

  constexpr void __cordl_internal_set__previewStartTime_k__BackingField(float_t value);

  constexpr float_t& __cordl_internal_get__previewDuration_k__BackingField();

  constexpr float_t const& __cordl_internal_get__previewDuration_k__BackingField() const;

  constexpr void __cordl_internal_set__previewDuration_k__BackingField(float_t value);
  ...
  constexpr ::UnityW<::GlobalNamespace::EnvironmentInfoSO>& __cordl_internal_get__allDirectionsEnvironmentInfo_k__BackingField();

  constexpr ::UnityW<::GlobalNamespace::EnvironmentInfoSO> const& __cordl_internal_get__allDirectionsEnvironmentInfo_k__BackingField() const;

  constexpr void __cordl_internal_set__allDirectionsEnvironmentInfo_k__BackingField(::UnityW<::GlobalNamespace::EnvironmentInfoSO> value);

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::EnvironmentInfoSO>, ::Array<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*>& __cordl_internal_get__environmentInfos_k__BackingField();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::EnvironmentInfoSO>, ::Array<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> const& __cordl_internal_get__environmentInfos_k__BackingField() const;

  constexpr void __cordl_internal_set__environmentInfos_k__BackingField(::ArrayW<::UnityW<::GlobalNamespace::EnvironmentInfoSO>, ::Array<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> value);

  constexpr ::UnityW<::UnityEngine::Sprite>& __cordl_internal_get__defaultCoverImage_k__BackingField();

  constexpr ::UnityW<::UnityEngine::Sprite> const& __cordl_internal_get__defaultCoverImage_k__BackingField() const;

  constexpr void __cordl_internal_set__defaultCoverImage_k__BackingField(::UnityW<::UnityEngine::Sprite> value);
  ...
  constexpr ::ArrayW<::GlobalNamespace::ColorScheme*, ::Array<::GlobalNamespace::ColorScheme*>*>& __cordl_internal_get__beatmapOverrideColorSchemes_k__BackingField();

  constexpr ::ArrayW<::GlobalNamespace::ColorScheme*, ::Array<::GlobalNamespace::ColorScheme*>*> const& __cordl_internal_get__beatmapOverrideColorSchemes_k__BackingField() const;

  constexpr void __cordl_internal_set__beatmapOverrideColorSchemes_k__BackingField(::ArrayW<::GlobalNamespace::ColorScheme*, ::Array<::GlobalNamespace::ColorScheme*>*> value);
  ...
  /// @brief Method get_spriteAsyncLoader, addr 0x234764c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ISpriteAsyncLoader* get_spriteAsyncLoader();

  /// @brief Method get_standardLevelInfoSaveData, addr 0x2347654, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::StandardLevelInfoSaveData* get_standardLevelInfoSaveData();

  /// @brief Method get_customLevelPath, addr 0x234765c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_customLevelPath();

  /// @brief Method get_levelID, addr 0x2347664, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_levelID();

  /// @brief Method get_songName, addr 0x234766c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_songName();

  /// @brief Method get_songSubName, addr 0x2347674, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_songSubName();

  /// @brief Method get_songAuthorName, addr 0x234767c, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_songAuthorName();

  /// @brief Method get_levelAuthorName, addr 0x2347684, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_levelAuthorName();

  /// @brief Method get_beatsPerMinute, addr 0x234768c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_beatsPerMinute();

  /// @brief Method get_songTimeOffset, addr 0x2347694, size 0x8, virtual true, abstract: false, final true
  inline float_t get_songTimeOffset();

  /// @brief Method get_songDuration, addr 0x234769c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_songDuration();

  /// @brief Method get_shuffle, addr 0x23476a4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_shuffle();

  /// @brief Method get_shufflePeriod, addr 0x23476ac, size 0x8, virtual true, abstract: false, final true
  inline float_t get_shufflePeriod();

  /// @brief Method get_previewStartTime, addr 0x23476b4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_previewStartTime();

  /// @brief Method get_previewDuration, addr 0x23476bc, size 0x8, virtual true, abstract: false, final true
  inline float_t get_previewDuration();

  /// @brief Method get_environmentInfo, addr 0x23476c4, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_environmentInfo();

  /// @brief Method get_allDirectionsEnvironmentInfo, addr 0x23476cc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_allDirectionsEnvironmentInfo();

  /// @brief Method get_environmentInfos, addr 0x23476d4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_defaultCoverImage, addr 0x23476dc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_defaultCoverImage();

  /// @brief Method get_previewDifficultyBeatmapSets, addr 0x23476e4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method get_songPreviewAudioClipPath, addr 0x23473d0, size 0x70, virtual true, abstract: false, final true
  inline ::StringW get_songPreviewAudioClipPath();

  /// @brief Method get_beatmapOverrideColorSchemes, addr 0x23476ec, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::ColorScheme*, ::Array<::GlobalNamespace::ColorScheme*>*> get_beatmapOverrideColorSchemes();

  /// @brief Method get_contentRating, addr 0x23476f4, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::PlayerSensitivityFlag get_contentRating();

  /// @brief Method GetCoverImageAsync, addr 0x23476fc, size 0xfc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2347508, size 0xf8, virtual false, abstract: false, final false
...
public:
  ...
  ::UnityW<::GlobalNamespace::EnvironmentInfoSO> ____allDirectionsEnvironmentInfo_k__BackingField;

  /// @brief Field <environmentInfos>k__BackingField, offset: 0x80, size: 0x8, def value: None
  ::ArrayW<::UnityW<::GlobalNamespace::EnvironmentInfoSO>, ::Array<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*> ____environmentInfos_k__BackingField;

  /// @brief Field <defaultCoverImage>k__BackingField, offset: 0x88, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Sprite> ____defaultCoverImage_k__BackingField;
...
static_assert(offsetof(::GlobalNamespace::CustomPreviewBeatmapLevel, ____environmentInfos_k__BackingField) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::CustomPreviewBeatmapLevel, ____defaultCoverImage_k__BackingField) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::CustomPreviewBeatmapLevel, ____previewDifficultyBeatmapSets_k__BackingField) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::CustomPreviewBeatmapLevel, ____beatmapOverrideColorSchemes_k__BackingField) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::CustomPreviewBeatmapLevel, ____contentRating_k__BackingField) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::CustomPreviewBeatmapLevel, ____coverImage) == 0xa8, "Offset mismatch!");
