...
MARK_REF_T(::GlobalNamespace::IAudioTimeSource*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IAudioTimeSource_State, "", "IAudioTimeSource/State");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IAudioTimeSource*, "", "IAudioTimeSource");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::IAudioTimeSource_State) == 0x4, "Size mismatch!");
