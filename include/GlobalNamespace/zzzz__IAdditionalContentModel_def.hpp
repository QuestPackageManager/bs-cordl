...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAdditionalContentModel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAdditionalContentModel(IAdditionalContentModelconst&) = delete;
