...
/// @brief Field environmentColor, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get_environmentColor, put=__cordl_internal_set_environmentColor)) ::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_EnvironmentColor  environmentColor;
...
/// @brief Method .ctor, addr 0x57476c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__elements, put=__cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*>*>  _elements;

/// @brief Method HandleColorProviderDidChangeColor, addr 0x57476c4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x574758c, size 0x138, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetColorsToElements, addr 0x57472c4, size 0x2c8, virtual false, abstract: false, final false
inline void SetColorsToElements() ;

/// @brief Method Start, addr 0x57471c4, size 0x100, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*>*> const& __cordl_internal_get__elements() const;

constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*>*>& __cordl_internal_get__elements() ;
...
constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*>*>  value) ;

/// @brief Method .ctor, addr 0x5746f1c, size 0x2a8, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset: 0x28, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradientFromColorSchemeColors_Element*>*>  ____elements;
