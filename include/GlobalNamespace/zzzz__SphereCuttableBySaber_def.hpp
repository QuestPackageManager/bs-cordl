...
public:
  ...
  /// @brief Method Awake, addr 0x3bec79c, size 0x2c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Cut, addr 0x3bec7c8, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bec7fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_canBeCut, addr 0x3bec794, size 0x8, virtual true, abstract: false, final false
  inline bool get_canBeCut();

  /// @brief Method get_radius, addr 0x3bec740, size 0x1c, virtual true, abstract: false, final false
  inline float_t get_radius();

  /// @brief Method set_canBeCut, addr 0x3bec75c, size 0x38, virtual true, abstract: false, final false
