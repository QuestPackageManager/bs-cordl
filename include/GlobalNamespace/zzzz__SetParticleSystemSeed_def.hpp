...
public:
  ...
  /// @brief Method Awake, addr 0x3b87dd8, size 0x148, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x3b87f20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
