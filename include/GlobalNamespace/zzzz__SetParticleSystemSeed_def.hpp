...
/// @brief Method ApplySeed, addr 0x57db2dc, size 0x20, virtual false, abstract: false, final false
inline void ApplySeed() ;

/// @brief Method GetSeed, addr 0x57db3cc, size 0x48, virtual false, abstract: false, final false
inline uint32_t GetSeed() ;

/// @brief Method HandleDeterminismSync, addr 0x57db414, size 0x20, virtual false, abstract: false, final false
inline void HandleDeterminismSync(bool  _) ;

static inline ::GlobalNamespace::SetParticleSystemSeed* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57db2fc, size 0xd0, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57db150, size 0x18c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57db434, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
