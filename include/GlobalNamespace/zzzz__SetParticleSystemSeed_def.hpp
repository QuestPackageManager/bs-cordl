...
public:
  ...
  /// @brief Method Awake, addr 0x25c1f50, size 0x4c, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x25c1f9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
