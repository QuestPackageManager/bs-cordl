...
// Write type traits
MARK_REF_T(::GlobalNamespace::HealthCheckService*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HealthCheckService*, "", "HealthCheckService");
...
public:
  ...
  /// @brief Method Dispose, addr 0x3330754, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::GlobalNamespace::HealthCheckService* New_ctor(int32_t port);

  /// @brief Method PollUpdate, addr 0x3330814, size 0x98, virtual true, abstract: false, final true
  inline void PollUpdate();

  /// @brief Method Run, addr 0x33308ac, size 0x51c, virtual false, abstract: false, final false
  inline void Run();
  ...
  /// @brief Method .ctor, addr 0x3330650, size 0x104, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::HealthCheckService) == 0x38, "Size mismatch!");
