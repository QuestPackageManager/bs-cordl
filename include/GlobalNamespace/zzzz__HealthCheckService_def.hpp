...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HealthCheckService", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HealthCheckService(HealthCheckService&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HealthCheckService", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HealthCheckService(HealthCheckServiceconst&) = delete;
