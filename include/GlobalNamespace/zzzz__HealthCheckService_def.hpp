...
/// @brief Method Dispose, addr 0x3237028, size 0xc0, virtual true, abstract: false, final true
inline void Dispose() ;

static inline ::GlobalNamespace::HealthCheckService* New_ctor(int32_t  port) ;

/// @brief Method PollUpdate, addr 0x32370e8, size 0x98, virtual true, abstract: false, final true
inline void PollUpdate() ;

/// @brief Method Run, addr 0x3237180, size 0x51c, virtual false, abstract: false, final false
inline void Run() ;
...
/// @brief Method .ctor, addr 0x3236f24, size 0x104, virtual false, abstract: false, final false
