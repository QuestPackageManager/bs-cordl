...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteJumpSpeedEventDataProcessor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoteJumpSpeedEventDataProcessor(NoteJumpSpeedEventDataProcessor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoteJumpSpeedEventDataProcessor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoteJumpSpeedEventDataProcessor(NoteJumpSpeedEventDataProcessorconst&) = delete;
