...
public:
  ...
  /// @brief Method InstallBindings, addr 0x23dd868, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23dd8d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::AppStaticSettingsInstaller, 0x28>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::AppStaticSettingsInstaller, ____appStaticSettings) == 0x20, "Offset mismatch!");
