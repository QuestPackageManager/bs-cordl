...
public:
  ...
  /// @brief Method InstallBindings, addr 0x271b6fc, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x271b768, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
