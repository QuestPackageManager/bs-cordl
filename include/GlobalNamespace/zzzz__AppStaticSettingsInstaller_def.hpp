...
public:
  ...
  /// @brief Method InstallBindings, addr 0x376d0b0, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x376d134, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AppStaticSettingsInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AppStaticSettingsInstaller(AppStaticSettingsInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AppStaticSettingsInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AppStaticSettingsInstaller(AppStaticSettingsInstallerconst&) = delete;
