...
public:
  ...
  /// @brief Method InstallBindings, addr 0x24ffdb4, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24ffe20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
