...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecordingSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecordingSettings(RecordingSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecordingSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecordingSettings(RecordingSettingsconst&) = delete;
