...
public:
  ...
  /// @brief Method ToString, addr 0x57dabc4, size 0xcbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d9cf8, size 0x90, virtual false, abstract: false, final false
