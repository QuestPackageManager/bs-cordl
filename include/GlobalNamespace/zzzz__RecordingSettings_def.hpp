...
public:
  ...
  /// @brief Method ToString, addr 0x3b2bb28, size 0xa6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b2ac88, size 0x148, virtual false, abstract: false, final false
