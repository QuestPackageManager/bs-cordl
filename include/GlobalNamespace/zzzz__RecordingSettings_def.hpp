...
/// @brief Field playbackScreenshots, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_playbackScreenshots, put=__cordl_internal_set_playbackScreenshots)) ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*,::Array<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>*>  playbackScreenshots;
...
/// @brief Method ToString, addr 0x576ab18, size 0xcbc, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*,::Array<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>*> const& __cordl_internal_get_playbackScreenshots() const;
...
/// @brief Method .ctor, addr 0x5769c4c, size 0x90, virtual false, abstract: false, final false
