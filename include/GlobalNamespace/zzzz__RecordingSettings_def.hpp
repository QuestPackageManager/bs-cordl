...
public:
  ...
  /// @brief Method ToString, addr 0x3b2bb50, size 0xa6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b2acb0, size 0x148, virtual false, abstract: false, final false
