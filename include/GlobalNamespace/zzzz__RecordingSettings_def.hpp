...
public:
  ...
  /// @brief Method ToString, addr 0x2693b38, size 0xa74, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26929b4, size 0x154, virtual false, abstract: false, final false
