...
public:
// Declarations
/// @brief Method GetValue, addr 0x5721a64, size 0x90, virtual false, abstract: false, final false
inline float_t GetValue(float_t  time) ;

/// @brief Method SetValues, addr 0x5721804, size 0x14, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_fromValue", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "_toValue", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "_fromTime", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "_duration", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "_easeType", ty: "::GlobalNamespace::EaseType", modifiers: "", def_value: None }]
...
/// @brief Field _noteJumpValueType, offset 0x74, size 0x4 
 __declspec(property(get=__cordl_internal_get__noteJumpValueType, put=__cordl_internal_set__noteJumpValueType)) ::GlobalNamespace::BeatmapObjectSpawnMovementData_NoteJumpValueType  _noteJumpValueType;
...
/// @brief Field _relativeNoteJumpSpeedInterpolation, offset 0xa0, size 0x14 
 __declspec(property(get=__cordl_internal_get__relativeNoteJumpSpeedInterpolation, put=__cordl_internal_set__relativeNoteJumpSpeedInterpolation)) ::GlobalNamespace::VariableMovementDataProvider_InterpolationData  _relativeNoteJumpSpeedInterpolation;
...
/// @brief Method CalculateCurrentNoteJumpGravity, addr 0x571f480, size 0x14, virtual true, abstract: false, final true
inline float_t CalculateCurrentNoteJumpGravity(float_t  gravityBase) ;

/// @brief Method Dispose, addr 0x57215d0, size 0xe8, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleNoteJumpMovementSpeedEvent, addr 0x5721af4, size 0x6c, virtual false, abstract: false, final false
inline void HandleNoteJumpMovementSpeedEvent(::GlobalNamespace::NoteJumpSpeedEventData*  currentEventData) ;

/// @brief Method Init, addr 0x57216b8, size 0x14c, virtual true, abstract: false, final true
...
/// @brief Method JumpPosYForLineLayerAtDistanceFromPlayerWithoutJumpOffset, addr 0x57219c4, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method ManualUpdate, addr 0x5721818, size 0x1ac, virtual false, abstract: false, final false
inline void ManualUpdate(float_t  songTime) ;

static inline ::GlobalNamespace::VariableMovementDataProvider* New_ctor(::GlobalNamespace::PlayerTransforms*  playerTransforms, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;

/// @brief Method NoteJumpGravityForLineLayerWithoutJumpOffset, addr 0x5721a24, size 0x40, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5721470, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method get_halfJumpDuration, addr 0x57213b0, size 0x8, virtual true, abstract: false, final true
inline float_t get_halfJumpDuration() ;

/// @brief Method get_jumpDistance, addr 0x57213a0, size 0x8, virtual true, abstract: false, final true
inline float_t get_jumpDistance() ;

/// @brief Method get_jumpDuration, addr 0x57213a8, size 0x8, virtual true, abstract: false, final true
inline float_t get_jumpDuration() ;

/// @brief Method get_jumpEndPosition, addr 0x5721440, size 0x30, virtual true, abstract: false, final true
inline ::UnityEngine::Vector3 get_jumpEndPosition() ;

/// @brief Method get_moveDuration, addr 0x57213b8, size 0x8, virtual true, abstract: false, final true
inline float_t get_moveDuration() ;

/// @brief Method get_moveEndPosition, addr 0x5721410, size 0x30, virtual true, abstract: false, final true
inline ::UnityEngine::Vector3 get_moveEndPosition() ;

/// @brief Method get_moveStartPosition, addr 0x57213e0, size 0x30, virtual true, abstract: false, final true
inline ::UnityEngine::Vector3 get_moveStartPosition() ;

/// @brief Method get_noteJumpSpeed, addr 0x57213d0, size 0x8, virtual true, abstract: false, final true
inline float_t get_noteJumpSpeed() ;

/// @brief Method get_spawnAheadTime, addr 0x57213c0, size 0x8, virtual true, abstract: false, final true
inline float_t get_spawnAheadTime() ;

/// @brief Method get_targetNoteJumpSpeed, addr 0x57213d8, size 0x8, virtual false, abstract: false, final false
inline float_t get_targetNoteJumpSpeed() ;

/// @brief Method get_waitingDuration, addr 0x57213c8, size 0x8, virtual true, abstract: false, final true
inline float_t get_waitingDuration() ;

/// @brief Method get_wasUpdatedThisFrame, addr 0x5721390, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_wasUpdatedThisFrame, addr 0x5721398, size 0x8, virtual false, abstract: false, final false
