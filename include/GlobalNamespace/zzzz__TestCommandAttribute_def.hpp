...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TestCommandAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TestCommandAttribute(TestCommandAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TestCommandAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TestCommandAttribute(TestCommandAttributeconst&) = delete;
