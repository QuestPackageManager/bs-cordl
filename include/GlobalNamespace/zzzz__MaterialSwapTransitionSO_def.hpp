...
/// @brief Field _selectedAndHighlightedMaterial, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__selectedAndHighlightedMaterial, put=__cordl_internal_set__selectedAndHighlightedMaterial)) ::UnityW<::UnityEngine::Material>  _selectedAndHighlightedMaterial;
...
/// @brief Method .ctor, addr 0x6290f98, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_disabledMaterial, addr 0x6290f80, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_disabledMaterial() ;

/// @brief Method get_highlightedMaterial, addr 0x6290f70, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_highlightedMaterial() ;

/// @brief Method get_normalMaterial, addr 0x6290f68, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_normalMaterial() ;

/// @brief Method get_pressedMaterial, addr 0x6290f78, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_pressedMaterial() ;

/// @brief Method get_selectedAndHighlightedMaterial, addr 0x6290f90, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> get_selectedAndHighlightedMaterial() ;

/// @brief Method get_selectedMaterial, addr 0x6290f88, size 0x8, virtual false, abstract: false, final false
