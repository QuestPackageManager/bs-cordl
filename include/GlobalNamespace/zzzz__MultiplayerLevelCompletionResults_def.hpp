...
MARK_REF_T(::GlobalNamespace::MultiplayerLevelCompletionResults*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason, "", "MultiplayerLevelCompletionResults/MultiplayerPlayerLevelEndReason");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndState, "", "MultiplayerLevelCompletionResults/MultiplayerPlayerLevelEndState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLevelCompletionResults*, "", "MultiplayerLevelCompletionResults");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndState) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method CompareTo, addr 0x32b71dc, size 0xf8, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* obj);

  /// @brief Method CreateFromSerializedData, addr 0x32b7134, size 0xa8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method HasAnyResult, addr 0x32b7078, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x32b70a8, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x32b7098, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x32b709c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_failedOrGivenUp, addr 0x32b7084, size 0x14, virtual false, abstract: false, final false
  inline bool get_failedOrGivenUp();

  /// @brief Method get_hasAnyResults, addr 0x32b7068, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasAnyResults();

  /// @brief Method get_levelCompletionResults, addr 0x32b7060, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LevelCompletionResults* get_levelCompletionResults();

  /// @brief Method get_playerLevelEndReason, addr 0x32b7058, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason get_playerLevelEndReason();

  /// @brief Method get_playerLevelEndState, addr 0x32b7050, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLevelCompletionResults) == 0x20, "Size mismatch!");
