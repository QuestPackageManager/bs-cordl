...
public:
  ...
  /// @brief Method CompareTo, addr 0x22d7b68, size 0xe8, virtual true, abstract: false, final true
  inline int32_t CompareTo(::System::Object* obj);

  /// @brief Method CreateFromSerializedData, addr 0x22d7ac4, size 0xa4, virtual true, abstract: false, final true
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method HasAnyResult, addr 0x22d79f4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x22d7a58, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22d7a14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x22d7a1c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_failedOrGivenUp, addr 0x22d7a00, size 0x14, virtual false, abstract: false, final false
  inline bool get_failedOrGivenUp();

  /// @brief Method get_hasAnyResults, addr 0x22d79e4, size 0x10, virtual false, abstract: false, final false
  inline bool get_hasAnyResults();

  /// @brief Method get_levelCompletionResults, addr 0x22d79dc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::LevelCompletionResults* get_levelCompletionResults();

  /// @brief Method get_playerLevelEndReason, addr 0x22d79d4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason get_playerLevelEndReason();

  /// @brief Method get_playerLevelEndState, addr 0x22d79cc, size 0x8, virtual false, abstract: false, final false
