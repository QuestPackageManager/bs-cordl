...
// Dependencies MultiplayerLevelCompletionResults::MultiplayerPlayerLevelEndReason, MultiplayerLevelCompletionResults::MultiplayerPlayerLevelEndState, System.Object
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Field _playerLevelEndReason, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get__playerLevelEndReason, put=__cordl_internal_set__playerLevelEndReason)) ::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason  _playerLevelEndReason;

/// @brief Field _playerLevelEndState, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__playerLevelEndState, put=__cordl_internal_set__playerLevelEndState)) ::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndState  _playerLevelEndState;
...
/// @brief Method CompareTo, addr 0x31e2db8, size 0xf8, virtual true, abstract: false, final true
inline int32_t CompareTo(::System::Object*  obj) ;

/// @brief Method CreateFromSerializedData, addr 0x31e2d10, size 0xa8, virtual true, abstract: false, final true
inline ::GlobalNamespace::MultiplayerLevelCompletionResults* CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method HasAnyResult, addr 0x31e2c54, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Serialize, addr 0x31e2c84, size 0x8c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x31e2c74, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x31e2c78, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndState  playerLevelEndState, ::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason  playerLevelEndReason, ::GlobalNamespace::LevelCompletionResults*  levelCompletionResults) ;

/// @brief Method get_failedOrGivenUp, addr 0x31e2c60, size 0x14, virtual false, abstract: false, final false
inline bool get_failedOrGivenUp() ;

/// @brief Method get_hasAnyResults, addr 0x31e2c44, size 0x10, virtual false, abstract: false, final false
inline bool get_hasAnyResults() ;

/// @brief Method get_levelCompletionResults, addr 0x31e2c3c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::LevelCompletionResults* get_levelCompletionResults() ;

/// @brief Method get_playerLevelEndReason, addr 0x31e2c34, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerLevelCompletionResults_MultiplayerPlayerLevelEndReason get_playerLevelEndReason() ;

/// @brief Method get_playerLevelEndState, addr 0x31e2c2c, size 0x8, virtual false, abstract: false, final false
...
constexpr ::LiteNetLib::Utils::INetImmutableSerializable_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* i___LiteNetLib__Utils__INetImmutableSerializable_1___GlobalNamespace__MultiplayerLevelCompletionResults__() noexcept;
