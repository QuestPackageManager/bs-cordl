...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x58cd660, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x58cd714, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::by_ref<::GlobalNamespace::NoteSpawnData> noteSpawnData, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x58cd64c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58cd504, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BezierCurve, addr 0x58cd024, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x58cd0b0, size 0x418, virtual false, abstract: false, final false
