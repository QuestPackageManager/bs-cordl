...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x578ef94, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x578f048, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::ByRef<::GlobalNamespace::NoteSpawnData> noteSpawnData, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x578ef80, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x578ee38, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BezierCurve, addr 0x578e958, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x578e9e4, size 0x418, virtual false, abstract: false, final false
