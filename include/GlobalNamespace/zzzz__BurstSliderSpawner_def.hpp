...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3af0a4c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3af0b18, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::ByRef<::GlobalNamespace::NoteSpawnData> noteSpawnData, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3af0a34, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3af0930, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BezierCurve, addr 0x3af04b4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x3af052c, size 0x3cc, virtual false, abstract: false, final false
