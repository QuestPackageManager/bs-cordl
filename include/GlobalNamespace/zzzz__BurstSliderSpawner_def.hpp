...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3ae543c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3ae5508, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::ByRef<::GlobalNamespace::NoteSpawnData> noteSpawnData, ::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3ae5424, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ae5320, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method BezierCurve, addr 0x3ae4ea4, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x3ae4f1c, size 0x3cc, virtual false, abstract: false, final false
