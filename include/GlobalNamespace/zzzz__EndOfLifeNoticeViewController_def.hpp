...
#include <cmath>
#include <cstdint>
CORDL_MODULE_EXPORT(EndOfLifeNoticeViewController)
namespace GlobalNamespace {
class ICoroutineStarter;
}
namespace GlobalNamespace {
class __EndOfLifeNoticeViewController___EnableOkButton_d__10;
}
...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::EndOfLifeNoticeViewController);
MARK_REF_PTR_T(::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10);
// Type: ::<EnableOkButton>d__10
// SizeInfo { instance_size: 40, native_size: -1, calculated_instance_size: 40, calculated_native_size: 40, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: false
// CS Name: ::EndOfLifeNoticeViewController::<EnableOkButton>d__10*
class CORDL_TYPE __EndOfLifeNoticeViewController___EnableOkButton_d__10 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Method MoveNext, addr 0x26361fc, size 0xc0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x26362bc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x26362c4, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2636304, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x26361f8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26361ac, size 0x28, virtual false, abstract: false, final false
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __EndOfLifeNoticeViewController___EnableOkButton_d__10();

public:
  // Ctor Parameters [CppParam { name: "", ty: "__EndOfLifeNoticeViewController___EnableOkButton_d__10", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __EndOfLifeNoticeViewController___EnableOkButton_d__10(__EndOfLifeNoticeViewController___EnableOkButton_d__10&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__EndOfLifeNoticeViewController___EnableOkButton_d__10", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __EndOfLifeNoticeViewController___EnableOkButton_d__10(__EndOfLifeNoticeViewController___EnableOkButton_d__10 const&) = delete;
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10, 0x28>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10, _____4__this) == 0x20, "Offset mismatch!");

} // namespace GlobalNamespace
// Type: ::EndOfLifeNoticeViewController
// SizeInfo { instance_size: 168, native_size: -1, calculated_instance_size: 168, calculated_native_size: 168, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: false
// CS Name: ::EndOfLifeNoticeViewController*
class CORDL_TYPE EndOfLifeNoticeViewController : public ::HMUI::ViewController {
public:
  // Declarations
  using _EnableOkButton_d__10 = ::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10;

  /// @brief Field _coroutineStarter, offset 0x90, size 0x8
  ...
  /// @brief Field _enableOkButtonCoroutine, offset 0xa0, size 0x8
  ...
  /// @brief Field _endOfLifeNoticeLocalizationKey, offset 0x88, size 0x8
  ...
  /// @brief Field _endOfLifeNoticeTextMesh, offset 0x80, size 0x8
  ...
  /// @brief Method DidActivate, addr 0x2635fd0, size 0x174, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method EnableOkButton, addr 0x2636144, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* EnableOkButton();

  static inline ::GlobalNamespace::EndOfLifeNoticeViewController* New_ctor();

  /// @brief Method <DidActivate>b__9_0, addr 0x26361dc, size 0x1c, virtual false, abstract: false, final false
  ...
  constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Coroutine*> const& __cordl_internal_get__enableOkButtonCoroutine() const;
  ...
  /// @brief Method .ctor, addr 0x26361d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x2635e98, size 0x9c, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action* value);

  /// @brief Method remove_didFinishEvent, addr 0x2635f34, size 0x9c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _endOfLifeNoticeTextMesh, offset: 0x80, size: 0x8, def value: None
  ::UnityW<::TMPro::TextMeshProUGUI> ____endOfLifeNoticeTextMesh;

  /// @brief Field _endOfLifeNoticeLocalizationKey, offset: 0x88, size: 0x8, def value: None
  ::StringW ____endOfLifeNoticeLocalizationKey;

  /// @brief Field _coroutineStarter, offset: 0x90, size: 0x8, def value: None
  ...
  /// @brief Field _enableOkButtonCoroutine, offset: 0xa0, size: 0x8, def value: None
  ::UnityEngine::Coroutine* ____enableOkButtonCoroutine;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::EndOfLifeNoticeViewController, 0xa8>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::EndOfLifeNoticeViewController, ____okButton) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EndOfLifeNoticeViewController, ____duration) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EndOfLifeNoticeViewController, ____endOfLifeNoticeTextMesh) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EndOfLifeNoticeViewController, ____endOfLifeNoticeLocalizationKey) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EndOfLifeNoticeViewController, ____coroutineStarter) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EndOfLifeNoticeViewController, ___didFinishEvent) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EndOfLifeNoticeViewController, ____enableOkButtonCoroutine) == 0xa0, "Offset mismatch!");
...
NEED_NO_BOX(::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__EndOfLifeNoticeViewController___EnableOkButton_d__10*, "", "EndOfLifeNoticeViewController/<EnableOkButton>d__10");
