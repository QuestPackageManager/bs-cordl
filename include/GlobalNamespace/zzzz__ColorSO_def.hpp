...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ColorSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ColorSO(ColorSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ColorSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ColorSO(ColorSOconst&) = delete;
