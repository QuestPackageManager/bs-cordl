...
/// @brief Method .ctor, addr 0x3608174, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_appId, addr 0x3608164, size 0x8, virtual true, abstract: false, final true
inline uint64_t get_appId() ;

/// @brief Method get_graphAppId, addr 0x360816c, size 0x8, virtual true, abstract: false, final true
