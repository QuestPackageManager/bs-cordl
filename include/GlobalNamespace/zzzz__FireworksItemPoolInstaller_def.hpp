...
/// @brief Method InstallBindings, addr 0x5847f70, size 0x98, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5848008, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
