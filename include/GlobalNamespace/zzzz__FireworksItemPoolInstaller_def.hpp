...
public:
  ...
  /// @brief Method InstallBindings, addr 0x58466c4, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584675c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
