...
public:
  ...
  /// @brief Method InstallBindings, addr 0x248de20, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x248deb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
