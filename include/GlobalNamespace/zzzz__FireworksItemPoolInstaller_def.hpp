...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57d3e98, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d3f30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
