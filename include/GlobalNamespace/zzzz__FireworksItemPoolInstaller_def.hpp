...
// Write type traits
MARK_REF_T(::GlobalNamespace::FireworksItemPoolInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FireworksItemPoolInstaller*, "", "FireworksItemPoolInstaller");
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x59823a0, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5982438, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::FireworksItemPoolInstaller) == 0x38, "Size mismatch!");
