...
// Write type traits
MARK_REF_T(::GlobalNamespace::PoseObjectIdSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PoseObjectIdSO*, "", "PoseObjectIdSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58e9c58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x58e9c50, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PoseObjectIdSO) == 0x20, "Size mismatch!");
