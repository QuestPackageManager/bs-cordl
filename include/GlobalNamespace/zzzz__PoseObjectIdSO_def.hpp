...
public:
  ...
  /// @brief Method .ctor, addr 0x58e80b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x58e80b0, size 0x8, virtual false, abstract: false, final false
