...
public:
  ...
  /// @brief Method .ctor, addr 0x3b15f3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x3b15f34, size 0x8, virtual false, abstract: false, final false
