...
public:
  ...
  /// @brief Method .ctor, addr 0x23f83f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x23f83f0, size 0x8, virtual false, abstract: false, final false
