...
public:
  ...
  /// @brief Method .ctor, addr 0x5756a24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x5756a1c, size 0x8, virtual false, abstract: false, final false
