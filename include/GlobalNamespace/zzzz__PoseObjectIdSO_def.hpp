...
public:
  ...
  /// @brief Method .ctor, addr 0x57c7480, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x57c7478, size 0x8, virtual false, abstract: false, final false
