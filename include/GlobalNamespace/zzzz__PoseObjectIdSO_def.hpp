...
public:
  ...
  /// @brief Method get_id, addr 0x23296f4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_id();

  static inline ::GlobalNamespace::PoseObjectIdSO* New_ctor();

  /// @brief Method .ctor, addr 0x23296fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
