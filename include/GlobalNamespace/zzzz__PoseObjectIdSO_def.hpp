...
/// @brief Method .ctor, addr 0x57c8ce8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x57c8ce0, size 0x8, virtual false, abstract: false, final false
