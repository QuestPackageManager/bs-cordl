...
public:
  // Declarations
  /// @brief Method FromGuid addr 0x0 size 0xffffffffffffffff virtual false final false
  template <typename TResult> static inline ::GlobalNamespace::OVRTask_1<TResult> FromGuid(::System::Guid id);

  /// @brief Method FromRequest addr 0x0 size 0xffffffffffffffff virtual false final false
  ...
  /// @brief Method GetExisting addr 0x0 size 0xffffffffffffffff virtual false final false
  ...
  /// @brief Method GetId addr 0x27a1d70 size 0x30 virtual false final false
