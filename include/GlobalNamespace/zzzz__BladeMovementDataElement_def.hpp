...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BladeMovementDataElement, "", "BladeMovementDataElement");
...
static_assert(sizeof(::GlobalNamespace::BladeMovementDataElement) == 0x2c, "Size mismatch!");
