...
public:
  ...
  /// @brief Method get_logString, addr 0x231aa40, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_logString();

  /// @brief Method get_stackTrace, addr 0x231aa48, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_stackTrace();

  /// @brief Method StartCatchingExceptions, addr 0x231aa50, size 0x80, virtual false, abstract: false, final false
  inline void StartCatchingExceptions();

  /// @brief Method OnDisable, addr 0x231aad0, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method HandleLog, addr 0x231ab50, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x231abf0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
