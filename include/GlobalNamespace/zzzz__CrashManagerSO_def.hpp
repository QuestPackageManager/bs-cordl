...
public:
  ...
  /// @brief Method get_logString addr 0x21a73a8 size 0x8 virtual false final false
  inline ::StringW get_logString();

  /// @brief Method get_stackTrace addr 0x21a73b0 size 0x8 virtual false final false
  inline ::StringW get_stackTrace();

  /// @brief Method StartCatchingExceptions addr 0x21a73b8 size 0x80 virtual false final false
  inline void StartCatchingExceptions();

  /// @brief Method OnDisable addr 0x21a7438 size 0x80 virtual false final false
  inline void OnDisable();

  /// @brief Method HandleLog addr 0x21a74b8 size 0xa0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21a7558 size 0x8 virtual false final false
  inline void _ctor();
