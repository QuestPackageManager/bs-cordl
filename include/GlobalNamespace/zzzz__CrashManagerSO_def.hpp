...
public:
  ...
  /// @brief Method HandleLog, addr 0x3b08a6c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x3b089c8, size 0xa4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method StartCatchingExceptions, addr 0x3b08924, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b08b30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_logString, addr 0x3b08914, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_logString();

  /// @brief Method get_stackTrace, addr 0x3b0891c, size 0x8, virtual false, abstract: false, final false
