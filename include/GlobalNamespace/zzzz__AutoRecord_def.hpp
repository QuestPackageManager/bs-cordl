...
public:
  ...
  /// @brief Method AddNoteHandFrames, addr 0x57d68f4, size 0x490, virtual false, abstract: false, final false
  static inline void
  ...
  /// @brief Method AddSliderHandFrames, addr 0x57d6d84, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method CreatePlayerPoseFrames, addr 0x57d5fb8, size 0x8fc, virtual false, abstract: false, final false
  static inline ::BeatSaber::RecPlay::PlayerPoseFrames CreatePlayerPoseFrames(::ByRef<::GlobalNamespace::AutoRecord_Beatmap> beatmap);

  /// @brief Method LocateCutPosition, addr 0x57d68b4, size 0x40, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 LocateCutPosition(int32_t lineCount, int32_t line, ::GlobalNamespace::NoteLineLayer layer);

  /// @brief Method <CreatePlayerPoseFrames>g__FixFrames|1_0, addr 0x57d7314, size 0x78, virtual false, abstract: false, final false
