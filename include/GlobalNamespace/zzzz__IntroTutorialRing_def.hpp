...
public:
  ...
  /// @brief Method OnEnable, addr 0x5788be8, size 0x54, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnTriggerEnter, addr 0x5788e04, size 0x114, virtual false, abstract: false, final false
  inline void OnTriggerEnter(::UnityEngine::Collider* other);

  /// @brief Method OnTriggerExit, addr 0x5788f18, size 0x108, virtual false, abstract: false, final false
  inline void OnTriggerExit(::UnityEngine::Collider* other);

  /// @brief Method OnTriggerStay, addr 0x5789020, size 0x120, virtual false, abstract: false, final false
  inline void OnTriggerStay(::UnityEngine::Collider* other);

  /// @brief Method SetProgressImagesfillAmount, addr 0x5788da0, size 0x64, virtual false, abstract: false, final false
  inline void SetProgressImagesfillAmount(float_t fillAmount);

  /// @brief Method Start, addr 0x5788b68, size 0x80, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5788c3c, size 0x164, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5789140, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_fullyActivated, addr 0x5788b34, size 0x24, virtual false, abstract: false, final false
  inline bool get_fullyActivated();

  /// @brief Method get_saberType, addr 0x5788b58, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SaberType get_saberType();

  /// @brief Method set_alpha, addr 0x5788b1c, size 0x18, virtual false, abstract: false, final false
  inline void set_alpha(float_t value);

  /// @brief Method set_saberType, addr 0x5788b60, size 0x8, virtual false, abstract: false, final false
