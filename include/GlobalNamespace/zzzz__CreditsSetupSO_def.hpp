...
// Write type traits
MARK_REF_T(::GlobalNamespace::CreditsSetupSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CreditsSetupSO*, "", "CreditsSetupSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3280ce0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CreditsSetupSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CreditsSetupSO(CreditsSetupSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CreditsSetupSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CreditsSetupSO(CreditsSetupSOconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23230 };
...
static_assert(sizeof(::GlobalNamespace::CreditsSetupSO) == 0x50, "Size mismatch!");
