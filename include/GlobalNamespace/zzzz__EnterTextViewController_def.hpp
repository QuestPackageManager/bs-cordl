...
public:
  ...
  /// @brief Method DidActivate, addr 0x3c12508, size 0xe0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method Init, addr 0x3c124e4, size 0x24, virtual false, abstract: false, final false
  inline void Init(::StringW titleText);

  static inline ::GlobalNamespace::EnterTextViewController* New_ctor();

  /// @brief Method OkButtonPressed, addr 0x3c125e8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c12680, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3c12384, size 0xb0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_2<::UnityW<::GlobalNamespace::EnterTextViewController>, ::StringW>* value);

  /// @brief Method remove_didFinishEvent, addr 0x3c12434, size 0xb0, virtual false, abstract: false, final false
