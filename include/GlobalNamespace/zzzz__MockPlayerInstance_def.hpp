...
public:
  ...
  /// @brief Method MoveNext, addr 0x594af74, size 0x294, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x594b208, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x594b274, size 0x2d8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x594b54c, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x594b5b8, size 0x184, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x594b73c, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Dispose, addr 0x594ac64, size 0xb8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method DisposeAsync, addr 0x594abb4, size 0xb0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* DisposeAsync();

  /// @brief Method HandleConnectionFailedEvent, addr 0x594ab58, size 0x5c, virtual false, abstract: false, final false
  inline void HandleConnectionFailedEvent(::GlobalNamespace::ConnectionFailedReason reason);

  /// @brief Method HandleDisconnectedEvent, addr 0x594aafc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method RunAsync, addr 0x594a964, size 0xc4, virtual true, abstract: false, final true
  ...
  /// @brief Method Stop, addr 0x594aa58, size 0xa4, virtual true, abstract: false, final true
  inline void Stop();

  /// @brief Method Tick, addr 0x594a950, size 0x14, virtual false, abstract: false, final false
  inline void Tick();

  /// @brief Method WhenReady, addr 0x594aa28, size 0x18, virtual true, abstract: false, final true
  inline void WhenReady(::System::Action* action);

  /// @brief Method WhenReadyAsync, addr 0x594aa40, size 0x18, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task* WhenReadyAsync(::System::Func_1<::System::Threading::Tasks::Task*>* action);

  /// @brief Method <DisposeAsync>b__32_0, addr 0x594ad1c, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x594a520, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_connectionFailedReason, addr 0x594a510, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::GlobalNamespace::ConnectionFailedReason> get_connectionFailedReason();

  /// @brief Method get_disconnectedReason, addr 0x594a500, size 0x8, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::GlobalNamespace::DisconnectedReason> get_disconnectedReason();

  /// @brief Method get_id, addr 0x594a4e8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_id();

  /// @brief Method get_userId, addr 0x594a4f0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_userId();

  /// @brief Method get_userName, addr 0x594a4f8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_connectionFailedReason, addr 0x594a518, size 0x8, virtual false, abstract: false, final false
  inline void set_connectionFailedReason(::System::Nullable_1<::GlobalNamespace::ConnectionFailedReason> value);

  /// @brief Method set_disconnectedReason, addr 0x594a508, size 0x8, virtual false, abstract: false, final false
