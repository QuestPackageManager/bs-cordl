...
public:
  // Declarations
  // Ctor Parameters [CppParam { name: "", ty: "IConnectionInitParams_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IConnectionInitParams_1(IConnectionInitParams_1const&) = delete;
