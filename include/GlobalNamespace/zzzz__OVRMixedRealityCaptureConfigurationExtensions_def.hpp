...
public:
  // Declarations
  /// @brief Method ApplyTo, addr 0x403d13c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x403d140, size 0x1428, virtual false, abstract: false, final false
