...
public:
  // Declarations
  /// @brief Method ApplyTo, addr 0x5ced72c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadFrom, addr 0x5ced730, size 0x142c, virtual false, abstract: false, final false
