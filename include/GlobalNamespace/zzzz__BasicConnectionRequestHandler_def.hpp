...
public:
  ...
  /// @brief Method GetConnectionMessage, addr 0x22b60f4, size 0x70, virtual true, abstract: false, final true
  ...
  /// @brief Method ValidateConnectionMessage, addr 0x22b6164, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22b6220, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_secret, addr 0x22b60e4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_secret, addr 0x22b60ec, size 0x8, virtual false, abstract: false, final false
