...
public:
  ...
  /// @brief Method GetLightmapLights, addr 0x23f9778, size 0x10c, virtual false, abstract: false, final false
  inline void GetLightmapLights();

  /// @brief Method GetNormalizationMultiplier, addr 0x23f9884, size 0x48, virtual false, abstract: false, final false
  inline float_t GetNormalizationMultiplier();

  /// @brief Method LateUpdate, addr 0x23f9518, size 0x3c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::BakedLightsNormalizer* New_ctor();

  /// @brief Method UpdateGrayscaleTotal, addr 0x23f9554, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f98cc, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightmapLightDict, addr 0x23f9508, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_maxTotalIntensity, addr 0x23f9510, size 0x8, virtual false, abstract: false, final false
