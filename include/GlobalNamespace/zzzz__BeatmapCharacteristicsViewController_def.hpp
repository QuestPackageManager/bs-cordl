...
public:
  ...
  /// @brief Method add_didSelectBeatmapCharacteristicEvent addr 0x22b68c4 size 0xb0 virtual false final false
  inline void add_didSelectBeatmapCharacteristicEvent(::System::Action_1<::GlobalNamespace::BeatmapCharacteristicSO*>* value);

  /// @brief Method remove_didSelectBeatmapCharacteristicEvent addr 0x22b6974 size 0xb0 virtual false final false
  inline void remove_didSelectBeatmapCharacteristicEvent(::System::Action_1<::GlobalNamespace::BeatmapCharacteristicSO*>* value);

  /// @brief Method get_beatmapCharacteristicCollection addr 0x22b6a24 size 0x8 virtual false final false
  inline ::GlobalNamespace::BeatmapCharacteristicCollection* get_beatmapCharacteristicCollection();

  /// @brief Method get_selectedBeatmapCharacteristic addr 0x22b6a2c size 0xbc virtual false final false
  inline ::GlobalNamespace::BeatmapCharacteristicSO* get_selectedBeatmapCharacteristic();

  /// @brief Method DidActivate addr 0x22b6ae8 size 0xb4 virtual true final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate addr 0x22b6b9c size 0xa0 virtual true final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method SetData addr 0x22b6c3c size 0x64 virtual false final false
  ...
  /// @brief Method HandleBeatmapCharacteristicsTableViewDidSelecteCharacteristic addr 0x22b6ca0 size 0x1c0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x22b6e60 size 0x8 virtual false final false
  inline void _ctor();
