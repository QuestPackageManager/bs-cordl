...
/// @brief Field _beatmapCharacteristicsTableView, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapCharacteristicsTableView, put=__cordl_internal_set__beatmapCharacteristicsTableView)) ::UnityW<::GlobalNamespace::BeatmapCharacteristicsTableView>  _beatmapCharacteristicsTableView;
...
/// @brief Field didSelectBeatmapCharacteristicEvent, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectBeatmapCharacteristicEvent, put=__cordl_internal_set_didSelectBeatmapCharacteristicEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*  didSelectBeatmapCharacteristicEvent;
...
/// @brief Method DidActivate, addr 0x58784e0, size 0xc4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x58785a4, size 0xb0, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleBeatmapCharacteristicsTableViewDidSelecteCharacteristic, addr 0x58786b8, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method SetData, addr 0x5878654, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5878884, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectBeatmapCharacteristicEvent, addr 0x5878298, size 0xc0, virtual false, abstract: false, final false
inline void add_didSelectBeatmapCharacteristicEvent(::System::Action_1<::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>*  value) ;

/// @brief Method get_beatmapCharacteristicCollection, addr 0x5878418, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapCharacteristicCollection* get_beatmapCharacteristicCollection() ;

/// @brief Method get_selectedBeatmapCharacteristic, addr 0x5878420, size 0xc0, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_selectedBeatmapCharacteristic() ;

/// @brief Method remove_didSelectBeatmapCharacteristicEvent, addr 0x5878358, size 0xc0, virtual false, abstract: false, final false
