...
// Write type traits
MARK_REF_T(::GlobalNamespace::SelectModifiersViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectModifiersViewController*, "", "SelectModifiersViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5963a50, size 0xa4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::SelectModifiersViewController* New_ctor();

  /// @brief Method Setup, addr 0x5963a38, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5963af4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayModifiers, addr 0x5963a20, size 0x18, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SelectModifiersViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SelectModifiersViewController(SelectModifiersViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SelectModifiersViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SelectModifiersViewController(SelectModifiersViewControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SelectModifiersViewController) == 0x80, "Size mismatch!");
