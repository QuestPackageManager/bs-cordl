...
/// @brief Field _gameplayModifiersPanelController, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameplayModifiersPanelController, put=__cordl_internal_set__gameplayModifiersPanelController)) ::UnityW<::GlobalNamespace::GameplayModifiersPanelController>  _gameplayModifiersPanelController;

 __declspec(property(get=get_gameplayModifiers)) ::GlobalNamespace::GameplayModifiers*  gameplayModifiers;

/// @brief Method DidActivate, addr 0x57befe8, size 0xa4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

static inline ::GlobalNamespace::SelectModifiersViewController* New_ctor() ;

/// @brief Method Setup, addr 0x57befd0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57bf08c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameplayModifiers, addr 0x57befb8, size 0x18, virtual false, abstract: false, final false
