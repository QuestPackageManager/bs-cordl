...
public:
  ...
  /// @brief Method <GetSongPackMask>b__7_0, addr 0x14d8334, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _GetSongPackMask_b__7_0(::GlobalNamespace::PackDefinitionSO* pack);

  /// @brief Method .ctor, addr 0x14d832c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetSongPackMask, addr 0x14d7e04, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14d82c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_containsMultiplePacks, addr 0x14d7f9c, size 0x10, virtual false, abstract: false, final false
  inline bool get_containsMultiplePacks();

  /// @brief Method get_serializedName, addr 0x14d7de8, size 0x1c, virtual false, abstract: false, final false
