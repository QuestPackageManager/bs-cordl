...
public:
  ...
  /// @brief Method <GetSongPackMask>b__7_0, addr 0x14de358, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _GetSongPackMask_b__7_0(::GlobalNamespace::PackDefinitionSO* pack);

  /// @brief Method .ctor, addr 0x14de350, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetSongPackMask, addr 0x14dde28, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14de2e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_containsMultiplePacks, addr 0x14ddfc0, size 0x10, virtual false, abstract: false, final false
  inline bool get_containsMultiplePacks();

  /// @brief Method get_serializedName, addr 0x14dde0c, size 0x1c, virtual false, abstract: false, final false
