...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(14898))]
...
public:
  ...
  /// @brief Method get_executionOrder, addr 0x23c42cc, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_maxPossibleCutScore, addr 0x23c42e8, size 0x1c, virtual true, abstract: false, final true
  inline int32_t get_maxPossibleCutScore();

  /// @brief Method get_isFinished, addr 0x23c4304, size 0x8, virtual true, abstract: false, final true
  inline bool get_isFinished();

  /// @brief Method get_cutScore, addr 0x23c430c, size 0x30, virtual true, abstract: false, final true
  inline int32_t get_cutScore();

  /// @brief Method get_beforeCutScore, addr 0x23c433c, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_beforeCutScore();

  /// @brief Method get_centerDistanceCutScore, addr 0x23c4344, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_centerDistanceCutScore();

  /// @brief Method get_afterCutScore, addr 0x23c434c, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_afterCutScore();

  /// @brief Method get_noteScoreDefinition, addr 0x23c4354, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__ScoreModel__NoteScoreDefinition* get_noteScoreDefinition();

  /// @brief Method get_noteCutInfo, addr 0x23c435c, size 0x10, virtual true, abstract: false, final true
  inline ::GlobalNamespace::NoteCutInfo get_noteCutInfo();

  /// @brief Method get_beforeCutSwingRating, addr 0x23c436c, size 0x1c, virtual true, abstract: false, final true
  inline float_t get_beforeCutSwingRating();

  /// @brief Method get_afterCutSwingRating, addr 0x23c4388, size 0x1c, virtual true, abstract: false, final true
  inline float_t get_afterCutSwingRating();

  /// @brief Method RegisterDidChangeReceiver, addr 0x23c43a4, size 0x58, virtual true, abstract: false, final true
  inline void RegisterDidChangeReceiver(::GlobalNamespace::ICutScoreBufferDidChangeReceiver* receiver);

  /// @brief Method RegisterDidFinishReceiver, addr 0x23c43fc, size 0x58, virtual true, abstract: false, final true
  inline void RegisterDidFinishReceiver(::GlobalNamespace::ICutScoreBufferDidFinishReceiver* receiver);

  /// @brief Method UnregisterDidChangeReceiver, addr 0x23c4454, size 0x58, virtual true, abstract: false, final true
  inline void UnregisterDidChangeReceiver(::GlobalNamespace::ICutScoreBufferDidChangeReceiver* receiver);

  /// @brief Method UnregisterDidFinishReceiver, addr 0x23c44ac, size 0x58, virtual true, abstract: false, final true
  inline void UnregisterDidFinishReceiver(::GlobalNamespace::ICutScoreBufferDidFinishReceiver* receiver);

  /// @brief Method Init, addr 0x23c4504, size 0x264, virtual false, abstract: false, final false
  inline bool Init(ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method RefreshScores, addr 0x23c4768, size 0x208, virtual false, abstract: false, final false
  inline void RefreshScores();

  /// @brief Method HandleSaberSwingRatingCounterDidChange, addr 0x23c4970, size 0x1d4, virtual true, abstract: false, final true
  ...
  /// @brief Method HandleSaberSwingRatingCounterDidFinish, addr 0x23c4b44, size 0x2b8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x23c4dfc, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor();
