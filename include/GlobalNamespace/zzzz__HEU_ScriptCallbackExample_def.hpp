...
public:
  ...
  /// @brief Method AssetCallbackNoMsg, addr 0x230ed84, size 0x68, virtual false, abstract: false, final false
  inline void AssetCallbackNoMsg();

  /// @brief Method AssetCallbackWithMsg, addr 0x230ecec, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230edec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
