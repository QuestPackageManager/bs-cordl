...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameplayAdditionalInformationSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameplayAdditionalInformationSetupData(GameplayAdditionalInformationSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameplayAdditionalInformationSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameplayAdditionalInformationSetupData(GameplayAdditionalInformationSetupDataconst&) = delete;
