...
/// @brief Method EndEffect, addr 0x57ced88, size 0xa8, virtual true, abstract: false, final false
inline void EndEffect() ;

static inline ::GlobalNamespace::SliderParticleInteractionEffect* New_ctor() ;

/// @brief Method SetPSStartColor, addr 0x57ceba8, size 0xa8, virtual false, abstract: false, final false
inline void SetPSStartColor(::UnityEngine::Color  color) ;

/// @brief Method Start, addr 0x57ceb0c, size 0x9c, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method StartEffect, addr 0x57cecb8, size 0xd0, virtual true, abstract: false, final false
inline void StartEffect(float_t  saberInteractionParam) ;

/// @brief Method Update, addr 0x57cec50, size 0x68, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x57cee30, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
