...
public:
  ...
  /// @brief Method EndEffect, addr 0x3b89d8c, size 0x94, virtual true, abstract: false, final false
  inline void EndEffect();

  static inline ::GlobalNamespace::SliderParticleInteractionEffect* New_ctor();

  /// @brief Method SetPSStartColor, addr 0x3b89b94, size 0xd4, virtual false, abstract: false, final false
  inline void SetPSStartColor(::UnityEngine::Color color);

  /// @brief Method Start, addr 0x3b89afc, size 0x98, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x3b89cd4, size 0xb8, virtual true, abstract: false, final false
  inline void StartEffect(float_t saberInteractionParam);

  /// @brief Method Update, addr 0x3b89c68, size 0x6c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b89e20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
