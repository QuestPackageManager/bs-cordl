...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultipliedColorSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultipliedColorSO*, "", "MultipliedColorSO");
...
public:
  ...
  /// @brief Method .ctor, addr 0x36f885c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x36f880c, size 0x50, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MultipliedColorSO) == 0x30, "Size mismatch!");
