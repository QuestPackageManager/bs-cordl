...
public:
  ...
  /// @brief Method .ctor, addr 0x26a69c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x26a6970, size 0x50, virtual true, abstract: false, final false
