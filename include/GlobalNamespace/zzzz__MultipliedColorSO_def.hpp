...
public:
  ...
  /// @brief Method .ctor, addr 0x1497a0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x14979bc, size 0x50, virtual true, abstract: false, final false
