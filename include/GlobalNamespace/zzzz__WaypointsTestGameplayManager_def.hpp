...
public:
  ...
  /// @brief Method GetBar, addr 0x2265718, size 0x1a8, virtual false, abstract: false, final false
  inline ::StringW GetBar(float_t songTime);

  /// @brief Method LateUpdate, addr 0x2264b4c, size 0xbcc, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::WaypointsTestGameplayManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x22658c0, size 0x320, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDrawGizmos, addr 0x2265be0, size 0x1d8, virtual false, abstract: false, final false
  inline void OnDrawGizmos();

  /// @brief Method Start, addr 0x2264b18, size 0x34, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2265db8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
