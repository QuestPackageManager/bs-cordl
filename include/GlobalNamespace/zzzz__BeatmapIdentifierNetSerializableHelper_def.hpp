...
public:
  // Declarations
  /// @brief Method ToBeatmapKey, addr 0x13c41ec, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIdentifier, addr 0x13c426c, size 0xb8, virtual false, abstract: false, final false
