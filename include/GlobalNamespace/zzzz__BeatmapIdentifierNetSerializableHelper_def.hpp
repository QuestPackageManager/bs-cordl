...
public:
  // Declarations
  /// @brief Method ToBeatmapKey, addr 0x26c4a3c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIdentifier, addr 0x26c4ac8, size 0xbc, virtual false, abstract: false, final false
