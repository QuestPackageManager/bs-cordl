...
public:
  // Declarations
  /// @brief Method ToBeatmapKey, addr 0x26c3334, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIdentifier, addr 0x26c33c0, size 0xbc, virtual false, abstract: false, final false
