...
public:
  // Declarations
  /// @brief Method ToBeatmapKey, addr 0x26c8e1c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIdentifier, addr 0x26c8ea8, size 0xbc, virtual false, abstract: false, final false
