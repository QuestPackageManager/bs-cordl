...
public:
  // Declarations
  /// @brief Method ToBeatmapKey, addr 0x14b9934, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIdentifier, addr 0x14b99b4, size 0xb8, virtual false, abstract: false, final false
