...
public:
  // Declarations
  /// @brief Method ToBeatmapKey, addr 0x26c4d30, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method ToIdentifier, addr 0x26c4dbc, size 0xbc, virtual false, abstract: false, final false
