...
public:
  ...
  /// @brief Method Start, addr 0x3ba8258, size 0x174, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ba83cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
