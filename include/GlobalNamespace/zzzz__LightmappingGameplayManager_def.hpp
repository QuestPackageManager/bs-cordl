...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightmappingGameplayManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightmappingGameplayManager*, "", "LightmappingGameplayManager");
...
public:
  ...
  /// @brief Method Start, addr 0x59a3050, size 0x178, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59a31c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LightmappingGameplayManager) == 0x28, "Size mismatch!");
