...
public:
  ...
  /// @brief Method Start, addr 0x3bb1190, size 0x174, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bb1304, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
