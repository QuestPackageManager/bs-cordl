...
public:
  ...
  /// @brief Method Start, addr 0x3ba56f8, size 0x174, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ba586c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
