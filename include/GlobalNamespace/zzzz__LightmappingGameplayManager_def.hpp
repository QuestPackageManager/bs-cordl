...
public:
  ...
  /// @brief Method Start, addr 0x24b167c, size 0x188, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24b1804, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
