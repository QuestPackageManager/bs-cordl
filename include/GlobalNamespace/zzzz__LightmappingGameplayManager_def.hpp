...
public:
  ...
  /// @brief Method Start, addr 0x59a9648, size 0x178, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59a97c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
