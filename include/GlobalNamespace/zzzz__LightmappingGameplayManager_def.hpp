...
public:
  ...
  /// @brief Method Start, addr 0x3ba3bd8, size 0x174, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ba3d4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
