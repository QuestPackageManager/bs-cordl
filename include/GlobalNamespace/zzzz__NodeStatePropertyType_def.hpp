...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NodeStatePropertyType, "", "NodeStatePropertyType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::NodeStatePropertyType) == 0x4, "Size mismatch!");
