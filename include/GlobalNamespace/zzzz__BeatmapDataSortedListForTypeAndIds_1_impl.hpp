...
template <typename TBase> inline ::GlobalNamespace::ISortedList_1<TBase>* GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<TBase>::GetList(::System::Type* type, int32_t typeIdentifier) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<TBase>*>::get(), "GetList", std::span<Il2CppClass const* const, 0>(),
...
template <typename TBase> inline void GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<TBase>::RemoveList(::System::Type* type, int32_t typeIdentifier) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapDataSortedListForTypeAndIds_1<TBase>*>::get(), "RemoveList", std::span<Il2CppClass const* const, 0>(),
      ::std::array<Il2CppType const*, 2>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Type*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get() })));
