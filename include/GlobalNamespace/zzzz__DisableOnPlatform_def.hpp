...
public:
  ...
  /// @brief Method Awake, addr 0x24d0778, size 0x98, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x24d0810, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
