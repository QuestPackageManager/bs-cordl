...
public:
  ...
  /// @brief Method Awake, addr 0x24e92e0, size 0x98, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x24e9378, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
