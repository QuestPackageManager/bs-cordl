...
public:
  ...
  /// @brief Method Awake, addr 0x39be79c, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x39be86c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
