...
public:
  ...
  /// @brief Method Awake, addr 0x39cbb5c, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x39cbc2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
