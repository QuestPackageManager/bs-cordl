...
public:
  ...
  /// @brief Method Awake, addr 0x570a17c, size 0x108, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x570a284, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
