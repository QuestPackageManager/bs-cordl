...
public:
  ...
  /// @brief Method .ctor, addr 0x13f1684, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::StringW getStaticF_version();

  /// @brief Method get_Version, addr 0x13f1510, size 0x12c, virtual false, abstract: false, final false
