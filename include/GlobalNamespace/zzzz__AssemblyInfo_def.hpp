...
public:
  ...
  /// @brief Method .ctor, addr 0x25fda50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::StringW getStaticF_version();

  /// @brief Method get_Version, addr 0x25fd8dc, size 0x12c, virtual false, abstract: false, final false
