...
public:
  ...
  /// @brief Method .ctor, addr 0x26014c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::StringW getStaticF_version();

  /// @brief Method get_Version, addr 0x260134c, size 0x12c, virtual false, abstract: false, final false
