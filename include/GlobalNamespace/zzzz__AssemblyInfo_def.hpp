...
/// @brief Method .ctor, addr 0x355bc88, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::StringW getStaticF_version() ;

/// @brief Method get_Version, addr 0x355baec, size 0x150, virtual false, abstract: false, final false
