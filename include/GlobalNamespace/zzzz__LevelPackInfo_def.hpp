...
public:
  ...
  /// @brief Method .ctor, addr 0x321ee74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levels, addr 0x321ee54, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::LevelInfo*, ::Array<::GlobalNamespace::LevelInfo*>*> get_levels();

  /// @brief Method get_minimumProtocolVersion, addr 0x321ee64, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_minimumProtocolVersion();

  /// @brief Method get_packID, addr 0x321ee44, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_packID();

  /// @brief Method set_levels, addr 0x321ee5c, size 0x8, virtual false, abstract: false, final false
  inline void set_levels(::ArrayW<::GlobalNamespace::LevelInfo*, ::Array<::GlobalNamespace::LevelInfo*>*> value);

  /// @brief Method set_minimumProtocolVersion, addr 0x321ee6c, size 0x8, virtual false, abstract: false, final false
  inline void set_minimumProtocolVersion(uint32_t value);

  /// @brief Method set_packID, addr 0x321ee4c, size 0x8, virtual false, abstract: false, final false
