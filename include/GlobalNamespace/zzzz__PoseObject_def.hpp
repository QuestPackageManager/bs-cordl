...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoseObject", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoseObject(PoseObject&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoseObject", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoseObject(PoseObjectconst&) = delete;
