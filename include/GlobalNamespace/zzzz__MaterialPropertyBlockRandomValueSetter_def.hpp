...
public:
  ...
  /// @brief Method ApplyParams, addr 0x24f715c, size 0x208, virtual false, abstract: false, final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyBlockRandomValueSetter* New_ctor();

  /// @brief Method OnValidate, addr 0x24f7364, size 0x24, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyId, addr 0x24f7388, size 0x20, virtual false, abstract: false, final false
  inline void RefreshPropertyId();

  /// @brief Method Start, addr 0x24f7158, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24f73a8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
