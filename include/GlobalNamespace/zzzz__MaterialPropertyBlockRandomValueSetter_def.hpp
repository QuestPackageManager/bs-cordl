...
public:
  ...
  /// @brief Method Start addr 0x1fbf684 size 0x4 virtual false final false
  inline void Start();

  /// @brief Method OnValidate addr 0x1fbf890 size 0x24 virtual false final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyId addr 0x1fbf8b4 size 0x20 virtual false final false
  inline void RefreshPropertyId();

  /// @brief Method ApplyParams addr 0x1fbf688 size 0x208 virtual false final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyBlockRandomValueSetter* New_ctor();

  /// @brief Method .ctor addr 0x1fbf8d4 size 0x10 virtual false final false
  inline void _ctor();
