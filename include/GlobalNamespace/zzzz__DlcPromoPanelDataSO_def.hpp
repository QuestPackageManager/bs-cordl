...
MARK_REF_T(::GlobalNamespace::DlcPromoPanelDataSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DlcPromoPanelDataSO_DlcPromoPanelType, "", "DlcPromoPanelDataSO/DlcPromoPanelType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DlcPromoPanelDataSO*, "", "DlcPromoPanelDataSO");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::DlcPromoPanelDataSO_DlcPromoPanelType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method SetMusicPackPromo, addr 0x374e964, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x374e974, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customDlcPromoBanner, addr 0x374e944, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::PromoBannerInfoSO> get_customDlcPromoBanner();

  /// @brief Method get_cutOffTest, addr 0x374e92c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cutOffTest();

  /// @brief Method get_dlcPromoPanelType, addr 0x374e93c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::DlcPromoPanelDataSO_DlcPromoPanelType get_dlcPromoPanelType();

  /// @brief Method get_minNumberOfNotOwnedPacks, addr 0x374e934, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_minNumberOfNotOwnedPacks();

  /// @brief Method get_priority, addr 0x374e95c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_priority();

  /// @brief Method get_promoId, addr 0x374e94c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_promoId();

  /// @brief Method get_target, addr 0x374e954, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DlcPromoPanelDataSO) == 0x40, "Size mismatch!");
