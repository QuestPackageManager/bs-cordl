...
public:
  ...
  /// @brief Method .ctor, addr 0x26f5650, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customDlcPromoBanner, addr 0x26f5638, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::PromoBannerInfoSO> get_customDlcPromoBanner();

  /// @brief Method get_cutOffTest, addr 0x26f5620, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cutOffTest();

  /// @brief Method get_defaultPromoInfoId, addr 0x26f5640, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_defaultPromoInfoId();

  /// @brief Method get_dlcPromoPanelType, addr 0x26f5630, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::DlcPromoPanelDataSO_DlcPromoPanelType get_dlcPromoPanelType();

  /// @brief Method get_minNumberOfNotOwnedPacks, addr 0x26f5628, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_minNumberOfNotOwnedPacks();

  /// @brief Method set_defaultPromoInfoId, addr 0x26f5648, size 0x8, virtual false, abstract: false, final false
