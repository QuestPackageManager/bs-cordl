...
public:
  ...
  /// @brief Method SetMusicPackPromo, addr 0x368da5c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368da6c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_customDlcPromoBanner, addr 0x368da3c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::PromoBannerInfoSO> get_customDlcPromoBanner();

  /// @brief Method get_cutOffTest, addr 0x368da24, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_cutOffTest();

  /// @brief Method get_dlcPromoPanelType, addr 0x368da34, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::DlcPromoPanelDataSO_DlcPromoPanelType get_dlcPromoPanelType();

  /// @brief Method get_minNumberOfNotOwnedPacks, addr 0x368da2c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_minNumberOfNotOwnedPacks();

  /// @brief Method get_priority, addr 0x368da54, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_priority();

  /// @brief Method get_promoId, addr 0x368da44, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_promoId();

  /// @brief Method get_target, addr 0x368da4c, size 0x8, virtual false, abstract: false, final false
