...
public:
  ...
  /// @brief Method Awake, addr 0x25bfc0c, size 0x12c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetTrailWidth, addr 0x25bffdc, size 0x84, virtual false, abstract: false, final false
  inline float_t GetTrailWidth(::GlobalNamespace::BladeMovementDataElement lastAddedData);

  /// @brief Method Init, addr 0x25bfd58, size 0x284, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method LateUpdate, addr 0x25c01dc, size 0x3f4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberTrail* New_ctor();

  /// @brief Method OnDestroy, addr 0x25c0834, size 0xa8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x25c07b0, size 0x84, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrawGizmosSelected, addr 0x25c08dc, size 0x1d4, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  /// @brief Method OnEnable, addr 0x25c0704, size 0xac, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResetTrailData, addr 0x25c0060, size 0x17c, virtual false, abstract: false, final false
  inline void ResetTrailData();

  /// @brief Method Setup, addr 0x25bfd38, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c0ab0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
