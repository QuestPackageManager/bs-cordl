...
// Write type traits
MARK_REF_T(::GlobalNamespace::SaberTrail*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SaberTrail*, "", "SaberTrail");
...
static_assert(sizeof(::GlobalNamespace::SaberTrail) == 0xb0, "Size mismatch!");
