...
public:
  // Declarations
  /// @brief Method Init, addr 0x3b2e2c4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b2e37c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
