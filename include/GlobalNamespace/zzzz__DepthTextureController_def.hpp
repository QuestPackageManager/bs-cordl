...
public:
  // Declarations
  /// @brief Method Init, addr 0x3b3c6c0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3c778, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
