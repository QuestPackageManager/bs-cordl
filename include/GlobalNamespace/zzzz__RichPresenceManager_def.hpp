...
public:
  ...
  /// @brief Method Awake, addr 0x2593058, size 0x2a8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Clear, addr 0x2593b80, size 0xa8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method HandleGameScenesManagerTransitionDidFinish, addr 0x2593858, size 0x328, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLobbyGameStateModelDidChange, addr 0x2593564, size 0x1c, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateModelDidChange(::GlobalNamespace::MultiplayerGameState newGameState);

  /// @brief Method HandleLobbyPlayerPermissionChanged, addr 0x2593df8, size 0x154, virtual false, abstract: false, final false
  inline void HandleLobbyPlayerPermissionChanged();

  /// @brief Method HandleMultiplayerPartySizeChanged, addr 0x2593c28, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2593300, size 0x264, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetMenuPresence, addr 0x2593580, size 0x22c, virtual false, abstract: false, final false
  inline void SetMenuPresence();

  /// @brief Method SetPresence, addr 0x25937ac, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2593f4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
