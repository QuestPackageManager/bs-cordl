...
public:
  ...
  /// @brief Method Awake, addr 0x576bb7c, size 0x310, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Clear, addr 0x576c820, size 0xac, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method HandleGameScenesManagerTransitionDidFinish, addr 0x576c4e0, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLobbyGameStateModelDidChange, addr 0x576c1dc, size 0x1c, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateModelDidChange(::GlobalNamespace::MultiplayerGameState newGameState);

  /// @brief Method HandleLobbyPlayerPermissionChanged, addr 0x576caa8, size 0x15c, virtual false, abstract: false, final false
  inline void HandleLobbyPlayerPermissionChanged();

  /// @brief Method HandleMultiplayerPartySizeChanged, addr 0x576c8cc, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x576be8c, size 0x350, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetMenuPresence, addr 0x576c1f8, size 0x230, virtual false, abstract: false, final false
  inline void SetMenuPresence();

  /// @brief Method SetPresence, addr 0x576c428, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x576cc04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
