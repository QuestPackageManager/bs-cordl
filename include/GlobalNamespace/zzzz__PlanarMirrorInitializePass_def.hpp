...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlanarMirrorInitializePass", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlanarMirrorInitializePass(PlanarMirrorInitializePass&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlanarMirrorInitializePass", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlanarMirrorInitializePass(PlanarMirrorInitializePassconst&) = delete;
