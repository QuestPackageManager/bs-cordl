...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MainMenuMissionInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MainMenuMissionInstaller(MainMenuMissionInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MainMenuMissionInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MainMenuMissionInstaller(MainMenuMissionInstallerconst&) = delete;
