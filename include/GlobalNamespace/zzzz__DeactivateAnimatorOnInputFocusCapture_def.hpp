...
public:
  ...
  /// @brief Method HandleInputFocusCaptured, addr 0x24fef70, size 0x40, virtual false, abstract: false, final false
  inline void HandleInputFocusCaptured();

  /// @brief Method HandleInputFocusReleased, addr 0x24ff154, size 0x24, virtual false, abstract: false, final false
  inline void HandleInputFocusReleased();

  static inline ::GlobalNamespace::DeactivateAnimatorOnInputFocusCapture* New_ctor();

  /// @brief Method OnDestroy, addr 0x24fefb0, size 0x1a4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x24fed60, size 0x210, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24ff178, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
