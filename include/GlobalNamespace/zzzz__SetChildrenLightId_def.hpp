...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SetChildrenLightId", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SetChildrenLightId(SetChildrenLightId&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SetChildrenLightId", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SetChildrenLightId(SetChildrenLightIdconst&) = delete;
