...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId::*)()>(&::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId::get_intensity)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x56b96f8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>::get(),
                        "get_intensity",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId::*)(float_t)>(&::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId::set_intensity)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x56b9700;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId::*)(int32_t, float_t)>(&::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x56b9708;
...
inline ::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId* GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId::New_ctor(int32_t  lightId, float_t  lightIntensity)  {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GlobalShaderColorLightWithIds::*)()>(&::GlobalNamespace::GlobalShaderColorLightWithIds::ProcessNewColorData)> {
  constexpr static std::size_t size = 0x12c;
  constexpr static std::size_t addrs = 0x56b9548;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::LightWithIds_LightWithId*>* (::GlobalNamespace::GlobalShaderColorLightWithIds::*)()>(&::GlobalNamespace::GlobalShaderColorLightWithIds::GetLightWithIds)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x56b9674;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GlobalShaderColorLightWithIds::*)()>(&::GlobalNamespace::GlobalShaderColorLightWithIds::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x56b967c;
...
constexpr ::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>*>& GlobalNamespace::GlobalShaderColorLightWithIds::__cordl_internal_get__lightIntensityData()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightIntensityData;
}
constexpr ::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>*> const& GlobalNamespace::GlobalShaderColorLightWithIds::__cordl_internal_get__lightIntensityData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightIntensityData;
}
constexpr void GlobalNamespace::GlobalShaderColorLightWithIds::__cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::GlobalShaderColorLightWithIds_LightIntensitiesWithId*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
::cordl_internals::setStaticField<int32_t, "_globalLightTintColorPropertyId", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::GlobalShaderColorLightWithIds*>::get>(std::forward<int32_t>(value));
}
inline int32_t GlobalNamespace::GlobalShaderColorLightWithIds::getStaticF__globalLightTintColorPropertyId()  {
return ::cordl_internals::getStaticField<int32_t, "_globalLightTintColorPropertyId", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::GlobalShaderColorLightWithIds*>::get>();
}
