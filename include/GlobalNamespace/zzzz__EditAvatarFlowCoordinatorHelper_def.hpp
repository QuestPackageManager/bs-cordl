...
/// @brief Method MoveNext, addr 0x58d4820, size 0x4a4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58d4cc4, size 0x8, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::EditAvatarFlowCoordinatorHelper*", modifiers: "", def_value: None }, CppParam { name: "_avatarSystem_5__2", ty: "::BeatSaber::AvatarCore::IAvatarSystem*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>>", modifiers: "", def_value: None }]
constexpr EditAvatarFlowCoordinatorHelper__Initialize_d__13(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::EditAvatarFlowCoordinatorHelper*  __4__this, ::BeatSaber::AvatarCore::IAvatarSystem*  _avatarSystem_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>>  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x58d4ccc, size 0x2b8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58d5074, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::EditAvatarFlowCoordinatorHelper*", modifiers: "", def_value: None }, CppParam { name: "parentFlowCoordinator", ty: "::UnityW<::HMUI::FlowCoordinator>", modifiers: "", def_value: None }, CppParam { name: "immediately", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "replaceTopViewController", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "backButtonVisible", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<bool>", modifiers: "", def_value: None }]
constexpr EditAvatarFlowCoordinatorHelper__Show_d__12(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::EditAvatarFlowCoordinatorHelper*  __4__this, ::UnityW<::HMUI::FlowCoordinator>  parentFlowCoordinator, bool  immediately, bool  replaceTopViewController, bool  backButtonVisible, ::System::Runtime::CompilerServices::TaskAwaiter_1<bool>  __u__1) noexcept;
...
/// @brief Field _avatarSystemSelectionFlowCoordinator, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__avatarSystemSelectionFlowCoordinator, put=__cordl_internal_set__avatarSystemSelectionFlowCoordinator)) ::UnityW<::GlobalNamespace::AvatarSystemSelectionFlowCoordinator>  _avatarSystemSelectionFlowCoordinator;
...
/// @brief Field _singleAvatarEditorFlowCoordinator, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__singleAvatarEditorFlowCoordinator, put=__cordl_internal_set__singleAvatarEditorFlowCoordinator)) ::UnityW<::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator>  _singleAvatarEditorFlowCoordinator;

/// @brief Field didFinishEvent, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_2<::UnityW<::HMUI::FlowCoordinator>,::GlobalNamespace::EditAvatarFlowCoordinatorHelper_FinishAction>*  didFinishEvent;

/// @brief Method HandleAvatarEditorFlowCoordinatorDidFinish, addr 0x58d4724, size 0xd0, virtual false, abstract: false, final false
inline void HandleAvatarEditorFlowCoordinatorDidFinish(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator*  flowCoordinator, ::BeatSaber::AvatarCore::IAvatarSystemMetadata*  avatarSystem, ::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_FinishAction  finishAction) ;

/// @brief Method HandleAvatarSystemSelectionFlowCoordinatorDidFinish, addr 0x58d47f4, size 0x28, virtual false, abstract: false, final false
inline void HandleAvatarSystemSelectionFlowCoordinatorDidFinish(::GlobalNamespace::AvatarSystemSelectionFlowCoordinator*  flowCoordinator, ::GlobalNamespace::AvatarSystemSelectionFlowCoordinator_FinishAction  finishAction) ;

/// @brief Method Initialize, addr 0x58d4594, size 0xa0, virtual false, abstract: false, final false
inline void Initialize() ;

static inline ::GlobalNamespace::EditAvatarFlowCoordinatorHelper* New_ctor() ;

/// @brief Method PresentAvatarEditorFlowCoordinator, addr 0x58d4634, size 0xf0, virtual false, abstract: false, final false
inline void PresentAvatarEditorFlowCoordinator(::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator*  flowCoordinator, ::BeatSaber::AvatarCore::AvatarEditorFlowCoordinator_EditMode  editMode, ::HMUI::FlowCoordinator*  parentFlowCoordinator, bool  immediately, bool  replaceTopViewController) ;

/// @brief Method Show, addr 0x58d44b8, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58d481c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x58d42d4, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get__hasOnlyOneAvatarSystem, addr 0x58d4454, size 0x64, virtual false, abstract: false, final false
inline bool get__hasOnlyOneAvatarSystem() ;

/// @brief Method remove_didFinishEvent, addr 0x58d4394, size 0xc0, virtual false, abstract: false, final false
