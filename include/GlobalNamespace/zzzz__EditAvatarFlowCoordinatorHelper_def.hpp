...
public:
  ...
  /// @brief Method MoveNext addr 0x22882d8 size 0x2b0 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x228868c size 0xc virtual true final true
...
public:
  ...
  /// @brief Method MoveNext addr 0x2288698 size 0x494 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x2288b2c size 0xc virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method add_didFinishEvent addr 0x2287dc0 size 0xb0 virtual false final false
  ...
  /// @brief Method remove_didFinishEvent addr 0x2287e70 size 0xb0 virtual false final false
  ...
  /// @brief Method get__hasOnlyOneAvatarSystem addr 0x2287f20 size 0x60 virtual false final false
  inline bool get__hasOnlyOneAvatarSystem();

  /// @brief Method Show addr 0x2287f80 size 0xc0 virtual false final false
  ...
  /// @brief Method Initialize addr 0x2288040 size 0x90 virtual false final false
  inline void Initialize();

  /// @brief Method PresentAvatarEditorFlowCoordinator addr 0x22880d0 size 0xec virtual false final false
  ...
  /// @brief Method HandleAvatarEditorFlowCoordinatorDidFinish addr 0x22881bc size 0xcc virtual false final false
  ...
  /// @brief Method HandleAvatarSystemSelectionFlowCoordinatorDidFinish addr 0x2288288 size 0x48 virtual false final false
  ...
  /// @brief Method .ctor addr 0x22882d0 size 0x8 virtual false final false
  inline void _ctor();
