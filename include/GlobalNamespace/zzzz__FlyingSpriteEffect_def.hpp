...
class CORDL_TYPE FlyingSpriteEffect_Pool : public ::Zenject::MonoMemoryPool_1<::GlobalNamespace::FlyingSpriteEffect*> {
public:
  // Declarations
  static inline ::GlobalNamespace::FlyingSpriteEffect_Pool* New_ctor();

  /// @brief Method .ctor, addr 0x3b7ee70, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InitAndPresent, addr 0x3b7ed2c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method ManualUpdate, addr 0x3b7ede4, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7ee40, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
