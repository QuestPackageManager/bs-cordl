...
// Write type traits
MARK_REF_T(::GlobalNamespace::FlyingSpriteEffect*);
MARK_REF_T(::GlobalNamespace::FlyingSpriteEffect_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlyingSpriteEffect*, "", "FlyingSpriteEffect");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlyingSpriteEffect_Pool*, "", "FlyingSpriteEffect/Pool");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FlyingSpriteEffect_Pool", modifiers: "&&", def_value: None, comment: None }]
...
static_assert(sizeof(::GlobalNamespace::FlyingSpriteEffect_Pool) == 0x40, "Size mismatch!");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FlyingSpriteEffect", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
...
static_assert(sizeof(::GlobalNamespace::FlyingSpriteEffect) == 0xa8, "Size mismatch!");
