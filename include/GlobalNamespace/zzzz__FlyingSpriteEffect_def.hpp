...
public:
  ...
  /// @brief Method .ctor, addr 0x26b8f60, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InitAndPresent, addr 0x26b8e1c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method ManualUpdate, addr 0x26b8ed4, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b8f30, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
