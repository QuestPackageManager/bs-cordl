...
/// @brief Field _multiplayerPositionHUDController, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerPositionHUDController, put=__cordl_internal_set__multiplayerPositionHUDController)) ::UnityW<::GlobalNamespace::MultiplayerPositionHUDController>  _multiplayerPositionHUDController;

/// @brief Method AnimateNewLeaderSelected, addr 0x581bbbc, size 0xd0, virtual true, abstract: false, final false
inline void AnimateNewLeaderSelected(bool  isLeading) ;

/// @brief Method HandlePlayerDidFinish, addr 0x581bc8c, size 0x24, virtual false, abstract: false, final false
inline void HandlePlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults*  levelCompletionResults) ;

/// @brief Method HandleStateChanged, addr 0x581b95c, size 0x1b8, virtual true, abstract: false, final false
inline void HandleStateChanged(::GlobalNamespace::MultiplayerController_State  state) ;

/// @brief Method InitializeIfNeeded, addr 0x581b818, size 0x144, virtual false, abstract: false, final false
inline void InitializeIfNeeded() ;

static inline ::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator* New_ctor() ;

/// @brief Method OnDestroy, addr 0x581b70c, size 0x10c, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method TransitionIntoFailedState, addr 0x581bb14, size 0xa8, virtual false, abstract: false, final false
inline void TransitionIntoFailedState() ;

/// @brief Method <InitializeIfNeeded>b__6_0, addr 0x581bcc0, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x581bcb0, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
