...
public:
  ...
  /// @brief Method AnimateNewLeaderSelected, addr 0x25f5b50, size 0xe4, virtual true, abstract: false, final false
  inline void AnimateNewLeaderSelected(bool isLeading);

  /// @brief Method HandlePlayerDidFinish, addr 0x25f5c34, size 0x34, virtual false, abstract: false, final false
  inline void HandlePlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* levelCompletionResults);

  /// @brief Method HandleStateChanged, addr 0x25f58f8, size 0x1a8, virtual true, abstract: false, final false
  inline void HandleStateChanged(::GlobalNamespace::__MultiplayerController__State state);

  /// @brief Method InitializeIfNeeded, addr 0x25f5828, size 0xd0, virtual false, abstract: false, final false
  inline void InitializeIfNeeded();

  static inline ::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator* New_ctor();

  /// @brief Method OnDestroy, addr 0x25f5714, size 0x114, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method TransitionIntoFailedState, addr 0x25f5aa0, size 0xb0, virtual false, abstract: false, final false
  inline void TransitionIntoFailedState();

  /// @brief Method <InitializeIfNeeded>b__6_0, addr 0x25f5c70, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f5c68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
