...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator*, "", "MultiplayerLocalActivePlayerGameplayAnimator");
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator) == 0x98, "Size mismatch!");
