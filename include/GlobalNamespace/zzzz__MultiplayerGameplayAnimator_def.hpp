...
/// @brief Method HandleNewLeaderWasSelected, addr 0x582d388, size 0xf4, virtual false, abstract: false, final false
inline void HandleNewLeaderWasSelected(::StringW  userId) ;

/// @brief Method HandleStateChanged, addr 0x582d178, size 0x150, virtual true, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x582cee8, size 0x1d0, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x582ce18, size 0xd0, virtual true, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x582d47c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
