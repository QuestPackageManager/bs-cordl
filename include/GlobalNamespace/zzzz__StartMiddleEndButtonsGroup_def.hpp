...
public:
  ...
  /// @brief Method SetLayoutHorizontal, addr 0x58cd194, size 0x104, virtual true, abstract: false, final true
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x58cd298, size 0x4, virtual true, abstract: false, final true
  inline void SetLayoutVertical();

  /// @brief Method .ctor, addr 0x58cd29c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
