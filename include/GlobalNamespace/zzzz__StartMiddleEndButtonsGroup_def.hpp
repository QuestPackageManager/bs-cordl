...
// Dependencies UnityEngine.MonoBehaviour, UnityEngine.UI.ILayoutController
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method SetLayoutHorizontal, addr 0x3bfbfb0, size 0xe8, virtual true, abstract: false, final true
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x3bfc098, size 0x4, virtual true, abstract: false, final true
  inline void SetLayoutVertical();

  /// @brief Method .ctor, addr 0x3bfc09c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
