...
public:
  ...
  /// @brief Method SetLayoutHorizontal, addr 0x23d7fe0, size 0xe8, virtual true, abstract: false, final true
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x23d80c8, size 0x4, virtual true, abstract: false, final true
  inline void SetLayoutVertical();

  static inline ::GlobalNamespace::StartMiddleEndButtonsGroup* New_ctor();

  /// @brief Method .ctor, addr 0x23d80cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
