...
/// @brief Method InstallBindings, addr 0x57792a4, size 0x10f4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x577a46c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_colorScheme, addr 0x5779294, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ColorSchemeSO> get_colorScheme() ;

/// @brief Method set_colorScheme, addr 0x577929c, size 0x8, virtual false, abstract: false, final false
