...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IConstructorStringGenerator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IConstructorStringGenerator(IConstructorStringGeneratorconst&) = delete;
