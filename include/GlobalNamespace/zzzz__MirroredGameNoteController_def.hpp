...
public:
  ...
  /// @brief Method .ctor, addr 0x3ae8980, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Mirror, addr 0x3ae8780, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method get_noteMovement, addr 0x3ae8630, size 0xac, virtual true, abstract: false, final true
