...
public:
  ...
  /// @brief Method .ctor, addr 0x57967d4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Mirror, addr 0x57965c4, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5796718, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x57962ec, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_noteMovement, addr 0x579646c, size 0xb0, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x579651c, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x57963ac, size 0xc0, virtual true, abstract: false, final true
