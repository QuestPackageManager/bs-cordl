...
public:
  ...
  /// @brief Method .ctor, addr 0x3a8eff0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Mirror, addr 0x3a8edf0, size 0x150, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a8ef40, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x3a8eb40, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_noteMovement, addr 0x3a8eca0, size 0xac, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x3a8ed4c, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x3a8ebf0, size 0xb0, virtual true, abstract: false, final true
