...
// Ctor Parameters [CppParam { name: "threshold", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "gameObject", ty: "::UnityW<::UnityEngine::GameObject>", modifiers: "", def_value: None }]
...
/// @brief Field gameObjects, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_gameObjects, put=__cordl_internal_set_gameObjects)) ::ArrayW<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation,::Array<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation>*>  gameObjects;

static inline ::GlobalNamespace::SwitchGameObjectArrayEffectTarget* New_ctor() ;

/// @brief Method SetFloat, addr 0x57e3f84, size 0xb0, virtual false, abstract: false, final false
inline void SetFloat(float_t  value) ;

/// @brief Method SetValue, addr 0x57e3f80, size 0x4, virtual true, abstract: false, final false
inline void SetValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

/// @brief Method TriggerValue, addr 0x57e4034, size 0x4, virtual true, abstract: false, final false
inline void TriggerValue(int32_t  groupId, int32_t  elementId, float_t  value) ;

constexpr ::ArrayW<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation,::Array<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation>*> const& __cordl_internal_get_gameObjects() const;

constexpr ::ArrayW<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation,::Array<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation>*>& __cordl_internal_get_gameObjects() ;

constexpr void __cordl_internal_set_gameObjects(::ArrayW<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation,::Array<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation>*>  value) ;

/// @brief Method .ctor, addr 0x57e4038, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
