...
// Write type traits
MARK_REF_T(::GlobalNamespace::SwitchGameObjectArrayEffectTarget*);
MARK_VAL_T(::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SwitchGameObjectArrayEffectTarget*, "", "SwitchGameObjectArrayEffectTarget");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation, "", "SwitchGameObjectArrayEffectTarget/GameObjectActivation");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies FloatFxGroupEffectTarget, SwitchGameObjectArrayEffectTarget::GameObjectActivation
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_gameObjects, put = __cordl_internal_set_gameObjects)) ::ArrayW<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation> gameObjects;
  ...
  constexpr ::ArrayW<::GlobalNamespace::SwitchGameObjectArrayEffectTarget_GameObjectActivation>& __cordl_internal_get_gameObjects();
...
static_assert(sizeof(::GlobalNamespace::SwitchGameObjectArrayEffectTarget) == 0x28, "Size mismatch!");
