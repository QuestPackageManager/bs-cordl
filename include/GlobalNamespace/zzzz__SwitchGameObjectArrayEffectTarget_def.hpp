...
public:
  ...
  /// @brief Method SetFloat, addr 0x5855e7c, size 0xb0, virtual false, abstract: false, final false
  inline void SetFloat(float_t value);

  /// @brief Method SetValue, addr 0x5855e78, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x5855f2c, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5855f30, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
