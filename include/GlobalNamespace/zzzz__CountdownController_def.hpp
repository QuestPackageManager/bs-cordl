...
public:
  ...
  /// @brief Method Awake, addr 0x5a0fa78, size 0x18, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::CountdownController* New_ctor();

  /// @brief Method StartCountdown, addr 0x5a0fcd8, size 0xf0, virtual false, abstract: false, final false
  inline void StartCountdown(int64_t countdownEndTime);

  /// @brief Method StopCountdown, addr 0x5a0fe50, size 0x74, virtual false, abstract: false, final false
  inline void StopCountdown();

  /// @brief Method Update, addr 0x5a0fa90, size 0x1e8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCountdown, addr 0x5a0fdec, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0fec4, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
