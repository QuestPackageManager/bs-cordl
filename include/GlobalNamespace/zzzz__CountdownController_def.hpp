...
public:
  ...
  /// @brief Method Awake, addr 0x58dcf74, size 0x18, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::CountdownController* New_ctor();

  /// @brief Method StartCountdown, addr 0x58dd1d4, size 0xf0, virtual false, abstract: false, final false
  inline void StartCountdown(int64_t countdownEndTime);

  /// @brief Method StopCountdown, addr 0x58dd34c, size 0x74, virtual false, abstract: false, final false
  inline void StopCountdown();

  /// @brief Method Update, addr 0x58dcf8c, size 0x1e8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCountdown, addr 0x58dd2e8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58dd3c0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();
