...
/// @brief Field _tubeLights, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__tubeLights, put=__cordl_internal_set__tubeLights)) ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>,::Array<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>>*>  _tubeLights;
...
/// @brief Method OnPlayableDestroy, addr 0x5777428, size 0xd8, virtual true, abstract: false, final false
inline void OnPlayableDestroy(::UnityEngine::Playables::Playable  playable) ;

/// @brief Method ProcessFrame, addr 0x5777028, size 0x400, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5777500, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
