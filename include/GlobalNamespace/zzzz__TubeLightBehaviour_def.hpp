...
MARK_REF_T(::GlobalNamespace::TubeLightBehaviour*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TubeLightBehaviour_ParameterType, "", "TubeLightBehaviour/ParameterType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TubeLightBehaviour*, "", "TubeLightBehaviour");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::TubeLightBehaviour_ParameterType) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies DirectionalLight, TubeBloomPrePassLight, UnityEngine.Color, UnityEngine.Playables.PlayableBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method OnPlayableDestroy, addr 0x590ae6c, size 0xd8, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x590aa6c, size 0x400, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x590af44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::TubeLightBehaviour) == 0x68, "Size mismatch!");
