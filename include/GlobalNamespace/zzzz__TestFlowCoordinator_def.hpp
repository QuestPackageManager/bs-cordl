...
public:
  ...
  /// @brief Method DidActivate, addr 0x58127d0, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58127f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
