...
public:
  ...
  /// @brief Method DidActivate, addr 0x5937c24, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5937c48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
