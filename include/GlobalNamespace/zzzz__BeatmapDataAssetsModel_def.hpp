...
public:
  ...
  /// @brief Method AssetBundleStreamingAssetsPathForAssetBundleName, addr 0x26c0bf0, size 0x90, virtual false, abstract: false, final false
  static inline ::StringW AssetBundleStreamingAssetsPathForAssetBundleName(::StringW assetBundleName);

  /// @brief Method GetAssetBundleNameForBeatmapLevel, addr 0x26c09f8, size 0x74, virtual false, abstract: false, final false
  static inline ::StringW GetAssetBundleNameForBeatmapLevel(::StringW levelID, ::GlobalNamespace::BeatmapLevelDataVersion version);

  /// @brief Method GetAssetBundleNameWithVersionForBeatmapLevelData, addr 0x26c0a6c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAssetBundleStreamingAssetsPathForBeatmapLevelId, addr 0x26c0b44, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method GetBeatmapLevelAssetFilenameForBeatmapLevel, addr 0x26c0914, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW GetBeatmapLevelAssetFilenameForBeatmapLevel(::StringW levelID);

  /// @brief Method GetBeatmapLevelDataAssetFilenameForBeatmapLevel, addr 0x26c08c8, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW GetBeatmapLevelDataAssetFilenameForBeatmapLevel(::StringW levelID);

  /// @brief Method GetBeatmapLevelDataAssetNameForBeatmapLevel, addr 0x26c09ac, size 0x4c, virtual false, abstract: false, final false
  static inline ::StringW GetBeatmapLevelDataAssetNameForBeatmapLevel(::StringW levelID);

  /// @brief Method GetBeatmapLevelPackAssetFilename, addr 0x26c0960, size 0x4c, virtual false, abstract: false, final false
