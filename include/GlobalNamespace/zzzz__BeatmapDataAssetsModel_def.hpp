...
/// @brief Method AssetBundleStreamingAssetsPathForAssetBundleName, addr 0x361dc3c, size 0x98, virtual false, abstract: false, final false
static inline ::StringW AssetBundleStreamingAssetsPathForAssetBundleName(::StringW  assetBundleName) ;

/// @brief Method GetAssetBundleNameForBeatmapLevel, addr 0x361d9ec, size 0x90, virtual false, abstract: false, final false
static inline ::StringW GetAssetBundleNameForBeatmapLevel(::StringW  levelID, ::GlobalNamespace::BeatmapLevelDataVersion  version) ;

/// @brief Method GetAssetBundleNameWithVersionForBeatmapLevelData, addr 0x361da7c, size 0x10c, virtual false, abstract: false, final false
...
/// @brief Method GetAssetBundleStreamingAssetsPathForBeatmapLevelId, addr 0x361db88, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method GetBeatmapLevelAssetFilenameForBeatmapLevel, addr 0x361d8fc, size 0x50, virtual false, abstract: false, final false
static inline ::StringW GetBeatmapLevelAssetFilenameForBeatmapLevel(::StringW  levelID) ;

/// @brief Method GetBeatmapLevelDataAssetFilenameForBeatmapLevel, addr 0x361d8ac, size 0x50, virtual false, abstract: false, final false
static inline ::StringW GetBeatmapLevelDataAssetFilenameForBeatmapLevel(::StringW  levelID) ;

/// @brief Method GetBeatmapLevelDataAssetNameForBeatmapLevel, addr 0x361d99c, size 0x50, virtual false, abstract: false, final false
static inline ::StringW GetBeatmapLevelDataAssetNameForBeatmapLevel(::StringW  levelID) ;

/// @brief Method GetBeatmapLevelPackAssetFilename, addr 0x361d94c, size 0x50, virtual false, abstract: false, final false
