...
// Write type traits
MARK_REF_T(::GlobalNamespace::BakedLightWithIdBase*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BakedLightWithIdBase*, "", "BakedLightWithIdBase");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5f3ec58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BakedLightWithIdBase) == 0x20, "Size mismatch!");
