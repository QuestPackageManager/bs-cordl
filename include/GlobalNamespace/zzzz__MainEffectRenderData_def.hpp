...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MainEffectRenderData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MainEffectRenderData(MainEffectRenderData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MainEffectRenderData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MainEffectRenderData(MainEffectRenderDataconst&) = delete;
