...
public:
  ...
  /// @brief Method __Validate, addr 0x5993a78, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5993cb8, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_transformGroupType, addr 0x5993a40, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::LightTransformGroupType get_transformGroupType();

  /// @brief Method get_xDistributionLimits, addr 0x5993a60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_xDistributionLimits();

  /// @brief Method get_xTranslationLimits, addr 0x5993a48, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_xTranslationLimits();

  /// @brief Method get_yDistributionLimits, addr 0x5993a68, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_yDistributionLimits();

  /// @brief Method get_yTranslationLimits, addr 0x5993a50, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_yTranslationLimits();

  /// @brief Method get_zDistributionLimits, addr 0x5993a70, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_zDistributionLimits();

  /// @brief Method get_zTranslationLimits, addr 0x5993a58, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LightTranslationGroup) == 0x78, "Size mismatch!");
