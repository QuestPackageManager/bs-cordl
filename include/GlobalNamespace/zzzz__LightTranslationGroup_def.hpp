...
class CORDL_TYPE LightTranslationGroup : public ::GlobalNamespace::LightTransformGroup_3<::UnityW<::GlobalNamespace::LightGroupTranslationXTransform>,::UnityW<::GlobalNamespace::LightGroupTranslationYTransform>,::UnityW<::GlobalNamespace::LightGroupTranslationZTransform>> {
public:
// Declarations
...
/// @brief Method __Validate, addr 0x585b530, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x585b770, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_transformGroupType, addr 0x585b4f8, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::LightTransformGroupType get_transformGroupType() ;

/// @brief Method get_xDistributionLimits, addr 0x585b518, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_xDistributionLimits() ;

/// @brief Method get_xTranslationLimits, addr 0x585b500, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_xTranslationLimits() ;

/// @brief Method get_yDistributionLimits, addr 0x585b520, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_yDistributionLimits() ;

/// @brief Method get_yTranslationLimits, addr 0x585b508, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_yTranslationLimits() ;

/// @brief Method get_zDistributionLimits, addr 0x585b528, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_zDistributionLimits() ;

/// @brief Method get_zTranslationLimits, addr 0x585b510, size 0x8, virtual false, abstract: false, final false
