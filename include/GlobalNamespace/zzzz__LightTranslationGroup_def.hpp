...
/// @brief Method __Validate, addr 0x57e7d8c, size 0x240, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57e7fcc, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_transformGroupType, addr 0x57e7d54, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::LightTransformGroupType get_transformGroupType() ;

/// @brief Method get_xDistributionLimits, addr 0x57e7d74, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_xDistributionLimits() ;

/// @brief Method get_xTranslationLimits, addr 0x57e7d5c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_xTranslationLimits() ;

/// @brief Method get_yDistributionLimits, addr 0x57e7d7c, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_yDistributionLimits() ;

/// @brief Method get_yTranslationLimits, addr 0x57e7d64, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_yTranslationLimits() ;

/// @brief Method get_zDistributionLimits, addr 0x57e7d84, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 get_zDistributionLimits() ;

/// @brief Method get_zTranslationLimits, addr 0x57e7d6c, size 0x8, virtual false, abstract: false, final false
