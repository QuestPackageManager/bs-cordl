...
public:
  ...
  /// @brief Method Init, addr 0x3b1e5f8, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method PlaybackTick, addr 0x3b20484, size 0x3a0, virtual false, abstract: false, final false
  inline void PlaybackTick(float_t time);

  /// @brief Method StartPlayback, addr 0x3b1ec94, size 0xe8, virtual false, abstract: false, final false
  inline void StartPlayback();

  /// @brief Method StopPlayback, addr 0x3b1ec0c, size 0xc, virtual false, abstract: false, final false
  inline void StopPlayback();

  /// @brief Method Update, addr 0x3b20468, size 0x1c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b20824, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
