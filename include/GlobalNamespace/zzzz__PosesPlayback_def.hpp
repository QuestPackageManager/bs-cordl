...
public:
  ...
  /// @brief Method Init, addr 0x57c5510, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method PlaybackTick, addr 0x57c74a0, size 0x3a8, virtual false, abstract: false, final false
  inline void PlaybackTick(float_t time);

  /// @brief Method StartPlayback, addr 0x57c5c30, size 0xf0, virtual false, abstract: false, final false
  inline void StartPlayback();

  /// @brief Method StopPlayback, addr 0x57c5ba4, size 0xc, virtual false, abstract: false, final false
  inline void StopPlayback();

  /// @brief Method Update, addr 0x57c7488, size 0x18, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57c7848, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
