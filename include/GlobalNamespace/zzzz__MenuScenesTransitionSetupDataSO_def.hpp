...
public:
// Declarations
/// @brief Method Init, addr 0x577e73c, size 0xc0, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::MenuScenesTransitionSetupDataSO* New_ctor() ;

/// @brief Method .ctor, addr 0x577e7fc, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
