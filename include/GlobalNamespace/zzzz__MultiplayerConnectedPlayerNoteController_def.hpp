...
/// @brief Method HiddenStateDidChange, addr 0x5886938, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method Pause, addr 0x5886958, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5886698, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
