...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerConnectedPlayerNoteController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerConnectedPlayerNoteController*, "", "MultiplayerConnectedPlayerNoteController");
...
public:
  ...
  /// @brief Method HiddenStateDidChange, addr 0x59b770c, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Pause, addr 0x59b772c, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59b746c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerConnectedPlayerNoteController) == 0x90, "Size mismatch!");
