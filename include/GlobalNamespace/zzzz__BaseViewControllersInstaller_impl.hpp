...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BaseViewControllersInstaller::*)()>(&::GlobalNamespace::BaseViewControllersInstaller::InstallBindings)> {
  constexpr static std::size_t size = 0xc8;
  constexpr static std::size_t addrs = 0x584d71c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BaseViewControllersInstaller::*)()>(&::GlobalNamespace::BaseViewControllersInstaller::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x584d7e4;
...
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____simpleDialogPromptViewControllerPrefab)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
constexpr ::UnityW<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController>& GlobalNamespace::BaseViewControllersInstaller::__cordl_internal_get__safeAreaFocusedSimpleDialogPromptViewControllerPrefab()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____safeAreaFocusedSimpleDialogPromptViewControllerPrefab;
}
constexpr ::UnityW<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController> const& GlobalNamespace::BaseViewControllersInstaller::__cordl_internal_get__safeAreaFocusedSimpleDialogPromptViewControllerPrefab() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____safeAreaFocusedSimpleDialogPromptViewControllerPrefab;
}
constexpr void GlobalNamespace::BaseViewControllersInstaller::__cordl_internal_set__safeAreaFocusedSimpleDialogPromptViewControllerPrefab(::UnityW<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____safeAreaFocusedSimpleDialogPromptViewControllerPrefab)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
