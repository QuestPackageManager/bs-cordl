...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::GlobalNamespace::MultiplayerLobbyController::*)()>(&::GlobalNamespace::MultiplayerLobbyController::get_lobbyActivated)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5a1147c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLobbyController*>(), { "get_lobbyActivated", {}, {} })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerLobbyController::*)(bool)>(&::GlobalNamespace::MultiplayerLobbyController::set_lobbyActivated)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5a11484;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLobbyController*>(), { "set_lobbyActivated", {}, { ::i2c::type_of<bool>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerLobbyController::*)()>(&::GlobalNamespace::MultiplayerLobbyController::ActivateMultiplayerLobby)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x5a1148c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLobbyController*>(), { "ActivateMultiplayerLobby", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerLobbyController::*)()>(&::GlobalNamespace::MultiplayerLobbyController::DeactivateMultiplayerLobby)> {
  constexpr static std::size_t size = 0x84;
  constexpr static std::size_t addrs = 0x5a11550;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLobbyController*>(), { "DeactivateMultiplayerLobby", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::MultiplayerLobbyController::*)()>(&::GlobalNamespace::MultiplayerLobbyController::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x5a115d4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLobbyController*>(), { ".ctor", {}, {} })));
    return ___internal_method;
  }
};
...
constexpr void GlobalNamespace::MultiplayerLobbyController::__cordl_internal_set__multiplayerLobbyAvatarManager(::UnityW<::GlobalNamespace::MultiplayerLobbyAvatarManager> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____multiplayerLobbyAvatarManager = value;
}
...
constexpr void GlobalNamespace::MultiplayerLobbyController::__cordl_internal_set__multiplayerLobbyCenterStageManager(::UnityW<::GlobalNamespace::MultiplayerLobbyCenterStageManager> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____multiplayerLobbyCenterStageManager = value;
}
...
constexpr void GlobalNamespace::MultiplayerLobbyController::__cordl_internal_set__multiplayerLobbyAvatarPlaceManager(::UnityW<::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____multiplayerLobbyAvatarPlaceManager = value;
}
...
constexpr void GlobalNamespace::MultiplayerLobbyController::__cordl_internal_set__menuEnvironmentManager(::UnityW<::GlobalNamespace::MenuEnvironmentManager> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____menuEnvironmentManager = value;
}
...
inline void GlobalNamespace::MultiplayerLobbyController::DeactivateMultiplayerLobby() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::MultiplayerLobbyController*>(), { "DeactivateMultiplayerLobby", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
...
inline ::GlobalNamespace::MultiplayerLobbyController* GlobalNamespace::MultiplayerLobbyController::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::MultiplayerLobbyController*>());
}
// Ctor Parameters []
