...
public:
  ...
  /// @brief Method .ctor, addr 0x39cf56c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanPlayHapticPreset, addr 0x39cf0a4, size 0x40, virtual true, abstract: false, final true
  inline bool CanPlayHapticPreset(::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset, ::UnityEngine::XR::XRNode node);

  /// @brief Method GetRumble, addr 0x39cef28, size 0x17c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RumbleHapticFeedbackPlayer_RumbleData* GetRumble(::UnityEngine::XR::XRNode node, ::System::Object* preset);

  /// @brief Method LateUpdate, addr 0x39cf0e4, size 0x4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::RumbleHapticFeedbackPlayer* New_ctor();

  /// @brief Method PlayHapticFeedback, addr 0x39c6eb0, size 0xc8, virtual true, abstract: false, final true
  inline void PlayHapticFeedback(::UnityEngine::XR::XRNode node, ::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset);

  /// @brief Method UpdateRumbles, addr 0x39cf0e8, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39cf574, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  static constexpr float_t kContinuousRumbleFrameDuration{ static_cast<float_t>(0.0f) };
