...
public:
  ...
  /// @brief Method .ctor, addr 0x57166b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CanPlayHapticPreset, addr 0x5716174, size 0x3c, virtual true, abstract: false, final true
  inline bool CanPlayHapticPreset(::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset, ::UnityEngine::XR::XRNode node);

  /// @brief Method GetRumble, addr 0x5715fa8, size 0x1cc, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RumbleHapticFeedbackPlayer_RumbleData* GetRumble(::UnityEngine::XR::XRNode node, ::System::Object* preset);

  /// @brief Method LateUpdate, addr 0x57161b0, size 0x4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::RumbleHapticFeedbackPlayer* New_ctor();

  /// @brief Method PlayHapticFeedback, addr 0x5713e88, size 0xe0, virtual true, abstract: false, final true
  inline void PlayHapticFeedback(::UnityEngine::XR::XRNode node, ::Libraries::HM::HMLib::VR::HapticPresetSO* hapticPreset);

  /// @brief Method UpdateRumbles, addr 0x57161b4, size 0x4fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57166b4, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
