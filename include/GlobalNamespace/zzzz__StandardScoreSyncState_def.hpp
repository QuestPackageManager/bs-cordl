...
public:
  ...
  /// @brief Method GetState, addr 0x32be7f0, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method SetState, addr 0x32be758, size 0x50, virtual true, abstract: false, final true
