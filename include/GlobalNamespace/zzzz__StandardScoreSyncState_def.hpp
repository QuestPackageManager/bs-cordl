...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardScoreSyncState_Score, "", "StandardScoreSyncState/Score");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardScoreSyncState, "", "StandardScoreSyncState");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::StandardScoreSyncState_Score) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method ApplyDelta, addr 0x32bd044, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::StandardScoreSyncState ApplyDelta(::by_ref<::GlobalNamespace::StandardScoreSyncState> delta);

  /// @brief Method Deserialize, addr 0x32bd17c, size 0xa8, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x32bd224, size 0x5c, virtual false, abstract: false, final false
  inline bool Equals(::by_ref<::GlobalNamespace::StandardScoreSyncState> other);

  /// @brief Method GetDelta, addr 0x32bd020, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::StandardScoreSyncState GetDelta(::by_ref<::GlobalNamespace::StandardScoreSyncState> stateTable);

  /// @brief Method GetSize, addr 0x32bd280, size 0xfc, virtual true, abstract: false, final true
  inline int32_t GetSize();

  /// @brief Method GetState, addr 0x32bd068, size 0x58, virtual true, abstract: false, final true
  inline int32_t GetState(::GlobalNamespace::StandardScoreSyncState_Score s);

  /// @brief Method IEquatableByReference<StandardScoreSyncState>.Equals, addr 0x32bd3c4, size 0x4, virtual true, abstract: false, final true
  inline bool IEquatableByReference_StandardScoreSyncState__Equals(::by_ref<::GlobalNamespace::StandardScoreSyncState> other);

  /// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.ApplyDelta, addr 0x32bd3a0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.GetDelta, addr 0x32bd37c, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x32bd0c0, size 0xbc, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method SetState, addr 0x32bcfd0, size 0x50, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::StandardScoreSyncState) == 0x14, "Size mismatch!");
