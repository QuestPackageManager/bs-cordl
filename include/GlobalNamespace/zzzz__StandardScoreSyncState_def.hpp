...
/// @brief Method ApplyDelta, addr 0x3225d94, size 0x24, virtual false, abstract: false, final false
inline ::GlobalNamespace::StandardScoreSyncState ApplyDelta(::ByRef<::GlobalNamespace::StandardScoreSyncState>  delta) ;

/// @brief Method Deserialize, addr 0x3225ecc, size 0xa8, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x3225f74, size 0x5c, virtual false, abstract: false, final false
inline bool Equals(::ByRef<::GlobalNamespace::StandardScoreSyncState>  other) ;

/// @brief Method GetDelta, addr 0x3225d70, size 0x24, virtual false, abstract: false, final false
inline ::GlobalNamespace::StandardScoreSyncState GetDelta(::ByRef<::GlobalNamespace::StandardScoreSyncState>  stateTable) ;

/// @brief Method GetSize, addr 0x3225fd0, size 0xfc, virtual true, abstract: false, final true
inline int32_t GetSize() ;

/// @brief Method GetState, addr 0x3225db8, size 0x58, virtual true, abstract: false, final true
inline int32_t GetState(::GlobalNamespace::StandardScoreSyncState_Score  s) ;

/// @brief Method IEquatableByReference<StandardScoreSyncState>.Equals, addr 0x3226114, size 0x4, virtual true, abstract: false, final true
inline bool IEquatableByReference_StandardScoreSyncState__Equals(::ByRef<::GlobalNamespace::StandardScoreSyncState>  other) ;

/// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.ApplyDelta, addr 0x32260f0, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.GetDelta, addr 0x32260cc, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method Serialize, addr 0x3225e10, size 0xbc, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method SetState, addr 0x3225d20, size 0x50, virtual true, abstract: false, final true
...
constexpr ::GlobalNamespace::IStateTable_3<::GlobalNamespace::StandardScoreSyncState,::GlobalNamespace::StandardScoreSyncState_Score,int32_t>* i___GlobalNamespace__IStateTable_3___GlobalNamespace__StandardScoreSyncState___GlobalNamespace__StandardScoreSyncState_Score_int32_t_() ;
