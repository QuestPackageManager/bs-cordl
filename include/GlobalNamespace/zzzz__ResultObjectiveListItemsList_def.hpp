...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13674)), TypeDefinitionIndex(TypeDefinitionIndex(5804)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13674), inst:
// 5220 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(5805)) CS Name: ::ResultObjectiveListItemsList*
...
public:
  ...
  /// @brief Method .ctor, addr 0x22e8100, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
