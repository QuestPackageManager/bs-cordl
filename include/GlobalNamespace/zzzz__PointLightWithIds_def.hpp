...
/// @brief Method ColorWasSet, addr 0x56bc5ec, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bc608, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;
