...
public:
  ...
  /// @brief Method InstallBindings, addr 0x2347e84, size 0xc4, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::RecordingToolSceneSetup* New_ctor();

  /// @brief Method .ctor, addr 0x2347f48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
