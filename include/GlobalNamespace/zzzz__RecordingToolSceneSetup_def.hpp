...
public:
  ...
  /// @brief Method InstallBindings, addr 0x247b30c, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x247b3d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
