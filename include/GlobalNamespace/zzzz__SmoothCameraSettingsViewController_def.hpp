...
public:
  ...
  /// @brief Method DidActivate, addr 0x3afb760, size 0x16c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3afb8cc, size 0x90, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleEnabledChanged, addr 0x3afb984, size 0x20, virtual false, abstract: false, final false
  inline void HandleEnabledChanged(bool newValue);

  /// @brief Method HandleFovChanged, addr 0x3afb9a4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3afb95c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3afb9c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
