...
/// @brief Method DidActivate, addr 0x57ac924, size 0x1a4, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x57acac8, size 0x90, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleEnabledChanged, addr 0x57acb80, size 0x1c, virtual false, abstract: false, final false
inline void HandleEnabledChanged(bool  newValue) ;

/// @brief Method HandleFovChanged, addr 0x57acb9c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57acb58, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57acbb4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
