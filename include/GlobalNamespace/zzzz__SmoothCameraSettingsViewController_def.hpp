...
// Write type traits
MARK_REF_T(::GlobalNamespace::SmoothCameraSettingsViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SmoothCameraSettingsViewController*, "", "SmoothCameraSettingsViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a228b8, size 0x1a0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5a22a58, size 0x8c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleEnabledChanged, addr 0x5a22b0c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleEnabledChanged(bool newValue);

  /// @brief Method HandleFovChanged, addr 0x5a22b28, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5a22ae4, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a22b40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SmoothCameraSettingsViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SmoothCameraSettingsViewController(SmoothCameraSettingsViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SmoothCameraSettingsViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SmoothCameraSettingsViewController(SmoothCameraSettingsViewControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SmoothCameraSettingsViewController) == 0x98, "Size mismatch!");
