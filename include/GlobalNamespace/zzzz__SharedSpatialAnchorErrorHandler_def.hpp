...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SharedSpatialAnchorErrorHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SharedSpatialAnchorErrorHandler(SharedSpatialAnchorErrorHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SharedSpatialAnchorErrorHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SharedSpatialAnchorErrorHandler(SharedSpatialAnchorErrorHandlerconst&) = delete;
