...
public:
  ...
  /// @brief Method Awake, addr 0x5a30dc4, size 0xa8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LogWarning, addr 0x5a30ee8, size 0xac, virtual false, abstract: false, final false
  inline void LogWarning(::StringW msg);

  static inline ::GlobalNamespace::SharedSpatialAnchorErrorHandler* New_ctor();

  /// @brief Method OnAnchorCreate, addr 0x5a30e6c, size 0x7c, virtual false, abstract: false, final false
  inline void OnAnchorCreate(::GlobalNamespace::OVRSpatialAnchor* _, ::GlobalNamespace::OVRSpatialAnchor_OperationResult result);

  /// @brief Method OnAnchorErase, addr 0x5a31120, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnAnchorEraseAll, addr 0x5a310b0, size 0x70, virtual false, abstract: false, final false
  inline void OnAnchorEraseAll(::GlobalNamespace::OVRSpatialAnchor_OperationResult result);

  /// @brief Method OnAnchorShare, addr 0x5a30f94, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSharedSpatialAnchorLoad, addr 0x5a31010, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a311d4, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
