...
public:
  ...
  /// @brief Method MoveNext, addr 0x5844c90, size 0x114, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::CutoutAnimateEffect__AnimateToCutoutCoroutine_d__7* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5844da4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5844dac, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5844de4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5844c8c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5844bf4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnimateCutout, addr 0x583907c, size 0x54, virtual false, abstract: false, final false
  inline void AnimateCutout(float_t cutoutStart, float_t cutoutEnd, float_t duration);

  /// @brief Method AnimateToCutoutCoroutine, addr 0x5844b7c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetEffect, addr 0x5839038, size 0x24, virtual false, abstract: false, final false
  inline void ResetEffect();

  /// @brief Method SetCutout, addr 0x5844b1c, size 0x60, virtual false, abstract: false, final false
  inline void SetCutout(float_t cutout);

  /// @brief Method Start, addr 0x5844b14, size 0x8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5844c58, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animating, addr 0x5844b04, size 0x8, virtual false, abstract: false, final false
  inline bool get_animating();

  /// @brief Method set_animating, addr 0x5844b0c, size 0x8, virtual false, abstract: false, final false
