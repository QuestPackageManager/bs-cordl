...
public:
  ...
  /// @brief Method get_color, addr 0x21a8858, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method ColorWasSet, addr 0x21a8874, size 0x4c, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  static inline ::GlobalNamespace::UnityLightWithId* New_ctor();

  /// @brief Method .ctor, addr 0x21a88c0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
