...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x39e51ac, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e51f8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x39e5190, size 0x1c, virtual false, abstract: false, final false
