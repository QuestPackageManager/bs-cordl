...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x24f5e48, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24f5e94, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x24f5e2c, size 0x1c, virtual false, abstract: false, final false
