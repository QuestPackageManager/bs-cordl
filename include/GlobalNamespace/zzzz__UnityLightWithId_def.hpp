...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x56bd188, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56bd1d4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x56bd170, size 0x18, virtual false, abstract: false, final false
