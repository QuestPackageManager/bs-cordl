...
public:
  ...
  /// @brief Method GetCopy, addr 0x103889c, size 0x9c, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method Mirror, addr 0x1038938, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateDuration, addr 0x1038894, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103882c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_duration, addr 0x10387fc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_duration();

  /// @brief Method get_height, addr 0x103881c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_height();

  /// @brief Method get_lineIndex, addr 0x10387dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_lineLayer, addr 0x10387ec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_lineLayer();

  /// @brief Method get_width, addr 0x103880c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_width();

  /// @brief Method set_duration, addr 0x1038804, size 0x8, virtual false, abstract: false, final false
  inline void set_duration(float_t value);

  /// @brief Method set_height, addr 0x1038824, size 0x8, virtual false, abstract: false, final false
  inline void set_height(int32_t value);

  /// @brief Method set_lineIndex, addr 0x10387e4, size 0x8, virtual false, abstract: false, final false
  inline void set_lineIndex(int32_t value);

  /// @brief Method set_lineLayer, addr 0x10387f4, size 0x8, virtual false, abstract: false, final false
  inline void set_lineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_width, addr 0x1038814, size 0x8, virtual false, abstract: false, final false
