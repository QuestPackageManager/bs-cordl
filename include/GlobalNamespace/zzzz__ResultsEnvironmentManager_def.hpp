...
public:
  ...
  /// @brief Method GetResultEnvironmentControllerForKeyword, addr 0x250e7a8, size 0x78, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BaseResultsEnvironmentController> GetResultEnvironmentControllerForKeyword(::StringW keyword);

  /// @brief Method HideResultForKeyword, addr 0x250e8a4, size 0x84, virtual false, abstract: false, final false
  inline void HideResultForKeyword(::StringW keyword);

  /// @brief Method Init, addr 0x250e398, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowResultForKeyword, addr 0x250e820, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x250e928, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
