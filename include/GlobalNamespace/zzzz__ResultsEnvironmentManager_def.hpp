#pragma once
// IWYU pragma private; include "GlobalNamespace/ResultsEnvironmentManager.hpp"
...
public:
  ...
  /// @brief Method GetResultEnvironmentControllerForKeyword, addr 0x2625778, size 0x78, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BaseResultsEnvironmentController> GetResultEnvironmentControllerForKeyword(::StringW keyword);

  /// @brief Method HideResultForKeyword, addr 0x2625874, size 0x84, virtual false, abstract: false, final false
  inline void HideResultForKeyword(::StringW keyword);

  /// @brief Method Init, addr 0x2625368, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowResultForKeyword, addr 0x26257f0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26258f8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
