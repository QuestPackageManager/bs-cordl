...
public:
  ...
  /// @brief Method ChangeColor, addr 0x3bdfec4, size 0x7c, virtual false, abstract: false, final false
  inline void ChangeColor(::UnityEngine::Color toColor, float_t duration);

  /// @brief Method HandleFirstPlayerDidChange, addr 0x3be028c, size 0xb0, virtual false, abstract: false, final false
  inline void HandleFirstPlayerDidChange(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* obj);

  /// @brief Method HandlePlayerFailed, addr 0x3be0194, size 0x18, virtual false, abstract: false, final false
  inline void HandlePlayerFailed();

  static inline ::GlobalNamespace::MultiplayerPositionDisplay* New_ctor();

  /// @brief Method OnDestroy, addr 0x3bdfde8, size 0xdc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3bdfcb0, size 0x118, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3bdff40, size 0x4c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateColors, addr 0x3bdff8c, size 0x98, virtual false, abstract: false, final false
  inline void UpdateColors();

  /// @brief Method UpdatePosition, addr 0x3be0024, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3be033c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
