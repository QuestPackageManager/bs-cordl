...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2773)), TypeDefinitionIndex(TypeDefinitionIndex(3390)), TypeDefinitionIndex(TypeDefinitionIndex(3398)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2773), inst: 77 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3390), inst: 4080 }),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3398), inst: 77 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(15205)) CS Name: ::AsyncHelper::<AnyTaskTrueNonAlloc>d__2
...
public:
  ...
  /// @brief Method MoveNext, addr 0xe46940, size 0x2a8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0xe46be8, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method RunSync, addr 0xe467c0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method AnyTaskTrueNonAlloc, addr 0xe46848, size 0xf8, virtual false, abstract: false, final false
