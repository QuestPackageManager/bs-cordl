...
constexpr ::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T0>*& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value0()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value0;
}
template<typename T0,typename T1>
constexpr ::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T0>* const& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value0() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value0;
}
template<typename T0,typename T1>
constexpr void GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_set__value0(::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T0>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____value0, value);
}
template<typename T0,typename T1>
constexpr ::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T1>*& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value1()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value1;
}
template<typename T0,typename T1>
constexpr ::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T1>* const& GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_get__value1() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____value1;
}
template<typename T0,typename T1>
constexpr void GlobalNamespace::RemoteProcedureCall_2<T0,T1>::__cordl_internal_set__value1(::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T1>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
