...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5624)), TypeDefinitionIndex(TypeDefinitionIndex(13791)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13791), inst:
// 5101 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(5625)) CS Name: ::GuestNameButtonsListItemsList*
...
public:
  ...
  /// @brief Method .ctor addr 0x21596a0 size 0x48 virtual false final false
  inline void _ctor();
