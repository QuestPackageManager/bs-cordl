...
// Write type traits
MARK_REF_T(::GlobalNamespace::GuestNameButtonsListItemsList*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GuestNameButtonsListItemsList*, "", "GuestNameButtonsListItemsList");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a08d84, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::GuestNameButtonsListItemsList) == 0x48, "Size mismatch!");
