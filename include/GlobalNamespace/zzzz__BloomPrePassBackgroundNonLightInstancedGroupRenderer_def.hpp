...
/// @brief Field propertyType, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get_propertyType, put=__cordl_internal_set_propertyType)) ::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_PropertyType  propertyType;
...
/// @brief Method .ctor, addr 0x56af62c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _renderers, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__renderers, put=__cordl_internal_set__renderers)) ::ArrayW<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>,::Array<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>>*>  _renderers;

/// @brief Field _reusableArraysSize, offset 0x58, size 0x4 
...
/// @brief Field _reusableFloatArrays, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableFloatArrays, put=__cordl_internal_set__reusableFloatArrays)) ::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<float_t,::Array<float_t>*>>*  _reusableFloatArrays;

/// @brief Field _reusableGetMaterialPropertyBlock, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableGetMaterialPropertyBlock, put=__cordl_internal_set__reusableGetMaterialPropertyBlock)) ::UnityEngine::MaterialPropertyBlock*  _reusableGetMaterialPropertyBlock;

/// @brief Field _reusableMatrixArrays, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableMatrixArrays, put=__cordl_internal_set__reusableMatrixArrays)) ::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*>>*  _reusableMatrixArrays;

/// @brief Field _reusableSetMaterialPropertyBlock, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableSetMaterialPropertyBlock, put=__cordl_internal_set__reusableSetMaterialPropertyBlock)) ::UnityEngine::MaterialPropertyBlock*  _reusableSetMaterialPropertyBlock;

/// @brief Field _reusableVectorArrays, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableVectorArrays, put=__cordl_internal_set__reusableVectorArrays)) ::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>>*  _reusableVectorArrays;

/// @brief Field _supportedProperties, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__supportedProperties, put=__cordl_internal_set__supportedProperties)) ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*,::Array<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*>*>  _supportedProperties;
...
/// @brief Method AutoFillRenderers, addr 0x56af3cc, size 0x54, virtual false, abstract: false, final false
inline void AutoFillRenderers() ;

/// @brief Method Awake, addr 0x56ae7cc, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetCachedFloatArray, addr 0x56af2d8, size 0xf4, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> GetCachedFloatArray(::StringW  propertyName) ;

/// @brief Method GetCachedMatrixArray, addr 0x56af0f0, size 0xf4, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Matrix4x4,::Array<::UnityEngine::Matrix4x4>*> GetCachedMatrixArray(::StringW  propertyName) ;

/// @brief Method GetCachedVectorArray, addr 0x56af1e4, size 0xf4, virtual false, abstract: false, final false
inline ::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*> GetCachedVectorArray(::StringW  propertyName) ;

/// @brief Method InitIfNeeded, addr 0x56ae7d0, size 0x284, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer* New_ctor() ;

/// @brief Method Render, addr 0x56aea88, size 0x668, virtual true, abstract: false, final false
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>,::Array<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>>*> const& __cordl_internal_get__renderers() const;

constexpr ::ArrayW<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>,::Array<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>>*>& __cordl_internal_get__renderers() ;
...
constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*,::Array<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*>*> const& __cordl_internal_get__supportedProperties() const;

constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*,::Array<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*>*>& __cordl_internal_get__supportedProperties() ;
...
constexpr void __cordl_internal_set__renderers(::ArrayW<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>,::Array<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>>*>  value) ;
...
constexpr void __cordl_internal_set__supportedProperties(::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*,::Array<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*>*>  value) ;

constexpr void __cordl_internal_set__timeHelper(::UnityW<::GlobalNamespace::TimeHelper>  value) ;

/// @brief Method .ctor, addr 0x56af420, size 0x19c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _supportedProperties, offset: 0x38, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*,::Array<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*>*>  ____supportedProperties;

/// @brief Field _reusableFloatArrays, offset: 0x40, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::StringW,::ArrayW<float_t,::Array<float_t>*>>*  ____reusableFloatArrays;

/// @brief Field _reusableVectorArrays, offset: 0x48, size: 0x8, def value: None
...
/// @brief Field _reusableMatrixArrays, offset: 0x50, size: 0x8, def value: None
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer, ____timeHelper) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer, ____renderers) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer, ____supportedProperties) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer, ____reusableFloatArrays) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer, ____reusableVectorArrays) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer, ____reusableMatrixArrays) == 0x50, "Offset mismatch!");
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer, 0x78>, "Size mismatch!");
