...
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer*);
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_PropertyType, "", "BloomPrePassBackgroundNonLightInstancedGroupRenderer/PropertyType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer*, "", "BloomPrePassBackgroundNonLightInstancedGroupRenderer");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*, "", "BloomPrePassBackgroundNonLightInstancedGroupRenderer/SupportedProperty");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_PropertyType) == 0x4, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__reusableVectorArrays,
                      put = __cordl_internal_set__reusableVectorArrays)) ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Vector4>>* _reusableVectorArrays;
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer>>& __cordl_internal_get__renderers();
  ...
  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<float_t>>* const& __cordl_internal_get__reusableFloatArrays() const;

  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<float_t>>*& __cordl_internal_get__reusableFloatArrays();
  ...
  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Matrix4x4>>* const& __cordl_internal_get__reusableMatrixArrays() const;

  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Matrix4x4>>*& __cordl_internal_get__reusableMatrixArrays();
  ...
  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Vector4>>* const& __cordl_internal_get__reusableVectorArrays() const;

  constexpr ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Vector4>>*& __cordl_internal_get__reusableVectorArrays();

  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*> const& __cordl_internal_get__supportedProperties() const;

  constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*>& __cordl_internal_get__supportedProperties();
  ...
  constexpr void __cordl_internal_set__reusableFloatArrays(::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<float_t>>* value);

  constexpr void __cordl_internal_set__reusableGetMaterialPropertyBlock(::UnityEngine::MaterialPropertyBlock* value);

  constexpr void __cordl_internal_set__reusableMatrixArrays(::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Matrix4x4>>* value);

  constexpr void __cordl_internal_set__reusableSetMaterialPropertyBlock(::UnityEngine::MaterialPropertyBlock* value);

  constexpr void __cordl_internal_set__reusableVectorArrays(::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Vector4>>* value);

  constexpr void __cordl_internal_set__supportedProperties(::ArrayW<::GlobalNamespace::BloomPrePassBackgroundNonLightInstancedGroupRenderer_SupportedProperty*> value);
...
public:
  ...
  ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<float_t>>* ____reusableFloatArrays;

  /// @brief Field _reusableVectorArrays, offset: 0x48, size: 0x8, def value: None
  ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Vector4>>* ____reusableVectorArrays;

  /// @brief Field _reusableMatrixArrays, offset: 0x50, size: 0x8, def value: None
  ::System::Collections::Generic::Dictionary_2<::StringW, ::ArrayW<::UnityEngine::Matrix4x4>>* ____reusableMatrixArrays;
