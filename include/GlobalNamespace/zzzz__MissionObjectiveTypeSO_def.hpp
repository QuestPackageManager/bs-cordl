...
/// @brief Method .ctor, addr 0x3633b10, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_noConditionValue, addr 0x3633b00, size 0x8, virtual false, abstract: false, final false
inline bool get_noConditionValue() ;

/// @brief Method get_objectiveName, addr 0x3633aec, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_objectiveName() ;

/// @brief Method get_objectiveNameLocalized, addr 0x3633af4, size 0xc, virtual false, abstract: false, final false
inline ::StringW get_objectiveNameLocalized() ;

/// @brief Method get_objectiveValueFormater, addr 0x3633b08, size 0x8, virtual false, abstract: false, final false
