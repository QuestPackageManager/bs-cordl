...
public:
  ...
  /// @brief Method .ctor, addr 0x14d086c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_noConditionValue, addr 0x14d085c, size 0x8, virtual false, abstract: false, final false
  inline bool get_noConditionValue();

  /// @brief Method get_objectiveName, addr 0x14d0848, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_objectiveName();

  /// @brief Method get_objectiveNameLocalized, addr 0x14d0850, size 0xc, virtual false, abstract: false, final false
  inline ::StringW get_objectiveNameLocalized();

  /// @brief Method get_objectiveValueFormater, addr 0x14d0864, size 0x8, virtual false, abstract: false, final false
