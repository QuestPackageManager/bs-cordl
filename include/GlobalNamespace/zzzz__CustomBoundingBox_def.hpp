...
public:
  ...
  /// @brief Method Awake, addr 0x24d4a54, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x24d4ac0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
