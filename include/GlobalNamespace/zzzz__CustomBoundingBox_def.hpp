...
public:
  ...
  /// @brief Method Awake, addr 0x39bce98, size 0x68, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x39bcf00, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
