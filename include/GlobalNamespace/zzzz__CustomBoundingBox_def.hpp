...
public:
  ...
  /// @brief Method Awake, addr 0x570eedc, size 0x68, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x570ef44, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
