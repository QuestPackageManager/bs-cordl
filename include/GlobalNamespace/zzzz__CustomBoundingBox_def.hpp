...
public:
  ...
  /// @brief Method Awake, addr 0x22b59a4, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x22b5a10, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
