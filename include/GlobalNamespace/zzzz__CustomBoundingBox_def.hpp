...
/// @brief Method Awake, addr 0x56a1014, size 0x68, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method .ctor, addr 0x56a107c, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
