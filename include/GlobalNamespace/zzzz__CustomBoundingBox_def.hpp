...
// Write type traits
MARK_REF_T(::GlobalNamespace::CustomBoundingBox*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CustomBoundingBox*, "", "CustomBoundingBox");
...
public:
  ...
  /// @brief Method Awake, addr 0x5858928, size 0x68, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x5858990, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CustomBoundingBox) == 0x40, "Size mismatch!");
