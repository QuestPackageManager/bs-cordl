...
/// @brief Method GetQuickPlaySetupAsync, addr 0x5898178, size 0x78, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x58981f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
