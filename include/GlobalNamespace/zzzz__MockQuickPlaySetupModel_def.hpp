...
public:
  ...
  /// @brief Method GetQuickPlaySetupAsync addr 0x21035fc size 0x70 virtual true final true
  ...
  /// @brief Method .ctor addr 0x210366c size 0x8 virtual false final false
  inline void _ctor();
