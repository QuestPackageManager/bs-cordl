...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockQuickPlaySetupModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockQuickPlaySetupModel*, "", "MockQuickPlaySetupModel");
...
public:
  ...
  /// @brief Method GetQuickPlaySetupAsync, addr 0x59cefe0, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59cf058, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MockQuickPlaySetupModel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MockQuickPlaySetupModel(MockQuickPlaySetupModel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MockQuickPlaySetupModel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MockQuickPlaySetupModel(MockQuickPlaySetupModelconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MockQuickPlaySetupModel) == 0x18, "Size mismatch!");
