...
/// @brief Field _animationHashes, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__animationHashes, put=__cordl_internal_set__animationHashes)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ScreenBackButtonAnimationController_AnimationType,int32_t>*  _animationHashes;
...
/// @brief Method Awake, addr 0x31f8280, size 0x1c, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::ScreenBackButtonAnimationController* New_ctor() ;

/// @brief Method StartAnimation, addr 0x31f829c, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31f8314, size 0x27c, virtual false, abstract: false, final false
inline void _ctor() ;
