...
public:
  ...
  /// @brief Method Awake, addr 0x31f8330, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ScreenBackButtonAnimationController* New_ctor();

  /// @brief Method StartAnimation, addr 0x31f834c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f83c4, size 0x27c, virtual false, abstract: false, final false
  inline void _ctor();
