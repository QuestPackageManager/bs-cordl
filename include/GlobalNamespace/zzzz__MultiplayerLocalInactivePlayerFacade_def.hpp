...
public:
  ...
  /// @brief Method .ctor, addr 0x581ce98, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ReportPlayerDidFinish, addr 0x581ce5c, size 0x1c, virtual true, abstract: false, final true
  inline void ReportPlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults* results);

  /// @brief Method ReportPlayerNetworkDidFailed, addr 0x581ce78, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x581ce94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerDidFinishEvent, addr 0x581cb5c, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method add_playerNetworkDidFailedEvent, addr 0x581ccdc, size 0xc0, virtual true, abstract: false, final true
  inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method get_introAnimator, addr 0x581cb34, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_introAnimator();

  /// @brief Method get_introPlayableDirector, addr 0x581cb4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Playables::PlayableDirector> get_introPlayableDirector();

  /// @brief Method get_outroAnimator, addr 0x581cb54, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator> get_outroAnimator();

  /// @brief Method get_songController, addr 0x581cb24, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IStartSeekSongController* get_songController();

  /// @brief Method get_spectatorController, addr 0x581cb2c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_playerDidFinishEvent, addr 0x581cc1c, size 0xc0, virtual true, abstract: false, final true
  inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>* value);

  /// @brief Method remove_playerNetworkDidFailedEvent, addr 0x581cd9c, size 0xc0, virtual true, abstract: false, final true
