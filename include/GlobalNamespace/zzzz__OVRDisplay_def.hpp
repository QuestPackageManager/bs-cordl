...
// Ctor Parameters [CppParam { name: "resolution", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "fov", ty: "::UnityEngine::Vector2", modifiers: "", def_value: None }, CppParam { name: "fullFov", ty: "::GlobalNamespace::OVRDisplay_EyeFov", modifiers: "", def_value: None }]
...
/// @brief Field eyeDescs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_eyeDescs, put=__cordl_internal_set_eyeDescs)) ::ArrayW<::GlobalNamespace::OVRDisplay_EyeRenderDesc,::Array<::GlobalNamespace::OVRDisplay_EyeRenderDesc>*>  eyeDescs;
...
/// @brief Method ConfigureEyeDesc, addr 0x5c71ce0, size 0x29c, virtual false, abstract: false, final false
inline void ConfigureEyeDesc(::UnityEngine::XR::XRNode  eye) ;

/// @brief Method GetEyeRenderDesc, addr 0x5c718d0, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method RecenterPose, addr 0x5c712ac, size 0x94, virtual false, abstract: false, final false
inline void RecenterPose() ;

/// @brief Method Update, addr 0x5c70fac, size 0x1a8, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateTextures, addr 0x5c70f8c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c70f1c, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_RecenteredPose, addr 0x5c71154, size 0xac, virtual false, abstract: false, final false
inline void add_RecenteredPose(::System::Action*  value) ;

/// @brief Method get_acceleration, addr 0x5c71340, size 0x164, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_acceleration() ;

/// @brief Method get_angularAcceleration, addr 0x5c714a4, size 0x164, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_angularAcceleration() ;

/// @brief Method get_angularVelocity, addr 0x5c7176c, size 0x164, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_angularVelocity() ;

/// @brief Method get_appFramerate, addr 0x5c71adc, size 0x98, virtual false, abstract: false, final false
inline float_t get_appFramerate() ;

/// @brief Method get_displayFrequenciesAvailable, addr 0x5c71bd4, size 0x54, virtual false, abstract: false, final false
inline ::ArrayW<float_t,::Array<float_t>*> get_displayFrequenciesAvailable() ;

/// @brief Method get_displayFrequency, addr 0x5c71c28, size 0x54, virtual false, abstract: false, final false
inline float_t get_displayFrequency() ;

/// @brief Method get_latency, addr 0x5c71908, size 0x1d4, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRDisplay_LatencyData get_latency() ;

/// @brief Method get_recommendedMSAALevel, addr 0x5c71b74, size 0x60, virtual false, abstract: false, final false
inline int32_t get_recommendedMSAALevel() ;

/// @brief Method get_velocity, addr 0x5c71608, size 0x164, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_velocity() ;

/// @brief Method remove_RecenteredPose, addr 0x5c71200, size 0xac, virtual false, abstract: false, final false
inline void remove_RecenteredPose(::System::Action*  value) ;

/// @brief Method set_displayFrequency, addr 0x5c71c7c, size 0x64, virtual false, abstract: false, final false
