...
public:
  ...
  /// @brief Method ConfigureEyeDesc, addr 0x3fa76d8, size 0x254, virtual false, abstract: false, final false
  inline void ConfigureEyeDesc(::UnityEngine::XR::XRNode eye);

  /// @brief Method GetEyeRenderDesc, addr 0x3fa7334, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method RecenterPose, addr 0x3fa6e2c, size 0x78, virtual false, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method Update, addr 0x3fa6b68, size 0x18c, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateTextures, addr 0x3fa6b48, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3fa6ad0, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_RecenteredPose, addr 0x3fa6cf4, size 0x9c, virtual false, abstract: false, final false
  inline void add_RecenteredPose(::System::Action* value);

  /// @brief Method get_acceleration, addr 0x3fa6ea4, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_acceleration();

  /// @brief Method get_angularAcceleration, addr 0x3fa6fc8, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_angularAcceleration();

  /// @brief Method get_angularVelocity, addr 0x3fa7210, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_angularVelocity();

  /// @brief Method get_appFramerate, addr 0x3fa753c, size 0x90, virtual false, abstract: false, final false
  inline float_t get_appFramerate();

  /// @brief Method get_displayFrequenciesAvailable, addr 0x3fa7628, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_displayFrequenciesAvailable();

  /// @brief Method get_displayFrequency, addr 0x3f97804, size 0x50, virtual false, abstract: false, final false
  inline float_t get_displayFrequency();

  /// @brief Method get_latency, addr 0x3fa736c, size 0x1d0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRDisplay_LatencyData get_latency();

  /// @brief Method get_recommendedMSAALevel, addr 0x3fa75cc, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_recommendedMSAALevel();

  /// @brief Method get_velocity, addr 0x3fa70ec, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_velocity();

  /// @brief Method remove_RecenteredPose, addr 0x3fa6d90, size 0x9c, virtual false, abstract: false, final false
  inline void remove_RecenteredPose(::System::Action* value);

  /// @brief Method set_displayFrequency, addr 0x3fa7678, size 0x60, virtual false, abstract: false, final false
