...
public:
  ...
  /// @brief Method .ctor, addr 0x271b5b4, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Update, addr 0x271b64c, size 0x184, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method add_RecenteredPose, addr 0x271b7d0, size 0x9c, virtual false, abstract: false, final false
  inline void add_RecenteredPose(::System::Action* value);

  /// @brief Method remove_RecenteredPose, addr 0x271b86c, size 0x9c, virtual false, abstract: false, final false
  inline void remove_RecenteredPose(::System::Action* value);

  /// @brief Method RecenterPose, addr 0x271b908, size 0x78, virtual false, abstract: false, final false
  inline void RecenterPose();

  /// @brief Method get_acceleration, addr 0x271b980, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_acceleration();

  /// @brief Method get_angularAcceleration, addr 0x271baa4, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_angularAcceleration();

  /// @brief Method get_velocity, addr 0x271bbc8, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_velocity();

  /// @brief Method get_angularVelocity, addr 0x271bcec, size 0x124, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_angularVelocity();

  /// @brief Method GetEyeRenderDesc, addr 0x271be10, size 0x38, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRDisplay__EyeRenderDesc GetEyeRenderDesc(::UnityEngine::XR::XRNode eye);

  /// @brief Method get_latency, addr 0x271be48, size 0x1d0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRDisplay__LatencyData get_latency();

  /// @brief Method get_appFramerate, addr 0x271c018, size 0x90, virtual false, abstract: false, final false
  inline float_t get_appFramerate();

  /// @brief Method get_recommendedMSAALevel, addr 0x271c0a8, size 0x5c, virtual false, abstract: false, final false
  inline int32_t get_recommendedMSAALevel();

  /// @brief Method get_displayFrequenciesAvailable, addr 0x271c104, size 0x50, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_displayFrequenciesAvailable();

  /// @brief Method get_displayFrequency, addr 0x270e4b8, size 0x50, virtual false, abstract: false, final false
  inline float_t get_displayFrequency();

  /// @brief Method set_displayFrequency, addr 0x271c154, size 0x60, virtual false, abstract: false, final false
  inline void set_displayFrequency(float_t value);

  /// @brief Method UpdateTextures, addr 0x271b62c, size 0x20, virtual false, abstract: false, final false
  inline void UpdateTextures();

  /// @brief Method ConfigureEyeDesc, addr 0x271c1b4, size 0x254, virtual false, abstract: false, final false
