...
public:
  ...
  /// @brief Method MoveNext, addr 0x2676a54, size 0x228, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2676c7c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CellForIdx, addr 0x2676714, size 0x2b8, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x2676668, size 0xc, virtual true, abstract: false, final true
  inline float_t CellSize();

  /// @brief Method DidActivate, addr 0x2675f20, size 0x388, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x2676658, size 0x10, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleLoadedSelectionViewDidPressCreateButton, addr 0x2676a14, size 0x1c, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressCreateButton(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method HandleLoadedSelectionViewDidPressEditButton, addr 0x26769f8, size 0x1c, virtual false, abstract: false, final false
  inline void HandleLoadedSelectionViewDidPressEditButton(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method HandleLoadedSelectionViewDidPressPreferredButton, addr 0x26769cc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberOfCells, addr 0x2676674, size 0xa0, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method Prewarm, addr 0x2675874, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadContinueButtonInteractability, addr 0x26765c4, size 0x94, virtual false, abstract: false, final false
  inline void ReloadContinueButtonInteractability();

  /// @brief Method ReloadCreateEditButtonOfAvatarSystem, addr 0x26762a8, size 0x31c, virtual false, abstract: false, final false
  inline void ReloadCreateEditButtonOfAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* avatarSystem);

  /// @brief Method SetAllCellsActive, addr 0x2675be4, size 0x33c, virtual false, abstract: false, final false
  inline void SetAllCellsActive(bool active);

  /// @brief Method SetSelectedAvatarSystem, addr 0x26758b4, size 0x330, virtual false, abstract: false, final false
  inline void SetSelectedAvatarSystem(::BeatSaber::AvatarCore::IAvatarSystemMetadata* selectedAvatarSystem);

  /// @brief Method <DidActivate>b__26_0, addr 0x2676a38, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2676a30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressContinueButtonEvent, addr 0x26756e4, size 0x9c, virtual false, abstract: false, final false
  inline void add_didPressContinueButtonEvent(::System::Action* value);

  /// @brief Method add_didRequestCreationOfAvatarEvent, addr 0x2675584, size 0xb0, virtual false, abstract: false, final false
  inline void add_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didRequestEditOfAvatarEvent, addr 0x2675424, size 0xb0, virtual false, abstract: false, final false
  inline void add_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method add_didSetAvatarSystemPreferredEvent, addr 0x26752c4, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSetAvatarSystemPreferredEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method get_continueButtonVisible, addr 0x267581c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didPressContinueButtonEvent, addr 0x2675780, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didPressContinueButtonEvent(::System::Action* value);

  /// @brief Method remove_didRequestCreationOfAvatarEvent, addr 0x2675634, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didRequestCreationOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didRequestEditOfAvatarEvent, addr 0x26754d4, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didRequestEditOfAvatarEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method remove_didSetAvatarSystemPreferredEvent, addr 0x2675374, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSetAvatarSystemPreferredEvent(::System::Action_1<::BeatSaber::AvatarCore::IAvatarSystemMetadata*>* value);

  /// @brief Method set_continueButtonVisible, addr 0x2675844, size 0x30, virtual false, abstract: false, final false
