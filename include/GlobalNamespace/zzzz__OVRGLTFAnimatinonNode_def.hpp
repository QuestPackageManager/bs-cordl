...
public:
  ...
  /// @brief Method AddChannel, addr 0x5e2481c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneQuaternion, addr 0x5e24818, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion CloneQuaternion(::UnityEngine::Quaternion q);

  /// @brief Method CloneVector3, addr 0x5e24814, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCardinalThumbsticks, addr 0x5e25b48, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCardinalWeights, addr 0x5e25ce8, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTransformType, addr 0x5e249c8, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAnimationSampler, addr 0x5e24b44, size 0x580, virtual false, abstract: false, final false
  ...
  /// @brief Method SetScale, addr 0x5e25264, size 0x100, virtual false, abstract: false, final false
  inline void SetScale(::UnityEngine::Vector3 scale);

  /// @brief Method ToOVRInterpolationType, addr 0x5e25e50, size 0x148, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRGLTFAnimatinonNode_OVRInterpolationType ToOVRInterpolationType(::StringW interpolationType);

  /// @brief Method UpdatePose, addr 0x5e250c4, size 0x1a0, virtual false, abstract: false, final false
  inline void UpdatePose(bool down);

  /// @brief Method UpdatePose, addr 0x5e257b0, size 0x398, virtual false, abstract: false, final false
  inline void UpdatePose(::UnityEngine::Vector2 joystick);

  /// @brief Method UpdatePose, addr 0x5e25364, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e24514, size 0x300, virtual false, abstract: false, final false
