...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(7632)), TypeDefinitionIndex(TypeDefinitionIndex(7636)),
// TypeDefinitionIndex(TypeDefinitionIndex(7641))] Self: TypeDefinitionIndex(TypeDefinitionIndex(7637)) CS Name: ::OVRGLTFAnimatinonNode*
...
public:
  ...
  /// @brief Field m_translations, offset 0x50, size 0x8
  ...
  /// @brief Field m_rotations, offset 0x58, size 0x8
  ...
  /// @brief Field m_scales, offset 0x60, size 0x8
  ...
  /// @brief Method .ctor, addr 0x274cc00, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddChannel, addr 0x274cedc, size 0x154, virtual false, abstract: false, final false
  inline void AddChannel(::OVRSimpleJSON::JSONNode* channel, ::OVRSimpleJSON::JSONNode* samplers);

  /// @brief Method UpdatePose, addr 0x274d704, size 0x18c, virtual false, abstract: false, final false
  inline void UpdatePose(bool down);

  /// @brief Method UpdatePose, addr 0x274d890, size 0x2e4, virtual false, abstract: false, final false
  inline void UpdatePose(float_t t);

  /// @brief Method UpdatePose, addr 0x274db74, size 0x320, virtual false, abstract: false, final false
  inline void UpdatePose(::UnityEngine::Vector2 joystick);

  /// @brief Method GetCardinalThumbsticks, addr 0x274de94, size 0x1bc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCardinalWeights, addr 0x274e050, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAnimationSampler, addr 0x274d14c, size 0x5b8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTransformType, addr 0x274d030, size 0x11c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRGLTFAnimatinonNode__OVRGLTFTransformType GetTransformType(::StringW transform);

  /// @brief Method ToOVRInterpolationType, addr 0x274e1a8, size 0x154, virtual false, abstract: false, final false
  ...
  template <typename T> inline void CopyData(::System::Collections::Generic::List_1<T>* dest, ::ArrayW<T, ::Array<T>*> src);

  /// @brief Method CloneVector3, addr 0x274ced4, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 CloneVector3(::UnityEngine::Vector3 v);

  /// @brief Method CloneQuaternion, addr 0x274ced8, size 0x4, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field m_translations, offset: 0x50, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<::UnityEngine::Vector3>* ___m_translations;

  /// @brief Field m_rotations, offset: 0x58, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<::UnityEngine::Quaternion>* ___m_rotations;

  /// @brief Field m_scales, offset: 0x60, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<::UnityEngine::Vector3>* ___m_scales;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVRGLTFAnimatinonNode, 0x68>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::OVRGLTFAnimatinonNode, ___m_translations) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGLTFAnimatinonNode, ___m_rotations) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRGLTFAnimatinonNode, ___m_scales) == 0x60, "Offset mismatch!");
