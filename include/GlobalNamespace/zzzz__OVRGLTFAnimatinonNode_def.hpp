...
public:
  ...
  /// @brief Method AddChannel, addr 0x3facc18, size 0x190, virtual false, abstract: false, final false
  inline void AddChannel(::OVRSimpleJSON::JSONNode* channel, ::OVRSimpleJSON::JSONNode* samplers);

  /// @brief Method CloneQuaternion, addr 0x3facc14, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion CloneQuaternion(::UnityEngine::Quaternion q);

  /// @brief Method CloneVector3, addr 0x3facc10, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCardinalThumbsticks, addr 0x3fae034, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCardinalWeights, addr 0x3fae1e8, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTransformType, addr 0x3facda8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAnimationSampler, addr 0x3facf1c, size 0x7f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ToOVRInterpolationType, addr 0x3fae33c, size 0x164, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRGLTFAnimatinonNode_OVRInterpolationType ToOVRInterpolationType(::StringW interpolationType);

  /// @brief Method UpdatePose, addr 0x3fad710, size 0x194, virtual false, abstract: false, final false
  inline void UpdatePose(bool down);

  /// @brief Method UpdatePose, addr 0x3fadd04, size 0x330, virtual false, abstract: false, final false
  inline void UpdatePose(::UnityEngine::Vector2 joystick);

  /// @brief Method UpdatePose, addr 0x3fad8a4, size 0x460, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3fac8f8, size 0x318, virtual false, abstract: false, final false
