...
public:
  ...
  /// @brief Method AddChannel, addr 0x5ce8854, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method CloneQuaternion, addr 0x5ce8850, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Quaternion CloneQuaternion(::UnityEngine::Quaternion q);

  /// @brief Method CloneVector3, addr 0x5ce884c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCardinalThumbsticks, addr 0x5ce9b80, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCardinalWeights, addr 0x5ce9d20, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTransformType, addr 0x5ce8a00, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAnimationSampler, addr 0x5ce8b7c, size 0x580, virtual false, abstract: false, final false
  ...
  /// @brief Method SetScale, addr 0x5ce929c, size 0x100, virtual false, abstract: false, final false
  inline void SetScale(::UnityEngine::Vector3 scale);

  /// @brief Method ToOVRInterpolationType, addr 0x5ce9e88, size 0x148, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRGLTFAnimatinonNode_OVRInterpolationType ToOVRInterpolationType(::StringW interpolationType);

  /// @brief Method UpdatePose, addr 0x5ce90fc, size 0x1a0, virtual false, abstract: false, final false
  inline void UpdatePose(bool down);

  /// @brief Method UpdatePose, addr 0x5ce97e8, size 0x398, virtual false, abstract: false, final false
  inline void UpdatePose(::UnityEngine::Vector2 joystick);

  /// @brief Method UpdatePose, addr 0x5ce939c, size 0x44c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ce854c, size 0x300, virtual false, abstract: false, final false
