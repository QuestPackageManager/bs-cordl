...
public:
  ...
  /// @brief Method .ctor, addr 0x583ee98, size 0x48, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x583edd0, size 0x10, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x583ef60, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x583efd0, size 0x24, virtual true, abstract: false, final false
  inline float_t EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x583ef4c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x583eee0, size 0x6c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x583f010, size 0x36c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::SliderIntensityEffect__ProcessEffectCoroutine_d__27* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x583f430, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x583f438, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x583f470, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x583eff4, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x583f37c, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x583ee40, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x583eb98, size 0x238, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x583b5b0, size 0xb8, virtual false, abstract: false, final false
  inline void Init(float_t sliderDuration, float_t initialHalfJumpDuration, bool startVisible);

  /// @brief Method ManualUpdate, addr 0x583d3bc, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessEffectCoroutine, addr 0x583ede0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method StartIntensityDipEffect, addr 0x583dfa8, size 0x30, virtual false, abstract: false, final false
  inline void StartIntensityDipEffect();

  /// @brief Method StartIntensityFadeInEffect, addr 0x583dd88, size 0x30, virtual false, abstract: false, final false
  inline void StartIntensityFadeInEffect();

  /// @brief Method <Awake>b__24_0, addr 0x583ee60, size 0x1c, virtual false, abstract: false, final false
  inline void _Awake_b__24_0();

  /// @brief Method <Awake>b__24_1, addr 0x583ee7c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x583ee48, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_fadeInDidStartEvent, addr 0x583c624, size 0xac, virtual false, abstract: false, final false
  inline void add_fadeInDidStartEvent(::System::Action* value);

  /// @brief Method get_colorIntensity, addr 0x583eb74, size 0x24, virtual false, abstract: false, final false
  inline float_t get_colorIntensity();

  /// @brief Method get_intensity, addr 0x583afb4, size 0x24, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method remove_fadeInDidStartEvent, addr 0x583cc44, size 0xac, virtual false, abstract: false, final false
