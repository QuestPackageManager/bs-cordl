...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x262f84c, size 0x4, virtual true, abstract: false, final false
  inline void HighlightDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  static inline ::GlobalNamespace::BeatmapCharacteristicTableCell* New_ctor();

  /// @brief Method RefreshVisuals, addr 0x262f7d0, size 0x7c, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x262f7cc, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::__SelectableCell__TransitionType transitionType);

  /// @brief Method SetData, addr 0x262f76c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x262f850, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
