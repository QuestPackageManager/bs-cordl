...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x5853d40, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method RefreshVisuals, addr 0x5853cbc, size 0x84, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x5853cb8, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::SelectableCell_TransitionType transitionType);

  /// @brief Method SetData, addr 0x5853c58, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5853d44, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
