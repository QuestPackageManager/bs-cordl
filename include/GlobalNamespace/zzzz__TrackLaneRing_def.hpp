...
public:
  ...
  /// @brief Method FixedUpdateRing, addr 0x3b9fb8c, size 0x64, virtual false, abstract: false, final false
  inline void FixedUpdateRing(float_t fixedDeltaTime);

  /// @brief Method GetDestinationRotation, addr 0x3b9fc68, size 0x8, virtual false, abstract: false, final false
  inline float_t GetDestinationRotation();

  /// @brief Method GetRotation, addr 0x3b9fc60, size 0x8, virtual false, abstract: false, final false
  inline float_t GetRotation();

  /// @brief Method Init, addr 0x3b9fb14, size 0x78, virtual false, abstract: false, final false
  inline void Init(::UnityEngine::Vector3 position, ::UnityEngine::Vector3 positionOffset);

  /// @brief Method LateUpdateRing, addr 0x3b9fbf0, size 0x68, virtual false, abstract: false, final false
  inline void LateUpdateRing(float_t interpolationFactor);

  static inline ::GlobalNamespace::TrackLaneRing* New_ctor();

  /// @brief Method SetDestRotation, addr 0x3b9fc58, size 0x8, virtual false, abstract: false, final false
  inline void SetDestRotation(float_t destRotZ, float_t rotateSpeed);

  /// @brief Method SetPosition, addr 0x3b9fc70, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b9fc78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_destRotZ, addr 0x3b9fb0c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _rotZ, offset: 0x24, size: 0x4, def value: None
  float_t ____rotZ;

  /// @brief Field _destRotZ, offset: 0x28, size: 0x4, def value: None
  float_t ____destRotZ;

  /// @brief Field _rotationSpeed, offset: 0x2c, size: 0x4, def value: None
  float_t ____rotationSpeed;

  /// @brief Field _prevPosZ, offset: 0x30, size: 0x4, def value: None
  float_t ____prevPosZ;

  /// @brief Field _posZ, offset: 0x34, size: 0x4, def value: None
  float_t ____posZ;

  /// @brief Field _destPosZ, offset: 0x38, size: 0x4, def value: None
  float_t ____destPosZ;

  /// @brief Field _moveSpeed, offset: 0x3c, size: 0x4, def value: None
  float_t ____moveSpeed;

  /// @brief Field _positionOffset, offset: 0x40, size: 0xc, def value: None
...
static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____prevRotZ) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____rotZ) == 0x24, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____destRotZ) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____rotationSpeed) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____prevPosZ) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____posZ) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____destPosZ) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____moveSpeed) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____positionOffset) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRing, ____transform) == 0x50, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::TrackLaneRing, 0x58>, "Size mismatch!");
