...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x3bac510, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bac5bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
