...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x3bb14cc, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bb1578, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
