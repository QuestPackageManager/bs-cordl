...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x238741c, size 0xb0, virtual true, abstract: false, final true
  inline void ReturnToMenu();

  static inline ::GlobalNamespace::MissionLevelReturnToMenuController* New_ctor();

  /// @brief Method .ctor, addr 0x23874cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
