...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x2701700, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27017b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
