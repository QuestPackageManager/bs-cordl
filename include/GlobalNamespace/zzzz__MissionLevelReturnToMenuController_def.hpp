...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x24bdb38, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x24bdbec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
