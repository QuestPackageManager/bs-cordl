...
public:
  ...
  /// @brief Method .ctor, addr 0x24ff0c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x2503bb0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
