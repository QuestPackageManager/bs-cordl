...
public:
  ...
  /// @brief Method .ctor, addr 0x56acc28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x56b127c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
