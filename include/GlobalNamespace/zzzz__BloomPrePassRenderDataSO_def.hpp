...
public:
  ...
  /// @brief Method .ctor, addr 0x23e5700, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x23ea1ec, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
