...
public:
  ...
  /// @brief Method .ctor, addr 0x564bfe0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x5650634, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
