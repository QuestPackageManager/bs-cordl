...
public:
  ...
  /// @brief Method .ctor, addr 0x39d4aa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x39d8f68, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
