...
public:
  ...
  /// @brief Method .ctor, addr 0x571a89c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x571eef0, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
