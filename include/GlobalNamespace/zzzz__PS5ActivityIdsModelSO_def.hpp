...
public:
  ...
  /// @brief Method .ctor, addr 0x26eb52c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_competetiveActivities, addr 0x26eb524, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_progressActivities, addr 0x26eb51c, size 0x8, virtual false, abstract: false, final false
