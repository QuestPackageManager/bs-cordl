...
/// @brief Method Pause, addr 0x584c034, size 0xa4, virtual true, abstract: false, final true
inline void Pause() ;

/// @brief Method Resume, addr 0x584c0f4, size 0xa0, virtual true, abstract: false, final true
inline void Resume() ;

/// @brief Method WillResume, addr 0x584c0d8, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x584c194, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didPauseEvent, addr 0x584bc2c, size 0xac, virtual true, abstract: false, final true
inline void add_didPauseEvent(::System::Action*  value) ;

/// @brief Method add_didResumeEvent, addr 0x584bedc, size 0xac, virtual true, abstract: false, final true
inline void add_didResumeEvent(::System::Action*  value) ;

/// @brief Method add_willResumeEvent, addr 0x584bd84, size 0xac, virtual true, abstract: false, final true
inline void add_willResumeEvent(::System::Action*  value) ;

/// @brief Method get_isPaused, addr 0x584bc24, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method remove_didPauseEvent, addr 0x584bcd8, size 0xac, virtual true, abstract: false, final true
inline void remove_didPauseEvent(::System::Action*  value) ;

/// @brief Method remove_didResumeEvent, addr 0x584bf88, size 0xac, virtual true, abstract: false, final true
inline void remove_didResumeEvent(::System::Action*  value) ;

/// @brief Method remove_willResumeEvent, addr 0x584be30, size 0xac, virtual true, abstract: false, final true
