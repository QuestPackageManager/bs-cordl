...
public:
  ...
  /// @brief Method SetDistances, addr 0x57c8324, size 0x80, virtual false, abstract: false, final false
  inline void SetDistances(float_t distance);

  /// @brief Method SetText, addr 0x57c8d50, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57c8f0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alpha, addr 0x57c7e58, size 0x38, virtual false, abstract: false, final false
  inline float_t get_alpha();

  /// @brief Method get_fontSize, addr 0x57c7e20, size 0x38, virtual false, abstract: false, final false
  inline float_t get_fontSize();

  /// @brief Method set_alpha, addr 0x57c8210, size 0x9c, virtual false, abstract: false, final false
  inline void set_alpha(float_t value);

  /// @brief Method set_fontSize, addr 0x57c8198, size 0x64, virtual false, abstract: false, final false
  inline void set_fontSize(float_t value);

  /// @brief Method set_hide, addr 0x57c7df4, size 0x2c, virtual false, abstract: false, final false
