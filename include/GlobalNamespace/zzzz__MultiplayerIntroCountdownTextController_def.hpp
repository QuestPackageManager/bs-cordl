...
public:
  ...
  /// @brief Method SetDistances, addr 0x3bd691c, size 0x88, virtual false, abstract: false, final false
  inline void SetDistances(float_t distance);

  /// @brief Method SetText, addr 0x3bd72b0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bd7474, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alpha, addr 0x3bd63cc, size 0x40, virtual false, abstract: false, final false
  inline float_t get_alpha();

  /// @brief Method get_fontSize, addr 0x3bd6394, size 0x38, virtual false, abstract: false, final false
  inline float_t get_fontSize();

  /// @brief Method set_alpha, addr 0x3bd6824, size 0x80, virtual false, abstract: false, final false
  inline void set_alpha(float_t value);

  /// @brief Method set_fontSize, addr 0x3bd679c, size 0x70, virtual false, abstract: false, final false
  inline void set_fontSize(float_t value);

  /// @brief Method set_hide, addr 0x3bd6368, size 0x2c, virtual false, abstract: false, final false
