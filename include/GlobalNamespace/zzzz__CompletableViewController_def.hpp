...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompletableViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompletableViewController(CompletableViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompletableViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompletableViewController(CompletableViewControllerconst&) = delete;
