...
public:
  ...
  /// @brief Method .ctor, addr 0x26e4c78, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(float_t time, ::GlobalNamespace::ObstacleExecutionRating_Rating rating);

  /// @brief Method get_rating, addr 0x26e4c70, size 0x8, virtual false, abstract: false, final false
