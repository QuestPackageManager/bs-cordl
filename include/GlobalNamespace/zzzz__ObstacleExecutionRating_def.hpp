...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(10593)), TypeDefinitionIndex(TypeDefinitionIndex(10948))]
...
public:
  ...
  /// @brief Method get_rating, addr 0x12a1ecc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12a1ed4, size 0x28, virtual false, abstract: false, final false
