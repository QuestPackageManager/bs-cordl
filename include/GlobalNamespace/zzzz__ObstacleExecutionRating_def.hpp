...
/// @brief Field <rating>k__BackingField, offset 0x14, size 0x4 
 __declspec(property(get=__cordl_internal_get__rating_k__BackingField, put=__cordl_internal_set__rating_k__BackingField)) ::GlobalNamespace::ObstacleExecutionRating_Rating  _rating_k__BackingField;
...
/// @brief Method .ctor, addr 0x36417c4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(float_t  time, ::GlobalNamespace::ObstacleExecutionRating_Rating  rating) ;

/// @brief Method get_rating, addr 0x36417bc, size 0x8, virtual false, abstract: false, final false
