...
// Write type traits
MARK_REF_T(::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds*, "", "MixedLightsColorSetterRuntimeLightWithIds");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MixedLightsColorSetterRuntimeLightWithIds", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MixedLightsColorSetterRuntimeLightWithIds(MixedLightsColorSetterRuntimeLightWithIds&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MixedLightsColorSetterRuntimeLightWithIds", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MixedLightsColorSetterRuntimeLightWithIds(MixedLightsColorSetterRuntimeLightWithIdsconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MixedLightsColorSetterRuntimeLightWithIds) == 0x60, "Size mismatch!");
