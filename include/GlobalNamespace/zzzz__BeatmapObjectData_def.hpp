...
public:
  ...
  /// @brief Method .ctor, addr 0x220f3ac, size 0x48, virtual false, abstract: false, final false
  inline void _ctor(float_t time, float_t beat, int32_t subtypeIdentifier);

  /// @brief Method get_beat, addr 0x220f3a4, size 0x8, virtual false, abstract: false, final false
