...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ICutScoreBufferDidFinishReceiver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ICutScoreBufferDidFinishReceiver(ICutScoreBufferDidFinishReceiverconst&) = delete;
