...
/// @brief Method .ctor, addr 0x57083e0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ApplyLoudness, addr 0x57082bc, size 0x34, virtual false, abstract: false, final false
inline void ApplyLoudness(float_t  songLoudness) ;

static inline ::GlobalNamespace::AdaptiveSfxVolume* New_ctor() ;

/// @brief Method OnAudioFilterRead, addr 0x5707f20, size 0x18c, virtual false, abstract: false, final false
inline void OnAudioFilterRead(::ArrayW<float_t,::Array<float_t>*>  data, int32_t  channels) ;

/// @brief Method OnDisable, addr 0x5707ef4, size 0x2c, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method Start, addr 0x5707e98, size 0x54, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x5708210, size 0x34, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x57082f0, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;
