...
public:
  ...
  /// @brief Method get_platformLeaderboardId addr 0x21d6b88 size 0x8 virtual false final false
  inline ::StringW get_platformLeaderboardId();

  /// @brief Method get_difficultyBeatmapId addr 0x21d6b90 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21d6b98 size 0x2c virtual false final false
...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__LeaderboardIdsModelSO__LeaderboardIdData*>*> const& __get__leaderboardIds() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>*> const& __get__leaderboardIdMap() const;

  constexpr void __set__leaderboardIdMap(::System::Collections::Generic::Dictionary_2<::StringW, ::StringW>* value);

  /// @brief Method RebuildMap addr 0x21d6870 size 0x1a0 virtual false final false
  inline void RebuildMap();

  /// @brief Method OnEnable addr 0x21d6a10 size 0x1c virtual true final false
  inline void OnEnable();

  /// @brief Method TryGetPlatformLeaderboardId addr 0x21d6a2c size 0x9c virtual false final false
  ...
  /// @brief Method .ctor addr 0x21d6ac8 size 0xc0 virtual false final false
  inline void _ctor();
