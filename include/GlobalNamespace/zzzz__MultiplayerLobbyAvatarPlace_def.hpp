...
public:
  ...
  /// @brief Method SetPositionAndRotation addr 0x20d7c44 size 0x78 virtual false final false
  ...
  /// @brief Method .ctor addr 0x20d7cbc size 0x8 virtual false final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4107)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10978), inst: 2761 }),
// TypeDefinitionIndex(TypeDefinitionIndex(10978))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4106)) CS Name: ::MultiplayerLobbyAvatarPlace::Pool*
...
public:
  ...
  /// @brief Method .ctor addr 0x20d7cc4 size 0x48 virtual false final false
  inline void _ctor();
