...
public:
  ...
  /// @brief Method .ctor, addr 0x2712424, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetPositionAndRotation, addr 0x27123a4, size 0x78, virtual false, abstract: false, final false
  inline void SetPositionAndRotation(::UnityEngine::Vector3 worldPos, ::UnityEngine::Quaternion rotation);

  /// @brief Method .ctor, addr 0x271241c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
