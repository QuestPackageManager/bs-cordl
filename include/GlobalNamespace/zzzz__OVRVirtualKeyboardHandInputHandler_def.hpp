...
public:
  // Declarations
  /// @brief Method Awake, addr 0x40269e4, size 0x58, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRVirtualKeyboardHandInputHandler* New_ctor();

  /// @brief Method .ctor, addr 0x4026a3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
