...
public:
  ...
  /// @brief Method OnEnable, addr 0x22b3f5c, size 0x24, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x22b3f80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
