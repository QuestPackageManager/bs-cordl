...
public:
  ...
  /// @brief Method OnEnable, addr 0x3323fa0, size 0x28, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x3323fc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
