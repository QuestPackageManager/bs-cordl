...
public:
  ...
  /// @brief Method OnEnable, addr 0xeb81a4, size 0x24, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0xeb81c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
