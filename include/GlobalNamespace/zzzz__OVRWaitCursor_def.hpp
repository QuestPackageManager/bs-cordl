...
public:
  ...
  /// @brief Method Update, addr 0x2bcdb74, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2bcdbd0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
