...
public:
  ...
  /// @brief Method Update, addr 0x2918c44, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2918ca0, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
