...
public:
  ...
  /// @brief Method Update, addr 0x5ddbf9c, size 0x80, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5ddc01c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
