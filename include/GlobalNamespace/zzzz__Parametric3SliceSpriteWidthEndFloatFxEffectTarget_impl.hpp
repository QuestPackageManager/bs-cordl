...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::*)(int32_t, int32_t, float_t)>(&::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::SetValue)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0x57e3c88;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget*>::get(),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget*>::get(),
                                  4
                                ));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::*)(int32_t, int32_t, float_t)>(&::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::TriggerValue)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0x57e3d2c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::*)()>(&::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::_ctor)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x57e3dd0;
...
constexpr ::UnityW<::GlobalNamespace::Parametric3SliceSpriteController> const& GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::__cordl_internal_get__parametric3SliceSpriteController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____parametric3SliceSpriteController;
}
constexpr void GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget::__cordl_internal_set__parametric3SliceSpriteController(::UnityW<::GlobalNamespace::Parametric3SliceSpriteController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::Parametric3SliceSpriteWidthEndFloatFxEffectTarget*>());
}
// Ctor Parameters []
