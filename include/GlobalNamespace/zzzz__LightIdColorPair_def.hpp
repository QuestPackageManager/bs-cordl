...
public:
  ...
  /// @brief Method .ctor, addr 0x3c2a720, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightColor, addr 0x3c2a6cc, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_lightColor();

  /// @brief Method get_useScriptableObjectColor, addr 0x3c2a70c, size 0x8, virtual false, abstract: false, final false
  inline bool get_useScriptableObjectColor();

  /// @brief Method set_useScriptableObjectColor, addr 0x3c2a714, size 0xc, virtual false, abstract: false, final false
