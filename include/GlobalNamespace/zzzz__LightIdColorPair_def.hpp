...
public:
  ...
  /// @brief Method .ctor, addr 0x58f3564, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightColor, addr 0x58f3514, size 0x40, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_lightColor();

  /// @brief Method get_useScriptableObjectColor, addr 0x58f3554, size 0x8, virtual false, abstract: false, final false
  inline bool get_useScriptableObjectColor();

  /// @brief Method set_useScriptableObjectColor, addr 0x58f355c, size 0x8, virtual false, abstract: false, final false
