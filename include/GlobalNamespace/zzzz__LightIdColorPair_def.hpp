...
/// @brief Method .ctor, addr 0x58815f8, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_lightColor, addr 0x58815a8, size 0x40, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_lightColor() ;

/// @brief Method get_useScriptableObjectColor, addr 0x58815e8, size 0x8, virtual false, abstract: false, final false
inline bool get_useScriptableObjectColor() ;

/// @brief Method set_useScriptableObjectColor, addr 0x58815f0, size 0x8, virtual false, abstract: false, final false
...
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{23354};
