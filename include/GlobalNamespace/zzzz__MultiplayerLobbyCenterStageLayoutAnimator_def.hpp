...
public:
  ...
  /// @brief Method Move, addr 0x252bb00, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method StartCountdown, addr 0x252ba7c, size 0x84, virtual false, abstract: false, final false
  inline void StartCountdown();

  /// @brief Method StopCountdown, addr 0x252bc3c, size 0xa0, virtual false, abstract: false, final false
  inline void StopCountdown(bool instant);

  /// @brief Method <Move>b__7_0, addr 0x252bce4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252bcdc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
