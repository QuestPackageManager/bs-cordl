...
public:
  ...
  /// @brief Method Move, addr 0x58dd7b0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method StartCountdown, addr 0x58dd72c, size 0x84, virtual false, abstract: false, final false
  inline void StartCountdown();

  /// @brief Method StopCountdown, addr 0x58dd954, size 0xa0, virtual false, abstract: false, final false
  inline void StopCountdown(bool instant);

  /// @brief Method <Move>b__7_0, addr 0x58dd9f8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58dd9f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
