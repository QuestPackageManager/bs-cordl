...
public:
  ...
  /// @brief Method Move, addr 0x2408f88, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method StartCountdown, addr 0x2408f04, size 0x84, virtual false, abstract: false, final false
  inline void StartCountdown();

  /// @brief Method StopCountdown, addr 0x24090c4, size 0xa0, virtual false, abstract: false, final false
  inline void StopCountdown(bool instant);

  /// @brief Method <Move>b__7_0, addr 0x240916c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2409164, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
