...
public:
  ...
  /// @brief Method <UnlockAchievement>b__0, addr 0x26a2ca0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a2a80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Initialize, addr 0x26a19d8, size 0x170, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method IsAchievementUnlocked, addr 0x26a2b14, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnlockAchievement, addr 0x26a286c, size 0x180, virtual false, abstract: false, final false
  inline void UnlockAchievement(::GlobalNamespace::AchievementSO* achievement);

  /// @brief Method <Initialize>b__3_0, addr 0x26a2bfc, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a2b80, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
