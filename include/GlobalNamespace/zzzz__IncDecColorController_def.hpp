...
public:
  ...
  /// @brief Method Awake, addr 0x24d238c, size 0xb8, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method OnDestroy, addr 0x24d2444, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24d2548, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_color, addr 0x24d2360, size 0x2c, virtual false, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_enableDec, addr 0x24d2310, size 0x28, virtual false, abstract: false, final false
  inline void set_enableDec(bool value);

  /// @brief Method set_enableInc, addr 0x24d2338, size 0x28, virtual false, abstract: false, final false
