...
public:
  ...
  /// @brief Method InstallBindings, addr 0x271ba88, size 0x90, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x271bb18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
