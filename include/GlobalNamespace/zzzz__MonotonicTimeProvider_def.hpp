...
public:
  ...
  /// @brief Method GetTicks, addr 0xedbf58, size 0x58, virtual true, abstract: false, final true
  inline int64_t GetTicks();

  /// @brief Method GetTimeMs, addr 0xedbf2c, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xedbd94, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();
