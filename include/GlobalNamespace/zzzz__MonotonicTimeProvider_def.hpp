...
// Write type traits
MARK_REF_T(::GlobalNamespace::MonotonicTimeProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MonotonicTimeProvider*, "", "MonotonicTimeProvider");
...
public:
  ...
  __declspec(property(get = getStaticF_instance, put = setStaticF_instance)) ::GlobalNamespace::MonotonicTimeProvider* instance;

  /// @brief Convert operator to "::BGNet::Core::ITimeProvider"
  constexpr operator ::BGNet::Core::ITimeProvider*() noexcept;

  /// @brief Method GetTicks, addr 0x3338f3c, size 0x58, virtual true, abstract: false, final true
  inline int64_t GetTicks();

  /// @brief Method GetTimeMs, addr 0x3338f10, size 0x2c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3338d84, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MonotonicTimeProvider) == 0x28, "Size mismatch!");
