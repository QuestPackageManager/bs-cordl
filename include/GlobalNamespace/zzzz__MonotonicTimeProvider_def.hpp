...
/// @brief Method GetTicks, addr 0x323f810, size 0x58, virtual true, abstract: false, final true
inline int64_t GetTicks() ;

/// @brief Method GetTimeMs, addr 0x323f7e4, size 0x2c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x323f658, size 0xd4, virtual false, abstract: false, final false
inline void _ctor() ;
