...
/// @brief Method GetTicks, addr 0x327ca84, size 0x58, virtual true, abstract: false, final true
inline int64_t GetTicks() ;

/// @brief Method GetTimeMs, addr 0x327ca58, size 0x2c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x327c8cc, size 0xd4, virtual false, abstract: false, final false
inline void _ctor() ;
