...
public:
  ...
  /// @brief Method RefreshView, addr 0x3b026d8, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b02770, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_buyLevelButton, addr 0x3b026c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_buyLevelButton();

  /// @brief Method get_buyPackButton, addr 0x3b026d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_buyPackButton();

  /// @brief Method get_openPackButton, addr 0x3b026c8, size 0x8, virtual false, abstract: false, final false
