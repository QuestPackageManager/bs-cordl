...
/// @brief Method Awake, addr 0x583490c, size 0x50, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition* New_ctor() ;

/// @brief Method SetEnabled, addr 0x582f8dc, size 0x8, virtual false, abstract: false, final false
inline void SetEnabled(bool  isEnabled) ;

/// @brief Method Update, addr 0x583495c, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdatePositionAndRotationIfNeeded, addr 0x5834960, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5834bec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
