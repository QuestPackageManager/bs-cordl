...
public:
  ...
  /// @brief Method Awake, addr 0x59d8fbc, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition* New_ctor();

  /// @brief Method SetEnabled, addr 0x59d3c94, size 0x8, virtual false, abstract: false, final false
  inline void SetEnabled(bool isEnabled);

  /// @brief Method Update, addr 0x59d900c, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePositionAndRotationIfNeeded, addr 0x59d9010, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59d929c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
