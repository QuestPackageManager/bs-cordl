...
public:
  ...
  /// @brief Method Awake, addr 0x24e9920, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition* New_ctor();

  /// @brief Method SetEnabled, addr 0x24e4610, size 0xc, virtual false, abstract: false, final false
  inline void SetEnabled(bool isEnabled);

  /// @brief Method Update, addr 0x24e9970, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePositionAndRotationIfNeeded, addr 0x24e9974, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24e9bfc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
