...
public:
  ...
  /// @brief Method OnEnable, addr 0xf91894, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xf918fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
