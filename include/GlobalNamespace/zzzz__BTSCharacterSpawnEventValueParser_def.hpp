...
public:
  // Declarations
  /// @brief Method GetPrefabId addr 0x221bdbc size 0x8 virtual false final false
  static inline int32_t GetPrefabId(int32_t value);

  /// @brief Method GetAnimationId addr 0x221bdc4 size 0x8 virtual false final false
  static inline int32_t GetAnimationId(int32_t value);

  /// @brief Method GetIsAlternativeMaterial addr 0x221c1fc size 0x8 virtual false final false
  static inline bool GetIsAlternativeMaterial(int32_t value);

  /// @brief Method MergeValuesIntoOneInt addr 0x221c334 size 0x18 virtual false final false
