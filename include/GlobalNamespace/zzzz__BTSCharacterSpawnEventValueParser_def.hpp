...
// Write type traits
MARK_REF_T(::GlobalNamespace::BTSCharacterSpawnEventValueParser*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterSpawnEventValueParser*, "", "BTSCharacterSpawnEventValueParser");
...
public:
  // Declarations
  /// @brief Method GetAnimationId, addr 0x3286d18, size 0x8, virtual false, abstract: false, final false
  static inline int32_t GetAnimationId(int32_t value);

  /// @brief Method GetIsAlternativeMaterial, addr 0x32871ac, size 0x8, virtual false, abstract: false, final false
  static inline bool GetIsAlternativeMaterial(int32_t value);

  /// @brief Method GetPrefabId, addr 0x3286d10, size 0x8, virtual false, abstract: false, final false
  static inline int32_t GetPrefabId(int32_t value);

  /// @brief Method MergeValuesIntoOneInt, addr 0x3287350, size 0x18, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BTSCharacterSpawnEventValueParser", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BTSCharacterSpawnEventValueParser(BTSCharacterSpawnEventValueParser&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BTSCharacterSpawnEventValueParser", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BTSCharacterSpawnEventValueParser(BTSCharacterSpawnEventValueParserconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterSpawnEventValueParser) == 0x10, "Size mismatch!");
