...
// Write type traits
MARK_REF_T(::GlobalNamespace::XRSubsystemHelper*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::XRSubsystemHelper*, "", "XRSubsystemHelper");
...
public:
  ...
  /// @brief Method GetCurrentDisplaySubsystem, addr 0x585d26c, size 0x15c, virtual false, abstract: false, final false
  static inline Il2CppObject* GetCurrentDisplaySubsystem();

  /// @brief Method GetCurrentDisplaySubsystemDescriptor, addr 0x585d3c8, size 0x150, virtual false, abstract: false, final false
  static inline ::UnityEngine::XR::XRDisplaySubsystemDescriptor* GetCurrentDisplaySubsystemDescriptor();

  /// @brief Method GetCurrentInputSubsystem, addr 0x585d518, size 0x150, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRSubsystemHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRSubsystemHelper(XRSubsystemHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRSubsystemHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XRSubsystemHelper(XRSubsystemHelperconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::XRSubsystemHelper) == 0x10, "Size mismatch!");
