...
public:
  ...
  /// @brief Method ClearCurrentConnection, addr 0x58a5d78, size 0x8, virtual false, abstract: false, final false
  inline void ClearCurrentConnection();

  /// @brief Method ConnectToMatchmaking, addr 0x58a5964, size 0x368, virtual false, abstract: false, final false
  ...
  /// @brief Method ConnectToParty, addr 0x58a4fa8, size 0x340, virtual false, abstract: false, final false
  inline void ConnectToParty(::StringW serverCode);

  /// @brief Method ConnectToServer, addr 0x58a5718, size 0x24c, virtual false, abstract: false, final false
  inline void ConnectToServer(::GlobalNamespace::INetworkPlayer* server, ::StringW password);

  /// @brief Method CreateOrConnectToDestinationParty, addr 0x58a52e8, size 0x430, virtual false, abstract: false, final false
  inline void CreateOrConnectToDestinationParty(::GlobalNamespace::SelectMultiplayerLobbyDestination* lobbyDestination);

  /// @brief Method CreateParty, addr 0x58a487c, size 0x490, virtual false, abstract: false, final false
  inline void CreateParty(::GlobalNamespace::CreateServerFormData data);

  /// @brief Method HandleMultiplayerSessionManagerConnected, addr 0x58a5d80, size 0x280, virtual false, abstract: false, final false
  inline void HandleMultiplayerSessionManagerConnected();

  /// @brief Method HandleMultiplayerSessionManagerConnectionFailed, addr 0x58a4d0c, size 0x29c, virtual false, abstract: false, final false
  inline void HandleMultiplayerSessionManagerConnectionFailed(::GlobalNamespace::ConnectionFailedReason reason);

  /// @brief Method HandleMultiplayerSessionManagerConnectionFailedWithRetry, addr 0x58a6000, size 0x134, virtual false, abstract: false, final false
  inline void HandleMultiplayerSessionManagerConnectionFailedWithRetry(::GlobalNamespace::ConnectionFailedReason reason);

  /// @brief Method LeaveLobby, addr 0x58a5ccc, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a6134, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_connectionFailedEvent, addr 0x58a46cc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_connectionSuccessEvent, addr 0x58a4574, size 0xac, virtual false, abstract: false, final false
  inline void add_connectionSuccessEvent(::System::Action* value);

  /// @brief Method get_connectionFailedReason, addr 0x58a486c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ConnectionFailedReason get_connectionFailedReason();

  /// @brief Method get_connectionState, addr 0x58a484c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionState get_connectionState();

  /// @brief Method get_connectionType, addr 0x58a485c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionType get_connectionType();

  /// @brief Method remove_connectionFailedEvent, addr 0x58a478c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_connectionSuccessEvent, addr 0x58a4620, size 0xac, virtual false, abstract: false, final false
  inline void remove_connectionSuccessEvent(::System::Action* value);

  /// @brief Method set_connectionFailedReason, addr 0x58a4874, size 0x8, virtual false, abstract: false, final false
  inline void set_connectionFailedReason(::GlobalNamespace::ConnectionFailedReason value);

  /// @brief Method set_connectionState, addr 0x58a4854, size 0x8, virtual false, abstract: false, final false
  inline void set_connectionState(::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionState value);

  /// @brief Method set_connectionType, addr 0x58a4864, size 0x8, virtual false, abstract: false, final false
