...
/// @brief Field <connectionFailedReason>k__BackingField, offset 0x38, size 0x4 
 __declspec(property(get=__cordl_internal_get__connectionFailedReason_k__BackingField, put=__cordl_internal_set__connectionFailedReason_k__BackingField)) ::GlobalNamespace::ConnectionFailedReason  _connectionFailedReason_k__BackingField;

/// @brief Field <connectionState>k__BackingField, offset 0x30, size 0x4 
 __declspec(property(get=__cordl_internal_get__connectionState_k__BackingField, put=__cordl_internal_set__connectionState_k__BackingField)) ::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionState  _connectionState_k__BackingField;

/// @brief Field <connectionType>k__BackingField, offset 0x34, size 0x4 
 __declspec(property(get=__cordl_internal_get__connectionType_k__BackingField, put=__cordl_internal_set__connectionType_k__BackingField)) ::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionType  _connectionType_k__BackingField;
...
/// @brief Field connectionFailedEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_connectionFailedEvent, put=__cordl_internal_set_connectionFailedEvent)) ::System::Action_2<::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionType,::GlobalNamespace::ConnectionFailedReason>*  connectionFailedEvent;
...
/// @brief Method ClearCurrentConnection, addr 0x5833e34, size 0x8, virtual false, abstract: false, final false
inline void ClearCurrentConnection() ;

/// @brief Method ConnectToMatchmaking, addr 0x5833a20, size 0x368, virtual false, abstract: false, final false
...
/// @brief Method ConnectToParty, addr 0x5833064, size 0x340, virtual false, abstract: false, final false
inline void ConnectToParty(::StringW  serverCode) ;

/// @brief Method ConnectToServer, addr 0x58337d4, size 0x24c, virtual false, abstract: false, final false
inline void ConnectToServer(::GlobalNamespace::INetworkPlayer*  server, ::StringW  password) ;

/// @brief Method CreateOrConnectToDestinationParty, addr 0x58333a4, size 0x430, virtual false, abstract: false, final false
inline void CreateOrConnectToDestinationParty(::GlobalNamespace::SelectMultiplayerLobbyDestination*  lobbyDestination) ;

/// @brief Method CreateParty, addr 0x5832938, size 0x490, virtual false, abstract: false, final false
inline void CreateParty(::GlobalNamespace::CreateServerFormData  data) ;

/// @brief Method HandleMultiplayerSessionManagerConnected, addr 0x5833e3c, size 0x280, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerConnected() ;

/// @brief Method HandleMultiplayerSessionManagerConnectionFailed, addr 0x5832dc8, size 0x29c, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerConnectionFailed(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method HandleMultiplayerSessionManagerConnectionFailedWithRetry, addr 0x58340bc, size 0x134, virtual false, abstract: false, final false
inline void HandleMultiplayerSessionManagerConnectionFailedWithRetry(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method LeaveLobby, addr 0x5833d88, size 0xac, virtual false, abstract: false, final false
...
constexpr ::System::Action_2<::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionType,::GlobalNamespace::ConnectionFailedReason>* const& __cordl_internal_get_connectionFailedEvent() const;
...
constexpr void __cordl_internal_set_connectionFailedEvent(::System::Action_2<::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionType,::GlobalNamespace::ConnectionFailedReason>*  value) ;

constexpr void __cordl_internal_set_connectionSuccessEvent(::System::Action*  value) ;

/// @brief Method .ctor, addr 0x58341f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_connectionFailedEvent, addr 0x5832788, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method add_connectionSuccessEvent, addr 0x5832630, size 0xac, virtual false, abstract: false, final false
inline void add_connectionSuccessEvent(::System::Action*  value) ;

/// @brief Method get_connectionFailedReason, addr 0x5832928, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ConnectionFailedReason get_connectionFailedReason() ;

/// @brief Method get_connectionState, addr 0x5832908, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionState get_connectionState() ;

/// @brief Method get_connectionType, addr 0x5832918, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionType get_connectionType() ;

/// @brief Method remove_connectionFailedEvent, addr 0x5832848, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_connectionSuccessEvent, addr 0x58326dc, size 0xac, virtual false, abstract: false, final false
inline void remove_connectionSuccessEvent(::System::Action*  value) ;

/// @brief Method set_connectionFailedReason, addr 0x5832930, size 0x8, virtual false, abstract: false, final false
inline void set_connectionFailedReason(::GlobalNamespace::ConnectionFailedReason  value) ;

/// @brief Method set_connectionState, addr 0x5832910, size 0x8, virtual false, abstract: false, final false
inline void set_connectionState(::GlobalNamespace::MultiplayerLobbyConnectionController_LobbyConnectionState  value) ;

/// @brief Method set_connectionType, addr 0x5832920, size 0x8, virtual false, abstract: false, final false
