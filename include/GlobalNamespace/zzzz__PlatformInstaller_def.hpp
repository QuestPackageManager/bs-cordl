...
public:
  ...
  /// @brief Method BindAchievementsHandler, addr 0x271bd40, size 0x7c, virtual false, abstract: false, final false
  inline void BindAchievementsHandler();

  /// @brief Method BindAdditionalContentModel, addr 0x271bdbc, size 0x74, virtual false, abstract: false, final false
  inline void BindAdditionalContentModel();

  /// @brief Method BindAnalyticsModel, addr 0x271bca4, size 0x9c, virtual false, abstract: false, final false
  inline void BindAnalyticsModel();

  /// @brief Method BindBeatmapDataAssetFileModel, addr 0x271be30, size 0x7c, virtual false, abstract: false, final false
  inline void BindBeatmapDataAssetFileModel();

  /// @brief Method BindMockPlatformAdditionalContentModel, addr 0x271beb0, size 0x9c, virtual false, abstract: false, final false
  inline void BindMockPlatformAdditionalContentModel();

  /// @brief Method BindPSPlusHandler, addr 0x271beac, size 0x4, virtual false, abstract: false, final false
  inline void BindPSPlusHandler();

  /// @brief Method BindPlatformUserModel, addr 0x271bbc8, size 0xdc, virtual false, abstract: false, final false
  inline void BindPlatformUserModel();

  /// @brief Method InstallBindings, addr 0x271bb98, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x271bb20, size 0x78, virtual false, abstract: false, final false
