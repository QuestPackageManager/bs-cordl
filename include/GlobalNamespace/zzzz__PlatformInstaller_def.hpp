...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11133)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11133), inst: 3910 }),
// TypeDefinitionIndex(TypeDefinitionIndex(4105)), TypeDefinitionIndex(TypeDefinitionIndex(15394))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4039)) CS Name: ::PlatformInstaller*
