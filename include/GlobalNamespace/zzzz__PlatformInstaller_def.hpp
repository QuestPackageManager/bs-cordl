...
public:
  ...
  /// @brief Method BindAchievementsHandler, addr 0x2720084, size 0x7c, virtual false, abstract: false, final false
  inline void BindAchievementsHandler();

  /// @brief Method BindAdditionalContentModel, addr 0x2720100, size 0x74, virtual false, abstract: false, final false
  inline void BindAdditionalContentModel();

  /// @brief Method BindAnalyticsModel, addr 0x271ffe8, size 0x9c, virtual false, abstract: false, final false
  inline void BindAnalyticsModel();

  /// @brief Method BindBeatmapDataAssetFileModel, addr 0x2720174, size 0x7c, virtual false, abstract: false, final false
  inline void BindBeatmapDataAssetFileModel();

  /// @brief Method BindMockPlatformAdditionalContentModel, addr 0x27201f4, size 0x9c, virtual false, abstract: false, final false
  inline void BindMockPlatformAdditionalContentModel();

  /// @brief Method BindPSPlusHandler, addr 0x27201f0, size 0x4, virtual false, abstract: false, final false
  inline void BindPSPlusHandler();

  /// @brief Method BindPlatformUserModel, addr 0x271ff0c, size 0xdc, virtual false, abstract: false, final false
  inline void BindPlatformUserModel();

  /// @brief Method InstallBindings, addr 0x271fedc, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x271fe64, size 0x78, virtual false, abstract: false, final false
