...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UndoRedoBuffer_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UndoRedoBuffer_1(UndoRedoBuffer_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UndoRedoBuffer_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UndoRedoBuffer_1(UndoRedoBuffer_1const&) = delete;
