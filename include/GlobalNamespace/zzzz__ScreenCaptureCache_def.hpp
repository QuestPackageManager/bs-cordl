...
/// @brief Field _cache, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__cache, put=__cordl_internal_set__cache)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ScreenCaptureCache_ScreenshotType,::UnityW<::UnityEngine::Texture2D>>*  _cache;

/// @brief Method GetLastScreenshot, addr 0x5d99118, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method StoreScreenshot, addr 0x5d98e1c, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d99194, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
