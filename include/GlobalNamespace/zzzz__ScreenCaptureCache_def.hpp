...
public:
  ...
  /// @brief Method GetLastScreenshot, addr 0x408abac, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreScreenshot, addr 0x408a87c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408ac24, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
