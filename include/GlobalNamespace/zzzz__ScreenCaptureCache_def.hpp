...
public:
  ...
  /// @brief Method GetLastScreenshot, addr 0x5f4bef8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method StoreScreenshot, addr 0x5f4bbfc, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f4bf74, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScreenCaptureCache", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScreenCaptureCache(ScreenCaptureCache&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScreenCaptureCache", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScreenCaptureCache(ScreenCaptureCacheconst&) = delete;
