...
/// @brief Method InstallBindings, addr 0x5777edc, size 0xec4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5778da0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
