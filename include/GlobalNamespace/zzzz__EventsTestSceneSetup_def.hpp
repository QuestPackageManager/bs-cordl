...
public:
  ...
  /// @brief Method InstallBindings, addr 0x259c538, size 0xc48, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x259d180, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
