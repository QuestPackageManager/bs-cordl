...
public:
  ...
  /// @brief Method get_appId, addr 0x236805c, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_appId();

  /// @brief Method get_levelId, addr 0x2368064, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelId();

  static inline ::GlobalNamespace::__SteamLevelProductsModelSO__LevelProductData* New_ctor();

  /// @brief Method .ctor, addr 0x236806c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__levelProductsData,
                      put = __cordl_internal_set__levelProductsData))::ArrayW<::GlobalNamespace::__SteamLevelProductsModelSO__LevelProductData*,
  ...
  /// @brief Method get_bundleId, addr 0x2368074, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_bundleId();

  /// @brief Method get_levelPackId, addr 0x236807c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelPackId();

  /// @brief Method get_levelProductsData, addr 0x2368084, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x236808c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_targetLevelPackId, addr 0x2368094, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_targetLevelPackId();

  /// @brief Method get_shouldOwnLevelPackId, addr 0x236809c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_shouldOwnLevelPackId();

  /// @brief Method get_redirectedBundleId, addr 0x23680a4, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_redirectedBundleId();

  /// @brief Method get_validUntilDate, addr 0x23680ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23680b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::__SteamLevelProductsModelSO__LevelPackRedirectionData, ____targetLevelPackId) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SteamLevelProductsModelSO__LevelPackRedirectionData, ____shouldOwnLevelPackId) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SteamLevelProductsModelSO__LevelPackRedirectionData, ____redirectedBundleId) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__SteamLevelProductsModelSO__LevelPackRedirectionData, ____validUntilDate) == 0x28, "Offset mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__levelPackProductsData,
                      put = __cordl_internal_set__levelPackProductsData))::ArrayW<::GlobalNamespace::__SteamLevelProductsModelSO__LevelPackProductData*,
  ...
  __declspec(property(get = __cordl_internal_get__levelPackRedirectionData,
                      put = __cordl_internal_set__levelPackRedirectionData))::ArrayW<::GlobalNamespace::__SteamLevelProductsModelSO__LevelPackRedirectionData*,
  ...
  /// @brief Method get_levelPackProductsData, addr 0x2368044, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_levelPackRedirectionData, addr 0x236804c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2368054, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::SteamLevelProductsModelSO, ____levelPackRedirectionData) == 0x20, "Offset mismatch!");
