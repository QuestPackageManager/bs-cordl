...
public:
  ...
  /// @brief Method SetColors, addr 0x2626b0c, size 0x5c, virtual false, abstract: false, final false
  inline void SetColors();

  /// @brief Method Start, addr 0x2626b68, size 0x80, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2626be8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_saberType, addr 0x262662c, size 0xc, virtual false, abstract: false, final false
