...
// Write type traits
MARK_REF_T(::GlobalNamespace::SetSaberFakeGlowColor*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SetSaberFakeGlowColor*, "", "SetSaberFakeGlowColor");
...
public:
  ...
  /// @brief Method SetColors, addr 0x59ea7c0, size 0x5c, virtual false, abstract: false, final false
  inline void SetColors();

  /// @brief Method Start, addr 0x59ea81c, size 0x94, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59ea8b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_saberType, addr 0x59ea360, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SetSaberFakeGlowColor) == 0x50, "Size mismatch!");
