...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SimpleMemoryPool_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SimpleMemoryPool_1(SimpleMemoryPool_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SimpleMemoryPool_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SimpleMemoryPool_1(SimpleMemoryPool_1const&) = delete;
