...
public:
  ...
  /// @brief Method MoveNext, addr 0x5778d94, size 0x12c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::AudioManager__FadeMainVolume_d__47* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x5778ec0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5778ec8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5778f00, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5778d90, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5778d58, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method FadeMainVolume, addr 0x5778ce4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method Finalize, addr 0x5778770, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method OnResetAudio, addr 0x5778d60, size 0x30, virtual false, abstract: false, final false
  inline void OnResetAudio();

  /// @brief Method StartMainVolumeFade, addr 0x5778b98, size 0x14c, virtual false, abstract: false, final false
  inline void StartMainVolumeFade(::GlobalNamespace::AudioManager_AudioFadeType fadeType, float_t duration);

  /// @brief Method UpdateMainVolume, addr 0x5778898, size 0x8c, virtual false, abstract: false, final false
  inline void UpdateMainVolume();

  /// @brief Method UpdateMusicPitch, addr 0x5778a20, size 0x114, virtual false, abstract: false, final false
  inline void UpdateMusicPitch();

  /// @brief Method UpdateMusicSpeed, addr 0x5778b3c, size 0x5c, virtual false, abstract: false, final false
  inline void UpdateMusicSpeed();

  /// @brief Method UpdateMusicVolume, addr 0x577892c, size 0x60, virtual false, abstract: false, final false
  inline void UpdateMusicVolume();

  /// @brief Method UpdateSfxVolume, addr 0x5778994, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57785e4, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_mainVolume, addr 0x5778888, size 0x8, virtual false, abstract: false, final false
  inline float_t get_mainVolume();

  /// @brief Method get_mainVolumeFade, addr 0x5778880, size 0x8, virtual false, abstract: false, final false
  inline float_t get_mainVolumeFade();

  /// @brief Method get_sfxEnabled, addr 0x5778a08, size 0x8, virtual false, abstract: false, final false
  inline bool get_sfxEnabled();

  /// @brief Method get_sfxLatency, addr 0x5778578, size 0x6c, virtual false, abstract: false, final false
  inline float_t get_sfxLatency();

  /// @brief Method get_sfxVolume, addr 0x577898c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_sfxVolume();

  /// @brief Method set_mainVolume, addr 0x5778890, size 0x8, virtual false, abstract: false, final false
  inline void set_mainVolume(float_t value);

  /// @brief Method set_musicPitch, addr 0x5778a18, size 0x8, virtual false, abstract: false, final false
  inline void set_musicPitch(float_t value);

  /// @brief Method set_musicSpeed, addr 0x5778b34, size 0x8, virtual false, abstract: false, final false
  inline void set_musicSpeed(float_t value);

  /// @brief Method set_musicVolume, addr 0x5778924, size 0x8, virtual false, abstract: false, final false
  inline void set_musicVolume(float_t value);

  /// @brief Method set_sfxEnabled, addr 0x5778a10, size 0x8, virtual false, abstract: false, final false
  inline void set_sfxEnabled(bool value);

  /// @brief Method set_sfxVolume, addr 0x5777a04, size 0x8, virtual false, abstract: false, final false
