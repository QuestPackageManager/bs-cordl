...
// Write type traits
MARK_REF_T(::GlobalNamespace::SpectrogramMultiplierFloatFxEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpectrogramMultiplierFloatFxEffectTarget*, "", "SpectrogramMultiplierFloatFxEffectTarget");
...
public:
  ...
  /// @brief Method SetValue, addr 0x5997d94, size 0x88, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x5997e1c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5997ea4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SpectrogramMultiplierFloatFxEffectTarget) == 0x28, "Size mismatch!");
