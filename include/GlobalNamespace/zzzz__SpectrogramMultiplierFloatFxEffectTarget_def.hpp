...
public:
  ...
  /// @brief Method SetValue, addr 0x3b90794, size 0x84, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x3b90818, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b9089c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
