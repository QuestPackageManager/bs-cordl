...
/// @brief Field _sdfPointArray, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__sdfPointArray, put=__cordl_internal_set__sdfPointArray)) ::ArrayW<::UnityW<::GlobalNamespace::SDFPoint>,::Array<::UnityW<::GlobalNamespace::SDFPoint>>*>  _sdfPointArray;
...
/// @brief Method Awake, addr 0x572e700, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method InitIfNeeded, addr 0x572e704, size 0x70, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::SDFArrayManager* New_ctor() ;

/// @brief Method Update, addr 0x572e774, size 0x10c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x572e880, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
