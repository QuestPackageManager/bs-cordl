...
public:
  ...
  __declspec(property(get = __cordl_internal_get__sdfArrayValues, put = __cordl_internal_set__sdfArrayValues)) ::ArrayW<::UnityEngine::Vector4> _sdfArrayValues;

  /// @brief Field _sdfPointArray, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__sdfPointArray, put = __cordl_internal_set__sdfPointArray)) ::ArrayW<::UnityW<::GlobalNamespace::SDFPoint>> _sdfPointArray;
  ...
  /// @brief Method Awake, addr 0x58752f4, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x58752f8, size 0x70, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::SDFArrayManager* New_ctor();

  /// @brief Method Update, addr 0x5875368, size 0x10c, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__sdfArrayValues() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__sdfArrayValues();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::SDFPoint>> const& __cordl_internal_get__sdfPointArray() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::SDFPoint>>& __cordl_internal_get__sdfPointArray();

  constexpr void __cordl_internal_set__isInitialized(bool value);

  constexpr void __cordl_internal_set__sdfArrayValues(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__sdfPointArray(::ArrayW<::UnityW<::GlobalNamespace::SDFPoint>> value);

  /// @brief Method .ctor, addr 0x5875474, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector4> ____sdfArrayValues;
...
static_assert(sizeof(::GlobalNamespace::SDFArrayManager) == 0x38, "Size mismatch!");
