...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPoolContainer_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPoolContainer_1(MemoryPoolContainer_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPoolContainer_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPoolContainer_1(MemoryPoolContainer_1const&) = delete;
