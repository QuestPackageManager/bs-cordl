...
/// @brief Method HandleNoteWasMissed, addr 0x58506c4, size 0x184, virtual false, abstract: false, final false
inline void HandleNoteWasMissed(::GlobalNamespace::NoteController*  noteController) ;

static inline ::GlobalNamespace::MissedNoteEffectSpawner* New_ctor() ;

/// @brief Method OnDestroy, addr 0x585062c, size 0x98, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5850554, size 0xd8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x5850848, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
