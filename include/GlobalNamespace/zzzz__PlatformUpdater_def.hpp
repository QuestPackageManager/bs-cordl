...
/// @brief Method Tick, addr 0x3678c30, size 0xe4, virtual true, abstract: false, final true
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x3678c28, size 0x8, virtual false, abstract: false, final false
