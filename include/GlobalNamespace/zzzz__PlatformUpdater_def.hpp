...
public:
  ...
  /// @brief Method Tick, addr 0x36b599c, size 0xe4, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x36b5994, size 0x8, virtual false, abstract: false, final false
