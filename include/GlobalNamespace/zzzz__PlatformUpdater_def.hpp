...
public:
  ...
  /// @brief Method Tick, addr 0x37798d8, size 0xe4, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x37798d0, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlatformUpdater", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlatformUpdater(PlatformUpdater&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlatformUpdater", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlatformUpdater(PlatformUpdaterconst&) = delete;
