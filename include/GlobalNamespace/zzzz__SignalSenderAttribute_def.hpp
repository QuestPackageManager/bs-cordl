...
public:
  ...
  /// @brief Method .ctor, addr 0x56a4714, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::SignalSenderAttribute, 0x18>, "Size mismatch!");
