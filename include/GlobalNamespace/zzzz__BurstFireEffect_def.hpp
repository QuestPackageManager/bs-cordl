...
/// @brief Method Awake, addr 0x5712b3c, size 0x154, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method EndEffect, addr 0x57130b4, size 0x2c, virtual false, abstract: false, final false
inline void EndEffect() ;

/// @brief Method HandleColorChangeBeatmapEvent, addr 0x5712f38, size 0x17c, virtual true, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5712e84, size 0x94, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetInitialValues, addr 0x5712dd4, size 0xb0, virtual false, abstract: false, final false
inline void SetInitialValues() ;

/// @brief Method Start, addr 0x5712c90, size 0x18, virtual true, abstract: false, final false
inline void Start() ;

/// @brief Method StartEffect, addr 0x57130e0, size 0xd8, virtual false, abstract: false, final false
inline void StartEffect(float_t  time) ;

/// @brief Method UpdateFadeOutProgress, addr 0x5713238, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x571351c, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
