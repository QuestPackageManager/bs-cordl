...
public:
  ...
  /// @brief Method Awake, addr 0x57824d4, size 0x154, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method EndEffect, addr 0x5782a50, size 0x2c, virtual false, abstract: false, final false
  inline void EndEffect();

  /// @brief Method HandleColorChangeBeatmapEvent, addr 0x57828d4, size 0x17c, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x578281c, size 0x94, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetInitialValues, addr 0x578276c, size 0xb0, virtual false, abstract: false, final false
  inline void SetInitialValues();

  /// @brief Method Start, addr 0x5782628, size 0x18, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x5782a7c, size 0xd8, virtual false, abstract: false, final false
  inline void StartEffect(float_t time);

  /// @brief Method UpdateFadeOutProgress, addr 0x5782bd4, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5782eb8, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
