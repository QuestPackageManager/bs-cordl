...
MARK_REF_T(::GlobalNamespace::FloatTextureProcessor3DMappingVectorEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatTextureProcessor3DMappingVectorEffectTarget_TextureProcessor3DChannel, "", "FloatTextureProcessor3DMappingVectorEffectTarget/TextureProcessor3DChannel");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatTextureProcessor3DMappingVectorEffectTarget_TextureProcessor3DMapping, "", "FloatTextureProcessor3DMappingVectorEffectTarget/TextureProcessor3DMapping");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatTextureProcessor3DMappingVectorEffectTarget*, "", "FloatTextureProcessor3DMappingVectorEffectTarget");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::FloatTextureProcessor3DMappingVectorEffectTarget_TextureProcessor3DMapping) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::FloatTextureProcessor3DMappingVectorEffectTarget_TextureProcessor3DChannel) == 0x4, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = getStaticF__propertyStrings, put = setStaticF__propertyStrings)) ::ArrayW<::StringW> _propertyStrings;
  ...
  /// @brief Method SetFloat, addr 0x599653c, size 0x384, virtual false, abstract: false, final false
  inline void SetFloat(float_t value);

  /// @brief Method SetValue, addr 0x5996538, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x59968c0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59968c4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<::StringW> getStaticF__propertyStrings();

  static inline void setStaticF__propertyStrings(::ArrayW<::StringW> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatTextureProcessor3DMappingVectorEffectTarget", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatTextureProcessor3DMappingVectorEffectTarget(FloatTextureProcessor3DMappingVectorEffectTarget&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatTextureProcessor3DMappingVectorEffectTarget", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatTextureProcessor3DMappingVectorEffectTarget(FloatTextureProcessor3DMappingVectorEffectTargetconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::FloatTextureProcessor3DMappingVectorEffectTarget) == 0x70, "Size mismatch!");
