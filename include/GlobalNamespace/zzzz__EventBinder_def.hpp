...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EventBinder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EventBinder(EventBinder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EventBinder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EventBinder(EventBinderconst&) = delete;
