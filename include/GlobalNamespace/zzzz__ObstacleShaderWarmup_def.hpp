...
// Write type traits
MARK_REF_T(::GlobalNamespace::ObstacleShaderWarmup*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ObstacleShaderWarmup*, "", "ObstacleShaderWarmup");
...
public:
  ...
  /// @brief Method Start, addr 0x58dd77c, size 0x50, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58dd7cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::ObstacleShaderWarmup) == 0x30, "Size mismatch!");
