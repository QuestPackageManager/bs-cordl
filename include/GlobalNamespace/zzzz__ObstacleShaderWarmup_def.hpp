...
public:
  ...
  /// @brief Method Start, addr 0x3af7ebc, size 0x50, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3af7f0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
