...
public:
  ...
  /// @brief Method MoveNext, addr 0x247dfd4, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x247e0f4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x247e0fc, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x247e13c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x247dfd0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x247dedc, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ActivateMultiplayerLobbyAvatarManager, addr 0x247cfbc, size 0x2f4, virtual false, abstract: false, final false
  inline void ActivateMultiplayerLobbyAvatarManager();

  /// @brief Method AddPlayer, addr 0x247d2b0, size 0x464, virtual false, abstract: false, final false
  inline void AddPlayer(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method DeactivateMultiplayerLobbyAvatarManager, addr 0x247d714, size 0x424, virtual false, abstract: false, final false
  inline void DeactivateMultiplayerLobbyAvatarManager();

  /// @brief Method HandleLobbyStateDataModelPlayerConnected, addr 0x247db38, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyStateDataModelPlayerConnected(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method HandleLobbyStateDataModelPlayerDisconnected, addr 0x247db3c, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyStateDataModelPlayerDisconnected(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method Init, addr 0x247cfb4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePlayer, addr 0x247db40, size 0x164, virtual false, abstract: false, final false
  inline void RemovePlayer(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method RemovePlayerAndDestroy, addr 0x247de60, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x247df04, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::MultiplayerLobbyAvatarManager, ____lobbyStateDataModel) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLobbyAvatarManager, ____avatarControllerFactory) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLobbyAvatarManager, ____innerCircleRadius) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLobbyAvatarManager, ____minOuterCircleRadius) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLobbyAvatarManager, ____playerIdToAvatarMap) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLobbyAvatarManager, ____inProgressDespawnAnimations) == 0x38, "Offset mismatch!");
