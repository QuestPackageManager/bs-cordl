...
public:
  ...
  /// @brief Method MoveNext, addr 0x2712234, size 0x120, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2712354, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x271235c, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x271239c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2712230, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x271213c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ActivateMultiplayerLobbyAvatarManager, addr 0x271121c, size 0x2f4, virtual false, abstract: false, final false
  inline void ActivateMultiplayerLobbyAvatarManager();

  /// @brief Method AddPlayer, addr 0x2711510, size 0x464, virtual false, abstract: false, final false
  inline void AddPlayer(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method DeactivateMultiplayerLobbyAvatarManager, addr 0x2711974, size 0x424, virtual false, abstract: false, final false
  inline void DeactivateMultiplayerLobbyAvatarManager();

  /// @brief Method HandleLobbyStateDataModelPlayerConnected, addr 0x2711d98, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyStateDataModelPlayerConnected(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method HandleLobbyStateDataModelPlayerDisconnected, addr 0x2711d9c, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyStateDataModelPlayerDisconnected(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method Init, addr 0x2711214, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RemovePlayer, addr 0x2711da0, size 0x164, virtual false, abstract: false, final false
  inline void RemovePlayer(::GlobalNamespace::IConnectedPlayer* connectedPlayer);

  /// @brief Method RemovePlayerAndDestroy, addr 0x27120c0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2712164, size 0xcc, virtual false, abstract: false, final false
  inline void _ctor();
