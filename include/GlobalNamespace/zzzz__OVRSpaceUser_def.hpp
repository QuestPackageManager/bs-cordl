...
public:
  ...
  /// @brief Method Dispose, addr 0x5d97464, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method TryCreate, addr 0x5d972fc, size 0x48, virtual false, abstract: false, final false
  static inline bool TryCreate(::StringW platformUserId, ::ByRef<::GlobalNamespace::OVRSpaceUser> spaceUser);

  /// @brief Method TryCreate, addr 0x5d9728c, size 0x70, virtual false, abstract: false, final false
  static inline bool TryCreate(uint64_t platformUserId, ::ByRef<::GlobalNamespace::OVRSpaceUser> spaceUser);

  /// @brief Method .ctor, addr 0x5d973f8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(uint64_t spaceUserId);

  /// @brief Method get_Id, addr 0x5d9736c, size 0x8c, virtual false, abstract: false, final false
  inline uint64_t get_Id();

  /// @brief Method get_Valid, addr 0x5d97344, size 0x28, virtual false, abstract: false, final false
