...
public:
  ...
  /// @brief Method get_Valid, addr 0x27ad944, size 0x28, virtual false, abstract: false, final false
  inline bool get_Valid();

  /// @brief Method .ctor, addr 0x27ad96c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(uint64_t spaceUserId);

  /// @brief Method get_Id, addr 0x27aa558, size 0x7c, virtual false, abstract: false, final false
  inline uint64_t get_Id();

  /// @brief Method Dispose, addr 0x27ad9d4, size 0x64, virtual true, abstract: false, final true
  inline void Dispose();
