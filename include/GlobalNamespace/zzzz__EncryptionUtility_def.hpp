...
public:
  ...
  /// @brief Method ComputeReceiveMac, addr 0x332f520, size 0x2e8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ComputeReceiveMac(::ArrayW<uint8_t> data, int32_t offset, int32_t count);

  /// @brief Method ComputeSendMac, addr 0x332ea18, size 0x2e8, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> ComputeSendMac(::ArrayW<uint8_t> data, int32_t offset, int32_t count);

  /// @brief Method Dispose, addr 0x3330438, size 0xc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method EncryptData, addr 0x332ffa4, size 0x88, virtual true, abstract: false, final true
  inline void EncryptData(::ArrayW<uint8_t> data, ::by_ref<int32_t> offset, ::by_ref<int32_t> length, int32_t extraPrefixBytes);

  /// @brief Method GetNextSentSequenceNum, addr 0x332e974, size 0x20, virtual false, abstract: false, final false
  inline uint32_t GetNextSentSequenceNum();

  /// @brief Method IsValidSequenceNum, addr 0x332f3f4, size 0x12c, virtual false, abstract: false, final false
  inline bool IsValidSequenceNum(uint32_t sequenceNum);

  /// @brief Method MakeSeed, addr 0x33300ac, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method PRF, addr 0x3330190, size 0xec, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> PRF(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> seed, int32_t length);

  /// @brief Method PRF_Hash, addr 0x333027c, size 0x1bc, virtual false, abstract: false, final false
  static inline void PRF_Hash(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> seed, ::by_ref<int32_t> length);

  /// @brief Method PutSequenceNum, addr 0x332f808, size 0x1fc, virtual false, abstract: false, final false
  inline bool PutSequenceNum(uint32_t sequenceNum);

  /// @brief Method TryDecryptData, addr 0x333002c, size 0x80, virtual true, abstract: false, final true
  inline bool TryDecryptData(::ArrayW<uint8_t> data, ::by_ref<int32_t> offset, ::by_ref<int32_t> length);
  ...
  /// @brief Method .ctor, addr 0x332de2c, size 0x270, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> preMasterSecret, ::ArrayW<uint8_t> serverSeed, ::ArrayW<uint8_t> clientSeed, bool isClient);

  /// @brief Method get_isValid, addr 0x332ff98, size 0xc, virtual true, abstract: false, final true
  inline bool get_isValid();
...
public:
  ...
  /// @brief Method <CreateEncryptionStateAsync>b__0, addr 0x3330444, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x332e238, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateEncryptionState, addr 0x332dda8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateEncryptionStateAsync, addr 0x332e09c, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptData, addr 0x332e254, size 0x720, virtual false, abstract: false, final false
  ...
  /// @brief Method FastCopyBlock, addr 0x332fa04, size 0x314, virtual false, abstract: false, final false
  static inline void FastCopyBlock(::ArrayW<uint8_t> inArr, int32_t inOff, ::ArrayW<uint8_t> outArr, int32_t outOff);

  /// @brief Method FastCopyMac, addr 0x332fd18, size 0x1f4, virtual false, abstract: false, final false
  static inline void FastCopyMac(::ArrayW<uint8_t> inArr, int32_t inOff, ::ArrayW<uint8_t> outArr, int32_t outOff);

  /// @brief Method IsValidLength, addr 0x332e23c, size 0x18, virtual false, abstract: false, final false
  static inline bool IsValidLength(int32_t length);

  /// @brief Method Log, addr 0x332ff0c, size 0x8c, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method TryDecryptData, addr 0x332ed00, size 0x6f4, virtual false, abstract: false, final false
