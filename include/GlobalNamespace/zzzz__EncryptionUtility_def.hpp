...
public:
  ...
  /// @brief Method ComputeReceiveMac, addr 0x22c9a5c, size 0x240, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ComputeReceiveMac(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t count);

  /// @brief Method ComputeSendMac, addr 0x22c9044, size 0x240, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ComputeSendMac(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t offset, int32_t count);

  /// @brief Method Dispose, addr 0x22caa28, size 0x18, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method EncryptData, addr 0x22ca568, size 0x84, virtual true, abstract: false, final true
  inline void EncryptData(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::ByRef<int32_t> offset, ::ByRef<int32_t> length, int32_t extraPrefixBytes);

  /// @brief Method GetNextSentSequenceNum, addr 0x22c9038, size 0xc, virtual false, abstract: false, final false
  inline uint32_t GetNextSentSequenceNum();

  /// @brief Method IsValidSequenceNum, addr 0x22c9930, size 0x12c, virtual false, abstract: false, final false
  inline bool IsValidSequenceNum(uint32_t sequenceNum);

  /// @brief Method MakeSeed, addr 0x22ca668, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method PRF, addr 0x22ca748, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method PRF_Hash, addr 0x22ca830, size 0x1f8, virtual false, abstract: false, final false
  static inline void PRF_Hash(::ArrayW<uint8_t, ::Array<uint8_t>*> key, ::ArrayW<uint8_t, ::Array<uint8_t>*> seed, ::ByRef<int32_t> length);

  /// @brief Method PutSequenceNum, addr 0x22c9c9c, size 0x1f8, virtual false, abstract: false, final false
  inline bool PutSequenceNum(uint32_t sequenceNum);

  /// @brief Method TryDecryptData, addr 0x22ca5ec, size 0x7c, virtual true, abstract: false, final true
  inline bool TryDecryptData(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::ByRef<int32_t> offset, ::ByRef<int32_t> length);
  ...
  /// @brief Method .ctor, addr 0x22c871c, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isValid, addr 0x22ca550, size 0x18, virtual true, abstract: false, final true
  inline bool get_isValid();
...
public:
  ...
  /// @brief Method <CreateEncryptionStateAsync>b__0, addr 0x22caa40, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22c8978, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateEncryptionState, addr 0x22c869c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateEncryptionStateAsync, addr 0x22c630c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method EncryptData, addr 0x22c89a0, size 0x698, virtual false, abstract: false, final false
  ...
  /// @brief Method FastCopyBlock, addr 0x22c9e94, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method FastCopyMac, addr 0x22ca1a8, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsValidLength, addr 0x22c8980, size 0x20, virtual false, abstract: false, final false
  static inline bool IsValidLength(int32_t length);

  /// @brief Method Log, addr 0x22ca39c, size 0x8c, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  /// @brief Method TryDecryptData, addr 0x22c9284, size 0x6ac, virtual false, abstract: false, final false
