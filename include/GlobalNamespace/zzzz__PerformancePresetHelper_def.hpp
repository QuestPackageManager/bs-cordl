...
// TypeDefinitionIndex(TypeDefinitionIndex(3402)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14033), inst: 857 }), TypeDefinitionIndex(TypeDefinitionIndex(3843)),
// TypeDefinitionIndex(TypeDefinitionIndex(10208)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3402), inst: 866 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3843), inst: 896 }), TypeDefinitionIndex(TypeDefinitionIndex(4443)), TypeDefinitionIndex(TypeDefinitionIndex(14033)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3835), inst: 401 }), TypeDefinitionIndex(TypeDefinitionIndex(3394))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4447)) CS Name:
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3402)), TypeDefinitionIndex(TypeDefinitionIndex(3394)), TypeDefinitionIndex(TypeDefinitionIndex(14021)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3402), inst: 105 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3835), inst: 3200 }),
// TypeDefinitionIndex(TypeDefinitionIndex(3835)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 793 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(4448)) CS
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10208)), TypeDefinitionIndex(TypeDefinitionIndex(3835)), TypeDefinitionIndex(TypeDefinitionIndex(3394)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 857 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3402), inst: 896 }),
// TypeDefinitionIndex(TypeDefinitionIndex(14033)), TypeDefinitionIndex(TypeDefinitionIndex(3402)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14033), inst: 857 }),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3835), inst: 401 }), TypeDefinitionIndex(TypeDefinitionIndex(4443))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4449)) CS
// Name: ::PerformancePresetHelper::<GetPerformancePresetAsync>d__5
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2507)), TypeDefinitionIndex(TypeDefinitionIndex(14021)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 793
// }), TypeDefinitionIndex(TypeDefinitionIndex(3402)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3835), inst: 3200 }), TypeDefinitionIndex(TypeDefinitionIndex(4443)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2507), inst: 5315 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3402), inst: 870 }),
// TypeDefinitionIndex(TypeDefinitionIndex(3394)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 896 }), TypeDefinitionIndex(TypeDefinitionIndex(3835))} Self:
