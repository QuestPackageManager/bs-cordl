...
public:
  ...
  /// @brief Method OnEnable, addr 0x58757f0, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x5875888, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Setup, addr 0x58757f4, size 0x94, virtual false, abstract: false, final false
  inline void Setup();

  /// @brief Method .ctor, addr 0x587588c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
