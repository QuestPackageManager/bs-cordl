...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GroundShadow", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GroundShadow(GroundShadow&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GroundShadow", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GroundShadow(GroundShadowconst&) = delete;
