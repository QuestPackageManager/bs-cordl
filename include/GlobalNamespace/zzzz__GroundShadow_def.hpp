...
public:
  ...
  /// @brief Method OnEnable, addr 0x572d270, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x572d308, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Setup, addr 0x572d274, size 0x94, virtual false, abstract: false, final false
  inline void Setup();

  /// @brief Method .ctor, addr 0x572d30c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
