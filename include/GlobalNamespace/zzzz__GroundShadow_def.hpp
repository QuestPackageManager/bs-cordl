...
public:
  ...
  /// @brief Method OnEnable, addr 0x39e6db0, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x39e6e50, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Setup, addr 0x39e6db4, size 0x9c, virtual false, abstract: false, final false
  inline void Setup();

  /// @brief Method .ctor, addr 0x39e6e54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
