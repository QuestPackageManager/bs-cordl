...
public:
  ...
  /// @brief Method OnEnable, addr 0x3990e68, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x3990f08, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Setup, addr 0x3990e6c, size 0x9c, virtual false, abstract: false, final false
  inline void Setup();

  /// @brief Method .ctor, addr 0x3990f0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
