...
public:
  // Declarations
  /// @brief Method Approximately, addr 0x22b2e70, size 0x10, virtual false, abstract: false, final false
  static inline bool Approximately(float_t a, float_t b, float_t precision);

  /// @brief Method MaxAbs, addr 0x22b2e5c, size 0x14, virtual false, abstract: false, final false
  static inline float_t MaxAbs(float_t a, float_t b);

  /// @brief Method Mod, addr 0x22b2d00, size 0x14, virtual false, abstract: false, final false
  static inline float_t Mod(float_t value, float_t mod);

  /// @brief Method Mod, addr 0x22b2d14, size 0x30, virtual false, abstract: false, final false
  static inline int32_t Mod(int32_t value, int32_t mod);

  /// @brief Method Repeat, addr 0x22b30f0, size 0x90, virtual false, abstract: false, final false
  static inline int32_t Repeat(int32_t t, int32_t length);

  /// @brief Method Round, addr 0x22b2eb4, size 0x23c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 Round(::UnityEngine::Vector4 value, int32_t digits);

  /// @brief Method Round, addr 0x22b2d44, size 0x118, virtual false, abstract: false, final false
  static inline float_t Round(float_t value, int32_t decimals);

  /// @brief Method ShortestAngleDifference, addr 0x22b2e80, size 0x34, virtual false, abstract: false, final false
