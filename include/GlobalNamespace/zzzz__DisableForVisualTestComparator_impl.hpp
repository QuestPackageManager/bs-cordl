...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DisableForVisualTestComparator::*)(::GlobalNamespace::DeterminismConfig*)>(&::GlobalNamespace::DisableForVisualTestComparator::Init)> {
  constexpr static std::size_t size = 0x9c;
  constexpr static std::size_t addrs = 0x57d3154;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DisableForVisualTestComparator*>::get(),
                        "Init",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DisableForVisualTestComparator::*)()>(&::GlobalNamespace::DisableForVisualTestComparator::OnDestroy)> {
  constexpr static std::size_t size = 0xd0;
  constexpr static std::size_t addrs = 0x57d31f0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DisableForVisualTestComparator::*)(bool)>(&::GlobalNamespace::DisableForVisualTestComparator::OnDeterminismSet)> {
  constexpr static std::size_t size = 0x254;
  constexpr static std::size_t addrs = 0x57d32c0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DisableForVisualTestComparator::*)()>(&::GlobalNamespace::DisableForVisualTestComparator::_ctor)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x57d3514;
...
constexpr ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MonoBehaviour>>* const& GlobalNamespace::DisableForVisualTestComparator::__cordl_internal_get__disableSpecificComponents() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____disableSpecificComponents;
}
