...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::MissionCompletionResults::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2352510;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionCompletionResults*>::get(),
                                                                               "get_IsMissionComplete", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MissionCompletionResults::*)(
  ...
  constexpr static std::size_t addrs = 0x2352578;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionCompletionResults*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
constexpr ::GlobalNamespace::LevelCompletionResults*& GlobalNamespace::MissionCompletionResults::__get_levelCompletionResults() {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->___levelCompletionResults;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelCompletionResults*> const& GlobalNamespace::MissionCompletionResults::__get_levelCompletionResults() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->___levelCompletionResults;
}
...
constexpr ::ArrayW<::GlobalNamespace::MissionObjectiveResult*, ::Array<::GlobalNamespace::MissionObjectiveResult*>*>& GlobalNamespace::MissionCompletionResults::__get_missionObjectiveResults() {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
...
GlobalNamespace::MissionCompletionResults::__get_missionObjectiveResults() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->___missionObjectiveResults;
}
constexpr void
GlobalNamespace::MissionCompletionResults::__set_missionObjectiveResults(::ArrayW<::GlobalNamespace::MissionObjectiveResult*, ::Array<::GlobalNamespace::MissionObjectiveResult*>*> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
...
GlobalNamespace::MissionCompletionResults::New_ctor(::GlobalNamespace::LevelCompletionResults* levelCompletionResults,
  ...
  return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::MissionCompletionResults*>(levelCompletionResults, missionObjectiveResults));
}
