...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b568f4, size 0x2c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b56bb8, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b56bc8, size 0x254, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::PlatformLeaderboardViewController__RefreshDelayed_d__33* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b56e1c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b56e24, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b56e5c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3b56bc4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b56790, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearContent, addr 0x3b567b8, size 0xbc, virtual false, abstract: false, final false
  inline void ClearContent();

  /// @brief Method DidActivate, addr 0x3b55a3c, size 0x53c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b5600c, size 0x118, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleDidPressRefreshButton, addr 0x3b56320, size 0xc, virtual false, abstract: false, final false
  inline void HandleDidPressRefreshButton();

  /// @brief Method HandleLeaderboardsResultsReturned, addr 0x3b5632c, size 0x264, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method HandlePlatformLeaderboardsModelAllScoresDidUpload, addr 0x3b56600, size 0xc, virtual false, abstract: false, final false
  inline void HandlePlatformLeaderboardsModelAllScoresDidUpload();

  /// @brief Method HandleScopeSegmentedControlDidSelectCell, addr 0x3b56590, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b56124, size 0x1c0, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x3b55960, size 0xac, virtual false, abstract: false, final false
  inline void Refresh(bool showLoadingIndicator, bool clear);

  /// @brief Method RefreshAsync, addr 0x3b5660c, size 0x104, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RefreshAsync(bool showLoadingIndicator, bool clear);

  /// @brief Method RefreshDelayed, addr 0x3b56710, size 0x80, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* RefreshDelayed(bool showLoadingIndicator, bool clear);

  /// @brief Method RefreshLevelStats, addr 0x3b55a0c, size 0x30, virtual true, abstract: false, final false
  inline void RefreshLevelStats();

  /// @brief Method ScopeScopeIndexToScoreScope, addr 0x3b562e4, size 0x3c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope ScopeScopeIndexToScoreScope(int32_t scoreScopeIndex);

  /// @brief Method ScoreScopeToScoreScopeIndex, addr 0x3b55f78, size 0x94, virtual false, abstract: false, final false
  inline int32_t ScoreScopeToScoreScopeIndex(::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope scoresScope);

  /// @brief Method SetData, addr 0x3b558c4, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b56874, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope getStaticF__scoresScope();

  /// @brief Method get_leaderboardsModel, addr 0x3b558bc, size 0x8, virtual false, abstract: false, final false
