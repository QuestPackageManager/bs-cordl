...
public:
  ...
  /// @brief Method MoveNext, addr 0x57a9acc, size 0x2d4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x57a9da0, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x57a9dac, size 0x308, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::PlatformLeaderboardViewController__RefreshDelayed_d__37* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x57aa0b4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x57aa0bc, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x57aa0f4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x57a9da8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x57a9844, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ClearContent, addr 0x57a984c, size 0xe4, virtual false, abstract: false, final false
  inline void ClearContent();

  /// @brief Method DidActivate, addr 0x57a87f0, size 0x62c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57a8eb4, size 0x1d8, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleDidPressRefreshButton, addr 0x57a9300, size 0x20, virtual false, abstract: false, final false
  inline void HandleDidPressRefreshButton();

  /// @brief Method HandleGameplayModifiersDidChange, addr 0x57a9320, size 0x8c, virtual false, abstract: false, final false
  inline void HandleGameplayModifiersDidChange();

  /// @brief Method HandleLeaderboardsResultsReturned, addr 0x57a93ac, size 0x270, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method HandlePlatformLeaderboardsModelAllScoresDidUpload, addr 0x57a9698, size 0x20, virtual false, abstract: false, final false
  inline void HandlePlatformLeaderboardsModelAllScoresDidUpload();

  /// @brief Method HandleScopeSegmentedControlDidSelectCell, addr 0x57a961c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x57a908c, size 0x238, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x57a85e0, size 0xc0, virtual false, abstract: false, final false
  inline void Refresh(bool showLoadingIndicator, bool clear);

  /// @brief Method RefreshAsync, addr 0x57a96b8, size 0x118, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* RefreshAsync(bool showLoadingIndicator, bool clear);

  /// @brief Method RefreshBeatLeaderboards, addr 0x57a86a0, size 0x120, virtual false, abstract: false, final false
  inline void RefreshBeatLeaderboards();

  /// @brief Method RefreshDelayed, addr 0x57a97d0, size 0x74, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* RefreshDelayed(bool showLoadingIndicator, bool clear);

  /// @brief Method RefreshLevelStats, addr 0x57a87c0, size 0x30, virtual true, abstract: false, final false
  inline void RefreshLevelStats();

  /// @brief Method ScopeScopeIndexToScoreScope, addr 0x57a92c4, size 0x3c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope ScopeScopeIndexToScoreScope(int32_t scoreScopeIndex);

  /// @brief Method ScoreScopeToScoreScopeIndex, addr 0x57a8e1c, size 0x98, virtual false, abstract: false, final false
  inline int32_t ScoreScopeToScoreScopeIndex(::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope scoresScope);

  /// @brief Method SetData, addr 0x57a84d4, size 0x10c, virtual true, abstract: false, final false
  inline void SetData(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method <RefreshBeatLeaderboards>b__38_0, addr 0x57a99e8, size 0x4c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* _RefreshBeatLeaderboards_b__38_0();

  /// @brief Method <RefreshBeatLeaderboards>b__38_1, addr 0x57a9a34, size 0x4c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* _RefreshBeatLeaderboards_b__38_1();

  /// @brief Method <RefreshBeatLeaderboards>b__38_2, addr 0x57a9a80, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a9930, size 0xb8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope getStaticF__scoresScope();

  /// @brief Method get_leaderboardsModel, addr 0x57a84cc, size 0x8, virtual false, abstract: false, final false
