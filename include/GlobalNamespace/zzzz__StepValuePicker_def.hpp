...
public:
  ...
  /// @brief Method DecButtonPressed, addr 0x58f31f4, size 0x1c, virtual false, abstract: false, final false
  inline void DecButtonPressed();

  /// @brief Method IncButtonPressed, addr 0x58f31d8, size 0x1c, virtual false, abstract: false, final false
  inline void IncButtonPressed();

  static inline ::GlobalNamespace::StepValuePicker* New_ctor();

  /// @brief Method OnDisable, addr 0x58f3084, size 0x154, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58f2f30, size 0x154, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f3210, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_decButtonWasPressedEvent, addr 0x58f2280, size 0xac, virtual false, abstract: false, final false
  inline void add_decButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_incButtonWasPressedEvent, addr 0x58f232c, size 0xac, virtual false, abstract: false, final false
  inline void add_incButtonWasPressedEvent(::System::Action* value);

  /// @brief Method get_text, addr 0x58f2f10, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method remove_decButtonWasPressedEvent, addr 0x58f2544, size 0xac, virtual false, abstract: false, final false
  inline void remove_decButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_incButtonWasPressedEvent, addr 0x58f25f0, size 0xac, virtual false, abstract: false, final false
  inline void remove_incButtonWasPressedEvent(::System::Action* value);

  /// @brief Method set_decButtonInteractable, addr 0x58f20b8, size 0x1c, virtual false, abstract: false, final false
  inline void set_decButtonInteractable(bool value);

  /// @brief Method set_incButtonInteractable, addr 0x58f20fc, size 0x1c, virtual false, abstract: false, final false
  inline void set_incButtonInteractable(bool value);

  /// @brief Method set_text, addr 0x58f2144, size 0x20, virtual false, abstract: false, final false
