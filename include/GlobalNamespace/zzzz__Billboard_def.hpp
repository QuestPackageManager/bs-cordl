...
public:
  ...
  /// @brief Method Awake, addr 0x56a02d8, size 0x1c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::Billboard* New_ctor();

  /// @brief Method OnWillRenderObject, addr 0x56a02f4, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56a03c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
