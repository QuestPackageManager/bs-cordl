...
// Write type traits
MARK_REF_T(::GlobalNamespace::IGameEnergyCounter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IGameEnergyCounter*, "", "IGameEnergyCounter");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IGameEnergyCounter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IGameEnergyCounter(IGameEnergyCounterconst&) = delete;
