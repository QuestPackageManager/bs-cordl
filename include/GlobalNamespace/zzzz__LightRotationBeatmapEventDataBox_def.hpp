...
public:
  ...
  /// @brief Method Unpack, addr 0x12c049c, size 0x580, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12c0268, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x12c0260, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x12c0258, size 0x8, virtual true, abstract: false, final false
