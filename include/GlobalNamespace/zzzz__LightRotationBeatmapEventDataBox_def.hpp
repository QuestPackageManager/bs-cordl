...
public:
  ...
  /// @brief Method Unpack, addr 0x26bbcf4, size 0x970, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bbac4, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x26bbabc, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x26bbab4, size 0x8, virtual true, abstract: false, final false
