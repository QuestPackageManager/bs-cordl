...
public:
  ...
  /// @brief Method Unpack, addr 0x12e77f0, size 0x580, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12e75bc, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x12e75b4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x12e75ac, size 0x8, virtual true, abstract: false, final false
