...
public:
  ...
  /// @brief Method SetAfterIntroValues, addr 0x59c7a28, size 0x48, virtual false, abstract: false, final false
  inline void SetAfterIntroValues();

  /// @brief Method SetBeforeIntroValues, addr 0x59c7a10, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59c7a70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
