...
public:
  ...
  /// @brief Method SetBeforeIntroValues, addr 0x239b1b8, size 0x1c, virtual false, abstract: false, final false
  inline void SetBeforeIntroValues();

  /// @brief Method SetAfterIntroValues, addr 0x239b1d4, size 0x48, virtual false, abstract: false, final false
  inline void SetAfterIntroValues();

  static inline ::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator* New_ctor();

  /// @brief Method .ctor, addr 0x239b21c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
