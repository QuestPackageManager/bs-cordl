...
public:
  ...
  /// @brief Method SetGlobalShaderValues, addr 0x408ff10, size 0x88, virtual false, abstract: false, final false
  static inline void SetGlobalShaderValues(float_t baseColorBoost, float_t baseColorBoostThreshold);

  /// @brief Method .ctor, addr 0x40908f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
