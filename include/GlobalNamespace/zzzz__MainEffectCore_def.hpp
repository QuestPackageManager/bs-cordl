...
public:
  ...
  /// @brief Method SetGlobalShaderValues, addr 0x5e06ee8, size 0xc8, virtual false, abstract: false, final false
  static inline void SetGlobalShaderValues(float_t baseColorBoost, float_t baseColorBoostThreshold);

  /// @brief Method UpdateKeyword, addr 0x5e07998, size 0x5c, virtual false, abstract: false, final false
