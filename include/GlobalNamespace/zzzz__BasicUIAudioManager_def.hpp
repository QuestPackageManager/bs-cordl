...
public:
  ...
  /// @brief Method HandleButtonClickEvent, addr 0x3bf8b90, size 0xd0, virtual false, abstract: false, final false
  inline void HandleButtonClickEvent();

  static inline ::GlobalNamespace::BasicUIAudioManager* New_ctor();

  /// @brief Method OnDisable, addr 0x3bf8ac0, size 0xd0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3bf89f0, size 0xd0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x3bf8954, size 0x9c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bf8c60, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
