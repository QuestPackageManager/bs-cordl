...
public:
  ...
  /// @brief Method HandleButtonClickEvent, addr 0x2507b50, size 0xd0, virtual false, abstract: false, final false
  inline void HandleButtonClickEvent();

  static inline ::GlobalNamespace::BasicUIAudioManager* New_ctor();

  /// @brief Method OnDisable, addr 0x2507a7c, size 0xd4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x25079a8, size 0xd4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x2507910, size 0x98, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2507c20, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
