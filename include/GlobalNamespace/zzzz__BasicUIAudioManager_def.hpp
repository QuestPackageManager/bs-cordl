...
public:
  ...
  /// @brief Method HandleButtonClickEvent, addr 0x58c7cec, size 0x1c8, virtual false, abstract: false, final false
  inline void HandleButtonClickEvent();

  static inline ::GlobalNamespace::BasicUIAudioManager* New_ctor();

  /// @brief Method OnDisable, addr 0x58c7be8, size 0x104, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58c7acc, size 0x11c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x58c79fc, size 0xd0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58c7eb4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
