...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2773)), TypeDefinitionIndex(TypeDefinitionIndex(15305)), TypeDefinitionIndex(TypeDefinitionIndex(16032)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2773), inst: 274 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(16032), inst: 3809 })] Self:
// TypeDefinitionIndex(TypeDefinitionIndex(16009)) CS Name: ::AudioReferenceCountingCache*
...
public:
  ...
  /// @brief Method .ctor, addr 0x23ff4e4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
