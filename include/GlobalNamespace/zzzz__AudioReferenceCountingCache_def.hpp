...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2773)), TypeDefinitionIndex(TypeDefinitionIndex(15594)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2773), inst: 276
// }), TypeDefinitionIndex(TypeDefinitionIndex(5912)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5912), inst: 3826 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(5889))
