...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5912), inst: 3826 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2773), inst: 276 }),
// TypeDefinitionIndex(TypeDefinitionIndex(15594)), TypeDefinitionIndex(TypeDefinitionIndex(2773)), TypeDefinitionIndex(TypeDefinitionIndex(5912))} Self: TypeDefinitionIndex(TypeDefinitionIndex(5889))
...
public:
  ...
  /// @brief Method .ctor, addr 0x22fbc9c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
