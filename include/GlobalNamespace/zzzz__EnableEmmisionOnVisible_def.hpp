...
/// @brief Field _emmisionModules, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__emmisionModules, put=__cordl_internal_set__emmisionModules)) ::ArrayW<::UnityEngine::ParticleSystem_EmissionModule,::Array<::UnityEngine::ParticleSystem_EmissionModule>*>  _emmisionModules;
...
/// @brief Method Awake, addr 0x56a1248, size 0x108, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::EnableEmmisionOnVisible* New_ctor() ;

/// @brief Method OnBecameInvisible, addr 0x56a13f8, size 0xa8, virtual false, abstract: false, final false
inline void OnBecameInvisible() ;

/// @brief Method OnBecameVisible, addr 0x56a1350, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56a14a0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
