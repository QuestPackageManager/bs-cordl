...
public:
  ...
  /// @brief Method Awake, addr 0x39c4f80, size 0xe8, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::EnableEmmisionOnVisible* New_ctor();

  /// @brief Method OnBecameInvisible, addr 0x39c50dc, size 0x74, virtual false, abstract: false, final false
  inline void OnBecameInvisible();

  /// @brief Method OnBecameVisible, addr 0x39c5068, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39c5150, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
