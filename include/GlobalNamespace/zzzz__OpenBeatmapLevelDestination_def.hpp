...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OpenBeatmapLevelDestination", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OpenBeatmapLevelDestination(OpenBeatmapLevelDestination&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OpenBeatmapLevelDestination", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OpenBeatmapLevelDestination(OpenBeatmapLevelDestinationconst&) = delete;
