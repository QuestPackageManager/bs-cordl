...
/// @brief Method HandleTextChanged, addr 0x5800cb4, size 0x8c, virtual false, abstract: false, final false
inline void HandleTextChanged(::UnityEngine::Object*  obj) ;

static inline ::GlobalNamespace::SyncText* New_ctor() ;

/// @brief Method OnDisable, addr 0x5800bdc, size 0xd8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5800908, size 0xe0, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method UpdateText, addr 0x58009e8, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5800d40, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
