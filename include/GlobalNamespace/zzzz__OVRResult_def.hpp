...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRResult*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRResult*, "", "OVRResult");
...
public:
  ...
  template <typename TResult, typename TStatus>
    requires(::cordl_internals::type_constraint<TStatus, ::System::IConvertible*> && ::cordl_internals::value_type_constraint<TStatus> && ::cordl_internals::default_constructor_constraint<TStatus>)
  static inline ::GlobalNamespace::OVRResult_2<TResult, TStatus> From(TResult result, TStatus status);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRResult", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRResult(OVRResult&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRResult", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OVRResult(OVRResultconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::OVRResult) == 0x10, "Size mismatch!");
