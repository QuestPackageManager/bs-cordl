...
public:
  ...
  /// @brief Method MoveNext, addr 0x3c248dc, size 0x29c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3c24b78, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method IsConnectedToInternetAsync, addr 0x3c247f0, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c248d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
