...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompositeElement", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompositeElement(CompositeElement&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompositeElement", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompositeElement(CompositeElementconst&) = delete;
