...
public:
  ...
  /// @brief Method AddVertex, addr 0x259fed4, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoint, addr 0x259fe9c, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPoint(int32_t index);

  /// @brief Method GetVertex, addr 0x259fe3c, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitBezierPathIntoFixNumberOfSegments, addr 0x259f880, size 0x584, virtual false, abstract: false, final false
  inline void SplitBezierPathIntoFixNumberOfSegments(::GlobalNamespace::BezierPath* bezierPath, int32_t numberOfVertexSegments);

  /// @brief Method TimeAtPoint, addr 0x259fe04, size 0x38, virtual false, abstract: false, final false
  inline float_t TimeAtPoint(int32_t pointIndex);

  /// @brief Method UpdateByBezierPath, addr 0x259f3e4, size 0x474, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x259f300, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfPathSegments);

  static inline ::UnityEngine::Vector3 getStaticF__back();

  /// @brief Method get_length, addr 0x259f878, size 0x8, virtual false, abstract: false, final false
