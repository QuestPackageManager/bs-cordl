...
public:
  ...
  /// @brief Method AddVertex, addr 0x3b31ec0, size 0x40c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoint, addr 0x3b31e88, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPoint(int32_t index);

  /// @brief Method GetVertex, addr 0x3b31e28, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitBezierPathIntoFixNumberOfSegments, addr 0x3b318b4, size 0x53c, virtual false, abstract: false, final false
  inline void SplitBezierPathIntoFixNumberOfSegments(::GlobalNamespace::BezierPath* bezierPath, int32_t numberOfVertexSegments);

  /// @brief Method TimeAtPoint, addr 0x3b31df0, size 0x38, virtual false, abstract: false, final false
  inline float_t TimeAtPoint(int32_t pointIndex);

  /// @brief Method UpdateByBezierPath, addr 0x3b31434, size 0x458, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b31350, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfPathSegments);

  static inline ::UnityEngine::Vector3 getStaticF__back();

  /// @brief Method get_length, addr 0x3b318ac, size 0x8, virtual false, abstract: false, final false
