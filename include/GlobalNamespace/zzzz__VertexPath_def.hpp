...
public:
  ...
  /// @brief Method AddVertex, addr 0x5770e40, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoint, addr 0x5770e08, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPoint(int32_t index);

  /// @brief Method GetVertex, addr 0x5770da8, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitBezierPathIntoFixNumberOfSegments, addr 0x5770804, size 0x56c, virtual false, abstract: false, final false
  inline void SplitBezierPathIntoFixNumberOfSegments(::GlobalNamespace::BezierPath* bezierPath, int32_t numberOfVertexSegments);

  /// @brief Method TimeAtPoint, addr 0x5770d70, size 0x38, virtual false, abstract: false, final false
  inline float_t TimeAtPoint(int32_t pointIndex);

  /// @brief Method UpdateByBezierPath, addr 0x577035c, size 0x484, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5770278, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfPathSegments);

  static inline ::UnityEngine::Vector3 getStaticF__back();

  /// @brief Method get_length, addr 0x57707fc, size 0x8, virtual false, abstract: false, final false
