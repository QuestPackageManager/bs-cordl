...
public:
  ...
  /// @brief Method get_length, addr 0x233b048, size 0x8, virtual false, abstract: false, final false
  inline float_t get_length();

  static inline ::GlobalNamespace::VertexPath* New_ctor(int32_t numberOfPathSegments);

  /// @brief Method .ctor, addr 0x233aad8, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfPathSegments);

  /// @brief Method UpdateByBezierPath, addr 0x233abbc, size 0x46c, virtual false, abstract: false, final false
  inline void UpdateByBezierPath(::GlobalNamespace::BezierPath* bezierPath);

  /// @brief Method TimeAtPoint, addr 0x233b5b4, size 0x38, virtual false, abstract: false, final false
  inline float_t TimeAtPoint(int32_t pointIndex);

  /// @brief Method GetVertex, addr 0x233b5ec, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPoint, addr 0x233b64c, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPoint(int32_t index);

  /// @brief Method SplitBezierPathIntoFixNumberOfSegments, addr 0x233b050, size 0x564, virtual false, abstract: false, final false
  inline void SplitBezierPathIntoFixNumberOfSegments(::GlobalNamespace::BezierPath* bezierPath, int32_t numberOfVertexSegments);

  /// @brief Method AddVertex, addr 0x233b684, size 0x40c, virtual false, abstract: false, final false
