...
/// @brief Field _localVertices, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__localVertices, put=__cordl_internal_set__localVertices)) ::ArrayW<::GlobalNamespace::VertexPath_Vertex,::Array<::GlobalNamespace::VertexPath_Vertex>*>  _localVertices;
...
/// @brief Method AddVertex, addr 0x5771770, size 0x498, virtual false, abstract: false, final false
inline void AddVertex(::ByRef<::UnityEngine::Vector3>  p0, ::ByRef<::UnityEngine::Vector3>  p1, ::ByRef<::UnityEngine::Vector3>  p2, ::ByRef<::UnityEngine::Vector3>  p3, float_t  t, ::ByRef<::UnityEngine::Vector3>  lastRotationAxis, ::ByRef<float_t>  currentPathLength, ::ByRef<::GlobalNamespace::VertexPath_Vertex>  lastVertex, ::ByRef<int32_t>  vertCount) ;

/// @brief Method GetPoint, addr 0x5771738, size 0x38, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 GetPoint(int32_t  index) ;

/// @brief Method GetVertex, addr 0x57716d8, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SplitBezierPathIntoFixNumberOfSegments, addr 0x5771134, size 0x56c, virtual false, abstract: false, final false
inline void SplitBezierPathIntoFixNumberOfSegments(::GlobalNamespace::BezierPath*  bezierPath, int32_t  numberOfVertexSegments) ;

/// @brief Method TimeAtPoint, addr 0x57716a0, size 0x38, virtual false, abstract: false, final false
inline float_t TimeAtPoint(int32_t  pointIndex) ;

/// @brief Method UpdateByBezierPath, addr 0x5770c8c, size 0x484, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5770ba8, size 0xe4, virtual false, abstract: false, final false
inline void _ctor(int32_t  numberOfPathSegments) ;

static inline ::UnityEngine::Vector3 getStaticF__back() ;

/// @brief Method get_length, addr 0x577112c, size 0x8, virtual false, abstract: false, final false
