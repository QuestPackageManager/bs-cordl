...
/// @brief Field _activeElements, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__activeElements, put=__cordl_internal_set__activeElements)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::PageControlElement>>*  _activeElements;
...
/// @brief Field _inactiveElements, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__inactiveElements, put=__cordl_internal_set__inactiveElements)) ::System::Collections::Generic::Queue_1<::UnityW<::GlobalNamespace::PageControlElement>>*  _inactiveElements;
...
/// @brief Method SetPagesCount, addr 0x57adf40, size 0x39c, virtual false, abstract: false, final false
inline void SetPagesCount(int32_t  pagesCount) ;

/// @brief Method SetSelectedPageIndex, addr 0x57ae2dc, size 0xe0, virtual false, abstract: false, final false
inline void SetSelectedPageIndex(int32_t  page) ;

/// @brief Method SetVisible, addr 0x57b63d4, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57b6404, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;
