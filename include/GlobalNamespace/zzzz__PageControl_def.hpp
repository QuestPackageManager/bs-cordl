...
public:
  ...
  /// @brief Method SetPagesCount, addr 0x24493ec, size 0x3d0, virtual false, abstract: false, final false
  inline void SetPagesCount(int32_t pagesCount);

  /// @brief Method SetSelectedPageIndex, addr 0x2449820, size 0xc8, virtual false, abstract: false, final false
  inline void SetSelectedPageIndex(int32_t page);

  /// @brief Method SetVisible, addr 0x24498e8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2449918, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
