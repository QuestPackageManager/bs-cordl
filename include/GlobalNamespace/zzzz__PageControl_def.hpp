...
public:
  ...
  /// @brief Method SetPagesCount, addr 0x3afc8d8, size 0x3d4, virtual false, abstract: false, final false
  inline void SetPagesCount(int32_t pagesCount);

  /// @brief Method SetSelectedPageIndex, addr 0x3afccac, size 0xd0, virtual false, abstract: false, final false
  inline void SetSelectedPageIndex(int32_t page);

  /// @brief Method SetVisible, addr 0x3b05c58, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b05c88, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
