...
public:
  ...
  /// @brief Method SetPagesCount addr 0x21a384c size 0x3d0 virtual false final false
  inline void SetPagesCount(int32_t pagesCount);

  /// @brief Method SetSelectedPageIndex addr 0x21a3c80 size 0xc8 virtual false final false
  inline void SetSelectedPageIndex(int32_t page);

  /// @brief Method SetVisible addr 0x21a3d48 size 0x30 virtual false final false
  inline void SetVisible(bool isVisible);

  static inline ::GlobalNamespace::PageControl* New_ctor();

  /// @brief Method .ctor addr 0x21a3d78 size 0xd0 virtual false final false
  inline void _ctor();
