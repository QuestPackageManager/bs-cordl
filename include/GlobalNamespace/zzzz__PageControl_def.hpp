...
public:
  ...
  /// @brief Method SetPagesCount, addr 0x57ac6d8, size 0x39c, virtual false, abstract: false, final false
  inline void SetPagesCount(int32_t pagesCount);

  /// @brief Method SetSelectedPageIndex, addr 0x57aca74, size 0xe0, virtual false, abstract: false, final false
  inline void SetSelectedPageIndex(int32_t page);

  /// @brief Method SetVisible, addr 0x57b4b6c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b4b9c, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
