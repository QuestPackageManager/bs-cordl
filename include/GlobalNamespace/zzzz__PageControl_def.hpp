...
public:
  ...
  /// @brief Method SetPagesCount, addr 0x269af3c, size 0x3d0, virtual false, abstract: false, final false
  inline void SetPagesCount(int32_t pagesCount);

  /// @brief Method SetSelectedPageIndex, addr 0x269b370, size 0xc8, virtual false, abstract: false, final false
  inline void SetSelectedPageIndex(int32_t page);

  /// @brief Method SetVisible, addr 0x269b438, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x269b468, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
