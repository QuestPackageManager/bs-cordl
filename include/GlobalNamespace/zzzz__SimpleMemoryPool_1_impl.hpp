...
template<typename T>
constexpr ::GlobalNamespace::LazyCopyHashSet_1<T>* const& GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_get__activeElements() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____activeElements;
}
template<typename T>
...
template<typename T>
constexpr ::System::Collections::Generic::List_1<T>* const& GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_get__inactiveElements() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____inactiveElements;
}
template<typename T>
...
template<typename T>
constexpr ::System::Func_1<T>* const& GlobalNamespace::SimpleMemoryPool_1<T>::__cordl_internal_get__createNewItemFunc() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____createNewItemFunc;
}
template<typename T>
