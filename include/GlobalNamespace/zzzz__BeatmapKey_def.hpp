...
public:
  ...
  /// @brief Method Equals, addr 0x13c4460, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x13b8830, size 0x74, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BeatmapKey other);

  /// @brief Method GetHashCode, addr 0x13c44f0, size 0xb4, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetIdentifier, addr 0x13c43d4, size 0x8c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKeyNetSerializable* GetIdentifier();

  /// @brief Method IsValid, addr 0x13c4354, size 0x80, virtual false, abstract: false, final false
  inline bool IsValid();

  /// @brief Method SerializedName, addr 0x13b584c, size 0x44, virtual false, abstract: false, final false
  inline ::StringW SerializedName();

  /// @brief Method .ctor, addr 0x13c425c, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x13c4324, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::BeatmapKey a, ::GlobalNamespace::BeatmapKey b);

  /// @brief Method op_Inequality, addr 0x13c45a4, size 0x48, virtual false, abstract: false, final false
