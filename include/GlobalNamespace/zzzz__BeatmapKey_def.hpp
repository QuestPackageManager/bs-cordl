...
/// @brief Method Equals, addr 0x3621f40, size 0x8c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x3621eec, size 0x54, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BeatmapKey  other) ;

/// @brief Method GetHashCode, addr 0x3621fcc, size 0x7c, virtual true, abstract: false, final false
inline int32_t GetHashCode() ;

/// @brief Method GetIdentifier, addr 0x3621e80, size 0x6c, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKeyNetSerializable* GetIdentifier() ;

/// @brief Method IsValid, addr 0x3621db8, size 0x84, virtual false, abstract: false, final false
inline bool IsValid() ;

/// @brief Method SerializedName, addr 0x3621e3c, size 0x44, virtual false, abstract: false, final false
inline ::StringW SerializedName() ;

/// @brief Method ToString, addr 0x3622080, size 0xb8, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x3621cc8, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x3621d90, size 0x28, virtual false, abstract: false, final false
static inline bool op_Equality(::GlobalNamespace::BeatmapKey  a, ::GlobalNamespace::BeatmapKey  b) ;

/// @brief Method op_Inequality, addr 0x3622048, size 0x38, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "beatmapCharacteristic", ty: "::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>", modifiers: "", def_value: None }, CppParam { name: "difficulty", ty: "::GlobalNamespace::BeatmapDifficulty", modifiers: "", def_value: None }, CppParam { name: "levelId", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "characteristic", ty: "::StringW", modifiers: "", def_value: None }]
constexpr BeatmapKey(::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>  beatmapCharacteristic, ::GlobalNamespace::BeatmapDifficulty  difficulty, ::StringW  levelId, ::StringW  characteristic) noexcept;
