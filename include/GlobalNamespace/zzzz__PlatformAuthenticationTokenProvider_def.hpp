...
public:
  ...
  /// @brief Method MoveNext, addr 0x407fa34, size 0x3f4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x407fe28, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x407fea4, size 0x3e4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x4080288, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x4080304, size 0x3d8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x40806dc, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method GetAuthenticationToken, addr 0x407f6dc, size 0xf0, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::AuthenticationToken>* GetAuthenticationToken();

  /// @brief Method GetTokenPlatform, addr 0x407f7cc, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method GetXPlatformAccessToken, addr 0x407f82c, size 0x10c, virtual true, abstract: false, final true
  ...
  /// @brief Method RequestXPlatformAccessToken, addr 0x407f938, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x407f5ec, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IPlatformUserModel* platformUserModel, ::GlobalNamespace::UserInfo* userInfo);

  /// @brief Method get_hashedUserId, addr 0x407f5d4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_hashedUserId();

  /// @brief Method get_platform, addr 0x407f5e4, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::AuthenticationToken_Platform get_platform();

  /// @brief Method get_userName, addr 0x407f5dc, size 0x8, virtual true, abstract: false, final true
