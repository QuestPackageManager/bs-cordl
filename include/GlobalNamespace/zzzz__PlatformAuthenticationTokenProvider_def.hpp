...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(3390)), TypeDefinitionIndex(TypeDefinitionIndex(3398)), TypeDefinitionIndex(TypeDefinitionIndex(12580)),
// TypeDefinitionIndex(TypeDefinitionIndex(16358)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3390), inst: 898 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3398), inst: 880 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(14841)) CS Name: ::PlatformAuthenticationTokenProvider::<GetAuthenticationToken>d__16
...
public:
  ...
  /// @brief Method MoveNext, addr 0x265d320, size 0x3ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x265d6cc, size 0x58, virtual true, abstract: false, final true
...
// TypeDefinitionIndex(TypeDefinitionIndex(12823)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3390), inst: 905 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3398), inst: 905 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(14842)) CS Name: ::PlatformAuthenticationTokenProvider::<GetXPlatformAccessToken>d__18
...
public:
  ...
  /// @brief Method MoveNext, addr 0x265d724, size 0x330, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x265da54, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2677)), TypeDefinitionIndex(TypeDefinitionIndex(3390)), TypeDefinitionIndex(TypeDefinitionIndex(3398)),
// TypeDefinitionIndex(TypeDefinitionIndex(12823)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3390), inst: 905 }), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3398), inst: 905 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(14843)) CS Name: ::PlatformAuthenticationTokenProvider::<RequestXPlatformAccessToken>d__19
...
public:
  ...
  /// @brief Method MoveNext, addr 0x265daac, size 0x380, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x265de2c, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(12579)), TypeDefinitionIndex(TypeDefinitionIndex(12823))]
...
public:
  ...
  /// @brief Method get_hashedUserId, addr 0x265ceac, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_hashedUserId();

  /// @brief Method get_userName, addr 0x265ceb4, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_userName();

  /// @brief Method get_platform, addr 0x265cebc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x265cec4, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IPlatformUserModel* platformUserModel, ::GlobalNamespace::UserInfo* userInfo);

  /// @brief Method GetAuthenticationToken, addr 0x265cfb4, size 0xf8, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::AuthenticationToken>* GetAuthenticationToken();

  /// @brief Method GetTokenPlatform, addr 0x265d0ac, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method GetXPlatformAccessToken, addr 0x265d10c, size 0x110, virtual true, abstract: false, final true
  ...
  /// @brief Method RequestXPlatformAccessToken, addr 0x265d21c, size 0x104, virtual false, abstract: false, final false
