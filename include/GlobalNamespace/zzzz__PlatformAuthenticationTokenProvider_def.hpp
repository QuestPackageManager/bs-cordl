...
public:
  ...
  /// @brief Method MoveNext, addr 0x2bd186c, size 0x3ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2bd1c18, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2bd1c70, size 0x330, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2bd1fa0, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2bd1ff8, size 0x380, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2bd2378, size 0x58, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method GetAuthenticationToken, addr 0x2bd1500, size 0xf8, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::AuthenticationToken>* GetAuthenticationToken();

  /// @brief Method GetTokenPlatform, addr 0x2bd15f8, size 0x60, virtual true, abstract: false, final true
  ...
  /// @brief Method GetXPlatformAccessToken, addr 0x2bd1658, size 0x110, virtual true, abstract: false, final true
  ...
  /// @brief Method RequestXPlatformAccessToken, addr 0x2bd1768, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bd1410, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IPlatformUserModel* platformUserModel, ::GlobalNamespace::UserInfo* userInfo);

  /// @brief Method get_hashedUserId, addr 0x2bd13f8, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_hashedUserId();

  /// @brief Method get_platform, addr 0x2bd1408, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__AuthenticationToken__Platform get_platform();

  /// @brief Method get_userName, addr 0x2bd1400, size 0x8, virtual true, abstract: false, final true
