...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair::*)()>(&::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58ba098;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SetSaberBladeParams::*)()>(&::GlobalNamespace::SetSaberBladeParams::Start)> {
  ...
  constexpr static std::size_t addrs = 0x58b9f5c;
...
constexpr ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>*>& GlobalNamespace::SetSaberBladeParams::__cordl_internal_get__propertyTintColorPairs()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____propertyTintColorPairs;
}
constexpr ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>*> const& GlobalNamespace::SetSaberBladeParams::__cordl_internal_get__propertyTintColorPairs() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____propertyTintColorPairs;
}
constexpr void GlobalNamespace::SetSaberBladeParams::__cordl_internal_set__propertyTintColorPairs(::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
