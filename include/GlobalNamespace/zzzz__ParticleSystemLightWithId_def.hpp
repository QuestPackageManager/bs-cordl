...
public:
  ...
  /// @brief Method Awake, addr 0x572a084, size 0x94, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x572a118, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572a298, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x572a058, size 0x2c, virtual false, abstract: false, final false
