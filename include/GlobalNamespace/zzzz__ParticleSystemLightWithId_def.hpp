...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(14436)), TypeDefinitionIndex(TypeDefinitionIndex(15042))]
...
public:
  ...
  /// @brief Method get_color, addr 0x21a6670, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method Awake, addr 0x21a66cc, size 0x78, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x21a6744, size 0x464, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  static inline ::GlobalNamespace::ParticleSystemLightWithId* New_ctor();

  /// @brief Method .ctor, addr 0x21a6ba8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
