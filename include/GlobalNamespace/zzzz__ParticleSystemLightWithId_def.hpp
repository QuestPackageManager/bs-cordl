...
public:
  ...
  /// @brief Method Awake, addr 0x39e9a78, size 0x78, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x39e9af0, size 0x1e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e9cd4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x39e9a1c, size 0x5c, virtual false, abstract: false, final false
