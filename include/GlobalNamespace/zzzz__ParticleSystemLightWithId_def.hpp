...
public:
  ...
  /// @brief Field setOnlyOnce, offset 0x48, size 0x1
  __declspec(property(get = __cordl_internal_get_setOnlyOnce, put = __cordl_internal_set_setOnlyOnce)) bool setOnlyOnce;

  /// @brief Method Awake, addr 0x58700e4, size 0x94, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x5870178, size 0x180, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58702f8, size 0x1ac, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x58700b8, size 0x2c, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::ParticleSystemLightWithId, ____particleSystem) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ParticleSystemLightWithId, ___setOnlyOnce) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ParticleSystemLightWithId, ____setColorOnly) == 0x49, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ParticleSystemLightWithId, ____intensity) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ParticleSystemLightWithId, ____minAlpha) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ParticleSystemLightWithId, ____mainModule) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ParticleSystemLightWithId, ____particles) == 0x60, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::ParticleSystemLightWithId) == 0x68, "Size mismatch!");
