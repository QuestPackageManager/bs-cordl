...
public:
  ...
  /// @brief Method Awake, addr 0x22d5c50, size 0x78, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x22d5cc8, size 0x464, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d612c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x22d5bf4, size 0x5c, virtual false, abstract: false, final false
