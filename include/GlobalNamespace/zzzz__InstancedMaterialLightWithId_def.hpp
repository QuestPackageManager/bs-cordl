...
/// @brief Field _multiplyColorByAlpha, offset 0x4c, size 0x4 
 __declspec(property(get=__cordl_internal_get__multiplyColorByAlpha, put=__cordl_internal_set__multiplyColorByAlpha)) ::GlobalNamespace::InstancedMaterialLightWithId_MultiplyColorByAlphaType  _multiplyColorByAlpha;
...
/// @brief Method AddNecessaryComponents, addr 0x56b980c, size 0x110, virtual false, abstract: false, final false
inline void AddNecessaryComponents() ;

/// @brief Method ColorWasSet, addr 0x56b9738, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b991c, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_intensity, addr 0x56b9714, size 0x8, virtual false, abstract: false, final false
inline float_t get_intensity() ;

/// @brief Method set_intensity, addr 0x56b971c, size 0x1c, virtual false, abstract: false, final false
