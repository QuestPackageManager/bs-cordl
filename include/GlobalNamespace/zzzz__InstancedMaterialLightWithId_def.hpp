...
public:
  ...
  /// @brief Method AddNecessaryComponents, addr 0x57276f8, size 0x110, virtual false, abstract: false, final false
  inline void AddNecessaryComponents();

  /// @brief Method ColorWasSet, addr 0x5727624, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5727808, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_intensity, addr 0x5727600, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method set_intensity, addr 0x5727608, size 0x1c, virtual false, abstract: false, final false
