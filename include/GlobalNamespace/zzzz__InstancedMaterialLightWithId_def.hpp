...
public:
  ...
  /// @brief Field _color, offset 0x6c, size 0x10
  __declspec(property(get = __cordl_internal_get__color, put = __cordl_internal_set__color)) ::UnityEngine::Color _color;

  /// @brief Field _hdr, offset 0x59, size 0x1
  ...
  /// @brief Field _materialPropertyBlockColorSetter, offset 0x40, size 0x8
  ...
  /// @brief Field _originalColor, offset 0x5c, size 0x10
  ...
  /// @brief Field _saturateIntensity, offset 0x58, size 0x1
...
public:
  ...
  /// @brief Field _originalColor, offset: 0x5c, size: 0x10, def value: None
  ::UnityEngine::Color ____originalColor;

  /// @brief Field _color, offset: 0x6c, size: 0x10, def value: None
  ::UnityEngine::Color ____color;

  /// @brief Field _startColorWasSet, offset: 0x7c, size: 0x1, def value: None
  bool ____startColorWasSet;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____materialPropertyBlockColorSetter) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____setColorOnly) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____intensity) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____minAlpha) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____multiplyColorByAlpha) == 0x54, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____saturateIntensity) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____hdr) == 0x59, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____originalColor) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____color) == 0x6c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::InstancedMaterialLightWithId, ____startColorWasSet) == 0x7c, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::InstancedMaterialLightWithId) == 0x80, "Size mismatch!");
