...
public:
  ...
  /// @brief Method get_didFinishEvent addr 0x20ce710 size 0x8 virtual false final false
  inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteCutSoundEffectDidFinishEvent*>* get_didFinishEvent();

  /// @brief Method set_volumeMultiplier addr 0x20ce718 size 0x8 virtual false final false
  inline void set_volumeMultiplier(float_t value);

  /// @brief Method get_volumeMultiplier addr 0x20ce720 size 0x8 virtual false final false
  inline float_t get_volumeMultiplier();

  /// @brief Method get_time addr 0x20ce728 size 0x2c virtual false final false
  inline float_t get_time();

  /// @brief Method Awake addr 0x20ce754 size 0x84 virtual false final false
  inline void Awake();

  /// @brief Method Start addr 0x20ce7d8 size 0x20 virtual false final false
  inline void Start();

  /// @brief Method Init addr 0x20ce7f8 size 0x1b0 virtual false final false
  ...
  /// @brief Method ComputeDSPTimes addr 0x20ce9a8 size 0xac virtual false final false
  inline void ComputeDSPTimes(double_t noteDSPTime, float_t aheadTime, float_t timeToPrevNote, float_t timeToNextNote);

  /// @brief Method LateUpdate addr 0x20cea54 size 0x1c0 virtual false final false
  inline void LateUpdate();

  /// @brief Method StopPlayingAndFinish addr 0x20cec14 size 0x1f0 virtual false final false
  inline void StopPlayingAndFinish();

  /// @brief Method NoteWasCut addr 0x20cee04 size 0x20c virtual false final false
  ...
  /// @brief Method .ctor addr 0x20cf010 size 0x84 virtual false final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10978)), TypeDefinitionIndex(TypeDefinitionIndex(4058)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10978), inst:
// 2763 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(4057)) CS Name: ::NoteCutSoundEffect::Pool*
...
public:
  ...
  /// @brief Method .ctor addr 0x20cf094 size 0x48 virtual false final false
  inline void _ctor();
