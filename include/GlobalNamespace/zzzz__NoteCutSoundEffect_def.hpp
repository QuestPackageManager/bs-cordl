...
public:
  ...
  /// @brief Method .ctor, addr 0x2620d74, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__badCutSoundEffectAudioClips,
                      put = __cordl_internal_set__badCutSoundEffectAudioClips))::ArrayW<::UnityW<::UnityEngine::AudioClip>, ::Array<::UnityW<::UnityEngine::AudioClip>>*> _badCutSoundEffectAudioClips;
  ...
  /// @brief Method Awake, addr 0x262035c, size 0x84, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ComputeDSPTimes, addr 0x26205b0, size 0xac, virtual false, abstract: false, final false
  inline void ComputeDSPTimes(double_t noteDSPTime, float_t aheadTime, float_t timeToPrevNote, float_t timeToNextNote);

  /// @brief Method Init, addr 0x2620400, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method NoteDidStartDissolving, addr 0x2620c74, size 0x7c, virtual false, abstract: false, final false
  inline void NoteDidStartDissolving(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method NoteWasCut, addr 0x2620a68, size 0x20c, virtual false, abstract: false, final false
  inline void NoteWasCut(::GlobalNamespace::NoteController* noteController, ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method OnLateUpdate, addr 0x262065c, size 0x21c, virtual false, abstract: false, final false
  inline void OnLateUpdate();

  /// @brief Method Start, addr 0x26203e0, size 0x20, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopPlayingAndFinish, addr 0x2620878, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2620cf0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_didFinishEvent, addr 0x2620318, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteCutSoundEffectDidFinishEvent*>* get_didFinishEvent();

  /// @brief Method get_time, addr 0x2620330, size 0x2c, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_volumeMultiplier, addr 0x2620328, size 0x8, virtual false, abstract: false, final false
  inline float_t get_volumeMultiplier();

  /// @brief Method set_volumeMultiplier, addr 0x2620320, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____audioSource) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____speedToVolumeCurve) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____badCutSoundEffectAudioClips) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____badCutVolume) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____goodCutVolume) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____saber) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____noteController) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____isPlaying) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____volumeMultiplier) == 0x4c, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____timeToPrevNote) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____startDSPTime) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____endDSPtime) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____fadeOutStartDSPtime) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____noteMissedTimeOffset) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____beforeCutVolume) == 0x7c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____goodCut) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____pitch) == 0x84, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____badCutRandomSoundPicker) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____handleWrongSaberTypeAsGood) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::NoteCutSoundEffect, ____ignoreSaberSpeed) == 0x91, "Offset mismatch!");
