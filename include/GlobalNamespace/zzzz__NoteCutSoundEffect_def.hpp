...
/// @brief Method .ctor, addr 0x570d434, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _badCutRandomSoundPicker, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__badCutRandomSoundPicker, put=__cordl_internal_set__badCutRandomSoundPicker)) ::GlobalNamespace::RandomObjectPicker_1<::UnityW<::UnityEngine::AudioClip>>*  _badCutRandomSoundPicker;

/// @brief Field _badCutSoundEffectAudioClips, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__badCutSoundEffectAudioClips, put=__cordl_internal_set__badCutSoundEffectAudioClips)) ::ArrayW<::UnityW<::UnityEngine::AudioClip>,::Array<::UnityW<::UnityEngine::AudioClip>>*>  _badCutSoundEffectAudioClips;
...
/// @brief Field _didFinishEvent, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__didFinishEvent, put=__cordl_internal_set__didFinishEvent)) ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteCutSoundEffectDidFinishEvent*>*  _didFinishEvent;
...
/// @brief Method Awake, addr 0x570c9b4, size 0x84, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ComputeDSPTimes, addr 0x570cc20, size 0xac, virtual false, abstract: false, final false
inline void ComputeDSPTimes(double_t  noteDSPTime, float_t  aheadTime, float_t  timeToPrevNote, float_t  timeToNextNote) ;

/// @brief Method Init, addr 0x570ca54, size 0x1cc, virtual false, abstract: false, final false
...
/// @brief Method NoteDidStartDissolving, addr 0x570d324, size 0x80, virtual false, abstract: false, final false
inline void NoteDidStartDissolving(::GlobalNamespace::NoteControllerBase*  noteController) ;

/// @brief Method NoteWasCut, addr 0x570d0f4, size 0x230, virtual false, abstract: false, final false
inline void NoteWasCut(::GlobalNamespace::NoteController*  noteController, ::ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method OnLateUpdate, addr 0x570cccc, size 0x264, virtual false, abstract: false, final false
inline void OnLateUpdate() ;

/// @brief Method Start, addr 0x570ca38, size 0x1c, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StopPlayingAndFinish, addr 0x570cf30, size 0x1c4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x570d3a4, size 0x90, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_didFinishEvent, addr 0x570c970, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ILazyCopyHashSet_1<::GlobalNamespace::INoteCutSoundEffectDidFinishEvent*>* get_didFinishEvent() ;

/// @brief Method get_time, addr 0x570c988, size 0x2c, virtual false, abstract: false, final false
inline float_t get_time() ;

/// @brief Method get_volumeMultiplier, addr 0x570c980, size 0x8, virtual false, abstract: false, final false
inline float_t get_volumeMultiplier() ;

/// @brief Method set_volumeMultiplier, addr 0x570c978, size 0x8, virtual false, abstract: false, final false
