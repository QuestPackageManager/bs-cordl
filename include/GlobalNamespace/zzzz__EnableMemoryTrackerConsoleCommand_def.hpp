...
public:
  ...
  /// @brief Method ExecuteAsync, addr 0x32d1010, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32d10c0, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_commandName, addr 0x32d0f88, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_commandName();

  /// @brief Method get_description, addr 0x32d0fcc, size 0x44, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnableMemoryTrackerConsoleCommand", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnableMemoryTrackerConsoleCommand(EnableMemoryTrackerConsoleCommand&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnableMemoryTrackerConsoleCommand", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnableMemoryTrackerConsoleCommand(EnableMemoryTrackerConsoleCommandconst&) = delete;
