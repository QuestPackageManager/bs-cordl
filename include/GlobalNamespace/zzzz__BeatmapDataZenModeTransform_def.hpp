...
public:
  // Declarations
  /// @brief Method CreateTransformedData, addr 0x12cefec, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0_0, addr 0x12cf358, size 0xb0, virtual false, abstract: false, final false
