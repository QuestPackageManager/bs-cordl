...
public:
  // Declarations
  /// @brief Method .ctor addr 0x21f46b8 size 0x10 virtual false final false
...
static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader__LoadBeatmapLevelResult, isError) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader__LoadBeatmapLevelResult, beatmapLevel) == 0x8, "Offset mismatch!");
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 865 }), TypeDefinitionIndex(TypeDefinitionIndex(4413)),
// TypeDefinitionIndex(TypeDefinitionIndex(3397)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 887 }), TypeDefinitionIndex(TypeDefinitionIndex(2675)),
// TypeDefinitionIndex(TypeDefinitionIndex(3389)), TypeDefinitionIndex(TypeDefinitionIndex(4433)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 112 }),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3389), inst: 870 }), TypeDefinitionIndex(TypeDefinitionIndex(4358))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4359)) CS
...
public:
  ...
  /// @brief Method MoveNext addr 0x21f46c8 size 0x6d0 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x21f4d98 size 0x58 virtual true final true
...
static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, previewLevel) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, cancellationToken) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, _level_5__2) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, __u__1) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, __u__2) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__BeatmapLevelLoader___LoadBeatmapLevelAsync_d__4, __u__3) == 0x50, "Offset mismatch!");
...
public:
  ...
  static inline ::GlobalNamespace::BeatmapLevelLoader* New_ctor(::GlobalNamespace::BeatmapLevelDataLoaderSO* beatmapLevelDataLoader,
                                                                ::GlobalNamespace::IBeatmapDataAssetFileModel* beatmapDataAssetFileModel);

  /// @brief Method .ctor addr 0x21f4578 size 0x2c virtual false final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelDataLoaderSO* beatmapLevelDataLoader, ::GlobalNamespace::IBeatmapDataAssetFileModel* beatmapDataAssetFileModel);

  /// @brief Method LoadBeatmapLevelAsync addr 0x21f45a4 size 0x114 virtual false final false
...
static_assert(offsetof(::GlobalNamespace::BeatmapLevelLoader, ____beatmapLevelDataLoader) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapLevelLoader, ____beatmapDataAssetFileModel) == 0x18, "Offset mismatch!");
