...
public:
  ...
  /// @brief Method ApplyUVLayoutTo, addr 0x3a12bd8, size 0x858, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a134d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
