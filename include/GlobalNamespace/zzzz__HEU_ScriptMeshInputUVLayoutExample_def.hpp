...
public:
  ...
  /// @brief Method ApplyUVLayoutTo, addr 0x21e29b4, size 0x840, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21e329c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
