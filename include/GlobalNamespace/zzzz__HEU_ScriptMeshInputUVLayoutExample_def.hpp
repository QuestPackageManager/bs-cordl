...
public:
  ...
  /// @brief Method ApplyUVLayoutTo, addr 0x2547f0c, size 0x840, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25487f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
