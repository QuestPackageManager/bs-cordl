...
public:
  ...
  /// @brief Method HandleEvent, addr 0x39c4ba0, size 0x1c, virtual false, abstract: false, final false
  inline void HandleEvent();

  static inline ::GlobalNamespace::SignalListener* New_ctor();

  /// @brief Method OnDisable, addr 0x39c4b14, size 0x8c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39c4a7c, size 0x98, virtual false, abstract: false, final false
