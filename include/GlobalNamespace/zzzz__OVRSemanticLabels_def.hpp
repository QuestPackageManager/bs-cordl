...
public:
  ...
  /// @brief Method Equals, addr 0x5cd801c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5cd7ecc, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRSemanticLabels other);

  /// @brief Method FromApiLabel, addr 0x5cd876c, size 0x8d8, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRSemanticLabels_Classification FromApiLabel(::System::ReadOnlySpan_1<char16_t> singleLabel);

  /// @brief Method FromApiString, addr 0x5cd85d8, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method GetClassifications, addr 0x5cd82d0, size 0x308, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x5cd80ac, size 0x6c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.FromAnchor, addr 0x5cd7ca0, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.SetEnabledAsync, addr 0x5cd7e80, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.get_Handle, addr 0x5cd7c48, size 0x58, virtual true, abstract: false, final true
  inline uint64_t IOVRAnchorComponent_OVRSemanticLabels__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRSemanticLabels>.get_Type, addr 0x5cd7bec, size 0x54, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRSemanticLabels__get_Type();

  /// @brief Method ToApiLabel, addr 0x5cd92ec, size 0x190, virtual false, abstract: false, final false
  static inline ::StringW ToApiLabel(::GlobalNamespace::OVRSemanticLabels_Classification classification);

  /// @brief Method ToApiString, addr 0x5cd947c, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5cd8118, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method <FromApiString>g__AddLabel|30_0, addr 0x5cd9044, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method <FromApiString>g__IndexOf|30_1, addr 0x5cd9240, size 0xac, virtual false, abstract: false, final false
  static inline int32_t _FromApiString_g__IndexOf_30_1(::System::ReadOnlySpan_1<char16_t> s, char16_t c, int32_t start);

  /// @brief Method .ctor, addr 0x5cd7cd0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Handle, addr 0x5cd81d8, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_IsEnabled, addr 0x5cd7d98, size 0xe8, virtual true, abstract: false, final true
  inline bool get_IsEnabled();

  /// @brief Method get_IsNull, addr 0x5cd7d38, size 0x60, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_Labels, addr 0x5cd81e0, size 0xf0, virtual false, abstract: false, final false
  inline ::StringW get_Labels();

  /// @brief Method get_Type, addr 0x5cd7c40, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5cd7f38, size 0x70, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRSemanticLabels lhs, ::GlobalNamespace::OVRSemanticLabels rhs);

  /// @brief Method op_Inequality, addr 0x5cd7fa8, size 0x74, virtual false, abstract: false, final false
