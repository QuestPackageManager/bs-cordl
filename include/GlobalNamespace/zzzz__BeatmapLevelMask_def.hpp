...
public:
  ...
  /// @brief Method AddLevel, addr 0x3776ac0, size 0x64, virtual false, abstract: false, final false
  inline void AddLevel(::StringW state);

  /// @brief Method Contains, addr 0x3776a5c, size 0x64, virtual false, abstract: false, final false
  inline bool Contains(::StringW state);

  /// @brief Method Deserialize, addr 0x3776d10, size 0x14, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x3776e88, size 0x98, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3776e68, size 0x20, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BeatmapLevelMask* other);

  /// @brief Method GetHashCode, addr 0x3776e4c, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method Serialize, addr 0x3776b24, size 0x14, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x3776dc0, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x377677c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3776870, size 0x94, virtual false, abstract: false, final false
  inline void _ctor(::StringW level);

  /// @brief Method .ctor, addr 0x3776904, size 0x158, virtual false, abstract: false, final false
