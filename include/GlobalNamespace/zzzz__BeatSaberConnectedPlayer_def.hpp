...
public:
  ...
  /// @brief Method GetGameSpecificPlayerIdentityData, addr 0x320d948, size 0x14, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatSaberPlayerIdentityPacketData GetGameSpecificPlayerIdentityData();

  /// @brief Method GetPlayerAvatarPacket, addr 0x320d95c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMultiplayerAvatarsData, addr 0x320da00, size 0x14, virtual false, abstract: false, final false
  inline void SetMultiplayerAvatarsData(::GlobalNamespace::MultiplayerAvatarsData playerAvatars);

  /// @brief Method UpdateAvatar, addr 0x320d9e0, size 0x20, virtual false, abstract: false, final false
  inline void UpdateAvatar(::GlobalNamespace::PlayerAvatarPacket* packet);

  /// @brief Method UpdateIdentity, addr 0x320d9cc, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320d870, size 0xd8, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method get_multiplayerAvatarsData, addr 0x320d85c, size 0x14, virtual true, abstract: false, final true
