...
public:
  ...
  /// @brief Method GetGameSpecificPlayerIdentityData, addr 0x32a56b0, size 0x1c, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatSaberPlayerIdentityPacketData GetGameSpecificPlayerIdentityData();

  /// @brief Method GetPlayerAvatarPacket, addr 0x32a56e4, size 0x70, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAvatarPacket* GetPlayerAvatarPacket();

  /// @brief Method GetPlayerControllerDataPacket, addr 0x32a5754, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActiveHand, addr 0x32a586c, size 0x8, virtual false, abstract: false, final false
  inline void SetActiveHand(::GlobalNamespace::MultiplayerActiveHand newActiveHand);

  /// @brief Method SetMultiplayerAvatarsData, addr 0x32a5840, size 0x14, virtual false, abstract: false, final false
  inline void SetMultiplayerAvatarsData(::GlobalNamespace::MultiplayerAvatarsData playerAvatars);

  /// @brief Method UpdateAvatar, addr 0x32a5820, size 0x20, virtual false, abstract: false, final false
  inline void UpdateAvatar(::GlobalNamespace::PlayerAvatarPacket* packet);

  /// @brief Method UpdateIdentity, addr 0x32a5804, size 0x1c, virtual false, abstract: false, final false
  inline void UpdateIdentity(::GlobalNamespace::BeatSaberPlayerIdentityPacketData identityData);

  /// @brief Method UpdatePlayerControllerData, addr 0x32a5854, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32a55d8, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_activeHand, addr 0x32a55d0, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::MultiplayerActiveHand get_activeHand();

  /// @brief Method get_multiplayerAvatarsData, addr 0x32a55bc, size 0x14, virtual true, abstract: false, final true
