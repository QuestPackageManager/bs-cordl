...
public:
  ...
  /// @brief Method <Awake>b__4, addr 0x2756778, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27566e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x2755994, size 0xd50, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::UIKeyboard* New_ctor();

  /// @brief Method <Awake>b__21_0, addr 0x27566f4, size 0x1c, virtual false, abstract: false, final false
  inline void _Awake_b__21_0();

  /// @brief Method <Awake>b__21_1, addr 0x2756710, size 0x24, virtual false, abstract: false, final false
  inline void _Awake_b__21_1();

  /// @brief Method <Awake>b__21_2, addr 0x2756734, size 0x24, virtual false, abstract: false, final false
  inline void _Awake_b__21_2();

  /// @brief Method <Awake>b__21_3, addr 0x2756758, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27566ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cancelButtonWasPressedEvent, addr 0x275570c, size 0x9c, virtual false, abstract: false, final false
  inline void add_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_deleteButtonWasPressedEvent, addr 0x275549c, size 0x9c, virtual false, abstract: false, final false
  inline void add_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_okButtonWasPressedEvent, addr 0x27555d4, size 0x9c, virtual false, abstract: false, final false
  inline void add_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_textKeyWasPressedEvent, addr 0x275533c, size 0xb0, virtual false, abstract: false, final false
  inline void add_textKeyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method remove_cancelButtonWasPressedEvent, addr 0x27557a8, size 0x9c, virtual false, abstract: false, final false
  inline void remove_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_deleteButtonWasPressedEvent, addr 0x2755538, size 0x9c, virtual false, abstract: false, final false
  inline void remove_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_okButtonWasPressedEvent, addr 0x2755670, size 0x9c, virtual false, abstract: false, final false
  inline void remove_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_textKeyWasPressedEvent, addr 0x27553ec, size 0xb0, virtual false, abstract: false, final false
  inline void remove_textKeyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method set_enableOkButtonInteractivity, addr 0x2755844, size 0xa0, virtual false, abstract: false, final false
  inline void set_enableOkButtonInteractivity(bool value);

  /// @brief Method set_hideCancelButton, addr 0x27558e4, size 0xb0, virtual false, abstract: false, final false
