...
public:
  ...
  /// @brief Method <Awake>b__4, addr 0x59fea2c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fe9a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x59fdee8, size 0xac0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::UIKeyboard* New_ctor();

  /// @brief Method <Awake>b__23_0, addr 0x59fe9b0, size 0x1c, virtual false, abstract: false, final false
  inline void _Awake_b__23_0();

  /// @brief Method <Awake>b__23_1, addr 0x59fe9cc, size 0x20, virtual false, abstract: false, final false
  inline void _Awake_b__23_1();

  /// @brief Method <Awake>b__23_2, addr 0x59fe9ec, size 0x20, virtual false, abstract: false, final false
  inline void _Awake_b__23_2();

  /// @brief Method <Awake>b__23_3, addr 0x59fea0c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fe9ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cancelButtonWasPressedEvent, addr 0x59fdc38, size 0xac, virtual false, abstract: false, final false
  inline void add_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_deleteButtonWasPressedEvent, addr 0x59fd988, size 0xac, virtual false, abstract: false, final false
  inline void add_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_okButtonWasPressedEvent, addr 0x59fdae0, size 0xac, virtual false, abstract: false, final false
  inline void add_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_textKeyWasPressedEvent, addr 0x59fd808, size 0xc0, virtual false, abstract: false, final false
  inline void add_textKeyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method remove_cancelButtonWasPressedEvent, addr 0x59fdce4, size 0xac, virtual false, abstract: false, final false
  inline void remove_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_deleteButtonWasPressedEvent, addr 0x59fda34, size 0xac, virtual false, abstract: false, final false
  inline void remove_deleteButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_okButtonWasPressedEvent, addr 0x59fdb8c, size 0xac, virtual false, abstract: false, final false
  inline void remove_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_textKeyWasPressedEvent, addr 0x59fd8c8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_textKeyWasPressedEvent(::System::Action_1<char16_t>* value);

  /// @brief Method set_enableOkButtonInteractivity, addr 0x59fdd90, size 0xa4, virtual false, abstract: false, final false
  inline void set_enableOkButtonInteractivity(bool value);

  /// @brief Method set_hideCancelButton, addr 0x59fde34, size 0xb4, virtual false, abstract: false, final false
