...
public:
  ...
  /// @brief Method <PresentDetailViewController>b__0, addr 0x581e384, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x581e1d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AnimateCanvasGroupAlpha, addr 0x581c8ec, size 0x274, virtual false, abstract: false, final false
  inline void AnimateCanvasGroupAlpha(::GlobalNamespace::LevelCollectionNavigationController_AlphaAnimationType animationType);

  /// @brief Method ClearSelected, addr 0x581dd84, size 0x28, virtual false, abstract: false, final false
  inline void ClearSelected();

  /// @brief Method DidActivate, addr 0x581cb60, size 0x4d4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x581d1b4, size 0x358, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleLevelCollectionViewControllerDidSelectLevel, addr 0x581e0e8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelCollectionViewControllerDidSelectPack, addr 0x581e174, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidChangeDifficultyBeatmap, addr 0x581e214, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPresentContent, addr 0x581e234, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPressActionButton, addr 0x581e1d4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPressOpenLevelPackButton, addr 0x581e254, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPressPracticeButton, addr 0x581e1f4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerLevelFavoriteStatusDidChange, addr 0x581e274, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method HideDetailViewController, addr 0x581e094, size 0x54, virtual false, abstract: false, final false
  inline void HideDetailViewController();

  /// @brief Method HideLoading, addr 0x581de8c, size 0x20, virtual false, abstract: false, final false
  inline void HideLoading();

  static inline ::GlobalNamespace::LevelCollectionNavigationController* New_ctor();

  /// @brief Method PresentDetailViewController, addr 0x581deac, size 0x1e8, virtual false, abstract: false, final false
  inline void PresentDetailViewController(::HMUI::ViewController* viewController, bool immediately);

  /// @brief Method PresentViewControllersForLevelCollection, addr 0x581dd04, size 0x60, virtual false, abstract: false, final false
  inline void PresentViewControllersForLevelCollection();

  /// @brief Method PresentViewControllersForPack, addr 0x581dc8c, size 0x78, virtual false, abstract: false, final false
  inline void PresentViewControllersForPack();

  /// @brief Method RefreshDetail, addr 0x581dd64, size 0x20, virtual false, abstract: false, final false
  inline void RefreshDetail();

  /// @brief Method SelectLevel, addr 0x581c884, size 0x34, virtual false, abstract: false, final false
  inline void SelectLevel(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method SetData, addr 0x581c63c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDataForLevelCollection, addr 0x581c754, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDataForPack, addr 0x581c678, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowLoading, addr 0x581ddac, size 0xe0, virtual false, abstract: false, final false
  inline void ShowLoading();

  /// @brief Method <AnimateCanvasGroupAlpha>b__39_0, addr 0x581e2c4, size 0x30, virtual false, abstract: false, final false
  inline void _AnimateCanvasGroupAlpha_b__39_0(float_t f);

  /// @brief Method <AnimateCanvasGroupAlpha>b__39_1, addr 0x581e2f4, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x581e2b8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeDifficultyBeatmapEvent, addr 0x581c47c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didChangeLevelDetailContentEvent, addr 0x581bcfc, size 0xc0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method add_didPressActionButtonEvent, addr 0x581bffc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didPressOpenPackButtonEvent, addr 0x581c17c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didPressPracticeButtonEvent, addr 0x581c2fc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didSelectLevelPackEvent, addr 0x581be7c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapKey, addr 0x581c5fc, size 0x28, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_beatmapLevel, addr 0x581c624, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel();

  /// @brief Method remove_didChangeDifficultyBeatmapEvent, addr 0x581c53c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangeLevelDetailContentEvent, addr 0x581bdbc, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didChangeLevelDetailContentEvent(
      ::System::Action_2<::UnityW<::GlobalNamespace::LevelCollectionNavigationController>, ::GlobalNamespace::StandardLevelDetailViewController_ContentType>* value);

  /// @brief Method remove_didPressActionButtonEvent, addr 0x581c0bc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didPressOpenPackButtonEvent, addr 0x581c23c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didPressPracticeButtonEvent, addr 0x581c3bc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectLevelPackEvent, addr 0x581bf3c, size 0xc0, virtual false, abstract: false, final false
