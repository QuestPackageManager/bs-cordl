...
public:
  ...
  /// @brief Method <PresentDetailViewController>b__0, addr 0x57ad57c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ad3c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AnimateCanvasGroupAlpha, addr 0x57abae4, size 0x274, virtual false, abstract: false, final false
  inline void AnimateCanvasGroupAlpha(::GlobalNamespace::LevelCollectionNavigationController_AlphaAnimationType animationType);

  /// @brief Method ClearSelected, addr 0x57acf7c, size 0x28, virtual false, abstract: false, final false
  inline void ClearSelected();

  /// @brief Method DidActivate, addr 0x57abd58, size 0x4d4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57ac3ac, size 0x358, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleLevelCollectionViewControllerDidSelectLevel, addr 0x57ad2e0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelCollectionViewControllerDidSelectPack, addr 0x57ad36c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidChangeDifficultyBeatmap, addr 0x57ad40c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPresentContent, addr 0x57ad42c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPressActionButton, addr 0x57ad3cc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPressOpenLevelPackButton, addr 0x57ad44c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerDidPressPracticeButton, addr 0x57ad3ec, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelDetailViewControllerLevelFavoriteStatusDidChange, addr 0x57ad46c, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method HideDetailViewController, addr 0x57ad28c, size 0x54, virtual false, abstract: false, final false
  inline void HideDetailViewController();

  /// @brief Method HideLoading, addr 0x57ad084, size 0x20, virtual false, abstract: false, final false
  inline void HideLoading();

  static inline ::GlobalNamespace::LevelCollectionNavigationController* New_ctor();

  /// @brief Method PresentDetailViewController, addr 0x57ad0a4, size 0x1e8, virtual false, abstract: false, final false
  inline void PresentDetailViewController(::HMUI::ViewController* viewController, bool immediately);

  /// @brief Method PresentViewControllersForLevelCollection, addr 0x57acefc, size 0x60, virtual false, abstract: false, final false
  inline void PresentViewControllersForLevelCollection();

  /// @brief Method PresentViewControllersForPack, addr 0x57ace84, size 0x78, virtual false, abstract: false, final false
  inline void PresentViewControllersForPack();

  /// @brief Method RefreshDetail, addr 0x57acf5c, size 0x20, virtual false, abstract: false, final false
  inline void RefreshDetail();

  /// @brief Method SelectLevel, addr 0x57aba7c, size 0x34, virtual false, abstract: false, final false
  inline void SelectLevel(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method SetData, addr 0x57ab834, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDataForLevelCollection, addr 0x57ab94c, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method SetDataForPack, addr 0x57ab870, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method ShowLoading, addr 0x57acfa4, size 0xe0, virtual false, abstract: false, final false
  inline void ShowLoading();

  /// @brief Method <AnimateCanvasGroupAlpha>b__39_0, addr 0x57ad4bc, size 0x30, virtual false, abstract: false, final false
  inline void _AnimateCanvasGroupAlpha_b__39_0(float_t f);

  /// @brief Method <AnimateCanvasGroupAlpha>b__39_1, addr 0x57ad4ec, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ad4b0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeDifficultyBeatmapEvent, addr 0x57ab674, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didChangeLevelDetailContentEvent, addr 0x57aaef4, size 0xc0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method add_didPressActionButtonEvent, addr 0x57ab1f4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didPressOpenPackButtonEvent, addr 0x57ab374, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didPressPracticeButtonEvent, addr 0x57ab4f4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didSelectLevelPackEvent, addr 0x57ab074, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapKey, addr 0x57ab7f4, size 0x28, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_beatmapLevel, addr 0x57ab81c, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel();

  /// @brief Method remove_didChangeDifficultyBeatmapEvent, addr 0x57ab734, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didChangeLevelDetailContentEvent, addr 0x57aafb4, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didChangeLevelDetailContentEvent(
      ::System::Action_2<::UnityW<::GlobalNamespace::LevelCollectionNavigationController>, ::GlobalNamespace::StandardLevelDetailViewController_ContentType>* value);

  /// @brief Method remove_didPressActionButtonEvent, addr 0x57ab2b4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didPressOpenPackButtonEvent, addr 0x57ab434, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didPressPracticeButtonEvent, addr 0x57ab5b4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectLevelPackEvent, addr 0x57ab134, size 0xc0, virtual false, abstract: false, final false
