...
public:
  ...
  /// @brief Method Dispose, addr 0x5892240, size 0x4, virtual false, abstract: false, final false
  inline void Dispose();

  static inline ::GlobalNamespace::MockBeatmapProvider* New_ctor();

  /// @brief Method SelectBeatmapFromSuggestionsWithSelectionMaskAndOwnedSongPacks, addr 0x58921b4, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method VerifyBeatmapForSelectionMask, addr 0x58921ac, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5892244, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
