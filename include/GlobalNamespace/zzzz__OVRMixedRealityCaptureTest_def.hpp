...
public:
  ...
  /// @brief Method Initialize, addr 0x404786c, size 0x224, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRMixedRealityCaptureTest* New_ctor();

  /// @brief Method Start, addr 0x40477bc, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x4047ea0, size 0x764, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateDefaultExternalCamera, addr 0x4047a90, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4048604, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
