...
public:
  ...
  /// @brief Method Initialize, addr 0x5dc7e28, size 0x21c, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRMixedRealityCaptureTest* New_ctor();

  /// @brief Method Start, addr 0x5dc7d6c, size 0xbc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5dc84a8, size 0x6e8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateDefaultExternalCamera, addr 0x5dc8044, size 0x464, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dc8b90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
