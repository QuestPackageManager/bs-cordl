...
public:
  ...
  /// @brief Method Initialize, addr 0x28a5024, size 0x224, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRMixedRealityCaptureTest* New_ctor();

  /// @brief Method Start, addr 0x28a4f74, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x28a5670, size 0x738, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateDefaultExternalCamera, addr 0x28a5248, size 0x428, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a5da8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
