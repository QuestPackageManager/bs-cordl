...
public:
  ...
  /// @brief Method GetBase64Char, addr 0x36b9968, size 0x44, virtual false, abstract: false, final false
  static inline char16_t GetBase64Char(uint64_t digit);

  /// @brief Method GetBase64Digit, addr 0x36b990c, size 0x5c, virtual false, abstract: false, final false
  static inline uint32_t GetBase64Digit(char16_t c);

  /// @brief Method GetHexDigit, addr 0x36b98d4, size 0x38, virtual false, abstract: false, final false
