...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapDataItemExecutionOrderConstants::*)()>(&::GlobalNamespace::BeatmapDataItemExecutionOrderConstants::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x31c60b0;
