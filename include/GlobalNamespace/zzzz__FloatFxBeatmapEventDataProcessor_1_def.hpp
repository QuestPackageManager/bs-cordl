...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatFxBeatmapEventDataProcessor_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatFxBeatmapEventDataProcessor_1(FloatFxBeatmapEventDataProcessor_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatFxBeatmapEventDataProcessor_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatFxBeatmapEventDataProcessor_1(FloatFxBeatmapEventDataProcessor_1const&) = delete;
