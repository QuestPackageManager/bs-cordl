...
public:
  ...
  /// @brief Method MoveNext, addr 0x395e3ec, size 0x10c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__KnucklesUnityXRHapticsHandler___HapticsCoroutine_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x395e4f8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x395e500, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x395e538, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x395e3e8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x395e33c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x395e364, size 0x84, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HapticsCoroutine, addr 0x395e2a4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method StopHaptics, addr 0x395e324, size 0x18, virtual true, abstract: false, final true
  inline void StopHaptics();

  /// @brief Method TriggerHapticPulse, addr 0x395e304, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x395e24c, size 0x58, virtual false, abstract: false, final false
