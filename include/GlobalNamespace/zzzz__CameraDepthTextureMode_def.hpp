...
public:
  ...
  /// @brief Method Awake, addr 0x2253e30, size 0x5c, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x2253e8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
