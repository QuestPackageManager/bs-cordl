...
// Write type traits
MARK_REF_T(::GlobalNamespace::CameraDepthTextureMode*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CameraDepthTextureMode*, "", "CameraDepthTextureMode");
...
public:
  ...
  /// @brief Method Awake, addr 0x5857a60, size 0x60, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x5857ac0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CameraDepthTextureMode) == 0x28, "Size mismatch!");
