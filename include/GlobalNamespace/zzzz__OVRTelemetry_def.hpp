...
public:
  ...
  /// @brief Method Dispose, addr 0x5da2bd8, size 0x6c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method .ctor, addr 0x5da2b4c, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor(::StringW name);

  /// @brief Method get_NameHandle, addr 0x5da2b44, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MarkerAnnotation, addr 0x5da2c44, size 0x18, virtual false, abstract: false, final false
  inline void MarkerAnnotation(int32_t markerId, ::StringW annotationKey, bool annotationValue, int32_t instanceKey);

  /// @brief Method MarkerAnnotation, addr 0x5da2c74, size 0x18, virtual false, abstract: false, final false
  inline void MarkerAnnotation(int32_t markerId, ::StringW annotationKey, double_t annotationValue, int32_t instanceKey);

  /// @brief Method MarkerAnnotation, addr 0x5da2c5c, size 0x18, virtual false, abstract: false, final false
  inline void MarkerAnnotation(int32_t markerId, ::StringW annotationKey, int64_t annotationValue, int32_t instanceKey);

  /// @brief Method MarkerAnnotation, addr 0x5da2ce0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkerAnnotation, addr 0x5da2cc4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkerAnnotation, addr 0x5da2ca8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method MarkerAnnotation, addr 0x5da2c8c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5da2cfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method CreateMarkerHandle, addr 0x5da2d1c, size 0xc, virtual true, abstract: false, final false
  inline bool CreateMarkerHandle(::StringW name, ::ByRef<int32_t> nameHandle);

  /// @brief Method DestroyMarkerHandle, addr 0x5da2d28, size 0x8, virtual true, abstract: false, final false
  inline bool DestroyMarkerHandle(int32_t nameHandle);

  /// @brief Method MarkerAnnotation, addr 0x5da2d14, size 0x4, virtual true, abstract: false, final false
  inline void MarkerAnnotation(int32_t markerId, ::StringW annotationKey, ::StringW annotationValue, int32_t instanceKey);

  /// @brief Method MarkerAnnotation, addr 0x5da2d10, size 0x4, virtual true, abstract: false, final false
  inline void MarkerAnnotation(int32_t markerId, ::StringW key, ::GlobalNamespace::Qpl_OVRPlugin_Variant value, int32_t instanceKey);

  /// @brief Method MarkerEnd, addr 0x5da2d18, size 0x4, virtual true, abstract: false, final false
  inline void MarkerEnd(int32_t markerId, ::GlobalNamespace::Qpl_OVRPlugin_ResultType resultTypeId, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerPoint, addr 0x5da2d0c, size 0x4, virtual true, abstract: false, final false
  inline void MarkerPoint(int32_t markerId, ::StringW name, ::GlobalNamespace::Qpl_OVRPlugin_Annotation* annotations, int32_t annotationCount, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerPoint, addr 0x5da2d08, size 0x4, virtual true, abstract: false, final false
  inline void MarkerPoint(int32_t markerId, ::StringW name, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerPointCached, addr 0x5da2d04, size 0x4, virtual true, abstract: false, final false
  inline void MarkerPointCached(int32_t markerId, int32_t nameHandle, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerStart, addr 0x5da2d00, size 0x4, virtual true, abstract: false, final false
  inline void MarkerStart(int32_t markerId, int32_t instanceKey, int64_t timestampMs, ::StringW joinId);

  static inline ::GlobalNamespace::OVRTelemetry_NullTelemetryClient* New_ctor();

  /// @brief Method .ctor, addr 0x5da2b3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method CreateMarkerHandle, addr 0x5da2e08, size 0x10, virtual true, abstract: false, final false
  inline bool CreateMarkerHandle(::StringW name, ::ByRef<int32_t> nameHandle);

  /// @brief Method DestroyMarkerHandle, addr 0x5da2e18, size 0xc, virtual true, abstract: false, final false
  inline bool DestroyMarkerHandle(int32_t nameHandle);

  /// @brief Method MarkerAnnotation, addr 0x5da2dbc, size 0x18, virtual true, abstract: false, final false
  inline void MarkerAnnotation(int32_t markerId, ::StringW annotationKey, ::StringW annotationValue, int32_t instanceKey);

  /// @brief Method MarkerAnnotation, addr 0x5da2dd4, size 0x1c, virtual true, abstract: false, final false
  inline void MarkerAnnotation(int32_t markerId, ::StringW key, ::GlobalNamespace::Qpl_OVRPlugin_Variant value, int32_t instanceKey);

  /// @brief Method MarkerEnd, addr 0x5da2df0, size 0x18, virtual true, abstract: false, final false
  inline void MarkerEnd(int32_t markerId, ::GlobalNamespace::Qpl_OVRPlugin_ResultType resultTypeId, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerPoint, addr 0x5da2d9c, size 0x20, virtual true, abstract: false, final false
  inline void MarkerPoint(int32_t markerId, ::StringW name, ::GlobalNamespace::Qpl_OVRPlugin_Annotation* annotations, int32_t annotationCount, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerPoint, addr 0x5da2d84, size 0x18, virtual true, abstract: false, final false
  inline void MarkerPoint(int32_t markerId, ::StringW name, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerPointCached, addr 0x5da2d6c, size 0x18, virtual true, abstract: false, final false
  inline void MarkerPointCached(int32_t markerId, int32_t nameHandle, int32_t instanceKey, int64_t timestampMs);

  /// @brief Method MarkerStart, addr 0x5da2d30, size 0x3c, virtual true, abstract: false, final false
  inline void MarkerStart(int32_t markerId, int32_t instanceKey, int64_t timestampMs, ::StringW joinId);

  static inline ::GlobalNamespace::OVRTelemetry_QPLTelemetryClient* New_ctor();

  /// @brief Method .ctor, addr 0x5da2b40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x5da2e24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddPlayModeOrigin, addr 0x5da2984, size 0xa8, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTelemetryMarker AddPlayModeOrigin(::GlobalNamespace::OVRTelemetryMarker marker);

  /// @brief Method AddSDKVersionAnnotation, addr 0x5da26ec, size 0x140, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTelemetryMarker AddSDKVersionAnnotation(::GlobalNamespace::OVRTelemetryMarker marker);

  /// @brief Method GetPlayModeOrigin, addr 0x5da28ac, size 0xd8, virtual false, abstract: false, final false
  static inline ::StringW GetPlayModeOrigin();

  /// @brief Method GetTelemetrySettingString, addr 0x5da2a2c, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW GetTelemetrySettingString(bool value);

  /// @brief Method SendEvent, addr 0x5da260c, size 0xb8, virtual false, abstract: false, final false
  static inline void SendEvent(int32_t markerId, ::GlobalNamespace::Qpl_OVRPlugin_ResultType result);

  /// @brief Method Start, addr 0x5da24d0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Client, addr 0x5da24f8, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRTelemetry_TelemetryClient* get_Client();

  /// @brief Method get_IsActive, addr 0x5da24f0, size 0x8, virtual false, abstract: false, final false
