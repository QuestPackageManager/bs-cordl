...
public:
  ...
  /// @brief Method GetComputeFieldPropertyId, addr 0x57279b4, size 0x54, virtual false, abstract: false, final false
  static inline int32_t GetComputeFieldPropertyId(::StringW fieldName);

  /// @brief Method GetLightProbeLightBakeIdPropertyId, addr 0x57278e8, size 0xcc, virtual false, abstract: false, final false
  static inline int32_t GetLightProbeLightBakeIdPropertyId(::GlobalNamespace::LightConstants_BakeId bakeId);

  /// @brief Method GetLightmapLightBakeIdPropertyId, addr 0x572781c, size 0xcc, virtual false, abstract: false, final false
