...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightConstants", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightConstants(LightConstants&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightConstants", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightConstants(LightConstantsconst&) = delete;
