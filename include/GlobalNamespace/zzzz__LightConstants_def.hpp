...
public:
  ...
  /// @brief Method GetComputeFieldPropertyId, addr 0x39e1bfc, size 0x50, virtual false, abstract: false, final false
  static inline int32_t GetComputeFieldPropertyId(::StringW fieldName);

  /// @brief Method GetLightProbeLightBakeIdPropertyId, addr 0x39e1b54, size 0xa8, virtual false, abstract: false, final false
  static inline int32_t GetLightProbeLightBakeIdPropertyId(::GlobalNamespace::LightConstants_BakeId bakeId);

  /// @brief Method GetLightmapLightBakeIdPropertyId, addr 0x39e1aac, size 0xa8, virtual false, abstract: false, final false
