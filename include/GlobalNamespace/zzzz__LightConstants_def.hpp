...
/// @brief Method GetComputeFieldPropertyId, addr 0x56b9ac8, size 0x54, virtual false, abstract: false, final false
static inline int32_t GetComputeFieldPropertyId(::StringW  fieldName) ;

/// @brief Method GetLightProbeLightBakeIdPropertyId, addr 0x56b99fc, size 0xcc, virtual false, abstract: false, final false
static inline int32_t GetLightProbeLightBakeIdPropertyId(::GlobalNamespace::LightConstants_BakeId  bakeId) ;

/// @brief Method GetLightmapLightBakeIdPropertyId, addr 0x56b9930, size 0xcc, virtual false, abstract: false, final false
