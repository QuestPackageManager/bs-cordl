...
public:
  ...
  /// @brief Method .ctor, addr 0x39c0a08, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x39c0a00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
