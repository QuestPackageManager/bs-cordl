...
public:
  ...
  /// @brief Method .ctor, addr 0x24ec600, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x24ec5f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
