...
public:
  ...
  /// @brief Method .ctor, addr 0x39c09e0, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x39c09d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
