...
public:
  ...
  /// @brief Method .ctor, addr 0x570dc64, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x570dc60, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
