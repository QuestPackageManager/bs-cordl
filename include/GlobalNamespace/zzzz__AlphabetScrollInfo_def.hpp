...
public:
  ...
  /// @brief Method .ctor, addr 0x23d3e98, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x23d3e90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
