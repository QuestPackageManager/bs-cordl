...
public:
  ...
  /// @brief Method .ctor, addr 0x58735d0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x58735cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
