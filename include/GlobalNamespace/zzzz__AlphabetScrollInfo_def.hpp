...
public:
  ...
  /// @brief Method .ctor, addr 0x56a0014, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x56a0010, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
