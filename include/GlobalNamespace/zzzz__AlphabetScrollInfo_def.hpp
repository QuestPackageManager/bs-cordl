...
public:
  ...
  /// @brief Method .ctor, addr 0x563b200, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x563b1fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
