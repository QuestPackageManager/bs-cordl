...
// Write type traits
MARK_REF_T(::GlobalNamespace::AlphabetScrollInfo*);
MARK_REF_T(::GlobalNamespace::AlphabetScrollInfo_Data*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AlphabetScrollInfo*, "", "AlphabetScrollInfo");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AlphabetScrollInfo_Data*, "", "AlphabetScrollInfo/Data");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58757e4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AlphabetScrollInfo_Data) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58757e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::AlphabetScrollInfo) == 0x10, "Size mismatch!");
