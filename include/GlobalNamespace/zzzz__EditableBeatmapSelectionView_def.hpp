...
public:
  ...
  /// @brief Method SetBeatmap, addr 0x3b05898, size 0x64, virtual true, abstract: false, final false
  inline void SetBeatmap(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method SetVisibility, addr 0x3b05864, size 0x28, virtual false, abstract: false, final false
  inline void SetVisibility(bool visible);

  /// @brief Method Setup, addr 0x3b0588c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b058fc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clearButton, addr 0x3b057e0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_clearButton();

  /// @brief Method get_editButton, addr 0x3b057d8, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_editButton();

  /// @brief Method get_interactable, addr 0x3b057e8, size 0x8, virtual false, abstract: false, final false
  inline bool get_interactable();

  /// @brief Method get_showClearButton, addr 0x3b05850, size 0x8, virtual false, abstract: false, final false
  inline bool get_showClearButton();

  /// @brief Method set_interactable, addr 0x3b057f0, size 0x60, virtual false, abstract: false, final false
  inline void set_interactable(bool value);

  /// @brief Method set_showClearButton, addr 0x3b05858, size 0xc, virtual false, abstract: false, final false
