...
/// @brief Method OpenDataPrivacyPage, addr 0x322b03c, size 0x4, virtual true, abstract: false, final true
inline void OpenDataPrivacyPage() ;

/// @brief Method .ctor, addr 0x322b744, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_supportsOpenDataPrivacyPage, addr 0x322b034, size 0x8, virtual true, abstract: false, final true
...
static constexpr uint32_t  __IL2CPP_TYPE_DEFINITION_INDEX{23383};
