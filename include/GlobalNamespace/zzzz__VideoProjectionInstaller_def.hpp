...
public:
  ...
  /// @brief Method InstallBindings, addr 0x599e2fc, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x599e3cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
