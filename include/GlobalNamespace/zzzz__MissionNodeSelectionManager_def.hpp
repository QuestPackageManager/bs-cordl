...
public:
  ...
  /// @brief Method DeselectSelectedNode, addr 0x3c19368, size 0x80, virtual false, abstract: false, final false
  inline void DeselectSelectedNode();

  /// @brief Method HandleNodeWasDisplayed, addr 0x3c19a1c, size 0x80, virtual false, abstract: false, final false
  inline void HandleNodeWasDisplayed(::GlobalNamespace::MissionNodeVisualController* missionNode);

  /// @brief Method HandleNodeWasSelect, addr 0x3c19968, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3c196a0, size 0x168, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3c19410, size 0x130, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3c19a9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectMissionNodeEvent, addr 0x3c19208, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectMissionNodeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>* value);

  /// @brief Method remove_didSelectMissionNodeEvent, addr 0x3c192b8, size 0xb0, virtual false, abstract: false, final false
