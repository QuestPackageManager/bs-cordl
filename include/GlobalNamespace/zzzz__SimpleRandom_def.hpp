...
public:
  ...
  /// @brief Method Sample, addr 0x3251f6c, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3251ee4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3251f00, size 0x6c, virtual false, abstract: false, final false
