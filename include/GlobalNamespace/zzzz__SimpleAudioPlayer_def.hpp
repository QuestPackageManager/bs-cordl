...
public:
  ...
  /// @brief Method FadeIn, addr 0x2622274, size 0x3c, virtual false, abstract: false, final false
  inline void FadeIn(float_t duration);

  /// @brief Method FadeOut, addr 0x26223b0, size 0x38, virtual true, abstract: false, final false
  inline void FadeOut(float_t duration);

  static inline ::GlobalNamespace::SimpleAudioPlayer* New_ctor();

  /// @brief Method PauseCurrentChannel, addr 0x26223e8, size 0x1c, virtual true, abstract: false, final false
  inline void PauseCurrentChannel();

  /// @brief Method Start, addr 0x26221f4, size 0x80, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnPauseCurrentChannel, addr 0x2622404, size 0x1c, virtual true, abstract: false, final false
  inline void UnPauseCurrentChannel();

  /// @brief Method Update, addr 0x26222b0, size 0x100, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2622420, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeAudioClip, addr 0x26221ec, size 0x8, virtual true, abstract: false, final false
