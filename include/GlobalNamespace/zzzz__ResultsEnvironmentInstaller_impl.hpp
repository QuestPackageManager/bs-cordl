...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__ResultsEnvironmentInstaller____c::*)()>(
  ...
  constexpr static std::size_t addrs = 0x2625310;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::GlobalNamespace::BaseResultsEnvironmentController> (
  ...
  constexpr static std::size_t addrs = 0x2625318;
...
inline void GlobalNamespace::__ResultsEnvironmentInstaller____c::setStaticF___9(::GlobalNamespace::__ResultsEnvironmentInstaller____c* value) {
  ::cordl_internals::setStaticField<::GlobalNamespace::__ResultsEnvironmentInstaller____c*, "<>9",
                                    ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__ResultsEnvironmentInstaller____c*>::get>(
      std::forward<::GlobalNamespace::__ResultsEnvironmentInstaller____c*>(value));
}
inline ::GlobalNamespace::__ResultsEnvironmentInstaller____c* GlobalNamespace::__ResultsEnvironmentInstaller____c::getStaticF___9() {
  return ::cordl_internals::getStaticField<::GlobalNamespace::__ResultsEnvironmentInstaller____c*, "<>9",
                                           ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__ResultsEnvironmentInstaller____c*>::get>();
}
inline void
...
inline ::GlobalNamespace::__ResultsEnvironmentInstaller____c* GlobalNamespace::__ResultsEnvironmentInstaller____c::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__ResultsEnvironmentInstaller____c*>());
}
inline void GlobalNamespace::__ResultsEnvironmentInstaller____c::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__ResultsEnvironmentInstaller____c*>::get(),
                                                                             ".ctor", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::ResultsEnvironmentInstaller::*)()>(
  ...
  inline static const ::MethodInfo* methodInfo() {
    ...
    static auto* ___internal_method =
        THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(),
                                                       ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(), 11));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::GlobalNamespace::ResultsEnvironmentInstaller.LoadResourcesBeforeInstall
template <>
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ResultsEnvironmentInstaller::*)(
  ...
  constexpr static std::size_t addrs = 0x262503c;

  inline static const ::MethodInfo* methodInfo() {

    static auto* ___internal_method =
        THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(),
                                                       ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(), 12));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::GlobalNamespace::ResultsEnvironmentInstaller.InstallBindings
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ResultsEnvironmentInstaller::*)()>(
    &::GlobalNamespace::ResultsEnvironmentInstaller::InstallBindings)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x262519c;

  inline static const ::MethodInfo* methodInfo() {

    static auto* ___internal_method =
        THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(),
                                                       ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(), 8));
    return ___internal_method;
  }
};
//  Writing Method size for method: ::GlobalNamespace::ResultsEnvironmentInstaller._ctor
template <>
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ResultsEnvironmentInstaller::*)()>(&::GlobalNamespace::ResultsEnvironmentInstaller::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x262521c;
...
GlobalNamespace::ResultsEnvironmentInstaller::__cordl_internal_get__resultsEnvironmentControllers() {
  ...
  return this->____resultsEnvironmentControllers;
}
...
GlobalNamespace::ResultsEnvironmentInstaller::__cordl_internal_get__resultsEnvironmentControllers() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____resultsEnvironmentControllers;
}
constexpr void GlobalNamespace::ResultsEnvironmentInstaller::__cordl_internal_set__resultsEnvironmentControllers(
    ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::BaseResultsEnvironmentController>>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void GlobalNamespace::ResultsEnvironmentInstaller::InstallBindings() {
  auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::ResolveVtableSlot(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(this)),
                                                                             ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(), 8)));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
inline ::GlobalNamespace::ResultsEnvironmentInstaller* GlobalNamespace::ResultsEnvironmentInstaller::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::ResultsEnvironmentInstaller*>());
}
inline void GlobalNamespace::ResultsEnvironmentInstaller::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::ResultsEnvironmentInstaller*>::get(), ".ctor",
                                                                             std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
// Ctor Parameters []
constexpr ::GlobalNamespace::ResultsEnvironmentInstaller::ResultsEnvironmentInstaller() {}
