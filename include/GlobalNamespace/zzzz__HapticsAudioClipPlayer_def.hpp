...
public:
  ...
  /// @brief Method OnCreated, addr 0x39cd5dc, size 0x14, virtual true, abstract: false, final false
  inline void OnCreated(::GlobalNamespace::HapticsAudioClipPlayer* item);

  /// @brief Method OnDespawned, addr 0x39cd664, size 0x14, virtual true, abstract: false, final false
  inline void OnDespawned(::GlobalNamespace::HapticsAudioClipPlayer* item);

  /// @brief Method OnDestroyed, addr 0x39cd5f0, size 0x74, virtual true, abstract: false, final false
  inline void OnDestroyed(::GlobalNamespace::HapticsAudioClipPlayer* item);

  /// @brief Method Reinitialize, addr 0x39cd678, size 0x14, virtual true, abstract: false, final false
  inline void Reinitialize(::GlobalNamespace::HapticsAudioClipPlayer* clipPlayer);

  /// @brief Method .ctor, addr 0x39cd68c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x39cd6d8, size 0x128, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x39cd800, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x39cd808, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x39cd840, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x39cd6d4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39cd4b0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x39cd84c, size 0x110, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::HapticsAudioClipPlayer__HandleOneShotPlayEndCoroutine_d__11* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x39cd95c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x39cd964, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x39cd99c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x39cd848, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x39cd520, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method ForceStopPlaying, addr 0x39cd548, size 0x2c, virtual false, abstract: false, final false
  inline void ForceStopPlaying();

  /// @brief Method GetPanForNode, addr 0x39cd2b8, size 0xe4, virtual false, abstract: false, final false
  inline float_t GetPanForNode(::UnityEngine::XR::XRNode node);

  /// @brief Method HandleContinuousAudioCoroutine, addr 0x39cd408, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleOneShotPlayEndCoroutine, addr 0x39cd39c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x39cd574, size 0x38, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::HapticsAudioClipPlayer* New_ctor();

  /// @brief Method PlayHapticsPreset, addr 0x39cd128, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x39cd264, size 0x54, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method RestartHaptic, addr 0x39cd4ac, size 0x4, virtual false, abstract: false, final false
  inline void RestartHaptic();

  /// @brief Method TriggerContinuousHaptic, addr 0x39cd474, size 0x38, virtual false, abstract: false, final false
  inline void TriggerContinuousHaptic();

  /// @brief Method UpdateFadeVolume, addr 0x39cd4d8, size 0x48, virtual false, abstract: false, final false
  inline void UpdateFadeVolume(float_t timeSinceEnd);

  /// @brief Method <HandleOneShotPlayEndCoroutine>b__11_0, addr 0x39cd5b4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39cd5ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
