...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13946)), TypeDefinitionIndex(TypeDefinitionIndex(11094)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13946), inst:
// 302 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(13943)) CS Name: ::DIContainerSignal*
...
public:
  ...
  /// @brief Method .ctor addr 0x1fa1934 size 0x48 virtual false final false
  inline void _ctor();
