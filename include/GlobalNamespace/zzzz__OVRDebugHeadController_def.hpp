...
public:
  ...
  /// @brief Method Awake, addr 0x3fa2eec, size 0xfc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRDebugHeadController* New_ctor();

  /// @brief Method Start, addr 0x3fa2fe8, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3fa2fec, size 0x534, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3fa3520, size 0x24, virtual false, abstract: false, final false
  inline void _ctor();
