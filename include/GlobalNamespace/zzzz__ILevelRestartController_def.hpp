...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ILevelRestartController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILevelRestartController(ILevelRestartControllerconst&) = delete;
