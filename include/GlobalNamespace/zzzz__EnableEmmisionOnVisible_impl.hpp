...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x56a1248;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::OnBecameVisible)> {
  ...
  constexpr static std::size_t addrs = 0x56a1350;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::OnBecameInvisible)> {
  constexpr static std::size_t size = 0xa8;
  constexpr static std::size_t addrs = 0x56a13f8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EnableEmmisionOnVisible::*)()>(&::GlobalNamespace::EnableEmmisionOnVisible::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x56a14a0;
...
constexpr ::ArrayW<::UnityEngine::ParticleSystem_EmissionModule,::Array<::UnityEngine::ParticleSystem_EmissionModule>*>& GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_get__emmisionModules()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____emmisionModules;
}
constexpr ::ArrayW<::UnityEngine::ParticleSystem_EmissionModule,::Array<::UnityEngine::ParticleSystem_EmissionModule>*> const& GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_get__emmisionModules() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____emmisionModules;
}
constexpr void GlobalNamespace::EnableEmmisionOnVisible::__cordl_internal_set__emmisionModules(::ArrayW<::UnityEngine::ParticleSystem_EmissionModule,::Array<::UnityEngine::ParticleSystem_EmissionModule>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
