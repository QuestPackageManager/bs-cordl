...
public:
  ...
  /// @brief Method MoveNext, addr 0x2228f08, size 0x318, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2229220, size 0x58, virtual true, abstract: false, final true
...
static_assert(offsetof(::GlobalNamespace::__OculusInit___InitializeInternalAsync_d__7, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__OculusInit___InitializeInternalAsync_d__7, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__OculusInit___InitializeInternalAsync_d__7, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__OculusInit___InitializeInternalAsync_d__7, __u__1) == 0x28, "Offset mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x2228d2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <TryToInitialize>b__0, addr 0x2229278, size 0xe0, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::__OculusInit____c__DisplayClass8_0, ___tcs) == 0x10, "Offset mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x2228ef8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <CheckUserAgeCategory>b__0, addr 0x22293f0, size 0x174, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::__OculusInit____c__DisplayClass9_0, ___tcs) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__OculusInit____c__DisplayClass9_0, _____4__this) == 0x18, "Offset mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x2228f00, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <CheckEntitlements>b__0, addr 0x2229564, size 0x104, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::__OculusInit____c__DisplayClass10_0, ___tcs) == 0x10, "Offset mismatch!");
...
public:
  ...
  /// @brief Method set_userAgeCategoryReceivedOrTimedOut, addr 0x222895c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method InitializeInternalAsync, addr 0x2228970, size 0xf8, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* InitializeInternalAsync();

  /// @brief Method TryToInitialize, addr 0x2228a68, size 0x2c4, virtual false, abstract: false, final false
  inline void TryToInitialize(::System::Threading::Tasks::TaskCompletionSource_1<bool>* tcs);

  /// @brief Method CheckUserAgeCategory, addr 0x2228d34, size 0xe8, virtual false, abstract: false, final false
  inline void CheckUserAgeCategory(::System::Threading::Tasks::TaskCompletionSource_1<bool>* tcs);

  /// @brief Method CheckEntitlements, addr 0x2228e1c, size 0xc8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::OculusInit, ____userAgeCategoryReceivedOrTimedOut_k__BackingField) == 0x28, "Offset mismatch!");
