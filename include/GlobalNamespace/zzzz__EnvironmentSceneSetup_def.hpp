...
public:
  ...
  /// @brief Method InstallBindings, addr 0x2318a80, size 0x168, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::EnvironmentSceneSetup* New_ctor();

  /// @brief Method .ctor, addr 0x2318be8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
