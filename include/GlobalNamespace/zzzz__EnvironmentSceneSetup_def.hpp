...
public:
  ...
  /// @brief Method InstallBindings, addr 0x259c360, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x259c4c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
