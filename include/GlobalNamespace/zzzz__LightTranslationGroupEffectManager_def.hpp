...
public:
  ...
  /// @brief Method OnDestroy, addr 0x26e33fc, size 0x148, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x26e3008, size 0x3f4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x26e3544, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
