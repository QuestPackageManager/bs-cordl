...
/// @brief Field _lightTranslationGroupEffects, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightTranslationGroupEffects, put=__cordl_internal_set__lightTranslationGroupEffects)) ::System::Collections::Generic::List_1<::GlobalNamespace::LightTranslationGroupEffect*>*  _lightTranslationGroupEffects;

/// @brief Field _lightTranslationGroups, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightTranslationGroups, put=__cordl_internal_set__lightTranslationGroups)) ::ArrayW<::UnityW<::GlobalNamespace::LightTranslationGroup>,::Array<::UnityW<::GlobalNamespace::LightTranslationGroup>>*>  _lightTranslationGroups;

static inline ::GlobalNamespace::LightTranslationGroupEffectManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57e9540, size 0x104, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57e9158, size 0x3e8, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57e9644, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
