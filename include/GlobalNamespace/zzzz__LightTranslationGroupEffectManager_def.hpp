...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightTranslationGroupEffectManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightTranslationGroupEffectManager*, "", "LightTranslationGroupEffectManager");
// Dependencies LightTranslationGroup, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightTranslationGroup>> const& __cordl_internal_get__lightTranslationGroups() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::LightTranslationGroup>>& __cordl_internal_get__lightTranslationGroups();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationGroupEffectManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightTranslationGroupEffectManager(LightTranslationGroupEffectManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightTranslationGroupEffectManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightTranslationGroupEffectManager(LightTranslationGroupEffectManagerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LightTranslationGroupEffectManager) == 0x38, "Size mismatch!");
