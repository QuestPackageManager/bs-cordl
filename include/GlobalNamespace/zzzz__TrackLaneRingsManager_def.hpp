...
public:
  ...
  /// @brief Field _rings, offset 0x58, size 0x8
...
public:
  ...
  /// @brief Field _rings, offset: 0x58, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::TrackLaneRingsManager, ____environmentContext) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRingsManager, ____audioTimeSyncController) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TrackLaneRingsManager, ____rings) == 0x58, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::TrackLaneRingsManager) == 0x60, "Size mismatch!");
