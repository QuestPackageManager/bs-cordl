...
public:
  ...
  /// @brief Method FixedUpdate, addr 0x58676b4, size 0x68, virtual false, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method LateUpdate, addr 0x586771c, size 0x7c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::TrackLaneRingsManager* New_ctor();

  /// @brief Method OnDrawGizmosSelected, addr 0x5867798, size 0x27c, virtual false, abstract: false, final false
  inline void OnDrawGizmosSelected();

  /// @brief Method Start, addr 0x58673f0, size 0x2c4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5867a14, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Rings, addr 0x58673e8, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::TrackLaneRing>, ::Array<::UnityW<::GlobalNamespace::TrackLaneRing>>*> get_Rings();

  /// @brief Method get_ringPositionStep, addr 0x58673e0, size 0x8, virtual false, abstract: false, final false
