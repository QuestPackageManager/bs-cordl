...
public:
  ...
  /// @brief Method DecButtonPressed, addr 0x2663f90, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method IncButtonPressed, addr 0x2663f50, size 0x40, virtual true, abstract: false, final false
  inline void IncButtonPressed();

  static inline ::GlobalNamespace::ListSettingsController* New_ctor();

  /// @brief Method OnEnable, addr 0x2663e6c, size 0x34, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x2663ef4, size 0x5c, virtual false, abstract: false, final false
  inline void Refresh(bool applyValue);

  /// @brief Method RefreshUI, addr 0x2663ea0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2663fc8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
