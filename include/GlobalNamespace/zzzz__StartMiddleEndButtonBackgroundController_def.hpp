...
/// @brief Method SetEndSprite, addr 0x58589bc, size 0x20, virtual false, abstract: false, final false
inline void SetEndSprite() ;

/// @brief Method SetMiddleSprite, addr 0x585899c, size 0x20, virtual false, abstract: false, final false
inline void SetMiddleSprite() ;

/// @brief Method SetStartSprite, addr 0x585897c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58589dc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
