...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapLevelOrPackIdAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapLevelOrPackIdAttribute*, "", "BeatmapLevelOrPackIdAttribute");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelOrPackIdAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapLevelOrPackIdAttribute(BeatmapLevelOrPackIdAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapLevelOrPackIdAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapLevelOrPackIdAttribute(BeatmapLevelOrPackIdAttributeconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatmapLevelOrPackIdAttribute) == 0x20, "Size mismatch!");
