...
/// @brief Method .ctor, addr 0x3650ca8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BeatmapLevelOrPackIdFilter  filter) ;

/// @brief Method get_allowEmpty, addr 0x3650c94, size 0xc, virtual false, abstract: false, final false
inline bool get_allowEmpty() ;

/// @brief Method get_allowLevels, addr 0x3650c80, size 0xc, virtual false, abstract: false, final false
inline bool get_allowLevels() ;

/// @brief Method get_allowPacks, addr 0x3650c6c, size 0xc, virtual false, abstract: false, final false
