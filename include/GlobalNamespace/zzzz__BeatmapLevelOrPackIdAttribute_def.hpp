...
public:
  ...
  /// @brief Method .ctor, addr 0x368d678, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelOrPackIdFilter filter);

  /// @brief Method get_allowEmpty, addr 0x368d664, size 0xc, virtual false, abstract: false, final false
  inline bool get_allowEmpty();

  /// @brief Method get_allowLevels, addr 0x368d650, size 0xc, virtual false, abstract: false, final false
  inline bool get_allowLevels();

  /// @brief Method get_allowPacks, addr 0x368d63c, size 0xc, virtual false, abstract: false, final false
