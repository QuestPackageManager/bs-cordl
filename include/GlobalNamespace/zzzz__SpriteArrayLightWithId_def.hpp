...
/// @brief Field _multiplyColorByAlpha, offset 0x54, size 0x4 
 __declspec(property(get=__cordl_internal_get__multiplyColorByAlpha, put=__cordl_internal_set__multiplyColorByAlpha)) ::GlobalNamespace::SpriteArrayLightWithId_MultiplyColorByAlphaType  _multiplyColorByAlpha;
...
/// @brief Field _spriteRenderers, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__spriteRenderers, put=__cordl_internal_set__spriteRenderers)) ::ArrayW<::UnityW<::UnityEngine::SpriteRenderer>,::Array<::UnityW<::UnityEngine::SpriteRenderer>>*>  _spriteRenderers;

 __declspec(property(get=get_color)) ::UnityEngine::Color  color;

/// @brief Method ColorWasSet, addr 0x56bcb2c, size 0x1a4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bccd0, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x56bcafc, size 0x30, virtual false, abstract: false, final false
