...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x572aa18, size 0x1a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572abbc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x572a9e8, size 0x30, virtual false, abstract: false, final false
