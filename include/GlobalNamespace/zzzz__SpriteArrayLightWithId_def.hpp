...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x39e4db8, size 0x198, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e4f50, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x39e4d88, size 0x30, virtual false, abstract: false, final false
