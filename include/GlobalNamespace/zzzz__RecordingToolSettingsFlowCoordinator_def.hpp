...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingToolSettingsFlowCoordinator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolSettingsFlowCoordinator*, "", "RecordingToolSettingsFlowCoordinator");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a0d4a8, size 0x128, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5a0d5d0, size 0xb0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleRecordingToolSettingsViewControllerDidFinish, addr 0x5a0d6d4, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5a0d680, size 0x54, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5a0d734, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RecordingToolSettingsFlowCoordinator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RecordingToolSettingsFlowCoordinator(RecordingToolSettingsFlowCoordinator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RecordingToolSettingsFlowCoordinator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RecordingToolSettingsFlowCoordinator(RecordingToolSettingsFlowCoordinatorconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::RecordingToolSettingsFlowCoordinator) == 0xd0, "Size mismatch!");
