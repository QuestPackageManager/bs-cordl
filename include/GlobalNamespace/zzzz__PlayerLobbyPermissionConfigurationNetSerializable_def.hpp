...
public:
  ...
  /// @brief Method Deserialize, addr 0x13a7b38, size 0x6c, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x13a7a50, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x13a79ec, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x13a7ad8, size 0x60, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13a7a80, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_hasInvitePermission, addr 0x13a79e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasInvitePermission();

  /// @brief Method get_hasKickVotePermission, addr 0x13a79dc, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasKickVotePermission();

  /// @brief Method get_hasRecommendBeatmapsPermission, addr 0x13a79cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasRecommendBeatmapsPermission();

  /// @brief Method get_hasRecommendGameplayModifiersPermission, addr 0x13a79d4, size 0x8, virtual false, abstract: false, final false
  inline bool get_hasRecommendGameplayModifiersPermission();

  /// @brief Method get_isServerOwner, addr 0x13a79c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_isServerOwner();

  /// @brief Method get_userId, addr 0x13a79bc, size 0x8, virtual false, abstract: false, final false
