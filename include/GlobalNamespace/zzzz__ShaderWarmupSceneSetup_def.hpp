...
public:
  ...
  /// @brief Method InstallBindings, addr 0x234cd98, size 0xb8, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::ShaderWarmupSceneSetup* New_ctor();

  /// @brief Method .ctor, addr 0x234ce50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
