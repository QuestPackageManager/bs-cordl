...
public:
  // Declarations
  /// @brief Method ToPlayerAllOverallStatsData addr 0x2371f14 size 0xd8 virtual false final false
  ...
  /// @brief Method ToPlayerAllOverallStatsData addr 0x23720e4 size 0xf4 virtual false final false
  ...
  /// @brief Method ToPlayerOverallStats addr 0x2371fec size 0xf8 virtual false final false
  ...
  /// @brief Method ToPlayerOverallStats addr 0x23721d8 size 0xf8 virtual false final false
  ...
  /// @brief Method ToPlayerAllOverallStatsData addr 0x23722d0 size 0xcc virtual false final false
  ...
  /// @brief Method ToPlayerOverallStatsData addr 0x237245c size 0xec virtual false final false
