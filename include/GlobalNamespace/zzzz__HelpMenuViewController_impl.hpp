...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HelpMenuViewController::*)(::System::Action_1<::UnityW<::HMUI::ViewController>>*)>(&::GlobalNamespace::HelpMenuViewController::add_didSelectHelpSubMenuEvent)> {
  constexpr static std::size_t size = 0xc0;
  constexpr static std::size_t addrs = 0x57a77b0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HelpMenuViewController::*)(::System::Action_1<::UnityW<::HMUI::ViewController>>*)>(&::GlobalNamespace::HelpMenuViewController::remove_didSelectHelpSubMenuEvent)> {
  constexpr static std::size_t size = 0xc0;
  constexpr static std::size_t addrs = 0x57a7870;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HelpMenuViewController::*)(bool, bool, bool)>(&::GlobalNamespace::HelpMenuViewController::DidActivate)> {
  ...
  constexpr static std::size_t addrs = 0x57a7930;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HelpMenuViewController::*)(::HMUI::SegmentedControl*, int32_t)>(&::GlobalNamespace::HelpMenuViewController::HandleHelpMenuSegmentedControlDidSelectCell)> {
  ...
  constexpr static std::size_t addrs = 0x57a7e78;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HelpMenuViewController::*)()>(&::GlobalNamespace::HelpMenuViewController::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x57a7f08;
...
constexpr ::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController>& GlobalNamespace::HelpMenuViewController::__cordl_internal_get__privacyPolicyNoticeDisplayViewController()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____privacyPolicyNoticeDisplayViewController;
}
constexpr ::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController> const& GlobalNamespace::HelpMenuViewController::__cordl_internal_get__privacyPolicyNoticeDisplayViewController() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____privacyPolicyNoticeDisplayViewController;
}
constexpr void GlobalNamespace::HelpMenuViewController::__cordl_internal_set__privacyPolicyNoticeDisplayViewController(::UnityW<::GlobalNamespace::PrivacyPolicyNoticeDisplayViewController>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->____privacyPolicyNoticeDisplayViewController)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
...
constexpr ::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityW<::HMUI::ViewController>,::StringW>>* const& GlobalNamespace::HelpMenuViewController::__cordl_internal_get__viewControllers() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____viewControllers;
}
