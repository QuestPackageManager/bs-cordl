...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x260cf40, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method EnqueueLevel, addr 0x260c900, size 0xc0, virtual false, abstract: false, final false
  inline bool EnqueueLevel(::GlobalNamespace::__SongRunningHelper__QueuedSongParams queuedSongParams);

  /// @brief Method FindBeatmapLevelPackBeatmaps, addr 0x260c794, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method StartLevel, addr 0x260c9c0, size 0x30c, virtual false, abstract: false, final false
  inline void StartLevel(::GlobalNamespace::__SongRunningHelper__QueuedSongParams queuedSongParams);

  /// @brief Method StopAllLevels, addr 0x260cccc, size 0x60, virtual false, abstract: false, final false
  inline void StopAllLevels();

  /// @brief Method StopCurrentLevel, addr 0x260cd2c, size 0x1c, virtual false, abstract: false, final false
  inline void StopCurrentLevel();

  /// @brief Method <StartLevel>g__HandleLevelDidFinishCallback|9_0, addr 0x260cdc4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260cd48, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
