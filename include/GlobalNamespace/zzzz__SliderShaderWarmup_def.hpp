...
public:
  ...
  /// @brief Method Start, addr 0x2489a8c, size 0x1d4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2489c60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
