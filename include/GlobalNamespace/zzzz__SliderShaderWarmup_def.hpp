...
public:
  ...
  /// @brief Method Start, addr 0x3b78d5c, size 0x1c8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b78f24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
