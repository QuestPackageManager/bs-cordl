...
public:
  ...
  /// @brief Method Start, addr 0x5841590, size 0x1fc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x584178c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
