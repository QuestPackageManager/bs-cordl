...
public:
  ...
  /// @brief Method DrawGizmos, addr 0x26b3550, size 0x2b4, virtual false, abstract: false, final false
  inline void DrawGizmos();

  /// @brief Method Finish, addr 0x26b33a4, size 0x1ac, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method Init, addr 0x26b262c, size 0x418, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessNewData, addr 0x26b2a44, size 0x960, virtual true, abstract: false, final true
  ...
  /// @brief Method RegisterDidChangeReceiver, addr 0x26b24cc, size 0x58, virtual true, abstract: false, final true
  inline void RegisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver* receiver);

  /// @brief Method RegisterDidFinishReceiver, addr 0x26b2524, size 0x58, virtual true, abstract: false, final true
  inline void RegisterDidFinishReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver* receiver);

  /// @brief Method UnregisterDidChangeReceiver, addr 0x26b257c, size 0x58, virtual true, abstract: false, final true
  inline void UnregisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver* receiver);

  /// @brief Method UnregisterDidFinishReceiver, addr 0x26b25d4, size 0x58, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26b3804, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_afterCutRating, addr 0x26b24c4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_afterCutRating();

  /// @brief Method get_beforeCutRating, addr 0x26b24bc, size 0x8, virtual true, abstract: false, final true
