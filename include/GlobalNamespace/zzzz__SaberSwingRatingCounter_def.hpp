...
public:
  ...
  /// @brief Method DrawGizmos, addr 0x12d3864, size 0x384, virtual false, abstract: false, final false
  inline void DrawGizmos();

  /// @brief Method Finish, addr 0x12d36b8, size 0x1ac, virtual false, abstract: false, final false
  inline void Finish();

  /// @brief Method Init, addr 0x12d2bd4, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessNewData, addr 0x12d2f38, size 0x780, virtual true, abstract: false, final true
  ...
  /// @brief Method RegisterDidChangeReceiver, addr 0x12d2a74, size 0x58, virtual true, abstract: false, final true
  inline void RegisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver* receiver);

  /// @brief Method RegisterDidFinishReceiver, addr 0x12d2acc, size 0x58, virtual true, abstract: false, final true
  inline void RegisterDidFinishReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver* receiver);

  /// @brief Method UnregisterDidChangeReceiver, addr 0x12d2b24, size 0x58, virtual true, abstract: false, final true
  inline void UnregisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver* receiver);

  /// @brief Method UnregisterDidFinishReceiver, addr 0x12d2b7c, size 0x58, virtual true, abstract: false, final true
  ...
  __cordl_internal_get__didChangeReceivers() const;
  ...
  __cordl_internal_get__didFinishReceivers() const;
  ...
  /// @brief Method .ctor, addr 0x12d3be8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_afterCutRating, addr 0x12d2a6c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_afterCutRating();

  /// @brief Method get_beforeCutRating, addr 0x12d2a64, size 0x8, virtual true, abstract: false, final true
