...
/// @brief Method DrawGizmos, addr 0x360f548, size 0x2e8, virtual false, abstract: false, final false
inline void DrawGizmos() ;

/// @brief Method Finish, addr 0x360f380, size 0x1c8, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method Init, addr 0x360e5f0, size 0x438, virtual false, abstract: false, final false
...
/// @brief Method ProcessNewData, addr 0x360ea28, size 0x958, virtual true, abstract: false, final true
...
/// @brief Method RegisterDidChangeReceiver, addr 0x360e460, size 0x64, virtual true, abstract: false, final true
inline void RegisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*  receiver) ;

/// @brief Method RegisterDidFinishReceiver, addr 0x360e4c4, size 0x64, virtual true, abstract: false, final true
inline void RegisterDidFinishReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver*  receiver) ;

/// @brief Method UnregisterDidChangeReceiver, addr 0x360e528, size 0x64, virtual true, abstract: false, final true
inline void UnregisterDidChangeReceiver(::GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver*  receiver) ;

/// @brief Method UnregisterDidFinishReceiver, addr 0x360e58c, size 0x64, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x360f830, size 0xdc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_afterCutRating, addr 0x360e458, size 0x8, virtual true, abstract: false, final true
inline float_t get_afterCutRating() ;

/// @brief Method get_beforeCutRating, addr 0x360e450, size 0x8, virtual true, abstract: false, final true
