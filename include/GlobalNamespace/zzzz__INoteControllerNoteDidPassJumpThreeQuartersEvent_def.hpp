...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "INoteControllerNoteDidPassJumpThreeQuartersEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INoteControllerNoteDidPassJumpThreeQuartersEvent(INoteControllerNoteDidPassJumpThreeQuartersEventconst&) = delete;
