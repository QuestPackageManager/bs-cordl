...
public:
  ...
  /// @brief Method ICoroutineStarter.StartCoroutine, addr 0x3321644, size 0xe0, virtual true, abstract: false, final true
  inline ::UnityEngine::Coroutine* ICoroutineStarter_StartCoroutine(::System::Collections::IEnumerator* routine);

  /// @brief Method ICoroutineStarter.StopCoroutine, addr 0x3321724, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x33217fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
