...
public:
  ...
  /// @brief Method ICoroutineStarter.StartCoroutine, addr 0xf8fc14, size 0xd4, virtual true, abstract: false, final true
  inline ::UnityEngine::Coroutine* ICoroutineStarter_StartCoroutine(::System::Collections::IEnumerator* routine);

  /// @brief Method ICoroutineStarter.StopCoroutine, addr 0xf8fce8, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xf8fdb4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
