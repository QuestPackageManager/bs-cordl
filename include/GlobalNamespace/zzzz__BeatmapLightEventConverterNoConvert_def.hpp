...
public:
  ...
  /// @brief Method ConvertBasicBeatmapEvent, addr 0x26d3ba4, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method ConvertLightColorBeatmapEvent, addr 0x26d3ca4, size 0x16c, virtual true, abstract: false, final true
  ...
  /// @brief Method ConvertLightRotationBeatmapEvent, addr 0x26d3e10, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26d3f68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
