...
public:
  ...
  /// @brief Method ConvertBasicBeatmapEvent, addr 0x26d181c, size 0x100, virtual true, abstract: false, final true
  ...
  /// @brief Method ConvertLightColorBeatmapEvent, addr 0x26d191c, size 0x16c, virtual true, abstract: false, final true
  ...
  /// @brief Method ConvertLightRotationBeatmapEvent, addr 0x26d1a88, size 0x158, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26d1be0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
