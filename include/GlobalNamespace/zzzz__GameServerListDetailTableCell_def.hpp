...
public:
  ...
  /// @brief Method Start, addr 0x250b864, size 0xa8, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method <Start>b__5_0, addr 0x250b974, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x250b90c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_joinServerButtonWasPressedEvent, addr 0x250b72c, size 0x9c, virtual false, abstract: false, final false
  inline void add_joinServerButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_joinServerButtonWasPressedEvent, addr 0x250b7c8, size 0x9c, virtual false, abstract: false, final false
