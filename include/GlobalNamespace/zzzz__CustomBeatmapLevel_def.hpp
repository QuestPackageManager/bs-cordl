...
public:
  ...
  /// @brief Method get_songAudioClipPath, addr 0x23473cc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2347440, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::CustomPreviewBeatmapLevel* customPreviewBeatmapLevel);

  /// @brief Method SetBeatmapLevelData, addr 0x2347600, size 0x8, virtual false, abstract: false, final false
  inline void SetBeatmapLevelData(::GlobalNamespace::BeatmapLevelData* beatmapLevelData);

  /// @brief Method GetBeatmapLevelColorScheme, addr 0x2347608, size 0x44, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::CustomBeatmapLevel, ____beatmapLevelData) == 0xb0, "Offset mismatch!");
