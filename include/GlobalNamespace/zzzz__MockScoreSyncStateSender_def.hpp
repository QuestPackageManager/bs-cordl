...
public:
  ...
  /// @brief Method Dispose, addr 0x253b6c4, size 0xc8, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleScoreSyncStateUpdate, addr 0x2540e7c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendScore, addr 0x253ea5c, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x253b51c, size 0x17c, virtual false, abstract: false, final false
