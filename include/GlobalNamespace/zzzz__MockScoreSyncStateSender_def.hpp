...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockScoreSyncStateSender*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockScoreSyncStateSender*, "", "MockScoreSyncStateSender");
...
public:
  ...
  /// @brief Method Dispose, addr 0x5a82fbc, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleScoreSyncStateUpdate, addr 0x5a88af8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendScore, addr 0x5a86248, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a82de8, size 0x1a8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MockScoreSyncStateSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MockScoreSyncStateSender(MockScoreSyncStateSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MockScoreSyncStateSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MockScoreSyncStateSender(MockScoreSyncStateSenderconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MockScoreSyncStateSender) == 0x18, "Size mismatch!");
