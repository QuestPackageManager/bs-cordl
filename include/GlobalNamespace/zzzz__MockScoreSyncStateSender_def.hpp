...
public:
  ...
  /// @brief Method Dispose, addr 0x3c38350, size 0xbc, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleScoreSyncStateUpdate, addr 0x3c3dc90, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendScore, addr 0x3c3b73c, size 0x224, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c381b4, size 0x170, virtual false, abstract: false, final false
