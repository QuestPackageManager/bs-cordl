...
public:
  ...
  /// @brief Method Dispose, addr 0x58d4508, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleScoreSyncStateUpdate, addr 0x58d9ea0, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendScore, addr 0x58d777c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58d4334, size 0x1a8, virtual false, abstract: false, final false
