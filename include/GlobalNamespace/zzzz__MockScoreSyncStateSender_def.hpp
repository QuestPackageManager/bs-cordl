...
public:
  ...
  /// @brief Method Dispose, addr 0x5a80cbc, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleScoreSyncStateUpdate, addr 0x5a867f8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendScore, addr 0x5a83f48, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a80ae8, size 0x1a8, virtual false, abstract: false, final false
