...
/// @brief Method MoveNext, addr 0x577e2d8, size 0x3f8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x577e6d0, size 0x6c, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelScenesTransitionSetupDataSO>", modifiers: "", def_value: None }, CppParam { name: "_stopwatch_5__2", ty: "::System::Diagnostics::Stopwatch*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
...
/// @brief Field <gameplayAdditionalInformationSetupData>k__BackingField, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameplayAdditionalInformationSetupData_k__BackingField, put=__cordl_internal_set__gameplayAdditionalInformationSetupData_k__BackingField)) ::GlobalNamespace::GameplayAdditionalInformationSetupData*  _gameplayAdditionalInformationSetupData_k__BackingField;
...
/// @brief Field _telemetryModel, offset 0x28, size 0x8 
 ...
 __declspec(property(get=get_gameplayAdditionalInformationSetupData, put=set_gameplayAdditionalInformationSetupData)) ::GlobalNamespace::GameplayAdditionalInformationSetupData*  gameplayAdditionalInformationSetupData;
...
/// @brief Method BeforeScenesWillBeActivated, addr 0x577e2b4, size 0x14, virtual true, abstract: false, final false
inline void BeforeScenesWillBeActivated() ;

/// @brief Method BeforeScenesWillBeActivatedAsync, addr 0x577e200, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method <>n__0, addr 0x577e2d0, size 0x8, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task* __n__0() ;

/// @brief Method .ctor, addr 0x577e2c8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_gameplayAdditionalInformationSetupData, addr 0x577e1f0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayAdditionalInformationSetupData* get_gameplayAdditionalInformationSetupData() ;

/// @brief Method get_gameplayCoreSceneSetupData, addr 0x577e1e0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_gameplayCoreSceneSetupData() ;

/// @brief Method get_transformedBeatmapData, addr 0x577e1c8, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::IReadonlyBeatmapData* get_transformedBeatmapData() ;

/// @brief Method set_gameplayAdditionalInformationSetupData, addr 0x577e1f8, size 0x8, virtual false, abstract: false, final false
inline void set_gameplayAdditionalInformationSetupData(::GlobalNamespace::GameplayAdditionalInformationSetupData*  value) ;

/// @brief Method set_gameplayCoreSceneSetupData, addr 0x577e1e8, size 0x8, virtual false, abstract: false, final false
