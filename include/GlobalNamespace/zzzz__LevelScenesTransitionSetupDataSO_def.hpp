...
public:
  ...
  /// @brief Method MoveNext, addr 0x57ee358, size 0x3f8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x57ee750, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method BeforeScenesWillBeActivated, addr 0x57ee334, size 0x14, virtual true, abstract: false, final false
  inline void BeforeScenesWillBeActivated();

  /// @brief Method BeforeScenesWillBeActivatedAsync, addr 0x57ee280, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method <>n__0, addr 0x57ee350, size 0x8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* __n__0();

  /// @brief Method .ctor, addr 0x57ee348, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameplayAdditionalInformationSetupData, addr 0x57ee270, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayAdditionalInformationSetupData* get_gameplayAdditionalInformationSetupData();

  /// @brief Method get_gameplayCoreSceneSetupData, addr 0x57ee260, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayCoreSceneSetupData* get_gameplayCoreSceneSetupData();

  /// @brief Method get_transformedBeatmapData, addr 0x57ee248, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IReadonlyBeatmapData* get_transformedBeatmapData();

  /// @brief Method set_gameplayAdditionalInformationSetupData, addr 0x57ee278, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayAdditionalInformationSetupData(::GlobalNamespace::GameplayAdditionalInformationSetupData* value);

  /// @brief Method set_gameplayCoreSceneSetupData, addr 0x57ee268, size 0x8, virtual false, abstract: false, final false
