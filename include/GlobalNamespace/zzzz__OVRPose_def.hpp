...
public:
  // Declarations
  /// @brief Method get_identity addr 0x25bf920 size 0x98 virtual false final false
  static inline ::GlobalNamespace::OVRPose get_identity();

  /// @brief Method Equals addr 0x25c2230 size 0xf8 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode addr 0x25c23ac size 0xa8 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality addr 0x25c2328 size 0x84 virtual false final false
  static inline bool op_Equality(::GlobalNamespace::OVRPose x, ::GlobalNamespace::OVRPose y);

  /// @brief Method op_Inequality addr 0x25c2454 size 0x84 virtual false final false
  static inline bool op_Inequality(::GlobalNamespace::OVRPose x, ::GlobalNamespace::OVRPose y);

  /// @brief Method op_Multiply addr 0x25b9d3c size 0xe4 virtual false final false
  static inline ::GlobalNamespace::OVRPose op_Multiply(::GlobalNamespace::OVRPose lhs, ::GlobalNamespace::OVRPose rhs);

  /// @brief Method Inverse addr 0x25bd4e8 size 0x84 virtual false final false
  inline ::GlobalNamespace::OVRPose Inverse();

  /// @brief Method flipZ addr 0x25c24d8 size 0x2c virtual false final false
  inline ::GlobalNamespace::OVRPose flipZ();

  /// @brief Method ToPosef_Legacy addr 0x25c2504 size 0x1c virtual false final false
  inline ::GlobalNamespace::__OVRPlugin__Posef ToPosef_Legacy();

  /// @brief Method ToPosef addr 0x25bd56c size 0x28 virtual false final false
  inline ::GlobalNamespace::__OVRPlugin__Posef ToPosef();

  /// @brief Method Rotate180AlongX addr 0x25c2520 size 0xe0 virtual false final false
