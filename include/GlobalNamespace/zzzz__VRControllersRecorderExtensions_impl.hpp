...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::VRControllersRecorder_Mode (*)(::GlobalNamespace::PlaymodeOptions)>(&::GlobalNamespace::VRControllersRecorderExtensions::ToVRControllersRecorderMode)> {
  constexpr static std::size_t size = 0x18;
  constexpr static std::size_t addrs = 0x574f1f0;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::VRControllersRecorderExtensions*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::VRControllersRecorder_InitData* (*)(::GlobalNamespace::GameplayAdditionalInformation*)>(&::GlobalNamespace::VRControllersRecorderExtensions::ToVRControllersRecorderInitData)> {
  constexpr static std::size_t size = 0x78;
  constexpr static std::size_t addrs = 0x574f208;
...
inline ::GlobalNamespace::VRControllersRecorder_InitData* GlobalNamespace::VRControllersRecorderExtensions::ToVRControllersRecorderInitData(::GlobalNamespace::GameplayAdditionalInformation*  gameplayAdditionalInformation)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::VRControllersRecorderExtensions*>::get(),
                        "ToVRControllersRecorderInitData",
                        std::span<const Il2CppClass* const, 0>(),
