...
/// @brief Method ApplyValue, addr 0x586faf8, size 0xe4, virtual true, abstract: false, final false
inline void ApplyValue(int32_t  idx) ;

/// @brief Method GetInitValues, addr 0x586f930, size 0x1c8, virtual true, abstract: false, final false
inline bool GetInitValues(::ByRef<int32_t>  idx, ::ByRef<int32_t>  numberOfElements) ;

static inline ::GlobalNamespace::LanguageSettingsController* New_ctor() ;

/// @brief Method TextForValue, addr 0x586fbdc, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x586fc44, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_language, addr 0x586f928, size 0x8, virtual false, abstract: false, final false
