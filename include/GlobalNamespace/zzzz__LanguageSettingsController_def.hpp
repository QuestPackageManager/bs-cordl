...
// Write type traits
MARK_REF_T(::GlobalNamespace::LanguageSettingsController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LanguageSettingsController*, "", "LanguageSettingsController");
// Dependencies BGLib.Polyglot.LocalizationLanguage, DropdownSettingsController
namespace GlobalNamespace {
// Is value type: false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LanguageSettingsController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LanguageSettingsController(LanguageSettingsController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LanguageSettingsController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LanguageSettingsController(LanguageSettingsControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LanguageSettingsController) == 0x48, "Size mismatch!");
