...
public:
  // Declarations
  /// @brief Method DoesSupport360, addr 0x23680c4, size 0x8, virtual true, abstract: false, final false
  inline bool DoesSupport360();

  static inline ::GlobalNamespace::PS4LeaderboardIdsModelSO* New_ctor();

  /// @brief Method .ctor, addr 0x23680cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
