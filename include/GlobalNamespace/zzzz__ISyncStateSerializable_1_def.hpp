...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::ISyncStateSerializable_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::ISyncStateSerializable_1, "", "ISyncStateSerializable`1");
// Dependencies
namespace GlobalNamespace {
// cpp template
template <typename T>
