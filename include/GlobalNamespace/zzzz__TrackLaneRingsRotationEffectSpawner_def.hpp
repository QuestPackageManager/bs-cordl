...
/// @brief Field _rotationStepType, offset 0x34, size 0x4 
 __declspec(property(get=__cordl_internal_get__rotationStepType, put=__cordl_internal_set__rotationStepType)) ::GlobalNamespace::TrackLaneRingsRotationEffectSpawner_RotationStepType  _rotationStepType;
...
/// @brief Method HandleBeatmapEvent, addr 0x57f64e0, size 0xe4, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::TrackLaneRingsRotationEffectSpawner* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57f64c4, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57f639c, size 0x128, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57f65c4, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
