...
template<typename T>
constexpr ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>::Enumerator_OVREnumerable_1_CollectionType(int32_t  value__) noexcept  {
this->value__ = value__;
}
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>::Enumerator_OVREnumerable_1_CollectionType()   {
}
template<typename T>
constexpr ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>  GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>::None{static_cast<int32_t>(0x0)};
template<typename T>
...
template<typename T>
constexpr ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>  GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>::List{static_cast<int32_t>(0x2)};
template<typename T>
constexpr ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>  GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>::Set{static_cast<int32_t>(0x3)};
template<typename T>
constexpr ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>  GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>::Queue{static_cast<int32_t>(0x4)};
template<typename T>
constexpr ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>  GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>::Enumerable{static_cast<int32_t>(0x5)};
template<typename T>
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVREnumerable_1_Enumerator<T>>::get(),
                        ".ctor",
...
// Ctor Parameters [CppParam { name: "_listIndex", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_type", ty: "::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_listCount", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "_enumerator", ty: "::System::Collections::Generic::IEnumerator_1<T>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "_readOnlyList", ty: "::System::Collections::Generic::IReadOnlyList_1<T>*", modifiers: "", def_value: Some("{}") }, CppParam { name: "_setEnumerator", ty: "::System::Collections::Generic::HashSet_1_Enumerator<T>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_queueEnumerator", ty: "::System::Collections::Generic::Queue_1_Enumerator<T>", modifiers: "", def_value: Some("{}") }, CppParam { name: "_listEnumerator", ty: "::System::Collections::Generic::List_1_Enumerator<T>", modifiers: "", def_value: Some("{}") }]
template<typename T>
constexpr ::GlobalNamespace::OVREnumerable_1_Enumerator<T>::OVREnumerable_1_Enumerator(int32_t  _listIndex, ::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>  _type, int32_t  _listCount, ::System::Collections::Generic::IEnumerator_1<T>*  _enumerator, ::System::Collections::Generic::IReadOnlyList_1<T>*  _readOnlyList, ::System::Collections::Generic::HashSet_1_Enumerator<T>  _setEnumerator, ::System::Collections::Generic::Queue_1_Enumerator<T>  _queueEnumerator, ::System::Collections::Generic::List_1_Enumerator<T>  _listEnumerator) noexcept  {
...
template<typename T>
inline bool GlobalNamespace::OVREnumerable_1<T>::TryGetCount(::ByRef<int32_t>  count)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVREnumerable_1<T>>::get(),
                        "TryGetCount",
                        std::span<const Il2CppClass* const, 0>(),
