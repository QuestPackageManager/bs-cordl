...
// Write type traits
MARK_REF_T(::GlobalNamespace::DisconnectPromptView*);
...
static_assert(sizeof(::GlobalNamespace::DisconnectPromptView___c__DisplayClass12_0) == 0x20, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::DisconnectPromptView) == 0x58, "Size mismatch!");
