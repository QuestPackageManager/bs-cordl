...
public:
  ...
  /// @brief Method <Hide>b__0, addr 0x2693f98, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2693ee8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Hide, addr 0x2693e1c, size 0xcc, virtual false, abstract: false, final false
  inline void Hide(::System::Action* finishedCallback);

  static inline ::GlobalNamespace::DisconnectPromptView* New_ctor();

  /// @brief Method OnDisable, addr 0x2693dc8, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2693cd8, size 0xf0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Show, addr 0x2693de4, size 0x38, virtual false, abstract: false, final false
  inline void Show();

  /// @brief Method <OnEnable>b__9_0, addr 0x2693f58, size 0x20, virtual false, abstract: false, final false
  inline void _OnEnable_b__9_0();

  /// @brief Method <OnEnable>b__9_1, addr 0x2693f78, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2693ef0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didViewFinishEvent, addr 0x2693b78, size 0xb0, virtual false, abstract: false, final false
  inline void add_didViewFinishEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_didViewFinishEvent, addr 0x2693c28, size 0xb0, virtual false, abstract: false, final false
