...
/// @brief Method <Hide>b__0, addr 0x573f884, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x573f7e4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method Hide, addr 0x573f6e0, size 0x104, virtual false, abstract: false, final false
inline void Hide(::System::Action*  finishedCallback) ;

static inline ::GlobalNamespace::DisconnectPromptView* New_ctor() ;

/// @brief Method OnDisable, addr 0x573f688, size 0x18, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x573f560, size 0x128, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Show, addr 0x573f6a0, size 0x40, virtual false, abstract: false, final false
inline void Show() ;

/// @brief Method <OnEnable>b__9_0, addr 0x573f844, size 0x20, virtual false, abstract: false, final false
inline void _OnEnable_b__9_0() ;

/// @brief Method <OnEnable>b__9_1, addr 0x573f864, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x573f7e8, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didViewFinishEvent, addr 0x573f3e0, size 0xc0, virtual false, abstract: false, final false
inline void add_didViewFinishEvent(::System::Action_1<bool>*  value) ;

/// @brief Method remove_didViewFinishEvent, addr 0x573f4a0, size 0xc0, virtual false, abstract: false, final false
