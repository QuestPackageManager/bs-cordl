...
public:
  ...
  /// @brief Method <Hide>b__0, addr 0x2566648, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2566598, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Hide, addr 0x25664cc, size 0xcc, virtual false, abstract: false, final false
  inline void Hide(::System::Action* finishedCallback);

  static inline ::GlobalNamespace::DisconnectPromptView* New_ctor();

  /// @brief Method OnDisable, addr 0x2566478, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2566388, size 0xf0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Show, addr 0x2566494, size 0x38, virtual false, abstract: false, final false
  inline void Show();

  /// @brief Method <OnEnable>b__9_0, addr 0x2566608, size 0x20, virtual false, abstract: false, final false
  inline void _OnEnable_b__9_0();

  /// @brief Method <OnEnable>b__9_1, addr 0x2566628, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25665a0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didViewFinishEvent, addr 0x2566228, size 0xb0, virtual false, abstract: false, final false
  inline void add_didViewFinishEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_didViewFinishEvent, addr 0x25662d8, size 0xb0, virtual false, abstract: false, final false
