...
public:
  ...
  /// @brief Method <Hide>b__0, addr 0x573f020, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x573ef80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Hide, addr 0x573ee7c, size 0x104, virtual false, abstract: false, final false
  inline void Hide(::System::Action* finishedCallback);

  static inline ::GlobalNamespace::DisconnectPromptView* New_ctor();

  /// @brief Method OnDisable, addr 0x573ee24, size 0x18, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x573ecfc, size 0x128, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Show, addr 0x573ee3c, size 0x40, virtual false, abstract: false, final false
  inline void Show();

  /// @brief Method <OnEnable>b__9_0, addr 0x573efe0, size 0x20, virtual false, abstract: false, final false
  inline void _OnEnable_b__9_0();

  /// @brief Method <OnEnable>b__9_1, addr 0x573f000, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x573ef84, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didViewFinishEvent, addr 0x573eb7c, size 0xc0, virtual false, abstract: false, final false
  inline void add_didViewFinishEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_didViewFinishEvent, addr 0x573ec3c, size 0xc0, virtual false, abstract: false, final false
