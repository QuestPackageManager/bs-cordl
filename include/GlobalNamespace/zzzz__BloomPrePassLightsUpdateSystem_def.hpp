...
public:
  ...
  /// @brief Method LateUpdate, addr 0x56b0dec, size 0x2f8, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::BloomPrePassLightsUpdateSystem* New_ctor();

  /// @brief Method .ctor, addr 0x56b10e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
