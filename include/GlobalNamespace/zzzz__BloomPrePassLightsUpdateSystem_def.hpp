...
public:
  // Declarations
  /// @brief Method LateUpdate, addr 0x2269c88, size 0x2f0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::BloomPrePassLightsUpdateSystem* New_ctor();

  /// @brief Method .ctor, addr 0x2269f78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
