...
public:
  // Declarations
  /// @brief Method LateUpdate, addr 0x2106e78, size 0x2f0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::BloomPrePassLightsUpdateSystem* New_ctor();

  /// @brief Method .ctor, addr 0x2107168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
