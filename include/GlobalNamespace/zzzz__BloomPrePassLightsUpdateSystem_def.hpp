...
public:
  ...
  /// @brief Method LateUpdate, addr 0x56501a4, size 0x2f8, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::BloomPrePassLightsUpdateSystem* New_ctor();

  /// @brief Method .ctor, addr 0x565049c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
