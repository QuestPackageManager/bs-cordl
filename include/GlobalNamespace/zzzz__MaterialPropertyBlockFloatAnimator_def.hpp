...
public:
  ...
  /// @brief Method SetProperty, addr 0x2276fb4, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2276fe4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
