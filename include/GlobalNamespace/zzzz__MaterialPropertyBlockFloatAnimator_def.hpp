...
public:
  ...
  /// @brief Method SetProperty, addr 0x39f42d0, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f4300, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
