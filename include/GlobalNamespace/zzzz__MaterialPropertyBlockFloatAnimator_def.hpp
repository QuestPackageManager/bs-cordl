...
public:
  ...
  /// @brief Method SetProperty, addr 0x39eb820, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39eb850, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
