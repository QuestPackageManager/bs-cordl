...
public:
  ...
  /// @brief Method SetProperty, addr 0x56be47c, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56be4a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
