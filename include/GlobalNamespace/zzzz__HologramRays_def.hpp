...
public:
  ...
  /// @brief Method MoveNext, addr 0x25e7814, size 0x188, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__HologramRays___FadingCoroutine_d__28* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x25e799c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x25e79a4, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x25e79e4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x25e7810, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25e7694, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Animate, addr 0x25e745c, size 0xc8, virtual false, abstract: false, final false
  inline void Animate(bool turningOn, float_t duration, ::GlobalNamespace::EaseType easeType);

  /// @brief Method Awake, addr 0x25e700c, size 0x13c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FadingCoroutine, addr 0x25e7524, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x25e7148, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x25e7168, size 0x7c, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Refresh, addr 0x25e71e4, size 0x274, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method RuntimeInit, addr 0x25e6fb4, size 0x58, virtual false, abstract: false, final false
  static inline void RuntimeInit();

  /// @brief Method Update, addr 0x25e7458, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateBounds, addr 0x25e75b8, size 0xdc, virtual false, abstract: false, final false
  inline void UpdateBounds();

  /// @brief Method <Awake>b__22_0, addr 0x25e77a8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25e76bc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
