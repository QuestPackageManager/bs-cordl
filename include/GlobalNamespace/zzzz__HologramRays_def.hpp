...
public:
  ...
  /// @brief Method MoveNext, addr 0x580c758, size 0x190, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::HologramRays__FadingCoroutine_d__28* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x580c8e8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x580c8f0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x580c928, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x580c754, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x580c5ec, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Animate, addr 0x580c3f8, size 0xa4, virtual false, abstract: false, final false
  inline void Animate(bool turningOn, float_t duration, ::GlobalNamespace::EaseType easeType);

  /// @brief Method Awake, addr 0x580bec4, size 0x1b0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method FadingCoroutine, addr 0x580c49c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x580c074, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x580c090, size 0xd0, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Refresh, addr 0x580c160, size 0x294, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method RuntimeInit, addr 0x580be68, size 0x5c, virtual false, abstract: false, final false
  static inline void RuntimeInit();

  /// @brief Method Update, addr 0x580c3f4, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateBounds, addr 0x580c51c, size 0xd0, virtual false, abstract: false, final false
  inline void UpdateBounds();

  /// @brief Method <Awake>b__22_0, addr 0x580c6ec, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x580c5f4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
