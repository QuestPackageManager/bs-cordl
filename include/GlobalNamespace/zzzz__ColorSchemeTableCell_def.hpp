...
public:
  ...
  /// @brief Method SetColors, addr 0x3bf9fc8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bfa2bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x3bfa298, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_showEditIcon, addr 0x3bf9f84, size 0x20, virtual false, abstract: false, final false
  inline void set_showEditIcon(bool value);

  /// @brief Method set_text, addr 0x3bf9fa4, size 0x24, virtual false, abstract: false, final false
