...
public:
  ...
  /// @brief Method SetColors, addr 0x57fb1f4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57fb514, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x57fb4f4, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_showEditIcon, addr 0x57fb1b8, size 0x1c, virtual false, abstract: false, final false
  inline void set_showEditIcon(bool value);

  /// @brief Method set_text, addr 0x57fb1d4, size 0x20, virtual false, abstract: false, final false
