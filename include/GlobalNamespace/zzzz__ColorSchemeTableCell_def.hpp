...
public:
  ...
  /// @brief Method SetColors, addr 0x591eaa0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591ecd0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_text, addr 0x591ea64, size 0x20, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method set_showEditIcon, addr 0x591ea84, size 0x1c, virtual false, abstract: false, final false
  inline void set_showEditIcon(bool value);

  /// @brief Method set_text, addr 0x591ea44, size 0x20, virtual false, abstract: false, final false
