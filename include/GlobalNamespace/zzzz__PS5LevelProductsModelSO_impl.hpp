...
inline ::GlobalNamespace::PS5LevelProductsModelSO* GlobalNamespace::PS5LevelProductsModelSO::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::PS5LevelProductsModelSO*>());
}
...
// Ctor Parameters []
constexpr ::GlobalNamespace::PS5LevelProductsModelSO::PS5LevelProductsModelSO() {}
