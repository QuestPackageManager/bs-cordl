...
public:
  ...
  /// @brief Method <ParseUnmatchedArguments>b__11_0, addr 0x3b0b244, size 0x54, virtual false, abstract: false, final false
  inline bool _ParseUnmatchedArguments_b__11_0(::StringW x);

  /// @brief Method .ctor, addr 0x3b0b23c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <ParseUnmatchedArguments>b__1, addr 0x3b0b298, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b0b05c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AreArgumentsValid, addr 0x3b0a11c, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTo, addr 0x3b0b184, size 0x54, virtual true, abstract: false, final true
  inline int32_t CompareTo(::GlobalNamespace::ConsoleCommandBase* other);

  /// @brief Method ExecuteAsync, addr 0x3b0a04c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArguments, addr 0x3b09b84, size 0x264, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::ArgumentBase*, ::Array<::GlobalNamespace::ArgumentBase*>*> GetArguments();

  /// @brief Method GetArgumentsText, addr 0x3b09de8, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInvalidArgumentMessage, addr 0x3b0ab80, size 0x4dc, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x3b09b6c, size 0x18, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::ConsoleCommandBase* New_ctor();

  /// @brief Method ParseMatchedArguments, addr 0x3b0a1d4, size 0x554, virtual false, abstract: false, final false
  ...
  /// @brief Method ParseUnmatchedArguments, addr 0x3b0a728, size 0x458, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::ArgumentBase*>*
  ...
  /// @brief Method Reset, addr 0x3b0b120, size 0x64, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3b0b1d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
