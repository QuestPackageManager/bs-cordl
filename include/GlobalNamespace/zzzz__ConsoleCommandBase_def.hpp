...
public:
  ...
  /// @brief Method <AreArgumentsValid>b__23_0, addr 0x32cc854, size 0x30, virtual false, abstract: false, final false
  inline bool _AreArgumentsValid_b__23_0(::StringW x);

  /// @brief Method .ctor, addr 0x32cc850, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <AreArgumentsValid>b__1, addr 0x32cc884, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32cba1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AreArgumentsValid, addr 0x32cb794, size 0x288, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTo, addr 0x32cc7a4, size 0x54, virtual true, abstract: false, final true
  inline int32_t CompareTo(::GlobalNamespace::ConsoleCommandBase* other);

  /// @brief Method ExecuteAsync, addr 0x32cb6dc, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateDescriptions, addr 0x32cb27c, size 0x328, virtual false, abstract: false, final false
  inline void GenerateDescriptions();

  /// @brief Method GetAllArgumentFields, addr 0x32cb5ac, size 0x128, virtual false, abstract: false, final false
  inline ::ArrayW<::System::Reflection::FieldInfo*> GetAllArgumentFields(::System::Type* type);

  /// @brief Method GetArguments, addr 0x32cb024, size 0x258, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::ArgumentBase*> GetArguments();

  /// @brief Method GetArgumentsText, addr 0x32cb6d4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetArgumentsText();

  /// @brief Method GetFullDescription, addr 0x32cb5a4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW GetFullDescription();

  /// @brief Method GetInvalidArgumentMessage, addr 0x32cc310, size 0x43c, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x32cb004, size 0x20, virtual true, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::ConsoleCommandBase* New_ctor();

  /// @brief Method ParseMatchedArguments, addr 0x32cba20, size 0x554, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::ArgumentBase*>* ParseMatchedArguments(::ArrayW<::StringW> args,
                                                                                                         ::System::Collections::Generic::List_1<::GlobalNamespace::ConsoleMessage>* messages);

  /// @brief Method ParseUnmatchedArguments, addr 0x32cbf74, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x32cc74c, size 0x58, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x32cc7f8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_AllowsUnknownArguments, addr 0x32caffc, size 0x8, virtual true, abstract: false, final false
  inline bool get_AllowsUnknownArguments();

  /// @brief Method get_arguments, addr 0x32cafec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_unknownArguments, addr 0x32caff4, size 0x8, virtual false, abstract: false, final false
