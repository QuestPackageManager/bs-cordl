...
public:
  ...
  /// @brief Method <GetUnmatchedArguments>b__1, addr 0x240cc48, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x240cb74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetUnmatchedArguments>b__14_0, addr 0x240cd38, size 0x54, virtual false, abstract: false, final false
  inline bool _GetUnmatchedArguments_b__14_0(::StringW x);

  /// @brief Method .ctor, addr 0x240cd30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AreArgumentsValid, addr 0x240ba58, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareTo, addr 0x240cbec, size 0x54, virtual true, abstract: false, final true
  inline int32_t CompareTo(::GlobalNamespace::ConsoleCommandBase* other);

  /// @brief Method Execute, addr 0x240ba18, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method ExecuteAsync, addr 0x240bb10, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetArgumentsText, addr 0x240b7b4, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInvalidArgumentMessage, addr 0x240c598, size 0x5dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMatchedArguments, addr 0x240bbe0, size 0x55c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUnmatchedArguments, addr 0x240c13c, size 0x45c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::ArgumentBase*>*
  ...
  /// @brief Method Initialize, addr 0x240b794, size 0x20, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::ConsoleCommandBase* New_ctor();

  /// @brief Method Reset, addr 0x240cb88, size 0x64, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x240cc40, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
