...
public:
  ...
  /// @brief Method MoveNext, addr 0x2550e30, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2550eec, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2550ef4, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2550f34, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2550e2c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2550db4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SetDataToUI>b__0, addr 0x2550f3c, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2550ddc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ContinueButtonPressed, addr 0x2550de4, size 0x20, virtual false, abstract: false, final false
  inline void ContinueButtonPressed();

  /// @brief Method DidActivate, addr 0x25508f8, size 0x198, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x2550d78, size 0x3c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Init, addr 0x25508f0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RetryButtonPressed, addr 0x2550e04, size 0x20, virtual false, abstract: false, final false
  inline void RetryButtonPressed();

  /// @brief Method SetDataToUI, addr 0x2550a90, size 0x270, virtual false, abstract: false, final false
  inline void SetDataToUI();

  /// @brief Method StartFireworksAfterDelay, addr 0x2550d00, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2550e24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_continueButtonPressedEvent, addr 0x2550620, size 0xb4, virtual false, abstract: false, final false
  inline void add_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionResultsViewController>>* value);

  /// @brief Method add_retryButtonPressedEvent, addr 0x2550788, size 0xb4, virtual false, abstract: false, final false
  inline void add_retryButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionResultsViewController>>* value);

  /// @brief Method remove_continueButtonPressedEvent, addr 0x25506d4, size 0xb4, virtual false, abstract: false, final false
  inline void remove_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionResultsViewController>>* value);

  /// @brief Method remove_retryButtonPressedEvent, addr 0x255083c, size 0xb4, virtual false, abstract: false, final false
