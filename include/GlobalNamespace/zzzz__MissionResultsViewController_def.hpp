...
public:
  ...
  /// @brief Method MoveNext, addr 0x242de34, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x242def0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x242def8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x242df38, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x242de30, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x242ddb8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SetDataToUI>b__0, addr 0x242df40, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x242dde0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ContinueButtonPressed, addr 0x242dde8, size 0x20, virtual false, abstract: false, final false
  inline void ContinueButtonPressed();

  /// @brief Method DidActivate, addr 0x242d8fc, size 0x198, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x242dd7c, size 0x3c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Init, addr 0x242d8f4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method RetryButtonPressed, addr 0x242de08, size 0x20, virtual false, abstract: false, final false
  inline void RetryButtonPressed();

  /// @brief Method SetDataToUI, addr 0x242da94, size 0x270, virtual false, abstract: false, final false
  inline void SetDataToUI();

  /// @brief Method StartFireworksAfterDelay, addr 0x242dd04, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x242de28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_continueButtonPressedEvent, addr 0x242d624, size 0xb4, virtual false, abstract: false, final false
  inline void add_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionResultsViewController>>* value);

  /// @brief Method add_retryButtonPressedEvent, addr 0x242d78c, size 0xb4, virtual false, abstract: false, final false
  inline void add_retryButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionResultsViewController>>* value);

  /// @brief Method remove_continueButtonPressedEvent, addr 0x242d6d8, size 0xb4, virtual false, abstract: false, final false
  inline void remove_continueButtonPressedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionResultsViewController>>* value);

  /// @brief Method remove_retryButtonPressedEvent, addr 0x242d840, size 0xb4, virtual false, abstract: false, final false
