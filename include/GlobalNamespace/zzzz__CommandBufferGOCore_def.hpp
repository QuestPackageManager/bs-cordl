...
// Write type traits
MARK_REF_T(::GlobalNamespace::CommandBufferGOCore*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CommandBufferGOCore*, "", "CommandBufferGOCore");
...
public:
  ...
  /// @brief Method OnDisable, addr 0x5f419a0, size 0x448, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5f41598, size 0x408, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnWillRenderObject, addr 0x5f41ea8, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f41138, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CommandBufferGOCore", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CommandBufferGOCore(CommandBufferGOCore&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CommandBufferGOCore", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CommandBufferGOCore(CommandBufferGOCoreconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::CommandBufferGOCore) == 0x30, "Size mismatch!");
