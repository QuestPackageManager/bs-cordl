...
public:
  ...
  /// @brief Method OnDisable, addr 0x2ad47dc, size 0x404, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2ad43c8, size 0x414, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnWillRenderObject, addr 0x2ad4c88, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2ad4004, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
