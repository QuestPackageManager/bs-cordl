...
public:
  ...
  /// @brief Method OnDisable, addr 0x5d2bd28, size 0x448, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5d2b920, size 0x408, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnWillRenderObject, addr 0x5d2c230, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d2b4c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
