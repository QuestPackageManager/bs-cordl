...
public:
  ...
  /// @brief Method MoveNext, addr 0x36594d4, size 0x838, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::LightTranslationBeatmapEventDataBox__Unpack_d__9* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<BeatmapEventData>.GetEnumerator, addr 0x3659ebc, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<BeatmapEventData>.get_Current, addr 0x3659e74, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BeatmapEventData* System_Collections_Generic_IEnumerator_BeatmapEventData__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3659f94, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3659e7c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3659eb4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3659428, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x3659dc0, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x3659d0c, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x3659408, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Unpack, addr 0x365933c, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36590e8, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x36590e0, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x36590d8, size 0x8, virtual true, abstract: false, final false
