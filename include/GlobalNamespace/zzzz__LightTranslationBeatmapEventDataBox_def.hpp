...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(10732)), TypeDefinitionIndex(TypeDefinitionIndex(15117))]
...
public:
  ...
  /// @brief Method get_subtypeIdentifier, addr 0x127daa8, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeIdentifier();

  /// @brief Method get_beatStep, addr 0x127dab0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x127dab8, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method Unpack, addr 0x127dcec, size 0x4e4, virtual true, abstract: false, final false
