...
public:
  ...
  /// @brief Method Start, addr 0x5845a8c, size 0x64, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5845af0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
