...
public:
  ...
  /// @brief Method Start, addr 0x3bf0d2c, size 0x70, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bf0d9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
