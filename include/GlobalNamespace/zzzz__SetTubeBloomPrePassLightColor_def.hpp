...
public:
  ...
  /// @brief Method Start, addr 0x3be7754, size 0x70, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3be77c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
