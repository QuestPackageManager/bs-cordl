...
public:
  ...
  /// @brief Method Start, addr 0x24929cc, size 0x70, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2492a3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
