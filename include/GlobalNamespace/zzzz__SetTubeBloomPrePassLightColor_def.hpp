...
public:
  ...
  /// @brief Method Start, addr 0x57df1a8, size 0x64, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x57df20c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
