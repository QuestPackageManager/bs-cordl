...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x39e13d0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x39e13f8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x39e13bc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e12b8, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnRenderImage, addr 0x39e1294, size 0x1c, virtual false, abstract: false, final false
  inline void OnRenderImage(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method SetCallback, addr 0x39e128c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e12b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
