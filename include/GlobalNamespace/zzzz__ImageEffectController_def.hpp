...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x24ef048, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x24ef070, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x24ef034, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24eef04, size 0x130, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method OnRenderImage, addr 0x24eeee0, size 0x1c, virtual false, abstract: false, final false
  inline void OnRenderImage(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method SetCallback, addr 0x24eeed8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24eeefc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
