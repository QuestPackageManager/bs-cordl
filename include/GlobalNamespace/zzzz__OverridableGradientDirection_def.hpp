...
public:
  ...
  /// @brief Method .ctor, addr 0x32cadfc, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OverridableGradientDirection", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OverridableGradientDirection(OverridableGradientDirection&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OverridableGradientDirection", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OverridableGradientDirection(OverridableGradientDirectionconst&) = delete;
