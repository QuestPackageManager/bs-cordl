...
public:
  // Declarations
  /// @brief Method BakedCallback, addr 0x2430308, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method CookedCallback, addr 0x243015c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadCallback, addr 0x242ffb0, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24304b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
