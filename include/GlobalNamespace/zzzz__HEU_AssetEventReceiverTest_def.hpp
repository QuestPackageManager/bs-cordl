...
public:
  // Declarations
  /// @brief Method ReloadCallback addr 0x214dd40 size 0x1ac virtual false final false
  ...
  /// @brief Method CookedCallback addr 0x214deec size 0x1ac virtual false final false
  ...
  /// @brief Method BakedCallback addr 0x214e098 size 0x1ac virtual false final false
  ...
  /// @brief Method .ctor addr 0x214e244 size 0x8 virtual false final false
  inline void _ctor();
