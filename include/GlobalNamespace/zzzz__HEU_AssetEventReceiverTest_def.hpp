...
public:
  // Declarations
  /// @brief Method BakedCallback, addr 0x2548ed4, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method CookedCallback, addr 0x2548d28, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadCallback, addr 0x2548b7c, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2549080, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
