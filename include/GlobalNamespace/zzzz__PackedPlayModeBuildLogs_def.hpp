...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x44e0fdc, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x44e0f60, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_RuntimeBuildLogs, addr 0x44e0f50, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::PackedPlayModeBuildLogs_RuntimeBuildLog>* get_RuntimeBuildLogs();

  /// @brief Method set_RuntimeBuildLogs, addr 0x44e0f58, size 0x8, virtual false, abstract: false, final false
