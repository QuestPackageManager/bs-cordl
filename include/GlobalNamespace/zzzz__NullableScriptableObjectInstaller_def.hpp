...
public:
  ...
  /// @brief Method InstallBindings, addr 0x4b13244, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b132e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
