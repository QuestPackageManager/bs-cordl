...
public:
  ...
  /// @brief Method InstallBindings, addr 0x4a96fb8, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4a97054, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
