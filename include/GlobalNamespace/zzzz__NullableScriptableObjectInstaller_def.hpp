...
public:
  ...
  /// @brief Method InstallBindings, addr 0x4b15e9c, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b15f38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
