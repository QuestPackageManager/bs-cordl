...
public:
  ...
  /// @brief Method CompositionMethod addr 0x270df20 size 0x8 virtual true final false
  ...
  /// @brief Method .ctor addr 0x270df28 size 0x590 virtual false final false
  ...
  /// @brief Method RefreshCameraObjects addr 0x270e508 size 0xbf4 virtual false final false
  ...
  /// @brief Method RefreshAudioFilter addr 0x270f0fc size 0x5b0 virtual false final false
  inline void RefreshAudioFilter(::UnityEngine::Camera* mainCamera);

  /// @brief Method CastMrcFrame addr 0x270f7e0 size 0x200 virtual false final false
  inline int32_t CastMrcFrame(int32_t castTextureIndex);

  /// @brief Method SetCameraTargetTexture addr 0x270fbbc size 0x1e0 virtual false final false
  inline void SetCameraTargetTexture(int32_t drawTextureIndex);

  /// @brief Method Update addr 0x270fd9c size 0xcac virtual true final false
  ...
  /// @brief Method CleanupAudioFilter addr 0x270f6ac size 0x134 virtual false final false
  inline void CleanupAudioFilter();

  /// @brief Method Cleanup addr 0x2710b5c size 0x1d4 virtual true final false
  inline void Cleanup();

  /// @brief Method CacheAudioData addr 0x2710d30 size 0x138 virtual false final false
  inline void CacheAudioData(::ArrayW<float_t, ::Array<float_t>*> data, int32_t channels);

  /// @brief Method GetAndResetAudioData addr 0x270f9e0 size 0x1dc virtual false final false
  ...
  /// @brief Method DisplayRefreshRateChanged addr 0x2710e68 size 0x14 virtual false final false
