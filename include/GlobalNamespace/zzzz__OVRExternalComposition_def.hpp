...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8425))}
...
public:
  ...
  /// @brief Method CompositionMethod addr 0x25bab00 size 0x8 virtual true final false
  ...
  /// @brief Method .ctor addr 0x25bab08 size 0x4bc virtual false final false
  ...
  /// @brief Method RefreshCameraObjects addr 0x25bafc4 size 0xbf4 virtual false final false
  ...
  /// @brief Method RefreshAudioFilter addr 0x25bbbb8 size 0x5b0 virtual false final false
  inline void RefreshAudioFilter(::UnityEngine::Camera* mainCamera);

  /// @brief Method CastMrcFrame addr 0x25bc29c size 0x200 virtual false final false
  inline int32_t CastMrcFrame(int32_t castTextureIndex);

  /// @brief Method SetCameraTargetTexture addr 0x25bc678 size 0x1e0 virtual false final false
  inline void SetCameraTargetTexture(int32_t drawTextureIndex);

  /// @brief Method Update addr 0x25bc858 size 0xc90 virtual true final false
  ...
  /// @brief Method CleanupAudioFilter addr 0x25bc168 size 0x134 virtual false final false
  inline void CleanupAudioFilter();

  /// @brief Method Cleanup addr 0x25bd5fc size 0x14c virtual true final false
  inline void Cleanup();

  /// @brief Method CacheAudioData addr 0x25bd748 size 0x138 virtual false final false
  inline void CacheAudioData(::ArrayW<float_t, ::Array<float_t>*> data, int32_t channels);

  /// @brief Method GetAndResetAudioData addr 0x25bc49c size 0x1dc virtual false final false
