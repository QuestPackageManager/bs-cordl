...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(7600))]
...
public:
  ...
  /// @brief Field audioListener, offset 0x70, size 0x8
  ...
  /// @brief Field audioFilter, offset 0x78, size 0x8
  ...
  /// @brief Field mrcRenderTextureArray, offset 0x80, size 0x8
  ...
  /// @brief Field mrcForegroundRenderTextureArray, offset 0x90, size 0x8
  __declspec(property(
  ...
  /// @brief Field cameraPoseTimeArray, offset 0x98, size 0x8
  ...
  /// @brief Field cachedAudioDataArray, offset 0xa0, size 0x8
  ...
  /// @brief Field audioDataLock, offset 0xa8, size 0x8
  ...
  /// @brief Field cachedAudioData, offset 0xb0, size 0x8
  ...
  /// @brief Field cachedChannels, offset 0xb8, size 0x4
  ...
  /// @brief Method CompositionMethod, addr 0x2740388, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2740390, size 0x4bc, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshCameraObjects, addr 0x274084c, size 0xbf4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshAudioFilter, addr 0x2741440, size 0x5b0, virtual false, abstract: false, final false
  inline void RefreshAudioFilter(::UnityEngine::Camera* mainCamera);

  /// @brief Method CastMrcFrame, addr 0x2741b24, size 0x200, virtual false, abstract: false, final false
  inline int32_t CastMrcFrame(int32_t castTextureIndex);

  /// @brief Method SetCameraTargetTexture, addr 0x2741f00, size 0x1e0, virtual false, abstract: false, final false
  inline void SetCameraTargetTexture(int32_t drawTextureIndex);

  /// @brief Method Update, addr 0x27420e0, size 0xc90, virtual true, abstract: false, final false
  ...
  /// @brief Method CleanupAudioFilter, addr 0x27419f0, size 0x134, virtual false, abstract: false, final false
  inline void CleanupAudioFilter();

  /// @brief Method Cleanup, addr 0x2742e84, size 0x14c, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CacheAudioData, addr 0x2742fd0, size 0x138, virtual false, abstract: false, final false
  inline void CacheAudioData(::ArrayW<float_t, ::Array<float_t>*> data, int32_t channels);

  /// @brief Method GetAndResetAudioData, addr 0x2741d24, size 0x1dc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field fpsThreshold, offset: 0x68, size: 0x4, def value: None
  float_t ___fpsThreshold;

  /// @brief Field isFrameSkipped, offset: 0x6c, size: 0x1, def value: None
  bool ___isFrameSkipped;

  /// @brief Field renderCombinedFrame, offset: 0x6d, size: 0x1, def value: None
  bool ___renderCombinedFrame;

  /// @brief Field audioListener, offset: 0x70, size: 0x8, def value: None
  ::UnityW<::UnityEngine::AudioListener> ___audioListener;

  /// @brief Field audioFilter, offset: 0x78, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::OVRMRAudioFilter> ___audioFilter;

  /// @brief Field mrcRenderTextureArray, offset: 0x80, size: 0x8, def value: None
  ::ArrayW<::UnityW<::UnityEngine::RenderTexture>, ::Array<::UnityW<::UnityEngine::RenderTexture>>*> ___mrcRenderTextureArray;

  /// @brief Field frameIndex, offset: 0x88, size: 0x4, def value: None
  int32_t ___frameIndex;

  /// @brief Field lastMrcEncodeFrameSyncId, offset: 0x8c, size: 0x4, def value: None
  int32_t ___lastMrcEncodeFrameSyncId;

  /// @brief Field mrcForegroundRenderTextureArray, offset: 0x90, size: 0x8, def value: None
  ::ArrayW<::UnityW<::UnityEngine::RenderTexture>, ::Array<::UnityW<::UnityEngine::RenderTexture>>*> ___mrcForegroundRenderTextureArray;

  /// @brief Field cameraPoseTimeArray, offset: 0x98, size: 0x8, def value: None
  ::ArrayW<double_t, ::Array<double_t>*> ___cameraPoseTimeArray;

  /// @brief Field cachedAudioDataArray, offset: 0xa0, size: 0x8, def value: None
  ::ArrayW<float_t, ::Array<float_t>*> ___cachedAudioDataArray;

  /// @brief Field audioDataLock, offset: 0xa8, size: 0x8, def value: None
  ::System::Object* ___audioDataLock;

  /// @brief Field cachedAudioData, offset: 0xb0, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<float_t>* ___cachedAudioData;

  /// @brief Field cachedChannels, offset: 0xb8, size: 0x4, def value: None
  int32_t ___cachedChannels;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVRExternalComposition, 0xc0>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___fpsThreshold) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___isFrameSkipped) == 0x6c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___renderCombinedFrame) == 0x6d, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___audioListener) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___audioFilter) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___mrcRenderTextureArray) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___frameIndex) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___lastMrcEncodeFrameSyncId) == 0x8c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___mrcForegroundRenderTextureArray) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___cameraPoseTimeArray) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___cachedAudioDataArray) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___audioDataLock) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___cachedAudioData) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRExternalComposition, ___cachedChannels) == 0xb8, "Offset mismatch!");
