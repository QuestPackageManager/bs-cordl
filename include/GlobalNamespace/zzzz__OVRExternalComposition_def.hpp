...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRExternalComposition*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRExternalComposition*, "", "OVRExternalComposition");
// Dependencies OVRComposition, UnityEngine.RenderTexture
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_cachedAudioDataArray, put = __cordl_internal_set_cachedAudioDataArray)) ::ArrayW<float_t> cachedAudioDataArray;
  ...
  __declspec(property(get = __cordl_internal_get_cameraPoseTimeArray, put = __cordl_internal_set_cameraPoseTimeArray)) ::ArrayW<double_t> cameraPoseTimeArray;
  ...
  __declspec(property(get = __cordl_internal_get_mrcForegroundRenderTextureArray, put = __cordl_internal_set_mrcForegroundRenderTextureArray)) ::ArrayW<::UnityW<::UnityEngine::RenderTexture>>
      mrcForegroundRenderTextureArray;

  /// @brief Field mrcRenderTextureArray, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get_mrcRenderTextureArray, put = __cordl_internal_set_mrcRenderTextureArray)) ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> mrcRenderTextureArray;
  ...
  /// @brief Method CacheAudioData, addr 0x5df731c, size 0x160, virtual false, abstract: false, final false
  inline void CacheAudioData(::ArrayW<float_t> data, int32_t channels);

  /// @brief Method CastMrcFrame, addr 0x5df5e08, size 0x238, virtual false, abstract: false, final false
  inline int32_t CastMrcFrame(int32_t castTextureIndex);

  /// @brief Method Cleanup, addr 0x5df70f8, size 0x224, virtual true, abstract: false, final false
  inline void Cleanup();

  /// @brief Method CleanupAudioFilter, addr 0x5df5cac, size 0x15c, virtual false, abstract: false, final false
  inline void CleanupAudioFilter();

  /// @brief Method CompositionMethod, addr 0x5df4500, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::OVRManager_CompositionMethod CompositionMethod();

  /// @brief Method DisplayRefreshRateChanged, addr 0x5df747c, size 0x14, virtual false, abstract: false, final false
  inline void DisplayRefreshRateChanged(float_t fromRefreshRate, float_t toRefreshRate);

  /// @brief Method GetAndResetAudioData, addr 0x5df6040, size 0x1fc, virtual false, abstract: false, final false
  inline void GetAndResetAudioData(::by_ref<::ArrayW<float_t>> audioData, ::by_ref<int32_t> audioFrames, ::by_ref<int32_t> channels);
  ...
  /// @brief Method RefreshAudioFilter, addr 0x5df56b0, size 0x5fc, virtual false, abstract: false, final false
  inline void RefreshAudioFilter(::UnityEngine::Camera* mainCamera);

  /// @brief Method RefreshCameraObjects, addr 0x5df4b20, size 0xb90, virtual false, abstract: false, final false
  ...
  /// @brief Method SetCameraTargetTexture, addr 0x5df623c, size 0x1cc, virtual false, abstract: false, final false
  inline void SetCameraTargetTexture(int32_t drawTextureIndex);

  /// @brief Method Update, addr 0x5df6408, size 0xcf0, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<float_t> const& __cordl_internal_get_cachedAudioDataArray() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get_cachedAudioDataArray();

  constexpr int32_t const& __cordl_internal_get_cachedChannels() const;

  constexpr int32_t& __cordl_internal_get_cachedChannels();

  constexpr ::ArrayW<double_t> const& __cordl_internal_get_cameraPoseTimeArray() const;

  constexpr ::ArrayW<double_t>& __cordl_internal_get_cameraPoseTimeArray();
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> const& __cordl_internal_get_mrcForegroundRenderTextureArray() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>>& __cordl_internal_get_mrcForegroundRenderTextureArray();

  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> const& __cordl_internal_get_mrcRenderTextureArray() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::RenderTexture>>& __cordl_internal_get_mrcRenderTextureArray();
  ...
  constexpr void __cordl_internal_set_cachedAudioDataArray(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set_cachedChannels(int32_t value);

  constexpr void __cordl_internal_set_cameraPoseTimeArray(::ArrayW<double_t> value);
  ...
  constexpr void __cordl_internal_set_mrcForegroundRenderTextureArray(::ArrayW<::UnityW<::UnityEngine::RenderTexture>> value);

  constexpr void __cordl_internal_set_mrcRenderTextureArray(::ArrayW<::UnityW<::UnityEngine::RenderTexture>> value);
  ...
  /// @brief Method .ctor, addr 0x5df4508, size 0x618, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRExternalComposition", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRExternalComposition(OVRExternalComposition&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRExternalComposition", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OVRExternalComposition(OVRExternalCompositionconst&) = delete;
  ...
  ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> ___mrcRenderTextureArray;
  ...
  ::ArrayW<::UnityW<::UnityEngine::RenderTexture>> ___mrcForegroundRenderTextureArray;

  /// @brief Field cameraPoseTimeArray, offset: 0xa0, size: 0x8, def value: None
  ::ArrayW<double_t> ___cameraPoseTimeArray;

  /// @brief Field cachedAudioDataArray, offset: 0xa8, size: 0x8, def value: None
  ::ArrayW<float_t> ___cachedAudioDataArray;
...
static_assert(sizeof(::GlobalNamespace::OVRExternalComposition) == 0xc8, "Size mismatch!");
