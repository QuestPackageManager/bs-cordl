...
/// @brief Method ProcessMultiplierEvent, addr 0x369586c, size 0x90, virtual false, abstract: false, final false
inline bool ProcessMultiplierEvent(::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType  multiplierEventType) ;

/// @brief Method Reset, addr 0x3695854, size 0x18, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3695eb8, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_multiplier, addr 0x3695fa0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_multiplier() ;

/// @brief Method get_normalizedProgress, addr 0x3695fa8, size 0x14, virtual false, abstract: false, final false
