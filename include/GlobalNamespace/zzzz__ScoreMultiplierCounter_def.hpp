...
MARK_REF_T(::GlobalNamespace::ScoreMultiplierCounter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType, "", "ScoreMultiplierCounter/MultiplierEventType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ScoreMultiplierCounter*, "", "ScoreMultiplierCounter");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method ProcessMultiplierEvent, addr 0x3750d30, size 0x90, virtual false, abstract: false, final false
  inline bool ProcessMultiplierEvent(::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType multiplierEventType);

  /// @brief Method Reset, addr 0x3750d18, size 0x18, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x375137c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_multiplier, addr 0x3751464, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_multiplier();

  /// @brief Method get_normalizedProgress, addr 0x375146c, size 0x14, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::ScoreMultiplierCounter) == 0x20, "Size mismatch!");
