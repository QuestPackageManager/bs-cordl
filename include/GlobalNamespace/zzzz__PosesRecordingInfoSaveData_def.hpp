...
public:
  ...
  /// @brief Method .ctor, addr 0x23f8e98, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(float_t fieldOfVision, float_t nearClip, float_t farClip, float_t hmdOffset, float_t nearOffset);

  /// @brief Method get_farClip, addr 0x23f8e80, size 0x8, virtual false, abstract: false, final false
  inline float_t get_farClip();

  /// @brief Method get_fieldOfVision, addr 0x23f8e70, size 0x8, virtual false, abstract: false, final false
  inline float_t get_fieldOfVision();

  /// @brief Method get_hmdOffset, addr 0x23f8e88, size 0x8, virtual false, abstract: false, final false
  inline float_t get_hmdOffset();

  /// @brief Method get_nearClip, addr 0x23f8e78, size 0x8, virtual false, abstract: false, final false
  inline float_t get_nearClip();

  /// @brief Method get_nearOffset, addr 0x23f8e90, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x23f8dfc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_dataFileName, addr 0x23f8df4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_dataFileName();

  /// @brief Method get_externalCameraCalibration, addr 0x23f8dec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__PosesRecordingInfoSaveData__ExternalCameraCalibrationSaveData* get_externalCameraCalibration();

  /// @brief Method get_objectIds, addr 0x23f8de4, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_objectIds();

  /// @brief Method get_version, addr 0x23f8ddc, size 0x8, virtual false, abstract: false, final false
