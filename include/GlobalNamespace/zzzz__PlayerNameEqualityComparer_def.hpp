...
// Write type traits
MARK_REF_T(::GlobalNamespace::PlayerNameEqualityComparer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PlayerNameEqualityComparer*, "", "PlayerNameEqualityComparer");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerNameEqualityComparer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerNameEqualityComparer(PlayerNameEqualityComparer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerNameEqualityComparer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerNameEqualityComparer(PlayerNameEqualityComparerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::PlayerNameEqualityComparer) == 0x10, "Size mismatch!");
