...
public:
  ...
  /// @brief Method Equals, addr 0x26ff2d0, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method GetHashCode, addr 0x26ff2f0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26ff314, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
