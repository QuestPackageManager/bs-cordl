...
public:
// Declarations
/// @brief Method Contains, addr 0x367c0c0, size 0x10, virtual false, abstract: false, final false
static inline bool Contains(::GlobalNamespace::GameplayModifierMask  mask, ::GlobalNamespace::GameplayModifierMask  other) ;

/// @brief Method DifferenceFrom, addr 0x367c0d0, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method ToGameplayModifierMask, addr 0x367c154, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method ToHexString, addr 0x367c0ec, size 0x64, virtual false, abstract: false, final false
static inline ::StringW ToHexString(::GlobalNamespace::GameplayModifierMask  mask) ;

/// @brief Method ToMask, addr 0x367c150, size 0x4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::GameplayModifierMask ToMask(::GlobalNamespace::GameplayModifiers*  gameplayModifiers) ;

/// @brief Method ToModifiers, addr 0x367c208, size 0xec, virtual false, abstract: false, final false
