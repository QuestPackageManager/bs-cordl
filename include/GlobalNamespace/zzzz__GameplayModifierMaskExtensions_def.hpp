...
public:
  // Declarations
  /// @brief Method Contains, addr 0x15026ec, size 0x10, virtual false, abstract: false, final false
  static inline bool Contains(::GlobalNamespace::GameplayModifierMask mask, ::GlobalNamespace::GameplayModifierMask other);

  /// @brief Method DifferenceFrom, addr 0x15026fc, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHexString, addr 0x150270c, size 0x5c, virtual false, abstract: false, final false
  static inline ::StringW ToHexString(::GlobalNamespace::GameplayModifierMask mask);

  /// @brief Method ToMask, addr 0x15029a4, size 0xb8, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::GameplayModifierMask ToMask(::GlobalNamespace::GameplayModifiers* gameplayModifiers);

  /// @brief Method ToModifiers, addr 0x1502768, size 0x148, virtual false, abstract: false, final false
