...
public:
  ...
  /// @brief Method PlayEffect, addr 0x23e5c04, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e5c68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_audioSource, addr 0x23e5bfc, size 0x8, virtual false, abstract: false, final false
