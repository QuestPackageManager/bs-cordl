...
public:
  ...
  /// @brief Method PlayEffect, addr 0x2383664, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23836c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_audioSource, addr 0x238365c, size 0x8, virtual false, abstract: false, final false
