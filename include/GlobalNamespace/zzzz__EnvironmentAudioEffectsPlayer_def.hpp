...
public:
  ...
  /// @brief Method PlayEffect, addr 0x577b590, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x577b5f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_audioSource, addr 0x577b588, size 0x8, virtual false, abstract: false, final false
