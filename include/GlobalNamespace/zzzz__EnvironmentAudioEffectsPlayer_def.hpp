...
public:
  ...
  /// @brief Method PlayEffect, addr 0x25081ec, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2508250, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_audioSource, addr 0x25081e4, size 0x8, virtual false, abstract: false, final false
