...
public:
  ...
  /// @brief Method .ctor, addr 0x25a07e4, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::ScenesTransitionSetupDataSO* nextScenesTransitionSetupData);

  /// @brief Method get_nextScenesTransitionSetupData, addr 0x25a07dc, size 0x8, virtual false, abstract: false, final false
