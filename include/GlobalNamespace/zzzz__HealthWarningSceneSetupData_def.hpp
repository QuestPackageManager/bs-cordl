...
public:
  ...
  /// @brief Method .ctor, addr 0x590dc20, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HealthWarningSceneSetupData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HealthWarningSceneSetupData(HealthWarningSceneSetupData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HealthWarningSceneSetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HealthWarningSceneSetupData(HealthWarningSceneSetupDataconst&) = delete;
