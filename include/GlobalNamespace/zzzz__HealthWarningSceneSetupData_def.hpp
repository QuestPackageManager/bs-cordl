...
public:
  ...
  /// @brief Method .ctor, addr 0x25a87e0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::ScenesTransitionSetupDataSO* nextScenesTransitionSetupData);

  /// @brief Method get_nextScenesTransitionSetupData, addr 0x25a87d8, size 0x8, virtual false, abstract: false, final false
