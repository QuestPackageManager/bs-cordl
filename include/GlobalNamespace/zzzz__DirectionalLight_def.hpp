...
public:
  ...
  /// @brief Method get_lights, addr 0x219fa3c, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::DirectionalLight>>* get_lights();

  /// @brief Method OnEnable, addr 0x219fa94, size 0xd0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x219fb64, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  static inline ::GlobalNamespace::DirectionalLight* New_ctor();

  /// @brief Method .ctor, addr 0x219fbe4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
