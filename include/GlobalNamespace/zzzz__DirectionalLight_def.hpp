...
public:
  ...
  /// @brief Method OnDisable, addr 0x22cf0f4, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x22cf024, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22cf174, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_lights, addr 0x22cefcc, size 0x58, virtual false, abstract: false, final false
