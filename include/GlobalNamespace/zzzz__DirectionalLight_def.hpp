...
public:
  ...
  /// @brief Method OnDisable, addr 0x23ee53c, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x23ee46c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ee5bc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_lights, addr 0x23ee414, size 0x58, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::DirectionalLight, ___color) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::DirectionalLight, ___intensity) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::DirectionalLight, ___radius) == 0x2c, "Offset mismatch!");
