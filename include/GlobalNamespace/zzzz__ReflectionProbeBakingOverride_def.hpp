...
/// @brief Method UpdateForProbeBaking, addr 0x5752714, size 0xec, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5752800, size 0xc0, virtual false, abstract: false, final false
inline void _ctor() ;
