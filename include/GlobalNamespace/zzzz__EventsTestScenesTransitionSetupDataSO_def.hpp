...
public:
  ...
  /// @brief Method Init, addr 0x26d2540, size 0x1dc, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x26d271c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
