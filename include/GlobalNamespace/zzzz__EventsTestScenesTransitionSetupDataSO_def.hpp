...
public:
  // Declarations
  /// @brief Method Init, addr 0x577ca40, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x577cc18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
