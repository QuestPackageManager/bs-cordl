...
public:
  ...
  /// @brief Method Init, addr 0x3ac68d8, size 0x1d8, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x3ac6ab0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
