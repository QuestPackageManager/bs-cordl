...
public:
  ...
  /// @brief Method Init, addr 0x3b3a438, size 0x1d8, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x3b3a610, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
