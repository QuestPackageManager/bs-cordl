...
public:
  // Declarations
  /// @brief Method Init, addr 0x57ed3f0, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ed5c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
