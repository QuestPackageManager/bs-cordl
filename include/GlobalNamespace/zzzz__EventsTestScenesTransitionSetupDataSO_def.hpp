...
public:
// Declarations
/// @brief Method Init, addr 0x57eec58, size 0x1d8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57eee30, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
