...
public:
  ...
  /// @brief Method Init, addr 0x247c898, size 0x1dc, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method .ctor, addr 0x247ca74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
