...
public:
  ...
  /// @brief Method RestartLevel, addr 0x25e8f6c, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x25e9020, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
