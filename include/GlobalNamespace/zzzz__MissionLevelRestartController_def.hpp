...
public:
  ...
  /// @brief Method RestartLevel, addr 0x2701648, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x27016f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
