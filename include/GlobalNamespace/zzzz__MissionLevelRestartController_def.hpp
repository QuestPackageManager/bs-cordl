...
/// @brief Method RestartLevel, addr 0x580859c, size 0xb4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5808650, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
