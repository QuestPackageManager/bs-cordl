...
public:
  ...
  /// @brief Method RestartLevel, addr 0x587a4e8, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x587a59c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
