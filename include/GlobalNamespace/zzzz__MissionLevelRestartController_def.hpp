...
public:
  ...
  /// @brief Method RestartLevel, addr 0x24552ac, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x245535c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
