...
public:
  ...
  /// @brief Method OnGUI, addr 0x3ae08a4, size 0xb1c, virtual false, abstract: false, final false
  inline void OnGUI();
  ...
  /// @brief Method .ctor, addr 0x3ae13c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
