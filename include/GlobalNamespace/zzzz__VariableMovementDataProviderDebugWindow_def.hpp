...
public:
  ...
  /// @brief Method OnGUI, addr 0x58cda14, size 0xbf8, virtual false, abstract: false, final false
  inline void OnGUI();
  ...
  /// @brief Method .ctor, addr 0x58ce60c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "VariableMovementDataProviderDebugWindow", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  VariableMovementDataProviderDebugWindow(VariableMovementDataProviderDebugWindow&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "VariableMovementDataProviderDebugWindow", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  VariableMovementDataProviderDebugWindow(VariableMovementDataProviderDebugWindowconst&) = delete;
