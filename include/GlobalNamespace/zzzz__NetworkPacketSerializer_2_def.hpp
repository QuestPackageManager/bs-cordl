...
/// @brief Field _packetProcessedHandler, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__packetProcessedHandler, put=__cordl_internal_set__packetProcessedHandler)) ::GlobalNamespace::INetworkPacketProcessedHandler_1<TData>*  _packetProcessedHandler;
...
/// @brief Field _subSerializerPacketTypes, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__subSerializerPacketTypes, put=__cordl_internal_set__subSerializerPacketTypes)) ::System::Collections::Generic::HashSet_1<uint8_t>*  _subSerializerPacketTypes;
