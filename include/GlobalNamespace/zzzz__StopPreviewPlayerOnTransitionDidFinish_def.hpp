...
public:
  ...
  /// @brief Method HandleTransitionDidFinish, addr 0x3ae3708, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3ae3638, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3ae35a8, size 0x90, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ae3720, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
