...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockPlayerAvatarType, "", "MockPlayerAvatarType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Field Beat value: I32(0)
  static ::GlobalNamespace::MockPlayerAvatarType const Beat;

  /// @brief Field Meta value: I32(1)
...
static_assert(sizeof(::GlobalNamespace::MockPlayerAvatarType) == 0x4, "Size mismatch!");
