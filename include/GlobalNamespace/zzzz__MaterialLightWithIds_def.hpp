...
// Write type traits
MARK_REF_T(::GlobalNamespace::MaterialLightWithIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MaterialLightWithIds*, "", "MaterialLightWithIds");
...
public:
  ...
  /// @brief Method Awake, addr 0x5872080, size 0x74, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x58720f4, size 0x16c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5872260, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MaterialLightWithIds) == 0x80, "Size mismatch!");
