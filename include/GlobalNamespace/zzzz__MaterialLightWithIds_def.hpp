...
public:
  ...
  /// @brief Method Awake, addr 0x39e6e58, size 0x84, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x39e6edc, size 0x144, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e7020, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();
