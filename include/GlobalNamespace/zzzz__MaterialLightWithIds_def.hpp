...
/// @brief Method Awake, addr 0x56bbee0, size 0x74, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method ColorWasSet, addr 0x56bbf54, size 0x16c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bc0c0, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
