...
public:
  ...
  /// @brief Method HandleColorSchemeColorsToggleGroupSelectedColorDidChange, addr 0x57fcdc8, size 0x98, virtual false, abstract: false, final false
  inline void HandleColorSchemeColorsToggleGroupSelectedColorDidChange(::UnityEngine::Color color);

  /// @brief Method HandleHSVPanelControllerColorDidChange, addr 0x57fcf34, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandlePreviousColorPanelControllerColorWasSelected, addr 0x57fd018, size 0xc8, virtual false, abstract: false, final false
  inline void HandlePreviousColorPanelControllerColorWasSelected(::UnityEngine::Color color);

  /// @brief Method HandleRGBPanelControllerColorDidChange, addr 0x57fce60, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x57fcb40, size 0x288, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetColorScheme, addr 0x57fc710, size 0x14, virtual false, abstract: false, final false
  inline void SetColorScheme(::GlobalNamespace::ColorScheme* colorScheme);

  /// @brief Method Start, addr 0x57fc7c4, size 0x37c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method <Start>b__13_0, addr 0x57fd0e4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57fd0e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeColorSchemeEvent, addr 0x57fb9e0, size 0xc0, virtual false, abstract: false, final false
  inline void add_didChangeColorSchemeEvent(::System::Action_1<::GlobalNamespace::ColorScheme*>* value);

  /// @brief Method add_didFinishEvent, addr 0x57fb934, size 0xac, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action* value);

  /// @brief Method remove_didChangeColorSchemeEvent, addr 0x57fbe84, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didChangeColorSchemeEvent(::System::Action_1<::GlobalNamespace::ColorScheme*>* value);

  /// @brief Method remove_didFinishEvent, addr 0x57fbdd8, size 0xac, virtual false, abstract: false, final false
