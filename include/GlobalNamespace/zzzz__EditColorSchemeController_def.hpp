...
public:
  ...
  /// @brief Method HandleColorSchemeColorsToggleGroupSelectedColorDidChange, addr 0x592059c, size 0x98, virtual false, abstract: false, final false
  inline void HandleColorSchemeColorsToggleGroupSelectedColorDidChange(::UnityEngine::Color color);

  /// @brief Method HandleHSVPanelControllerColorDidChange, addr 0x592070c, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandlePreviousColorPanelControllerColorWasSelected, addr 0x59207f4, size 0xcc, virtual false, abstract: false, final false
  inline void HandlePreviousColorPanelControllerColorWasSelected(::UnityEngine::Color color);

  /// @brief Method HandleRGBPanelControllerColorDidChange, addr 0x5920634, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5920310, size 0x28c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetColorScheme, addr 0x591fed8, size 0x18, virtual false, abstract: false, final false
  inline void SetColorScheme(::GlobalNamespace::ColorScheme* colorScheme);

  /// @brief Method Start, addr 0x591ff90, size 0x380, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method <Start>b__13_0, addr 0x59208c4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59208c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeColorSchemeEvent, addr 0x591f1a0, size 0xc0, virtual false, abstract: false, final false
  inline void add_didChangeColorSchemeEvent(::System::Action_1<::GlobalNamespace::ColorScheme*>* value);

  /// @brief Method add_didFinishEvent, addr 0x591f0f4, size 0xac, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action* value);

  /// @brief Method remove_didChangeColorSchemeEvent, addr 0x591f644, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didChangeColorSchemeEvent(::System::Action_1<::GlobalNamespace::ColorScheme*>* value);

  /// @brief Method remove_didFinishEvent, addr 0x591f598, size 0xac, virtual false, abstract: false, final false
