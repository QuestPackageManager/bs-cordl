...
public:
  ...
  /// @brief Method HandleColorSchemeColorsToggleGroupSelectedColorDidChange, addr 0x3bfd254, size 0x80, virtual false, abstract: false, final false
  inline void HandleColorSchemeColorsToggleGroupSelectedColorDidChange(::UnityEngine::Color color);

  /// @brief Method HandleHSVPanelControllerColorDidChange, addr 0x3bfd3a8, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandlePreviousColorPanelControllerColorWasSelected, addr 0x3bfd47c, size 0xbc, virtual false, abstract: false, final false
  inline void HandlePreviousColorPanelControllerColorWasSelected(::UnityEngine::Color color);

  /// @brief Method HandleRGBPanelControllerColorDidChange, addr 0x3bfd2d4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bfd088, size 0x1cc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetColorScheme, addr 0x3bfcd44, size 0x18, virtual false, abstract: false, final false
  inline void SetColorScheme(::GlobalNamespace::ColorScheme* colorScheme);

  /// @brief Method Start, addr 0x3bfce04, size 0x284, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method <Start>b__13_0, addr 0x3bfd540, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bfd538, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeColorSchemeEvent, addr 0x3bfc1a8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didChangeColorSchemeEvent(::System::Action_1<::GlobalNamespace::ColorScheme*>* value);

  /// @brief Method add_didFinishEvent, addr 0x3bfc10c, size 0x9c, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action* value);

  /// @brief Method remove_didChangeColorSchemeEvent, addr 0x3bfc590, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didChangeColorSchemeEvent(::System::Action_1<::GlobalNamespace::ColorScheme*>* value);

  /// @brief Method remove_didFinishEvent, addr 0x3bfc4f4, size 0x9c, virtual false, abstract: false, final false
