...
public:
  ...
  /// @brief Method CreateErrorLog, addr 0x57ce2d0, size 0x244, virtual false, abstract: false, final false
  inline ::StringW CreateErrorLog();

  /// @brief Method IsValid, addr 0x57ce274, size 0x5c, virtual false, abstract: false, final false
  inline bool IsValid();

  static inline ::GlobalNamespace::PerformanceConfigurationChecks* New_ctor();

  /// @brief Method SetExpected, addr 0x57ce514, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifyExpected, addr 0x57ce88c, size 0x1560, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57cfdec, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
