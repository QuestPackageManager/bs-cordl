...
public:
  ...
  /// @brief Method CreateErrorLog, addr 0x3b23aec, size 0x28c, virtual false, abstract: false, final false
  inline ::StringW CreateErrorLog();

  /// @brief Method IsValid, addr 0x3b23a90, size 0x5c, virtual false, abstract: false, final false
  inline bool IsValid();

  static inline ::GlobalNamespace::PerformanceConfigurationChecks* New_ctor();

  /// @brief Method SetExpected, addr 0x3b23d78, size 0x4c0, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifyExpected, addr 0x3b24238, size 0x1c04, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b25e3c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
