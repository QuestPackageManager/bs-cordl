...
public:
  ...
  /// @brief Method HandleMirrorDidChangeEnabledState, addr 0x24580c8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x24580f4, size 0xd4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x2458028, size 0xa0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24581c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mirror, addr 0x2458018, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::Mirror> get_mirror();

  /// @brief Method set_mirror, addr 0x2458020, size 0x8, virtual false, abstract: false, final false
