...
public:
  ...
  /// @brief Method .ctor, addr 0x22b2a78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <InstallBindings>b__54_0, addr 0x22b2a80, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method <InstallBindings>b__54_1, addr 0x22b2af8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method <InstallBindings>b__54_2, addr 0x22b2b5c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method <InstallPlatformLeaderboardsModel>b__58_0, addr 0x22b2bd4, size 0x7c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x22b05d0, size 0x34c, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InstallBindings, addr 0x22b0a28, size 0x1974, virtual false, abstract: false, final false
  inline void InstallBindings(::Zenject::DiContainer* container, bool isRunningFromTests);

  /// @brief Method InstallHapticsController, addr 0x22b27d8, size 0x1c0, virtual false, abstract: false, final false
  inline void InstallHapticsController(::Zenject::DiContainer* container);

  /// @brief Method InstallRichPresence, addr 0x22b24bc, size 0xf0, virtual false, abstract: false, final false
  inline void InstallRichPresence(::Zenject::DiContainer* container, bool isRunningFromTests);

  /// @brief Method InstallOculusDestinationBindings, addr 0x22b23c4, size 0xf8, virtual false, abstract: false, final false
  inline void InstallOculusDestinationBindings(::Zenject::DiContainer* container);

  /// @brief Method InstallPlatformLeaderboardsModel, addr 0x22b25ac, size 0x22c, virtual false, abstract: false, final false
  inline void InstallPlatformLeaderboardsModel(::Zenject::DiContainer* container, bool isRunningFromTests);

  /// @brief Method InstallPS5Bindings, addr 0x22b2998, size 0x4, virtual false, abstract: false, final false
  inline void InstallPS5Bindings(::Zenject::DiContainer* container);

  /// @brief Method InstallPS4Bindings, addr 0x22b299c, size 0x4, virtual false, abstract: false, final false
  inline void InstallPS4Bindings(::Zenject::DiContainer* container);

  static inline ::GlobalNamespace::MainSystemInit* New_ctor();

  /// @brief Method .ctor, addr 0x22b29a0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
