...
/// @brief Field <>9__33_2, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__33_2, put=setStaticF___9__33_2)) ::System::Func_2<::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*,::GlobalNamespace::PerceivedLoudnessPerLevelModel*>*  __9__33_2;

/// @brief Field <>9__33_3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF___9__33_3, put=setStaticF___9__33_3)) ::System::Func_2<::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*,::GlobalNamespace::OculusLevelProductCollectionModel*>*  __9__33_3;
...
/// @brief Method <InstallBindings>b__33_1, addr 0x3676e48, size 0x100, virtual false, abstract: false, final false
inline ::GlobalNamespace::IRandom* _InstallBindings_b__33_1(::Zenject::InjectContext*  ctx) ;

/// @brief Method <InstallBindings>b__33_2, addr 0x3676f48, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method <InstallBindings>b__33_3, addr 0x3676fbc, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method <InstallPlatformLeaderboardsModel>b__36_0, addr 0x3677030, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3676e44, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
static inline ::System::Func_2<::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*,::GlobalNamespace::PerceivedLoudnessPerLevelModel*>* getStaticF___9__33_2() ;

static inline ::System::Func_2<::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*,::GlobalNamespace::OculusLevelProductCollectionModel*>* getStaticF___9__33_3() ;
...
static inline void setStaticF___9__33_2(::System::Func_2<::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*,::GlobalNamespace::PerceivedLoudnessPerLevelModel*>*  value) ;

static inline void setStaticF___9__33_3(::System::Func_2<::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>*,::GlobalNamespace::OculusLevelProductCollectionModel*>*  value) ;
...
/// @brief Method <InstallBindings>b__0, addr 0x36770ac, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x36768ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _beatmapLevelsPromoData, offset 0xc8, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapLevelsPromoData, put=__cordl_internal_set__beatmapLevelsPromoData)) ::UnityW<::GlobalNamespace::BeatmapLevelsPromoDataSO>  _beatmapLevelsPromoData;

/// @brief Field _campaignProgressModelPrefab, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__campaignProgressModelPrefab, put=__cordl_internal_set__campaignProgressModelPrefab)) ::UnityW<::GlobalNamespace::CampaignProgressModel>  _campaignProgressModelPrefab;
...
/// @brief Field _devicelessVRHelperPrefab, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get__devicelessVRHelperPrefab, put=__cordl_internal_set__devicelessVRHelperPrefab)) ::UnityW<::GlobalNamespace::DevicelessVRHelper>  _devicelessVRHelperPrefab;
...
/// @brief Field _environmentAudioEffectsPlayerPrefab, offset 0x98, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentAudioEffectsPlayerPrefab, put=__cordl_internal_set__environmentAudioEffectsPlayerPrefab)) ::UnityW<::GlobalNamespace::EnvironmentAudioEffectsPlayer>  _environmentAudioEffectsPlayerPrefab;

/// @brief Field _gameLiftNetworkPlayerModelPrefab, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameLiftNetworkPlayerModelPrefab, put=__cordl_internal_set__gameLiftNetworkPlayerModelPrefab)) ::UnityW<::GlobalNamespace::GameLiftNetworkPlayerModel>  _gameLiftNetworkPlayerModelPrefab;

/// @brief Field _leaderboardScoreUploader, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get__leaderboardScoreUploader, put=__cordl_internal_set__leaderboardScoreUploader)) ::UnityW<::GlobalNamespace::LeaderboardScoreUploader>  _leaderboardScoreUploader;

/// @brief Field _lightsUpdateSystemPrefab, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightsUpdateSystemPrefab, put=__cordl_internal_set__lightsUpdateSystemPrefab)) ::UnityW<::GlobalNamespace::BloomPrePassLightsUpdateSystem>  _lightsUpdateSystemPrefab;

/// @brief Field _localServerNetworkPlayerModelPrefab, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__localServerNetworkPlayerModelPrefab, put=__cordl_internal_set__localServerNetworkPlayerModelPrefab)) ::UnityW<::GlobalNamespace::LocalServerNetworkPlayerModel>  _localServerNetworkPlayerModelPrefab;

/// @brief Field _menuTransitionHelperPrefab, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get__menuTransitionHelperPrefab, put=__cordl_internal_set__menuTransitionHelperPrefab)) ::UnityW<::GlobalNamespace::MenuTransitionsHelper>  _menuTransitionHelperPrefab;
...
/// @brief Field _multiplayerSessionManagerPrefab, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__multiplayerSessionManagerPrefab, put=__cordl_internal_set__multiplayerSessionManagerPrefab)) ::UnityW<::GlobalNamespace::BeatSaberMultiplayerSessionManager>  _multiplayerSessionManagerPrefab;
...
/// @brief Field _networkPlayerEntitlementCheckerPrefab, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__networkPlayerEntitlementCheckerPrefab, put=__cordl_internal_set__networkPlayerEntitlementCheckerPrefab)) ::UnityW<::GlobalNamespace::NetworkPlayerEntitlementChecker>  _networkPlayerEntitlementCheckerPrefab;

/// @brief Field _nodePoseSyncStateManagerPrefab, offset 0xa0, size 0x8 
 __declspec(property(get=__cordl_internal_get__nodePoseSyncStateManagerPrefab, put=__cordl_internal_set__nodePoseSyncStateManagerPrefab)) ::UnityW<::GlobalNamespace::NodePoseSyncStateManager>  _nodePoseSyncStateManagerPrefab;

/// @brief Field _oculusNetworkPlayerModelPrefab, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__oculusNetworkPlayerModelPrefab, put=__cordl_internal_set__oculusNetworkPlayerModelPrefab)) ::UnityW<::GlobalNamespace::OculusNetworkPlayerModel>  _oculusNetworkPlayerModelPrefab;

/// @brief Field _persistentAudioNoisePrefab, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__persistentAudioNoisePrefab, put=__cordl_internal_set__persistentAudioNoisePrefab)) ::UnityW<::GlobalNamespace::PersistentAudioNoiseController>  _persistentAudioNoisePrefab;

/// @brief Field _platformLeaderboardsModel, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__platformLeaderboardsModel, put=__cordl_internal_set__platformLeaderboardsModel)) ::UnityW<::GlobalNamespace::PlatformLeaderboardsModel>  _platformLeaderboardsModel;
...
/// @brief Field _richPresenceManagerPrefab, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get__richPresenceManagerPrefab, put=__cordl_internal_set__richPresenceManagerPrefab)) ::UnityW<::GlobalNamespace::RichPresenceManager>  _richPresenceManagerPrefab;
...
/// @brief Field _steamNetworkPlayerModelPrefab, offset 0xd8, size 0x8 
 __declspec(property(get=__cordl_internal_get__steamNetworkPlayerModelPrefab, put=__cordl_internal_set__steamNetworkPlayerModelPrefab)) ::UnityW<::GlobalNamespace::SteamNetworkPlayerModel>  _steamNetworkPlayerModelPrefab;
...
/// @brief Method Init, addr 0x366eeb0, size 0x7c, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::SettingsApplicatorSO*  settingsApplicator) ;

/// @brief Method InstallBindings, addr 0x366f6c0, size 0x1bb8, virtual false, abstract: false, final false
inline void InstallBindings(::Zenject::DiContainer*  container, bool  isRunningFromTests) ;

/// @brief Method InstallOculusDestinationBindings, addr 0x36768f0, size 0x124, virtual false, abstract: false, final false
inline void InstallOculusDestinationBindings(::Zenject::DiContainer*  container) ;

/// @brief Method InstallPlatformLeaderboardsModel, addr 0x3676b4c, size 0x298, virtual false, abstract: false, final false
inline void InstallPlatformLeaderboardsModel(::Zenject::DiContainer*  container, bool  isRunningFromTests) ;

/// @brief Method InstallRichPresence, addr 0x3676a14, size 0x138, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3676de4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
