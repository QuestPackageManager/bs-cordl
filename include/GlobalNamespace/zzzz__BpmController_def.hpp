...
public:
  ...
  /// @brief Method .ctor, addr 0x3b7d8d8, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x3b7d8a0, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleBpmChangeBeatmapEvent, addr 0x3b7d8bc, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7d7cc, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentBpm, addr 0x3b7d7a4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_currentBpm();

  /// @brief Method get_oneBeatDuration, addr 0x3b7d7ac, size 0x20, virtual true, abstract: false, final true
