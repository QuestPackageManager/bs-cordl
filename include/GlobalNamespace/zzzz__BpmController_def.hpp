...
public:
  ...
  /// @brief Method .ctor, addr 0x25ae634, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x25ae5fc, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleBpmChangeBeatmapEvent, addr 0x25ae618, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ae52c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentBpm, addr 0x25ae504, size 0x8, virtual true, abstract: false, final true
  inline float_t get_currentBpm();

  /// @brief Method get_oneBeatDuration, addr 0x25ae50c, size 0x20, virtual true, abstract: false, final true
