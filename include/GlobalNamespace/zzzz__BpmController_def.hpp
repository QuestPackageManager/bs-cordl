...
/// @brief Method .ctor, addr 0x57cff88, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x57cff54, size 0x1c, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method HandleBpmChangeBeatmapEvent, addr 0x57cff70, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57cfe88, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method get_currentBpm, addr 0x57cfe60, size 0x8, virtual true, abstract: false, final true
inline float_t get_currentBpm() ;

/// @brief Method get_oneBeatDuration, addr 0x57cfe68, size 0x20, virtual true, abstract: false, final true
