...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::ISortedListItemProcessor_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::ISortedListItemProcessor_1, "", "ISortedListItemProcessor`1");
// Dependencies
namespace GlobalNamespace {
// cpp template
template <typename T>
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISortedListItemProcessor_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISortedListItemProcessor_1(ISortedListItemProcessor_1const&) = delete;
