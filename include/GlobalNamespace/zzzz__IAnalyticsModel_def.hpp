...
// Write type traits
MARK_REF_T(::GlobalNamespace::IAnalyticsModel*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IAnalyticsModel*, "", "IAnalyticsModel");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23376 };
