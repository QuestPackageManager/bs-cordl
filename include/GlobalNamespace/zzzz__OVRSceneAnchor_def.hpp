...
/// @brief Field AnchorReferenceCountDictionary, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_AnchorReferenceCountDictionary, put=setStaticF_AnchorReferenceCountDictionary)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::OVRSpace,int32_t>*  AnchorReferenceCountDictionary;
...
/// @brief Field SceneAnchors, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_SceneAnchors, put=setStaticF_SceneAnchors)) ::System::Collections::Generic::Dictionary_2<::System::Guid,::UnityW<::GlobalNamespace::OVRSceneAnchor>>*  SceneAnchors;
...
/// @brief Field _isLocatable, offset 0x74, size 0x1 
 __declspec(property(get=__cordl_internal_get__isLocatable, put=__cordl_internal_set__isLocatable)) bool  _isLocatable;
...
/// @brief Field _supportedComponents, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__supportedComponents, put=__cordl_internal_set__supportedComponents)) ::System::Collections::Generic::List_1<::GlobalNamespace::OVRPlugin_SpaceComponentType>*  _supportedComponents;

/// @brief Method ClearPoseCache, addr 0x5d11c88, size 0x10, virtual false, abstract: false, final false
inline void ClearPoseCache() ;

/// @brief Method GetSceneAnchors, addr 0x5d12494, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method Initialize, addr 0x5d11c98, size 0x3d0, virtual false, abstract: false, final false
inline void Initialize(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method InitializeFrom, addr 0x5d123ac, size 0xe8, virtual false, abstract: false, final false
inline void InitializeFrom(::GlobalNamespace::OVRSceneAnchor*  other) ;

/// @brief Method IsComponentEnabled, addr 0x5d11be0, size 0xa8, virtual false, abstract: false, final false
inline bool IsComponentEnabled(::GlobalNamespace::OVRPlugin_SpaceComponentType  spaceComponentType) ;

/// @brief Method IsComponentSupported, addr 0x5d11ae8, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5d125a8, size 0x21c, virtual false, abstract: false, final false
...
/// @brief Method TryUpdateTransform, addr 0x5d12068, size 0x344, virtual false, abstract: false, final false
...
constexpr bool const& __cordl_internal_get__isLocatable() const;

constexpr bool& __cordl_internal_get__isLocatable() ;
...
constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::OVRPlugin_SpaceComponentType>* const& __cordl_internal_get__supportedComponents() const;

constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::OVRPlugin_SpaceComponentType>*& __cordl_internal_get__supportedComponents() ;
...
constexpr void __cordl_internal_set__isLocatable(bool  value) ;
...
/// @brief Method .ctor, addr 0x5d127c4, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_Anchor, addr 0x5d11ab0, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRAnchor get_Anchor() ;

/// @brief Method get_IsTracked, addr 0x5d11ad8, size 0x8, virtual false, abstract: false, final false
inline bool get_IsTracked() ;

/// @brief Method get_Space, addr 0x5d11a8c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRSpace get_Space() ;

/// @brief Method get_Uuid, addr 0x5d11a9c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_Anchor, addr 0x5d11ac4, size 0x14, virtual false, abstract: false, final false
inline void set_Anchor(::GlobalNamespace::OVRAnchor  value) ;

/// @brief Method set_IsTracked, addr 0x5d11ae0, size 0x8, virtual false, abstract: false, final false
inline void set_IsTracked(bool  value) ;

/// @brief Method set_Space, addr 0x5d11a94, size 0x8, virtual false, abstract: false, final false
inline void set_Space(::GlobalNamespace::OVRSpace  value) ;

/// @brief Method set_Uuid, addr 0x5d11aa8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _isLocatable, offset: 0x74, size: 0x1, def value: None
 bool  ____isLocatable;

/// @brief Field _supportedComponents, offset: 0x78, size: 0x8, def value: None
 ::System::Collections::Generic::List_1<::GlobalNamespace::OVRPlugin_SpaceComponentType>*  ____supportedComponents;
...
static_assert(offsetof(::GlobalNamespace::OVRSceneAnchor, ____isLocatable) == 0x74, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OVRSceneAnchor, ____supportedComponents) == 0x78, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVRSceneAnchor, 0x80>, "Size mismatch!");
