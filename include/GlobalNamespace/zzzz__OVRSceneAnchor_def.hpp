...
public:
  ...
  /// @brief Method ClearPoseCache, addr 0x400b7ec, size 0x10, virtual false, abstract: false, final false
  inline void ClearPoseCache();

  /// @brief Method GetSceneAnchors, addr 0x400bf80, size 0xf4, virtual false, abstract: false, final false
  static inline void GetSceneAnchors(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::OVRSceneAnchor>>* anchors);

  /// @brief Method Initialize, addr 0x400b7fc, size 0x380, virtual false, abstract: false, final false
  inline void Initialize(::GlobalNamespace::OVRAnchor anchor);

  /// @brief Method InitializeFrom, addr 0x400be9c, size 0xe4, virtual false, abstract: false, final false
  inline void InitializeFrom(::GlobalNamespace::OVRSceneAnchor* other);

  /// @brief Method IsComponentEnabled, addr 0x400b75c, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x400c074, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method TryUpdateTransform, addr 0x400bb90, size 0x30c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x400c254, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_Anchor, addr 0x400b720, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRAnchor get_Anchor();

  /// @brief Method get_IsTracked, addr 0x400b748, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsTracked();

  /// @brief Method get_Space, addr 0x400b6fc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSpace get_Space();

  /// @brief Method get_Uuid, addr 0x400b70c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_Anchor, addr 0x400b734, size 0x14, virtual false, abstract: false, final false
  inline void set_Anchor(::GlobalNamespace::OVRAnchor value);

  /// @brief Method set_IsTracked, addr 0x400b750, size 0xc, virtual false, abstract: false, final false
  inline void set_IsTracked(bool value);

  /// @brief Method set_Space, addr 0x400b704, size 0x8, virtual false, abstract: false, final false
  inline void set_Space(::GlobalNamespace::OVRSpace value);

  /// @brief Method set_Uuid, addr 0x400b718, size 0x8, virtual false, abstract: false, final false
