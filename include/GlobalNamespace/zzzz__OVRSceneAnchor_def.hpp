...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2406)), TypeDefinitionIndex(TypeDefinitionIndex(2448)), TypeDefinitionIndex(TypeDefinitionIndex(7778)),
// TypeDefinitionIndex(TypeDefinitionIndex(8000)), TypeDefinitionIndex(TypeDefinitionIndex(8969)), TypeDefinitionIndex(TypeDefinitionIndex(8996)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(2448), inst: 4755 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(7974)) CS Name: ::OVRSceneAnchor*
...
public:
  ...
  /// @brief Method get_Space, addr 0x279d918, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSpace get_Space();

  /// @brief Method set_Space, addr 0x279d920, size 0x8, virtual false, abstract: false, final false
  inline void set_Space(::GlobalNamespace::OVRSpace value);

  /// @brief Method get_Uuid, addr 0x279d928, size 0xc, virtual false, abstract: false, final false
  inline ::System::Guid get_Uuid();

  /// @brief Method set_Uuid, addr 0x279d934, size 0x8, virtual false, abstract: false, final false
  inline void set_Uuid(::System::Guid value);

  /// @brief Method get_IsTracked, addr 0x279d93c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsTracked();

  /// @brief Method set_IsTracked, addr 0x279d944, size 0xc, virtual false, abstract: false, final false
  inline void set_IsTracked(bool value);

  /// @brief Method IsComponentEnabled, addr 0x279d950, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearPoseCache, addr 0x279d9e0, size 0x10, virtual false, abstract: false, final false
  inline void ClearPoseCache();

  /// @brief Method Initialize, addr 0x279d9f0, size 0x368, virtual false, abstract: false, final false
  inline void Initialize(::GlobalNamespace::OVRSpace space, ::System::Guid uuid);

  /// @brief Method InitializeFrom, addr 0x279e02c, size 0xd0, virtual false, abstract: false, final false
  inline void InitializeFrom(::GlobalNamespace::OVRSceneAnchor* other);

  /// @brief Method GetSceneAnchors, addr 0x279e0fc, size 0xf8, virtual false, abstract: false, final false
  static inline void GetSceneAnchors(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::OVRSceneAnchor>>* anchors);

  /// @brief Method TryUpdateTransform, addr 0x279dd68, size 0x2c4, virtual false, abstract: false, final false
  inline bool TryUpdateTransform(bool useCache);

  /// @brief Method OnDestroy, addr 0x279e1f4, size 0x1e0, virtual false, abstract: false, final false
  inline void OnDestroy();

  static inline ::GlobalNamespace::OVRSceneAnchor* New_ctor();

  /// @brief Method .ctor, addr 0x279e3d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
