...
public:
  ...
  /// @brief Method SubtypeIdentifier, addr 0x2241e0c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2241da8, size 0x64, virtual false, abstract: false, final false
