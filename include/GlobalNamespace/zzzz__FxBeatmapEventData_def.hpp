...
public:
  ...
  /// @brief Method SubtypeIdentifier, addr 0x2243130, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22430cc, size 0x64, virtual false, abstract: false, final false
