...
public:
  ...
  /// @brief Method SubtypeIdentifier, addr 0xe6e12c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe6e0c8, size 0x64, virtual false, abstract: false, final false
