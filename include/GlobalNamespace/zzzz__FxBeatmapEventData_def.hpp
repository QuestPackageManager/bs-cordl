...
public:
  ...
  /// @brief Method SubtypeIdentifier, addr 0x103ded0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103de6c, size 0x64, virtual false, abstract: false, final false
