...
public:
  ...
  /// @brief Method SubtypeIdentifier, addr 0x2241030, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2240fcc, size 0x64, virtual false, abstract: false, final false
