...
/// @brief Method Awake, addr 0x58686d0, size 0xa4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ChangeNodeSelection, addr 0x58688dc, size 0x2c, virtual false, abstract: false, final false
inline void ChangeNodeSelection(bool  selected) ;

/// @brief Method HandleMissionToggleSelectionDidChange, addr 0x586891c, size 0x38, virtual false, abstract: false, final false
inline void HandleMissionToggleSelectionDidChange(::GlobalNamespace::MissionToggle*  toggle) ;

/// @brief Method Init, addr 0x5868778, size 0x5c, virtual false, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::MissionNodeVisualController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x58687dc, size 0xd8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnEnable, addr 0x58686b0, size 0x20, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method Reset, addr 0x58687d4, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method SetInteractable, addr 0x58674d8, size 0xc, virtual false, abstract: false, final false
inline void SetInteractable() ;

/// @brief Method SetMissionCleared, addr 0x5866f24, size 0xc, virtual false, abstract: false, final false
inline void SetMissionCleared() ;

/// @brief Method SetSelected, addr 0x5867a14, size 0x28, virtual false, abstract: false, final false
inline void SetSelected(bool  value) ;

/// @brief Method Setup, addr 0x5868908, size 0x14, virtual false, abstract: false, final false
inline void Setup(bool  cleared, bool  interactable) ;

/// @brief Method SetupToggle, addr 0x58688b4, size 0x28, virtual false, abstract: false, final false
inline void SetupToggle() ;

/// @brief Method Start, addr 0x5868774, size 0x4, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x5868954, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_nodeWasDisplayedEvent, addr 0x5867c34, size 0xc0, virtual false, abstract: false, final false
inline void add_nodeWasDisplayedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  value) ;

/// @brief Method add_nodeWasSelectEvent, addr 0x5867b74, size 0xc0, virtual false, abstract: false, final false
inline void add_nodeWasSelectEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  value) ;

/// @brief Method get_cleared, addr 0x58686a0, size 0x8, virtual false, abstract: false, final false
inline bool get_cleared() ;

/// @brief Method get_interactable, addr 0x58686a8, size 0x8, virtual false, abstract: false, final false
inline bool get_interactable() ;

/// @brief Method get_isInitialized, addr 0x5868698, size 0x8, virtual false, abstract: false, final false
inline bool get_isInitialized() ;

/// @brief Method get_missionNode, addr 0x5868688, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> get_missionNode() ;

/// @brief Method get_selected, addr 0x5868690, size 0x8, virtual false, abstract: false, final false
inline bool get_selected() ;

/// @brief Method remove_nodeWasDisplayedEvent, addr 0x5867f2c, size 0xc0, virtual false, abstract: false, final false
inline void remove_nodeWasDisplayedEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionNodeVisualController>>*  value) ;

/// @brief Method remove_nodeWasSelectEvent, addr 0x5867e6c, size 0xc0, virtual false, abstract: false, final false
