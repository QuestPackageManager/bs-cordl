...
public:
  ...
  /// @brief Method .ctor, addr 0x26ebfcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_levelsCount, addr 0x26ebfc4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_levelsCount();

  /// @brief Method get_pricePerBundle, addr 0x26ebfbc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetPricePerBundlePair, addr 0x26ebefc, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ebf58, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pricePairBundlePairs, addr 0x26ebef4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_pricePerLevel, addr 0x26ebeec, size 0x8, virtual false, abstract: false, final false
