...
/// @brief Field _currentlyDisplayedUser, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentlyDisplayedUser, put=__cordl_internal_set__currentlyDisplayedUser)) ::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*  _currentlyDisplayedUser;

/// @brief Field _currentlyLeadingUser, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__currentlyLeadingUser, put=__cordl_internal_set__currentlyLeadingUser)) ::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*  _currentlyLeadingUser;
...
/// @brief Method HandleFirstPlayerDidChange, addr 0x58305fc, size 0x110, virtual false, abstract: false, final false
inline void HandleFirstPlayerDidChange(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*  firstPlayer) ;

/// @brief Method HandleStateChanged, addr 0x5830258, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5830268, size 0x19c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x58301a4, size 0xb4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartProviding, addr 0x5830558, size 0xa4, virtual false, abstract: false, final false
inline void StartProviding() ;

/// @brief Method StopProviding, addr 0x58304b8, size 0xa0, virtual false, abstract: false, final false
inline void StopProviding() ;

/// @brief Method Update, addr 0x5830404, size 0xb4, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x583070c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_newLeaderWasSelectedEvent, addr 0x582d2c8, size 0xc0, virtual false, abstract: false, final false
inline void add_newLeaderWasSelectedEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_newLeaderWasSelectedEvent, addr 0x582d0b8, size 0xc0, virtual false, abstract: false, final false
