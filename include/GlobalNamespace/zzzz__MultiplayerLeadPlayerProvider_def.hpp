...
public:
  ...
  /// @brief Method HandleFirstPlayerDidChange, addr 0x3bd7a58, size 0xe8, virtual false, abstract: false, final false
  inline void HandleFirstPlayerDidChange(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer* firstPlayer);

  /// @brief Method HandleStateChanged, addr 0x3bd75b8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bd75c8, size 0x158, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3bd7500, size 0xb8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartProviding, addr 0x3bd79b8, size 0xa0, virtual false, abstract: false, final false
  inline void StartProviding();

  /// @brief Method StopProviding, addr 0x3bd791c, size 0x9c, virtual false, abstract: false, final false
  inline void StopProviding();

  /// @brief Method Update, addr 0x3bd77d0, size 0x94, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3bd7c40, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_newLeaderWasSelectedEvent, addr 0x3bd44e8, size 0xb0, virtual false, abstract: false, final false
  inline void add_newLeaderWasSelectedEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_newLeaderWasSelectedEvent, addr 0x3bd42dc, size 0xb0, virtual false, abstract: false, final false
