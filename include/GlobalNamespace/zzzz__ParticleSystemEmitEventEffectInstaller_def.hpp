...
public:
  ...
  /// @brief Method InstallBindings, addr 0x24a6974, size 0xa8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24a6a1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
