...
public:
  ...
  /// @brief Method InstallBindings, addr 0x5999594, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5999638, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
