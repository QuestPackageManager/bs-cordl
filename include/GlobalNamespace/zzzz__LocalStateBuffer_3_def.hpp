...
// StateBuffer`3<TStateTable, TType, TState>, SyncStateId, System.IConvertible
namespace GlobalNamespace {
// cpp template
template <typename TStateTable, typename TType, typename TState>
  requires(::cordl_internals::type_constraint<TStateTable, ::GlobalNamespace::IStateTable_3<TStateTable, TType, TState>*> &&
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalStateBuffer_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalStateBuffer_3(LocalStateBuffer_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalStateBuffer_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocalStateBuffer_3(LocalStateBuffer_3const&) = delete;
