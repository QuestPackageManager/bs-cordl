...
public:
  ...
  __declspec(property(get = __cordl_internal_get__sentDeltas,
                      put = __cordl_internal_set__sentDeltas)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>,
  ...
  __declspec(property(get = __cordl_internal_get__sentStates,
                      put = __cordl_internal_set__sentStates)) ::ArrayW<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>,
                                                                        ::Array<::GlobalNamespace::StateBuffer_3_TimestampedStateTable<TStateTable, TType, TState>>*>
      _sentStates;
