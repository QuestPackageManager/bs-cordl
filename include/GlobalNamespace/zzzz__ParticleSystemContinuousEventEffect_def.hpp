...
/// @brief Method HandleBeatmapEvent, addr 0x57ec4f8, size 0x1c, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

static inline ::GlobalNamespace::ParticleSystemContinuousEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57ec4dc, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57ec3b4, size 0x128, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ToggleEmitting, addr 0x57ec514, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ec5b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
