...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LocalServerConnectionRequestHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LocalServerConnectionRequestHandler(LocalServerConnectionRequestHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LocalServerConnectionRequestHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LocalServerConnectionRequestHandler(LocalServerConnectionRequestHandlerconst&) = delete;
