...
public:
  ...
  /// @brief Method CompareTo, addr 0x26df5dc, size 0x1dc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26df5b0, size 0x2c, virtual false, abstract: false, final false
