...
public:
  ...
  /// @brief Method CompareTo, addr 0x367c844, size 0x1dc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x367c83c, size 0x8, virtual false, abstract: false, final false
