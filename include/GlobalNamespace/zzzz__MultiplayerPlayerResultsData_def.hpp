...
public:
  ...
  /// @brief Method CompareTo, addr 0x37392d0, size 0x1dc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x37392c8, size 0x8, virtual false, abstract: false, final false
