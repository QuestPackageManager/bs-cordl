...
/// @brief Method ReturnToMenu, addr 0x5809dec, size 0x30, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5809e1c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
