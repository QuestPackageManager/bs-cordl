...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x2456890, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x24568b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
