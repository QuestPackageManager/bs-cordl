...
public:
  ...
  /// @brief Method .ctor, addr 0x24b745c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Append000Number, addr 0x24b738c, size 0x60, virtual false, abstract: false, final false
  static inline void Append000Number(::System::Text::StringBuilder* stringBuilder, int32_t number);

  /// @brief Method HandleScoreDidChangeRealtime, addr 0x24b7388, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x24b727c, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x24b7278, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterForEvents, addr 0x24b6f5c, size 0x198, virtual false, abstract: false, final false
  inline void RegisterForEvents();

  /// @brief Method Start, addr 0x24b6ee4, size 0x78, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterFromEvents, addr 0x24b7280, size 0x108, virtual false, abstract: false, final false
  inline void UnregisterFromEvents();

  /// @brief Method UpdateScore, addr 0x24b70f4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24b73ec, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
