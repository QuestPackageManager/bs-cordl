...
/// @brief Method .ctor, addr 0x57ffb64, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Append000Number, addr 0x57ffab8, size 0x4c, virtual false, abstract: false, final false
static inline void Append000Number(::System::Text::StringBuilder*  stringBuilder, int32_t  number) ;

/// @brief Method HandleScoreDidChangeRealtime, addr 0x57ff93c, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x57ff7fc, size 0x4, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x57ff7f8, size 0x4, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method RegisterForEvents, addr 0x57ff600, size 0x1d8, virtual false, abstract: false, final false
inline void RegisterForEvents() ;

/// @brief Method Start, addr 0x57ff58c, size 0x74, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UnregisterFromEvents, addr 0x57ff800, size 0x13c, virtual false, abstract: false, final false
inline void UnregisterFromEvents() ;

/// @brief Method UpdateScore, addr 0x57ff940, size 0x178, virtual false, abstract: false, final false
inline void UpdateScore(int32_t  displayScore) ;

/// @brief Method UpdateScore, addr 0x57ff7d8, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ffb04, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;
