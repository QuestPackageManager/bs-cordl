...
public:
  ...
  /// @brief Method .ctor, addr 0x57ff234, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Append000Number, addr 0x57ff188, size 0x4c, virtual false, abstract: false, final false
  static inline void Append000Number(::System::Text::StringBuilder* stringBuilder, int32_t number);

  /// @brief Method HandleScoreDidChangeRealtime, addr 0x57ff00c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x57feecc, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57feec8, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterForEvents, addr 0x57fecd0, size 0x1d8, virtual false, abstract: false, final false
  inline void RegisterForEvents();

  /// @brief Method Start, addr 0x57fec5c, size 0x74, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterFromEvents, addr 0x57feed0, size 0x13c, virtual false, abstract: false, final false
  inline void UnregisterFromEvents();

  /// @brief Method UpdateScore, addr 0x57ff010, size 0x178, virtual false, abstract: false, final false
  inline void UpdateScore(int32_t displayScore);

  /// @brief Method UpdateScore, addr 0x57feea8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ff1d4, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
