...
public:
  ...
  /// @brief Method .ctor, addr 0x26e2680, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Append000Number, addr 0x26e25b0, size 0x60, virtual false, abstract: false, final false
  static inline void Append000Number(::System::Text::StringBuilder* stringBuilder, int32_t number);

  /// @brief Method HandleScoreDidChangeRealtime, addr 0x26e25ac, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x26e24a0, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x26e249c, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RegisterForEvents, addr 0x26e2180, size 0x198, virtual false, abstract: false, final false
  inline void RegisterForEvents();

  /// @brief Method Start, addr 0x26e2108, size 0x78, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterFromEvents, addr 0x26e24a4, size 0x108, virtual false, abstract: false, final false
  inline void UnregisterFromEvents();

  /// @brief Method UpdateScore, addr 0x26e2318, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e2610, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
