...
public:
  ...
  /// @brief Method OnDespawned, addr 0x3b902a0, size 0x60, virtual true, abstract: false, final false
  inline void OnDespawned(::GlobalNamespace::FlyingScoreEffect* item);

  /// @brief Method .ctor, addr 0x3b90300, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method HandleCutScoreBufferDidChange, addr 0x3b900f8, size 0x4c, virtual true, abstract: false, final true
  inline void HandleCutScoreBufferDidChange(::GlobalNamespace::CutScoreBuffer* cutScoreBuffer);

  /// @brief Method HandleCutScoreBufferDidFinish, addr 0x3b90144, size 0x4, virtual true, abstract: false, final true
  inline void HandleCutScoreBufferDidFinish(::GlobalNamespace::CutScoreBuffer* cutScoreBuffer);

  /// @brief Method InitAndPresent, addr 0x3b8fb04, size 0x4e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ManualUpdate, addr 0x3b90070, size 0x88, virtual true, abstract: false, final false
  inline void ManualUpdate(float_t t);

  static inline ::GlobalNamespace::FlyingScoreEffect* New_ctor();

  /// @brief Method RefreshScore, addr 0x3b8ffe8, size 0x88, virtual false, abstract: false, final false
  inline void RefreshScore(int32_t score, int32_t maxPossibleCutScore);

  /// @brief Method UnregisterCallbacksIfNeeded, addr 0x3b90148, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b90270, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
