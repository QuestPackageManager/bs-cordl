...
public:
  ...
  /// @brief Method HandleCutScoreBufferDidChange, addr 0x2427dfc, size 0x4c, virtual true, abstract: false, final true
  inline void HandleCutScoreBufferDidChange(::GlobalNamespace::CutScoreBuffer* cutScoreBuffer);

  /// @brief Method HandleCutScoreBufferDidFinish, addr 0x2427e48, size 0x4, virtual true, abstract: false, final true
  inline void HandleCutScoreBufferDidFinish(::GlobalNamespace::CutScoreBuffer* cutScoreBuffer);

  /// @brief Method InitAndPresent, addr 0x2427808, size 0x4e4, virtual false, abstract: false, final false
  ...
  /// @brief Method ManualUpdate, addr 0x2427d74, size 0x88, virtual true, abstract: false, final false
  inline void ManualUpdate(float_t t);

  static inline ::GlobalNamespace::FlyingScoreEffect* New_ctor();

  /// @brief Method RefreshScore, addr 0x2427cec, size 0x88, virtual false, abstract: false, final false
  inline void RefreshScore(int32_t score, int32_t maxPossibleCutScore);

  /// @brief Method UnregisterCallbacksIfNeeded, addr 0x2427e4c, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2427f74, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnDespawned, addr 0x2427fa4, size 0x60, virtual true, abstract: false, final false
  inline void OnDespawned(::GlobalNamespace::FlyingScoreEffect* item);

  /// @brief Method .ctor, addr 0x2428004, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
