...
/// @brief Field _items, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__items, put=__cordl_internal_set__items)) ::ArrayW<::UnityW<::GlobalNamespace::MultiplayerLeaderboardPanelItem>,::Array<::UnityW<::GlobalNamespace::MultiplayerLeaderboardPanelItem>>*>  _items;
...
/// @brief Method Start, addr 0x5871840, size 0x54, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x58718c0, size 0x238, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5871dc0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
