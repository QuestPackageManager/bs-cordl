...
public:
  ...
  /// @brief Method Start, addr 0x586ff94, size 0x54, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5870014, size 0x238, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5870514, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
