...
public:
  ...
  /// @brief Method Start, addr 0x26e0d40, size 0x60, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x26e0dcc, size 0x248, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x26e12e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
