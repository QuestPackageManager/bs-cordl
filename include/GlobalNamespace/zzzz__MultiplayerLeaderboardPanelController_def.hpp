...
public:
  ...
  __declspec(property(get = __cordl_internal_get__items, put = __cordl_internal_set__items)) ::ArrayW<::UnityW<::GlobalNamespace::MultiplayerLeaderboardPanelItem>> _items;
  ...
  /// @brief Method Start, addr 0x59a65d0, size 0x54, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x59a6650, size 0x238, virtual false, abstract: false, final false
  inline void Update();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MultiplayerLeaderboardPanelItem>> const& __cordl_internal_get__items() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MultiplayerLeaderboardPanelItem>>& __cordl_internal_get__items();
  ...
  constexpr void __cordl_internal_set__items(::ArrayW<::UnityW<::GlobalNamespace::MultiplayerLeaderboardPanelItem>> value);

  constexpr void __cordl_internal_set__scoreProvider(::UnityW<::GlobalNamespace::MultiplayerScoreProvider> value);

  /// @brief Method .ctor, addr 0x59a6b50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLeaderboardPanelController) == 0x30, "Size mismatch!");
