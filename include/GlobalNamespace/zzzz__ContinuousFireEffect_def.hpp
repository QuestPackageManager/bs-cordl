...
public:
  ...
  /// @brief Method EndEffect, addr 0x106bd48, size 0x24, virtual false, abstract: false, final false
  inline void EndEffect();

  /// @brief Method HandleColorChangeBeatmapEvent, addr 0x106bc0c, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method SetInitialValues, addr 0x106b9b8, size 0xa8, virtual false, abstract: false, final false
  inline void SetInitialValues();

  /// @brief Method Start, addr 0x106b990, size 0x28, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method StartEffect, addr 0x106bd6c, size 0xe0, virtual false, abstract: false, final false
  inline void StartEffect(float_t startTime, float_t endTime);

  /// @brief Method Update, addr 0x106ba60, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateEffect, addr 0x106ba64, size 0x1a8, virtual false, abstract: false, final false
  inline void UpdateEffect();

  /// @brief Method UpdateRenderers, addr 0x106be4c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x106bfa8, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();
