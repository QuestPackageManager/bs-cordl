...
MARK_REF_T(::GlobalNamespace::GameServerLobbyFlowCoordinatorBase*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServerLobbyFlowCoordinatorBase_LobbyType, "", "GameServerLobbyFlowCoordinatorBase/LobbyType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServerLobbyFlowCoordinatorBase*, "", "GameServerLobbyFlowCoordinatorBase");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::GameServerLobbyFlowCoordinatorBase_LobbyType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a02c30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::GameServerLobbyFlowCoordinatorBase) == 0xb0, "Size mismatch!");
