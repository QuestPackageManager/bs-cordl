...
public:
  ...
  /// @brief Method GetMultiplayerStatusAsync, addr 0x59caa40, size 0x78, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59caab8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MockMultiplayerStatusModel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MockMultiplayerStatusModel(MockMultiplayerStatusModel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MockMultiplayerStatusModel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MockMultiplayerStatusModel(MockMultiplayerStatusModelconst&) = delete;
