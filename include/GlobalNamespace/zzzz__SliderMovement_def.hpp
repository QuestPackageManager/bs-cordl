...
public:
  ...
  /// @brief Method Init, addr 0x3b76f58, size 0x118, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::SliderData* sliderData, ::ByRef<::GlobalNamespace::SliderSpawnData> sliderSpawnData);

  /// @brief Method ManualUpdate, addr 0x3b78730, size 0x480, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::SliderMovement* New_ctor();

  /// @brief Method StartMovement, addr 0x3b77b14, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7c49c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_headDidMovePastCutMarkEvent, addr 0x3b77d28, size 0x9c, virtual false, abstract: false, final false
  inline void add_headDidMovePastCutMarkEvent(::System::Action* value);

  /// @brief Method add_movementDidFinishEvent, addr 0x3b77c8c, size 0x9c, virtual false, abstract: false, final false
  inline void add_movementDidFinishEvent(::System::Action* value);

  /// @brief Method add_movementDidMoveEvent, addr 0x3b7c334, size 0xb0, virtual false, abstract: false, final false
  inline void add_movementDidMoveEvent(::System::Action_1<float_t>* value);

  /// @brief Method add_tailDidMovePastCutMarkEvent, addr 0x3b77dc4, size 0x9c, virtual false, abstract: false, final false
  inline void add_tailDidMovePastCutMarkEvent(::System::Action* value);

  /// @brief Method get_timeSinceHeadNoteJump, addr 0x3b7c494, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeSinceHeadNoteJump();

  /// @brief Method remove_headDidMovePastCutMarkEvent, addr 0x3b7836c, size 0x9c, virtual false, abstract: false, final false
  inline void remove_headDidMovePastCutMarkEvent(::System::Action* value);

  /// @brief Method remove_movementDidFinishEvent, addr 0x3b782d0, size 0x9c, virtual false, abstract: false, final false
  inline void remove_movementDidFinishEvent(::System::Action* value);

  /// @brief Method remove_movementDidMoveEvent, addr 0x3b7c3e4, size 0xb0, virtual false, abstract: false, final false
  inline void remove_movementDidMoveEvent(::System::Action_1<float_t>* value);

  /// @brief Method remove_tailDidMovePastCutMarkEvent, addr 0x3b78408, size 0x9c, virtual false, abstract: false, final false
