...
public:
  ...
  /// @brief Method Init, addr 0x25b0238, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ManualUpdate, addr 0x25b19f8, size 0x20c, virtual false, abstract: false, final false
  inline void ManualUpdate();

  static inline ::GlobalNamespace::SliderMovement* New_ctor();

  /// @brief Method StartMovement, addr 0x25b0ec8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b52c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_headDidMovePastCutMarkEvent, addr 0x25b10ec, size 0x9c, virtual false, abstract: false, final false
  inline void add_headDidMovePastCutMarkEvent(::System::Action* value);

  /// @brief Method add_movementDidFinishEvent, addr 0x25b1050, size 0x9c, virtual false, abstract: false, final false
  inline void add_movementDidFinishEvent(::System::Action* value);

  /// @brief Method add_movementDidMoveEvent, addr 0x25b5148, size 0xb0, virtual false, abstract: false, final false
  inline void add_movementDidMoveEvent(::System::Action_1<float_t>* value);

  /// @brief Method add_tailDidMovePastCutMarkEvent, addr 0x25b1188, size 0x9c, virtual false, abstract: false, final false
  inline void add_tailDidMovePastCutMarkEvent(::System::Action* value);

  /// @brief Method get_headNoteGravity, addr 0x25b52b0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_headNoteGravity();

  /// @brief Method get_jumpDuration, addr 0x25b52a8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_jumpDuration();

  /// @brief Method get_tailNoteGravity, addr 0x25b52b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_tailNoteGravity();

  /// @brief Method get_timeSinceHeadNoteJump, addr 0x25b52c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_timeSinceHeadNoteJump();

  /// @brief Method remove_headDidMovePastCutMarkEvent, addr 0x25b1754, size 0x9c, virtual false, abstract: false, final false
  inline void remove_headDidMovePastCutMarkEvent(::System::Action* value);

  /// @brief Method remove_movementDidFinishEvent, addr 0x25b16b8, size 0x9c, virtual false, abstract: false, final false
  inline void remove_movementDidFinishEvent(::System::Action* value);

  /// @brief Method remove_movementDidMoveEvent, addr 0x25b51f8, size 0xb0, virtual false, abstract: false, final false
  inline void remove_movementDidMoveEvent(::System::Action_1<float_t>* value);

  /// @brief Method remove_tailDidMovePastCutMarkEvent, addr 0x25b17f0, size 0x9c, virtual false, abstract: false, final false
