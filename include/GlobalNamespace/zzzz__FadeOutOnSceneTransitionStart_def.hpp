...
public:
  ...
  /// @brief Method Start, addr 0x280c04c, size 0x8c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnDestroy, addr 0x280c0d8, size 0xd4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleGameScenesManagerTransitionDidStart, addr 0x280c1ac, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x280c1c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
