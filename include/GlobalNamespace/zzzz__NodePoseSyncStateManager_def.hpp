...
/// @brief Method Interpolate, addr 0x5b1f3e0, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method Smooth, addr 0x5b1f44c, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5b1f4a8, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_deltaMessageType, addr 0x5b1f3d8, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::NetworkMessageType get_deltaMessageType() ;

/// @brief Method get_deltaSerializablePool, addr 0x5b1f3c8, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable*>* get_deltaSerializablePool() ;

/// @brief Method get_deltaUpdateFrequencyMs, addr 0x5b1f3a0, size 0x8, virtual true, abstract: false, final false
inline int64_t get_deltaUpdateFrequencyMs() ;

/// @brief Method get_fullStateUpdateFrequencyMs, addr 0x5b1f3a8, size 0x8, virtual true, abstract: false, final false
inline int64_t get_fullStateUpdateFrequencyMs() ;

/// @brief Method get_localBufferSize, addr 0x5b1f3b0, size 0x8, virtual true, abstract: false, final false
inline int32_t get_localBufferSize() ;

/// @brief Method get_messageType, addr 0x5b1f3d0, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::NetworkMessageType get_messageType() ;

/// @brief Method get_remoteBufferSize, addr 0x5b1f3b8, size 0x8, virtual true, abstract: false, final false
inline int32_t get_remoteBufferSize() ;

/// @brief Method get_serializablePool, addr 0x5b1f3c0, size 0x8, virtual true, abstract: false, final false
