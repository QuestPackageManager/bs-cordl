...
public:
  ...
  /// @brief Method Interpolate, addr 0x5ab8438, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method Smooth, addr 0x5ab84a4, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ab8500, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_deltaMessageType, addr 0x5ab8430, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_deltaMessageType();

  /// @brief Method get_deltaSerializablePool, addr 0x5ab8420, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable*>* get_deltaSerializablePool();

  /// @brief Method get_deltaUpdateFrequencyMs, addr 0x5ab83f8, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_deltaUpdateFrequencyMs();

  /// @brief Method get_fullStateUpdateFrequencyMs, addr 0x5ab8400, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_fullStateUpdateFrequencyMs();

  /// @brief Method get_localBufferSize, addr 0x5ab8408, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_localBufferSize();

  /// @brief Method get_messageType, addr 0x5ab8428, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_messageType();

  /// @brief Method get_remoteBufferSize, addr 0x5ab8410, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_remoteBufferSize();

  /// @brief Method get_serializablePool, addr 0x5ab8418, size 0x8, virtual true, abstract: false, final false
