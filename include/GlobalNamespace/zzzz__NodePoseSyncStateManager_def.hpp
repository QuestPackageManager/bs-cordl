...
public:
  ...
  /// @brief Method Interpolate, addr 0x28ba284, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method Smooth, addr 0x28ba2f0, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28ba34c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_deltaMessageType, addr 0x28ba27c, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__MultiplayerSessionManager__MessageType get_deltaMessageType();

  /// @brief Method get_deltaSerializablePool, addr 0x28ba26c, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable*>* get_deltaSerializablePool();

  /// @brief Method get_deltaUpdateFrequencyMs, addr 0x28ba244, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_deltaUpdateFrequencyMs();

  /// @brief Method get_fullStateUpdateFrequencyMs, addr 0x28ba24c, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_fullStateUpdateFrequencyMs();

  /// @brief Method get_localBufferSize, addr 0x28ba254, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_localBufferSize();

  /// @brief Method get_messageType, addr 0x28ba274, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__MultiplayerSessionManager__MessageType get_messageType();

  /// @brief Method get_remoteBufferSize, addr 0x28ba25c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_remoteBufferSize();

  /// @brief Method get_serializablePool, addr 0x28ba264, size 0x8, virtual true, abstract: false, final false
