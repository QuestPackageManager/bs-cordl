...
// Write type traits
MARK_REF_T(::GlobalNamespace::NodePoseSyncStateManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NodePoseSyncStateManager*, "", "NodePoseSyncStateManager");
...
public:
  ...
  /// @brief Method Interpolate, addr 0x5cce1fc, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method Smooth, addr 0x5cce268, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cce2c4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_deltaMessageType, addr 0x5cce1f4, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_deltaMessageType();

  /// @brief Method get_deltaSerializablePool, addr 0x5cce1e4, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::NodePoseSyncStateDeltaNetSerializable*>* get_deltaSerializablePool();

  /// @brief Method get_deltaUpdateFrequencyMs, addr 0x5cce1bc, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_deltaUpdateFrequencyMs();

  /// @brief Method get_fullStateUpdateFrequencyMs, addr 0x5cce1c4, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_fullStateUpdateFrequencyMs();

  /// @brief Method get_localBufferSize, addr 0x5cce1cc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_localBufferSize();

  /// @brief Method get_messageType, addr 0x5cce1ec, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_messageType();

  /// @brief Method get_remoteBufferSize, addr 0x5cce1d4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_remoteBufferSize();

  /// @brief Method get_serializablePool, addr 0x5cce1dc, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NodePoseSyncStateManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NodePoseSyncStateManager(NodePoseSyncStateManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NodePoseSyncStateManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NodePoseSyncStateManager(NodePoseSyncStateManagerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::NodePoseSyncStateManager) == 0x40, "Size mismatch!");
