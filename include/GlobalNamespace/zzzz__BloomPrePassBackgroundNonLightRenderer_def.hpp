...
/// @brief Method Awake, addr 0x56af648, size 0x2c, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method InitIfNeeded, addr 0x56af6d0, size 0xcc, virtual true, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer* New_ctor() ;

/// @brief Method OnEnable, addr 0x56af680, size 0x10, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnValidate, addr 0x56af694, size 0x34, virtual true, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetRenderer, addr 0x56af6c8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56af8d8, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_cachedTransform, addr 0x56af640, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Transform> get_cachedTransform() ;

/// @brief Method get_meshFilter, addr 0x56af638, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::MeshFilter> get_meshFilter() ;

/// @brief Method get_renderer, addr 0x56af630, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::UnityEngine::Renderer> get_renderer() ;

/// @brief Method set_isPartOfInstancedRendering, addr 0x56aea54, size 0x34, virtual false, abstract: false, final false
