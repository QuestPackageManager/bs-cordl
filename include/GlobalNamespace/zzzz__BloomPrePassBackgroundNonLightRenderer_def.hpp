...
public:
  ...
  /// @brief Method Awake, addr 0x23e892c, size 0x2c, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x23e89ac, size 0xc8, virtual true, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer* New_ctor();

  /// @brief Method OnEnable, addr 0x23e8964, size 0x10, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x23e8978, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23e8b88, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cachedTransform, addr 0x23e8924, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_cachedTransform();

  /// @brief Method get_meshFilter, addr 0x23e891c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::MeshFilter> get_meshFilter();

  /// @brief Method get_renderer, addr 0x23e8914, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Renderer> get_renderer();

  /// @brief Method set_isPartOfInstancedRendering, addr 0x23e7da4, size 0x30, virtual false, abstract: false, final false
