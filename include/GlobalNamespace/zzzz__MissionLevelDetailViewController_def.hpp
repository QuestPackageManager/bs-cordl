...
public:
  ...
  /// @brief Method <RefreshContent>b__0, addr 0x3c21c58, size 0x1d8, virtual false, abstract: false, final false
  inline void _RefreshContent_b__0(int32_t idx, ::GlobalNamespace::ObjectiveListItem* objectiveListItem);

  /// @brief Method <RefreshContent>b__1, addr 0x3c21e30, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c21c20, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x3c21b78, size 0xa8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::MissionLevelDetailViewController* New_ctor();

  /// @brief Method PlayButtonPressed, addr 0x3c21c28, size 0x28, virtual false, abstract: false, final false
  inline void PlayButtonPressed();

  /// @brief Method RefreshContent, addr 0x3c2195c, size 0x21c, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method Setup, addr 0x3c21930, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c21c50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressPlayButtonEvent, addr 0x3c217c8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didPressPlayButtonEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionLevelDetailViewController>>* value);

  /// @brief Method get_missionNode, addr 0x3c21928, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> get_missionNode();

  /// @brief Method remove_didPressPlayButtonEvent, addr 0x3c21878, size 0xb0, virtual false, abstract: false, final false
