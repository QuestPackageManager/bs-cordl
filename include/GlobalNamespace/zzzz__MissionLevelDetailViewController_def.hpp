...
public:
  ...
  /// @brief Method <RefreshContent>b__0, addr 0x579fed0, size 0x224, virtual false, abstract: false, final false
  inline void _RefreshContent_b__0(int32_t idx, ::GlobalNamespace::ObjectiveListItem* objectiveListItem);

  /// @brief Method <RefreshContent>b__1, addr 0x57a00f4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x579fde4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x579fd34, size 0xb0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  static inline ::GlobalNamespace::MissionLevelDetailViewController* New_ctor();

  /// @brief Method PlayButtonPressed, addr 0x579fea4, size 0x28, virtual false, abstract: false, final false
  inline void PlayButtonPressed();

  /// @brief Method RefreshContent, addr 0x579faa8, size 0x28c, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method Setup, addr 0x579fa7c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x579fecc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressPlayButtonEvent, addr 0x579f8f4, size 0xc0, virtual false, abstract: false, final false
  inline void add_didPressPlayButtonEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionLevelDetailViewController>>* value);

  /// @brief Method get_missionNode, addr 0x579fa74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> get_missionNode();

  /// @brief Method remove_didPressPlayButtonEvent, addr 0x579f9b4, size 0xc0, virtual false, abstract: false, final false
