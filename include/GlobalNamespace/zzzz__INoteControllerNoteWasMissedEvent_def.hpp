...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "INoteControllerNoteWasMissedEvent", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INoteControllerNoteWasMissedEvent(INoteControllerNoteWasMissedEventconst&) = delete;
