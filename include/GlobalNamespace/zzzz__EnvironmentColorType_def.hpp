...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentColorType, "", "EnvironmentColorType");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::EnvironmentColorType) == 0x4, "Size mismatch!");
