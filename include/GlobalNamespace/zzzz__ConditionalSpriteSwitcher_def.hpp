...
public:
  ...
  /// @brief Method Apply, addr 0x23d8818, size 0xa4, virtual false, abstract: false, final false
  inline void Apply();

  /// @brief Method Awake, addr 0x23d8814, size 0x4, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x23d88bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_falseSprite, addr 0x23d87f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_falseSprite();

  /// @brief Method get_trueSprite, addr 0x23d8804, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_trueSprite();

  /// @brief Method set_falseSprite, addr 0x23d87fc, size 0x8, virtual false, abstract: false, final false
  inline void set_falseSprite(::UnityEngine::Sprite* value);

  /// @brief Method set_trueSprite, addr 0x23d880c, size 0x8, virtual false, abstract: false, final false
