...
public:
  ...
  /// @brief Method GetTiltAngle, addr 0x225fc90, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225fbb0, size 0xe0, virtual false, abstract: false, final false
