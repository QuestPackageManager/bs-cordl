...
public:
  ...
  /// @brief Method .ctor, addr 0xe28d5c, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTiltAngle, addr 0xe28e3c, size 0x2cc, virtual false, abstract: false, final false
