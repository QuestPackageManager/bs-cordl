...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapObjectAvoidanceTiltEvaluator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapObjectAvoidanceTiltEvaluator*, "", "BeatmapObjectAvoidanceTiltEvaluator");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapObjectAvoidanceTiltEvaluator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapObjectAvoidanceTiltEvaluator(BeatmapObjectAvoidanceTiltEvaluator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapObjectAvoidanceTiltEvaluator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapObjectAvoidanceTiltEvaluator(BeatmapObjectAvoidanceTiltEvaluatorconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectAvoidanceTiltEvaluator) == 0x38, "Size mismatch!");
