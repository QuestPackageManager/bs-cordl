...
public:
  ...
  /// @brief Method BuildCube, addr 0x5e9b510, size 0x83c, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildHemicylinder, addr 0x5e9c390, size 0x5cc, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildQuad, addr 0x5e9bd4c, size 0x644, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildSphere, addr 0x5e9ae40, size 0x6d0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMesh, addr 0x5e9ad40, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCubeUV, addr 0x5e9ca24, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCubeVert, addr 0x5e9cb08, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSphereUV, addr 0x5e9c998, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetSphereUV(float_t theta, float_t phi, float_t expandScale);

  /// @brief Method GetSphereVert, addr 0x5e9c9d0, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetSphereVert(float_t theta, float_t phi);

  /// @brief Method Initialize, addr 0x5e9a0e4, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5e9a24c, size 0x1a4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x5e9a0e0, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetOverlay, addr 0x5e9ab34, size 0x8, virtual false, abstract: false, final false
  inline void SetOverlay(::GlobalNamespace::OVROverlay* overlay);

  /// @brief Method TryUpdateMesh, addr 0x5e9a3f0, size 0x744, virtual false, abstract: false, final false
  inline void TryUpdateMesh();

  /// @brief Method UpdateMesh, addr 0x5e9ab3c, size 0x204, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e9cc08, size 0x158, virtual false, abstract: false, final false
  inline void _ctor();
