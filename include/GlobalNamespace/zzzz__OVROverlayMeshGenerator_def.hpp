...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(7718)), TypeDefinitionIndex(TypeDefinitionIndex(8909)), TypeDefinitionIndex(TypeDefinitionIndex(8969)),
// TypeDefinitionIndex(TypeDefinitionIndex(8993)), TypeDefinitionIndex(TypeDefinitionIndex(8996))] Self: TypeDefinitionIndex(TypeDefinitionIndex(7724)) CS Name: ::OVROverlayMeshGenerator*
...
public:
  ...
  /// @brief Method Awake, addr 0x277060c, size 0x174, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method SetOverlay, addr 0x2770780, size 0x8, virtual false, abstract: false, final false
  inline void SetOverlay(::GlobalNamespace::OVROverlay* overlay);

  /// @brief Method GetBoundingRect, addr 0x2770788, size 0x144, virtual false, abstract: false, final false
  inline ::UnityEngine::Rect GetBoundingRect(::UnityEngine::Rect a, ::UnityEngine::Rect b);

  /// @brief Method OnEnable, addr 0x27708cc, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnDisable, addr 0x27708d0, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Update, addr 0x27708d4, size 0x624, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateMesh, addr 0x2770ef8, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateMesh, addr 0x27711d8, size 0x338, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSphereUV, addr 0x2772f78, size 0x38, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 GetSphereUV(float_t theta, float_t phi, float_t expand_coef);

  /// @brief Method GetSphereVert, addr 0x2772fb0, size 0x54, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetSphereVert(float_t theta, float_t phi);

  /// @brief Method BuildSphere, addr 0x2771510, size 0x784, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCubeUV, addr 0x2773004, size 0x140, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCubeVert, addr 0x2773144, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildCube, addr 0x2771c94, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildQuad, addr 0x27721f8, size 0x720, virtual false, abstract: false, final false
  ...
  /// @brief Method BuildHemicylinder, addr 0x2772918, size 0x660, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2773250, size 0x104, virtual false, abstract: false, final false
  inline void _ctor();
