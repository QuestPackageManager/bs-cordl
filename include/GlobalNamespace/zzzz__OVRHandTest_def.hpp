...
// Write type traits
MARK_REF_T(::GlobalNamespace::BoolMonitor_OVRHandTest_BoolGenerator*);
MARK_REF_T(::GlobalNamespace::OVRHandTest*);
MARK_REF_T(::GlobalNamespace::OVRHandTest_BoolMonitor*);
MARK_REF_T(::GlobalNamespace::OVRHandTest___c*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BoolMonitor_OVRHandTest_BoolGenerator*, "", "OVRHandTest/BoolMonitor/BoolGenerator");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRHandTest*, "", "OVRHandTest");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRHandTest_BoolMonitor*, "", "OVRHandTest/BoolMonitor");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRHandTest___c*, "", "OVRHandTest/<>c");
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x5efe9d8, size 0x1c, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x5efe9f4, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x5efe9c4, size 0x14, virtual true, abstract: false, final false
  inline bool Invoke();

  static inline ::GlobalNamespace::BoolMonitor_OVRHandTest_BoolGenerator* New_ctor(::System::Object* object, ::System::IntPtr method);

  /// @brief Method .ctor, addr 0x5efd574, size 0x68, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BoolMonitor_OVRHandTest_BoolGenerator) == 0x80, "Size mismatch!");
...
public:
  ...
  /// @brief Method AppendToStringBuilder, addr 0x5efe6ec, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5efe63c, size 0xb0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5efd5dc, size 0x64, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Start>b__14_0, addr 0x5efea70, size 0x5c, virtual false, abstract: false, final false
  inline bool _Start_b__14_0();

  /// @brief Method <.cctor>b__19_0, addr 0x5efeacc, size 0x11c, virtual false, abstract: false, final false
  inline bool __cctor_b__19_0();

  /// @brief Method .ctor, addr 0x5efea6c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Start, addr 0x5efd254, size 0x320, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5efd640, size 0xffc, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5efe7e8, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::OVRHandTest) == 0x190, "Size mismatch!");
