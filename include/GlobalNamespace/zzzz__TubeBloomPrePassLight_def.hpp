...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10178)), TypeDefinitionIndex(TypeDefinitionIndex(14692))}
...
public:
  ...
  /// @brief Field _dynamic3SliceSprite, offset 0xb8, size 0x8
  ...
  /// @brief Method add_didRefreshEvent addr 0x1fb4574 size 0x9c virtual false final false
  inline void add_didRefreshEvent(::System::Action* value);

  /// @brief Method remove_didRefreshEvent addr 0x1fb4610 size 0x9c virtual false final false
  inline void remove_didRefreshEvent(::System::Action* value);

  /// @brief Method get_colorAlphaMultiplier addr 0x1fb46ac size 0x8 virtual false final false
  inline float_t get_colorAlphaMultiplier();

  /// @brief Method get_center addr 0x1fb46b4 size 0x8 virtual false final false
  inline float_t get_center();

  /// @brief Method get_isDirty addr 0x1fb46bc size 0x20 virtual true final false
  inline bool get_isDirty();

  /// @brief Method MarkDirty addr 0x1fb46dc size 0xc virtual false final false
  inline void MarkDirty();

  /// @brief Method get_length addr 0x1fb46e8 size 0x8 virtual false final false
  inline float_t get_length();

  /// @brief Method set_length addr 0x1fb46f0 size 0x10 virtual false final false
  inline void set_length(float_t value);

  /// @brief Method get_width addr 0x1fb4700 size 0x8 virtual false final false
  inline float_t get_width();

  /// @brief Method set_width addr 0x1fb4708 size 0x10 virtual false final false
  inline void set_width(float_t value);

  /// @brief Method get_lightWidthMultiplier addr 0x1fb4718 size 0x8 virtual false final false
  inline float_t get_lightWidthMultiplier();

  /// @brief Method set_lightWidthMultiplier addr 0x1fb4720 size 0x8 virtual false final false
  inline void set_lightWidthMultiplier(float_t value);

  /// @brief Method get_bloomFogIntensityMultiplier addr 0x1fb4728 size 0x8 virtual false final false
  inline float_t get_bloomFogIntensityMultiplier();

  /// @brief Method set_bloomFogIntensityMultiplier addr 0x1fb4730 size 0x8 virtual false final false
  inline void set_bloomFogIntensityMultiplier(float_t value);

  /// @brief Method set_color addr 0x1fb4738 size 0x118 virtual false final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method get_color addr 0x1fb4850 size 0xc virtual false final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method OnEnable addr 0x1fb485c size 0x20 virtual true final false
  inline void OnEnable();

  /// @brief Method DidRegisterLight addr 0x1fb487c size 0x1c virtual true final false
  inline void DidRegisterLight();

  /// @brief Method Refresh addr 0x1fb4898 size 0x33c virtual true final false
  inline void Refresh();

  /// @brief Method FillMeshData addr 0x1fb4bd4 size 0x9e8 virtual true final false
  ...
  /// @brief Method ClipPoints addr 0x1fb55bc size 0x94 virtual false final false
  ...
  /// @brief Method OnDrawGizmos addr 0x1fb5650 size 0x13c virtual false final false
  inline void OnDrawGizmos();

  static inline ::GlobalNamespace::TubeBloomPrePassLight* New_ctor();

  /// @brief Method .ctor addr 0x1fb578c size 0xd8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _bakedGlowWidthScale, offset: 0x88, size: 0x4, def value: None
  float_t ____bakedGlowWidthScale;

  /// @brief Field _forceUseBakedGlow, offset: 0x8c, size: 0x1, def value: None
  bool ____forceUseBakedGlow;

  /// @brief Field _updateAlways, offset: 0x8d, size: 0x1, def value: None
  bool ____updateAlways;

  /// @brief Field _limitAlpha, offset: 0x8e, size: 0x1, def value: None
  bool ____limitAlpha;

  /// @brief Field _minAlpha, offset: 0x90, size: 0x4, def value: None
  float_t ____minAlpha;

  /// @brief Field _maxAlpha, offset: 0x94, size: 0x4, def value: None
  float_t ____maxAlpha;

  /// @brief Field _overrideChildrenAlpha, offset: 0x98, size: 0x1, def value: None
  bool ____overrideChildrenAlpha;

  /// @brief Field _startAlpha, offset: 0x9c, size: 0x4, def value: None
  float_t ____startAlpha;

  /// @brief Field _endAlpha, offset: 0xa0, size: 0x4, def value: None
  float_t ____endAlpha;

  /// @brief Field _overrideChildrenWidth, offset: 0xa4, size: 0x1, def value: None
  bool ____overrideChildrenWidth;

  /// @brief Field _startWidth, offset: 0xa8, size: 0x4, def value: None
  float_t ____startWidth;

  /// @brief Field _endWidth, offset: 0xac, size: 0x4, def value: None
  float_t ____endWidth;

  /// @brief Field _parametricBoxController, offset: 0xb0, size: 0x8, def value: None
  ::GlobalNamespace::ParametricBoxController* ____parametricBoxController;

  /// @brief Field _dynamic3SliceSprite, offset: 0xb8, size: 0x8, def value: None
  ::GlobalNamespace::Parametric3SliceSpriteController* ____dynamic3SliceSprite;

  /// @brief Field didRefreshEvent, offset: 0xc0, size: 0x8, def value: None
  ::System::Action* ___didRefreshEvent;

  /// @brief Field _isDirty, offset: 0xc8, size: 0x1, def value: None
  bool ____isDirty;

  /// @brief Field _transform, offset: 0xd0, size: 0x8, def value: None
  ::UnityEngine::Transform* ____transform;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::TubeBloomPrePassLight, 0xd8>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____bakedGlowWidthScale) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____forceUseBakedGlow) == 0x8c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____updateAlways) == 0x8d, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____limitAlpha) == 0x8e, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____minAlpha) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____maxAlpha) == 0x94, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____overrideChildrenAlpha) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____startAlpha) == 0x9c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____endAlpha) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____overrideChildrenWidth) == 0xa4, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____startWidth) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____endWidth) == 0xac, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____parametricBoxController) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____dynamic3SliceSprite) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ___didRefreshEvent) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____isDirty) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLight, ____transform) == 0xd0, "Offset mismatch!");
