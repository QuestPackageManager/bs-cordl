...
public:
  ...
  /// @brief Method Awake, addr 0x39e1594, size 0x14, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClipPoints, addr 0x39e231c, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method DidRegisterLight, addr 0x39e15c8, size 0x1c, virtual true, abstract: false, final false
  inline void DidRegisterLight();

  /// @brief Method FillMeshData, addr 0x39e19e0, size 0x8a4, virtual true, abstract: false, final false
  ...
  /// @brief Method InitIfNeeded, addr 0x39e12fc, size 0xc4, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  /// @brief Method MarkDirty, addr 0x39e1464, size 0xc, virtual false, abstract: false, final false
  inline void MarkDirty();

  /// @brief Method NeedsRefresh, addr 0x39e15e4, size 0x68, virtual false, abstract: false, final false
  inline bool NeedsRefresh();

  static inline ::GlobalNamespace::TubeBloomPrePassLight* New_ctor();

  /// @brief Method OnDrawGizmos, addr 0x39e23b0, size 0x15c, virtual false, abstract: false, final false
  inline void OnDrawGizmos();

  /// @brief Method OnEnable, addr 0x39e15a8, size 0x20, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x39e164c, size 0x394, virtual true, abstract: false, final false
  inline void Refresh();

  /// @brief Method ZeroQuad, addr 0x39e2284, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e250c, size 0x120, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didRefreshEvent, addr 0x39e1154, size 0x9c, virtual false, abstract: false, final false
  inline void add_didRefreshEvent(::System::Action* value);

  /// @brief Method get_bloomFogIntensityMultiplier, addr 0x39e14c8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_bloomFogIntensityMultiplier();

  /// @brief Method get_calculatedCollisionLength, addr 0x39e1440, size 0x24, virtual false, abstract: false, final false
  inline float_t get_calculatedCollisionLength();

  /// @brief Method get_center, addr 0x39e129c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_center();

  /// @brief Method get_collisionEndAlpha, addr 0x39e13d8, size 0x68, virtual false, abstract: false, final false
  inline float_t get_collisionEndAlpha();

  /// @brief Method get_collisionLength, addr 0x39e13c0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_collisionLength();

  /// @brief Method get_color, addr 0x39e1588, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_colorAlphaMultiplier, addr 0x39e1294, size 0x8, virtual false, abstract: false, final false
  inline float_t get_colorAlphaMultiplier();

  /// @brief Method get_enabledRenderers, addr 0x39e128c, size 0x8, virtual false, abstract: false, final false
  inline bool get_enabledRenderers();

  /// @brief Method get_length, addr 0x39e1470, size 0x8, virtual false, abstract: false, final false
  inline float_t get_length();

  /// @brief Method get_lightWidthMultiplier, addr 0x39e14b8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_lightWidthMultiplier();

  /// @brief Method get_startAlpha, addr 0x39e14a0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startAlpha();

  /// @brief Method get_useCollision, addr 0x39e12a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_useCollision();

  /// @brief Method get_width, addr 0x39e1488, size 0x8, virtual false, abstract: false, final false
  inline float_t get_width();

  /// @brief Method remove_didRefreshEvent, addr 0x39e11f0, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didRefreshEvent(::System::Action* value);

  /// @brief Method set_bloomFogIntensityMultiplier, addr 0x39e14d0, size 0x8, virtual false, abstract: false, final false
  inline void set_bloomFogIntensityMultiplier(float_t value);

  /// @brief Method set_collisionLength, addr 0x39e13c8, size 0x10, virtual false, abstract: false, final false
  inline void set_collisionLength(float_t value);

  /// @brief Method set_color, addr 0x39e14d8, size 0xb0, virtual false, abstract: false, final false
  inline void set_color(::UnityEngine::Color value);

  /// @brief Method set_length, addr 0x39e1478, size 0x10, virtual false, abstract: false, final false
  inline void set_length(float_t value);

  /// @brief Method set_lightWidthMultiplier, addr 0x39e14c0, size 0x8, virtual false, abstract: false, final false
  inline void set_lightWidthMultiplier(float_t value);

  /// @brief Method set_startAlpha, addr 0x39e14a8, size 0x10, virtual false, abstract: false, final false
  inline void set_startAlpha(float_t value);

  /// @brief Method set_useCollision, addr 0x39e12ac, size 0x50, virtual false, abstract: false, final false
  inline void set_useCollision(bool value);

  /// @brief Method set_width, addr 0x39e1490, size 0x10, virtual false, abstract: false, final false
