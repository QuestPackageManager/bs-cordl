...
public:
  ...
  /// @brief Method Update, addr 0x39dde20, size 0x18, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x39dde38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
