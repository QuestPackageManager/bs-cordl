...
public:
  ...
  /// @brief Method Update, addr 0x5652754, size 0x14, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5652768, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
