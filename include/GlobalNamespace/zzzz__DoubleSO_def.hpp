...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13974), inst: 2643 }), TypeDefinitionIndex(TypeDefinitionIndex(13974))}
...
public:
  ...
  /// @brief Method .ctor addr 0x1fa302c size 0x48 virtual false final false
  inline void _ctor();
