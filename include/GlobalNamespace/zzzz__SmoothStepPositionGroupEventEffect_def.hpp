...
// Write type traits
MARK_REF_T(::GlobalNamespace::SmoothStepPositionGroupEventEffect*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SmoothStepPositionGroupEventEffect*, "", "SmoothStepPositionGroupEventEffect");
// Dependencies BasicBeatmapEventType, EaseType, UnityEngine.MonoBehaviour, UnityEngine.Transform, UnityEngine.Vector3
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__elements, put = __cordl_internal_set__elements)) ::ArrayW<::UnityW<::UnityEngine::Transform>> _elements;
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>> const& __cordl_internal_get__elements() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>>& __cordl_internal_get__elements();
  ...
  constexpr void __cordl_internal_set__elements(::ArrayW<::UnityW<::UnityEngine::Transform>> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SmoothStepPositionGroupEventEffect", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SmoothStepPositionGroupEventEffect(SmoothStepPositionGroupEventEffect&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SmoothStepPositionGroupEventEffect", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SmoothStepPositionGroupEventEffect(SmoothStepPositionGroupEventEffectconst&) = delete;
  ...
  ::ArrayW<::UnityW<::UnityEngine::Transform>> ____elements;
...
static_assert(sizeof(::GlobalNamespace::SmoothStepPositionGroupEventEffect) == 0x98, "Size mismatch!");
