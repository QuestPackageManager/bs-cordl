...
public:
  ...
  /// @brief Method .ctor, addr 0x3acf914, size 0x4c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3acefe4, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleAudioConfigurationChanged, addr 0x3acf220, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3acf1a0, size 0x80, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x3acf854, size 0x58, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method Resume, addr 0x3acf8ac, size 0x50, virtual false, abstract: false, final false
  inline void Resume();

  /// @brief Method SeekTo, addr 0x3acf6c0, size 0x14c, virtual false, abstract: false, final false
  inline void SeekTo(float_t startTimeOffset);

  /// @brief Method Start, addr 0x3acf02c, size 0x174, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSong, addr 0x3acf67c, size 0x44, virtual false, abstract: false, final false
  inline void StartSong(float_t startTimeOffset);

  /// @brief Method StopSong, addr 0x3acf80c, size 0x48, virtual false, abstract: false, final false
  inline void StopSong();

  /// @brief Method Update, addr 0x3acf264, size 0x418, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3acf8fc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_waitUntilAudioIsLoaded>b__32_0, addr 0x3acf910, size 0x4, virtual false, abstract: false, final false
  inline bool _get_waitUntilAudioIsLoaded_b__32_0();

  /// @brief Method add_stateChangedEvent, addr 0x3acee8c, size 0x9c, virtual false, abstract: false, final false
  inline void add_stateChangedEvent(::System::Action* value);

  /// @brief Method get_dspTimeOffset, addr 0x3acedb8, size 0x8, virtual false, abstract: false, final false
  inline double_t get_dspTimeOffset();

  /// @brief Method get_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x3acee78, size 0x8, virtual false, abstract: false, final false
  inline bool get_forceNoAudioSyncOrAudioSyncErrorFixing();

  /// @brief Method get_isAudioLoaded, addr 0x3aceca8, size 0xdc, virtual false, abstract: false, final false
  inline bool get_isAudioLoaded();

  /// @brief Method get_isReady, addr 0x3acee68, size 0x8, virtual true, abstract: false, final true
  inline bool get_isReady();

  /// @brief Method get_lastFrameDeltaSongTime, addr 0x3aceb30, size 0x8, virtual true, abstract: false, final true
  inline float_t get_lastFrameDeltaSongTime();

  /// @brief Method get_songEndTime, addr 0x3aced8c, size 0x24, virtual true, abstract: false, final true
  inline float_t get_songEndTime();

  /// @brief Method get_songFailedToLoad, addr 0x3acebd0, size 0xd8, virtual false, abstract: false, final false
  inline bool get_songFailedToLoad();

  /// @brief Method get_songLength, addr 0x3aceb38, size 0x98, virtual true, abstract: false, final true
  inline float_t get_songLength();

  /// @brief Method get_songTime, addr 0x3aceb28, size 0x8, virtual true, abstract: false, final true
  inline float_t get_songTime();

  /// @brief Method get_songTimeOffset, addr 0x3acee70, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songTimeOffset();

  /// @brief Method get_startSongTime, addr 0x3aced84, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startSongTime();

  /// @brief Method get_state, addr 0x3aceb20, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AudioTimeSyncController_State get_state();

  /// @brief Method get_timeScale, addr 0x3acedb0, size 0x8, virtual true, abstract: false, final true
  inline float_t get_timeScale();

  /// @brief Method get_timeSinceStart, addr 0x3acefc4, size 0x20, virtual false, abstract: false, final false
  inline float_t get_timeSinceStart();

  /// @brief Method get_waitUntilAudioIsLoaded, addr 0x3acedc0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_stateChangedEvent, addr 0x3acef28, size 0x9c, virtual false, abstract: false, final false
  inline void remove_stateChangedEvent(::System::Action* value);

  /// @brief Method set_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x3acee80, size 0xc, virtual false, abstract: false, final false
