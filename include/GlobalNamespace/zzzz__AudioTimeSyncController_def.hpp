...
// Write type traits
MARK_REF_T(::GlobalNamespace::AudioTimeSyncController*);
MARK_REF_T(::GlobalNamespace::AudioTimeSyncController_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AudioTimeSyncController*, "", "AudioTimeSyncController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AudioTimeSyncController_InitData*, "", "AudioTimeSyncController/InitData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58b8398, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AudioTimeSyncController_InitData) == 0x28, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies IAudioTimeSource::State, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__lastState, put = __cordl_internal_set__lastState)) ::GlobalNamespace::IAudioTimeSource_State _lastState;
  ...
  __declspec(property(get = __cordl_internal_get__state, put = __cordl_internal_set__state)) ::GlobalNamespace::IAudioTimeSource_State _state;
  ...
  /// @brief Method Awake, addr 0x58b7450, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleAudioConfigurationChanged, addr 0x58b76bc, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58b763c, size 0x80, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x58b82dc, size 0x58, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method Resume, addr 0x58b8334, size 0x50, virtual false, abstract: false, final false
  inline void Resume();

  /// @brief Method SeekTo, addr 0x58b8114, size 0x180, virtual false, abstract: false, final false
  inline void SeekTo(float_t startTimeOffset);

  /// @brief Method Start, addr 0x58b7498, size 0x1a4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSong, addr 0x58b80d0, size 0x44, virtual false, abstract: false, final false
  inline void StartSong(float_t startTimeOffset);

  /// @brief Method StopSong, addr 0x58b8294, size 0x48, virtual false, abstract: false, final false
  inline void StopSong();

  /// @brief Method Update, addr 0x58b7700, size 0x9d0, virtual false, abstract: false, final false
  inline void Update();
  ...
  constexpr ::GlobalNamespace::IAudioTimeSource_State const& __cordl_internal_get__lastState() const;

  constexpr ::GlobalNamespace::IAudioTimeSource_State& __cordl_internal_get__lastState();
  ...
  constexpr ::GlobalNamespace::IAudioTimeSource_State const& __cordl_internal_get__state() const;

  constexpr ::GlobalNamespace::IAudioTimeSource_State& __cordl_internal_get__state();
  ...
  constexpr void __cordl_internal_set__lastState(::GlobalNamespace::IAudioTimeSource_State value);
  ...
  constexpr void __cordl_internal_set__state(::GlobalNamespace::IAudioTimeSource_State value);
  ...
  /// @brief Method .ctor, addr 0x58b8384, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_waitUntilAudioIsLoaded>b__31_0, addr 0x58b8394, size 0x4, virtual false, abstract: false, final false
  inline bool _get_waitUntilAudioIsLoaded_b__31_0();

  /// @brief Method add_stateChangedEvent, addr 0x58b72b4, size 0xac, virtual false, abstract: false, final false
  inline void add_stateChangedEvent(::System::Action* value);

  /// @brief Method get_dspTimeOffset, addr 0x58b71e8, size 0x8, virtual false, abstract: false, final false
  inline double_t get_dspTimeOffset();

  /// @brief Method get_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x58b72a4, size 0x8, virtual false, abstract: false, final false
  inline bool get_forceNoAudioSyncOrAudioSyncErrorFixing();

  /// @brief Method get_isAudioLoaded, addr 0x58b70d4, size 0xe0, virtual false, abstract: false, final false
  inline bool get_isAudioLoaded();

  /// @brief Method get_isReady, addr 0x58b7294, size 0x8, virtual true, abstract: false, final true
  inline bool get_isReady();

  /// @brief Method get_lastFrameDeltaSongTime, addr 0x58b6f54, size 0x8, virtual true, abstract: false, final true
  inline float_t get_lastFrameDeltaSongTime();

  /// @brief Method get_songEndTime, addr 0x58b71bc, size 0x24, virtual true, abstract: false, final true
  inline float_t get_songEndTime();

  /// @brief Method get_songFailedToLoad, addr 0x58b6ff8, size 0xdc, virtual false, abstract: false, final false
  inline bool get_songFailedToLoad();

  /// @brief Method get_songLength, addr 0x58b6f5c, size 0x9c, virtual true, abstract: false, final true
  inline float_t get_songLength();

  /// @brief Method get_songTime, addr 0x58b6f4c, size 0x8, virtual true, abstract: false, final true
  inline float_t get_songTime();

  /// @brief Method get_songTimeOffset, addr 0x58b729c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songTimeOffset();

  /// @brief Method get_startSongTime, addr 0x58b71b4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startSongTime();

  /// @brief Method get_state, addr 0x58b6f44, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IAudioTimeSource_State get_state();

  /// @brief Method get_timeScale, addr 0x58b71e0, size 0x8, virtual true, abstract: false, final true
  inline float_t get_timeScale();

  /// @brief Method get_timeSinceStart, addr 0x58b740c, size 0x44, virtual false, abstract: false, final false
  inline float_t get_timeSinceStart();

  /// @brief Method get_waitUntilAudioIsLoaded, addr 0x58b71f0, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_stateChangedEvent, addr 0x58b7360, size 0xac, virtual false, abstract: false, final false
  inline void remove_stateChangedEvent(::System::Action* value);

  /// @brief Method set_forceNoAudioSyncOrAudioSyncErrorFixing, addr 0x58b72ac, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::GlobalNamespace::IAudioTimeSource_State ____state;
  ...
  ::GlobalNamespace::IAudioTimeSource_State ____lastState;
...
static_assert(sizeof(::GlobalNamespace::AudioTimeSyncController) == 0xb0, "Size mismatch!");
