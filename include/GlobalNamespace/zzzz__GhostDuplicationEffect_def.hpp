...
public:
  ...
  /// @brief Method <Animate>b__0, addr 0x3b837c4, size 0x18, virtual false, abstract: false, final false
  inline void _Animate_b__0(float_t val);

  /// @brief Method <Animate>b__1, addr 0x3b837dc, size 0x2c, virtual false, abstract: false, final false
  inline void _Animate_b__1(float_t val);

  /// @brief Method <Animate>b__2, addr 0x3b83808, size 0x50, virtual false, abstract: false, final false
  inline void _Animate_b__2(::UnityEngine::Vector3 pos);

  /// @brief Method <Animate>b__3, addr 0x3b83858, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b834f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b8389c, size 0xf8, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::GhostDuplicationEffect__HideRedundantWithDelay_d__8* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3b83994, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3b8399c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3b839d4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3b83898, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b83570, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Animate, addr 0x3b83148, size 0x3b0, virtual false, abstract: false, final false
  inline void Animate(::GlobalNamespace::GhostDuplicationEffect_GhostEffectParams ghostEffectParams);

  /// @brief Method Awake, addr 0x3b83030, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HideRedundantWithDelay, addr 0x3b83500, size 0x70, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* HideRedundantWithDelay(float_t delay);

  /// @brief Method Init, addr 0x3b83040, size 0x88, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::GhostDuplicationEffect* New_ctor();

  /// @brief Method OnDestroy, addr 0x3b82fa8, size 0x88, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetDistances, addr 0x3b83598, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b837bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_alpha, addr 0x3b8377c, size 0x40, virtual false, abstract: false, final false
  inline float_t get_alpha();

  /// @brief Method get_size, addr 0x3b83734, size 0x48, virtual false, abstract: false, final false
  inline float_t get_size();

  /// @brief Method set_alpha, addr 0x3b830c8, size 0x80, virtual false, abstract: false, final false
  inline void set_alpha(float_t value);

  /// @brief Method set_hide, addr 0x3b83684, size 0x2c, virtual false, abstract: false, final false
  inline void set_hide(bool value);

  /// @brief Method set_size, addr 0x3b836b0, size 0x84, virtual false, abstract: false, final false
