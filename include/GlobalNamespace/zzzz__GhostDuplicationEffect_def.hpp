...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10176)), TypeDefinitionIndex(TypeDefinitionIndex(15944))}
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10176)), TypeDefinitionIndex(TypeDefinitionIndex(4979)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2264e08 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Animate>b__0 addr 0x22650dc size 0x18 virtual false final false
  inline void _Animate_b__0(float_t val);

  /// @brief Method <Animate>b__1 addr 0x22650f4 size 0x2c virtual false final false
  inline void _Animate_b__1(float_t val);

  /// @brief Method <Animate>b__2 addr 0x2265120 size 0x50 virtual false final false
  inline void _Animate_b__2(::UnityEngine::Vector3 pos);

  /// @brief Method <Animate>b__3 addr 0x2265170 size 0x40 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2264e88 size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x22651b0 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x22651b4 size 0xfc virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x22652b0 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x22652b8 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x22652f8 size 0x8 virtual true final true
...
public:
  ...
  /// @brief Method OnDestroy addr 0x22648b0 size 0x88 virtual true final false
  inline void OnDestroy();

  /// @brief Method Awake addr 0x2264938 size 0x10 virtual false final false
  inline void Awake();

  /// @brief Method Init addr 0x2264948 size 0x88 virtual false final false
  inline void Init();

  /// @brief Method Animate addr 0x2264a54 size 0x3b4 virtual false final false
  inline void Animate(::GlobalNamespace::__GhostDuplicationEffect__GhostEffectParams ghostEffectParams);

  /// @brief Method HideRedundantWithDelay addr 0x2264e10 size 0x78 virtual false final false
  inline ::System::Collections::IEnumerator* HideRedundantWithDelay(float_t delay);

  /// @brief Method SetDistances addr 0x2264eb0 size 0xec virtual false final false
  inline void SetDistances(float_t distance, ::UnityEngine::Vector3 direction);

  /// @brief Method set_hide addr 0x2264f9c size 0x2c virtual false final false
  inline void set_hide(bool value);

  /// @brief Method set_size addr 0x2264fc8 size 0x84 virtual false final false
  inline void set_size(float_t value);

  /// @brief Method get_size addr 0x226504c size 0x48 virtual false final false
  inline float_t get_size();

  /// @brief Method set_alpha addr 0x22649d0 size 0x84 virtual false final false
  inline void set_alpha(float_t value);

  /// @brief Method get_alpha addr 0x2265094 size 0x40 virtual false final false
  inline float_t get_alpha();

  static inline ::GlobalNamespace::GhostDuplicationEffect* New_ctor();

  /// @brief Method .ctor addr 0x22650d4 size 0x8 virtual false final false
  inline void _ctor();
