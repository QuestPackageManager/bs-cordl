...
public:
  ...
  /// @brief Method GetColor, addr 0x3b9ea5c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b9ea20, size 0x3c, virtual false, abstract: false, final false
