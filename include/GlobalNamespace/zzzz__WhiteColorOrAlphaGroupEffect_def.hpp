...
public:
  ...
  /// @brief Method GetColor, addr 0x26e081c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e07e0, size 0x3c, virtual false, abstract: false, final false
