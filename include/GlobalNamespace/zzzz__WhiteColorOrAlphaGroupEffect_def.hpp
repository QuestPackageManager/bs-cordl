...
public:
  ...
  /// @brief Method GetColor, addr 0x26f5d48, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f5d0c, size 0x3c, virtual false, abstract: false, final false
