...
public:
  ...
  /// @brief Method GetColor, addr 0x25c3fec, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25c3fb0, size 0x3c, virtual false, abstract: false, final false
