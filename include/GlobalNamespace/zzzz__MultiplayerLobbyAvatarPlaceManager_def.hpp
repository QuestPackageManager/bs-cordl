...
/// @brief Method Activate, addr 0x5831f8c, size 0x8, virtual false, abstract: false, final false
inline void Activate(float_t  innerCircleRadius, float_t  minOuterCircleRadius) ;

/// @brief Method Deactivate, addr 0x583242c, size 0x4, virtual false, abstract: false, final false
inline void Deactivate() ;

/// @brief Method DespawnAllPlaces, addr 0x5832430, size 0x184, virtual false, abstract: false, final false
inline void DespawnAllPlaces() ;

static inline ::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x58325b4, size 0x4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SpawnAllPlaces, addr 0x5831f94, size 0x498, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58325b8, size 0x78, virtual false, abstract: false, final false
inline void _ctor() ;
