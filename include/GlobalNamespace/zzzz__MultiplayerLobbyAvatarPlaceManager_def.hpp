...
public:
  ...
  /// @brief Method Activate, addr 0x260b5e4, size 0x8, virtual false, abstract: false, final false
  inline void Activate(float_t innerCircleRadius, float_t minOuterCircleRadius);

  /// @brief Method Deactivate, addr 0x260ba84, size 0x4, virtual false, abstract: false, final false
  inline void Deactivate();

  /// @brief Method DespawnAllPlaces, addr 0x260ba88, size 0x14c, virtual false, abstract: false, final false
  inline void DespawnAllPlaces();

  static inline ::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x260bbd4, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SpawnAllPlaces, addr 0x260b5ec, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x260bbd8, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
