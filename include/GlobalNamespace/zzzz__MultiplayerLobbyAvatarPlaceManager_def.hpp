...
public:
  ...
  /// @brief Method Activate, addr 0x58a3ed0, size 0x8, virtual false, abstract: false, final false
  inline void Activate(float_t innerCircleRadius, float_t minOuterCircleRadius);

  /// @brief Method Deactivate, addr 0x58a4370, size 0x4, virtual false, abstract: false, final false
  inline void Deactivate();

  /// @brief Method DespawnAllPlaces, addr 0x58a4374, size 0x184, virtual false, abstract: false, final false
  inline void DespawnAllPlaces();

  static inline ::GlobalNamespace::MultiplayerLobbyAvatarPlaceManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x58a44f8, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SpawnAllPlaces, addr 0x58a3ed8, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58a44fc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();
