...
public:
  ...
  /// @brief Method .ctor, addr 0x234fd78, size 0xbc, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___dataVersion) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___presetName) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___presetNameLocalizationTag) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___renderViewportScale) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___vrResolutionScale) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___menuVRResolutionScaleMultiplier) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___antiAliasingLevel) == 0x34, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___targetFramerate) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___vSyncCount) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___maxQueuedFrames) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___mirrorGraphics) == 0x44, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___mainEffectGraphics) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___bloomGraphics) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___smokeGraphics) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___burnMarkTrails) == 0x51, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___screenDisplacementEffects) == 0x52, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___maxShockwaveParticles) == 0x54, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___maxNumberOfCutSoundEffects) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___obstaclesQuality) == 0x5c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::PerformancePreset, ___questSettings) == 0x60, "Offset mismatch!");
