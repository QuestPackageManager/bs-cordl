...
public:
  ...
  /// @brief Method ConnectWithNext, addr 0x3654c94, size 0x10, virtual false, abstract: false, final false
  inline void ConnectWithNext(::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData* nextElementData);

  /// @brief Method ConnectWithPrevious, addr 0x3654c84, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetConnections, addr 0x3654c7c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3654618, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method get_next, addr 0x3654c6c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData* get_next();

  /// @brief Method get_previous, addr 0x3654c74, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3654c00, size 0x6c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::GlobalNamespace::BeatmapEventDataBoxGroup* b);

  /// @brief Method GetCopyWithNewBeat, addr 0x3654690, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveBeatmapEventDataFromBeatmapData, addr 0x3654700, size 0x168, virtual false, abstract: false, final false
  inline void RemoveBeatmapEventDataFromBeatmapData(::GlobalNamespace::BeatmapData* beatmapData);

  /// @brief Method SyncWithBeatmapData, addr 0x3654868, size 0x398, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3653ed4, size 0x6f0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapEventDataBoxList, addr 0x3653ecc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBox*>* get_beatmapEventDataBoxList();

  /// @brief Method get_elementDataDict, addr 0x3653ec4, size 0x8, virtual false, abstract: false, final false
