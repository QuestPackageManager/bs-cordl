...
public:
  ...
  /// @brief Method ConnectWithNext, addr 0x12bd0d4, size 0x10, virtual false, abstract: false, final false
  inline void ConnectWithNext(::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData* nextElementData);

  /// @brief Method ConnectWithPrevious, addr 0x12bd0c4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method ResetConnections, addr 0x12bd0bc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bcab0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_next, addr 0x12bd0ac, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData* get_next();

  /// @brief Method get_previous, addr 0x12bd0b4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x12bd080, size 0x2c, virtual true, abstract: false, final true
  inline int32_t CompareTo(::GlobalNamespace::BeatmapEventDataBoxGroup* b);

  /// @brief Method GetCopyWithNewBeat, addr 0x12bcb3c, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveBeatmapEventDataFromBeatmapData, addr 0x12bcbb0, size 0x190, virtual false, abstract: false, final false
  inline void RemoveBeatmapEventDataFromBeatmapData(::GlobalNamespace::BeatmapData* beatmapData);

  /// @brief Method SyncWithBeatmapData, addr 0x12bcd40, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12bc2bc, size 0x78c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_elementDataDict, addr 0x12bc2b4, size 0x8, virtual false, abstract: false, final false
