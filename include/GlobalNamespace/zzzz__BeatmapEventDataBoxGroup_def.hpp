...
/// @brief Method ConnectWithNext, addr 0x3618594, size 0x10, virtual false, abstract: false, final false
inline void ConnectWithNext(::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*  nextElementData) ;

/// @brief Method ConnectWithPrevious, addr 0x3618584, size 0x10, virtual false, abstract: false, final false
inline void ConnectWithPrevious(::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*  prevElementData) ;

static inline ::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData* New_ctor(::GlobalNamespace::BeatmapEventDataBoxGroup*  boxGroup, ::GlobalNamespace::BeatmapEventDataBox*  eventBox, int32_t  elementId, int32_t  durationOrderIndex, int32_t  distributionOrderIndex, float_t  startBeat) ;

/// @brief Method ResetConnections, addr 0x361857c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3617f18, size 0x78, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BeatmapEventDataBoxGroup*  boxGroup, ::GlobalNamespace::BeatmapEventDataBox*  eventBox, int32_t  elementId, int32_t  durationOrderIndex, int32_t  distributionOrderIndex, float_t  startBeat) ;

/// @brief Method get_next, addr 0x361856c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData* get_next() ;

/// @brief Method get_previous, addr 0x3618574, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _beatmapEventDataBoxList, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__beatmapEventDataBoxList, put=__cordl_internal_set__beatmapEventDataBoxList)) ::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBox*>*  _beatmapEventDataBoxList;

/// @brief Field _elementDataDict, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__elementDataDict, put=__cordl_internal_set__elementDataDict)) ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*>*  _elementDataDict;

/// @brief Field _unpackedBeatmapEventData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__unpackedBeatmapEventData, put=__cordl_internal_set__unpackedBeatmapEventData)) ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapEventData*>*  _unpackedBeatmapEventData;
 ...
 __declspec(property(get=get_elementDataDict)) ::System::Collections::Generic::IReadOnlyDictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*>*  elementDataDict;
...
/// @brief Method CompareTo, addr 0x3618500, size 0x6c, virtual true, abstract: false, final true
inline int32_t CompareTo(::GlobalNamespace::BeatmapEventDataBoxGroup*  b) ;

/// @brief Method GetCopyWithNewBeat, addr 0x3617f90, size 0x70, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventDataBoxGroup* GetCopyWithNewBeat(float_t  newBeat) ;

static inline ::GlobalNamespace::BeatmapEventDataBoxGroup* New_ctor(float_t  beat, ::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBox*>*  beatmapEventDataBoxList) ;

/// @brief Method RemoveBeatmapEventDataFromBeatmapData, addr 0x3618000, size 0x168, virtual false, abstract: false, final false
inline void RemoveBeatmapEventDataFromBeatmapData(::GlobalNamespace::BeatmapData*  beatmapData) ;

/// @brief Method SyncWithBeatmapData, addr 0x3618168, size 0x398, virtual false, abstract: false, final false
inline void SyncWithBeatmapData(int32_t  groupId, ::GlobalNamespace::BeatmapData*  beatmapData, ::GlobalNamespace::IBeatToTimeConverter*  beatToTimeConverter, ::GlobalNamespace::IBeatmapLightEventConverter*  lightEventConverter) ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*>* const& __cordl_internal_get__elementDataDict() const;

constexpr ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*>*& __cordl_internal_get__elementDataDict() ;
...
constexpr void __cordl_internal_set__elementDataDict(::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*>*  value) ;
...
/// @brief Method .ctor, addr 0x36177d4, size 0x6f0, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapEventDataBoxList, addr 0x36177cc, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBox*>* get_beatmapEventDataBoxList() ;

/// @brief Method get_elementDataDict, addr 0x36177c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyDictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*>* get_elementDataDict() ;
