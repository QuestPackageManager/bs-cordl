...
/// @brief Method ConnectWithNext, addr 0x3656028, size 0x10, virtual false, abstract: false, final false
inline void ConnectWithNext(::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData*  nextElementData) ;

/// @brief Method ConnectWithPrevious, addr 0x3656018, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method ResetConnections, addr 0x3656010, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x36559ac, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method get_next, addr 0x3656000, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventDataBoxGroup_ElementData* get_next() ;

/// @brief Method get_previous, addr 0x3656008, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method CompareTo, addr 0x3655f94, size 0x6c, virtual true, abstract: false, final true
inline int32_t CompareTo(::GlobalNamespace::BeatmapEventDataBoxGroup*  b) ;

/// @brief Method GetCopyWithNewBeat, addr 0x3655a24, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method RemoveBeatmapEventDataFromBeatmapData, addr 0x3655a94, size 0x168, virtual false, abstract: false, final false
inline void RemoveBeatmapEventDataFromBeatmapData(::GlobalNamespace::BeatmapData*  beatmapData) ;

/// @brief Method SyncWithBeatmapData, addr 0x3655bfc, size 0x398, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3655268, size 0x6f0, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapEventDataBoxList, addr 0x3655260, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBox*>* get_beatmapEventDataBoxList() ;

/// @brief Method get_elementDataDict, addr 0x3655258, size 0x8, virtual false, abstract: false, final false
