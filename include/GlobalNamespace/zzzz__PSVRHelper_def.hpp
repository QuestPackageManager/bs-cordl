...
public:
  ...
  /// @brief Method add_inputFocusWasCapturedEvent addr 0x20fbb64 size 0x9c virtual true final true
  inline void add_inputFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method remove_inputFocusWasCapturedEvent addr 0x20fbc00 size 0x9c virtual true final true
  inline void remove_inputFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method add_inputFocusWasReleasedEvent addr 0x20fbc9c size 0x9c virtual true final true
  inline void add_inputFocusWasReleasedEvent(::System::Action* value);

  /// @brief Method remove_inputFocusWasReleasedEvent addr 0x20fbd38 size 0x9c virtual true final true
  inline void remove_inputFocusWasReleasedEvent(::System::Action* value);

  /// @brief Method add_vrFocusWasCapturedEvent addr 0x20fbdd4 size 0x9c virtual true final true
  inline void add_vrFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method remove_vrFocusWasCapturedEvent addr 0x20fbe70 size 0x9c virtual true final true
  inline void remove_vrFocusWasCapturedEvent(::System::Action* value);

  /// @brief Method add_vrFocusWasReleasedEvent addr 0x20fbf0c size 0x9c virtual true final true
  inline void add_vrFocusWasReleasedEvent(::System::Action* value);

  /// @brief Method remove_vrFocusWasReleasedEvent addr 0x20fbfa8 size 0x9c virtual true final true
  inline void remove_vrFocusWasReleasedEvent(::System::Action* value);

  /// @brief Method add_hmdUnmountedEvent addr 0x20fc044 size 0x9c virtual true final true
  inline void add_hmdUnmountedEvent(::System::Action* value);

  /// @brief Method remove_hmdUnmountedEvent addr 0x20fc0e0 size 0x9c virtual true final true
  inline void remove_hmdUnmountedEvent(::System::Action* value);

  /// @brief Method add_hmdMountedEvent addr 0x20fc17c size 0x9c virtual true final true
  inline void add_hmdMountedEvent(::System::Action* value);

  /// @brief Method remove_hmdMountedEvent addr 0x20fc218 size 0x9c virtual true final true
  inline void remove_hmdMountedEvent(::System::Action* value);

  /// @brief Method add_controllersDidChangeReferenceEvent addr 0x20fc2b4 size 0x9c virtual true final true
  inline void add_controllersDidChangeReferenceEvent(::System::Action* value);

  /// @brief Method remove_controllersDidChangeReferenceEvent addr 0x20fc350 size 0x9c virtual true final true
  inline void remove_controllersDidChangeReferenceEvent(::System::Action* value);

  /// @brief Method add_controllersDidDisconnectEvent addr 0x20fc3ec size 0x9c virtual true final true
  inline void add_controllersDidDisconnectEvent(::System::Action* value);

  /// @brief Method remove_controllersDidDisconnectEvent addr 0x20fc488 size 0x9c virtual true final true
  inline void remove_controllersDidDisconnectEvent(::System::Action* value);

  /// @brief Method get_hasInputFocus addr 0x20fc524 size 0x8 virtual true final true
  inline bool get_hasInputFocus();

  /// @brief Method get_hasVrFocus addr 0x20fc52c size 0x8 virtual true final true
  inline bool get_hasVrFocus();

  /// @brief Method get_isAlwaysWireless addr 0x20fc534 size 0x8 virtual true final true
  inline bool get_isAlwaysWireless();

  /// @brief Method get_vrPlatformSDK addr 0x20fc53c size 0x8 virtual true final true
  inline ::GlobalNamespace::VRPlatformSDK get_vrPlatformSDK();

  /// @brief Method Start addr 0x20fc544 size 0x4 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x20fc548 size 0x4 virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleMoveDeviceDidDisconnectEvent addr 0x20fc54c size 0x1c virtual false final false
  inline void HandleMoveDeviceDidDisconnectEvent();

  /// @brief Method Update addr 0x20fc568 size 0x4 virtual false final false
  inline void Update();

  /// @brief Method LateUpdate addr 0x20fc56c size 0x8 virtual false final false
  inline void LateUpdate();

  /// @brief Method TriggerHapticPulse addr 0x20fc574 size 0x4 virtual true final true
  inline void TriggerHapticPulse(::UnityEngine::XR::XRNode node, float_t duration, float_t strength, float_t frequency);

  /// @brief Method StopHaptics addr 0x20fc578 size 0x4 virtual true final true
  inline void StopHaptics(::UnityEngine::XR::XRNode node);

  /// @brief Method TryGetPoseOffsetForNode addr 0x20fc57c size 0x88 virtual true final true
  inline bool TryGetPoseOffsetForNode(::UnityEngine::XR::XRNode node, ByRef<::UnityEngine::Pose> poseOffset);

  /// @brief Method XRNodeToPSDeviceIndex addr 0x20fc604 size 0xdc virtual false final false
  static inline int32_t XRNodeToPSDeviceIndex(::UnityEngine::XR::XRNode node);

  /// @brief Method GetNodePose addr 0x20fc6e0 size 0x384 virtual true final true
  ...
  /// @brief Method GetAnyJoystickMaxAxis addr 0x20fca64 size 0x40 virtual true final true
  inline ::UnityEngine::Vector2 GetAnyJoystickMaxAxis();

  /// @brief Method GetTriggerValue addr 0x20fcaa4 size 0x8 virtual true final true
  inline float_t GetTriggerValue(::UnityEngine::XR::XRNode node);

  /// @brief Method GetThumbstickValue addr 0x20fcaac size 0x40 virtual true final true
  inline ::UnityEngine::Vector2 GetThumbstickValue(::UnityEngine::XR::XRNode node);

  /// @brief Method GetMenuButton addr 0x20fcaec size 0x4 virtual true final true
  inline bool GetMenuButton();

  /// @brief Method GetMenuButtonDown addr 0x20fcaf0 size 0x4 virtual true final true
  inline bool GetMenuButtonDown();

  /// @brief Method RefreshControllersReference addr 0x20fcaf4 size 0x1c virtual true final true
  inline void RefreshControllersReference();

  static inline ::GlobalNamespace::PSVRHelper* New_ctor();

  /// @brief Method .ctor addr 0x20fcb10 size 0x88 virtual false final false
  inline void _ctor();
