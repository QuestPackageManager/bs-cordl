...
/// @brief Method GetCopy, addr 0x3192cfc, size 0x78, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method GetDefault, addr 0x3192d74, size 0x8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3192cdc, size 0x20, virtual false, abstract: false, final false
inline void _ctor(float_t  time, float_t  bpm) ;

/// @brief Method get_nextSameTypeEventData, addr 0x3192c60, size 0x7c, virtual false, abstract: false, final false
inline ::GlobalNamespace::BPMChangeBeatmapEventData* get_nextSameTypeEventData() ;

/// @brief Method get_previousSameTypeEventData, addr 0x3192be4, size 0x7c, virtual false, abstract: false, final false
