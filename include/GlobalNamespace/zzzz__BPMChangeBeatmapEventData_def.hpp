...
public:
  ...
  /// @brief Method GetCopy, addr 0x223f3f0, size 0x84, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x223f474, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x223f3ac, size 0x44, virtual false, abstract: false, final false
