...
public:
  ...
  /// @brief Method GetCopy, addr 0x2241b7c, size 0x84, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x2241c00, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2241b38, size 0x44, virtual false, abstract: false, final false
