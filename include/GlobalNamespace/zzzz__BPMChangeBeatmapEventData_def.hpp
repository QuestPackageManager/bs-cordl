...
public:
  ...
  /// @brief Method GetCopy, addr 0x103dc28, size 0x8c, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x103dcb4, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103dbe4, size 0x44, virtual false, abstract: false, final false
