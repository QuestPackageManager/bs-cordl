...
public:
  ...
  /// @brief Method GetCopy, addr 0x2243428, size 0x84, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x22434ac, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22433e4, size 0x44, virtual false, abstract: false, final false
