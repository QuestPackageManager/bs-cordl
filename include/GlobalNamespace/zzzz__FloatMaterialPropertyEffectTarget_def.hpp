...
public:
  ...
  /// @brief Field _propertyId, offset 0x30, size 0x4
  ...
  /// @brief Method Awake, addr 0x26ddc84, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::FloatMaterialPropertyEffectTarget* New_ctor();

  /// @brief Method SetFloat, addr 0x26ddca8, size 0x60, virtual false, abstract: false, final false
  inline void SetFloat(float_t value);

  /// @brief Method SetValue, addr 0x26ddca4, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x26ddd08, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ddd0c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _propertyId, offset: 0x30, size: 0x4, def value: None
  int32_t ____propertyId;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::FloatMaterialPropertyEffectTarget, 0x38>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::FloatMaterialPropertyEffectTarget, ____materialPropertyBlockController) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FloatMaterialPropertyEffectTarget, ____propertyName) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FloatMaterialPropertyEffectTarget, ____valueBounds) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FloatMaterialPropertyEffectTarget, ____propertyId) == 0x30, "Offset mismatch!");
