...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PerlinNoise", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PerlinNoise(PerlinNoise&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PerlinNoise", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PerlinNoise(PerlinNoiseconst&) = delete;
