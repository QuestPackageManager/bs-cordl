...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x570bfc0, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570bf70, size 0x50, virtual false, abstract: false, final false
