...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x585757c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x585752c, size 0x50, virtual false, abstract: false, final false
