...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10249)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 412 }),
// TypeDefinitionIndex(TypeDefinitionIndex(14333))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14334)) CS Name: ::FixedUpdateVector3SmoothValue*
