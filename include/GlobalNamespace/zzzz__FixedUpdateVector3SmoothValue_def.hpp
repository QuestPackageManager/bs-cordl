...
public:
  // Declarations
  /// @brief Method Interpolate, addr 0x39cd410, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39cd3b8, size 0x58, virtual false, abstract: false, final false
