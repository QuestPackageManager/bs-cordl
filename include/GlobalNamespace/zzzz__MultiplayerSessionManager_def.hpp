...
public:
  ...
  /// @brief Method .ctor addr 0xe4c8a8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetPlayerByUserId>b__0 addr 0xe4cc9c size 0xb0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0xe4cdb0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <TryUpdateConnectedPlayer>b__104_0 addr 0xe4cdb8 size 0xa0 virtual false final false
...
public:
  ...
  /// @brief Method add_connectedEvent addr 0xe49d90 size 0x9c virtual true final true
  inline void add_connectedEvent(::System::Action* value);

  /// @brief Method remove_connectedEvent addr 0xe49e2c size 0x9c virtual true final true
  inline void remove_connectedEvent(::System::Action* value);

  /// @brief Method add_connectionFailedEvent addr 0xe49ec8 size 0xb0 virtual true final true
  inline void add_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method remove_connectionFailedEvent addr 0xe49f78 size 0xb0 virtual true final true
  inline void remove_connectionFailedEvent(::System::Action_1<::GlobalNamespace::ConnectionFailedReason>* value);

  /// @brief Method add_playerConnectedEvent addr 0xe4a028 size 0xb0 virtual true final true
  inline void add_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerConnectedEvent addr 0xe4a0d8 size 0xb0 virtual true final true
  inline void remove_playerConnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerDisconnectedEvent addr 0xe4a188 size 0xb0 virtual true final true
  inline void add_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerDisconnectedEvent addr 0xe4a238 size 0xb0 virtual true final true
  inline void remove_playerDisconnectedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerAvatarChangedEvent addr 0xe4a2e8 size 0xb0 virtual true final true
  inline void add_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerAvatarChangedEvent addr 0xe4a398 size 0xb0 virtual true final true
  inline void remove_playerAvatarChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_playerStateChangedEvent addr 0xe4a448 size 0xb0 virtual true final true
  inline void add_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_playerStateChangedEvent addr 0xe4a4f8 size 0xb0 virtual true final true
  inline void remove_playerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_connectionOwnerStateChangedEvent addr 0xe4a5a8 size 0xb0 virtual true final true
  inline void add_connectionOwnerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method remove_connectionOwnerStateChangedEvent addr 0xe4a658 size 0xb0 virtual true final true
  inline void remove_connectionOwnerStateChangedEvent(::System::Action_1<::GlobalNamespace::IConnectedPlayer*>* value);

  /// @brief Method add_disconnectedEvent addr 0xe4a708 size 0xb0 virtual true final true
  inline void add_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method remove_disconnectedEvent addr 0xe4a7b8 size 0xb0 virtual true final true
  inline void remove_disconnectedEvent(::System::Action_1<::GlobalNamespace::DisconnectedReason>* value);

  /// @brief Method add_pollUpdateEvent addr 0xe4a868 size 0x9c virtual true final true
  inline void add_pollUpdateEvent(::System::Action* value);

  /// @brief Method remove_pollUpdateEvent addr 0xe4a904 size 0x9c virtual true final true
  inline void remove_pollUpdateEvent(::System::Action* value);

  /// @brief Method get_isConnectionOwner addr 0xe4a9a0 size 0x18 virtual true final true
  inline bool get_isConnectionOwner();

  /// @brief Method get_connectionOwner addr 0xe4a9b8 size 0x8 virtual true final true
  inline ::GlobalNamespace::IConnectedPlayer* get_connectionOwner();

  /// @brief Method set_connectionOwner addr 0xe4a9c0 size 0x8 virtual false final false
  inline void set_connectionOwner(::GlobalNamespace::IConnectedPlayer* value);

  /// @brief Method get_isSpectating addr 0xe4a9c8 size 0x118 virtual true final true
  inline bool get_isSpectating();

  /// @brief Method get_isConnectingOrConnected addr 0xe4aae0 size 0x14 virtual true final true
  inline bool get_isConnectingOrConnected();

  /// @brief Method get_isConnected addr 0xe4ab04 size 0x10 virtual true final true
  inline bool get_isConnected();

  /// @brief Method get_isConnecting addr 0xe4aaf4 size 0x10 virtual true final true
  inline bool get_isConnecting();

  /// @brief Method get_isDisconnecting addr 0xe4ab14 size 0x10 virtual true final true
  inline bool get_isDisconnecting();

  /// @brief Method get_connectedPlayers addr 0xe4ab24 size 0x8 virtual true final true
  inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IConnectedPlayer*>* get_connectedPlayers();

  /// @brief Method get_connectedPlayerCount addr 0xe4ab2c size 0x48 virtual true final true
  inline int32_t get_connectedPlayerCount();

  /// @brief Method get_syncTime addr 0xe4ab74 size 0x14 virtual true final true
  inline int64_t get_syncTime();

  /// @brief Method get_isSyncTimeInitialized addr 0xe4ab88 size 0x14 virtual true final true
  inline bool get_isSyncTimeInitialized();

  /// @brief Method get_localPlayer addr 0xe4ab9c size 0x18 virtual true final true
  inline ::GlobalNamespace::IConnectedPlayer* get_localPlayer();

  /// @brief Method get_connectedPlayerManager addr 0xe4abb4 size 0x8 virtual false final false
  inline ::GlobalNamespace::ConnectedPlayerManager* get_connectedPlayerManager();

  /// @brief Method get_maxPlayerCount addr 0xe4abbc size 0x8 virtual true final true
  inline int32_t get_maxPlayerCount();

  /// @brief Method Start addr 0xe4abc4 size 0x4c virtual true final false
  inline void Start();

  /// @brief Method Update addr 0xe4acc4 size 0x58 virtual true final false
  inline void Update();

  /// @brief Method LateUpdate addr 0xe4ad24 size 0x14 virtual false final false
  inline void LateUpdate();

  /// @brief Method OnDestroy addr 0xe4ad38 size 0x24 virtual true final false
  inline void OnDestroy();

  /// @brief Method OnApplicationPause addr 0xe4b5e0 size 0x58 virtual true final false
  inline void OnApplicationPause(bool pauseStatus);

  /// @brief Method RegisterSerializer addr 0xe4b638 size 0x68 virtual true final true
  ...
  /// @brief Method UnregisterSerializer addr 0xe4b6a0 size 0x68 virtual true final true
  ...
  /// @brief Method StartSession addr 0xe4b708 size 0x5e8 virtual true final true
  ...
  /// @brief Method SetMaxPlayerCount addr 0xe4bcf0 size 0x8 virtual true final true
  inline void SetMaxPlayerCount(int32_t maxPlayerCount);

  /// @brief Method EndSession addr 0xe4b11c size 0x4c4 virtual true final true
  inline void EndSession();

  /// @brief Method Disconnect addr 0xe4bcf8 size 0x10 virtual true final true
  ...
  /// @brief Method SendUnreliableOnlyToFirstDegreeConnections addr 0x0 size 0xffffffffffffffff virtual true final true
  template <typename T> inline void SendUnreliableOnlyToFirstDegreeConnections(T message);

  /// @brief Method SendUnreliableFromPlayerToPlayer addr 0x0 size 0xffffffffffffffff virtual true final true
  ...
  /// @brief Method HandleInitialized addr 0xe4bd08 size 0x10 virtual false final false
  inline void HandleInitialized();

  /// @brief Method HandleConnected addr 0xe4bd18 size 0x10 virtual false final false
  inline void HandleConnected();

  /// @brief Method HandleDisconnected addr 0xe4bd28 size 0x10 virtual false final false
  inline void HandleDisconnected(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method HandleConnectionFailed addr 0xe4bd38 size 0x10 virtual false final false
  inline void HandleConnectionFailed(::GlobalNamespace::ConnectionFailedReason reason);

  /// @brief Method HandleSyncTimeInitialized addr 0xe4bd48 size 0x10 virtual false final false
  inline void HandleSyncTimeInitialized();

  /// @brief Method HandlePlayerConnected addr 0xe4bd58 size 0xbc virtual false final false
  inline void HandlePlayerConnected(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerDisconnected addr 0xe4c3e0 size 0xbc virtual false final false
  inline void HandlePlayerDisconnected(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerStateChanged addr 0xe4c49c size 0x1a8 virtual false final false
  inline void HandlePlayerStateChanged(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerAvatarChanged addr 0xe4c644 size 0x84 virtual false final false
  inline void HandlePlayerAvatarChanged(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerOrderChanged addr 0xe4c6c8 size 0x3c virtual false final false
  inline void HandlePlayerOrderChanged(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method HandlePlayerLatencyInitialized addr 0xe4c704 size 0x8 virtual false final false
  inline void HandlePlayerLatencyInitialized(::GlobalNamespace::IConnectedPlayer* player);

  /// @brief Method GetPlayerByUserId addr 0xe4c70c size 0x19c virtual true final true
  inline ::GlobalNamespace::IConnectedPlayer* GetPlayerByUserId(::StringW userId);

  /// @brief Method GetConnectedPlayer addr 0xe4c8b0 size 0x58 virtual true final true
  inline ::GlobalNamespace::IConnectedPlayer* GetConnectedPlayer(int32_t i);

  /// @brief Method SetLocalPlayerState addr 0xe4ac10 size 0xb4 virtual true final true
  inline void SetLocalPlayerState(::StringW state, bool hasState);

  /// @brief Method KickPlayer addr 0xe4c908 size 0x18 virtual true final true
  inline void KickPlayer(::StringW userId);

  /// @brief Method LocalPlayerHasState addr 0xe4c920 size 0xe4 virtual true final true
  inline bool LocalPlayerHasState(::StringW state);

  /// @brief Method UpdateConnectionState addr 0xe4ad5c size 0x3c0 virtual false final false
  ...
  /// @brief Method TryUpdateConnectedPlayer addr 0xe4be14 size 0x5cc virtual false final false
  inline bool TryUpdateConnectedPlayer(::GlobalNamespace::IConnectedPlayer* player, bool isPlayerConnected);

  /// @brief Method GetNextAvailableSortIndex addr 0xe4ca04 size 0xb4 virtual false final false
  inline int32_t GetNextAvailableSortIndex();

  static inline ::GlobalNamespace::MultiplayerSessionManager* New_ctor();

  /// @brief Method .ctor addr 0xe4cab8 size 0x144 virtual false final false
  inline void _ctor();
