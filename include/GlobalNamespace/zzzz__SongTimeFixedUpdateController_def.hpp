...
public:
  ...
  /// @brief Method Update, addr 0x5710c68, size 0x134, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5710d9c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_songControllerFixedTimeDidUpdateEvent, addr 0x571097c, size 0xc0, virtual false, abstract: false, final false
  inline void add_songControllerFixedTimeDidUpdateEvent(::System::Action_1<float_t>* value);

  /// @brief Method add_songControllerTimeDidUpdateEvent, addr 0x5710afc, size 0xac, virtual false, abstract: false, final false
  inline void add_songControllerTimeDidUpdateEvent(::System::Action* value);

  /// @brief Method get_fixedDeltaTime, addr 0x5710c54, size 0xc, virtual false, abstract: false, final false
  inline float_t get_fixedDeltaTime();

  /// @brief Method get_interpolationFactor, addr 0x5710c60, size 0x8, virtual false, abstract: false, final false
  inline float_t get_interpolationFactor();

  /// @brief Method remove_songControllerFixedTimeDidUpdateEvent, addr 0x5710a3c, size 0xc0, virtual false, abstract: false, final false
  inline void remove_songControllerFixedTimeDidUpdateEvent(::System::Action_1<float_t>* value);

  /// @brief Method remove_songControllerTimeDidUpdateEvent, addr 0x5710ba8, size 0xac, virtual false, abstract: false, final false
