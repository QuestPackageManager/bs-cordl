...
/// @brief Method InstallBindings, addr 0x36aca1c, size 0x98, virtual true, abstract: false, final false
inline void InstallBindings() ;

/// @brief Method LoadCharacteristicCollectionAsync, addr 0x36acab4, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x36acb38, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_assetRuntimeKey, addr 0x36ac9d8, size 0x44, virtual true, abstract: false, final false
