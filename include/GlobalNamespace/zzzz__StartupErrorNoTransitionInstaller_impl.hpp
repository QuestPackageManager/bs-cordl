...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::StartupErrorNoTransitionInstaller::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3b3eff8;
...
constexpr ::GlobalNamespace::StartupErrorSceneSetupData* const& GlobalNamespace::StartupErrorNoTransitionInstaller::__cordl_internal_get__startupErrorSceneSetupData() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____startupErrorSceneSetupData;
}
