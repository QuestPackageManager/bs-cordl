...
/// @brief Field <promoInfo>k__BackingField, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__promoInfo_k__BackingField, put=__cordl_internal_set__promoInfo_k__BackingField)) ::GlobalNamespace::DlcPromoPanelModel_PromoInfo*  _promoInfo_k__BackingField;
...
/// @brief Method Setup, addr 0x57b61bc, size 0x160, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::DlcPromoPanelModel_PromoInfo*  newPromoInfo, bool  probablyOwned) ;

/// @brief Method StartLoading, addr 0x57b6150, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57b631c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_promoButtonText, addr 0x57b6148, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_promoButtonText() ;

/// @brief Method get_promoInfo, addr 0x57b6138, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::DlcPromoPanelModel_PromoInfo* get_promoInfo() ;

/// @brief Method set_promoInfo, addr 0x57b6140, size 0x8, virtual false, abstract: false, final false
