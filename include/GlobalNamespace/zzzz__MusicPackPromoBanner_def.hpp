...
/// @brief Method Setup, addr 0x5744e30, size 0x160, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::DlcPromoPanelModel_PromoInfo*  newPromoInfo, bool  probablyOwned) ;

/// @brief Method StartLoading, addr 0x5744dc4, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5744f90, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_promoButtonText, addr 0x5744dbc, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_promoButtonText() ;

/// @brief Method get_promoInfo, addr 0x5744dac, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::DlcPromoPanelModel_PromoInfo* get_promoInfo() ;

/// @brief Method set_promoInfo, addr 0x5744db4, size 0x8, virtual false, abstract: false, final false
