...
public:
  ...
  /// @brief Method get_currentPromoMusicPack, addr 0x22e77b0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IBeatmapLevelPack* get_currentPromoMusicPack();

  /// @brief Method get_promoButtonText, addr 0x22e77b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_promoButtonText();

  /// @brief Method Setup, addr 0x22e77c0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22e78d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::MusicPackPromoBanner, ____currentPromoMusicPack) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MusicPackPromoBanner, ____currentPromoBeatmapLevel) == 0x40, "Offset mismatch!");
