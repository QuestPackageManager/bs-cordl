...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScreenDisplacementEffectCopyDepthPass", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScreenDisplacementEffectCopyDepthPass(ScreenDisplacementEffectCopyDepthPass&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScreenDisplacementEffectCopyDepthPass", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScreenDisplacementEffectCopyDepthPass(ScreenDisplacementEffectCopyDepthPassconst&) = delete;
