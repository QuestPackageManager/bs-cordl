...
/// @brief Method InstallBindings, addr 0x585079c, size 0x510, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5850cac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
