...
public:
  ...
  /// @brief Method Awake, addr 0x3ba38d8, size 0xa0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::SpectrogramRow* New_ctor();

  /// @brief Method Update, addr 0x3ba3978, size 0x120, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ba3a98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
