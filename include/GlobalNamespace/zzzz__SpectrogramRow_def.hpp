...
public:
  ...
  /// @brief Method Awake, addr 0x578d8b8, size 0xcc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::SpectrogramRow* New_ctor();

  /// @brief Method Update, addr 0x578d984, size 0x120, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x578daa4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
