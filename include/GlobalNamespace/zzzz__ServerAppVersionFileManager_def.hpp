...
public:
  // Declarations
  /// @brief Method BuildFilePath, addr 0x22e75e0, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAppVersion, addr 0x22e7650, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW ReadAppVersion(::StringW directoryPath);

  /// @brief Method WriteAppVersion, addr 0x22e75c4, size 0x1c, virtual false, abstract: false, final false
  static inline void WriteAppVersion(::StringW directoryPath, ::StringW appVersion);

  /// @brief Method .ctor, addr 0x22e7664, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
