...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServerAppVersionFileManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServerAppVersionFileManager(ServerAppVersionFileManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServerAppVersionFileManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServerAppVersionFileManager(ServerAppVersionFileManagerconst&) = delete;
