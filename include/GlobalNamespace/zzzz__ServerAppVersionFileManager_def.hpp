...
public:
  // Declarations
  /// @brief Method BuildFilePath, addr 0x32ba9d8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAppVersion, addr 0x32baa50, size 0x14, virtual false, abstract: false, final false
  static inline ::StringW ReadAppVersion(::StringW directoryPath);

  /// @brief Method WriteAppVersion, addr 0x32ba9bc, size 0x1c, virtual false, abstract: false, final false
  static inline void WriteAppVersion(::StringW directoryPath, ::StringW appVersion);

  /// @brief Method .ctor, addr 0x32baa64, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
