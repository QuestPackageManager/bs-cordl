...
public:
  ...
  /// @brief Method <SetData>b__10_0, addr 0x3c17254, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3c16870, size 0x90, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBeatmapCharacteristicSegmentedControlDidSelectCell, addr 0x3c170e8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3c16900, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetData, addr 0x3c169d0, size 0x718, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c17170, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectBeatmapCharacteristicEvent, addr 0x3c16708, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectBeatmapCharacteristicEvent(
      ::System::Action_2<::UnityW<::GlobalNamespace::BeatmapCharacteristicSegmentedControlController>, ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>* value);

  /// @brief Method get_selectedBeatmapCharacteristic, addr 0x3c16868, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_selectedBeatmapCharacteristic();

  /// @brief Method remove_didSelectBeatmapCharacteristicEvent, addr 0x3c167b8, size 0xb0, virtual false, abstract: false, final false
