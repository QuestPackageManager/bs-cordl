...
public:
  ...
  /// @brief Method <SetData>b__10_0, addr 0x3c19eac, size 0x30, virtual false, abstract: false, final false
  inline int32_t _SetData_b__10_0(::GlobalNamespace::BeatmapCharacteristicSO* a, ::GlobalNamespace::BeatmapCharacteristicSO* b);

  /// @brief Method .ctor, addr 0x3c19ea4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x3c194c8, size 0x90, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBeatmapCharacteristicSegmentedControlDidSelectCell, addr 0x3c19d40, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3c19558, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetData, addr 0x3c19628, size 0x718, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c19dc8, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectBeatmapCharacteristicEvent, addr 0x3c19360, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectBeatmapCharacteristicEvent(
      ::System::Action_2<::UnityW<::GlobalNamespace::BeatmapCharacteristicSegmentedControlController>, ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>>* value);

  /// @brief Method get_selectedBeatmapCharacteristic, addr 0x3c194c0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_selectedBeatmapCharacteristic();

  /// @brief Method remove_didSelectBeatmapCharacteristicEvent, addr 0x3c19410, size 0xb0, virtual false, abstract: false, final false
