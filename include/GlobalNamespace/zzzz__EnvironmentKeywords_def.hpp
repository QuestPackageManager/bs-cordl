...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentKeywords", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnvironmentKeywords(EnvironmentKeywords&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentKeywords", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnvironmentKeywords(EnvironmentKeywordsconst&) = delete;
