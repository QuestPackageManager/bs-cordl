...
public:
  ...
  /// @brief Method Tick, addr 0x58734c0, size 0x12c, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x58735ec, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_menuButtonTriggeredEvent, addr 0x5873368, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_menuButtonTriggeredEvent, addr 0x5873414, size 0xac, virtual true, abstract: false, final true
