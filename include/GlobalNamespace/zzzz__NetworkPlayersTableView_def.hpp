...
public:
  ...
  /// @brief Method .ctor, addr 0x58e1a18, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddPlayers, addr 0x58e13d0, size 0x648, virtual false, abstract: false, final false
  inline void AddPlayers(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer*>* players, ::StringW title);

  /// @brief Method CellForIdx, addr 0x58e0cfc, size 0x608, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t row);

  /// @brief Method CellSize, addr 0x58e0ca4, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method HandleCellWasPressed, addr 0x58e1e2c, size 0x4, virtual false, abstract: false, final false
  inline void HandleCellWasPressed(::HMUI::TableView* tableView, ::HMUI::TableCell* tableCell);

  /// @brief Method HasVisibleOptions, addr 0x58e1a1c, size 0x2bc, virtual false, abstract: false, final false
  ...
  /// @brief Method NumberOfCells, addr 0x58e0cac, size 0x50, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetParties, addr 0x58e1cd8, size 0x154, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e1e30, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
