...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockNodePoseSyncStateSender*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockNodePoseSyncStateSender*, "", "MockNodePoseSyncStateSender");
...
public:
  ...
  /// @brief Method Dispose, addr 0x5a82790, size 0xc0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleNodePoseSyncStateUpdate, addr 0x5a82a28, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method SendPose, addr 0x5a82850, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a825e8, size 0x1a8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MockNodePoseSyncStateSender", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MockNodePoseSyncStateSender(MockNodePoseSyncStateSender&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MockNodePoseSyncStateSender", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MockNodePoseSyncStateSender(MockNodePoseSyncStateSenderconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::MockNodePoseSyncStateSender) == 0x18, "Size mismatch!");
