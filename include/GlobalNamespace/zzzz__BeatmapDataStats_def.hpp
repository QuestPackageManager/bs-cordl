...
MARK_REF_T(::GlobalNamespace::BeatmapDataStats*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataStats_Events, "", "BeatmapDataStats/Events");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataStats_Objects, "", "BeatmapDataStats/Objects");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapDataStats*, "", "BeatmapDataStats");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataStats_Objects) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::BeatmapDataStats_Events) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method CountItems, addr 0x58ec144, size 0x1d8, virtual false, abstract: false, final false
  static inline ::System::Span_1<int32_t> CountItems(::ArrayW<::GlobalNamespace::BeatmapDataItem*> items);

  /// @brief Method CountItems, addr 0x58ec31c, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method GenerateReport, addr 0x58ec780, size 0x558, virtual false, abstract: false, final false
  static inline ::StringW GenerateReport(::System::Span_1<int32_t> counts);

  /// @brief Method SumCounts, addr 0x58ec70c, size 0x74, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::BeatmapDataStats) == 0x10, "Size mismatch!");
