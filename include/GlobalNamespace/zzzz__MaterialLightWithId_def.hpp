...
public:
  ...
  /// @brief Method Awake, addr 0x22747f4, size 0x80, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ColorWasSet, addr 0x2274874, size 0x188, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22749fc, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::MaterialPropertyBlock* getStaticF__materialPropertyBlock();

  /// @brief Method get_color, addr 0x22747e8, size 0xc, virtual false, abstract: false, final false
