...
public:
  ...
  /// @brief Method .ctor, addr 0x2701ea4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method get_badCutsCount, addr 0x2701e74, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_badCutsCount();

  /// @brief Method get_beatmapKey, addr 0x2701df8, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_fullCombo, addr 0x2701e50, size 0x8, virtual false, abstract: false, final false
  inline bool get_fullCombo();

  /// @brief Method get_gameplayModifiers, addr 0x2701e20, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_goodCutsCount, addr 0x2701e64, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_goodCutsCount();

  /// @brief Method get_maxCombo, addr 0x2701e94, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_maxCombo();

  /// @brief Method get_missedCount, addr 0x2701e84, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_missedCount();

  /// @brief Method get_modifiedScore, addr 0x2701e40, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_modifiedScore();

  /// @brief Method get_multipliedScore, addr 0x2701e30, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_multipliedScore();

  /// @brief Method get_playerId, addr 0x2701de8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_playerId();

  /// @brief Method set_badCutsCount, addr 0x2701e7c, size 0x8, virtual false, abstract: false, final false
  inline void set_badCutsCount(int32_t value);

  /// @brief Method set_beatmapKey, addr 0x2701e0c, size 0x14, virtual false, abstract: false, final false
  inline void set_beatmapKey(::GlobalNamespace::BeatmapKey value);

  /// @brief Method set_fullCombo, addr 0x2701e58, size 0xc, virtual false, abstract: false, final false
  inline void set_fullCombo(bool value);

  /// @brief Method set_gameplayModifiers, addr 0x2701e28, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_goodCutsCount, addr 0x2701e6c, size 0x8, virtual false, abstract: false, final false
  inline void set_goodCutsCount(int32_t value);

  /// @brief Method set_maxCombo, addr 0x2701e9c, size 0x8, virtual false, abstract: false, final false
  inline void set_maxCombo(int32_t value);

  /// @brief Method set_missedCount, addr 0x2701e8c, size 0x8, virtual false, abstract: false, final false
  inline void set_missedCount(int32_t value);

  /// @brief Method set_modifiedScore, addr 0x2701e48, size 0x8, virtual false, abstract: false, final false
  inline void set_modifiedScore(int32_t value);

  /// @brief Method set_multipliedScore, addr 0x2701e38, size 0x8, virtual false, abstract: false, final false
  inline void set_multipliedScore(int32_t value);

  /// @brief Method set_playerId, addr 0x2701df0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2701f38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x2702058, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x2702080, size 0xc, virtual true, abstract: false, final false
  inline ::GlobalNamespace::HMAsyncRequest* EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x2702044, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2701f40, size 0x104, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <UploadScoresCoroutine>b__0, addr 0x2702094, size 0x230, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270208c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x27022c4, size 0x5b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2702874, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x27028dc, size 0x498, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2702d74, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x2702d84, size 0x1e0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::LeaderboardScoreUploader__UploadScoresCoroutine_d__16* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2702f64, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2702f6c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2702fa4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2702d80, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2701b08, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddScore, addr 0x2701c80, size 0xc4, virtual false, abstract: false, final false
  inline void AddScore(::GlobalNamespace::LeaderboardScoreUploader_ScoreData* scoreData);

  /// @brief Method Init, addr 0x27019a8, size 0x58, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::LeaderboardScoreUploader_UploadScoreCallback* uploadScoreCallback, ::StringW playerId);

  /// @brief Method LoadScoresToUploadFromFile, addr 0x2701b30, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method OnApplicationQuit, addr 0x2701b04, size 0x4, virtual false, abstract: false, final false
  inline void OnApplicationQuit();

  /// @brief Method SaveScoresToUploadToFile, addr 0x2701bf0, size 0x90, virtual false, abstract: false, final false
  inline void SaveScoresToUploadToFile();

  /// @brief Method Uninitialize, addr 0x2701a60, size 0xa4, virtual false, abstract: false, final false
  inline void Uninitialize();

  /// @brief Method UploadScoresCoroutine, addr 0x2701a00, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* UploadScoresCoroutine();

  /// @brief Method <UploadScoresCoroutine>b__16_1, addr 0x2701dd8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2701d44, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allScoresDidUploadEvent, addr 0x2701870, size 0x9c, virtual false, abstract: false, final false
  inline void add_allScoresDidUploadEvent(::System::Action* value);

  /// @brief Method remove_allScoresDidUploadEvent, addr 0x270190c, size 0x9c, virtual false, abstract: false, final false
