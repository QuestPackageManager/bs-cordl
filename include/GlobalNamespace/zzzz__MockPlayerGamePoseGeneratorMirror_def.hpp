...
/// @brief Method Dispose, addr 0x5822798, size 0x514, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method FindPlayerToMirror, addr 0x5822d78, size 0x380, virtual false, abstract: false, final false
inline void FindPlayerToMirror() ;

/// @brief Method HandleLevelFinished, addr 0x5823c60, size 0x178, virtual false, abstract: false, final false
inline void HandleLevelFinished(::StringW  userId, ::GlobalNamespace::MultiplayerLevelCompletionResults*  results) ;

/// @brief Method HandleNoteWasCut, addr 0x5823718, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method HandleNoteWasMissed, addr 0x5823590, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method HandleNoteWasSpawned, addr 0x58230f8, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method HandleObstacleWasSpawned, addr 0x5823280, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method HandleOptionalAvatarDataReceived, addr 0x5823a80, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method HandleScoreSyncStateUpdate, addr 0x58238a0, size 0x1e0, virtual false, abstract: false, final false
...
/// @brief Method HandleSliderWasSpawned, addr 0x5823408, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x5822cac, size 0x8, virtual true, abstract: false, final false
...
static inline ::GlobalNamespace::MockPlayerGamePoseGeneratorMirror* New_ctor(::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::IGameplayRpcManager*  gameplayRpcManager, bool  leftHanded, ::GlobalNamespace::NodePoseSyncStateManager*  nodePoseSyncStateManager) ;

/// @brief Method Tick, addr 0x5822cb4, size 0xc4, virtual true, abstract: false, final false
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x5821d64, size 0x758, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::IGameplayRpcManager*  gameplayRpcManager, bool  leftHanded, ::GlobalNamespace::NodePoseSyncStateManager*  nodePoseSyncStateManager) ;
