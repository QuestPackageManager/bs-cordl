...
public:
  ...
  /// @brief Method Dispose, addr 0x3bca360, size 0x4ec, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method FindPlayerToMirror, addr 0x3bca9a4, size 0x39c, virtual false, abstract: false, final false
  inline void FindPlayerToMirror();

  /// @brief Method HandleLevelFinished, addr 0x3bcb88c, size 0x174, virtual false, abstract: false, final false
  inline void HandleLevelFinished(::StringW userId, ::GlobalNamespace::MultiplayerLevelCompletionResults* results);

  /// @brief Method HandleNoteWasCut, addr 0x3bcb350, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteWasMissed, addr 0x3bcb1cc, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleNoteWasSpawned, addr 0x3bcad40, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleObstacleWasSpawned, addr 0x3bcaec4, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleOptionalAvatarDataReceived, addr 0x3bcb6b0, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleScoreSyncStateUpdate, addr 0x3bcb4d4, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSliderWasSpawned, addr 0x3bcb048, size 0x184, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x3bca84c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Tick, addr 0x3bca854, size 0x150, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x3bc9cbc, size 0x6a4, virtual false, abstract: false, final false
