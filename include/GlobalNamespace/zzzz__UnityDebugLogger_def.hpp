...
/// @brief Method Log, addr 0x57c59b0, size 0x5c, virtual true, abstract: false, final true
inline void Log(::StringW  message) ;

/// @brief Method Log, addr 0x57c5a0c, size 0xc0, virtual true, abstract: false, final true
inline void Log(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogError, addr 0x57c5be8, size 0x5c, virtual true, abstract: false, final true
inline void LogError(::StringW  message) ;

/// @brief Method LogError, addr 0x57c5c44, size 0xc0, virtual true, abstract: false, final true
inline void LogError(::StringW  message, ::System::Object*  context) ;

/// @brief Method LogException, addr 0x57c5d04, size 0x5c, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception) ;

/// @brief Method LogException, addr 0x57c5d60, size 0xc0, virtual true, abstract: false, final true
inline void LogException(::System::Exception*  exception, ::System::Object*  context) ;

/// @brief Method LogWarning, addr 0x57c5acc, size 0x5c, virtual true, abstract: false, final true
inline void LogWarning(::StringW  message) ;

/// @brief Method LogWarning, addr 0x57c5b28, size 0xc0, virtual true, abstract: false, final true
inline void LogWarning(::StringW  message, ::System::Object*  context) ;

static inline ::GlobalNamespace::UnityDebugLogger* New_ctor() ;

/// @brief Method .ctor, addr 0x57c5e20, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
