...
public:
  ...
  /// @brief Method <SongPlayerCrossfadeToLevelAsync>b__0, addr 0x3b6489c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b64894, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b648bc, size 0x294, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b64b50, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b64b5c, size 0x3dc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b64f38, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method DidActivate, addr 0x3b640ac, size 0x204, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b642b0, size 0x1d4, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x3b64868, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleLevelCollectionTableViewDidSelectLevel, addr 0x3b64484, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelCollectionTableViewDidSelectPack, addr 0x3b64824, size 0x44, virtual false, abstract: false, final false
  inline void HandleLevelCollectionTableViewDidSelectPack(::GlobalNamespace::LevelCollectionTableView* tableView);

  /// @brief Method LateUpdate, addr 0x3b64768, size 0x50, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::LevelCollectionViewController* New_ctor();

  /// @brief Method OnDisable, addr 0x3b64714, size 0x54, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3b64644, size 0xd0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshFavorites, addr 0x3b63f90, size 0x30, virtual false, abstract: false, final false
  inline void RefreshFavorites();

  /// @brief Method SelectLevel, addr 0x3b62a98, size 0x34, virtual false, abstract: false, final false
  inline void SelectLevel(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method SetData, addr 0x3b6372c, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method SongPlayerCrossfadeToLevel, addr 0x3b644d4, size 0x98, virtual false, abstract: false, final false
  inline void SongPlayerCrossfadeToLevel(::GlobalNamespace::BeatmapLevel* level);

  /// @brief Method SongPlayerCrossfadeToLevelAsync, addr 0x3b6456c, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadPreviewAudioClip, addr 0x3b647b8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b64884, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectHeaderEvent, addr 0x3b63200, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionViewController>>* value);

  /// @brief Method add_didSelectLevelEvent, addr 0x3b63150, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectHeaderEvent, addr 0x3b6367c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionViewController>>* value);

  /// @brief Method remove_didSelectLevelEvent, addr 0x3b635cc, size 0xb0, virtual false, abstract: false, final false
