...
/// @brief Method <SongPlayerCrossfadeToLevelAsync>b__0, addr 0x57ae588, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ae584, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method MoveNext, addr 0x57ae5ac, size 0x2c4, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x57ae870, size 0x8, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelCollectionViewController>", modifiers: "", def_value: None }, CppParam { name: "level", ty: "::GlobalNamespace::BeatmapLevel*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr LevelCollectionViewController__SongPlayerCrossfadeToLevel_d__24(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::LevelCollectionViewController>  __4__this, ::GlobalNamespace::BeatmapLevel*  level, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x57ae878, size 0x438, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x57aecb0, size 0x6c, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelCollectionViewController>", modifiers: "", def_value: None }, CppParam { name: "level", ty: "::GlobalNamespace::BeatmapLevel*", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__8__1", ty: "::GlobalNamespace::LevelCollectionViewController___c__DisplayClass25_0*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::AudioClip>>", modifiers: "", def_value: None }]
constexpr LevelCollectionViewController__SongPlayerCrossfadeToLevelAsync_d__25(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::LevelCollectionViewController>  __4__this, ::GlobalNamespace::BeatmapLevel*  level, ::System::Threading::CancellationToken  cancellationToken, ::GlobalNamespace::LevelCollectionViewController___c__DisplayClass25_0*  __8__1, ::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::AudioClip>>  __u__1) noexcept;
...
/// @brief Field _crossfadeCancellationTokenSource, offset 0xe0, size 0x8 
 __declspec(property(get=__cordl_internal_get__crossfadeCancellationTokenSource, put=__cordl_internal_set__crossfadeCancellationTokenSource)) ::System::Threading::CancellationTokenSource*  _crossfadeCancellationTokenSource;

/// @brief Field _levelCollectionTableView, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get__levelCollectionTableView, put=__cordl_internal_set__levelCollectionTableView)) ::UnityW<::GlobalNamespace::LevelCollectionTableView>  _levelCollectionTableView;
...
/// @brief Field didSelectHeaderEvent, offset 0xc0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectHeaderEvent, put=__cordl_internal_set_didSelectHeaderEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionViewController>>*  didSelectHeaderEvent;

/// @brief Field didSelectLevelEvent, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectLevelEvent, put=__cordl_internal_set_didSelectLevelEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::LevelCollectionViewController>,::GlobalNamespace::BeatmapLevel*>*  didSelectLevelEvent;

/// @brief Method DidActivate, addr 0x57aded4, size 0x25c, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x57ae130, size 0x228, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x57ae560, size 0x18, virtual false, abstract: false, final false
inline void HandleAdditionalContentModelDidInvalidateData() ;

/// @brief Method HandleLevelCollectionTableViewDidSelectLevel, addr 0x57ae358, size 0x50, virtual false, abstract: false, final false
...
/// @brief Method HandleLevelCollectionTableViewDidSelectPack, addr 0x57ae51c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method RefreshFavorites, addr 0x57addb0, size 0x30, virtual false, abstract: false, final false
inline void RefreshFavorites() ;

/// @brief Method SelectLevel, addr 0x57ac3e0, size 0x34, virtual false, abstract: false, final false
inline void SelectLevel(::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method SetData, addr 0x57ad1b4, size 0x300, virtual false, abstract: false, final false
inline void SetData(::ArrayW<::GlobalNamespace::BeatmapLevel*,::Array<::GlobalNamespace::BeatmapLevel*>*>  beatmapLevels, ::StringW  headerText, ::UnityEngine::Sprite*  headerSprite, bool  sortLevels, bool  sortBeatmapLevels, ::UnityEngine::GameObject*  noDataInfoPrefab) ;

/// @brief Method SongPlayerCrossfadeToLevel, addr 0x57ae3a8, size 0xac, virtual false, abstract: false, final false
inline void SongPlayerCrossfadeToLevel(::GlobalNamespace::BeatmapLevel*  level) ;

/// @brief Method SongPlayerCrossfadeToLevelAsync, addr 0x57ae454, size 0xc8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ae578, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectHeaderEvent, addr 0x57acc1c, size 0xc0, virtual false, abstract: false, final false
inline void add_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionViewController>>*  value) ;

/// @brief Method add_didSelectLevelEvent, addr 0x57acb5c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_didSelectHeaderEvent, addr 0x57ad0f4, size 0xc0, virtual false, abstract: false, final false
inline void remove_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionViewController>>*  value) ;

/// @brief Method remove_didSelectLevelEvent, addr 0x57ad034, size 0xc0, virtual false, abstract: false, final false
