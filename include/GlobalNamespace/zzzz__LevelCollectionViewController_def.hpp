...
public:
  ...
  /// @brief Method <SongPlayerCrossfadeToLevelAsync>b__0, addr 0x594e1f0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x594e1ec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x594e214, size 0x2c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x594e4d8, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x594e4e0, size 0x438, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x594e918, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method DidActivate, addr 0x594db3c, size 0x25c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x594dd98, size 0x228, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x594e1c8, size 0x18, virtual false, abstract: false, final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleLevelCollectionTableViewDidSelectLevel, addr 0x594dfc0, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelCollectionTableViewDidSelectPack, addr 0x594e184, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshFavorites, addr 0x594da18, size 0x30, virtual false, abstract: false, final false
  inline void RefreshFavorites();

  /// @brief Method SelectLevel, addr 0x594c344, size 0x34, virtual false, abstract: false, final false
  inline void SelectLevel(::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method SetData, addr 0x594d114, size 0x300, virtual false, abstract: false, final false
  ...
  /// @brief Method SongPlayerCrossfadeToLevel, addr 0x594e010, size 0xac, virtual false, abstract: false, final false
  inline void SongPlayerCrossfadeToLevel(::GlobalNamespace::BeatmapLevel* level);

  /// @brief Method SongPlayerCrossfadeToLevelAsync, addr 0x594e0bc, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x594e1e0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectHeaderEvent, addr 0x594cb7c, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionViewController>>* value);

  /// @brief Method add_didSelectLevelEvent, addr 0x594cabc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectHeaderEvent, addr 0x594d054, size 0xc0, virtual false, abstract: false, final false
  inline void remove_didSelectHeaderEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelCollectionViewController>>* value);

  /// @brief Method remove_didSelectLevelEvent, addr 0x594cf94, size 0xc0, virtual false, abstract: false, final false
