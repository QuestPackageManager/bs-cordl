...
template <typename T0, typename T1, typename T2> inline T0 GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::get_value0() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(), { "get_value0", {}, {} })));
...
template <typename T0, typename T1, typename T2> inline T1 GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::get_value1() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(), { "get_value1", {}, {} })));
...
template <typename T0, typename T1, typename T2> inline T2 GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::get_value2() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(), { "get_value2", {}, {} })));
...
template <typename T0, typename T1, typename T2> inline void GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::SerializeData(::LiteNetLib::Utils::NetDataWriter* writer, uint32_t protocolVersion) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(), 8 })));
...
template <typename T0, typename T1, typename T2> inline void GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::DeserializeData(::LiteNetLib::Utils::NetDataReader* reader, uint32_t protocolVersion) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(), 9 })));
...
inline ::GlobalNamespace::IRemoteProcedureCall* GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::Init(int64_t syncTime, T0 value0, T1 value1, T2 value2) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(),
                                                           { "Init", {}, { ::i2c::type_of<int64_t>(), ::i2c::type_of<T0>(), ::i2c::type_of<T1>(), ::i2c::type_of<T2>() } })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::IRemoteProcedureCall*>(this, ___internal_method, syncTime, value0, value1, value2);
}
template <typename T0, typename T1, typename T2> inline void GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::Release() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(), 10 })));
...
template <typename T0, typename T1, typename T2> inline void GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T0, typename T1, typename T2> inline ::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>* GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::RemoteProcedureCall_3<T0, T1, T2>*>());
}
// Ctor Parameters []
