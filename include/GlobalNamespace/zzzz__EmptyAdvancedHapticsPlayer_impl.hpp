...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EmptyAdvancedHapticsPlayer::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::EmptyAdvancedHapticsPlayer*>::get(), "PlayHapticFeedback", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::EmptyAdvancedHapticsPlayer::*)(::Libraries::HM::HMLib::VR::HapticPresetSO*)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::EmptyAdvancedHapticsPlayer*>::get(), "CanPlayHapticPreset", std::span<Il2CppClass const* const, 0>(),
...
constexpr ::GlobalNamespace::IHapticFeedbackPlayer* GlobalNamespace::EmptyAdvancedHapticsPlayer::i___GlobalNamespace__IHapticFeedbackPlayer() noexcept {
  return static_cast<::GlobalNamespace::IHapticFeedbackPlayer*>(static_cast<void*>(this));
}
...
inline ::GlobalNamespace::EmptyAdvancedHapticsPlayer* GlobalNamespace::EmptyAdvancedHapticsPlayer::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::EmptyAdvancedHapticsPlayer*>());
}
