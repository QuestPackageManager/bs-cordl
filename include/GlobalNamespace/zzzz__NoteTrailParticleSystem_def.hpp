...
public:
  ...
  /// @brief Method Awake, addr 0x25bd330, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Emit, addr 0x25bd340, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25bd450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
