...
// [AddComponentMenu("Beat Saber/Gameplay/NoteTrailParticleSystem")]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteTrailParticleSystem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoteTrailParticleSystem(NoteTrailParticleSystem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoteTrailParticleSystem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoteTrailParticleSystem(NoteTrailParticleSystemconst&) = delete;
