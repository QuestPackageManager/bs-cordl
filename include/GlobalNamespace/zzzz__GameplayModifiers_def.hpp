...
public:
  ...
  __declspec(property(get = get_BeatmapTransformValues)) ::System::ValueTuple_4<bool, ::GlobalNamespace::GameplayModifiers_EnabledObstacleType, bool, bool> BeatmapTransformValues;
