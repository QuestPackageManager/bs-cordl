...
/// @brief Method .ctor, addr 0x367c424, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x367c2f4, size 0x60, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::GameplayModifiers_EnergyType  energyType, bool  noFailOn0Energy, bool  instaFail, bool  failOnSaberClash, ::GlobalNamespace::GameplayModifiers_EnabledObstacleType  enabledObstacleType, bool  noBombs, bool  fastNotes, bool  strictAngles, bool  disappearingArrows, ::GlobalNamespace::GameplayModifiers_SongSpeed  songSpeed, bool  noArrows, bool  ghostNotes, bool  proMode, bool  zenMode, bool  smallCubes) ;

static inline ::GlobalNamespace::GameplayModifiers* getStaticF_noModifiers() ;

/// @brief Method get_cutAngleTolerance, addr 0x367c3ec, size 0x20, virtual false, abstract: false, final false
inline float_t get_cutAngleTolerance() ;

/// @brief Method get_disappearingArrows, addr 0x367c38c, size 0x8, virtual false, abstract: false, final false
inline bool get_disappearingArrows() ;

/// @brief Method get_enabledObstacleType, addr 0x367c374, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifiers_EnabledObstacleType get_enabledObstacleType() ;

/// @brief Method get_energyType, addr 0x367c354, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifiers_EnergyType get_energyType() ;

/// @brief Method get_failOnSaberClash, addr 0x367c36c, size 0x8, virtual false, abstract: false, final false
inline bool get_failOnSaberClash() ;

/// @brief Method get_fastNotes, addr 0x367c37c, size 0x8, virtual false, abstract: false, final false
inline bool get_fastNotes() ;

/// @brief Method get_ghostNotes, addr 0x367c394, size 0x8, virtual false, abstract: false, final false
inline bool get_ghostNotes() ;

/// @brief Method get_instaFail, addr 0x367c364, size 0x8, virtual false, abstract: false, final false
inline bool get_instaFail() ;

/// @brief Method get_noArrows, addr 0x367c3ac, size 0x8, virtual false, abstract: false, final false
inline bool get_noArrows() ;

/// @brief Method get_noBombs, addr 0x367c39c, size 0x8, virtual false, abstract: false, final false
inline bool get_noBombs() ;

/// @brief Method get_noFailOn0Energy, addr 0x367c35c, size 0x8, virtual false, abstract: false, final false
inline bool get_noFailOn0Energy() ;

/// @brief Method get_notesUniformScale, addr 0x367c40c, size 0x18, virtual false, abstract: false, final false
inline float_t get_notesUniformScale() ;

/// @brief Method get_proMode, addr 0x367c3b4, size 0x8, virtual false, abstract: false, final false
inline bool get_proMode() ;

/// @brief Method get_smallCubes, addr 0x367c3c4, size 0x8, virtual false, abstract: false, final false
inline bool get_smallCubes() ;

/// @brief Method get_songSpeed, addr 0x367c3a4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::GameplayModifiers_SongSpeed get_songSpeed() ;

/// @brief Method get_songSpeedMul, addr 0x367c3cc, size 0x20, virtual false, abstract: false, final false
inline float_t get_songSpeedMul() ;

/// @brief Method get_strictAngles, addr 0x367c384, size 0x8, virtual false, abstract: false, final false
inline bool get_strictAngles() ;

/// @brief Method get_zenMode, addr 0x367c3bc, size 0x8, virtual false, abstract: false, final false
