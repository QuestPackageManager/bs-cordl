...
public:
  ...
  /// @brief Method Awake, addr 0x3c0721c, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleButtonClickEvent, addr 0x3c073cc, size 0x28, virtual false, abstract: false, final false
  inline void HandleButtonClickEvent();

  static inline ::GlobalNamespace::MenuShockwave* New_ctor();

  /// @brief Method OnDisable, addr 0x3c072fc, size 0xd0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3c0722c, size 0xd0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SpawnShockwave, addr 0x3c073f4, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c07498, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
