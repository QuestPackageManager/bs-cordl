...
public:
  ...
  /// @brief Method Awake, addr 0x3c10154, size 0x10, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleButtonClickEvent, addr 0x3c10304, size 0x28, virtual false, abstract: false, final false
  inline void HandleButtonClickEvent();

  static inline ::GlobalNamespace::MenuShockwave* New_ctor();

  /// @brief Method OnDisable, addr 0x3c10234, size 0xd0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3c10164, size 0xd0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SpawnShockwave, addr 0x3c1032c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c103d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
