...
public:
  ...
  /// @brief Method AddStrobeData, addr 0x26ae374, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method StartPotentialStrobe, addr 0x26ae430, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ae2e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateTransformedData, addr 0x26ad6a4, size 0xc44, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFlashAndFadeToBlackEventDataValue, addr 0x26ae410, size 0x20, virtual false, abstract: false, final false
  static inline int32_t GetFlashAndFadeToBlackEventDataValue(::GlobalNamespace::EnvironmentColorType lightColorType);

  /// @brief Method GetOnEventDataValue, addr 0x26ae3ec, size 0x24, virtual false, abstract: false, final false
