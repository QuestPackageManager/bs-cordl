...
public:
  ...
  /// @brief Method MarkModified, addr 0x281582c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x28154a8, size 0x384, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2815474, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRMeshData meshData);

  /// @brief Method get_MeshData, addr 0x281544c, size 0x10, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRMeshData get_MeshData();

  /// @brief Method set_MeshData, addr 0x281545c, size 0x18, virtual false, abstract: false, final false
