...
public:
  ...
  /// @brief Method MarkModified, addr 0x5d155d0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5d1534c, size 0x284, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d152a0, size 0xac, virtual false, abstract: false, final false
