...
public:
  ...
  /// @brief Method MarkModified, addr 0x3fa9e80, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x3fa9af4, size 0x38c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3fa9ac0, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRMeshData meshData);

  /// @brief Method get_MeshData, addr 0x3fa9a98, size 0x10, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRMeshData get_MeshData();

  /// @brief Method set_MeshData, addr 0x3fa9aa8, size 0x18, virtual false, abstract: false, final false
