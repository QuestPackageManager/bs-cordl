...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRGLTFAnimationNodeMorphTargetHandler*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRGLTFAnimationNodeMorphTargetHandler*, "", "OVRGLTFAnimationNodeMorphTargetHandler");
...
public:
  ...
  /// @brief Method MarkModified, addr 0x5e51598, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5e51314, size 0x284, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5e51268, size 0xac, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::OVRGLTFAnimationNodeMorphTargetHandler) == 0x98, "Size mismatch!");
