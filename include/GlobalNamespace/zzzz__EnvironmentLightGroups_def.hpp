...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnvironmentLightGroups*);
...
public:
  ...
  /// @brief Method <Sort>b__9_0, addr 0x3705f14, size 0x14, virtual false, abstract: false, final false
  inline int32_t _Sort_b__9_0(::GlobalNamespace::LightGroupSO* s);

  /// @brief Method .ctor, addr 0x3705f10, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EnvironmentLightGroups___c) == 0x10, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetDataForGroup, addr 0x3705b64, size 0x22c, virtual true, abstract: false, final true
  ...
  /// @brief Method Sort, addr 0x3705d90, size 0x12c, virtual false, abstract: false, final false
  inline void Sort();
  ...
  /// @brief Method .ctor, addr 0x3705b5c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>* lightGroups);

  /// @brief Method get_lightGroupSOList, addr 0x3705b54, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>* get_lightGroupSOList();

  /// @brief Method get_lightGroups, addr 0x3705b4c, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::EnvironmentLightGroups) == 0x28, "Size mismatch!");
