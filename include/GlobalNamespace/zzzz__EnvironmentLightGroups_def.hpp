...
public:
  ...
  /// @brief Method <Sort>b__9_0, addr 0x26ad748, size 0x18, virtual false, abstract: false, final false
  inline int32_t _Sort_b__9_0(::GlobalNamespace::LightGroupSO* s);

  /// @brief Method .ctor, addr 0x26ad740, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method get_lightGroups, addr 0x26ad354, size 0x8, virtual true, abstract: false, final true
