...
public:
  ...
  /// @brief Method <Sort>b__9_0, addr 0x26b447c, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetDataForGroup, addr 0x26b40c0, size 0x238, virtual true, abstract: false, final true
  ...
  /// @brief Method Sort, addr 0x26b42f8, size 0x120, virtual false, abstract: false, final false
  inline void Sort();
  ...
  /// @brief Method .ctor, addr 0x26b4098, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>* lightGroups);

  /// @brief Method get_lightGroupSOList, addr 0x26b4090, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>* get_lightGroupSOList();

  /// @brief Method get_lightGroups, addr 0x26b4088, size 0x8, virtual true, abstract: false, final true
