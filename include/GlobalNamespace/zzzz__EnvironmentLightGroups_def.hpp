...
public:
  ...
  static __declspec(property(get = getStaticF___9__6_0, put = setStaticF___9__6_0))::System::Func_2<::GlobalNamespace::LightGroupSO*, int32_t>* __9__6_0;
...
public:
  ...
  __declspec(property(get = __get__lightGroupSOListForLightGroupDataDict,
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::LightGroupSO*>*> const& __get__lightGroupSOList() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t, ::GlobalNamespace::LightGroupSO*>*> const& __get__lightGroupSODict() const;
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::LightGroupSO*>*> const& __get__lightGroupSOListForLightGroupDataDict() const;
...
public:
  ...
  ::System::Collections::Generic::List_1<::GlobalNamespace::LightGroupSO*>* ____lightGroupSOList;

  /// @brief Field _lightGroupSODict, offset: 0x18, size: 0x8, def value: None
  ::System::Collections::Generic::Dictionary_2<int32_t, ::GlobalNamespace::LightGroupSO*>* ____lightGroupSODict;

  /// @brief Field _lightGroupSOListForLightGroupDataDict, offset: 0x20, size: 0x8, def value: None
  ::System::Collections::Generic::List_1<::GlobalNamespace::LightGroupSO*>* ____lightGroupSOListForLightGroupDataDict;
