...
/// @brief Method <Sort>b__9_0, addr 0x3649a84, size 0x14, virtual false, abstract: false, final false
inline int32_t _Sort_b__9_0(::GlobalNamespace::LightGroupSO*  s) ;

/// @brief Method .ctor, addr 0x3649a80, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _lightGroupSODict, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightGroupSODict, put=__cordl_internal_set__lightGroupSODict)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::GlobalNamespace::LightGroupSO>>*  _lightGroupSODict;

/// @brief Field _lightGroupSOList, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightGroupSOList, put=__cordl_internal_set__lightGroupSOList)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*  _lightGroupSOList;

/// @brief Field _lightGroupSOListForLightGroupDataDict, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__lightGroupSOListForLightGroupDataDict, put=__cordl_internal_set__lightGroupSOListForLightGroupDataDict)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*  _lightGroupSOListForLightGroupDataDict;
...
/// @brief Method GetDataForGroup, addr 0x36496d4, size 0x22c, virtual true, abstract: false, final true
...
/// @brief Method Sort, addr 0x3649900, size 0x12c, virtual false, abstract: false, final false
inline void Sort() ;
...
/// @brief Method .ctor, addr 0x36496cc, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>*  lightGroups) ;

/// @brief Method get_lightGroupSOList, addr 0x36496c4, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LightGroupSO>>* get_lightGroupSOList() ;

/// @brief Method get_lightGroups, addr 0x36496bc, size 0x8, virtual true, abstract: false, final true
