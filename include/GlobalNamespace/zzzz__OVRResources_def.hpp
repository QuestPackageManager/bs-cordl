...
public:
  ...
  /// @brief Method .ctor addr 0x2617fa0 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <Load>b__0 addr 0x2618084 size 0x34 virtual false final false
...
public:
  ...
  /// @brief Method Load addr 0x2617dbc size 0x1e4 virtual false final false
  ...
  /// @brief Method SetResourceBundle addr 0x2617fa8 size 0xd4 virtual false final false
  static inline void SetResourceBundle(::UnityEngine::AssetBundle* bundle);

  static inline ::GlobalNamespace::OVRResources* New_ctor();

  /// @brief Method .ctor addr 0x261807c size 0x8 virtual false final false
  inline void _ctor();
