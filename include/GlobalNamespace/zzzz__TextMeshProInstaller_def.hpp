...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(12254)), TypeDefinitionIndex(TypeDefinitionIndex(15466)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15466), inst:
// 730 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(3989)) CS Name: ::TextMeshProInstaller*
...
public:
  ...
  /// @brief Method get_assetLabel, addr 0x22b4628, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetLabelReference* get_assetLabel();

  /// @brief Method LoadResourcesBeforeInstall, addr 0x22b4630, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method InstallBindings, addr 0x22b4688, size 0x140, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::TextMeshProInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x22b47c8, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
