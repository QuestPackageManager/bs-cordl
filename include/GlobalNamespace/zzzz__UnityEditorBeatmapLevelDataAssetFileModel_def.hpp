...
/// @brief Method LoadBeatmapLevelDataFromAssetDatabase, addr 0x3658cb4, size 0x78, virtual false, abstract: false, final false
static inline ::UnityW<::GlobalNamespace::BeatmapLevelDataSO> LoadBeatmapLevelDataFromAssetDatabase(::StringW  levelId) ;

/// @brief Method LoadBeatmapLevelFromAssetDatabase, addr 0x3658d2c, size 0x78, virtual false, abstract: false, final false
static inline ::UnityW<::GlobalNamespace::BeatmapLevelSO> LoadBeatmapLevelFromAssetDatabase(::StringW  levelId) ;

/// @brief Method LoadBeatmapLevelPackFromAssetDatabase, addr 0x3658da4, size 0x78, virtual false, abstract: false, final false
