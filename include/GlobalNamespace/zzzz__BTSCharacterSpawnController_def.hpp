...
public:
  ...
  /// @brief Method .ctor addr 0x20b9e6c size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x20b9e9c size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x20b9ea0 size 0xc8 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x20b9f68 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x20b9f70 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x20b9fb0 size 0x8 virtual true final true
...
public:
  ...
  /// @brief Method get_isCharacterVisible addr 0x20b9410 size 0x18 virtual false final false
  inline bool get_isCharacterVisible();

  /// @brief Method get_isSpawned addr 0x20b9428 size 0x8 virtual false final false
  inline bool get_isSpawned();

  /// @brief Method Start addr 0x20b9430 size 0x338 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x20b9818 size 0x3a0 virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleStartCharacterAnimation addr 0x20b9c68 size 0xc8 virtual false final false
  inline void HandleStartCharacterAnimation(::GlobalNamespace::BTSCharacter* btsCharacter);

  /// @brief Method HandleGamePauseDidPause addr 0x20b9d98 size 0x40 virtual false final false
  inline void HandleGamePauseDidPause();

  /// @brief Method HandleGamePauseWillResume addr 0x20b9dd8 size 0x44 virtual false final false
  inline void HandleGamePauseWillResume();

  /// @brief Method HandleGamePauseDidResume addr 0x20b9e1c size 0x28 virtual false final false
  inline void HandleGamePauseDidResume();

  /// @brief Method HandleLevelEndActionsLevelFailed addr 0x20b9e44 size 0x28 virtual false final false
  inline void HandleLevelEndActionsLevelFailed();

  /// @brief Method TimelineStoppedDelayed addr 0x20b9d30 size 0x68 virtual false final false
  ...
  /// @brief Method .ctor addr 0x20b9e94 size 0x8 virtual false final false
  inline void _ctor();
