...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x39e1484, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method __SetIsRegistered, addr 0x39e3cbc, size 0xc, virtual true, abstract: false, final true
  inline void __SetIsRegistered();

  /// @brief Method __SetIsUnRegistered, addr 0x39e3cc8, size 0x8, virtual true, abstract: false, final true
  inline void __SetIsUnRegistered();

  /// @brief Method __SetParentLightWithIds, addr 0x39e3cd0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e2078, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x39e1414, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId);

  /// @brief Method get_color, addr 0x39e3ca8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_isRegistered, addr 0x39e3cb4, size 0x8, virtual true, abstract: false, final true
  inline bool get_isRegistered();

  /// @brief Method get_lightId, addr 0x39e3ca0, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Awake, addr 0x39e2114, size 0x38, virtual true, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method HandleLightManagerDidChangeSomeColorsThisFrame, addr 0x39e3c84, size 0x1c, virtual false, abstract: false, final false
  inline void HandleLightManagerDidChangeSomeColorsThisFrame();

  /// @brief Method MarkChildrenColorAsSet, addr 0x39e38d8, size 0xc, virtual false, abstract: false, final false
  inline void MarkChildrenColorAsSet();

  static inline ::GlobalNamespace::LightWithIds* New_ctor();

  /// @brief Method OnDisable, addr 0x39e3c80, size 0x4, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39e0e20, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method RegisterForColorChanges, addr 0x39e3510, size 0x3c8, virtual false, abstract: false, final false
  inline void RegisterForColorChanges();

  /// @brief Method SetNewLightsWithIds, addr 0x39e34e4, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x39e350c, size 0x4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method UnregisterFromColorChanges, addr 0x39e38e4, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e13dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightWithIds, addr 0x39e34dc, size 0x8, virtual false, abstract: false, final false
