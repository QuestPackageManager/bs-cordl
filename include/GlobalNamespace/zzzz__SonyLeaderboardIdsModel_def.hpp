...
public:
  ...
  /// @brief Method GetMaxId, addr 0x14aaf6c, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetSonyLeaderboardId, addr 0x14aaeb4, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14aa8b4, size 0x600, virtual false, abstract: false, final false
