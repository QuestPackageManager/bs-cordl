...
public:
  ...
  /// @brief Method Awake, addr 0x5855a04, size 0x120, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Move, addr 0x5855b28, size 0x48, virtual false, abstract: false, final false
  inline void Move(float_t value);

  static inline ::GlobalNamespace::MoveInDirectionEffect* New_ctor();

  /// @brief Method SetValue, addr 0x5855b24, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x5855b70, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5855b74, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
