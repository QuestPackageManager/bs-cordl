...
public:
  ...
  /// @brief Method <CreateBeatmapLevelPack>b__0, addr 0x26ccf08, size 0x68, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* _CreateBeatmapLevelPack_b__0(::GlobalNamespace::BeatmapLevelSO* l);

  /// @brief Method <CreateBeatmapLevelPack>b__1, addr 0x26ccf70, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ccedc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ccfac, size 0x45c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26cd408, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26cd484, size 0x47c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26cd900, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26cd980, size 0xd4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::BeatmapLevelsModel__SelectPacks_d__28* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<PackDefinitionSO>.GetEnumerator, addr 0x26cda9c, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<PackDefinitionSO>.get_Current, addr 0x26cda54, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::PackDefinitionSO> System_Collections_Generic_IEnumerator_PackDefinitionSO__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x26cdb48, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x26cda5c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x26cda94, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x26cd97c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26ccb98, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckBeatmapLevelDataExistsAsync, addr 0x26cc9fc, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearLoadedBeatmapLevelsCaches, addr 0x26cc778, size 0xa4, virtual false, abstract: false, final false
  inline void ClearLoadedBeatmapLevelsCaches();

  /// @brief Method CreateBeatmapLevelPack, addr 0x26ccbd0, size 0x2d8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x26cc6d8, size 0xa0, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetAllPacks, addr 0x26cc8b4, size 0x1c, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevelPack*>* GetAllPacks();

  /// @brief Method GetBeatmapLevel, addr 0x26cc8d0, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* GetBeatmapLevel(::StringW levelId);

  /// @brief Method GetLevelPack, addr 0x26cc89c, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* GetLevelPack(::StringW levelPackId);

  /// @brief Method GetLevelPackForLevelId, addr 0x26cc884, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* GetLevelPackForLevelId(::StringW levelId);

  /// @brief Method LoadAllBeatmapLevelPacks, addr 0x26cc230, size 0x4a8, virtual false, abstract: false, final false
  inline void LoadAllBeatmapLevelPacks();

  /// @brief Method LoadBeatmapLevelDataAsync, addr 0x26cc8e8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadAllBeatmapLevelPacks, addr 0x26ccbcc, size 0x4, virtual false, abstract: false, final false
  inline void ReloadAllBeatmapLevelPacks();

  /// @brief Method ReloadCustomLevelPackCollectionAsync, addr 0x26cc81c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectPacks, addr 0x26ccb10, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method <CreateBeatmapLevelPack>g__ShouldBeKeptIntact|31_2, addr 0x26ccee4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26cbf44, size 0x2ec, virtual false, abstract: false, final false
  ...
  /// @brief Method add_newPackWasCreatedFromDefinitionEvent, addr 0x26cbde4, size 0xb0, virtual false, abstract: false, final false
  inline void add_newPackWasCreatedFromDefinitionEvent(::System::Action_1<::GlobalNamespace::BeatmapLevelPack*>* value);

  /// @brief Method get_entitlements, addr 0x26cbddc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IEntitlementModel* get_entitlements();

  /// @brief Method get_packDefinitions, addr 0x26cbdd4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>* get_packDefinitions();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method remove_newPackWasCreatedFromDefinitionEvent, addr 0x26cbe94, size 0xb0, virtual false, abstract: false, final false
