...
public:
  ...
  /// @brief Method <CreateBeatmapLevelPack>g__ShouldBeKeptIntact|1, addr 0x3666b38, size 0xd0, virtual false, abstract: false, final false
  inline bool _CreateBeatmapLevelPack_g__ShouldBeKeptIntact_1(::GlobalNamespace::BeatmapLevel* level);

  /// @brief Method <CreateBeatmapLevelPack>g__ToRuntime|0, addr 0x3666a2c, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3666984, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3666c08, size 0x474, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x366707c, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x36670fc, size 0x49c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3667598, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x366761c, size 0xd4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::BeatmapLevelsModel__SelectPacks_d__29* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<PackDefinitionSO>.GetEnumerator, addr 0x3667738, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<PackDefinitionSO>.get_Current, addr 0x36676f0, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::PackDefinitionSO> System_Collections_Generic_IEnumerator_PackDefinitionSO__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x36677e0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x36676f8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3667730, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3667618, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3666598, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckBeatmapLevelDataExistsAsync, addr 0x366640c, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearLoadedBeatmapLevelsCaches, addr 0x3666190, size 0xa8, virtual false, abstract: false, final false
  inline void ClearLoadedBeatmapLevelsCaches();

  /// @brief Method CreateBeatmapLevelPack, addr 0x36666b0, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x36660ec, size 0xa4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetAllPacks, addr 0x36662d4, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::BeatmapLevelPack*>* GetAllPacks();

  /// @brief Method GetBeatmapLevel, addr 0x36662ec, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* GetBeatmapLevel(::StringW levelId, bool ignoreCase);

  /// @brief Method GetLevelPack, addr 0x36662bc, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* GetLevelPack(::StringW levelPackId, bool ignoreCase);

  /// @brief Method GetLevelPackForLevelId, addr 0x36662a8, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* GetLevelPackForLevelId(::StringW levelId);

  /// @brief Method LoadAllBeatmapLevelPacks, addr 0x3665c28, size 0x4c4, virtual false, abstract: false, final false
  inline void LoadAllBeatmapLevelPacks();

  /// @brief Method LoadBeatmapLevelDataAsync, addr 0x3666304, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadAllBeatmapLevelPacks, addr 0x36665b8, size 0x4, virtual false, abstract: false, final false
  inline void ReloadAllBeatmapLevelPacks();

  /// @brief Method ReloadCustomLevelPackCollectionAsync, addr 0x3666238, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method SelectPacks, addr 0x3666514, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method SetExcludedLevelIdsAndReload, addr 0x36665bc, size 0xf4, virtual false, abstract: false, final false
  inline void SetExcludedLevelIdsAndReload(::System::Collections::Generic::IEnumerable_1<::StringW>* excludedLevelIds);

  /// @brief Method <CreateBeatmapLevelPack>g__IsSensitivitySafe|33_2, addr 0x3666a18, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3665918, size 0x310, virtual false, abstract: false, final false
  ...
  /// @brief Method add_newPackWasCreatedFromDefinitionEvent, addr 0x3665798, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_entitlements, addr 0x3665790, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IEntitlementModel* get_entitlements();

  /// @brief Method get_packDefinitions, addr 0x3665788, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::PackDefinitionSO>>* get_packDefinitions();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method remove_newPackWasCreatedFromDefinitionEvent, addr 0x3665858, size 0xc0, virtual false, abstract: false, final false
