...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::EnumTableViewDataSource_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::EnumTableViewDataSource_1, "", "EnumTableViewDataSource`1");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__values, put = __cordl_internal_set__values)) ::ArrayW<T> _values;
  ...
  constexpr ::ArrayW<T> const& __cordl_internal_get__values() const;

  constexpr ::ArrayW<T>& __cordl_internal_get__values();
  ...
  constexpr void __cordl_internal_set__values(::ArrayW<T> value);
