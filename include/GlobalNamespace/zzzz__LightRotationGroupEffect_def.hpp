...
public:
  ...
  __declspec(property(get = __cordl_internal_get__handler, put = __cordl_internal_set__handler)) ::GlobalNamespace::LightRotationEventHandler* _handler;

  /// @brief Field _lightRotationBeatmapEventCallbackWrapper, offset 0x20, size 0x8
  ...
  constexpr ::GlobalNamespace::LightRotationEventHandler* const& __cordl_internal_get__handler() const;

  constexpr ::GlobalNamespace::LightRotationEventHandler*& __cordl_internal_get__handler();
  ...
  constexpr void __cordl_internal_set__handler(::GlobalNamespace::LightRotationEventHandler* value);
...
public:
  ...
  ::GlobalNamespace::LightRotationEventHandler* ____handler;

  /// @brief Field _lightRotationBeatmapEventCallbackWrapper, offset: 0x20, size: 0x8, def value: None
  ::GlobalNamespace::BeatmapDataCallbackWrapper* ____lightRotationBeatmapEventCallbackWrapper;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::LightRotationGroupEffect, ____beatmapCallbacksController) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightRotationGroupEffect, ____handler) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightRotationGroupEffect, ____lightRotationBeatmapEventCallbackWrapper) == 0x20, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::LightRotationGroupEffect) == 0x28, "Size mismatch!");
