...
public:
  ...
  /// @brief Method SpawnShockwave, addr 0x3b88068, size 0xd4, virtual false, abstract: false, final false
  inline void SpawnShockwave(::UnityEngine::Vector3 pos);

  /// @brief Method Start, addr 0x3b87f28, size 0x140, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b8813c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
