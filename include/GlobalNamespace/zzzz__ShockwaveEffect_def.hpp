...
/// @brief Method SpawnShockwave, addr 0x57db618, size 0xc8, virtual false, abstract: false, final false
inline void SpawnShockwave(::UnityEngine::Vector3  pos) ;

/// @brief Method Start, addr 0x57db438, size 0x1e0, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57db6e0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
