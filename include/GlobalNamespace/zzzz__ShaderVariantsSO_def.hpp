...
public:
  ...
  /// @brief Method .ctor, addr 0x28f4968, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::PassType passType, ::StringW keywords);

  /// @brief Method get_keywords, addr 0x28f4960, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_keywords();

  /// @brief Method get_passType, addr 0x28f4958, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x28f492c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_shader, addr 0x28f4924, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_shader();

  /// @brief Method get_variants, addr 0x28f491c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x28f490c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28f4914, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_shaderVariants, addr 0x28f4904, size 0x8, virtual false, abstract: false, final false
