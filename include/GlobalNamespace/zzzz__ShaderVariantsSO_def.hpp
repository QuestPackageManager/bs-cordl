...
public:
  ...
  /// @brief Method .ctor, addr 0x408ad04, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Rendering::PassType passType, ::StringW keywords);

  /// @brief Method get_keywords, addr 0x408acfc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_keywords();

  /// @brief Method get_passType, addr 0x408acf4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x408acc8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_shader, addr 0x408acc0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Shader> get_shader();

  /// @brief Method get_variants, addr 0x408acb8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x408aca8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x408acb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_shaderVariants, addr 0x408aca0, size 0x8, virtual false, abstract: false, final false
