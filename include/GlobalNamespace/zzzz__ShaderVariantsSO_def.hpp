...
/// @brief Method .ctor, addr 0x5d9ac1c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::UnityEngine::Rendering::PassType  passType, ::StringW  keywords) ;

/// @brief Method get_keywords, addr 0x5d9ac14, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_keywords() ;

/// @brief Method get_passType, addr 0x5d9ac0c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _variants, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__variants, put=__cordl_internal_set__variants)) ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*,::Array<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*>*>  _variants;
...
static inline ::GlobalNamespace::ShaderVariantsSO_ShaderVariant* New_ctor(::UnityEngine::Shader*  shader, ::ArrayW<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*,::Array<::GlobalNamespace::ShaderVariant_ShaderVariantsSO_Variant*>*>  variants) ;
...
/// @brief Method .ctor, addr 0x5d9ac04, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_shader, addr 0x5d9abfc, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Shader> get_shader() ;

/// @brief Method get_variants, addr 0x5d9abf4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _shaderVariants, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__shaderVariants, put=__cordl_internal_set__shaderVariants)) ::ArrayW<::GlobalNamespace::ShaderVariantsSO_ShaderVariant*,::Array<::GlobalNamespace::ShaderVariantsSO_ShaderVariant*>*>  _shaderVariants;
...
/// @brief Method Init, addr 0x5d9abe4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d9abec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_shaderVariants, addr 0x5d9abdc, size 0x8, virtual false, abstract: false, final false
