...
template<typename T>
class SortExtensions___c__DisplayClass1_0_1;
}
...
// Declarations
template<typename T>
using __c__DisplayClass1_0_1 = ::GlobalNamespace::SortExtensions___c__DisplayClass1_0_1<T>;

/// @brief Method InsertSorted, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void InsertSorted(::System::Collections::Generic::List_1<T>*  list, T  item, ::System::Func_2<T,int32_t>*  getSortIndex) ;

/// @brief Method Sort, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline void Sort(::System::Collections::Generic::List_1<T>*  list, ::System::Func_2<T,int32_t>*  getSortIndex) ;
