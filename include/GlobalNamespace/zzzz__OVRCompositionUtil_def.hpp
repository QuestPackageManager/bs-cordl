...
public:
  // Declarations
  /// @brief Method BuildBoundaryMesh, addr 0x5df4024, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaximumBoundaryDistance, addr 0x5df3e48, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeDestroy, addr 0x5df3c30, size 0xc8, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::GameObject* obj);

  /// @brief Method SafeDestroy, addr 0x5df3cf8, size 0x78, virtual false, abstract: false, final false
  static inline void SafeDestroy(::by_ref<::UnityEngine::GameObject*> obj);

  /// @brief Method .ctor, addr 0x5df44fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
