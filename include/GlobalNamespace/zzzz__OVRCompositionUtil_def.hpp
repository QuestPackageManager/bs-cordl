...
public:
  // Declarations
  /// @brief Method BuildBoundaryMesh, addr 0x5c45b68, size 0x4d8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetMaximumBoundaryDistance, addr 0x5c4598c, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetWorldPosition, addr 0x5c458f0, size 0x9c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 GetWorldPosition(::UnityEngine::Camera* camera, ::UnityEngine::Vector3 trackingSpacePosition);

  /// @brief Method GetWorldPosition, addr 0x5c458b4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SafeDestroy, addr 0x5c4583c, size 0x78, virtual false, abstract: false, final false
  static inline void SafeDestroy(::ByRef<::UnityEngine::GameObject*> obj);

  /// @brief Method SafeDestroy, addr 0x5c45774, size 0xc8, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::GameObject* obj);

  /// @brief Method .ctor, addr 0x5c46040, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
