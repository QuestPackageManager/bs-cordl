...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IFilePathSongAudioClipProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFilePathSongAudioClipProvider(IFilePathSongAudioClipProviderconst&) = delete;
