...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x28a4fa0, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetStyleHandler, addr 0x28a5318, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorLutHandler, addr 0x28a23c8, size 0x58, virtual false, abstract: false, final false
  inline void SetColorLutHandler(::GlobalNamespace::OVRPassthroughColorLut* lut, float_t weight);

  /// @brief Method SetInterpolatedColorLutHandler, addr 0x28a253c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMonoToMonoHandler, addr 0x28a29a4, size 0x5c, virtual false, abstract: false, final false
  inline void SetMonoToMonoHandler(::ArrayW<uint8_t, ::Array<uint8_t>*> values);

  /// @brief Method SetMonoToRgbaHandler, addr 0x28a21fc, size 0x34, virtual false, abstract: false, final false
  inline void SetMonoToRgbaHandler(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> values);

  /// @brief Method SetStyleHandler, addr 0x28a2cec, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a4fc0, size 0x188, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyStyleSettings, addr 0x28a5500, size 0x4, virtual true, abstract: false, final true
  inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x28a5508, size 0x4, virtual true, abstract: false, final true
  inline void Clear();

  static inline ::GlobalNamespace::__OVRPassthroughLayer__NoneStyleHandler* New_ctor();

  /// @brief Method Update, addr 0x28a5504, size 0x4, virtual true, abstract: false, final true
  inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings settings);

  /// @brief Method .ctor, addr 0x28a5270, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsValid, addr 0x28a54f8, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsValid();
...
public:
  ...
  /// @brief Method AllocateColorMapData, addr 0x28a55bc, size 0x90, virtual true, abstract: false, final false
  inline void AllocateColorMapData(uint32_t size);

  /// @brief Method ApplyStyleSettings, addr 0x28a5548, size 0x68, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x28a55b0, size 0xc, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method ComputeBrightnessContrastPosterizeMap, addr 0x28a5884, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method DeallocateColorMapData, addr 0x28a564c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x28a5544, size 0x4, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings settings);

  /// @brief Method WriteColorToColorMap, addr 0x28a5674, size 0x188, virtual false, abstract: false, final false
  inline void WriteColorToColorMap(int32_t colorIndex, ByRef<::UnityEngine::Color> color);

  /// @brief Method WriteFloatToColorMap, addr 0x28a57fc, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a5514, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsValid, addr 0x28a550c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsValid();
...
public:
  ...
  /// @brief Method AllocateColorMapData, addr 0x28a5abc, size 0x68, virtual true, abstract: false, final false
  inline void AllocateColorMapData(uint32_t size);

  /// @brief Method DeallocateColorMapData, addr 0x28a5b24, size 0x2c, virtual true, abstract: false, final false
  inline void DeallocateColorMapData();
  ...
  /// @brief Method Update, addr 0x28a5a00, size 0xbc, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings settings);

  /// @brief Method Update, addr 0x28a5440, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a52b8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle> colorMapDataHandler, ::ArrayW<uint8_t, ::Array<uint8_t>*> colorMapData);

  /// @brief Method get_MapSize, addr 0x28a59f8, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_MapSize();
...
public:
  ...
  /// @brief Method Update, addr 0x28a5b58, size 0x38, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings settings);

  /// @brief Method Update, addr 0x28a54b4, size 0x44, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> values);

  /// @brief Method .ctor, addr 0x28a5288, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle> colorMapDataHandler, ::ArrayW<uint8_t, ::Array<uint8_t>*> colorMapData);

  /// @brief Method get_MapSize, addr 0x28a5b50, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_MapSize();
...
public:
  ...
  /// @brief Method Update, addr 0x28a5b98, size 0x78, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings settings);

  /// @brief Method .ctor, addr 0x28a52e8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle> colorMapDataHandler, ::ArrayW<uint8_t, ::Array<uint8_t>*> colorMapData);

  /// @brief Method get_MapSize, addr 0x28a5b90, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_MapSize();
...
public:
  ...
  /// @brief Method ApplyStyleSettings, addr 0x28a5c44, size 0x28, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x28a5e20, size 0x8, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method GetColorLutForTexture, addr 0x28a5cc0, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x28a53f8, size 0x20, virtual false, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughColorLut* lut, float_t weight);

  /// @brief Method Update, addr 0x28a5c6c, size 0x54, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings settings);
  ...
  /// @brief Method .ctor, addr 0x28a5278, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsValid, addr 0x28a5c30, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsValid();

  /// @brief Method get_Lut, addr 0x28a5c10, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPassthroughColorLut* get_Lut();

  /// @brief Method get_Weight, addr 0x28a5c20, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Weight();

  /// @brief Convert to "::GlobalNamespace::__OVRPassthroughLayer__IStyleHandler"
  constexpr ::GlobalNamespace::__OVRPassthroughLayer__IStyleHandler* i___GlobalNamespace____OVRPassthroughLayer__IStyleHandler() noexcept;

  /// @brief Method set_IsValid, addr 0x28a5c38, size 0xc, virtual false, abstract: false, final false
  inline void set_IsValid(bool value);

  /// @brief Method set_Lut, addr 0x28a5c18, size 0x8, virtual false, abstract: false, final false
  inline void set_Lut(::GlobalNamespace::OVRPassthroughColorLut* value);

  /// @brief Method set_Weight, addr 0x28a5c28, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyStyleSettings, addr 0x28a5e38, size 0x38, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x28a5eec, size 0xc, virtual true, abstract: false, final false
  inline void Clear();

  static inline ::GlobalNamespace::__OVRPassthroughLayer__InterpolatedColorLutHandler* New_ctor();

  /// @brief Method Update, addr 0x28a5418, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x28a5e70, size 0x7c, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings settings);
  ...
  /// @brief Method .ctor, addr 0x28a5280, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LutTarget, addr 0x28a5e28, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPassthroughColorLut* get_LutTarget();

  /// @brief Method set_LutTarget, addr 0x28a5e30, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <RemoveSurfaceGeometry>b__0, addr 0x28a5ef8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a1d18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <IsSurfaceGeometry>b__0, addr 0x28a5f64, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a1fcc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddDeferredSurfaceGeometries, addr 0x28a2dbc, size 0x258, virtual false, abstract: false, final false
  inline void AddDeferredSurfaceGeometries();

  /// @brief Method AddSurfaceGeometry, addr 0x28a1910, size 0x1f0, virtual false, abstract: false, final false
  inline void AddSurfaceGeometry(::UnityEngine::GameObject* obj, bool updateTransform);

  /// @brief Method Awake, addr 0x28a43f8, size 0x228, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClampWeight, addr 0x28a232c, size 0x9c, virtual false, abstract: false, final false
  static inline float_t ClampWeight(float_t weight);

  /// @brief Method CreateAndAddMesh, addr 0x28a3014, size 0x2b0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNeutralColorMapGradient, addr 0x28a2730, size 0x1d0, virtual false, abstract: false, final false
  static inline ::UnityEngine::Gradient* CreateNeutralColorMapGradient();

  /// @brief Method CreateOvrPluginStyleObject, addr 0x28a4794, size 0x154, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2 CreateOvrPluginStyleObject();

  /// @brief Method DestroySurfaceGeometries, addr 0x28a38e4, size 0x280, virtual false, abstract: false, final false
  inline void DestroySurfaceGeometries(bool addBackToDeferredQueue);

  /// @brief Method DisableColorMap, addr 0x28a2cdc, size 0x8, virtual false, abstract: false, final false
  inline void DisableColorMap();

  /// @brief Method GetTransformMatrixForPassthroughSurfaceObject, addr 0x28a32c4, size 0x354, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 GetTransformMatrixForPassthroughSurfaceObject(::UnityEngine::Matrix4x4 worldFromObj);

  /// @brief Method HasControlsBasedColorMap, addr 0x28a4140, size 0x30, virtual false, abstract: false, final false
  inline bool HasControlsBasedColorMap();

  /// @brief Method IsSurfaceGeometry, addr 0x28a1eb0, size 0x11c, virtual false, abstract: false, final false
  inline bool IsSurfaceGeometry(::UnityEngine::GameObject* obj);

  /// @brief Method LateUpdate, addr 0x28a4624, size 0x170, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::OVRPassthroughLayer* New_ctor();

  /// @brief Method OnDestroy, addr 0x28a4d58, size 0x8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x28a4c88, size 0xd0, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x28a4afc, size 0x18c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RemoveSurfaceGeometry, addr 0x28a1b00, size 0x218, virtual false, abstract: false, final false
  inline void RemoveSurfaceGeometry(::UnityEngine::GameObject* obj);

  /// @brief Method SetBrightnessContrastSaturation, addr 0x28a2a00, size 0x4c, virtual false, abstract: false, final false
  inline void SetBrightnessContrastSaturation(float_t brightness, float_t contrast, float_t saturation);

  /// @brief Method SetColorLut, addr 0x28a2230, size 0xfc, virtual false, abstract: false, final false
  inline void SetColorLut(::GlobalNamespace::OVRPassthroughColorLut* lut, float_t weight);

  /// @brief Method SetColorLut, addr 0x28a2420, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorMap, addr 0x28a2084, size 0xa0, virtual false, abstract: false, final false
  inline void SetColorMap(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> values);

  /// @brief Method SetColorMapControls, addr 0x28a25a0, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorMapMonochromatic, addr 0x28a2900, size 0xa4, virtual false, abstract: false, final false
  inline void SetColorMapMonochromatic(::ArrayW<uint8_t, ::Array<uint8_t>*> values);

  /// @brief Method SetStyleDirty, addr 0x28a2db0, size 0xc, virtual false, abstract: false, final false
  inline void SetStyleDirty();

  /// @brief Method SyncToOverlay, addr 0x28a4170, size 0x274, virtual false, abstract: false, final false
  inline void SyncToOverlay();

  /// @brief Method Update, addr 0x28a4620, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateColorMapFromControls, addr 0x28a2a4c, size 0x290, virtual false, abstract: false, final false
  inline void UpdateColorMapFromControls(bool forceUpdate);

  /// @brief Method UpdateSurfaceGeometryTransform, addr 0x28a3e80, size 0x1b8, virtual false, abstract: false, final false
  inline void UpdateSurfaceGeometryTransform(uint64_t instanceHandle, ::UnityEngine::Matrix4x4 localToWorld);

  /// @brief Method UpdateSurfaceGeometryTransforms, addr 0x28a3b64, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x28a4d60, size 0x240, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_colorMapEditorType, addr 0x28a2ce4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType get_colorMapEditorType();

  /// @brief Method get_edgeColor, addr 0x28a2020, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_edgeColor();

  /// @brief Method get_edgeRenderingEnabled, addr 0x28a1ff8, size 0x8, virtual false, abstract: false, final false
  inline bool get_edgeRenderingEnabled();

  /// @brief Method get_overlayShape, addr 0x28a43e4, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__OVROverlay__OverlayShape get_overlayShape();

  /// @brief Method get_textureOpacity, addr 0x28a1fd4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_colorMapEditorType, addr 0x28a2124, size 0xd8, virtual false, abstract: false, final false
  inline void set_colorMapEditorType(::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType value);

  /// @brief Method set_edgeColor, addr 0x28a202c, size 0x58, virtual false, abstract: false, final false
  inline void set_edgeColor(::UnityEngine::Color value);

  /// @brief Method set_edgeRenderingEnabled, addr 0x28a2000, size 0x20, virtual false, abstract: false, final false
  inline void set_edgeRenderingEnabled(bool value);

  /// @brief Method set_textureOpacity, addr 0x28a1fdc, size 0x1c, virtual false, abstract: false, final false
