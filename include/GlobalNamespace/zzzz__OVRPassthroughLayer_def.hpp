...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5d64584, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetStyleHandler, addr 0x5d648cc, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorLutHandler, addr 0x5d61990, size 0x58, virtual false, abstract: false, final false
  inline void SetColorLutHandler(::GlobalNamespace::OVRPassthroughColorLut* lut, float_t weight);

  /// @brief Method SetInterpolatedColorLutHandler, addr 0x5d61b10, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method SetMonoToMonoHandler, addr 0x5d61f00, size 0x5c, virtual false, abstract: false, final false
  inline void SetMonoToMonoHandler(::ArrayW<uint8_t, ::Array<uint8_t>*> values);

  /// @brief Method SetMonoToRgbaHandler, addr 0x5d61798, size 0x34, virtual false, abstract: false, final false
  inline void SetMonoToRgbaHandler(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> values);

  /// @brief Method SetStyleHandler, addr 0x5d6226c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d645a0, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyStyleSettings, addr 0x5d64ab0, size 0x4, virtual true, abstract: false, final true
  inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x5d64ab8, size 0x4, virtual true, abstract: false, final true
  inline void Clear();

  static inline ::GlobalNamespace::OVRPassthroughLayer_NoneStyleHandler* New_ctor();

  /// @brief Method Update, addr 0x5d64ab4, size 0x4, virtual true, abstract: false, final true
  inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings settings);

  /// @brief Method .ctor, addr 0x5d6489c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsValid, addr 0x5d64aa8, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsValid();
...
public:
  ...
  /// @brief Method AllocateColorMapData, addr 0x5d64b44, size 0xa0, virtual true, abstract: false, final false
  inline void AllocateColorMapData(uint32_t size);

  /// @brief Method ApplyStyleSettings, addr 0x5d64ad4, size 0x64, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x5d64b38, size 0xc, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method ComputeBrightnessContrastPosterizeMap, addr 0x5d64cb0, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method DeallocateColorMapData, addr 0x5d64be4, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5d64ad0, size 0x4, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings settings);

  /// @brief Method WriteColorToColorMap, addr 0x5d64c0c, size 0x6c, virtual false, abstract: false, final false
  inline void WriteColorToColorMap(int32_t colorIndex, ::ByRef<::UnityEngine::Color> color);

  /// @brief Method WriteFloatToColorMap, addr 0x5d64c78, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d64ac4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsValid, addr 0x5d64abc, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsValid();
...
public:
  ...
  /// @brief Method AllocateColorMapData, addr 0x5d64ef4, size 0x6c, virtual true, abstract: false, final false
  inline void AllocateColorMapData(uint32_t size);

  /// @brief Method DeallocateColorMapData, addr 0x5d64f60, size 0x2c, virtual true, abstract: false, final false
  inline void DeallocateColorMapData();
  ...
  /// @brief Method Update, addr 0x5d64e38, size 0xbc, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings settings);

  /// @brief Method Update, addr 0x5d649f0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d648b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle> colorMapDataHandler, ::ArrayW<uint8_t, ::Array<uint8_t>*> colorMapData);

  /// @brief Method get_MapSize, addr 0x5d64e30, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_MapSize();
...
public:
  ...
  /// @brief Method Update, addr 0x5d64f94, size 0x38, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings settings);

  /// @brief Method Update, addr 0x5d64a64, size 0x44, virtual false, abstract: false, final false
  inline void Update(::ArrayW<uint8_t, ::Array<uint8_t>*> values);

  /// @brief Method .ctor, addr 0x5d648a8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle> colorMapDataHandler, ::ArrayW<uint8_t, ::Array<uint8_t>*> colorMapData);

  /// @brief Method get_MapSize, addr 0x5d64f8c, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_MapSize();
...
public:
  ...
  /// @brief Method Update, addr 0x5d64fd4, size 0xb4, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings settings);

  /// @brief Method .ctor, addr 0x5d648c0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle> colorMapDataHandler, ::ArrayW<uint8_t, ::Array<uint8_t>*> colorMapData);

  /// @brief Method get_MapSize, addr 0x5d64fcc, size 0x8, virtual true, abstract: false, final false
  inline uint32_t get_MapSize();
...
public:
  ...
  /// @brief Method ApplyStyleSettings, addr 0x5d650b8, size 0x24, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x5d65294, size 0x8, virtual true, abstract: false, final false
  inline void Clear();

  /// @brief Method GetColorLutForTexture, addr 0x5d65130, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5d649ac, size 0x20, virtual false, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughColorLut* lut, float_t weight);

  /// @brief Method Update, addr 0x5d650dc, size 0x54, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings settings);
  ...
  /// @brief Method .ctor, addr 0x5d648a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsValid, addr 0x5d650a8, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsValid();

  /// @brief Method get_Lut, addr 0x5d65088, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPassthroughColorLut* get_Lut();

  /// @brief Method get_Weight, addr 0x5d65098, size 0x8, virtual false, abstract: false, final false
  inline float_t get_Weight();

  /// @brief Convert to "::GlobalNamespace::OVRPassthroughLayer_IStyleHandler"
  constexpr ::GlobalNamespace::OVRPassthroughLayer_IStyleHandler* i___GlobalNamespace__OVRPassthroughLayer_IStyleHandler() noexcept;

  /// @brief Method set_IsValid, addr 0x5d650b0, size 0x8, virtual false, abstract: false, final false
  inline void set_IsValid(bool value);

  /// @brief Method set_Lut, addr 0x5d65090, size 0x8, virtual false, abstract: false, final false
  inline void set_Lut(::GlobalNamespace::OVRPassthroughColorLut* value);

  /// @brief Method set_Weight, addr 0x5d650a0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyStyleSettings, addr 0x5d652ac, size 0x38, virtual true, abstract: false, final false
  inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2> style);

  /// @brief Method Clear, addr 0x5d6535c, size 0xc, virtual true, abstract: false, final false
  inline void Clear();

  static inline ::GlobalNamespace::OVRPassthroughLayer_InterpolatedColorLutHandler* New_ctor();

  /// @brief Method Update, addr 0x5d649cc, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Update, addr 0x5d652e4, size 0x78, virtual true, abstract: false, final false
  inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings settings);
  ...
  /// @brief Method .ctor, addr 0x5d648a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_LutTarget, addr 0x5d6529c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPassthroughColorLut* get_LutTarget();

  /// @brief Method set_LutTarget, addr 0x5d652a4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <IsSurfaceGeometry>b__0, addr 0x5d65368, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d613d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <RemoveSurfaceGeometry>b__0, addr 0x5d653d8, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d61264, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddDeferredSurfaceGeometries, addr 0x5d62348, size 0x2c4, virtual false, abstract: false, final false
  inline void AddDeferredSurfaceGeometries();

  /// @brief Method AddSurfaceGeometry, addr 0x5d60d98, size 0x230, virtual false, abstract: false, final false
  inline void AddSurfaceGeometry(::UnityEngine::GameObject* obj, bool updateTransform);

  /// @brief Method Awake, addr 0x5d63980, size 0x1e4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ClampWeight, addr 0x5d618e0, size 0xb0, virtual false, abstract: false, final false
  static inline float_t ClampWeight(float_t weight);

  /// @brief Method CreateAndAddMesh, addr 0x5d6260c, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNeutralColorMapGradient, addr 0x5d61d14, size 0x14c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Gradient* CreateNeutralColorMapGradient();

  /// @brief Method CreateOvrPluginStyleObject, addr 0x5d63cdc, size 0x138, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2 CreateOvrPluginStyleObject();

  /// @brief Method DestroySurfaceGeometries, addr 0x5d62bb4, size 0x2e4, virtual false, abstract: false, final false
  inline void DestroySurfaceGeometries(bool addBackToDeferredQueue);

  /// @brief Method DisableColorMap, addr 0x5d6225c, size 0x8, virtual false, abstract: false, final false
  inline void DisableColorMap();

  /// @brief Method GetTransformMatrixForPassthroughSurfaceObject, addr 0x5d628d0, size 0x2e4, virtual false, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 GetTransformMatrixForPassthroughSurfaceObject(::UnityEngine::Matrix4x4 worldFromObj);

  /// @brief Method HasControlsBasedColorMap, addr 0x5d63590, size 0x1c, virtual false, abstract: false, final false
  inline bool HasControlsBasedColorMap();

  /// @brief Method IsSurfaceGeometry, addr 0x5d61268, size 0x168, virtual false, abstract: false, final false
  inline bool IsSurfaceGeometry(::UnityEngine::GameObject* obj);

  /// @brief Method IsUserDefinedAndDoesNotContainSurfaceGeometry, addr 0x5d638d8, size 0x94, virtual false, abstract: false, final false
  inline bool IsUserDefinedAndDoesNotContainSurfaceGeometry();

  /// @brief Method LateUpdate, addr 0x5d63b68, size 0x174, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::OVRPassthroughLayer* New_ctor();

  /// @brief Method OnDestroy, addr 0x5d641a8, size 0x8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5d64078, size 0x130, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5d63e14, size 0x264, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnPassthroughLayerResumed, addr 0x5d641b0, size 0xe0, virtual false, abstract: false, final false
  inline void OnPassthroughLayerResumed(int32_t layerId);

  /// @brief Method RemoveSurfaceGeometry, addr 0x5d60fc8, size 0x29c, virtual false, abstract: false, final false
  inline void RemoveSurfaceGeometry(::UnityEngine::GameObject* obj);

  /// @brief Method SetBrightnessContrastSaturation, addr 0x5d61f5c, size 0x4c, virtual false, abstract: false, final false
  inline void SetBrightnessContrastSaturation(float_t brightness, float_t contrast, float_t saturation);

  /// @brief Method SetColorLut, addr 0x5d617cc, size 0x114, virtual false, abstract: false, final false
  inline void SetColorLut(::GlobalNamespace::OVRPassthroughColorLut* lut, float_t weight);

  /// @brief Method SetColorLut, addr 0x5d619e8, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorMap, addr 0x5d61610, size 0x9c, virtual false, abstract: false, final false
  inline void SetColorMap(::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> values);

  /// @brief Method SetColorMapControls, addr 0x5d61b70, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColorMapMonochromatic, addr 0x5d61e60, size 0xa0, virtual false, abstract: false, final false
  inline void SetColorMapMonochromatic(::ArrayW<uint8_t, ::Array<uint8_t>*> values);

  /// @brief Method SetStyleDirty, addr 0x5d6233c, size 0xc, virtual false, abstract: false, final false
  inline void SetStyleDirty();

  /// @brief Method SyncToOverlay, addr 0x5d635ac, size 0x32c, virtual false, abstract: false, final false
  inline void SyncToOverlay();

  /// @brief Method Update, addr 0x5d63b64, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateColorMapFromControls, addr 0x5d61fa8, size 0x2b4, virtual false, abstract: false, final false
  inline void UpdateColorMapFromControls(bool forceUpdate);

  /// @brief Method UpdateSurfaceGeometryTransform, addr 0x5d63444, size 0x14c, virtual false, abstract: false, final false
  inline void UpdateSurfaceGeometryTransform(uint64_t instanceHandle, ::UnityEngine::Matrix4x4 localToWorld);

  /// @brief Method UpdateSurfaceGeometryTransforms, addr 0x5d62e98, size 0x5ac, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d64290, size 0x2f4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_PassthroughLayerResumed, addr 0x5d614b8, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorMapEditorType, addr 0x5d62264, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType get_colorMapEditorType();

  /// @brief Method get_edgeColor, addr 0x5d6143c, size 0x14, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_edgeColor();

  /// @brief Method get_edgeRenderingEnabled, addr 0x5d61414, size 0x8, virtual false, abstract: false, final false
  inline bool get_edgeRenderingEnabled();

  /// @brief Method get_overlayShape, addr 0x5d6396c, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVROverlay_OverlayShape get_overlayShape();

  /// @brief Method get_textureOpacity, addr 0x5d613d4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_textureOpacity();

  /// @brief Method remove_PassthroughLayerResumed, addr 0x5d61564, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method set_colorMapEditorType, addr 0x5d616ac, size 0xec, virtual false, abstract: false, final false
  inline void set_colorMapEditorType(::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType value);

  /// @brief Method set_edgeColor, addr 0x5d61450, size 0x68, virtual false, abstract: false, final false
  inline void set_edgeColor(::UnityEngine::Color value);

  /// @brief Method set_edgeRenderingEnabled, addr 0x5d6141c, size 0x20, virtual false, abstract: false, final false
  inline void set_edgeRenderingEnabled(bool value);

  /// @brief Method set_textureOpacity, addr 0x5d613dc, size 0x38, virtual false, abstract: false, final false
