...
public:
// Declarations
/// @brief Method .ctor, addr 0x5cf259c, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Field _interpolatedLutHandler, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__interpolatedLutHandler, put=__cordl_internal_set__interpolatedLutHandler)) ::GlobalNamespace::OVRPassthroughLayer_InterpolatedColorLutHandler*  _interpolatedLutHandler;
...
/// @brief Method GetStyleHandler, addr 0x5cf28e4, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method SetColorLutHandler, addr 0x5cef9a8, size 0x58, virtual false, abstract: false, final false
inline void SetColorLutHandler(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetInterpolatedColorLutHandler, addr 0x5cefb28, size 0x60, virtual false, abstract: false, final false
...
/// @brief Method SetMonoToMonoHandler, addr 0x5ceff18, size 0x5c, virtual false, abstract: false, final false
inline void SetMonoToMonoHandler(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method SetMonoToRgbaHandler, addr 0x5cef7b0, size 0x34, virtual false, abstract: false, final false
inline void SetMonoToRgbaHandler(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetStyleHandler, addr 0x5cf0284, size 0xd0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5cf25b8, size 0x13c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method ApplyStyleSettings, addr 0x5cf2ac8, size 0x4, virtual true, abstract: false, final true
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x5cf2ad0, size 0x4, virtual true, abstract: false, final true
inline void Clear() ;

static inline ::GlobalNamespace::OVRPassthroughLayer_NoneStyleHandler* New_ctor() ;

/// @brief Method Update, addr 0x5cf2acc, size 0x4, virtual true, abstract: false, final true
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method .ctor, addr 0x5cf28b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsValid, addr 0x5cf2ac0, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;
...
/// @brief Method AllocateColorMapData, addr 0x5cf2b5c, size 0xa0, virtual true, abstract: false, final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method ApplyStyleSettings, addr 0x5cf2aec, size 0x64, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x5cf2b50, size 0xc, virtual true, abstract: false, final true
inline void Clear() ;

/// @brief Method ComputeBrightnessContrastPosterizeMap, addr 0x5cf2cc8, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method DeallocateColorMapData, addr 0x5cf2bfc, size 0x28, virtual true, abstract: false, final false
inline void DeallocateColorMapData() ;

static inline ::GlobalNamespace::OVRPassthroughLayer_BaseGeneratedStyleHandler* New_ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x5cf2ae8, size 0x4, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method WriteColorToColorMap, addr 0x5cf2c24, size 0x6c, virtual false, abstract: false, final false
inline void WriteColorToColorMap(int32_t  colorIndex, ::ByRef<::UnityEngine::Color>  color) ;

/// @brief Method WriteFloatToColorMap, addr 0x5cf2c90, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5cf2adc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_IsValid, addr 0x5cf2ad4, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;
...
/// @brief Method AllocateColorMapData, addr 0x5cf2f0c, size 0x6c, virtual true, abstract: false, final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method DeallocateColorMapData, addr 0x5cf2f78, size 0x2c, virtual true, abstract: false, final false
inline void DeallocateColorMapData() ;

static inline ::GlobalNamespace::OVRPassthroughLayer_MonoToRgbaStyleHandler* New_ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x5cf2e50, size 0xbc, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method Update, addr 0x5cf2a08, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5cf28cc, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x5cf2e48, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
static inline ::GlobalNamespace::OVRPassthroughLayer_MonoToMonoStyleHandler* New_ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x5cf2fac, size 0x38, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method Update, addr 0x5cf2a7c, size 0x44, virtual false, abstract: false, final false
inline void Update(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method .ctor, addr 0x5cf28c0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x5cf2fa4, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
static inline ::GlobalNamespace::OVRPassthroughLayer_BCSStyleHandler* New_ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update, addr 0x5cf2fec, size 0xb4, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;

/// @brief Method .ctor, addr 0x5cf28d8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method get_MapSize, addr 0x5cf2fe4, size 0x8, virtual true, abstract: false, final false
inline uint32_t get_MapSize() ;
...
/// @brief Method ApplyStyleSettings, addr 0x5cf30d0, size 0x24, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x5cf32ac, size 0x8, virtual true, abstract: false, final false
inline void Clear() ;

/// @brief Method GetColorLutForTexture, addr 0x5cf3148, size 0x164, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x5cf29c4, size 0x20, virtual false, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method Update, addr 0x5cf30f4, size 0x54, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;
...
/// @brief Method .ctor, addr 0x5cf28b8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsValid, addr 0x5cf30c0, size 0x8, virtual true, abstract: false, final true
inline bool get_IsValid() ;

/// @brief Method get_Lut, addr 0x5cf30a0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_Lut() ;

/// @brief Method get_Weight, addr 0x5cf30b0, size 0x8, virtual false, abstract: false, final false
inline float_t get_Weight() ;

/// @brief Convert to "::GlobalNamespace::OVRPassthroughLayer_IStyleHandler"
constexpr ::GlobalNamespace::OVRPassthroughLayer_IStyleHandler* i___GlobalNamespace__OVRPassthroughLayer_IStyleHandler() noexcept;

/// @brief Method set_IsValid, addr 0x5cf30c8, size 0x8, virtual false, abstract: false, final false
inline void set_IsValid(bool  value) ;

/// @brief Method set_Lut, addr 0x5cf30a8, size 0x8, virtual false, abstract: false, final false
inline void set_Lut(::GlobalNamespace::OVRPassthroughColorLut*  value) ;

/// @brief Method set_Weight, addr 0x5cf30b8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method ApplyStyleSettings, addr 0x5cf32c4, size 0x38, virtual true, abstract: false, final false
inline void ApplyStyleSettings(::ByRef<::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2>  style) ;

/// @brief Method Clear, addr 0x5cf3374, size 0xc, virtual true, abstract: false, final false
inline void Clear() ;

static inline ::GlobalNamespace::OVRPassthroughLayer_InterpolatedColorLutHandler* New_ctor() ;

/// @brief Method Update, addr 0x5cf29e4, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method Update, addr 0x5cf32fc, size 0x78, virtual true, abstract: false, final false
inline void Update(::GlobalNamespace::OVRPassthroughLayer_Settings  settings) ;
...
/// @brief Method .ctor, addr 0x5cf28bc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_LutTarget, addr 0x5cf32b4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_LutTarget() ;

/// @brief Method set_LutTarget, addr 0x5cf32bc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <IsSurfaceGeometry>b__0, addr 0x5cf3380, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5cef3e8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RemoveSurfaceGeometry>b__0, addr 0x5cf33f0, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5cef27c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Dependencies OVROverlay::OverlayType, OVRPassthroughLayer::ColorMapEditorType, OVRPassthroughLayer::ProjectionSurfaceType, OVRPassthroughLayer::Settings, OVRPlugin::InsightPassthroughColorMapType, UnityEngine.Color, UnityEngine.MonoBehaviour, UnityEngine.Vector4
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Field _editorToColorMapType, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__editorToColorMapType, put=setStaticF__editorToColorMapType)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType,::GlobalNamespace::OVRPlugin_InsightPassthroughColorMapType>*  _editorToColorMapType;
...
/// @brief Field deferredSurfaceGameObjects, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get_deferredSurfaceGameObjects, put=__cordl_internal_set_deferredSurfaceGameObjects)) ::System::Collections::Generic::List_1<::GlobalNamespace::OVRPassthroughLayer_DeferredPassthroughMeshAddition>*  deferredSurfaceGameObjects;
...
/// @brief Field passthroughLayerResumed, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_passthroughLayerResumed, put=__cordl_internal_set_passthroughLayerResumed)) ::UnityEngine::Events::UnityEvent_1<::UnityW<::GlobalNamespace::OVRPassthroughLayer>>*  passthroughLayerResumed;
...
/// @brief Field projectionSurfaceType, offset 0x20, size 0x4 
 __declspec(property(get=__cordl_internal_get_projectionSurfaceType, put=__cordl_internal_set_projectionSurfaceType)) ::GlobalNamespace::OVRPassthroughLayer_ProjectionSurfaceType  projectionSurfaceType;

/// @brief Field serializedSurfaceGeometry, offset 0xf8, size 0x8 
 __declspec(property(get=__cordl_internal_get_serializedSurfaceGeometry, put=__cordl_internal_set_serializedSurfaceGeometry)) ::System::Collections::Generic::List_1<::GlobalNamespace::OVRPassthroughLayer_SerializedSurfaceGeometry>*  serializedSurfaceGeometry;
...
/// @brief Field surfaceGameObjects, offset 0xe8, size 0x8 
 __declspec(property(get=__cordl_internal_get_surfaceGameObjects, put=__cordl_internal_set_surfaceGameObjects)) ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::OVRPassthroughLayer_PassthroughMeshInstance>*  surfaceGameObjects;
...
/// @brief Method AddDeferredSurfaceGeometries, addr 0x5cf0360, size 0x2c4, virtual false, abstract: false, final false
inline void AddDeferredSurfaceGeometries() ;

/// @brief Method AddSurfaceGeometry, addr 0x5ceedb0, size 0x230, virtual false, abstract: false, final false
inline void AddSurfaceGeometry(::UnityEngine::GameObject*  obj, bool  updateTransform) ;

/// @brief Method Awake, addr 0x5cf1998, size 0x1e4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method ClampWeight, addr 0x5cef8f8, size 0xb0, virtual false, abstract: false, final false
static inline float_t ClampWeight(float_t  weight) ;

/// @brief Method CreateAndAddMesh, addr 0x5cf0624, size 0x2c4, virtual false, abstract: false, final false
...
/// @brief Method CreateNeutralColorMapGradient, addr 0x5cefd2c, size 0x14c, virtual false, abstract: false, final false
static inline ::UnityEngine::Gradient* CreateNeutralColorMapGradient() ;

/// @brief Method CreateOvrPluginStyleObject, addr 0x5cf1cf4, size 0x138, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_InsightPassthroughStyle2 CreateOvrPluginStyleObject() ;

/// @brief Method DestroySurfaceGeometries, addr 0x5cf0bcc, size 0x2e4, virtual false, abstract: false, final false
inline void DestroySurfaceGeometries(bool  addBackToDeferredQueue) ;

/// @brief Method DisableColorMap, addr 0x5cf0274, size 0x8, virtual false, abstract: false, final false
inline void DisableColorMap() ;

/// @brief Method GetTransformMatrixForPassthroughSurfaceObject, addr 0x5cf08e8, size 0x2e4, virtual false, abstract: false, final false
inline ::UnityEngine::Matrix4x4 GetTransformMatrixForPassthroughSurfaceObject(::UnityEngine::Matrix4x4  worldFromObj) ;

/// @brief Method HasControlsBasedColorMap, addr 0x5cf15a8, size 0x1c, virtual false, abstract: false, final false
inline bool HasControlsBasedColorMap() ;

/// @brief Method IsSurfaceGeometry, addr 0x5cef280, size 0x168, virtual false, abstract: false, final false
inline bool IsSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method IsUserDefinedAndDoesNotContainSurfaceGeometry, addr 0x5cf18f0, size 0x94, virtual false, abstract: false, final false
inline bool IsUserDefinedAndDoesNotContainSurfaceGeometry() ;

/// @brief Method LateUpdate, addr 0x5cf1b80, size 0x174, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::OVRPassthroughLayer* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5cf21c0, size 0x8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x5cf2090, size 0x130, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5cf1e2c, size 0x264, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPassthroughLayerResumed, addr 0x5cf21c8, size 0xe0, virtual false, abstract: false, final false
inline void OnPassthroughLayerResumed(int32_t  layerId) ;

/// @brief Method RemoveSurfaceGeometry, addr 0x5ceefe0, size 0x29c, virtual false, abstract: false, final false
inline void RemoveSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method SetBrightnessContrastSaturation, addr 0x5ceff74, size 0x4c, virtual false, abstract: false, final false
inline void SetBrightnessContrastSaturation(float_t  brightness, float_t  contrast, float_t  saturation) ;

/// @brief Method SetColorLut, addr 0x5cef7e4, size 0x114, virtual false, abstract: false, final false
inline void SetColorLut(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetColorLut, addr 0x5cefa00, size 0x128, virtual false, abstract: false, final false
...
/// @brief Method SetColorMap, addr 0x5cef628, size 0x9c, virtual false, abstract: false, final false
inline void SetColorMap(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetColorMapControls, addr 0x5cefb88, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method SetColorMapMonochromatic, addr 0x5cefe78, size 0xa0, virtual false, abstract: false, final false
inline void SetColorMapMonochromatic(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method SetStyleDirty, addr 0x5cf0354, size 0xc, virtual false, abstract: false, final false
inline void SetStyleDirty() ;

/// @brief Method SyncToOverlay, addr 0x5cf15c4, size 0x32c, virtual false, abstract: false, final false
inline void SyncToOverlay() ;

/// @brief Method Update, addr 0x5cf1b7c, size 0x4, virtual false, abstract: false, final false
inline void Update() ;

/// @brief Method UpdateColorMapFromControls, addr 0x5ceffc0, size 0x2b4, virtual false, abstract: false, final false
inline void UpdateColorMapFromControls(bool  forceUpdate) ;

/// @brief Method UpdateSurfaceGeometryTransform, addr 0x5cf145c, size 0x14c, virtual false, abstract: false, final false
inline void UpdateSurfaceGeometryTransform(uint64_t  instanceHandle, ::UnityEngine::Matrix4x4  localToWorld) ;

/// @brief Method UpdateSurfaceGeometryTransforms, addr 0x5cf0eb0, size 0x5ac, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::OVRPassthroughLayer_PassthroughMeshInstance>* const& __cordl_internal_get_surfaceGameObjects() const;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::OVRPassthroughLayer_PassthroughMeshInstance>*& __cordl_internal_get_surfaceGameObjects() ;
...
constexpr void __cordl_internal_set_surfaceGameObjects(::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::GameObject>,::GlobalNamespace::OVRPassthroughLayer_PassthroughMeshInstance>*  value) ;

constexpr void __cordl_internal_set_textureOpacity_(float_t  value) ;

/// @brief Method .ctor, addr 0x5cf22a8, size 0x2f4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_PassthroughLayerResumed, addr 0x5cef4d0, size 0xac, virtual false, abstract: false, final false
inline void add_PassthroughLayerResumed(::System::Action*  value) ;

static inline ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType,::GlobalNamespace::OVRPlugin_InsightPassthroughColorMapType>* getStaticF__editorToColorMapType() ;

static inline ::UnityEngine::Gradient* getStaticF_colorMapNeutralGradient() ;

/// @brief Method get_colorMapEditorType, addr 0x5cf027c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType get_colorMapEditorType() ;

/// @brief Method get_edgeColor, addr 0x5cef454, size 0x14, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_edgeColor() ;

/// @brief Method get_edgeRenderingEnabled, addr 0x5cef42c, size 0x8, virtual false, abstract: false, final false
inline bool get_edgeRenderingEnabled() ;

/// @brief Method get_overlayShape, addr 0x5cf1984, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVROverlay_OverlayShape get_overlayShape() ;

/// @brief Method get_textureOpacity, addr 0x5cef3ec, size 0x8, virtual false, abstract: false, final false
inline float_t get_textureOpacity() ;

/// @brief Method remove_PassthroughLayerResumed, addr 0x5cef57c, size 0xac, virtual false, abstract: false, final false
inline void remove_PassthroughLayerResumed(::System::Action*  value) ;

static inline void setStaticF__editorToColorMapType(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType,::GlobalNamespace::OVRPlugin_InsightPassthroughColorMapType>*  value) ;

static inline void setStaticF_colorMapNeutralGradient(::UnityEngine::Gradient*  value) ;

/// @brief Method set_colorMapEditorType, addr 0x5cef6c4, size 0xec, virtual false, abstract: false, final false
inline void set_colorMapEditorType(::GlobalNamespace::OVRPassthroughLayer_ColorMapEditorType  value) ;

/// @brief Method set_edgeColor, addr 0x5cef468, size 0x68, virtual false, abstract: false, final false
inline void set_edgeColor(::UnityEngine::Color  value) ;

/// @brief Method set_edgeRenderingEnabled, addr 0x5cef434, size 0x20, virtual false, abstract: false, final false
inline void set_edgeRenderingEnabled(bool  value) ;

/// @brief Method set_textureOpacity, addr 0x5cef3f4, size 0x38, virtual false, abstract: false, final false
