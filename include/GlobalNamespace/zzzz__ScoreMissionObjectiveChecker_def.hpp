...
public:
  ...
  /// @brief Method OnDestroy addr 0x20eb8e0 size 0x108 virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleScoreDidChange addr 0x20eb9e8 size 0x48 virtual false final false
  inline void HandleScoreDidChange(int32_t multipliedScore, int32_t modifiedScore);

  /// @brief Method Init addr 0x20eba30 size 0x208 virtual true final false
  inline void Init();

  static inline ::GlobalNamespace::ScoreMissionObjectiveChecker* New_ctor();

  /// @brief Method .ctor addr 0x20ebc38 size 0x8 virtual false final false
  inline void _ctor();
