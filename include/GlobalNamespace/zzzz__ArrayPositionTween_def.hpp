...
/// @brief Method CreatePlayable, addr 0x57735bc, size 0x168, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5773724, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_clipCaps, addr 0x57735b4, size 0x8, virtual true, abstract: false, final true
