...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(5296)), TypeDefinitionIndex(TypeDefinitionIndex(8778)), TypeDefinitionIndex(TypeDefinitionIndex(9190)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8778), inst: 1721 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(5279)) CS Name: ::ArrayPositionTween*
...
public:
  ...
  /// @brief Method get_clipCaps, addr 0x234100c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method CreatePlayable, addr 0x2341014, size 0x144, virtual true, abstract: false, final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  static inline ::GlobalNamespace::ArrayPositionTween* New_ctor();

  /// @brief Method .ctor, addr 0x2341158, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
