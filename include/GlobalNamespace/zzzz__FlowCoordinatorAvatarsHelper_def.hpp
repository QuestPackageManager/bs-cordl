...
public:
  ...
  /// @brief Method <HasUserSelectedAvatarSystemWithCreatedAvatar>b__0, addr 0x263fde4, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263fddc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x263fea0, size 0x3b4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x2640254, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method HasUserSelectedAvatarSystemWithCreatedAvatar, addr 0x263f820, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263fdd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
