...
// Write type traits
MARK_REF_T(::GlobalNamespace::FlowCoordinatorAvatarsHelper*);
MARK_REF_T(::GlobalNamespace::FlowCoordinatorAvatarsHelper___c__DisplayClass0_0*);
MARK_VAL_T(::GlobalNamespace::FlowCoordinatorAvatarsHelper__HasUserSelectedAvatarSystemWithCreatedAvatar_d__0);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FlowCoordinatorAvatarsHelper*, "", "FlowCoordinatorAvatarsHelper");
...
public:
  ...
  /// @brief Method <HasUserSelectedAvatarSystemWithCreatedAvatar>b__0, addr 0x5a026d4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a026d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a02798, size 0x418, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5a02bb0, size 0x80, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::FlowCoordinatorAvatarsHelper__HasUserSelectedAvatarSystemWithCreatedAvatar_d__0) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method HasUserSelectedAvatarSystemWithCreatedAvatar, addr 0x5a025d4, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a026cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::FlowCoordinatorAvatarsHelper) == 0x10, "Size mismatch!");
