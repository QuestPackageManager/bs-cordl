...
public:
  ...
  /// @brief Method <HasUserSelectedAvatarSystemWithCreatedAvatar>b__0, addr 0x251c85c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251c854, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x251c918, size 0x3b4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x251cccc, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method HasUserSelectedAvatarSystemWithCreatedAvatar, addr 0x251c298, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x251c84c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
