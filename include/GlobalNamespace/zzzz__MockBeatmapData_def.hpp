...
// Write type traits
MARK_REF_T(::GlobalNamespace::MockBeatmapData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MockBeatmapData*, "", "MockBeatmapData");
// Dependencies MockNoteData, MockObstacleData, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__bombNotes_k__BackingField, put = __cordl_internal_set__bombNotes_k__BackingField)) ::ArrayW<::GlobalNamespace::MockNoteData*>
      _bombNotes_k__BackingField;

  /// @brief Field <leftNotes>k__BackingField, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get__leftNotes_k__BackingField, put = __cordl_internal_set__leftNotes_k__BackingField)) ::ArrayW<::GlobalNamespace::MockNoteData*>
  ...
  __declspec(property(get = __cordl_internal_get__obstacles_k__BackingField, put = __cordl_internal_set__obstacles_k__BackingField)) ::ArrayW<::GlobalNamespace::MockObstacleData*>
      _obstacles_k__BackingField;

  /// @brief Field <rightNotes>k__BackingField, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__rightNotes_k__BackingField, put = __cordl_internal_set__rightNotes_k__BackingField)) ::ArrayW<::GlobalNamespace::MockNoteData*>
  ...
  __declspec(property(get = get_bombNotes, put = set_bombNotes)) ::ArrayW<::GlobalNamespace::MockNoteData*> bombNotes;

  __declspec(property(get = get_leftNotes, put = set_leftNotes)) ::ArrayW<::GlobalNamespace::MockNoteData*> leftNotes;

  __declspec(property(get = get_numberOfLines, put = set_numberOfLines)) int32_t numberOfLines;

  __declspec(property(get = get_obstacles, put = set_obstacles)) ::ArrayW<::GlobalNamespace::MockObstacleData*> obstacles;

  __declspec(property(get = get_rightNotes, put = set_rightNotes)) ::ArrayW<::GlobalNamespace::MockNoteData*> rightNotes;
  ...
  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*> const& __cordl_internal_get__bombNotes_k__BackingField() const;

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*>& __cordl_internal_get__bombNotes_k__BackingField();

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*> const& __cordl_internal_get__leftNotes_k__BackingField() const;

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*>& __cordl_internal_get__leftNotes_k__BackingField();
  ...
  constexpr ::ArrayW<::GlobalNamespace::MockObstacleData*> const& __cordl_internal_get__obstacles_k__BackingField() const;

  constexpr ::ArrayW<::GlobalNamespace::MockObstacleData*>& __cordl_internal_get__obstacles_k__BackingField();

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*> const& __cordl_internal_get__rightNotes_k__BackingField() const;

  constexpr ::ArrayW<::GlobalNamespace::MockNoteData*>& __cordl_internal_get__rightNotes_k__BackingField();
  ...
  constexpr void __cordl_internal_set__bombNotes_k__BackingField(::ArrayW<::GlobalNamespace::MockNoteData*> value);

  constexpr void __cordl_internal_set__leftNotes_k__BackingField(::ArrayW<::GlobalNamespace::MockNoteData*> value);

  constexpr void __cordl_internal_set__numberOfLines_k__BackingField(int32_t value);

  constexpr void __cordl_internal_set__obstacles_k__BackingField(::ArrayW<::GlobalNamespace::MockObstacleData*> value);

  constexpr void __cordl_internal_set__rightNotes_k__BackingField(::ArrayW<::GlobalNamespace::MockNoteData*> value);
...
static_assert(sizeof(::GlobalNamespace::MockBeatmapData) == 0x38, "Size mismatch!");
