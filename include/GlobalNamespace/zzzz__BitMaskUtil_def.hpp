...
public:
  // Declarations
  /// @brief Method NumberOfSetBits, addr 0x31c4e38, size 0x14, virtual false, abstract: false, final false
  static inline uint32_t NumberOfSetBits(uint32_t i);

  /// @brief Method NumberOfSetBits, addr 0x31cc5e4, size 0x30, virtual false, abstract: false, final false
  static inline uint32_t NumberOfSetBits(uint64_t i);

  /// @brief Method ShiftLeft, addr 0x31cc614, size 0x44, virtual false, abstract: false, final false
  static inline uint64_t ShiftLeft(::ByRef<uint64_t> value, ::ByRef<int32_t> shift);

  /// @brief Method ShiftRight, addr 0x31cc658, size 0x5c, virtual false, abstract: false, final false
