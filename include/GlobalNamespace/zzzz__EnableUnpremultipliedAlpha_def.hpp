...
/// @brief Method Start, addr 0x5882678, size 0x58, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method .ctor, addr 0x58826d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
