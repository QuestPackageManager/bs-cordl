...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnableUnpremultipliedAlpha*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnableUnpremultipliedAlpha*, "", "EnableUnpremultipliedAlpha");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnableUnpremultipliedAlpha", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnableUnpremultipliedAlpha(EnableUnpremultipliedAlpha&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnableUnpremultipliedAlpha", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnableUnpremultipliedAlpha(EnableUnpremultipliedAlphaconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::EnableUnpremultipliedAlpha) == 0x20, "Size mismatch!");
