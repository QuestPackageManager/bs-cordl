...
public:
  ...
  /// @brief Method Start, addr 0x58f45e4, size 0x58, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method .ctor, addr 0x58f463c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
