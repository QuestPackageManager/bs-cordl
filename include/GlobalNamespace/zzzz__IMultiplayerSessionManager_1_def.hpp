...
public:
  ...
  IMultiplayerSessionManager_1_IMultiplayerSessionInitializer(IMultiplayerSessionManager_1_IMultiplayerSessionInitializerconst&) = delete;
...
public:
  ...
  // @brief delete copy ctor to prevent accidental deref copies
  IMultiplayerSessionManager_1(IMultiplayerSessionManager_1const&) = delete;
