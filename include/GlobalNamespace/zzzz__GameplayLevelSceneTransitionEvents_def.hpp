...
public:
  ...
  /// @brief Method Finalize, addr 0x57edbf4, size 0x1fc, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleMissionLevelDidFinish, addr 0x57ee160, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerLevelDidDisconnect, addr 0x57ee144, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerLevelDidFinish, addr 0x57ee128, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleStandardLevelDidFinish, addr 0x57ee0f0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeAnyGameplayLevelDidFinish, addr 0x57ee10c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ed728, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO* standardLevelScenesTransitionSetupData,
                    ::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO* missionLevelScenesTransitionSetupData,
                    ::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO* multiplayerLevelScenesTransitionSetupData);

  /// @brief Method add_anyGameplayLevelDidFinishEvent, addr 0x57ed5d0, size 0xac, virtual false, abstract: false, final false
  inline void add_anyGameplayLevelDidFinishEvent(::System::Action* value);

  /// @brief Method remove_anyGameplayLevelDidFinishEvent, addr 0x57ed67c, size 0xac, virtual false, abstract: false, final false
