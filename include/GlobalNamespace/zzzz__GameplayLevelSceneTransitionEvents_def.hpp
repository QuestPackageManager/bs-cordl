...
public:
  ...
  /// @brief Method Finalize, addr 0x577d244, size 0x1fc, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method HandleMissionLevelDidFinish, addr 0x577d7b0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerLevelDidDisconnect, addr 0x577d794, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMultiplayerLevelDidFinish, addr 0x577d778, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleStandardLevelDidFinish, addr 0x577d740, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method InvokeAnyGameplayLevelDidFinish, addr 0x577d75c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x577cd78, size 0x1cc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO* standardLevelScenesTransitionSetupData,
                    ::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO* missionLevelScenesTransitionSetupData,
                    ::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO* multiplayerLevelScenesTransitionSetupData);

  /// @brief Method add_anyGameplayLevelDidFinishEvent, addr 0x577cc20, size 0xac, virtual false, abstract: false, final false
  inline void add_anyGameplayLevelDidFinishEvent(::System::Action* value);

  /// @brief Method remove_anyGameplayLevelDidFinishEvent, addr 0x577cccc, size 0xac, virtual false, abstract: false, final false
