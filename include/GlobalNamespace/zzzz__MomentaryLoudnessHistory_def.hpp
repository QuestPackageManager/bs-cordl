...
/// @brief Method Add, addr 0x57081c0, size 0x50, virtual false, abstract: false, final false
inline void Add(float_t  momentaryLoudness) ;

/// @brief Method GetAverageLoudness, addr 0x5708244, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5708380, size 0x60, virtual false, abstract: false, final false
