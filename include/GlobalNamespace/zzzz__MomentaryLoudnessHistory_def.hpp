...
public:
  ...
  /// @brief Method Add, addr 0x3ac8f7c, size 0x50, virtual false, abstract: false, final false
  inline void Add(float_t momentaryLoudness);

  /// @brief Method GetAverageLoudness, addr 0x3ac9000, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ac914c, size 0x68, virtual false, abstract: false, final false
