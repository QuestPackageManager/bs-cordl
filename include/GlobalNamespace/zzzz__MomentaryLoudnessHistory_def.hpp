...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MomentaryLoudnessHistory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MomentaryLoudnessHistory(MomentaryLoudnessHistory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MomentaryLoudnessHistory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MomentaryLoudnessHistory(MomentaryLoudnessHistoryconst&) = delete;
