...
public:
  ...
  /// @brief Method Add, addr 0x56a7790, size 0x50, virtual false, abstract: false, final false
  inline void Add(float_t momentaryLoudness);

  /// @brief Method GetAverageLoudness, addr 0x56a7814, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56a7950, size 0x60, virtual false, abstract: false, final false
