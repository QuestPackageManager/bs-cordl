...
public:
  ...
  /// @brief Method AddColor, addr 0x5818404, size 0xa0, virtual false, abstract: false, final false
  inline void AddColor(::UnityEngine::Color color);

  /// @brief Method Awake, addr 0x5818324, size 0xc8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DiscardUpcomingColor, addr 0x58184a4, size 0xc, virtual false, abstract: false, final false
  inline void DiscardUpcomingColor();

  static inline ::GlobalNamespace::PreviousColorPanelController* New_ctor();

  /// @brief Method OnDestroy, addr 0x58183ec, size 0x18, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method <Awake>b__9_0, addr 0x58184c0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58184b0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorWasSelectedEvent, addr 0x58181a4, size 0xc0, virtual false, abstract: false, final false
  inline void add_colorWasSelectedEvent(::System::Action_1<::UnityEngine::Color>* value);

  /// @brief Method remove_colorWasSelectedEvent, addr 0x5818264, size 0xc0, virtual false, abstract: false, final false
