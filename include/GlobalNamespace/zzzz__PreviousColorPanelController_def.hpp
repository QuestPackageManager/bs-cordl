...
public:
  ...
  /// @brief Method AddColor, addr 0x3c2b1cc, size 0xa4, virtual false, abstract: false, final false
  inline void AddColor(::UnityEngine::Color color);

  /// @brief Method Awake, addr 0x3c2b0f0, size 0xc0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DiscardUpcomingColor, addr 0x3c2b270, size 0xc, virtual false, abstract: false, final false
  inline void DiscardUpcomingColor();

  static inline ::GlobalNamespace::PreviousColorPanelController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3c2b1b0, size 0x1c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method <Awake>b__9_0, addr 0x3c2b290, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c2b27c, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorWasSelectedEvent, addr 0x3c2af90, size 0xb0, virtual false, abstract: false, final false
  inline void add_colorWasSelectedEvent(::System::Action_1<::UnityEngine::Color>* value);

  /// @brief Method remove_colorWasSelectedEvent, addr 0x3c2b040, size 0xb0, virtual false, abstract: false, final false
