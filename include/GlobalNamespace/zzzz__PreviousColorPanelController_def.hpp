...
/// @brief Method AddColor, addr 0x587f074, size 0xa0, virtual false, abstract: false, final false
inline void AddColor(::UnityEngine::Color  color) ;

/// @brief Method Awake, addr 0x587ef94, size 0xc8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method DiscardUpcomingColor, addr 0x587f114, size 0xc, virtual false, abstract: false, final false
inline void DiscardUpcomingColor() ;

static inline ::GlobalNamespace::PreviousColorPanelController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x587f05c, size 0x18, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method <Awake>b__9_0, addr 0x587f130, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x587f120, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_colorWasSelectedEvent, addr 0x587ee14, size 0xc0, virtual false, abstract: false, final false
inline void add_colorWasSelectedEvent(::System::Action_1<::UnityEngine::Color>*  value) ;

/// @brief Method remove_colorWasSelectedEvent, addr 0x587eed4, size 0xc0, virtual false, abstract: false, final false
