...
public:
  ...
  /// @brief Method FailStopSong, addr 0x3bfd694, size 0x118, virtual false, abstract: false, final false
  inline void FailStopSong();

  /// @brief Method LateUpdate, addr 0x3bfd528, size 0x74, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::GameSongController* New_ctor();

  /// @brief Method PauseSong, addr 0x3bfd634, size 0x30, virtual true, abstract: false, final false
  inline void PauseSong();

  /// @brief Method ResumeSong, addr 0x3bfd664, size 0x30, virtual true, abstract: false, final false
  inline void ResumeSong();

  /// @brief Method SeekTo, addr 0x3bfd7ac, size 0x1c, virtual true, abstract: false, final true
  inline void SeekTo(float_t songTime);

  /// @brief Method StartSong, addr 0x3bfd5b8, size 0x44, virtual true, abstract: false, final true
  inline void StartSong(float_t songTimeOffset);

  /// @brief Method StopSong, addr 0x3bfd618, size 0x1c, virtual true, abstract: false, final false
  inline void StopSong();

  /// @brief Method <FailStopSong>b__16_0, addr 0x3bfd7d8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bfd7c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_songFailedToLoad, addr 0x3bfd50c, size 0x1c, virtual true, abstract: false, final true
  inline bool get_songFailedToLoad();

  /// @brief Method get_songLength, addr 0x3bfd4d4, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_songLength();

  /// @brief Method get_waitUntilIsReadyToStartTheSong, addr 0x3bfd4f0, size 0x1c, virtual true, abstract: false, final true
