...
public:
  ...
  /// @brief Method FailStopSong, addr 0x3beb184, size 0x118, virtual false, abstract: false, final false
  inline void FailStopSong();

  /// @brief Method LateUpdate, addr 0x3beb018, size 0x74, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::GameSongController* New_ctor();

  /// @brief Method PauseSong, addr 0x3beb124, size 0x30, virtual true, abstract: false, final false
  inline void PauseSong();

  /// @brief Method ResumeSong, addr 0x3beb154, size 0x30, virtual true, abstract: false, final false
  inline void ResumeSong();

  /// @brief Method SeekTo, addr 0x3beb29c, size 0x1c, virtual true, abstract: false, final true
  inline void SeekTo(float_t songTime);

  /// @brief Method StartSong, addr 0x3beb0a8, size 0x44, virtual true, abstract: false, final true
  inline void StartSong(float_t songTimeOffset);

  /// @brief Method StopSong, addr 0x3beb108, size 0x1c, virtual true, abstract: false, final false
  inline void StopSong();

  /// @brief Method <FailStopSong>b__16_0, addr 0x3beb2c8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3beb2b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_songFailedToLoad, addr 0x3beaffc, size 0x1c, virtual true, abstract: false, final true
  inline bool get_songFailedToLoad();

  /// @brief Method get_songLength, addr 0x3beafc4, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_songLength();

  /// @brief Method get_waitUntilIsReadyToStartTheSong, addr 0x3beafe0, size 0x1c, virtual true, abstract: false, final true
