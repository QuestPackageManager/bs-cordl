...
public:
  ...
  /// @brief Method Reset, addr 0x22e0f2c, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x22e0e0c, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22e0da4, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t window);

  /// @brief Method get_currentAverage, addr 0x22e0d8c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_currentAverage();

  /// @brief Method get_hasValue, addr 0x22e0d94, size 0x10, virtual false, abstract: false, final false
