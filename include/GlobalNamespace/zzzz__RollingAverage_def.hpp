...
public:
  ...
  /// @brief Method Reset, addr 0x328128c, size 0x10, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x326ede8, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x326efa0, size 0x60, virtual false, abstract: false, final false
  inline void _ctor(int32_t window);

  /// @brief Method get_currentAverage, addr 0x3281274, size 0x8, virtual false, abstract: false, final false
  inline float_t get_currentAverage();

  /// @brief Method get_hasValue, addr 0x328127c, size 0x10, virtual false, abstract: false, final false
