...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0::*)()>(&::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5773140;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0::*)(::UnityEngine::Timeline::IMarker*)>(&::GlobalNamespace::TimelineExtensions___c__DisplayClass0_0::_JumpToTimelineMarker_b__0)> {
  constexpr static std::size_t size = 0x38;
  constexpr static std::size_t addrs = 0x5773144;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Playables::PlayableDirector*, ::System::Type*)>(&::GlobalNamespace::TimelineExtensions::JumpToTimelineMarker)> {
  ...
  constexpr static std::size_t addrs = 0x5772f6c;
