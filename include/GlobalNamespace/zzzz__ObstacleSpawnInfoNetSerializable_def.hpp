...
public:
  ...
  /// @brief Method Deserialize, addr 0x36bc638, size 0x130, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x36bc3d4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x36bc368, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ObstacleSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x36bc4ac, size 0x18c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36bc454, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
