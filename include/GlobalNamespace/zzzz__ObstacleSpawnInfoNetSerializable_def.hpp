...
public:
  ...
  /// @brief Method Deserialize, addr 0x150c020, size 0x118, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x150bda4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x150bd40, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ObstacleSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x150bf1c, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x150bec4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
