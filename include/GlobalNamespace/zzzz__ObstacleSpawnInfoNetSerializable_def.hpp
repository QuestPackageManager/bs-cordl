...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(14906)), TypeDefinitionIndex(TypeDefinitionIndex(14912)), TypeDefinitionIndex(TypeDefinitionIndex(15144))]
...
public:
  ...
  /// @brief Method Obtain, addr 0x133b080, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::ObstacleSpawnInfoNetSerializable* Obtain();

  /// @brief Method Init, addr 0x133b0e4, size 0x120, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133b204, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Serialize, addr 0x133b25c, size 0x104, virtual true, abstract: false, final false
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize, addr 0x133b360, size 0x118, virtual true, abstract: false, final false
