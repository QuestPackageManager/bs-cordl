...
public:
  ...
  /// @brief Method get_IsDataHighConfidence, addr 0x4048da0, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x4048d8c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_RootScale, addr 0x4048d7c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_RootScale();

  /// @brief Method get_ShouldUseSystemGestureMaterial, addr 0x4048db4, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldUseSystemGestureMaterial();

  /// @brief Method set_IsDataHighConfidence, addr 0x4048da8, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x4048d94, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_RootScale, addr 0x4048d84, size 0x8, virtual false, abstract: false, final false
  inline void set_RootScale(float_t value);

  /// @brief Method set_ShouldUseSystemGestureMaterial, addr 0x4048dbc, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Update, addr 0x40486e4, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4048188, size 0x1d8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Update, addr 0x40488bc, size 0x320, virtual false, abstract: false, final false
  inline void Update(float_t scale, bool shouldRender, bool shouldUseSystemGestureMaterial, ::GlobalNamespace::OVRSkeletonRenderer_ConfidenceBehavior confidenceBehavior,
                     ::GlobalNamespace::OVRSkeletonRenderer_SystemGestureBehavior systemGestureBehavior);
  ...
  /// @brief Method .ctor, addr 0x4048360, size 0x1c0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x40478a4, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Initialize, addr 0x4047a3c, size 0x74c, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::OVRSkeletonRenderer* New_ctor();

  /// @brief Method OnDestroy, addr 0x4048bdc, size 0x12c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ShouldInitialize, addr 0x4047a08, size 0x34, virtual false, abstract: false, final false
  inline bool ShouldInitialize();

  /// @brief Method Start, addr 0x404795c, size 0xac, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x4048520, size 0x1c4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x4048d08, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityEngine::Quaternion getStaticF__capsuleRotationOffset();

  /// @brief Method get_IsDataHighConfidence, addr 0x404787c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataHighConfidence();

  /// @brief Method get_IsDataValid, addr 0x4047868, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsDataValid();

  /// @brief Method get_IsInitialized, addr 0x4047854, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_ShouldUseSystemGestureMaterial, addr 0x4047890, size 0x8, virtual false, abstract: false, final false
  inline bool get_ShouldUseSystemGestureMaterial();

  static inline void setStaticF__capsuleRotationOffset(::UnityEngine::Quaternion value);

  /// @brief Method set_IsDataHighConfidence, addr 0x4047884, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataHighConfidence(bool value);

  /// @brief Method set_IsDataValid, addr 0x4047870, size 0xc, virtual false, abstract: false, final false
  inline void set_IsDataValid(bool value);

  /// @brief Method set_IsInitialized, addr 0x404785c, size 0xc, virtual false, abstract: false, final false
  inline void set_IsInitialized(bool value);

  /// @brief Method set_ShouldUseSystemGestureMaterial, addr 0x4047898, size 0xc, virtual false, abstract: false, final false
  inline void set_ShouldUseSystemGestureMaterial(bool value);
