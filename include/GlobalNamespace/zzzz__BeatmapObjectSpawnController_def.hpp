...
public:
  ...
  /// @brief Method .ctor, addr 0x3ae7974, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleNoteDataCallback, addr 0x3ae72fc, size 0xf8, virtual false, abstract: false, final false
  inline void HandleNoteDataCallback(::GlobalNamespace::NoteData* noteData);

  /// @brief Method HandleObstacleDataCallback, addr 0x3ae74b8, size 0xf0, virtual false, abstract: false, final false
  inline void HandleObstacleDataCallback(::GlobalNamespace::ObstacleData* obstacleData);

  /// @brief Method HandleSliderDataCallback, addr 0x3ae76f4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3ae72a8, size 0x54, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3ae6ab4, size 0x7e0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopSpawning, addr 0x3ae78b0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ae78bc, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didInitEvent, addr 0x3ae697c, size 0x9c, virtual false, abstract: false, final false
  inline void add_didInitEvent(::System::Action* value);

  /// @brief Method get_beatmapObjectSpawnMovementData, addr 0x3ae68f8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapObjectSpawnMovementData* get_beatmapObjectSpawnMovementData();

  /// @brief Method get_isInitialized, addr 0x3ae6974, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInitialized();

  /// @brief Method get_noteLinesCount, addr 0x3ae6900, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_noteLinesCount();

  /// @brief Method get_noteLinesDistance, addr 0x3ae691c, size 0x20, virtual false, abstract: false, final false
  inline float_t get_noteLinesDistance();

  /// @brief Method get_verticalLayerDistance, addr 0x3ae6948, size 0x20, virtual false, abstract: false, final false
  inline float_t get_verticalLayerDistance();

  /// @brief Method remove_didInitEvent, addr 0x3ae6a18, size 0x9c, virtual false, abstract: false, final false
