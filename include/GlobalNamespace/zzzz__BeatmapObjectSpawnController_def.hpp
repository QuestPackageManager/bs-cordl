...
public:
  ...
  /// @brief Method .ctor, addr 0x3ae0dd0, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleNoteDataCallback, addr 0x3ae0758, size 0xf8, virtual false, abstract: false, final false
  inline void HandleNoteDataCallback(::GlobalNamespace::NoteData* noteData);

  /// @brief Method HandleObstacleDataCallback, addr 0x3ae0914, size 0xf0, virtual false, abstract: false, final false
  inline void HandleObstacleDataCallback(::GlobalNamespace::ObstacleData* obstacleData);

  /// @brief Method HandleSliderDataCallback, addr 0x3ae0b50, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3ae0704, size 0x54, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3adff10, size 0x7e0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopSpawning, addr 0x3ae0d0c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ae0d18, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didInitEvent, addr 0x3adfdd8, size 0x9c, virtual false, abstract: false, final false
  inline void add_didInitEvent(::System::Action* value);

  /// @brief Method get_beatmapObjectSpawnMovementData, addr 0x3adfd54, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapObjectSpawnMovementData* get_beatmapObjectSpawnMovementData();

  /// @brief Method get_isInitialized, addr 0x3adfdd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInitialized();

  /// @brief Method get_noteLinesCount, addr 0x3adfd5c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_noteLinesCount();

  /// @brief Method get_noteLinesDistance, addr 0x3adfd78, size 0x20, virtual false, abstract: false, final false
  inline float_t get_noteLinesDistance();

  /// @brief Method get_verticalLayerDistance, addr 0x3adfda4, size 0x20, virtual false, abstract: false, final false
  inline float_t get_verticalLayerDistance();

  /// @brief Method remove_didInitEvent, addr 0x3adfe74, size 0x9c, virtual false, abstract: false, final false
