...
public:
  ...
  /// @brief Method .ctor, addr 0x58ccfd8, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleNoteDataCallback, addr 0x58cc88c, size 0xf8, virtual false, abstract: false, final false
  inline void HandleNoteDataCallback(::GlobalNamespace::NoteData* noteData);

  /// @brief Method HandleObstacleDataCallback, addr 0x58cca78, size 0xf4, virtual false, abstract: false, final false
  inline void HandleObstacleDataCallback(::GlobalNamespace::ObstacleData* obstacleData);

  /// @brief Method HandleSliderDataCallback, addr 0x58cccfc, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58cc838, size 0x54, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x58cc048, size 0x7dc, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StopSpawning, addr 0x58ccf20, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ccf2c, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didInitEvent, addr 0x58cbef0, size 0xac, virtual false, abstract: false, final false
  inline void add_didInitEvent(::System::Action* value);

  /// @brief Method get_beatmapObjectSpawnMovementData, addr 0x58cbe78, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapObjectSpawnMovementData* get_beatmapObjectSpawnMovementData();

  /// @brief Method get_isInitialized, addr 0x58cbee8, size 0x8, virtual false, abstract: false, final false
  inline bool get_isInitialized();

  /// @brief Method get_noteLinesCount, addr 0x58cbe80, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_noteLinesCount();

  /// @brief Method get_noteLinesDistance, addr 0x58cbe98, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_noteLinesDistance();

  /// @brief Method get_verticalLayerDistance, addr 0x58cbec0, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_verticalLayerDistance();

  /// @brief Method remove_didInitEvent, addr 0x58cbf9c, size 0xac, virtual false, abstract: false, final false
