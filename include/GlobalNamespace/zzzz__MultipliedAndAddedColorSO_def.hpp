...
public:
  ...
  /// @brief Method .ctor, addr 0x269eaf8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x269ea90, size 0x68, virtual true, abstract: false, final false
