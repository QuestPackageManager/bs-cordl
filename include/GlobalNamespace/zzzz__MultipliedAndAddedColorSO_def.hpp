...
public:
  ...
  /// @brief Method .ctor, addr 0x26a25a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x26a2540, size 0x68, virtual true, abstract: false, final false
