...
public:
  ...
  /// @brief Method .ctor, addr 0x3638d98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x3638d38, size 0x60, virtual true, abstract: false, final false
