...
public:
  ...
  /// @brief Method AdjustPlatformSettings, addr 0x226b670, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateInstanceWithCurrentPlatformPreset, addr 0x226e268, size 0x8c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SettingsManager* CreateInstanceWithCurrentPlatformPreset();

  /// @brief Method CreateUninitialized, addr 0x226e214, size 0x54, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SettingsManager* CreateUninitialized();

  /// @brief Method GetCurrentPlatformPreset, addr 0x226e2f4, size 0x10, virtual false, abstract: false, final false
  static inline ::ByRef<::BeatSaber::Settings::Settings> GetCurrentPlatformPreset();

  /// @brief Method GetPlatformPreset, addr 0x226b3c4, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226e20c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
