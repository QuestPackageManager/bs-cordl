...
/// @brief Method AdjustPlatformSettings, addr 0x31bed0c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method CreateInstanceWithCurrentPlatformPreset, addr 0x31c1b48, size 0x70, virtual false, abstract: false, final false
static inline ::GlobalNamespace::SettingsManager* CreateInstanceWithCurrentPlatformPreset() ;

/// @brief Method CreateUninitialized, addr 0x31c1b04, size 0x44, virtual false, abstract: false, final false
static inline ::GlobalNamespace::SettingsManager* CreateUninitialized() ;

/// @brief Method GetCurrentPlatformPreset, addr 0x31c1bb8, size 0x10, virtual false, abstract: false, final false
static inline ::ByRef<::BeatSaber::Settings::Settings> GetCurrentPlatformPreset() ;

/// @brief Method GetPlatformPreset, addr 0x31beafc, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31c1b00, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
