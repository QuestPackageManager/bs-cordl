...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SettingsManager", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SettingsManager(SettingsManager&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SettingsManager", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SettingsManager(SettingsManagerconst&) = delete;
