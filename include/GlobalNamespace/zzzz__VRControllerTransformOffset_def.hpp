...
public:
  ...
  /// @brief Method .ctor, addr 0x23e3444, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_poseOffset, addr 0x23e2e28, size 0xb0, virtual false, abstract: false, final false
