...
public:
  ...
  /// @brief Method .ctor, addr 0x22c3f10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_poseOffset, addr 0x22c38f4, size 0xb0, virtual false, abstract: false, final false
