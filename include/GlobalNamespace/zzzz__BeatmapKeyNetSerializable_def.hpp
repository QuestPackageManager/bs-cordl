...
public:
  ...
  /// @brief Method get_levelID, addr 0x1335e44, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_levelID();

  /// @brief Method set_levelID, addr 0x1335e4c, size 0x8, virtual false, abstract: false, final false
  inline void set_levelID(::StringW value);

  /// @brief Method get_beatmapCharacteristicSerializedName, addr 0x1335e54, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_beatmapCharacteristicSerializedName();

  /// @brief Method set_beatmapCharacteristicSerializedName, addr 0x1335e5c, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapCharacteristicSerializedName(::StringW value);

  /// @brief Method get_difficulty, addr 0x1335e64, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method set_difficulty, addr 0x1335e6c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1335e74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method .ctor, addr 0x1335e7c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method LiteNetLib.Utils.INetSerializable.Deserialize, addr 0x1335eb8, size 0x50, virtual true, abstract: false, final true
  inline void LiteNetLib_Utils_INetSerializable_Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method LiteNetLib.Utils.INetSerializable.Serialize, addr 0x1335f18, size 0x4c, virtual true, abstract: false, final true
  inline void LiteNetLib_Utils_INetSerializable_Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Equals, addr 0x1335f6c, size 0x70, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BeatmapKeyNetSerializable* other);

  /// @brief Method Equals, addr 0x1335fdc, size 0x10c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x13360e8, size 0x64, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x133614c, size 0x90, virtual true, abstract: false, final false
