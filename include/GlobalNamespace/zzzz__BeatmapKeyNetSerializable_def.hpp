...
/// @brief Method Deserialize, addr 0x36b81d8, size 0x50, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Equals, addr 0x36b8320, size 0xf4, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x36b82b0, size 0x70, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::BeatmapKeyNetSerializable*  other) ;

/// @brief Method GetHashCode, addr 0x36b8414, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method Serialize, addr 0x36b8238, size 0x70, virtual true, abstract: false, final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method ToString, addr 0x36b8478, size 0xb8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x36b81c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x36b81cc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_beatmapCharacteristicSerializedName, addr 0x36b81a8, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_beatmapCharacteristicSerializedName() ;

/// @brief Method get_difficulty, addr 0x36b81b8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficulty get_difficulty() ;

/// @brief Method get_levelID, addr 0x36b8198, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_beatmapCharacteristicSerializedName, addr 0x36b81b0, size 0x8, virtual false, abstract: false, final false
inline void set_beatmapCharacteristicSerializedName(::StringW  value) ;

/// @brief Method set_difficulty, addr 0x36b81c0, size 0x8, virtual false, abstract: false, final false
inline void set_difficulty(::GlobalNamespace::BeatmapDifficulty  value) ;

/// @brief Method set_levelID, addr 0x36b81a0, size 0x8, virtual false, abstract: false, final false
