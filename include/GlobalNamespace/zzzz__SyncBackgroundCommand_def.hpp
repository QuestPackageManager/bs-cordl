...
/// @brief Method Execute, addr 0x322a0ac, size 0x180, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x322a22c, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_resultTask, addr 0x322a05c, size 0x50, virtual false, abstract: false, final false
