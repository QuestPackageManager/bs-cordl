...
// Write type traits
MARK_REF_T(::GlobalNamespace::SyncBackgroundCommand*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SyncBackgroundCommand*, "", "SyncBackgroundCommand");
...
public:
  ...
  /// @brief Method .ctor, addr 0x3322ae0, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_resultTask, addr 0x3322910, size 0x50, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SyncBackgroundCommand) == 0x18, "Size mismatch!");
