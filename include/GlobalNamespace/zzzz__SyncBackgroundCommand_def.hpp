...
public:
  ...
  /// @brief Method Execute, addr 0xeb62b4, size 0x168, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xeb641c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_resultTask, addr 0xeb626c, size 0x48, virtual false, abstract: false, final false
