...
public:
  ...
  /// @brief Method Execute, addr 0x22b2abc, size 0x168, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22b2c24, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_resultTask, addr 0x22b2a74, size 0x48, virtual false, abstract: false, final false
