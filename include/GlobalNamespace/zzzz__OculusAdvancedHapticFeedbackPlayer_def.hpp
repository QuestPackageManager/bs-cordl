...
/// @brief Method .ctor, addr 0x5716f44, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CanPlayHapticPreset, addr 0x5716f80, size 0x1d4, virtual true, abstract: false, final true
inline bool CanPlayHapticPreset(::Libraries::HM::HMLib::VR::HapticPresetSO*  hapticPreset, ::UnityEngine::XR::XRNode  node) ;

/// @brief Method Dispose, addr 0x57172e0, size 0x1ec, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method GetHapticClip, addr 0x5716f48, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method HandleApplicationQuitting, addr 0x5717708, size 0x70, virtual false, abstract: false, final false
inline void HandleApplicationQuitting() ;

/// @brief Method Initialize, addr 0x5717238, size 0xa8, virtual true, abstract: false, final true
inline void Initialize() ;

/// @brief Method IsTouchControllerSupported, addr 0x5717680, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method PlayHapticFeedback, addr 0x5716c68, size 0x2dc, virtual true, abstract: false, final true
inline void PlayHapticFeedback(::UnityEngine::XR::XRNode  node, ::Libraries::HM::HMLib::VR::HapticPresetSO*  hapticPreset) ;

/// @brief Method Tick, addr 0x57174cc, size 0x1b4, virtual true, abstract: false, final true
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x5717778, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
