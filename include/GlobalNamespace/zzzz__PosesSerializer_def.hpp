...
public:
  ...
  /// @brief Method .ctor addr 0x21b8d20 size 0x80 virtual false final false
  inline void _ctor(::GlobalNamespace::IBeatSaberLogger* logger);

  /// @brief Method SaveInfoFile addr 0x21b8dc8 size 0x104 virtual false final false
  static inline void SaveInfoFile(::StringW filePath, ::GlobalNamespace::PosesRecordingData* data);

  /// @brief Method SaveDataFile addr 0x21b8ecc size 0x368 virtual false final false
  static inline void SaveDataFile(::StringW filePath, ::GlobalNamespace::PosesRecordingData* data);

  /// @brief Method SaveRecordingIntoDirectory addr 0x21b9234 size 0x2a0 virtual false final false
  inline void SaveRecordingIntoDirectory(::StringW path, ::GlobalNamespace::PosesRecordingData* data);

  /// @brief Method LoadInfoFile addr 0x21b94d4 size 0x1a4 virtual false final false
  inline ::GlobalNamespace::PosesRecordingInfoSaveData* LoadInfoFile(::StringW filePath);

  /// @brief Method LoadDataFile addr 0x21b9678 size 0x5fc virtual false final false
  ...
  /// @brief Method LoadRecordingFromDirectory addr 0x21b9c74 size 0x308 virtual false final false
  inline ::GlobalNamespace::PosesRecordingData* LoadRecordingFromDirectory(::StringW path);

  /// @brief Method SaveToOldFormat addr 0x21b9f7c size 0x18 virtual true final true
  inline void SaveToOldFormat(::StringW path, ::GlobalNamespace::PosesRecordingData* data);

  /// @brief Method SaveRecording addr 0x21ba080 size 0x3c virtual true final true
  inline void SaveRecording(::StringW path, ::GlobalNamespace::PosesRecordingData* data, bool saveToOldFormat);

  /// @brief Method LoadRecording addr 0x21ba0bc size 0x118 virtual true final true
  inline ::GlobalNamespace::PosesRecordingData* LoadRecording(::StringW path);

  /// @brief Method RecordingExists addr 0x21ba1d4 size 0x340 virtual true final true
  inline bool RecordingExists(::StringW path);

  /// @brief Method RecordingCanBeCreated addr 0x21ba514 size 0x4d4 virtual true final true
