...
public:
  ...
  /// @brief Method Start, addr 0x4029acc, size 0x100, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x4029bcc, size 0x1b0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x4029d7c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
