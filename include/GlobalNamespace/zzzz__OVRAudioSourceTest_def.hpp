...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRAudioSourceTest*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OVRAudioSourceTest*, "", "OVRAudioSourceTest");
...
public:
  ...
  /// @brief Method Start, addr 0x5ef1688, size 0x114, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5ef179c, size 0x1e8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5ef1984, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OVRAudioSourceTest", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OVRAudioSourceTest(OVRAudioSourceTest&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OVRAudioSourceTest", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OVRAudioSourceTest(OVRAudioSourceTestconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::OVRAudioSourceTest) == 0x28, "Size mismatch!");
