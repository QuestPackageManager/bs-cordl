...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10252)), TypeDefinitionIndex(TypeDefinitionIndex(10225)), TypeDefinitionIndex(TypeDefinitionIndex(7543)),
// TypeDefinitionIndex(TypeDefinitionIndex(7679)), TypeDefinitionIndex(TypeDefinitionIndex(7803)), TypeDefinitionIndex(TypeDefinitionIndex(7544))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7545))
// CS Name: ::OVREyeGaze*
