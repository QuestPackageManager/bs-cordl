...
public:
  ...
  /// @brief Method GetUnlockedAchievements, addr 0x12a00bc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Initialize, addr 0x12a00b0, size 0x4, virtual true, abstract: false, final true
  inline void Initialize();

  static inline ::GlobalNamespace::EmptyPlatformAchievementsHandler* New_ctor();

  /// @brief Method UnlockAchievement, addr 0x12a00b4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x12a00c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
