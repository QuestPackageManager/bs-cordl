...
public:
  ...
  /// @brief Method GetUnlockedAchievements, addr 0x26a05f0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method Initialize, addr 0x26a05e4, size 0x4, virtual true, abstract: false, final true
  inline void Initialize();

  static inline ::GlobalNamespace::EmptyPlatformAchievementsHandler* New_ctor();

  /// @brief Method UnlockAchievement, addr 0x26a05e8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26a05f8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
