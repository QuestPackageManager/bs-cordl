...
public:
  ...
  /// @brief Method Awake, addr 0x26dc744, size 0x30, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x26dc774, size 0x30, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::AlphaFloatFxGroupEffectTarget* New_ctor();

  /// @brief Method SetColor, addr 0x26dc7bc, size 0xdc, virtual false, abstract: false, final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method SetValue, addr 0x26dc7a4, size 0x18, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x26dc898, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26dc8b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
