...
// Write type traits
MARK_REF_T(::GlobalNamespace::AlphaFloatFxGroupEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AlphaFloatFxGroupEffectTarget*, "", "AlphaFloatFxGroupEffectTarget");
// Dependencies FloatFxGroupEffectTarget, MaterialPropertyBlockController, UnityEngine.Color
namespace GlobalNamespace {
// Is value type: false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AlphaFloatFxGroupEffectTarget", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AlphaFloatFxGroupEffectTarget(AlphaFloatFxGroupEffectTarget&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AlphaFloatFxGroupEffectTarget", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AlphaFloatFxGroupEffectTarget(AlphaFloatFxGroupEffectTargetconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AlphaFloatFxGroupEffectTarget) == 0x48, "Size mismatch!");
