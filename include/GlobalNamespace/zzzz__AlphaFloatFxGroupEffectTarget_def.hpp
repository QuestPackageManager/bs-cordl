...
public:
  ...
  /// @brief Method Awake, addr 0x57e010c, size 0x34, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x57e0140, size 0x34, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::AlphaFloatFxGroupEffectTarget* New_ctor();

  /// @brief Method SetColor, addr 0x57e018c, size 0xcc, virtual false, abstract: false, final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method SetValue, addr 0x57e0174, size 0x18, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x57e0258, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e0270, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
