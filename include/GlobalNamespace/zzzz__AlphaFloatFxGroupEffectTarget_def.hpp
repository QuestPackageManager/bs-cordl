...
public:
  ...
  /// @brief Method Awake, addr 0x5852934, size 0x34, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x5852968, size 0x34, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::AlphaFloatFxGroupEffectTarget* New_ctor();

  /// @brief Method SetColor, addr 0x58529b4, size 0xcc, virtual false, abstract: false, final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method SetValue, addr 0x585299c, size 0x18, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x5852a80, size 0x18, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5852a98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
