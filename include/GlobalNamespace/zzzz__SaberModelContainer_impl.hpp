...
//  Writing Method size for method: ::GlobalNamespace::__SaberModelContainer__InitData._ctor
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__SaberModelContainer__InitData::*)()>(
    &::GlobalNamespace::__SaberModelContainer__InitData::_ctor)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x3b70688;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__SaberModelContainer__InitData*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__SaberModelContainer__InitData::*)(::UnityEngine::Color)>(
    &::GlobalNamespace::__SaberModelContainer__InitData::_ctor)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x3b706a8;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__SaberModelContainer__InitData*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
        ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Color>::get() })));
    return ___internal_method;
  }
};
constexpr ::UnityEngine::Color& GlobalNamespace::__SaberModelContainer__InitData::__cordl_internal_get_trailTintColor() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___trailTintColor;
}
constexpr ::UnityEngine::Color const& GlobalNamespace::__SaberModelContainer__InitData::__cordl_internal_get_trailTintColor() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___trailTintColor;
}
constexpr void GlobalNamespace::__SaberModelContainer__InitData::__cordl_internal_set_trailTintColor(::UnityEngine::Color value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->___trailTintColor = value;
}
inline ::GlobalNamespace::__SaberModelContainer__InitData* GlobalNamespace::__SaberModelContainer__InitData::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__SaberModelContainer__InitData*>());
}
inline void GlobalNamespace::__SaberModelContainer__InitData::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__SaberModelContainer__InitData*>::get(),
                                                                             ".ctor", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method);
}
inline ::GlobalNamespace::__SaberModelContainer__InitData* GlobalNamespace::__SaberModelContainer__InitData::New_ctor(::UnityEngine::Color trailTintColor) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::__SaberModelContainer__InitData*>(trailTintColor));
}
inline void GlobalNamespace::__SaberModelContainer__InitData::_ctor(::UnityEngine::Color trailTintColor) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::__SaberModelContainer__InitData*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
                                  ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Color>::get() })));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, trailTintColor);
}
// Ctor Parameters []
constexpr ::GlobalNamespace::__SaberModelContainer__InitData::__SaberModelContainer__InitData() {}
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SaberModelContainer::*)()>(&::GlobalNamespace::SaberModelContainer::Start)> {
  ...
  constexpr static std::size_t addrs = 0x3b70400;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SaberModelContainer::*)()>(&::GlobalNamespace::SaberModelContainer::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3b70620;
...
constexpr ::GlobalNamespace::__SaberModelContainer__InitData*& GlobalNamespace::SaberModelContainer::__cordl_internal_get__initData() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____initData;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__SaberModelContainer__InitData*> const& GlobalNamespace::SaberModelContainer::__cordl_internal_get__initData() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____initData;
}
constexpr void GlobalNamespace::SaberModelContainer::__cordl_internal_set__initData(::GlobalNamespace::__SaberModelContainer__InitData* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
