...
public:
// Declarations
/// @brief Method InitializePlayerLoop, addr 0x570c1d0, size 0x1bc, virtual false, abstract: false, final false
static inline void InitializePlayerLoop() ;

/// @brief Method RemoveDisabledSubsystems, addr 0x570c38c, size 0x250, virtual false, abstract: false, final false
