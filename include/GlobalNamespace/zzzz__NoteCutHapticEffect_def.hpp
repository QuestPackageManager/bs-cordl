...
public:
  ...
  /// @brief Method HitNote, addr 0x2490900, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24909a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
