...
public:
  ...
  /// @brief Method HitNote, addr 0x3b89208, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b892a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
