...
public:
  ...
  /// @brief Method HitNote, addr 0x58499c4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5849a7c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
