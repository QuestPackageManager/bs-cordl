...
public:
  ...
  __declspec(property(get = __cordl_internal_get__shortNormalPreset, put = __cordl_internal_set__shortNormalPreset))::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO> _shortNormalPreset;
...
public:
  ...
  ::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO> ____shortNormalPreset;

  /// @brief Field _shortWeakPreset, offset: 0x28, size: 0x8, def value: None
  ::UnityW<::Libraries::HM::HMLib::VR::HapticPresetSO> ____shortWeakPreset;
