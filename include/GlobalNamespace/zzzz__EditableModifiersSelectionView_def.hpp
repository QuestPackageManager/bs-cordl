...
// Write type traits
MARK_REF_T(::GlobalNamespace::EditableModifiersSelectionView*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EditableModifiersSelectionView*, "", "EditableModifiersSelectionView");
...
public:
  ...
  /// @brief Method SetGameplayModifiers, addr 0x596a018, size 0x60, virtual true, abstract: false, final false
  inline void SetGameplayModifiers(::GlobalNamespace::GameplayModifiers* gameplayModifiers);

  /// @brief Method SetVisibility, addr 0x5969fe8, size 0x28, virtual false, abstract: false, final false
  inline void SetVisibility(bool visible);

  /// @brief Method Setup, addr 0x596a010, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596a22c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clearButton, addr 0x5969f68, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_clearButton();

  /// @brief Method get_editButton, addr 0x5969f60, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_editButton();

  /// @brief Method get_interactable, addr 0x5969f70, size 0x8, virtual false, abstract: false, final false
  inline bool get_interactable();

  /// @brief Method get_showClearButton, addr 0x5969fd8, size 0x8, virtual false, abstract: false, final false
  inline bool get_showClearButton();

  /// @brief Method set_interactable, addr 0x5969f78, size 0x60, virtual false, abstract: false, final false
  inline void set_interactable(bool value);

  /// @brief Method set_showClearButton, addr 0x5969fe0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::EditableModifiersSelectionView) == 0x58, "Size mismatch!");
