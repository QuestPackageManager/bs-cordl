...
public:
  ...
  /// @brief Method GetCopy, addr 0x325a270, size 0x94, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x325a304, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method SubtypeIdentifier, addr 0x325a244, size 0xc, virtual false, abstract: false, final false
  static inline int32_t SubtypeIdentifier(int32_t groupId, int32_t elementId);

  /// @brief Method UpdateBy, addr 0x325a250, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x325a194, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nextSameTypeEventData, addr 0x325a0f8, size 0x7c, virtual false, abstract: false, final false
