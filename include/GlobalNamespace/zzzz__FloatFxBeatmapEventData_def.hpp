...
public:
  ...
  /// @brief Method GetCopy, addr 0x1045a28, size 0xa4, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x1045acc, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateBy, addr 0x1045a0c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1045990, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_easeType, addr 0x1045980, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EaseType get_easeType();

  /// @brief Method get_value, addr 0x1045970, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_easeType, addr 0x1045988, size 0x8, virtual false, abstract: false, final false
  inline void set_easeType(::GlobalNamespace::EaseType value);

  /// @brief Method set_value, addr 0x1045978, size 0x8, virtual false, abstract: false, final false
