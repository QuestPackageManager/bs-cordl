...
public:
  ...
  /// @brief Method GetCopy, addr 0x103df94, size 0xa4, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x103e038, size 0x13c, virtual true, abstract: false, final false
  ...
  /// @brief Method UpdateBy, addr 0x103df78, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x103defc, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_easeType, addr 0x103deec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EaseType get_easeType();

  /// @brief Method get_value, addr 0x103dedc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_easeType, addr 0x103def4, size 0x8, virtual false, abstract: false, final false
  inline void set_easeType(::GlobalNamespace::EaseType value);

  /// @brief Method set_value, addr 0x103dee4, size 0x8, virtual false, abstract: false, final false
