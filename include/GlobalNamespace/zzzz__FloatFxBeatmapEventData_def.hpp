...
/// @brief Method GetCopy, addr 0x31931d0, size 0x94, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDataItem* GetCopy() ;

/// @brief Method GetDefault, addr 0x3193264, size 0x13c, virtual true, abstract: false, final false
...
/// @brief Method SubtypeIdentifier, addr 0x31931a4, size 0xc, virtual false, abstract: false, final false
static inline int32_t SubtypeIdentifier(int32_t  groupId, int32_t  elementId) ;

/// @brief Method UpdateBy, addr 0x31931b0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31930f0, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method get_easeType, addr 0x31930e0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::EaseType get_easeType() ;

/// @brief Method get_nextSameTypeEventData, addr 0x3193054, size 0x7c, virtual false, abstract: false, final false
inline ::GlobalNamespace::FloatFxBeatmapEventData* get_nextSameTypeEventData() ;

/// @brief Method get_previousSameTypeEventData, addr 0x3192fd8, size 0x7c, virtual false, abstract: false, final false
inline ::GlobalNamespace::FloatFxBeatmapEventData* get_previousSameTypeEventData() ;

/// @brief Method get_value, addr 0x31930d0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_easeType, addr 0x31930e8, size 0x8, virtual false, abstract: false, final false
inline void set_easeType(::GlobalNamespace::EaseType  value) ;

/// @brief Method set_value, addr 0x31930d8, size 0x8, virtual false, abstract: false, final false
