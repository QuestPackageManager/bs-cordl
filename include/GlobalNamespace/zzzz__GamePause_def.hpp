...
public:
  ...
  /// @brief Method Pause, addr 0x587304c, size 0x174, virtual true, abstract: false, final true
  inline void Pause();

  /// @brief Method Resume, addr 0x58731e4, size 0x170, virtual true, abstract: false, final true
  inline void Resume();

  /// @brief Method WillResume, addr 0x58731c0, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5873354, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPauseEvent, addr 0x5872c44, size 0xac, virtual true, abstract: false, final true
  inline void add_didPauseEvent(::System::Action* value);

  /// @brief Method add_didResumeEvent, addr 0x5872ef4, size 0xac, virtual true, abstract: false, final true
  inline void add_didResumeEvent(::System::Action* value);

  /// @brief Method add_willResumeEvent, addr 0x5872d9c, size 0xac, virtual true, abstract: false, final true
  inline void add_willResumeEvent(::System::Action* value);

  /// @brief Method get_isPaused, addr 0x5872c3c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_didPauseEvent, addr 0x5872cf0, size 0xac, virtual true, abstract: false, final true
  inline void remove_didPauseEvent(::System::Action* value);

  /// @brief Method remove_didResumeEvent, addr 0x5872fa0, size 0xac, virtual true, abstract: false, final true
  inline void remove_didResumeEvent(::System::Action* value);

  /// @brief Method remove_willResumeEvent, addr 0x5872e48, size 0xac, virtual true, abstract: false, final true
