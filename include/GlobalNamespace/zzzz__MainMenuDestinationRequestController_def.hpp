...
public:
  ...
  /// @brief Method MoveNext, addr 0x5843618, size 0x4f0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5843b08, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x58431a0, size 0x1c4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleDestinationRequestManagerDidSendMenuDestinationRequest, addr 0x5843610, size 0x4, virtual false, abstract: false, final false
  inline void HandleDestinationRequestManagerDidSendMenuDestinationRequest(::GlobalNamespace::MenuDestination* menuDestination);

  /// @brief Method HandleGameScenesManagerInstallEarlyBindings, addr 0x5843364, size 0x2ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x5842e70, size 0x280, virtual true, abstract: false, final true
  inline void Initialize();

  static inline ::GlobalNamespace::MainMenuDestinationRequestController* New_ctor();

  /// @brief Method ProcessDestinationRequest, addr 0x58430f0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5843614, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
