...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b79fc4, size 0x4b8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b7a47c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x3b79b7c, size 0x1ac, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleDestinationRequestManagerDidSendMenuDestinationRequest, addr 0x3b79fb8, size 0x4, virtual false, abstract: false, final false
  inline void HandleDestinationRequestManagerDidSendMenuDestinationRequest(::GlobalNamespace::MenuDestination* menuDestination);

  /// @brief Method HandleGameScenesManagerInstallEarlyBindings, addr 0x3b79d28, size 0x290, virtual false, abstract: false, final false
  ...
  /// @brief Method Initialize, addr 0x3b79870, size 0x270, virtual true, abstract: false, final true
  inline void Initialize();

  static inline ::GlobalNamespace::MainMenuDestinationRequestController* New_ctor();

  /// @brief Method ProcessDestinationRequest, addr 0x3b79ae0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b79fbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
