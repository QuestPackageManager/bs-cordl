...
/// @brief Field <nextSameTypeEventData>k__BackingField, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__nextSameTypeEventData_k__BackingField, put=__cordl_internal_set__nextSameTypeEventData_k__BackingField)) ::GlobalNamespace::BeatmapEventData*  _nextSameTypeEventData_k__BackingField;

/// @brief Field <previousSameTypeEventData>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__previousSameTypeEventData_k__BackingField, put=__cordl_internal_set__previousSameTypeEventData_k__BackingField)) ::GlobalNamespace::BeatmapEventData*  _previousSameTypeEventData_k__BackingField;
...
/// @brief Method GetDefault, addr 0x3192bb8, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method __ConnectWithNextSameTypeEventData, addr 0x3192ba0, size 0x10, virtual false, abstract: false, final false
inline void __ConnectWithNextSameTypeEventData(::GlobalNamespace::BeatmapEventData*  newNextSameTypeEvent) ;

/// @brief Method __ConnectWithPreviousSameTypeEventData, addr 0x3192b90, size 0x10, virtual false, abstract: false, final false
inline void __ConnectWithPreviousSameTypeEventData(::GlobalNamespace::BeatmapEventData*  newPreviousSameTypeEvent) ;

/// @brief Method __ResetConnections, addr 0x3192bb0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3192824, size 0x14, virtual false, abstract: false, final false
inline void _ctor(float_t  time, int32_t  executionOrder, int32_t  subtypeIdentifier) ;

/// @brief Method get_nextSameTypeEventData, addr 0x3192b80, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* get_nextSameTypeEventData() ;

/// @brief Method get_previousSameTypeEventData, addr 0x3192b70, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapEventData* get_previousSameTypeEventData() ;

/// @brief Method set_nextSameTypeEventData, addr 0x3192b88, size 0x8, virtual false, abstract: false, final false
inline void set_nextSameTypeEventData(::GlobalNamespace::BeatmapEventData*  value) ;

/// @brief Method set_previousSameTypeEventData, addr 0x3192b78, size 0x8, virtual false, abstract: false, final false
