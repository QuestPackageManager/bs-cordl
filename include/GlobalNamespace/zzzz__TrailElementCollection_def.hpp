...
/// @brief Method GetElement, addr 0x5da0e40, size 0x44, virtual false, abstract: false, final false
inline ::GlobalNamespace::TrailElement* GetElement(int32_t  index) ;

/// @brief Method InitSnapshots, addr 0x5d9f1c4, size 0x90, virtual false, abstract: false, final false
inline void InitSnapshots(::UnityEngine::Vector3  defaultStartPosition, ::UnityEngine::Vector3  defaultEndPosition, float_t  time) ;

/// @brief Method Interpolate, addr 0x5da076c, size 0x2a4, virtual false, abstract: false, final false
inline void Interpolate(float_t  t, ::ByRef<::GlobalNamespace::TrailElementCollection_InterpolationState>  lerpState, ::ByRef<::UnityEngine::Vector3>  position, ::ByRef<::UnityEngine::Vector3>  normal, ::ByRef<float_t>  time) ;

/// @brief Method MoveTailToHead, addr 0x5d9f704, size 0x9c, virtual false, abstract: false, final false
...
/// @brief Method SetHeadData, addr 0x5d9f650, size 0xb4, virtual false, abstract: false, final false
inline void SetHeadData(::UnityEngine::Vector3  start, ::UnityEngine::Vector3  end, float_t  time) ;

/// @brief Method UpdateDistances, addr 0x5d9f7a0, size 0x7c, virtual false, abstract: false, final false
inline void UpdateDistances() ;

/// @brief Method UpdateLerpState, addr 0x5da0d24, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d9eeac, size 0x194, virtual false, abstract: false, final false
