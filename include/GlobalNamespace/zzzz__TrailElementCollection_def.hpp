...
public:
  ...
  /// @brief Method GetElement, addr 0x5e12e4c, size 0x44, virtual false, abstract: false, final false
  inline ::GlobalNamespace::TrailElement* GetElement(int32_t index);

  /// @brief Method InitSnapshots, addr 0x5e111d0, size 0x90, virtual false, abstract: false, final false
  inline void InitSnapshots(::UnityEngine::Vector3 defaultStartPosition, ::UnityEngine::Vector3 defaultEndPosition, float_t time);

  /// @brief Method Interpolate, addr 0x5e12778, size 0x2a4, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveTailToHead, addr 0x5e11710, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHeadData, addr 0x5e1165c, size 0xb4, virtual false, abstract: false, final false
  inline void SetHeadData(::UnityEngine::Vector3 start, ::UnityEngine::Vector3 end, float_t time);

  /// @brief Method UpdateDistances, addr 0x5e117ac, size 0x7c, virtual false, abstract: false, final false
  inline void UpdateDistances();

  /// @brief Method UpdateLerpState, addr 0x5e12d30, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e10eb8, size 0x194, virtual false, abstract: false, final false
