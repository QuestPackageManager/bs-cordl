...
public:
  ...
  /// @brief Method GetElement, addr 0x40894b4, size 0x44, virtual false, abstract: false, final false
  inline ::GlobalNamespace::TrailElement* GetElement(int32_t index);

  /// @brief Method InitSnapshots, addr 0x4087980, size 0x90, virtual false, abstract: false, final false
  inline void InitSnapshots(::UnityEngine::Vector3 defaultStartPosition, ::UnityEngine::Vector3 defaultEndPosition, float_t time);

  /// @brief Method Interpolate, addr 0x4088df8, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method MoveTailToHead, addr 0x4087ec4, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetHeadData, addr 0x4087e10, size 0xb4, virtual false, abstract: false, final false
  inline void SetHeadData(::UnityEngine::Vector3 start, ::UnityEngine::Vector3 end, float_t time);

  /// @brief Method UpdateDistances, addr 0x4087f60, size 0x7c, virtual false, abstract: false, final false
  inline void UpdateDistances();

  /// @brief Method UpdateLerpState, addr 0x408939c, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x40875d0, size 0x1b4, virtual false, abstract: false, final false
