...
public:
  ...
  /// @brief Method HandleSongDidFinish, addr 0x587271c, size 0xcc, virtual false, abstract: false, final false
  inline void HandleSongDidFinish();

  static inline ::GlobalNamespace::SongProgressUIController* New_ctor();

  /// @brief Method OnDestroy, addr 0x5872254, size 0x110, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x5871f28, size 0x32c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5872364, size 0x170, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateSongProgressUIElements, addr 0x58724d4, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58727e8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
