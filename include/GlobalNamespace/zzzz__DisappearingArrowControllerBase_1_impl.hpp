...
template <typename T>
constexpr void
GlobalNamespace::DisappearingArrowControllerBase_1<T>::__cordl_internal_set__transparentObjectMaterialPropertyBlocks(::ArrayW<::UnityW<::GlobalNamespace::MaterialPropertyBlockController>> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____transparentObjectMaterialPropertyBlocks = value;
}
...
template <typename T> constexpr void GlobalNamespace::DisappearingArrowControllerBase_1<T>::__cordl_internal_set__cubeMeshRenderer(::UnityW<::UnityEngine::MeshRenderer> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____cubeMeshRenderer = value;
}
...
template <typename T> constexpr void GlobalNamespace::DisappearingArrowControllerBase_1<T>::__cordl_internal_set__arrowCutoutEffect(::UnityW<::GlobalNamespace::CutoutEffect> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____arrowCutoutEffect = value;
}
...
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::setStaticF__colorId(int32_t value) {
  ::cordl_internals::setStaticField<int32_t, "_colorId", ::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(std::forward<int32_t>(value));
}
template <typename T> inline int32_t GlobalNamespace::DisappearingArrowControllerBase_1<T>::getStaticF__colorId() {
  return ::cordl_internals::getStaticField<int32_t, "_colorId", ::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>();
}
template <typename T> inline T GlobalNamespace::DisappearingArrowControllerBase_1<T>::get_gameNoteController() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), 4 })));
  return ::cordl_internals::RunMethodRethrow<T>(this, ___internal_method);
}
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::Awake() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), { "Awake", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::OnDestroy() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), { "OnDestroy", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::CalculateMinMaxDistance() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), { "CalculateMinMaxDistance", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::HandleNoteMovementNoteDidMoveInJumpPhase() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), { "HandleNoteMovementNoteDidMoveInJumpPhase", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::HandleCubeNoteControllerDidInit(T gameNoteController) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), { "HandleCubeNoteControllerDidInit", {}, { ::i2c::type_of<T>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, gameNoteController);
}
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::SetArrowTransparency(float_t arrowTransparency) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), { "SetArrowTransparency", {}, { ::i2c::type_of<float_t>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, arrowTransparency);
}
template <typename T> inline void GlobalNamespace::DisappearingArrowControllerBase_1<T>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T> inline ::GlobalNamespace::DisappearingArrowControllerBase_1<T>* GlobalNamespace::DisappearingArrowControllerBase_1<T>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::DisappearingArrowControllerBase_1<T>*>());
}
// Ctor Parameters []
