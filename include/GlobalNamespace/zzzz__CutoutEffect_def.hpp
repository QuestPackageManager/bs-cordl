...
/// @brief Method SetCutout, addr 0x57d2d00, size 0x5c, virtual false, abstract: false, final false
inline void SetCutout(float_t  cutout) ;

/// @brief Method SetCutout, addr 0x57d2fcc, size 0xe0, virtual false, abstract: false, final false
inline void SetCutout(float_t  cutout, ::UnityEngine::Vector3  cutoutOffset) ;

/// @brief Method Start, addr 0x57d2f90, size 0x3c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57d30ac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_useRandomCutoutOffset, addr 0x57d2ef0, size 0xa0, virtual false, abstract: false, final false
