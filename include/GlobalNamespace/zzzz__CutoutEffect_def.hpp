...
public:
  ...
  /// @brief Method SetCutout, addr 0x3b7b560, size 0xc4, virtual false, abstract: false, final false
  inline void SetCutout(float_t cutout);

  /// @brief Method SetCutout, addr 0x3b7b86c, size 0xe4, virtual false, abstract: false, final false
  inline void SetCutout(float_t cutout, ::UnityEngine::Vector3 cutoutOffset);

  /// @brief Method Start, addr 0x3b7b830, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b7b950, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_useRandomCutoutOffset, addr 0x3b7b79c, size 0x94, virtual false, abstract: false, final false
