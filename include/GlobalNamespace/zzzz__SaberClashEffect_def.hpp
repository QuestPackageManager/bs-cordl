...
public:
  ...
  /// @brief Method LateUpdate, addr 0x3b9e400, size 0x10c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberClashEffect* New_ctor();

  /// @brief Method OnDisable, addr 0x3b9e3f0, size 0x10, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Start, addr 0x3b9e248, size 0x1a8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b9e50c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
