...
public:
  ...
  /// @brief Method LateUpdate, addr 0x24a7a88, size 0xfc, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberClashEffect* New_ctor();

  /// @brief Method OnDisable, addr 0x24a7a78, size 0x10, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Start, addr 0x24a78c8, size 0x1b0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24a7b84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
