...
/// @brief Field _glowParticleSystemEmmisionModule, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__glowParticleSystemEmmisionModule, put=__cordl_internal_set__glowParticleSystemEmmisionModule)) ::UnityEngine::ParticleSystem_EmissionModule  _glowParticleSystemEmmisionModule;
...
/// @brief Field _sparkleParticleSystemEmmisionModule, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__sparkleParticleSystemEmmisionModule, put=__cordl_internal_set__sparkleParticleSystemEmmisionModule)) ::UnityEngine::ParticleSystem_EmissionModule  _sparkleParticleSystemEmmisionModule;

/// @brief Method LateUpdate, addr 0x57ef3d8, size 0x17c, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::SaberClashEffect* New_ctor() ;

/// @brief Method OnDisable, addr 0x57ef3c8, size 0x10, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method Start, addr 0x57ef244, size 0x184, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57ef554, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
