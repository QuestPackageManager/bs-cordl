...
public:
  ...
  /// @brief Method LateUpdate, addr 0x58612d0, size 0x17c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SaberClashEffect* New_ctor();

  /// @brief Method OnDisable, addr 0x58612c0, size 0x10, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method Start, addr 0x586113c, size 0x184, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x586144c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
