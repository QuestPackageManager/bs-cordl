...
public:
  ...
  /// @brief Method .ctor, addr 0x44de074, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disabledState, addr 0x44de05c, size 0x8, virtual false, abstract: false, final false
  inline bool get_disabledState();

  /// @brief Method get_highlightedState, addr 0x44de04c, size 0x8, virtual false, abstract: false, final false
  inline bool get_highlightedState();

  /// @brief Method get_normalState, addr 0x44de044, size 0x8, virtual false, abstract: false, final false
  inline bool get_normalState();

  /// @brief Method get_pressedState, addr 0x44de054, size 0x8, virtual false, abstract: false, final false
  inline bool get_pressedState();

  /// @brief Method get_selectedAndHighlightedState, addr 0x44de06c, size 0x8, virtual false, abstract: false, final false
  inline bool get_selectedAndHighlightedState();

  /// @brief Method get_selectedState, addr 0x44de064, size 0x8, virtual false, abstract: false, final false
