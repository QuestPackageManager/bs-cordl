...
public:
  ...
  /// @brief Method .ctor, addr 0x24a7684, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disabledState, addr 0x24a766c, size 0x8, virtual false, abstract: false, final false
  inline bool get_disabledState();

  /// @brief Method get_highlightedState, addr 0x24a765c, size 0x8, virtual false, abstract: false, final false
  inline bool get_highlightedState();

  /// @brief Method get_normalState, addr 0x24a7654, size 0x8, virtual false, abstract: false, final false
  inline bool get_normalState();

  /// @brief Method get_pressedState, addr 0x24a7664, size 0x8, virtual false, abstract: false, final false
  inline bool get_pressedState();

  /// @brief Method get_selectedAndHighlightedState, addr 0x24a767c, size 0x8, virtual false, abstract: false, final false
  inline bool get_selectedAndHighlightedState();

  /// @brief Method get_selectedState, addr 0x24a7674, size 0x8, virtual false, abstract: false, final false
