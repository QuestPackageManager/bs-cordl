...
// Write type traits
MARK_REF_T(::GlobalNamespace::ResultObjectiveListItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ResultObjectiveListItem*, "", "ResultObjectiveListItem");
...
static_assert(sizeof(::GlobalNamespace::ResultObjectiveListItem) == 0x48, "Size mismatch!");
