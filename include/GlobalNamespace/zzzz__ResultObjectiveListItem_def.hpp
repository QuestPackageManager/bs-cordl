...
public:
  ...
  /// @brief Method set_iconColor addr 0x22e7fc8 size 0x24 virtual false final false
  inline void set_iconColor(::UnityEngine::Color value);

  /// @brief Method set_icon addr 0x22e7fec size 0x1c virtual false final false
  inline void set_icon(::UnityEngine::Sprite* value);

  /// @brief Method set_iconGlow addr 0x22e8008 size 0x1c virtual false final false
  inline void set_iconGlow(::UnityEngine::Sprite* value);

  /// @brief Method set_title addr 0x22e8024 size 0x24 virtual false final false
  inline void set_title(::StringW value);

  /// @brief Method set_conditionText addr 0x22e8048 size 0x24 virtual false final false
  inline void set_conditionText(::StringW value);

  /// @brief Method set_hideConditionText addr 0x22e806c size 0x34 virtual false final false
  inline void set_hideConditionText(bool value);

  /// @brief Method set_valueText addr 0x22e80a0 size 0x24 virtual false final false
  inline void set_valueText(::StringW value);

  /// @brief Method set_hideValueText addr 0x22e80c4 size 0x34 virtual false final false
  inline void set_hideValueText(bool value);

  static inline ::GlobalNamespace::ResultObjectiveListItem* New_ctor();

  /// @brief Method .ctor addr 0x22e80f8 size 0x8 virtual false final false
  inline void _ctor();
