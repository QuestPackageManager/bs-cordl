...
public:
  ...
  /// @brief Method InstallBindings addr 0x20fbb5c size 0x100 virtual true final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::MultiplayerLocalActivePlayerInstaller* New_ctor();

  /// @brief Method .ctor addr 0x20fbc5c size 0x8 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MultiplayerLocalActivePlayerInstaller, 0x28>, "Size mismatch!");
