...
public:
  ...
  /// @brief Method InstallBindings, addr 0x27154d4, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2715614, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
