...
public:
  ...
  /// @brief Method InstallBindings, addr 0x27299fc, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2729b3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
