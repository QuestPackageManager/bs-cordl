...
public:
  ...
  /// @brief Method InstallBindings, addr 0x24d1aa4, size 0x140, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24d1be4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
