...
// Write type traits
MARK_REF_T(::GlobalNamespace::IVariableMovementDataProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IVariableMovementDataProvider*, "", "IVariableMovementDataProvider");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
