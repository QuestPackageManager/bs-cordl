...
public:
  ...
  /// @brief Method LogColorScheme, addr 0x35d13dc, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x35d16a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorScheme, addr 0x35d13cc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorScheme* get_colorScheme();

  /// @brief Method get_order, addr 0x35d13d4, size 0x8, virtual false, abstract: false, final false
