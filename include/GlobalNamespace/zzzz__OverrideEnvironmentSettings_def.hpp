...
// Write type traits
MARK_REF_T(::GlobalNamespace::OverrideEnvironmentSettings*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OverrideEnvironmentSettings*, "", "OverrideEnvironmentSettings");
...
public:
  ...
  /// @brief Field _overrideEnvironments, offset 0x10, size 0x1
  ...
  /// @brief Method GetOverrideEnvironmentInfoForType, addr 0x3746080, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEnvironmentInfoForType, addr 0x3746004, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37460dc, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_overrideEnvironments, addr 0x3745ff4, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideEnvironments();

  /// @brief Method set_overrideEnvironments, addr 0x3745ffc, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OverrideEnvironmentSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OverrideEnvironmentSettings(OverrideEnvironmentSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OverrideEnvironmentSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OverrideEnvironmentSettings(OverrideEnvironmentSettingsconst&) = delete;
...
static_assert(offsetof(::GlobalNamespace::OverrideEnvironmentSettings, ____overrideEnvironments) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::OverrideEnvironmentSettings, ____data) == 0x18, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::OverrideEnvironmentSettings) == 0x20, "Size mismatch!");
