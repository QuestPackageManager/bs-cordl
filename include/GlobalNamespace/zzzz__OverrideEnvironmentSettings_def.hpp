...
public:
  ...
  /// @brief Method GetOverrideEnvironmentInfoForType, addr 0x14f4628, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEnvironmentInfoForType, addr 0x14f45c0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f46a0, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
