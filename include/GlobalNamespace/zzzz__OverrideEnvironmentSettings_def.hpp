...
public:
  ...
  /// @brief Method GetOverrideEnvironmentInfoForType, addr 0x361da5c, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetEnvironmentInfoForType, addr 0x361d9e0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361dab8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_overrideEnvironments, addr 0x361d9d0, size 0x8, virtual false, abstract: false, final false
  inline bool get_overrideEnvironments();

  /// @brief Method set_overrideEnvironments, addr 0x361d9d8, size 0x8, virtual false, abstract: false, final false
