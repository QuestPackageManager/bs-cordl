...
public:
  ...
  /// @brief Method <CreateData>b__4_0, addr 0x26d4cb4, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _CreateData_b__4_0(::GlobalNamespace::BeatmapLevel* x);

  /// @brief Method .ctor, addr 0x26d4cac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateData, addr 0x26d4674, size 0x554, virtual false, abstract: false, final false
  ...
  /// @brief Method IsNumericOrSpecial, addr 0x26d4bc8, size 0x88, virtual false, abstract: false, final false
