...
/// @brief Method <CreateData>b__4_0, addr 0x36308e0, size 0x20, virtual false, abstract: false, final false
inline ::StringW _CreateData_b__4_0(::GlobalNamespace::BeatmapLevel*  x) ;

/// @brief Method .ctor, addr 0x36308dc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateData, addr 0x3630238, size 0x5c0, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::AlphabetScrollInfo_Data*>* CreateData(::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevel*>*  beatmapLevels, bool  sortBeatmapLevels, ::ByRef<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::BeatmapLevel*>*>  sortedBeatmapLevels) ;

/// @brief Method IsNumericOrSpecial, addr 0x36307f8, size 0x90, virtual false, abstract: false, final false
