...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::List_1<::GlobalNamespace::IBeatmapLevelPack*>* (
  ...
  constexpr static std::size_t addrs = 0x21bdc64;
...
//  Writing Method size for method: ::GlobalNamespace::RecordingToolResourceContainerSO.get_beatmapCharacteristicCollection
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapCharacteristicCollectionSO* (::GlobalNamespace::RecordingToolResourceContainerSO::*)()>(
    &::GlobalNamespace::RecordingToolResourceContainerSO::get_beatmapCharacteristicCollection)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21bdc6c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::EnvironmentsListSO* (::GlobalNamespace::RecordingToolResourceContainerSO::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21bdc74;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolResourceContainerSO::*)()>(
  ...
  constexpr static std::size_t addrs = 0x21bdc7c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RecordingToolResourceContainerSO::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21bdd48;
...
constexpr ::GlobalNamespace::BeatmapCharacteristicCollectionSO*& GlobalNamespace::RecordingToolResourceContainerSO::__get__beatmapCharacteristicCollection() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::RecordingToolResourceContainerSO::__get__beatmapCharacteristicCollection() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____beatmapCharacteristicCollection;
}
constexpr void GlobalNamespace::RecordingToolResourceContainerSO::__set__beatmapCharacteristicCollection(::GlobalNamespace::BeatmapCharacteristicCollectionSO* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::GlobalNamespace::BeatmapCharacteristicCollectionSO* GlobalNamespace::RecordingToolResourceContainerSO::get_beatmapCharacteristicCollection() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RecordingToolResourceContainerSO*>::get(),
                                                                             "get_beatmapCharacteristicCollection", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
