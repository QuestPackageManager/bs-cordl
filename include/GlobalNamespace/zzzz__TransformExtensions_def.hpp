...
public:
// Declarations
/// @brief Method CalculateTransformDepth, addr 0x326a1cc, size 0x8c, virtual false, abstract: false, final false
static inline int32_t CalculateTransformDepth(::UnityEngine::Transform*  transform) ;

/// @brief Method FindChildRecursively, addr 0x326a0cc, size 0x100, virtual false, abstract: false, final false
static inline ::UnityW<::UnityEngine::Transform> FindChildRecursively(::UnityEngine::Transform*  parent, ::StringW  name) ;

/// @brief Method InverseTransformRotation, addr 0x326a018, size 0xb4, virtual false, abstract: false, final false
