...
template<typename T>
constexpr ::System::Collections::Concurrent::ConcurrentBag_1<T>*& GlobalNamespace::PacketPool_1<T>::__cordl_internal_get__bag()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____bag;
}
template<typename T>
constexpr ::System::Collections::Concurrent::ConcurrentBag_1<T>* const& GlobalNamespace::PacketPool_1<T>::__cordl_internal_get__bag() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____bag;
}
template<typename T>
constexpr void GlobalNamespace::PacketPool_1<T>::__cordl_internal_set__bag(::System::Collections::Concurrent::ConcurrentBag_1<T>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "IPacketPool.Release",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::IPoolablePacket*>::get()}
                    )));
...
template<typename T>
constexpr ::GlobalNamespace::IPacketPool_1<T>* GlobalNamespace::PacketPool_1<T>::i___GlobalNamespace__IPacketPool_1_T_() noexcept {
return static_cast<::GlobalNamespace::IPacketPool_1<T>*>(static_cast<void*>(this));
}
...
template<typename T>
constexpr ::GlobalNamespace::IPacketPool* GlobalNamespace::PacketPool_1<T>::i___GlobalNamespace__IPacketPool() noexcept {
return static_cast<::GlobalNamespace::IPacketPool*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::PacketPool_1<T>::PacketPool_1()   {
}
