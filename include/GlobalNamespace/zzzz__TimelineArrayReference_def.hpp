...
MARK_REF_T(::GlobalNamespace::TimelineArrayReference*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TimelineArrayReference_ArrayTypes, "", "TimelineArrayReference/ArrayTypes");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::TimelineArrayReference*, "", "TimelineArrayReference");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::TimelineArrayReference_ArrayTypes) == 0x4, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies DirectionalLight, TMPro.TextMeshPro, TimelineArrayReference::ArrayTypes, TubeBloomPrePassLight, UnityEngine.CanvasGroup, UnityEngine.MonoBehaviour, UnityEngine.Transform
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__canvasGroupArray, put = __cordl_internal_set__canvasGroupArray)) ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>> _canvasGroupArray;
  ...
  __declspec(property(get = __cordl_internal_get__tmproArray, put = __cordl_internal_set__tmproArray)) ::ArrayW<::UnityW<::TMPro::TextMeshPro>> _tmproArray;

  /// @brief Field _transformArray, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__transformArray, put = __cordl_internal_set__transformArray)) ::ArrayW<::UnityW<::UnityEngine::Transform>> _transformArray;

  /// @brief Field _tubeLightArray, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get__tubeLightArray, put = __cordl_internal_set__tubeLightArray)) ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>> _tubeLightArray;
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>> const& __cordl_internal_get__canvasGroupArray() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>>& __cordl_internal_get__canvasGroupArray();
  ...
  constexpr ::ArrayW<::UnityW<::TMPro::TextMeshPro>> const& __cordl_internal_get__tmproArray() const;

  constexpr ::ArrayW<::UnityW<::TMPro::TextMeshPro>>& __cordl_internal_get__tmproArray();

  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>> const& __cordl_internal_get__transformArray() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::Transform>>& __cordl_internal_get__transformArray();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>> const& __cordl_internal_get__tubeLightArray() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>>& __cordl_internal_get__tubeLightArray();
  ...
  constexpr void __cordl_internal_set__canvasGroupArray(::ArrayW<::UnityW<::UnityEngine::CanvasGroup>> value);

  constexpr void __cordl_internal_set__directionalLights(::ArrayW<::UnityW<::GlobalNamespace::DirectionalLight>> value);

  constexpr void __cordl_internal_set__tmproArray(::ArrayW<::UnityW<::TMPro::TextMeshPro>> value);

  constexpr void __cordl_internal_set__transformArray(::ArrayW<::UnityW<::UnityEngine::Transform>> value);

  constexpr void __cordl_internal_set__tubeLightArray(::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>> value);

  constexpr void __cordl_internal_set_arrayType(::GlobalNamespace::TimelineArrayReference_ArrayTypes value);

  /// @brief Method .ctor, addr 0x590a5d8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>> ____tubeLightArray;

  /// @brief Field _canvasGroupArray, offset: 0x30, size: 0x8, def value: None
  ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>> ____canvasGroupArray;

  /// @brief Field _tmproArray, offset: 0x38, size: 0x8, def value: None
  ::ArrayW<::UnityW<::TMPro::TextMeshPro>> ____tmproArray;

  /// @brief Field _transformArray, offset: 0x40, size: 0x8, def value: None
  ::ArrayW<::UnityW<::UnityEngine::Transform>> ____transformArray;
...
static_assert(sizeof(::GlobalNamespace::TimelineArrayReference) == 0x50, "Size mismatch!");
