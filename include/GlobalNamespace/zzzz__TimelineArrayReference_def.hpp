...
/// @brief Field _canvasGroupArray, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__canvasGroupArray, put=__cordl_internal_set__canvasGroupArray)) ::ArrayW<::UnityW<::UnityEngine::CanvasGroup>,::Array<::UnityW<::UnityEngine::CanvasGroup>>*>  _canvasGroupArray;
...
/// @brief Field _transformArray, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__transformArray, put=__cordl_internal_set__transformArray)) ::ArrayW<::UnityW<::UnityEngine::Transform>,::Array<::UnityW<::UnityEngine::Transform>>*>  _transformArray;

/// @brief Field _tubeLightArray, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__tubeLightArray, put=__cordl_internal_set__tubeLightArray)) ::ArrayW<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>,::Array<::UnityW<::GlobalNamespace::TubeBloomPrePassLight>>*>  _tubeLightArray;
...
/// @brief Method .ctor, addr 0x5776b94, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
