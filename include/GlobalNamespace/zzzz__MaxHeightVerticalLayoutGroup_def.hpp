...
/// @brief Method CalculateLayoutInputHorizontal, addr 0x322cb5c, size 0x28, virtual true, abstract: false, final false
inline void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical, addr 0x322cb84, size 0x10, virtual true, abstract: false, final false
inline void CalculateLayoutInputVertical() ;

static inline ::GlobalNamespace::MaxHeightVerticalLayoutGroup* New_ctor() ;

/// @brief Method SetLayoutHorizontal, addr 0x322cb94, size 0x24, virtual true, abstract: false, final false
inline void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical, addr 0x322cc24, size 0x24, virtual true, abstract: false, final false
inline void SetLayoutVertical() ;

/// @brief Method SetMaxWidthAndHeight, addr 0x322cbb8, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x322cc48, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_maxHeight, addr 0x322cb4c, size 0x8, virtual false, abstract: false, final false
inline float_t get_maxHeight() ;

/// @brief Method set_maxHeight, addr 0x322cb54, size 0x8, virtual false, abstract: false, final false
