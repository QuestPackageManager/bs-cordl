...
public:
  ...
  /// @brief Method CalculateLayoutInputHorizontal, addr 0x3269034, size 0x28, virtual true, abstract: false, final false
  inline void CalculateLayoutInputHorizontal();

  /// @brief Method CalculateLayoutInputVertical, addr 0x326905c, size 0x10, virtual true, abstract: false, final false
  inline void CalculateLayoutInputVertical();

  static inline ::GlobalNamespace::MaxHeightVerticalLayoutGroup* New_ctor();

  /// @brief Method SetLayoutHorizontal, addr 0x326906c, size 0x24, virtual true, abstract: false, final false
  inline void SetLayoutHorizontal();

  /// @brief Method SetLayoutVertical, addr 0x32690fc, size 0x24, virtual true, abstract: false, final false
  inline void SetLayoutVertical();

  /// @brief Method SetMaxWidthAndHeight, addr 0x3269090, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3269120, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_maxHeight, addr 0x3269024, size 0x8, virtual false, abstract: false, final false
  inline float_t get_maxHeight();

  /// @brief Method set_maxHeight, addr 0x326902c, size 0x8, virtual false, abstract: false, final false
