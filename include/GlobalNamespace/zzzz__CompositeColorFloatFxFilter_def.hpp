...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompositeColorFloatFxFilter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompositeColorFloatFxFilter(CompositeColorFloatFxFilter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompositeColorFloatFxFilter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompositeColorFloatFxFilter(CompositeColorFloatFxFilterconst&) = delete;
