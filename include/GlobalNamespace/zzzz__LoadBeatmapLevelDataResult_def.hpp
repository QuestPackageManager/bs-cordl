...
/// @brief Field BeatmapLevelNotFoundInRepository, offset 0xffffffff, size 0x10 
 __declspec(property(get=getStaticF_BeatmapLevelNotFoundInRepository, put=setStaticF_BeatmapLevelNotFoundInRepository)) ::GlobalNamespace::LoadBeatmapLevelDataResult  BeatmapLevelNotFoundInRepository;
...
/// @brief Method FromValue, addr 0x363218c, size 0x54, virtual false, abstract: false, final false
static inline ::GlobalNamespace::LoadBeatmapLevelDataResult FromValue(::GlobalNamespace::IBeatmapLevelData*  beatmapLevelData) ;

/// @brief Method Success, addr 0x3632180, size 0xc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::LoadBeatmapLevelDataResult Success(::GlobalNamespace::IBeatmapLevelData*  beatmapLevelData) ;

/// @brief Method .ctor, addr 0x3632178, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_errorMessage, addr 0x363201c, size 0x15c, virtual false, abstract: false, final false
inline ::StringW get_errorMessage() ;

/// @brief Method get_isError, addr 0x3631fd8, size 0x44, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "errorType", ty: "::System::Nullable_1<::GlobalNamespace::LoadBeatmapLevelDataResult_ErrorType>", modifiers: "", def_value: None }, CppParam { name: "beatmapLevelData", ty: "::GlobalNamespace::IBeatmapLevelData*", modifiers: "", def_value: None }]
