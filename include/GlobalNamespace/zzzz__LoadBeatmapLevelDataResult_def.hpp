...
public:
  ...
  /// @brief Method FromValue, addr 0x2680e60, size 0x10, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::LoadBeatmapLevelDataResult FromValue(::GlobalNamespace::IBeatmapLevelData* beatmapLevelData);

  /// @brief Method Success, addr 0x2680e54, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::LoadBeatmapLevelDataResult Success(::GlobalNamespace::IBeatmapLevelData* beatmapLevelData);

  /// @brief Method .ctor, addr 0x26923e4, size 0x10, virtual false, abstract: false, final false
