...
public:
  ...
  /// @brief Method FromValue, addr 0x366eb78, size 0x54, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::LoadBeatmapLevelDataResult FromValue(::GlobalNamespace::IBeatmapLevelData* beatmapLevelData);

  /// @brief Method Success, addr 0x366eb6c, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::LoadBeatmapLevelDataResult Success(::GlobalNamespace::IBeatmapLevelData* beatmapLevelData);

  /// @brief Method .ctor, addr 0x366eb64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_errorMessage, addr 0x366ea08, size 0x15c, virtual false, abstract: false, final false
  inline ::StringW get_errorMessage();

  /// @brief Method get_isError, addr 0x366e9c4, size 0x44, virtual false, abstract: false, final false
