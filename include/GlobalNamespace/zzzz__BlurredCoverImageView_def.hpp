...
public:
  ...
  /// @brief Method MoveNext, addr 0x3afa6f0, size 0x748, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3afae38, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x3afa5a8, size 0xa4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetTextureAsync, addr 0x3afa64c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3afa6e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
