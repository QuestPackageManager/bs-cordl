...
// Write type traits
MARK_REF_T(::GlobalNamespace::BlurredCoverImageView*);
MARK_VAL_T(::GlobalNamespace::BlurredCoverImageView__SetTextureAsync_d__7);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BlurredCoverImageView*, "", "BlurredCoverImageView");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BlurredCoverImageView__SetTextureAsync_d__7, "", "BlurredCoverImageView/<SetTextureAsync>d__7");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59695a0, size 0x894, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5969e34, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::BlurredCoverImageView__SetTextureAsync_d__7) == 0x48, "Size mismatch!");
...
public:
  ...
  /// @brief Method OnDestroy, addr 0x5969438, size 0xb4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetTextureAsync, addr 0x59694ec, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596959c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BlurredCoverImageView) == 0x50, "Size mismatch!");
