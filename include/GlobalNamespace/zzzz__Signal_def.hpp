...
/// @brief Method Raise, addr 0x56a3ee0, size 0x1c, virtual true, abstract: false, final false
inline void Raise() ;

/// @brief Method Subscribe, addr 0x56a3efc, size 0x28, virtual false, abstract: false, final false
inline void Subscribe(::System::Action*  foo) ;

/// @brief Method Unsubscribe, addr 0x56a3f24, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56a3f28, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add__event, addr 0x56a3d88, size 0xac, virtual false, abstract: false, final false
inline void add__event(::System::Action*  value) ;

/// @brief Method remove__event, addr 0x56a3e34, size 0xac, virtual false, abstract: false, final false
