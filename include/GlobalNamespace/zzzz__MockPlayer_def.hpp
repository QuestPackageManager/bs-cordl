...
/// @brief Method Block, addr 0x5822578, size 0x38, virtual true, abstract: false, final true
inline void Block() ;

/// @brief Method Connect, addr 0x5820b6c, size 0x103c, virtual true, abstract: false, final false
inline void Connect(::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::BeatmapLevelsModel*  beatmapLevelsModel, ::GlobalNamespace::BeatmapDataLoader*  beatmapDataLoader, ::GlobalNamespace::EnvironmentsListModel*  environmentsListModel, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection, ::GlobalNamespace::NodePoseSyncStateManager*  nodePoseSyncStateManager) ;

/// @brief Method Disconnect, addr 0x58224c4, size 0xc, virtual true, abstract: false, final false
inline void Disconnect() ;

/// @brief Method HasState, addr 0x5820564, size 0x64, virtual true, abstract: false, final true
inline bool HasState(::StringW  state) ;

/// @brief Method Invite, addr 0x58225ec, size 0x38, virtual true, abstract: false, final true
inline void Invite() ;

/// @brief Method Join, addr 0x582265c, size 0x38, virtual true, abstract: false, final false
inline void Join() ;

/// @brief Method Join, addr 0x5822624, size 0x38, virtual true, abstract: false, final false
inline void Join(::StringW  password) ;

/// @brief Method Kick, addr 0x58225b4, size 0x38, virtual true, abstract: false, final true
inline void Kick() ;

/// @brief Method Leave, addr 0x58225b0, size 0x4, virtual true, abstract: false, final true
inline void Leave() ;

static inline ::GlobalNamespace::MockPlayer* New_ctor(::GlobalNamespace::MockPlayerSettings*  settings, bool  isLocalPlayer) ;

/// @brief Method RecommendBeatmapLevel, addr 0x5822784, size 0x14, virtual false, abstract: false, final false
inline void RecommendBeatmapLevel(::GlobalNamespace::BeatmapDifficulty  beatmapDifficulty, ::StringW  beatmapLevelId) ;

/// @brief Method SendInviteResponse, addr 0x5822540, size 0x38, virtual true, abstract: false, final true
inline void SendInviteResponse(bool  accept) ;

/// @brief Method SendJoinResponse, addr 0x5822508, size 0x38, virtual true, abstract: false, final true
inline void SendJoinResponse(bool  accept) ;

/// @brief Method SetState, addr 0x5820624, size 0xac, virtual false, abstract: false, final false
inline bool SetState(::StringW  state, bool  value) ;

/// @brief Method SimulateFail, addr 0x5822694, size 0x24, virtual false, abstract: false, final false
inline void SimulateFail() ;

/// @brief Method SimulateGiveUp, addr 0x58226b8, size 0x24, virtual false, abstract: false, final false
inline void SimulateGiveUp() ;

/// @brief Method SimulateReturnToMainMenu, addr 0x58226dc, size 0xa8, virtual false, abstract: false, final false
inline void SimulateReturnToMainMenu() ;

/// @brief Method Tick, addr 0x5820b68, size 0x4, virtual false, abstract: false, final false
inline void Tick() ;

/// @brief Method Unblock, addr 0x58224d0, size 0x38, virtual true, abstract: false, final true
inline void Unblock() ;
...
/// @brief Method .ctor, addr 0x5820ac0, size 0xa8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::MockPlayerSettings*  settings, bool  isLocalPlayer) ;

/// @brief Method get_autoConnect, addr 0x58202a4, size 0x18, virtual false, abstract: false, final false
inline bool get_autoConnect() ;

/// @brief Method get_canBlock, addr 0x58204f8, size 0x8, virtual true, abstract: false, final true
inline bool get_canBlock() ;

/// @brief Method get_canInvite, addr 0x58204b8, size 0x8, virtual true, abstract: false, final true
inline bool get_canInvite() ;

/// @brief Method get_canJoin, addr 0x5820490, size 0x8, virtual true, abstract: false, final false
inline bool get_canJoin() ;

/// @brief Method get_canKick, addr 0x58204d8, size 0x8, virtual true, abstract: false, final true
inline bool get_canKick() ;

/// @brief Method get_canLeave, addr 0x58204e8, size 0x8, virtual true, abstract: false, final true
inline bool get_canLeave() ;

/// @brief Method get_canUnblock, addr 0x5820508, size 0x8, virtual true, abstract: false, final true
inline bool get_canUnblock() ;

/// @brief Method get_compatibilityVersion, addr 0x5820248, size 0x44, virtual true, abstract: false, final true
inline ::StringW get_compatibilityVersion() ;

/// @brief Method get_configuration, addr 0x5820454, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_connectedPlayer, addr 0x582048c, size 0x4, virtual true, abstract: false, final true
inline ::GlobalNamespace::IBeatSaberConnectedPlayer* get_connectedPlayer() ;

/// @brief Method get_currentLatency, addr 0x58203d4, size 0x28, virtual true, abstract: false, final true
inline int64_t get_currentLatency() ;

/// @brief Method get_currentPartySize, addr 0x5820414, size 0x8, virtual true, abstract: false, final true
inline int32_t get_currentPartySize() ;

/// @brief Method get_disconnectedReason, addr 0x582031c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::DisconnectedReason get_disconnectedReason() ;

/// @brief Method get_finishedLevel, addr 0x5820970, size 0x4c, virtual false, abstract: false, final false
inline bool get_finishedLevel() ;

/// @brief Method get_hasValidLatency, addr 0x58203fc, size 0x8, virtual true, abstract: false, final true
inline bool get_hasValidLatency() ;

/// @brief Method get_inactiveByDefault, addr 0x58202bc, size 0x18, virtual false, abstract: false, final false
inline bool get_inactiveByDefault() ;

/// @brief Method get_isActive, addr 0x58208c8, size 0x4c, virtual false, abstract: false, final false
inline bool get_isActive() ;

/// @brief Method get_isConnected, addr 0x58202d4, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnected() ;

/// @brief Method get_isConnectionOwner, addr 0x582030c, size 0x8, virtual true, abstract: false, final true
inline bool get_isConnectionOwner() ;

/// @brief Method get_isDedicatedServer, addr 0x58206d0, size 0x4c, virtual false, abstract: false, final false
inline bool get_isDedicatedServer() ;

/// @brief Method get_isKicked, addr 0x5820404, size 0x8, virtual true, abstract: false, final true
inline bool get_isKicked() ;

/// @brief Method get_isMe, addr 0x5820210, size 0x8, virtual true, abstract: false, final true
inline bool get_isMe() ;

/// @brief Method get_isMyPartyOwner, addr 0x582047c, size 0x8, virtual true, abstract: false, final true
inline bool get_isMyPartyOwner() ;

/// @brief Method get_isPlayer, addr 0x5820518, size 0x4c, virtual false, abstract: false, final false
inline bool get_isPlayer() ;

/// @brief Method get_isReady, addr 0x5820200, size 0x8, virtual false, abstract: false, final false
inline bool get_isReady() ;

/// @brief Method get_isTerminating, addr 0x5820a18, size 0x4c, virtual false, abstract: false, final false
inline bool get_isTerminating() ;

/// @brief Method get_isWaitingOnInvite, addr 0x58204c8, size 0x8, virtual true, abstract: false, final true
inline bool get_isWaitingOnInvite() ;

/// @brief Method get_isWaitingOnJoin, addr 0x58204a8, size 0x8, virtual true, abstract: false, final true
inline bool get_isWaitingOnJoin() ;

/// @brief Method get_multiplayerAvatarsData, addr 0x58202e4, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::MultiplayerAvatarsData get_multiplayerAvatarsData() ;

/// @brief Method get_offsetSyncTime, addr 0x5820324, size 0xb0, virtual true, abstract: false, final true
inline int64_t get_offsetSyncTime() ;

/// @brief Method get_requiresPassword, addr 0x5820498, size 0x8, virtual true, abstract: false, final true
inline bool get_requiresPassword() ;

/// @brief Method get_selectionMask, addr 0x5820424, size 0x18, virtual true, abstract: false, final true
inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask() ;

/// @brief Method get_sortIndex, addr 0x582028c, size 0x18, virtual true, abstract: false, final true
inline int32_t get_sortIndex() ;

/// @brief Method get_userId, addr 0x5820218, size 0x18, virtual true, abstract: false, final true
inline ::StringW get_userId() ;

/// @brief Method get_userName, addr 0x5820230, size 0x18, virtual true, abstract: false, final true
inline ::StringW get_userName() ;

/// @brief Method get_wantsToPlayNextLevel, addr 0x5820778, size 0x4c, virtual false, abstract: false, final false
inline bool get_wantsToPlayNextLevel() ;

/// @brief Method get_wasActiveAtLevelStart, addr 0x5820820, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method set_canBlock, addr 0x5820500, size 0x8, virtual false, abstract: false, final false
inline void set_canBlock(bool  value) ;

/// @brief Method set_canInvite, addr 0x58204c0, size 0x8, virtual false, abstract: false, final false
inline void set_canInvite(bool  value) ;

/// @brief Method set_canKick, addr 0x58204e0, size 0x8, virtual false, abstract: false, final false
inline void set_canKick(bool  value) ;

/// @brief Method set_canLeave, addr 0x58204f0, size 0x8, virtual false, abstract: false, final false
inline void set_canLeave(bool  value) ;

/// @brief Method set_canUnblock, addr 0x5820510, size 0x8, virtual false, abstract: false, final false
inline void set_canUnblock(bool  value) ;

/// @brief Method set_configuration, addr 0x5820468, size 0x14, virtual false, abstract: false, final false
inline void set_configuration(::GlobalNamespace::GameplayServerConfiguration  value) ;

/// @brief Method set_currentPartySize, addr 0x582041c, size 0x8, virtual false, abstract: false, final false
inline void set_currentPartySize(int32_t  value) ;

/// @brief Method set_finishedLevel, addr 0x58209bc, size 0x5c, virtual false, abstract: false, final false
inline void set_finishedLevel(bool  value) ;

/// @brief Method set_isActive, addr 0x5820914, size 0x5c, virtual false, abstract: false, final false
inline void set_isActive(bool  value) ;

/// @brief Method set_isConnected, addr 0x58202dc, size 0x8, virtual false, abstract: false, final false
inline void set_isConnected(bool  value) ;

/// @brief Method set_isConnectionOwner, addr 0x5820314, size 0x8, virtual false, abstract: false, final false
inline void set_isConnectionOwner(bool  value) ;

/// @brief Method set_isDedicatedServer, addr 0x582071c, size 0x5c, virtual false, abstract: false, final false
inline void set_isDedicatedServer(bool  value) ;

/// @brief Method set_isKicked, addr 0x582040c, size 0x8, virtual false, abstract: false, final false
inline void set_isKicked(bool  value) ;

/// @brief Method set_isMyPartyOwner, addr 0x5820484, size 0x8, virtual false, abstract: false, final false
inline void set_isMyPartyOwner(bool  value) ;

/// @brief Method set_isPlayer, addr 0x58205c8, size 0x5c, virtual false, abstract: false, final false
inline void set_isPlayer(bool  value) ;

/// @brief Method set_isReady, addr 0x5820208, size 0x8, virtual false, abstract: false, final false
inline void set_isReady(bool  value) ;

/// @brief Method set_isTerminating, addr 0x5820a64, size 0x5c, virtual false, abstract: false, final false
inline void set_isTerminating(bool  value) ;

/// @brief Method set_isWaitingOnInvite, addr 0x58204d0, size 0x8, virtual false, abstract: false, final false
inline void set_isWaitingOnInvite(bool  value) ;

/// @brief Method set_isWaitingOnJoin, addr 0x58204b0, size 0x8, virtual false, abstract: false, final false
inline void set_isWaitingOnJoin(bool  value) ;

/// @brief Method set_multiplayerAvatarsData, addr 0x58202f8, size 0x14, virtual false, abstract: false, final false
inline void set_multiplayerAvatarsData(::GlobalNamespace::MultiplayerAvatarsData  value) ;

/// @brief Method set_requiresPassword, addr 0x58204a0, size 0x8, virtual false, abstract: false, final false
inline void set_requiresPassword(bool  value) ;

/// @brief Method set_selectionMask, addr 0x582043c, size 0x18, virtual false, abstract: false, final false
inline void set_selectionMask(::GlobalNamespace::BeatmapLevelSelectionMask  value) ;

/// @brief Method set_wantsToPlayNextLevel, addr 0x58207c4, size 0x5c, virtual false, abstract: false, final false
inline void set_wantsToPlayNextLevel(bool  value) ;

/// @brief Method set_wasActiveAtLevelStart, addr 0x582086c, size 0x5c, virtual false, abstract: false, final false
