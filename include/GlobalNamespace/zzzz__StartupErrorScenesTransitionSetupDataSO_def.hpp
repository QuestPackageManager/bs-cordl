...
public:
  // Declarations
  /// @brief Method Init, addr 0x3b47aa0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b4d628, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
