...
public:
  // Declarations
  /// @brief Method Init, addr 0x26ba45c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bfcec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
