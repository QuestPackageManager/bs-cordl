...
public:
  // Declarations
  /// @brief Method Init, addr 0x3b3eff0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b44b78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
