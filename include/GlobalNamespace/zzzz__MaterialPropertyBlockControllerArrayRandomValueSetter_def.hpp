...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MaterialPropertyBlockControllerArrayRandomValueSetter", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "MaterialPropertyBlockControllerArrayRandomValueSetter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MaterialPropertyBlockControllerArrayRandomValueSetter(MaterialPropertyBlockControllerArrayRandomValueSetterconst&) = delete;
