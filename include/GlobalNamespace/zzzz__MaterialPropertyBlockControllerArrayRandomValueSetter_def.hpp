...
public:
  ...
  /// @brief Method ApplyParams, addr 0x56be168, size 0x190, virtual false, abstract: false, final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyBlockControllerArrayRandomValueSetter* New_ctor();

  /// @brief Method OnValidate, addr 0x56be2f8, size 0x28, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyId, addr 0x56be148, size 0x20, virtual false, abstract: false, final false
  inline void RefreshPropertyId();

  /// @brief Method Start, addr 0x56be120, size 0x28, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x56be320, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
