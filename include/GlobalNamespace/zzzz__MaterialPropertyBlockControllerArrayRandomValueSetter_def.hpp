...
public:
  ...
  /// @brief Method ApplyParams, addr 0x39f4030, size 0x140, virtual false, abstract: false, final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyBlockControllerArrayRandomValueSetter* New_ctor();

  /// @brief Method OnValidate, addr 0x39f4170, size 0x24, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyId, addr 0x39f4010, size 0x20, virtual false, abstract: false, final false
  inline void RefreshPropertyId();

  /// @brief Method Start, addr 0x39f3fec, size 0x24, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x39f4194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
