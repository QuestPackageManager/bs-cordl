...
public:
  ...
  /// @brief Method Block, addr 0x262fff4, size 0xac, virtual false, abstract: false, final false
  inline void Block();

  /// @brief Method Invite, addr 0x26301f8, size 0xac, virtual false, abstract: false, final false
  inline void Invite();

  /// @brief Method Join, addr 0x263014c, size 0xac, virtual false, abstract: false, final false
  inline void Join();

  /// @brief Method Kick, addr 0x26302a4, size 0xac, virtual false, abstract: false, final false
  inline void Kick();

  /// @brief Method Leave, addr 0x2630350, size 0xac, virtual false, abstract: false, final false
  inline void Leave();

  static inline ::GlobalNamespace::NetworkPlayerOptionsTableCell* New_ctor();

  /// @brief Method Refresh, addr 0x262f480, size 0xb74, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method Unblock, addr 0x26300a0, size 0xac, virtual false, abstract: false, final false
  inline void Unblock();
  ...
  /// @brief Method .ctor, addr 0x26303fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_player, addr 0x262f470, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::INetworkPlayer* get_player();

  /// @brief Method set_player, addr 0x262f478, size 0x8, virtual false, abstract: false, final false
