...
public:
  ...
  /// @brief Method Block, addr 0x3c15060, size 0xac, virtual false, abstract: false, final false
  inline void Block();

  /// @brief Method Invite, addr 0x3c15264, size 0xac, virtual false, abstract: false, final false
  inline void Invite();

  /// @brief Method Join, addr 0x3c151b8, size 0xac, virtual false, abstract: false, final false
  inline void Join();

  /// @brief Method Kick, addr 0x3c15310, size 0xac, virtual false, abstract: false, final false
  inline void Kick();

  /// @brief Method Leave, addr 0x3c153bc, size 0xac, virtual false, abstract: false, final false
  inline void Leave();

  static inline ::GlobalNamespace::NetworkPlayerOptionsTableCell* New_ctor();

  /// @brief Method Refresh, addr 0x3c144c8, size 0xb98, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method Unblock, addr 0x3c1510c, size 0xac, virtual false, abstract: false, final false
  inline void Unblock();
  ...
  /// @brief Method .ctor, addr 0x3c15468, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_player, addr 0x3c144b8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::INetworkPlayer* get_player();

  /// @brief Method set_player, addr 0x3c144c0, size 0x8, virtual false, abstract: false, final false
