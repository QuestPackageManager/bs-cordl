...
/// @brief Method Block, addr 0x586c71c, size 0xb0, virtual false, abstract: false, final false
inline void Block() ;

/// @brief Method Invite, addr 0x586c92c, size 0xb0, virtual false, abstract: false, final false
inline void Invite() ;

/// @brief Method Join, addr 0x586c87c, size 0xb0, virtual false, abstract: false, final false
inline void Join() ;

/// @brief Method Kick, addr 0x586c9dc, size 0xb0, virtual false, abstract: false, final false
inline void Kick() ;

/// @brief Method Leave, addr 0x586ca8c, size 0xb0, virtual false, abstract: false, final false
inline void Leave() ;

static inline ::GlobalNamespace::NetworkPlayerOptionsTableCell* New_ctor() ;

/// @brief Method Refresh, addr 0x586ba48, size 0xcd4, virtual false, abstract: false, final false
inline void Refresh() ;

/// @brief Method Unblock, addr 0x586c7cc, size 0xb0, virtual false, abstract: false, final false
inline void Unblock() ;
...
/// @brief Method .ctor, addr 0x586cb3c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_player, addr 0x586ba38, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::INetworkPlayer* get_player() ;

/// @brief Method set_player, addr 0x586ba40, size 0x8, virtual false, abstract: false, final false
