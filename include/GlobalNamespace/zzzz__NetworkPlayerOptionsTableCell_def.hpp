...
public:
  ...
  /// @brief Method Block, addr 0x23aa4d0, size 0xac, virtual false, abstract: false, final false
  inline void Block();

  /// @brief Method Invite, addr 0x23aa6d4, size 0xac, virtual false, abstract: false, final false
  inline void Invite();

  /// @brief Method Join, addr 0x23aa628, size 0xac, virtual false, abstract: false, final false
  inline void Join();

  /// @brief Method Kick, addr 0x23aa780, size 0xac, virtual false, abstract: false, final false
  inline void Kick();

  /// @brief Method Leave, addr 0x23aa82c, size 0xac, virtual false, abstract: false, final false
  inline void Leave();

  static inline ::GlobalNamespace::NetworkPlayerOptionsTableCell* New_ctor();

  /// @brief Method Refresh, addr 0x23a995c, size 0xb74, virtual false, abstract: false, final false
  inline void Refresh();

  /// @brief Method Unblock, addr 0x23aa57c, size 0xac, virtual false, abstract: false, final false
  inline void Unblock();
  ...
  /// @brief Method .ctor, addr 0x23aa8d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_player, addr 0x23a994c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::INetworkPlayer* get_player();

  /// @brief Method set_player, addr 0x23a9954, size 0x8, virtual false, abstract: false, final false
