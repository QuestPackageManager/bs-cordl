...
public:
  // Declarations
  /// @brief Method Awake, addr 0x39c0968, size 0x64, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::AOTEnforcer* New_ctor();

  /// @brief Method .ctor, addr 0x39c09cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
