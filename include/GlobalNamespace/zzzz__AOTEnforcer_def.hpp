...
public:
  // Declarations
  /// @brief Method Awake, addr 0x5709ec0, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::AOTEnforcer* New_ctor();

  /// @brief Method .ctor, addr 0x5709f2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
