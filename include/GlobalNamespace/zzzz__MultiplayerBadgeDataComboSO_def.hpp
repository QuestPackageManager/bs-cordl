...
public:
  // Declarations
  /// @brief Method GetValue, addr 0x3733134, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x373315c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeDataComboSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerBadgeDataComboSO(MultiplayerBadgeDataComboSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeDataComboSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerBadgeDataComboSO(MultiplayerBadgeDataComboSOconst&) = delete;
