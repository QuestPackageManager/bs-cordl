...
/// @brief Method InitIfNeeded, addr 0x56ade0c, size 0x190, virtual false, abstract: false, final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::BloomPrePassBackgroundColor* New_ctor() ;

/// @brief Method Render, addr 0x56adf9c, size 0xd4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56ae070, size 0x6c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_bgColor, addr 0x56add74, size 0x98, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_bgColor() ;

/// @brief Method get_color, addr 0x56add5c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x56add68, size 0xc, virtual false, abstract: false, final false
