...
public:
  ...
  /// @brief Method InitIfNeeded, addr 0x39d6364, size 0x184, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundColor* New_ctor();

  /// @brief Method Render, addr 0x39d64e8, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39d65bc, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bgColor, addr 0x39d62d4, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_bgColor();

  /// @brief Method get_color, addr 0x39d62bc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x39d62c8, size 0xc, virtual false, abstract: false, final false
