...
public:
  ...
  /// @brief Method InitIfNeeded, addr 0x56ae084, size 0x190, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundColor* New_ctor();

  /// @brief Method Render, addr 0x56ae214, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56ae2e8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bgColor, addr 0x56adfec, size 0x98, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_bgColor();

  /// @brief Method get_color, addr 0x56adfd4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x56adfe0, size 0xc, virtual false, abstract: false, final false
