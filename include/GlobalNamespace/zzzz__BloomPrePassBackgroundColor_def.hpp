...
public:
  ...
  /// @brief Method InitIfNeeded, addr 0x2266c7c, size 0x184, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundColor* New_ctor();

  /// @brief Method Render, addr 0x2266e00, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2266ed4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bgColor, addr 0x2266bec, size 0x90, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_bgColor();

  /// @brief Method get_color, addr 0x2266bd4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x2266be0, size 0xc, virtual false, abstract: false, final false
