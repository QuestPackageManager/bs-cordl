...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BloomFogSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BloomFogSO(BloomFogSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BloomFogSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BloomFogSO(BloomFogSOconst&) = delete;
