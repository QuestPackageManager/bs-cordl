...
public:
  ...
  /// @brief Method set_transition, addr 0x2101ebc, size 0x18, virtual false, abstract: false, final false
  inline void set_transition(float_t value);

  /// @brief Method get_transition, addr 0x21025a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_bloomFogEnabled, addr 0x2101f3c, size 0x78, virtual false, abstract: false, final false
  inline void set_bloomFogEnabled(bool value);

  /// @brief Method get_bloomFogEnabled, addr 0x21025c0, size 0x8, virtual false, abstract: false, final false
  inline bool get_bloomFogEnabled();

  /// @brief Method set_legacyAutoExposureEnabled, addr 0x2101fb4, size 0x1c, virtual false, abstract: false, final false
  inline void set_legacyAutoExposureEnabled(bool value);

  /// @brief Method get_legacyAutoExposureEnabled, addr 0x21025c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_legacyAutoExposureEnabled();

  /// @brief Method get_autoExposureLimit, addr 0x21025d0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_autoExposureLimit();

  /// @brief Method get_noteSpawnIntensity, addr 0x21025d8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_noteSpawnIntensity();

  /// @brief Method Setup, addr 0x2101ed4, size 0x8, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::BloomFogEnvironmentParams* defaultFogParams);

  /// @brief Method OnEnable, addr 0x21025e0, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method UpdateShaderParams, addr 0x2101fd0, size 0x18c, virtual false, abstract: false, final false
  inline void UpdateShaderParams();

  /// @brief Method SetParams, addr 0x21025fc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2102734, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
