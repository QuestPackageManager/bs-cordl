...
/// @brief Method get_AdvertisementUuid, addr 0x5c6ec44, size 0xc, virtual false, abstract: false, final false
inline ::System::Guid get_AdvertisementUuid() ;

/// @brief Method get_Metadata, addr 0x5c6ec58, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Metadata() ;

/// @brief Method set_AdvertisementUuid, addr 0x5c6ec50, size 0x8, virtual false, abstract: false, final false
inline void set_AdvertisementUuid(::System::Guid  value) ;

/// @brief Method set_Metadata, addr 0x5c6ec60, size 0x8, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "_AdvertisementUuid_k__BackingField", ty: "::System::Guid", modifiers: "", def_value: None }, CppParam { name: "_Metadata_k__BackingField", ty: "::ArrayW<uint8_t,::Array<uint8_t>*>", modifiers: "", def_value: None }]
...
/// @brief Method OnColocationSessionAdvertisementComplete, addr 0x5c6ea70, size 0xe8, virtual false, abstract: false, final false
static inline void OnColocationSessionAdvertisementComplete(uint64_t  requestId, ::GlobalNamespace::OVRPlugin_Result  result) ;

/// @brief Method OnColocationSessionDiscoveryComplete, addr 0x5c6eb58, size 0xe8, virtual false, abstract: false, final false
static inline void OnColocationSessionDiscoveryComplete(uint64_t  requestId, ::GlobalNamespace::OVRPlugin_Result  result) ;

/// @brief Method OnColocationSessionDiscoveryResult, addr 0x5c6e970, size 0x100, virtual false, abstract: false, final false
...
/// @brief Method OnColocationSessionStartAdvertisementComplete, addr 0x5c6e730, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method OnColocationSessionStartDiscoveryComplete, addr 0x5c6e860, size 0x88, virtual false, abstract: false, final false
static inline void OnColocationSessionStartDiscoveryComplete(uint64_t  requestId, ::GlobalNamespace::OVRPlugin_Result  result) ;

/// @brief Method OnColocationSessionStopAdvertisementComplete, addr 0x5c6e7d8, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method OnColocationSessionStopDiscoveryComplete, addr 0x5c6e8e8, size 0x88, virtual false, abstract: false, final false
static inline void OnColocationSessionStopDiscoveryComplete(uint64_t  requestId, ::GlobalNamespace::OVRPlugin_Result  result) ;

/// @brief Method StartAdvertisementAsync, addr 0x5c6e2d4, size 0x1b0, virtual false, abstract: false, final false
...
/// @brief Method StartDiscoveryAsync, addr 0x5c6e568, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method StopAdvertisementAsync, addr 0x5c6e484, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method StopDiscoveryAsync, addr 0x5c6e64c, size 0xe4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5c6ec40, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_ColocationSessionDiscovered, addr 0x5c6e114, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method remove_ColocationSessionDiscovered, addr 0x5c6e1f4, size 0xe0, virtual false, abstract: false, final false
