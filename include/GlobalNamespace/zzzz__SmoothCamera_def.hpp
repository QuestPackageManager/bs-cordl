...
public:
  ...
  /// @brief Method Init, addr 0x58bdf40, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x58be12c, size 0x240, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::SmoothCamera* New_ctor();

  /// @brief Method OnDisable, addr 0x58be110, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58be0f4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58be36c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
