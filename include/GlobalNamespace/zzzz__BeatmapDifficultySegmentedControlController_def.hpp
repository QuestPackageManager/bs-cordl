...
public:
  ...
  /// @brief Method Awake, addr 0x3b65fdc, size 0x90, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method GetClosestDifficultyIndex, addr 0x3b6613c, size 0x14c, virtual false, abstract: false, final false
  inline int32_t GetClosestDifficultyIndex(::GlobalNamespace::BeatmapDifficulty searchDifficulty);

  /// @brief Method HandleDifficultySegmentedControlDidSelectCell, addr 0x3b66288, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b6606c, size 0xd0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetData, addr 0x3b66310, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b66804, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectDifficultyEvent, addr 0x3b65e74, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_selectedDifficulty, addr 0x3b65fd4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_selectedDifficulty();

  /// @brief Method remove_didSelectDifficultyEvent, addr 0x3b65f24, size 0xb0, virtual false, abstract: false, final false
