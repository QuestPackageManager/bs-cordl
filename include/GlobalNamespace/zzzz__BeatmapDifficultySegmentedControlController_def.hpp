...
/// @brief Method Awake, addr 0x57a6508, size 0x90, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetClosestDifficultyIndex, addr 0x57a6674, size 0x118, virtual false, abstract: false, final false
inline int32_t GetClosestDifficultyIndex(::GlobalNamespace::BeatmapDifficulty  searchDifficulty) ;

/// @brief Method HandleDifficultySegmentedControlDidSelectCell, addr 0x57a678c, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57a6598, size 0xdc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetData, addr 0x57a6824, size 0x4f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a6d1c, size 0x7c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectDifficultyEvent, addr 0x57a6380, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_selectedDifficulty, addr 0x57a6500, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficulty get_selectedDifficulty() ;

/// @brief Method remove_didSelectDifficultyEvent, addr 0x57a6440, size 0xc0, virtual false, abstract: false, final false
