...
public:
  ...
  __declspec(property(get = __cordl_internal_get__reusableControlPointsArray2, put = __cordl_internal_set__reusableControlPointsArray2)) ::ArrayW<::UnityEngine::Vector3> _reusableControlPointsArray2;

  /// @brief Field _reusableControlPointsArray4, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get__reusableControlPointsArray4, put = __cordl_internal_set__reusableControlPointsArray4)) ::ArrayW<::UnityEngine::Vector3> _reusableControlPointsArray4;
  ...
  /// @brief Method CreateBezierPathAndMesh, addr 0x5974800, size 0xaa4, virtual false, abstract: false, final false
  ...
  /// @brief Method CutDirectionToControlPointPosition, addr 0x5979c20, size 0xa8, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__reusableControlPointsArray2() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__reusableControlPointsArray2();

  constexpr ::ArrayW<::UnityEngine::Vector3> const& __cordl_internal_get__reusableControlPointsArray4() const;

  constexpr ::ArrayW<::UnityEngine::Vector3>& __cordl_internal_get__reusableControlPointsArray4();
  ...
  constexpr void __cordl_internal_set__reusableControlPointsArray2(::ArrayW<::UnityEngine::Vector3> value);

  constexpr void __cordl_internal_set__reusableControlPointsArray4(::ArrayW<::UnityEngine::Vector3> value);

  constexpr void __cordl_internal_set__sliderMeshConstructor(::UnityW<::GlobalNamespace::SliderMeshConstructor> value);

  /// @brief Method .ctor, addr 0x5979cc8, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x5979c00, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_mesh();

  /// @brief Method get_pathLength, addr 0x5979bdc, size 0x24, virtual false, abstract: false, final false
  inline float_t get_pathLength();

  /// @brief Method get_pathsHolder, addr 0x5979c18, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector3> ____reusableControlPointsArray4;

  /// @brief Field _reusableControlPointsArray2, offset: 0x58, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector3> ____reusableControlPointsArray2;
...
static_assert(sizeof(::GlobalNamespace::SliderMeshController) == 0x60, "Size mismatch!");
