...
/// @brief Field _controlPointDistancePerSqrtNotesDistance, offset 0x24, size 0x4 
 __declspec(property(get=__cordl_internal_get__controlPointDistancePerSqrtNotesDistance, put=__cordl_internal_set__controlPointDistancePerSqrtNotesDistance)) float_t  _controlPointDistancePerSqrtNotesDistance;
...
/// @brief Field _reusableAnchorsList, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableAnchorsList, put=__cordl_internal_set__reusableAnchorsList)) ::System::Collections::Generic::List_1<::UnityEngine::Vector3>*  _reusableAnchorsList;

/// @brief Field _reusableControlPointsArray2, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableControlPointsArray2, put=__cordl_internal_set__reusableControlPointsArray2)) ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  _reusableControlPointsArray2;

/// @brief Field _reusableControlPointsArray4, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__reusableControlPointsArray4, put=__cordl_internal_set__reusableControlPointsArray4)) ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  _reusableControlPointsArray4;
...
/// @brief Method CreateBezierPathAndMesh, addr 0x583cf14, size 0x78c, virtual false, abstract: false, final false
...
/// @brief Method CutDirectionToControlPointPosition, addr 0x5841fa8, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5842050, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mesh, addr 0x5841f88, size 0x18, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> get_mesh() ;

/// @brief Method get_pathLength, addr 0x5841f64, size 0x24, virtual false, abstract: false, final false
inline float_t get_pathLength() ;

/// @brief Method get_pathsHolder, addr 0x5841fa0, size 0x8, virtual false, abstract: false, final false
