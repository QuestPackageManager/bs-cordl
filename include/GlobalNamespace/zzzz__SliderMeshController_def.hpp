...
public:
  ...
  /// @brief Method CreateBezierPathAndMesh, addr 0x25a8428, size 0x758, virtual false, abstract: false, final false
  ...
  /// @brief Method CutDirectionToControlPointPosition, addr 0x25acfa0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ad07c, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mesh, addr 0x25acf7c, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> get_mesh();

  /// @brief Method get_pathLength, addr 0x25acf58, size 0x24, virtual false, abstract: false, final false
  inline float_t get_pathLength();

  /// @brief Method get_pathsHolder, addr 0x25acf98, size 0x8, virtual false, abstract: false, final false
