...
// Write type traits
MARK_REF_T(::GlobalNamespace::NoteDebrisPhysics*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NoteDebrisPhysics*, "", "NoteDebrisPhysics");
...
static_assert(sizeof(::GlobalNamespace::NoteDebrisPhysics) == 0x20, "Size mismatch!");
