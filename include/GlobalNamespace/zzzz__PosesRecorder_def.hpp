...
public:
  ...
  /// @brief Method <Init>b__6_0, addr 0x57570f8, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> _Init_b__6_0(::GlobalNamespace::PoseObject* ro);

  /// @brief Method <Init>b__6_1, addr 0x575710c, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _Init_b__6_1(::GlobalNamespace::PoseObject* ro);

  /// @brief Method .ctor, addr 0x57570f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x57547a0, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x5756df8, size 0x18, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::PosesRecorder* New_ctor();

  /// @brief Method RecordTick, addr 0x5756e10, size 0x144, virtual false, abstract: false, final false
  inline void RecordTick(float_t time);

  /// @brief Method StartRecording, addr 0x57551c8, size 0xc, virtual false, abstract: false, final false
  inline void StartRecording();

  /// @brief Method StopRecording, addr 0x575513c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x575709c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x5756df0, size 0x8, virtual false, abstract: false, final false
