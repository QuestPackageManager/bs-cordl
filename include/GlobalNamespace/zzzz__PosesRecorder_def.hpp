...
public:
  ...
  /// @brief Method <Init>b__6_0, addr 0x3b1b640, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> _Init_b__6_0(::GlobalNamespace::PoseObject* ro);

  /// @brief Method <Init>b__6_1, addr 0x3b1b658, size 0x20, virtual false, abstract: false, final false
  inline ::StringW _Init_b__6_1(::GlobalNamespace::PoseObject* ro);

  /// @brief Method .ctor, addr 0x3b1b638, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x3b18d30, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x3b1b284, size 0x1c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::PosesRecorder* New_ctor();

  /// @brief Method RecordTick, addr 0x3b1b2a0, size 0x1c4, virtual false, abstract: false, final false
  inline void RecordTick(float_t time);

  /// @brief Method StartRecording, addr 0x3b196d8, size 0xc, virtual false, abstract: false, final false
  inline void StartRecording();

  /// @brief Method StopRecording, addr 0x3b19650, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b1b5d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_data, addr 0x3b1b27c, size 0x8, virtual false, abstract: false, final false
