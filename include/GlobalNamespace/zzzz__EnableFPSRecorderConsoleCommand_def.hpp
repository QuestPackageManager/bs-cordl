...
public:
  ...
  /// @brief Method ExecuteAsync, addr 0x32cf53c, size 0x190, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32cf6cc, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_commandName, addr 0x32cf4b4, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_commandName();

  /// @brief Method get_description, addr 0x32cf4f8, size 0x44, virtual true, abstract: false, final false
