...
public:
  ...
  /// @brief Method Awake, addr 0x583925c, size 0x98, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleObstacleControllerDidInit, addr 0x58396a0, size 0xd8, virtual false, abstract: false, final false
  inline void HandleObstacleControllerDidInit(::GlobalNamespace::ObstacleControllerBase* obstacleController);

  /// @brief Method HandleObstacleControllerDidUpdateProgress, addr 0x583956c, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5839430, size 0x13c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UpdateScale, addr 0x58392f4, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5839778, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
