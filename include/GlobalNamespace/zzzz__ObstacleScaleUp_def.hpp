...
/// @brief Method Awake, addr 0x583ab08, size 0x98, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleObstacleControllerDidInit, addr 0x583af4c, size 0xd8, virtual false, abstract: false, final false
inline void HandleObstacleControllerDidInit(::GlobalNamespace::ObstacleControllerBase*  obstacleController) ;

/// @brief Method HandleObstacleControllerDidUpdateProgress, addr 0x583ae18, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x583acdc, size 0x13c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method UpdateScale, addr 0x583aba0, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x583b024, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
