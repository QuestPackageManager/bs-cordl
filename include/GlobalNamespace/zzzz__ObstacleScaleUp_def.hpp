...
public:
  ...
  /// @brief Method Awake, addr 0x2526380, size 0x94, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleObstacleControllerDidInit, addr 0x2526690, size 0xd0, virtual false, abstract: false, final false
  inline void HandleObstacleControllerDidInit(::GlobalNamespace::ObstacleControllerBase* obstacleController);

  /// @brief Method HandleObstacleControllerDidUpdateProgress, addr 0x2526668, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2526530, size 0x138, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UpdateScale, addr 0x2526414, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2526760, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
