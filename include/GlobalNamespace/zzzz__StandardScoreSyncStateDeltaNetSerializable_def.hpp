...
/// @brief Method Deserialize, addr 0x3226288, size 0x78, virtual true, abstract: false, final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

static inline ::GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable* New_ctor() ;

/// @brief Method Release, addr 0x3226300, size 0xb0, virtual true, abstract: false, final true
inline void Release() ;

/// @brief Method Serialize, addr 0x32261a4, size 0xe4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x32263b0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_baseId, addr 0x322615c, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::SyncStateId get_baseId() ;

/// @brief Method get_delta, addr 0x322617c, size 0x14, virtual true, abstract: false, final true
inline ::GlobalNamespace::StandardScoreSyncState get_delta() ;

/// @brief Method get_pool, addr 0x3226118, size 0x44, virtual false, abstract: false, final false
static inline ::GlobalNamespace::IPacketPool_1<::GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable*>* get_pool() ;

/// @brief Method get_timeOffsetMs, addr 0x322616c, size 0x8, virtual true, abstract: false, final true
...
constexpr ::GlobalNamespace::ISyncStateDeltaSerializable_1<::GlobalNamespace::StandardScoreSyncState>* i___GlobalNamespace__ISyncStateDeltaSerializable_1___GlobalNamespace__StandardScoreSyncState_() noexcept;

/// @brief Convert to "::LiteNetLib::Utils::INetSerializable"
constexpr ::LiteNetLib::Utils::INetSerializable* i___LiteNetLib__Utils__INetSerializable() noexcept;

/// @brief Method set_baseId, addr 0x3226164, size 0x8, virtual true, abstract: false, final true
inline void set_baseId(::GlobalNamespace::SyncStateId  value) ;

/// @brief Method set_delta, addr 0x3226190, size 0x14, virtual true, abstract: false, final true
inline void set_delta(::GlobalNamespace::StandardScoreSyncState  value) ;

/// @brief Method set_timeOffsetMs, addr 0x3226174, size 0x8, virtual true, abstract: false, final true
