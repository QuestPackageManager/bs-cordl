...
public:
  ...
  /// @brief Method .ctor, addr 0x3b426d8, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method .ctor, addr 0x3b42708, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack, ::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method .ctor, addr 0x3b4268c, size 0x4c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ActionButtonWasPressed, addr 0x3b41cd8, size 0x4, virtual true, abstract: false, final false
  inline void ActionButtonWasPressed();

  /// @brief Method DidActivate, addr 0x3b41cec, size 0x4a8, virtual true, abstract: false, final true
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b42194, size 0x294, virtual true, abstract: false, final true
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleLevelSearchViewControllerDidPressSearchButton, addr 0x3b424b0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidChangeDifficultyBeatmap, addr 0x3b42510, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidChangeLevelDetailContent, addr 0x3b42574, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidPressActionButton, addr 0x3b424f0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidPressPracticeButton, addr 0x3b42500, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidSelectPack, addr 0x3b42438, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSearchFilterParamsViewControllerDidFinish, addr 0x3b42468, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMainViewController, addr 0x3b425fc, size 0x6c, virtual false, abstract: false, final false
  inline bool IsMainViewController(::HMUI::ViewController* viewController);

  /// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x3b41bd4, size 0x4, virtual true, abstract: false, final false
  inline void LevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x3b41bd8, size 0x4, virtual true, abstract: false, final false
  inline void LevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x3b41bdc, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method PracticeButtonWasPressed, addr 0x3b41cdc, size 0x4, virtual true, abstract: false, final false
  inline void PracticeButtonWasPressed();

  /// @brief Method PresentMainViewController, addr 0x3b42668, size 0x1c, virtual false, abstract: false, final false
  inline void PresentMainViewController(::System::Action* finishedCallback, ::HMUI::ViewController_AnimationType animationType);

  /// @brief Method Refresh, addr 0x3b425e0, size 0x1c, virtual true, abstract: false, final false
  inline void Refresh();

  /// @brief Method SelectionDidChange, addr 0x3b41ce0, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack* pack, ::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method Setup, addr 0x3b41ce4, size 0x8, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::LevelSelectionFlowCoordinator_State* state);

  /// @brief Method TopViewControllerWillChange, addr 0x3b42428, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b42684, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_actionButtonText, addr 0x3b41b08, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_actionButtonText();

  /// @brief Method get_allowedBeatmapDifficultyMask, addr 0x3b41b88, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask();

  /// @brief Method get_enableCustomLevels, addr 0x3b41b54, size 0x8, virtual true, abstract: false, final false
  inline bool get_enableCustomLevels();

  /// @brief Method get_hidePacksIfOneOrNone, addr 0x3b41af8, size 0x8, virtual true, abstract: false, final false
  inline bool get_hidePacksIfOneOrNone();

  /// @brief Method get_hidePracticeButton, addr 0x3b41b00, size 0x8, virtual true, abstract: false, final false
  inline bool get_hidePracticeButton();

  /// @brief Method get_initialLeftScreenViewController, addr 0x3b41ae0, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController();

  /// @brief Method get_initialRightScreenViewController, addr 0x3b41ae8, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialRightScreenViewController();

  /// @brief Method get_initialTopScreenViewController, addr 0x3b41ad8, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController();

  /// @brief Method get_isInRootViewController, addr 0x3b419d0, size 0x74, virtual false, abstract: false, final false
  inline bool get_isInRootViewController();

  /// @brief Method get_mainTitle, addr 0x3b41b4c, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_mainTitle();

  /// @brief Method get_notAllowedCharacteristics, addr 0x3b41b90, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method get_selectedBeatmapKey, addr 0x3b41a7c, size 0x40, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_selectedBeatmapKey();

  /// @brief Method get_selectedBeatmapLevel, addr 0x3b41abc, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_selectedBeatmapLevel();

  /// @brief Method get_selectedBeatmapLevelPack, addr 0x3b41a60, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* get_selectedBeatmapLevelPack();

  /// @brief Method get_selectedLevelCategory, addr 0x3b41a44, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory get_selectedLevelCategory();

  /// @brief Method get_showBackButtonForMainViewController, addr 0x3b41af0, size 0x8, virtual true, abstract: false, final false
  inline bool get_showBackButtonForMainViewController();

  /// @brief Method get_songPackMask, addr 0x3b41b5c, size 0x2c, virtual true, abstract: false, final false
