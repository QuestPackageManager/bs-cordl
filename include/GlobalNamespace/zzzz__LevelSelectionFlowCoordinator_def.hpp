...
public:
  ...
  /// @brief Method .ctor addr 0x228b2cc size 0x40 virtual false final false
  ...
  /// @brief Method .ctor addr 0x228b30c size 0x2c virtual false final false
  inline void _ctor(::GlobalNamespace::IBeatmapLevelPack* beatmapLevelPack);

  static inline ::GlobalNamespace::__LevelSelectionFlowCoordinator__State* New_ctor(::GlobalNamespace::IBeatmapLevelPack* beatmapLevelPack,
                                                                                    ::GlobalNamespace::IPreviewBeatmapLevel* previewBeatmapLevel);

  /// @brief Method .ctor addr 0x228b338 size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0x228b368 size 0x100 virtual false final false
...
public:
  ...
  /// @brief Method get_isInRootViewController addr 0x228a628 size 0x74 virtual false final false
  inline bool get_isInRootViewController();

  /// @brief Method get_selectedLevelCategory addr 0x228a69c size 0x1c virtual false final false
  inline ::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory get_selectedLevelCategory();

  /// @brief Method get_selectedBeatmapLevelPack addr 0x228a6b8 size 0x1c virtual false final false
  inline ::GlobalNamespace::IBeatmapLevelPack* get_selectedBeatmapLevelPack();

  /// @brief Method get_selectedDifficultyBeatmap addr 0x228a6d4 size 0x1c virtual false final false
  inline ::GlobalNamespace::IDifficultyBeatmap* get_selectedDifficultyBeatmap();

  /// @brief Method get_selectedBeatmapLevel addr 0x228a6f0 size 0x1c virtual false final false
  inline ::GlobalNamespace::IPreviewBeatmapLevel* get_selectedBeatmapLevel();

  /// @brief Method get_initialTopScreenViewController addr 0x228a70c size 0x8 virtual true final false
  inline ::HMUI::ViewController* get_initialTopScreenViewController();

  /// @brief Method get_initialLeftScreenViewController addr 0x228a714 size 0x8 virtual true final false
  inline ::HMUI::ViewController* get_initialLeftScreenViewController();

  /// @brief Method get_initialRightScreenViewController addr 0x228a71c size 0x8 virtual true final false
  inline ::HMUI::ViewController* get_initialRightScreenViewController();

  /// @brief Method get_showBackButtonForMainViewController addr 0x228a724 size 0x8 virtual true final false
  inline bool get_showBackButtonForMainViewController();

  /// @brief Method get_hidePacksIfOneOrNone addr 0x228a72c size 0x8 virtual true final false
  inline bool get_hidePacksIfOneOrNone();

  /// @brief Method get_hidePracticeButton addr 0x228a734 size 0x8 virtual true final false
  inline bool get_hidePracticeButton();

  /// @brief Method get_actionButtonText addr 0x228a73c size 0x44 virtual true final false
  inline ::StringW get_actionButtonText();

  /// @brief Method get_mainTitle addr 0x228a780 size 0x8 virtual true final false
  inline ::StringW get_mainTitle();

  /// @brief Method get_enableCustomLevels addr 0x228a788 size 0x8 virtual true final false
  inline bool get_enableCustomLevels();

  /// @brief Method get_songPackMask addr 0x228a790 size 0x2c virtual true final false
  inline ::GlobalNamespace::SongPackMask get_songPackMask();

  /// @brief Method get_allowedBeatmapDifficultyMask addr 0x228a7bc size 0x8 virtual true final false
  inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask();

  /// @brief Method get_notAllowedCharacteristics addr 0x228a7c4 size 0x44 virtual true final false
  ...
  /// @brief Method LevelSelectionFlowCoordinatorDidActivate addr 0x228a808 size 0x4 virtual true final false
  inline void LevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorDidDeactivate addr 0x228a80c size 0x4 virtual true final false
  inline void LevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange addr 0x228a810 size 0xfc virtual true final false
  ...
  /// @brief Method ActionButtonWasPressed addr 0x228a90c size 0x4 virtual true final false
  inline void ActionButtonWasPressed();

  /// @brief Method PracticeButtonWasPressed addr 0x228a910 size 0x4 virtual true final false
  inline void PracticeButtonWasPressed();

  /// @brief Method SelectionDidChange addr 0x228a914 size 0x4 virtual true final false
  inline void SelectionDidChange(::GlobalNamespace::IBeatmapLevelPack* pack, ::GlobalNamespace::IDifficultyBeatmap* beatmap);

  /// @brief Method Setup addr 0x228a918 size 0x8 virtual false final false
  inline void Setup(::GlobalNamespace::__LevelSelectionFlowCoordinator__State* state);

  /// @brief Method DidActivate addr 0x228a920 size 0x500 virtual true final true
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate addr 0x228ae20 size 0x2c4 virtual true final true
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method TopViewControllerWillChange addr 0x228b0e4 size 0x10 virtual true final true
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidSelectPack addr 0x228b0f4 size 0x18 virtual false final false
  ...
  /// @brief Method HandleSearchFilterParamsViewControllerDidFinish addr 0x228b10c size 0x48 virtual false final false
  ...
  /// @brief Method HandleLevelSearchViewControllerDidPressSearchButton addr 0x228b154 size 0x40 virtual false final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidPressActionButton addr 0x228b194 size 0x10 virtual false final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidPressPracticeButton addr 0x228b1a4 size 0x10 virtual true final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidChangeDifficultyBeatmap addr 0x228b1b4 size 0x14 virtual true final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidChangeLevelDetailContent addr 0x228b1c8 size 0x58 virtual true final false
  ...
  /// @brief Method Refresh addr 0x228b220 size 0x1c virtual true final false
  inline void Refresh();

  /// @brief Method IsMainViewController addr 0x228b23c size 0x6c virtual false final false
  inline bool IsMainViewController(::HMUI::ViewController* viewController);

  /// @brief Method PresentMainViewController addr 0x228b2a8 size 0x1c virtual false final false
  ...
  /// @brief Method .ctor addr 0x228b2c4 size 0x8 virtual false final false
  inline void _ctor();
