...
/// @brief Method .ctor, addr 0x580087c, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack) ;

/// @brief Method .ctor, addr 0x5800890, size 0x14, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BeatmapLevelPack*  beatmapLevelPack, ::GlobalNamespace::BeatmapLevel*  beatmapLevel) ;

/// @brief Method .ctor, addr 0x5800868, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method ActionButtonWasPressed, addr 0x57ffe60, size 0x4, virtual true, abstract: false, final false
inline void ActionButtonWasPressed() ;

/// @brief Method DidActivate, addr 0x57ffe74, size 0x4c0, virtual true, abstract: false, final true
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x5800334, size 0x2bc, virtual true, abstract: false, final true
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleLevelSearchViewControllerDidPressSearchButton, addr 0x5800688, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidChangeDifficultyBeatmap, addr 0x580070c, size 0x54, virtual true, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidChangeLevelDetailContent, addr 0x5800760, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidPressActionButton, addr 0x58006ec, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidPressPracticeButton, addr 0x58006fc, size 0x10, virtual true, abstract: false, final false
...
/// @brief Method HandleLevelSelectionNavigationControllerDidSelectPack, addr 0x5800600, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method HandleSearchFilterParamsViewControllerDidFinish, addr 0x5800634, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method IsMainViewController, addr 0x58007d4, size 0x70, virtual false, abstract: false, final false
inline bool IsMainViewController(::HMUI::ViewController*  viewController) ;

/// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x57ffd54, size 0x4, virtual true, abstract: false, final false
inline void LevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x57ffd58, size 0x4, virtual true, abstract: false, final false
inline void LevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x57ffd5c, size 0x104, virtual true, abstract: false, final false
...
/// @brief Method PracticeButtonWasPressed, addr 0x57ffe64, size 0x4, virtual true, abstract: false, final false
inline void PracticeButtonWasPressed() ;

/// @brief Method PresentMainViewController, addr 0x5800844, size 0x1c, virtual false, abstract: false, final false
inline void PresentMainViewController(::System::Action*  finishedCallback, ::HMUI::ViewController_AnimationType  animationType) ;

/// @brief Method Refresh, addr 0x58007b0, size 0x24, virtual true, abstract: false, final false
inline void Refresh() ;

/// @brief Method SelectionDidChange, addr 0x57ffe68, size 0x4, virtual true, abstract: false, final false
inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack*  pack, ::ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey) ;

/// @brief Method Setup, addr 0x57ffe6c, size 0x8, virtual false, abstract: false, final false
inline void Setup(::GlobalNamespace::LevelSelectionFlowCoordinator_State*  state) ;

/// @brief Method TopViewControllerWillChange, addr 0x58005f0, size 0x10, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5800860, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_actionButtonText, addr 0x57ffca0, size 0x48, virtual true, abstract: false, final false
inline ::StringW get_actionButtonText() ;

/// @brief Method get_allowedBeatmapDifficultyMask, addr 0x57ffd04, size 0x8, virtual true, abstract: false, final false
inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask() ;

/// @brief Method get_enableCustomLevels, addr 0x57ffcf0, size 0x8, virtual true, abstract: false, final false
inline bool get_enableCustomLevels() ;

/// @brief Method get_hidePacksIfOneOrNone, addr 0x57ffc90, size 0x8, virtual true, abstract: false, final false
inline bool get_hidePacksIfOneOrNone() ;

/// @brief Method get_hidePracticeButton, addr 0x57ffc98, size 0x8, virtual true, abstract: false, final false
inline bool get_hidePracticeButton() ;

/// @brief Method get_initialLeftScreenViewController, addr 0x57ffc78, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController() ;

/// @brief Method get_initialRightScreenViewController, addr 0x57ffc80, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialRightScreenViewController() ;

/// @brief Method get_initialTopScreenViewController, addr 0x57ffc70, size 0x8, virtual true, abstract: false, final false
inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController() ;

/// @brief Method get_isInRootViewController, addr 0x57ffb78, size 0x78, virtual false, abstract: false, final false
inline bool get_isInRootViewController() ;

/// @brief Method get_mainTitle, addr 0x57ffce8, size 0x8, virtual true, abstract: false, final false
inline ::StringW get_mainTitle() ;

/// @brief Method get_notAllowedCharacteristics, addr 0x57ffd0c, size 0x48, virtual true, abstract: false, final false
...
/// @brief Method get_selectedBeatmapKey, addr 0x57ffc20, size 0x38, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKey get_selectedBeatmapKey() ;

/// @brief Method get_selectedBeatmapLevel, addr 0x57ffc58, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevel* get_selectedBeatmapLevel() ;

/// @brief Method get_selectedBeatmapLevelPack, addr 0x57ffc08, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapLevelPack* get_selectedBeatmapLevelPack() ;

/// @brief Method get_selectedLevelCategory, addr 0x57ffbf0, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory get_selectedLevelCategory() ;

/// @brief Method get_showBackButtonForMainViewController, addr 0x57ffc88, size 0x8, virtual true, abstract: false, final false
inline bool get_showBackButtonForMainViewController() ;

/// @brief Method get_songPackMask, addr 0x57ffcf8, size 0xc, virtual true, abstract: false, final false
