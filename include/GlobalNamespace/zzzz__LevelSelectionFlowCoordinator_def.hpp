...
public:
  ...
  /// @brief Method .ctor, addr 0x3b50760, size 0x30, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack);

  /// @brief Method .ctor, addr 0x3b50790, size 0x34, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapLevelPack* beatmapLevelPack, ::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method .ctor, addr 0x3b50714, size 0x4c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ActionButtonWasPressed, addr 0x3b4fd60, size 0x4, virtual true, abstract: false, final false
  inline void ActionButtonWasPressed();

  /// @brief Method DidActivate, addr 0x3b4fd74, size 0x4a8, virtual true, abstract: false, final true
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b5021c, size 0x294, virtual true, abstract: false, final true
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleLevelSearchViewControllerDidPressSearchButton, addr 0x3b50538, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidChangeDifficultyBeatmap, addr 0x3b50598, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidChangeLevelDetailContent, addr 0x3b505fc, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidPressActionButton, addr 0x3b50578, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidPressPracticeButton, addr 0x3b50588, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method HandleLevelSelectionNavigationControllerDidSelectPack, addr 0x3b504c0, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSearchFilterParamsViewControllerDidFinish, addr 0x3b504f0, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method IsMainViewController, addr 0x3b50684, size 0x6c, virtual false, abstract: false, final false
  inline bool IsMainViewController(::HMUI::ViewController* viewController);

  /// @brief Method LevelSelectionFlowCoordinatorDidActivate, addr 0x3b4fc5c, size 0x4, virtual true, abstract: false, final false
  inline void LevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorDidDeactivate, addr 0x3b4fc60, size 0x4, virtual true, abstract: false, final false
  inline void LevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x3b4fc64, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method PracticeButtonWasPressed, addr 0x3b4fd64, size 0x4, virtual true, abstract: false, final false
  inline void PracticeButtonWasPressed();

  /// @brief Method PresentMainViewController, addr 0x3b506f0, size 0x1c, virtual false, abstract: false, final false
  inline void PresentMainViewController(::System::Action* finishedCallback, ::HMUI::ViewController_AnimationType animationType);

  /// @brief Method Refresh, addr 0x3b50668, size 0x1c, virtual true, abstract: false, final false
  inline void Refresh();

  /// @brief Method SelectionDidChange, addr 0x3b4fd68, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::GlobalNamespace::BeatmapLevelPack* pack, ::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method Setup, addr 0x3b4fd6c, size 0x8, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::LevelSelectionFlowCoordinator_State* state);

  /// @brief Method TopViewControllerWillChange, addr 0x3b504b0, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b5070c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_actionButtonText, addr 0x3b4fb90, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_actionButtonText();

  /// @brief Method get_allowedBeatmapDifficultyMask, addr 0x3b4fc10, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask();

  /// @brief Method get_enableCustomLevels, addr 0x3b4fbdc, size 0x8, virtual true, abstract: false, final false
  inline bool get_enableCustomLevels();

  /// @brief Method get_hidePacksIfOneOrNone, addr 0x3b4fb80, size 0x8, virtual true, abstract: false, final false
  inline bool get_hidePacksIfOneOrNone();

  /// @brief Method get_hidePracticeButton, addr 0x3b4fb88, size 0x8, virtual true, abstract: false, final false
  inline bool get_hidePracticeButton();

  /// @brief Method get_initialLeftScreenViewController, addr 0x3b4fb68, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialLeftScreenViewController();

  /// @brief Method get_initialRightScreenViewController, addr 0x3b4fb70, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialRightScreenViewController();

  /// @brief Method get_initialTopScreenViewController, addr 0x3b4fb60, size 0x8, virtual true, abstract: false, final false
  inline ::UnityW<::HMUI::ViewController> get_initialTopScreenViewController();

  /// @brief Method get_isInRootViewController, addr 0x3b4fa58, size 0x74, virtual false, abstract: false, final false
  inline bool get_isInRootViewController();

  /// @brief Method get_mainTitle, addr 0x3b4fbd4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_mainTitle();

  /// @brief Method get_notAllowedCharacteristics, addr 0x3b4fc18, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method get_selectedBeatmapKey, addr 0x3b4fb04, size 0x40, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_selectedBeatmapKey();

  /// @brief Method get_selectedBeatmapLevel, addr 0x3b4fb44, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_selectedBeatmapLevel();

  /// @brief Method get_selectedBeatmapLevelPack, addr 0x3b4fae8, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* get_selectedBeatmapLevelPack();

  /// @brief Method get_selectedLevelCategory, addr 0x3b4facc, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory get_selectedLevelCategory();

  /// @brief Method get_showBackButtonForMainViewController, addr 0x3b4fb78, size 0x8, virtual true, abstract: false, final false
  inline bool get_showBackButtonForMainViewController();

  /// @brief Method get_songPackMask, addr 0x3b4fbe4, size 0x2c, virtual true, abstract: false, final false
