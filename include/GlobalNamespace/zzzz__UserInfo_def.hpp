...
MARK_REF_T(::GlobalNamespace::UserInfo*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UserInfo_Platform, "", "UserInfo/Platform");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::UserInfo*, "", "UserInfo");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::UserInfo_Platform) == 0x4, "Size mismatch!");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UserInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UserInfo(UserInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UserInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UserInfo(UserInfoconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::UserInfo) == 0x28, "Size mismatch!");
