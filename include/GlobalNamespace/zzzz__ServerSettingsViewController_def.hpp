...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a1bca8, size 0x260, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5a1bf08, size 0x64, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleEnabledChanged, addr 0x5a1bf6c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleEnabledChanged(bool newValue);

  /// @brief Method HandleForceGameliftChanged, addr 0x5a1bfb0, size 0x1c, virtual false, abstract: false, final false
  inline void HandleForceGameliftChanged(bool newValue);

  /// @brief Method HandleHostnameChanged, addr 0x5a1bf88, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1bfcc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
