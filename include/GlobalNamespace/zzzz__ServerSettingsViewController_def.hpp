...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ServerSettingsViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ServerSettingsViewController(ServerSettingsViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ServerSettingsViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ServerSettingsViewController(ServerSettingsViewControllerconst&) = delete;
