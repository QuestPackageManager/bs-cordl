...
public:
  ...
  /// @brief Method DidActivate, addr 0x3a9c688, size 0x1dc, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3a9c864, size 0x58, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleEnabledChanged, addr 0x3a9c8bc, size 0x20, virtual false, abstract: false, final false
  inline void HandleEnabledChanged(bool newValue);

  /// @brief Method HandleForceGameliftChanged, addr 0x3a9c904, size 0x20, virtual false, abstract: false, final false
  inline void HandleForceGameliftChanged(bool newValue);

  /// @brief Method HandleHostnameChanged, addr 0x3a9c8dc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a9c924, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
