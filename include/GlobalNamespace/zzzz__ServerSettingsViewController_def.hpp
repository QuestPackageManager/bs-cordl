...
public:
  ...
  /// @brief Method DidActivate, addr 0x267b620, size 0x230, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x267b850, size 0x58, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleEnabledChanged, addr 0x267b8a8, size 0x6c, virtual false, abstract: false, final false
  inline void HandleEnabledChanged(bool newValue);

  /// @brief Method HandleForceGameliftChanged, addr 0x267b984, size 0x6c, virtual false, abstract: false, final false
  inline void HandleForceGameliftChanged(bool newValue);

  /// @brief Method HandleHostnameChanged, addr 0x267b914, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267b9f0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
