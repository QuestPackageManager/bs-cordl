...
public:
  ...
  /// @brief Method ChangeMirrorEnabledState, addr 0x2bf7104, size 0x38, virtual false, abstract: false, final false
  inline void ChangeMirrorEnabledState(bool newIsEnabled);

  static inline ::GlobalNamespace::Mirror* New_ctor();

  /// @brief Method OnWillRenderObject, addr 0x2bf6e44, size 0x2c0, virtual false, abstract: false, final false
  inline void OnWillRenderObject();

  /// @brief Method Update, addr 0x2bf6ca0, size 0x18, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2bf7944, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_mirrorDidChangeEnabledStateEvent, addr 0x2bf6b40, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isEnabled, addr 0x2bf6b2c, size 0x8, virtual false, abstract: false, final false
  inline bool get_isEnabled();

  /// @brief Method get_mirrorMaterial, addr 0x2bf6b1c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_mirrorMaterial();

  /// @brief Method get_noMirrorMaterial, addr 0x2bf6b24, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_noMirrorMaterial();

  /// @brief Method remove_mirrorDidChangeEnabledStateEvent, addr 0x2bf6bf0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isEnabled, addr 0x2bf6b34, size 0xc, virtual false, abstract: false, final false
