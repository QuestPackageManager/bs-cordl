...
public:
  ...
  /// @brief Method ChangeMirrorEnabledState, addr 0x5e08c00, size 0x3c, virtual false, abstract: false, final false
  inline void ChangeMirrorEnabledState(bool newIsEnabled);

  static inline ::GlobalNamespace::Mirror* New_ctor();

  /// @brief Method OnWillRenderObject, addr 0x5e08930, size 0x1c, virtual false, abstract: false, final false
  inline void OnWillRenderObject();

  /// @brief Method RenderMirror, addr 0x5e0894c, size 0x2b4, virtual false, abstract: false, final false
  inline void RenderMirror(::UnityEngine::Camera* currentCamera);

  /// @brief Method Update, addr 0x5e087d0, size 0x14, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5e094cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_mirrorDidChangeEnabledStateEvent, addr 0x5e08650, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_isEnabled, addr 0x5e08640, size 0x8, virtual false, abstract: false, final false
  inline bool get_isEnabled();

  /// @brief Method get_mirrorMaterial, addr 0x5e08628, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_mirrorMaterial();

  /// @brief Method get_noMirrorMaterial, addr 0x5e08630, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> get_noMirrorMaterial();

  /// @brief Method get_reflectionPlaneTransform, addr 0x5e08638, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_reflectionPlaneTransform();

  /// @brief Method remove_mirrorDidChangeEnabledStateEvent, addr 0x5e08710, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_isEnabled, addr 0x5e08648, size 0x8, virtual false, abstract: false, final false
