...
public:
  ...
  /// @brief Method .ctor, addr 0x573d8e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_bpm, addr 0x573d8a0, size 0x44, virtual false, abstract: false, final false
  inline void set_bpm(float_t value);

  /// @brief Method set_duration, addr 0x573d86c, size 0x34, virtual false, abstract: false, final false
