...
public:
  ...
  /// @brief Method set_duration, addr 0x230fc5c, size 0x34, virtual false, abstract: false, final false
  inline void set_duration(float_t value);

  /// @brief Method set_bpm, addr 0x230fc90, size 0x48, virtual false, abstract: false, final false
  inline void set_bpm(float_t value);

  static inline ::GlobalNamespace::BasicLevelParamsPanel* New_ctor();

  /// @brief Method .ctor, addr 0x230fcd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
