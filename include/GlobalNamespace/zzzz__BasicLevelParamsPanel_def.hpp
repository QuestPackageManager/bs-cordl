...
public:
  ...
  /// @brief Method .ctor, addr 0x596aca8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_bpm, addr 0x596ac64, size 0x44, virtual false, abstract: false, final false
  inline void set_bpm(float_t value);

  /// @brief Method set_duration, addr 0x596ac30, size 0x34, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BasicLevelParamsPanel", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BasicLevelParamsPanel(BasicLevelParamsPanel&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BasicLevelParamsPanel", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BasicLevelParamsPanel(BasicLevelParamsPanelconst&) = delete;
