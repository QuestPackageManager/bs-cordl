...
public:
  ...
  /// @brief Method Deserialize, addr 0x36bcc2c, size 0x188, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x36bc9c0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x36bc954, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PlayersLobbyPermissionConfigurationNetSerializable* Obtain();

  /// @brief Method Release, addr 0x36bcdb4, size 0xd8, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method Retain, addr 0x36bcf00, size 0xa8, virtual true, abstract: false, final false
  inline void Retain();

  /// @brief Method Serialize, addr 0x36bcae0, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36bca3c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playersPermission, addr 0x36bc94c, size 0x8, virtual false, abstract: false, final false
