...
/// @brief Field _playersPermission, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__playersPermission, put=__cordl_internal_set__playersPermission)) ::System::Collections::Generic::List_1<::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable*>*  _playersPermission;
...
/// @brief Method Deserialize, addr 0x367fee4, size 0x188, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x367fc78, size 0x7c, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayersLobbyPermissionConfigurationNetSerializable* Init(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable*>*  playersPermission) ;

static inline ::GlobalNamespace::PlayersLobbyPermissionConfigurationNetSerializable* New_ctor() ;

/// @brief Method Obtain, addr 0x367fc0c, size 0x6c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::PlayersLobbyPermissionConfigurationNetSerializable* Obtain() ;

/// @brief Method Release, addr 0x368006c, size 0xd8, virtual true, abstract: false, final false
inline void Release() ;

/// @brief Method Retain, addr 0x36801b8, size 0xa8, virtual true, abstract: false, final false
inline void Retain() ;

/// @brief Method Serialize, addr 0x367fd98, size 0x14c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x367fcf4, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_playersPermission, addr 0x367fc04, size 0x8, virtual false, abstract: false, final false
