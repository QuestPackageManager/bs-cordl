...
public:
  ...
  /// @brief Method get_playersPermission addr 0x123368c size 0x8 virtual false final false
  ...
  /// @brief Method Obtain addr 0x1233694 size 0x64 virtual false final false
  static inline ::GlobalNamespace::PlayersLobbyPermissionConfigurationNetSerializable* Obtain();

  /// @brief Method Init addr 0x12336f8 size 0x60 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1233758 size 0xa0 virtual false final false
  inline void _ctor();

  /// @brief Method Serialize addr 0x12337f8 size 0x180 virtual true final false
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0x1233978 size 0x168 virtual true final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Release addr 0x1233ae0 size 0xc4 virtual true final false
  inline void Release();

  /// @brief Method Retain addr 0x1233c14 size 0x9c virtual true final false
  inline void Retain();
