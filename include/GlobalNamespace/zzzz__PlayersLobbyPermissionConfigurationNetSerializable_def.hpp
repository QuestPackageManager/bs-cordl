...
public:
  ...
  /// @brief Method Deserialize, addr 0x367fe7c, size 0x188, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x367fc10, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x367fba4, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::PlayersLobbyPermissionConfigurationNetSerializable* Obtain();

  /// @brief Method Release, addr 0x3680004, size 0xd8, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method Retain, addr 0x3680150, size 0xa8, virtual true, abstract: false, final false
  inline void Retain();

  /// @brief Method Serialize, addr 0x367fd30, size 0x14c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x367fc8c, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_playersPermission, addr 0x367fb9c, size 0x8, virtual false, abstract: false, final false
