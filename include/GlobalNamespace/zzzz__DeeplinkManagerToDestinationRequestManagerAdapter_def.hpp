...
public:
  ...
  /// @brief Field _currentMenuDestinationRequest, offset 0x30, size 0x8
  ...
  /// @brief Field didSendMenuDestinationRequestEvent, offset 0x28, size 0x8
...
public:
  ...
  /// @brief Field _currentMenuDestinationRequest, offset: 0x30, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter, ____playerDataModel) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter, ____telemetryModel) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter, ___didSendMenuDestinationRequestEvent) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter, ____currentMenuDestinationRequest) == 0x30, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::DeeplinkManagerToDestinationRequestManagerAdapter) == 0x38, "Size mismatch!");
