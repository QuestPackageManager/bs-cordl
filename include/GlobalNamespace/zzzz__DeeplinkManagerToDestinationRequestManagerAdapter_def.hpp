...
public:
  ...
  /// @brief Method Clear, addr 0x3b7a53c, size 0x8, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method HandleDeeplinkManagerDidReceiveDeeplink, addr 0x3b79f7c, size 0x5c0, virtual false, abstract: false, final false
  inline void HandleDeeplinkManagerDidReceiveDeeplink(::GlobalNamespace::Deeplink* deeplink);

  /// @brief Method Init, addr 0x3b79db4, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7a544, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSendMenuDestinationRequestEvent, addr 0x3b79c2c, size 0xb0, virtual true, abstract: false, final true
  inline void add_didSendMenuDestinationRequestEvent(::System::Action_1<::GlobalNamespace::MenuDestination*>* value);

  /// @brief Method get_currentMenuDestinationRequest, addr 0x3b79d8c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_didSendMenuDestinationRequestEvent, addr 0x3b79cdc, size 0xb0, virtual true, abstract: false, final true
  inline void remove_didSendMenuDestinationRequestEvent(::System::Action_1<::GlobalNamespace::MenuDestination*>* value);

  /// @brief Method set_currentMenuDestinationRequest, addr 0x3b79d94, size 0x20, virtual true, abstract: false, final true
