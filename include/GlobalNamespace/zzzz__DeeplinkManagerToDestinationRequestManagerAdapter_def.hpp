...
public:
  ...
  /// @brief Method Clear, addr 0x25b6f80, size 0x8, virtual true, abstract: false, final true
  inline void Clear();

  /// @brief Method HandleDeeplinkManagerDidReceiveDeeplink, addr 0x25b69ac, size 0x5d4, virtual false, abstract: false, final false
  inline void HandleDeeplinkManagerDidReceiveDeeplink(::GlobalNamespace::Deeplink* deeplink);

  /// @brief Method Init, addr 0x25b67e0, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25b6f88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSendMenuDestinationRequestEvent, addr 0x25b6658, size 0xb0, virtual true, abstract: false, final true
  inline void add_didSendMenuDestinationRequestEvent(::System::Action_1<::GlobalNamespace::MenuDestination*>* value);

  /// @brief Method get_currentMenuDestinationRequest, addr 0x25b67b8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_didSendMenuDestinationRequestEvent, addr 0x25b6708, size 0xb0, virtual true, abstract: false, final true
  inline void remove_didSendMenuDestinationRequestEvent(::System::Action_1<::GlobalNamespace::MenuDestination*>* value);

  /// @brief Method set_currentMenuDestinationRequest, addr 0x25b67c0, size 0x20, virtual true, abstract: false, final true
