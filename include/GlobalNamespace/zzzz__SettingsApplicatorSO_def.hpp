...
public:
  ...
  /// @brief Method ApplyGameSettings, addr 0x57de25c, size 0x10c, virtual false, abstract: false, final false
  inline void ApplyGameSettings(::ByRef<::BeatSaber::Settings::Settings> settings);

  /// @brief Method ApplyGraphicSettings, addr 0x57dded4, size 0x2f0, virtual true, abstract: false, final false
  inline void ApplyGraphicSettings(::ByRef<::BeatSaber::Settings::Settings> settings, ::GlobalNamespace::SceneType sceneType);

  /// @brief Method ApplyWindowSettings, addr 0x57de4e0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method NotifyRoomTransformOffsetWasUpdated, addr 0x57de4c4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57de1e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_roomTransformOffsetDidUpdateEvent, addr 0x57de36c, size 0xac, virtual false, abstract: false, final false
  inline void add_roomTransformOffsetDidUpdateEvent(::System::Action* value);

  /// @brief Method remove_roomTransformOffsetDidUpdateEvent, addr 0x57de418, size 0xac, virtual false, abstract: false, final false
