...
public:
  ...
  /// @brief Method CalculateObstacleTransformProperties, addr 0x583a970, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidate, addr 0x583ad34, size 0x90, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetAllProperties, addr 0x583a598, size 0x3d8, virtual false, abstract: false, final false
  inline void SetAllProperties(float_t width, float_t height, float_t length, ::UnityEngine::Color color, float_t manualUvOffset);

  /// @brief Method SetObstacleCoreTransformProperties, addr 0x583a9b0, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSizeAndOffset, addr 0x583aae0, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x583adc4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bounds, addr 0x583a584, size 0x14, virtual false, abstract: false, final false
