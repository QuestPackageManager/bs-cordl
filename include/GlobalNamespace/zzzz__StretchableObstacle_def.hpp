...
public:
  ...
  /// @brief Method CalculateObstacleTransformProperties, addr 0x3b76438, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidate, addr 0x3b767f4, size 0x6c, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetAllProperties, addr 0x3b76030, size 0x408, virtual false, abstract: false, final false
  inline void SetAllProperties(float_t width, float_t height, float_t length, ::UnityEngine::Color color, float_t manualUvOffset);

  /// @brief Method SetObstacleCoreTransformProperties, addr 0x3b76478, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSizeAndOffset, addr 0x3b765a0, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b76860, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bounds, addr 0x3b7601c, size 0x14, virtual false, abstract: false, final false
