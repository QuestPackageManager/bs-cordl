...
/// @brief Method CalculateObstacleTransformProperties, addr 0x57c89fc, size 0x40, virtual false, abstract: false, final false
inline void CalculateObstacleTransformProperties(float_t  width, float_t  height, float_t  length, ::ByRef<::UnityEngine::Vector3>  localPosition, ::ByRef<::UnityEngine::Vector3>  size, ::ByRef<::UnityEngine::Vector3>  scale) ;

static inline ::GlobalNamespace::StretchableObstacle* New_ctor() ;

/// @brief Method OnValidate, addr 0x57c8dc0, size 0x90, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method SetAllProperties, addr 0x57c8624, size 0x3d8, virtual false, abstract: false, final false
inline void SetAllProperties(float_t  width, float_t  height, float_t  length, ::UnityEngine::Color  color, float_t  manualUvOffset) ;

/// @brief Method SetObstacleCoreTransformProperties, addr 0x57c8a3c, size 0x130, virtual false, abstract: false, final false
...
/// @brief Method SetSizeAndOffset, addr 0x57c8b6c, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57c8e50, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_bounds, addr 0x57c8610, size 0x14, virtual false, abstract: false, final false
