...
public:
  ...
  /// @brief Field _addColorMultiplier, offset 0x28, size 0x4
  ...
  /// @brief Field _coreOffset, offset 0x24, size 0x4
  ...
  /// @brief Field _fakeGlowOffset, offset 0x30, size 0xc
  ...
  /// @brief Field _obstacleCore, offset 0x40, size 0x8
  ...
  /// @brief Field _obstacleCoreLerpToWhiteFactor, offset 0x2c, size 0x4
  ...
  /// @brief Field _obstacleFakeGlow, offset 0x58, size 0x8
  ...
  /// @brief Field _obstacleFrame, offset 0x50, size 0x8
  ...
  /// @brief Method OnValidate, addr 0x3a980f0, size 0x68, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetSizeAndColor, addr 0x3a9555c, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a98158, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bounds, addr 0x3a980dc, size 0x14, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _coreOffset, offset: 0x24, size: 0x4, def value: None
  float_t ____coreOffset;

  /// @brief Field _addColorMultiplier, offset: 0x28, size: 0x4, def value: None
  float_t ____addColorMultiplier;

  /// @brief Field _obstacleCoreLerpToWhiteFactor, offset: 0x2c, size: 0x4, def value: None
  float_t ____obstacleCoreLerpToWhiteFactor;

  /// @brief Field _fakeGlowOffset, offset: 0x30, size: 0xc, def value: None
  ::UnityEngine::Vector3 ____fakeGlowOffset;

  /// @brief Field _obstacleCore, offset: 0x40, size: 0x8, def value: None
  ...
  /// @brief Field _obstacleFrame, offset: 0x50, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::ParametricBoxFrameController> ____obstacleFrame;

  /// @brief Field _obstacleFakeGlow, offset: 0x58, size: 0x8, def value: None
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::StretchableObstacle, 0x78>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____addColorMultiplier) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____obstacleCoreLerpToWhiteFactor) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____fakeGlowOffset) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____obstacleCore) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____materialPropertyBlockControllers) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____obstacleFrame) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____obstacleFakeGlow) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StretchableObstacle, ____bounds) == 0x60, "Offset mismatch!");
