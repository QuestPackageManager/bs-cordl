...
namespace GlobalNamespace {
struct __CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28;
}
namespace GlobalNamespace {
...
namespace GlobalNamespace {
class __CustomDifficultyBeatmap____c__DisplayClass28_0;
}
namespace GlobalNamespace {
struct __CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27;
}
namespace GlobalNamespace {
class IBeatmapLevel;
}
...
MARK_REF_PTR_T(::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0);
MARK_VAL_T(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28);
MARK_VAL_T(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27);
// Type: ::<GetBeatmapDataBasicInfoAsync>d__27
// SizeInfo { instance_size: 48, native_size: -1, calculated_instance_size: 48, calculated_native_size: 64, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4290)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 869 }), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(3389), inst: 869 }), TypeDefinitionIndex(TypeDefinitionIndex(3397)), TypeDefinitionIndex(TypeDefinitionIndex(3389))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4401)) CS
// Name: ::CustomDifficultyBeatmap::<GetBeatmapDataBasicInfoAsync>d__27
struct CORDL_TYPE __CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext addr 0x21fc7b4 size 0x220 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x21fc9d4 size 0x58 virtual true final true
  ...
  constexpr __CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27(int32_t __1__state,
  ...
  // Ctor Parameters []
  // @brief default ctor
  constexpr __CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27, 0x30>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27, __u__1) == 0x28, "Offset mismatch!");
...
// CS Name: ::CustomDifficultyBeatmap::<>c__DisplayClass28_0*
class CORDL_TYPE __CustomDifficultyBeatmap____c__DisplayClass28_0 : public ::System::Object {
public:
  // Declarations
  ...
  /// @brief Field environmentInfo, offset 0x20, size 0x8
  ...
  static inline ::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0* New_ctor();

  /// @brief Method .ctor addr 0x21fca2c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetBeatmapDataAsync>b__0 addr 0x21fca34 size 0x108 virtual false final false
  inline void _GetBeatmapDataAsync_b__0();

  // Ctor Parameters [CppParam { name: "", ty: "__CustomDifficultyBeatmap____c__DisplayClass28_0", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __CustomDifficultyBeatmap____c__DisplayClass28_0(__CustomDifficultyBeatmap____c__DisplayClass28_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__CustomDifficultyBeatmap____c__DisplayClass28_0", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __CustomDifficultyBeatmap____c__DisplayClass28_0(__CustomDifficultyBeatmap____c__DisplayClass28_0 const&) = delete;

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __CustomDifficultyBeatmap____c__DisplayClass28_0();
...
public:
  ...
  /// @brief Field environmentInfo, offset: 0x20, size: 0x8, def value: None
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0, 0x30>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0, ___readonlyBeatmapData) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0, _____4__this) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0, ___environmentInfo) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0, ___playerSpecificSettings) == 0x28, "Offset mismatch!");

} // namespace GlobalNamespace
// Type: ::<GetBeatmapDataAsync>d__28
// SizeInfo { instance_size: 72, native_size: -1, calculated_instance_size: 72, calculated_native_size: 88, minimum_alignment: 8, natural_alignment: 8, packing: None, specified_packing: None }
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 873 }), TypeDefinitionIndex(TypeDefinitionIndex(4292)),
// TypeDefinitionIndex(TypeDefinitionIndex(3397)), TypeDefinitionIndex(TypeDefinitionIndex(3388))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4403)) CS Name:
// ::CustomDifficultyBeatmap::<GetBeatmapDataAsync>d__28
struct CORDL_TYPE __CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28 {
public:
  // Declarations
  /// @brief Convert operator to "::System::Runtime::CompilerServices::IAsyncStateMachine"
  constexpr operator ::System::Runtime::CompilerServices::IAsyncStateMachine*();

  /// @brief Method MoveNext addr 0x21fcb3c size 0x27c virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x21fcdb8 size 0x58 virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
  ...
  // "::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter",
  // modifiers: "", def_value: None }]
  constexpr __CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28(int32_t __1__state,
                                                                  ...
                                                                  ::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0* __8__1,
                                                                  ::System::Runtime::CompilerServices::TaskAwaiter __u__1) noexcept;

  // Ctor Parameters []
  // @brief default ctor
  constexpr __CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, 0x48>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, __4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, environmentInfo) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, playerSpecificSettings) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, __8__1) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, __u__1) == 0x40, "Offset mismatch!");
...
public:
  // Declarations
  using _GetBeatmapDataAsync_d__28 = ::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28;

  using __c__DisplayClass28_0 = ::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0;

  using _GetBeatmapDataBasicInfoAsync_d__27 = ::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27;
  ...
  /// @brief Field <beatsPerMinute>k__BackingField, offset 0x38, size 0x4
  ...
  /// @brief Field <beatmapSaveData>k__BackingField, offset 0x40, size 0x8
  ...
  /// @brief Method get_level addr 0x21fc4f8 size 0x8 virtual true final true
  inline ::GlobalNamespace::IBeatmapLevel* get_level();

  /// @brief Method get_parentDifficultyBeatmapSet addr 0x21fc500 size 0x8 virtual true final true
  inline ::GlobalNamespace::IDifficultyBeatmapSet* get_parentDifficultyBeatmapSet();

  /// @brief Method get_difficulty addr 0x21fc508 size 0x8 virtual true final true
  inline ::GlobalNamespace::BeatmapDifficulty get_difficulty();

  /// @brief Method get_difficultyRank addr 0x21fc510 size 0x8 virtual true final true
  inline int32_t get_difficultyRank();

  /// @brief Method get_noteJumpMovementSpeed addr 0x21fc518 size 0x8 virtual true final true
  inline float_t get_noteJumpMovementSpeed();

  /// @brief Method get_noteJumpStartBeatOffset addr 0x21fc520 size 0x8 virtual true final true
  inline float_t get_noteJumpStartBeatOffset();

  /// @brief Method get_beatmapDataBasicInfo addr 0x21fc528 size 0x8 virtual false final false
  inline ::GlobalNamespace::IBeatmapDataBasicInfo* get_beatmapDataBasicInfo();

  /// @brief Method get_beatsPerMinute addr 0x21fc530 size 0x8 virtual false final false
  inline float_t get_beatsPerMinute();

  /// @brief Method get_beatmapSaveData addr 0x21fc538 size 0x8 virtual false final false
  inline ::BeatmapSaveDataVersion3::BeatmapSaveData* get_beatmapSaveData();

  /// @brief Method GetBeatmapDataBasicInfoAsync addr 0x21fc540 size 0xf0 virtual true final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::IBeatmapDataBasicInfo*>* GetBeatmapDataBasicInfoAsync();

  /// @brief Method GetBeatmapDataAsync addr 0x21fc630 size 0x108 virtual true final true
  ...
  static inline ::GlobalNamespace::CustomDifficultyBeatmap* New_ctor(::GlobalNamespace::IBeatmapLevel* level, ::GlobalNamespace::IDifficultyBeatmapSet* parentDifficultyBeatmapSet,
                                                                     ...
                                                                     float_t noteJumpStartBeatOffset, float_t beatsPerMinute, ::BeatmapSaveDataVersion3::BeatmapSaveData* beatmapSaveData,
                                                                     ::GlobalNamespace::IBeatmapDataBasicInfo* beatmapDataBasicInfo);

  /// @brief Method .ctor addr 0x21fc738 size 0x7c virtual false final false
  inline void _ctor(::GlobalNamespace::IBeatmapLevel* level, ::GlobalNamespace::IDifficultyBeatmapSet* parentDifficultyBeatmapSet, ::GlobalNamespace::BeatmapDifficulty difficulty,
                    int32_t difficultyRank, float_t noteJumpMovementSpeed, float_t noteJumpStartBeatOffset, float_t beatsPerMinute, ::BeatmapSaveDataVersion3::BeatmapSaveData* beatmapSaveData,
                    ::GlobalNamespace::IBeatmapDataBasicInfo* beatmapDataBasicInfo);
...
public:
  ...
  /// @brief Field <beatsPerMinute>k__BackingField, offset: 0x38, size: 0x4, def value: None
  float_t ____beatsPerMinute_k__BackingField;

  /// @brief Field <beatmapSaveData>k__BackingField, offset: 0x40, size: 0x8, def value: None
  ::BeatmapSaveDataVersion3::BeatmapSaveData* ____beatmapSaveData_k__BackingField;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::CustomDifficultyBeatmap, 0x48>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::CustomDifficultyBeatmap, ____beatsPerMinute_k__BackingField) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::CustomDifficultyBeatmap, ____beatmapSaveData_k__BackingField) == 0x40, "Offset mismatch!");
...
NEED_NO_BOX(::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__CustomDifficultyBeatmap____c__DisplayClass28_0*, "", "CustomDifficultyBeatmap/<>c__DisplayClass28_0");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__28, "", "CustomDifficultyBeatmap/<GetBeatmapDataAsync>d__28");
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__27, "", "CustomDifficultyBeatmap/<GetBeatmapDataBasicInfoAsync>d__27");
