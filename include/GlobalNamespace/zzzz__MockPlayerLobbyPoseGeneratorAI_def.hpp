...
public:
  ...
  /// @brief Method Init, addr 0x5a85ca0, size 0x1e0, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x5a85e80, size 0x978, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x5a84cc0, size 0x4, virtual false, abstract: false, final false
