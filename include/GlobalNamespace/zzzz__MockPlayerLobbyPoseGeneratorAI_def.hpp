...
public:
  ...
  /// @brief Method Init, addr 0x58d9348, size 0x1e0, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x58d9528, size 0x978, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x58d84d4, size 0x4, virtual false, abstract: false, final false
