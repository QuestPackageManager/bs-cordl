...
public:
  ...
  /// @brief Method Init, addr 0x2663cac, size 0x2d0, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x2663f7c, size 0x9ec, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x2663250, size 0x4, virtual false, abstract: false, final false
