...
public:
  ...
  /// @brief Method Init, addr 0x25401c0, size 0x2d0, virtual true, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method Tick, addr 0x2540490, size 0x9ec, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x253f764, size 0x4, virtual false, abstract: false, final false
