...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::Material> (*)()>(&::GlobalNamespace::CubemapHelpers::get_cubemapHelpersMaterial)> {
  ...
  constexpr static std::size_t addrs = 0x57512e0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Texture*, ::UnityEngine::RenderTexture*)>(&::GlobalNamespace::CubemapHelpers::Downsample)> {
  ...
  constexpr static std::size_t addrs = 0x5751410;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::RenderTexture> (*)(::UnityEngine::RenderTexture*, int32_t)>(&::GlobalNamespace::CubemapHelpers::CreateDownsampledCubemap)> {
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityW<::UnityEngine::RenderTexture> (*)(::UnityEngine::RenderTexture*)>(&::GlobalNamespace::CubemapHelpers::Create2DTextureFromCubemap)> {
  constexpr static std::size_t size = 0x18c;
  constexpr static std::size_t addrs = 0x5751a18;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::Texture*, ::UnityEngine::CubemapFace)>(&::GlobalNamespace::CubemapHelpers::DrawCubemapFace)> {
  ...
  constexpr static std::size_t addrs = 0x5751544;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "DrawCubemapFace",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Texture*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::CubemapFace>::get()}
                    )));
    return ___internal_method;
  }
};
inline void GlobalNamespace::CubemapHelpers::setStaticF__cubemapHelpersMaterial(::UnityW<::UnityEngine::Material>  value)  {
::cordl_internals::setStaticField<::UnityW<::UnityEngine::Material>, "_cubemapHelpersMaterial", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::CubemapHelpers*>::get>(std::forward<::UnityW<::UnityEngine::Material>>(value));
}
inline ::UnityW<::UnityEngine::Material> GlobalNamespace::CubemapHelpers::getStaticF__cubemapHelpersMaterial()  {
return ::cordl_internals::getStaticField<::UnityW<::UnityEngine::Material>, "_cubemapHelpersMaterial", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::CubemapHelpers*>::get>();
}
...
::cordl_internals::setStaticField<::ArrayW<::UnityEngine::CubemapFace,::Array<::UnityEngine::CubemapFace>*>, "_cubemapFaces", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::CubemapHelpers*>::get>(std::forward<::ArrayW<::UnityEngine::CubemapFace,::Array<::UnityEngine::CubemapFace>*>>(value));
}
...
return ::cordl_internals::getStaticField<::ArrayW<::UnityEngine::CubemapFace,::Array<::UnityEngine::CubemapFace>*>, "_cubemapFaces", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::CubemapHelpers*>::get>();
}
