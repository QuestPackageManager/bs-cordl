...
public:
  ...
  /// @brief Method ErrorCode, addr 0x26e2110, size 0x80, virtual false, abstract: false, final false
  static inline ::StringW ErrorCode(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method GetLocalizedMessage, addr 0x26e24b8, size 0xb0, virtual false, abstract: false, final false
  static inline ::StringW GetLocalizedMessage(::GlobalNamespace::MultiplayerStatusData* data, ::BGLib::Polyglot::Language language);

  /// @brief Method LocalizedKey, addr 0x26e208c, size 0x84, virtual false, abstract: false, final false
  static inline ::StringW LocalizedKey(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method TryGetMultiplayerUnavailableReason, addr 0x26e2190, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method VersionLessThan, addr 0x26e22f0, size 0x1c8, virtual false, abstract: false, final false
