...
public:
  ...
  /// @brief Method ErrorCode, addr 0x367d0b0, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW ErrorCode(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method GetLocalizedMessage, addr 0x367d468, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method LocalizedKey, addr 0x367d00c, size 0xa4, virtual false, abstract: false, final false
  static inline ::StringW LocalizedKey(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method TryGetMultiplayerUnavailableReason, addr 0x367d144, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method VersionLessThan, addr 0x367d2ac, size 0x1bc, virtual false, abstract: false, final false
