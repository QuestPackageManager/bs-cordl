...
public:
  ...
  /// @brief Method ErrorCode, addr 0x3739b3c, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW ErrorCode(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method GetLocalizedMessage, addr 0x3739ef4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method LocalizedKey, addr 0x3739a98, size 0xa4, virtual false, abstract: false, final false
  static inline ::StringW LocalizedKey(::GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason);

  /// @brief Method TryGetMultiplayerUnavailableReason, addr 0x3739bd0, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method VersionLessThan, addr 0x3739d38, size 0x1bc, virtual false, abstract: false, final false
