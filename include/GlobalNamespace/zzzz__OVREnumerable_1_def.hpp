...
template <typename T>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8104)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8104), inst: 1018 }), GenericInstantiation(GenericInstantiation {
// tdi: TypeDefinitionIndex(14314), inst: 1018 }), TypeDefinitionIndex(TypeDefinitionIndex(14314)), TypeDefinitionIndex(TypeDefinitionIndex(3852)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3852), inst: 1018 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(8105)) CS Name: ::OVREnumerable`1::Enumerator<T>
