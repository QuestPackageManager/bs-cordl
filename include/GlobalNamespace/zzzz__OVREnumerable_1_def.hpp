...
template <typename T>
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3852), inst: 1018 }), TypeDefinitionIndex(TypeDefinitionIndex(14314)), GenericInstantiation(GenericInstantiation
// { tdi: TypeDefinitionIndex(14314), inst: 1018 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8104), inst: 1018 }), TypeDefinitionIndex(TypeDefinitionIndex(3852)),
