...
// Ctor Parameters [CppParam { name: "_listIndex", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_type", ty: "::GlobalNamespace::Enumerator_OVREnumerable_1_CollectionType<T>", modifiers: "", def_value: None }, CppParam { name: "_listCount", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_enumerator", ty: "::System::Collections::Generic::IEnumerator_1<T>*", modifiers: "", def_value: None }, CppParam { name: "_readOnlyList", ty: "::System::Collections::Generic::IReadOnlyList_1<T>*", modifiers: "", def_value: None }, CppParam { name: "_setEnumerator", ty: "::System::Collections::Generic::HashSet_1_Enumerator<T>", modifiers: "", def_value: None }, CppParam { name: "_queueEnumerator", ty: "::System::Collections::Generic::Queue_1_Enumerator<T>", modifiers: "", def_value: None }, CppParam { name: "_listEnumerator", ty: "::System::Collections::Generic::List_1_Enumerator<T>", modifiers: "", def_value: None }]
...
inline bool TryGetCount(::ByRef<int32_t>  count) ;
