...
/// @brief Method Equals, addr 0x5e0bc20, size 0x9c, virtual true, abstract: false, final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals, addr 0x5e0bb3c, size 0xe4, virtual true, abstract: false, final true
inline bool Equals(::GlobalNamespace::MirrorRendererSO_CameraTransformData  other) ;

/// @brief Method GetHashCode, addr 0x5e0bcbc, size 0x158, virtual true, abstract: false, final false
...
/// @brief Method op_Equality, addr 0x5e0be14, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method op_Inequality, addr 0x5e0be4c, size 0x3c, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "position", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "rotation", ty: "::UnityEngine::Quaternion", modifiers: "", def_value: None }, CppParam { name: "fov", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "stereoEnabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "reflectionPlane", ty: "::UnityEngine::Plane", modifiers: "", def_value: None }]
...
/// @brief Field _renderTextures, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get__renderTextures, put=__cordl_internal_set__renderTextures)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::MirrorRendererSO_CameraTransformData,::UnityW<::UnityEngine::RenderTexture>>*  _renderTextures;
...
/// @brief Method Awake, addr 0x5e0b158, size 0x4, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CalculateReflectionMatrix, addr 0x5e0b43c, size 0xf4, virtual false, abstract: false, final false
static inline ::UnityEngine::Matrix4x4 CalculateReflectionMatrix(::UnityEngine::Vector4  plane) ;

/// @brief Method CameraSpacePlane, addr 0x5e0b744, size 0x13c, virtual false, abstract: false, final false
...
/// @brief Method CreateOrUpdateMirrorCamera, addr 0x5e0b170, size 0x2a0, virtual false, abstract: false, final false
inline void CreateOrUpdateMirrorCamera(::UnityEngine::Camera*  currentCamera, ::UnityEngine::RenderTexture*  renderTexture) ;

/// @brief Method Init, addr 0x5e0b15c, size 0x14, virtual false, abstract: false, final false
...
/// @brief Method OnDisable, addr 0x5e0b880, size 0x1ec, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnValidate, addr 0x5e0b0bc, size 0x4, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method Plane, addr 0x5e0b410, size 0x2c, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector4 Plane(::UnityEngine::Vector3  pos, ::UnityEngine::Vector3  normal) ;

/// @brief Method PrepareForNextFrame, addr 0x5e0a35c, size 0x14c, virtual false, abstract: false, final false
inline void PrepareForNextFrame() ;

/// @brief Method RenderMirror, addr 0x5e0b530, size 0x214, virtual false, abstract: false, final false
...
/// @brief Method RenderMirrorTexture, addr 0x5e0a7b4, size 0x890, virtual false, abstract: false, final false
...
/// @brief Method ValidateParams, addr 0x5e0b0c0, size 0x98, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::MirrorRendererSO_CameraTransformData,::UnityW<::UnityEngine::RenderTexture>>* const& __cordl_internal_get__renderTextures() const;
...
constexpr void __cordl_internal_set__renderTextures(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::MirrorRendererSO_CameraTransformData,::UnityW<::UnityEngine::RenderTexture>>*  value) ;
...
/// @brief Method .ctor, addr 0x5e0ba6c, size 0xd0, virtual false, abstract: false, final false
inline void _ctor() ;
