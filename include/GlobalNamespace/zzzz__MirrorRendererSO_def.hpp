...
public:
  ...
  /// @brief Method Equals, addr 0x2bd6ec0, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2bd6e1c, size 0xa4, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::__MirrorRendererSO__CameraTransformData other);

  /// @brief Method GetHashCode, addr 0x2bd6f50, size 0xf0, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x2bd7040, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x2bd7070, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x2bd633c, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculateReflectionMatrix, addr 0x2bd6638, size 0xe8, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 CalculateReflectionMatrix(::UnityEngine::Vector4 plane);

  /// @brief Method CameraSpacePlane, addr 0x2bd6990, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOrUpdateMirrorCamera, addr 0x2bd6358, size 0x2b4, virtual false, abstract: false, final false
  inline void CreateOrUpdateMirrorCamera(::UnityEngine::Camera* currentCamera, ::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method Init, addr 0x2bd6340, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x2bd6abc, size 0x224, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x2bd62c4, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Plane, addr 0x2bd660c, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 Plane(::UnityEngine::Vector3 pos, ::UnityEngine::Vector3 normal);

  /// @brief Method PrepareForNextFrame, addr 0x2bd562c, size 0x18c, virtual false, abstract: false, final false
  inline void PrepareForNextFrame();

  /// @brief Method RenderMirror, addr 0x2bd6720, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderMirrorTexture, addr 0x2bd5a4c, size 0x808, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateParams, addr 0x2bd62c8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bd6ce0, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor();
