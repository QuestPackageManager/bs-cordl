...
public:
  ...
  /// @brief Method Equals, addr 0x280f2b4, size 0xa4, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::__MirrorRendererSO__CameraTransformData other);

  /// @brief Method Equals, addr 0x280f358, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x280f3e8, size 0xf0, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method op_Equality, addr 0x280f4d8, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x280f508, size 0x34, virtual false, abstract: false, final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8909)), TypeDefinitionIndex(TypeDefinitionIndex(8948)), TypeDefinitionIndex(TypeDefinitionIndex(15602))]
...
public:
  ...
  /// @brief Method OnValidate, addr 0x280e75c, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Awake, addr 0x280e7d4, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method ValidateParams, addr 0x280e760, size 0x74, virtual false, abstract: false, final false
  inline void ValidateParams();

  /// @brief Method Init, addr 0x280e7d8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method PrepareForNextFrame, addr 0x280dac4, size 0x18c, virtual false, abstract: false, final false
  inline void PrepareForNextFrame();

  /// @brief Method RenderMirrorTexture, addr 0x280dee4, size 0x808, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderMirror, addr 0x280ebb8, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x280ef54, size 0x224, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method CreateOrUpdateMirrorCamera, addr 0x280e7f0, size 0x2b4, virtual false, abstract: false, final false
  inline void CreateOrUpdateMirrorCamera(::UnityEngine::Camera* currentCamera, ::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method Plane, addr 0x280eaa4, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 Plane(::UnityEngine::Vector3 pos, ::UnityEngine::Vector3 normal);

  /// @brief Method CameraSpacePlane, addr 0x280ee28, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method CalculateReflectionMatrix, addr 0x280ead0, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x280f178, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor();
