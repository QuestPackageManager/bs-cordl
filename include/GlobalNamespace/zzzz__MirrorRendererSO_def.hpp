...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MirrorRendererSO_CameraTransformData, "", "MirrorRendererSO/CameraTransformData");
...
public:
  ...
  /// @brief Method Equals, addr 0x5f4586c, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5f45788, size 0xe4, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::MirrorRendererSO_CameraTransformData other);

  /// @brief Method GetHashCode, addr 0x5f45908, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5f45a60, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x5f45a98, size 0x3c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MirrorRendererSO_CameraTransformData) == 0x34, "Size mismatch!");
...
public:
  ...
  /// @brief Field _clearDepthShader, offset 0x38, size 0x8
  ...
  /// @brief Field _mirrorCamera, offset 0x48, size 0x8
  ...
  /// @brief Field _mirrorCameraComponent, offset 0x50, size 0x8
  __declspec(property(get = __cordl_internal_get__mirrorCameraComponent, put = __cordl_internal_set__mirrorCameraComponent)) ::UnityW<::GlobalNamespace::MirrorCamera> _mirrorCameraComponent;
  ...
  /// @brief Field _renderTextures, offset 0x60, size 0x8
  ...
  /// @brief Method CreateOrUpdateMirrorCamera, addr 0x5f44c1c, size 0x2e4, virtual false, abstract: false, final false
  inline void CreateOrUpdateMirrorCamera(::UnityEngine::Camera* currentCamera, ::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method Init, addr 0x5f44c08, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5f454c8, size 0x1ec, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x5f44b68, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Plane, addr 0x5f4526c, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 Plane(::UnityEngine::Vector3 pos, ::UnityEngine::Vector3 normal);

  /// @brief Method PrepareForNextFrame, addr 0x5f43d24, size 0x14c, virtual false, abstract: false, final false
  inline void PrepareForNextFrame();

  /// @brief Method RenderMirror, addr 0x5f44f00, size 0x36c, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderMirrorTexture, addr 0x5f44214, size 0x6bc, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateParams, addr 0x5f44b6c, size 0x98, virtual false, abstract: false, final false
  ...
  constexpr ::UnityW<::GlobalNamespace::MirrorCamera> const& __cordl_internal_get__mirrorCameraComponent() const;

  constexpr ::UnityW<::GlobalNamespace::MirrorCamera>& __cordl_internal_get__mirrorCameraComponent();
  ...
  constexpr void __cordl_internal_set__mirrorCameraComponent(::UnityW<::GlobalNamespace::MirrorCamera> value);
  ...
  /// @brief Method .ctor, addr 0x5f456b4, size 0xd4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field kMirrorUniversalRendererAssetIndex offset 0xffffffff size 0x4
  static constexpr int32_t kMirrorUniversalRendererAssetIndex{ static_cast<int32_t>(0x1) };
  ...
  /// @brief Field _clearDepthShader, offset: 0x38, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Shader> ____clearDepthShader;

  /// @brief Field _bloomPrePassRenderTexture, offset: 0x40, size: 0x8, def value: None
  ::UnityW<::UnityEngine::RenderTexture> ____bloomPrePassRenderTexture;

  /// @brief Field _mirrorCamera, offset: 0x48, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Camera> ____mirrorCamera;

  /// @brief Field _mirrorCameraComponent, offset: 0x50, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::MirrorCamera> ____mirrorCameraComponent;

  /// @brief Field _antialiasing, offset: 0x58, size: 0x4, def value: None
  int32_t ____antialiasing;

  /// @brief Field _renderTextures, offset: 0x60, size: 0x8, def value: None
  ...
  /// @brief Field kLeftRect, offset: 0x68, size: 0x10, def value: None
  ::UnityEngine::Rect ___kLeftRect;

  /// @brief Field kRightRect, offset: 0x78, size: 0x10, def value: None
  ::UnityEngine::Rect ___kRightRect;

  /// @brief Field kFullRect, offset: 0x88, size: 0x10, def value: None
...
static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____clearDepthShader) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____bloomPrePassRenderTexture) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____mirrorCamera) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____mirrorCameraComponent) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____antialiasing) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ____renderTextures) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ___kLeftRect) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ___kRightRect) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MirrorRendererSO, ___kFullRect) == 0x88, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::MirrorRendererSO) == 0x98, "Size mismatch!");
