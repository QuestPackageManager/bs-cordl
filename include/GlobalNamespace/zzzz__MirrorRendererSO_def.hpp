...
public:
  ...
  /// @brief Method Equals, addr 0x5e0a0a8, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5e09fc4, size 0xe4, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::MirrorRendererSO_CameraTransformData other);

  /// @brief Method GetHashCode, addr 0x5e0a144, size 0x158, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5e0a29c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x5e0a2d4, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x5e095e0, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculateReflectionMatrix, addr 0x5e098c4, size 0xf4, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 CalculateReflectionMatrix(::UnityEngine::Vector4 plane);

  /// @brief Method CameraSpacePlane, addr 0x5e09bcc, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOrUpdateMirrorCamera, addr 0x5e095f8, size 0x2a0, virtual false, abstract: false, final false
  inline void CreateOrUpdateMirrorCamera(::UnityEngine::Camera* currentCamera, ::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method Init, addr 0x5e095e4, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x5e09d08, size 0x1ec, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x5e09544, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Plane, addr 0x5e09898, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 Plane(::UnityEngine::Vector3 pos, ::UnityEngine::Vector3 normal);

  /// @brief Method PrepareForNextFrame, addr 0x5e087e4, size 0x14c, virtual false, abstract: false, final false
  inline void PrepareForNextFrame();

  /// @brief Method RenderMirror, addr 0x5e099b8, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderMirrorTexture, addr 0x5e08c3c, size 0x890, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateParams, addr 0x5e09548, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e09ef4, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
