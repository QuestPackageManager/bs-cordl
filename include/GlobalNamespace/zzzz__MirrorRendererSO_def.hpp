...
public:
  ...
  /// @brief Method Equals, addr 0x4086f1c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x4086e74, size 0xa8, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::MirrorRendererSO_CameraTransformData other);

  /// @brief Method GetHashCode, addr 0x4086fac, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x40870d4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Inequality, addr 0x4087104, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x408642c, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculateReflectionMatrix, addr 0x4086720, size 0xec, virtual false, abstract: false, final false
  static inline ::UnityEngine::Matrix4x4 CalculateReflectionMatrix(::UnityEngine::Vector4 plane);

  /// @brief Method CameraSpacePlane, addr 0x4086a54, size 0x12c, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateOrUpdateMirrorCamera, addr 0x4086448, size 0x2ac, virtual false, abstract: false, final false
  inline void CreateOrUpdateMirrorCamera(::UnityEngine::Camera* currentCamera, ::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method Init, addr 0x4086430, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x4086b80, size 0x224, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnValidate, addr 0x40863b4, size 0x4, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method Plane, addr 0x40866f4, size 0x2c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 Plane(::UnityEngine::Vector3 pos, ::UnityEngine::Vector3 normal);

  /// @brief Method PrepareForNextFrame, addr 0x4085644, size 0x18c, virtual false, abstract: false, final false
  inline void PrepareForNextFrame();

  /// @brief Method RenderMirror, addr 0x408680c, size 0x248, virtual false, abstract: false, final false
  ...
  /// @brief Method RenderMirrorTexture, addr 0x4085acc, size 0x878, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateParams, addr 0x40863b8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4086da4, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
