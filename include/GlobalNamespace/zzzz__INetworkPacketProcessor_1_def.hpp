...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::INetworkPacketProcessor_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::INetworkPacketProcessor_1, "", "INetworkPacketProcessor`1");
// Dependencies
namespace GlobalNamespace {
// cpp template
