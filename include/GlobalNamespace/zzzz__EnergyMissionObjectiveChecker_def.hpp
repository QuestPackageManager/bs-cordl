...
/// @brief Method CheckAndUpdateStatus, addr 0x580a684, size 0xbc, virtual false, abstract: false, final false
inline void CheckAndUpdateStatus() ;

/// @brief Method HandleEnergyDidChange, addr 0x580a618, size 0x6c, virtual false, abstract: false, final false
inline void HandleEnergyDidChange(float_t  energy) ;

/// @brief Method Init, addr 0x580a740, size 0x174, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::EnergyMissionObjectiveChecker* New_ctor() ;

/// @brief Method OnDestroy, addr 0x580a508, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x580a8b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
