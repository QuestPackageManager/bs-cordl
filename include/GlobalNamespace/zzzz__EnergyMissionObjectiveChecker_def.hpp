...
public:
  ...
  /// @brief Method CheckAndUpdateStatus, addr 0x27035b8, size 0xc4, virtual false, abstract: false, final false
  inline void CheckAndUpdateStatus();

  /// @brief Method HandleEnergyDidChange, addr 0x270354c, size 0x6c, virtual false, abstract: false, final false
  inline void HandleEnergyDidChange(float_t energy);

  /// @brief Method Init, addr 0x270367c, size 0x138, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::EnergyMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x270347c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27037b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
