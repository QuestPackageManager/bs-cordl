...
public:
  // Declarations
  /// @brief Method ErrorCode, addr 0x373250c, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW ErrorCode(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method LocalizedKey, addr 0x373242c, size 0xe0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::DisconnectedReasonMethods) == 0x10, "Size mismatch!");
