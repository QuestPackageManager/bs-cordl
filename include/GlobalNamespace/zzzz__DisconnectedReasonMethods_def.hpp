...
public:
  // Declarations
  /// @brief Method ErrorCode, addr 0x3639014, size 0x94, virtual false, abstract: false, final false
  static inline ::StringW ErrorCode(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method LocalizedKey, addr 0x3638f34, size 0xe0, virtual false, abstract: false, final false
