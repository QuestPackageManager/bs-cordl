...
template <typename T> inline void GlobalNamespace::ObservableVariableSO_1<T>::add_didChangeEvent(::System::Action* value) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ObservableVariableSO_1<T>*>(), { "add_didChangeEvent", {}, { ::i2c::type_of<::System::Action*>() } })));
...
template <typename T> inline void GlobalNamespace::ObservableVariableSO_1<T>::remove_didChangeEvent(::System::Action* value) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ObservableVariableSO_1<T>*>(), { "remove_didChangeEvent", {}, { ::i2c::type_of<::System::Action*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, value);
}
template <typename T> inline void GlobalNamespace::ObservableVariableSO_1<T>::set_value(T value) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ObservableVariableSO_1<T>*>(), { "set_value", {}, { ::i2c::type_of<T>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, value);
}
template <typename T> inline T GlobalNamespace::ObservableVariableSO_1<T>::get_value() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ObservableVariableSO_1<T>*>(), { "get_value", {}, {} })));
...
template <typename T> inline T GlobalNamespace::ObservableVariableSO_1<T>::op_Implicit_T(::GlobalNamespace::ObservableVariableSO_1<T>* obj) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ObservableVariableSO_1<T>*>(), { "op_Implicit", {}, { ::i2c::type_of<::GlobalNamespace::ObservableVariableSO_1<T>*>() } })));
...
template <typename T> inline void GlobalNamespace::ObservableVariableSO_1<T>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ObservableVariableSO_1<T>*>(), { ".ctor", {}, {} })));
...
template <typename T> inline ::GlobalNamespace::ObservableVariableSO_1<T>* GlobalNamespace::ObservableVariableSO_1<T>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::ObservableVariableSO_1<T>*>());
}
