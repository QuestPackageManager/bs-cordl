...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeAwardData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MultiplayerBadgeAwardData(MultiplayerBadgeAwardData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MultiplayerBadgeAwardData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MultiplayerBadgeAwardData(MultiplayerBadgeAwardDataconst&) = delete;
