...
/// @brief Method HandleToggleValueChanged, addr 0x56c03cc, size 0x4, virtual false, abstract: false, final false
inline void HandleToggleValueChanged(bool  isOn) ;

static inline ::GlobalNamespace::ToggleableCanvasGroup* New_ctor() ;

/// @brief Method OnDisable, addr 0x56c02e4, size 0xe8, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x56c01bc, size 0xfc, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method SetCanvasGroupData, addr 0x56c02b8, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56c03d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
