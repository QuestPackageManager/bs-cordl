...
public:
  ...
  /// @brief Method HandleToggleValueChanged, addr 0x572e2b8, size 0x4, virtual false, abstract: false, final false
  inline void HandleToggleValueChanged(bool isOn);

  static inline ::GlobalNamespace::ToggleableCanvasGroup* New_ctor();

  /// @brief Method OnDisable, addr 0x572e1d0, size 0xe8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x572e0a8, size 0xfc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SetCanvasGroupData, addr 0x572e1a4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572e2bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
