...
public:
  ...
  /// @brief Method .ctor, addr 0x25d872c, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Initialize, addr 0x25d8694, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25d8724, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_energyPanelGo, addr 0x25d8670, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_energyPanelGo();

  /// @brief Method get_immediateRankGo, addr 0x25d8668, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_immediateRankGo();

  /// @brief Method get_relativeScoreGo, addr 0x25d8660, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_relativeScoreGo();

  /// @brief Method get_songProgressPanelGO, addr 0x25d8658, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::GameObject> get_songProgressPanelGO();

  /// @brief Method set_alpha, addr 0x25d8678, size 0x1c, virtual false, abstract: false, final false
