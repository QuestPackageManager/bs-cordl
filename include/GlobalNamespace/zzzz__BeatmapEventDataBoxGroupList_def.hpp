...
public:
  ...
  /// @brief Method Insert, addr 0x2679908, size 0x37c, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x2679738, size 0x78, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  /// @brief Method Remove, addr 0x2679cd4, size 0x374, virtual false, abstract: false, final false
  inline void Remove(::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapEventDataBoxGroup*>* nodeToDelete);

  /// @brief Method SyncWithBeatmapData, addr 0x267a048, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26797b0, size 0xdc, virtual false, abstract: false, final false
