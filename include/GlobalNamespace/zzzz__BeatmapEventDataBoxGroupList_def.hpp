...
/// @brief Field _usedBeatmapEventDataBoxes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__usedBeatmapEventDataBoxes, put=setStaticF__usedBeatmapEventDataBoxes)) ::System::Collections::Generic::HashSet_1<::GlobalNamespace::BeatmapEventDataBoxGroup*>*  _usedBeatmapEventDataBoxes;
...
/// @brief Method Insert, addr 0x3618768, size 0x354, virtual false, abstract: false, final false
...
static inline ::GlobalNamespace::BeatmapEventDataBoxGroupList* New_ctor(int32_t  groupId, ::GlobalNamespace::BeatmapData*  beatmapData, ::GlobalNamespace::IBeatToTimeConverter*  beatToTimeConverter, ::GlobalNamespace::IBeatmapLightEventConverter*  lightEventConverter) ;

/// @brief Method NoDomainReloadInit, addr 0x36185a4, size 0x80, virtual false, abstract: false, final false
static inline void NoDomainReloadInit() ;

/// @brief Method Remove, addr 0x3618b10, size 0x354, virtual false, abstract: false, final false
inline void Remove(::System::Collections::Generic::LinkedListNode_1<::GlobalNamespace::BeatmapEventDataBoxGroup*>*  nodeToDelete) ;

/// @brief Method SyncWithBeatmapData, addr 0x3618e64, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3618624, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(int32_t  groupId, ::GlobalNamespace::BeatmapData*  beatmapData, ::GlobalNamespace::IBeatToTimeConverter*  beatToTimeConverter, ::GlobalNamespace::IBeatmapLightEventConverter*  lightEventConverter) ;
