...
public:
  ...
  /// @brief Method ClearLoading, addr 0x252f398, size 0x34, virtual false, abstract: false, final false
  inline void ClearLoading();

  /// @brief Method LoadLevel, addr 0x252f258, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNewStartTime, addr 0x252f390, size 0x8, virtual false, abstract: false, final false
  inline void SetNewStartTime(int64_t newStartTime);

  /// @brief Method Tick, addr 0x252f3cc, size 0x1f4, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x252f5c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_countdownFinishedEvent, addr 0x252f0f8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_stillDownloadingSongEvent, addr 0x252efc0, size 0x9c, virtual false, abstract: false, final false
  inline void add_stillDownloadingSongEvent(::System::Action* value);

  /// @brief Convert to "::Zenject::ITickable"
  constexpr ::Zenject::ITickable* i___Zenject__ITickable() noexcept;

  /// @brief Method remove_countdownFinishedEvent, addr 0x252f1a8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_stillDownloadingSongEvent, addr 0x252f05c, size 0x9c, virtual false, abstract: false, final false
