...
public:
  ...
  /// @brief Method MoveNext, addr 0x58df19c, size 0x4d8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x58df674, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method ClearLoading, addr 0x58deee0, size 0x48, virtual false, abstract: false, final false
  inline void ClearLoading();

  /// @brief Method LoadBeatmapLevelDataAsync, addr 0x58dedec, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLevel, addr 0x58ded50, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetNewStartTime, addr 0x58deed8, size 0x8, virtual false, abstract: false, final false
  inline void SetNewStartTime(int64_t newStartTime);

  /// @brief Method Tick, addr 0x58def28, size 0x270, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x58df198, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_countdownFinishedEvent, addr 0x58debd0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_stillDownloadingSongEvent, addr 0x58dea78, size 0xac, virtual false, abstract: false, final false
  inline void add_stillDownloadingSongEvent(::System::Action* value);

  /// @brief Convert to "::Zenject::ITickable"
  constexpr ::Zenject::ITickable* i___Zenject__ITickable() noexcept;

  /// @brief Method remove_countdownFinishedEvent, addr 0x58dec90, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_stillDownloadingSongEvent, addr 0x58deb24, size 0xac, virtual false, abstract: false, final false
