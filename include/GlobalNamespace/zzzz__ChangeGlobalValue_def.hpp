...
public:
  ...
  // Ctor Parameters [CppParam { name: "key", ty: "::StringW", modifiers: "", def_value: None, comment: None }, CppParam { name: "value", ty: "T", modifiers: "", def_value: None, comment: None }]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ChangeGlobalValue", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ChangeGlobalValue(ChangeGlobalValue&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ChangeGlobalValue", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ChangeGlobalValue(ChangeGlobalValueconst&) = delete;
