...
public:
  ...
  /// @brief Method MoveNext, addr 0x5891be8, size 0x544, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x589212c, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Dispose, addr 0x5891be4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetBeatmapData, addr 0x5891af4, size 0xf0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5891ae8, size 0xc, virtual false, abstract: false, final false
