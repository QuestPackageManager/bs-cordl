...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ILevelGameplaySetupData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILevelGameplaySetupData(ILevelGameplaySetupDataconst&) = delete;
