...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x584fc88, size 0x74, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::MainMenuAdditionalComponentsInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x584fcfc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
