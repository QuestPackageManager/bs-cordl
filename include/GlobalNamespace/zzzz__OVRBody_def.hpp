...
/// @brief Method Awake, addr 0x5c495a8, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method GetBodyState, addr 0x5c49a20, size 0x90, virtual false, abstract: false, final false
inline void GetBodyState(::GlobalNamespace::OVRPlugin_Step  step) ;

/// @brief Method GetBodyTrackingCalibrationStatus, addr 0x5c49d2c, size 0x18, virtual false, abstract: false, final false
inline ::GlobalNamespace::OVRPlugin_BodyTrackingCalibrationState GetBodyTrackingCalibrationStatus() ;

/// @brief Method GetBodyTrackingFidelityStatus, addr 0x5c49d44, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData, addr 0x5c49f94, size 0x18, virtual true, abstract: false, final true
...
/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData, addr 0x5c49d6c, size 0x228, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRSkeleton_SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType, addr 0x5c49d4c, size 0x20, virtual true, abstract: false, final true
inline ::GlobalNamespace::OVRSkeleton_SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled, addr 0x5c4a044, size 0x8, virtual true, abstract: false, final true
inline bool OVRSkeleton_IOVRSkeletonDataProvider_get_enabled() ;

/// @brief Method OnDestroy, addr 0x5c49b9c, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x5c49b0c, size 0x90, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5c49624, size 0x224, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OnPermissionGranted, addr 0x5c49ab0, size 0x5c, virtual false, abstract: false, final false
inline void OnPermissionGranted(::StringW  permissionId) ;

/// @brief Method ResetBodyTrackingCalibration, addr 0x5c49cd8, size 0x54, virtual false, abstract: false, final false
static inline bool ResetBodyTrackingCalibration() ;

/// @brief Method SetRequestedJointSet, addr 0x5c49bb0, size 0xc4, virtual false, abstract: false, final false
static inline bool SetRequestedJointSet(::GlobalNamespace::OVRPlugin_BodyJointSet  jointSet) ;

/// @brief Method StartBodyTracking, addr 0x5c49848, size 0x1d8, virtual false, abstract: false, final false
static inline bool StartBodyTracking() ;

/// @brief Method SuggestBodyTrackingCalibrationOverride, addr 0x5c49c74, size 0x64, virtual false, abstract: false, final false
static inline bool SuggestBodyTrackingCalibrationOverride(float_t  height) ;

/// @brief Method Update, addr 0x5c49ba8, size 0x8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5c4a040, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline int32_t getStaticF__trackingInstanceCount() ;

/// @brief Method get_BodyState, addr 0x5c49524, size 0x84, virtual false, abstract: false, final false
inline ::System::Nullable_1<::GlobalNamespace::OVRPlugin_BodyState> get_BodyState() ;

/// @brief Method get_Fidelity, addr 0x5c49fac, size 0x20, virtual false, abstract: false, final false
static inline ::GlobalNamespace::OVRPlugin_BodyTrackingFidelity2 get_Fidelity() ;

/// @brief Method get_ProvidedSkeletonType, addr 0x5c49514, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method set_Fidelity, addr 0x5c49fcc, size 0x74, virtual false, abstract: false, final false
static inline void set_Fidelity(::GlobalNamespace::OVRPlugin_BodyTrackingFidelity2  value) ;

/// @brief Method set_ProvidedSkeletonType, addr 0x5c4951c, size 0x8, virtual false, abstract: false, final false
