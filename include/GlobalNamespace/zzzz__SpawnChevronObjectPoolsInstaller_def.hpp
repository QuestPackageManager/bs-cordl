...
public:
  ...
  /// @brief Method InstallBindings, addr 0x578bd0c, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x578bd94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
