...
/// @brief Method DidActivate, addr 0x5739f8c, size 0x270, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate, addr 0x573a248, size 0x1c4, virtual true, abstract: false, final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleHideExplicitChanged, addr 0x573a424, size 0x30, virtual false, abstract: false, final false
inline void HandleHideExplicitChanged(bool  newValue) ;

/// @brief Method HandlePausePressDurationChanged, addr 0x573a40c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method UpdateExplicitContentHiddenWarningVisibility, addr 0x573a1fc, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x573a454, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
