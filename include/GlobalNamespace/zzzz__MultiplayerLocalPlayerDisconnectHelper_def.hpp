...
public:
  ...
  /// @brief Method Disconnect, addr 0x2715008, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveDisconnectButtonString, addr 0x2716dd4, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2716e44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
