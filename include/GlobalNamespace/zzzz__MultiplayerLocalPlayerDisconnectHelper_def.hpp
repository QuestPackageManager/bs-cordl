...
public:
  ...
  /// @brief Method Disconnect, addr 0x25f6acc, size 0x210, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveDisconnectButtonString, addr 0x25f8850, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25f88c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
