...
// Write type traits
MARK_REF_T(::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper*, "", "MultiplayerLocalPlayerDisconnectHelper");
...
public:
  ...
  /// @brief Method Disconnect, addr 0x59c741c, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveDisconnectButtonString, addr 0x59c9654, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59c96d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MultiplayerLocalPlayerDisconnectHelper) == 0x28, "Size mismatch!");
