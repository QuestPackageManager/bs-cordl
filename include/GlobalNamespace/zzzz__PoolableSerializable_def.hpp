...
public:
  ...
  /// @brief Method GetPool, addr 0x1506a70, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x150692c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x15063f4, size 0x70, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method Release, addr 0x15069a4, size 0xcc, virtual false, abstract: false, final false
  static inline void Release(::GlobalNamespace::IPoolableSerializable* t);

  /// @brief Method Retain, addr 0x1506500, size 0x10, virtual true, abstract: false, final false
  inline void Retain();
  ...
  /// @brief Method .ctor, addr 0x1504e24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
