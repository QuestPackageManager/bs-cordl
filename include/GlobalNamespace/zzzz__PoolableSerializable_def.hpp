...
public:
  ...
  /// @brief Method NoDomainReloadInit, addr 0x133c0b0, size 0x78, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  /// @brief Method Retain, addr 0x133bc84, size 0x10, virtual true, abstract: false, final false
  inline void Retain();

  /// @brief Method Release, addr 0x133bb78, size 0x70, virtual true, abstract: false, final false
  inline void Release();
  ...
  /// @brief Method Release, addr 0x133c128, size 0xcc, virtual false, abstract: false, final false
  static inline void Release(::GlobalNamespace::IPoolableSerializable* t);

  /// @brief Method GetPool, addr 0x133c1f4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x133a5a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
