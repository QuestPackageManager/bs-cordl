...
// Dependencies IPoolableSerializable, LiteNetLib.Utils.INetSerializable, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method GetPool, addr 0x27242e4, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x27241a0, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x2723c6c, size 0x70, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method Release, addr 0x2724218, size 0xcc, virtual false, abstract: false, final false
  static inline void Release(::GlobalNamespace::IPoolableSerializable* t);

  /// @brief Method Retain, addr 0x2723d78, size 0x10, virtual true, abstract: false, final false
  inline void Retain();
  ...
  /// @brief Method .ctor, addr 0x2722734, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
