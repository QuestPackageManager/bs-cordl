...
public:
  ...
  /// @brief Method GetPool, addr 0x36bd550, size 0x1ec, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x36bd3f8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x36bce8c, size 0x74, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method Release, addr 0x36bd478, size 0xd8, virtual false, abstract: false, final false
  static inline void Release(::GlobalNamespace::IPoolableSerializable* t);

  /// @brief Method Retain, addr 0x36bcfa8, size 0x10, virtual true, abstract: false, final false
  inline void Retain();
  ...
  /// @brief Method .ctor, addr 0x36bb6ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
