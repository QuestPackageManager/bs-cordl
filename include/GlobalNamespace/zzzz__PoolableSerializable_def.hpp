...
public:
  ...
  /// @brief Method GetPool, addr 0x150ceb4, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method NoDomainReloadInit, addr 0x150cd70, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x150c838, size 0x70, virtual true, abstract: false, final false
  inline void Release();

  /// @brief Method Release, addr 0x150cde8, size 0xcc, virtual false, abstract: false, final false
  static inline void Release(::GlobalNamespace::IPoolableSerializable* t);

  /// @brief Method Retain, addr 0x150c944, size 0x10, virtual true, abstract: false, final false
  inline void Retain();
  ...
  /// @brief Method .ctor, addr 0x150b268, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
