...
/// @brief Field _pools, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__pools, put=setStaticF__pools)) ::System::Collections::Concurrent::ConcurrentDictionary_2<::System::Type*,::System::Collections::Concurrent::ConcurrentBag_1<::GlobalNamespace::IPoolableSerializable*>*>*  _pools;
...
/// @brief Method GetPool, addr 0x3680808, size 0x1ec, virtual false, abstract: false, final false
...
/// @brief Method NoDomainReloadInit, addr 0x36806b0, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method Release, addr 0x3680144, size 0x74, virtual true, abstract: false, final false
inline void Release() ;

/// @brief Method Release, addr 0x3680730, size 0xd8, virtual false, abstract: false, final false
static inline void Release(::GlobalNamespace::IPoolableSerializable*  t) ;

/// @brief Method Retain, addr 0x3680260, size 0x10, virtual true, abstract: false, final false
inline void Retain() ;
...
/// @brief Method .ctor, addr 0x367e964, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
