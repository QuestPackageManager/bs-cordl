...
public:
  ...
  /// @brief Method .ctor addr 0x23100a8 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ExecuteAsync>b__0 addr 0x23100b0 size 0x2c virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x2310140 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <ExecuteAsync>b__14_1 addr 0x2310148 size 0x20 virtual false final false
  inline ::StringW _ExecuteAsync_b__14_1(::GlobalNamespace::PreviewDifficultyBeatmapSet* x);

  /// @brief Method <ExecuteAsync>b__14_2 addr 0x2310168 size 0x64 virtual false final false
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4358)), TypeDefinitionIndex(TypeDefinitionIndex(3394)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 906
// }), TypeDefinitionIndex(TypeDefinitionIndex(3401))} Self: TypeDefinitionIndex(TypeDefinitionIndex(5987)) CS Name: ::RunSongConsoleCommand::<ExecuteAsync>d__14
...
public:
  ...
  /// @brief Method MoveNext addr 0x23101cc size 0xd7c virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x2310f48 size 0xc virtual true final true
...
public:
  ...
  /// @brief Method get_isAsyncCommand addr 0x230fb5c size 0x8 virtual true final false
  inline bool get_isAsyncCommand();

  /// @brief Method GetArguments addr 0x230fb64 size 0x144 virtual true final false
  inline ::ArrayW<::GlobalNamespace::ArgumentBase*, ::Array<::GlobalNamespace::ArgumentBase*>*> GetArguments();

  /// @brief Method GetShortHelpText addr 0x230fca8 size 0x44 virtual true final false
  inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetShortHelpText();

  /// @brief Method GetLongUsageHelp addr 0x230fcec size 0x44 virtual true final false
  inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetLongUsageHelp();

  /// @brief Method GetCommandName addr 0x230fd30 size 0x40 virtual true final false
  inline ::StringW GetCommandName();

  /// @brief Method Execute addr 0x230fd70 size 0x4 virtual true final false
  inline void Execute(::System::Collections::Generic::List_1<::GlobalNamespace::__DebugConsoleController__ConsoleMessage>* messages);

  /// @brief Method ExecuteAsync addr 0x230fd74 size 0xd8 virtual true final false
  ...
  /// @brief Method .ctor addr 0x230fe4c size 0x25c virtual false final false
  inline void _ctor();
