...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorSchemeIdAttribute*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorSchemeIdAttribute*, "", "ColorSchemeIdAttribute");
...
static_assert(sizeof(::GlobalNamespace::ColorSchemeIdAttribute) == 0x20, "Size mismatch!");
