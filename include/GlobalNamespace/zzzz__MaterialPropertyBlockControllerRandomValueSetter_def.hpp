...
public:
  ...
  /// @brief Method ApplyParams, addr 0x565d6c4, size 0xdc, virtual false, abstract: false, final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter* New_ctor();

  /// @brief Method OnValidate, addr 0x565d7a0, size 0x28, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyId, addr 0x565d6a4, size 0x20, virtual false, abstract: false, final false
  inline void RefreshPropertyId();

  /// @brief Method Start, addr 0x565d67c, size 0x28, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x565d7c8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
