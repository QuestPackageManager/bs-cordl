...
public:
  ...
  /// @brief Method Start, addr 0x21a9818, size 0x24, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method OnValidate, addr 0x21a9918, size 0x24, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyId, addr 0x21a983c, size 0x20, virtual false, abstract: false, final false
  inline void RefreshPropertyId();

  /// @brief Method ApplyParams, addr 0x21a985c, size 0xbc, virtual false, abstract: false, final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyBlockControllerRandomValueSetter* New_ctor();

  /// @brief Method .ctor, addr 0x21a993c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
