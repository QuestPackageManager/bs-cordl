...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ab274, size 0x24c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26ab4c0, size 0x7c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ab53c, size 0x268, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26ab7a4, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ab820, size 0x268, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26aba88, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26abb04, size 0x3f4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26abef8, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26abf74, size 0x2a0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26ac214, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x26ac290, size 0x2b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x26ac540, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method CheckForNewEntitlementsAsync, addr 0x26ab010, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AdditionalContentModel_UpdateEntitlementsResult CheckForNewEntitlementsAsync();

  /// @brief Method GetLevelDataVersion, addr 0x26ab018, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelDataVersion GetLevelDataVersion(::StringW levelId);

  /// @brief Method GetLevelDataVersionInternalAsync, addr 0x26aaa60, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetLevelEntitlementStatusInternalAsync, addr 0x26aa870, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetLevelProductData, addr 0x26aa854, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SteamLevelProductCollectionModel_LevelProductData* GetLevelProductData(::StringW levelId);

  /// @brief Method GetPackEntitlementStatusInternalAsync, addr 0x26aa968, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method GetRedirectedLevelPackProductData, addr 0x26aab58, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method HasLevelEntitlement, addr 0x26ab020, size 0x80, virtual false, abstract: false, final false
  inline bool HasLevelEntitlement(::StringW levelId);

  /// @brief Method HasLevelPackEntitlement, addr 0x26ab0a0, size 0xcc, virtual false, abstract: false, final false
  inline bool HasLevelPackEntitlement(::StringW levelPackId);

  /// @brief Method InvalidateDataInternal, addr 0x26aa84c, size 0x8, virtual true, abstract: false, final false
  inline void InvalidateDataInternal();

  /// @brief Method IsDataValidAsync, addr 0x26aac60, size 0xfc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<bool>* IsDataValidAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method IsPackBetterBuyThanLevelAsync, addr 0x26aafa8, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method OpenBundleUrl, addr 0x26aaf6c, size 0x3c, virtual false, abstract: false, final false
  inline void OpenBundleUrl(uint32_t bundleId);

  /// @brief Method OpenLevelPackProductStoreAsync, addr 0x26aae70, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method OpenLevelProductStoreAsync, addr 0x26aad5c, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method OpenProductStore, addr 0x26aae34, size 0x3c, virtual false, abstract: false, final false
  inline void OpenProductStore(uint32_t appId);

  /// @brief Method OpenStore, addr 0x26aaf68, size 0x4, virtual true, abstract: false, final false
  inline void OpenStore(::StringW uri);

  /// @brief Method <HasLevelPackEntitlement>b__22_0, addr 0x26ab218, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ab16c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
