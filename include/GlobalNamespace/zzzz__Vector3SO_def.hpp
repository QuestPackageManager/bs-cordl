...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8993)), TypeDefinitionIndex(TypeDefinitionIndex(15622)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15622), inst:
// 414 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(15627)) CS Name: ::Vector3SO*
...
public:
  ...
  /// @brief Method .ctor, addr 0xe52dcc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
