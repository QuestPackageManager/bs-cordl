...
public:
  ...
  /// @brief Method .ctor, addr 0x263bf6c, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DespawnInternal, addr 0x263aa94, size 0x1e4, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::NoteController* noteController);

  /// @brief Method DespawnInternal, addr 0x263a6a8, size 0x58, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method DespawnInternal, addr 0x263aec8, size 0x9c, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::SliderController* sliderNoteController);

  /// @brief Method Init, addr 0x263a014, size 0x59c, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessNoteData, addr 0x263a700, size 0x394, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessObstacleData, addr 0x263a5b0, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x263ac78, size 0x250, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263af64, size 0x1008, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeObstacleControllers, addr 0x2639fc4, size 0x50, virtual true, abstract: false, final false
