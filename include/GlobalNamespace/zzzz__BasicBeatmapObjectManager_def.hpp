...
public:
  ...
  /// @brief Method .ctor, addr 0x3a81794, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _basicGameNotePoolContainer, offset 0xb8, size 0x8
  ...
  /// @brief Field _bombNotePoolContainer, offset 0xd0, size 0x8
  ...
  /// @brief Field _burstSliderGameNotePoolContainer, offset 0xc8, size 0x8
  ...
  /// @brief Field _burstSliderHeadGameNotePoolContainer, offset 0xc0, size 0x8
  __declspec(property(
  ...
  /// @brief Field _firstBasicNoteTime, offset 0xa8, size 0x8
  ...
  /// @brief Field _obstaclePoolContainer, offset 0xd8, size 0x8
  ...
  /// @brief Field _random, offset 0xa0, size 0x8
  __declspec(property(get = __cordl_internal_get__random, put = __cordl_internal_set__random)) ::System::Random* _random;

  /// @brief Field _sliderNotePoolContainersDictionary, offset 0xe0, size 0x8
  ...
  /// @brief Method DespawnInternal, addr 0x3a80ec0, size 0x1dc, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::NoteController* noteController);

  /// @brief Method DespawnInternal, addr 0x3a8095c, size 0x58, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method DespawnInternal, addr 0x3a814c0, size 0x9c, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::SliderController* sliderNoteController);

  /// @brief Method Init, addr 0x3a8015c, size 0x588, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessNoteData, addr 0x3a809b4, size 0x378, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessObstacleData, addr 0x3a806e4, size 0xe0, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x3a8109c, size 0x29c, virtual true, abstract: false, final false
  ...
  /// @brief Method __InvalidateBombNotePool, addr 0x3a81624, size 0x94, virtual false, abstract: false, final false
  inline void __InvalidateBombNotePool();

  /// @brief Method __InvalidateGameNotePools, addr 0x3a8155c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3a816b8, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_activeObstacleControllers, addr 0x3a8010c, size 0x50, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Field _random, offset: 0xa0, size: 0x8, def value: None
  ::System::Random* ____random;

  /// @brief Field _firstBasicNoteTime, offset: 0xa8, size: 0x8, def value: None
  ...
  /// @brief Field _basicGameNotePoolContainer, offset: 0xb8, size: 0x8, def value: None
  ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::GameNoteController>>* ____basicGameNotePoolContainer;

  /// @brief Field _burstSliderHeadGameNotePoolContainer, offset: 0xc0, size: 0x8, def value: None
  ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::GameNoteController>>* ____burstSliderHeadGameNotePoolContainer;

  /// @brief Field _burstSliderGameNotePoolContainer, offset: 0xc8, size: 0x8, def value: None
  ...
  /// @brief Field _bombNotePoolContainer, offset: 0xd0, size: 0x8, def value: None
  ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::BombNoteController>>* ____bombNotePoolContainer;

  /// @brief Field _obstaclePoolContainer, offset: 0xd8, size: 0x8, def value: None
  ::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::ObstacleController>>* ____obstaclePoolContainer;

  /// @brief Field _sliderNotePoolContainersDictionary, offset: 0xe0, size: 0x8, def value: None
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::BasicBeatmapObjectManager, 0xe8>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____random) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____firstBasicNoteTime) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____initData) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____basicGameNotePoolContainer) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____burstSliderHeadGameNotePoolContainer) == 0xc0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____burstSliderGameNotePoolContainer) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____bombNotePoolContainer) == 0xd0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____obstaclePoolContainer) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BasicBeatmapObjectManager, ____sliderNotePoolContainersDictionary) == 0xe0, "Offset mismatch!");
