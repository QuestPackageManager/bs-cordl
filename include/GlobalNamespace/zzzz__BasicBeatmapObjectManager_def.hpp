...
/// @brief Method .ctor, addr 0x57160f4, size 0x10, virtual false, abstract: false, final false
...
/// @brief Field _sliderNotePoolContainersDictionary, offset 0xf0, size 0x8 
 __declspec(property(get=__cordl_internal_get__sliderNotePoolContainersDictionary, put=__cordl_internal_set__sliderNotePoolContainersDictionary)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SliderController_LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*  _sliderNotePoolContainersDictionary;
...
/// @brief Method DespawnInternal, addr 0x5715a80, size 0x208, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method DespawnInternal, addr 0x5715728, size 0x64, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method DespawnInternal, addr 0x5715ec4, size 0xb0, virtual true, abstract: false, final false
inline void DespawnInternal(::GlobalNamespace::SliderController*  sliderNoteController) ;

/// @brief Method Init, addr 0x57150d4, size 0x5a4, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::BasicBeatmapObjectManager_InitData*  initData, ::GlobalNamespace::IRandom*  random, ::GlobalNamespace::DeterminismConfig*  determinismConfig, ::GlobalNamespace::VariableMovementDataProvider*  variableMovementDataProvider, ::GlobalNamespace::GameNoteController_Pool*  basicGameNotePool, ::GlobalNamespace::GameNoteController_Pool*  burstSliderHeadGameNotePool, ::GlobalNamespace::BurstSliderGameNoteController_Pool*  burstSliderGameNotePool, ::GlobalNamespace::BombNoteController_Pool*  bombNotePool, ::GlobalNamespace::ObstacleController_Pool*  obstaclePool, ::GlobalNamespace::SliderController_Pool*  sliderPools) ;

static inline ::GlobalNamespace::BasicBeatmapObjectManager* New_ctor() ;

/// @brief Method ProcessNoteData, addr 0x571578c, size 0x2f4, virtual true, abstract: false, final false
...
/// @brief Method ProcessObstacleData, addr 0x5715678, size 0xb0, virtual true, abstract: false, final false
...
/// @brief Method ProcessSliderData, addr 0x5715c88, size 0x23c, virtual true, abstract: false, final false
...
/// @brief Method __InvalidateBombNotePool, addr 0x571604c, size 0xa0, virtual false, abstract: false, final false
inline void __InvalidateBombNotePool() ;

/// @brief Method __InvalidateGameNotePools, addr 0x5715f74, size 0xd8, virtual false, abstract: false, final false
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SliderController_LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>* const& __cordl_internal_get__sliderNotePoolContainersDictionary() const;

constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SliderController_LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*& __cordl_internal_get__sliderNotePoolContainersDictionary() ;
...
constexpr void __cordl_internal_set__sliderNotePoolContainersDictionary(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SliderController_LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*  value) ;

constexpr void __cordl_internal_set__variableMovementDataProvider(::GlobalNamespace::VariableMovementDataProvider*  value) ;

/// @brief Method .ctor, addr 0x57160ec, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_activeObstacleControllers, addr 0x5715080, size 0x54, virtual true, abstract: false, final false
...
/// @brief Field _sliderNotePoolContainersDictionary, offset: 0xf0, size: 0x8, def value: None
 ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SliderController_LengthType,::GlobalNamespace::MemoryPoolContainer_1<::UnityW<::GlobalNamespace::SliderController>>*>*  ____sliderNotePoolContainersDictionary;
