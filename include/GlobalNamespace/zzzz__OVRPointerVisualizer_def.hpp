...
public:
  ...
  /// @brief Method Update, addr 0x5d82e90, size 0x20c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5d8309c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
