...
public:
  ...
  /// @brief Method Update, addr 0x4001870, size 0x1f8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x4001a68, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
