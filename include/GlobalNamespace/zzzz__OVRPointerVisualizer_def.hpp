...
public:
  ...
  /// @brief Method Update, addr 0x5ebee58, size 0x20c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5ebf064, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
