...
public:
  ...
  /// @brief Method Update, addr 0x5ca9ebc, size 0x20c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5caa0c8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
