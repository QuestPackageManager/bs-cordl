...
public:
  ...
  /// @brief Method Update, addr 0x2b76360, size 0x1a0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2b76500, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
