...
public:
  ...
  /// @brief Method GetStartupLevel, addr 0x3b78f40, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_meshFilter, addr 0x3b78e50, size 0x78, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::MeshFilter> get_meshFilter();

  /// @brief Method get_meshRenderer, addr 0x3b78ec8, size 0x78, virtual false, abstract: false, final false
