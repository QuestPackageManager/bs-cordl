...
public:
  ...
  /// @brief Method .ctor, addr 0x5778f20, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_audioMixer, addr 0x5778f08, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Audio::AudioMixer> get_audioMixer();

  /// @brief Method get_spatializerPluginLatency, addr 0x5778f10, size 0x8, virtual false, abstract: false, final false
  inline float_t get_spatializerPluginLatency();

  /// @brief Method get_spatializerSfxVolumeOffset, addr 0x5778f18, size 0x8, virtual false, abstract: false, final false
