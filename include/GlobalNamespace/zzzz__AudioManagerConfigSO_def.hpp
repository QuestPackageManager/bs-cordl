...
/// @brief Method .ctor, addr 0x5709408, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_audioMixer, addr 0x57093f0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Audio::AudioMixer> get_audioMixer() ;

/// @brief Method get_spatializerPluginLatency, addr 0x57093f8, size 0x8, virtual false, abstract: false, final false
inline float_t get_spatializerPluginLatency() ;

/// @brief Method get_spatializerSfxVolumeOffset, addr 0x5709400, size 0x8, virtual false, abstract: false, final false
