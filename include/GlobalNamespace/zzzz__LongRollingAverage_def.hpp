...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LongRollingAverage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LongRollingAverage(LongRollingAverage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LongRollingAverage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LongRollingAverage(LongRollingAverageconst&) = delete;
