...
public:
  ...
  /// @brief Method Reset, addr 0x22d35c4, size 0xc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x22d34d0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d3468, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t window);

  /// @brief Method get_currentAverage, addr 0x22d3450, size 0x8, virtual false, abstract: false, final false
  inline int64_t get_currentAverage();

  /// @brief Method get_hasValue, addr 0x22d3458, size 0x10, virtual false, abstract: false, final false
