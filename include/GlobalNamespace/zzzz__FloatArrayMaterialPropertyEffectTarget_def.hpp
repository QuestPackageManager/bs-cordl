...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatArrayMaterialPropertyEffectTarget", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatArrayMaterialPropertyEffectTarget(FloatArrayMaterialPropertyEffectTarget&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatArrayMaterialPropertyEffectTarget", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatArrayMaterialPropertyEffectTarget(FloatArrayMaterialPropertyEffectTargetconst&) = delete;
