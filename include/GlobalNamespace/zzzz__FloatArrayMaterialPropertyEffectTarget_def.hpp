...
// Write type traits
MARK_REF_T(::GlobalNamespace::FloatArrayMaterialPropertyEffectTarget*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FloatArrayMaterialPropertyEffectTarget*, "", "FloatArrayMaterialPropertyEffectTarget");
// Dependencies FloatFxGroupEffectTarget, MaterialPropertyBlockController, UnityEngine.Vector2
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Awake, addr 0x598cbc0, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::FloatArrayMaterialPropertyEffectTarget* New_ctor();

  /// @brief Method SetFloat, addr 0x598cbe4, size 0xa4, virtual false, abstract: false, final false
  inline void SetFloat(float_t value);

  /// @brief Method SetValue, addr 0x598cbe0, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x598cc88, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x598cc8c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::FloatArrayMaterialPropertyEffectTarget, ____granularityMultiplier) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FloatArrayMaterialPropertyEffectTarget, ____propertyId) == 0x3c, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::FloatArrayMaterialPropertyEffectTarget) == 0x40, "Size mismatch!");
