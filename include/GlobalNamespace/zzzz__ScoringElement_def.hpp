...
/// @brief Method CompareTo, addr 0x58bf634, size 0xb4, virtual true, abstract: false, final true
inline int32_t CompareTo(::GlobalNamespace::ScoringElement*  other) ;

static inline ::GlobalNamespace::ScoringElement* New_ctor() ;

/// @brief Method Reinitialize, addr 0x58bf6e8, size 0x4, virtual true, abstract: false, final false
inline void Reinitialize() ;

/// @brief Method SetMultipliers, addr 0x58be594, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58bf6ec, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_isFinished, addr 0x58bf624, size 0x8, virtual false, abstract: false, final false
inline bool get_isFinished() ;

/// @brief Method get_maxMultiplier, addr 0x58bf614, size 0x8, virtual false, abstract: false, final false
inline int32_t get_maxMultiplier() ;

/// @brief Method get_maxPossibleCutScore, addr 0x58be59c, size 0x8c, virtual false, abstract: false, final false
inline int32_t get_maxPossibleCutScore() ;

/// @brief Method get_multiplier, addr 0x58bf604, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_noteData, addr 0x58bf5f4, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteData* get_noteData() ;

/// @brief Method get_time, addr 0x58be57c, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method set_isFinished, addr 0x58bf62c, size 0x8, virtual false, abstract: false, final false
inline void set_isFinished(bool  value) ;

/// @brief Method set_maxMultiplier, addr 0x58bf61c, size 0x8, virtual false, abstract: false, final false
inline void set_maxMultiplier(int32_t  value) ;

/// @brief Method set_multiplier, addr 0x58bf60c, size 0x8, virtual false, abstract: false, final false
inline void set_multiplier(int32_t  value) ;

/// @brief Method set_noteData, addr 0x58bf5fc, size 0x8, virtual false, abstract: false, final false
