...
public:
  ...
  /// @brief Method Clear, addr 0x58fdbb0, size 0x18, virtual true, abstract: false, final true
  inline void Clear();

  static inline ::GlobalNamespace::NoRichPresencePlatformHandler* New_ctor();

  /// @brief Method SetPresence, addr 0x58fdafc, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x58fdbc8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentPresenceApiName, addr 0x58fdaec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentPresenceApiName, addr 0x58fdaf4, size 0x8, virtual false, abstract: false, final false
