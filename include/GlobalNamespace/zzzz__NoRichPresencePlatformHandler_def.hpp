...
public:
  ...
  /// @brief Method Clear, addr 0x576b3cc, size 0x18, virtual true, abstract: false, final true
  inline void Clear();

  static inline ::GlobalNamespace::NoRichPresencePlatformHandler* New_ctor();

  /// @brief Method SetPresence, addr 0x576b318, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x576b3e4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentPresenceApiName, addr 0x576b308, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentPresenceApiName, addr 0x576b310, size 0x8, virtual false, abstract: false, final false
