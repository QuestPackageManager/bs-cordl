...
public:
  ...
  /// @brief Method Clear, addr 0x3b2cad8, size 0x50, virtual true, abstract: false, final true
  inline void Clear();

  static inline ::GlobalNamespace::NoRichPresencePlatformHandler* New_ctor();

  /// @brief Method SetPresence, addr 0x3b2ca30, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3b2cb28, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentPresenceApiName, addr 0x3b2ca20, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentPresenceApiName, addr 0x3b2ca28, size 0x8, virtual false, abstract: false, final false
