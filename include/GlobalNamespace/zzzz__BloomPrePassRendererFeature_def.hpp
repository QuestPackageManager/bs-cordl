...
/// @brief Method AddRenderPasses, addr 0x56b1064, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method Create, addr 0x56b1060, size 0x4, virtual true, abstract: false, final false
inline void Create() ;
...
/// @brief Method .ctor, addr 0x56b1068, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
