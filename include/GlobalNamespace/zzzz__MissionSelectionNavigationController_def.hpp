...
public:
  ...
  /// @brief Method <PresentMissionClearedIfNeeded>b__0, addr 0x582d4cc, size 0xf8, virtual false, abstract: false, final false
  inline void _PresentMissionClearedIfNeeded_b__0();

  /// @brief Method <PresentMissionClearedIfNeeded>b__1, addr 0x582d5c4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x582d4bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x582d040, size 0x188, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x582d1c8, size 0x114, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleMissionLevelDetailViewControllerDidPressPlayButton, addr 0x582d350, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMissionSelectionMapViewControllerDidSelectMissionLevel, addr 0x582d2dc, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method PresentMissionClearedIfNeeded, addr 0x582d370, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x582d4c0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressPlayButtonEvent, addr 0x582cea8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_selectedMissionNode, addr 0x582d028, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> get_selectedMissionNode();

  /// @brief Method remove_didPressPlayButtonEvent, addr 0x582cf68, size 0xc0, virtual false, abstract: false, final false
