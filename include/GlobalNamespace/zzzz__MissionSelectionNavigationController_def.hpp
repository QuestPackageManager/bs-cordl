...
public:
  ...
  /// @brief Method <PresentMissionClearedIfNeeded>b__0, addr 0x2669104, size 0xbc, virtual false, abstract: false, final false
  inline void _PresentMissionClearedIfNeeded_b__0();

  /// @brief Method <PresentMissionClearedIfNeeded>b__1, addr 0x26691c0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26690f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x2668cd0, size 0x174, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x2668e44, size 0x104, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleMissionLevelDetailViewControllerDidPressPlayButton, addr 0x2668fbc, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleMissionSelectionMapViewControllerDidSelectMissionLevel, addr 0x2668f48, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method PresentMissionClearedIfNeeded, addr 0x2668fdc, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26690fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressPlayButtonEvent, addr 0x2668b54, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_selectedMissionNode, addr 0x2668cb4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> get_selectedMissionNode();

  /// @brief Method remove_didPressPlayButtonEvent, addr 0x2668c04, size 0xb0, virtual false, abstract: false, final false
