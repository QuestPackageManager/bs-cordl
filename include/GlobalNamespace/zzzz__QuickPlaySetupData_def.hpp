...
/// @brief Method .ctor, addr 0x3634898, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field localizedNames, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_localizedNames, put=__cordl_internal_set_localizedNames)) ::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*,::Array<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*>*>  localizedNames;
...
constexpr ::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*,::Array<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*>*> const& __cordl_internal_get_localizedNames() const;

constexpr ::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*,::Array<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*>*>& __cordl_internal_get_localizedNames() ;
...
constexpr void __cordl_internal_set_localizedNames(::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*,::Array<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*>*>  value) ;
...
/// @brief Method .ctor, addr 0x363489c, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field localizedNames, offset: 0x20, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*,::Array<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPackName*>*>  ___localizedNames;
...
/// @brief Method .ctor, addr 0x3634910, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field localizedCustomPacks, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_localizedCustomPacks, put=__cordl_internal_set_localizedCustomPacks)) ::System::Collections::Generic::List_1<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_LocalizedCustomPack*>*  localizedCustomPacks;

/// @brief Field predefinedPackIds, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_predefinedPackIds, put=__cordl_internal_set_predefinedPackIds)) ::System::Collections::Generic::List_1<::GlobalNamespace::QuickPlaySongPacksOverride_QuickPlaySetupData_PredefinedPack*>*  predefinedPackIds;
...
/// @brief Method .ctor, addr 0x36347dc, size 0xbc, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field quickPlayAvailablePacksOverride, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_quickPlayAvailablePacksOverride, put=__cordl_internal_set_quickPlayAvailablePacksOverride)) ::GlobalNamespace::QuickPlaySetupData_QuickPlaySongPacksOverride*  quickPlayAvailablePacksOverride;
...
/// @brief Method .ctor, addr 0x36347d8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasOverride, addr 0x3634740, size 0x98, virtual false, abstract: false, final false
