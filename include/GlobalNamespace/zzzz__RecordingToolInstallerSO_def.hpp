...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x58fc140, size 0x218, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::RecordingToolInstallerSO* New_ctor();

  /// @brief Method .ctor, addr 0x58fc358, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
