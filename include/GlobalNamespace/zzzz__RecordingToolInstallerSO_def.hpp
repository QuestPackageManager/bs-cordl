...
public:
// Declarations
/// @brief Method InstallBindings, addr 0x576a1cc, size 0x218, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::RecordingToolInstallerSO* New_ctor() ;

/// @brief Method .ctor, addr 0x576a3e4, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
