...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IStartSeekSongController* (::GlobalNamespace::IStartSeekSongControllerProvider::*)()>(&::GlobalNamespace::IStartSeekSongControllerProvider::get_songController)> {
