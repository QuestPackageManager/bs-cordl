...
public:
  ...
  /// @brief Method Awake, addr 0x3bb1798, size 0x1c4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DisconnectButtonPressed, addr 0x3bb1bcc, size 0x34, virtual false, abstract: false, final false
  inline void DisconnectButtonPressed();

  /// @brief Method GiveUpButtonPressed, addr 0x3bb1ccc, size 0x4c, virtual false, abstract: false, final false
  inline void GiveUpButtonPressed();

  /// @brief Method HandleDisconnectPromptViewDidViewFinish, addr 0x3bb1c00, size 0xcc, virtual false, abstract: false, final false
  inline void HandleDisconnectPromptViewDidViewFinish(bool disconnect);

  /// @brief Method HideMenu, addr 0x3bb1520, size 0x44, virtual false, abstract: false, final false
  inline void HideMenu();

  static inline ::GlobalNamespace::MultiplayerLocalActivePlayerInGameMenuViewController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3bb1a0c, size 0xa0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method ResumeButtonPressed, addr 0x3bb1b94, size 0x38, virtual false, abstract: false, final false
  inline void ResumeButtonPressed();

  /// @brief Method ShowMenu, addr 0x3bb14d0, size 0x50, virtual false, abstract: false, final false
  inline void ShowMenu();

  /// @brief Method Start, addr 0x3bb195c, size 0xb0, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3bb1aac, size 0xe8, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method <HandleDisconnectPromptViewDidViewFinish>b__32_0, addr 0x3bb1d20, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bb1d18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressDisconnectButtonEvent, addr 0x3bb0cac, size 0x9c, virtual false, abstract: false, final false
  inline void add_didPressDisconnectButtonEvent(::System::Action* value);

  /// @brief Method add_didPressGiveUpButtonEvent, addr 0x3bb0de4, size 0x9c, virtual false, abstract: false, final false
  inline void add_didPressGiveUpButtonEvent(::System::Action* value);

  /// @brief Method add_didPressResumeButtonEvent, addr 0x3bb0d48, size 0x9c, virtual false, abstract: false, final false
  inline void add_didPressResumeButtonEvent(::System::Action* value);

  /// @brief Method remove_didPressDisconnectButtonEvent, addr 0x3bb11c8, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didPressDisconnectButtonEvent(::System::Action* value);

  /// @brief Method remove_didPressGiveUpButtonEvent, addr 0x3bb1300, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didPressGiveUpButtonEvent(::System::Action* value);

  /// @brief Method remove_didPressResumeButtonEvent, addr 0x3bb1264, size 0x9c, virtual false, abstract: false, final false
