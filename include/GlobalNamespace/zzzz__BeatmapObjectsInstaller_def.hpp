...
public:
  ...
  /// @brief Field _bombNotePrefab, offset 0x40, size 0x8
  ...
  /// @brief Field _noteLineConnectionControllerPrefab, offset 0x68, size 0x8
  ...
  /// @brief Field _obstaclePrefab, offset 0x48, size 0x8
  ...
  /// @brief Field _sliderLongPrefab, offset 0x60, size 0x8
  ...
  /// @brief Field _sliderMediumPrefab, offset 0x58, size 0x8
  ...
  /// @brief Field _sliderShortPrefab, offset 0x50, size 0x8
  ...
  /// @brief Method InstallBindings, addr 0x275aea8, size 0x478, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x275b320, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _bombNotePrefab, offset: 0x40, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::BombNoteController> ____bombNotePrefab;

  /// @brief Field _obstaclePrefab, offset: 0x48, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::ObstacleController> ____obstaclePrefab;

  /// @brief Field _sliderShortPrefab, offset: 0x50, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::SliderController> ____sliderShortPrefab;

  /// @brief Field _sliderMediumPrefab, offset: 0x58, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::SliderController> ____sliderMediumPrefab;

  /// @brief Field _sliderLongPrefab, offset: 0x60, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::SliderController> ____sliderLongPrefab;

  /// @brief Field _noteLineConnectionControllerPrefab, offset: 0x68, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::BeatmapObjectsInstaller, ____bombNotePrefab) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapObjectsInstaller, ____obstaclePrefab) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapObjectsInstaller, ____sliderShortPrefab) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapObjectsInstaller, ____sliderMediumPrefab) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapObjectsInstaller, ____sliderLongPrefab) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::BeatmapObjectsInstaller, ____noteLineConnectionControllerPrefab) == 0x68, "Offset mismatch!");
