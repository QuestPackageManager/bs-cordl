...
public:
  ...
  /// @brief Method <EndGameplay>b__50_0, addr 0x3bdf020, size 0x20, virtual false, abstract: false, final false
  inline bool _EndGameplay_b__50_0(::GlobalNamespace::MultiplayerLevelCompletionResults* result);

  /// @brief Method .ctor, addr 0x3bdf018, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <HandleSongStartSyncControllerSyncStartSuccess>b__0, addr 0x3bdf040, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bdd788, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3bdf064, size 0x998, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::MultiplayerController__PerformSongStartSync_d__39* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3be0868, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3be0870, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3be08a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3bdf060, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bdce84, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ChangeState, addr 0x3bdc3d8, size 0x20, virtual false, abstract: false, final false
  inline void ChangeState(::GlobalNamespace::MultiplayerController_State newState);

  /// @brief Method CreateAndBindPlayersSpecificSettingsAtGameStartModel, addr 0x3bdbfb4, size 0x424, virtual false, abstract: false, final false
  inline void CreateAndBindPlayersSpecificSettingsAtGameStartModel();

  /// @brief Method EndGameplay, addr 0x3bdd2c4, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCurrentSongTime, addr 0x3bdd044, size 0xc0, virtual false, abstract: false, final false
  inline float_t GetCurrentSongTime(int64_t songStartSyncTime);

  /// @brief Method GetSongStartSyncTime, addr 0x3bdd01c, size 0x28, virtual false, abstract: false, final false
  inline int64_t GetSongStartSyncTime(int64_t introAnimationStartSyncTime);

  /// @brief Method HandleAllResultsCollected, addr 0x3bdebd8, size 0x4, virtual false, abstract: false, final false
  inline void HandleAllResultsCollected(::GlobalNamespace::MultiplayerLevelCompletionResults* localPlayerResults,
                                        ::System::Collections::Generic::Dictionary_2<::StringW, ::GlobalNamespace::MultiplayerLevelCompletionResults*>* otherPlayerResults);

  /// @brief Method HandleDidSwitchPlayerToInactive, addr 0x3bdceac, size 0x170, virtual false, abstract: false, final false
  inline void HandleDidSwitchPlayerToInactive();

  /// @brief Method HandleDisconnected, addr 0x3bdca68, size 0x54, virtual false, abstract: false, final false
  inline void HandleDisconnected(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method HandleInitialGetGameStateFailed, addr 0x3bdd154, size 0xbc, virtual false, abstract: false, final false
  inline void HandleInitialGetGameStateFailed();

  /// @brief Method HandleIsDisconnectedDuringLoading, addr 0x3bdca60, size 0x8, virtual false, abstract: false, final false
  inline void HandleIsDisconnectedDuringLoading();

  /// @brief Method HandleOutroAnimationDidFinish, addr 0x3bded98, size 0x48, virtual false, abstract: false, final false
  inline void HandleOutroAnimationDidFinish();

  /// @brief Method HandleRpcReturnToMenu, addr 0x3bdede0, size 0x184, virtual false, abstract: false, final false
  inline void HandleRpcReturnToMenu(::StringW userId);

  /// @brief Method HandleSceneStartSyncControllerSyncStartDidFail, addr 0x3bdd22c, size 0x98, virtual false, abstract: false, final false
  inline void HandleSceneStartSyncControllerSyncStartDidFail();

  /// @brief Method HandleSceneStartSyncControllerSyncStartDidReceiveTooLate, addr 0x3bdd12c, size 0x28, virtual false, abstract: false, final false
  inline void HandleSceneStartSyncControllerSyncStartDidReceiveTooLate(::StringW sessionGameId);

  /// @brief Method HandleSceneStartSyncControllerSyncStartDidSuccess, addr 0x3bdd104, size 0x28, virtual false, abstract: false, final false
  inline void HandleSceneStartSyncControllerSyncStartDidSuccess(::StringW sessionGameId);

  /// @brief Method HandleSetMultiplayerGameState, addr 0x3bdcabc, size 0x1ec, virtual false, abstract: false, final false
  inline void HandleSetMultiplayerGameState(::StringW userId, ::GlobalNamespace::MultiplayerGameState gameState);

  /// @brief Method HandleSongStartSyncControllerSyncResume, addr 0x3bde5fc, size 0x4dc, virtual false, abstract: false, final false
  inline void HandleSongStartSyncControllerSyncResume(int64_t introAnimationStartSyncTime);

  /// @brief Method HandleSongStartSyncControllerSyncStartFailed, addr 0x3bdeb40, size 0x98, virtual false, abstract: false, final false
  inline void HandleSongStartSyncControllerSyncStartFailed();

  /// @brief Method HandleSongStartSyncControllerSyncStartSuccess, addr 0x3bdd52c, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bdc3f8, size 0x5cc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PerformSongStartSync, addr 0x3bdce14, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x3bdbb74, size 0x440, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartGameplay, addr 0x3bddd84, size 0x878, virtual false, abstract: false, final false
  inline void StartGameplay(int64_t introAnimationStartSyncTime);

  /// @brief Method StartSceneLoadSync, addr 0x3bdcca8, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bdef64, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_stateChangedEvent, addr 0x3bdba14, size 0xb0, virtual false, abstract: false, final false
  inline void add_stateChangedEvent(::System::Action_1<::GlobalNamespace::MultiplayerController_State>* value);

  /// @brief Method get_state, addr 0x3bdba0c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerController_State get_state();

  /// @brief Method remove_stateChangedEvent, addr 0x3bdbac4, size 0xb0, virtual false, abstract: false, final false
