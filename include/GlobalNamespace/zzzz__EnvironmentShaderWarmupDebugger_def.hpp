...
public:
  ...
  /// @brief Method <Initialize>b__4_0, addr 0x57728b0, size 0x14, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> _Initialize_b__4_0(::UnityEngine::Renderer* renderer);

  /// @brief Method .ctor, addr 0x57728ac, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FullMaterialLookup, addr 0x5772214, size 0x5a0, virtual false, abstract: false, final false
  inline void FullMaterialLookup();

  /// @brief Method GetGameObjectPath, addr 0x57720c0, size 0x154, virtual false, abstract: false, final false
  inline ::StringW GetGameObjectPath(::UnityEngine::GameObject* obj);

  /// @brief Method Initialize, addr 0x5771c84, size 0x1a8, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method JustRenderersAndInitialMaterials, addr 0x5771e30, size 0x290, virtual false, abstract: false, final false
  inline void JustRenderersAndInitialMaterials();

  /// @brief Method LateTick, addr 0x5771e2c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x57727b4, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
