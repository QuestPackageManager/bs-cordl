...
/// @brief Method <Initialize>b__4_0, addr 0x57049c4, size 0x14, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Material> _Initialize_b__4_0(::UnityEngine::Renderer*  renderer) ;

/// @brief Method .ctor, addr 0x57049c0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _allMaterialVariantHashes, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__allMaterialVariantHashes, put=__cordl_internal_set__allMaterialVariantHashes)) ::System::Collections::Generic::HashSet_1<::StringW>*  _allMaterialVariantHashes;

/// @brief Field _materialsThatWereNotRendered, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__materialsThatWereNotRendered, put=__cordl_internal_set__materialsThatWereNotRendered)) ::System::Collections::Generic::HashSet_1<::UnityW<::UnityEngine::Material>>*  _materialsThatWereNotRendered;

/// @brief Field _renderersThatWereNotRendered, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__renderersThatWereNotRendered, put=__cordl_internal_set__renderersThatWereNotRendered)) ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::Renderer>>*  _renderersThatWereNotRendered;
...
/// @brief Method FullMaterialLookup, addr 0x5704328, size 0x5a0, virtual false, abstract: false, final false
inline void FullMaterialLookup() ;

/// @brief Method GetGameObjectPath, addr 0x57041d4, size 0x154, virtual false, abstract: false, final false
inline ::StringW GetGameObjectPath(::UnityEngine::GameObject*  obj) ;

/// @brief Method Initialize, addr 0x5703d98, size 0x1a8, virtual true, abstract: false, final true
inline void Initialize() ;

/// @brief Method JustRenderersAndInitialMaterials, addr 0x5703f44, size 0x290, virtual false, abstract: false, final false
inline void JustRenderersAndInitialMaterials() ;

/// @brief Method LateTick, addr 0x5703f40, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x57048c8, size 0xa4, virtual false, abstract: false, final false
inline void _ctor() ;
