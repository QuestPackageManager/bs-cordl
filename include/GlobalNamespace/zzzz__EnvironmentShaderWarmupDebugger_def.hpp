...
public:
  ...
  /// @brief Method <Initialize>b__4_0, addr 0x3ac5acc, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Material> _Initialize_b__4_0(::UnityEngine::Renderer* renderer);

  /// @brief Method .ctor, addr 0x3ac5ac4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FullMaterialLookup, addr 0x3ac53fc, size 0x5c4, virtual false, abstract: false, final false
  inline void FullMaterialLookup();

  /// @brief Method GetGameObjectPath, addr 0x3ac52a0, size 0x15c, virtual false, abstract: false, final false
  inline ::StringW GetGameObjectPath(::UnityEngine::GameObject* obj);

  /// @brief Method Initialize, addr 0x3ac4eac, size 0x188, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method JustRenderersAndInitialMaterials, addr 0x3ac5038, size 0x268, virtual false, abstract: false, final false
  inline void JustRenderersAndInitialMaterials();

  /// @brief Method LateTick, addr 0x3ac5034, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3ac59c0, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
