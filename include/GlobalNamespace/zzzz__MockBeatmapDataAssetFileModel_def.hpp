...
public:
  ...
  /// @brief Method SetStateMachine, addr 0x234d60c, size 0x58, virtual true, abstract: false, final true
  ...
  // "::GlobalNamespace::IPreviewBeatmapLevel*", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::MockBeatmapDataAssetFileModel*", modifiers: "", def_value: None
  ...
  // None }]
  constexpr __MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4(
...
static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, __1__state) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, __t__builder) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, previewBeatmapLevel) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, __4__this) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, cancellationToken) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, _path_5__2) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, __u__1) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, _i_5__3) == 0x48, "Offset mismatch!");
...
public:
  ...
  /// @brief Method remove_levelDataAssetDownloadUpdateEvent, addr 0x234ce98, size 0xb0, virtual true, abstract: false, final true
  inline void remove_levelDataAssetDownloadUpdateEvent(::System::Action_1<::GlobalNamespace::LevelDataAssetDownloadUpdate>* value);

  /// @brief Method GetAssetBundleFileForPreviewLevelAsync, addr 0x234cf48, size 0x110, virtual true, abstract: false, final true
  ...
  /// @brief Method TryDeleteAssetBundleFileForPreviewLevelAsync, addr 0x234d058, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x234d0c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__MockBeatmapDataAssetFileModel___GetAssetBundleFileForPreviewLevelAsync_d__4, "",
                       "MockBeatmapDataAssetFileModel/<GetAssetBundleFileForPreviewLevelAsync>d__4");
