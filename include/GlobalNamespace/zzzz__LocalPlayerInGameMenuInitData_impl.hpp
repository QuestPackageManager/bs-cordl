...
constexpr ::GlobalNamespace::IPreviewBeatmapLevel*& GlobalNamespace::LocalPlayerInGameMenuInitData::__cordl_internal_get_previewBeatmapLevel() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___previewBeatmapLevel;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IPreviewBeatmapLevel*> const& GlobalNamespace::LocalPlayerInGameMenuInitData::__cordl_internal_get_previewBeatmapLevel() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___previewBeatmapLevel;
}
constexpr void GlobalNamespace::LocalPlayerInGameMenuInitData::__cordl_internal_set_previewBeatmapLevel(::GlobalNamespace::IPreviewBeatmapLevel* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::GlobalNamespace::LocalPlayerInGameMenuInitData* GlobalNamespace::LocalPlayerInGameMenuInitData::New_ctor(::GlobalNamespace::IPreviewBeatmapLevel* previewBeatmapLevel,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::LocalPlayerInGameMenuInitData*>(previewBeatmapLevel, beatmapDifficulty, beatmapCharacteristic, hasSong));
}
