...
public:
  ...
  /// @brief Method .ctor, addr 0x26b2ec4, size 0x38, virtual false, abstract: false, final false
  inline void _ctor(float_t time, ::GlobalNamespace::BombExecutionRating_Rating rating);

  /// @brief Method get_rating, addr 0x26b2ebc, size 0x8, virtual false, abstract: false, final false
