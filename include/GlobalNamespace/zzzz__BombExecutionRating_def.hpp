...
public:
  ...
  /// @brief Method .ctor, addr 0x3647224, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(float_t time, ::GlobalNamespace::BombExecutionRating_Rating rating);

  /// @brief Method get_rating, addr 0x364721c, size 0x8, virtual false, abstract: false, final false
