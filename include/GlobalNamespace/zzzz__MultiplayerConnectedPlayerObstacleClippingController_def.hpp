...
public:
  ...
  /// @brief Method SetClippingParams, addr 0x2720108, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2720254, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
