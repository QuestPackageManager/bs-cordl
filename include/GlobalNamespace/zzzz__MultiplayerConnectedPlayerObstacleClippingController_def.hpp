...
/// @brief Method SetClippingParams, addr 0x5813170, size 0x150, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58132c0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
