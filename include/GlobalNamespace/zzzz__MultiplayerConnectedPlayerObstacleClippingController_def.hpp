...
public:
  ...
  /// @brief Method SetClippingParams, addr 0x25ed694, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ed7e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
