...
public:
  ...
  /// @brief Method add_scoreDidChangeEvent addr 0x2122154 size 0xb0 virtual true final true
  inline void add_scoreDidChangeEvent(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method remove_scoreDidChangeEvent addr 0x2122204 size 0xb0 virtual true final true
  inline void remove_scoreDidChangeEvent(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method add_multiplierDidChangeEvent addr 0x21222b4 size 0xb0 virtual true final true
  inline void add_multiplierDidChangeEvent(::System::Action_2<int32_t, float_t>* value);

  /// @brief Method remove_multiplierDidChangeEvent addr 0x2122364 size 0xb0 virtual true final true
  inline void remove_multiplierDidChangeEvent(::System::Action_2<int32_t, float_t>* value);

  /// @brief Method add_scoringForNoteStartedEvent addr 0x2122414 size 0xb0 virtual true final true
  inline void add_scoringForNoteStartedEvent(::System::Action_1<::GlobalNamespace::ScoringElement*>* value);

  /// @brief Method remove_scoringForNoteStartedEvent addr 0x21224c4 size 0xb0 virtual true final true
  inline void remove_scoringForNoteStartedEvent(::System::Action_1<::GlobalNamespace::ScoringElement*>* value);

  /// @brief Method add_scoringForNoteFinishedEvent addr 0x2122574 size 0xb0 virtual true final true
  inline void add_scoringForNoteFinishedEvent(::System::Action_1<::GlobalNamespace::ScoringElement*>* value);

  /// @brief Method remove_scoringForNoteFinishedEvent addr 0x2122624 size 0xb0 virtual true final true
  inline void remove_scoringForNoteFinishedEvent(::System::Action_1<::GlobalNamespace::ScoringElement*>* value);

  /// @brief Method get_multipliedScore addr 0x21226d4 size 0x8 virtual true final true
  inline int32_t get_multipliedScore();

  /// @brief Method get_modifiedScore addr 0x21226dc size 0x8 virtual true final true
  inline int32_t get_modifiedScore();

  /// @brief Method get_immediateMaxPossibleMultipliedScore addr 0x21226e4 size 0x8 virtual true final true
  inline int32_t get_immediateMaxPossibleMultipliedScore();

  /// @brief Method get_immediateMaxPossibleModifiedScore addr 0x21226ec size 0x8 virtual true final true
  inline int32_t get_immediateMaxPossibleModifiedScore();

  /// @brief Method SetEnabled addr 0x21226f4 size 0xc virtual true final true
  inline void SetEnabled(bool enabled);

  /// @brief Method Start addr 0x2122700 size 0x24c virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x212294c size 0x1e8 virtual false final false
  inline void OnDestroy();

  /// @brief Method LateUpdate addr 0x2122b34 size 0x7ac virtual false final false
  inline void LateUpdate();

  /// @brief Method HandleNoteWasSpawned addr 0x21235b0 size 0xd4 virtual false final false
  inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteWasCut addr 0x2123684 size 0x1ac virtual false final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method HandleNoteWasMissed addr 0x21238ec size 0x134 virtual false final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandlePlayerHeadDidEnterObstacles addr 0x2123a6c size 0x88 virtual false final false
  inline void HandlePlayerHeadDidEnterObstacles();

  /// @brief Method DespawnScoringElement addr 0x2123428 size 0x188 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2123af4 size 0x174 virtual false final false
  inline void _ctor();
