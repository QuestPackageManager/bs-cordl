...
public:
  ...
  /// @brief Method DespawnScoringElement, addr 0x3beefe8, size 0x180, virtual false, abstract: false, final false
  inline void DespawnScoringElement(::GlobalNamespace::ScoringElement* scoringElement);

  /// @brief Method HandleNoteWasCut, addr 0x3bef204, size 0x178, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method HandleNoteWasMissed, addr 0x3bef438, size 0x10c, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleNoteWasSpawned, addr 0x3bef168, size 0x9c, virtual false, abstract: false, final false
  inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandlePlayerHeadDidEnterObstacles, addr 0x3bef590, size 0x6c, virtual false, abstract: false, final false
  inline void HandlePlayerHeadDidEnterObstacles();

  /// @brief Method LateUpdate, addr 0x3bee7b4, size 0x79c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::ScoreController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3bee5dc, size 0x1d8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetEnabled, addr 0x3bee394, size 0xc, virtual true, abstract: false, final true
  inline void SetEnabled(bool enabled);

  /// @brief Method Start, addr 0x3bee3a0, size 0x23c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bef5fc, size 0x148, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_multiplierDidChangeEvent, addr 0x3bedf4c, size 0xb0, virtual true, abstract: false, final true
  inline void add_multiplierDidChangeEvent(::System::Action_2<int32_t, float_t>* value);

  /// @brief Method add_scoreDidChangeEvent, addr 0x3beddec, size 0xb0, virtual true, abstract: false, final true
  inline void add_scoreDidChangeEvent(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method add_scoringForNoteFinishedEvent, addr 0x3bee20c, size 0xb0, virtual true, abstract: false, final true
  inline void add_scoringForNoteFinishedEvent(::System::Action_1<::GlobalNamespace::ScoringElement*>* value);

  /// @brief Method add_scoringForNoteStartedEvent, addr 0x3bee0ac, size 0xb0, virtual true, abstract: false, final true
  inline void add_scoringForNoteStartedEvent(::System::Action_1<::GlobalNamespace::ScoringElement*>* value);

  /// @brief Method get_immediateMaxPossibleModifiedScore, addr 0x3bee38c, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_immediateMaxPossibleModifiedScore();

  /// @brief Method get_immediateMaxPossibleMultipliedScore, addr 0x3bee37c, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_immediateMaxPossibleMultipliedScore();

  /// @brief Method get_invalidated, addr 0x3bee36c, size 0x8, virtual true, abstract: false, final true
  inline bool get_invalidated();

  /// @brief Method get_modifiedScore, addr 0x3bee384, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_modifiedScore();

  /// @brief Method get_multipliedScore, addr 0x3bee374, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_multiplierDidChangeEvent, addr 0x3bedffc, size 0xb0, virtual true, abstract: false, final true
  inline void remove_multiplierDidChangeEvent(::System::Action_2<int32_t, float_t>* value);

  /// @brief Method remove_scoreDidChangeEvent, addr 0x3bede9c, size 0xb0, virtual true, abstract: false, final true
  inline void remove_scoreDidChangeEvent(::System::Action_2<int32_t, int32_t>* value);

  /// @brief Method remove_scoringForNoteFinishedEvent, addr 0x3bee2bc, size 0xb0, virtual true, abstract: false, final true
  inline void remove_scoringForNoteFinishedEvent(::System::Action_1<::GlobalNamespace::ScoringElement*>* value);

  /// @brief Method remove_scoringForNoteStartedEvent, addr 0x3bee15c, size 0xb0, virtual true, abstract: false, final true
