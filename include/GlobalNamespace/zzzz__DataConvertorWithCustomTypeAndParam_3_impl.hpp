...
inline T GlobalNamespace::DataConvertorWithCustomTypeAndParam_3<T, TType, TParam>::ProcessItem(::System::Object* item, TParam param, TType type) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DataConvertorWithCustomTypeAndParam_3<T, TType, TParam>*>::get(), "ProcessItem", std::vector<Il2CppClass*>{},
...
inline void GlobalNamespace::DataConvertorWithCustomTypeAndParam_3<T, TType, TParam>::AddConvertor(TType type, ::GlobalNamespace::DataItemConvertor_2<T, TParam>* dataItemConvertor) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DataConvertorWithCustomTypeAndParam_3<T, TType, TParam>*>::get(), "AddConvertor", std::vector<Il2CppClass*>{},
