...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x321f45c, size 0xc0, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x321f51c, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x321f40c, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321f3a0, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x321f5b8, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::StringW secret, ::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x321f5d8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x321f5a4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321f528, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method Deserialize, addr 0x321f604, size 0x28, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x321f300, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method Release, addr 0x321f348, size 0x58, virtual true, abstract: false, final true
  inline void Release();

  /// @brief Method Serialize, addr 0x321f5e4, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x321f62c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_pool, addr 0x321f070, size 0x44, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ConnectToMasterServer, addr 0x321f268, size 0x98, virtual false, abstract: false, final false
  inline void ConnectToMasterServer(::StringW secret);

  /// @brief Method Dispose, addr 0x321f0b4, size 0x5c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleConnectToMasterServer, addr 0x321f308, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321eec0, size 0x1b0, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatSaberConnectedPlayerManager* connectedPlayerManager);

  /// @brief Method add_connectToMasterServerEvent, addr 0x321f110, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_connectToMasterServerEvent, addr 0x321f1bc, size 0xac, virtual false, abstract: false, final false
