...
public:
  ...
  /// @brief Method Awake addr 0x238297c size 0x144 virtual false final false
  inline void Awake();

  /// @brief Method OnDestroy addr 0x2382ac0 size 0x190 virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleNoteControllerDidInit addr 0x2382c50 size 0x1c virtual true final true
  inline void HandleNoteControllerDidInit(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method HandleNoteControllerNoteDidStartDissolving addr 0x2382c6c size 0x10 virtual true final true
  ...
  /// @brief Method AnimateCutout addr 0x2382c7c size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x2382ca8 size 0x8 virtual false final false
  inline void _ctor();
