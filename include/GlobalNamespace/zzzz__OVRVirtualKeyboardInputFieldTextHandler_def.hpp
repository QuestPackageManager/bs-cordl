...
/// @brief Method AppendText, addr 0x5d3f63c, size 0xac, virtual true, abstract: false, final false
inline void AppendText(::StringW  s) ;

/// @brief Method ApplyBackspace, addr 0x5d3f6e8, size 0xe8, virtual true, abstract: false, final false
inline void ApplyBackspace() ;

/// @brief Method MoveTextEnd, addr 0x5d3f7d0, size 0x88, virtual true, abstract: false, final false
inline void MoveTextEnd() ;

static inline ::GlobalNamespace::OVRVirtualKeyboardInputFieldTextHandler* New_ctor() ;

/// @brief Method ProxyOnValueChanged, addr 0x5d3f950, size 0x44, virtual false, abstract: false, final false
inline void ProxyOnValueChanged(::StringW  arg0) ;

/// @brief Method Start, addr 0x5d3f858, size 0xf8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Submit, addr 0x5d3f594, size 0xa8, virtual true, abstract: false, final false
inline void Submit() ;
...
/// @brief Method .ctor, addr 0x5d3f994, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_InputField, addr 0x5d3f3e0, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::UI::InputField> get_InputField() ;

/// @brief Method get_IsFocused, addr 0x5d3f50c, size 0x88, virtual true, abstract: false, final false
inline bool get_IsFocused() ;

/// @brief Method get_OnTextChanged, addr 0x5d3f3e8, size 0x8, virtual true, abstract: false, final false
inline ::System::Action_1<::StringW>* get_OnTextChanged() ;

/// @brief Method get_SubmitOnEnter, addr 0x5d3f484, size 0x88, virtual true, abstract: false, final false
inline bool get_SubmitOnEnter() ;

/// @brief Method get_Text, addr 0x5d3f3f8, size 0x8c, virtual true, abstract: false, final false
inline ::StringW get_Text() ;

/// @brief Method set_InputField, addr 0x5d38434, size 0x1f4, virtual false, abstract: false, final false
inline void set_InputField(::UnityEngine::UI::InputField*  value) ;

/// @brief Method set_OnTextChanged, addr 0x5d3f3f0, size 0x8, virtual true, abstract: false, final false
