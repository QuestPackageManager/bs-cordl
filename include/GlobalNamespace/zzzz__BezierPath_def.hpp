...
public:
  ...
  /// @brief Method AddSegmentToEnd, addr 0x2697f44, size 0x510, virtual false, abstract: false, final false
  inline void AddSegmentToEnd(::UnityEngine::Vector3 anchorPos);

  /// @brief Method AutoSetAllAffectedControlPoints, addr 0x26987e8, size 0x8c, virtual false, abstract: false, final false
  inline void AutoSetAllAffectedControlPoints(int32_t updatedAnchorIndex);

  /// @brief Method AutoSetAllControlPoints, addr 0x2697118, size 0x80, virtual false, abstract: false, final false
  inline void AutoSetAllControlPoints();

  /// @brief Method AutoSetAnchorControlPoints, addr 0x2698bfc, size 0x4f0, virtual false, abstract: false, final false
  inline void AutoSetAnchorControlPoints(int32_t anchorIndex);

  /// @brief Method AutoSetStartAndEndControls, addr 0x26990ec, size 0x250, virtual false, abstract: false, final false
  inline void AutoSetStartAndEndControls();

  /// @brief Method GetAnchorNormalAngle, addr 0x2698a04, size 0x64, virtual false, abstract: false, final false
  inline float_t GetAnchorNormalAngle(int32_t anchorIndex);

  /// @brief Method GetPoint, addr 0x2698790, size 0x58, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetPoint(int32_t i);

  /// @brief Method GetPointsInSegment, addr 0x269890c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPointsInSegment, addr 0x2698874, size 0x98, virtual false, abstract: false, final false
  inline void GetPointsInSegment(int32_t segmentIndex, ByRef<::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*>> points);

  /// @brief Method LoopIndex, addr 0x2698ba4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method NotifyPathModified, addr 0x2697198, size 0x1c, virtual false, abstract: false, final false
  inline void NotifyPathModified();

  /// @brief Method SetAnchorNormalAngle, addr 0x2698a68, size 0x13c, virtual false, abstract: false, final false
  inline void SetAnchorNormalAngle(int32_t anchorIndex, float_t angle);

  /// @brief Method SetPoint, addr 0x26986cc, size 0xc0, virtual false, abstract: false, final false
  inline void SetPoint(int32_t i, ::UnityEngine::Vector3 localPosition, bool suppressPathModified);

  /// @brief Method UpdateByAnchorPoints, addr 0x269793c, size 0x608, virtual false, abstract: false, final false
  inline void UpdateByAnchorPoints(::System::Collections::Generic::IReadOnlyList_1<::UnityEngine::Vector3>* points);

  /// @brief Method UpdateControlPoints, addr 0x2698454, size 0x278, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26973f8, size 0x544, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector3 centre, bool initTwoSegments);

  /// @brief Method add_bezierPathWasModifiedEvent, addr 0x26971b4, size 0x9c, virtual false, abstract: false, final false
  inline void add_bezierPathWasModifiedEvent(::System::Action* value);

  /// @brief Method get_Item, addr 0x269878c, size 0x4, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_Item(int32_t i);

  /// @brief Method get_anchorPointsCount, addr 0x2697334, size 0x64, virtual false, abstract: false, final false
  inline int32_t get_anchorPointsCount();

  /// @brief Method get_controlPointMode, addr 0x26970c4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__BezierPath__ControlMode get_controlPointMode();

  /// @brief Method get_pointsCount, addr 0x26972ec, size 0x48, virtual false, abstract: false, final false
  inline int32_t get_pointsCount();

  /// @brief Method get_segmentsCount, addr 0x2697398, size 0x60, virtual false, abstract: false, final false
  inline int32_t get_segmentsCount();

  /// @brief Method remove_bezierPathWasModifiedEvent, addr 0x2697250, size 0x9c, virtual false, abstract: false, final false
  inline void remove_bezierPathWasModifiedEvent(::System::Action* value);

  /// @brief Method set_controlPointMode, addr 0x26970cc, size 0x4c, virtual false, abstract: false, final false
