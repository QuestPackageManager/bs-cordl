...
public:
  ...
  /// @brief Method OnDestroy, addr 0x23aa624, size 0x148, virtual false, abstract: false, final false
  inline void OnDestroy();

  static inline ::GlobalNamespace::LightRotationGroupEffectManager* New_ctor();

  /// @brief Method .ctor, addr 0x23aa76c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
