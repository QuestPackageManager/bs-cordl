...
public:
  ...
  /// @brief Method SetRandomSeed, addr 0x39eb3d8, size 0x68, virtual false, abstract: false, final false
  inline void SetRandomSeed(int32_t seed);

  /// @brief Method SetRandomValueToShaders, addr 0x39eb584, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39eb62c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
