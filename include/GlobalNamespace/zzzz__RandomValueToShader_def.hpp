...
public:
  ...
  /// @brief Method SetRandomValueToShaders, addr 0x23ee308, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ee39c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
