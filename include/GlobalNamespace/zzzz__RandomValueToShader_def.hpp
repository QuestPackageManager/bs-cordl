...
/// @brief Method SetRandom, addr 0x56b4f00, size 0x8, virtual false, abstract: false, final false
inline void SetRandom(::GlobalNamespace::IRandom*  random) ;

/// @brief Method SetRandomValueToShaders, addr 0x56b4dd8, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b4f08, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
