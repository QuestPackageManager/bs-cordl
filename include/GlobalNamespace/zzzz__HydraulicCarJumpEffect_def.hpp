...
public:
  ...
  /// @brief Method Awake, addr 0x31f1ff4, size 0xac, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBeatmapEvent, addr 0x31f2274, size 0x174, virtual false, abstract: false, final false
  inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  static inline ::GlobalNamespace::HydraulicCarJumpEffect* New_ctor();

  /// @brief Method OnDestroy, addr 0x31f2248, size 0x2c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x31f21f0, size 0x2c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x31f21ec, size 0x4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnInject, addr 0x31f20a0, size 0x4, virtual false, abstract: false, final false
  inline void OnInject();

  /// @brief Method TrySubscribe, addr 0x31f20a4, size 0x148, virtual false, abstract: false, final false
  inline void TrySubscribe();

  /// @brief Method TryUnsubscribe, addr 0x31f221c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31f23e8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
