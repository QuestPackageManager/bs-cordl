...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element::*)()>(&::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x56ae344;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*> (::GlobalNamespace::BloomPrePassBackgroundColorsGradient::*)()>(&::GlobalNamespace::BloomPrePassBackgroundColorsGradient::get_elements)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x56ae150;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BloomPrePassBackgroundColorsGradient::*)(::Unity::Collections::NativeArray_1<::UnityEngine::Color32>, int32_t)>(&::GlobalNamespace::BloomPrePassBackgroundColorsGradient::UpdatePixels)> {
  ...
  constexpr static std::size_t addrs = 0x56ae158;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::BloomPrePassBackgroundColorsGradient::*)(float_t)>(&::GlobalNamespace::BloomPrePassBackgroundColorsGradient::EvaluateColor)> {
  ...
  constexpr static std::size_t addrs = 0x56ae1c0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BloomPrePassBackgroundColorsGradient::*)()>(&::GlobalNamespace::BloomPrePassBackgroundColorsGradient::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x56ae28c;
...
constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*>& GlobalNamespace::BloomPrePassBackgroundColorsGradient::__cordl_internal_get__elements()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____elements;
}
constexpr ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*> const& GlobalNamespace::BloomPrePassBackgroundColorsGradient::__cordl_internal_get__elements() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____elements;
}
constexpr void GlobalNamespace::BloomPrePassBackgroundColorsGradient::__cordl_internal_set__elements(::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*> GlobalNamespace::BloomPrePassBackgroundColorsGradient::get_elements()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BloomPrePassBackgroundColorsGradient*>::get(),
                        "get_elements",
                        std::span<const Il2CppClass* const, 0>(),
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*,::Array<::GlobalNamespace::BloomPrePassBackgroundColorsGradient_Element*>*>, false>(this, ___internal_method);
}
