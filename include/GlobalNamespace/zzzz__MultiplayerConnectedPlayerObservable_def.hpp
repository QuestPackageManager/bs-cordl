...
public:
  ...
  /// @brief Method .ctor, addr 0x5898b78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IBeatSaberConnectedPlayer* connectedPlayer);

  /// @brief Method get_isFailed, addr 0x5898c28, size 0xc, virtual true, abstract: false, final true
  inline bool get_isFailed();

  /// @brief Method get_offsetSyncTime, addr 0x5898b80, size 0xa8, virtual true, abstract: false, final true
