...
/// @brief Method <Update>b__10_0, addr 0x5835c70, size 0x18, virtual false, abstract: false, final false
inline bool _Update_b__10_0(::GlobalNamespace::MultiplayerScoreProvider_RankedPlayer*  p) ;

/// @brief Method .ctor, addr 0x5835c6c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method HandleStateChanged, addr 0x5835a90, size 0x184, virtual false, abstract: false, final false
inline void HandleStateChanged(::GlobalNamespace::MultiplayerController_State  newState) ;

/// @brief Method HideAll, addr 0x583522c, size 0x39c, virtual false, abstract: false, final false
inline void HideAll() ;

/// @brief Method InitLeftRightPositions, addr 0x58355c8, size 0x4c8, virtual false, abstract: false, final false
inline void InitLeftRightPositions() ;

static inline ::GlobalNamespace::MultiplayerOtherPlayersScoreDiffTextManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5834ce4, size 0x110, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5834bf0, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x5834df4, size 0x438, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5835c14, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
