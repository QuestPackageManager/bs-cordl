...
public:
  ...
  /// @brief Method GetAllEnvironmentsSongsFromPack, addr 0x32de3d0, size 0x470, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetLevelsToPlay, addr 0x32dda30, size 0x9a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32de840, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_commandName, addr 0x32dd9a8, size 0x44, virtual true, abstract: false, final false
  inline ::StringW get_commandName();

  /// @brief Method get_description, addr 0x32dd9ec, size 0x44, virtual true, abstract: false, final false
