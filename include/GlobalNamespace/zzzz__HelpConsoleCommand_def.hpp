...
public:
  ...
  /// @brief Method GetArguments, addr 0x230f300, size 0x94, virtual true, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::ArgumentBase*, ::Array<::GlobalNamespace::ArgumentBase*>*> GetArguments();

  /// @brief Method GetShortHelpText, addr 0x230f394, size 0x44, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetShortHelpText();

  /// @brief Method GetLongUsageHelp, addr 0x230f3d8, size 0x44, virtual true, abstract: false, final false
  inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetLongUsageHelp();

  /// @brief Method GetCommandName, addr 0x230f41c, size 0x40, virtual true, abstract: false, final false
  inline ::StringW GetCommandName();

  /// @brief Method Execute, addr 0x230f45c, size 0x7c, virtual true, abstract: false, final false
  inline void Execute(::System::Collections::Generic::List_1<::GlobalNamespace::__DebugConsoleController__ConsoleMessage>* messages);

  /// @brief Method ExecuteAsync, addr 0x230f9b0, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method GetCommandUsage, addr 0x230f7cc, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetListOfCommands, addr 0x230f4d8, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x230fab0, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::HelpConsoleCommand, ____console) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::HelpConsoleCommand, ____commandName) == 0x20, "Offset mismatch!");
