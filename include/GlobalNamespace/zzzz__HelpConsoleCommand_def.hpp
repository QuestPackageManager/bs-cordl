...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HelpConsoleCommand", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HelpConsoleCommand(HelpConsoleCommand&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HelpConsoleCommand", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HelpConsoleCommand(HelpConsoleCommandconst&) = delete;
