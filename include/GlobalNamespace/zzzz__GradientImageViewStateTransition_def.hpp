...
/// @brief Method SetColors, addr 0x628f198, size 0x70, virtual false, abstract: false, final false
inline void SetColors(::UnityEngine::Color  startColor, ::UnityEngine::Color  endColor) ;

/// @brief Method SetDisabledState, addr 0x628f308, size 0x80, virtual true, abstract: false, final false
inline void SetDisabledState() ;

/// @brief Method SetHighlightedState, addr 0x628f208, size 0x80, virtual true, abstract: false, final false
inline void SetHighlightedState() ;

/// @brief Method SetNormalState, addr 0x628f118, size 0x80, virtual true, abstract: false, final false
inline void SetNormalState() ;

/// @brief Method SetPressedState, addr 0x628f288, size 0x80, virtual true, abstract: false, final false
inline void SetPressedState() ;

/// @brief Method SetSelectedAndHighlightedState, addr 0x628f408, size 0x80, virtual true, abstract: false, final false
inline void SetSelectedAndHighlightedState() ;

/// @brief Method SetSelectedState, addr 0x628f388, size 0x80, virtual true, abstract: false, final false
inline void SetSelectedState() ;

/// @brief Method StartTween, addr 0x628f488, size 0x154, virtual false, abstract: false, final false
...
/// @brief Method StartTweens, addr 0x628ea08, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method StopCurrentTransitionAnimation, addr 0x628f048, size 0xd0, virtual true, abstract: false, final false
inline void StopCurrentTransitionAnimation() ;

/// @brief Method TransitionToDisabledState, addr 0x628ee50, size 0x90, virtual true, abstract: false, final false
inline void TransitionToDisabledState(::GlobalNamespace::TransitionTimingSO*  transitionTiming) ;

/// @brief Method TransitionToHighlightedState, addr 0x628ed00, size 0x90, virtual true, abstract: false, final false
inline void TransitionToHighlightedState(::GlobalNamespace::TransitionTimingSO*  transitionTiming) ;

/// @brief Method TransitionToNormalState, addr 0x628e960, size 0x90, virtual true, abstract: false, final false
inline void TransitionToNormalState(::GlobalNamespace::TransitionTimingSO*  transitionTiming) ;

/// @brief Method TransitionToPressedState, addr 0x628eda8, size 0x90, virtual true, abstract: false, final false
inline void TransitionToPressedState(::GlobalNamespace::TransitionTimingSO*  transitionTiming) ;

/// @brief Method TransitionToSelectedAndHighlightedState, addr 0x628efa0, size 0x90, virtual true, abstract: false, final false
inline void TransitionToSelectedAndHighlightedState(::GlobalNamespace::TransitionTimingSO*  transitionTiming) ;

/// @brief Method TransitionToSelectedState, addr 0x628eef8, size 0x90, virtual true, abstract: false, final false
inline void TransitionToSelectedState(::GlobalNamespace::TransitionTimingSO*  transitionTiming) ;

/// @brief Method <StartTweens>b__18_2, addr 0x628f740, size 0x20, virtual false, abstract: false, final false
inline void _StartTweens_b__18_2(::UnityEngine::Color  color) ;

/// @brief Method <StartTweens>b__18_3, addr 0x628f760, size 0x20, virtual false, abstract: false, final false
inline void _StartTweens_b__18_3(::UnityEngine::Color  color) ;

/// @brief Method <StartTweens>g__Color1CompleteAction|18_0, addr 0x628f620, size 0x90, virtual false, abstract: false, final false
inline void _StartTweens_g__Color1CompleteAction_18_0() ;

/// @brief Method <StartTweens>g__Color2CompleteAction|18_1, addr 0x628f6b0, size 0x90, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x628f5dc, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_transition, addr 0x628e958, size 0x8, virtual true, abstract: false, final false
