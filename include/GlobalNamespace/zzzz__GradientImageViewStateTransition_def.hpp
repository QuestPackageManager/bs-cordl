...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13627)), TypeDefinitionIndex(TypeDefinitionIndex(5442)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5442), inst: 925
...
public:
  ...
  /// @brief Method TransitionToHighlightedState, addr 0x227e2d0, size 0x80, virtual true, abstract: false, final false
  inline void TransitionToHighlightedState();

  /// @brief Method TransitionToPressedState, addr 0x227e368, size 0x80, virtual true, abstract: false, final false
  inline void TransitionToPressedState();

  /// @brief Method TransitionToDisabledState, addr 0x227e400, size 0x80, virtual true, abstract: false, final false
  inline void TransitionToDisabledState();

  /// @brief Method TransitionToSelectedState, addr 0x227e498, size 0x80, virtual true, abstract: false, final false
  inline void TransitionToSelectedState();

  /// @brief Method TransitionToSelectedAndHighlightedState, addr 0x227e530, size 0x80, virtual true, abstract: false, final false
  inline void TransitionToSelectedAndHighlightedState();

  /// @brief Method SetNormalState, addr 0x227e5c8, size 0x80, virtual true, abstract: false, final false
  inline void SetNormalState();

  /// @brief Method SetHighlightedState, addr 0x227e6a8, size 0x80, virtual true, abstract: false, final false
  inline void SetHighlightedState();

  /// @brief Method SetPressedState, addr 0x227e728, size 0x80, virtual true, abstract: false, final false
  inline void SetPressedState();

  /// @brief Method SetDisabledState, addr 0x227e7a8, size 0x80, virtual true, abstract: false, final false
  inline void SetDisabledState();

  /// @brief Method SetSelectedState, addr 0x227e828, size 0x80, virtual true, abstract: false, final false
  inline void SetSelectedState();

  /// @brief Method SetSelectedAndHighlightedState, addr 0x227e8a8, size 0x80, virtual true, abstract: false, final false
  inline void SetSelectedAndHighlightedState();

  /// @brief Method StartTweens, addr 0x227e0c4, size 0x20c, virtual false, abstract: false, final false
  inline void StartTweens(::UnityEngine::Color endColor1, ::UnityEngine::Color endColor2);

  /// @brief Method StartTween, addr 0x227e928, size 0x194, virtual false, abstract: false, final false
  ...
  /// @brief Method SetColors, addr 0x227e648, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x227eabc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <StartTweens>g__Color1CompleteAction|17_0, addr 0x227eb04, size 0x88, virtual false, abstract: false, final false
  inline void _StartTweens_g__Color1CompleteAction_17_0();

  /// @brief Method <StartTweens>g__Color2CompleteAction|17_1, addr 0x227eb8c, size 0x88, virtual false, abstract: false, final false
  inline void _StartTweens_g__Color2CompleteAction_17_1();

  /// @brief Method <StartTweens>b__17_2, addr 0x227ec14, size 0x1c, virtual false, abstract: false, final false
  inline void _StartTweens_b__17_2(::UnityEngine::Color color);

  /// @brief Method <StartTweens>b__17_3, addr 0x227ec30, size 0x1c, virtual false, abstract: false, final false
