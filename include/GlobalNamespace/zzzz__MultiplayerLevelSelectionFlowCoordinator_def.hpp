...
public:
  ...
  /// @brief Method ActionButtonWasPressed, addr 0x580f8e0, size 0x118, virtual true, abstract: false, final false
  inline void ActionButtonWasPressed();

  /// @brief Method BackButtonWasPressed, addr 0x580f9f8, size 0x38, virtual true, abstract: false, final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method DismissViewControllersAndFinish, addr 0x580ffe8, size 0x74, virtual false, abstract: false, final false
  inline void DismissViewControllersAndFinish();

  /// @brief Method HandleLobbyGameStateControllerGameStarted, addr 0x5810080, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerGameStarted(::GlobalNamespace::ILevelGameplaySetupData* levelGameplaySetupData);

  /// @brief Method HandleLobbyGameStateControllerLobbyDisconnected, addr 0x5810084, size 0x4, virtual false, abstract: false, final false
  inline void HandleLobbyGameStateControllerLobbyDisconnected();

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange, addr 0x580fa30, size 0x108, virtual true, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x581005c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method TransitionDidFinish, addr 0x580fd18, size 0x2d0, virtual true, abstract: false, final false
  inline void TransitionDidFinish();

  /// @brief Method TransitionDidStart, addr 0x580fb38, size 0x1e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5810088, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishedEvent, addr 0x580f738, size 0xac, virtual false, abstract: false, final false
  inline void add_didFinishedEvent(::System::Action* value);

  /// @brief Method add_didSelectLevelEvent, addr 0x580f5b8, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectLevelEvent(::System::Action_1<::GlobalNamespace::LevelSelectionFlowCoordinator_State*>* value);

  /// @brief Method get_actionButtonText, addr 0x580f8a0, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_actionButtonText();

  /// @brief Method get_allowedBeatmapDifficultyMask, addr 0x580f8c8, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask();

  /// @brief Method get_enableCustomLevels, addr 0x580f8c0, size 0x8, virtual true, abstract: false, final false
  inline bool get_enableCustomLevels();

  /// @brief Method get_hidePacksIfOneOrNone, addr 0x580f898, size 0x8, virtual true, abstract: false, final false
  inline bool get_hidePacksIfOneOrNone();

  /// @brief Method get_hidePracticeButton, addr 0x580f890, size 0x8, virtual true, abstract: false, final false
  inline bool get_hidePracticeButton();

  /// @brief Method get_mainTitle, addr 0x580f8d8, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_mainTitle();

  /// @brief Method get_notAllowedCharacteristics, addr 0x580f8d0, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_showBackButtonForMainViewController, addr 0x580f8a8, size 0x8, virtual true, abstract: false, final false
  inline bool get_showBackButtonForMainViewController();

  /// @brief Method get_songPackMask, addr 0x580f8b0, size 0x10, virtual true, abstract: false, final false
  inline ::GlobalNamespace::SongPackMask get_songPackMask();

  /// @brief Method remove_didFinishedEvent, addr 0x580f7e4, size 0xac, virtual false, abstract: false, final false
  inline void remove_didFinishedEvent(::System::Action* value);

  /// @brief Method remove_didSelectLevelEvent, addr 0x580f678, size 0xc0, virtual false, abstract: false, final false
