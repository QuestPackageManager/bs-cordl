...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15192)), TypeDefinitionIndex(TypeDefinitionIndex(14936)), TypeDefinitionIndex(TypeDefinitionIndex(5599))}
...
public:
  ...
  /// @brief Field _songPackMask, offset 0x100, size 0x10
  ...
  /// @brief Method add_didSelectLevelEvent addr 0x214b324 size 0xb0 virtual false final false
  inline void add_didSelectLevelEvent(::System::Action_1<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*>* value);

  /// @brief Method remove_didSelectLevelEvent addr 0x214c984 size 0xb0 virtual false final false
  inline void remove_didSelectLevelEvent(::System::Action_1<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*>* value);

  /// @brief Method add_didFinishedEvent addr 0x214b3d4 size 0x9c virtual false final false
  inline void add_didFinishedEvent(::System::Action* value);

  /// @brief Method remove_didFinishedEvent addr 0x214ca34 size 0x9c virtual false final false
  inline void remove_didFinishedEvent(::System::Action* value);

  /// @brief Method get_hidePracticeButton addr 0x2154dc8 size 0x8 virtual true final false
  inline bool get_hidePracticeButton();

  /// @brief Method get_hidePacksIfOneOrNone addr 0x2154dd0 size 0x8 virtual true final false
  inline bool get_hidePacksIfOneOrNone();

  /// @brief Method get_actionButtonText addr 0x2154dd8 size 0x8 virtual true final false
  inline ::StringW get_actionButtonText();

  /// @brief Method get_showBackButtonForMainViewController addr 0x2154de0 size 0x8 virtual true final false
  inline bool get_showBackButtonForMainViewController();

  /// @brief Method get_songPackMask addr 0x2154de8 size 0xc virtual true final false
  inline ::GlobalNamespace::SongPackMask get_songPackMask();

  /// @brief Method get_enableCustomLevels addr 0x2154df4 size 0x8 virtual true final false
  inline bool get_enableCustomLevels();

  /// @brief Method get_allowedBeatmapDifficultyMask addr 0x2154dfc size 0x8 virtual true final false
  inline ::GlobalNamespace::BeatmapDifficultyMask get_allowedBeatmapDifficultyMask();

  /// @brief Method get_notAllowedCharacteristics addr 0x2154e04 size 0x8 virtual true final false
  ...
  /// @brief Method get_mainTitle addr 0x2154e0c size 0x8 virtual true final false
  inline ::StringW get_mainTitle();

  /// @brief Method ActionButtonWasPressed addr 0x2154e14 size 0xdc virtual true final false
  inline void ActionButtonWasPressed();

  /// @brief Method BackButtonWasPressed addr 0x2154ef0 size 0x5c virtual true final false
  inline void BackButtonWasPressed(::HMUI::ViewController* topViewController);

  /// @brief Method LevelSelectionFlowCoordinatorTopViewControllerWillChange addr 0x2154f4c size 0xec virtual true final false
  ...
  /// @brief Method TransitionDidStart addr 0x2155038 size 0x11c virtual true final false
  inline void TransitionDidStart();

  /// @brief Method TransitionDidFinish addr 0x2155154 size 0x21c virtual true final false
  inline void TransitionDidFinish();

  /// @brief Method Setup addr 0x214e378 size 0x1c virtual false final false
  ...
  /// @brief Method HandleLobbyGameStateControllerGameStarted addr 0x21553e0 size 0x4 virtual false final false
  inline void HandleLobbyGameStateControllerGameStarted(::GlobalNamespace::ILevelGameplaySetupData* levelGameplaySetupData);

  /// @brief Method DismissViewControllersAndFinish addr 0x2155370 size 0x70 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21553e4 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _songPackMask, offset: 0x100, size: 0x10, def value: None
  ...
  /// @brief Field _state, offset: 0x118, size: 0x8, def value: None
  ::GlobalNamespace::__LevelSelectionFlowCoordinator__State* ____state;

  /// @brief Field _isBeingFinished, offset: 0x120, size: 0x1, def value: None
  bool ____isBeingFinished;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MultiplayerLevelSelectionFlowCoordinator, 0x128>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::MultiplayerLevelSelectionFlowCoordinator, ____allowedBeatmapDifficultyMask) == 0x110, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLevelSelectionFlowCoordinator, ____state) == 0x118, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerLevelSelectionFlowCoordinator, ____isBeingFinished) == 0x120, "Offset mismatch!");
