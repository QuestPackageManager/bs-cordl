...
public:
  ...
  /// @brief Method SetData, addr 0x3bf7afc, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bf7f0c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
