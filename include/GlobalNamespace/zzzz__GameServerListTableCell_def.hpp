...
public:
  ...
  /// @brief Method SetData, addr 0x23d4adc, size 0x3f4, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::INetworkPlayer* player);

  static inline ::GlobalNamespace::GameServerListTableCell* New_ctor();

  /// @brief Method .ctor, addr 0x23d4ed0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
