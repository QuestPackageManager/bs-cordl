...
public:
  ...
  /// @brief Method SetData, addr 0x3bfcab8, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bfcec8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
