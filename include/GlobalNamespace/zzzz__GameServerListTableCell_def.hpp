...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameServerListTableCell*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServerListTableCell*, "", "GameServerListTableCell");
...
static_assert(sizeof(::GlobalNamespace::GameServerListTableCell) == 0xa8, "Size mismatch!");
