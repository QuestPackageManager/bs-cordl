...
public:
  // Declarations
  /// @brief Field _difficultiesText, offset 0x80, size 0x8
  ...
  /// @brief Field _musicPackText, offset 0x88, size 0x8
  ...
  /// @brief Field _passwordProtected, offset 0x98, size 0x8
  ...
  /// @brief Field _playerCount, offset 0x90, size 0x8
  ...
  /// @brief Field _serverName, offset 0x78, size 0x8
  ...
  /// @brief Method SetData, addr 0x57f0838, size 0x428, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57f0c60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::GameServerListTableCell, ____serverName) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerListTableCell, ____difficultiesText) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerListTableCell, ____musicPackText) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerListTableCell, ____playerCount) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerListTableCell, ____passwordProtected) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::GameServerListTableCell, ____songPackMasksModel) == 0xa0, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::GameServerListTableCell, 0xa8>, "Size mismatch!");
