...
public:
  ...
  /// @brief Method SetData, addr 0x262fe84, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2630278, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
