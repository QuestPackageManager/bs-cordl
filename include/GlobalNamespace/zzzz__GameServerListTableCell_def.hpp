...
public:
  ...
  /// @brief Method SetData, addr 0x3bfc750, size 0x410, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bfcb60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
