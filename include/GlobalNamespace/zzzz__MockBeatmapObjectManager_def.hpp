...
public:
  ...
  /// @brief Method get_activeObstacleControllers, addr 0x22c9518, size 0x8, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::ObstacleController>>* get_activeObstacleControllers();

  /// @brief Method ProcessObstacleData, addr 0x22c9520, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessNoteData, addr 0x22c9524, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessSliderData, addr 0x22c9528, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method DespawnInternal, addr 0x22c952c, size 0x4, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::NoteController* noteController);

  /// @brief Method DespawnInternal, addr 0x22c9530, size 0x4, virtual true, abstract: false, final false
  inline void DespawnInternal(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method DespawnInternal, addr 0x22c9534, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22c9538, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
