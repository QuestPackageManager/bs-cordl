...
// Ctor Parameters [CppParam { name: "value", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "texture", ty: "::UnityW<::UnityEngine::Texture>", modifiers: "", def_value: Some("{}") }]
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)(::GlobalNamespace::BeatmapCallbacksController*)>(&::GlobalNamespace::TextureIntSwitchEventEffect::Initialize)> {
  constexpr static std::size_t size = 0x208;
  constexpr static std::size_t addrs = 0x58637b8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::TextureIntSwitchEventEffect*>::get(),
                        "Initialize",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::BeatmapCallbacksController*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)()>(&::GlobalNamespace::TextureIntSwitchEventEffect::OnDestroy)> {
  constexpr static std::size_t size = 0x1c;
  constexpr static std::size_t addrs = 0x5863a90;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)(::GlobalNamespace::BasicBeatmapEventData*)>(&::GlobalNamespace::TextureIntSwitchEventEffect::HandleBasicBeatmapEventData)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0x5863aac;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)(int32_t)>(&::GlobalNamespace::TextureIntSwitchEventEffect::SetTextureByIndex)> {
  constexpr static std::size_t size = 0xd0;
  constexpr static std::size_t addrs = 0x58639c0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::TextureIntSwitchEventEffect::*)()>(&::GlobalNamespace::TextureIntSwitchEventEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5863ac0;
...
constexpr ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple,::Array<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>*>& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__textureValueTuples()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____textureValueTuples;
}
constexpr ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple,::Array<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>*> const& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__textureValueTuples() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____textureValueTuples;
}
constexpr void GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_set__textureValueTuples(::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple,::Array<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::System::Collections::Generic::Dictionary_2<int32_t,::UnityW<::UnityEngine::Texture>>* const& GlobalNamespace::TextureIntSwitchEventEffect::__cordl_internal_get__valueToTextureMap() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____valueToTextureMap;
}
