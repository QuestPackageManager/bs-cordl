...
public:
  // Declarations
  /// @brief Method HandleInputFieldSelectionStateDidChange, addr 0x44dd69c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x44dd60c, size 0x90, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x44dd478, size 0xa8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResolveSelectionState, addr 0x44dd520, size 0xec, virtual false, abstract: false, final false
  inline void ResolveSelectionState(::HMUI::InputFieldView_SelectionState state, bool animated);

  /// @brief Method .ctor, addr 0x44dd6a4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
