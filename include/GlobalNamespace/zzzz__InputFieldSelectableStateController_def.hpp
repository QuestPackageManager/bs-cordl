...
public:
  // Declarations
  /// @brief Method HandleInputFieldSelectionStateDidChange, addr 0x44e66cc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x44e663c, size 0x90, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x44e64a8, size 0xa8, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method ResolveSelectionState, addr 0x44e6550, size 0xec, virtual false, abstract: false, final false
  inline void ResolveSelectionState(::HMUI::InputFieldView_SelectionState state, bool animated);

  /// @brief Method .ctor, addr 0x44e66d4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
