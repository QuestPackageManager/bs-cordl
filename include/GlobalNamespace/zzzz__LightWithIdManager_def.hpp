...
public:
  ...
  /// @brief Method GetColorForId, addr 0x39e318c, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color GetColorForId(int32_t lightId, bool initializeIfNull);

  /// @brief Method LateUpdate, addr 0x39e28e4, size 0x27c, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::LightWithIdManager* New_ctor();

  /// @brief Method RegisterLight, addr 0x39e2b60, size 0x42c, virtual false, abstract: false, final false
  inline void RegisterLight(::GlobalNamespace::ILightWithId* lightWithId);

  /// @brief Method SetColorForId, addr 0x39e0578, size 0x23c, virtual false, abstract: false, final false
  inline void SetColorForId(int32_t lightId, ::UnityEngine::Color color);

  /// @brief Method UnregisterLight, addr 0x39e2f8c, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e3258, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeSomeColorsThisFrameEvent, addr 0x39e27ac, size 0x9c, virtual false, abstract: false, final false
  inline void add_didChangeSomeColorsThisFrameEvent(::System::Action* value);

  /// @brief Method remove_didChangeSomeColorsThisFrameEvent, addr 0x39e2848, size 0x9c, virtual false, abstract: false, final false
