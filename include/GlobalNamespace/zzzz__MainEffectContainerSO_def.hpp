...
/// @brief Method Init, addr 0x5d95358, size 0x80, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::MainEffectSO*  mainEffect) ;

static inline ::GlobalNamespace::MainEffectContainerSO* New_ctor() ;

/// @brief Method OnEnable, addr 0x5d952cc, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d953d8, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mainEffect, addr 0x5d952c4, size 0x8, virtual false, abstract: false, final false
