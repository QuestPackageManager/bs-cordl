...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightIds*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightIds*, "", "BloomPrePassBackgroundColorsGradientTintColorWithLightIds");
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x586c3bc, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586c3d8, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassBackgroundColorsGradientTintColorWithLightIds", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "BloomPrePassBackgroundColorsGradientTintColorWithLightIds", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BloomPrePassBackgroundColorsGradientTintColorWithLightIds(BloomPrePassBackgroundColorsGradientTintColorWithLightIdsconst&) = delete;
...
static_assert(offsetof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightIds, ____bloomPrePassBackgroundColorsGradient) == 0x40, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::BloomPrePassBackgroundColorsGradientTintColorWithLightIds) == 0x48, "Size mismatch!");
