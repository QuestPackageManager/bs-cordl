...
/// @brief Method ColorWasSet, addr 0x56b8c3c, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b8c58, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
