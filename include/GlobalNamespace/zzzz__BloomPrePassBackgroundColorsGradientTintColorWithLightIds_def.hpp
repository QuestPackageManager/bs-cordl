...
/// @brief Method ColorWasSet, addr 0x5728390, size 0x1c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57283ac, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
