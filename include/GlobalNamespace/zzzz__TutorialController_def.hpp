...
public:
  ...
  /// @brief Method MoveNext, addr 0x272c4e4, size 0x10c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__TutorialController___OutroCoroutine_d__19* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x272c5f0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x272c5f8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x272c638, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x272c4e0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x272c464, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleIntroTutorialDidFinishEvent, addr 0x272c320, size 0x1c, virtual false, abstract: false, final false
  inline void HandleIntroTutorialDidFinishEvent();

  /// @brief Method HandlePauseControllerCanPause, addr 0x272c48c, size 0x38, virtual false, abstract: false, final false
  inline void HandlePauseControllerCanPause(::System::Action_1<bool>* canPause);

  /// @brief Method HandlePauseControllerDidPause, addr 0x272c4c4, size 0xc, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidPause();

  /// @brief Method HandlePauseControllerDidResume, addr 0x272c4d0, size 0x8, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidResume();

  /// @brief Method HandleTutorialSongControllerSongDidFinishEvent, addr 0x272c3bc, size 0x40, virtual false, abstract: false, final false
  inline void HandleTutorialSongControllerSongDidFinishEvent();

  static inline ::GlobalNamespace::TutorialController* New_ctor();

  /// @brief Method OnDestroy, addr 0x272c0b4, size 0x26c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OutroCoroutine, addr 0x272c3fc, size 0x68, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* OutroCoroutine();

  /// @brief Method Start, addr 0x272be78, size 0x23c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x272c4d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_levelDidStartEvent, addr 0x272bd40, size 0x9c, virtual true, abstract: false, final true
  inline void add_levelDidStartEvent(::System::Action* value);

  /// @brief Method add_levelWillStartIntroEvent, addr 0x272bc08, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_levelDidStartEvent, addr 0x272bddc, size 0x9c, virtual true, abstract: false, final true
  inline void remove_levelDidStartEvent(::System::Action* value);

  /// @brief Method remove_levelWillStartIntroEvent, addr 0x272bca4, size 0x9c, virtual true, abstract: false, final true
