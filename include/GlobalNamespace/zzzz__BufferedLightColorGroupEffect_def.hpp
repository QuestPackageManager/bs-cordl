...
public:
  ...
  /// @brief Method .ctor, addr 0x5857424, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Cleanup, addr 0x5856fd8, size 0x140, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method GetColor, addr 0x5857318, size 0x34, virtual true, abstract: false, final false
  inline ::UnityEngine::Color GetColor(::GlobalNamespace::EnvironmentColorType colorType, bool colorBoost, float_t brightness);

  /// @brief Method HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame, addr 0x585720c, size 0x10c, virtual false, abstract: false, final false
  inline void HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame();

  /// @brief Method HandleColorBoostBeatmapEvent, addr 0x5857118, size 0x18, virtual false, abstract: false, final false
  inline void HandleColorBoostBeatmapEvent(::GlobalNamespace::ColorBoostBeatmapEventData* colorBoost);

  /// @brief Method HandleColorChangeBeatmapEvent, addr 0x5857130, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5856c2c, size 0x3ac, virtual false, abstract: false, final false
