...
static inline ::GlobalNamespace::BufferedLightColorGroupEffect_InitData* New_ctor(::GlobalNamespace::LightGroup*  lightGroup, ::GlobalNamespace::MaterialPropertyBlockController*  materialPropertyBlockController) ;
...
/// @brief Method .ctor, addr 0x57e552c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x57e50e0, size 0x140, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method GetColor, addr 0x57e5420, size 0x34, virtual true, abstract: false, final false
inline ::UnityEngine::Color GetColor(::GlobalNamespace::EnvironmentColorType  colorType, bool  colorBoost, float_t  brightness) ;

/// @brief Method HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame, addr 0x57e5314, size 0x10c, virtual false, abstract: false, final false
inline void HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame() ;

/// @brief Method HandleColorBoostBeatmapEvent, addr 0x57e5220, size 0x18, virtual false, abstract: false, final false
inline void HandleColorBoostBeatmapEvent(::GlobalNamespace::ColorBoostBeatmapEventData*  colorBoost) ;

/// @brief Method HandleColorChangeBeatmapEvent, addr 0x57e5238, size 0xdc, virtual false, abstract: false, final false
inline void HandleColorChangeBeatmapEvent(::GlobalNamespace::LightColorBeatmapEventData*  currentEvent) ;

static inline ::GlobalNamespace::BufferedLightColorGroupEffect* New_ctor(::GlobalNamespace::BufferedLightColorGroupEffect_InitData*  initData, ::GlobalNamespace::ColorManager*  colorManager, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;
...
/// @brief Method .ctor, addr 0x57e4d34, size 0x3ac, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BufferedLightColorGroupEffect_InitData*  initData, ::GlobalNamespace::ColorManager*  colorManager, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;
