...
// Write type traits
MARK_REF_T(::GlobalNamespace::ColorSaturationValueSlider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ColorSaturationValueSlider*, "", "ColorSaturationValueSlider");
// Dependencies HMUI.Slider2D, UnityEngine.Color, UnityEngine.UI.Graphic
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Awake, addr 0x5a2a7e8, size 0x90, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNormalizedValueDidChange, addr 0x5a2aa30, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5a2a878, size 0x84, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPointerUp, addr 0x5a2aa58, size 0x44, virtual true, abstract: false, final false
  inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData* eventData);

  /// @brief Method SetHue, addr 0x5a2a8fc, size 0x14, virtual false, abstract: false, final false
  inline void SetHue(float_t hue);

  /// @brief Method UpdateVisuals, addr 0x5a2a910, size 0x120, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a2aa9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_colorSaturationOrValueDidChangeEvent, addr 0x5a2a668, size 0xc0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method remove_colorSaturationOrValueDidChangeEvent, addr 0x5a2a728, size 0xc0, virtual false, abstract: false, final false
  inline void
...
static_assert(sizeof(::GlobalNamespace::ColorSaturationValueSlider) == 0x160, "Size mismatch!");
