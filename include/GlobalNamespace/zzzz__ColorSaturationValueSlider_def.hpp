...
// Dependencies HMUI.Slider2D, UnityEngine.Color
namespace GlobalNamespace {
// Is value type: false
...
/// @brief Field _graphics, offset 0x130, size 0x8 
 __declspec(property(get=__cordl_internal_get__graphics, put=__cordl_internal_set__graphics)) ::ArrayW<::UnityW<::UnityEngine::UI::Graphic>,::Array<::UnityW<::UnityEngine::UI::Graphic>>*>  _graphics;
...
/// @brief Field colorSaturationOrValueDidChangeEvent, offset 0x158, size 0x8 
 __declspec(property(get=__cordl_internal_get_colorSaturationOrValueDidChangeEvent, put=__cordl_internal_set_colorSaturationOrValueDidChangeEvent)) ::System::Action_3<::UnityW<::GlobalNamespace::ColorSaturationValueSlider>,::UnityEngine::Vector2,::GlobalNamespace::ColorChangeUIEventType>*  colorSaturationOrValueDidChangeEvent;
...
/// @brief Method Awake, addr 0x58f1d1c, size 0x90, virtual true, abstract: false, final false
inline void Awake() ;

/// @brief Method HandleNormalizedValueDidChange, addr 0x58f1f64, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x58f1dac, size 0x84, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnPointerUp, addr 0x58f1f8c, size 0x44, virtual true, abstract: false, final false
inline void OnPointerUp(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method SetHue, addr 0x58f1e30, size 0x14, virtual false, abstract: false, final false
inline void SetHue(float_t  hue) ;

/// @brief Method UpdateVisuals, addr 0x58f1e44, size 0x120, virtual true, abstract: false, final false
...
constexpr ::System::Action_3<::UnityW<::GlobalNamespace::ColorSaturationValueSlider>,::UnityEngine::Vector2,::GlobalNamespace::ColorChangeUIEventType>* const& __cordl_internal_get_colorSaturationOrValueDidChangeEvent() const;

constexpr ::System::Action_3<::UnityW<::GlobalNamespace::ColorSaturationValueSlider>,::UnityEngine::Vector2,::GlobalNamespace::ColorChangeUIEventType>*& __cordl_internal_get_colorSaturationOrValueDidChangeEvent() ;
...
constexpr void __cordl_internal_set_colorSaturationOrValueDidChangeEvent(::System::Action_3<::UnityW<::GlobalNamespace::ColorSaturationValueSlider>,::UnityEngine::Vector2,::GlobalNamespace::ColorChangeUIEventType>*  value) ;

/// @brief Method .ctor, addr 0x58f1fd0, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_colorSaturationOrValueDidChangeEvent, addr 0x58f1b9c, size 0xc0, virtual false, abstract: false, final false
inline void add_colorSaturationOrValueDidChangeEvent(::System::Action_3<::UnityW<::GlobalNamespace::ColorSaturationValueSlider>,::UnityEngine::Vector2,::GlobalNamespace::ColorChangeUIEventType>*  value) ;
...
/// @brief Method remove_colorSaturationOrValueDidChangeEvent, addr 0x58f1c5c, size 0xc0, virtual false, abstract: false, final false
inline void remove_colorSaturationOrValueDidChangeEvent(::System::Action_3<::UnityW<::GlobalNamespace::ColorSaturationValueSlider>,::UnityEngine::Vector2,::GlobalNamespace::ColorChangeUIEventType>*  value) ;
