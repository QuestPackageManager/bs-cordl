...
public:
  ...
  /// @brief Method TableViewSetup, addr 0x2526344, size 0xe4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2526428, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
