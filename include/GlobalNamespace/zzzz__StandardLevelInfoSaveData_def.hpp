...
public:
  ...
  /// @brief Method get_beatmapCharacteristicName addr 0x2201e20 size 0x8 virtual false final false
  inline ::StringW get_beatmapCharacteristicName();

  /// @brief Method get_difficultyBeatmaps addr 0x2201e28 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2201df4 size 0x2c virtual false final false
...
public:
  ...
  /// @brief Method get_difficulty addr 0x2201e30 size 0x8 virtual false final false
  inline ::StringW get_difficulty();

  /// @brief Method get_difficultyRank addr 0x2201e38 size 0x8 virtual false final false
  inline int32_t get_difficultyRank();

  /// @brief Method get_beatmapFilename addr 0x2201e40 size 0x8 virtual false final false
  inline ::StringW get_beatmapFilename();

  /// @brief Method get_noteJumpMovementSpeed addr 0x2201e48 size 0x8 virtual false final false
  inline float_t get_noteJumpMovementSpeed();

  /// @brief Method get_noteJumpStartBeatOffset addr 0x2201e50 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2201da0 size 0x54 virtual false final false
  inline void _ctor(::StringW difficultyName, int32_t difficultyRank, ::StringW beatmapFilename, float_t noteJumpMovementSpeed, float_t noteJumpStartBeatOffset);
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmap, 0x30>, "Size mismatch!");
...
public:
  ...
  /// @brief Method get_version addr 0x2201e58 size 0x8 virtual false final false
  inline ::StringW get_version();

  static inline ::GlobalNamespace::__StandardLevelInfoSaveData__VersionCheck* New_ctor();

  /// @brief Method .ctor addr 0x2201e60 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _difficultyBeatmapSets, offset 0x70, size 0x8
  ...
  /// @brief Method get_version addr 0x2201740 size 0x8 virtual false final false
  inline ::StringW get_version();

  /// @brief Method get_songName addr 0x2201748 size 0x8 virtual false final false
  inline ::StringW get_songName();

  /// @brief Method get_songSubName addr 0x2201750 size 0x8 virtual false final false
  inline ::StringW get_songSubName();

  /// @brief Method get_songAuthorName addr 0x2201758 size 0x8 virtual false final false
  inline ::StringW get_songAuthorName();

  /// @brief Method get_levelAuthorName addr 0x2201760 size 0x8 virtual false final false
  inline ::StringW get_levelAuthorName();

  /// @brief Method get_beatsPerMinute addr 0x2201768 size 0x8 virtual false final false
  inline float_t get_beatsPerMinute();

  /// @brief Method get_songTimeOffset addr 0x2201770 size 0x8 virtual false final false
  inline float_t get_songTimeOffset();

  /// @brief Method get_shuffle addr 0x2201778 size 0x8 virtual false final false
  inline float_t get_shuffle();

  /// @brief Method get_shufflePeriod addr 0x2201780 size 0x8 virtual false final false
  inline float_t get_shufflePeriod();

  /// @brief Method get_previewStartTime addr 0x2201788 size 0x8 virtual false final false
  inline float_t get_previewStartTime();

  /// @brief Method get_previewDuration addr 0x2201790 size 0x8 virtual false final false
  inline float_t get_previewDuration();

  /// @brief Method get_songFilename addr 0x2201798 size 0x8 virtual false final false
  inline ::StringW get_songFilename();

  /// @brief Method get_coverImageFilename addr 0x22017a0 size 0x8 virtual false final false
  inline ::StringW get_coverImageFilename();

  /// @brief Method get_environmentName addr 0x22017a8 size 0x8 virtual false final false
  inline ::StringW get_environmentName();

  /// @brief Method get_allDirectionsEnvironmentName addr 0x22017b0 size 0x8 virtual false final false
  inline ::StringW get_allDirectionsEnvironmentName();

  /// @brief Method get_difficultyBeatmapSets addr 0x22017b8 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x22017c0 size 0xe4 virtual false final false
  inline void
  ...
  /// @brief Method get_hasAllData addr 0x22018a4 size 0x64 virtual false final false
  inline bool get_hasAllData();

  /// @brief Method SetSongFilename addr 0x2201908 size 0x8 virtual false final false
  inline void SetSongFilename(::StringW songFilename);

  /// @brief Method SerializeToJSONString addr 0x2201910 size 0x8 virtual false final false
  inline ::StringW SerializeToJSONString();

  /// @brief Method DeserializeFromJSONString addr 0x2201918 size 0x488 virtual false final false
...
public:
  ...
  /// @brief Field _difficultyBeatmapSets, offset: 0x70, size: 0x8, def value: None
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::StandardLevelInfoSaveData, 0x78>, "Size mismatch!");
...
static_assert(offsetof(::GlobalNamespace::StandardLevelInfoSaveData, ____difficultyBeatmapSets) == 0x70, "Offset mismatch!");
