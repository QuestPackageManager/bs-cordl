...
public:
  ...
  /// @brief Method Render, addr 0x5e0d110, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e0d17c, size 0x44, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_toneMapping, addr 0x5e0d0fc, size 0x14, virtual true, abstract: false, final false
