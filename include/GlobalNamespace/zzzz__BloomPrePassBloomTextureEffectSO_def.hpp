...
// Write type traits
MARK_REF_T(::GlobalNamespace::BloomPrePassBloomTextureEffectSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BloomPrePassBloomTextureEffectSO*, "", "BloomPrePassBloomTextureEffectSO");
...
static_assert(sizeof(::GlobalNamespace::BloomPrePassBloomTextureEffectSO) == 0x68, "Size mismatch!");
