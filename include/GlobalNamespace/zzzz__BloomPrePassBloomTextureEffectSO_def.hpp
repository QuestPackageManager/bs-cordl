...
public:
  ...
  /// @brief Method Render, addr 0x4081de4, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4081e50, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_toneMapping, addr 0x4081dc4, size 0x20, virtual true, abstract: false, final false
