...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapSaveDataHelpers*);
MARK_REF_T(::GlobalNamespace::BeatmapSaveDataHelpers_VersionSerializedData*);
MARK_REF_T(::GlobalNamespace::BeatmapSaveDataHelpers___c__DisplayClass6_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapSaveDataHelpers*, "", "BeatmapSaveDataHelpers");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapSaveDataHelpers_VersionSerializedData*, "", "BeatmapSaveDataHelpers/VersionSerializedData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapSaveDataHelpers___c__DisplayClass6_0*, "", "BeatmapSaveDataHelpers/<>c__DisplayClass6_0");
...
public:
  ...
  /// @brief Method .ctor, addr 0x374fe34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_v, addr 0x374fbb8, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapSaveDataHelpers_VersionSerializedData) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method <GetVersionAsync>b__0, addr 0x374fe38, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x374fd00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::BeatmapSaveDataHelpers___c__DisplayClass6_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetVersion, addr 0x374f87c, size 0x218, virtual false, abstract: false, final false
  static inline ::System::Version* GetVersion(::StringW data);

  /// @brief Method GetVersionAsync, addr 0x374fbd8, size 0x128, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::BeatmapSaveDataHelpers) == 0x10, "Size mismatch!");
