...
public:
  ...
  /// @brief Method get_v addr 0xe05124 size 0x30 virtual false final false
  inline ::StringW get_v();

  static inline ::GlobalNamespace::__BeatmapSaveDataHelpers__VersionSerializedData* New_ctor();

  /// @brief Method .ctor addr 0xe05154 size 0x8 virtual false final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetVersion addr 0xe05078 size 0xac virtual false final false
