...
/// @brief Method .ctor, addr 0x3694970, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_v, addr 0x36946f4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method <GetVersionAsync>b__0, addr 0x3694974, size 0x5c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x369483c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetVersion, addr 0x36943b8, size 0x218, virtual false, abstract: false, final false
static inline ::System::Version* GetVersion(::StringW  data) ;

/// @brief Method GetVersionAsync, addr 0x3694714, size 0x128, virtual false, abstract: false, final false
