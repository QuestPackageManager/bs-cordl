...
public:
  ...
  /// @brief Method .ctor, addr 0x26ff2a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_v, addr 0x26ff050, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetVersionAsync>b__0, addr 0x26ff2b0, size 0x58, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetVersion, addr 0x26fec58, size 0x21c, virtual false, abstract: false, final false
  static inline ::System::Version* GetVersion(::StringW data);

  /// @brief Method GetVersionAsync, addr 0x26ff080, size 0xec, virtual false, abstract: false, final false
