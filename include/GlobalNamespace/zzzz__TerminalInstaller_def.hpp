...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TerminalInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TerminalInstaller(TerminalInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TerminalInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TerminalInstaller(TerminalInstallerconst&) = delete;
