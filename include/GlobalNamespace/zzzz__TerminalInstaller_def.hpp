...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x32e9f00, size 0xbc, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::TerminalInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x32e9fbc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
