...
/// @brief Method FillLevelCompletionResults, addr 0x58418e4, size 0x2d4, virtual false, abstract: false, final false
inline ::GlobalNamespace::LevelCompletionResults* FillLevelCompletionResults(::GlobalNamespace::LevelCompletionResults_LevelEndStateType  levelEndStateType, ::GlobalNamespace::LevelCompletionResults_LevelEndAction  levelEndAction) ;
...
/// @brief Method .ctor, addr 0x5841be8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
