...
public:
  ...
  /// @brief Method FillLevelCompletionResults, addr 0x3be7f9c, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3be829c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
