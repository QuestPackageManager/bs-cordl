...
public:
  ...
  /// @brief Method FillLevelCompletionResults, addr 0x2622630, size 0x250, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26228b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
