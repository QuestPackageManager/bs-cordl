...
public:
  ...
  /// @brief Method FillLevelCompletionResults, addr 0x58b3ecc, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58b41d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
