...
public:
  ...
  /// @brief Method Awake, addr 0x5855df4, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::StepFloatMaterialPropertyEffectTarget* New_ctor();

  /// @brief Method SetFloat, addr 0x5855e18, size 0x58, virtual false, abstract: false, final false
  inline void SetFloat(float_t value);

  /// @brief Method SetValue, addr 0x5855e14, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x5855e70, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5855e74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
