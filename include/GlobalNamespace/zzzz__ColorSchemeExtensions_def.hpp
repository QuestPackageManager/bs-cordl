...
public:
  // Declarations
  /// @brief Method GetColorSchemeForGameplayOverride, addr 0x35d11d0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetColorSchemeForLightshowOverride, addr 0x35d12ac, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveColorScheme, addr 0x35d0cb0, size 0x520, virtual false, abstract: false, final false
