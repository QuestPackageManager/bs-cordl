...
public:
  // Declarations
  /// @brief Method ResolveColor, addr 0x26a2570, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveColorScheme, addr 0x26a1b34, size 0xa3c, virtual false, abstract: false, final false
