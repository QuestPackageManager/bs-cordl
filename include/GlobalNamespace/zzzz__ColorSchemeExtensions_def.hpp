...
public:
  // Declarations
  /// @brief Method GetColorSchemeForGameplayOverride, addr 0x36f7584, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetColorSchemeForLightshowOverride, addr 0x36f7660, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveColorScheme, addr 0x36f7064, size 0x520, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ColorSchemeExtensions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ColorSchemeExtensions(ColorSchemeExtensions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ColorSchemeExtensions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ColorSchemeExtensions(ColorSchemeExtensionsconst&) = delete;
