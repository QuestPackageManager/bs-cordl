...
public:
  // Declarations
  /// @brief Method GetColorSchemeForGameplayOverride, addr 0x3637fa8, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetColorSchemeForLightshowOverride, addr 0x3638084, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveColorScheme, addr 0x3637a88, size 0x520, virtual false, abstract: false, final false
