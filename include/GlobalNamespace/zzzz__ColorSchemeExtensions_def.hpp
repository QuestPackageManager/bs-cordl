...
public:
  // Declarations
  /// @brief Method ResolveColor, addr 0x269e438, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveColorScheme, addr 0x269d9fc, size 0xa3c, virtual false, abstract: false, final false
