...
// Write type traits
MARK_REF_T(::GlobalNamespace::IStandaloneMonobehavior*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IStandaloneMonobehavior*, "", "IStandaloneMonobehavior");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IStandaloneMonobehavior", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IStandaloneMonobehavior(IStandaloneMonobehaviorconst&) = delete;
