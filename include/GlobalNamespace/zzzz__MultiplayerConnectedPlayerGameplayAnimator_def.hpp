...
public:
  ...
  /// @brief Method Start addr 0x20f3444 size 0xa8 virtual true final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x20f34ec size 0x170 virtual true final false
  inline void OnDestroy();

  /// @brief Method TransitionIntoFailedState addr 0x20f36f8 size 0xf4 virtual false final false
  inline void TransitionIntoFailedState();

  /// @brief Method AnimateNewLeaderSelected addr 0x20f38e8 size 0x148 virtual true final false
  inline void AnimateNewLeaderSelected(bool isLeading);

  /// @brief Method HandleStateChanged addr 0x20f3a30 size 0x110 virtual true final false
  inline void HandleStateChanged(::GlobalNamespace::__MultiplayerController__State state);

  /// @brief Method HandlePlayerDidFail addr 0x20f3bdc size 0x4 virtual false final false
  inline void HandlePlayerDidFail();

  /// @brief Method HandleIsObservedChanged addr 0x20f3be0 size 0x7c virtual false final false
  ...
  /// @brief Method .ctor addr 0x20f3ccc size 0x8 virtual false final false
  inline void _ctor();
