...
public:
  ...
  /// @brief Method AnimateNewLeaderSelected, addr 0x25eb308, size 0x148, virtual true, abstract: false, final false
  inline void AnimateNewLeaderSelected(bool isLeading);

  /// @brief Method HandleIsObservedChanged, addr 0x25eb600, size 0x7c, virtual false, abstract: false, final false
  inline void HandleIsObservedChanged(bool isObserved);

  /// @brief Method HandlePlayerDidFail, addr 0x25eb5fc, size 0x4, virtual false, abstract: false, final false
  inline void HandlePlayerDidFail();

  /// @brief Method HandleStateChanged, addr 0x25eb450, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25eaf0c, size 0x170, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x25eae64, size 0xa8, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method TransitionIntoFailedState, addr 0x25eb118, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25eb6ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
