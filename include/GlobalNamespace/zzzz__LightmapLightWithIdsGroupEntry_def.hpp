...
public:
  ...
  /// @brief Method .ctor, addr 0x39e7e58, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupIntensity, addr 0x39e7e48, size 0x8, virtual false, abstract: false, final false
  inline float_t get_groupIntensity();

  /// @brief Method get_groupProbeHighlightsIntensityMultiplier, addr 0x39e7e50, size 0x8, virtual false, abstract: false, final false
  inline float_t get_groupProbeHighlightsIntensityMultiplier();

  /// @brief Method get_lightGroup, addr 0x39e7e40, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x39e7eac, size 0x44, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity, float_t probeHighlightsIntensityMultiplier);

  /// @brief Method get_intensity, addr 0x39e7e9c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method get_lightId, addr 0x39e7e94, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lightId();

  /// @brief Method get_probeHighlightsIntensityMultiplier, addr 0x39e7ea4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x39e7e38, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_groupLightData, addr 0x39e7e20, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupLightsWeighting, addr 0x39e7e30, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorMixAndWeightingApproach get_groupLightsWeighting();

  /// @brief Method get_individualLightData, addr 0x39e7e28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lightmapLightWithIds, addr 0x39e7e18, size 0x8, virtual false, abstract: false, final false
