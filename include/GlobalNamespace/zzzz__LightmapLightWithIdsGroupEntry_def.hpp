...
public:
  ...
  /// @brief Method .ctor, addr 0x5728558, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupIntensity, addr 0x5728548, size 0x8, virtual false, abstract: false, final false
  inline float_t get_groupIntensity();

  /// @brief Method get_groupProbeHighlightsIntensityMultiplier, addr 0x5728550, size 0x8, virtual false, abstract: false, final false
  inline float_t get_groupProbeHighlightsIntensityMultiplier();

  /// @brief Method get_lightGroup, addr 0x5728540, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x572857c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(int32_t lightId, float_t intensity, float_t probeHighlightsIntensityMultiplier);

  /// @brief Method get_intensity, addr 0x572856c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_intensity();

  /// @brief Method get_lightId, addr 0x5728564, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lightId();

  /// @brief Method get_probeHighlightsIntensityMultiplier, addr 0x5728574, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x572853c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_groupLightData, addr 0x5728524, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_groupLightsWeighting, addr 0x5728534, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorMixAndWeightingApproach get_groupLightsWeighting();

  /// @brief Method get_individualLightData, addr 0x572852c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lightmapLightWithIds, addr 0x572851c, size 0x8, virtual false, abstract: false, final false
