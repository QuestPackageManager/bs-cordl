...
public:
  ...
  /// @brief Method Setup, addr 0x252bf4c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x252bfac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_formData, addr 0x252be5c, size 0xf0, virtual false, abstract: false, final false
