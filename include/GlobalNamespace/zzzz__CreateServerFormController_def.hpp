...
public:
  ...
  /// @brief Method Setup, addr 0x24093d4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2409434, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_formData, addr 0x24092e4, size 0xf0, virtual false, abstract: false, final false
