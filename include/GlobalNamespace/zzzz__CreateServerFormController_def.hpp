...
public:
  ...
  /// @brief Method Setup, addr 0x23a5de8, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23a5e48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_formData, addr 0x23a5cf8, size 0xf0, virtual false, abstract: false, final false
