...
public:
  ...
  /// @brief Method get_formData, addr 0x22d7044, size 0xf0, virtual false, abstract: false, final false
  inline ::GlobalNamespace::CreateServerFormData get_formData();

  /// @brief Method Setup, addr 0x22d7134, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22d7194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
