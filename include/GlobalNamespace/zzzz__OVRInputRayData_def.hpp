...
// Ctor Parameters [CppParam { name: "IsActive", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "ActivationStrength", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "IsOverCanvas", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "DistanceToCanvas", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "WorldPosition", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "WorldNormal", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }]
