...
public:
  ...
  /// @brief Method get_groupId, addr 0x23660b0, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_groupId();

  /// @brief Method get_lightGroup, addr 0x2369adc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::LightGroup> get_lightGroup();

  /// @brief Method OnEnable, addr 0x2369ae4, size 0x60, virtual false, abstract: false, final false
  inline void OnEnable();

  static inline ::GlobalNamespace::LightGroupSubsystem* New_ctor();

  /// @brief Method .ctor, addr 0x2365950, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
