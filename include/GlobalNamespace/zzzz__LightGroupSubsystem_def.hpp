...
public:
  ...
  /// @brief Method OnEnable, addr 0x26f6358, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f23cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_groupId, addr 0x26f2b5c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_groupId();

  /// @brief Method get_lightGroup, addr 0x26f6350, size 0x8, virtual false, abstract: false, final false
