...
public:
  ...
  /// @brief Method OnEnable, addr 0x26ca364, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26c63e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_groupId, addr 0x26c6b70, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_groupId();

  /// @brief Method get_lightGroup, addr 0x26ca35c, size 0x8, virtual false, abstract: false, final false
