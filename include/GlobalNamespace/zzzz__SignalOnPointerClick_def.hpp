...
public:
  ...
  /// @brief Method OnPointerClick, addr 0x5858f88, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5858fa4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignalOnPointerClick", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignalOnPointerClick(SignalOnPointerClick&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignalOnPointerClick", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignalOnPointerClick(SignalOnPointerClickconst&) = delete;
