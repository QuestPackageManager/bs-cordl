...
public:
  ...
  /// @brief Method OnPointerClick, addr 0x5711f38, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5711f54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
