...
public:
  ...
  /// @brief Method OnPointerClick, addr 0x39d2db8, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39d2dd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
