...
public:
  ...
  /// @brief Method OnPointerClick, addr 0x56a42e8, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x56a4304, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
