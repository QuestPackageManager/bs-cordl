...
public:
  ...
  /// @brief Method OnPointerClick, addr 0x39c4bc4, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x39c4be4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
