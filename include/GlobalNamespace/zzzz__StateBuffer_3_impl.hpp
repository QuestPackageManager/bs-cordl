...
// Ctor Parameters [CppParam { name: "isValid", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "id", ty: "::GlobalNamespace::SyncStateId", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "time", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "state", ty: "TStateTable", modifiers: "",
