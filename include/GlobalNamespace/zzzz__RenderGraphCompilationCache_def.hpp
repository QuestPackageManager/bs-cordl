...
// Ctor Parameters [CppParam { name: "hash", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "lastFrameUsed", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "compiledGraph", ty: "T", modifiers: "", def_value: None }]
...
// Declarations
template<typename T>
using HashEntry_1 = ::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<T>;
...
/// @brief Field m_CompiledGraphPool, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_CompiledGraphPool, put=__cordl_internal_set_m_CompiledGraphPool)) ::System::Collections::Generic::Stack_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>*  m_CompiledGraphPool;

/// @brief Field m_HashEntries, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_HashEntries, put=__cordl_internal_set_m_HashEntries)) ::UnityEngine::Rendering::DynamicArray_1<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>>*  m_HashEntries;

/// @brief Field m_NativeCompiledGraphPool, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_NativeCompiledGraphPool, put=__cordl_internal_set_m_NativeCompiledGraphPool)) ::System::Collections::Generic::Stack_1<Il2CppObject*>*  m_NativeCompiledGraphPool;

/// @brief Field m_NativeHashEntries, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_m_NativeHashEntries, put=__cordl_internal_set_m_NativeHashEntries)) ::UnityEngine::Rendering::DynamicArray_1<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<Il2CppObject*>>*  m_NativeHashEntries;

/// @brief Field s_EntryComparer, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_EntryComparer, put=setStaticF_s_EntryComparer)) ::UnityEngine::Rendering::DynamicArray_1_SortComparer<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>>*  s_EntryComparer;
...
/// @brief Field s_NativeEntryComparer, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_s_NativeEntryComparer, put=setStaticF_s_NativeEntryComparer)) ::UnityEngine::Rendering::DynamicArray_1_SortComparer<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<Il2CppObject*>>*  s_NativeEntryComparer;

/// @brief Method Clear, addr 0x658cd58, size 0x1a8, virtual false, abstract: false, final false
inline void Clear() ;

/// @brief Method GetCompilationCache, addr 0x658cbe8, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method GetCompilationCache, addr 0x658cca0, size 0xb8, virtual false, abstract: false, final false
...
template<typename T>
inline bool GetCompilationCache(int32_t  hash, int32_t  frameIndex, ::ByRef<T>  outGraph, ::UnityEngine::Rendering::DynamicArray_1<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<T>>*  hashEntries, ::System::Collections::Generic::Stack_1<T>*  pool, ::UnityEngine::Rendering::DynamicArray_1_SortComparer<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<T>>*  comparer) ;

/// @brief Method HashEntryComparer, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
template<typename T>
static inline int32_t HashEntryComparer(::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<T>  a, ::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<T>  b) ;
...
constexpr ::UnityEngine::Rendering::DynamicArray_1<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>>* const& __cordl_internal_get_m_HashEntries() const;

constexpr ::UnityEngine::Rendering::DynamicArray_1<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>>*& __cordl_internal_get_m_HashEntries() ;
...
constexpr void __cordl_internal_set_m_HashEntries(::UnityEngine::Rendering::DynamicArray_1<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>>*  value) ;
...
/// @brief Method .ctor, addr 0x658c9b8, size 0x230, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::Rendering::DynamicArray_1_SortComparer<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>>* getStaticF_s_EntryComparer() ;
...
static inline void setStaticF_s_EntryComparer(::UnityEngine::Rendering::DynamicArray_1_SortComparer<::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1<::UnityEngine::Rendering::RenderGraphModule::RenderGraph_CompiledGraph*>>*  value) ;
