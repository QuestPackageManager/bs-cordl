...
public:
  ...
  /// @brief Method Clear, addr 0x65fed64, size 0x1a8, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetCompilationCache, addr 0x65febf4, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetCompilationCache, addr 0x65fecac, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x65fe9c4, size 0x230, virtual false, abstract: false, final false
  inline void _ctor();
