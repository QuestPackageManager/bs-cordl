...
// Write type traits
MARK_REF_T(::GlobalNamespace::RenderGraphCompilationCache*);
MARK_GEN_REF_T_PTR(::GlobalNamespace::RenderGraphCompilationCache___c__11_1);
MARK_GEN_VAL_T(::GlobalNamespace::RenderGraphCompilationCache_HashEntry_1);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RenderGraphCompilationCache*, "", "RenderGraphCompilationCache");
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::RenderGraphCompilationCache___c__11_1, "", "RenderGraphCompilationCache/<>c__11`1");
...
static_assert(sizeof(::GlobalNamespace::RenderGraphCompilationCache) == 0x30, "Size mismatch!");
