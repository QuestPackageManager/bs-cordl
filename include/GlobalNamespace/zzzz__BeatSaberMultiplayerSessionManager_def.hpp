...
// Dependencies BeatSaberPlayerIdentityPacketData, MultiplayerSessionManager`5<TMessageType, TConnectedPlayerSessionManager, TConnectedPlayer, TConnectedPlayerImpl, TGameSpecificIdentityData>, NetworkMessageType
namespace GlobalNamespace {
// Is value type: false
// CS Name: BeatSaberMultiplayerSessionManager
class CORDL_TYPE BeatSaberMultiplayerSessionManager : public ::GlobalNamespace::MultiplayerSessionManager_5<::GlobalNamespace::NetworkMessageType,::GlobalNamespace::BeatSaberConnectedPlayerManager*,::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData> {
public:
// Declarations
/// @brief Field playerAvatarChangedEvent, offset 0xb8, size 0x8 
 __declspec(property(get=__cordl_internal_get_playerAvatarChangedEvent, put=__cordl_internal_set_playerAvatarChangedEvent)) ::System::Action_1<::GlobalNamespace::IBeatSaberConnectedPlayer*>*  playerAvatarChangedEvent;
...
constexpr operator  ::GlobalNamespace::IMultiplayerSessionManager_4<::GlobalNamespace::BeatSaberConnectedPlayerManager*,::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData>*() noexcept;
...
/// @brief Method HandlePlayerAvatarChanged, addr 0x31d2ce8, size 0x94, virtual false, abstract: false, final false
inline void HandlePlayerAvatarChanged(::GlobalNamespace::IBeatSaberConnectedPlayer*  player) ;

/// @brief Method IMultiplayerSessionManager<BeatSaberConnectedPlayerManager,IBeatSaberConnectedPlayer,BeatSaberConnectedPlayer,BeatSaberPlayerIdentityPacketData>.StartSession, addr 0x31d2dc8, size 0x64, virtual true, abstract: false, final true
inline void IMultiplayerSessionManager_BeatSaberConnectedPlayerManager_IBeatSaberConnectedPlayer_BeatSaberConnectedPlayer_BeatSaberPlayerIdentityPacketData__StartSession(::GlobalNamespace::BeatSaberConnectedPlayerManager*  connectedPlayerManager, ::GlobalNamespace::IMultiplayerSessionManager_1_IMultiplayerSessionInitializer<::GlobalNamespace::IBeatSaberConnectedPlayer*>*  multiplayerSessionInitializer) ;

static inline ::GlobalNamespace::BeatSaberMultiplayerSessionManager* New_ctor() ;

/// @brief Method RegisterGameSpecificEventHandlers, addr 0x31d2bd0, size 0x8c, virtual true, abstract: false, final false
inline void RegisterGameSpecificEventHandlers() ;

/// @brief Method UnregisterGameSpecificEventHandlers, addr 0x31d2c5c, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31d2d7c, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerAvatarChangedEvent, addr 0x31d2a50, size 0xc0, virtual true, abstract: false, final true
...
constexpr ::GlobalNamespace::IMultiplayerSessionManager_1<::GlobalNamespace::IBeatSaberConnectedPlayer*>* i___GlobalNamespace__IMultiplayerSessionManager_1___GlobalNamespace__IBeatSaberConnectedPlayer__() noexcept;
...
constexpr ::GlobalNamespace::IMultiplayerSessionManager_4<::GlobalNamespace::BeatSaberConnectedPlayerManager*,::GlobalNamespace::IBeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberConnectedPlayer*,::GlobalNamespace::BeatSaberPlayerIdentityPacketData>* i___GlobalNamespace__IMultiplayerSessionManager_4___GlobalNamespace__BeatSaberConnectedPlayerManager____GlobalNamespace__IBeatSaberConnectedPlayer____GlobalNamespace__BeatSaberConnectedPlayer____GlobalNamespace__BeatSaberPlayerIdentityPacketData_() noexcept;
...
constexpr ::GlobalNamespace::IMultiplayerSessionMessageProcessor_2<::GlobalNamespace::NetworkMessageType,::GlobalNamespace::IBeatSaberConnectedPlayer*>* i___GlobalNamespace__IMultiplayerSessionMessageProcessor_2___GlobalNamespace__NetworkMessageType___GlobalNamespace__IBeatSaberConnectedPlayer__() noexcept;

/// @brief Method remove_playerAvatarChangedEvent, addr 0x31d2b10, size 0xc0, virtual true, abstract: false, final true
