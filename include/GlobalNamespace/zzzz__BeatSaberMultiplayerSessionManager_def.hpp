...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatSaberMultiplayerSessionManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatSaberMultiplayerSessionManager*, "", "BeatSaberMultiplayerSessionManager");
