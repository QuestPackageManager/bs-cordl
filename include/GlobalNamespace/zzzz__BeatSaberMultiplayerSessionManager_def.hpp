...
public:
  ...
  /// @brief Method HandlePlayerAvatarChanged, addr 0x320e950, size 0x94, virtual false, abstract: false, final false
  inline void HandlePlayerAvatarChanged(::GlobalNamespace::IBeatSaberConnectedPlayer* player);

  /// @brief Method IMultiplayerSessionManager<BeatSaberConnectedPlayerManager,IBeatSaberConnectedPlayer,BeatSaberConnectedPlayer,BeatSaberPlayerIdentityPacketData>.StartSession, addr 0x320ea30, size
  ...
  /// @brief Method RegisterGameSpecificEventHandlers, addr 0x320e838, size 0x8c, virtual true, abstract: false, final false
  inline void RegisterGameSpecificEventHandlers();

  /// @brief Method UnregisterGameSpecificEventHandlers, addr 0x320e8c4, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x320e9e4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerAvatarChangedEvent, addr 0x320e6b8, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_playerAvatarChangedEvent, addr 0x320e778, size 0xc0, virtual true, abstract: false, final true
