...
/// @brief Method IMultiplayerSessionManager<BeatSaberConnectedPlayerManager,IBeatSaberConnectedPlayer,BeatSaberConnectedPlayer,BeatSaberPlayerIdentityPacketData>.StartSession, addr 0x320f750, size 0x64, virtual true, abstract: false, final true
