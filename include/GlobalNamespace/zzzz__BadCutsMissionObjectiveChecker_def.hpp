...
// Write type traits
MARK_REF_T(::GlobalNamespace::BadCutsMissionObjectiveChecker*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BadCutsMissionObjectiveChecker*, "", "BadCutsMissionObjectiveChecker");
...
public:
  ...
  /// @brief Method HandleNoteWasCut, addr 0x591935c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x5919198, size 0x12c, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::BadCutsMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x59192c4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59193fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BadCutsMissionObjectiveChecker", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BadCutsMissionObjectiveChecker(BadCutsMissionObjectiveChecker&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BadCutsMissionObjectiveChecker", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BadCutsMissionObjectiveChecker(BadCutsMissionObjectiveCheckerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BadCutsMissionObjectiveChecker) == 0x58, "Size mismatch!");
