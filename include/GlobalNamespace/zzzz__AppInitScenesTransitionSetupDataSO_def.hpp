...
public:
  ...
  /// @brief Method .ctor, addr 0x229388c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method get_appInitOverrideStartType, addr 0x229a894, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType get_appInitOverrideStartType();

  /// @brief Method set_appInitOverrideStartType, addr 0x229a89c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x229a664, size 0x64, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InitAsAppStart, addr 0x229a7b4, size 0x64, virtual false, abstract: false, final false
  inline void InitAsAppStart();

  static inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO* New_ctor();

  /// @brief Method __Init, addr 0x229a818, size 0x6c, virtual false, abstract: false, final false
  inline void __Init(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method .ctor, addr 0x229a884, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
