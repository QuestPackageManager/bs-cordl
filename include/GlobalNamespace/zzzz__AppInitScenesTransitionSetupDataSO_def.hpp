...
public:
  ...
  /// @brief Method .ctor, addr 0x3245ad0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method get_appInitOverrideStartType, addr 0x324decc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType get_appInitOverrideStartType();

  /// @brief Method set_appInitOverrideStartType, addr 0x324ded4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x324dd4c, size 0xe4, virtual false, abstract: false, final false
  inline void Init(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method InitAsDefault, addr 0x324de30, size 0x8, virtual false, abstract: false, final false
  inline void InitAsDefault();

  /// @brief Method InitAsMultiSceneEditor, addr 0x324de38, size 0x8, virtual false, abstract: false, final false
  inline void InitAsMultiSceneEditor();

  /// @brief Method InitDirectlyToMenu, addr 0x324dd44, size 0x8, virtual false, abstract: false, final false
  inline void InitDirectlyToMenu();

  static inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO* New_ctor();

  /// @brief Method .ctor, addr 0x324debc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
