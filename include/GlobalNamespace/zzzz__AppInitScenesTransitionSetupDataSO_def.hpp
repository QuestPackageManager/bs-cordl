...
/// @brief Field <appInitOverrideStartType>k__BackingField, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__appInitOverrideStartType_k__BackingField, put=__cordl_internal_set__appInitOverrideStartType_k__BackingField)) ::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType  _appInitOverrideStartType_k__BackingField;
...
static inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitSceneSetupData* New_ctor(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType  appInitOverrideStartType) ;
...
/// @brief Method .ctor, addr 0x3209da0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType  appInitOverrideStartType) ;

/// @brief Method get_appInitOverrideStartType, addr 0x321219c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType get_appInitOverrideStartType() ;

/// @brief Method set_appInitOverrideStartType, addr 0x32121a4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x321201c, size 0xe4, virtual false, abstract: false, final false
inline void Init(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType  appInitOverrideStartType) ;

/// @brief Method InitAsDefault, addr 0x3212100, size 0x8, virtual false, abstract: false, final false
inline void InitAsDefault() ;

/// @brief Method InitAsMultiSceneEditor, addr 0x3212108, size 0x8, virtual false, abstract: false, final false
inline void InitAsMultiSceneEditor() ;

/// @brief Method InitDirectlyToMenu, addr 0x3212014, size 0x8, virtual false, abstract: false, final false
inline void InitDirectlyToMenu() ;

static inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO* New_ctor() ;

/// @brief Method .ctor, addr 0x321218c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;
