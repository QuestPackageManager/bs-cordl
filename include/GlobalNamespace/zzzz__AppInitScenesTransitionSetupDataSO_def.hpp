...
public:
  ...
  /// @brief Method .ctor, addr 0x2292ab0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method get_appInitOverrideStartType, addr 0x2299ab8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType get_appInitOverrideStartType();

  /// @brief Method set_appInitOverrideStartType, addr 0x2299ac0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Init, addr 0x2299888, size 0x64, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method InitAsAppStart, addr 0x22999d8, size 0x64, virtual false, abstract: false, final false
  inline void InitAsAppStart();

  static inline ::GlobalNamespace::AppInitScenesTransitionSetupDataSO* New_ctor();

  /// @brief Method __Init, addr 0x2299a3c, size 0x6c, virtual false, abstract: false, final false
  inline void __Init(::GlobalNamespace::AppInitScenesTransitionSetupDataSO_AppInitOverrideStartType appInitOverrideStartType);

  /// @brief Method .ctor, addr 0x2299aa8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
