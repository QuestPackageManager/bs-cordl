...
public:
  ...
  /// @brief Method Awake, addr 0x25d1984, size 0x94, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x25d1a18, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
