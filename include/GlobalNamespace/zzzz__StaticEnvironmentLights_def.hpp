...
public:
  ...
  /// @brief Method Awake, addr 0x2704134, size 0x94, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x27041c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
