...
public:
  ...
  /// @brief Method AddData, addr 0x5b9e824, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Stop, addr 0x5b9e5bc, size 0x44, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x5b9e600, size 0x224, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5b9e4fc, size 0xc0, virtual false, abstract: false, final false
