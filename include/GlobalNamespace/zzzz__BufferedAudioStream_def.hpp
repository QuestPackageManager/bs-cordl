...
public:
  ...
  /// @brief Method AddData, addr 0x3f5a7ec, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Stop, addr 0x3f5a5cc, size 0x44, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x3f5a610, size 0x1dc, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3f5a508, size 0xc4, virtual false, abstract: false, final false
