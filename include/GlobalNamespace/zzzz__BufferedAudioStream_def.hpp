...
public:
  ...
  /// @brief Method AddData, addr 0x282194c, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method Stop, addr 0x2821738, size 0x44, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method Update, addr 0x282177c, size 0x1d0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2821674, size 0xc4, virtual false, abstract: false, final false
