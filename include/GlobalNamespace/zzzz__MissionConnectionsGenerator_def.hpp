...
public:
  ...
  /// @brief Method CreateConnectionBetweenNodes, addr 0x58da9cc, size 0xd8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateConnections, addr 0x58da7d4, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateNodeConnections, addr 0x58da2c8, size 0x94, virtual false, abstract: false, final false
  inline void CreateNodeConnections();

  static inline ::GlobalNamespace::MissionConnectionsGenerator* New_ctor();

  /// @brief Method RemoveOldConnections, addr 0x58da35c, size 0x478, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58daac8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get__rootMissionNode, addr 0x58da2b0, size 0x18, virtual false, abstract: false, final false
