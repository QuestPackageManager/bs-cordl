...
// Write type traits
MARK_REF_T(::GlobalNamespace::ShuffleExtensions*);
MARK_GEN_REF_T_PTR(::GlobalNamespace::ShuffleExtensions__PickRandomElementsWithTombstone_d__1_1);
MARK_GEN_REF_T_PTR(::GlobalNamespace::ShuffleExtensions__TakeWithTombstone_d__2_1);
MARK_REF_T(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ShuffleExtensions*, "", "ShuffleExtensions");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x330adbc, size 0x578, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<(System.Int32,System.Int32)>.GetEnumerator, addr 0x330b53c, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<(System.Int32,System.Int32)>.get_Current, addr 0x330b49c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x330b5e4, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x330b4a4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x330b4dc, size 0x60, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x330ad10, size 0xac, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method <>m__Finally1, addr 0x330b3e8, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x330b334, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x330acf0, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method ZipSkipTombstone, addr 0x330ac6c, size 0x84, virtual false, abstract: false, final false
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::ShuffleExtensions) == 0x10, "Size mismatch!");
