...
template<typename T>
class ShuffleExtensions__PickRandomElementsWithTombstone_d__1_1;
}
namespace GlobalNamespace {
template<typename T>
class ShuffleExtensions__TakeWithTombstone_d__2_1;
}
namespace GlobalNamespace {
class ShuffleExtensions__ZipSkipTombstone_d__3;
}
...
MARK_GEN_REF_PTR_T(::GlobalNamespace::ShuffleExtensions__PickRandomElementsWithTombstone_d__1_1);
MARK_GEN_REF_PTR_T(::GlobalNamespace::ShuffleExtensions__TakeWithTombstone_d__2_1);
MARK_REF_PTR_T(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3);
...
class CORDL_TYPE ShuffleExtensions__PickRandomElementsWithTombstone_d__1_1 : public ::System::Object {
public:
// Declarations
...
constexpr ::System::Random* const& __cordl_internal_get___3__random() const;
...
constexpr ::System::Collections::Generic::IEnumerator_1<T>* const& __cordl_internal_get___7__wrap3() const;
...
class CORDL_TYPE ShuffleExtensions__TakeWithTombstone_d__2_1 : public ::System::Object {
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator_T__get_Current)) T  System_Collections_Generic_IEnumerator_T__Current;
...
constexpr ::System::Collections::Generic::IEnumerator_1<T>* const& __cordl_internal_get__enumerator_5__2() const;
...
class CORDL_TYPE ShuffleExtensions__ZipSkipTombstone_d__3 : public ::System::Object {
public:
// Declarations
 __declspec(property(get=System_Collections_Generic_IEnumerator__System_Int32_System_Int32___get_Current)) ::System::ValueTuple_2<int32_t,int32_t>  System_Collections_Generic_IEnumerator__System_Int32_System_Int32___Current;
...
/// @brief Method MoveNext, addr 0x3215988, size 0x578, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerable<(System.Int32,System.Int32)>.GetEnumerator, addr 0x3216108, size 0xa8, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerator<(System.Int32,System.Int32)>.get_Current, addr 0x3216068, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x32161b0, size 0x4, virtual true, abstract: false, final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x3216070, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x32160a8, size 0x60, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x32158dc, size 0xac, virtual true, abstract: false, final true
inline void System_IDisposable_Dispose() ;
...
constexpr ::System::Collections::Generic::IEnumerable_1<int32_t>* const& __cordl_internal_get___3__collection1() const;

constexpr ::System::Collections::Generic::IEnumerable_1<int32_t>*& __cordl_internal_get___3__collection1() ;

constexpr ::System::Collections::Generic::IEnumerable_1<int32_t>* const& __cordl_internal_get___3__collection2() const;
...
constexpr ::System::Collections::Generic::IEnumerator_1<int32_t>* const& __cordl_internal_get__enum1_5__2() const;

constexpr ::System::Collections::Generic::IEnumerator_1<int32_t>*& __cordl_internal_get__enum1_5__2() ;

constexpr ::System::Collections::Generic::IEnumerator_1<int32_t>* const& __cordl_internal_get__enum2_5__3() const;

constexpr ::System::Collections::Generic::IEnumerator_1<int32_t>*& __cordl_internal_get__enum2_5__3() ;

constexpr ::System::Collections::Generic::IEnumerable_1<int32_t>* const& __cordl_internal_get_collection1() const;

constexpr ::System::Collections::Generic::IEnumerable_1<int32_t>*& __cordl_internal_get_collection1() ;

constexpr ::System::Collections::Generic::IEnumerable_1<int32_t>* const& __cordl_internal_get_collection2() const;
...
/// @brief Method <>m__Finally1, addr 0x3215fb4, size 0xb4, virtual false, abstract: false, final false
inline void __m__Finally1() ;

/// @brief Method <>m__Finally2, addr 0x3215f00, size 0xb4, virtual false, abstract: false, final false
inline void __m__Finally2() ;

/// @brief Method .ctor, addr 0x32158bc, size 0x20, virtual false, abstract: false, final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Convert to "::System::Collections::Generic::IEnumerable_1<::System::ValueTuple_2<int32_t,int32_t>>"
constexpr ::System::Collections::Generic::IEnumerable_1<::System::ValueTuple_2<int32_t,int32_t>>* i___System__Collections__Generic__IEnumerable_1___System__ValueTuple_2_int32_t_int32_t__() noexcept;

/// @brief Convert to "::System::Collections::Generic::IEnumerator_1<::System::ValueTuple_2<int32_t,int32_t>>"
constexpr ::System::Collections::Generic::IEnumerator_1<::System::ValueTuple_2<int32_t,int32_t>>* i___System__Collections__Generic__IEnumerator_1___System__ValueTuple_2_int32_t_int32_t__() noexcept;
...
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, _____2__current) == 0x14, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, _____l__initialThreadId) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, ___collection1) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, _____3__collection1) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, ___collection2) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, _____3__collection2) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, ___collection2Tombstone) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, _____3__collection2Tombstone) == 0x44, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, ____enum1_5__2) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, ____enum2_5__3) == 0x50, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3, 0x58>, "Size mismatch!");
...
// Declarations
template<typename T>
using _PickRandomElementsWithTombstone_d__1_1 = ::GlobalNamespace::ShuffleExtensions__PickRandomElementsWithTombstone_d__1_1<T>;

template<typename T>
using _TakeWithTombstone_d__2_1 = ::GlobalNamespace::ShuffleExtensions__TakeWithTombstone_d__2_1<T>;
...
/// @brief Method ZipSkipTombstone, addr 0x3215838, size 0x84, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::IEnumerable_1<::System::ValueTuple_2<int32_t,int32_t>>* ZipSkipTombstone(::System::Collections::Generic::IEnumerable_1<int32_t>*  collection1, ::System::Collections::Generic::IEnumerable_1<int32_t>*  collection2, int32_t  collection2Tombstone) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::ShuffleExtensions__PickRandomElementsWithTombstone_d__1_1, "", "ShuffleExtensions/<PickRandomElementsWithTombstone>d__1`1");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::GlobalNamespace::ShuffleExtensions__TakeWithTombstone_d__2_1, "", "ShuffleExtensions/<TakeWithTombstone>d__2`1");
NEED_NO_BOX(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::ShuffleExtensions__ZipSkipTombstone_d__3*, "", "ShuffleExtensions/<ZipSkipTombstone>d__3");
