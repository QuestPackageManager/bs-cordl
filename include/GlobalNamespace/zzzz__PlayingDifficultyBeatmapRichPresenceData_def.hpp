...
public:
  ...
  /// @brief Field _beatmapKey, offset 0x20, size 0x20
  ...
  /// @brief Method GetDestinationLocalizedString, addr 0x570dc0c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570dd54, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey, ::GlobalNamespace::BeatmapLevel* beatmapLevel);

  /// @brief Method get_apiName, addr 0x570dbdc, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_apiName();

  /// @brief Method get_localizedDescription, addr 0x570dbe4, size 0x28, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Field _beatmapKey, offset: 0x20, size: 0x20, def value: None
...
static_assert(offsetof(::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData, ____beatmapLevel) == 0x40, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::PlayingDifficultyBeatmapRichPresenceData, 0x48>, "Size mismatch!");
