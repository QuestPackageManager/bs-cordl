...
public:
  ...
  /// @brief Method ThreePointsToBox, addr 0x32686dc, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3268b80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
