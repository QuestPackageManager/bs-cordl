...
public:
  ...
  /// @brief Method ThreePointsToBox, addr 0x22b363c, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22b3ad4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
