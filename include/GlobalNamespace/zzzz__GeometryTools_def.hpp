...
public:
  ...
  /// @brief Method ThreePointsToBox, addr 0x31fb888, size 0x4a4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31fbd2c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
