...
public:
  ...
  /// @brief Method ThreePointsToBox, addr 0x108b69c, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x108ba88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
