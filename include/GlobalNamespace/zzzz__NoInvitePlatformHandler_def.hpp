...
public:
  ...
  /// @brief Method OpenInvitePanel, addr 0x14d5f10, size 0x40, virtual true, abstract: false, final true
  inline void OpenInvitePanel();

  /// @brief Method .ctor, addr 0x14d5f50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isSupported, addr 0x14d5f08, size 0x8, virtual true, abstract: false, final true
