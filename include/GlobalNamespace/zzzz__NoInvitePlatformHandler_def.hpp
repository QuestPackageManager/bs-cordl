...
public:
  ...
  /// @brief Method get_isSupported, addr 0x1299bd4, size 0x8, virtual true, abstract: false, final true
  inline bool get_isSupported();

  /// @brief Method OpenInvitePanel, addr 0x1299bdc, size 0x40, virtual true, abstract: false, final true
  inline void OpenInvitePanel();

  static inline ::GlobalNamespace::NoInvitePlatformHandler* New_ctor();

  /// @brief Method .ctor, addr 0x1299c1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
