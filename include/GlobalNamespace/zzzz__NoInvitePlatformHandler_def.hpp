...
public:
  ...
  /// @brief Method OpenInvitePanel, addr 0x36390d0, size 0x38, virtual true, abstract: false, final true
  inline void OpenInvitePanel();

  /// @brief Method .ctor, addr 0x3639108, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isSupported, addr 0x36390c8, size 0x8, virtual true, abstract: false, final true
