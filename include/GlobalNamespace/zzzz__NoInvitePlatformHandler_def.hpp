...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoInvitePlatformHandler", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoInvitePlatformHandler(NoInvitePlatformHandler&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoInvitePlatformHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoInvitePlatformHandler(NoInvitePlatformHandlerconst&) = delete;
