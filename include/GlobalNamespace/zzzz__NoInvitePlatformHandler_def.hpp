...
public:
  ...
  /// @brief Method OpenInvitePanel, addr 0x2355c04, size 0x40, virtual true, abstract: false, final true
  inline void OpenInvitePanel();

  static inline ::GlobalNamespace::NoInvitePlatformHandler* New_ctor();

  /// @brief Method .ctor, addr 0x2355c44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
