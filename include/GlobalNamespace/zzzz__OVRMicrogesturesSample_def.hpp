...
// Write type traits
MARK_REF_T(::GlobalNamespace::OVRMicrogesturesSample*);
MARK_REF_T(::GlobalNamespace::OVRMicrogesturesSample__HighlightIconCoroutine_d__22*);
MARK_REF_T(::GlobalNamespace::OVRMicrogesturesSample__ShowGestureLabel_d__26*);
...
static_assert(sizeof(::GlobalNamespace::OVRMicrogesturesSample__ShowGestureLabel_d__26) == 0x38, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::OVRMicrogesturesSample) == 0xc8, "Size mismatch!");
