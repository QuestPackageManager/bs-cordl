...
public:
  ...
  /// @brief Method .ctor, addr 0xe12f04, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::SliderData* slider);

  /// @brief Method GetCopy, addr 0xe153b8, size 0x4, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xe15014, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <HandleCurrentTimeSliceColorNotesDidFinishTimeSlice>b__1, addr 0xe153bc, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xe154a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <HandleCurrentTimeSliceColorNotesDidFinishTimeSlice>b__17_0, addr 0xe154a8, size 0xb8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xe122dc, size 0x5bc, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfLines);

  /// @brief Method ProcessNote, addr 0xe12898, size 0xd4, virtual false, abstract: false, final false
  inline void ProcessNote(::GlobalNamespace::NoteData* noteData);

  /// @brief Method ProcessSlider, addr 0xe1296c, size 0x184, virtual false, abstract: false, final false
  inline void ProcessSlider(::GlobalNamespace::SliderData* sliderData);

  /// @brief Method ProcessAllRemainingData, addr 0xe12af0, size 0x1fc, virtual false, abstract: false, final false
  inline void ProcessAllRemainingData();

  /// @brief Method HandleCurrentTimeSliceColorNotesDidAddItem, addr 0xe12cec, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCurrentNewTimeSliceAllNotesAndSlidersDidStartNewTimeSlice, addr 0xe12d4c, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCurrentTimeSliceAllNotesAndSlidersDidFinishTimeSlice, addr 0xe12f54, size 0x193c, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method HandleCurrentTimeSliceColorNotesDidFinishTimeSlice, addr 0xe14964, size 0x6b0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandlePerColorTypeTimeSliceContainerDidFinishTimeSlice, addr 0xe1501c, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method SliderHeadPositionOverlapsWithNote, addr 0xe14890, size 0x40, virtual false, abstract: false, final false
  static inline bool SliderHeadPositionOverlapsWithNote(::GlobalNamespace::SliderData* slider, ::GlobalNamespace::NoteData* note);

  /// @brief Method SliderTailPositionOverlapsWithNote, addr 0xe14924, size 0x40, virtual false, abstract: false, final false
  static inline bool SliderTailPositionOverlapsWithNote(::GlobalNamespace::SliderData* slider, ::GlobalNamespace::NoteData* note);

  /// @brief Method SliderHeadPositionOverlapsWithBurstTail, addr 0xe148d0, size 0x54, virtual false, abstract: false, final false
