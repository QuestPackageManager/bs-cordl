...
public:
  ...
  /// @brief Method .ctor, addr 0xe02a1c, size 0x50, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::SliderData* slider);

  /// @brief Method GetCopy, addr 0xe04ed0, size 0x4, virtual true, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xe04b2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <HandleCurrentTimeSliceColorNotesDidFinishTimeSlice>b__1, addr 0xe04ed4, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xe04fb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <HandleCurrentTimeSliceColorNotesDidFinishTimeSlice>b__17_0, addr 0xe04fc0, size 0xb8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0xe01df4, size 0x5bc, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfLines);

  /// @brief Method ProcessNote, addr 0xe023b0, size 0xd4, virtual false, abstract: false, final false
  inline void ProcessNote(::GlobalNamespace::NoteData* noteData);

  /// @brief Method ProcessSlider, addr 0xe02484, size 0x184, virtual false, abstract: false, final false
  inline void ProcessSlider(::GlobalNamespace::SliderData* sliderData);

  /// @brief Method ProcessAllRemainingData, addr 0xe02608, size 0x1fc, virtual false, abstract: false, final false
  inline void ProcessAllRemainingData();

  /// @brief Method HandleCurrentTimeSliceColorNotesDidAddItem, addr 0xe02804, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCurrentNewTimeSliceAllNotesAndSlidersDidStartNewTimeSlice, addr 0xe02864, size 0x1b8, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCurrentTimeSliceAllNotesAndSlidersDidFinishTimeSlice, addr 0xe02a6c, size 0x193c, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method HandleCurrentTimeSliceColorNotesDidFinishTimeSlice, addr 0xe0447c, size 0x6b0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandlePerColorTypeTimeSliceContainerDidFinishTimeSlice, addr 0xe04b34, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method SliderHeadPositionOverlapsWithNote, addr 0xe043a8, size 0x40, virtual false, abstract: false, final false
  static inline bool SliderHeadPositionOverlapsWithNote(::GlobalNamespace::SliderData* slider, ::GlobalNamespace::NoteData* note);

  /// @brief Method SliderTailPositionOverlapsWithNote, addr 0xe0443c, size 0x40, virtual false, abstract: false, final false
  static inline bool SliderTailPositionOverlapsWithNote(::GlobalNamespace::SliderData* slider, ::GlobalNamespace::NoteData* note);

  /// @brief Method SliderHeadPositionOverlapsWithBurstTail, addr 0xe043e8, size 0x54, virtual false, abstract: false, final false
