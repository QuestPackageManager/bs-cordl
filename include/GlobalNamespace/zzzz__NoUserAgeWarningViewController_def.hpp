...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoUserAgeWarningViewController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoUserAgeWarningViewController(NoUserAgeWarningViewController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoUserAgeWarningViewController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoUserAgeWarningViewController(NoUserAgeWarningViewControllerconst&) = delete;
