...
// Write type traits
MARK_REF_T(::GlobalNamespace::FormattedIntListSettingsController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::FormattedIntListSettingsController*, "", "FormattedIntListSettingsController");
...
static_assert(sizeof(::GlobalNamespace::FormattedIntListSettingsController) == 0x50, "Size mismatch!");
