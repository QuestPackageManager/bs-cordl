...
/// @brief Field valueDidChangeEvent, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get_valueDidChangeEvent, put=__cordl_internal_set_valueDidChangeEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::FormattedIntListSettingsController>,int32_t>*  valueDidChangeEvent;

/// @brief Method ApplyValue, addr 0x586ed0c, size 0x30, virtual true, abstract: false, final false
inline void ApplyValue(int32_t  idx) ;

/// @brief Method GetInitValues, addr 0x586ece4, size 0x28, virtual true, abstract: false, final false
inline bool GetInitValues(::ByRef<int32_t>  idx, ::ByRef<int32_t>  numberOfElements) ;

static inline ::GlobalNamespace::FormattedIntListSettingsController* New_ctor() ;

/// @brief Method SetValue, addr 0x586ecd0, size 0x14, virtual false, abstract: false, final false
inline void SetValue(int32_t  value, bool  callCallback) ;

/// @brief Method TextForValue, addr 0x586ed3c, size 0x64, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x586eda0, size 0x50, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_valueDidChangeEvent, addr 0x586eb50, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_valueDidChangeEvent, addr 0x586ec10, size 0xc0, virtual false, abstract: false, final false
