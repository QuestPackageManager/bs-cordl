...
// Type: ::FormattedIntListSettingsController
...
public:
  ...
  /// @brief Method ApplyValue, addr 0x3babe9c, size 0x30, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x3babe74, size 0x28, virtual true, abstract: false, final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::FormattedIntListSettingsController* New_ctor();

  /// @brief Method SetValue, addr 0x3babe60, size 0x14, virtual false, abstract: false, final false
  inline void SetValue(int32_t value, bool callCallback);

  /// @brief Method TextForValue, addr 0x3babecc, size 0x78, virtual true, abstract: false, final false
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityW<::GlobalNamespace::FormattedIntListSettingsController>, int32_t>*> const& __cordl_internal_get_valueDidChangeEvent() const;
  ...
  /// @brief Method .ctor, addr 0x3babf44, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x3babd00, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_valueDidChangeEvent, addr 0x3babdb0, size 0xb0, virtual false, abstract: false, final false
