...
public:
  // Declarations
  /// @brief Method Init, addr 0x26a6434, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26a643c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
