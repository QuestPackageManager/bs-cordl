...
public:
  // Declarations
  /// @brief Method Init, addr 0x234c7b0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x234c7b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
