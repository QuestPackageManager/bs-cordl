...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x278f178, size 0x64, virtual false, abstract: false, final false
  inline ::StringW GetErrorMessage();

  /// @brief Method ToString, addr 0x278f43c, size 0xd4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x278f244, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t _cordl_errno);

  /// @brief Method .ctor, addr 0x278f2b0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::__Interop__Error error);

  /// @brief Method get_Error, addr 0x278f2bc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__Interop__Error get_Error();

  /// @brief Method get_RawErrno, addr 0x278f10c, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetName, addr 0x278fe4c, size 0x164, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CloseDir, addr 0x278f550, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t CloseDir(void* dir);

  /// @brief Method ConvertErrorPalToPlatform, addr 0x278f2c4, size 0x7c, virtual false, abstract: false, final false
  static inline int32_t ConvertErrorPalToPlatform(::GlobalNamespace::__Interop__Error error);

  /// @brief Method ConvertErrorPlatformToPal, addr 0x278f2ac, size 0x4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__Interop__Error ConvertErrorPlatformToPal(int32_t platformErrno);

  /// @brief Method CopyFile, addr 0x278f900, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoubleToString, addr 0x278fdf4, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEGid, addr 0x278f9b4, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEGid();

  /// @brief Method GetEUid, addr 0x278f9b8, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEUid();

  /// @brief Method GetLastErrorInfo, addr 0x278ef88, size 0x68, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__Interop__ErrorInfo GetLastErrorInfo();

  /// @brief Method GetNonCryptographicallySecureRandomBytes, addr 0x278f240, size 0x4, virtual false, abstract: false, final false
  static inline void GetNonCryptographicallySecureRandomBytes(::cordl_internals::Ptr<uint8_t> buffer, int32_t length);

  /// @brief Method GetReadDirRBufferSize, addr 0x278f548, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetReadDirRBufferSize();

  /// @brief Method LChflagsCanSetHiddenFlag, addr 0x278f9bc, size 0x4, virtual false, abstract: false, final false
  static inline int32_t LChflagsCanSetHiddenFlag();

  /// @brief Method LStat, addr 0x278f80c, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t LStat(::StringW path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method LStat, addr 0x278fc68, size 0x158, virtual false, abstract: false, final false
  static inline int32_t LStat(::System::ReadOnlySpan_1<char16_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method LStat, addr 0x278fc4c, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t LStat(ByRef<uint8_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method Link, addr 0x278f9c0, size 0x54, virtual false, abstract: false, final false
  static inline int32_t Link(::StringW source, ::StringW link);

  /// @brief Method MkDir, addr 0x278fa14, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t MkDir(::StringW path, int32_t mode);

  /// @brief Method OpenDir, addr 0x278f514, size 0x34, virtual false, abstract: false, final false
  static inline void* OpenDir(::StringW path);

  /// @brief Method ReadDirR, addr 0x278f54c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadLink, addr 0x278f5b8, size 0x218, virtual false, abstract: false, final false
  static inline ::StringW ReadLink(::StringW path);

  /// @brief Method ReadLink, addr 0x278f56c, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t ReadLink(::StringW path, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t bufferSize);

  /// @brief Method Rename, addr 0x278fa50, size 0x54, virtual false, abstract: false, final false
  static inline int32_t Rename(::StringW oldPath, ::StringW newPath);

  /// @brief Method RmDir, addr 0x278faa4, size 0x34, virtual false, abstract: false, final false
  static inline int32_t RmDir(::StringW path);

  /// @brief Method Stat, addr 0x278f7d0, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t Stat(::StringW path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method Stat, addr 0x278faf4, size 0x158, virtual false, abstract: false, final false
  static inline int32_t Stat(::System::ReadOnlySpan_1<char16_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method Stat, addr 0x278fad8, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t Stat(ByRef<uint8_t> path, ByRef<::GlobalNamespace::__Interop__Sys__FileStatus> output);

  /// @brief Method StrError, addr 0x278f340, size 0xfc, virtual false, abstract: false, final false
  static inline ::StringW StrError(int32_t platformErrno);

  /// @brief Method StrErrorR, addr 0x278f510, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Symlink, addr 0x278f848, size 0xb8, virtual false, abstract: false, final false
  static inline int32_t Symlink(::StringW target, ::StringW linkPath);

  /// @brief Method Unlink, addr 0x278fdc0, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckIo, addr 0x278eff0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIo, addr 0x278ef10, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExceptionForIoErrno, addr 0x278ea18, size 0x4f8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIOException, addr 0x278f080, size 0x8c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetIOException(::GlobalNamespace::__Interop__ErrorInfo errorInfo);

  /// @brief Method GetRandomBytes, addr 0x278f1dc, size 0x64, virtual false, abstract: false, final false
  static inline void GetRandomBytes(::cordl_internals::Ptr<uint8_t> buffer, int32_t length);

  /// @brief Method ThrowExceptionForIoErrno, addr 0x278e9c0, size 0x58, virtual false, abstract: false, final false
