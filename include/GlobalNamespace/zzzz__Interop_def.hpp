...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x596fc9c, size 0x68, virtual false, abstract: false, final false
  inline ::StringW GetErrorMessage();

  /// @brief Method ToString, addr 0x596fee4, size 0xe4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x596fd70, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(int32_t _cordl_errno);

  /// @brief Method .ctor, addr 0x596fde0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::Interop_Error error);

  /// @brief Method get_Error, addr 0x596fdec, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::Interop_Error get_Error();

  /// @brief Method get_RawErrno, addr 0x596fc2c, size 0x70, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetName, addr 0x59708cc, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CloseDir, addr 0x5970020, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t CloseDir(::System::IntPtr dir);

  /// @brief Method ConvertErrorPalToPlatform, addr 0x596fdf4, size 0x4, virtual false, abstract: false, final false
  static inline int32_t ConvertErrorPalToPlatform(::GlobalNamespace::Interop_Error error);

  /// @brief Method ConvertErrorPlatformToPal, addr 0x596fddc, size 0x4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::Interop_Error ConvertErrorPlatformToPal(int32_t platformErrno);

  /// @brief Method CopyFile, addr 0x59703bc, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoubleToString, addr 0x5970868, size 0x18, virtual false, abstract: false, final false
  static inline int32_t DoubleToString(double_t value, uint8_t* format, uint8_t* buffer, int32_t bufferLength);

  /// @brief Method GetEGid, addr 0x5970470, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEGid();

  /// @brief Method GetEUid, addr 0x5970474, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEUid();

  /// @brief Method GetLastErrorInfo, addr 0x596fa7c, size 0x68, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::Interop_ErrorInfo GetLastErrorInfo();

  /// @brief Method GetNonCryptographicallySecureRandomBytes, addr 0x596fd6c, size 0x4, virtual false, abstract: false, final false
  static inline void GetNonCryptographicallySecureRandomBytes(uint8_t* buffer, int32_t length);

  /// @brief Method GetReadDirRBufferSize, addr 0x5970014, size 0x8, virtual false, abstract: false, final false
  static inline int32_t GetReadDirRBufferSize();

  /// @brief Method LChflagsCanSetHiddenFlag, addr 0x5970478, size 0x8, virtual false, abstract: false, final false
  static inline int32_t LChflagsCanSetHiddenFlag();

  /// @brief Method LStat, addr 0x59706f0, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t LStat(::ByRef<uint8_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method LStat, addr 0x5970320, size 0x40, virtual false, abstract: false, final false
  static inline int32_t LStat(::StringW path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method LStat, addr 0x597070c, size 0x124, virtual false, abstract: false, final false
  static inline int32_t LStat(::System::ReadOnlySpan_1<char16_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method Link, addr 0x5970480, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t Link(::StringW source, ::StringW link);

  /// @brief Method MkDir, addr 0x59704dc, size 0x40, virtual false, abstract: false, final false
  static inline int32_t MkDir(::StringW path, int32_t mode);

  /// @brief Method OpenDir, addr 0x596ffdc, size 0x38, virtual false, abstract: false, final false
  static inline ::System::IntPtr OpenDir(::StringW path);

  /// @brief Method ReadDirR, addr 0x597001c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadLink, addr 0x59700ac, size 0x234, virtual false, abstract: false, final false
  static inline ::StringW ReadLink(::StringW path);

  /// @brief Method ReadLink, addr 0x597003c, size 0x70, virtual false, abstract: false, final false
  static inline int32_t ReadLink(::StringW path, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t bufferSize);

  /// @brief Method Rename, addr 0x597051c, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t Rename(::StringW oldPath, ::StringW newPath);

  /// @brief Method RmDir, addr 0x5970578, size 0x38, virtual false, abstract: false, final false
  static inline int32_t RmDir(::StringW path);

  /// @brief Method Stat, addr 0x59705b0, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t Stat(::ByRef<uint8_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method Stat, addr 0x59702e0, size 0x40, virtual false, abstract: false, final false
  static inline int32_t Stat(::StringW path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method Stat, addr 0x59705cc, size 0x124, virtual false, abstract: false, final false
  static inline int32_t Stat(::System::ReadOnlySpan_1<char16_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method StrError, addr 0x596fdf8, size 0xec, virtual false, abstract: false, final false
  static inline ::StringW StrError(int32_t platformErrno);

  /// @brief Method StrErrorR, addr 0x596ffc8, size 0x14, virtual false, abstract: false, final false
  static inline uint8_t* StrErrorR(int32_t platformErrno, uint8_t* buffer, int32_t bufferSize);

  /// @brief Method Symlink, addr 0x5970360, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t Symlink(::StringW target, ::StringW linkPath);

  /// @brief Method Unlink, addr 0x5970830, size 0x38, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckIo, addr 0x596fae4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIo, addr 0x596f9f0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExceptionForIoErrno, addr 0x596f48c, size 0x564, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIOException, addr 0x596fba4, size 0x88, virtual false, abstract: false, final false
  static inline ::System::Exception* GetIOException(::GlobalNamespace::Interop_ErrorInfo errorInfo);

  /// @brief Method GetRandomBytes, addr 0x596fd04, size 0x68, virtual false, abstract: false, final false
  static inline void GetRandomBytes(uint8_t* buffer, int32_t length);

  /// @brief Method ThrowExceptionForIoErrno, addr 0x596f434, size 0x58, virtual false, abstract: false, final false
