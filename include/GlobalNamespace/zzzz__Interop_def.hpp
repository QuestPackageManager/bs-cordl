...
public:
  ...
  /// @brief Method GetErrorMessage, addr 0x3c54438, size 0x64, virtual false, abstract: false, final false
  inline ::StringW GetErrorMessage();

  /// @brief Method ToString, addr 0x3c54684, size 0xd4, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3c54504, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(int32_t _cordl_errno);

  /// @brief Method .ctor, addr 0x3c54570, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::Interop_Error error);

  /// @brief Method get_Error, addr 0x3c5457c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::Interop_Error get_Error();

  /// @brief Method get_RawErrno, addr 0x3c543cc, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method GetName, addr 0x3c54ff0, size 0x124, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CloseDir, addr 0x3c54798, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t CloseDir(::System::IntPtr dir);

  /// @brief Method ConvertErrorPalToPlatform, addr 0x3c54584, size 0x4, virtual false, abstract: false, final false
  static inline int32_t ConvertErrorPalToPlatform(::GlobalNamespace::Interop_Error error);

  /// @brief Method ConvertErrorPlatformToPal, addr 0x3c5456c, size 0x4, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::Interop_Error ConvertErrorPlatformToPal(int32_t platformErrno);

  /// @brief Method CopyFile, addr 0x3c54ae4, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method DoubleToString, addr 0x3c54f98, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEGid, addr 0x3c54b98, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEGid();

  /// @brief Method GetEUid, addr 0x3c54b9c, size 0x4, virtual false, abstract: false, final false
  static inline uint32_t GetEUid();

  /// @brief Method GetLastErrorInfo, addr 0x3c54250, size 0x68, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::Interop_ErrorInfo GetLastErrorInfo();

  /// @brief Method GetNonCryptographicallySecureRandomBytes, addr 0x3c54500, size 0x4, virtual false, abstract: false, final false
  static inline void GetNonCryptographicallySecureRandomBytes(::cordl_internals::Ptr<uint8_t> buffer, int32_t length);

  /// @brief Method GetReadDirRBufferSize, addr 0x3c54790, size 0x4, virtual false, abstract: false, final false
  static inline int32_t GetReadDirRBufferSize();

  /// @brief Method LChflagsCanSetHiddenFlag, addr 0x3c54ba0, size 0x4, virtual false, abstract: false, final false
  static inline int32_t LChflagsCanSetHiddenFlag();

  /// @brief Method LStat, addr 0x3c54e10, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t LStat(::ByRef<uint8_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method LStat, addr 0x3c54a54, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t LStat(::StringW path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method LStat, addr 0x3c54e2c, size 0x138, virtual false, abstract: false, final false
  static inline int32_t LStat(::System::ReadOnlySpan_1<char16_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method Link, addr 0x3c54ba4, size 0x54, virtual false, abstract: false, final false
  static inline int32_t Link(::StringW source, ::StringW link);

  /// @brief Method MkDir, addr 0x3c54bf8, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t MkDir(::StringW path, int32_t mode);

  /// @brief Method OpenDir, addr 0x3c5475c, size 0x34, virtual false, abstract: false, final false
  static inline ::System::IntPtr OpenDir(::StringW path);

  /// @brief Method ReadDirR, addr 0x3c54794, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadLink, addr 0x3c54800, size 0x218, virtual false, abstract: false, final false
  static inline ::StringW ReadLink(::StringW path);

  /// @brief Method ReadLink, addr 0x3c547b4, size 0x4c, virtual false, abstract: false, final false
  static inline int32_t ReadLink(::StringW path, ::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t bufferSize);

  /// @brief Method Rename, addr 0x3c54c34, size 0x54, virtual false, abstract: false, final false
  static inline int32_t Rename(::StringW oldPath, ::StringW newPath);

  /// @brief Method RmDir, addr 0x3c54c88, size 0x34, virtual false, abstract: false, final false
  static inline int32_t RmDir(::StringW path);

  /// @brief Method Stat, addr 0x3c54cbc, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t Stat(::ByRef<uint8_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method Stat, addr 0x3c54a18, size 0x3c, virtual false, abstract: false, final false
  static inline int32_t Stat(::StringW path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method Stat, addr 0x3c54cd8, size 0x138, virtual false, abstract: false, final false
  static inline int32_t Stat(::System::ReadOnlySpan_1<char16_t> path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus> output);

  /// @brief Method StrError, addr 0x3c54588, size 0xfc, virtual false, abstract: false, final false
  static inline ::StringW StrError(int32_t platformErrno);

  /// @brief Method StrErrorR, addr 0x3c54758, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method Symlink, addr 0x3c54a90, size 0x54, virtual false, abstract: false, final false
  static inline int32_t Symlink(::StringW target, ::StringW linkPath);

  /// @brief Method Unlink, addr 0x3c54f64, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CheckIo, addr 0x3c542b8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckIo, addr 0x3c541d8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetExceptionForIoErrno, addr 0x3c53cec, size 0x4ec, virtual false, abstract: false, final false
  ...
  /// @brief Method GetIOException, addr 0x3c54348, size 0x84, virtual false, abstract: false, final false
  static inline ::System::Exception* GetIOException(::GlobalNamespace::Interop_ErrorInfo errorInfo);

  /// @brief Method GetRandomBytes, addr 0x3c5449c, size 0x64, virtual false, abstract: false, final false
  static inline void GetRandomBytes(::cordl_internals::Ptr<uint8_t> buffer, int32_t length);

  /// @brief Method ThrowExceptionForIoErrno, addr 0x3c53c94, size 0x58, virtual false, abstract: false, final false
