...
/// @brief Method GetErrorMessage, addr 0x58fdd30, size 0x68, virtual false, abstract: false, final false
inline ::StringW GetErrorMessage() ;

/// @brief Method ToString, addr 0x58fdf78, size 0xe4, virtual true, abstract: false, final false
inline ::StringW ToString() ;

/// @brief Method .ctor, addr 0x58fde04, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(int32_t  _cordl_errno) ;

/// @brief Method .ctor, addr 0x58fde74, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::Interop_Error  error) ;

/// @brief Method get_Error, addr 0x58fde80, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::Interop_Error get_Error() ;

/// @brief Method get_RawErrno, addr 0x58fdcc0, size 0x70, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method GetName, addr 0x58fe960, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method CloseDir, addr 0x58fe0b4, size 0x1c, virtual false, abstract: false, final false
static inline int32_t CloseDir(::System::IntPtr  dir) ;

/// @brief Method ConvertErrorPalToPlatform, addr 0x58fde88, size 0x4, virtual false, abstract: false, final false
static inline int32_t ConvertErrorPalToPlatform(::GlobalNamespace::Interop_Error  error) ;

/// @brief Method ConvertErrorPlatformToPal, addr 0x58fde70, size 0x4, virtual false, abstract: false, final false
static inline ::GlobalNamespace::Interop_Error ConvertErrorPlatformToPal(int32_t  platformErrno) ;

/// @brief Method CopyFile, addr 0x58fe450, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method DoubleToString, addr 0x58fe8fc, size 0x18, virtual false, abstract: false, final false
static inline int32_t DoubleToString(double_t  value, uint8_t*  format, uint8_t*  buffer, int32_t  bufferLength) ;

/// @brief Method GetEGid, addr 0x58fe504, size 0x4, virtual false, abstract: false, final false
static inline uint32_t GetEGid() ;

/// @brief Method GetEUid, addr 0x58fe508, size 0x4, virtual false, abstract: false, final false
static inline uint32_t GetEUid() ;

/// @brief Method GetLastErrorInfo, addr 0x58fdb10, size 0x68, virtual false, abstract: false, final false
static inline ::GlobalNamespace::Interop_ErrorInfo GetLastErrorInfo() ;

/// @brief Method GetNonCryptographicallySecureRandomBytes, addr 0x58fde00, size 0x4, virtual false, abstract: false, final false
static inline void GetNonCryptographicallySecureRandomBytes(uint8_t*  buffer, int32_t  length) ;

/// @brief Method GetReadDirRBufferSize, addr 0x58fe0a8, size 0x8, virtual false, abstract: false, final false
static inline int32_t GetReadDirRBufferSize() ;

/// @brief Method LChflagsCanSetHiddenFlag, addr 0x58fe50c, size 0x8, virtual false, abstract: false, final false
static inline int32_t LChflagsCanSetHiddenFlag() ;

/// @brief Method LStat, addr 0x58fe784, size 0x1c, virtual false, abstract: false, final false
static inline int32_t LStat(::ByRef<uint8_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method LStat, addr 0x58fe3b4, size 0x40, virtual false, abstract: false, final false
static inline int32_t LStat(::StringW  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method LStat, addr 0x58fe7a0, size 0x124, virtual false, abstract: false, final false
static inline int32_t LStat(::System::ReadOnlySpan_1<char16_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method Link, addr 0x58fe514, size 0x5c, virtual false, abstract: false, final false
static inline int32_t Link(::StringW  source, ::StringW  link) ;

/// @brief Method MkDir, addr 0x58fe570, size 0x40, virtual false, abstract: false, final false
static inline int32_t MkDir(::StringW  path, int32_t  mode) ;

/// @brief Method OpenDir, addr 0x58fe070, size 0x38, virtual false, abstract: false, final false
static inline ::System::IntPtr OpenDir(::StringW  path) ;

/// @brief Method ReadDirR, addr 0x58fe0b0, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method ReadLink, addr 0x58fe140, size 0x234, virtual false, abstract: false, final false
static inline ::StringW ReadLink(::StringW  path) ;

/// @brief Method ReadLink, addr 0x58fe0d0, size 0x70, virtual false, abstract: false, final false
static inline int32_t ReadLink(::StringW  path, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  bufferSize) ;

/// @brief Method Rename, addr 0x58fe5b0, size 0x5c, virtual false, abstract: false, final false
static inline int32_t Rename(::StringW  oldPath, ::StringW  newPath) ;

/// @brief Method RmDir, addr 0x58fe60c, size 0x38, virtual false, abstract: false, final false
static inline int32_t RmDir(::StringW  path) ;

/// @brief Method Stat, addr 0x58fe644, size 0x1c, virtual false, abstract: false, final false
static inline int32_t Stat(::ByRef<uint8_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method Stat, addr 0x58fe374, size 0x40, virtual false, abstract: false, final false
static inline int32_t Stat(::StringW  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method Stat, addr 0x58fe660, size 0x124, virtual false, abstract: false, final false
static inline int32_t Stat(::System::ReadOnlySpan_1<char16_t>  path, ::ByRef<::GlobalNamespace::Sys_Interop_FileStatus>  output) ;

/// @brief Method StrError, addr 0x58fde8c, size 0xec, virtual false, abstract: false, final false
static inline ::StringW StrError(int32_t  platformErrno) ;

/// @brief Method StrErrorR, addr 0x58fe05c, size 0x14, virtual false, abstract: false, final false
static inline uint8_t* StrErrorR(int32_t  platformErrno, uint8_t*  buffer, int32_t  bufferSize) ;

/// @brief Method Symlink, addr 0x58fe3f4, size 0x5c, virtual false, abstract: false, final false
static inline int32_t Symlink(::StringW  target, ::StringW  linkPath) ;

/// @brief Method Unlink, addr 0x58fe8c4, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method CheckIo, addr 0x58fdb78, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method CheckIo, addr 0x58fda84, size 0x8c, virtual false, abstract: false, final false
...
/// @brief Method GetExceptionForIoErrno, addr 0x58fd520, size 0x564, virtual false, abstract: false, final false
...
/// @brief Method GetIOException, addr 0x58fdc38, size 0x88, virtual false, abstract: false, final false
static inline ::System::Exception* GetIOException(::GlobalNamespace::Interop_ErrorInfo  errorInfo) ;

/// @brief Method GetRandomBytes, addr 0x58fdd98, size 0x68, virtual false, abstract: false, final false
static inline void GetRandomBytes(uint8_t*  buffer, int32_t  length) ;

/// @brief Method ThrowExceptionForIoErrno, addr 0x58fd4c8, size 0x58, virtual false, abstract: false, final false
