...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10152)), TypeDefinitionIndex(TypeDefinitionIndex(8482))}
...
public:
  ...
  /// @brief Method Update addr 0x2645cdc size 0xe0 virtual false final false
  inline void Update();

  static inline ::GlobalNamespace::OVRResetOrientation* New_ctor();

  /// @brief Method .ctor addr 0x2645dbc size 0x10 virtual false final false
  inline void _ctor();
