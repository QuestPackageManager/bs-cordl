...
public:
  ...
  /// @brief Method Update, addr 0x5dcffc0, size 0xf0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5dd00b0, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
