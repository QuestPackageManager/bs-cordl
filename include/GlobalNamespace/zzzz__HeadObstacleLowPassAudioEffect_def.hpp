...
// [AddComponentMenu("Beat Saber/Gameplay/HeadObstacleLowPassAudioEffect")]
...
public:
  ...
  /// @brief Method Update, addr 0x5994a40, size 0x7c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5994abc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HeadObstacleLowPassAudioEffect", modifiers: "&&", def_value: None, comment: None }]
