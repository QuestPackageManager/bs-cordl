...
public:
  ...
  /// @brief Method Update, addr 0x57e008c, size 0x7c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57e0108, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
