...
public:
  ...
  /// @brief Method Update, addr 0x58528b4, size 0x7c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5852930, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
