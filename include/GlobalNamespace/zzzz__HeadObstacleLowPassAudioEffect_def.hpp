...
public:
  ...
  /// @brief Method Update, addr 0x2365758, size 0x5c, virtual false, abstract: false, final false
  inline void Update();

  static inline ::GlobalNamespace::HeadObstacleLowPassAudioEffect* New_ctor();

  /// @brief Method .ctor, addr 0x23657b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
