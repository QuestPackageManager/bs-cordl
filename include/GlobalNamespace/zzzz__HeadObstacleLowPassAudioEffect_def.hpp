...
public:
  ...
  /// @brief Method Update, addr 0x3b8d22c, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b8d288, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
