...
public:
  ...
  /// @brief Method Update, addr 0x3b882e0, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b8833c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
