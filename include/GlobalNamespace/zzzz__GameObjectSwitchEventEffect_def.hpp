...
public:
  ...
  /// @brief Method Start addr 0x226f1fc size 0xa8 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x226f2a4 size 0x1c virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleBeatmapEvent addr 0x226f2c0 size 0x18 virtual false final false
  inline void HandleBeatmapEvent(::GlobalNamespace::ColorBoostBeatmapEventData* basicBeatmapEventData);

  /// @brief Method ToggleObjects addr 0x226f2d8 size 0xc4 virtual false final false
  inline void ToggleObjects(bool isBoostOn);

  static inline ::GlobalNamespace::GameObjectSwitchEventEffect* New_ctor();

  /// @brief Method .ctor addr 0x226f39c size 0x8 virtual false final false
  inline void _ctor();
