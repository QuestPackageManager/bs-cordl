...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionTextSliderSelectableStateController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoTransitionTextSliderSelectableStateController(NoTransitionTextSliderSelectableStateController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoTransitionTextSliderSelectableStateController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoTransitionTextSliderSelectableStateController(NoTransitionTextSliderSelectableStateControllerconst&) = delete;
