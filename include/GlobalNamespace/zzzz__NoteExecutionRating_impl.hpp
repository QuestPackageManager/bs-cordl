...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::NoteExecutionRating::*)(float_t, ::GlobalNamespace::NoteData_ScoringType, ::GlobalNamespace::NoteExecutionRating_Rating,
  ...
  constexpr static std::size_t addrs = 0x373ac20;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{},
                     (::i2c::find_method(::i2c::class_of<::GlobalNamespace::NoteExecutionRating*>(),
                                         { ".ctor",
                                           {},
                                           { ::i2c::type_of<float_t>(), ::i2c::type_of<::GlobalNamespace::NoteData_ScoringType>(), ::i2c::type_of<::GlobalNamespace::NoteExecutionRating_Rating>(),
...
inline void GlobalNamespace::NoteExecutionRating::_ctor(float_t time, ::GlobalNamespace::NoteData_ScoringType scoringType, ::GlobalNamespace::NoteExecutionRating_Rating rating, int32_t cutScore,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::NoteExecutionRating*>(),
                                              { ".ctor",
                                                {},
                                                { ::i2c::type_of<float_t>(), ::i2c::type_of<::GlobalNamespace::NoteData_ScoringType>(), ::i2c::type_of<::GlobalNamespace::NoteExecutionRating_Rating>(),
                                                  ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>(), ::i2c::type_of<int32_t>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, time, scoringType, rating, cutScore, beforeCutScore, centerDistanceCutScore, afterCutScore);
}
inline ::GlobalNamespace::NoteExecutionRating* GlobalNamespace::NoteExecutionRating::New_ctor(float_t time, ::GlobalNamespace::NoteData_ScoringType scoringType,
  ...
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::NoteExecutionRating*>(time, scoringType, rating, cutScore, beforeCutScore, centerDistanceCutScore, afterCutScore));
}
// Ctor Parameters []
