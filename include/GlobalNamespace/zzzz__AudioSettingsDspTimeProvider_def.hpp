...
/// @brief Method .ctor, addr 0x570c720, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_dspTime, addr 0x570c6f8, size 0x28, virtual true, abstract: false, final true
