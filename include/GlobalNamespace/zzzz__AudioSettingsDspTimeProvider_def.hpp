...
public:
  ...
  /// @brief Method .ctor, addr 0x577c238, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_dspTime, addr 0x577c210, size 0x28, virtual true, abstract: false, final true
