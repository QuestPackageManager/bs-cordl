...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AudioSettingsDspTimeProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AudioSettingsDspTimeProvider(AudioSettingsDspTimeProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AudioSettingsDspTimeProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AudioSettingsDspTimeProvider(AudioSettingsDspTimeProviderconst&) = delete;
