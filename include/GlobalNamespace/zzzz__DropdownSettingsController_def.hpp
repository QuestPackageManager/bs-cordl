...
public:
  ...
  /// @brief Method HandleDropdownValueDidChange, addr 0x3c128f4, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x3c12828, size 0xcc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3c12628, size 0xc4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x3c12934, size 0x5c, virtual false, abstract: false, final false
  inline void Refresh(bool applyValue);

  /// @brief Method RefreshUI, addr 0x3c126ec, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c12990, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_dropDownValueDidChangeEvent, addr 0x3c124f0, size 0x9c, virtual false, abstract: false, final false
  inline void add_dropDownValueDidChangeEvent(::System::Action* value);

  /// @brief Method remove_dropDownValueDidChangeEvent, addr 0x3c1258c, size 0x9c, virtual false, abstract: false, final false
