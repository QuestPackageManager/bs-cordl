...
public:
  ...
  /// @brief Method HandleDropdownValueDidChange, addr 0x58e2754, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x58e267c, size 0xd8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x58e2474, size 0xc0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x58e2794, size 0x5c, virtual false, abstract: false, final false
  inline void Refresh(bool applyValue);

  /// @brief Method RefreshUI, addr 0x58e2534, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e27f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_dropDownValueDidChangeEvent, addr 0x58e231c, size 0xac, virtual false, abstract: false, final false
  inline void add_dropDownValueDidChangeEvent(::System::Action* value);

  /// @brief Method remove_dropDownValueDidChangeEvent, addr 0x58e23c8, size 0xac, virtual false, abstract: false, final false
