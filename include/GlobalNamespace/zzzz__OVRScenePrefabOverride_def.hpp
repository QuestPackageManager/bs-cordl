...
/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize, addr 0x5d1ff20, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize, addr 0x5d1ff1c, size 0x4, virtual true, abstract: false, final true
inline void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize() ;

/// @brief Method UpdateEditorClassificationIndex, addr 0x5d1ff24, size 0x170, virtual false, abstract: false, final false
inline void UpdateEditorClassificationIndex() ;

/// @brief Method <UpdateEditorClassificationIndex>g__IndexOf|5_0, addr 0x5d20094, size 0x2cc, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d20360, size 0x4c, virtual false, abstract: false, final false
inline void _ctor() ;
