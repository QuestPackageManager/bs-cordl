...
public:
  ...
  /// @brief Method GetUserAuthToken, addr 0x4083b5c, size 0xb8, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::PlatformUserAuthTokenData*>* GetUserAuthToken();

  /// @brief Method GetUserFriendsUserIds, addr 0x4083aa0, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method GetUserInfo, addr 0x4083994, size 0xd0, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::UserInfo*>* GetUserInfo(::System::Threading::CancellationToken ctx);

  /// @brief Method GetUserNamesForUserIds, addr 0x4083c14, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetUsersSystemLanguage, addr 0x4083d20, size 0x5c, virtual true, abstract: false, final true
  inline ::BGLib::Polyglot::Language GetUsersSystemLanguage();

  static inline ::GlobalNamespace::MockPlatformUserModel* New_ctor();

  /// @brief Method RequestXPlatformAccessToken, addr 0x4083c80, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4083d7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_platformUserInfoDidChangeEvent, addr 0x408382c, size 0xb0, virtual true, abstract: false, final true
  inline void add_platformUserInfoDidChangeEvent(::System::Action_1<::GlobalNamespace::UserInfo*>* value);

  /// @brief Method get_CanXPlatformAccessTokenBeCached, addr 0x408398c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_platformUserInfoDidChangeEvent, addr 0x40838dc, size 0xb0, virtual true, abstract: false, final true
