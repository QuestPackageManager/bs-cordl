...
public:
  ...
  /// @brief Method GetUserAuthToken, addr 0x28eeb08, size 0xc0, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::PlatformUserAuthTokenData*>* GetUserAuthToken();

  /// @brief Method GetUserFriendsUserIds, addr 0x28eea28, size 0xe0, virtual true, abstract: false, final true
  ...
  /// @brief Method GetUserInfo, addr 0x28ee914, size 0xd8, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::UserInfo*>* GetUserInfo(::System::Threading::CancellationToken ctx);

  /// @brief Method GetUserNamesForUserIds, addr 0x28eebc8, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method RequestXPlatformAccessToken, addr 0x28eec34, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x28eecd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_platformUserInfoDidChangeEvent, addr 0x28ee7ac, size 0xb0, virtual true, abstract: false, final true
  inline void add_platformUserInfoDidChangeEvent(::System::Action_1<::GlobalNamespace::UserInfo*>* value);

  /// @brief Method get_CanXPlatformAccessTokenBeCached, addr 0x28ee90c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_platformUserInfoDidChangeEvent, addr 0x28ee85c, size 0xb0, virtual true, abstract: false, final true
