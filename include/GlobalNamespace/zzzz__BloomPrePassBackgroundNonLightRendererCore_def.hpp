...
public:
  ...
  /// @brief Method Awake, addr 0x250231c, size 0xc, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x2502438, size 0x114, virtual true, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore* New_ctor();

  /// @brief Method Render, addr 0x250266c, size 0x310, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCustomPropertyBlock, addr 0x25025b0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25014b4, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_customMaterial, addr 0x25025a8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_useCustomMaterial, addr 0x25025a0, size 0x8, virtual false, abstract: false, final false
