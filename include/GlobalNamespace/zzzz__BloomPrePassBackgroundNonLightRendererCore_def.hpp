...
public:
  ...
  /// @brief Method Awake, addr 0x39d8524, size 0xc, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x39d8648, size 0x114, virtual true, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore* New_ctor();

  /// @brief Method Render, addr 0x39d8874, size 0x304, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCustomPropertyBlock, addr 0x39d87c0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39d7700, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_customMaterial, addr 0x39d87b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_useCustomMaterial, addr 0x39d87b0, size 0x8, virtual false, abstract: false, final false
