...
public:
  ...
  /// @brief Method Awake, addr 0x24e8544, size 0xc, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x24e8660, size 0x114, virtual true, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore* New_ctor();

  /// @brief Method Render, addr 0x24e8894, size 0x310, virtual true, abstract: false, final false
  ...
  /// @brief Method SetCustomPropertyBlock, addr 0x24e87d8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24e76dc, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_customMaterial, addr 0x24e87d0, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_useCustomMaterial, addr 0x24e87c8, size 0x8, virtual false, abstract: false, final false
