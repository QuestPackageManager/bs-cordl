...
public:
  ...
  /// @brief Method SetProperty, addr 0x39f3cb0, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39f3d48, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x39f3c98, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method set_color, addr 0x39f3ca4, size 0xc, virtual false, abstract: false, final false
