...
public:
  ...
  /// @brief Method SetProperty, addr 0x56bdcdc, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56bdd94, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x56bdcc4, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method set_color, addr 0x56bdcd0, size 0xc, virtual false, abstract: false, final false
