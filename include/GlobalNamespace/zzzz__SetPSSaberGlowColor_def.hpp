...
public:
  ...
  /// @brief Method Start, addr 0x58b8520, size 0x68, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58b8588, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
