...
public:
  ...
  /// @brief Method Start, addr 0x3be7320, size 0x80, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3be73a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
