...
/// @brief Method Start, addr 0x5845f38, size 0x68, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x5845fa0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
