...
public:
  ...
  /// @brief Method Start, addr 0x24925a0, size 0x84, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2492624, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
