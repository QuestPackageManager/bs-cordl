...
public:
  ...
  /// @brief Method Start, addr 0x261f970, size 0x84, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x261f9f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
