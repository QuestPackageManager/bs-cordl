...
public:
  ...
  /// @brief Method CalculateDisplacementVector, addr 0x3b8f750, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x3b8f67c, size 0xd4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x3b8f7d8, size 0x24, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetValue, addr 0x3b8f7fc, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method SetValue, addr 0x3b8f800, size 0xd4, virtual false, abstract: false, final false
  inline void SetValue(float_t value);

  /// @brief Method TriggerValue, addr 0x3b8f8d4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b8f8d8, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();
