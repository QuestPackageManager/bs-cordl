...
public:
  ...
  /// @brief Method CalculateDisplacementVector, addr 0x26de868, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method OnEnable, addr 0x26de794, size 0xd4, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnValidate, addr 0x26de8f0, size 0x24, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method SetValue, addr 0x26de914, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method SetValue, addr 0x26de918, size 0xd4, virtual false, abstract: false, final false
  inline void SetValue(float_t value);

  /// @brief Method TriggerValue, addr 0x26de9ec, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26de9f0, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor();
