...
/// @brief Method Deserialize, addr 0x367ed48, size 0x94, virtual true, abstract: false, final false
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Init, addr 0x367eef0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Init, addr 0x367eec8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method Obtain, addr 0x367ecdc, size 0x6c, virtual false, abstract: false, final false
static inline ::GlobalNamespace::NoteMissInfoNetSerializable* Obtain() ;

/// @brief Method Serialize, addr 0x367eddc, size 0x94, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x367ee70, size 0x58, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_colorType, addr 0x367ec9c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorType get_colorType() ;

/// @brief Method get_noteLineIndex, addr 0x367ecbc, size 0x8, virtual false, abstract: false, final false
inline int32_t get_noteLineIndex() ;

/// @brief Method get_noteLineLayer, addr 0x367eccc, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::NoteLineLayer get_noteLineLayer() ;

/// @brief Method get_noteTime, addr 0x367ecac, size 0x8, virtual false, abstract: false, final false
inline float_t get_noteTime() ;

/// @brief Method set_colorType, addr 0x367eca4, size 0x8, virtual false, abstract: false, final false
inline void set_colorType(::GlobalNamespace::ColorType  value) ;

/// @brief Method set_noteLineIndex, addr 0x367ecc4, size 0x8, virtual false, abstract: false, final false
inline void set_noteLineIndex(int32_t  value) ;

/// @brief Method set_noteLineLayer, addr 0x367ecd4, size 0x8, virtual false, abstract: false, final false
inline void set_noteLineLayer(::GlobalNamespace::NoteLineLayer  value) ;

/// @brief Method set_noteTime, addr 0x367ecb4, size 0x8, virtual false, abstract: false, final false
