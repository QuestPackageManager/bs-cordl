...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::MultiplayerAvatarAudioController);
MARK_REF_PTR_T(::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4);
// Type: ::<Start>d__4
...
public:
  ...
  __declspec(property(get = __get___4__this, put = __set___4__this))::GlobalNamespace::MultiplayerAvatarAudioController* __4__this;
  ...
  constexpr ::GlobalNamespace::MultiplayerAvatarAudioController*& __get___4__this();

  constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerAvatarAudioController*> const& __get___4__this() const;

  constexpr void __set___4__this(::GlobalNamespace::MultiplayerAvatarAudioController* value);

  static inline ::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4* New_ctor(int32_t __1__state);

  /// @brief Method .ctor addr 0x20d5fa8 size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x20d5fd8 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x20d5fdc size 0xd4 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x20d60b0 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x20d60b8 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x20d60f8 size 0x8 virtual true final true
...
public:
  ...
  ::GlobalNamespace::MultiplayerAvatarAudioController* _____4__this;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4, 0x28>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4, _____1__state) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4, _____4__this) == 0x20, "Offset mismatch!");
...
public:
  // Declarations
  using _Start_d__4 = ::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4;
  ...
  /// @brief Method set_connectedPlayer addr 0x20d5f38 size 0x8 virtual false final false
  inline void set_connectedPlayer(::GlobalNamespace::IConnectedPlayer* value);

  /// @brief Method Start addr 0x20d5f40 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerator* Start();

  static inline ::GlobalNamespace::MultiplayerAvatarAudioController* New_ctor();

  /// @brief Method .ctor addr 0x20d5fd0 size 0x8 virtual false final false
  inline void _ctor();
...
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MultiplayerAvatarAudioController, 0x28>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerAvatarAudioController, ____audioSource) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MultiplayerAvatarAudioController, ____connectedPlayer) == 0x20, "Offset mismatch!");
...
NEED_NO_BOX(::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4);
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__MultiplayerAvatarAudioController___Start_d__4*, "", "MultiplayerAvatarAudioController/<Start>d__4");
