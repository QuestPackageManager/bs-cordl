...
public:
  // Declarations
  /// @brief Method ContainsLayer, addr 0x32677ac, size 0xc, virtual false, abstract: false, final false
  static inline bool ContainsLayer(::UnityEngine::LayerMask layerMask, int32_t layer);

  /// @brief Method CreateTexture2D, addr 0x3267c34, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFixedSeed, addr 0x3267fd8, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetFixedSeed(::UnityEngine::Component* component);

  /// @brief Method GetFixedSeed, addr 0x3267fbc, size 0x1c, virtual false, abstract: false, final false
  static inline int32_t GetFixedSeed(::UnityEngine::GameObject* gameObject);

  /// @brief Method GetFixedSeed, addr 0x3267e54, size 0x168, virtual false, abstract: false, final false
  static inline int32_t GetFixedSeed(::UnityEngine::Transform* transform);

  /// @brief Method GetPath, addr 0x32679ac, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method IsDescendantOf, addr 0x3267888, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method Reflect, addr 0x3267aa8, size 0x18c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion Reflect(::UnityEngine::Quaternion source, ::UnityEngine::Vector3 normal);

  /// @brief Method Rotate, addr 0x3267d90, size 0x48, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector2 Rotate(::UnityEngine::Vector2 vector, float_t rads);

  /// @brief Method SetLocalPositionAndRotation, addr 0x3267954, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method SetSeed, addr 0x3267dd8, size 0x7c, virtual false, abstract: false, final false
  static inline void SetSeed(::UnityEngine::ParticleSystem* particleSystem, uint32_t seed);

  /// @brief Method StartUniqueCoroutine, addr 0x32677b8, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method StopUniqueCoroutine, addr 0x326783c, size 0x4c, virtual false, abstract: false, final false
