...
public:
// Declarations
/// @brief Method ContainsLayer, addr 0x322b2d4, size 0xc, virtual false, abstract: false, final false
static inline bool ContainsLayer(::UnityEngine::LayerMask  layerMask, int32_t  layer) ;

/// @brief Method CreateTexture2D, addr 0x322b75c, size 0x15c, virtual false, abstract: false, final false
...
/// @brief Method GetFixedSeed, addr 0x322bb00, size 0x1c, virtual false, abstract: false, final false
static inline int32_t GetFixedSeed(::UnityEngine::Component*  component) ;

/// @brief Method GetFixedSeed, addr 0x322bae4, size 0x1c, virtual false, abstract: false, final false
static inline int32_t GetFixedSeed(::UnityEngine::GameObject*  gameObject) ;

/// @brief Method GetFixedSeed, addr 0x322b97c, size 0x168, virtual false, abstract: false, final false
static inline int32_t GetFixedSeed(::UnityEngine::Transform*  transform) ;

/// @brief Method GetPath, addr 0x322b4d4, size 0xfc, virtual false, abstract: false, final false
...
/// @brief Method IsDescendantOf, addr 0x322b3b0, size 0xcc, virtual false, abstract: false, final false
...
/// @brief Method Reflect, addr 0x322b5d0, size 0x18c, virtual false, abstract: false, final false
static inline ::UnityEngine::Quaternion Reflect(::UnityEngine::Quaternion  source, ::UnityEngine::Vector3  normal) ;

/// @brief Method Rotate, addr 0x322b8b8, size 0x48, virtual false, abstract: false, final false
static inline ::UnityEngine::Vector2 Rotate(::UnityEngine::Vector2  vector, float_t  rads) ;

/// @brief Method SetLocalPositionAndRotation, addr 0x322b47c, size 0x58, virtual false, abstract: false, final false
...
/// @brief Method SetSeed, addr 0x322b900, size 0x7c, virtual false, abstract: false, final false
static inline void SetSeed(::UnityEngine::ParticleSystem*  particleSystem, uint32_t  seed) ;

/// @brief Method StartUniqueCoroutine, addr 0x322b2e0, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method StopUniqueCoroutine, addr 0x322b364, size 0x4c, virtual false, abstract: false, final false
