...
public:
  // Declarations
  /// @brief Method ContainsLayer addr 0x1f956e4 size 0x38 virtual false final false
  static inline bool ContainsLayer(::UnityEngine::LayerMask layerMask, int32_t layer);

  /// @brief Method StartUniqueCoroutine addr 0x1f9571c size 0x7c virtual false final false
  ...
  /// @brief Method StopUniqueCoroutine addr 0x1f95798 size 0x44 virtual false final false
  ...
  /// @brief Method IsDescendantOf addr 0x1f957dc size 0xcc virtual false final false
  static inline bool IsDescendantOf(::UnityEngine::Transform* transform, ::UnityEngine::Transform* parent);

  /// @brief Method SetLocalPositionAndRotation addr 0x1f958a8 size 0x58 virtual false final false
  ...
  /// @brief Method GetPath addr 0x1f95900 size 0x100 virtual false final false
  static inline ::StringW GetPath(::UnityEngine::Transform* current);

  /// @brief Method Reflect addr 0x1f95a00 size 0x164 virtual false final false
  static inline ::UnityEngine::Quaternion Reflect(::UnityEngine::Quaternion source, ::UnityEngine::Vector3 normal);

  /// @brief Method CreateTexture2D addr 0x1f95b64 size 0x148 virtual false final false
  ...
  /// @brief Method Rotate addr 0x1f95cac size 0x48 virtual false final false
