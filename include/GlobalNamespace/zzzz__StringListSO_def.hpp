...
public:
  ...
  /// @brief Method .ctor, addr 0x22b4ee4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_strings, addr 0x22b4edc, size 0x8, virtual false, abstract: false, final false
