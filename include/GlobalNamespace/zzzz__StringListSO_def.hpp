...
public:
  ...
  /// @brief Method .ctor, addr 0x326a140, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_strings, addr 0x326a138, size 0x8, virtual false, abstract: false, final false
