...
public:
  ...
  /// @brief Method .ctor, addr 0x22b6258, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_strings, addr 0x22b6250, size 0x8, virtual false, abstract: false, final false
