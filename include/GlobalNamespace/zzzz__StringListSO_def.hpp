...
/// @brief Method .ctor, addr 0x322dc68, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_strings, addr 0x322dc60, size 0x8, virtual false, abstract: false, final false
