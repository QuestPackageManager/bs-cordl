...
public:
  ...
  /// @brief Method .ctor, addr 0x108c6f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_strings, addr 0x108c6ec, size 0x8, virtual false, abstract: false, final false
