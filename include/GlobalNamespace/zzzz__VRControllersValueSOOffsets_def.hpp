...
public:
  ...
  /// @brief Method .ctor, addr 0x13ff4a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_positionOffset, addr 0x13ff410, size 0x4c, virtual true, abstract: false, final false
  inline ::UnityEngine::Vector3 get_positionOffset();

  /// @brief Method get_rotationOffset, addr 0x13ff45c, size 0x4c, virtual true, abstract: false, final false
