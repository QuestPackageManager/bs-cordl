...
// "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::XPlatformAccessTokenData>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "__4__this",
// ty: "::GlobalNamespace::PlatformAuthenticationTokenProvider*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "skipCacheRead", ty: "bool", modifiers: "", def_value:
