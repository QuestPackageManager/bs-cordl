...
public:
  ...
  /// @brief Method Awake, addr 0x250da10, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::AudioClipQueue* New_ctor();

  /// @brief Method PlayAudioClipWithDelay, addr 0x250db70, size 0xcc, virtual false, abstract: false, final false
  inline void PlayAudioClipWithDelay(::UnityEngine::AudioClip* audioClip, float_t delay);

  /// @brief Method Update, addr 0x250da30, size 0x140, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x250dc3c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
