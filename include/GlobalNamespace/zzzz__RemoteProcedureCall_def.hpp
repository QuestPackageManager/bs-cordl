...
namespace GlobalNamespace {
template<typename T>
class RemoteProcedureCall_TypeWrapper_1;
}
...
// Declarations
template<typename T>
using TypeWrapper_1 = ::GlobalNamespace::RemoteProcedureCall_TypeWrapper_1<T>;
...
/// @brief Method DeserializeData, addr 0x3244bec, size 0x4, virtual true, abstract: false, final false
inline void DeserializeData(::LiteNetLib::Utils::NetDataReader*  reader, uint32_t  protocolVersion) ;

/// @brief Method Init, addr 0x3244d90, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::IRemoteProcedureCall* Init(int64_t  syncTime) ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Deserialize, addr 0x3244c34, size 0x44, virtual true, abstract: false, final true
inline void LiteNetLib_Utils_INetSerializable_Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Serialize, addr 0x3244bf0, size 0x44, virtual true, abstract: false, final true
...
/// @brief Method Release, addr 0x3244c78, size 0x4, virtual true, abstract: false, final false
inline void Release() ;

/// @brief Method SerializeData, addr 0x3244be8, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3244d98, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_syncTime, addr 0x3244bd8, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method set_syncTime, addr 0x3244be0, size 0x8, virtual false, abstract: false, final false
