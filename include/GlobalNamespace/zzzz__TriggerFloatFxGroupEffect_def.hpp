...
/// @brief Method .ctor, addr 0x57e4998, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method Cleanup, addr 0x57e471c, size 0x1c, virtual false, abstract: false, final false
inline void Cleanup() ;

/// @brief Method HandleFloatFxBeatmapEventCallback, addr 0x57e4960, size 0x38, virtual false, abstract: false, final false
inline void HandleFloatFxBeatmapEventCallback(::GlobalNamespace::FloatFxBeatmapEventData*  currentEvent) ;

static inline ::GlobalNamespace::TriggerFloatFxGroupEffect* New_ctor(::GlobalNamespace::TriggerFloatFxGroupEffect_InitData*  initData, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController) ;
...
/// @brief Method .ctor, addr 0x57e481c, size 0x144, virtual false, abstract: false, final false
