...
public:
  ...
  /// @brief Method .ctor, addr 0x5856890, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Cleanup, addr 0x5856614, size 0x1c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method HandleFloatFxBeatmapEventCallback, addr 0x5856858, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5856714, size 0x144, virtual false, abstract: false, final false
