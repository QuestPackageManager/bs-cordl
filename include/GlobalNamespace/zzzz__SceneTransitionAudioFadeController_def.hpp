...
// Write type traits
MARK_REF_T(::GlobalNamespace::SceneTransitionAudioFadeController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SceneTransitionAudioFadeController*, "", "SceneTransitionAudioFadeController");
...
static_assert(sizeof(::GlobalNamespace::SceneTransitionAudioFadeController) == 0x20, "Size mismatch!");
