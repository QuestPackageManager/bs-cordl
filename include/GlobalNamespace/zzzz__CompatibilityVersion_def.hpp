...
public:
// Declarations
/// @brief Method Get, addr 0x31d3298, size 0x44, virtual false, abstract: false, final false
static inline ::StringW Get() ;

/// @brief Method Length, addr 0x31d32dc, size 0x8, virtual false, abstract: false, final false
static inline int32_t Length() ;

static inline ::GlobalNamespace::CompatibilityVersion* New_ctor() ;

/// @brief Method .ctor, addr 0x31d32e4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
