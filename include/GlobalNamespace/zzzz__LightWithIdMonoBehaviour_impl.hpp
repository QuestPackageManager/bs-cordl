...
//  Writing Method size for method: ::GlobalNamespace::LightWithIdMonoBehaviour.get_groupId
template <>
...
//  Writing Method size for method: ::GlobalNamespace::LightWithIdMonoBehaviour.get_elementId
template <>
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightWithIdMonoBehaviour::*)()>(&::GlobalNamespace::LightWithIdMonoBehaviour::Start)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), { ::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), 13 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightWithIdMonoBehaviour::*)()>(&::GlobalNamespace::LightWithIdMonoBehaviour::OnDisable)> {
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), { ::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), 14 }));
    return ___internal_method;
  }
};
...
constexpr int32_t& GlobalNamespace::LightWithIdMonoBehaviour::__cordl_internal_get__groupId() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____groupId;
}
constexpr int32_t const& GlobalNamespace::LightWithIdMonoBehaviour::__cordl_internal_get__groupId() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____groupId;
}
constexpr void GlobalNamespace::LightWithIdMonoBehaviour::__cordl_internal_set__groupId(int32_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  this->____groupId = value;
}
constexpr int32_t& GlobalNamespace::LightWithIdMonoBehaviour::__cordl_internal_get__elementId() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____elementId;
}
constexpr int32_t const& GlobalNamespace::LightWithIdMonoBehaviour::__cordl_internal_get__elementId() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____elementId;
}
constexpr void GlobalNamespace::LightWithIdMonoBehaviour::__cordl_internal_set__elementId(int32_t value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline int32_t GlobalNamespace::LightWithIdMonoBehaviour::get_groupId() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), { "get_groupId", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method);
}
inline int32_t GlobalNamespace::LightWithIdMonoBehaviour::get_elementId() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), { "get_elementId", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method);
}
...
inline void GlobalNamespace::LightWithIdMonoBehaviour::Start() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), 13 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
inline void GlobalNamespace::LightWithIdMonoBehaviour::OnDisable() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::LightWithIdMonoBehaviour*>(), 14 })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
