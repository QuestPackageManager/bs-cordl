...
// Write type traits
MARK_REF_T(::GlobalNamespace::BTSCharacterDataModel*);
MARK_REF_T(::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*);
MARK_REF_T(::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterDataModel*, "", "BTSCharacterDataModel");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*, "", "BTSCharacterDataModel/AnimationClipWithId");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*, "", "BTSCharacterDataModel/PrefabWithId");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32837a8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x3283798, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();

  /// @brief Method get_prefabAssetReference, addr 0x32837a0, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterDataModel_PrefabWithId) == 0x20, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x32837bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animationClipAssetReference, addr 0x32837b4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetReference* get_animationClipAssetReference();

  /// @brief Method get_id, addr 0x32837ac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BTSCharacterDataModel::AnimationClipWithId, BTSCharacterDataModel::PrefabWithId, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__animationClipsWithIds, put = __cordl_internal_set__animationClipsWithIds)) ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*>
      _animationClipsWithIds;

  /// @brief Field _prefabsWithIds, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get__prefabsWithIds, put = __cordl_internal_set__prefabsWithIds)) ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*> _prefabsWithIds;

  __declspec(property(get = get_animationClipsWithIds)) ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*> animationClipsWithIds;

  __declspec(property(get = get_prefabsWithIds)) ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*> prefabsWithIds;

  static inline ::GlobalNamespace::BTSCharacterDataModel* New_ctor();

  constexpr ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*> const& __cordl_internal_get__animationClipsWithIds() const;

  constexpr ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*>& __cordl_internal_get__animationClipsWithIds();

  constexpr ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*> const& __cordl_internal_get__prefabsWithIds() const;

  constexpr ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*>& __cordl_internal_get__prefabsWithIds();

  constexpr void __cordl_internal_set__animationClipsWithIds(::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*> value);

  constexpr void __cordl_internal_set__prefabsWithIds(::ArrayW<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*> value);

  /// @brief Method .ctor, addr 0x3283794, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animationClipsWithIds, addr 0x328378c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*> get_animationClipsWithIds();

  /// @brief Method get_prefabsWithIds, addr 0x3283784, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*> get_prefabsWithIds();
...
static_assert(sizeof(::GlobalNamespace::BTSCharacterDataModel) == 0x30, "Size mismatch!");
