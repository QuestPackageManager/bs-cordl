...
public:
  ...
  /// @brief Method .ctor, addr 0x31eb8b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x31eb8a0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();

  /// @brief Method get_prefabAssetReference, addr 0x31eb8a8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x31eb8c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animationClipAssetReference, addr 0x31eb8bc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::AddressableAssets::AssetReference* get_animationClipAssetReference();

  /// @brief Method get_id, addr 0x31eb8b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_id();
...
public:
  ...
  /// @brief Method .ctor, addr 0x31eb89c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animationClipsWithIds, addr 0x31eb894, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_prefabsWithIds, addr 0x31eb88c, size 0x8, virtual false, abstract: false, final false
