...
/// @brief Method .ctor, addr 0x31b4da8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_id, addr 0x31b4d98, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;

/// @brief Method get_prefabAssetReference, addr 0x31b4da0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _animationClipAssetReference, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__animationClipAssetReference, put=__cordl_internal_set__animationClipAssetReference)) ::UnityEngine::AddressableAssets::AssetReference*  _animationClipAssetReference;
...
/// @brief Method .ctor, addr 0x31b4dbc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_animationClipAssetReference, addr 0x31b4db4, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::AddressableAssets::AssetReference* get_animationClipAssetReference() ;

/// @brief Method get_id, addr 0x31b4dac, size 0x8, virtual false, abstract: false, final false
inline int32_t get_id() ;
...
/// @brief Field _animationClipsWithIds, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__animationClipsWithIds, put=__cordl_internal_set__animationClipsWithIds)) ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*,::Array<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*>*>  _animationClipsWithIds;

/// @brief Field _prefabsWithIds, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__prefabsWithIds, put=__cordl_internal_set__prefabsWithIds)) ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*,::Array<::GlobalNamespace::BTSCharacterDataModel_PrefabWithId*>*>  _prefabsWithIds;

 __declspec(property(get=get_animationClipsWithIds)) ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*,::Array<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*>*>  animationClipsWithIds;
...
constexpr ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*,::Array<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*>*> const& __cordl_internal_get__animationClipsWithIds() const;

constexpr ::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*,::Array<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*>*>& __cordl_internal_get__animationClipsWithIds() ;
...
constexpr void __cordl_internal_set__animationClipsWithIds(::ArrayW<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*,::Array<::GlobalNamespace::BTSCharacterDataModel_AnimationClipWithId*>*>  value) ;
...
/// @brief Method .ctor, addr 0x31b4d94, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_animationClipsWithIds, addr 0x31b4d8c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_prefabsWithIds, addr 0x31b4d84, size 0x8, virtual false, abstract: false, final false
