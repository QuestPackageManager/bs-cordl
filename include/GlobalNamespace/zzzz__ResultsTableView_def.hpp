...
public:
  ...
  /// @brief Method CellForIdx, addr 0x57b5300, size 0x1e4, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x57b5254, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  static inline ::GlobalNamespace::ResultsTableView* New_ctor();

  /// @brief Method NumberOfCells, addr 0x57b525c, size 0xa4, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetData, addr 0x57b54e4, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b5514, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
