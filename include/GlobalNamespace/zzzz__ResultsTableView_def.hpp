...
public:
  ...
  /// @brief Method CellForIdx, addr 0x266e618, size 0x1d0, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x266e570, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize();

  static inline ::GlobalNamespace::ResultsTableView* New_ctor();

  /// @brief Method NumberOfCells, addr 0x266e578, size 0xa0, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method SetData, addr 0x266e7e8, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x266e814, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
