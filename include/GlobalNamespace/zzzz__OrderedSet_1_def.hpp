...
template<typename T>
class OrderedSet_1_Node;
}
namespace GlobalNamespace {
template<typename T>
struct OrderedSet_1_ProcessOrder;
}
namespace GlobalNamespace {
template<typename T>
class OrderedSet_1__GetEnumerator_d__23;
}
...
/// @brief Field _sortIndices, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__sortIndices, put=__cordl_internal_set__sortIndices)) ::System::Collections::Generic::Dictionary_2<T,::GlobalNamespace::OrderedSet_1_Node<T>*>*  _sortIndices;
