...
public:
  ...
  /// @brief Method OnValidate, addr 0x57e3f40, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e400c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
