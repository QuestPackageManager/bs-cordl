...
public:
  ...
  /// @brief Method OnValidate, addr 0x3b36d84, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b36e58, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
