...
public:
  ...
  /// @brief Method OnValidate, addr 0x5773594, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5773660, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
