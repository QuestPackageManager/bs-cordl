...
public:
  ...
  /// @brief Method OnValidate, addr 0x3b398e4, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b399b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
