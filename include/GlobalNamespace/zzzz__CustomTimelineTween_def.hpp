...
public:
  ...
  /// @brief Method OnValidate, addr 0x3b3430c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b343e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
