...
template<typename T>
constexpr ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteDidPassJumpThreeQuartersEvent*>* const& GlobalNamespace::MirroredNoteController_1<T>::__cordl_internal_get__noteDidPassJumpThreeQuartersEvent() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____noteDidPassJumpThreeQuartersEvent;
}
template<typename T>
...
template<typename T>
constexpr ::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteControllerNoteDidStartDissolvingEvent*>* const& GlobalNamespace::MirroredNoteController_1<T>::__cordl_internal_get__noteDidStartDissolvingEvent() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____noteDidStartDissolvingEvent;
}
template<typename T>
