...
public:
  ...
  /// @brief Method .ctor, addr 0xe98df0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_value, addr 0xe98de4, size 0xc, virtual false, abstract: false, final false
