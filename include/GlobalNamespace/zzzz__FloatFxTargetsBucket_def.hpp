...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FloatFxTargetsBucket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FloatFxTargetsBucket(FloatFxTargetsBucket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FloatFxTargetsBucket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FloatFxTargetsBucket(FloatFxTargetsBucketconst&) = delete;
