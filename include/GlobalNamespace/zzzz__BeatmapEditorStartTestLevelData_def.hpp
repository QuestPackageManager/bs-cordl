...
// Ctor Parameters [CppParam { name: "enabled", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "computeBuffer", ty: "::UnityEngine::ComputeBuffer*", modifiers: "", def_value: None }, CppParam { name: "audioClipFrequency", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "samplesPerOverdrawBucket", ty: "float_t", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "recorderMode", ty: "::GlobalNamespace::VRControllersRecorder_Mode", modifiers: "", def_value: None }, CppParam { name: "positionOffset", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "rotationOffset", ty: "::UnityEngine::Vector3", modifiers: "", def_value: None }, CppParam { name: "headSmoothing", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "controllersSmoothing", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "controllersTimeOffset", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "cameraFov", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "fpfc", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "recordingPath", ty: "::StringW", modifiers: "", def_value: None }]
constexpr BeatmapEditorStartTestLevelData_RecordingData(::GlobalNamespace::VRControllersRecorder_Mode  recorderMode, ::UnityEngine::Vector3  positionOffset, ::UnityEngine::Vector3  rotationOffset, float_t  headSmoothing, float_t  controllersSmoothing, float_t  controllersTimeOffset, float_t  cameraFov, bool  fpfc, ::StringW  recordingPath) noexcept;
...
// Ctor Parameters [CppParam { name: "fpfc", ty: "::GlobalNamespace::BeatmapEditorStartTestLevelData_FpfcData", modifiers: "", def_value: None }, CppParam { name: "overdrawData", ty: "::GlobalNamespace::BeatmapEditorStartTestLevelData_OverdrawData", modifiers: "", def_value: None }, CppParam { name: "recordingData", ty: "::GlobalNamespace::BeatmapEditorStartTestLevelData_RecordingData", modifiers: "", def_value: None }]
constexpr BeatmapEditorStartTestLevelData(::GlobalNamespace::BeatmapEditorStartTestLevelData_FpfcData  fpfc, ::GlobalNamespace::BeatmapEditorStartTestLevelData_OverdrawData  overdrawData, ::GlobalNamespace::BeatmapEditorStartTestLevelData_RecordingData  recordingData) noexcept;
