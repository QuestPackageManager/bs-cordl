...
public:
  ...
  /// @brief Method .ctor, addr 0xe7ddf8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <SaveFromNetSerializable>b__0, addr 0xe7de00, size 0x11c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method get_playersAtGameStart, addr 0xe7d5a8, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>* get_playersAtGameStart();

  /// @brief Method get_localPlayerSpecificSettings, addr 0xe7d5c0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsNetSerializable* get_localPlayerSpecificSettings();

  /// @brief Method set_localPlayerSpecificSettings, addr 0xe7d5c8, size 0x8, virtual false, abstract: false, final false
  inline void set_localPlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettingsNetSerializable* value);

  /// @brief Method get_playersAtGameStartNetSerializable, addr 0xe7d5d0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable* get_playersAtGameStartNetSerializable();

  /// @brief Method set_playersAtGameStartNetSerializable, addr 0xe7d5d8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe7d5e0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayerSpecificSettingsForUserId, addr 0xe7d664, size 0x3a8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsNetSerializable* GetPlayerSpecificSettingsForUserId(::StringW userId);

  /// @brief Method SaveFromNetSerializable, addr 0xe7da0c, size 0x3ec, virtual false, abstract: false, final false
