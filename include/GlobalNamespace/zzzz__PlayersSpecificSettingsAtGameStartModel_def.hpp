...
public:
  ...
  /// @brief Method <SaveFromNetSerializable>b__0, addr 0x10b1780, size 0x11c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10b1778, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPlayerSpecificSettingsForUserId, addr 0x10b0fe4, size 0x3a8, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveFromNetSerializable, addr 0x10b138c, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10b0f60, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method get_localPlayerSpecificSettings, addr 0x10b0f40, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsNetSerializable* get_localPlayerSpecificSettings();

  /// @brief Method get_playersAtGameStart, addr 0x10b0f28, size 0x18, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::IConnectedPlayer*>* get_playersAtGameStart();

  /// @brief Method get_playersAtGameStartNetSerializable, addr 0x10b0f50, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable* get_playersAtGameStartNetSerializable();

  /// @brief Method set_localPlayerSpecificSettings, addr 0x10b0f48, size 0x8, virtual false, abstract: false, final false
  inline void set_localPlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettingsNetSerializable* value);

  /// @brief Method set_playersAtGameStartNetSerializable, addr 0x10b0f58, size 0x8, virtual false, abstract: false, final false
