...
/// @brief Method <SaveFromNetSerializable>b__0, addr 0x31e4aac, size 0x124, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31e4aa8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetPlayerSpecificSettingsForUserId, addr 0x31e4328, size 0x37c, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettingsNetSerializable* GetPlayerSpecificSettingsForUserId(::StringW  userId) ;

static inline ::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel* New_ctor(::GlobalNamespace::IBeatSaberMultiplayerSessionManager*  multiplayerSessionManager, ::GlobalNamespace::PlayerSpecificSettingsNetSerializable*  localPlayerSpecificSettings) ;

/// @brief Method SaveFromNetSerializable, addr 0x31e46a4, size 0x404, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x31e42c0, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method get_localPlayerSpecificSettings, addr 0x31e42a0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettingsNetSerializable* get_localPlayerSpecificSettings() ;

/// @brief Method get_playersAtGameStart, addr 0x31e428c, size 0x14, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::GlobalNamespace::IBeatSaberConnectedPlayer*>* get_playersAtGameStart() ;

/// @brief Method get_playersAtGameStartNetSerializable, addr 0x31e42b0, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable* get_playersAtGameStartNetSerializable() ;

/// @brief Method set_localPlayerSpecificSettings, addr 0x31e42a8, size 0x8, virtual false, abstract: false, final false
inline void set_localPlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettingsNetSerializable*  value) ;

/// @brief Method set_playersAtGameStartNetSerializable, addr 0x31e42b8, size 0x8, virtual false, abstract: false, final false
