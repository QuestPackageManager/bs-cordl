...
public:
  ...
  /// @brief Method <SaveFromNetSerializable>b__0, addr 0x3220714, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3220710, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPlayerSpecificSettingsForUserId, addr 0x321ff90, size 0x37c, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveFromNetSerializable, addr 0x322030c, size 0x404, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x321ff28, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_localPlayerSpecificSettings, addr 0x321ff08, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsNetSerializable* get_localPlayerSpecificSettings();

  /// @brief Method get_playersAtGameStart, addr 0x321fef4, size 0x14, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::IBeatSaberConnectedPlayer*>* get_playersAtGameStart();

  /// @brief Method get_playersAtGameStartNetSerializable, addr 0x321ff18, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable* get_playersAtGameStartNetSerializable();

  /// @brief Method set_localPlayerSpecificSettings, addr 0x321ff10, size 0x8, virtual false, abstract: false, final false
  inline void set_localPlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettingsNetSerializable* value);

  /// @brief Method set_playersAtGameStartNetSerializable, addr 0x321ff20, size 0x8, virtual false, abstract: false, final false
