...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3b6aeec, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <DidActivate>b__8_1, addr 0x3b6af5c, size 0xc, virtual false, abstract: false, final false
  inline ::StringW _DidActivate_b__8_1(::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair p);

  /// @brief Method .ctor, addr 0x3b6af54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x3b6ab48, size 0x224, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleRegionSelectionDropdownDidSelectCell, addr 0x3b6ae48, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b6ad6c, size 0xdc, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method <DidActivate>b__8_0, addr 0x3b6ae94, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b6ae8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didPressContinueButtonEvent, addr 0x3b6a9e8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didPressContinueButtonEvent(::System::Action_1<::GlobalNamespace::SelectRegionViewController_Region>* value);

  /// @brief Method remove_didPressContinueButtonEvent, addr 0x3b6aa98, size 0xb0, virtual false, abstract: false, final false
