...
public:
// Declarations
/// @brief Method .ctor, addr 0x57c2170, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "region", ty: "::GlobalNamespace::SelectRegionViewController_Region", modifiers: "", def_value: None }, CppParam { name: "localizationKey", ty: "::StringW", modifiers: "", def_value: None }]
...
/// @brief Method <DidActivate>b__5_1, addr 0x57c21d4, size 0xc, virtual false, abstract: false, final false
inline ::StringW _DidActivate_b__5_1(::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair  p) ;

/// @brief Method .ctor, addr 0x57c21d0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _regionLocalizationKeys, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__regionLocalizationKeys, put=__cordl_internal_set__regionLocalizationKeys)) ::ArrayW<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair,::Array<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair>*>  _regionLocalizationKeys;
...
/// @brief Method DidActivate, addr 0x57c1d3c, size 0x248, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleRegionSelectionDropdownDidSelectCell, addr 0x57c206c, size 0x44, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57c1f84, size 0xe8, virtual true, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method <DidActivate>b__5_0, addr 0x57c20f4, size 0x7c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair,::Array<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair>*> const& __cordl_internal_get__regionLocalizationKeys() const;

constexpr ::ArrayW<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair,::Array<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair>*>& __cordl_internal_get__regionLocalizationKeys() ;
...
constexpr void __cordl_internal_set__regionLocalizationKeys(::ArrayW<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair,::Array<::GlobalNamespace::SelectRegionViewController_RegionToLocalizationKeyPair>*>  value) ;

constexpr void __cordl_internal_set__regionSelectionDropdown(::UnityW<::HMUI::SimpleTextDropdown>  value) ;

/// @brief Method .ctor, addr 0x57c20b0, size 0x44, virtual false, abstract: false, final false
inline void _ctor() ;
