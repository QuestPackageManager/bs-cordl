...
// Write type traits
MARK_REF_T(::GlobalNamespace::SelectRegionViewController*);
...
static_assert(sizeof(::GlobalNamespace::SelectRegionViewController___c) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies CompletableViewController`1<T>, Region, RegionToLocalizationKeyPair
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__regionLocalizationKeys, put = __cordl_internal_set__regionLocalizationKeys)) ::ArrayW<::GlobalNamespace::RegionToLocalizationKeyPair>
  ...
  constexpr ::ArrayW<::GlobalNamespace::RegionToLocalizationKeyPair> const& __cordl_internal_get__regionLocalizationKeys() const;

  constexpr ::ArrayW<::GlobalNamespace::RegionToLocalizationKeyPair>& __cordl_internal_get__regionLocalizationKeys();
  ...
  constexpr void __cordl_internal_set__regionLocalizationKeys(::ArrayW<::GlobalNamespace::RegionToLocalizationKeyPair> value);
...
static_assert(sizeof(::GlobalNamespace::SelectRegionViewController) == 0x98, "Size mismatch!");
