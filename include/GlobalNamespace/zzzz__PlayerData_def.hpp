...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14717)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(4660)),
// TypeDefinitionIndex(TypeDefinitionIndex(4658))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4628)) CS Name: ::PlayerData*
...
public:
  ...
  /// @brief Method get_playerId addr 0x236be04 size 0x8 virtual false final false
  inline ::StringW get_playerId();

  /// @brief Method set_playerId addr 0x236be0c size 0x8 virtual false final false
  inline void set_playerId(::StringW value);

  /// @brief Method get_playerName addr 0x236be14 size 0x8 virtual false final false
  inline ::StringW get_playerName();

  /// @brief Method set_playerName addr 0x236be1c size 0x8 virtual false final false
  inline void set_playerName(::StringW value);

  /// @brief Method get_shouldShowTutorialPrompt addr 0x236be24 size 0x8 virtual false final false
  inline bool get_shouldShowTutorialPrompt();

  /// @brief Method set_shouldShowTutorialPrompt addr 0x236be2c size 0xc virtual false final false
  inline void set_shouldShowTutorialPrompt(bool value);

  /// @brief Method get_shouldShow360Warning addr 0x236be38 size 0x8 virtual false final false
  inline bool get_shouldShow360Warning();

  /// @brief Method set_shouldShow360Warning addr 0x236be40 size 0xc virtual false final false
  inline void set_shouldShow360Warning(bool value);

  /// @brief Method get_agreedToEula addr 0x236be4c size 0x8 virtual false final false
  inline bool get_agreedToEula();

  /// @brief Method set_agreedToEula addr 0x236be54 size 0xc virtual false final false
  inline void set_agreedToEula(bool value);

  /// @brief Method get_didSelectLanguage addr 0x236be60 size 0x8 virtual false final false
  inline bool get_didSelectLanguage();

  /// @brief Method set_didSelectLanguage addr 0x236be68 size 0xc virtual false final false
  inline void set_didSelectLanguage(bool value);

  /// @brief Method get_agreedToMultiplayerDisclaimer addr 0x236be74 size 0x8 virtual false final false
  inline bool get_agreedToMultiplayerDisclaimer();

  /// @brief Method set_agreedToMultiplayerDisclaimer addr 0x236be7c size 0xc virtual false final false
  inline void set_agreedToMultiplayerDisclaimer(bool value);

  /// @brief Method get_didSelectRegionVersion addr 0x236be88 size 0x8 virtual false final false
  inline int32_t get_didSelectRegionVersion();

  /// @brief Method set_didSelectRegionVersion addr 0x236be90 size 0x8 virtual false final false
  inline void set_didSelectRegionVersion(int32_t value);

  /// @brief Method get_selectedAvatarSystemTypeId addr 0x236be98 size 0x8 virtual false final false
  inline ::StringW get_selectedAvatarSystemTypeId();

  /// @brief Method set_selectedAvatarSystemTypeId addr 0x236bea0 size 0x8 virtual false final false
  inline void set_selectedAvatarSystemTypeId(::StringW value);

  /// @brief Method get_playerAgreements addr 0x236bea8 size 0x8 virtual false final false
  inline ::GlobalNamespace::PlayerAgreements* get_playerAgreements();

  /// @brief Method set_playerAgreements addr 0x236beb0 size 0x8 virtual false final false
  inline void set_playerAgreements(::GlobalNamespace::PlayerAgreements* value);

  /// @brief Method get_lastSelectedBeatmapDifficulty addr 0x236beb8 size 0x8 virtual false final false
  inline ::GlobalNamespace::BeatmapDifficulty get_lastSelectedBeatmapDifficulty();

  /// @brief Method set_lastSelectedBeatmapDifficulty addr 0x236bec0 size 0x8 virtual false final false
  inline void set_lastSelectedBeatmapDifficulty(::GlobalNamespace::BeatmapDifficulty value);

  /// @brief Method get_lastSelectedBeatmapCharacteristic addr 0x236bec8 size 0x8 virtual false final false
  inline ::GlobalNamespace::BeatmapCharacteristicSO* get_lastSelectedBeatmapCharacteristic();

  /// @brief Method set_lastSelectedBeatmapCharacteristic addr 0x236bed0 size 0x8 virtual false final false
  inline void set_lastSelectedBeatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO* value);

  /// @brief Method get_gameplayModifiers addr 0x236bed8 size 0x8 virtual false final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method set_gameplayModifiers addr 0x236bee0 size 0x8 virtual false final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method get_playerSpecificSettings addr 0x236bee8 size 0x8 virtual false final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings();

  /// @brief Method set_playerSpecificSettings addr 0x236bef0 size 0x8 virtual false final false
  inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method get_practiceSettings addr 0x236bef8 size 0x8 virtual false final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method set_practiceSettings addr 0x236bf00 size 0x8 virtual false final false
  inline void set_practiceSettings(::GlobalNamespace::PracticeSettings* value);

  /// @brief Method get_playerAllOverallStatsData addr 0x236bf08 size 0x8 virtual false final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData* get_playerAllOverallStatsData();

  /// @brief Method set_playerAllOverallStatsData addr 0x236bf10 size 0x8 virtual false final false
  inline void set_playerAllOverallStatsData(::GlobalNamespace::PlayerAllOverallStatsData* value);

  /// @brief Method get_levelsStatsData addr 0x236bf18 size 0x8 virtual false final false
  ...
  /// @brief Method set_levelsStatsData addr 0x236bf20 size 0x8 virtual false final false
  ...
  /// @brief Method get_missionsStatsData addr 0x236bf28 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::PlayerMissionStatsData*>* get_missionsStatsData();

  /// @brief Method set_missionsStatsData addr 0x236bf30 size 0x8 virtual false final false
  inline void set_missionsStatsData(::System::Collections::Generic::List_1<::GlobalNamespace::PlayerMissionStatsData*>* value);

  /// @brief Method get_showedMissionHelpIds addr 0x236bf38 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_showedMissionHelpIds();

  /// @brief Method set_showedMissionHelpIds addr 0x236bf40 size 0x8 virtual false final false
  inline void set_showedMissionHelpIds(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method get_guestPlayerNames addr 0x236bf48 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_guestPlayerNames();

  /// @brief Method set_guestPlayerNames addr 0x236bf50 size 0x8 virtual false final false
  inline void set_guestPlayerNames(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method get_colorSchemesSettings addr 0x236bf58 size 0x8 virtual false final false
  inline ::GlobalNamespace::ColorSchemesSettings* get_colorSchemesSettings();

  /// @brief Method set_colorSchemesSettings addr 0x236bf60 size 0x8 virtual false final false
  inline void set_colorSchemesSettings(::GlobalNamespace::ColorSchemesSettings* value);

  /// @brief Method get_overrideEnvironmentSettings addr 0x236bf68 size 0x8 virtual false final false
  inline ::GlobalNamespace::OverrideEnvironmentSettings* get_overrideEnvironmentSettings();

  /// @brief Method set_overrideEnvironmentSettings addr 0x236bf70 size 0x8 virtual false final false
  inline void set_overrideEnvironmentSettings(::GlobalNamespace::OverrideEnvironmentSettings* value);

  /// @brief Method get_favoritesLevelIds addr 0x236bf78 size 0x8 virtual false final false
  inline ::System::Collections::Generic::HashSet_1<::StringW>* get_favoritesLevelIds();

  /// @brief Method set_favoritesLevelIds addr 0x236bf80 size 0x8 virtual false final false
  inline void set_favoritesLevelIds(::System::Collections::Generic::HashSet_1<::StringW>* value);

  /// @brief Method get_multiplayerModeSettings addr 0x236bf88 size 0x8 virtual false final false
  inline ::GlobalNamespace::MultiplayerModeSettings* get_multiplayerModeSettings();

  /// @brief Method set_multiplayerModeSettings addr 0x236bf90 size 0x8 virtual false final false
  inline void set_multiplayerModeSettings(::GlobalNamespace::MultiplayerModeSettings* value);

  /// @brief Method get_userAgeCategory addr 0x236bf98 size 0x8 virtual false final false
  inline ::GlobalNamespace::UserAgeCategory get_userAgeCategory();

  /// @brief Method set_userAgeCategory addr 0x236bfa0 size 0x8 virtual false final false
  inline void set_userAgeCategory(::GlobalNamespace::UserAgeCategory value);

  /// @brief Method get_desiredSensitivityFlag addr 0x236bfa8 size 0x8 virtual false final false
  inline ::GlobalNamespace::PlayerSensitivityFlag get_desiredSensitivityFlag();

  /// @brief Method set_desiredSensitivityFlag addr 0x236bfb0 size 0x8 virtual false final false
  inline void set_desiredSensitivityFlag(::GlobalNamespace::PlayerSensitivityFlag value);

  /// @brief Method get_currentDlcPromoDisplayCount addr 0x236bfb8 size 0x8 virtual false final false
  inline int32_t get_currentDlcPromoDisplayCount();

  /// @brief Method set_currentDlcPromoDisplayCount addr 0x236bfc0 size 0x8 virtual false final false
  inline void set_currentDlcPromoDisplayCount(int32_t value);

  /// @brief Method get_currentDlcPromoId addr 0x236bfc8 size 0x8 virtual false final false
  inline ::StringW get_currentDlcPromoId();

  /// @brief Method set_currentDlcPromoId addr 0x236bfd0 size 0x8 virtual false final false
  inline void set_currentDlcPromoId(::StringW value);

  /// @brief Method add_favoriteLevelsSetDidChangeEvent addr 0x236bfd8 size 0x9c virtual false final false
  inline void add_favoriteLevelsSetDidChangeEvent(::System::Action* value);

  /// @brief Method remove_favoriteLevelsSetDidChangeEvent addr 0x236c074 size 0x9c virtual false final false
  inline void remove_favoriteLevelsSetDidChangeEvent(::System::Action* value);

  /// @brief Method add_didIncreaseNumberOfGameplaysEvent addr 0x236c110 size 0x9c virtual false final false
  inline void add_didIncreaseNumberOfGameplaysEvent(::System::Action* value);

  /// @brief Method remove_didIncreaseNumberOfGameplaysEvent addr 0x236c1ac size 0x9c virtual false final false
  ...
  /// @brief Method .ctor addr 0x236c248 size 0x2d0 virtual false final false
  ...
  /// @brief Method .ctor addr 0x236c518 size 0x410 virtual false final false
  ...
  /// @brief Method SetNewDlcPromo addr 0x236c928 size 0xc virtual false final false
  inline void SetNewDlcPromo(::StringW dlcPromoId);

  /// @brief Method IncreaseCurrentDlcPromoDisplayCount addr 0x236c934 size 0x10 virtual false final false
  inline void IncreaseCurrentDlcPromoDisplayCount();

  /// @brief Method GetPlayerLevelStatsData addr 0x236c944 size 0x264 virtual false final false
  inline ::GlobalNamespace::PlayerLevelStatsData* GetPlayerLevelStatsData(::GlobalNamespace::IDifficultyBeatmap* difficultyBeatmap);

  /// @brief Method GetPlayerLevelStatsData addr 0x236cba8 size 0x104 virtual false final false
  ...
  /// @brief Method GetPlayerMissionStatsData addr 0x236ccac size 0x230 virtual false final false
  inline ::GlobalNamespace::PlayerMissionStatsData* GetPlayerMissionStatsData(::StringW missionId);

  /// @brief Method WasMissionHelpShowed addr 0x236cedc size 0x5c virtual false final false
  inline bool WasMissionHelpShowed(::GlobalNamespace::MissionHelpSO* missionHelp);

  /// @brief Method MissionHelpWasShowed addr 0x236cf38 size 0xd8 virtual false final false
  inline void MissionHelpWasShowed(::GlobalNamespace::MissionHelpSO* missionHelp);

  /// @brief Method IncreaseNumberOfGameplays addr 0x236d010 size 0x40 virtual false final false
  inline void IncreaseNumberOfGameplays(::GlobalNamespace::PlayerLevelStatsData* playerLevelStats);

  /// @brief Method IsLevelUserFavorite addr 0x236d050 size 0xcc virtual false final false
  inline bool IsLevelUserFavorite(::GlobalNamespace::IPreviewBeatmapLevel* level);

  /// @brief Method AddLevelToFavorites addr 0x236d11c size 0x100 virtual false final false
  inline void AddLevelToFavorites(::GlobalNamespace::IPreviewBeatmapLevel* level);

  /// @brief Method RemoveLevelFromFavorites addr 0x236d21c size 0x100 virtual false final false
  inline void RemoveLevelFromFavorites(::GlobalNamespace::IPreviewBeatmapLevel* level);

  /// @brief Method MarkTutorialAsShown addr 0x236d31c size 0x8 virtual false final false
  inline void MarkTutorialAsShown();

  /// @brief Method Mark360WarningAsShown addr 0x236d324 size 0x8 virtual false final false
  inline void Mark360WarningAsShown();

  /// @brief Method MarkEulaAsAgreed addr 0x236d32c size 0x20 virtual false final false
  inline void MarkEulaAsAgreed();

  /// @brief Method MarkLanguageAsSelected addr 0x236d34c size 0xc virtual false final false
  inline void MarkLanguageAsSelected();

  /// @brief Method MarkRegionAsSelected addr 0x236d358 size 0x8 virtual false final false
  inline void MarkRegionAsSelected(int32_t version);

  /// @brief Method SelectAvatarSystemTypeId addr 0x236d360 size 0x8 virtual false final false
  inline void SelectAvatarSystemTypeId(::StringW selectedAvatarSystemTypeId);

  /// @brief Method MarkMultiplayerDisclaimerAsAgreed addr 0x236d368 size 0xc virtual false final false
  inline void MarkMultiplayerDisclaimerAsAgreed();

  /// @brief Method MarkPrivacyPolicyAsAgreed addr 0x236d374 size 0x20 virtual false final false
  inline void MarkPrivacyPolicyAsAgreed();

  /// @brief Method MarkHealthAndSafetyAsAgreed addr 0x236d394 size 0x20 virtual false final false
  inline void MarkHealthAndSafetyAsAgreed();

  /// @brief Method AddGuestPlayerName addr 0x236d3b4 size 0x158 virtual false final false
  inline void AddGuestPlayerName(::StringW guestPlayerName);

  /// @brief Method DeleteAllGuestPlayers addr 0x236d50c size 0x70 virtual false final false
  inline void DeleteAllGuestPlayers();

  /// @brief Method SetLastSelectedBeatmapDifficulty addr 0x236d57c size 0x8 virtual false final false
  inline void SetLastSelectedBeatmapDifficulty(::GlobalNamespace::BeatmapDifficulty beatmapDifficulty);

  /// @brief Method SetLastSelectedBeatmapCharacteristic addr 0x236d584 size 0x8 virtual false final false
  inline void SetLastSelectedBeatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic);

  /// @brief Method SetGameplayModifiers addr 0x236d58c size 0x8 virtual false final false
  inline void SetGameplayModifiers(::GlobalNamespace::GameplayModifiers* newGameplayModifiers);

  /// @brief Method SetPlayerSpecificSettings addr 0x236d594 size 0x8 virtual false final false
  inline void SetPlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* newPlayerSpecificSettings);

  /// @brief Method SetMultiplayerModeSettings addr 0x236d59c size 0x8 virtual false final false
  inline void SetMultiplayerModeSettings(::GlobalNamespace::MultiplayerModeSettings* multiplayerModeSettings);

  /// @brief Method DidSelectRegion addr 0x236d5a4 size 0x10 virtual false final false
