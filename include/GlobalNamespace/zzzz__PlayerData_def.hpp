...
public:
  ...
  /// @brief Method AddGuestPlayerName, addr 0x26f457c, size 0x150, virtual false, abstract: false, final false
  inline void AddGuestPlayerName(::StringW guestPlayerName);

  /// @brief Method AddLevelToFavorites, addr 0x26f43a8, size 0x90, virtual false, abstract: false, final false
  inline void AddLevelToFavorites(::GlobalNamespace::BeatmapLevel* level);

  /// @brief Method DeleteAllGuestPlayers, addr 0x26f46cc, size 0x70, virtual false, abstract: false, final false
  inline void DeleteAllGuestPlayers();

  /// @brief Method DidSelectRegion, addr 0x26f4764, size 0x10, virtual false, abstract: false, final false
  inline bool DidSelectRegion();

  /// @brief Method GetOrCreatePlayerLevelStatsData, addr 0x26f3d48, size 0x11c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerLevelStatsData* GetOrCreatePlayerLevelStatsData(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method GetOrCreatePlayerLevelStatsData, addr 0x26f3f34, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method GetOrCreatePlayerMissionStatsData, addr 0x26f3f88, size 0x218, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerMissionStatsData* GetOrCreatePlayerMissionStatsData(::StringW missionId);

  /// @brief Method IncreaseCurrentDlcPromoDisplayCount, addr 0x26f3d38, size 0x10, virtual false, abstract: false, final false
  inline void IncreaseCurrentDlcPromoDisplayCount();

  /// @brief Method IncreaseNumberOfGameplays, addr 0x26f4300, size 0x3c, virtual false, abstract: false, final false
  inline void IncreaseNumberOfGameplays(::GlobalNamespace::PlayerLevelStatsData* playerLevelStats);

  /// @brief Method IsLevelUserFavorite, addr 0x26f434c, size 0x5c, virtual false, abstract: false, final false
  inline bool IsLevelUserFavorite(::GlobalNamespace::BeatmapLevel* level);

  /// @brief Method Mark360WarningAsShown, addr 0x26f44d0, size 0x8, virtual false, abstract: false, final false
  inline void Mark360WarningAsShown();

  /// @brief Method MarkEulaAsAgreed, addr 0x26f44d8, size 0x3c, virtual false, abstract: false, final false
  inline void MarkEulaAsAgreed();

  /// @brief Method MarkHealthAndSafetyAsAgreed, addr 0x26f455c, size 0x20, virtual false, abstract: false, final false
  inline void MarkHealthAndSafetyAsAgreed();

  /// @brief Method MarkLanguageAsSelected, addr 0x26f4514, size 0xc, virtual false, abstract: false, final false
  inline void MarkLanguageAsSelected();

  /// @brief Method MarkMultiplayerDisclaimerAsAgreed, addr 0x26f4530, size 0xc, virtual false, abstract: false, final false
  inline void MarkMultiplayerDisclaimerAsAgreed();

  /// @brief Method MarkPrivacyPolicyAsAgreed, addr 0x26f453c, size 0x20, virtual false, abstract: false, final false
  inline void MarkPrivacyPolicyAsAgreed();

  /// @brief Method MarkRegionAsSelected, addr 0x26f4520, size 0x8, virtual false, abstract: false, final false
  inline void MarkRegionAsSelected(int32_t version);

  /// @brief Method MarkTutorialAsShown, addr 0x26f44c8, size 0x8, virtual false, abstract: false, final false
  inline void MarkTutorialAsShown();

  /// @brief Method MissionHelpWasShowed, addr 0x26f422c, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveLevelFromFavorites, addr 0x26f4438, size 0x90, virtual false, abstract: false, final false
  inline void RemoveLevelFromFavorites(::GlobalNamespace::BeatmapLevel* level);

  /// @brief Method ResetDlcPromoDisplayCount, addr 0x26f3d30, size 0x8, virtual false, abstract: false, final false
  inline void ResetDlcPromoDisplayCount();

  /// @brief Method SelectAvatarSystemTypeId, addr 0x26f4528, size 0x8, virtual false, abstract: false, final false
  inline void SelectAvatarSystemTypeId(::StringW selectedAvatarSystemTypeId);

  /// @brief Method SetGameplayModifiers, addr 0x26f474c, size 0x8, virtual false, abstract: false, final false
  inline void SetGameplayModifiers(::GlobalNamespace::GameplayModifiers* newGameplayModifiers);

  /// @brief Method SetLastSelectedBeatmapCharacteristic, addr 0x26f4744, size 0x8, virtual false, abstract: false, final false
  inline void SetLastSelectedBeatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO* beatmapCharacteristic);

  /// @brief Method SetLastSelectedBeatmapDifficulty, addr 0x26f473c, size 0x8, virtual false, abstract: false, final false
  inline void SetLastSelectedBeatmapDifficulty(::GlobalNamespace::BeatmapDifficulty beatmapDifficulty);

  /// @brief Method SetMultiplayerModeSettings, addr 0x26f475c, size 0x8, virtual false, abstract: false, final false
  inline void SetMultiplayerModeSettings(::GlobalNamespace::MultiplayerModeSettings* multiplayerModeSettings);

  /// @brief Method SetNewDlcPromo, addr 0x26f3d24, size 0xc, virtual false, abstract: false, final false
  inline void SetNewDlcPromo(::StringW dlcPromoId);

  /// @brief Method SetPlayerSpecificSettings, addr 0x26f4754, size 0x8, virtual false, abstract: false, final false
  inline void SetPlayerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* newPlayerSpecificSettings);

  /// @brief Method ShouldForceApplySensitivity, addr 0x26f3d14, size 0x10, virtual false, abstract: false, final false
  inline bool ShouldForceApplySensitivity();

  /// @brief Method TryGetPlayerLevelStatsData, addr 0x26f3ea0, size 0x94, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerLevelStatsData* TryGetPlayerLevelStatsData(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey);

  /// @brief Method WasMissionHelpShowed, addr 0x26f41d0, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f35c0, size 0x294, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26f3904, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didIncreaseNumberOfGameplaysEvent, addr 0x26f3488, size 0x9c, virtual false, abstract: false, final false
  inline void add_didIncreaseNumberOfGameplaysEvent(::System::Action* value);

  /// @brief Method add_favoriteLevelsSetDidChangeEvent, addr 0x26f3350, size 0x9c, virtual false, abstract: false, final false
  inline void add_favoriteLevelsSetDidChangeEvent(::System::Action* value);

  /// @brief Method get_agreedToEula, addr 0x26f31c4, size 0x8, virtual false, abstract: false, final false
  inline bool get_agreedToEula();

  /// @brief Method get_agreedToMultiplayerDisclaimer, addr 0x26f31ec, size 0x8, virtual false, abstract: false, final false
  inline bool get_agreedToMultiplayerDisclaimer();

  /// @brief Method get_colorSchemesSettings, addr 0x26f32d0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorSchemesSettings* get_colorSchemesSettings();

  /// @brief Method get_currentDlcPromoDisplayCount, addr 0x26f3330, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_currentDlcPromoDisplayCount();

  /// @brief Method get_currentDlcPromoId, addr 0x26f3340, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_currentDlcPromoId();

  /// @brief Method get_desiredSensitivityFlag, addr 0x26f3320, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSensitivityFlag get_desiredSensitivityFlag();

  /// @brief Method get_didSelectLanguage, addr 0x26f31d8, size 0x8, virtual false, abstract: false, final false
  inline bool get_didSelectLanguage();

  /// @brief Method get_didSelectRegionVersion, addr 0x26f3200, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_didSelectRegionVersion();

  /// @brief Method get_favoritesLevelIds, addr 0x26f32f0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::HashSet_1<::StringW>* get_favoritesLevelIds();

  /// @brief Method get_gameplayModifiers, addr 0x26f3250, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_guestPlayerNames, addr 0x26f32c0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_guestPlayerNames();

  /// @brief Method get_lastSelectedBeatmapCharacteristic, addr 0x26f3240, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_lastSelectedBeatmapCharacteristic();

  /// @brief Method get_lastSelectedBeatmapDifficulty, addr 0x26f3230, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_lastSelectedBeatmapDifficulty();

  /// @brief Method get_levelsStatsData, addr 0x26f3290, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_missionsStatsData, addr 0x26f32a0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::GlobalNamespace::PlayerMissionStatsData*>* get_missionsStatsData();

  /// @brief Method get_multiplayerModeSettings, addr 0x26f3300, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MultiplayerModeSettings* get_multiplayerModeSettings();

  /// @brief Method get_overrideEnvironmentSettings, addr 0x26f32e0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OverrideEnvironmentSettings* get_overrideEnvironmentSettings();

  /// @brief Method get_playerAgreements, addr 0x26f3220, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAgreements* get_playerAgreements();

  /// @brief Method get_playerAllOverallStatsData, addr 0x26f3280, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerAllOverallStatsData* get_playerAllOverallStatsData();

  /// @brief Method get_playerId, addr 0x26f317c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_playerId();

  /// @brief Method get_playerName, addr 0x26f318c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_playerName();

  /// @brief Method get_playerSpecificSettings, addr 0x26f3260, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings();

  /// @brief Method get_practiceSettings, addr 0x26f3270, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method get_selectedAvatarSystemTypeId, addr 0x26f3210, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_selectedAvatarSystemTypeId();

  /// @brief Method get_shouldShow360Warning, addr 0x26f31b0, size 0x8, virtual false, abstract: false, final false
  inline bool get_shouldShow360Warning();

  /// @brief Method get_shouldShowTutorialPrompt, addr 0x26f319c, size 0x8, virtual false, abstract: false, final false
  inline bool get_shouldShowTutorialPrompt();

  /// @brief Method get_showedMissionHelpIds, addr 0x26f32b0, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_showedMissionHelpIds();

  /// @brief Method get_userAgeCategory, addr 0x26f3310, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::UserAgeCategory get_userAgeCategory();

  /// @brief Method remove_didIncreaseNumberOfGameplaysEvent, addr 0x26f3524, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didIncreaseNumberOfGameplaysEvent(::System::Action* value);

  /// @brief Method remove_favoriteLevelsSetDidChangeEvent, addr 0x26f33ec, size 0x9c, virtual false, abstract: false, final false
  inline void remove_favoriteLevelsSetDidChangeEvent(::System::Action* value);

  /// @brief Method set_agreedToEula, addr 0x26f31cc, size 0xc, virtual false, abstract: false, final false
  inline void set_agreedToEula(bool value);

  /// @brief Method set_agreedToMultiplayerDisclaimer, addr 0x26f31f4, size 0xc, virtual false, abstract: false, final false
  inline void set_agreedToMultiplayerDisclaimer(bool value);

  /// @brief Method set_colorSchemesSettings, addr 0x26f32d8, size 0x8, virtual false, abstract: false, final false
  inline void set_colorSchemesSettings(::GlobalNamespace::ColorSchemesSettings* value);

  /// @brief Method set_currentDlcPromoDisplayCount, addr 0x26f3338, size 0x8, virtual false, abstract: false, final false
  inline void set_currentDlcPromoDisplayCount(int32_t value);

  /// @brief Method set_currentDlcPromoId, addr 0x26f3348, size 0x8, virtual false, abstract: false, final false
  inline void set_currentDlcPromoId(::StringW value);

  /// @brief Method set_desiredSensitivityFlag, addr 0x26f3328, size 0x8, virtual false, abstract: false, final false
  inline void set_desiredSensitivityFlag(::GlobalNamespace::PlayerSensitivityFlag value);

  /// @brief Method set_didSelectLanguage, addr 0x26f31e0, size 0xc, virtual false, abstract: false, final false
  inline void set_didSelectLanguage(bool value);

  /// @brief Method set_didSelectRegionVersion, addr 0x26f3208, size 0x8, virtual false, abstract: false, final false
  inline void set_didSelectRegionVersion(int32_t value);

  /// @brief Method set_favoritesLevelIds, addr 0x26f32f8, size 0x8, virtual false, abstract: false, final false
  inline void set_favoritesLevelIds(::System::Collections::Generic::HashSet_1<::StringW>* value);

  /// @brief Method set_gameplayModifiers, addr 0x26f3258, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_guestPlayerNames, addr 0x26f32c8, size 0x8, virtual false, abstract: false, final false
  inline void set_guestPlayerNames(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_lastSelectedBeatmapCharacteristic, addr 0x26f3248, size 0x8, virtual false, abstract: false, final false
  inline void set_lastSelectedBeatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO* value);

  /// @brief Method set_lastSelectedBeatmapDifficulty, addr 0x26f3238, size 0x8, virtual false, abstract: false, final false
  inline void set_lastSelectedBeatmapDifficulty(::GlobalNamespace::BeatmapDifficulty value);

  /// @brief Method set_levelsStatsData, addr 0x26f3298, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_missionsStatsData, addr 0x26f32a8, size 0x8, virtual false, abstract: false, final false
  inline void set_missionsStatsData(::System::Collections::Generic::List_1<::GlobalNamespace::PlayerMissionStatsData*>* value);

  /// @brief Method set_multiplayerModeSettings, addr 0x26f3308, size 0x8, virtual false, abstract: false, final false
  inline void set_multiplayerModeSettings(::GlobalNamespace::MultiplayerModeSettings* value);

  /// @brief Method set_overrideEnvironmentSettings, addr 0x26f32e8, size 0x8, virtual false, abstract: false, final false
  inline void set_overrideEnvironmentSettings(::GlobalNamespace::OverrideEnvironmentSettings* value);

  /// @brief Method set_playerAgreements, addr 0x26f3228, size 0x8, virtual false, abstract: false, final false
  inline void set_playerAgreements(::GlobalNamespace::PlayerAgreements* value);

  /// @brief Method set_playerAllOverallStatsData, addr 0x26f3288, size 0x8, virtual false, abstract: false, final false
  inline void set_playerAllOverallStatsData(::GlobalNamespace::PlayerAllOverallStatsData* value);

  /// @brief Method set_playerId, addr 0x26f3184, size 0x8, virtual false, abstract: false, final false
  inline void set_playerId(::StringW value);

  /// @brief Method set_playerName, addr 0x26f3194, size 0x8, virtual false, abstract: false, final false
  inline void set_playerName(::StringW value);

  /// @brief Method set_playerSpecificSettings, addr 0x26f3268, size 0x8, virtual false, abstract: false, final false
  inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method set_practiceSettings, addr 0x26f3278, size 0x8, virtual false, abstract: false, final false
  inline void set_practiceSettings(::GlobalNamespace::PracticeSettings* value);

  /// @brief Method set_selectedAvatarSystemTypeId, addr 0x26f3218, size 0x8, virtual false, abstract: false, final false
  inline void set_selectedAvatarSystemTypeId(::StringW value);

  /// @brief Method set_shouldShow360Warning, addr 0x26f31b8, size 0xc, virtual false, abstract: false, final false
  inline void set_shouldShow360Warning(bool value);

  /// @brief Method set_shouldShowTutorialPrompt, addr 0x26f31a4, size 0xc, virtual false, abstract: false, final false
  inline void set_shouldShowTutorialPrompt(bool value);

  /// @brief Method set_showedMissionHelpIds, addr 0x26f32b8, size 0x8, virtual false, abstract: false, final false
  inline void set_showedMissionHelpIds(::System::Collections::Generic::List_1<::StringW>* value);

  /// @brief Method set_userAgeCategory, addr 0x26f3318, size 0x8, virtual false, abstract: false, final false
