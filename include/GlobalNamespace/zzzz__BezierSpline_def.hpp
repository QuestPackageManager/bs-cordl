...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x10586d8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <ComputeControlPoints>b__8_0, addr 0x105877c, size 0x4, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_0(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_1, addr 0x1058780, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_1(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_2, addr 0x1058788, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_2(::UnityEngine::Vector3 p);

  /// @brief Method <SortSourceData>b__6_0, addr 0x105874c, size 0x30, virtual false, abstract: false, final false
  inline int32_t _SortSourceData_b__6_0(::UnityEngine::Vector3 point1, ::UnityEngine::Vector3 point2);

  /// @brief Method .ctor, addr 0x1058744, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddArtificialStartAndFinishPoint, addr 0x105286c, size 0x1f8, virtual false, abstract: false, final false
  inline void AddArtificialStartAndFinishPoint();

  /// @brief Method AddPoint, addr 0x1052794, size 0xd8, virtual false, abstract: false, final false
  inline void AddPoint(float_t distance, ::UnityEngine::Vector2 point);

  /// @brief Method Clear, addr 0x1058668, size 0x70, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeControlPoints, addr 0x1058150, size 0x518, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeControlPoints, addr 0x1052a64, size 0x55c, virtual false, abstract: false, final false
  inline void ComputeControlPoints();

  static inline ::GlobalNamespace::BezierSpline* New_ctor();

  /// @brief Method SortSourceData, addr 0x1058050, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x10523e4, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_segments, addr 0x1058048, size 0x8, virtual false, abstract: false, final false
