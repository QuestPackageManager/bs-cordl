...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x2265130, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <ComputeControlPoints>b__8_0, addr 0x22651cc, size 0x4, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_0(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_1, addr 0x22651d0, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_1(::UnityEngine::Vector3 p);

  /// @brief Method <ComputeControlPoints>b__8_2, addr 0x22651d8, size 0x8, virtual false, abstract: false, final false
  inline float_t _ComputeControlPoints_b__8_2(::UnityEngine::Vector3 p);

  /// @brief Method <SortSourceData>b__6_0, addr 0x226519c, size 0x30, virtual false, abstract: false, final false
  inline int32_t _SortSourceData_b__6_0(::UnityEngine::Vector3 point1, ::UnityEngine::Vector3 point2);

  /// @brief Method .ctor, addr 0x2265194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method AddArtificialStartAndFinishPoint, addr 0x226014c, size 0x1f4, virtual false, abstract: false, final false
  inline void AddArtificialStartAndFinishPoint();

  /// @brief Method AddPoint, addr 0x2260078, size 0xd4, virtual false, abstract: false, final false
  inline void AddPoint(float_t distance, ::UnityEngine::Vector2 point);

  /// @brief Method Clear, addr 0x22650c0, size 0x70, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method ComputeControlPoints, addr 0x2264b98, size 0x528, virtual false, abstract: false, final false
  ...
  /// @brief Method ComputeControlPoints, addr 0x2260340, size 0x520, virtual false, abstract: false, final false
  inline void ComputeControlPoints();

  static inline ::GlobalNamespace::BezierSpline* New_ctor();

  /// @brief Method SortSourceData, addr 0x2264a9c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x225fe2c, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_segments, addr 0x2264a94, size 0x8, virtual false, abstract: false, final false
