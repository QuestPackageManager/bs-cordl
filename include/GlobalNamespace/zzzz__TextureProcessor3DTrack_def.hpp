...
public:
// Declarations
/// @brief Method CreateTrackMixer, addr 0x5776a8c, size 0xac, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5776b38, size 0x5c, virtual false, abstract: false, final false
inline void _ctor() ;
