...
public:
  // Declarations
  /// @brief Method CreateTrackMixer, addr 0x59089c4, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5908a70, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();
