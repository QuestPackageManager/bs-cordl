...
public:
  ...
  /// @brief Method GetTransitionTiming, addr 0x6441174, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x644117c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
