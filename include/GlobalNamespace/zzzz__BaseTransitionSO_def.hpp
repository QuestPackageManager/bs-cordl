...
public:
  ...
  /// @brief Method GetTransitionTiming, addr 0x6228c0c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6228c14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
