...
public:
  ...
  /// @brief Method GetTransitionTiming, addr 0x44db354, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44db35c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
