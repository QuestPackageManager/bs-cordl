...
public:
  ...
  /// @brief Method GetTransitionTiming, addr 0x6290798, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x62907a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
