...
public:
  ...
  /// @brief Method get_easeDuration, addr 0x227cdf8, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_easeDuration();

  static inline ::GlobalNamespace::BaseTransitionSO* New_ctor();

  /// @brief Method .ctor, addr 0x227ce14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
