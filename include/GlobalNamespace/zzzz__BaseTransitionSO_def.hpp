...
public:
  ...
  /// @brief Method GetTransitionTiming, addr 0x6302e64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6302e6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
