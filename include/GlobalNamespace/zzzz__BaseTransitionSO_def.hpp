...
public:
  ...
  /// @brief Method GetTransitionTiming, addr 0x44e6fdc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44e6fe4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
