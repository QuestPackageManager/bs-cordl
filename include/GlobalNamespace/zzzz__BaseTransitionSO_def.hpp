...
public:
  ...
  /// @brief Method get_easeType, addr 0x23d8694, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::EaseType get_easeType();

  /// @brief Method get_easeDuration, addr 0x23d86b0, size 0x1c, virtual false, abstract: false, final false
  inline float_t get_easeDuration();

  static inline ::GlobalNamespace::BaseTransitionSO* New_ctor();

  /// @brief Method .ctor, addr 0x23d86cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
