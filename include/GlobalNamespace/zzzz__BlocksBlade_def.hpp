...
public:
  ...
  /// @brief Method .ctor, addr 0x58b5324, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method RandomPointOnCircle, addr 0x58b58bc, size 0x5c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 RandomPointOnCircle(float_t radius);

  /// @brief Method SetUpElement, addr 0x58b5328, size 0x1a4, virtual false, abstract: false, final false
  inline void SetUpElement(::GlobalNamespace::BlocksBlade_Element* element, float_t velocity, ::UnityEngine::Color color);

  /// @brief Method Start, addr 0x58b507c, size 0x2a8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58b54cc, size 0x3f0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58b5918, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_color, addr 0x58b5064, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method set_color, addr 0x58b5070, size 0xc, virtual false, abstract: false, final false
