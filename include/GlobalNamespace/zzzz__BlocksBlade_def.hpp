...
/// @brief Method .ctor, addr 0x5842d3c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method RandomPointOnCircle, addr 0x58432d4, size 0x5c, virtual false, abstract: false, final false
inline ::UnityEngine::Vector2 RandomPointOnCircle(float_t  radius) ;

/// @brief Method SetUpElement, addr 0x5842d40, size 0x1a4, virtual false, abstract: false, final false
inline void SetUpElement(::GlobalNamespace::BlocksBlade_Element*  element, float_t  velocity, ::UnityEngine::Color  color) ;

/// @brief Method Start, addr 0x5842a94, size 0x2a8, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x5842ee4, size 0x3f0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5843330, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_color, addr 0x5842a7c, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method set_color, addr 0x5842a88, size 0xc, virtual false, abstract: false, final false
