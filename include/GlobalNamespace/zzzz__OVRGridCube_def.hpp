...
public:
  ...
  /// @brief Method CreateCubeGrid, addr 0x5d4f6bc, size 0x3a0, virtual false, abstract: false, final false
  inline void CreateCubeGrid();

  /// @brief Method CubeGridSwitchColor, addr 0x5d4fa5c, size 0x17c, virtual false, abstract: false, final false
  inline void CubeGridSwitchColor(bool CubeSwitchColor);

  static inline ::GlobalNamespace::OVRGridCube* New_ctor();

  /// @brief Method SetOVRCameraController, addr 0x5d4f6b0, size 0xc, virtual false, abstract: false, final false
  inline void SetOVRCameraController(::ByRef<::GlobalNamespace::OVRCameraRig*> cameraController);

  /// @brief Method Update, addr 0x5d4f44c, size 0x4, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCubeGrid, addr 0x5d4f450, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d4fbd8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
