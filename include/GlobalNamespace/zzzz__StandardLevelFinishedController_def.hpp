...
public:
  ...
  /// @brief Method HandleLevelFinished, addr 0x580937c, size 0x4, virtual false, abstract: false, final false
  inline void HandleLevelFinished();

  static inline ::GlobalNamespace::StandardLevelFinishedController* New_ctor();

  /// @brief Method OnDestroy, addr 0x5809244, size 0x138, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x5809150, size 0xf4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartLevelFinished, addr 0x5809380, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58093d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
