...
/// @brief Field _standardLevelSceneSetupData, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__standardLevelSceneSetupData, put=__cordl_internal_set__standardLevelSceneSetupData)) ::UnityW<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO>  _standardLevelSceneSetupData;

/// @brief Method HandleLevelFinished, addr 0x5809cac, size 0x4, virtual false, abstract: false, final false
inline void HandleLevelFinished() ;

static inline ::GlobalNamespace::StandardLevelFinishedController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5809b74, size 0x138, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5809a80, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartLevelFinished, addr 0x5809cb0, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5809d04, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
