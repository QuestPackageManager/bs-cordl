...
public:
  ...
  /// @brief Method OnDestroy, addr 0x23cae34, size 0x108, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleLevelFinished, addr 0x23caf3c, size 0x4, virtual false, abstract: false, final false
  inline void HandleLevelFinished();

  /// @brief Method StartLevelFinished, addr 0x23caf40, size 0x40, virtual false, abstract: false, final false
  inline void StartLevelFinished();

  static inline ::GlobalNamespace::StandardLevelFinishedController* New_ctor();

  /// @brief Method .ctor, addr 0x23caf80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
