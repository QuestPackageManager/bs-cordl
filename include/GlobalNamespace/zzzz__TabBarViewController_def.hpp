...
public:
  ...
  /// @brief Method .ctor, addr 0x57ac114, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x57abea4, size 0x58, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method DidActivate, addr 0x57abefc, size 0xe0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleDidSelectCell, addr 0x57ac0c0, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x57abfdc, size 0xe4, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectItem, addr 0x57abe8c, size 0x18, virtual false, abstract: false, final false
  inline void SelectItem(int32_t index);

  /// @brief Method Setup, addr 0x57abcd8, size 0x1b4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57ac110, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_selectedCellNumber, addr 0x57abcc0, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_selectedCellNumber();

  /// @brief Method get_sizeToFit, addr 0x57abca8, size 0x18, virtual false, abstract: false, final false
  inline bool get_sizeToFit();

  /// @brief Method set_sizeToFit, addr 0x57abc8c, size 0x1c, virtual false, abstract: false, final false
