...
public:
  ...
  /// @brief Method .ctor, addr 0x267ccd4, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Clear, addr 0x267ca88, size 0x54, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method DidActivate, addr 0x267cadc, size 0xc4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleDidSelectCell, addr 0x267cc7c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x267cba0, size 0xdc, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectItem, addr 0x267ca6c, size 0x1c, virtual false, abstract: false, final false
  inline void SelectItem(int32_t index);

  /// @brief Method Setup, addr 0x267c8e0, size 0x18c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267cccc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_selectedCellNumber, addr 0x267c8c4, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_selectedCellNumber();

  /// @brief Method get_sizeToFit, addr 0x267c8a8, size 0x1c, virtual false, abstract: false, final false
  inline bool get_sizeToFit();

  /// @brief Method set_sizeToFit, addr 0x267c888, size 0x20, virtual false, abstract: false, final false
