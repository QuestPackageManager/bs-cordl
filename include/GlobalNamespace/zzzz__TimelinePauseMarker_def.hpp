...
public:
  ...
  /// @brief Method .ctor, addr 0x24d7d94, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_id, addr 0x24d7d8c, size 0x8, virtual true, abstract: false, final true
