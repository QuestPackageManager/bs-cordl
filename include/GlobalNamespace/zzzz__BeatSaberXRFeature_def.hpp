...
/// @brief Field <currentSessionState>k__BackingField, offset 0x50, size 0x4 
 __declspec(property(get=__cordl_internal_get__currentSessionState_k__BackingField, put=__cordl_internal_set__currentSessionState_k__BackingField)) ::GlobalNamespace::BeatSaberXRFeature_SessionState  _currentSessionState_k__BackingField;
...
/// @brief Field sessionStateChangedEvent, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_sessionStateChangedEvent, put=__cordl_internal_set_sessionStateChangedEvent)) ::System::Action_2<::GlobalNamespace::BeatSaberXRFeature_SessionState,::GlobalNamespace::BeatSaberXRFeature_SessionState>*  sessionStateChangedEvent;

static inline ::GlobalNamespace::BeatSaberXRFeature* New_ctor() ;

/// @brief Method OnSessionStateChange, addr 0x56a4a7c, size 0x20, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56a4a9c, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_sessionStateChangedEvent, addr 0x56a48fc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method get_currentSessionState, addr 0x56a48ec, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatSaberXRFeature_SessionState get_currentSessionState() ;

/// @brief Method remove_sessionStateChangedEvent, addr 0x56a49bc, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method set_currentSessionState, addr 0x56a48f4, size 0x8, virtual false, abstract: false, final false
