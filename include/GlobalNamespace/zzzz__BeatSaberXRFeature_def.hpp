...
MARK_REF_T(::GlobalNamespace::BeatSaberXRFeature*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatSaberXRFeature_SessionState, "", "BeatSaberXRFeature/SessionState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatSaberXRFeature*, "", "BeatSaberXRFeature");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::BeatSaberXRFeature_SessionState) == 0x4, "Size mismatch!");
