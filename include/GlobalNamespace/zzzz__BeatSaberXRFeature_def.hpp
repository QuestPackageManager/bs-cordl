...
public:
  ...
  /// @brief Method OnSessionStateChange, addr 0x5712944, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5712964, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_sessionStateChangedEvent, addr 0x57127c4, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentSessionState, addr 0x57127b4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatSaberXRFeature_SessionState get_currentSessionState();

  /// @brief Method remove_sessionStateChangedEvent, addr 0x5712884, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_currentSessionState, addr 0x57127bc, size 0x8, virtual false, abstract: false, final false
