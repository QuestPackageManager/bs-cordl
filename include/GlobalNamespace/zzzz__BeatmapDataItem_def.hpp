...
public:
  ...
  /// @brief Method CompareTo, addr 0x31c4868, size 0x48, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31c4858, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0x31c4828, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x31c4830, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_subtypeIdentifier, addr 0x31c4838, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_subtypeIdentifier();

  /// @brief Method get_time, addr 0x31c4818, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_type, addr 0x31c4848, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_subtypeIdentifier, addr 0x31c4840, size 0x8, virtual false, abstract: false, final false
  inline void set_subtypeIdentifier(int32_t value);

  /// @brief Method set_time, addr 0x31c4820, size 0x8, virtual false, abstract: false, final false
  inline void set_time(float_t value);

  /// @brief Method set_type, addr 0x31c4850, size 0x8, virtual false, abstract: false, final false
