...
public:
  ...
  /// @brief Method CompareTo, addr 0xe6d248, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xe6d1fc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0xe6d1ec, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_subtypeGroupIdentifier, addr 0xe6d1f4, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_time, addr 0xe6d1e4, size 0x8, virtual false, abstract: false, final false
