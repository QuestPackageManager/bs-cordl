...
public:
  ...
  /// @brief Method CompareTo, addr 0x32589c4, size 0x48, virtual true, abstract: false, final true
  ...
  /// @brief Method GetTypeId, addr 0x3258684, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32588bc, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method get_baseTypeId, addr 0x3258884, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_baseTypeId();

  /// @brief Method get_executionOrder, addr 0x325886c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_itemTypeId, addr 0x3258874, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_itemTypeId();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x3258894, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_subtypeIdentifier, addr 0x325889c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_subtypeIdentifier();

  /// @brief Method get_time, addr 0x325885c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_type, addr 0x32588ac, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem_BeatmapDataItemType get_type();

  /// @brief Method get_typeIdCount, addr 0x3258570, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method set_baseTypeId, addr 0x325888c, size 0x8, virtual false, abstract: false, final false
  inline void set_baseTypeId(int32_t value);

  /// @brief Method set_itemTypeId, addr 0x325887c, size 0x8, virtual false, abstract: false, final false
  inline void set_itemTypeId(int32_t value);

  /// @brief Method set_subtypeIdentifier, addr 0x32588a4, size 0x8, virtual false, abstract: false, final false
  inline void set_subtypeIdentifier(int32_t value);

  /// @brief Method set_time, addr 0x3258864, size 0x8, virtual false, abstract: false, final false
  inline void set_time(float_t value);

  /// @brief Method set_type, addr 0x32588b4, size 0x8, virtual false, abstract: false, final false
