...
public:
  ...
  /// @brief Method CompareTo, addr 0x31920f4, size 0x48, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x31920e4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0x31920b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_subtypeGroupIdentifier, addr 0x31920bc, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_subtypeGroupIdentifier();

  /// @brief Method get_subtypeIdentifier, addr 0x31920c4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_subtypeIdentifier();

  /// @brief Method get_time, addr 0x31920a4, size 0x8, virtual false, abstract: false, final false
  inline float_t get_time();

  /// @brief Method get_type, addr 0x31920d4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_subtypeIdentifier, addr 0x31920cc, size 0x8, virtual false, abstract: false, final false
  inline void set_subtypeIdentifier(int32_t value);

  /// @brief Method set_time, addr 0x31920ac, size 0x8, virtual false, abstract: false, final false
  inline void set_time(float_t value);

  /// @brief Method set_type, addr 0x31920dc, size 0x8, virtual false, abstract: false, final false
