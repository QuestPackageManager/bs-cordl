...
public:
  ...
  /// @brief Method Render, addr 0x572d138, size 0x6c, virtual true, abstract: false, final false
  inline void Render(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method .ctor, addr 0x572d1a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
