...
public:
  // Declarations
  /// @brief Method Render, addr 0x21aa6b0, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21aa718, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
