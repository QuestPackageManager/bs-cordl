...
public:
  ...
  /// @brief Method Render, addr 0x397d4a8, size 0x68, virtual true, abstract: false, final false
  inline void Render(::UnityEngine::RenderTexture* src, ::UnityEngine::RenderTexture* dest);

  /// @brief Method .ctor, addr 0x397d510, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
