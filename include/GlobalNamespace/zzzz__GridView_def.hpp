...
public:
  ...
  /// @brief Method MoveNext, addr 0x3234d2c, size 0x310, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::GridViewCellsEnumerator_GridView__GetEnumerator_d__1* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.Component>.get_Current, addr 0x32350cc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Component> System_Collections_Generic_IEnumerator_UnityEngine_Component__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x32350d4, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x323510c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3234c18, size 0x114, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x3235084, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x323503c, size 0x48, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x3234c0c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x3234bb8, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3234c14, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3234380, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetActiveCellsForCellPrefab, addr 0x32349a8, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadData, addr 0x3234388, size 0x620, virtual false, abstract: false, final false
  inline void ReloadData();

  /// @brief Method SetDataSource, addr 0x32342f8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3234ab0, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cellsEnumerator, addr 0x32342d8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GridView_GridViewCellsEnumerator* get_cellsEnumerator();

  /// @brief Method get_columnCount, addr 0x32342f0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_columnCount();

  /// @brief Method get_contentTransform, addr 0x32342d0, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RectTransform> get_contentTransform();

  /// @brief Method get_dataSource, addr 0x32342c8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GridView_IDataSource* get_dataSource();

  /// @brief Method get_rowCount, addr 0x32342e8, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_rowCount();

  /// @brief Method get_visibleColumnCount, addr 0x32342c0, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_visibleColumnCount();

  /// @brief Method set_cellsEnumerator, addr 0x32342e0, size 0x8, virtual false, abstract: false, final false
