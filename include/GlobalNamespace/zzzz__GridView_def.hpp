...
public:
  ...
  /// @brief Method MoveNext, addr 0x244522c, size 0x2b0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__GridView__GridViewCellsEnumerator___GetEnumerator_d__1* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.MonoBehaviour>.get_Current, addr 0x244557c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::MonoBehaviour> System_Collections_Generic_IEnumerator_UnityEngine_MonoBehaviour__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2445584, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x24455c4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2445174, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x244552c, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method <>m__Finally2, addr 0x24454dc, size 0x50, virtual false, abstract: false, final false
  inline void __m__Finally2();

  /// @brief Method .ctor, addr 0x2445148, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetEnumerator, addr 0x2440254, size 0x68, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x2445170, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2445060, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetActiveCellsForIdentifier, addr 0x243fea4, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReloadData, addr 0x2440e00, size 0x774, virtual false, abstract: false, final false
  inline void ReloadData();

  /// @brief Method SetDataSource, addr 0x243f7e4, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2445088, size 0xc0, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cellsEnumerator, addr 0x2445040, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__GridView__GridViewCellsEnumerator* get_cellsEnumerator();

  /// @brief Method get_columnCount, addr 0x2445058, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_columnCount();

  /// @brief Method get_dataSource, addr 0x2445038, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__GridView__IDataSource* get_dataSource();

  /// @brief Method get_rowCount, addr 0x2445050, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_rowCount();

  /// @brief Method set_cellsEnumerator, addr 0x2445048, size 0x8, virtual false, abstract: false, final false
