...
namespace GlobalNamespace {
class UIKeyboardManager__SummonSystemKeyboardAndWaitForResponse_d__20;
}
namespace HMUI {
...
MARK_REF_PTR_T(::GlobalNamespace::UIKeyboardManager__SummonSystemKeyboardAndWaitForResponse_d__20);
...
/// @brief Method MoveNext, addr 0x58d0a2c, size 0x138, virtual true, abstract: false, final true
...
/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x58d0b64, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x58d0b6c, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x58d0ba4, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x58d0a28, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x58d0a1c, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::UIKeyboardManager__SummonSystemKeyboardAndWaitForResponse_d__20, _____2__current) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::UIKeyboardManager__SummonSystemKeyboardAndWaitForResponse_d__20, _____4__this) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::UIKeyboardManager__SummonSystemKeyboardAndWaitForResponse_d__20, ___input) == 0x28, "Offset mismatch!");
...
/// @brief Method CloseKeyboard, addr 0x58d05b4, size 0xa0, virtual false, abstract: false, final false
inline void CloseKeyboard() ;

/// @brief Method HandleKeyboardOkButton, addr 0x58d08b4, size 0x168, virtual false, abstract: false, final false
inline void HandleKeyboardOkButton() ;

static inline ::GlobalNamespace::UIKeyboardManager* New_ctor() ;

/// @brief Method OnDestroy, addr 0x58d0254, size 0x100, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method OnDisable, addr 0x58d01c4, size 0x90, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x58d0134, size 0x90, virtual false, abstract: false, final false
inline void OnEnable() ;

/// @brief Method OpenKeyboardFor, addr 0x58d0354, size 0x200, virtual false, abstract: false, final false
inline void OpenKeyboardFor(::HMUI::InputFieldView*  input) ;

/// @brief Method ProcessMousePress, addr 0x58d0744, size 0x170, virtual false, abstract: false, final false
inline void ProcessMousePress(::UnityEngine::GameObject*  currentOverGo) ;

/// @brief Method ShouldCloseKeyboard, addr 0x58d06ec, size 0x58, virtual false, abstract: false, final false
inline bool ShouldCloseKeyboard(::UnityEngine::GameObject*  root) ;

/// @brief Method Start, addr 0x58d0040, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method SummonSystemKeyboardAndWaitForResponse, addr 0x58d0554, size 0x60, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* SummonSystemKeyboardAndWaitForResponse(::HMUI::InputFieldView*  input) ;

/// @brief Method TransferKeyboardTo, addr 0x58d0654, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58d0a24, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_keyboard, addr 0x58d0038, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::UIKeyboardManager, ___systemKeyboard) == 0x50, "Offset mismatch!");
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::UIKeyboardManager__SummonSystemKeyboardAndWaitForResponse_d__20*, "", "UIKeyboardManager/<SummonSystemKeyboardAndWaitForResponse>d__20");
