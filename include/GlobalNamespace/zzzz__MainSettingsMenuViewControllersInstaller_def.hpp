...
/// @brief Field _defaultSettingsMenuViewController, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__defaultSettingsMenuViewController, put=__cordl_internal_set__defaultSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>  _defaultSettingsMenuViewController;

/// @brief Field _oculusPCSettingsMenuViewController, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__oculusPCSettingsMenuViewController, put=__cordl_internal_set__oculusPCSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>  _oculusPCSettingsMenuViewController;

/// @brief Field _psvr2SettingsMenuViewController, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__psvr2SettingsMenuViewController, put=__cordl_internal_set__psvr2SettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>  _psvr2SettingsMenuViewController;

/// @brief Field _psvrSettingsMenuViewController, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__psvrSettingsMenuViewController, put=__cordl_internal_set__psvrSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>  _psvrSettingsMenuViewController;

/// @brief Field _questSettingsMenuViewController, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__questSettingsMenuViewController, put=__cordl_internal_set__questSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>  _questSettingsMenuViewController;

/// @brief Field _tabBarViewControllerPrefab, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__tabBarViewControllerPrefab, put=__cordl_internal_set__tabBarViewControllerPrefab)) ::UnityW<::GlobalNamespace::TabBarViewController>  _tabBarViewControllerPrefab;

/// @brief Method InstallBindings, addr 0x58506d0, size 0xc8, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5850798, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
