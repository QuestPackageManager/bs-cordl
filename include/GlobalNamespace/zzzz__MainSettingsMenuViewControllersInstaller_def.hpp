...
// Write type traits
MARK_REF_T(::GlobalNamespace::MainSettingsMenuViewControllersInstaller*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainSettingsMenuViewControllersInstaller*, "", "MainSettingsMenuViewControllersInstaller");
...
public:
  // Declarations
  /// @brief Field _defaultSettingsMenuViewController, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get__defaultSettingsMenuViewController,
                      put = __cordl_internal_set__defaultSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>
      _defaultSettingsMenuViewController;

  /// @brief Field _oculusPCSettingsMenuViewController, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get__oculusPCSettingsMenuViewController,
                      put = __cordl_internal_set__oculusPCSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>
      _oculusPCSettingsMenuViewController;

  /// @brief Field _psvr2SettingsMenuViewController, offset 0x48, size 0x8
  __declspec(property(get = __cordl_internal_get__psvr2SettingsMenuViewController,
                      put = __cordl_internal_set__psvr2SettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>
      _psvr2SettingsMenuViewController;

  /// @brief Field _psvrSettingsMenuViewController, offset 0x40, size 0x8
  __declspec(property(get = __cordl_internal_get__psvrSettingsMenuViewController,
                      put = __cordl_internal_set__psvrSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>
      _psvrSettingsMenuViewController;

  /// @brief Field _questSettingsMenuViewController, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get__questSettingsMenuViewController,
                      put = __cordl_internal_set__questSettingsMenuViewController)) ::UnityW<::GlobalNamespace::MainSettingsMenuViewController>
      _questSettingsMenuViewController;

  /// @brief Field _tabBarViewControllerPrefab, offset 0x50, size 0x8
  ...
  /// @brief Method InstallBindings, addr 0x59fdccc, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fdd94, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MainSettingsMenuViewControllersInstaller", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MainSettingsMenuViewControllersInstaller(MainSettingsMenuViewControllersInstaller&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MainSettingsMenuViewControllersInstaller", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MainSettingsMenuViewControllersInstaller(MainSettingsMenuViewControllersInstallerconst&) = delete;
  ...
  /// [SerializeField]
  /// @brief Field _oculusPCSettingsMenuViewController, offset: 0x30, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::MainSettingsMenuViewController> ____oculusPCSettingsMenuViewController;

  /// [SerializeField]
  /// @brief Field _questSettingsMenuViewController, offset: 0x38, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::MainSettingsMenuViewController> ____questSettingsMenuViewController;

  /// [SerializeField]
  /// @brief Field _psvrSettingsMenuViewController, offset: 0x40, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::MainSettingsMenuViewController> ____psvrSettingsMenuViewController;

  /// [SerializeField]
  /// @brief Field _psvr2SettingsMenuViewController, offset: 0x48, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::MainSettingsMenuViewControllersInstaller, ____questSettingsMenuViewController) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::MainSettingsMenuViewControllersInstaller, ____psvrSettingsMenuViewController) == 0x40, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::MainSettingsMenuViewControllersInstaller) == 0x58, "Size mismatch!");
