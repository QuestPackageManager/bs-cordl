...
public:
  ...
  /// @brief Method InstallBindings, addr 0x584fda0, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x584fe68, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
