...
public:
  ...
  /// @brief Method HandleComboDidChange, addr 0x3bb2e34, size 0x50, virtual false, abstract: false, final false
  inline void HandleComboDidChange(int32_t combo);

  /// @brief Method Init, addr 0x3bb2c20, size 0x144, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::ComboMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x3bb2d64, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bb2e84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
