...
public:
  ...
  /// @brief Method HandleComboDidChange, addr 0x57a32e0, size 0x4c, virtual false, abstract: false, final false
  inline void HandleComboDidChange(int32_t combo);

  /// @brief Method Init, addr 0x57a3044, size 0x188, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::ComboMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x57a31cc, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a332c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
