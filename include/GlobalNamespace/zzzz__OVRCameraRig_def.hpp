...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(8969)), TypeDefinitionIndex(TypeDefinitionIndex(8989))]
...
public:
  ...
  /// @brief Method get_leftEyeCamera, addr 0x2743eb4, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_leftEyeCamera();

  /// @brief Method get_rightEyeCamera, addr 0x2743ed0, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_rightEyeCamera();

  /// @brief Method get_trackingSpace, addr 0x2743eec, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_trackingSpace();

  /// @brief Method set_trackingSpace, addr 0x2743ef4, size 0x8, virtual false, abstract: false, final false
  inline void set_trackingSpace(::UnityEngine::Transform* value);

  /// @brief Method get_leftEyeAnchor, addr 0x2743efc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_leftEyeAnchor();

  /// @brief Method set_leftEyeAnchor, addr 0x2743f04, size 0x8, virtual false, abstract: false, final false
  inline void set_leftEyeAnchor(::UnityEngine::Transform* value);

  /// @brief Method get_centerEyeAnchor, addr 0x2743f0c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_centerEyeAnchor();

  /// @brief Method set_centerEyeAnchor, addr 0x2743f14, size 0x8, virtual false, abstract: false, final false
  inline void set_centerEyeAnchor(::UnityEngine::Transform* value);

  /// @brief Method get_rightEyeAnchor, addr 0x2743f1c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_rightEyeAnchor();

  /// @brief Method set_rightEyeAnchor, addr 0x2743f24, size 0x8, virtual false, abstract: false, final false
  inline void set_rightEyeAnchor(::UnityEngine::Transform* value);

  /// @brief Method get_leftHandAnchor, addr 0x2743f2c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_leftHandAnchor();

  /// @brief Method set_leftHandAnchor, addr 0x2743f34, size 0x8, virtual false, abstract: false, final false
  inline void set_leftHandAnchor(::UnityEngine::Transform* value);

  /// @brief Method get_rightHandAnchor, addr 0x2743f3c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_rightHandAnchor();

  /// @brief Method set_rightHandAnchor, addr 0x2743f44, size 0x8, virtual false, abstract: false, final false
  inline void set_rightHandAnchor(::UnityEngine::Transform* value);

  /// @brief Method get_leftControllerAnchor, addr 0x2743f4c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_leftControllerAnchor();

  /// @brief Method set_leftControllerAnchor, addr 0x2743f54, size 0x8, virtual false, abstract: false, final false
  inline void set_leftControllerAnchor(::UnityEngine::Transform* value);

  /// @brief Method get_rightControllerAnchor, addr 0x2743f5c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_rightControllerAnchor();

  /// @brief Method set_rightControllerAnchor, addr 0x2743f64, size 0x8, virtual false, abstract: false, final false
  inline void set_rightControllerAnchor(::UnityEngine::Transform* value);

  /// @brief Method get_trackerAnchor, addr 0x2743f6c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_trackerAnchor();

  /// @brief Method set_trackerAnchor, addr 0x2743f74, size 0x8, virtual false, abstract: false, final false
  inline void set_trackerAnchor(::UnityEngine::Transform* value);

  /// @brief Method add_UpdatedAnchors, addr 0x2743f7c, size 0xb0, virtual false, abstract: false, final false
  inline void add_UpdatedAnchors(::System::Action_1<::UnityW<::GlobalNamespace::OVRCameraRig>>* value);

  /// @brief Method remove_UpdatedAnchors, addr 0x274402c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_UpdatedAnchors(::System::Action_1<::UnityW<::GlobalNamespace::OVRCameraRig>>* value);

  /// @brief Method add_TrackingSpaceChanged, addr 0x27440dc, size 0xb0, virtual false, abstract: false, final false
  inline void add_TrackingSpaceChanged(::System::Action_1<::UnityW<::UnityEngine::Transform>>* value);

  /// @brief Method remove_TrackingSpaceChanged, addr 0x274418c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_TrackingSpaceChanged(::System::Action_1<::UnityW<::UnityEngine::Transform>>* value);

  /// @brief Method Awake, addr 0x274423c, size 0x18, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method Start, addr 0x2744254, size 0x88, virtual true, abstract: false, final false
  inline void Start();

  /// @brief Method FixedUpdate, addr 0x27442dc, size 0x20, virtual true, abstract: false, final false
  inline void FixedUpdate();

  /// @brief Method Update, addr 0x27442fc, size 0x24, virtual true, abstract: false, final false
  inline void Update();

  /// @brief Method OnDestroy, addr 0x2744320, size 0x74, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UpdateAnchors, addr 0x2744394, size 0xe14, virtual true, abstract: false, final false
  inline void UpdateAnchors(bool updateEyeAnchors, bool updateHandAnchors);

  /// @brief Method OnBeforeRenderCallback, addr 0x27457a4, size 0xd4, virtual true, abstract: false, final false
  inline void OnBeforeRenderCallback();

  /// @brief Method CheckForTrackingSpaceChangesAndRaiseEvent, addr 0x2745878, size 0x27c, virtual true, abstract: false, final false
  inline void CheckForTrackingSpaceChangesAndRaiseEvent();

  /// @brief Method RaiseUpdatedAnchorsEvent, addr 0x2745af4, size 0x20, virtual true, abstract: false, final false
  inline void RaiseUpdatedAnchorsEvent();

  /// @brief Method EnsureGameObjectIntegrity, addr 0x2745b14, size 0x80c, virtual true, abstract: false, final false
  inline void EnsureGameObjectIntegrity();

  /// @brief Method ConfigureAnchor, addr 0x2746320, size 0x25c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> ConfigureAnchor(::UnityEngine::Transform* root, ::StringW name);

  /// @brief Method ComputeTrackReferenceMatrix, addr 0x274657c, size 0x2d4, virtual true, abstract: false, final false
  inline ::UnityEngine::Matrix4x4 ComputeTrackReferenceMatrix();

  /// @brief Method CheckForAnchorsInParent, addr 0x2746850, size 0xe0, virtual false, abstract: false, final false
  inline void CheckForAnchorsInParent();

  static inline ::GlobalNamespace::OVRCameraRig* New_ctor();

  /// @brief Method .ctor, addr 0x2746930, size 0x150, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <CheckForAnchorsInParent>g__Check|75_0, addr 0x0, size 0xffffffffffffffff, virtual false, abstract: false, final false
