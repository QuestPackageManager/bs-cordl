...
public:
  ...
  /// @brief Method .ctor, addr 0x58f2c24, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyValue, addr 0x58f2bc4, size 0x20, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method ColorForValue, addr 0x58f2be4, size 0x3c, virtual true, abstract: false, final false
  inline ::UnityEngine::Color ColorForValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x58f2b50, size 0x74, virtual true, abstract: false, final false
  inline bool GetInitValues(::ByRef<int32_t> idx, ::ByRef<int32_t> numberOfElements);

  /// @brief Method Init, addr 0x58f2adc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x58f2b18, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58f2c20, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueChangedEvent, addr 0x58f295c, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_valueChangedEvent, addr 0x58f2a1c, size 0xc0, virtual true, abstract: false, final true
