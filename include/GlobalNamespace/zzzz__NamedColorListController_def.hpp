...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16290))
...
public:
  ...
  /// @brief Method .ctor, addr 0x24052dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(16288))]
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16291))
...
public:
  ...
  /// @brief Method add_valueChangedEvent, addr 0x2405030, size 0xb0, virtual true, abstract: false, final true
  inline void add_valueChangedEvent(::System::Action_1<int32_t>* value);

  /// @brief Method remove_valueChangedEvent, addr 0x24050e0, size 0xb0, virtual true, abstract: false, final true
  inline void remove_valueChangedEvent(::System::Action_1<int32_t>* value);

  /// @brief Method Init, addr 0x2405190, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x24051cc, size 0x38, virtual false, abstract: false, final false
  inline void SetValue(int32_t value);

  /// @brief Method GetInitValues, addr 0x2405204, size 0x74, virtual true, abstract: false, final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  /// @brief Method ApplyValue, addr 0x2405278, size 0x20, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method ColorForValue, addr 0x2405298, size 0x3c, virtual true, abstract: false, final false
  inline ::UnityEngine::Color ColorForValue(int32_t idx);

  static inline ::GlobalNamespace::NamedColorListController* New_ctor();

  /// @brief Method .ctor, addr 0x24052d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
