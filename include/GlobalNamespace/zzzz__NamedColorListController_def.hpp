...
public:
  ...
  /// @brief Method .ctor, addr 0x5a30234, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyValue, addr 0x5a301d4, size 0x20, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method ColorForValue, addr 0x5a301f4, size 0x3c, virtual true, abstract: false, final false
  inline ::UnityEngine::Color ColorForValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x5a30160, size 0x74, virtual true, abstract: false, final false
  inline bool GetInitValues(::by_ref<int32_t> idx, ::by_ref<int32_t> numberOfElements);

  /// @brief Method Init, addr 0x5a300ec, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x5a30128, size 0x38, virtual false, abstract: false, final false
