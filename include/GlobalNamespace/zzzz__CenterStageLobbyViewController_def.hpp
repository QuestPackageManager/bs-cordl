...
public:
  ...
  /// @brief Method SetLevelGameplaySetupData, addr 0x3c1a6c8, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c1a82c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
