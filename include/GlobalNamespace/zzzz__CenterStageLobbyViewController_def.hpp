...
public:
  ...
  /// @brief Method SetLevelGameplaySetupData, addr 0x57a125c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57a13b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
