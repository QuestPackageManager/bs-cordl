...
/// @brief Method SetLevelGameplaySetupData, addr 0x5730df0, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5730f48, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
