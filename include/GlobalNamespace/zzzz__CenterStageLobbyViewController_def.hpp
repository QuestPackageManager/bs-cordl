...
public:
  ...
  /// @brief Method SetLevelGameplaySetupData, addr 0x2552784, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25528e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
