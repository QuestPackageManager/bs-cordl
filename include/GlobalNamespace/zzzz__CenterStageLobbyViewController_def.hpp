...
public:
  ...
  /// @brief Method SetLevelGameplaySetupData, addr 0x267e6e0, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267e844, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
