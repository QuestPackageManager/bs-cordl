...
public:
  ...
  /// @brief Method SetLevelGameplaySetupData, addr 0x22fc2ec, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22fc450, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
