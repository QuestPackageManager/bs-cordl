...
public:
  ...
  /// @brief Method SetLevelGameplaySetupData, addr 0x3c2086c, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c209d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
