...
// Write type traits
MARK_REF_T(::GlobalNamespace::CenterStageLobbyViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::CenterStageLobbyViewController*, "", "CenterStageLobbyViewController");
...
public:
  ...
  /// @brief Method SetLevelGameplaySetupData, addr 0x595e76c, size 0x150, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x595e8bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::CenterStageLobbyViewController) == 0x88, "Size mismatch!");
