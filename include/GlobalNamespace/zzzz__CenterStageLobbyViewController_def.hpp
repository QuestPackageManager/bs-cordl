...
/// @brief Method SetLevelGameplaySetupData, addr 0x57a2ac4, size 0x158, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a2c1c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
