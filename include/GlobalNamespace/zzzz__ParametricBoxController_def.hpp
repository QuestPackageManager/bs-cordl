...
public:
  ...
  /// @brief Method Awake, addr 0x39dabe8, size 0x28, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x39dac10, size 0xc4, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::ParametricBoxController* New_ctor();

  /// @brief Method OnDisable, addr 0x39dacf4, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39dacd4, size 0x20, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x39dad14, size 0x220, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x39daf34, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_collisionHeight, addr 0x39dabd8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_collisionHeight();

  /// @brief Method get_useCollision, addr 0x39dabc4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_collisionHeight, addr 0x39dabe0, size 0x8, virtual false, abstract: false, final false
  inline void set_collisionHeight(float_t value);

  /// @brief Method set_useCollision, addr 0x39dabcc, size 0xc, virtual false, abstract: false, final false
