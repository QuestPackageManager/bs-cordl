...
public:
  ...
  /// @brief Method Awake, addr 0x39daf84, size 0x28, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x39dafac, size 0xc4, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::ParametricBoxController* New_ctor();

  /// @brief Method OnDisable, addr 0x39db090, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39db070, size 0x20, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x39db0b0, size 0x220, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x39db2d0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_collisionHeight, addr 0x39daf74, size 0x8, virtual false, abstract: false, final false
  inline float_t get_collisionHeight();

  /// @brief Method get_useCollision, addr 0x39daf60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_collisionHeight, addr 0x39daf7c, size 0x8, virtual false, abstract: false, final false
  inline void set_collisionHeight(float_t value);

  /// @brief Method set_useCollision, addr 0x39daf68, size 0xc, virtual false, abstract: false, final false
