...
public:
  ...
  /// @brief Method Awake, addr 0x57210a8, size 0x28, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method InitIfNeeded, addr 0x57210d0, size 0xfc, virtual false, abstract: false, final false
  inline void InitIfNeeded();

  static inline ::GlobalNamespace::ParametricBoxController* New_ctor();

  /// @brief Method OnDisable, addr 0x57211e8, size 0x1c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57211cc, size 0x1c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x5721204, size 0x214, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x5721418, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_collisionHeight, addr 0x5721098, size 0x8, virtual false, abstract: false, final false
  inline float_t get_collisionHeight();

  /// @brief Method get_useCollision, addr 0x5721088, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_collisionHeight, addr 0x57210a0, size 0x8, virtual false, abstract: false, final false
  inline void set_collisionHeight(float_t value);

  /// @brief Method set_useCollision, addr 0x5721090, size 0x8, virtual false, abstract: false, final false
