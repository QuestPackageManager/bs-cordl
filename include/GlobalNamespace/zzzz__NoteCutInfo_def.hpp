...
public:
  ...
  /// @brief Method .ctor, addr 0x36baeb0, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method get_allExceptSaberTypeIsOK, addr 0x36bae44, size 0x28, virtual false, abstract: false, final false
  inline bool get_allExceptSaberTypeIsOK();

  /// @brief Method get_allIsOK, addr 0x36bae14, size 0x30, virtual false, abstract: false, final false
  inline bool get_allIsOK();

  /// @brief Method get_failReason, addr 0x36bae6c, size 0x44, virtual false, abstract: false, final false
