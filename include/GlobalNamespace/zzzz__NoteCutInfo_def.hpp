...
public:
  ...
  /// @brief Method .ctor, addr 0x15047a8, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method get_allExceptSaberTypeIsOK, addr 0x150473c, size 0x28, virtual false, abstract: false, final false
  inline bool get_allExceptSaberTypeIsOK();

  /// @brief Method get_allIsOK, addr 0x150470c, size 0x30, virtual false, abstract: false, final false
  inline bool get_allIsOK();

  /// @brief Method get_failReason, addr 0x1504764, size 0x44, virtual false, abstract: false, final false
