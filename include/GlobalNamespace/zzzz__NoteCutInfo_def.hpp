...
public:
  ...
  /// @brief Method .ctor, addr 0x377a490, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method get_allExceptSaberTypeIsOK, addr 0x377a424, size 0x28, virtual false, abstract: false, final false
  inline bool get_allExceptSaberTypeIsOK();

  /// @brief Method get_allIsOK, addr 0x377a3f4, size 0x30, virtual false, abstract: false, final false
  inline bool get_allIsOK();

  /// @brief Method get_failReason, addr 0x377a44c, size 0x44, virtual false, abstract: false, final false
