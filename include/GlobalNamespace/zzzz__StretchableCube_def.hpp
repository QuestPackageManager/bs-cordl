...
public:
  ...
  /// @brief Method Awake, addr 0x263d754, size 0x70, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CreateBox, addr 0x263d7c4, size 0x144, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> CreateBox();

  static inline ::GlobalNamespace::StretchableCube* New_ctor();

  /// @brief Method OnDestroy, addr 0x263d908, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RecalculateUVs, addr 0x263d914, size 0x1e4, virtual false, abstract: false, final false
  inline void RecalculateUVs(::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> uvs);

  /// @brief Method RefreshUVs, addr 0x263daf8, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x263db8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
