...
/// @brief Method Awake, addr 0x572f7a4, size 0x74, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method CreateBox, addr 0x572f818, size 0x148, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Mesh> CreateBox() ;

static inline ::GlobalNamespace::StretchableCube* New_ctor() ;

/// @brief Method OnDestroy, addr 0x572f960, size 0xc, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method RecalculateUVs, addr 0x572f96c, size 0x1f4, virtual false, abstract: false, final false
inline void RecalculateUVs(::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>  uvs) ;

/// @brief Method RefreshUVs, addr 0x572fb60, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x572fbf8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
