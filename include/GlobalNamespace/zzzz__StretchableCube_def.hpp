...
public:
  ...
  /// @brief Method Awake, addr 0x22d51ac, size 0x70, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method OnDestroy, addr 0x22d5360, size 0xc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method CreateBox, addr 0x22d521c, size 0x144, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Mesh> CreateBox();

  /// @brief Method RecalculateUVs, addr 0x22d536c, size 0x1e4, virtual false, abstract: false, final false
  inline void RecalculateUVs(::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> uvs);

  /// @brief Method RefreshUVs, addr 0x22d5550, size 0x94, virtual false, abstract: false, final false
  inline void RefreshUVs();

  static inline ::GlobalNamespace::StretchableCube* New_ctor();

  /// @brief Method .ctor, addr 0x22d55e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
