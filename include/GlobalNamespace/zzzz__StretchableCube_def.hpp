...
// [AddComponentMenu("Beat Saber/Gameplay/StretchableCube")]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StretchableCube", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StretchableCube(StretchableCube&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StretchableCube", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StretchableCube(StretchableCubeconst&) = delete;
