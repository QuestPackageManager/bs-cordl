...
public:
  ...
  /// @brief Method Init, addr 0x39c8398, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method InstantiateMixedRealityCameraGameObject, addr 0x39c84f8, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x39c8340, size 0x58, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Update, addr 0x39c82cc, size 0x74, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x39c852c, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_capturingCameraDevice, addr 0x39c80f0, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRManager_CameraDevice get_capturingCameraDevice();

  /// @brief Method get_chromaKeyColor, addr 0x39c8158, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color get_chromaKeyColor();

  /// @brief Method get_chromaKeySimilarity, addr 0x39c8170, size 0x8, virtual true, abstract: false, final true
  inline float_t get_chromaKeySimilarity();

  /// @brief Method get_chromaKeySmoothRange, addr 0x39c8180, size 0x8, virtual true, abstract: false, final true
  inline float_t get_chromaKeySmoothRange();

  /// @brief Method get_chromaKeySpillRange, addr 0x39c8190, size 0x8, virtual true, abstract: false, final true
  inline float_t get_chromaKeySpillRange();

  /// @brief Method get_compositionMethod, addr 0x39c80b0, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRManager_CompositionMethod get_compositionMethod();

  /// @brief Method get_depthQuality, addr 0x39c81b4, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRManager_DepthQuality get_depthQuality();

  /// @brief Method get_dynamicCullingMask, addr 0x39c809c, size 0x8, virtual true, abstract: false, final true
  inline bool get_dynamicCullingMask();

  /// @brief Method get_dynamicLightingDepthVariationClampingValue, addr 0x39c81d4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_dynamicLightingDepthVariationClampingValue();

  /// @brief Method get_dynamicLightingSmoothFactor, addr 0x39c81c4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_dynamicLightingSmoothFactor();

  /// @brief Method get_enableMixedReality, addr 0x39c8068, size 0x8, virtual true, abstract: false, final true
  inline bool get_enableMixedReality();

  /// @brief Method get_externalCompositionBackdropColorQuest, addr 0x39c80d8, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color get_externalCompositionBackdropColorQuest();

  /// @brief Method get_externalCompositionBackdropColorRift, addr 0x39c80c0, size 0xc, virtual true, abstract: false, final true
  inline ::UnityEngine::Color get_externalCompositionBackdropColorRift();

  /// @brief Method get_extraHiddenLayers, addr 0x39c807c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::LayerMask get_extraHiddenLayers();

  /// @brief Method get_extraVisibleLayers, addr 0x39c808c, size 0x8, virtual true, abstract: false, final true
  inline ::UnityEngine::LayerMask get_extraVisibleLayers();

  /// @brief Method get_flipCameraFrameHorizontally, addr 0x39c8100, size 0x8, virtual true, abstract: false, final true
  inline bool get_flipCameraFrameHorizontally();

  /// @brief Method get_flipCameraFrameVertically, addr 0x39c8114, size 0x8, virtual true, abstract: false, final true
  inline bool get_flipCameraFrameVertically();

  /// @brief Method get_handPoseStateLatency, addr 0x39c8128, size 0x8, virtual true, abstract: false, final true
  inline float_t get_handPoseStateLatency();

  /// @brief Method get_instantiateMixedRealityCameraGameObject, addr 0x39c8248, size 0x80, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRManager_InstantiateMrcCameraDelegate* get_instantiateMixedRealityCameraGameObject();

  /// @brief Method get_mrcActivationMode, addr 0x39c8238, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRManager_MrcActivationMode get_mrcActivationMode();

  /// @brief Method get_sandwichCompositionBufferedFrames, addr 0x39c8148, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_sandwichCompositionBufferedFrames();

  /// @brief Method get_sandwichCompositionRenderLatency, addr 0x39c8138, size 0x8, virtual true, abstract: false, final true
  inline float_t get_sandwichCompositionRenderLatency();

  /// @brief Method get_useDynamicLighting, addr 0x39c81a0, size 0x8, virtual true, abstract: false, final true
  inline bool get_useDynamicLighting();

  /// @brief Method get_virtualGreenScreenApplyDepthCulling, addr 0x39c8214, size 0x8, virtual true, abstract: false, final true
  inline bool get_virtualGreenScreenApplyDepthCulling();

  /// @brief Method get_virtualGreenScreenBottomY, addr 0x39c8204, size 0x8, virtual true, abstract: false, final true
  inline float_t get_virtualGreenScreenBottomY();

  /// @brief Method get_virtualGreenScreenDepthTolerance, addr 0x39c8228, size 0x8, virtual true, abstract: false, final true
  inline float_t get_virtualGreenScreenDepthTolerance();

  /// @brief Method get_virtualGreenScreenTopY, addr 0x39c81f4, size 0x8, virtual true, abstract: false, final true
  inline float_t get_virtualGreenScreenTopY();

  /// @brief Method get_virtualGreenScreenType, addr 0x39c81e4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_capturingCameraDevice, addr 0x39c80f8, size 0x8, virtual true, abstract: false, final true
  inline void set_capturingCameraDevice(::GlobalNamespace::OVRManager_CameraDevice value);

  /// @brief Method set_chromaKeyColor, addr 0x39c8164, size 0xc, virtual true, abstract: false, final true
  inline void set_chromaKeyColor(::UnityEngine::Color value);

  /// @brief Method set_chromaKeySimilarity, addr 0x39c8178, size 0x8, virtual true, abstract: false, final true
  inline void set_chromaKeySimilarity(float_t value);

  /// @brief Method set_chromaKeySmoothRange, addr 0x39c8188, size 0x8, virtual true, abstract: false, final true
  inline void set_chromaKeySmoothRange(float_t value);

  /// @brief Method set_chromaKeySpillRange, addr 0x39c8198, size 0x8, virtual true, abstract: false, final true
  inline void set_chromaKeySpillRange(float_t value);

  /// @brief Method set_compositionMethod, addr 0x39c80b8, size 0x8, virtual true, abstract: false, final true
  inline void set_compositionMethod(::GlobalNamespace::OVRManager_CompositionMethod value);

  /// @brief Method set_depthQuality, addr 0x39c81bc, size 0x8, virtual true, abstract: false, final true
  inline void set_depthQuality(::GlobalNamespace::OVRManager_DepthQuality value);

  /// @brief Method set_dynamicCullingMask, addr 0x39c80a4, size 0xc, virtual true, abstract: false, final true
  inline void set_dynamicCullingMask(bool value);

  /// @brief Method set_dynamicLightingDepthVariationClampingValue, addr 0x39c81dc, size 0x8, virtual true, abstract: false, final true
  inline void set_dynamicLightingDepthVariationClampingValue(float_t value);

  /// @brief Method set_dynamicLightingSmoothFactor, addr 0x39c81cc, size 0x8, virtual true, abstract: false, final true
  inline void set_dynamicLightingSmoothFactor(float_t value);

  /// @brief Method set_enableMixedReality, addr 0x39c8070, size 0xc, virtual true, abstract: false, final true
  inline void set_enableMixedReality(bool value);

  /// @brief Method set_externalCompositionBackdropColorQuest, addr 0x39c80e4, size 0xc, virtual true, abstract: false, final true
  inline void set_externalCompositionBackdropColorQuest(::UnityEngine::Color value);

  /// @brief Method set_externalCompositionBackdropColorRift, addr 0x39c80cc, size 0xc, virtual true, abstract: false, final true
  inline void set_externalCompositionBackdropColorRift(::UnityEngine::Color value);

  /// @brief Method set_extraHiddenLayers, addr 0x39c8084, size 0x8, virtual true, abstract: false, final true
  inline void set_extraHiddenLayers(::UnityEngine::LayerMask value);

  /// @brief Method set_extraVisibleLayers, addr 0x39c8094, size 0x8, virtual true, abstract: false, final true
  inline void set_extraVisibleLayers(::UnityEngine::LayerMask value);

  /// @brief Method set_flipCameraFrameHorizontally, addr 0x39c8108, size 0xc, virtual true, abstract: false, final true
  inline void set_flipCameraFrameHorizontally(bool value);

  /// @brief Method set_flipCameraFrameVertically, addr 0x39c811c, size 0xc, virtual true, abstract: false, final true
  inline void set_flipCameraFrameVertically(bool value);

  /// @brief Method set_handPoseStateLatency, addr 0x39c8130, size 0x8, virtual true, abstract: false, final true
  inline void set_handPoseStateLatency(float_t value);

  /// @brief Method set_instantiateMixedRealityCameraGameObject, addr 0x39c82c8, size 0x4, virtual true, abstract: false, final true
  inline void set_instantiateMixedRealityCameraGameObject(::GlobalNamespace::OVRManager_InstantiateMrcCameraDelegate* value);

  /// @brief Method set_mrcActivationMode, addr 0x39c8240, size 0x8, virtual true, abstract: false, final true
  inline void set_mrcActivationMode(::GlobalNamespace::OVRManager_MrcActivationMode value);

  /// @brief Method set_sandwichCompositionBufferedFrames, addr 0x39c8150, size 0x8, virtual true, abstract: false, final true
  inline void set_sandwichCompositionBufferedFrames(int32_t value);

  /// @brief Method set_sandwichCompositionRenderLatency, addr 0x39c8140, size 0x8, virtual true, abstract: false, final true
  inline void set_sandwichCompositionRenderLatency(float_t value);

  /// @brief Method set_useDynamicLighting, addr 0x39c81a8, size 0xc, virtual true, abstract: false, final true
  inline void set_useDynamicLighting(bool value);

  /// @brief Method set_virtualGreenScreenApplyDepthCulling, addr 0x39c821c, size 0xc, virtual true, abstract: false, final true
  inline void set_virtualGreenScreenApplyDepthCulling(bool value);

  /// @brief Method set_virtualGreenScreenBottomY, addr 0x39c820c, size 0x8, virtual true, abstract: false, final true
  inline void set_virtualGreenScreenBottomY(float_t value);

  /// @brief Method set_virtualGreenScreenDepthTolerance, addr 0x39c8230, size 0x8, virtual true, abstract: false, final true
  inline void set_virtualGreenScreenDepthTolerance(float_t value);

  /// @brief Method set_virtualGreenScreenTopY, addr 0x39c81fc, size 0x8, virtual true, abstract: false, final true
  inline void set_virtualGreenScreenTopY(float_t value);

  /// @brief Method set_virtualGreenScreenType, addr 0x39c81ec, size 0x8, virtual true, abstract: false, final true
