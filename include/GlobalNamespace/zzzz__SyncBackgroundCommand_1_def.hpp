...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::SyncBackgroundCommand_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::SyncBackgroundCommand_1, "", "SyncBackgroundCommand`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SyncBackgroundCommand_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SyncBackgroundCommand_1(SyncBackgroundCommand_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SyncBackgroundCommand_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SyncBackgroundCommand_1(SyncBackgroundCommand_1const&) = delete;
