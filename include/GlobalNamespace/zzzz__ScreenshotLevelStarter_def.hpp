...
// Ctor Parameters [CppParam { name: "framerate", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "screenshotPeriod", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "overwriteExistingFolder", ty: "bool", modifiers: "", def_value: None }]
...
/// @brief Method ToBeatmapKey, addr 0x57f3afc, size 0x484, virtual false, abstract: false, final false
inline ::GlobalNamespace::BeatmapKey ToBeatmapKey(::GlobalNamespace::BeatmapLevelsModel*  beatmapLevels) ;

/// @brief Method .ctor, addr 0x57f2f3c, size 0xc, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "levelId", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "characteristic", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "difficulty", ty: "::StringW", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "beatmapKey", ty: "::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_SerializedBeatmapKey", modifiers: "", def_value: None }, CppParam { name: "screenshotTimes", ty: "::System::Collections::Generic::List_1<float_t>*", modifiers: "", def_value: None }, CppParam { name: "overrideGlobalSettings", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "settings", ty: "::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Settings", modifiers: "", def_value: None }, CppParam { name: "differenceThreshold", ty: "float_t", modifiers: "", def_value: None }]
constexpr RunScreenshotLevelData_ScreenshotLevelStarter_Command(::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_SerializedBeatmapKey  beatmapKey, ::System::Collections::Generic::List_1<float_t>*  screenshotTimes, bool  overrideGlobalSettings, ::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Settings  settings, float_t  differenceThreshold) noexcept;
...
/// @brief Method <ToBeatmapKey>b__0, addr 0x57f3f84, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f3f80, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
// Ctor Parameters [CppParam { name: "command", ty: "::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command", modifiers: "", def_value: None }, CppParam { name: "gameSettings", ty: "::BeatSaber::Settings::Settings", modifiers: "", def_value: None }, CppParam { name: "playerSpecificSettings", ty: "::GlobalNamespace::PlayerSpecificSettings*", modifiers: "", def_value: None }, CppParam { name: "gameplayModifiers", ty: "::GlobalNamespace::GameplayModifiers*", modifiers: "", def_value: None }]
constexpr RunScreenshotLevelData_ScreenshotLevelStarter_FolderMetadata(::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command  command, ::BeatSaber::Settings::Settings  gameSettings, ::GlobalNamespace::PlayerSpecificSettings*  playerSpecificSettings, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers) noexcept;
...
/// @brief Field gameSettings, offset: 0x38, size: 0xf8, def value: None
 ::BeatSaber::Settings::Settings  gameSettings;

/// @brief Field playerSpecificSettings, offset: 0x130, size: 0x8, def value: None
 ::GlobalNamespace::PlayerSpecificSettings*  playerSpecificSettings;

/// @brief Field gameplayModifiers, offset: 0x138, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_FolderMetadata, playerSpecificSettings) == 0x130, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_FolderMetadata, gameplayModifiers) == 0x138, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_FolderMetadata, 0x140>, "Size mismatch!");
...
// Ctor Parameters [CppParam { name: "deviceUID", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "deviceName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "deviceType", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "devicePlatform", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "deviceModel", ty: "::StringW", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "globalScreenshotSettings", ty: "::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Settings", modifiers: "", def_value: None }, CppParam { name: "screenshotLevels", ty: "::ArrayW<::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command,::Array<::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command>*>", modifiers: "", def_value: None }]
constexpr ScreenshotLevelStarter_RunScreenshotLevelData(::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Settings  globalScreenshotSettings, ::ArrayW<::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command,::Array<::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command>*>  screenshotLevels) noexcept;
...
/// @brief Field audioTimeSyncController, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_audioTimeSyncController, put=__cordl_internal_set_audioTimeSyncController)) ::UnityW<::GlobalNamespace::AudioTimeSyncController>  audioTimeSyncController;
...
/// @brief Method <RunScreenshotLevel>b__0, addr 0x57f3fa4, size 0x20, virtual false, abstract: false, final false
inline bool _RunScreenshotLevel_b__0() ;

/// @brief Method <RunScreenshotLevel>g__GetNextScreenshotTime|2, addr 0x57f4138, size 0x94, virtual false, abstract: false, final false
inline float_t _RunScreenshotLevel_g__GetNextScreenshotTime_2() ;

/// @brief Method <RunScreenshotLevel>g__HandleLevelEnded|1, addr 0x57f3fc4, size 0x174, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f3fa0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <RunScreenshotLevel>b__3, addr 0x57f41d0, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f41cc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <cancellationTokenSource>5__12, offset 0xd0, size 0x8 
 __declspec(property(get=__cordl_internal_get__cancellationTokenSource_5__12, put=__cordl_internal_set__cancellationTokenSource_5__12)) ::System::Threading::CancellationTokenSource*  _cancellationTokenSource_5__12;
...
/// @brief Field <playerSpecificSettings>5__6, offset 0xa8, size 0x8 
 __declspec(property(get=__cordl_internal_get__playerSpecificSettings_5__6, put=__cordl_internal_set__playerSpecificSettings_5__6)) ::GlobalNamespace::PlayerSpecificSettings*  _playerSpecificSettings_5__6;
...
/// @brief Method MoveNext, addr 0x57f4204, size 0x205c, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::ScreenshotLevelStarter__RunScreenshotLevel_d__46* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x57f6314, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x57f631c, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x57f6354, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x57f41e8, size 0x1c, virtual true, abstract: false, final true
...
/// @brief Method <>m__Finally1, addr 0x57f6260, size 0xb4, virtual false, abstract: false, final false
inline void __m__Finally1() ;

/// @brief Method .ctor, addr 0x57f3234, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method MoveNext, addr 0x57f6368, size 0x288, virtual true, abstract: false, final true
inline bool MoveNext() ;

static inline ::GlobalNamespace::ScreenshotLevelStarter__RunScreenshotLevelQueue_d__45* New_ctor(int32_t  __1__state) ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x57f65f0, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset, addr 0x57f65f8, size 0x38, virtual true, abstract: false, final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current, addr 0x57f6630, size 0x8, virtual true, abstract: false, final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.IDisposable.Dispose, addr 0x57f6364, size 0x4, virtual true, abstract: false, final true
inline void System_IDisposable_Dispose() ;
...
/// @brief Method .ctor, addr 0x57f635c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(int32_t  __1__state) ;
...
/// @brief Field _commandQueue, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__commandQueue, put=__cordl_internal_set__commandQueue)) ::System::Collections::Generic::Queue_1<::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command>*  _commandQueue;
...
/// @brief Field _renderingParamsApplicator, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__renderingParamsApplicator, put=__cordl_internal_set__renderingParamsApplicator)) ::GlobalNamespace::IRenderingParamsApplicator*  _renderingParamsApplicator;
...
/// @brief Method EnqueueScreenshotLevel, addr 0x57f2f48, size 0x11c, virtual false, abstract: false, final false
inline void EnqueueScreenshotLevel(::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command  command) ;

/// @brief Method EnqueueScreenshotLevel, addr 0x57f2f0c, size 0x30, virtual false, abstract: false, final false
inline void EnqueueScreenshotLevel(::StringW  levelID, ::StringW  characteristic, ::StringW  difficulty, float_t  screenshotPeriod, ::System::Collections::Generic::List_1<float_t>*  screenshotTimes, int32_t  captureFramerate) ;

/// @brief Method HandlePauseControllerCanPause, addr 0x57f3a00, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method RunScreenshotLevel, addr 0x57f31b8, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method RunScreenshotLevelQueue, addr 0x57f3064, size 0x54, virtual false, abstract: false, final false
inline ::System::Collections::IEnumerator* RunScreenshotLevelQueue() ;

/// @brief Method SaveBuildSpecificMetadata, addr 0x57f37c4, size 0xf0, virtual false, abstract: false, final false
static inline void SaveBuildSpecificMetadata(::StringW  metadataFolderPath, ::ByRef<::StringW>  gameVersion) ;

/// @brief Method SaveDeviceMetadata, addr 0x57f35bc, size 0x208, virtual false, abstract: false, final false
static inline void SaveDeviceMetadata(::StringW  metadataFolderPath) ;

/// @brief Method SaveMetadata, addr 0x57f323c, size 0x154, virtual false, abstract: false, final false
static inline void SaveMetadata(::GlobalNamespace::RunScreenshotLevelData_ScreenshotLevelStarter_Command  command, ::StringW  metadataFolderPath, ::ByRef<::BeatSaber::Settings::Settings>  settings, ::ByRef<::GlobalNamespace::PlayerSpecificSettings*>  playerSpecificSettings, ::ByRef<::GlobalNamespace::GameplayModifiers*>  gameplayModifiers) ;

/// @brief Method SaveMetadataObject, addr 0x57f3390, size 0x22c, virtual false, abstract: false, final false
static inline void SaveMetadataObject(::System::Object*  obj, ::StringW  path) ;

/// @brief Method StopScreenshotting, addr 0x57f30b8, size 0x100, virtual false, abstract: false, final false
inline void StopScreenshotting() ;

/// @brief Method TakeScreenshotFromCamera, addr 0x57f38b4, size 0x14c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f3a1c, size 0x74, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::UnityEngine::WaitForEndOfFrame* getStaticF_kWaitForEndOfFrame() ;

/// @brief Method get_Screenshotting, addr 0x57f2efc, size 0x10, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::SerializedBeatmapKey_RunScreenshotLevelData_ScreenshotLevelStarter___c__DisplayClass4_0*, "", "ScreenshotLevelStarter/RunScreenshotLevelData/SerializedBeatmapKey/<>c__DisplayClass4_0");
