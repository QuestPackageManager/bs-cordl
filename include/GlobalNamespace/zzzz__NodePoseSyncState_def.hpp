...
public:
  ...
  /// @brief Method ApplyDelta, addr 0x22ee138, size 0x110, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NodePoseSyncState ApplyDelta(::ByRef<::GlobalNamespace::NodePoseSyncState> delta);

  /// @brief Method Deserialize, addr 0x22edeb8, size 0x40, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x22edf94, size 0x94, virtual false, abstract: false, final false
  inline bool Equals(::ByRef<::GlobalNamespace::NodePoseSyncState> other);

  /// @brief Method GetDelta, addr 0x22ee028, size 0x110, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NodePoseSyncState GetDelta(::ByRef<::GlobalNamespace::NodePoseSyncState> latest);

  /// @brief Method GetSize, addr 0x22ee248, size 0x48, virtual true, abstract: false, final true
  inline int32_t GetSize();

  /// @brief Method GetState, addr 0x22edf48, size 0x4c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::PoseSerializable GetState(::GlobalNamespace::NodePoseSyncState_NodePose nodePose);

  /// @brief Method IEquatableByReference<NodePoseSyncState>.Equals, addr 0x22ee2f0, size 0x4, virtual true, abstract: false, final true
  inline bool IEquatableByReference_NodePoseSyncState__Equals(::ByRef<::GlobalNamespace::NodePoseSyncState> other);

  /// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.ApplyDelta, addr 0x22ee2c0, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.GetDelta, addr 0x22ee290, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x22ede78, size 0x40, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method SetState, addr 0x22edef8, size 0x50, virtual true, abstract: false, final true
