...
public:
  ...
  /// @brief Method ApplyDelta, addr 0x31e87e0, size 0x124, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NodePoseSyncState ApplyDelta(::ByRef<::GlobalNamespace::NodePoseSyncState> delta);

  /// @brief Method Deserialize, addr 0x31e8550, size 0x58, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x31e8628, size 0x94, virtual false, abstract: false, final false
  inline bool Equals(::ByRef<::GlobalNamespace::NodePoseSyncState> other);

  /// @brief Method GetDelta, addr 0x31e86bc, size 0x124, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NodePoseSyncState GetDelta(::ByRef<::GlobalNamespace::NodePoseSyncState> latest);

  /// @brief Method GetSize, addr 0x31e8904, size 0x7c, virtual true, abstract: false, final true
  inline int32_t GetSize();

  /// @brief Method GetState, addr 0x31e85dc, size 0x4c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::PoseSerializable GetState(::GlobalNamespace::NodePoseSyncState_NodePose nodePose);

  /// @brief Method IEquatableByReference<NodePoseSyncState>.Equals, addr 0x31e89e0, size 0x4, virtual true, abstract: false, final true
  inline bool IEquatableByReference_NodePoseSyncState__Equals(::ByRef<::GlobalNamespace::NodePoseSyncState> other);

  /// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.ApplyDelta, addr 0x31e89b0, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.GetDelta, addr 0x31e8980, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x31e84f8, size 0x58, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method SetState, addr 0x31e85a8, size 0x34, virtual true, abstract: false, final true
