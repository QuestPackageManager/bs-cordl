...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NodePoseSyncState_NodePose, "", "NodePoseSyncState/NodePose");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::NodePoseSyncState, "", "NodePoseSyncState");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::NodePoseSyncState_NodePose) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method ApplyDelta, addr 0x32bc3e4, size 0x124, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NodePoseSyncState ApplyDelta(::by_ref<::GlobalNamespace::NodePoseSyncState> delta);

  /// @brief Method Deserialize, addr 0x32bc154, size 0x58, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x32bc22c, size 0x94, virtual false, abstract: false, final false
  inline bool Equals(::by_ref<::GlobalNamespace::NodePoseSyncState> other);

  /// @brief Method GetDelta, addr 0x32bc2c0, size 0x124, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NodePoseSyncState GetDelta(::by_ref<::GlobalNamespace::NodePoseSyncState> latest);

  /// @brief Method GetSize, addr 0x32bc508, size 0x7c, virtual true, abstract: false, final true
  inline int32_t GetSize();

  /// @brief Method GetState, addr 0x32bc1e0, size 0x4c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::PoseSerializable GetState(::GlobalNamespace::NodePoseSyncState_NodePose nodePose);

  /// @brief Method IEquatableByReference<NodePoseSyncState>.Equals, addr 0x32bc5e4, size 0x4, virtual true, abstract: false, final true
  inline bool IEquatableByReference_NodePoseSyncState__Equals(::by_ref<::GlobalNamespace::NodePoseSyncState> other);

  /// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.ApplyDelta, addr 0x32bc5b4, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.GetDelta, addr 0x32bc584, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x32bc0fc, size 0x58, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method SetState, addr 0x32bc1ac, size 0x34, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::NodePoseSyncState) == 0x48, "Size mismatch!");
