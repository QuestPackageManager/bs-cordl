...
// Write type traits
MARK_REF_T(::GlobalNamespace::IAssetSongPreviewAudioClipProvider*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IAssetSongPreviewAudioClipProvider*, "", "IAssetSongPreviewAudioClipProvider");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IAssetSongPreviewAudioClipProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IAssetSongPreviewAudioClipProvider(IAssetSongPreviewAudioClipProviderconst&) = delete;
