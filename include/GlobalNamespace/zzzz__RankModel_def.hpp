...
public:
  ...
  /// @brief Method GetRankForScore, addr 0x272497c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRankName, addr 0x27248c0, size 0xbc, virtual false, abstract: false, final false
