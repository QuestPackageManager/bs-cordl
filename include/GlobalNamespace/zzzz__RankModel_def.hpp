...
public:
  ...
  /// @brief Method GetRankForScore, addr 0x150d1e4, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRankName, addr 0x150d128, size 0xbc, virtual false, abstract: false, final false
