...
public:
  ...
  /// @brief Method GetRankForScore, addr 0x36bd8d0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRankName, addr 0x36bd7cc, size 0x104, virtual false, abstract: false, final false
