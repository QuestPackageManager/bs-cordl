...
public:
  ...
  /// @brief Method GetRankForScore, addr 0x27244b8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRankName, addr 0x27243fc, size 0xbc, virtual false, abstract: false, final false
