...
public:
  ...
  /// @brief Method GetRankForScore, addr 0x1415754, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRankName, addr 0x1415698, size 0xbc, virtual false, abstract: false, final false
