...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RoomMeshAnchor_PopulateMeshDataJob, "", "RoomMeshAnchor/PopulateMeshDataJob");
...
static_assert(sizeof(::GlobalNamespace::RoomMeshAnchor_PopulateMeshDataJob) == 0x28, "Size mismatch!");
