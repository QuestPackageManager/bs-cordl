...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15565)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15565), inst: 4462 }),
// TypeDefinitionIndex(TypeDefinitionIndex(13532))} Self: TypeDefinitionIndex(TypeDefinitionIndex(5534)) CS Name: ::LocalizedHoverHint*
