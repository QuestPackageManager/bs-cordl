...
public:
  ...
  /// @brief Method SetText, addr 0x3c054d8, size 0x18, virtual true, abstract: false, final false
  inline void SetText(::HMUI::HoverHint* hoverHint, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x3c054f0, size 0x4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::HMUI::HoverHint* hoverHint, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x3c054f4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
