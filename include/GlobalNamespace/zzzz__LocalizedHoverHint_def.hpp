...
public:
  ...
  /// @brief Method SetText, addr 0x2626570, size 0x18, virtual true, abstract: false, final false
  inline void SetText(::HMUI::HoverHint* hoverHint, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x2626588, size 0x4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::HMUI::HoverHint* hoverHint, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x262658c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
