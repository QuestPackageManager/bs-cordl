...
public:
  ...
  /// @brief Method SetText, addr 0x5a09498, size 0x14, virtual true, abstract: false, final false
  inline void SetText(::HMUI::HoverHint* hoverHint, ::StringW value);

  /// @brief Method UpdateAlignment, addr 0x5a094ac, size 0x4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::HMUI::HoverHint* hoverHint, ::BGLib::Polyglot::LanguageDirection direction);

  /// @brief Method .ctor, addr 0x5a094b0, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
