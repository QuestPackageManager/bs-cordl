...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4433)), TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(4442))}
...
public:
  ...
  /// @brief Method .ctor addr 0x234f6d0 size 0xdc virtual false final false
  inline void _ctor();
  ...
  /// @brief Method .ctor addr 0x234f7ac size 0xfc virtual false final false
  inline void _ctor(::System::ValueTuple_2<::StringW, ::GlobalNamespace::PerformancePreset*> performancePresetToLoad);

  /// @brief Method ApplyPerformancePreset addr 0x234f8a8 size 0x1c0 virtual false final false
...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3394)), TypeDefinitionIndex(TypeDefinitionIndex(2507)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2507), inst: 5315
// }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 896 }), TypeDefinitionIndex(TypeDefinitionIndex(4443)), TypeDefinitionIndex(TypeDefinitionIndex(3401)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 870 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(4435)) CS Name:
...
public:
  ...
  /// @brief Method MoveNext addr 0x234fe44 size 0x358 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x2350378 size 0xc virtual true final true
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15857)), TypeDefinitionIndex(TypeDefinitionIndex(4443)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2507), inst:
// 5315 }), TypeDefinitionIndex(TypeDefinitionIndex(2448)), TypeDefinitionIndex(TypeDefinitionIndex(2507)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2448), inst: 870 })}
...
public:
  ...
  /// @brief Method get_createScreenshotDuringTheGame addr 0x234e734 size 0x8 virtual false final false
  inline bool get_createScreenshotDuringTheGame();

  /// @brief Method set_createScreenshotDuringTheGame addr 0x234e73c size 0xc virtual false final false
  inline void set_createScreenshotDuringTheGame(bool value);

  /// @brief Method get_playingForTheFirstTime addr 0x234e748 size 0x8 virtual false final false
  inline bool get_playingForTheFirstTime();

  /// @brief Method set_playingForTheFirstTime addr 0x234e750 size 0xc virtual false final false
  inline void set_playingForTheFirstTime(bool value);

  /// @brief Method Initialize addr 0x234e75c size 0x1dc virtual false final false
  ...
  /// @brief Method Save addr 0x234f1cc size 0x504 virtual false final false
  inline void Save(::GlobalNamespace::ISaveData* saveData);

  /// @brief Method Load addr 0x234e938 size 0x894 virtual false final false
  inline void Load(::GlobalNamespace::ISaveData* saveData, bool forced);

  /// @brief Method ForceApplyPerformancePresetAsync addr 0x234fa68 size 0xc8 virtual false final false
  inline ::System::Threading::Tasks::Task* ForceApplyPerformancePresetAsync(::GlobalNamespace::__MainSettingsModelSO__Config* config);

  /// @brief Method __DeleteSettingsFiles addr 0x234fb30 size 0x140 virtual false final false
  inline void __DeleteSettingsFiles();

  static inline ::GlobalNamespace::MainSettingsModelSO* New_ctor();

  /// @brief Method .ctor addr 0x234fc70 size 0x8 virtual false final false
  inline void _ctor();
