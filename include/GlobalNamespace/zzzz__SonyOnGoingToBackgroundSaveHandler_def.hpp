...
public:
  ...
  /// @brief Method HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution, addr 0x14df7d8, size 0x114, virtual false, abstract: false, final false
  inline void HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution();

  /// @brief Method Initialize, addr 0x14df684, size 0xbc, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::SonyOnGoingToBackgroundSaveHandler* New_ctor();

  /// @brief Method OnDestroy, addr 0x14df740, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14df8ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
