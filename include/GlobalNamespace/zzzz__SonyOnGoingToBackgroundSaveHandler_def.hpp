...
public:
  ...
  /// @brief Method HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution, addr 0x26eb874, size 0xc4, virtual false, abstract: false, final false
  inline void HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution();

  /// @brief Method Initialize, addr 0x26eb72c, size 0xbc, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::SonyOnGoingToBackgroundSaveHandler* New_ctor();

  /// @brief Method OnDestroy, addr 0x26eb7e8, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26eb938, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
