...
public:
  ...
  /// @brief Method HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution, addr 0x13ed564, size 0x140, virtual false, abstract: false, final false
  inline void HandlePlatformBackgroundExecutionHelperDidGoToBackgroundExecution();

  /// @brief Method Initialize, addr 0x13ed418, size 0xb8, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::GlobalNamespace::SonyOnGoingToBackgroundSaveHandler* New_ctor();

  /// @brief Method OnDestroy, addr 0x13ed4d0, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13ed6a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
