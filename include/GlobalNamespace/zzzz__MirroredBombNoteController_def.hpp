...
public:
  ...
  /// @brief Method .ctor, addr 0x3aeef7c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3aeef34, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
