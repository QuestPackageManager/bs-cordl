...
public:
  ...
  /// @brief Method .ctor, addr 0x3af7a2c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3af79e4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
