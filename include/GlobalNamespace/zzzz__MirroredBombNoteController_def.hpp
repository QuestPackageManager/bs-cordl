...
public:
  ...
  /// @brief Method .ctor, addr 0x261dcac, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x261dc64, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
