...
public:
  ...
  /// @brief Method .ctor, addr 0x23fbdc4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x23fbe0c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
