...
public:
  ...
  /// @brief Method .ctor, addr 0x239a9e0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x239aa28, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
