...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4756), inst: 4620 }), TypeDefinitionIndex(TypeDefinitionIndex(4756)),
// TypeDefinitionIndex(TypeDefinitionIndex(4747))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4752)) CS Name: ::MirroredBombNoteController*
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11050)), TypeDefinitionIndex(TypeDefinitionIndex(4752)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst:
