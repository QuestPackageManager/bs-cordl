...
public:
  ...
  /// @brief Method .ctor, addr 0x5796230, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x57961e4, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
