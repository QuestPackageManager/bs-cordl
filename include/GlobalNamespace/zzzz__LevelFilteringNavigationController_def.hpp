...
public:
  ...
  /// @brief Method <SelectAnnotatedBeatmapLevelCollection>b__53_0, addr 0x3b6f5d0, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _SelectAnnotatedBeatmapLevelCollection_b__53_0(::GlobalNamespace::BeatmapLevelPack* pack);

  /// @brief Method .ctor, addr 0x3b6f5c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <SelectAnnotatedBeatmapLevelCollection>b__1, addr 0x3b6f5e8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b6f4bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3b6f610, size 0x4e8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3b6faf8, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method DidActivate, addr 0x3b6e574, size 0x3cc, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b6ead0, size 0x328, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidCloseBeatmapLevelCollections, addr 0x3b6f238, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAnnotatedBeatmapLevelCollectionsViewControllerDidCloseBeatmapLevelCollections();

  /// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidOpenBeatmapLevelCollections, addr 0x3b6f21c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAnnotatedBeatmapLevelCollectionsViewControllerDidOpenBeatmapLevelCollections();

  /// @brief Method HandleAnnotatedBeatmapLevelCollectionsViewControllerDidSelectAnnotatedBeatmapLevelCollection, addr 0x3b6f254, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleIncreaseNumberOfGameplays, addr 0x3b6f1b8, size 0x64, virtual false, abstract: false, final false
  inline void HandleIncreaseNumberOfGameplays();

  /// @brief Method HandleLevelSearchViewControllerDidFilterBeatmapLevelCollection, addr 0x3b6edf8, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleLevelSearchViewControllerDidStartLoading, addr 0x3b6eab0, size 0x20, virtual false, abstract: false, final false
  inline void HandleLevelSearchViewControllerDidStartLoading(::GlobalNamespace::LevelSearchViewController* obj);

  /// @brief Method HandlePlayerDataFavoriteLevelsSetDidChange, addr 0x3b6f16c, size 0x4c, virtual false, abstract: false, final false
  inline void HandlePlayerDataFavoriteLevelsSetDidChange();

  /// @brief Method HandleSelectLevelCategoryViewControllerDidSelectLevelCategory, addr 0x3b6ee5c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReplaceSecondViewController, addr 0x3b6f040, size 0xa0, virtual false, abstract: false, final false
  inline void ReplaceSecondViewController(::HMUI::ViewController* viewController);

  /// @brief Method SelectAnnotatedBeatmapLevelCollection, addr 0x3b6f2c0, size 0x1fc, virtual false, abstract: false, final false
  inline void SelectAnnotatedBeatmapLevelCollection(::GlobalNamespace::BeatmapLevelPack* levelPack);

  /// @brief Method Setup, addr 0x3b6e114, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method SetupBeatmapLevelPacks, addr 0x3b6e1c0, size 0x3b4, virtual false, abstract: false, final false
  inline void SetupBeatmapLevelPacks();

  /// @brief Method ShowPacksInSecondChildController, addr 0x3b6ee64, size 0x1dc, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateCustomSongs, addr 0x3b6f0e0, size 0x8c, virtual false, abstract: false, final false
  inline void UpdateCustomSongs();

  /// @brief Method UpdateSecondChildControllerContent, addr 0x3b6e940, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method <SetupBeatmapLevelPacks>b__39_0, addr 0x3b6f4cc, size 0x50, virtual false, abstract: false, final false
  inline bool _SetupBeatmapLevelPacks_b__39_0(::GlobalNamespace::BeatmapLevelPack* pack);

  /// @brief Method <SetupBeatmapLevelPacks>b__39_1, addr 0x3b6f51c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b6f4c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didCloseBeatmapLevelCollectionsEvent, addr 0x3b6dfa8, size 0x9c, virtual false, abstract: false, final false
  inline void add_didCloseBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method add_didOpenBeatmapLevelCollectionsEvent, addr 0x3b6de70, size 0x9c, virtual false, abstract: false, final false
  inline void add_didOpenBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method add_didPressAllSongsEvent, addr 0x3b6dd10, size 0xb0, virtual false, abstract: false, final false
  inline void add_didPressAllSongsEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>* value);

  /// @brief Method add_didSelectBeatmapLevelPackEvent, addr 0x3b6da50, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didStartLoadingEvent, addr 0x3b6dbb0, size 0xb0, virtual false, abstract: false, final false
  inline void add_didStartLoadingEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>* value);

  /// @brief Method get_selectedBeatmapLevelPack, addr 0x3b6e0e0, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevelPack* get_selectedBeatmapLevelPack();

  /// @brief Method get_selectedLevelCategory, addr 0x3b6e0f8, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory get_selectedLevelCategory();

  /// @brief Method remove_didCloseBeatmapLevelCollectionsEvent, addr 0x3b6e044, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didCloseBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method remove_didOpenBeatmapLevelCollectionsEvent, addr 0x3b6df0c, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didOpenBeatmapLevelCollectionsEvent(::System::Action* value);

  /// @brief Method remove_didPressAllSongsEvent, addr 0x3b6ddc0, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didPressAllSongsEvent(::System::Action_1<::UnityW<::GlobalNamespace::LevelFilteringNavigationController>>* value);

  /// @brief Method remove_didSelectBeatmapLevelPackEvent, addr 0x3b6db00, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didStartLoadingEvent, addr 0x3b6dc60, size 0xb0, virtual false, abstract: false, final false
