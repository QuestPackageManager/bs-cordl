...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISaberSwingRatingCounterDidFinishReceiver", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISaberSwingRatingCounterDidFinishReceiver(ISaberSwingRatingCounterDidFinishReceiverconst&) = delete;
