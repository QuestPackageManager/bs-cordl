...
public:
  ...
  __declspec(
      property(get = __cordl_internal_get__colliders,
  ...
  /// @brief Method RegisterColliderEventEffect, addr 0x26fdb1c, size 0x60, virtual false, abstract: false, final false
  inline void RegisterColliderEventEffect(::GlobalNamespace::ColliderEventEffect* colliderEventEffect);

  /// @brief Method TryGetColliderEventEffect, addr 0x26fdb94, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26fdc4c, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
