...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnvironmentCollisionRepository*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentCollisionRepository*, "", "EnvironmentCollisionRepository");
...
public:
  ...
  /// @brief Method RegisterColliderEventEffect, addr 0x59a0ca0, size 0x7c, virtual false, abstract: false, final false
  inline void RegisterColliderEventEffect(::GlobalNamespace::ColliderEventEffect* colliderEventEffect);

  /// @brief Method TryGetColliderEventEffect, addr 0x59a0d30, size 0xc0, virtual false, abstract: false, final false
  inline bool TryGetColliderEventEffect(::UnityEngine::Collider* collider, ::by_ref<::GlobalNamespace::ColliderEventEffect*> colliderEventEffect);
  ...
  /// @brief Method .ctor, addr 0x59a0df0, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentCollisionRepository", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EnvironmentCollisionRepository(EnvironmentCollisionRepository&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EnvironmentCollisionRepository", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EnvironmentCollisionRepository(EnvironmentCollisionRepositoryconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::EnvironmentCollisionRepository) == 0x18, "Size mismatch!");
