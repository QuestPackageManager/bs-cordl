...
/// @brief Field _textureValueTuples, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__textureValueTuples, put=__cordl_internal_set__textureValueTuples)) ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple,::Array<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>*>  _textureValueTuples;
...
/// @brief Method HandleBasicBeatmapEventData, addr 0x57f0308, size 0x14, virtual false, abstract: false, final false
inline void HandleBasicBeatmapEventData(::GlobalNamespace::BasicBeatmapEventData*  data) ;

/// @brief Method Initialize, addr 0x57f0014, size 0x208, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57f02ec, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetTextureByIndex, addr 0x57f021c, size 0xd0, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple,::Array<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>*> const& __cordl_internal_get__textureValueTuples() const;

constexpr ::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple,::Array<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>*>& __cordl_internal_get__textureValueTuples() ;
...
constexpr void __cordl_internal_set__textureValueTuples(::ArrayW<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple,::Array<::GlobalNamespace::TextureIntSwitchEventEffect_TextureValueTuple>*>  value) ;
...
/// @brief Method .ctor, addr 0x57f031c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
