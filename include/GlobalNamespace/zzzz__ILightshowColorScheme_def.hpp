...
// Write type traits
MARK_REF_T(::GlobalNamespace::ILightshowColorScheme*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ILightshowColorScheme*, "", "ILightshowColorScheme");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method get_overrideLights, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline bool get_overrideLights();

  /// @brief Method get_supportsEnvironmentColorBoost, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  inline bool get_supportsEnvironmentColorBoost();

  // Ctor Parameters [CppParam { name: "", ty: "ILightshowColorScheme", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ILightshowColorScheme(ILightshowColorSchemeconst&) = delete;

  /// @brief IL2CPP Metadata Type Index
  static constexpr uint32_t __IL2CPP_TYPE_DEFINITION_INDEX{ 23159 };
