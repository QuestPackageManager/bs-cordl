...
public:
  ...
  /// @brief Method SafeDestroy, addr 0x322bca8, size 0xf8, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::Object* obj);

  /// @brief Method get_CurrentTimeStamp, addr 0x322bbcc, size 0xdc, virtual false, abstract: false, final false
