...
public:
  ...
  /// @brief Method SafeDestroy, addr 0x22b882c, size 0xcc, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::Object* obj);

  /// @brief Method get_CurrentTimeStamp, addr 0x22b8754, size 0xd8, virtual false, abstract: false, final false
