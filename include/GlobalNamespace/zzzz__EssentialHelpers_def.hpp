...
public:
  ...
  /// @brief Method SafeDestroy, addr 0x3322124, size 0xf8, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::Object* obj);

  /// @brief Method get_CurrentTimeStamp, addr 0x3322048, size 0xdc, virtual false, abstract: false, final false
