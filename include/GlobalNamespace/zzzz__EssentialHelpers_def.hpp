...
public:
  ...
  /// @brief Method SafeDestroy, addr 0x22b09bc, size 0xcc, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::Object* obj);

  /// @brief Method get_CurrentTimeStamp, addr 0x22b08e4, size 0xd8, virtual false, abstract: false, final false
