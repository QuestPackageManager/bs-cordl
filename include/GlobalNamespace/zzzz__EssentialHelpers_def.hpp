...
public:
  ...
  /// @brief Method SafeDestroy, addr 0x22b4af4, size 0xcc, virtual false, abstract: false, final false
  static inline void SafeDestroy(::UnityEngine::Object* obj);

  /// @brief Method get_CurrentTimeStamp, addr 0x22b4a1c, size 0xd8, virtual false, abstract: false, final false
