...
public:
  ...
  /// @brief Method Equals, addr 0x570ffcc, size 0x20, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::HMAutoincrementedRequestId* obj);

  /// @brief Method Equals, addr 0x570ffec, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5710088, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x570fde4, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline uint64_t getStaticF__nextRequestId();

  /// @brief Method get_RequestId, addr 0x570ffc4, size 0x8, virtual false, abstract: false, final false
