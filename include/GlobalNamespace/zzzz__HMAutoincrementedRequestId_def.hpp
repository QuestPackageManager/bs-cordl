...
public:
  ...
  /// @brief Method Equals, addr 0x585701c, size 0x20, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::HMAutoincrementedRequestId* obj);

  /// @brief Method Equals, addr 0x585703c, size 0x9c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x58570d8, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5856e34, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline uint64_t getStaticF__nextRequestId();

  /// @brief Method get_RequestId, addr 0x5857014, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HMAutoincrementedRequestId", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HMAutoincrementedRequestId(HMAutoincrementedRequestId&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HMAutoincrementedRequestId", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HMAutoincrementedRequestId(HMAutoincrementedRequestIdconst&) = delete;
