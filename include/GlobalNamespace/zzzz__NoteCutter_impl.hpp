...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteCutter_CuttableBySaberSortParams::*)()>(&::GlobalNamespace::NoteCutter_CuttableBySaberSortParams::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5844534;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::*)(::System::Object*, ::System::Object*)>(&::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::Compare)> {
  constexpr static std::size_t size = 0x12c;
  constexpr static std::size_t addrs = 0x5844538;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer*>::get(),
                        "Compare",
                        std::span<const Il2CppClass* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::*)()>(&::GlobalNamespace::NoteCutter_CuttableBySaberSortParamsComparer::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x5844530;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteCutter::*)()>(&::GlobalNamespace::NoteCutter::_ctor)> {
  constexpr static std::size_t size = 0x12c;
  constexpr static std::size_t addrs = 0x5844404;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteCutter::*)(::GlobalNamespace::Saber*)>(&::GlobalNamespace::NoteCutter::Cut)> {
  ...
  constexpr static std::size_t addrs = 0x5843d84;
...
constexpr ::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*,::Array<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*>*>& GlobalNamespace::NoteCutter::__cordl_internal_get__cuttableBySaberSortParams()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cuttableBySaberSortParams;
}
constexpr ::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*,::Array<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*>*> const& GlobalNamespace::NoteCutter::__cordl_internal_get__cuttableBySaberSortParams() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____cuttableBySaberSortParams;
}
constexpr void GlobalNamespace::NoteCutter::__cordl_internal_set__cuttableBySaberSortParams(::ArrayW<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*,::Array<::GlobalNamespace::NoteCutter_CuttableBySaberSortParams*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
