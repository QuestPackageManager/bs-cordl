...
public:
  ...
  /// @brief Method Serialize, addr 0x133d03c, size 0x68, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize, addr 0x133d0a4, size 0x7c, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x133d120, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::Vector4Serializable other);

  /// @brief Method Approximately, addr 0x133d164, size 0x74, virtual false, abstract: false, final false
  inline bool Approximately(::GlobalNamespace::Vector4Serializable other);

  /// @brief Method Equals, addr 0x133d1d8, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x133d280, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x133d29c, size 0x25c, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method GetSize, addr 0x133d4f8, size 0x6c, virtual false, abstract: false, final false
  inline int32_t GetSize();

  /// @brief Method .ctor, addr 0x133d564, size 0x34c, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Vector4 v);

  /// @brief Method .ctor, addr 0x133d8b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method op_Implicit, addr 0x133d8b8, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 op_Implicit___UnityEngine__Vector4(::GlobalNamespace::Vector4Serializable v);

  /// @brief Method op_Implicit, addr 0x133d8ec, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x133d910, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Subtraction, addr 0x133d93c, size 0x2c, virtual false, abstract: false, final false
