...
public:
  ...
  /// @brief Method Approximately, addr 0x3782494, size 0x74, virtual false, abstract: false, final false
  inline bool Approximately(::GlobalNamespace::Vector4Serializable other);

  /// @brief Method Deserialize, addr 0x37823c4, size 0x8c, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x3782508, size 0xac, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x3782450, size 0x44, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::Vector4Serializable other);

  /// @brief Method GetHashCode, addr 0x37825b4, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetSize, addr 0x3782730, size 0xcc, virtual false, abstract: false, final false
  inline int32_t GetSize();

  /// @brief Method Serialize, addr 0x3782328, size 0x9c, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToString, addr 0x37825d0, size 0x160, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x3782b74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method .ctor, addr 0x37827fc, size 0x378, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Addition, addr 0x3782bd4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x3782bb0, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Implicit, addr 0x3782b7c, size 0x34, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector4 op_Implicit___UnityEngine__Vector4(::GlobalNamespace::Vector4Serializable v);

  /// @brief Method op_Subtraction, addr 0x3782c00, size 0x2c, virtual false, abstract: false, final false
