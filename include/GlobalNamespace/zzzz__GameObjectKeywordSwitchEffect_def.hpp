...
/// @brief Method .ctor, addr 0x57e0820, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _gameObjectKeywordItems, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__gameObjectKeywordItems, put=__cordl_internal_set__gameObjectKeywordItems)) ::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*,::Array<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>*>  _gameObjectKeywordItems;

/// @brief Method Initialize, addr 0x57e06d4, size 0x148, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*,::Array<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>*> const& __cordl_internal_get__gameObjectKeywordItems() const;

constexpr ::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*,::Array<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>*>& __cordl_internal_get__gameObjectKeywordItems() ;

constexpr void __cordl_internal_set__defaultGameObject(::UnityW<::UnityEngine::GameObject>  value) ;

constexpr void __cordl_internal_set__gameObjectKeywordItems(::ArrayW<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*,::Array<::GlobalNamespace::GameObjectKeywordSwitchEffect_GameObjectKeywordItem*>*>  value) ;

/// @brief Method .ctor, addr 0x57e081c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
