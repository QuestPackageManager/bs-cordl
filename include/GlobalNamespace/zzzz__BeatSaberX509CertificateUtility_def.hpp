...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatSaberX509CertificateUtility*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatSaberX509CertificateUtility*, "", "BeatSaberX509CertificateUtility");
// Dependencies System.Object, System.Security.Cryptography.X509Certificates.X509Certificate2
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = getStaticF__rootCertificates, put = setStaticF__rootCertificates)) ::ArrayW<::System::Security::Cryptography::X509Certificates::X509Certificate2*> _rootCertificates;
  ...
  static inline void setStaticF__rootCertificates(::ArrayW<::System::Security::Cryptography::X509Certificates::X509Certificate2*> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatSaberX509CertificateUtility", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatSaberX509CertificateUtility(BeatSaberX509CertificateUtility&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatSaberX509CertificateUtility", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatSaberX509CertificateUtility(BeatSaberX509CertificateUtilityconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatSaberX509CertificateUtility) == 0x10, "Size mismatch!");
