...
public:
  ...
  /// @brief Method GetRootCertificates, addr 0x320eb94, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method GetRootCertificatesRaw, addr 0x320ec9c, size 0xbc, virtual false, abstract: false, final false
  static inline ::StringW GetRootCertificatesRaw();

  static inline ::GlobalNamespace::BeatSaberX509CertificateUtility* New_ctor();

  /// @brief Method .ctor, addr 0x320ed58, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
