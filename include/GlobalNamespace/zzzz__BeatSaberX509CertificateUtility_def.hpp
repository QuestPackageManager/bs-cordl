...
/// @brief Field _rootCertificates, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__rootCertificates, put=setStaticF__rootCertificates)) ::ArrayW<::System::Security::Cryptography::X509Certificates::X509Certificate2*,::Array<::System::Security::Cryptography::X509Certificates::X509Certificate2*>*>  _rootCertificates;
...
/// @brief Method GetRootCertificates, addr 0x31d2f2c, size 0x108, virtual false, abstract: false, final false
...
/// @brief Method GetRootCertificatesRaw, addr 0x31d3034, size 0xbc, virtual false, abstract: false, final false
static inline ::StringW GetRootCertificatesRaw() ;

static inline ::GlobalNamespace::BeatSaberX509CertificateUtility* New_ctor() ;

/// @brief Method .ctor, addr 0x31d30f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::ArrayW<::System::Security::Cryptography::X509Certificates::X509Certificate2*,::Array<::System::Security::Cryptography::X509Certificates::X509Certificate2*>*> getStaticF__rootCertificates() ;

static inline ::StringW getStaticF_kBeatSaberDotComRootCertificate() ;

static inline void setStaticF__rootCertificates(::ArrayW<::System::Security::Cryptography::X509Certificates::X509Certificate2*,::Array<::System::Security::Cryptography::X509Certificates::X509Certificate2*>*>  value) ;
