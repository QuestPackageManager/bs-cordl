...
public:
  ...
  /// @brief Method Get, addr 0x22a1378, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22a143c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
