...
public:
  ...
  /// @brief Method Get, addr 0x3b71644, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7170c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
