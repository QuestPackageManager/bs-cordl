...
public:
  ...
  /// @brief Method Get, addr 0x22755c0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2275634, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
