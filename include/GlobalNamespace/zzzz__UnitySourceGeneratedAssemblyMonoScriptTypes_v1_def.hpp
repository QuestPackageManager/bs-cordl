...
public:
  ...
  /// @brief Method Get, addr 0x587d8e8, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x587d9a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
