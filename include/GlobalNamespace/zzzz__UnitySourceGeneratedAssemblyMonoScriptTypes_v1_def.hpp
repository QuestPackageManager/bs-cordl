...
public:
  ...
  /// @brief Method Get, addr 0x229ab1c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x229abe0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
