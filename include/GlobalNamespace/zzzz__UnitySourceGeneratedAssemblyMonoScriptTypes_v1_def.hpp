...
public:
  ...
  /// @brief Method Get, addr 0x3195048, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3195108, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
