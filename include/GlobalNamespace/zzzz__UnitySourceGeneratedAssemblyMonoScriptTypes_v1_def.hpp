...
public:
  ...
  /// @brief Method Get, addr 0x226afe0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x226b0a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
