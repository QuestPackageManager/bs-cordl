...
public:
  ...
  /// @brief Method Get, addr 0x44d9ad4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x44d9b98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
