...
public:
  ...
  /// @brief Method get_endPoint addr 0xe33b78 size 0x74 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe32a1c size 0x30 virtual false final false
  ...
  /// @brief Method .ctor addr 0xe33bec size 0xb4 virtual false final false
  inline void _ctor(::System::Net::IPEndPoint* endPoint);

  /// @brief Method GetEndPointAsync addr 0xe33ca0 size 0x120 virtual false final false
  inline ::System::Threading::Tasks::Task_1<::System::Net::IPEndPoint*>* GetEndPointAsync(::BGNet::Core::ITaskUtility* taskUtility);

  /// @brief Method GetEndPoint addr 0xe33dc0 size 0x94 virtual false final false
  inline ::System::Net::IPEndPoint* GetEndPoint();

  /// @brief Method GetEndPointInternal addr 0xe33e54 size 0xb0 virtual false final false
  inline ::System::Net::IPEndPoint* GetEndPointInternal();

  /// @brief Method ToString addr 0xe33f04 size 0x8c virtual true final false
  inline ::StringW ToString();

  /// @brief Method Equals addr 0xe33f90 size 0xa0 virtual true final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals addr 0xe34030 size 0x4c virtual true final true
  inline bool Equals(::GlobalNamespace::DnsEndPoint* other);

  /// @brief Method GetHashCode addr 0xe3407c size 0x2c virtual true final false
