...
// Write type traits
MARK_REF_T(::GlobalNamespace::DnsEndPoint*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DnsEndPoint*, "", "DnsEndPoint");
...
public:
  ...
  /// @brief Method Equals, addr 0x332fec8, size 0xa8, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x332ff70, size 0x50, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::DnsEndPoint* other);

  /// @brief Method GetEndPoint, addr 0x332fcd8, size 0x9c, virtual false, abstract: false, final false
  inline ::System::Net::IPEndPoint* GetEndPoint();

  /// @brief Method GetEndPointAsync, addr 0x332fbb8, size 0x120, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::System::Net::IPEndPoint*>* GetEndPointAsync(::BGNet::Core::ITaskUtility* taskUtility);

  /// @brief Method GetEndPointInternal, addr 0x332fd74, size 0xb4, virtual false, abstract: false, final false
  inline ::System::Net::IPEndPoint* GetEndPointInternal();

  /// @brief Method GetHashCode, addr 0x332ffc0, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x332fe28, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x332fb04, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::IPEndPoint* endPoint);

  /// @brief Method .ctor, addr 0x332faf8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW hostName, int32_t port);

  /// @brief Method get_endPoint, addr 0x332fa60, size 0x98, virtual false, abstract: false, final false
...
public:
  ...
  DnsEndPoint(DnsEndPointconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::DnsEndPoint) == 0x28, "Size mismatch!");
