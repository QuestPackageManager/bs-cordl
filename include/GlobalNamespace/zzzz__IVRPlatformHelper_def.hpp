...
public:
  ...
  /// @brief Method GetRootPositionOffsetForLegacyNodePose, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  /// @brief Method TryGetLegacyPoseOffsetForNode, addr 0x0, size 0xffffffffffffffff, virtual true, abstract: true, final false
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IVRPlatformHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IVRPlatformHelper(IVRPlatformHelperconst&) = delete;
