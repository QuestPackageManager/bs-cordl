...
public:
  // Declarations
  /// @brief Method Awake, addr 0x570a154, size 0x24, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::DisableOnNonSteam* New_ctor();

  /// @brief Method .ctor, addr 0x570a178, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
