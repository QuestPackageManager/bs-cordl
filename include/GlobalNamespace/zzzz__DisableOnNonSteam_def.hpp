...
public:
  // Declarations
  /// @brief Method Awake, addr 0x22b1104, size 0x24, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::DisableOnNonSteam* New_ctor();

  /// @brief Method .ctor, addr 0x22b1128, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
