...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(15440))]
...
public:
  ...
  /// @brief Method .ctor, addr 0xe40294, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
