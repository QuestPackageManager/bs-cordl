...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EventsTestScenesTransitionSetupDataSO::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3b3b9e8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::EventsTestScenesTransitionSetupDataSO::*)()>(
  ...
  constexpr static std::size_t addrs = 0x3b3bbc0;
...
constexpr ::UnityW<::GlobalNamespace::EnvironmentInfoSO>& GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_get__environmentInfo() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____environmentInfo;
}
constexpr ::UnityW<::GlobalNamespace::EnvironmentInfoSO> const& GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_get__environmentInfo() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____environmentInfo;
}
constexpr void GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_set__environmentInfo(::UnityW<::GlobalNamespace::EnvironmentInfoSO> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::UnityW<::GlobalNamespace::SceneInfo>& GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_get__eventsTestSceneInfo() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____eventsTestSceneInfo;
}
constexpr ::UnityW<::GlobalNamespace::SceneInfo> const& GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_get__eventsTestSceneInfo() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____eventsTestSceneInfo;
}
constexpr void GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_set__eventsTestSceneInfo(::UnityW<::GlobalNamespace::SceneInfo> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::UnityW<::GlobalNamespace::SceneInfo>& GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_get__gameCoreSceneInfo() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____gameCoreSceneInfo;
}
constexpr ::UnityW<::GlobalNamespace::SceneInfo> const& GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_get__gameCoreSceneInfo() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____gameCoreSceneInfo;
}
constexpr void GlobalNamespace::EventsTestScenesTransitionSetupDataSO::__cordl_internal_set__gameCoreSceneInfo(::UnityW<::GlobalNamespace::SceneInfo> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
