...
// Ctor Parameters [CppParam { name: "packetsSentDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "packetsReceivedDelta", ty: "int64_t", modifiers: "",
// def_value: Some("{}"), comment: None }, CppParam { name: "bytesSentDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "bytesReceivedDelta", ty:
// "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "packetsLostDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "packetsSentEncryptedDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "packetsSentPlaintextDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "packetsSentRejectedDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "packetsReceivedEncryptedDelta", ty: "int64_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "packetsReceivedPlaintextDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name:
// "packetsReceivedRejectedDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "encryptionProcessingTimeDelta", ty: "int64_t", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "decryptionProcessingTimeDelta", ty: "int64_t", modifiers: "", def_value: Some("{}"), comment: None }]
