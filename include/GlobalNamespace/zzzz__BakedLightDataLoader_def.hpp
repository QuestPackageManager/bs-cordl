...
public:
  ...
  /// @brief Method get_lightmapData, addr 0x23220ac, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::LightmapDataSO> get_lightmapData();

  /// @brief Method set_lightmapData, addr 0x23220b4, size 0x8, virtual false, abstract: false, final false
  inline void set_lightmapData(::GlobalNamespace::LightmapDataSO* value);

  /// @brief Method Start, addr 0x23220bc, size 0xb8, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method SetTextureDataToShaders, addr 0x2322174, size 0x13c, virtual false, abstract: false, final false
  inline void SetTextureDataToShaders();

  static inline ::GlobalNamespace::BakedLightDataLoader* New_ctor();

  /// @brief Method .ctor, addr 0x23222b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
