...
public:
  ...
  /// @brief Method SetTextureDataToShaders, addr 0x3b19514, size 0x13c, virtual false, abstract: false, final false
  inline void SetTextureDataToShaders();

  /// @brief Method Start, addr 0x3b1945c, size 0xb8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b19650, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_lightmapData, addr 0x3b1944c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_lightmapData, addr 0x3b19454, size 0x8, virtual false, abstract: false, final false
