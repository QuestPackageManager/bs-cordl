...
public:
  ...
  /// @brief Method SetTextureDataToShaders, addr 0x57bfd2c, size 0x144, virtual false, abstract: false, final false
  inline void SetTextureDataToShaders();

  /// @brief Method Start, addr 0x57bfc68, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x57bfe70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_lightmapData, addr 0x57bfc58, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_lightmapData, addr 0x57bfc60, size 0x8, virtual false, abstract: false, final false
