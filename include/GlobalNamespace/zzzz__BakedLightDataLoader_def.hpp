...
public:
  ...
  /// @brief Method SetTextureDataToShaders, addr 0x3b0eff0, size 0x13c, virtual false, abstract: false, final false
  inline void SetTextureDataToShaders();

  /// @brief Method Start, addr 0x3b0ef38, size 0xb8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b0f12c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_lightmapData, addr 0x3b0ef28, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_lightmapData, addr 0x3b0ef30, size 0x8, virtual false, abstract: false, final false
