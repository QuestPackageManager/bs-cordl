...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlayerControllerDataPacket", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlayerControllerDataPacket(PlayerControllerDataPacket&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlayerControllerDataPacket", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlayerControllerDataPacket(PlayerControllerDataPacketconst&) = delete;
