...
public:
  ...
  /// @brief Method <GetPlayerSaveData>b__19_0, addr 0x368bfe8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method <LoadFromCurrentVersion>b__24_0, addr 0x368c088, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368bfe4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x368c0d8, size 0x3cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x368c4a4, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x368c524, size 0x29c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x368c7c0, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method ColorOverrideTypeFromSaveData, addr 0x368b290, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method ColorOverrideTypeToSaveData, addr 0x36890dc, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateDefaultOverrideEnvironmentSettings, addr 0x368b29c, size 0xb8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OverrideEnvironmentSettings* CreateDefaultOverrideEnvironmentSettings();

  /// @brief Method CreateDefaultPlayerData, addr 0x36895d8, size 0xc8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerData* CreateDefaultPlayerData();

  /// @brief Method GetBeatmapCharacteristicFromV_1_0_1LevelId, addr 0x368b90c, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentInfoBySerializedName, addr 0x368bd28, size 0x18, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetEnvironmentInfoBySerializedName(::StringW environmentName);

  /// @brief Method GetLevelIdFromV_1_0_1LevelId, addr 0x368bca8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPlayerSaveData, addr 0x3687e40, size 0xf74, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSaveData* GetPlayerSaveData(::GlobalNamespace::PlayerData* playerData);

  /// @brief Method Init, addr 0x3687c6c, size 0x78, virtual false, abstract: false, final false
  static inline void Init();

  /// @brief Method Load, addr 0x3689170, size 0x68, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerData* Load();

  /// @brief Method LoadAsString, addr 0x36891d8, size 0x128, virtual false, abstract: false, final false
  static inline ::StringW LoadAsString(::GlobalNamespace::IFileStorage* fileStorage);

  /// @brief Method LoadAsStringAsync, addr 0x368bd40, size 0xdc, virtual false, abstract: false, final false
  static inline ::System::Threading::Tasks::Task_1<::StringW>* LoadAsStringAsync(::GlobalNamespace::IFileStorage* fileStorage);

  /// @brief Method LoadAsync, addr 0x3689324, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::PlayerData*>* LoadAsync();

  /// @brief Method LoadCorrectedSongPackMask, addr 0x368b354, size 0x8c, virtual false, abstract: false, final false
  inline ::StringW LoadCorrectedSongPackMask(::ArrayW<uint8_t, ::Array<uint8_t>*> songMaskPackBytes);

  /// @brief Method LoadFromCurrentVersion, addr 0x368a088, size 0x1060, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerData* LoadFromCurrentVersion(::GlobalNamespace::PlayerSaveData* playerSaveData);

  /// @brief Method LoadFromJSONString, addr 0x3689400, size 0x1d8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerData* LoadFromJSONString(::StringW jsonString);

  /// @brief Method LoadFromVersionV1_0_1, addr 0x36896a0, size 0x9e8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerData* LoadFromVersionV1_0_1(::GlobalNamespace::PlayerSaveDataV1_0_1* playerDataModelSaveData);

  /// @brief Method LoadOrCreateFromJsonString, addr 0x3689300, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method Save, addr 0x3687cf4, size 0x14c, virtual false, abstract: false, final false
  inline void Save(::GlobalNamespace::PlayerData* playerData);

  /// @brief Method SaveAsync, addr 0x3688db4, size 0x14c, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SaveAsync(::GlobalNamespace::PlayerData* playerData);

  /// @brief Method WipePlayerDataFiles, addr 0x368be1c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3687ce4, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method get_PlayerDataFileName, addr 0x3687b80, size 0x5c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_PlayerDataFileName, addr 0x3687bdc, size 0x90, virtual false, abstract: false, final false
