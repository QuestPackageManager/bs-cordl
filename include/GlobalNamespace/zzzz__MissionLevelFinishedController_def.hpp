...
/// @brief Method HandleLevelFinished, addr 0x58084e0, size 0x4, virtual false, abstract: false, final false
inline void HandleLevelFinished() ;

static inline ::GlobalNamespace::MissionLevelFinishedController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x58083a8, size 0x138, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x58082b4, size 0xf4, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartLevelFinished, addr 0x58084e4, size 0xb4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5808598, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
