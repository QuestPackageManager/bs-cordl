...
public:
  ...
  /// @brief Method HandleLevelFinished, addr 0x5918f60, size 0x4, virtual false, abstract: false, final false
  inline void HandleLevelFinished();

  static inline ::GlobalNamespace::MissionLevelFinishedController* New_ctor();

  /// @brief Method OnDestroy, addr 0x5918e28, size 0x138, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x5918d34, size 0xf4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartLevelFinished, addr 0x5918f64, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x591901c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
