...
public:
  ...
  /// @brief Method SetAlternativeAnimationAndMaterial, addr 0x105a778, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x105abc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animator, addr 0x105a768, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> get_animator();

  /// @brief Method get_characterName, addr 0x105a758, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_characterName();

  /// @brief Method get_headTransform, addr 0x105a770, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_headTransform();

  /// @brief Method get_materialPropertyBlockController, addr 0x105a760, size 0x8, virtual false, abstract: false, final false
