...
public:
  ...
  /// @brief Method SetAlternativeAnimationAndMaterial, addr 0x31eb490, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31eb888, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animator, addr 0x31eb480, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> get_animator();

  /// @brief Method get_characterName, addr 0x31eb470, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_characterName();

  /// @brief Method get_headTransform, addr 0x31eb488, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_headTransform();

  /// @brief Method get_materialPropertyBlockController, addr 0x31eb478, size 0x8, virtual false, abstract: false, final false
