...
public:
  ...
  /// @brief Method SetAlternativeAnimationAndMaterial, addr 0x3284404, size 0x1e4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x32847fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_animator, addr 0x32843f4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Animator> get_animator();

  /// @brief Method get_characterName, addr 0x32843e4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_characterName();

  /// @brief Method get_headTransform, addr 0x32843fc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_headTransform();

  /// @brief Method get_materialPropertyBlockController, addr 0x32843ec, size 0x8, virtual false, abstract: false, final false
