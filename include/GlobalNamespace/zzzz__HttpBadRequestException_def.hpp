...
public:
  // Ctor Parameters [CppParam { name: "", ty: "HttpBadRequestException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  HttpBadRequestException(HttpBadRequestException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "HttpBadRequestException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  HttpBadRequestException(HttpBadRequestExceptionconst&) = delete;
