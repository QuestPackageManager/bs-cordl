...
/// @brief Field _activeBeatLines, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__activeBeatLines, put=__cordl_internal_set__activeBeatLines)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::Vector4,::UnityW<::GlobalNamespace::BeatLine>>*  _activeBeatLines;
...
/// @brief Field _removeBeatLineKeyList, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__removeBeatLineKeyList, put=__cordl_internal_set__removeBeatLineKeyList)) ::System::Collections::Generic::List_1<::UnityEngine::Vector4>*  _removeBeatLineKeyList;
...
/// @brief Method HandleNoteWasSpawned, addr 0x5714e0c, size 0x19c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5714820, size 0x90, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5714790, size 0x90, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method Update, addr 0x57148b0, size 0x55c, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5714fa8, size 0xd8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_isMidRotationValid, addr 0x5714778, size 0x8, virtual false, abstract: false, final false
inline bool get_isMidRotationValid() ;

/// @brief Method get_midRotation, addr 0x5714780, size 0x8, virtual false, abstract: false, final false
inline float_t get_midRotation() ;

/// @brief Method get_rotationRange, addr 0x5714788, size 0x8, virtual false, abstract: false, final false
