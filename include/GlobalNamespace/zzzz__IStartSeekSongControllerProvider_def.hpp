...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IStartSeekSongControllerProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IStartSeekSongControllerProvider(IStartSeekSongControllerProviderconst&) = delete;
