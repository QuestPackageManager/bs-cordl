...
public:
  ...
  /// @brief Method Start, addr 0x5863e94, size 0x44, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5863f1c, size 0x98, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePos, addr 0x5863ed8, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5863fb4, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
