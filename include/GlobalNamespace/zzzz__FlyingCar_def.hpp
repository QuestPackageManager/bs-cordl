...
public:
  ...
  /// @brief Method Start, addr 0x25ce808, size 0x44, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x25ce890, size 0x60, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePos, addr 0x25ce84c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ce8f0, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::FlyingCar, ____startZ) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FlyingCar, ____endZ) == 0x1c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FlyingCar, ____speed) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FlyingCar, ____progress) == 0x24, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::FlyingCar, ____pos) == 0x28, "Offset mismatch!");
