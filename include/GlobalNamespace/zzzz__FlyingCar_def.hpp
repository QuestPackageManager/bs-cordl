...
public:
  ...
  /// @brief Method Start addr 0x227b768 size 0x44 virtual false final false
  inline void Start();

  /// @brief Method Update addr 0x227b7f0 size 0x60 virtual false final false
  inline void Update();

  /// @brief Method UpdatePos addr 0x227b7ac size 0x44 virtual false final false
  inline void UpdatePos();

  static inline ::GlobalNamespace::FlyingCar* New_ctor();

  /// @brief Method .ctor addr 0x227b850 size 0x1c virtual false final false
  inline void _ctor();
