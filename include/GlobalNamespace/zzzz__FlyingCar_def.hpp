...
public:
  ...
  /// @brief Method Start, addr 0x23b4580, size 0x44, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x23b4608, size 0x60, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdatePos, addr 0x23b45c4, size 0x44, virtual false, abstract: false, final false
  inline void UpdatePos();

  static inline ::GlobalNamespace::FlyingCar* New_ctor();

  /// @brief Method .ctor, addr 0x23b4668, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
