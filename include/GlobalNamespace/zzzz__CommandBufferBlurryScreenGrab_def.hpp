...
public:
  ...
  /// @brief Method CamerasDict, addr 0x5e05484, size 0x5c, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::Dictionary_2<::UnityW<::UnityEngine::Camera>, ::GlobalNamespace::CommandBufferOwners*>* CamerasDict();

  /// @brief Method CommandBufferCameraEvent, addr 0x5e054e0, size 0x8, virtual true, abstract: false, final false
  inline ::UnityEngine::Rendering::CameraEvent CommandBufferCameraEvent();

  /// @brief Method CreateCommandBuffer, addr 0x5e05380, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e054e8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
