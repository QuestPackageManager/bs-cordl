...
// Write type traits
MARK_REF_T(::GlobalNamespace::SinglePositionTween*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SinglePositionTween*, "", "SinglePositionTween");
...
public:
  ...
  /// @brief Method CreatePlayable, addr 0x59070f0, size 0x1f8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59072e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x59070e8, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::SinglePositionTween) == 0x30, "Size mismatch!");
