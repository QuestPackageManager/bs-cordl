...
public:
  ...
  /// @brief Method MoveNext, addr 0x58ef650, size 0x2a8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x58ef8f8, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x58ef900, size 0x458, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x58efd58, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method ClearCache, addr 0x58ef198, size 0x348, virtual false, abstract: false, final false
  inline void ClearCache();

  /// @brief Method DestroySprite, addr 0x58ef59c, size 0xb4, virtual false, abstract: false, final false
  static inline void DestroySprite(::UnityEngine::Sprite* sprite);

  /// @brief Method DestroySpriteTask, addr 0x58ef4e0, size 0xac, virtual false, abstract: false, final false
  inline void DestroySpriteTask(::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>* spriteTask);

  /// @brief Method HandleItemWillBeRemovedFromCache, addr 0x58ef58c, size 0x10, virtual false, abstract: false, final false
  inline void HandleItemWillBeRemovedFromCache(::StringW path, ::StringW _);

  /// @brief Method LoadSpriteAsync, addr 0x58eef5c, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSprite, addr 0x58ef0e0, size 0xb8, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSprite, addr 0x58ef0d0, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58eee04, size 0x158, virtual false, abstract: false, final false
