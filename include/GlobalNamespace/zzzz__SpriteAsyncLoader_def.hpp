...
public:
  ...
  /// @brief Method MoveNext, addr 0x3c20314, size 0x288, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3c2059c, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3c205a8, size 0x434, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3c209dc, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method ClearCache, addr 0x3c1fe5c, size 0x360, virtual false, abstract: false, final false
  inline void ClearCache();

  /// @brief Method DestroySprite, addr 0x3c20264, size 0xb0, virtual false, abstract: false, final false
  static inline void DestroySprite(::UnityEngine::Sprite* sprite);

  /// @brief Method DestroySpriteTask, addr 0x3c201bc, size 0x98, virtual false, abstract: false, final false
  inline void DestroySpriteTask(::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>* spriteTask);

  /// @brief Method HandleItemWillBeRemovedFromCache, addr 0x3c20254, size 0x10, virtual false, abstract: false, final false
  inline void HandleItemWillBeRemovedFromCache(::StringW path, ::StringW _);

  /// @brief Method LoadSpriteAsync, addr 0x3c1fc3c, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSprite, addr 0x3c1fdb8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method UnloadSprite, addr 0x3c1fda8, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c1fae4, size 0x158, virtual false, abstract: false, final false
