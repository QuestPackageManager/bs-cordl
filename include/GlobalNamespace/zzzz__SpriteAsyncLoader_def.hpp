...
/// @brief Method MoveNext, addr 0x587d6e4, size 0x2a8, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x587d98c, size 0x8, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "spriteTask", ty: "::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::SpriteAsyncLoader*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>", modifiers: "", def_value: None }]
constexpr SpriteAsyncLoader__DestroySpriteTask_d__10(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*  spriteTask, ::GlobalNamespace::SpriteAsyncLoader*  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x587d994, size 0x458, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x587ddec, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "cache", ty: "::GlobalNamespace::IReferenceCountingCache_2<::StringW,::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*>*", modifiers: "", def_value: None }, CppParam { name: "path", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::SpriteAsyncLoader*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>", modifiers: "", def_value: None }]
...
/// @brief Field _loadFunc, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__loadFunc, put=__cordl_internal_set__loadFunc)) ::System::Func_3<::StringW,::System::Threading::CancellationToken,::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*>*  _loadFunc;
...
/// @brief Field _referenceCountingCache, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__referenceCountingCache, put=__cordl_internal_set__referenceCountingCache)) ::GlobalNamespace::ReferenceCountingCache_2<::StringW,::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*>*  _referenceCountingCache;

/// @brief Method ClearCache, addr 0x587d22c, size 0x348, virtual false, abstract: false, final false
inline void ClearCache() ;

/// @brief Method DestroySprite, addr 0x587d630, size 0xb4, virtual false, abstract: false, final false
static inline void DestroySprite(::UnityEngine::Sprite*  sprite) ;

/// @brief Method DestroySpriteTask, addr 0x587d574, size 0xac, virtual false, abstract: false, final false
inline void DestroySpriteTask(::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*  spriteTask) ;

/// @brief Method HandleItemWillBeRemovedFromCache, addr 0x587d620, size 0x10, virtual false, abstract: false, final false
inline void HandleItemWillBeRemovedFromCache(::StringW  path, ::StringW  _) ;

/// @brief Method LoadSpriteAsync, addr 0x587cff0, size 0x174, virtual false, abstract: false, final false
inline ::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>* LoadSpriteAsync(::StringW  path) ;

static inline ::GlobalNamespace::SpriteAsyncLoader* New_ctor(::System::Func_3<::StringW,::System::Threading::CancellationToken,::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*>*  loadFunc, ::System::Action_1<::UnityW<::UnityEngine::Sprite>>*  destroyFunc, int32_t  cacheSize) ;

/// @brief Method UnloadSprite, addr 0x587d174, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method UnloadSprite, addr 0x587d164, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x587ce98, size 0x158, virtual false, abstract: false, final false
inline void _ctor(::System::Func_3<::StringW,::System::Threading::CancellationToken,::System::Threading::Tasks::Task_1<::UnityW<::UnityEngine::Sprite>>*>*  loadFunc, ::System::Action_1<::UnityW<::UnityEngine::Sprite>>*  destroyFunc, int32_t  cacheSize) ;
