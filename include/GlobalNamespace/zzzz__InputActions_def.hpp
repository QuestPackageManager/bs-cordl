...
public:
  ...
  /// @brief Method HasInputFocus, addr 0x3b12290, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ResolveGameplayCoreSceneContext, addr 0x3b12534, size 0x3b0, virtual false, abstract: false, final false
  static inline ::UnityW<::Zenject::SceneContext> ResolveGameplayCoreSceneContext();

  /// @brief Method ToggleAutopilot, addr 0x3b12390, size 0x1a0, virtual false, abstract: false, final false
  static inline void ToggleAutopilot();

  /// @brief Method ToggleLevelFreeze, addr 0x3b12530, size 0x4, virtual false, abstract: false, final false
  static inline void ToggleLevelFreeze();

  /// @brief Method Update, addr 0x3b120c0, size 0x1d0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3b128e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
