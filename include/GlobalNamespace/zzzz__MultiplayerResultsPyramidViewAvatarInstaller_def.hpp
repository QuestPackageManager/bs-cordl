...
/// @brief Method InstallBindings, addr 0x5839a54, size 0x304, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5839d58, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
