...
public:
  ...
  /// @brief Method MoveNext, addr 0x3bfe174, size 0x134, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3bfe2a8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3bfe2b0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3bfe2e8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3bfe170, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3bfe0e4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CleanUp, addr 0x3bfdd48, size 0x1a8, virtual false, abstract: false, final false
  inline void CleanUp();

  /// @brief Method HandleGameDidPause, addr 0x3bfdfdc, size 0x70, virtual false, abstract: false, final false
  inline void HandleGameDidPause();

  /// @brief Method HandleGameDidResume, addr 0x3bfe04c, size 0x38, virtual false, abstract: false, final false
  inline void HandleGameDidResume();

  static inline ::GlobalNamespace::IntroTutorialController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3bfdd44, size 0x4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetFinishAnimationParams, addr 0x3bfe10c, size 0x5c, virtual false, abstract: false, final false
  inline void SetFinishAnimationParams(float_t progress);

  /// @brief Method ShowFinishAnimation, addr 0x3bfdf60, size 0x7c, virtual false, abstract: false, final false
  inline void ShowFinishAnimation();

  /// @brief Method ShowFinishAnimationCoroutine, addr 0x3bfe084, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* ShowFinishAnimationCoroutine();

  /// @brief Method Start, addr 0x3bfdbb0, size 0x194, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3bfdef0, size 0x70, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3bfe168, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_introTutorialDidFinishEvent, addr 0x3bfda78, size 0x9c, virtual false, abstract: false, final false
  inline void add_introTutorialDidFinishEvent(::System::Action* value);

  /// @brief Method remove_introTutorialDidFinishEvent, addr 0x3bfdb14, size 0x9c, virtual false, abstract: false, final false
