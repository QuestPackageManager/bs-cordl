...
/// @brief Method Awake, addr 0x5875c44, size 0xc8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method HideConnectionSettings, addr 0x5875be4, size 0x20, virtual false, abstract: false, final false
inline void HideConnectionSettings(bool  hide) ;

/// @brief Method HideSpectateSettings, addr 0x5875c04, size 0x20, virtual false, abstract: false, final false
inline void HideSpectateSettings(bool  hide) ;

static inline ::GlobalNamespace::MultiplayerSettingsPanelController* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5875d0c, size 0x14, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Refresh, addr 0x5875ad4, size 0x110, virtual true, abstract: false, final true
inline void Refresh() ;

/// @brief Method SetLobbyCode, addr 0x5875c24, size 0x20, virtual false, abstract: false, final false
inline void SetLobbyCode(::StringW  code) ;

/// @brief Method SetLobbyPlayerDataModel, addr 0x5875ac8, size 0xc, virtual false, abstract: false, final false
inline void SetLobbyPlayerDataModel(::GlobalNamespace::ILobbyPlayerData*  lobbyPlayerData) ;

/// @brief Method UpdateLocalPlayerIsActiveState, addr 0x5875d20, size 0x24, virtual false, abstract: false, final false
inline void UpdateLocalPlayerIsActiveState(bool  isActive) ;

/// @brief Method <Awake>b__14_0, addr 0x5875d48, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5875d44, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_playerActiveStateChangedEvent, addr 0x5875948, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_playerActiveStateChangedEvent, addr 0x5875a08, size 0xc0, virtual false, abstract: false, final false
