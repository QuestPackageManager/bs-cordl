...
public:
  ...
  /// @brief Method Awake, addr 0x253b570, size 0xc4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HideConnectionSettings, addr 0x253b50c, size 0x24, virtual false, abstract: false, final false
  inline void HideConnectionSettings(bool hide);

  /// @brief Method HideSpectateSettings, addr 0x253b530, size 0x24, virtual false, abstract: false, final false
  inline void HideSpectateSettings(bool hide);

  static inline ::GlobalNamespace::MultiplayerSettingsPanelController* New_ctor();

  /// @brief Method OnDestroy, addr 0x253b634, size 0x14, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x253b400, size 0x10c, virtual true, abstract: false, final true
  inline void Refresh();

  /// @brief Method SetLobbyCode, addr 0x253b554, size 0x1c, virtual false, abstract: false, final false
  inline void SetLobbyCode(::StringW code);

  /// @brief Method SetLobbyPlayerDataModel, addr 0x253b3f4, size 0xc, virtual false, abstract: false, final false
  inline void SetLobbyPlayerDataModel(::GlobalNamespace::ILobbyPlayerData* lobbyPlayerData);

  /// @brief Method UpdateLocalPlayerIsActiveState, addr 0x253b648, size 0x24, virtual false, abstract: false, final false
  inline void UpdateLocalPlayerIsActiveState(bool isActive);

  /// @brief Method <Awake>b__14_0, addr 0x253b674, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x253b66c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerActiveStateChangedEvent, addr 0x253b294, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_playerActiveStateChangedEvent, addr 0x253b344, size 0xb0, virtual false, abstract: false, final false
