...
public:
  ...
  /// @brief Method .ctor, addr 0x58cd128, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Start, addr 0x58cce0c, size 0x64, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58cce70, size 0x250, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58cd0c0, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
