...
public:
  ...
  /// @brief Method .ctor, addr 0x5858044, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Start, addr 0x5857d28, size 0x64, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5857d8c, size 0x250, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5857fdc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor();
