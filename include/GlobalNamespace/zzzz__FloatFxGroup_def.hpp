...
public:
  ...
  /// @brief Method .ctor, addr 0x25c0670, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isTriggerOnly, addr 0x25c0660, size 0x8, virtual false, abstract: false, final false
  inline bool get_isTriggerOnly();

  /// @brief Method get_targets, addr 0x25c0668, size 0x8, virtual false, abstract: false, final false
