...
static inline ::GlobalNamespace::ScoreModel_NoteScoreDefinition* New_ctor(int32_t  maxCenterDistanceCutScore, int32_t  minBeforeCutScore, int32_t  maxBeforeCutScore, int32_t  minAfterCutScore, int32_t  maxAfterCutScore, int32_t  fixedCutScore) ;
...
/// @brief Method .ctor, addr 0x3658ba0, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method get_executionOrder, addr 0x3658bc4, size 0x1c, virtual false, abstract: false, final false
inline int32_t get_executionOrder() ;

/// @brief Method get_maxCutScore, addr 0x3657ab8, size 0x1c, virtual false, abstract: false, final false
...
/// @brief Method CompareTo, addr 0x3658be0, size 0xb8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x36584d0, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Field _scoreDefinitions, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF__scoreDefinitions, put=setStaticF__scoreDefinitions)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteData_ScoringType,::GlobalNamespace::ScoreModel_NoteScoreDefinition*>*  _scoreDefinitions;
...
/// @brief Field fullScoreScoringTypes, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_fullScoreScoringTypes, put=setStaticF_fullScoreScoringTypes)) ::System::Collections::Generic::HashSet_1<::GlobalNamespace::NoteData_ScoringType>*  fullScoreScoringTypes;

/// @brief Method ComputeMaxMultipliedScoreForBeatmap, addr 0x3657ad4, size 0x9fc, virtual false, abstract: false, final false
static inline int32_t ComputeMaxMultipliedScoreForBeatmap(::GlobalNamespace::IReadonlyBeatmapData*  beatmapData) ;

/// @brief Method ComputeQuickInaccurateMaxMultipliedScoreForBeatmap, addr 0x3657a00, size 0xb8, virtual false, abstract: false, final false
...
/// @brief Method GetModifiedScoreForGameplayModifiersScoreMultiplier, addr 0x36585f4, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method GetNoteScoreDefinition, addr 0x3657978, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3658678, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
