...
public:
  ...
  /// @brief Method .ctor, addr 0x14f6c4c, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0x14f6cb8, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_maxCutScore, addr 0x14f5ce4, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x14f6cd4, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x14f6780, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ComputeMaxMultipliedScoreForBeatmap, addr 0x14f5d00, size 0xa80, virtual false, abstract: false, final false
  static inline int32_t ComputeMaxMultipliedScoreForBeatmap(::GlobalNamespace::IReadonlyBeatmapData* beatmapData);

  /// @brief Method ComputeQuickInaccurateMaxMultipliedScoreForBeatmap, addr 0x14f5c34, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetModifiedScoreForGameplayModifiersScoreMultiplier, addr 0x14f68b8, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNoteScoreDefinition, addr 0x14f5bb4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f692c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
