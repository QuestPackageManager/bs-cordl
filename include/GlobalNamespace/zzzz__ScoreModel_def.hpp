...
public:
  ...
  /// @brief Method .ctor, addr 0x2700ca0, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0x2700d0c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_maxCutScore, addr 0x26ffc90, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x2700d28, size 0x94, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2700704, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ComputeMaxMultipliedScoreForBeatmap, addr 0x26ffcac, size 0xa58, virtual false, abstract: false, final false
  static inline int32_t ComputeMaxMultipliedScoreForBeatmap(::GlobalNamespace::IReadonlyBeatmapData* beatmapData);

  /// @brief Method ComputeQuickInaccurateMaxMultipliedScoreForBeatmap, addr 0x26ffbe0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetModifiedScoreForGameplayModifiersScoreMultiplier, addr 0x2700830, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNoteScoreDefinition, addr 0x26ffb60, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27008b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
