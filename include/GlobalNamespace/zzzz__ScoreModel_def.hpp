...
public:
  ...
  /// @brief Method .ctor, addr 0x14f0734, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method get_executionOrder, addr 0x14f07a0, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_maxCutScore, addr 0x14ef7cc, size 0x1c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CompareTo, addr 0x14f07bc, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x14f0268, size 0x84, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ComputeMaxMultipliedScoreForBeatmap, addr 0x14ef7e8, size 0xa80, virtual false, abstract: false, final false
  static inline int32_t ComputeMaxMultipliedScoreForBeatmap(::GlobalNamespace::IReadonlyBeatmapData* beatmapData);

  /// @brief Method ComputeQuickInaccurateMaxMultipliedScoreForBeatmap, addr 0x14ef71c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetModifiedScoreForGameplayModifiersScoreMultiplier, addr 0x14f03a0, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method GetNoteScoreDefinition, addr 0x14ef69c, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14f0414, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
