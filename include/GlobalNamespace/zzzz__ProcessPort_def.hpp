...
public:
  ...
  /// @brief Method GetProcessesByPort, addr 0x5d41ca0, size 0xb30, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::GlobalNamespace::ProcessPort*>* GetProcessesByPort(::StringW targetPort);

  /// @brief Method LookupProcess, addr 0x5d41bc8, size 0xd8, virtual false, abstract: false, final false
  static inline ::StringW LookupProcess(int32_t pid);

  static inline ::GlobalNamespace::ProcessPort* New_ctor();

  /// @brief Method ToString, addr 0x5d41a2c, size 0x15c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d427d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_portNumber, addr 0x5d41ba8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_portNumber();

  /// @brief Method get_processId, addr 0x5d41b98, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_processId();

  /// @brief Method get_processName, addr 0x5d41b88, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_processName();

  /// @brief Method get_protocol, addr 0x5d41bb8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_protocol();

  /// @brief Method set_portNumber, addr 0x5d41bb0, size 0x8, virtual false, abstract: false, final false
  inline void set_portNumber(::StringW value);

  /// @brief Method set_processId, addr 0x5d41ba0, size 0x8, virtual false, abstract: false, final false
  inline void set_processId(int32_t value);

  /// @brief Method set_processName, addr 0x5d41b90, size 0x8, virtual false, abstract: false, final false
  inline void set_processName(::StringW value);

  /// @brief Method set_protocol, addr 0x5d41bc0, size 0x8, virtual false, abstract: false, final false
