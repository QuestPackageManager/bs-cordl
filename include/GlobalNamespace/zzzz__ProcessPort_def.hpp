...
public:
  ...
  /// @brief Method get_processName, addr 0x27a1088, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_processName();

  /// @brief Method set_processName, addr 0x27a1090, size 0x8, virtual false, abstract: false, final false
  inline void set_processName(::StringW value);

  /// @brief Method get_processId, addr 0x27a1098, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_processId();

  /// @brief Method set_processId, addr 0x27a10a0, size 0x8, virtual false, abstract: false, final false
  inline void set_processId(int32_t value);

  /// @brief Method get_portNumber, addr 0x27a10a8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_portNumber();

  /// @brief Method set_portNumber, addr 0x27a10b0, size 0x8, virtual false, abstract: false, final false
  inline void set_portNumber(::StringW value);

  /// @brief Method get_protocol, addr 0x27a10b8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_protocol();

  /// @brief Method set_protocol, addr 0x27a10c0, size 0x8, virtual false, abstract: false, final false
  inline void set_protocol(::StringW value);

  /// @brief Method LookupProcess, addr 0x27a10c8, size 0xcc, virtual false, abstract: false, final false
  static inline ::StringW LookupProcess(int32_t pid);

  /// @brief Method GetProcessesByPort, addr 0x27a1194, size 0xbd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27a1d68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
