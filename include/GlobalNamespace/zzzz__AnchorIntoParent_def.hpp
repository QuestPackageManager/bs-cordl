...
public:
  ...
  /// @brief Method Start, addr 0x23d049c, size 0x100, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x23d059c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
