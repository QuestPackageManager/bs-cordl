...
public:
  ...
  /// @brief Method Start, addr 0x5709dac, size 0x110, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5709ebc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
