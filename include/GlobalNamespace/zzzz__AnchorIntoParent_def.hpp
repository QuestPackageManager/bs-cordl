...
public:
  ...
  /// @brief Method Start, addr 0x3954f74, size 0x100, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3955074, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
