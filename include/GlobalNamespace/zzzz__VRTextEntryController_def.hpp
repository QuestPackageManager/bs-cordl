...
public:
  ...
  /// @brief Method MoveNext, addr 0x3c0ffac, size 0x160, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::VRTextEntryController__BlinkCursor_d__23* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x3c1010c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x3c10114, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x3c1014c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x3c0ffa8, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c0fccc, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x3c0fac0, size 0x17c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method BlinkCursor, addr 0x3c0fc60, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* BlinkCursor();

  /// @brief Method HandleUIKeyboardDeleteButtonWasPressed, addr 0x3c0fe2c, size 0x134, virtual false, abstract: false, final false
  inline void HandleUIKeyboardDeleteButtonWasPressed();

  /// @brief Method HandleUIKeyboardTextKeyWasPressed, addr 0x3c0fcf4, size 0x138, virtual false, abstract: false, final false
  inline void HandleUIKeyboardTextKeyWasPressed(char16_t key);

  static inline ::GlobalNamespace::VRTextEntryController* New_ctor();

  /// @brief Method OnDisable, addr 0x3c0fcc0, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3c0fc3c, size 0x24, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method <Awake>b__20_0, addr 0x3c0ff70, size 0x1c, virtual false, abstract: false, final false
  inline void _Awake_b__20_0();

  /// @brief Method <Awake>b__20_1, addr 0x3c0ff8c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c0ff60, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cancelButtonWasPressedEvent, addr 0x3c0f894, size 0x9c, virtual false, abstract: false, final false
  inline void add_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_okButtonWasPressedEvent, addr 0x3c0f75c, size 0x9c, virtual false, abstract: false, final false
  inline void add_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_textDidChangeEvent, addr 0x3c0f5fc, size 0xb0, virtual false, abstract: false, final false
  inline void add_textDidChangeEvent(::System::Action_1<::StringW>* value);

  /// @brief Method get_text, addr 0x3c0f9e8, size 0x24, virtual false, abstract: false, final false
  inline ::StringW get_text();

  /// @brief Method remove_cancelButtonWasPressedEvent, addr 0x3c0f930, size 0x9c, virtual false, abstract: false, final false
  inline void remove_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_okButtonWasPressedEvent, addr 0x3c0f7f8, size 0x9c, virtual false, abstract: false, final false
  inline void remove_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_textDidChangeEvent, addr 0x3c0f6ac, size 0xb0, virtual false, abstract: false, final false
  inline void remove_textDidChangeEvent(::System::Action_1<::StringW>* value);

  /// @brief Method set_hideCancelButton, addr 0x3c0f9cc, size 0x1c, virtual false, abstract: false, final false
  inline void set_hideCancelButton(bool value);

  /// @brief Method set_text, addr 0x3c0fa0c, size 0xb4, virtual false, abstract: false, final false
