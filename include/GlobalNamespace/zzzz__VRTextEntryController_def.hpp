...
public:
  ...
  /// @brief Method .ctor addr 0x2282528 size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x22827c8 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x22827cc size 0x160 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x228292c size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x2282934 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x2282974 size 0x8 virtual true final true
...
public:
  ...
  /// @brief Method add_textDidChangeEvent addr 0x2281e40 size 0xb0 virtual false final false
  inline void add_textDidChangeEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_textDidChangeEvent addr 0x2281ef0 size 0xb0 virtual false final false
  inline void remove_textDidChangeEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_okButtonWasPressedEvent addr 0x2281fa0 size 0x9c virtual false final false
  inline void add_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_okButtonWasPressedEvent addr 0x228203c size 0x9c virtual false final false
  inline void remove_okButtonWasPressedEvent(::System::Action* value);

  /// @brief Method add_cancelButtonWasPressedEvent addr 0x22820d8 size 0x9c virtual false final false
  inline void add_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method remove_cancelButtonWasPressedEvent addr 0x2282174 size 0x9c virtual false final false
  inline void remove_cancelButtonWasPressedEvent(::System::Action* value);

  /// @brief Method set_hideCancelButton addr 0x2282210 size 0x1c virtual false final false
  inline void set_hideCancelButton(bool value);

  /// @brief Method get_text addr 0x228222c size 0x24 virtual false final false
  inline ::StringW get_text();

  /// @brief Method set_text addr 0x2282250 size 0xb4 virtual false final false
  inline void set_text(::StringW value);

  /// @brief Method Awake addr 0x2282304 size 0x18c virtual false final false
  inline void Awake();

  /// @brief Method OnEnable addr 0x2282490 size 0x24 virtual false final false
  inline void OnEnable();

  /// @brief Method OnDisable addr 0x228251c size 0xc virtual false final false
  inline void OnDisable();

  /// @brief Method BlinkCursor addr 0x22824b4 size 0x68 virtual false final false
  inline ::System::Collections::IEnumerator* BlinkCursor();

  /// @brief Method HandleUIKeyboardTextKeyWasPressed addr 0x2282550 size 0xfc virtual false final false
  inline void HandleUIKeyboardTextKeyWasPressed(char16_t key);

  /// @brief Method HandleUIKeyboardDeleteButtonWasPressed addr 0x228264c size 0x134 virtual false final false
  inline void HandleUIKeyboardDeleteButtonWasPressed();

  static inline ::GlobalNamespace::VRTextEntryController* New_ctor();

  /// @brief Method .ctor addr 0x2282780 size 0x10 virtual false final false
  inline void _ctor();

  /// @brief Method <Awake>b__20_0 addr 0x2282790 size 0x1c virtual false final false
  inline void _Awake_b__20_0();

  /// @brief Method <Awake>b__20_1 addr 0x22827ac size 0x1c virtual false final false
