...
/// @brief Field _defaultLastSelectedBeatmapCharacteristic, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__defaultLastSelectedBeatmapCharacteristic, put=__cordl_internal_set__defaultLastSelectedBeatmapCharacteristic)) ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>  _defaultLastSelectedBeatmapCharacteristic;
...
/// @brief Method .ctor, addr 0x364b140, size 0x70, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_allSongPackSerializedName, addr 0x364b138, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_allSongPackSerializedName() ;

/// @brief Method get_buildInSongPackSerializedName, addr 0x364b130, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_buildInSongPackSerializedName() ;

/// @brief Method get_defaultLastSelectedBeatmapCharacteristic, addr 0x364b128, size 0x8, virtual false, abstract: false, final false
