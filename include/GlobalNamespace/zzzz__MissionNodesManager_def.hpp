...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissionNodesManager*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissionNodesManager*, "", "MissionNodesManager");
// Dependencies MissionNode, MissionNodeConnection, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__allMissionNodeConnections, put = __cordl_internal_set__allMissionNodeConnections)) ::ArrayW<::UnityW<::GlobalNamespace::MissionNodeConnection>>
      _allMissionNodeConnections;

  /// @brief Field _allMissionNodes, offset 0x58, size 0x8
  __declspec(property(get = __cordl_internal_get__allMissionNodes, put = __cordl_internal_set__allMissionNodes)) ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> _allMissionNodes;
  ...
  __declspec(property(get = get_allMissionNodes)) ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> allMissionNodes;
  ...
  /// @brief Method Awake, addr 0x593abac, size 0x2c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DidFirstLockedMissionStageChange, addr 0x5939750, size 0xa8, virtual false, abstract: false, final false
  inline bool DidFirstLockedMissionStageChange();

  /// @brief Method GetAllMissionNodes, addr 0x593b16c, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllMissionNodes, addr 0x593abd8, size 0xac, virtual false, abstract: false, final false
  inline void GetAllMissionNodes();

  /// @brief Method GetMissionNodeWithModelClearedStateInconsistency, addr 0x593869c, size 0xb8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> GetMissionNodeWithModelClearedStateInconsistency();

  /// @brief Method GetNewEnabledConnection, addr 0x59393b4, size 0x18c, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::MissionNodeConnection>> GetNewEnabledConnection();

  /// @brief Method GetTopMostNotClearedMissionNode, addr 0x5938824, size 0x160, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> GetTopMostNotClearedMissionNode();

  /// @brief Method IMissionNodesManager.get_allMissionNodes, addr 0x593aba4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method IMissionNodesManager.get_finalMissionNode, addr 0x593ab9c, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IMissionNode* IMissionNodesManager_get_finalMissionNode();

  /// @brief Method IsNodeInteractable, addr 0x593b264, size 0x5c, virtual false, abstract: false, final false
  inline bool IsNodeInteractable(::GlobalNamespace::MissionNodeVisualController* node, bool parentCleared);

  /// @brief Method MissionWasCleared, addr 0x593afc8, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterAllNodes, addr 0x593ac84, size 0xbc, virtual false, abstract: false, final false
  inline void RegisterAllNodes();

  /// @brief Method ResetAllNodes, addr 0x593ad40, size 0x50, virtual false, abstract: false, final false
  inline void ResetAllNodes();

  /// @brief Method SetupNodeConnections, addr 0x593af04, size 0xc4, virtual false, abstract: false, final false
  inline void SetupNodeConnections();

  /// @brief Method SetupNodeMap, addr 0x5938a74, size 0x3c, virtual false, abstract: false, final false
  inline void SetupNodeMap();

  /// @brief Method SetupNodeTree, addr 0x593adfc, size 0x108, virtual false, abstract: false, final false
  inline void SetupNodeTree(::GlobalNamespace::MissionNodeVisualController* node, bool parentCleared);

  /// @brief Method SetupStages, addr 0x593ad90, size 0x6c, virtual false, abstract: false, final false
  inline void SetupStages();

  /// @brief Method UpdateStageLockText, addr 0x593970c, size 0x44, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MissionNodeConnection>>& __cordl_internal_get__allMissionNodeConnections();

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> const& __cordl_internal_get__allMissionNodes() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>>& __cordl_internal_get__allMissionNodes();
  ...
  constexpr void __cordl_internal_set__allMissionNodeConnections(::ArrayW<::UnityW<::GlobalNamespace::MissionNodeConnection>> value);

  constexpr void __cordl_internal_set__allMissionNodes(::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> value);
  ...
  /// @brief Method .ctor, addr 0x593b2e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInitialized, addr 0x593ab94, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_allMissionNodes, addr 0x593ab8c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> get_allMissionNodes();

  /// @brief Method get_finalMissionNode, addr 0x593ab74, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> get_finalMissionNode();

  /// @brief Method get_missionProgressModel, addr 0x593ab84, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::CampaignProgressModel> get_missionProgressModel();

  /// @brief Method get_missionStagesManager, addr 0x593ab7c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionStagesManager> get_missionStagesManager();

  /// @brief Method get_rootMissionNode, addr 0x593ab6c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::UnityW<::GlobalNamespace::MissionNodeConnection>> ____allMissionNodeConnections;

  /// @brief Field _allMissionNodes, offset: 0x58, size: 0x8, def value: None
  ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>> ____allMissionNodes;
...
static_assert(sizeof(::GlobalNamespace::MissionNodesManager) == 0x68, "Size mismatch!");
