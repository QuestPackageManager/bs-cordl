...
/// @brief Field _allMissionNodeConnections, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__allMissionNodeConnections, put=__cordl_internal_set__allMissionNodeConnections)) ::ArrayW<::UnityW<::GlobalNamespace::MissionNodeConnection>,::Array<::UnityW<::GlobalNamespace::MissionNodeConnection>>*>  _allMissionNodeConnections;

/// @brief Field _allMissionNodes, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__allMissionNodes, put=__cordl_internal_set__allMissionNodes)) ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>,::Array<::UnityW<::GlobalNamespace::MissionNode>>*>  _allMissionNodes;
...
/// @brief Method Awake, addr 0x57a26d4, size 0x2c, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method DidFirstLockedMissionStageChange, addr 0x57a2c54, size 0xac, virtual false, abstract: false, final false
inline bool DidFirstLockedMissionStageChange() ;

/// @brief Method GetAllMissionNodes, addr 0x57a2ea8, size 0xf8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::MissionNode>>* GetAllMissionNodes(::GlobalNamespace::MissionNode*  node, ::System::Collections::Generic::HashSet_1<::UnityW<::GlobalNamespace::MissionNode>>*  visited) ;

/// @brief Method GetAllMissionNodes, addr 0x57a2700, size 0xac, virtual false, abstract: false, final false
inline void GetAllMissionNodes() ;

/// @brief Method GetMissionNodeWithModelClearedStateInconsistency, addr 0x57a2b9c, size 0xb8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> GetMissionNodeWithModelClearedStateInconsistency() ;

/// @brief Method GetNewEnabledConnection, addr 0x57a2fa0, size 0x18c, virtual false, abstract: false, final false
...
/// @brief Method GetTopMostNotClearedMissionNode, addr 0x57a2d48, size 0x160, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> GetTopMostNotClearedMissionNode() ;

/// @brief Method IMissionNodesManager.get_allMissionNodes, addr 0x57a26cc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method IMissionNodesManager.get_finalMissionNode, addr 0x57a26c4, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::IMissionNode* IMissionNodesManager_get_finalMissionNode() ;

/// @brief Method IsNodeInteractable, addr 0x57a312c, size 0x60, virtual false, abstract: false, final false
inline bool IsNodeInteractable(::GlobalNamespace::MissionNodeVisualController*  node, bool  parentCleared) ;

/// @brief Method MissionWasCleared, addr 0x57a2b30, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method RegisterAllNodes, addr 0x57a27ac, size 0xbc, virtual false, abstract: false, final false
inline void RegisterAllNodes() ;

/// @brief Method ResetAllNodes, addr 0x57a28a4, size 0x4c, virtual false, abstract: false, final false
inline void ResetAllNodes() ;

/// @brief Method SetupNodeConnections, addr 0x57a2a6c, size 0xc4, virtual false, abstract: false, final false
inline void SetupNodeConnections() ;

/// @brief Method SetupNodeMap, addr 0x57a2868, size 0x3c, virtual false, abstract: false, final false
inline void SetupNodeMap() ;

/// @brief Method SetupNodeTree, addr 0x57a2964, size 0x108, virtual false, abstract: false, final false
inline void SetupNodeTree(::GlobalNamespace::MissionNodeVisualController*  node, bool  parentCleared) ;

/// @brief Method SetupStages, addr 0x57a28f0, size 0x74, virtual false, abstract: false, final false
inline void SetupStages() ;

/// @brief Method UpdateStageLockText, addr 0x57a2d00, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57a318c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_IsInitialized, addr 0x57a26bc, size 0x8, virtual false, abstract: false, final false
inline bool get_IsInitialized() ;

/// @brief Method get_allMissionNodes, addr 0x57a26b4, size 0x8, virtual false, abstract: false, final false
inline ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>,::Array<::UnityW<::GlobalNamespace::MissionNode>>*> get_allMissionNodes() ;

/// @brief Method get_finalMissionNode, addr 0x57a269c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionNode> get_finalMissionNode() ;

/// @brief Method get_missionProgressModel, addr 0x57a26ac, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::CampaignProgressModel> get_missionProgressModel() ;

/// @brief Method get_missionStagesManager, addr 0x57a26a4, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::GlobalNamespace::MissionStagesManager> get_missionStagesManager() ;

/// @brief Method get_rootMissionNode, addr 0x57a2694, size 0x8, virtual false, abstract: false, final false
