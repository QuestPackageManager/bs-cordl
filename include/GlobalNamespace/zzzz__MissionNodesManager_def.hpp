...
public:
  ...
  /// @brief Method Awake, addr 0x3b54484, size 0x2c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DidFirstLockedMissionStageChange, addr 0x3b549b0, size 0xa0, virtual false, abstract: false, final false
  inline bool DidFirstLockedMissionStageChange();

  /// @brief Method GetAllMissionNodes, addr 0x3b54be4, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllMissionNodes, addr 0x3b544b0, size 0xa8, virtual false, abstract: false, final false
  inline void GetAllMissionNodes();

  /// @brief Method GetMissionNodeWithModelClearedStateInconsistency, addr 0x3b5490c, size 0xa4, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> GetMissionNodeWithModelClearedStateInconsistency();

  /// @brief Method GetNewEnabledConnection, addr 0x3b54cc8, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTopMostNotClearedMissionNode, addr 0x3b54a88, size 0x15c, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> GetTopMostNotClearedMissionNode();

  /// @brief Method IMissionNodesManager.get_allMissionNodes, addr 0x3b5447c, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method IMissionNodesManager.get_finalMissionNode, addr 0x3b54474, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IMissionNode* IMissionNodesManager_get_finalMissionNode();

  /// @brief Method IsNodeInteractable, addr 0x3b54e3c, size 0x60, virtual false, abstract: false, final false
  inline bool IsNodeInteractable(::GlobalNamespace::MissionNodeVisualController* node, bool parentCleared);

  /// @brief Method MissionWasCleared, addr 0x3b548bc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterAllNodes, addr 0x3b54558, size 0xa0, virtual false, abstract: false, final false
  inline void RegisterAllNodes();

  /// @brief Method ResetAllNodes, addr 0x3b54634, size 0x68, virtual false, abstract: false, final false
  inline void ResetAllNodes();

  /// @brief Method SetupNodeConnections, addr 0x3b547fc, size 0xc0, virtual false, abstract: false, final false
  inline void SetupNodeConnections();

  /// @brief Method SetupNodeMap, addr 0x3b545f8, size 0x3c, virtual false, abstract: false, final false
  inline void SetupNodeMap();

  /// @brief Method SetupNodeTree, addr 0x3b54704, size 0xf8, virtual false, abstract: false, final false
  inline void SetupNodeTree(::GlobalNamespace::MissionNodeVisualController* node, bool parentCleared);

  /// @brief Method SetupStages, addr 0x3b5469c, size 0x68, virtual false, abstract: false, final false
  inline void SetupStages();

  /// @brief Method UpdateStageLockText, addr 0x3b54a50, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b54e9c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_IsInitialized, addr 0x3b5446c, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsInitialized();

  /// @brief Method get_allMissionNodes, addr 0x3b54464, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::GlobalNamespace::MissionNode>, ::Array<::UnityW<::GlobalNamespace::MissionNode>>*> get_allMissionNodes();

  /// @brief Method get_finalMissionNode, addr 0x3b5444c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionNode> get_finalMissionNode();

  /// @brief Method get_missionProgressModel, addr 0x3b5445c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::CampaignProgressModel> get_missionProgressModel();

  /// @brief Method get_missionStagesManager, addr 0x3b54454, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionStagesManager> get_missionStagesManager();

  /// @brief Method get_rootMissionNode, addr 0x3b54444, size 0x8, virtual false, abstract: false, final false
