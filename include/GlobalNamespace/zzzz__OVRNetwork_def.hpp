...
public:
  // Declarations
  /// @brief Method FromBytes, addr 0x2907a0c, size 0x130, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::__OVRNetwork__FrameHeader FromBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> arr);

  /// @brief Method ToBytes, addr 0x29078ec, size 0x120, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Broadcast, addr 0x29089c4, size 0x5b0, virtual false, abstract: false, final false
  inline void Broadcast(int32_t payloadType, ::ArrayW<uint8_t, ::Array<uint8_t>*> payload);

  /// @brief Method DoAcceptTcpClientCallback, addr 0x2908224, size 0x54c, virtual false, abstract: false, final false
  inline void DoAcceptTcpClientCallback(::System::IAsyncResult* ar);

  /// @brief Method DoWriteDataCallback, addr 0x2908f74, size 0xf4, virtual false, abstract: false, final false
  inline void DoWriteDataCallback(::System::IAsyncResult* ar);

  /// @brief Method HasConnectedClient, addr 0x2908770, size 0x254, virtual false, abstract: false, final false
  inline bool HasConnectedClient();

  static inline ::GlobalNamespace::__OVRNetwork__OVRNetworkTcpServer* New_ctor();

  /// @brief Method StartListening, addr 0x2907b3c, size 0x528, virtual false, abstract: false, final false
  inline void StartListening(int32_t listeningPort);

  /// @brief Method StopListening, addr 0x2908064, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2909068, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Connect, addr 0x2909150, size 0x17c, virtual false, abstract: false, final false
  inline void Connect(int32_t listeningPort);

  /// @brief Method ConnectCallback, addr 0x29092cc, size 0x300, virtual false, abstract: false, final false
  inline void ConnectCallback(::System::IAsyncResult* ar);

  /// @brief Method Disconnect, addr 0x29095cc, size 0x238, virtual false, abstract: false, final false
  inline void Disconnect();

  static inline ::GlobalNamespace::__OVRNetwork__OVRNetworkTcpClient* New_ctor();

  /// @brief Method OnReadDataCallback, addr 0x2909a1c, size 0x4dc, virtual false, abstract: false, final false
  inline void OnReadDataCallback(::System::IAsyncResult* ar);

  /// @brief Method Tick, addr 0x2909804, size 0x218, virtual false, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x2909ef8, size 0x134, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Connected, addr 0x290913c, size 0x14, virtual false, abstract: false, final false
  inline bool get_Connected();

  /// @brief Method get_connectionState, addr 0x2909114, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x29078e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
