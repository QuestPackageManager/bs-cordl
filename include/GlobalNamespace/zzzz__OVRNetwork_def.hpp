...
public:
  // Declarations
  /// @brief Method FromBytes, addr 0x5dc8fe0, size 0x12c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRNetwork_FrameHeader FromBytes(::ArrayW<uint8_t, ::Array<uint8_t>*> arr);

  /// @brief Method ToBytes, addr 0x5dc8ec8, size 0x118, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Broadcast, addr 0x5dc9f5c, size 0x588, virtual false, abstract: false, final false
  inline void Broadcast(int32_t payloadType, ::ArrayW<uint8_t, ::Array<uint8_t>*> payload);

  /// @brief Method DoAcceptTcpClientCallback, addr 0x5dc984c, size 0x558, virtual false, abstract: false, final false
  inline void DoAcceptTcpClientCallback(::System::IAsyncResult* ar);

  /// @brief Method DoWriteDataCallback, addr 0x5dca4e4, size 0xfc, virtual false, abstract: false, final false
  inline void DoWriteDataCallback(::System::IAsyncResult* ar);

  /// @brief Method HasConnectedClient, addr 0x5dc9da4, size 0x1b8, virtual false, abstract: false, final false
  inline bool HasConnectedClient();

  static inline ::GlobalNamespace::OVRNetwork_OVRNetworkTcpServer* New_ctor();

  /// @brief Method StartListening, addr 0x5dc910c, size 0x570, virtual false, abstract: false, final false
  inline void StartListening(int32_t listeningPort);

  /// @brief Method StopListening, addr 0x5dc967c, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dca5e0, size 0x9c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Connect, addr 0x5dca6e0, size 0x190, virtual false, abstract: false, final false
  inline void Connect(int32_t listeningPort);

  /// @brief Method ConnectCallback, addr 0x5dca870, size 0x334, virtual false, abstract: false, final false
  inline void ConnectCallback(::System::IAsyncResult* ar);

  /// @brief Method Disconnect, addr 0x5dcaba4, size 0x258, virtual false, abstract: false, final false
  inline void Disconnect();

  static inline ::GlobalNamespace::OVRNetwork_OVRNetworkTcpClient* New_ctor();

  /// @brief Method OnReadDataCallback, addr 0x5dcb028, size 0x4f4, virtual false, abstract: false, final false
  inline void OnReadDataCallback(::System::IAsyncResult* ar);

  /// @brief Method Tick, addr 0x5dcadfc, size 0x22c, virtual false, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method .ctor, addr 0x5dcb51c, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Connected, addr 0x5dca6b0, size 0x30, virtual false, abstract: false, final false
  inline bool get_Connected();

  /// @brief Method get_connectionState, addr 0x5dca67c, size 0x34, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x5dc8ec4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
