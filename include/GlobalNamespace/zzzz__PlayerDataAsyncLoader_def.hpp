...
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(3983)) CS Name: ::PlayerDataAsyncLoader::<LoadResourcesBeforeInstallAsync>d__2
...
public:
  ...
  /// @brief Method MoveNext, addr 0x22b36a8, size 0x28c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x22b3934, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method LoadResourcesBeforeInstall, addr 0x22b348c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method LoadResourcesBeforeInstallAsync, addr 0x22b350c, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method InstallBindings, addr 0x22b35e8, size 0xb8, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::PlayerDataAsyncLoader* New_ctor();

  /// @brief Method .ctor, addr 0x22b36a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
