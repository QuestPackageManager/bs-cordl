...
public:
  // Declarations
  /// @brief Method Init, addr 0x229bb5c, size 0x8, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::NoSetupDataSingleFixedSceneScenesTransitionSetupDataSO* New_ctor();

  /// @brief Method .ctor, addr 0x229bb54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
