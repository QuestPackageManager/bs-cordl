...
public:
  ...
  /// @brief Method <GraphicRaycast>b__20_0, addr 0x5f0bb40, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f0bb3c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetScreenPosition, addr 0x5f0b7b4, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetScreenPosition(::UnityEngine::EventSystems::RaycastResult raycastResult);

  /// @brief Method GraphicRaycast, addr 0x5f0a8fc, size 0x684, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFocussed, addr 0x5f0b7ec, size 0x124, virtual true, abstract: false, final false
  inline bool IsFocussed();

  static inline ::GlobalNamespace::OVRRaycaster* New_ctor();

  /// @brief Method OnPointerEnter, addr 0x5f0b910, size 0x118, virtual true, abstract: false, final false
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* e);

  /// @brief Method RayIntersectsRectTransform, addr 0x5f0b324, size 0x490, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x5f0af80, size 0x60, virtual true, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList);

  /// @brief Method Raycast, addr 0x5f0a2c8, size 0x634, virtual false, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList,
                      ::UnityEngine::Ray ray, bool checkForBlocking, bool checkOnlyRaycastable);

  /// @brief Method RaycastOnRaycastableGraphics, addr 0x5f0afe0, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method RaycastPointer, addr 0x5f0b040, size 0x2e4, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x5f0a158, size 0x170, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5f09fc8, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_canvas, addr 0x5f0a06c, size 0xc0, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Canvas> get_canvas();

  /// @brief Method get_eventCamera, addr 0x5f0a134, size 0x1c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_rayTransformer, addr 0x5f0a12c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::OVRRayTransformer> get_rayTransformer();

  /// @brief Method get_sortOrderPriority, addr 0x5f0a150, size 0x8, virtual true, abstract: false, final false
