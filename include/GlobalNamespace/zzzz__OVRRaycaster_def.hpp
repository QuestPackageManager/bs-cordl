...
public:
  ...
  /// @brief Method <GraphicRaycast>b__16_0, addr 0x403c7c8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x403c7c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetScreenPosition, addr 0x403c484, size 0x38, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 GetScreenPosition(::UnityEngine::EventSystems::RaycastResult raycastResult);

  /// @brief Method GraphicRaycast, addr 0x403b7fc, size 0x688, virtual false, abstract: false, final false
  ...
  /// @brief Method IsFocussed, addr 0x403c4bc, size 0x118, virtual false, abstract: false, final false
  inline bool IsFocussed();

  static inline ::GlobalNamespace::OVRRaycaster* New_ctor();

  /// @brief Method OnPointerEnter, addr 0x403c5d4, size 0x104, virtual true, abstract: false, final true
  inline void OnPointerEnter(::UnityEngine::EventSystems::PointerEventData* e);

  /// @brief Method RayIntersectsRectTransform, addr 0x403c1b0, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method Raycast, addr 0x403be84, size 0x6c, virtual true, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList);

  /// @brief Method Raycast, addr 0x403b134, size 0x6c8, virtual false, abstract: false, final false
  inline void Raycast(::UnityEngine::EventSystems::PointerEventData* eventData, ::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>* resultAppendList,
                      ::UnityEngine::Ray ray, bool checkForBlocking);

  /// @brief Method RaycastPointer, addr 0x403bef0, size 0x2c0, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x403afe4, size 0x150, virtual true, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x403ae8c, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::List_1<::GlobalNamespace::OVRRaycaster_RaycastHit>* getStaticF_s_SortedGraphics();

  /// @brief Method get_canvas, addr 0x403af2c, size 0x94, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Canvas> get_canvas();

  /// @brief Method get_eventCamera, addr 0x403afc0, size 0x1c, virtual true, abstract: false, final false
  inline ::UnityW<::UnityEngine::Camera> get_eventCamera();

  /// @brief Method get_sortOrderPriority, addr 0x403afdc, size 0x8, virtual true, abstract: false, final false
