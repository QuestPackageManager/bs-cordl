...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelPackHeaderTableCell*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LevelPackHeaderTableCell*, "", "LevelPackHeaderTableCell");
...
public:
  ...
  /// @brief Method HighlightDidChange, addr 0x59fcc74, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method RefreshVisuals, addr 0x59fcbd8, size 0x9c, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x59fcbd4, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::SelectableCell_TransitionType transitionType);

  /// @brief Method SetData, addr 0x59fcbb4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fcc78, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelPackHeaderTableCell) == 0xb8, "Size mismatch!");
