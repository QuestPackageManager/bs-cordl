...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::ITimeProvider::*)()>(&::GlobalNamespace::ITimeProvider::get_time)> {
...
inline float_t GlobalNamespace::ITimeProvider::get_time() {
