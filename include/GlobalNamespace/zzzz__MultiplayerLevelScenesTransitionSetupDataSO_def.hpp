...
public:
  ...
  /// @brief Method add_didFinishEvent, addr 0x23498b8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x2349cac, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didDisconnectEvent, addr 0x234af28, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didDisconnectEvent, addr 0x234a12c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_gameMode, addr 0x234c2bc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_gameMode();

  /// @brief Method set_gameMode, addr 0x234c2c4, size 0x8, virtual false, abstract: false, final false
  inline void set_gameMode(::StringW value);

  /// @brief Method get_beatmapKey, addr 0x234c2cc, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method set_beatmapKey, addr 0x234c2e0, size 0x14, virtual false, abstract: false, final false
  inline void set_beatmapKey(::GlobalNamespace::BeatmapKey value);

  /// @brief Method get_beatmapLevel, addr 0x234c2f4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel();

  /// @brief Method set_beatmapLevel, addr 0x234c2fc, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevel(::GlobalNamespace::BeatmapLevel* value);

  /// @brief Method get_usingOverrideColorScheme, addr 0x234c304, size 0x8, virtual false, abstract: false, final false
  inline bool get_usingOverrideColorScheme();

  /// @brief Method set_usingOverrideColorScheme, addr 0x234c30c, size 0xc, virtual false, abstract: false, final false
  inline void set_usingOverrideColorScheme(bool value);

  /// @brief Method get_colorScheme, addr 0x234c318, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorScheme* get_colorScheme();

  /// @brief Method set_colorScheme, addr 0x234c320, size 0x8, virtual false, abstract: false, final false
  inline void set_colorScheme(::GlobalNamespace::ColorScheme* value);

  /// @brief Method get_beatmapLevelData, addr 0x234c328, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IBeatmapLevelData* get_beatmapLevelData();

  /// @brief Method set_beatmapLevelData, addr 0x234c330, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevelData(::GlobalNamespace::IBeatmapLevelData* value);

  /// @brief Method Init, addr 0x234afd8, size 0x1ac, virtual false, abstract: false, final false
  ...
  /// @brief Method Finish, addr 0x234c750, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::MultiplayerResultsData* resultsData);

  /// @brief Method FinishWithDisconnect, addr 0x234c778, size 0x28, virtual false, abstract: false, final false
  inline void FinishWithDisconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method InitColorInfo, addr 0x234c430, size 0x88, virtual false, abstract: false, final false
  inline void InitColorInfo(::GlobalNamespace::ColorScheme* overrideColorScheme);

  /// @brief Method InitAndSetupScenes, addr 0x234c4b8, size 0x298, virtual false, abstract: false, final false
  inline void InitAndSetupScenes();

  /// @brief Method GetOrLoadMultiplayerEnvironmentInfo, addr 0x234c338, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x234c7a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
