...
public:
  ...
  /// @brief Method Finish, addr 0x3b4193c, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::MultiplayerResultsData* resultsData);

  /// @brief Method FinishWithDisconnect, addr 0x3b41964, size 0x28, virtual false, abstract: false, final false
  inline void FinishWithDisconnect(::GlobalNamespace::DisconnectedReason disconnectedReason);

  /// @brief Method GetOrLoadMultiplayerEnvironmentInfo, addr 0x3b41528, size 0xf8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> GetOrLoadMultiplayerEnvironmentInfo();

  /// @brief Method Init, addr 0x3b40204, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method InitAndSetupScenes, addr 0x3b416a4, size 0x298, virtual false, abstract: false, final false
  inline void InitAndSetupScenes();

  /// @brief Method InitColorInfo, addr 0x3b41620, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b4198c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didDisconnectEvent, addr 0x3b3ea68, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_didFinishEvent, addr 0x3b3e9b8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapKey, addr 0x3b414bc, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_beatmapLevel, addr 0x3b414e4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel();

  /// @brief Method get_beatmapLevelData, addr 0x3b41518, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::IBeatmapLevelData* get_beatmapLevelData();

  /// @brief Method get_colorScheme, addr 0x3b41508, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorScheme* get_colorScheme();

  /// @brief Method get_gameMode, addr 0x3b414ac, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_gameMode();

  /// @brief Method get_usingOverrideColorScheme, addr 0x3b414f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_usingOverrideColorScheme();

  /// @brief Method remove_didDisconnectEvent, addr 0x3b3ef48, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x3b3ee98, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_beatmapKey, addr 0x3b414d0, size 0x14, virtual false, abstract: false, final false
  inline void set_beatmapKey(::GlobalNamespace::BeatmapKey value);

  /// @brief Method set_beatmapLevel, addr 0x3b414ec, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevel(::GlobalNamespace::BeatmapLevel* value);

  /// @brief Method set_beatmapLevelData, addr 0x3b41520, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevelData(::GlobalNamespace::IBeatmapLevelData* value);

  /// @brief Method set_colorScheme, addr 0x3b41510, size 0x8, virtual false, abstract: false, final false
  inline void set_colorScheme(::GlobalNamespace::ColorScheme* value);

  /// @brief Method set_gameMode, addr 0x3b414b4, size 0x8, virtual false, abstract: false, final false
  inline void set_gameMode(::StringW value);

  /// @brief Method set_usingOverrideColorScheme, addr 0x3b414fc, size 0xc, virtual false, abstract: false, final false
