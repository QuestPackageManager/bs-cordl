...
public:
  // Declarations
  /// @brief Method GetText, addr 0x2431be0, size 0x4, virtual false, abstract: false, final false
  static inline ::StringW GetText(::StringW msg);

  /// @brief Method GetText, addr 0x2431be4, size 0x8, virtual false, abstract: false, final false
