...
public:
  // Declarations
  /// @brief Method GetText, addr 0x5a88bc4, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW GetText(::StringW fmt, /* [ParamArray] */ ::ArrayW<::System::Object*> args);

  /// @brief Method GetText, addr 0x5a88bc0, size 0x4, virtual false, abstract: false, final false
