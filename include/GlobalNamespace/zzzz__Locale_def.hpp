...
public:
  // Declarations
  /// @brief Method GetText, addr 0x5a868c4, size 0x8, virtual false, abstract: false, final false
  static inline ::StringW GetText(::StringW fmt, ::ArrayW<::System::Object*> args);

  /// @brief Method GetText, addr 0x5a868c0, size 0x4, virtual false, abstract: false, final false
