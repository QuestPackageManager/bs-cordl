...
public:
  ...
  /// @brief Method .ctor, addr 0x58c1e10, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MenuNeonLightsGenerator) == 0x78, "Size mismatch!");
