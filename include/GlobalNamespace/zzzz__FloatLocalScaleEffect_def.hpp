...
public:
  ...
  /// @brief Method Awake, addr 0x5853eb0, size 0x68, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Move, addr 0x5853f1c, size 0x94, virtual false, abstract: false, final false
  inline void Move(float_t value);

  static inline ::GlobalNamespace::FloatLocalScaleEffect* New_ctor();

  /// @brief Method SetValue, addr 0x5853f18, size 0x4, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x5853fb0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5853fb4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
