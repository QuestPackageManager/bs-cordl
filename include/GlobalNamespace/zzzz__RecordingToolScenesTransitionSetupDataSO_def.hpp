...
public:
  // Declarations
  /// @brief Method Init, addr 0x247a930, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x247fc98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
