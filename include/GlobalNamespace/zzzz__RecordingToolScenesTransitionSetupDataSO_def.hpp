...
public:
  // Declarations
  /// @brief Method Init, addr 0x3b39348, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3ef1c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
