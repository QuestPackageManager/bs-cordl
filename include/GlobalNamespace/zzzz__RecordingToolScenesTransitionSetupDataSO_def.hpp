...
public:
  // Declarations
  /// @brief Method Init, addr 0x26d0030, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26d5a88, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
