...
public:
  ...
  /// @brief Method HandleRelativeScoreAndImmediateRankCounterRelativeScoreOrImmediateRankDidChange, addr 0x3ba7bd8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshUI, addr 0x3ba79d0, size 0x16c, virtual false, abstract: false, final false
  inline void RefreshUI();

  /// @brief Method Start, addr 0x3ba790c, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ba7bdc, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
