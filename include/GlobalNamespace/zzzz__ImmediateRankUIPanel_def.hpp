...
public:
  ...
  /// @brief Method HandleRelativeScoreAndImmediateRankCounterRelativeScoreOrImmediateRankDidChange, addr 0x586f624, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshUI, addr 0x586f3f4, size 0x184, virtual false, abstract: false, final false
  inline void RefreshUI();

  /// @brief Method Start, addr 0x586f32c, size 0xc8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x586f628, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
