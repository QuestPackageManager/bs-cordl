...
public:
  ...
  /// @brief Method HandleRelativeScoreAndImmediateRankCounterRelativeScoreOrImmediateRankDidChange, addr 0x26e041c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RefreshUI, addr 0x26e0214, size 0x16c, virtual false, abstract: false, final false
  inline void RefreshUI();

  /// @brief Method Start, addr 0x26e0150, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x26e0420, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
