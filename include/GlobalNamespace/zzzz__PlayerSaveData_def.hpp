...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(4640)), TypeDefinitionIndex(TypeDefinitionIndex(4638)),
// TypeDefinitionIndex(TypeDefinitionIndex(4639))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4641)) CS Name: ::PlayerSaveData::PlayerSpecificSettings*
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4653)), TypeDefinitionIndex(TypeDefinitionIndex(4654)), TypeDefinitionIndex(TypeDefinitionIndex(2613)),
