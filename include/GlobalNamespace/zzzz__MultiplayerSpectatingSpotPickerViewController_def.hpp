...
public:
  ...
  /// @brief Method HandleDecButtonWasPressed, addr 0x245255c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleDecButtonWasPressed();

  /// @brief Method HandleIncButtonWasPressed, addr 0x2452540, size 0x1c, virtual false, abstract: false, final false
  inline void HandleIncButtonWasPressed();

  /// @brief Method HandleSpectatingSpotDidChangeEvent, addr 0x245253c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2452388, size 0x1b4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshSpectatingSpotName, addr 0x245228c, size 0xfc, virtual false, abstract: false, final false
  inline void RefreshSpectatingSpotName();

  /// @brief Method Start, addr 0x2452144, size 0x148, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2452578, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
