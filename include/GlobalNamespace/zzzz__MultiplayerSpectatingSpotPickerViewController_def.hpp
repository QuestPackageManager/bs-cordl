...
public:
  ...
  /// @brief Method Start addr 0x20e4a44 size 0x148 virtual false final false
  inline void Start();

  /// @brief Method OnDestroy addr 0x20e4c88 size 0x1b4 virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleSpectatingSpotDidChangeEvent addr 0x20e4e3c size 0x4 virtual false final false
  inline void HandleSpectatingSpotDidChangeEvent(::GlobalNamespace::IMultiplayerSpectatingSpot* spectatingSpot);

  /// @brief Method RefreshSpectatingSpotName addr 0x20e4b8c size 0xfc virtual false final false
  inline void RefreshSpectatingSpotName();

  /// @brief Method HandleIncButtonWasPressed addr 0x20e4e40 size 0x1c virtual false final false
  inline void HandleIncButtonWasPressed();

  /// @brief Method HandleDecButtonWasPressed addr 0x20e4e5c size 0x1c virtual false final false
  ...
  /// @brief Method .ctor addr 0x20e4e78 size 0x8 virtual false final false
  inline void _ctor();
