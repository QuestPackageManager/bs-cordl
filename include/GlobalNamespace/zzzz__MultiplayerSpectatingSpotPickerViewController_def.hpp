...
public:
  ...
  /// @brief Method HandleDecButtonWasPressed, addr 0x3bafe2c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleDecButtonWasPressed();

  /// @brief Method HandleIncButtonWasPressed, addr 0x3bafe10, size 0x1c, virtual false, abstract: false, final false
  inline void HandleIncButtonWasPressed();

  /// @brief Method HandleSpectatingSpotDidChangeEvent, addr 0x3bafe0c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bafc64, size 0x1a8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshSpectatingSpotName, addr 0x3bafb68, size 0xfc, virtual false, abstract: false, final false
  inline void RefreshSpectatingSpotName();

  /// @brief Method Start, addr 0x3bafa2c, size 0x13c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bafe48, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
