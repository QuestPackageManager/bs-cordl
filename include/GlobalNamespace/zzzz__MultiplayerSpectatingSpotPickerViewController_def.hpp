...
public:
  ...
  /// @brief Method HandleDecButtonWasPressed, addr 0x58767b8, size 0x18, virtual false, abstract: false, final false
  inline void HandleDecButtonWasPressed();

  /// @brief Method HandleIncButtonWasPressed, addr 0x58767a0, size 0x18, virtual false, abstract: false, final false
  inline void HandleIncButtonWasPressed();

  /// @brief Method HandleSpectatingSpotDidChangeEvent, addr 0x587679c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x587657c, size 0x220, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RefreshSpectatingSpotName, addr 0x587646c, size 0x110, virtual false, abstract: false, final false
  inline void RefreshSpectatingSpotName();

  /// @brief Method Start, addr 0x58762bc, size 0x1b0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58767d0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
