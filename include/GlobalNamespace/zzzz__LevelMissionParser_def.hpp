...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3612004, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3612060, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3611ff0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3611f70, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFunction, addr 0x361199c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x3611a18, size 0x18, virtual false, abstract: false, final false
  inline bool Parse(::StringW s);

  /// @brief Method Parse, addr 0x3611a30, size 0x248, virtual false, abstract: false, final false
  inline bool Parse(::StringW s, int32_t start, int32_t length);

  /// @brief Method ParseFunction, addr 0x3611c78, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3611914, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
