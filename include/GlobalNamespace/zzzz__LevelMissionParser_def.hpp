...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x12de830, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x12de8c4, size 0x28, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x12de81c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12de744, size 0xd8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFunction, addr 0x12de104, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x12de16c, size 0x1c, virtual false, abstract: false, final false
  inline bool Parse(::StringW s);

  /// @brief Method Parse, addr 0x12de188, size 0x2c8, virtual false, abstract: false, final false
  inline bool Parse(::StringW s, int32_t start, int32_t length);

  /// @brief Method ParseFunction, addr 0x12de450, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12de080, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
