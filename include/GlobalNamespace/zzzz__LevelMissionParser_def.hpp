...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x364f9e8, size 0x5c, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x364fa44, size 0x24, virtual true, abstract: false, final false
inline bool EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x364f9d4, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x364f954, size 0x80, virtual false, abstract: false, final false
...
/// @brief Field _functions, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__functions, put=__cordl_internal_set__functions)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::LevelMissionParser_ParserFunction*>*  _functions;

/// @brief Method AddFunction, addr 0x364f380, size 0x7c, virtual false, abstract: false, final false
...
/// @brief Method Parse, addr 0x364f3fc, size 0x18, virtual false, abstract: false, final false
inline bool Parse(::StringW  s) ;

/// @brief Method Parse, addr 0x364f414, size 0x248, virtual false, abstract: false, final false
inline bool Parse(::StringW  s, int32_t  start, int32_t  length) ;

/// @brief Method ParseFunction, addr 0x364f65c, size 0x2f8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x364f2f8, size 0x88, virtual false, abstract: false, final false
inline void _ctor() ;
