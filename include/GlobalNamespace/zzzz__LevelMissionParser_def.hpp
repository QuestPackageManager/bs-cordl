...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x26b5930, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x26b59c4, size 0x28, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x26b591c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b587c, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFunction, addr 0x26b5288, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x26b52f0, size 0x1c, virtual false, abstract: false, final false
  inline bool Parse(::StringW s);

  /// @brief Method Parse, addr 0x26b530c, size 0x27c, virtual false, abstract: false, final false
  inline bool Parse(::StringW s, int32_t start, int32_t length);

  /// @brief Method ParseFunction, addr 0x26b5588, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b5204, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
