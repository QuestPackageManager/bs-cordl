...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x26b5ce4, size 0x94, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x26b5d78, size 0x28, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x26b5cd0, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b5c30, size 0xa0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFunction, addr 0x26b563c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x26b56a4, size 0x1c, virtual false, abstract: false, final false
  inline bool Parse(::StringW s);

  /// @brief Method Parse, addr 0x26b56c0, size 0x27c, virtual false, abstract: false, final false
  inline bool Parse(::StringW s, int32_t start, int32_t length);

  /// @brief Method ParseFunction, addr 0x26b593c, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b55b8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
