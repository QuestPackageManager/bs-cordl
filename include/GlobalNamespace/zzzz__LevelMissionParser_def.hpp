...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x364e654, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x364e6b0, size 0x24, virtual true, abstract: false, final false
  inline bool EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x364e640, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x364e5c0, size 0x80, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddFunction, addr 0x364dfec, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method Parse, addr 0x364e068, size 0x18, virtual false, abstract: false, final false
  inline bool Parse(::StringW s);

  /// @brief Method Parse, addr 0x364e080, size 0x248, virtual false, abstract: false, final false
  inline bool Parse(::StringW s, int32_t start, int32_t length);

  /// @brief Method ParseFunction, addr 0x364e2c8, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x364df64, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
