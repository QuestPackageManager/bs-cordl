...
/// @brief Method Dispose, addr 0x57ec9ec, size 0x158, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method EmitParticles, addr 0x57ecce0, size 0x188, virtual true, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ParticleSystemEventController> EmitParticles(float_t  startTime) ;

/// @brief Method HandleBeatmapEvent, addr 0x57ecb60, size 0x180, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ec848, size 0x1a4, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x57ed290, size 0x28, virtual true, abstract: false, final false
inline void Dispose() ;

static inline ::GlobalNamespace::ParticleSystemEmitEventEffect_BeatmapEditorParticleSystemEmitBehavior* New_ctor(::GlobalNamespace::BasicBeatmapEventType  beatmapEvent, ::UnityEngine::Transform*  particleSystemParentTransform, int32_t  particleSystemMaxSpawnedSystems, ::GlobalNamespace::IAudioTimeSource*  audioTimeSource, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController, ::GlobalNamespace::ParticleSystemEventController_Pool*  particleSystemEventControllerPool, ::Zenject::TickableManager*  tickableManager) ;

/// @brief Method Tick, addr 0x57ececc, size 0x350, virtual true, abstract: false, final true
inline void Tick() ;
...
/// @brief Method .ctor, addr 0x57ece94, size 0x38, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BasicBeatmapEventType  beatmapEvent, ::UnityEngine::Transform*  particleSystemParentTransform, int32_t  particleSystemMaxSpawnedSystems, ::GlobalNamespace::IAudioTimeSource*  audioTimeSource, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController, ::GlobalNamespace::ParticleSystemEventController_Pool*  particleSystemEventControllerPool, ::Zenject::TickableManager*  tickableManager) ;
...
/// @brief Method Dispose, addr 0x57ed428, size 0x194, virtual true, abstract: false, final false
inline void Dispose() ;

/// @brief Method EmitParticles, addr 0x57ed854, size 0xc0, virtual true, abstract: false, final false
inline ::UnityW<::GlobalNamespace::ParticleSystemEventController> EmitParticles(float_t  startTime) ;

/// @brief Method HandlePauseControllerDidPause, addr 0x57ed5bc, size 0x134, virtual false, abstract: false, final false
inline void HandlePauseControllerDidPause() ;

/// @brief Method HandlePauseControllerDidResume, addr 0x57ed708, size 0x134, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ed2b8, size 0x170, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::BasicBeatmapEventType  beatmapEvent, ::UnityEngine::Transform*  particleSystemParentTransform, int32_t  particleSystemMaxSpawnedSystems, ::GlobalNamespace::IAudioTimeSource*  audioTimeSource, ::GlobalNamespace::BeatmapCallbacksController*  beatmapCallbacksController, ::GlobalNamespace::ParticleSystemEventController_Pool*  particleSystemEventControllerPool, ::GlobalNamespace::PauseController*  pauseController, ::GlobalNamespace::SongSpeedData*  songSpeedData) ;
...
/// @brief Field _particleSystemEmitBehavior, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__particleSystemEmitBehavior, put=__cordl_internal_set__particleSystemEmitBehavior)) ::GlobalNamespace::ParticleSystemEmitEventEffect_ParticleSystemEmitBehavior*  _particleSystemEmitBehavior;
...
/// @brief Method OnDestroy, addr 0x57ec824, size 0x18, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x57ec5b8, size 0x26c, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57ec83c, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
