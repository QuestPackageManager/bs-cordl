...
/// @brief Field didFinishEvent, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_1<::UnityW<::GlobalNamespace::CreditsScenesTransitionSetupDataSO>>*  didFinishEvent;

/// @brief Method Finish, addr 0x57eec30, size 0x20, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method Init, addr 0x57eeb70, size 0xc0, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method .ctor, addr 0x57eec50, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x57ee9f0, size 0xc0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::CreditsScenesTransitionSetupDataSO>>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x57eeab0, size 0xc0, virtual false, abstract: false, final false
