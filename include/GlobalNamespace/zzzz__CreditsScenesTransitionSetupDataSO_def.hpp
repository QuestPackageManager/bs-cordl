...
/// @brief Method Finish, addr 0x577d348, size 0x20, virtual false, abstract: false, final false
inline void Finish() ;

/// @brief Method Init, addr 0x577d288, size 0xc0, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method .ctor, addr 0x577d368, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x577d108, size 0xc0, virtual false, abstract: false, final false
inline void add_didFinishEvent(::System::Action_1<::UnityW<::GlobalNamespace::CreditsScenesTransitionSetupDataSO>>*  value) ;

/// @brief Method remove_didFinishEvent, addr 0x577d1c8, size 0xc0, virtual false, abstract: false, final false
