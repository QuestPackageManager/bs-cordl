...
public:
  ...
  /// @brief Method DecButtonPressed, addr 0x5880348, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method IncButtonPressed, addr 0x5880308, size 0x40, virtual true, abstract: false, final false
  inline void IncButtonPressed();

  static inline ::GlobalNamespace::ListColorController* New_ctor();

  /// @brief Method OnEnable, addr 0x5880228, size 0x34, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x58802ac, size 0x5c, virtual false, abstract: false, final false
  inline void Refresh(bool applyValue);

  /// @brief Method RefreshUI, addr 0x588025c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5880380, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
