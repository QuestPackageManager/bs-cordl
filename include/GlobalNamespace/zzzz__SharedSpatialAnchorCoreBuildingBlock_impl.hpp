...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock::*)()>(
    &::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x581d0d0;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock*>::get(),
...
inline ::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock* GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::SharedSpatialAnchorCoreBuildingBlock*>());
}
// Ctor Parameters []
