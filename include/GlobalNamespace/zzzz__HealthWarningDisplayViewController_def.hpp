...
public:
  ...
  /// @brief Method DidActivate, addr 0x253e08c, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x253e0c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
