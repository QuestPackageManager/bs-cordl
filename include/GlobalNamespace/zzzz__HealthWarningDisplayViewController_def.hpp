...
/// @brief Method DidActivate, addr 0x579fa34, size 0x38, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x579fa6c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
