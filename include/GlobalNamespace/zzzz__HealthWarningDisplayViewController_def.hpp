...
public:
  ...
  /// @brief Method DidActivate, addr 0x2655368, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26553a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
