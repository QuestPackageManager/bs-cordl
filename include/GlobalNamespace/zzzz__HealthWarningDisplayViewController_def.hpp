...
// Write type traits
MARK_REF_T(::GlobalNamespace::HealthWarningDisplayViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::HealthWarningDisplayViewController*, "", "HealthWarningDisplayViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a13d38, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a13d70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::HealthWarningDisplayViewController) == 0x90, "Size mismatch!");
