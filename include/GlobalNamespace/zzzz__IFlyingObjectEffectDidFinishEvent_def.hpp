...
// Write type traits
MARK_REF_T(::GlobalNamespace::IFlyingObjectEffectDidFinishEvent*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IFlyingObjectEffectDidFinishEvent*, "", "IFlyingObjectEffectDidFinishEvent");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
