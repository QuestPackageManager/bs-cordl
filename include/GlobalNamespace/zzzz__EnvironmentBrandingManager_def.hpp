...
public:
  ...
  /// @brief Method .ctor, addr 0x22bc898, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Start, addr 0x22bc7c4, size 0xcc, virtual false, abstract: false, final false
  inline void Start();

  static inline ::GlobalNamespace::EnvironmentBrandingManager* New_ctor();

  /// @brief Method .ctor, addr 0x22bc890, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
