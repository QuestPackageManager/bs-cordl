...
public:
  ...
  /// @brief Method .ctor, addr 0x3add1b0, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Start, addr 0x3add0dc, size 0xcc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3add1a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
