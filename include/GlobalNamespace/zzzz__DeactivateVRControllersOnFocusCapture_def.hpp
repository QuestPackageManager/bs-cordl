...
/// @brief Method LateUpdate, addr 0x569e0a0, size 0x4, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::DeactivateVRControllersOnFocusCapture* New_ctor() ;

/// @brief Method OnDestroy, addr 0x569dec8, size 0x1d8, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x569d9cc, size 0x268, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method UpdateVRControllerActiveState, addr 0x569dc34, size 0x294, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x569e0a4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_loggerPrefix, addr 0x569d988, size 0x44, virtual true, abstract: false, final true
