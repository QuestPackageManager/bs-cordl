...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DeactivateVRControllersOnFocusCapture", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DeactivateVRControllersOnFocusCapture(DeactivateVRControllersOnFocusCapture&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DeactivateVRControllersOnFocusCapture", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DeactivateVRControllersOnFocusCapture(DeactivateVRControllersOnFocusCaptureconst&) = delete;
