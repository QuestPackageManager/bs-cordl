...
public:
  ...
  /// @brief Method .ctor, addr 0x577de64, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleNoteCutSoundEffectDidFinish, addr 0x577dd10, size 0xe8, virtual true, abstract: false, final true
  inline void HandleNoteCutSoundEffectDidFinish(::GlobalNamespace::NoteCutSoundEffect* noteCutSoundEffect);

  /// @brief Method HandleNoteDidStartDissolving, addr 0x577dba8, size 0x168, virtual false, abstract: false, final false
  inline void HandleNoteDidStartDissolving(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method HandleNoteWasCut, addr 0x577da38, size 0x170, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method HandleNoteWasSpawned, addr 0x577d484, size 0x584, virtual false, abstract: false, final false
  inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method IsSupportedNote, addr 0x577da08, size 0x30, virtual false, abstract: false, final false
  inline bool IsSupportedNote(::GlobalNamespace::NoteData* noteData);

  /// @brief Method LateUpdate, addr 0x577d3c8, size 0xbc, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::NoteCutSoundEffectManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x577d264, size 0x164, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x577cf98, size 0x2cc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x577ddf8, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_handleWrongSaberTypeAsGood, addr 0x577cf88, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_handleWrongSaberTypeAsGood, addr 0x577cf90, size 0x8, virtual false, abstract: false, final false
