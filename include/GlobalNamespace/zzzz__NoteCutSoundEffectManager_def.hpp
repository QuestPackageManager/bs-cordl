...
public:
  ...
  /// @brief Method .ctor, addr 0x3a68590, size 0x30, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method HandleNoteCutSoundEffectDidFinish, addr 0x3a68440, size 0xd8, virtual true, abstract: false, final true
  inline void HandleNoteCutSoundEffectDidFinish(::GlobalNamespace::NoteCutSoundEffect* noteCutSoundEffect);

  /// @brief Method HandleNoteDidStartDissolving, addr 0x3a682a0, size 0x1a0, virtual false, abstract: false, final false
  inline void HandleNoteDidStartDissolving(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method HandleNoteWasCut, addr 0x3a680f0, size 0x1b0, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method HandleNoteWasSpawned, addr 0x3a67b2c, size 0x590, virtual false, abstract: false, final false
  inline void HandleNoteWasSpawned(::GlobalNamespace::NoteController* noteController);

  /// @brief Method IsSupportedNote, addr 0x3a680bc, size 0x34, virtual false, abstract: false, final false
  inline bool IsSupportedNote(::GlobalNamespace::NoteData* noteData);

  /// @brief Method LateUpdate, addr 0x3a67a84, size 0xa8, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::NoteCutSoundEffectManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x3a677dc, size 0x148, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3a673f0, size 0x28c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3a68518, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_handleWrongSaberTypeAsGood, addr 0x3a673dc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_handleWrongSaberTypeAsGood, addr 0x3a673e4, size 0xc, virtual false, abstract: false, final false
