...
/// @brief Method SetShaderKeyword, addr 0x56b1e54, size 0x64, virtual false, abstract: false, final false
static inline void SetShaderKeyword(::GlobalNamespace::ToneMapping  toneMapping) ;

/// @brief Method SetShaderKeyword, addr 0x56b3bb4, size 0xac, virtual false, abstract: false, final false
