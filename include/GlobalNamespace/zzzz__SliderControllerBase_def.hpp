...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SliderControllerBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SliderControllerBase(SliderControllerBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SliderControllerBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SliderControllerBase(SliderControllerBaseconst&) = delete;
