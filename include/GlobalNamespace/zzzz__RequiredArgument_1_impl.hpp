...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
constexpr bool& GlobalNamespace::RequiredArgument_1<T>::__cordl_internal_get__hasValue() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____hasValue;
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
constexpr bool const& GlobalNamespace::RequiredArgument_1<T>::__cordl_internal_get__hasValue() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____hasValue;
}
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
constexpr void GlobalNamespace::RequiredArgument_1<T>::__cordl_internal_set__hasValue(bool value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline bool GlobalNamespace::RequiredArgument_1<T>::get_hasValue() {
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline void GlobalNamespace::RequiredArgument_1<T>::_ctor(::StringW name, ::StringW description, ::ArrayW<::StringW> autocompleteValues) {
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline void GlobalNamespace::RequiredArgument_1<T>::SetAutocompleteValues(::ArrayW<::StringW> newAutocompleteValues) {
  static auto* ___internal_method =
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline bool GlobalNamespace::RequiredArgument_1<T>::TryParseWithValue(::StringW inValue, ::by_ref<::StringW> outError) {
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline T GlobalNamespace::RequiredArgument_1<T>::op_Implicit_T(::GlobalNamespace::RequiredArgument_1<T>* argument) {
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IConvertible*>)
inline ::GlobalNamespace::RequiredArgument_1<T>* GlobalNamespace::RequiredArgument_1<T>::New_ctor(::StringW name, ::StringW description, ::ArrayW<::StringW> autocompleteValues) {
