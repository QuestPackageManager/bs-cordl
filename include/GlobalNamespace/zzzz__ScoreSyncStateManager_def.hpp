...
public:
  ...
  /// @brief Method Interpolate, addr 0x5b91d60, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b91e64, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_deltaMessageType, addr 0x5b91d58, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_deltaMessageType();

  /// @brief Method get_deltaSerializablePool, addr 0x5b91d48, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_deltaUpdateFrequencyMs, addr 0x5b91d20, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_deltaUpdateFrequencyMs();

  /// @brief Method get_fullStateUpdateFrequencyMs, addr 0x5b91d28, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_fullStateUpdateFrequencyMs();

  /// @brief Method get_localBufferSize, addr 0x5b91d30, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_localBufferSize();

  /// @brief Method get_messageType, addr 0x5b91d50, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_messageType();

  /// @brief Method get_remoteBufferSize, addr 0x5b91d38, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_remoteBufferSize();

  /// @brief Method get_serializablePool, addr 0x5b91d40, size 0x8, virtual true, abstract: false, final false
