...
public:
  ...
  /// @brief Method Interpolate, addr 0x5b1f86c, size 0x104, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5b1f970, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_deltaMessageType, addr 0x5b1f864, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_deltaMessageType();

  /// @brief Method get_deltaSerializablePool, addr 0x5b1f854, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method get_deltaUpdateFrequencyMs, addr 0x5b1f82c, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_deltaUpdateFrequencyMs();

  /// @brief Method get_fullStateUpdateFrequencyMs, addr 0x5b1f834, size 0x8, virtual true, abstract: false, final false
  inline int64_t get_fullStateUpdateFrequencyMs();

  /// @brief Method get_localBufferSize, addr 0x5b1f83c, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_localBufferSize();

  /// @brief Method get_messageType, addr 0x5b1f85c, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::NetworkMessageType get_messageType();

  /// @brief Method get_remoteBufferSize, addr 0x5b1f844, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_remoteBufferSize();

  /// @brief Method get_serializablePool, addr 0x5b1f84c, size 0x8, virtual true, abstract: false, final false
