...
public:
  ...
  /// @brief Method DidActivate, addr 0x221bfe0, size 0x4c4, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x221cd00, size 0x280, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleBeatAvatarEditorViewCancelButtonWasPressed, addr 0x221d670, size 0xc, virtual false, abstract: false, final false
  inline void HandleBeatAvatarEditorViewCancelButtonWasPressed();

  /// @brief Method HandleBeatAvatarEditorViewOkButtonWasPressed, addr 0x221d67c, size 0xc, virtual false, abstract: false, final false
  inline void HandleBeatAvatarEditorViewOkButtonWasPressed();

  /// @brief Method HandleBeatAvatarViewControllerChangedAvatarPart, addr 0x221d5d0, size 0xa0, virtual false, abstract: false, final false
  inline void HandleBeatAvatarViewControllerChangedAvatarPart(::BeatSaber::BeatAvatarSDK::AvatarPart avatarPart);

  /// @brief Method HandleBeatAvatarViewControllerDidRequestColorChange, addr 0x221d4e0, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleEditColorViewControllerControllerDidFinish, addr 0x221d6b0, size 0xcc, virtual false, abstract: false, final false
  inline void HandleEditColorViewControllerControllerDidFinish(bool apply);

  /// @brief Method HandleEditColorViewControllerDidChangedColor, addr 0x221d688, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method OneTimeInitialize, addr 0x221d7c0, size 0x4, virtual true, abstract: false, final false
  inline void OneTimeInitialize();

  /// @brief Method Setup, addr 0x221bf18, size 0x38, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x221d7c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
