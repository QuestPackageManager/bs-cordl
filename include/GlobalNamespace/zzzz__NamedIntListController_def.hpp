...
public:
  ...
  /// @brief Method .ctor, addr 0x277bfa8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_localizedText, addr 0x277bf78, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ApplyValue, addr 0x277bf24, size 0x20, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x277beb0, size 0x74, virtual true, abstract: false, final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  /// @brief Method InitValues, addr 0x277be40, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x277be78, size 0x38, virtual false, abstract: false, final false
  inline void SetValue(int32_t value);

  /// @brief Method TextForValue, addr 0x277bf44, size 0x34, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x277bfa0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueChangedEvent, addr 0x277bce0, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_valueChangedEvent, addr 0x277bd90, size 0xb0, virtual true, abstract: false, final true
