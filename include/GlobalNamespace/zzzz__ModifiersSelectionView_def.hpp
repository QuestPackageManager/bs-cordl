...
public:
  ...
  /// @brief Method <SetGameplayModifiers>b__0, addr 0x57b4850, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b484c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetGameplayModifiers, addr 0x57af50c, size 0x1b4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57af6cc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
