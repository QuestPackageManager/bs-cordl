...
public:
  ...
  /// @brief Method <SetGameplayModifiers>b__0, addr 0x3b04714, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b0470c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetGameplayModifiers, addr 0x3afee80, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3afeff8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
