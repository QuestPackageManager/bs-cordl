...
public:
  ...
  /// @brief Method DidActivate, addr 0x57be8e0, size 0x1ec, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57beacc, size 0x28, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleCancelButtonPressed, addr 0x57beb88, size 0x24, virtual false, abstract: false, final false
  inline void HandleCancelButtonPressed();

  /// @brief Method HandleInputFieldChanged, addr 0x57beaf4, size 0x38, virtual false, abstract: false, final false
  inline void HandleInputFieldChanged(::HMUI::InputFieldView* obj);

  /// @brief Method HandleJoinButtonPressed, addr 0x57beb54, size 0x34, virtual false, abstract: false, final false
  inline void HandleJoinButtonPressed();

  static inline ::GlobalNamespace::ServerCodeEntryViewController* New_ctor();

  /// @brief Method OnDestroy, addr 0x57beb2c, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57bebac, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57be760, size 0xc0, virtual false, abstract: false, final false
  inline void add_didFinishEvent(::System::Action_2<bool, ::StringW>* value);

  /// @brief Method remove_didFinishEvent, addr 0x57be820, size 0xc0, virtual false, abstract: false, final false
