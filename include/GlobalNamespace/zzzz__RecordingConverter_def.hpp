...
public:
  ...
  /// @brief Method SaveToOldFormat, addr 0x3b1f5fc, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b1e458, size 0x28, virtual false, abstract: false, final false
