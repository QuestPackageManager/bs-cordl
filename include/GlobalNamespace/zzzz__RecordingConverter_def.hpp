...
public:
  ...
  /// @brief Method SaveToOldFormat, addr 0x3b1cb84, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b1b9e0, size 0x28, virtual false, abstract: false, final false
