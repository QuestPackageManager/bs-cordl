...
public:
  ...
  /// @brief Method SaveToOldFormat, addr 0x3b2215c, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b20fb8, size 0x28, virtual false, abstract: false, final false
