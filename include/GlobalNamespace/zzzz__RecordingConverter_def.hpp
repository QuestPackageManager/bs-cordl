...
public:
  ...
  /// @brief Method SaveToOldFormat, addr 0x23fa15c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f8f68, size 0x28, virtual false, abstract: false, final false
