...
public:
  ...
  /// @brief Method ProcessFrame, addr 0x57e60a8, size 0xa5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e6b04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
