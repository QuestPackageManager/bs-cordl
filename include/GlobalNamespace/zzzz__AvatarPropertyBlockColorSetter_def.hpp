...
// Write type traits
MARK_REF_PTR_T(::GlobalNamespace::AvatarPropertyBlockColorSetter);
...
public:
  ...
  /// @brief Method Awake addr 0x20d3314 size 0x10 virtual false final false
  inline void Awake();

  /// @brief Method OnValidate addr 0x20d3324 size 0xa0 virtual false final false
  inline void OnValidate();

  /// @brief Method SetColor addr 0x20d33c4 size 0x38 virtual false final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method SetColors addr 0x20d33fc size 0x14 virtual false final false
  inline void SetColors(::UnityEngine::Color mainColor, ::UnityEngine::Color rimLightColor);

  /// @brief Method SetHighlight addr 0x20d3580 size 0xc virtual false final false
  inline void SetHighlight(bool highlighted, int32_t uvSegment);

  /// @brief Method UpdateRenderer addr 0x20d3410 size 0x170 virtual false final false
  inline void UpdateRenderer();

  static inline ::GlobalNamespace::AvatarPropertyBlockColorSetter* New_ctor();

  /// @brief Method .ctor addr 0x20d358c size 0x24 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::AvatarPropertyBlockColorSetter, 0x78>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____defaultColor) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____darkerColorMultiplier) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____whiteBoost) == 0x2c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____editInPlayMode) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____renderer) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____rimLightColor) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____mainColor) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____boostColor) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::AvatarPropertyBlockColorSetter, ____highlighted) == 0x70, "Offset mismatch!");
