...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ParametricBoxFakeGlowController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ParametricBoxFakeGlowController(ParametricBoxFakeGlowController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ParametricBoxFakeGlowController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ParametricBoxFakeGlowController(ParametricBoxFakeGlowControllerconst&) = delete;
