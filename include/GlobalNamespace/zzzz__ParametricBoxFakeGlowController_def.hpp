...
public:
  ...
  /// @brief Method Awake, addr 0x39db46c, size 0x20, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ParametricBoxFakeGlowController* New_ctor();

  /// @brief Method OnDisable, addr 0x39db5d8, size 0x20, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39db48c, size 0x28, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x39db4b4, size 0x124, virtual false, abstract: false, final false
  inline void Refresh();
  ...
  /// @brief Method .ctor, addr 0x39db5f8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method set_localPosition, addr 0x39db424, size 0x48, virtual false, abstract: false, final false
