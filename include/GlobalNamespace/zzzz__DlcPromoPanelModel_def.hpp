...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x368f7c8, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::UnityEngine::Sprite* image, ::StringW promoText, float_t promoTextPosition);

  /// @brief Method .ctor, addr 0x368f7d4, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x368f7a4, size 0x24, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <UpdatePromoInfosAsync>b__30_0, addr 0x368f84c, size 0x28, virtual false, abstract: false, final false
  inline bool _UpdatePromoInfosAsync_b__30_0(::GlobalNamespace::PackDefinitionSO* packDefinition);

  /// @brief Method <UpdatePromoInfosAsync>b__30_1, addr 0x368f874, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368f848, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <UpdatePromoInfosAsync>b__2, addr 0x368f8a4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368f8a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetPackDataForMainMenuPromoBannerInternal>b__0, addr 0x368f8c8, size 0x20, virtual false, abstract: false, final false
  inline bool _GetPackDataForMainMenuPromoBannerInternal_b__0(::GlobalNamespace::DlcPromoPanelModel_PromoInfo* x);

  /// @brief Method <GetPackDataForMainMenuPromoBannerInternal>b__1, addr 0x368f8e8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368e868, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetPackDataForMainMenuPromoBannerInternal>b__2, addr 0x368f908, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368e86c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x368f92c, size 0x278, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x368fba4, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x368fbac, size 0x44c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x368fff8, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3690078, size 0x684, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x36906fc, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3690768, size 0x668, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3690dd0, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3690e3c, size 0x7bc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x36915f8, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
  ...
  // "::ArrayW<::GlobalNamespace::DlcPromoPanelModel_PromoInfo*,::Array<::GlobalNamespace::DlcPromoPanelModel_PromoInfo*>*>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty:
...
public:
  ...
  /// @brief Method MoveNext, addr 0x3691664, size 0xfc8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x369262c, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
  ...
  // "::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<::UnityW<::GlobalNamespace::PackPromoInfoSO>,::Array<::UnityW<::GlobalNamespace::PackPromoInfoSO>>*>>", modifiers: "", def_value: None
  // }]
  constexpr DlcPromoPanelModel__UpdatePromoInfosAsync_d__30(
      int32_t __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, ::GlobalNamespace::DlcPromoPanelModel* __4__this,
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__defaultDlcPromoPanels,
                      put = __cordl_internal_set__defaultDlcPromoPanels)) ::ArrayW<::UnityW<::GlobalNamespace::DlcPromoPanelDataSO>, ::Array<::UnityW<::GlobalNamespace::DlcPromoPanelDataSO>>*>
  ...
  /// @brief Method BuyLevelButtonWasPressed, addr 0x368ee38, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method BuyLevelButtonWasShown, addr 0x368f10c, size 0x100, virtual false, abstract: false, final false
  inline void BuyLevelButtonWasShown(::GlobalNamespace::BeatmapLevel* level, ::StringW page, ::StringW customText);

  /// @brief Method BuyPackButtonWasPressed, addr 0x368f20c, size 0x148, virtual false, abstract: false, final false
  inline void BuyPackButtonWasPressed(::GlobalNamespace::BeatmapLevelPack* pack, ::StringW page, ::StringW customText);

  /// @brief Method BuyPackButtonWasShown, addr 0x368f354, size 0x100, virtual false, abstract: false, final false
  inline void BuyPackButtonWasShown(::GlobalNamespace::BeatmapLevelPack* pack, ::StringW page, ::StringW customText);

  /// @brief Method GetExperimentEventData, addr 0x368ead0, size 0x180, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPackDataForMainMenuPromoBannerInternal, addr 0x368df4c, size 0x4d0, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x368e54c, size 0xa4, virtual false, abstract: false, final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleColdplayBuyClicked, addr 0x368efb4, size 0x158, virtual false, abstract: false, final false
  inline void HandleColdplayBuyClicked(::StringW itemId);

  /// @brief Method HandleColdplayPurchased, addr 0x368f4d4, size 0x158, virtual false, abstract: false, final false
  inline void HandleColdplayPurchased(::StringW itemId);

  /// @brief Method HandleDidCatalogLoadOrUpdate, addr 0x368e5f0, size 0x4, virtual false, abstract: false, final false
  inline void HandleDidCatalogLoadOrUpdate();

  /// @brief Method LevelPackWasPurchased, addr 0x368f454, size 0x80, virtual false, abstract: false, final false
  inline void LevelPackWasPurchased(::GlobalNamespace::BeatmapLevelPack* pack);

  /// @brief Method LevelWasPurchased, addr 0x368f62c, size 0xb4, virtual false, abstract: false, final false
  inline void LevelWasPurchased(::GlobalNamespace::BeatmapLevelPack* pack, ::GlobalNamespace::BeatmapLevel* level);

  /// @brief Method LoadPackPromoInfoAsync, addr 0x368e778, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method MainMenuDlcPromoBannerWasPressed, addr 0x368ec50, size 0x1e8, virtual false, abstract: false, final false
  inline void MainMenuDlcPromoBannerWasPressed(::GlobalNamespace::DlcPromoPanelModel_PromoInfo* promoInfo, ::StringW customText);

  /// @brief Method MainMenuDlcPromoBannerWasShown, addr 0x368e8e8, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestNextPromo, addr 0x368e41c, size 0x6c, virtual false, abstract: false, final false
  inline void RequestNextPromo();

  /// @brief Method RunModelDataUpdate, addr 0x368dda4, size 0xf0, virtual false, abstract: false, final false
  inline void RunModelDataUpdate();

  /// @brief Method Tick, addr 0x368de94, size 0xb8, virtual false, abstract: false, final false
  inline void Tick();

  /// @brief Method TryGetPromoGroupId, addr 0x368e870, size 0x78, virtual false, abstract: false, final false
  static inline bool TryGetPromoGroupId(::StringW promoId, ::ByRef<::StringW> promoGroupId);

  /// @brief Method UpdateDlcPromoPanelDataAsync, addr 0x368e5f4, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* UpdateDlcPromoPanelDataAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method UpdateModelDataAsync, addr 0x368e488, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateOwnedPacksAsync, addr 0x368f6e0, size 0xc4, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* UpdateOwnedPacksAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method UpdatePromoInfosAsync, addr 0x368e6b8, size 0xc0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* UpdatePromoInfosAsync(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Zenject.IInitializable.Initialize, addr 0x368dd94, size 0x10, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x368dac8, size 0x2cc, virtual false, abstract: false, final false
