...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3394)), TypeDefinitionIndex(TypeDefinitionIndex(3393)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3394), inst: 105
// }), TypeDefinitionIndex(TypeDefinitionIndex(3400))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4160)) CS Name: ::DlcPromoPanelModel::<Initialize>d__10
...
public:
  ...
  /// @brief Method MoveNext addr 0x223f2d0 size 0x614 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x223f8e4 size 0xc virtual true final true
...
public:
  ...
  /// @brief Method .ctor addr 0x223e7dc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <GetPackDataForMainMenuPromoBanner>b__0 addr 0x223f8f0 size 0x24 virtual false final false
  inline bool _GetPackDataForMainMenuPromoBanner_b__0(::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo* x);

  /// @brief Method <GetPackDataForMainMenuPromoBanner>b__1 addr 0x223f914 size 0x24 virtual false final false
...
// TypeDefinitionIndex(TypeDefinitionIndex(16270)), TypeDefinitionIndex(TypeDefinitionIndex(3401))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4162)) CS Name:
...
public:
  ...
  /// @brief Method MoveNext addr 0x223f938 size 0x5e4 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x223ff1c size 0xc virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext addr 0x223ff28 size 0x228 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x2240150 size 0xc virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method Initialize addr 0x223e3a0 size 0x90 virtual true final true
  inline void Initialize();

  /// @brief Method GetPackDataForMainMenuPromoBanner addr 0x223e430 size 0x3ac virtual false final false
  inline ::GlobalNamespace::__DlcPromoPanelDataSO__MusicPackPromoInfo* GetPackDataForMainMenuPromoBanner(ByRef<bool> owned);

  /// @brief Method MainMenuDlcPromoBannerWasShown addr 0x223e7e4 size 0x184 virtual false final false
  inline void MainMenuDlcPromoBannerWasShown(::GlobalNamespace::IBeatmapLevelPack* promoPack, ::StringW customText);

  /// @brief Method MainMenuDlcPromoBannerWasPressed addr 0x223ea88 size 0x16c virtual false final false
  inline void MainMenuDlcPromoBannerWasPressed(::GlobalNamespace::IBeatmapLevelPack* promoPack, ::StringW customText);

  /// @brief Method BuyLevelButtonWasPressed addr 0x223ebf4 size 0x15c virtual false final false
  inline void BuyLevelButtonWasPressed(::GlobalNamespace::IPreviewBeatmapLevel* level, ::StringW page, ::StringW customText);

  /// @brief Method BuyLevelButtonWasShown addr 0x223ed50 size 0x15c virtual false final false
  inline void BuyLevelButtonWasShown(::GlobalNamespace::IPreviewBeatmapLevel* level, ::StringW page, ::StringW customText);

  /// @brief Method BuyPackButtonWasPressed addr 0x223eeac size 0x15c virtual false final false
  inline void BuyPackButtonWasPressed(::GlobalNamespace::IBeatmapLevelPack* pack, ::StringW page, ::StringW customText);

  /// @brief Method BuyPackButtonWasShown addr 0x223f008 size 0x15c virtual false final false
  inline void BuyPackButtonWasShown(::GlobalNamespace::IBeatmapLevelPack* pack, ::StringW page, ::StringW customText);

  /// @brief Method GetExperimentEventData addr 0x223e968 size 0x120 virtual false final false
  ...
  /// @brief Method UpdatePacksAsync addr 0x223f164 size 0xd0 virtual false final false
  inline ::System::Threading::Tasks::Task* UpdatePacksAsync();

  /// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x223f234 size 0x94 virtual false final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  static inline ::GlobalNamespace::DlcPromoPanelModel* New_ctor();

  /// @brief Method .ctor addr 0x223f2c8 size 0x8 virtual false final false
  inline void _ctor();
