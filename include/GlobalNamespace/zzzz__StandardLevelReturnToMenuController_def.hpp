...
public:
  ...
  /// @brief Method ReturnToMenu, addr 0x59b0a20, size 0x54, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59b0a74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::StandardLevelReturnToMenuController) == 0x30, "Size mismatch!");
