...
/// @brief Method ReturnToMenu, addr 0x587d558, size 0x54, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x587d5ac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
