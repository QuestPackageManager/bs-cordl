...
public:
  ...
  /// @brief Method ConvertRenderTexture, addr 0x57c730c, size 0xfc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> ConvertRenderTexture(::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method HandleTexturesReady, addr 0x57c714c, size 0x78, virtual false, abstract: false, final false
  inline void HandleTexturesReady();

  /// @brief Method Init, addr 0x57c5800, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x57c70c0, size 0x8c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57c7034, size 0x8c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SaveScreenshot, addr 0x57c71c4, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57c7408, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_directory, addr 0x57c702c, size 0x8, virtual false, abstract: false, final false
