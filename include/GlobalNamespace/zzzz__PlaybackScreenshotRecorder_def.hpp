...
public:
  ...
  /// @brief Method ConvertRenderTexture, addr 0x3b1a99c, size 0xfc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> ConvertRenderTexture(::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method HandleTexturesReady, addr 0x3b1a7ec, size 0x7c, virtual false, abstract: false, final false
  inline void HandleTexturesReady();

  /// @brief Method Init, addr 0x3b18f9c, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x3b1a760, size 0x8c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x3b1a6d4, size 0x8c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SaveScreenshot, addr 0x3b1a868, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b1aa98, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_directory, addr 0x3b1a6cc, size 0x8, virtual false, abstract: false, final false
