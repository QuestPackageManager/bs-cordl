...
public:
  ...
  /// @brief Method ConvertRenderTexture, addr 0x56f9ed4, size 0xfc, virtual false, abstract: false, final false
  static inline ::UnityW<::UnityEngine::Texture2D> ConvertRenderTexture(::UnityEngine::RenderTexture* renderTexture);

  /// @brief Method HandleTexturesReady, addr 0x56f9d14, size 0x78, virtual false, abstract: false, final false
  inline void HandleTexturesReady();

  /// @brief Method Init, addr 0x56f83c8, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDisable, addr 0x56f9c88, size 0x8c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x56f9bfc, size 0x8c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method SaveScreenshot, addr 0x56f9d8c, size 0x148, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56f9fd0, size 0x50, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_directory, addr 0x56f9bf4, size 0x8, virtual false, abstract: false, final false
