...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14934)), TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(6009)),
// TypeDefinitionIndex(TypeDefinitionIndex(6008))} Self: TypeDefinitionIndex(TypeDefinitionIndex(6045)) CS Name: ::RecordingToolSettings*
...
public:
  ...
  static inline ::GlobalNamespace::RecordingToolSettings*
  ...
  /// @brief Method .ctor addr 0x21bd058 size 0x144 virtual false final false
  inline void _ctor(::StringW gameMode, ::GlobalNamespace::IBeatmapLevelPack* pack, ::GlobalNamespace::IPreviewBeatmapLevel* level, ::GlobalNamespace::BeatmapDifficulty difficulty,
                    ::GlobalNamespace::BeatmapCharacteristicSO* characteristic, bool runLevel, ::GlobalNamespace::__ObjectsMovementRecorder__Mode recordingMode, ::StringW recordingPath,
                    ::GlobalNamespace::__ObjectsMovementRecorder__CameraView cameraView, bool addDateTimeSuffixToRecordingName, bool screenshotRecording, int32_t screenshotWidth,
  ...
  /// @brief Method ToString addr 0x21bdd50 size 0xb54 virtual true final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::RecordingToolSettings, 0x90>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___gameMode) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___pack) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___level) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___difficulty) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___characteristic) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___runLevel) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___recordingMode) == 0x3c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___recordingPath) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___cameraView) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___addDateTimeSuffixToRecordingName) == 0x4c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___screenshotRecording) == 0x4d, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___screenshotWidth) == 0x50, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___screenshotHeight) == 0x54, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___framerate) == 0x58, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___playbackScreenshots) == 0x60, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___practice) == 0x68, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___startSongTime) == 0x6c, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___songSpeedMultiplier) == 0x70, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___overrideEnvironments) == 0x74, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___environmentType) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___environmentInfo) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RecordingToolSettings, ___saveToOldFormat) == 0x88, "Offset mismatch!");
