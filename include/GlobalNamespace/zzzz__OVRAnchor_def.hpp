...
public:
  ...
  /// @brief Method CreateSpatialAnchorAsync, addr 0x2803fc8, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchorAsync, addr 0x2804120, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x28045dc, size 0x5c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Equals, addr 0x280446c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x2804404, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRAnchor other);

  /// @brief Method FetchAnchors, addr 0x280398c, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method FetchAnchorsAsync, addr 0x28038b0, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method FetchAnchorsAsync, addr 0x2803b5c, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetHashCode, addr 0x2804560, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method GetQueryInfo, addr 0x28037b8, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQueryInfo, addr 0x2803834, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSpaceQueryCompleteData, addr 0x2803ca8, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x28045b4, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2803fbc, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(uint64_t handle, ::System::Guid uuid);

  static inline ::GlobalNamespace::OVRAnchor getStaticF_Null();

  /// @brief Method get_Handle, addr 0x28043f0, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_Uuid, addr 0x28043f8, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x28044fc, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRAnchor lhs, ::GlobalNamespace::OVRAnchor rhs);

  /// @brief Method op_Inequality, addr 0x280452c, size 0x34, virtual false, abstract: false, final false
