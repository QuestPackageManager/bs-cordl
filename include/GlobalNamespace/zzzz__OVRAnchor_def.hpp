...
public:
  ...
  /// @brief Method GetQueryInfo, addr 0x2710eb0, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetQueryInfo, addr 0x2710f2c, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnSpaceQueryCompleteData, addr 0x27113a0, size 0x314, virtual false, abstract: false, final false
  static inline void OnSpaceQueryCompleteData(::GlobalNamespace::__OVRDeserialize__SpaceQueryCompleteData data);

  /// @brief Method CreateSpatialAnchorAsync, addr 0x27116c0, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateSpatialAnchorAsync, addr 0x2711818, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Handle, addr 0x2711ae8, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_Uuid, addr 0x2711af0, size 0xc, virtual false, abstract: false, final false
  inline ::System::Guid get_Uuid();

  /// @brief Method .ctor, addr 0x27116b4, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method Equals, addr 0x2711afc, size 0x68, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRAnchor other);

  /// @brief Method Equals, addr 0x2711b64, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method op_Equality, addr 0x2711bf4, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRAnchor lhs, ::GlobalNamespace::OVRAnchor rhs);

  /// @brief Method op_Inequality, addr 0x2711c24, size 0x34, virtual false, abstract: false, final false
  static inline bool op_Inequality(::GlobalNamespace::OVRAnchor lhs, ::GlobalNamespace::OVRAnchor rhs);

  /// @brief Method GetHashCode, addr 0x2711c58, size 0x54, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method ToString, addr 0x2711cac, size 0x28, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method Dispose, addr 0x2711cd4, size 0x5c, virtual true, abstract: false, final true
  inline void Dispose();
