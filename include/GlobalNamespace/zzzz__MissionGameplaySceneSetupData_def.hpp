...
public:
  ...
  /// @brief Method .ctor, addr 0x571e8b8, size 0x1c, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MissionGameplaySceneSetupData, 0x58>, "Size mismatch!");
