...
template <typename TValue, typename TStatus>
  requires(::cordl_internals::type_constraint<TStatus, ::System::IConvertible*> && ::cordl_internals::value_type_constraint<TStatus> && ::cordl_internals::default_constructor_constraint<TStatus>)
inline bool GlobalNamespace::OVRResult_2<TValue, TStatus>::TryGetValue(::by_ref<TValue> value) {
...
// Ctor Parameters [CppParam { name: "_initialized", ty: "bool", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_value", ty: "TValue", modifiers: "", def_value: Some("{}"),
// comment: None }, CppParam { name: "_statusCode", ty: "int32_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "_status", ty: "TStatus", modifiers: "", def_value:
// Some("{}"), comment: None }]
template <typename TValue, typename TStatus>
  requires(::cordl_internals::type_constraint<TStatus, ::System::IConvertible*> && ::cordl_internals::value_type_constraint<TStatus> && ::cordl_internals::default_constructor_constraint<TStatus>)
