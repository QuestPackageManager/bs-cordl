...
public:
  ...
  /// @brief Method .ctor, addr 0x3b8def0, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Cleanup, addr 0x3b8e074, size 0x9c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method HandleFloatFxBeatmapEventCallback, addr 0x3b8e3e4, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x3b8e4f0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b8e210, size 0x1d4, virtual false, abstract: false, final false
