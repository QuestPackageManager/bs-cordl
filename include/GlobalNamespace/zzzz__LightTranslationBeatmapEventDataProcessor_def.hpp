...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14956), inst: 919 }), TypeDefinitionIndex(TypeDefinitionIndex(14952)),
// TypeDefinitionIndex(TypeDefinitionIndex(14956))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14960)) CS Name: ::LightTranslationBeatmapEventDataProcessor*
...
public:
  // Declarations
  /// @brief Method ProcessInsertedEventDataInternal addr 0xd9a458 size 0x110 virtual true final false
  ...
  /// @brief Method ProcessBeforeDeleteEventDataInternal addr 0xd9a568 size 0xfc virtual true final false
  ...
  /// @brief Method .ctor addr 0xd9a664 size 0x48 virtual false final false
  inline void _ctor();
