...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15121)), TypeDefinitionIndex(TypeDefinitionIndex(15125)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15125), inst:
// 942 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(15131)) CS Name: ::LightTranslationBeatmapEventDataProcessor*
...
public:
  // Declarations
  /// @brief Method ProcessInsertedEventDataInternal, addr 0xe10350, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method ProcessBeforeDeleteEventDataInternal, addr 0xe10460, size 0xfc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe1055c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
