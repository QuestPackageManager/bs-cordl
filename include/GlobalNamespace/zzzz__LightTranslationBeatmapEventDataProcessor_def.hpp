...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14741), inst: 936 }), TypeDefinitionIndex(TypeDefinitionIndex(14741)),
// TypeDefinitionIndex(TypeDefinitionIndex(14737))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14747)) CS Name: ::LightTranslationBeatmapEventDataProcessor*
