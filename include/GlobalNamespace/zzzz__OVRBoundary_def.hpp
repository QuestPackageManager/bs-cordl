...
public:
  ...
  /// @brief Method GetConfigured, addr 0x3f9c820, size 0x98, virtual false, abstract: false, final false
  inline bool GetConfigured();

  /// @brief Method GetDimensions, addr 0x3fa727c, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetDimensions(::GlobalNamespace::OVRBoundary_BoundaryType boundaryType);

  /// @brief Method GetGeometry, addr 0x3f9c8b8, size 0x3c4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVisible, addr 0x3fa7350, size 0x98, virtual false, abstract: false, final false
  inline bool GetVisible();

  static inline ::GlobalNamespace::OVRBoundary* New_ctor();

  /// @brief Method SetVisible, addr 0x3fa73e8, size 0x9c, virtual false, abstract: false, final false
  inline void SetVisible(bool value);

  /// @brief Method TestNode, addr 0x3fa7080, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method TestPoint, addr 0x3fa713c, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3fa7484, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
