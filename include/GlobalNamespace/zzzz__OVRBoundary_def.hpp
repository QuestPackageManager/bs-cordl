...
public:
  ...
  /// @brief Method GetConfigured, addr 0x5cdc60c, size 0xa0, virtual false, abstract: false, final false
  inline bool GetConfigured();

  /// @brief Method GetDimensions, addr 0x5cdcc6c, size 0xdc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 GetDimensions(::GlobalNamespace::OVRBoundary_BoundaryType boundaryType);

  /// @brief Method GetGeometry, addr 0x5cdc85c, size 0x3e0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetVisible, addr 0x5cdcd4c, size 0xa0, virtual false, abstract: false, final false
  inline bool GetVisible();

  static inline ::GlobalNamespace::OVRBoundary* New_ctor();

  /// @brief Method SetVisible, addr 0x5cdcdec, size 0xa4, virtual false, abstract: false, final false
  inline void SetVisible(bool value);

  /// @brief Method TestNode, addr 0x5cdc6ac, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method TestPoint, addr 0x5cdc770, size 0xe4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5cdce90, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();
