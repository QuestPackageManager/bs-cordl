...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO::*)(::GlobalNamespace::HealthWarningSceneSetupData*)>(&::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO::Init)> {
  constexpr static std::size_t size = 0xc4;
  constexpr static std::size_t addrs = 0x577e0fc;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::HealthWarningSceneSetupData*>::get()}
                    )));
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO::*)()>(&::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x577e1c0;
...
return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, healthWarningSceneSetupData);
}
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::HealthWarningScenesTransitionSetupDataSO*>());
}
// Ctor Parameters []
