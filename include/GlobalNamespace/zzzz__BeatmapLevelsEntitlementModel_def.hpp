...
public:
  ...
  /// @brief Method .ctor, addr 0x12864e0, size 0xac, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::IAdditionalContentEntitlementModel* additionalContentEntitlementModel);

  /// @brief Method AddPack, addr 0x128658c, size 0x340, virtual false, abstract: false, final false
  inline void AddPack(::GlobalNamespace::PackDefinitionSO* pack);

  /// @brief Method GetLevelEntitlementStatusAsync, addr 0x12868cc, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLevelPackEntitlementStatusAsync, addr 0x1286a00, size 0x138, virtual false, abstract: false, final false
