...
public:
  ...
  /// @brief Method AddAlwaysOwnedPack, addr 0x26c9d74, size 0x33c, virtual false, abstract: false, final false
  inline void AddAlwaysOwnedPack(::GlobalNamespace::PackDefinitionSO* pack);

  /// @brief Method GetLevelDataVersionAsync, addr 0x26ca31c, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLevelEntitlementStatusAsync, addr 0x26ca0b0, size 0x134, virtual true, abstract: false, final true
  ...
  /// @brief Method GetPackEntitlementStatusAsync, addr 0x26ca1e4, size 0x138, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26c9cd4, size 0xa0, virtual false, abstract: false, final false
