...
public:
  ...
  /// @brief Method AddAlwaysOwnedPack, addr 0x26cb47c, size 0x33c, virtual false, abstract: false, final false
  inline void AddAlwaysOwnedPack(::GlobalNamespace::PackDefinitionSO* pack);

  /// @brief Method GetLevelDataVersionAsync, addr 0x26cba24, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method GetLevelEntitlementStatusAsync, addr 0x26cb7b8, size 0x134, virtual true, abstract: false, final true
  ...
  /// @brief Method GetPackEntitlementStatusAsync, addr 0x26cb8ec, size 0x138, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x26cb3dc, size 0xa0, virtual false, abstract: false, final false
