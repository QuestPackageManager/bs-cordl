...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapDataLoaderUtils", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapDataLoaderUtils(BeatmapDataLoaderUtils&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapDataLoaderUtils", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapDataLoaderUtils(BeatmapDataLoaderUtilsconst&) = delete;
