...
public:
  // Declarations
  /// @brief Method GetEnvironmentKeywords, addr 0x3652048, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentLightGroups, addr 0x36521b8, size 0x110, virtual false, abstract: false, final false
