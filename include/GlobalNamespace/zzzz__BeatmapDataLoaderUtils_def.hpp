...
public:
  // Declarations
  /// @brief Method GetEnvironmentKeywords, addr 0x37100c4, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentLightGroups, addr 0x3710234, size 0x110, virtual false, abstract: false, final false
