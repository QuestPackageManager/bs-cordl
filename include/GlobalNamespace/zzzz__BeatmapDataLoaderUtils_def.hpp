...
public:
  // Declarations
  /// @brief Method GetEnvironmentKeywords, addr 0x36159f8, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentLightGroups, addr 0x3615b68, size 0x110, virtual false, abstract: false, final false
