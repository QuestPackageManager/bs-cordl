...
public:
// Declarations
/// @brief Method GetEnvironmentKeywords, addr 0x3615948, size 0x170, virtual false, abstract: false, final false
static inline ::GlobalNamespace::EnvironmentKeywords* GetEnvironmentKeywords(::GlobalNamespace::IEnvironmentInfo*  environmentInfo, ::GlobalNamespace::BeatmapLevelDataVersion  beatmapLevelDataVersion) ;

/// @brief Method GetEnvironmentLightGroups, addr 0x3615ab8, size 0x110, virtual false, abstract: false, final false
