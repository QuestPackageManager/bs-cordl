...
public:
  // Declarations
  /// @brief Method GetEnvironmentKeywords, addr 0x35eaac0, size 0x16c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentLightGroups, addr 0x35eac2c, size 0x110, virtual false, abstract: false, final false
