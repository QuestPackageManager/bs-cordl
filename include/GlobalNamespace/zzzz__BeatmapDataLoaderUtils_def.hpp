...
public:
  // Declarations
  /// @brief Method GetEnvironmentKeywords, addr 0x26bdb04, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentLightGroups, addr 0x26bdc50, size 0x110, virtual false, abstract: false, final false
