...
static inline ::GlobalNamespace::NoteExecutionRating* New_ctor(float_t  time, ::GlobalNamespace::NoteData_ScoringType  scoringType, ::GlobalNamespace::NoteExecutionRating_Rating  rating, int32_t  cutScore, int32_t  beforeCutScore, int32_t  centerDistanceCutScore, int32_t  afterCutScore) ;
...
/// @brief Method .ctor, addr 0x36417a8, size 0x14, virtual false, abstract: false, final false
inline void _ctor(float_t  time, ::GlobalNamespace::NoteData_ScoringType  scoringType, ::GlobalNamespace::NoteExecutionRating_Rating  rating, int32_t  cutScore, int32_t  beforeCutScore, int32_t  centerDistanceCutScore, int32_t  afterCutScore) ;
