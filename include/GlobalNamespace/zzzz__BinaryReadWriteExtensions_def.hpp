...
public:
  // Declarations
  /// @brief Method ReadColor, addr 0x2272f94, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadPose, addr 0x2273240, size 0x84, virtual false, abstract: false, final false
  static inline ::UnityEngine::Pose ReadPose(::System::IO::BinaryReader* binaryReader);

  /// @brief Method ReadQuaternion, addr 0x227317c, size 0x90, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion ReadQuaternion(::System::IO::BinaryReader* binaryReader);

  /// @brief Method ReadVector3, addr 0x2273088, size 0x6c, virtual false, abstract: false, final false
  static inline ::UnityEngine::Vector3 ReadVector3(::System::IO::BinaryReader* binaryReader);

  /// @brief Method Write, addr 0x2272f0c, size 0x88, virtual false, abstract: false, final false
  static inline void Write(::System::IO::BinaryWriter* binaryWriter, ::UnityEngine::Color color);

  /// @brief Method Write, addr 0x227320c, size 0x34, virtual false, abstract: false, final false
  static inline void Write(::System::IO::BinaryWriter* binaryWriter, ::UnityEngine::Pose pose);

  /// @brief Method Write, addr 0x22730f4, size 0x88, virtual false, abstract: false, final false
  static inline void Write(::System::IO::BinaryWriter* binaryWriter, ::UnityEngine::Quaternion quaternion);

  /// @brief Method Write, addr 0x2273024, size 0x64, virtual false, abstract: false, final false
