...
public:
  ...
  /// @brief Method SetValue, addr 0x57e098c, size 0x80, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x57e0a0c, size 0x80, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e0a8c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
