...
public:
  ...
  /// @brief Method SetValue, addr 0x3b88b78, size 0x8c, virtual true, abstract: false, final false
  inline void SetValue(int32_t groupId, int32_t elementId, float_t value);

  /// @brief Method TriggerValue, addr 0x3b88c04, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b88c90, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
