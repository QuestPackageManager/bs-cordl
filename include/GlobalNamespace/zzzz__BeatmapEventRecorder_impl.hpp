...
// Ctor Parameters [CppParam { name: "bpm", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "jumpSpeed", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "basic", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "boost", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "color", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "rotation", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "translation", ty: "int32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "fx", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::BeatmapEventRecorder_EventCounts::BeatmapEventRecorder_EventCounts(int32_t  bpm, int32_t  jumpSpeed, int32_t  basic, int32_t  boost, int32_t  color, int32_t  rotation, int32_t  translation, int32_t  fx) noexcept  {
this->bpm = bpm;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapEventRecorder::*)(int32_t)>(&::GlobalNamespace::BeatmapEventRecorder::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x575a518;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapEventRecorder*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapEventRecorder::*)(::GlobalNamespace::BeatmapCallbacksController*)>(&::GlobalNamespace::BeatmapEventRecorder::Begin)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x575a59c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapEventRecorder::*)()>(&::GlobalNamespace::BeatmapEventRecorder::CaptureFrame)> {
  ...
  constexpr static std::size_t addrs = 0x575a65c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts,::Array<::GlobalNamespace::BeatmapEventRecorder_EventCounts>*> (::GlobalNamespace::BeatmapEventRecorder::*)()>(&::GlobalNamespace::BeatmapEventRecorder::Finish)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0x575a748;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (*)(::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts,::Array<::GlobalNamespace::BeatmapEventRecorder_EventCounts>*>)>(&::GlobalNamespace::BeatmapEventRecorder::GenerateTableReport)> {
  constexpr static std::size_t size = 0x540;
  constexpr static std::size_t addrs = 0x575a81c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "GenerateTableReport",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts,::Array<::GlobalNamespace::BeatmapEventRecorder_EventCounts>*>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapEventRecorder::*)()>(&::GlobalNamespace::BeatmapEventRecorder::ClearCallbacks)> {
  ...
  constexpr static std::size_t addrs = 0x575a7ec;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapEventRecorder::*)(::GlobalNamespace::BeatmapCallbacksController*)>(&::GlobalNamespace::BeatmapEventRecorder::SetupCallbacks)> {
  constexpr static std::size_t size = 0xbc;
  constexpr static std::size_t addrs = 0x575a5a0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapEventRecorder::*)(::GlobalNamespace::BeatmapEventData*)>(&::GlobalNamespace::BeatmapEventRecorder::HandleBeatmapEvent)> {
  constexpr static std::size_t size = 0x2cc;
  constexpr static std::size_t addrs = 0x575ad5c;
...
return ::cordl_internals::RunMethodRethrow<::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts,::Array<::GlobalNamespace::BeatmapEventRecorder_EventCounts>*>, false>(this, ___internal_method);
}
inline ::StringW GlobalNamespace::BeatmapEventRecorder::GenerateTableReport(::ArrayW<::GlobalNamespace::BeatmapEventRecorder_EventCounts,::Array<::GlobalNamespace::BeatmapEventRecorder_EventCounts>*>  samples)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapEventRecorder*>::get(),
                        "GenerateTableReport",
                        std::span<const Il2CppClass* const, 0>(),
