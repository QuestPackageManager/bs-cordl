...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14741)), TypeDefinitionIndex(TypeDefinitionIndex(14730)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14741), inst:
...
public:
  ...
  /// @brief Method .ctor, addr 0xdff8ec, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
