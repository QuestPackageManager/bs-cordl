...
public:
  ...
  /// @brief Method .ctor, addr 0x58b80e4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x58b80f0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Start, addr 0x58b7df8, size 0x98, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58b8084, size 0x60, virtual false, abstract: false, final false
  inline void _ctor();
