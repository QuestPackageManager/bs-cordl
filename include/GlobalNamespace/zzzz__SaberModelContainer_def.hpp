...
// Write type traits
MARK_REF_T(::GlobalNamespace::SaberModelContainer*);
MARK_REF_T(::GlobalNamespace::SaberModelContainer_InitData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SaberModelContainer*, "", "SaberModelContainer");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SaberModelContainer_InitData*, "", "SaberModelContainer/InitData");
...
static_assert(sizeof(::GlobalNamespace::SaberModelContainer) == 0x40, "Size mismatch!");
