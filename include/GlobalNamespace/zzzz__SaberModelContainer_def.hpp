...
public:
  ...
  /// @brief Method Start, addr 0x23c2f90, size 0x84, virtual false, abstract: false, final false
  inline void Start();

  static inline ::GlobalNamespace::SaberModelContainer* New_ctor();

  /// @brief Method .ctor, addr 0x23c3304, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
