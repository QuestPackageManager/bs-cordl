...
public:
  ...
  /// @brief Method HandleHapticSettingValueDidChange, addr 0x58e3a08, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x58e388c, size 0xd8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x58e37f0, size 0x9c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58e3964, size 0xa4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58e3a7c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
