...
public:
  ...
  /// @brief Method HandleHapticSettingValueDidChange, addr 0x3c13a28, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3c138f4, size 0xcc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3c13858, size 0x9c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3c139c0, size 0x68, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3c13a78, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
