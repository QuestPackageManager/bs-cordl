...
public:
  ...
  /// @brief Method HandleHapticSettingValueDidChange, addr 0x3c13aa0, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3c1396c, size 0xcc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3c138d0, size 0x9c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3c13a38, size 0x68, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3c13af0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
