...
public:
  ...
  /// @brief Method HandleHapticSettingValueDidChange, addr 0x3c1812c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3c17ff8, size 0xcc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3c17f5c, size 0x9c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3c180c4, size 0x68, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3c1817c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
