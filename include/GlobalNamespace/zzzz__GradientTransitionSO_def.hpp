...
public:
  ...
  /// @brief Method .ctor, addr 0x6302f6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_disabledColor1, addr 0x6300eec, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_disabledColor1();

  /// @brief Method get_disabledColor2, addr 0x6300ef8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_disabledColor2();

  /// @brief Method get_highlightColor1, addr 0x6300d9c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_highlightColor1();

  /// @brief Method get_highlightColor2, addr 0x6300da8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_highlightColor2();

  /// @brief Method get_normalColor1, addr 0x63009fc, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_normalColor1();

  /// @brief Method get_normalColor2, addr 0x6300a08, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_normalColor2();

  /// @brief Method get_pressedColor1, addr 0x6300e44, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_pressedColor1();

  /// @brief Method get_pressedColor2, addr 0x6300e50, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_pressedColor2();

  /// @brief Method get_selectedAndHighlightedColor1, addr 0x630103c, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_selectedAndHighlightedColor1();

  /// @brief Method get_selectedAndHighlightedColor2, addr 0x6301048, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_selectedAndHighlightedColor2();

  /// @brief Method get_selectedColor1, addr 0x6300f94, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_selectedColor1();

  /// @brief Method get_selectedColor2, addr 0x6300fa0, size 0xc, virtual false, abstract: false, final false
