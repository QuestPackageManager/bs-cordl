...
public:
  ...
  /// @brief Method Deserialize, addr 0x22dede0, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x22debf4, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x22dedd8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x22dee78, size 0x130, virtual false, abstract: false, final false
