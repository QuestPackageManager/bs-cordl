...
public:
  ...
  /// @brief Method Deserialize, addr 0xfbd62c, size 0x98, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0xfbd43c, size 0x90, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0xfbd624, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0xfbd6c4, size 0x140, virtual false, abstract: false, final false
