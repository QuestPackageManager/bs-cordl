...
public:
  ...
  /// @brief Method Deserialize, addr 0x321fdf0, size 0xb4, virtual true, abstract: false, final true
  ...
  /// @brief Method Serialize, addr 0x321fbfc, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x321fdec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x321fea4, size 0x50, virtual false, abstract: false, final false
