...
/// @brief Method DrawFadeQuad, addr 0x5e09998, size 0x1c4, virtual false, abstract: false, final false
inline void DrawFadeQuad(float_t  alpha) ;

/// @brief Method DrawSetAlphaQuad, addr 0x5e0981c, size 0x17c, virtual false, abstract: false, final false
inline void DrawSetAlphaQuad() ;

static inline ::GlobalNamespace::NoPostProcessMainEffectSO* New_ctor() ;

/// @brief Method OnDisable, addr 0x5e09758, size 0x24, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5e0967c, size 0xdc, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PostRender, addr 0x5e097e4, size 0x38, virtual true, abstract: false, final false
inline void PostRender(float_t  fade) ;

/// @brief Method PreRender, addr 0x5e0977c, size 0x68, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e09b5c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasPostProcessEffect, addr 0x5e09674, size 0x8, virtual true, abstract: false, final false
