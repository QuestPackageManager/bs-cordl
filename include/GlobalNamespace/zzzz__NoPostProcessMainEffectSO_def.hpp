...
public:
  ...
  /// @brief Method DrawFadeQuad, addr 0x2bf64c4, size 0xec, virtual false, abstract: false, final false
  inline void DrawFadeQuad(float_t alpha);

  static inline ::GlobalNamespace::NoPostProcessMainEffectSO* New_ctor();

  /// @brief Method OnDisable, addr 0x2bf6448, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2bf63c8, size 0x80, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PostRender, addr 0x2bf64b8, size 0xc, virtual true, abstract: false, final false
  inline void PostRender(float_t fade);

  /// @brief Method PreRender, addr 0x2bf6454, size 0x64, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2bf65b0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_hasPostProcessEffect, addr 0x2bf63c0, size 0x8, virtual true, abstract: false, final false
