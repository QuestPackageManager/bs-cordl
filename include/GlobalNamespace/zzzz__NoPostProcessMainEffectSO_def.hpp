...
public:
  ...
  /// @brief Method CreateFullScreenTriangleVertexPosition, addr 0x5f43228, size 0xb4, virtual false, abstract: false, final false
  static inline ::ArrayW<::UnityEngine::Vector3> CreateFullScreenTriangleVertexPosition(float_t z);

  /// @brief Method InitTriangleMeshIfNeeded, addr 0x5f42e54, size 0x1c4, virtual false, abstract: false, final false
  inline void InitTriangleMeshIfNeeded();

  static inline ::GlobalNamespace::NoPostProcessMainEffectSO* New_ctor();

  /// @brief Method OnDisable, addr 0x5f43018, size 0x30, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5f42d20, size 0x134, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PostRender, addr 0x5f430c0, size 0x168, virtual true, abstract: false, final false
  inline void PostRender(::UnityEngine::Rendering::RasterCommandBuffer* cmd, float_t fade);

  /// @brief Method PreRender, addr 0x5f43048, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f432dc, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_hasPostProcessEffect, addr 0x5f42d18, size 0x8, virtual true, abstract: false, final false
