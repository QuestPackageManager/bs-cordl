...
/// @brief Method .ctor, addr 0x57f27c8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_localPositionOffset, addr 0x57f27bc, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field _movementData, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__movementData, put=__cordl_internal_set__movementData)) ::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*,::Array<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*>*>  _movementData;
...
/// @brief Method FixedUpdate, addr 0x57f260c, size 0x130, virtual false, abstract: false, final false
inline void FixedUpdate() ;

/// @brief Method HandleBeatmapEvent, addr 0x57f2780, size 0x38, virtual false, abstract: false, final false
inline void HandleBeatmapEvent(::GlobalNamespace::BasicBeatmapEventData*  basicBeatmapEventData) ;

/// @brief Method LateUpdate, addr 0x57f273c, size 0x44, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::MovementBeatmapEventEffect* New_ctor() ;

/// @brief Method OnDestroy, addr 0x57f25f0, size 0x1c, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method SetLocalPositionOffsetsForAllObjects, addr 0x57f2544, size 0xac, virtual false, abstract: false, final false
inline void SetLocalPositionOffsetsForAllObjects(::UnityEngine::Vector3  localPositionOffset) ;

/// @brief Method Start, addr 0x57f2348, size 0x1fc, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::ArrayW<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*,::Array<::GlobalNamespace::MovementBeatmapEventEffect_MovementData*>*> const& __cordl_internal_get__movementData() const;
...
/// @brief Method .ctor, addr 0x57f27b8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
