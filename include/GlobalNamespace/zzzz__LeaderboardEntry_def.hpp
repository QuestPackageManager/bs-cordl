...
public:
  ...
  /// @brief Method SetScore, addr 0x3c0a2a8, size 0x190, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c0a438, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
