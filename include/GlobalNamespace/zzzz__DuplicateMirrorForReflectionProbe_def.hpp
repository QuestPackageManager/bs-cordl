...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DuplicateMirrorForReflectionProbe", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DuplicateMirrorForReflectionProbe(DuplicateMirrorForReflectionProbe&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DuplicateMirrorForReflectionProbe", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DuplicateMirrorForReflectionProbe(DuplicateMirrorForReflectionProbeconst&) = delete;
