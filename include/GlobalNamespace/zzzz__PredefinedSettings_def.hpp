...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PredefinedSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PredefinedSettings(PredefinedSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PredefinedSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PredefinedSettings(PredefinedSettingsconst&) = delete;
