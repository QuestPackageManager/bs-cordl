...
public:
  ...
  /// @brief Method Start, addr 0x270cd90, size 0x15c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x270ceec, size 0x1b0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x270d09c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_alpha, addr 0x270cd74, size 0x1c, virtual false, abstract: false, final false
