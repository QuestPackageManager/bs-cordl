...
public:
  ...
  /// @brief Method Start, addr 0x3ba3b48, size 0x150, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x3ba3c98, size 0x1b0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ba3e48, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_alpha, addr 0x3ba3b2c, size 0x1c, virtual false, abstract: false, final false
