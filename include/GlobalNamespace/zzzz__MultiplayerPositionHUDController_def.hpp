...
public:
  ...
  /// @brief Method Start, addr 0x5870540, size 0x174, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x58706b4, size 0x1c4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5870878, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_alpha, addr 0x5870528, size 0x18, virtual false, abstract: false, final false
