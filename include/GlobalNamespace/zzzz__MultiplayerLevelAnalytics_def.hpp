...
public:
  ...
  /// @brief Method HandleMultiplayerLevelDidFinish, addr 0x23dc4fc, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x23dc470, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x23dc3e4, size 0x8c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x23dc97c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
