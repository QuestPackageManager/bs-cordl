...
public:
  ...
  /// @brief Method HandleMultiplayerLevelDidFinish, addr 0x237a724, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x237a698, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x237a60c, size 0x8c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x237aba4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
