...
public:
  ...
  /// @brief Method HandleMultiplayerLevelDidFinish, addr 0x24fea48, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x24fe9bc, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x24fe930, size 0x8c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24feec8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
