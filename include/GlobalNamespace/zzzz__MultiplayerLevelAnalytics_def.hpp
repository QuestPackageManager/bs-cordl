...
public:
  ...
  /// @brief Method HandleMultiplayerLevelDidFinish, addr 0x2506a44, size 0x480, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25069b8, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x250692c, size 0x8c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2506ec4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
