...
public:
  // Declarations
  /// @brief Method BeatmapDifficultyFromSerializedName, addr 0x31c4978, size 0x164, virtual false, abstract: false, final false
  static inline bool BeatmapDifficultyFromSerializedName(::StringW name, ::ByRef<::GlobalNamespace::BeatmapDifficulty> difficulty);

  /// @brief Method SerializedName, addr 0x31c48b0, size 0xc8, virtual false, abstract: false, final false
