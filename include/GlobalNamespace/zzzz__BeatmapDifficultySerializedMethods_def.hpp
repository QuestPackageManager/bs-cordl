...
public:
  // Declarations
  /// @brief Method SerializedName addr 0xd98040 size 0xa4 virtual false final false
  static inline ::StringW SerializedName(::GlobalNamespace::BeatmapDifficulty difficulty);

  /// @brief Method BeatmapDifficultyFromSerializedName addr 0xd980e4 size 0x164 virtual false final false
