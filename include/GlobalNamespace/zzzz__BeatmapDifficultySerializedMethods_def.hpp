...
public:
// Declarations
/// @brief Method BeatmapDifficultyFromSerializedName, addr 0x3192154, size 0x164, virtual false, abstract: false, final false
static inline bool BeatmapDifficultyFromSerializedName(::StringW  name, ::ByRef<::GlobalNamespace::BeatmapDifficulty>  difficulty) ;

/// @brief Method SerializedName, addr 0x319208c, size 0xc8, virtual false, abstract: false, final false
