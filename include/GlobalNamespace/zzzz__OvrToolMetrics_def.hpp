...
public:
  ...
  /// @brief Method CaptureFrame, addr 0x3b191b8, size 0x54, virtual false, abstract: false, final false
  inline void CaptureFrame();

  /// @brief Method Dispose, addr 0x3b191b4, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GenerateListReport, addr 0x3b1920c, size 0x18c, virtual false, abstract: false, final false
  inline ::StringW GenerateListReport();

  /// @brief Method GenerateTableReport, addr 0x3b19398, size 0x1cc, virtual false, abstract: false, final false
  inline ::StringW GenerateTableReport();

  static inline ::GlobalNamespace::OvrToolMetrics* New_ctor();

  /// @brief Method RecordMetrics, addr 0x3b191ac, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b19564, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
