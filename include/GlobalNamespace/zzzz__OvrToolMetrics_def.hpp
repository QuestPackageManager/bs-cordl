...
// Write type traits
MARK_REF_T(::GlobalNamespace::OvrToolMetrics*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::OvrToolMetrics*, "", "OvrToolMetrics");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__metrics, put = __cordl_internal_set__metrics)) ::ArrayW<::StringW> _metrics;
  ...
  __declspec(property(get = __cordl_internal_get__sample, put = __cordl_internal_set__sample)) ::ArrayW<int64_t> _sample;
  ...
  constexpr ::ArrayW<::StringW>& __cordl_internal_get__metrics();
  ...
  constexpr ::ArrayW<int64_t> const& __cordl_internal_get__sample() const;

  constexpr ::ArrayW<int64_t>& __cordl_internal_get__sample();
  ...
  constexpr void __cordl_internal_set__metrics(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set__metricsTool(::UnityW<::GlobalNamespace::OVRMetricsToolSDK> value);

  constexpr void __cordl_internal_set__sample(::ArrayW<int64_t> value);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "OvrToolMetrics", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  OvrToolMetrics(OvrToolMetrics&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "OvrToolMetrics", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  OvrToolMetrics(OvrToolMetricsconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::OvrToolMetrics) == 0x30, "Size mismatch!");
