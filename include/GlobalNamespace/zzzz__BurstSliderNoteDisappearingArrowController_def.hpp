...
// Write type traits
MARK_REF_T(::GlobalNamespace::BurstSliderNoteDisappearingArrowController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BurstSliderNoteDisappearingArrowController*, "", "BurstSliderNoteDisappearingArrowController");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58d3064, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_gameNoteController, addr 0x58d305c, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BurstSliderNoteDisappearingArrowController) == 0x60, "Size mismatch!");
