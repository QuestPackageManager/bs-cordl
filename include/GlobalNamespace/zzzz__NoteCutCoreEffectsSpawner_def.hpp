...
public:
  ...
  /// @brief Method HandleNoteWasCut, addr 0x25bccd0, size 0x198, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method IsArcHapticsCurrentlyActive, addr 0x25bd590, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x25bcc38, size 0x98, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PlayHitChainNoteHapticEffect, addr 0x25bd528, size 0x68, virtual false, abstract: false, final false
  inline void PlayHitChainNoteHapticEffect(::GlobalNamespace::NoteCutInfo noteCutInfo, bool isChainHead);

  /// @brief Method PlayHitNoteHapticEffect, addr 0x25bd3d4, size 0x104, virtual false, abstract: false, final false
  inline void PlayHitNoteHapticEffect(::GlobalNamespace::NoteCutInfo noteCutInfo, ::GlobalNamespace::NoteData* noteData);

  /// @brief Method SpawnBombCutEffect, addr 0x25bd4d8, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteCutEffect, addr 0x25bce68, size 0x56c, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x25bca54, size 0x1e4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x25bdeb4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
