...
/// @brief Field _colorTypeToSliderInteractionManagerDictionary, offset 0x70, size 0x8 
 __declspec(property(get=__cordl_internal_get__colorTypeToSliderInteractionManagerDictionary, put=__cordl_internal_set__colorTypeToSliderInteractionManagerDictionary)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::UnityW<::GlobalNamespace::SliderInteractionManager>>*  _colorTypeToSliderInteractionManagerDictionary;
...
/// @brief Field _noteCutParticlesEffect, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__noteCutParticlesEffect, put=__cordl_internal_set__noteCutParticlesEffect)) ::UnityW<::GlobalNamespace::NoteCutParticlesEffect>  _noteCutParticlesEffect;
...
/// @brief Method HandleNoteWasCut, addr 0x57dd2dc, size 0x19c, virtual false, abstract: false, final false
inline void HandleNoteWasCut(::GlobalNamespace::NoteController*  noteController, ::ByRef<::GlobalNamespace::NoteCutInfo>  noteCutInfo) ;

/// @brief Method IsArcHapticsCurrentlyActive, addr 0x57dd928, size 0x98, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57dd244, size 0x98, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method PlayHitChainNoteHapticEffect, addr 0x57dd8bc, size 0x6c, virtual false, abstract: false, final false
inline void PlayHitChainNoteHapticEffect(::GlobalNamespace::NoteCutInfo  noteCutInfo, bool  isChainHead) ;

/// @brief Method PlayHitNoteHapticEffect, addr 0x57dd764, size 0x104, virtual false, abstract: false, final false
inline void PlayHitNoteHapticEffect(::GlobalNamespace::NoteCutInfo  noteCutInfo, ::GlobalNamespace::NoteData*  noteData) ;

/// @brief Method SpawnBombCutEffect, addr 0x57dd868, size 0x54, virtual false, abstract: false, final false
...
/// @brief Method SpawnNoteCutEffect, addr 0x57dd478, size 0x2ec, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x57dd0a0, size 0x1a4, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::UnityW<::GlobalNamespace::SliderInteractionManager>>* const& __cordl_internal_get__colorTypeToSliderInteractionManagerDictionary() const;

constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::UnityW<::GlobalNamespace::SliderInteractionManager>>*& __cordl_internal_get__colorTypeToSliderInteractionManagerDictionary() ;
...
constexpr void __cordl_internal_set__colorTypeToSliderInteractionManagerDictionary(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ColorType,::UnityW<::GlobalNamespace::SliderInteractionManager>>*  value) ;
...
/// @brief Method .ctor, addr 0x57de298, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
