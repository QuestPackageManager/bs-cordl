...
public:
  ...
  /// @brief Method HandleNoteWasCut, addr 0x584f1dc, size 0x19c, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method IsArcHapticsCurrentlyActive, addr 0x584f820, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x584f144, size 0x98, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PlayHitChainNoteHapticEffect, addr 0x584f7b4, size 0x6c, virtual false, abstract: false, final false
  inline void PlayHitChainNoteHapticEffect(::GlobalNamespace::NoteCutInfo noteCutInfo, bool isChainHead);

  /// @brief Method PlayHitNoteHapticEffect, addr 0x584f660, size 0x104, virtual false, abstract: false, final false
  inline void PlayHitNoteHapticEffect(::GlobalNamespace::NoteCutInfo noteCutInfo, ::GlobalNamespace::NoteData* noteData);

  /// @brief Method SpawnBombCutEffect, addr 0x584f764, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteCutEffect, addr 0x584f378, size 0x2e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x584efa0, size 0x1a4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5850190, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
