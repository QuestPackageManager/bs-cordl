...
public:
  ...
  /// @brief Method HandleNoteWasCut, addr 0x3b8b970, size 0x194, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method IsArcHapticsCurrentlyActive, addr 0x3b8bf80, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3b8b8e0, size 0x90, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method PlayHitChainNoteHapticEffect, addr 0x3b8bf28, size 0x58, virtual false, abstract: false, final false
  inline void PlayHitChainNoteHapticEffect(::GlobalNamespace::NoteCutInfo noteCutInfo, bool isChainHead);

  /// @brief Method PlayHitNoteHapticEffect, addr 0x3b8bde4, size 0xf8, virtual false, abstract: false, final false
  inline void PlayHitNoteHapticEffect(::GlobalNamespace::NoteCutInfo noteCutInfo, ::GlobalNamespace::NoteData* noteData);

  /// @brief Method SpawnBombCutEffect, addr 0x3b8bedc, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteCutEffect, addr 0x3b8bb04, size 0x2e0, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x3b8b700, size 0x1e0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b8c014, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
