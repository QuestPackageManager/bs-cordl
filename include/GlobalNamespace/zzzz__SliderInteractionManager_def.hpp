...
public:
  ...
  /// @brief Method AddActiveSlider, addr 0x59790b0, size 0x200, virtual false, abstract: false, final false
  inline void AddActiveSlider(::GlobalNamespace::SliderController* newSliderController);

  /// @brief Method HandleSliderWasDespawned, addr 0x5979398, size 0x34, virtual false, abstract: false, final false
  inline void HandleSliderWasDespawned(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method HandleSliderWasSpawned, addr 0x5979364, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5978e9c, size 0xf4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method RemoveActiveSlider, addr 0x59792b0, size 0xb4, virtual false, abstract: false, final false
  inline void RemoveActiveSlider(::GlobalNamespace::SliderController* sliderController);

  /// @brief Method Start, addr 0x5978db8, size 0xe4, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5978f90, size 0x120, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x59793cc, size 0x78, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allSliderWereRemovedFromActiveSlidersEvent, addr 0x5978a5c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_sliderWasAddedToActiveSlidersEvent, addr 0x597899c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_colorType, addr 0x5978da0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorType get_colorType();

  /// @brief Method get_saberInteractionParam, addr 0x5978da8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_saberInteractionParam();

  /// @brief Method remove_allSliderWereRemovedFromActiveSlidersEvent, addr 0x5978cc8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_sliderWasAddedToActiveSlidersEvent, addr 0x5978c08, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_saberInteractionParam, addr 0x5978db0, size 0x8, virtual false, abstract: false, final false
