...
public:
  ...
  /// @brief Method .ctor, addr 0x264a1e4, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Awake, addr 0x2649768, size 0x160, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBigWasCutBySaber, addr 0x2649c08, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCut, addr 0x2649c20, size 0x4b4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSmallWasCutBySaber, addr 0x264a0d4, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method HiddenStateDidChange, addr 0x264a1ac, size 0x24, virtual true, abstract: false, final false
  inline void HiddenStateDidChange(bool hide);

  /// @brief Method Init, addr 0x26494b0, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method NoteDidPassMissedMarker, addr 0x2649a94, size 0xbc, virtual true, abstract: false, final false
  inline void NoteDidPassMissedMarker();

  /// @brief Method NoteDidStartDissolving, addr 0x2649b50, size 0xb8, virtual true, abstract: false, final false
  inline void NoteDidStartDissolving();

  /// @brief Method NoteDidStartJump, addr 0x264a0ec, size 0xc0, virtual true, abstract: false, final false
  inline void NoteDidStartJump();

  /// @brief Method OnDestroy, addr 0x26498c8, size 0x1cc, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x264a1d0, size 0x10, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x264a1e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x2649338, size 0xb0, virtual true, abstract: false, final true
  inline void add_cubeNoteControllerDidInitEvent(::System::Action_1<::UnityW<::GlobalNamespace::GameNoteController>>* value);

  /// @brief Method get_gameplayType, addr 0x26494a8, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__NoteData__GameplayType get_gameplayType();

  /// @brief Method get_noteMovement, addr 0x2649498, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x26494a0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x26493e8, size 0xb0, virtual true, abstract: false, final true
