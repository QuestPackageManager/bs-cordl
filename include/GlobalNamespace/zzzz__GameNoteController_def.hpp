...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameNoteController*);
MARK_REF_T(::GlobalNamespace::GameNoteController_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameNoteController*, "", "GameNoteController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameNoteController_Pool*, "", "GameNoteController/Pool");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58d26e8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameNoteController_Pool", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameNoteController_Pool(GameNoteController_Pool&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameNoteController_Pool", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameNoteController_Pool(GameNoteController_Poolconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GameNoteController_Pool) == 0x40, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BoxCuttableBySaber, NoteController, NoteData::GameplayType, NoteVisualModifierType
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__bigCuttableBySaberList, put = __cordl_internal_set__bigCuttableBySaberList)) ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>
  ...
  __declspec(property(get = __cordl_internal_get__smallCuttableBySaberList, put = __cordl_internal_set__smallCuttableBySaberList)) ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>
  ...
  /// @brief Method Awake, addr 0x58d1bf8, size 0x158, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleBigWasCutBySaber, addr 0x58d2088, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleCut, addr 0x58d20a0, size 0x548, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleSmallWasCutBySaber, addr 0x58d25e8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method HiddenStateDidChange, addr 0x58d26b4, size 0x20, virtual true, abstract: false, final false
  inline void HiddenStateDidChange(bool hide);

  /// @brief Method Init, addr 0x58d1a04, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method NoteDidPassMissedMarker, addr 0x58d1f2c, size 0xb0, virtual true, abstract: false, final false
  inline void NoteDidPassMissedMarker();

  /// @brief Method NoteDidStartDissolving, addr 0x58d1fdc, size 0xac, virtual true, abstract: false, final false
  inline void NoteDidStartDissolving();

  /// @brief Method NoteDidStartJump, addr 0x58d2600, size 0xb4, virtual true, abstract: false, final false
  inline void NoteDidStartJump();

  /// @brief Method OnDestroy, addr 0x58d1d50, size 0x1dc, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Pause, addr 0x58d26d4, size 0x10, virtual true, abstract: false, final false
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>> const& __cordl_internal_get__bigCuttableBySaberList() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>& __cordl_internal_get__bigCuttableBySaberList();
  ...
  constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>> const& __cordl_internal_get__smallCuttableBySaberList() const;

  constexpr ::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>>& __cordl_internal_get__smallCuttableBySaberList();
  ...
  constexpr void __cordl_internal_set__bigCuttableBySaberList(::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>> value);
  ...
  constexpr void __cordl_internal_set__smallCuttableBySaberList(::ArrayW<::UnityW<::GlobalNamespace::BoxCuttableBySaber>> value);
  ...
  /// @brief Method .ctor, addr 0x58d26e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// [CompilerGenerated]
  /// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x58d186c, size 0xc0, virtual true, abstract: false, final true
  inline void add_cubeNoteControllerDidInitEvent(::System::Action_1<::UnityW<::GlobalNamespace::GameNoteController>>* value);

  /// @brief Method get_gameplayType, addr 0x58d19fc, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::NoteData_GameplayType get_gameplayType();

  /// @brief Method get_noteMovement, addr 0x58d19ec, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x58d19f4, size 0x8, virtual true, abstract: false, final true
  ...
  /// [CompilerGenerated]
  /// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x58d192c, size 0xc0, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameNoteController", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameNoteController(GameNoteController&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameNoteController", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameNoteController(GameNoteControllerconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GameNoteController) == 0xc0, "Size mismatch!");
