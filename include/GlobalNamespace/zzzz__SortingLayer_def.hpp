...
public:
  ...
  /// @brief Method Reset, addr 0x39d3150, size 0x50, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x39d31a0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x39d3148, size 0x8, virtual false, abstract: false, final false
