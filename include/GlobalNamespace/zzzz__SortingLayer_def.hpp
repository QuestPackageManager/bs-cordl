...
public:
  ...
  /// @brief Method Reset, addr 0x2505704, size 0x50, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x2505754, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x25056fc, size 0x8, virtual false, abstract: false, final false
