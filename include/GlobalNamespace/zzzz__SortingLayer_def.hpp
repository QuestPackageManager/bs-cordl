...
/// @brief Method Reset, addr 0x56a44f8, size 0x54, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x56a454c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_renderer, addr 0x56a44f0, size 0x8, virtual false, abstract: false, final false
