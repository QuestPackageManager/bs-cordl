...
public:
  ...
  /// @brief Method Reset, addr 0x39bffe8, size 0x50, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x39c0038, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_renderer, addr 0x39bffe0, size 0x8, virtual false, abstract: false, final false
