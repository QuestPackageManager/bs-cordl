...
/// @brief Method <.ctor>b__16_0, addr 0x3648948, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* __ctor_b__16_0(::GlobalNamespace::ColorSchemeSO*  csSO) ;

/// @brief Method .ctor, addr 0x3648944, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field <colorOverrideType>k__BackingField, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__colorOverrideType_k__BackingField, put=__cordl_internal_set__colorOverrideType_k__BackingField)) ::GlobalNamespace::ColorSchemesSettings_ColorOverrideType  _colorOverrideType_k__BackingField;
...
/// @brief Method GetColorSchemeForId, addr 0x364862c, size 0x64, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetColorSchemeForId(::StringW  id) ;

/// @brief Method GetColorSchemeForIdx, addr 0x36485c8, size 0x64, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetColorSchemeForIdx(int32_t  idx) ;

/// @brief Method GetNumberOfColorSchemes, addr 0x3648578, size 0x50, virtual false, abstract: false, final false
inline int32_t GetNumberOfColorSchemes() ;

/// @brief Method GetOverrideColorScheme, addr 0x36488bc, size 0x14, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetOverrideColorScheme() ;

/// @brief Method GetSelectedColorScheme, addr 0x36487bc, size 0x58, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorScheme* GetSelectedColorScheme() ;

/// @brief Method GetSelectedColorSchemeIdx, addr 0x3648814, size 0xa8, virtual false, abstract: false, final false
...
/// @brief Method SetColorSchemeForId, addr 0x3648690, size 0x12c, virtual false, abstract: false, final false
inline void SetColorSchemeForId(::GlobalNamespace::ColorScheme*  colorScheme) ;

/// @brief Method ShouldOverrideLightshowColors, addr 0x36488d0, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3648468, size 0x110, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::UnityW<::GlobalNamespace::ColorSchemeSO>>*  colorSchemeSOs) ;

/// @brief Method .ctor, addr 0x364821c, size 0x24c, virtual false, abstract: false, final false
inline void _ctor(::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::ColorScheme*>*  colorSchemes) ;

/// @brief Method get_colorOverrideType, addr 0x364820c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::ColorSchemesSettings_ColorOverrideType get_colorOverrideType() ;

/// @brief Method get_overrideDefaultColors, addr 0x36481ec, size 0x8, virtual false, abstract: false, final false
inline bool get_overrideDefaultColors() ;

/// @brief Method get_selectedColorSchemeId, addr 0x3648204, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_selectedColorSchemeId() ;

/// @brief Method set_colorOverrideType, addr 0x3648214, size 0x8, virtual false, abstract: false, final false
inline void set_colorOverrideType(::GlobalNamespace::ColorSchemesSettings_ColorOverrideType  value) ;

/// @brief Method set_overrideDefaultColors, addr 0x36481f4, size 0x8, virtual false, abstract: false, final false
inline void set_overrideDefaultColors(bool  value) ;

/// @brief Method set_selectedColorSchemeId, addr 0x36481fc, size 0x8, virtual false, abstract: false, final false
