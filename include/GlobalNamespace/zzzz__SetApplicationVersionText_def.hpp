...
public:
  ...
  /// @brief Method Start, addr 0x2380be0, size 0x48, virtual false, abstract: false, final false
  inline void Start();

  static inline ::GlobalNamespace::SetApplicationVersionText* New_ctor();

  /// @brief Method .ctor, addr 0x2380c28, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
