...
public:
  ...
  /// @brief Method Start, addr 0x24b7484, size 0x48, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x24b74cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
