...
public:
  ...
  /// @brief Method MoveNext, addr 0x3ba527c, size 0x2d4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x3ba5550, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method SetText, addr 0x3ba4f38, size 0x324, virtual false, abstract: false, final false
  inline void SetText(::BeatSaber::Init::GameVersion* gameVersion);

  /// @brief Method Start, addr 0x3ba4ea8, size 0x90, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ba525c, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
