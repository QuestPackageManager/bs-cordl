...
/// @brief Method SetText, addr 0x57ffc80, size 0x300, virtual false, abstract: false, final false
inline void SetText(::BeatSaber::Init::GameVersion*  gameVersion) ;

/// @brief Method Start, addr 0x57ffb6c, size 0x114, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method ToggleVersionColor, addr 0x57fff80, size 0x94, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5800014, size 0x1c, virtual false, abstract: false, final false
inline void _ctor() ;
