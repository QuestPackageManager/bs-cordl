...
public:
  ...
  /// @brief Method .ctor, addr 0x44e716c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_easeDuration, addr 0x44e7164, size 0x8, virtual false, abstract: false, final false
  inline float_t get_easeDuration();

  /// @brief Method get_easeType, addr 0x44e715c, size 0x8, virtual false, abstract: false, final false
