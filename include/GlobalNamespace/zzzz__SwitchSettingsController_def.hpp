...
public:
  ...
  /// @brief Method Awake, addr 0x3c2d098, size 0xa4, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method HandleToggleValueDidChange, addr 0x3c2d240, size 0x10, virtual false, abstract: false, final false
  inline void HandleToggleValueDidChange(bool value);

  static inline ::GlobalNamespace::SwitchSettingsController* New_ctor();

  /// @brief Method OnDestroy, addr 0x3c2d13c, size 0xa4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x3c2d1e0, size 0x3c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method RefreshUI, addr 0x3c2d21c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c2d250, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
