...
public:
  // Declarations
  /// @brief Method ToAuthenticationTokenPlatform, addr 0x2ad3de0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUserInfoPlatform, addr 0x2ad3e08, size 0x2c, virtual false, abstract: false, final false
