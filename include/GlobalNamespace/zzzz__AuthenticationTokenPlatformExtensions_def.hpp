...
public:
  // Declarations
  /// @brief Method ToAuthenticationTokenPlatform, addr 0x4079bc0, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUserInfoPlatform, addr 0x4079be8, size 0x2c, virtual false, abstract: false, final false
