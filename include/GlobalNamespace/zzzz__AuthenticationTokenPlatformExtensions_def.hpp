...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AuthenticationTokenPlatformExtensions", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AuthenticationTokenPlatformExtensions(AuthenticationTokenPlatformExtensions&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AuthenticationTokenPlatformExtensions", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AuthenticationTokenPlatformExtensions(AuthenticationTokenPlatformExtensionsconst&) = delete;
