...
public:
  // Declarations
  /// @brief Method ToAuthenticationTokenPlatform, addr 0x407eb34, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method ToUserInfoPlatform, addr 0x407eb5c, size 0x2c, virtual false, abstract: false, final false
