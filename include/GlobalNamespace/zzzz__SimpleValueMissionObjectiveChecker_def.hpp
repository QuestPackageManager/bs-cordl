...
public:
  // Declarations
  /// @brief Method CheckAndUpdateStatus, addr 0x27030f0, size 0x104, virtual false, abstract: false, final false
  inline void CheckAndUpdateStatus();

  static inline ::GlobalNamespace::SimpleValueMissionObjectiveChecker* New_ctor();

  /// @brief Method .ctor, addr 0x27031fc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
