...
public:
  // Declarations
  /// @brief Method ApplyGraphicSettings, addr 0x3b297ac, size 0x2a4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b29c44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
