...
public:
  // Declarations
  /// @brief Method ApplyGraphicSettings, addr 0x57ddb7c, size 0x358, virtual true, abstract: false, final false
  ...
  /// @brief Method <ApplyGraphicSettings>g__ConvertProcessorPerformanceLevel|0_0, addr 0x57de1c4, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57de1e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
