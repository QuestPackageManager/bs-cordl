...
public:
  ...
  /// @brief Method <OnBehaviourPlay>b__21_0, addr 0x3b42cf8, size 0x8, virtual false, abstract: false, final false
  inline float_t _OnBehaviourPlay_b__21_0(int32_t i);

  /// @brief Method .ctor, addr 0x3b42cf0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnBehaviourPlay, addr 0x3b42a98, size 0x1e4, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnGraphStart, addr 0x3b42470, size 0x13c, virtual true, abstract: false, final false
  inline void OnGraphStart(::UnityEngine::Playables::Playable playable);

  /// @brief Method OnPlayableDestroy, addr 0x3b42994, size 0x104, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x3b425ac, size 0x3e8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b42c7c, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
