...
public:
  ...
  /// @brief Method <OnBehaviourPlay>b__21_0, addr 0x57e48bc, size 0x28, virtual false, abstract: false, final false
  inline float_t _OnBehaviourPlay_b__21_0(int32_t i);

  /// @brief Method .ctor, addr 0x57e48b8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method OnBehaviourPlay, addr 0x57e4634, size 0x21c, virtual true, abstract: false, final false
  inline void OnBehaviourPlay(::UnityEngine::Playables::Playable playable, ::UnityEngine::Playables::FrameData info);

  /// @brief Method OnGraphStart, addr 0x57e4010, size 0x13c, virtual true, abstract: false, final false
  inline void OnGraphStart(::UnityEngine::Playables::Playable playable);

  /// @brief Method OnPlayableDestroy, addr 0x57e452c, size 0x108, virtual true, abstract: false, final false
  inline void OnPlayableDestroy(::UnityEngine::Playables::Playable playable);

  /// @brief Method ProcessFrame, addr 0x57e414c, size 0x3e0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e4850, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
