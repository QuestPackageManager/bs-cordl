...
public:
  ...
  /// @brief Method DetailsToggleValueChanged, addr 0x5875e70, size 0x1c, virtual false, abstract: false, final false
  inline void DetailsToggleValueChanged(bool isOn);

  /// @brief Method DisconnectButtonPressed, addr 0x5875e3c, size 0x34, virtual false, abstract: false, final false
  inline void DisconnectButtonPressed();

  /// @brief Method HandleDisconnectPromptViewDidViewFinish, addr 0x5875e8c, size 0xd4, virtual false, abstract: false, final false
  inline void HandleDisconnectPromptViewDidViewFinish(bool disconnect);

  /// @brief Method HandleStateChanged, addr 0x5875f60, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5875cdc, size 0x160, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x5875a58, size 0xe8, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5875898, size 0x1c0, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x5875b40, size 0x19c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method <HandleDisconnectPromptViewDidViewFinish>b__22_0, addr 0x5876264, size 0x1c, virtual false, abstract: false, final false
  inline void _HandleDisconnectPromptViewDidViewFinish_b__22_0();

  /// @brief Method <HandleStateChanged>b__23_0, addr 0x5876280, size 0x18, virtual false, abstract: false, final false
  inline void _HandleStateChanged_b__23_0(float_t val);

  /// @brief Method <HandleStateChanged>b__23_1, addr 0x5876298, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58761d4, size 0x90, virtual false, abstract: false, final false
  inline void _ctor();
