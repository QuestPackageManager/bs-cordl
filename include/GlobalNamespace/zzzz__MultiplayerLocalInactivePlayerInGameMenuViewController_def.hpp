...
public:
  ...
  /// @brief Method DetailsToggleValueChanged, addr 0x2711654, size 0x20, virtual false, abstract: false, final false
  inline void DetailsToggleValueChanged(bool isOn);

  /// @brief Method DisconnectButtonPressed, addr 0x2711620, size 0x34, virtual false, abstract: false, final false
  inline void DisconnectButtonPressed();

  /// @brief Method HandleDisconnectPromptViewDidViewFinish, addr 0x2711674, size 0xc4, virtual false, abstract: false, final false
  inline void HandleDisconnectPromptViewDidViewFinish(bool disconnect);

  /// @brief Method HandleStateChanged, addr 0x2711738, size 0x1c8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x27114f4, size 0x12c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x27112d4, size 0xac, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x2711184, size 0x150, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Start, addr 0x2711380, size 0x174, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method <HandleDisconnectPromptViewDidViewFinish>b__22_0, addr 0x2711998, size 0x20, virtual false, abstract: false, final false
  inline void _HandleDisconnectPromptViewDidViewFinish_b__22_0();

  /// @brief Method <HandleStateChanged>b__23_0, addr 0x27119b8, size 0x1c, virtual false, abstract: false, final false
  inline void _HandleStateChanged_b__23_0(float_t val);

  /// @brief Method <HandleStateChanged>b__23_1, addr 0x27119d4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2711900, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
