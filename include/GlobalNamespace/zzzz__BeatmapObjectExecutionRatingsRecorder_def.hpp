...
public:
  ...
  /// @brief Method HandleObstacleDidPassAvoidedMark, addr 0x578930c, size 0x16c, virtual false, abstract: false, final false
  inline void HandleObstacleDidPassAvoidedMark(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandlePlayerHeadDidEnterObstacle, addr 0x57891d8, size 0x134, virtual false, abstract: false, final false
  inline void HandlePlayerHeadDidEnterObstacle(::GlobalNamespace::ObstacleController* obstacleController);

  /// @brief Method HandleScoringForNoteDidFinish, addr 0x5788dec, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5788b30, size 0x1fc, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x57888c4, size 0x1ac, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5789478, size 0xc4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_beatmapObjectExecutionRatings, addr 0x57888bc, size 0x8, virtual false, abstract: false, final false
