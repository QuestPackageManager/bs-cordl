...
/// @brief Method .ctor, addr 0x58463b8, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _propertyTintColorPairs, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__propertyTintColorPairs, put=__cordl_internal_set__propertyTintColorPairs)) ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>*>  _propertyTintColorPairs;
...
/// @brief Method SetColors, addr 0x58461d8, size 0x158, virtual false, abstract: false, final false
inline void SetColors() ;

/// @brief Method Start, addr 0x5846330, size 0x84, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>*> const& __cordl_internal_get__propertyTintColorPairs() const;

constexpr ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>*>& __cordl_internal_get__propertyTintColorPairs() ;
...
constexpr void __cordl_internal_set__propertyTintColorPairs(::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>*>  value) ;
...
/// @brief Method .ctor, addr 0x58463b4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method set_saberType, addr 0x5845c78, size 0xc, virtual false, abstract: false, final false
