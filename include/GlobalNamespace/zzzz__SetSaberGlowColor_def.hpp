...
public:
  ...
  /// @brief Method .ctor, addr 0x58b89a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method SetColors, addr 0x58b87c0, size 0x158, virtual false, abstract: false, final false
  inline void SetColors();

  /// @brief Method Start, addr 0x58b8918, size 0x84, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58b899c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_saberType, addr 0x58b8260, size 0xc, virtual false, abstract: false, final false
