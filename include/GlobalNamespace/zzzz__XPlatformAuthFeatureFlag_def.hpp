...
public:
  ...
  /// @brief Method .ctor, addr 0x22ed2cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_UseXPlatformAuth, addr 0x22ed2b8, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseXPlatformAuth();

  /// @brief Method set_UseXPlatformAuth, addr 0x22ed2c0, size 0xc, virtual false, abstract: false, final false
