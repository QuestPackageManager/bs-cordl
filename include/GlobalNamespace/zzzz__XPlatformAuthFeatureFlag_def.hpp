...
public:
  ...
  /// @brief Method get_UseXPlatformAuth addr 0xdd7dec size 0x8 virtual false final false
  inline bool get_UseXPlatformAuth();

  /// @brief Method set_UseXPlatformAuth addr 0xdd7df4 size 0xc virtual false final false
  inline void set_UseXPlatformAuth(bool value);

  static inline ::GlobalNamespace::XPlatformAuthFeatureFlag* New_ctor();

  /// @brief Method .ctor addr 0xdd7e00 size 0x8 virtual false final false
  inline void _ctor();
