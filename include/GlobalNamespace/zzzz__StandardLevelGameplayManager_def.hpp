...
MARK_REF_T(::GlobalNamespace::StandardLevelGameplayManager*);
MARK_REF_T(::GlobalNamespace::StandardLevelGameplayManager_InitData*);
MARK_REF_T(::GlobalNamespace::StandardLevelGameplayManager__Start_d__27*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardLevelGameplayManager_GameState, "", "StandardLevelGameplayManager/GameState");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardLevelGameplayManager*, "", "StandardLevelGameplayManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardLevelGameplayManager_InitData*, "", "StandardLevelGameplayManager/InitData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StandardLevelGameplayManager__Start_d__27*, "", "StandardLevelGameplayManager/<Start>d__27");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59a4278, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::StandardLevelGameplayManager_InitData) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59a4284, size 0x770, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::StandardLevelGameplayManager__Start_d__27* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x59a4cb8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x59a4cc0, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x59a4cf8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x59a4280, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x59a38ec, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Awake, addr 0x59a3890, size 0x8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleGameEnergyDidReach0, addr 0x59a4100, size 0x50, virtual false, abstract: false, final false
  inline void HandleGameEnergyDidReach0();

  /// @brief Method HandlePauseControllerCanPause, addr 0x59a4184, size 0x38, virtual false, abstract: false, final false
  inline void HandlePauseControllerCanPause(::System::Action_1<bool>* canPause);

  /// @brief Method HandlePauseControllerDidPause, addr 0x59a41bc, size 0x1c, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidPause();

  /// @brief Method HandlePauseControllerDidResume, addr 0x59a41f0, size 0x18, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidResume();

  /// @brief Method HandlePauseControllerDidStartResume, addr 0x59a41d8, size 0x18, virtual false, abstract: false, final false
  inline void HandlePauseControllerDidStartResume();

  /// @brief Method HandleSongDidFinish, addr 0x59a4150, size 0x34, virtual false, abstract: false, final false
  inline void HandleSongDidFinish();

  static inline ::GlobalNamespace::StandardLevelGameplayManager* New_ctor();

  /// @brief Method OnDestroy, addr 0x59a38f4, size 0x3b8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x59a3898, size 0x54, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Start();

  /// @brief Method Update, addr 0x59a3f70, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x59a4208, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_levelDidStartEvent, addr 0x59a3480, size 0xac, virtual true, abstract: false, final true
  inline void add_levelDidStartEvent(::System::Action* value);

  /// @brief Method add_levelFailedEvent, addr 0x59a3730, size 0xac, virtual true, abstract: false, final true
  inline void add_levelFailedEvent(::System::Action* value);

  /// @brief Method add_levelFinishedEvent, addr 0x59a35d8, size 0xac, virtual true, abstract: false, final true
  ...
  /// @brief Method get_levelEndStateType, addr 0x59a3888, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_levelDidStartEvent, addr 0x59a352c, size 0xac, virtual true, abstract: false, final true
  inline void remove_levelDidStartEvent(::System::Action* value);

  /// @brief Method remove_levelFailedEvent, addr 0x59a37dc, size 0xac, virtual true, abstract: false, final true
  inline void remove_levelFailedEvent(::System::Action* value);

  /// @brief Method remove_levelFinishedEvent, addr 0x59a3684, size 0xac, virtual true, abstract: false, final true
...
static_assert(sizeof(::GlobalNamespace::StandardLevelGameplayManager) == 0x90, "Size mismatch!");
