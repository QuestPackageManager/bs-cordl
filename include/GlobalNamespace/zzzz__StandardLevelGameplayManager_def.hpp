...
public:
  ...
  /// @brief Method .ctor addr 0x23bd840 size 0x28 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x23bd384 size 0x28 virtual false final false
  inline void _ctor(int32_t __1__state);

  /// @brief Method System.IDisposable.Dispose addr 0x23bd868 size 0x4 virtual true final true
  inline void System_IDisposable_Dispose();

  /// @brief Method MoveNext addr 0x23bd86c size 0x374 virtual true final true
  inline bool MoveNext();

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x23bdbe0 size 0x8 virtual true final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x23bdbe8 size 0x40 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x23bdc28 size 0x8 virtual true final true
...
public:
  ...
  /// @brief Method add_levelWillStartIntroEvent addr 0x23bce34 size 0x9c virtual true final true
  inline void add_levelWillStartIntroEvent(::System::Action* value);

  /// @brief Method remove_levelWillStartIntroEvent addr 0x23bced0 size 0x9c virtual true final true
  inline void remove_levelWillStartIntroEvent(::System::Action* value);

  /// @brief Method add_levelDidStartEvent addr 0x23bcf6c size 0x9c virtual true final true
  inline void add_levelDidStartEvent(::System::Action* value);

  /// @brief Method remove_levelDidStartEvent addr 0x23bd008 size 0x9c virtual true final true
  inline void remove_levelDidStartEvent(::System::Action* value);

  /// @brief Method add_levelFailedEvent addr 0x23bd0a4 size 0x9c virtual true final true
  inline void add_levelFailedEvent(::System::Action* value);

  /// @brief Method remove_levelFailedEvent addr 0x23bd140 size 0x9c virtual true final true
  inline void remove_levelFailedEvent(::System::Action* value);

  /// @brief Method add_levelFinishedEvent addr 0x23bd1dc size 0x9c virtual true final true
  inline void add_levelFinishedEvent(::System::Action* value);

  /// @brief Method remove_levelFinishedEvent addr 0x23bd278 size 0x9c virtual true final true
  inline void remove_levelFinishedEvent(::System::Action* value);

  /// @brief Method Awake addr 0x23bd314 size 0x8 virtual false final false
  inline void Awake();

  /// @brief Method Start addr 0x23bd31c size 0x68 virtual false final false
  inline ::System::Collections::IEnumerator* Start();

  /// @brief Method OnDestroy addr 0x23bd3ac size 0x268 virtual false final false
  inline void OnDestroy();

  /// @brief Method Update addr 0x23bd614 size 0x34 virtual false final false
  inline void Update();

  /// @brief Method HandleGameEnergyDidReach0 addr 0x23bd75c size 0x54 virtual false final false
  inline void HandleGameEnergyDidReach0();

  /// @brief Method HandleSongDidFinish addr 0x23bd7b0 size 0x34 virtual false final false
  inline void HandleSongDidFinish();

  /// @brief Method HandlePauseControllerCanPause addr 0x23bd7e4 size 0x24 virtual false final false
  inline void HandlePauseControllerCanPause(::System::Action_1<bool>* canPause);

  /// @brief Method HandlePauseControllerDidPause addr 0x23bd808 size 0x18 virtual false final false
  inline void HandlePauseControllerDidPause();

  /// @brief Method HandlePauseControllerDidResume addr 0x23bd820 size 0x18 virtual false final false
  inline void HandlePauseControllerDidResume();

  static inline ::GlobalNamespace::StandardLevelGameplayManager* New_ctor();

  /// @brief Method .ctor addr 0x23bd838 size 0x8 virtual false final false
  inline void _ctor();
