...
// Write type traits
MARK_REF_T(::GlobalNamespace::RankModelHelper*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RankModelHelper*, "", "RankModelHelper");
...
public:
  // Declarations
  /// @brief Method MaxRankForGameplayModifiers, addr 0x3753644, size 0xfc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RankModelHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RankModelHelper(RankModelHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RankModelHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RankModelHelper(RankModelHelperconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::RankModelHelper) == 0x10, "Size mismatch!");
