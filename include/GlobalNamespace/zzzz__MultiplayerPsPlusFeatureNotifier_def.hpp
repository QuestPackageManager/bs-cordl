...
public:
  ...
  /// @brief Method .ctor, addr 0x24ee790, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::MultiplayerPsPlusFeatureNotifier, ____isSpectator) == 0x18, "Offset mismatch!");
