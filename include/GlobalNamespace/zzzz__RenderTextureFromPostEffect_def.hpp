...
public:
  ...
  /// @brief Method Awake, addr 0x2ada804, size 0x50, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::RenderTextureFromPostEffect* New_ctor();

  /// @brief Method OnRenderImage, addr 0x2ada854, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2adaa4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_targetTexture, addr 0x2ada7fc, size 0x8, virtual false, abstract: false, final false
...
static_assert(offsetof(::GlobalNamespace::RenderTextureFromPostEffect, ____targetTexture) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::RenderTextureFromPostEffect, ____camera) == 0x20, "Offset mismatch!");
