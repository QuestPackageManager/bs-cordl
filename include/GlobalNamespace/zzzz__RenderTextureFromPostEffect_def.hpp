...
public:
  ...
  /// @brief Method Awake, addr 0x5d97c4c, size 0x54, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::RenderTextureFromPostEffect* New_ctor();

  /// @brief Method OnRenderImage, addr 0x5d97ca0, size 0x208, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d97ea8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_targetTexture, addr 0x5d97c44, size 0x8, virtual false, abstract: false, final false
