...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RenderTextureFromPostEffect", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RenderTextureFromPostEffect(RenderTextureFromPostEffect&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RenderTextureFromPostEffect", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RenderTextureFromPostEffect(RenderTextureFromPostEffectconst&) = delete;
