...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameServersFilter*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServersFilter*, "", "GameServersFilter");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5a10654, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameServersFilter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameServersFilter(GameServersFilter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameServersFilter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameServersFilter(GameServersFilterconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GameServersFilter) == 0x40, "Size mismatch!");
