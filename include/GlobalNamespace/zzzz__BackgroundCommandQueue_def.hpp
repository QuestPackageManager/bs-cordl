...
public:
  ...
  /// @brief Method MoveNext, addr 0xeb5e80, size 0x3e0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0xeb6260, size 0xc, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method Enqueue, addr 0xeb5b70, size 0x19c, virtual false, abstract: false, final false
  ...
  /// @brief Method RunInternal, addr 0xeb5d0c, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xeb5dd4, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
