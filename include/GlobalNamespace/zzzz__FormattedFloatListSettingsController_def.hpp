...
public:
  ...
  /// @brief Method ApplyValue, addr 0x586dc28, size 0x58, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x586dac4, size 0x164, virtual true, abstract: false, final false
  inline bool GetInitValues(::ByRef<int32_t> idx, ::ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::FormattedFloatListSettingsController* New_ctor();

  /// @brief Method SetValue, addr 0x586dab0, size 0x14, virtual false, abstract: false, final false
  inline void SetValue(float_t value, bool callCallback);

  /// @brief Method TextForValue, addr 0x586dc80, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586dd48, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x586d8e8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x586da68, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method get_values, addr 0x586da70, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_values();

  /// @brief Method remove_valueDidChangeEvent, addr 0x586d9a8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_values, addr 0x586da78, size 0x38, virtual false, abstract: false, final false
