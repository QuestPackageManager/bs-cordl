...
public:
  ...
  /// @brief Method ApplyValue, addr 0x5a0e040, size 0x58, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x5a0dedc, size 0x164, virtual true, abstract: false, final false
  ...
  /// @brief Method SetValue, addr 0x5a0dec8, size 0x14, virtual false, abstract: false, final false
  inline void SetValue(float_t value, bool callCallback);

  /// @brief Method TextForValue, addr 0x5a0e098, size 0xc8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0e160, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x5a0dd00, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x5a0de80, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method get_values, addr 0x5a0de88, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<float_t> get_values();

  /// @brief Method remove_valueDidChangeEvent, addr 0x5a0ddc0, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_values, addr 0x5a0de90, size 0x38, virtual false, abstract: false, final false
