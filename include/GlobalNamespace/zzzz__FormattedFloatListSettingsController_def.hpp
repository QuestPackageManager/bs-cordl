...
public:
  ...
  /// @brief Method ApplyValue, addr 0x3c0dd08, size 0x58, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x3c0dbbc, size 0x14c, virtual true, abstract: false, final false
  inline bool GetInitValues(::ByRef<int32_t> idx, ::ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::FormattedFloatListSettingsController* New_ctor();

  /// @brief Method SetValue, addr 0x3c0dba4, size 0x18, virtual false, abstract: false, final false
  inline void SetValue(float_t value, bool callCallback);

  /// @brief Method TextForValue, addr 0x3c0dd60, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c0de3c, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x3c0da24, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_value, addr 0x3c0db84, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method get_values, addr 0x3c0db8c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> get_values();

  /// @brief Method remove_valueDidChangeEvent, addr 0x3c0dad4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_values, addr 0x3c0db94, size 0x10, virtual false, abstract: false, final false
