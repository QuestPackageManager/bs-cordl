...
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8464)), TypeDefinitionIndex(TypeDefinitionIndex(10043))}
...
public:
  ...
  // name: "transcodedFormat", ty: "::UnityEngine::TextureFormat", modifiers: "", def_value: None }]
  constexpr OVRTextureData(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t width, int32_t height, ::GlobalNamespace::OVRTextureFormat format,
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::OVRTextureData, 0x18>, "Size mismatch!");
