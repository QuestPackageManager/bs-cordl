...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x400ac60, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x400ac6c, size 0xa0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRSceneLoader__DelayCanvasPosUpdate_d__24* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x400ad0c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x400ad14, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x400ad4c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x400ac68, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x400aa5c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x400ad58, size 0x348, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRSceneLoader__onCheckSceneCoroutine_d__25* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x400b0a0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x400b0a8, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x400b0e0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x400ad54, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x400aa84, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method Awake, addr 0x4009758, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DelayCanvasPosUpdate, addr 0x4009934, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DelayCanvasPosUpdate();

  /// @brief Method DestroyAllGameObjects, addr 0x400aaac, size 0x110, virtual false, abstract: false, final false
  inline void DestroyAllGameObjects();

  /// @brief Method GetSceneInfo, addr 0x4009994, size 0x284, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSceneLoader_SceneInfo GetSceneInfo();

  /// @brief Method LoadScene, addr 0x4009c18, size 0x8a4, virtual false, abstract: false, final false
  inline void LoadScene(::GlobalNamespace::OVRSceneLoader_SceneInfo sceneInfo);

  /// @brief Method LoadSceneOperation_completed, addr 0x400a4bc, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x40097c4, size 0x170, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x400a5f8, size 0x264, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCanvasPosition, addr 0x400a85c, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x400abbc, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method onCheckSceneCoroutine, addr 0x400a598, size 0x60, virtual false, abstract: false, final false
