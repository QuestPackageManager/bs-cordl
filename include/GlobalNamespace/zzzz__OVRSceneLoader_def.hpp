...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x400d8b8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x400d8c4, size 0xa0, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRSceneLoader__DelayCanvasPosUpdate_d__24* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x400d964, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x400d96c, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x400d9a4, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x400d8c0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x400d6b4, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method MoveNext, addr 0x400d9b0, size 0x348, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::OVRSceneLoader__onCheckSceneCoroutine_d__25* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x400dcf8, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x400dd00, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x400dd38, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x400d9ac, size 0x4, virtual true, abstract: false, final true
  inline void System_IDisposable_Dispose();
  ...
  /// @brief Method .ctor, addr 0x400d6dc, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t __1__state);
...
public:
  ...
  /// @brief Method Awake, addr 0x400c3b0, size 0x6c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DelayCanvasPosUpdate, addr 0x400c58c, size 0x60, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* DelayCanvasPosUpdate();

  /// @brief Method DestroyAllGameObjects, addr 0x400d704, size 0x110, virtual false, abstract: false, final false
  inline void DestroyAllGameObjects();

  /// @brief Method GetSceneInfo, addr 0x400c5ec, size 0x284, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRSceneLoader_SceneInfo GetSceneInfo();

  /// @brief Method LoadScene, addr 0x400c870, size 0x8a4, virtual false, abstract: false, final false
  inline void LoadScene(::GlobalNamespace::OVRSceneLoader_SceneInfo sceneInfo);

  /// @brief Method LoadSceneOperation_completed, addr 0x400d114, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x400c41c, size 0x170, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x400d250, size 0x264, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method UpdateCanvasPosition, addr 0x400d4b4, size 0x200, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x400d814, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method onCheckSceneCoroutine, addr 0x400d1f0, size 0x60, virtual false, abstract: false, final false
