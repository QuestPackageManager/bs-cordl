...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x24422c8, size 0x30, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24422f8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x24422a8, size 0x20, virtual false, abstract: false, final false
