...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x5864aac, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5864ad4, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_color, addr 0x5864a90, size 0x1c, virtual false, abstract: false, final false
