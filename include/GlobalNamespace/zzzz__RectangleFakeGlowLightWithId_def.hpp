...
/// @brief Method ColorWasSet, addr 0x57f2bb4, size 0x28, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57f2bdc, size 0x14, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_color, addr 0x57f2b98, size 0x1c, virtual false, abstract: false, final false
