...
public:
  ...
  /// @brief Method .ctor, addr 0x58540a4, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AfterPlayerSendFrameStarted", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AfterPlayerSendFrameStarted(AfterPlayerSendFrameStarted&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AfterPlayerSendFrameStarted", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AfterPlayerSendFrameStarted(AfterPlayerSendFrameStartedconst&) = delete;
