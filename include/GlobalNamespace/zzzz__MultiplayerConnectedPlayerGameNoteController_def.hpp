...
public:
  ...
  /// @brief Method .ctor, addr 0x3bbb6f0, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
// Dependencies ICubeNoteControllerInitializable`1<T>, INoteMovementProvider, INoteVisualModifierTypeProvider, MultiplayerConnectedPlayerNoteController, NoteData::GameplayType, NoteVisualModifierType
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  /// @brief Method Init, addr 0x3bb79cc, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bbb6e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x3bbb570, size 0xb0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_gameplayType, addr 0x3bbb6d8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_GameplayType get_gameplayType();

  /// @brief Method get_noteMovement, addr 0x3bbb6d0, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x3bbb6e0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x3bbb620, size 0xb0, virtual true, abstract: false, final true
