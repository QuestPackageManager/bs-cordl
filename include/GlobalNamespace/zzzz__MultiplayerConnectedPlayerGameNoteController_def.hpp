...
public:
  ...
  /// @brief Method .ctor, addr 0x5885050, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x5881144, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5885048, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_cubeNoteControllerDidInitEvent, addr 0x5884eb0, size 0xc0, virtual true, abstract: false, final true
  ...
  /// @brief Method get_gameplayType, addr 0x5885038, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteData_GameplayType get_gameplayType();

  /// @brief Method get_noteMovement, addr 0x5885030, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::GlobalNamespace::NoteMovement> get_noteMovement();

  /// @brief Method get_noteVisualModifierType, addr 0x5885040, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_cubeNoteControllerDidInitEvent, addr 0x5884f70, size 0xc0, virtual true, abstract: false, final true
