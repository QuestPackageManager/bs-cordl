...
public:
  ...
  /// @brief Method RecordRenderGraph, addr 0x5f52cdc, size 0x88, virtual true, abstract: false, final false
  inline void RecordRenderGraph(::UnityEngine::Rendering::RenderGraphModule::RenderGraph* renderGraph, ::UnityEngine::Rendering::ContextContainer* frameData);

  /// @brief Method .ctor, addr 0x5f52c18, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "XRRenderScaleRenderPass", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  XRRenderScaleRenderPass(XRRenderScaleRenderPass&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "XRRenderScaleRenderPass", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  XRRenderScaleRenderPass(XRRenderScaleRenderPassconst&) = delete;
