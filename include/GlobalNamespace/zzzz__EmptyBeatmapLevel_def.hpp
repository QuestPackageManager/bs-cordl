...
public:
  ...
  /// @brief Method get_levelID addr 0x2347bdc size 0x8 virtual true final true
  inline ::StringW get_levelID();

  /// @brief Method get_songName addr 0x2347be4 size 0x8 virtual true final true
  inline ::StringW get_songName();

  /// @brief Method get_songSubName addr 0x2347bec size 0x8 virtual true final true
  inline ::StringW get_songSubName();

  /// @brief Method get_songAuthorName addr 0x2347bf4 size 0x8 virtual true final true
  inline ::StringW get_songAuthorName();

  /// @brief Method get_levelAuthorName addr 0x2347bfc size 0x8 virtual true final true
  inline ::StringW get_levelAuthorName();

  /// @brief Method get_beatsPerMinute addr 0x2347c04 size 0x8 virtual true final true
  inline float_t get_beatsPerMinute();

  /// @brief Method get_songTimeOffset addr 0x2347c0c size 0x8 virtual true final true
  inline float_t get_songTimeOffset();

  /// @brief Method get_shuffle addr 0x2347c14 size 0x8 virtual true final true
  inline float_t get_shuffle();

  /// @brief Method get_shufflePeriod addr 0x2347c1c size 0x8 virtual true final true
  inline float_t get_shufflePeriod();

  /// @brief Method get_previewStartTime addr 0x2347c24 size 0x8 virtual true final true
  inline float_t get_previewStartTime();

  /// @brief Method get_previewDuration addr 0x2347c2c size 0x8 virtual true final true
  inline float_t get_previewDuration();

  /// @brief Method get_songDuration addr 0x2347c34 size 0x8 virtual true final true
  inline float_t get_songDuration();

  /// @brief Method get_environmentInfo addr 0x2347c3c size 0x8 virtual true final true
  inline ::GlobalNamespace::EnvironmentInfoSO* get_environmentInfo();

  /// @brief Method get_allDirectionsEnvironmentInfo addr 0x2347c44 size 0x8 virtual true final true
  inline ::GlobalNamespace::EnvironmentInfoSO* get_allDirectionsEnvironmentInfo();

  /// @brief Method get_environmentInfos addr 0x2347c4c size 0x7c virtual true final true
  inline ::ArrayW<::GlobalNamespace::EnvironmentInfoSO*, ::Array<::GlobalNamespace::EnvironmentInfoSO*>*> get_environmentInfos();

  /// @brief Method get_previewDifficultyBeatmapSets addr 0x2347cc8 size 0x8 virtual true final true
  ...
  /// @brief Method get_contentRating addr 0x2347cd0 size 0x8 virtual true final true
  inline ::GlobalNamespace::PlayerSensitivityFlag get_contentRating();

  /// @brief Method GetPreviewAudioClipAsync addr 0x2347cd8 size 0x40 virtual false final false
  ...
  /// @brief Method GetCoverImageAsync addr 0x2347d18 size 0x40 virtual true final true
  ...
  /// @brief Method get_beatmapLevelData addr 0x2347d58 size 0x8 virtual true final true
  inline ::GlobalNamespace::IBeatmapLevelData* get_beatmapLevelData();

  static inline ::GlobalNamespace::EmptyBeatmapLevel* New_ctor();

  /// @brief Method .ctor addr 0x2347d60 size 0x6c virtual false final false
  inline void _ctor();
