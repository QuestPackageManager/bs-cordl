...
public:
  ...
  /// @brief Method LazyInitializeMaterials, addr 0x4083700, size 0x124, virtual false, abstract: false, final false
  inline void LazyInitializeMaterials();

  static inline ::GlobalNamespace::PyramidBloomMainEffectSO* New_ctor();

  /// @brief Method OnDisable, addr 0x4083824, size 0x30, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x40836e4, size 0x1c, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PreRender, addr 0x4083854, size 0x64, virtual true, abstract: false, final false
  inline void PreRender();

  /// @brief Method Render, addr 0x40838b8, size 0x27c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4083b34, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_hasPostProcessEffect, addr 0x40836dc, size 0x8, virtual true, abstract: false, final false
