...
// Write type traits
MARK_REF_T(::GlobalNamespace::PyramidBloomMainEffectSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PyramidBloomMainEffectSO*, "", "PyramidBloomMainEffectSO");
...
public:
  ...
  __declspec(property(get = get_bloomTextureWidth)) int32_t bloomTextureWidth;

  __declspec(property(get = get_hasPostProcessEffect)) bool hasPostProcessEffect;

  /// @brief Method BindAndFetchTempTextureHandles, addr 0x5f4645c, size 0x58, virtual true, abstract: false, final false
  ...
  /// @brief Method LazyInitializeMaterials, addr 0x5f461ac, size 0x130, virtual false, abstract: false, final false
  inline void LazyInitializeMaterials();

  static inline ::GlobalNamespace::PyramidBloomMainEffectSO* New_ctor();

  /// @brief Method OnDisable, addr 0x5f462dc, size 0x30, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x5f460e4, size 0xc8, virtual true, abstract: false, final false
  inline void OnEnable();

  /// @brief Method PostRender, addr 0x5f46384, size 0xd8, virtual true, abstract: false, final false
  inline void PostRender(::UnityEngine::Rendering::RasterCommandBuffer* cmd, float_t fade);

  /// @brief Method PreRender, addr 0x5f4630c, size 0x78, virtual true, abstract: false, final false
  inline void PreRender(::UnityEngine::Rendering::IBaseCommandBuffer* cmd);

  /// @brief Method Render, addr 0x5f464b4, size 0x23c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5f466f0, size 0x38, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_bloomTextureWidth, addr 0x5f460dc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_bloomTextureWidth();

  /// @brief Method get_hasPostProcessEffect, addr 0x5f460d4, size 0x8, virtual true, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PyramidBloomMainEffectSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PyramidBloomMainEffectSO(PyramidBloomMainEffectSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PyramidBloomMainEffectSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PyramidBloomMainEffectSO(PyramidBloomMainEffectSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::PyramidBloomMainEffectSO) == 0x80, "Size mismatch!");
