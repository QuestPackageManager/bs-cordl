...
/// @brief Method LazyInitializeMaterials, addr 0x5d960c0, size 0x130, virtual false, abstract: false, final false
inline void LazyInitializeMaterials() ;

static inline ::GlobalNamespace::PyramidBloomMainEffectSO* New_ctor() ;

/// @brief Method OnDisable, addr 0x5d961f0, size 0x30, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnEnable, addr 0x5d95ff8, size 0xc8, virtual true, abstract: false, final false
inline void OnEnable() ;

/// @brief Method PreRender, addr 0x5d96220, size 0x68, virtual true, abstract: false, final false
inline void PreRender() ;

/// @brief Method Render, addr 0x5d96288, size 0x284, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5d9650c, size 0x38, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_bloomTextureWidth, addr 0x5d95ff0, size 0x8, virtual false, abstract: false, final false
inline int32_t get_bloomTextureWidth() ;

/// @brief Method get_hasPostProcessEffect, addr 0x5d95fe8, size 0x8, virtual true, abstract: false, final false
