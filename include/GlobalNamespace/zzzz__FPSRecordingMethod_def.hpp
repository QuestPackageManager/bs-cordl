...
struct CORDL_TYPE FPSRecordingMethod {
public:
  // Declarations
  ...
  constexpr operator __FPSRecordingMethod_Unwrapped() const noexcept {
    return static_cast<__FPSRecordingMethod_Unwrapped>(this->value__);
  }
...
static_assert(offsetof(::GlobalNamespace::FPSRecordingMethod, value__) == 0x0, "Offset mismatch!");
