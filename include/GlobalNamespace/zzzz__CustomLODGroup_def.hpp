...
public:
  ...
  /// @brief Method Awake, addr 0x3b7d598, size 0x24, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DetectLODs, addr 0x3b7d850, size 0x1dc, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* DetectLODs();

  /// @brief Method DisableAllLevels, addr 0x3b7d730, size 0xc4, virtual false, abstract: false, final false
  inline void DisableAllLevels();

  /// @brief Method GetActiveLevel, addr 0x3b7d6f0, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActiveLevel, addr 0x3b7d5bc, size 0x134, virtual false, abstract: false, final false
  inline void SetActiveLevel(int32_t level);

  /// @brief Method SetLevels, addr 0x3b7d820, size 0x30, virtual false, abstract: false, final false
  inline void SetLevels(::ArrayW<::UnityEngine::GameObject*, ::Array<::UnityEngine::GameObject*>*> levels);

  /// @brief Method ToggleLevel, addr 0x3b7d7f4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b7da2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
