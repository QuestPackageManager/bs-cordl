...
public:
  ...
  /// @brief Method Awake, addr 0x3b8af80, size 0x24, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DetectLODs, addr 0x3b8b238, size 0x1dc, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::GameObject>>* DetectLODs();

  /// @brief Method DisableAllLevels, addr 0x3b8b118, size 0xc4, virtual false, abstract: false, final false
  inline void DisableAllLevels();

  /// @brief Method GetActiveLevel, addr 0x3b8b0d8, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method SetActiveLevel, addr 0x3b8afa4, size 0x134, virtual false, abstract: false, final false
  inline void SetActiveLevel(int32_t level);

  /// @brief Method SetLevels, addr 0x3b8b208, size 0x30, virtual false, abstract: false, final false
  inline void SetLevels(::ArrayW<::UnityEngine::GameObject*, ::Array<::UnityEngine::GameObject*>*> levels);

  /// @brief Method ToggleLevel, addr 0x3b8b1dc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b8b414, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
