...
/// @brief Method CalculateBadgeData, addr 0x3635624, size 0x434, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3635a7c, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
