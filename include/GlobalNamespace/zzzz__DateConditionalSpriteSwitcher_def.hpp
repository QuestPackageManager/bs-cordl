...
public:
  ...
  /// @brief Method Awake, addr 0x22b0e1c, size 0xb8, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x22b0ed4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
