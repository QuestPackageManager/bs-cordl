...
public:
  ...
  /// @brief Method .ctor, addr 0x14ab530, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x14ab528, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x14abd3c, size 0x204, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x14abf40, size 0x58, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x14abf98, size 0x2c8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x14ac260, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method <AppendLeaderboardScores>b__21_0, addr 0x14ac2d8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method <MigrateQuestLeaderboards>b__22_0, addr 0x14ac2fc, size 0x58, virtual false, abstract: false, final false
  inline bool _MigrateQuestLeaderboards_b__22_0(::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData* leaderboardData);

  /// @brief Method <MigrateQuestLeaderboards>b__22_1, addr 0x14ac354, size 0xc, virtual false, abstract: false, final false
  inline bool _MigrateQuestLeaderboards_b__22_1(::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData* leaderboardData);

  /// @brief Method .ctor, addr 0x14ac2d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x14ac360, size 0x25c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x14ac5bc, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x14ac5c8, size 0x3c4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x14ac98c, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x14ac998, size 0x2cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x14acc64, size 0xc, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AddScore, addr 0x14ab214, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method AddScore, addr 0x14ab880, size 0x5c, virtual false, abstract: false, final false
  inline void AddScore(::StringW leaderboardId, ::StringW playerName, int32_t score, bool fullCombo);

  /// @brief Method AppendLeaderboardScores, addr 0x14aa8c0, size 0x174, virtual false, abstract: false, final false
  ...
  /// @brief Method ClearAllLeaderboardsAsync, addr 0x14aba68, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ClearAllLeaderboardsAsync(bool deleteLeaderboardFile);

  /// @brief Method ClearLastScorePosition, addr 0x14ab828, size 0x58, virtual false, abstract: false, final false
  inline void ClearLastScorePosition();

  /// @brief Method ClearLeaderboard, addr 0x14ab92c, size 0x13c, virtual false, abstract: false, final false
  inline void ClearLeaderboard(::StringW leaderboardId);

  /// @brief Method GetCurrentTimestamp, addr 0x14aaf58, size 0xcc, virtual false, abstract: false, final false
  inline int64_t GetCurrentTimestamp();

  /// @brief Method GetHighScore, addr 0x14ab618, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLastScorePosition, addr 0x14ab790, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLeaderboardData, addr 0x14aae84, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetLeaderboardsData, addr 0x14aae5c, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method GetPositionInLeaderboard, addr 0x14ab6bc, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x14ab600, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method Load, addr 0x14abc0c, size 0x80, virtual false, abstract: false, final false
  inline void Load();

  /// @brief Method LoadAsync, addr 0x14abb44, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* LoadAsync();

  /// @brief Method LoadInternal, addr 0x14abc8c, size 0xa8, virtual false, abstract: false, final false
  inline void LoadInternal();

  /// @brief Method LoadLeaderboardsData, addr 0x14aa648, size 0x60, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLeaderboardsDataAsync, addr 0x14aa54c, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method LoadLeaderboardsDataInternal, addr 0x14aa6a8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method MigrateQuestLeaderboards, addr 0x14aaa34, size 0x360, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveAsync, addr 0x14aad94, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SaveAsync();

  /// @brief Method SaveLeaderboardsData, addr 0x14aa728, size 0xdc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SaveLeaderboardsData(::StringW filename,
                                                                ::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>* leaderboardsData);

  /// @brief Method SaveLeaderboardsDataAsync, addr 0x14aa804, size 0xbc, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* SaveLeaderboardsDataAsync(::StringW filename, ::StringW json);

  /// @brief Method UpdateDailyLeaderboard, addr 0x14ab024, size 0x1f0, virtual false, abstract: false, final false
  inline void UpdateDailyLeaderboard(::StringW leaderboardId);

  /// @brief Method WillScoreGoIntoLeaderboard, addr 0x14ab538, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method WillScoreGoIntoLeaderboard, addr 0x14ab8dc, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14aa4ac, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method add_newScoreWasAddedToLeaderboardEvent, addr 0x14aa34c, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_newScoreWasAddedToLeaderboardEvent, addr 0x14aa3fc, size 0xb0, virtual false, abstract: false, final false
