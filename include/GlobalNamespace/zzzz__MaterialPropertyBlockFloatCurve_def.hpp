...
public:
  ...
  /// @brief Method SetProperty, addr 0x2510ec4, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2510f5c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
