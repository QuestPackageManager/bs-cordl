...
public:
  ...
  /// @brief Method SetProperty, addr 0x21a9984, size 0x98, virtual true, abstract: false, final false
  inline void SetProperty();

  static inline ::GlobalNamespace::MaterialPropertyBlockFloatCurve* New_ctor();

  /// @brief Method .ctor, addr 0x21a9a1c, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
