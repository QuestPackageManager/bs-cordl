...
public:
  ...
  /// @brief Method SetProperty, addr 0x565d804, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x565d8b4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
