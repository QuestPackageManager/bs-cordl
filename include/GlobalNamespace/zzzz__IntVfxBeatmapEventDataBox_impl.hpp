...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::IntVfxBeatmapEventDataBox::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x267b164;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::IntVfxBeatmapEventDataBox::*)(
  ...
  constexpr static std::size_t addrs = 0x267b16c;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::IntVfxBeatmapEventDataBox*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::IntVfxBeatmapEventDataBox::*)(
    ...
    ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapEventData*>*)>(&::GlobalNamespace::IntVfxBeatmapEventDataBox::Unpack)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x267b374;
...
GlobalNamespace::IntVfxBeatmapEventDataBox::__cordl_internal_get__vfxBaseDataList() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____vfxBaseDataList;
}
...
GlobalNamespace::IntVfxBeatmapEventDataBox::New_ctor(::GlobalNamespace::IndexFilter* indexFilter, ::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType beatDistributionParamType,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::IntVfxBeatmapEventDataBox*>(indexFilter, beatDistributionParamType, beatDistributionParam, eventDistributionParamType,
