...
public:
  ...
  /// @brief Method CellForIdx, addr 0x2666064, size 0x1b4, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x2665fa4, size 0x8, virtual true, abstract: false, final true
  inline float_t CellSize();

  /// @brief Method HandleAdditionalContentModelDidInvalidateData, addr 0x26662f8, size 0xa8, virtual false, abstract: false, final false
  inline void HandleAdditionalContentModelDidInvalidateData();

  /// @brief Method HandleDidSelectColumnEvent, addr 0x2666218, size 0xe0, virtual false, abstract: false, final false
  inline void HandleDidSelectColumnEvent(::HMUI::TableView* tableView, int32_t column);

  /// @brief Method Init, addr 0x2665e04, size 0xc0, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::BeatmapCharacteristicsTableView* New_ctor();

  /// @brief Method NumberOfCells, addr 0x2665fac, size 0xb8, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method OnDestroy, addr 0x2665f18, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SelectCellWithIdx, addr 0x26663a0, size 0x20, virtual false, abstract: false, final false
  inline void SelectCellWithIdx(int32_t idx);

  /// @brief Method SetData, addr 0x2665ec4, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26663c0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectCharacteristic, addr 0x2665ca4, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectCharacteristic, addr 0x2665d54, size 0xb0, virtual false, abstract: false, final false
