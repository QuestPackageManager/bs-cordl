...
public:
  ...
  /// @brief Method InstallBindings, addr 0x377178c, size 0xdc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3771868, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
