...
public:
  ...
  /// @brief Method InstallBindings, addr 0x237c730, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x237c7e0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
