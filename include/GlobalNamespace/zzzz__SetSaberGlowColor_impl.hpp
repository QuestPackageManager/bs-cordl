...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair::*)()>(&::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58463b8;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>::get(),
                        ".ctor",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SetSaberGlowColor::*)(::GlobalNamespace::SaberType)>(&::GlobalNamespace::SetSaberGlowColor::set_saberType)> {
  ...
  constexpr static std::size_t addrs = 0x5845c78;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SetSaberGlowColor::*)()>(&::GlobalNamespace::SetSaberGlowColor::Start)> {
  ...
  constexpr static std::size_t addrs = 0x5846330;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SetSaberGlowColor::*)()>(&::GlobalNamespace::SetSaberGlowColor::SetColors)> {
  ...
  constexpr static std::size_t addrs = 0x58461d8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SetSaberGlowColor::*)()>(&::GlobalNamespace::SetSaberGlowColor::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x58463b4;
...
constexpr ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>*>& GlobalNamespace::SetSaberGlowColor::__cordl_internal_get__propertyTintColorPairs()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____propertyTintColorPairs;
}
constexpr ::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>*> const& GlobalNamespace::SetSaberGlowColor::__cordl_internal_get__propertyTintColorPairs() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____propertyTintColorPairs;
}
constexpr void GlobalNamespace::SetSaberGlowColor::__cordl_internal_set__propertyTintColorPairs(::ArrayW<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberGlowColor_PropertyTintColorPair*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
