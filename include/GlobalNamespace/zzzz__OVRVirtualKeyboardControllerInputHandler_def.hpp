...
public:
  // Declarations
  /// @brief Method Awake, addr 0x2b9657c, size 0x58, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRVirtualKeyboardControllerInputHandler* New_ctor();

  /// @brief Method .ctor, addr 0x2b965d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
