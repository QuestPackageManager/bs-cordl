...
public:
  // Declarations
  /// @brief Method Awake, addr 0x5d3ee14, size 0x5c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::OVRVirtualKeyboardControllerInputHandler* New_ctor();

  /// @brief Method .ctor, addr 0x5d3ee70, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
