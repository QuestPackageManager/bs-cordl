...
public:
  ...
  /// @brief Method <PingAsync>b__0_0, addr 0x327f824, size 0x84, virtual false, abstract: false, final false
  inline ::UnityEngine::Ping* _PingAsync_b__0_0(::System::Net::IPAddress* ip);

  /// @brief Method .ctor, addr 0x327f820, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x327f8a8, size 0x600, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x327fea8, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method PingAsync, addr 0x327f6e8, size 0xe4, virtual false, abstract: false, final false
