...
// TypeDefinitionIndex(TypeDefinitionIndex(14732)), TypeDefinitionIndex(TypeDefinitionIndex(4314))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4311)) CS Name: ::FloatFxBeatmapEventDataBox*
