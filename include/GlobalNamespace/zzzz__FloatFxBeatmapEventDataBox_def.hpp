...
public:
  ...
  /// @brief Method CreateVfxBeatmapEventData, addr 0x26bca78, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26bc9d0, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x26bc9c8, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x26bc9c0, size 0x8, virtual true, abstract: false, final false
