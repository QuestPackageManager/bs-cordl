...
public:
  ...
  /// @brief Method CreateVfxBeatmapEventData, addr 0x14b3674, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x14b35c4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x14b35bc, size 0x8, virtual true, abstract: false, final false
