...
public:
  ...
  /// @brief Method CreateVfxBeatmapEventData, addr 0x3656958, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36568ac, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x36568a4, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x365689c, size 0x8, virtual true, abstract: false, final false
