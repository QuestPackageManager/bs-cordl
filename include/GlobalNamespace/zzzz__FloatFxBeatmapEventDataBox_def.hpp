...
// Dependencies FloatFxBeatmapEventDataBox`2<TIn, TOut>
namespace GlobalNamespace {
// Is value type: false
// CS Name: FloatFxBeatmapEventDataBox
class CORDL_TYPE FloatFxBeatmapEventDataBox : public ::GlobalNamespace::FloatFxBeatmapEventDataBox_2<::GlobalNamespace::FloatFxBaseData*,::GlobalNamespace::FloatFxBeatmapEventData*> {
public:
// Declarations
...
/// @brief Method CreateVfxBeatmapEventData, addr 0x361a258, size 0xb0, virtual true, abstract: false, final false
...
static inline ::GlobalNamespace::FloatFxBeatmapEventDataBox* New_ctor(::GlobalNamespace::IndexFilter*  indexFilter, ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  beatDistributionParamType, float_t  beatDistributionParam, ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  eventDistributionParamType, float_t  eventDistributionParam, bool  eventDistributionShouldAffectFirstBaseEvent, ::GlobalNamespace::EaseType  eventDistributionEaseType, ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::FloatFxBaseData*>*  fxBaseDataList) ;
...
/// @brief Method .ctor, addr 0x361a1ac, size 0xac, virtual false, abstract: false, final false
inline void _ctor(::GlobalNamespace::IndexFilter*  indexFilter, ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  beatDistributionParamType, float_t  beatDistributionParam, ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  eventDistributionParamType, float_t  eventDistributionParam, bool  eventDistributionShouldAffectFirstBaseEvent, ::GlobalNamespace::EaseType  eventDistributionEaseType, ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::FloatFxBaseData*>*  fxBaseDataList) ;

/// @brief Method get_beatStep, addr 0x361a1a4, size 0x8, virtual true, abstract: false, final false
inline float_t get_beatStep() ;

/// @brief Method get_subtypeIdentifier, addr 0x361a19c, size 0x8, virtual true, abstract: false, final false
