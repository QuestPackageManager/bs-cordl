...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14732)), TypeDefinitionIndex(TypeDefinitionIndex(4309)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4309), inst:
// 2547 }), TypeDefinitionIndex(TypeDefinitionIndex(4314))} Self: TypeDefinitionIndex(TypeDefinitionIndex(4311)) CS Name: ::FloatFxBeatmapEventDataBox*
...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::FloatFxBaseData*>*> const& __get__vfxBaseDataList() const;
