...
public:
  ...
  /// @brief Method CreateVfxBeatmapEventData, addr 0x361a308, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x361a25c, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x361a254, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x361a24c, size 0x8, virtual true, abstract: false, final false
