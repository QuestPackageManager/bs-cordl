...
public:
  ...
  /// @brief Method CreateVfxBeatmapEventData, addr 0x14c2970, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14c28c8, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x14c28c0, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x14c28b8, size 0x8, virtual true, abstract: false, final false
