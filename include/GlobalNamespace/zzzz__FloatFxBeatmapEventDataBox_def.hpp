...
public:
  ...
  /// @brief Method CreateVfxBeatmapEventData, addr 0x13bdf2c, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13bde84, size 0xa8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatStep, addr 0x13bde7c, size 0x8, virtual true, abstract: false, final false
  inline float_t get_beatStep();

  /// @brief Method get_subtypeIdentifier, addr 0x13bde74, size 0x8, virtual true, abstract: false, final false
