...
public:
  ...
  /// @brief Method .ctor, addr 0x583a9b4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x583a9b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
