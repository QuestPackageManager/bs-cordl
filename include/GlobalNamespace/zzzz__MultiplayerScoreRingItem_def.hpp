...
public:
  ...
  /// @brief Method .ctor, addr 0x3be22b8, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3be22b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
