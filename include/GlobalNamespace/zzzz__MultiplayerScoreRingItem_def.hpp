...
public:
  ...
  /// @brief Method .ctor, addr 0x59df5e0, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x59df5dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
