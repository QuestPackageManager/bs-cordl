...
public:
  ...
  /// @brief Method .ctor, addr 0x3bdd344, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x3bdd33c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
