...
/// @brief Method .ctor, addr 0x583b2e4, size 0x3c, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x583b2e0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
