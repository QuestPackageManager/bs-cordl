...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11050)), TypeDefinitionIndex(TypeDefinitionIndex(5253)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst:
