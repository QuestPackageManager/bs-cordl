...
// Write type traits
MARK_REF_T(::GlobalNamespace::INetworkPlayer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::INetworkPlayer*, "", "INetworkPlayer");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "INetworkPlayer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INetworkPlayer(INetworkPlayerconst&) = delete;
