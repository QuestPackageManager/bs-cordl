...
static_assert(offsetof(::GlobalNamespace::__QuestPerformanceSettings__ProcessorPerformanceLevel, value__) == 0x0, "Offset mismatch!");
...
public:
  ...
  /// @brief Method get_cpuPerformanceLevel, addr 0x23503f0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__QuestPerformanceSettings__ProcessorPerformanceLevel get_cpuPerformanceLevel();

  /// @brief Method get_useFoveatedRenderingDuringGameplay, addr 0x234fe34, size 0x10, virtual false, abstract: false, final false
  inline bool get_useFoveatedRenderingDuringGameplay();

  static inline ::GlobalNamespace::QuestPerformanceSettings* New_ctor();

  /// @brief Method .ctor, addr 0x23503f8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::QuestPerformanceSettings, ___gpuLevel) == 0x10, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::QuestPerformanceSettings, ___cpuLevel) == 0x14, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::QuestPerformanceSettings, ___foveatedRenderingLevel) == 0x18, "Offset mismatch!");
