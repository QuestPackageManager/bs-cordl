...
public:
  ...
  /// @brief Method CellForIdx, addr 0x39e83cc, size 0x1e0, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x39e8278, size 0xa0, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method DidSelectCellWithIdx, addr 0x39e8610, size 0x130, virtual true, abstract: false, final false
  inline void DidSelectCellWithIdx(int32_t idx);

  static inline ::GlobalNamespace::TableViewWithDetailCell* New_ctor();

  /// @brief Method NumberOfCells, addr 0x39e8318, size 0xb4, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method ReloadData, addr 0x39e85ac, size 0x28, virtual true, abstract: false, final false
  inline void ReloadData();

  /// @brief Method ReloadData, addr 0x39e85d4, size 0x3c, virtual false, abstract: false, final false
