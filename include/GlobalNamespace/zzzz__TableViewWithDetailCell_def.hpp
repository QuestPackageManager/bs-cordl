...
public:
  ...
  /// @brief Method CellForIdx, addr 0x39ed0bc, size 0x1e0, virtual true, abstract: false, final true
  inline ::UnityW<::HMUI::TableCell> CellForIdx(::HMUI::TableView* tableView, int32_t idx);

  /// @brief Method CellSize, addr 0x39ecf68, size 0xa0, virtual true, abstract: false, final true
  inline float_t CellSize(int32_t idx);

  /// @brief Method DidSelectCellWithIdx, addr 0x39ed300, size 0x130, virtual true, abstract: false, final false
  inline void DidSelectCellWithIdx(int32_t idx);

  static inline ::GlobalNamespace::TableViewWithDetailCell* New_ctor();

  /// @brief Method NumberOfCells, addr 0x39ed008, size 0xb4, virtual true, abstract: false, final true
  inline int32_t NumberOfCells();

  /// @brief Method ReloadData, addr 0x39ed29c, size 0x28, virtual true, abstract: false, final false
  inline void ReloadData();

  /// @brief Method ReloadData, addr 0x39ed2c4, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39ed430, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didDeselectContentCellEvent, addr 0x39ecdd8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didDeselectContentCellEvent(::System::Action_2<::UnityW<::GlobalNamespace::TableViewWithDetailCell>, int32_t>* value);

  /// @brief Method add_didSelectContentCellEvent, addr 0x39ecc78, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectContentCellEvent(::System::Action_2<::UnityW<::GlobalNamespace::TableViewWithDetailCell>, int32_t>* value);

  /// @brief Method get_dataSource, addr 0x39ecf38, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didDeselectContentCellEvent, addr 0x39ece88, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didSelectContentCellEvent, addr 0x39ecd28, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_dataSource, addr 0x39ecf40, size 0x28, virtual false, abstract: false, final false
