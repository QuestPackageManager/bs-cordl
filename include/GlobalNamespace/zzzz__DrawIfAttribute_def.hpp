...
public:
  ...
  /// @brief Method .ctor, addr 0xe8c420, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe8c45c, size 0x44, virtual false, abstract: false, final false
