...
public:
  ...
  /// @brief Method OnDisable, addr 0x39e5328, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrawGizmos, addr 0x39e53a8, size 0x88, virtual false, abstract: false, final false
  inline void OnDrawGizmos();

  /// @brief Method OnEnable, addr 0x39e525c, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x39e5430, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LineLight>>* getStaticF__lineLights();

  /// @brief Method get_color, addr 0x39e51f8, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_color();

  /// @brief Method get_lineLights, addr 0x39e5204, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LineLight>>* get_lineLights();

  /// @brief Method get_p0, addr 0x39e51e0, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector3 get_p0();

  /// @brief Method get_p1, addr 0x39e51ec, size 0xc, virtual false, abstract: false, final false
