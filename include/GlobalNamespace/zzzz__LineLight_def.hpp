...
public:
  ...
  /// @brief Method OnDisable, addr 0x39e5bec, size 0x80, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnDrawGizmos, addr 0x39e5c6c, size 0x88, virtual false, abstract: false, final false
  inline void OnDrawGizmos();

  /// @brief Method OnEnable, addr 0x39e5b20, size 0xcc, virtual false, abstract: false, final false
