...
/// @brief Method OnDisable, addr 0x56bd0c4, size 0x88, virtual false, abstract: false, final false
inline void OnDisable() ;

/// @brief Method OnDrawGizmos, addr 0x56bd14c, size 0x88, virtual false, abstract: false, final false
inline void OnDrawGizmos() ;

/// @brief Method OnEnable, addr 0x56bcff0, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bd1d4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

static inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LineLight>>* getStaticF__lineLights() ;

/// @brief Method get_color, addr 0x56bcf88, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method get_lineLights, addr 0x56bcf94, size 0x5c, virtual false, abstract: false, final false
static inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::LineLight>>* get_lineLights() ;

/// @brief Method get_p0, addr 0x56bcf70, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Vector3 get_p0() ;

/// @brief Method get_p1, addr 0x56bcf7c, size 0xc, virtual false, abstract: false, final false
