...
public:
  ...
  /// @brief Method Sucess, addr 0x14c8908, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::GetAssetBundleFileResult Sucess(::StringW assetBundlePath);

  /// @brief Method .ctor, addr 0x14c88f8, size 0x10, virtual false, abstract: false, final false
