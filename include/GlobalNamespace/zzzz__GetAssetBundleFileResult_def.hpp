...
public:
  ...
  /// @brief Method Success, addr 0x26d4a10, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::GetAssetBundleFileResult Success(::StringW assetBundlePath);

  /// @brief Method .ctor, addr 0x26d4a00, size 0x10, virtual false, abstract: false, final false
