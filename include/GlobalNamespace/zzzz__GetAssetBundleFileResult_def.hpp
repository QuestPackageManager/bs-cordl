...
/// @brief Method Success, addr 0x363090c, size 0xc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::GetAssetBundleFileResult Success(::StringW  assetBundlePath) ;

/// @brief Method .ctor, addr 0x3630900, size 0xc, virtual false, abstract: false, final false
