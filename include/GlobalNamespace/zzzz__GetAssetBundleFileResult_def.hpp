...
public:
  ...
  /// @brief Method Success, addr 0x372afe0, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::GetAssetBundleFileResult Success(::StringW assetBundlePath);

  /// @brief Method .ctor, addr 0x372afd4, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::GetAssetBundleFileResult) == 0x10, "Size mismatch!");
