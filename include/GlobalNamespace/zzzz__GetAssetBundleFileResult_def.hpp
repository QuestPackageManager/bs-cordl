...
public:
  ...
  /// @brief Method Success, addr 0x3605980, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::GetAssetBundleFileResult Success(::StringW assetBundlePath);

  /// @brief Method .ctor, addr 0x3605974, size 0xc, virtual false, abstract: false, final false
