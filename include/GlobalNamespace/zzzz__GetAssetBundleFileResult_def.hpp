...
public:
  ...
  /// @brief Method Success, addr 0x366d2f8, size 0xc, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::GetAssetBundleFileResult Success(::StringW assetBundlePath);

  /// @brief Method .ctor, addr 0x366d2ec, size 0xc, virtual false, abstract: false, final false
