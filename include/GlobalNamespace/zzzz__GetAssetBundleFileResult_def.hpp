...
/// @brief Method Success, addr 0x366e68c, size 0xc, virtual false, abstract: false, final false
static inline ::GlobalNamespace::GetAssetBundleFileResult Success(::StringW  assetBundlePath) ;

/// @brief Method .ctor, addr 0x366e680, size 0xc, virtual false, abstract: false, final false
