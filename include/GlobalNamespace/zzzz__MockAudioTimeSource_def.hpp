...
public:
  ...
  /// @brief Method get_songTime, addr 0x22b7e28, size 0x8, virtual true, abstract: false, final true
  inline float_t get_songTime();

  /// @brief Method set_songTime, addr 0x22b7e30, size 0x8, virtual false, abstract: false, final false
  inline void set_songTime(float_t value);

  /// @brief Method get_lastFrameDeltaSongTime, addr 0x22b7e38, size 0x8, virtual true, abstract: false, final true
  inline float_t get_lastFrameDeltaSongTime();

  /// @brief Method set_lastFrameDeltaSongTime, addr 0x22b7e40, size 0x8, virtual false, abstract: false, final false
  inline void set_lastFrameDeltaSongTime(float_t value);

  /// @brief Method get_songEndTime, addr 0x22b7e48, size 0xc, virtual true, abstract: false, final true
  inline float_t get_songEndTime();

  /// @brief Method get_songLength, addr 0x22b7e54, size 0xc, virtual true, abstract: false, final true
  inline float_t get_songLength();

  /// @brief Method get_isReady, addr 0x22b7e60, size 0x8, virtual true, abstract: false, final true
  inline bool get_isReady();

  /// @brief Method Update, addr 0x22b7e68, size 0x38, virtual false, abstract: false, final false
  inline void Update();

  static inline ::GlobalNamespace::MockAudioTimeSource* New_ctor();

  /// @brief Method .ctor, addr 0x22b7ea0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
