...
public:
  ...
  /// @brief Method Update, addr 0x577c410, size 0x6c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x577c47c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_isReady, addr 0x577c400, size 0x8, virtual true, abstract: false, final true
  inline bool get_isReady();

  /// @brief Method get_lastFrameDeltaSongTime, addr 0x577c3d0, size 0x8, virtual true, abstract: false, final true
  inline float_t get_lastFrameDeltaSongTime();

  /// @brief Method get_songEndTime, addr 0x577c3e0, size 0xc, virtual true, abstract: false, final true
  inline float_t get_songEndTime();

  /// @brief Method get_songLength, addr 0x577c3ec, size 0xc, virtual true, abstract: false, final true
  inline float_t get_songLength();

  /// @brief Method get_songTime, addr 0x577c3c0, size 0x8, virtual true, abstract: false, final true
  inline float_t get_songTime();

  /// @brief Method get_state, addr 0x577c408, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::IAudioTimeSource_State get_state();

  /// @brief Method get_timeScale, addr 0x577c3f8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_lastFrameDeltaSongTime, addr 0x577c3d8, size 0x8, virtual false, abstract: false, final false
  inline void set_lastFrameDeltaSongTime(float_t value);

  /// @brief Method set_songTime, addr 0x577c3c8, size 0x8, virtual false, abstract: false, final false
