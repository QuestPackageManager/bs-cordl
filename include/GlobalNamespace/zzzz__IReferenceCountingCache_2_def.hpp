...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IReferenceCountingCache_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IReferenceCountingCache_2(IReferenceCountingCache_2const&) = delete;
