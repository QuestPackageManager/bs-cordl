...
public:
  ...
  /// @brief Method .ctor, addr 0x2517f74, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_environmentInfos, addr 0x2517f64, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>* get_environmentInfos();

  /// @brief Method set_environmentInfos, addr 0x2517f6c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SetData>b__12_0, addr 0x2517fe8, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _SetData_b__12_0(::GlobalNamespace::EnvironmentInfoSO* x);

  /// @brief Method .ctor, addr 0x2517fe0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method HandleDropDownDidSelectCellWithIdx, addr 0x2517a88, size 0x288, virtual false, abstract: false, final false
  inline void HandleDropDownDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropDownWithTableView, int32_t idx);

  /// @brief Method HandleOverrideEnvironmentsToggleValueChanged, addr 0x2517d10, size 0x22c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x2517794, size 0x19c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x2517930, size 0x158, virtual true, abstract: false, final true
  inline void Refresh();

  /// @brief Method SetData, addr 0x25174e4, size 0x2b0, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::OverrideEnvironmentSettings* overrideEnvironmentSettings);

  /// @brief Method <HandleOverrideEnvironmentsToggleValueChanged>b__16_0, addr 0x2517f44, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2517f3c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_overrideEnvironmentSettings, addr 0x25174dc, size 0x8, virtual false, abstract: false, final false
