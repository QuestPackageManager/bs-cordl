...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnvironmentOverrideSettingsPanelController*);
MARK_REF_T(::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*);
MARK_REF_T(::GlobalNamespace::EnvironmentOverrideSettingsPanelController___c*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentOverrideSettingsPanelController*, "", "EnvironmentOverrideSettingsPanelController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*, "", "EnvironmentOverrideSettingsPanelController/Elements");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnvironmentOverrideSettingsPanelController___c*, "", "EnvironmentOverrideSettingsPanelController/<>c");
...
public:
  ...
  /// @brief Method <SetData>b__10_0, addr 0x5923f00, size 0x14, virtual false, abstract: false, final false
  inline ::StringW _SetData_b__10_0(::GlobalNamespace::EnvironmentInfoSO* x);

  /// @brief Method .ctor, addr 0x5923efc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
// Non member Declarations
static_assert(sizeof(::GlobalNamespace::EnvironmentOverrideSettingsPanelController___c) == 0x10, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies EnvironmentOverrideSettingsPanelController::Elements, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__elements, put = __cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*> _elements;
  ...
  /// @brief Method HandleDropDownDidSelectCellWithIdx, addr 0x59238b8, size 0x2e8, virtual false, abstract: false, final false
  inline void HandleDropDownDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropDownWithTableView, int32_t idx);

  /// @brief Method HandleOverrideEnvironmentsToggleValueChanged, addr 0x5923ba0, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5923570, size 0x1e4, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x5923754, size 0x164, virtual true, abstract: false, final true
  inline void Refresh();
  ...
  constexpr ::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*> const& __cordl_internal_get__elements() const;

  constexpr ::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*>& __cordl_internal_get__elements();
  ...
  constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*> value);
  ...
  /// @brief Method .ctor, addr 0x5923e74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EnvironmentOverrideSettingsPanelController) == 0x68, "Size mismatch!");
