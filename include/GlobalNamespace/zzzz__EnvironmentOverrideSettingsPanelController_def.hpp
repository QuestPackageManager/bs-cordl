...
/// @brief Field <environmentInfos>k__BackingField, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__environmentInfos_k__BackingField, put=__cordl_internal_set__environmentInfos_k__BackingField)) ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>*  _environmentInfos_k__BackingField;
...
/// @brief Method .ctor, addr 0x585c538, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_environmentInfos, addr 0x585c528, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>* get_environmentInfos() ;

/// @brief Method set_environmentInfos, addr 0x585c530, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method <SetData>b__10_0, addr 0x585c594, size 0x14, virtual false, abstract: false, final false
inline ::StringW _SetData_b__10_0(::GlobalNamespace::EnvironmentInfoSO*  x) ;

/// @brief Method .ctor, addr 0x585c590, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _elements, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__elements, put=__cordl_internal_set__elements)) ::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*,::Array<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*>*>  _elements;
...
/// @brief Field _overrideEnvironmentSettings, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__overrideEnvironmentSettings, put=__cordl_internal_set__overrideEnvironmentSettings)) ::GlobalNamespace::OverrideEnvironmentSettings*  _overrideEnvironmentSettings;
...
/// @brief Method HandleDropDownDidSelectCellWithIdx, addr 0x585bf4c, size 0x2e8, virtual false, abstract: false, final false
inline void HandleDropDownDidSelectCellWithIdx(::HMUI::DropdownWithTableView*  dropDownWithTableView, int32_t  idx) ;

/// @brief Method HandleOverrideEnvironmentsToggleValueChanged, addr 0x585c234, size 0x2d4, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x585bc04, size 0x1e4, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Refresh, addr 0x585bde8, size 0x164, virtual true, abstract: false, final true
inline void Refresh() ;

/// @brief Method SetData, addr 0x585b8d8, size 0x32c, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::OverrideEnvironmentSettings*  overrideEnvironmentSettings) ;

/// @brief Method <HandleOverrideEnvironmentsToggleValueChanged>b__14_0, addr 0x585c50c, size 0x1c, virtual false, abstract: false, final false
...
constexpr ::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*,::Array<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*>*> const& __cordl_internal_get__elements() const;

constexpr ::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*,::Array<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*>*>& __cordl_internal_get__elements() ;
...
constexpr void __cordl_internal_set__elements(::ArrayW<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*,::Array<::GlobalNamespace::EnvironmentOverrideSettingsPanelController_Elements*>*>  value) ;
...
/// @brief Method .ctor, addr 0x585c508, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
