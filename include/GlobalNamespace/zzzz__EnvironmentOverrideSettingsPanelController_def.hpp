...
public:
  ...
  /// @brief Method .ctor, addr 0x3bfe974, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_environmentInfos, addr 0x3bfe964, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::UnityW<::GlobalNamespace::EnvironmentInfoSO>>* get_environmentInfos();

  /// @brief Method set_environmentInfos, addr 0x3bfe96c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <SetData>b__10_0, addr 0x3bfe9e0, size 0x18, virtual false, abstract: false, final false
  inline ::StringW _SetData_b__10_0(::GlobalNamespace::EnvironmentInfoSO* x);

  /// @brief Method .ctor, addr 0x3bfe9d8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method HandleDropDownDidSelectCellWithIdx, addr 0x3bfe464, size 0x27c, virtual false, abstract: false, final false
  inline void HandleDropDownDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropDownWithTableView, int32_t idx);

  /// @brief Method HandleOverrideEnvironmentsToggleValueChanged, addr 0x3bfe6e0, size 0x25c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3bfe178, size 0x194, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Refresh, addr 0x3bfe30c, size 0x158, virtual true, abstract: false, final true
  inline void Refresh();

  /// @brief Method SetData, addr 0x3bfded4, size 0x2a4, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::OverrideEnvironmentSettings* overrideEnvironmentSettings);

  /// @brief Method <HandleOverrideEnvironmentsToggleValueChanged>b__14_0, addr 0x3bfe944, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bfe93c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
