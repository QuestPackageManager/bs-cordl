...
public:
  ...
  /// @brief Method GetCopy, addr 0x2245828, size 0x98, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method Mirror, addr 0x2245928, size 0x20, virtual true, abstract: false, final false
  inline void Mirror(int32_t lineCount);

  /// @brief Method MirrorTransformOffsetDirection, addr 0x2245948, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22458c0, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lineIndex, addr 0x2245808, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_lineLayer, addr 0x2245818, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_lineLayer();

  /// @brief Method get_offsetDirection, addr 0x22457f8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OffsetDirection get_offsetDirection();

  /// @brief Method set_lineIndex, addr 0x2245810, size 0x8, virtual false, abstract: false, final false
  inline void set_lineIndex(int32_t value);

  /// @brief Method set_lineLayer, addr 0x2245820, size 0x8, virtual false, abstract: false, final false
  inline void set_lineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_offsetDirection, addr 0x2245800, size 0x8, virtual false, abstract: false, final false
