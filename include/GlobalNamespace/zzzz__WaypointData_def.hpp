...
public:
  ...
  /// @brief Method GetCopy, addr 0xe71aac, size 0x90, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method Mirror, addr 0xe71b94, size 0x14, virtual true, abstract: false, final false
  inline void Mirror(int32_t lineCount);

  /// @brief Method MirrorTransformOffsetDirection, addr 0xe71ba8, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0xe71b3c, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method get_lineIndex, addr 0xe71a8c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_lineIndex();

  /// @brief Method get_lineLayer, addr 0xe71a9c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::NoteLineLayer get_lineLayer();

  /// @brief Method get_offsetDirection, addr 0xe71a7c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OffsetDirection get_offsetDirection();

  /// @brief Method set_lineIndex, addr 0xe71a94, size 0x8, virtual false, abstract: false, final false
  inline void set_lineIndex(int32_t value);

  /// @brief Method set_lineLayer, addr 0xe71aa4, size 0x8, virtual false, abstract: false, final false
  inline void set_lineLayer(::GlobalNamespace::NoteLineLayer value);

  /// @brief Method set_offsetDirection, addr 0xe71a84, size 0x8, virtual false, abstract: false, final false
