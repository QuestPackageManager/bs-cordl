...
public:
  ...
  /// @brief Method GetCopy, addr 0x325e004, size 0x94, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method Mirror, addr 0x325e0d4, size 0x20, virtual true, abstract: false, final false
  inline void Mirror(int32_t lineCount);

  /// @brief Method MirrorTransformOffsetDirection, addr 0x325e0f4, size 0x24, virtual false, abstract: false, final false
