...
/// @brief Method DidActivate, addr 0x57ad3c4, size 0xb8, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleQuitButtonPressed, addr 0x57ad49c, size 0x54, virtual false, abstract: false, final false
inline void HandleQuitButtonPressed() ;

static inline ::GlobalNamespace::StartupErrorViewController* New_ctor() ;

/// @brief Method SetMessage, addr 0x57ad47c, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57ad4f0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
