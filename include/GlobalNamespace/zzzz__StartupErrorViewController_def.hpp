...
// Write type traits
MARK_REF_T(::GlobalNamespace::StartupErrorViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::StartupErrorViewController*, "", "StartupErrorViewController");
...
public:
  ...
  /// @brief Method DidActivate, addr 0x5a1ce28, size 0xb8, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleQuitButtonPressed, addr 0x5a1cf00, size 0x54, virtual false, abstract: false, final false
  inline void HandleQuitButtonPressed();

  static inline ::GlobalNamespace::StartupErrorViewController* New_ctor();

  /// @brief Method SetMessage, addr 0x5a1cee0, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a1cf54, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::StartupErrorViewController) == 0x88, "Size mismatch!");
