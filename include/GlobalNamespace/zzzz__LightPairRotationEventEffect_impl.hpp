...
inline ::GlobalNamespace::LightPairRotationEventEffect_RotationData* GlobalNamespace::LightPairRotationEventEffect_RotationData::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::LightPairRotationEventEffect_RotationData*>());
}
// Ctor Parameters []
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairRotationEventEffect::*)()>(&::GlobalNamespace::LightPairRotationEventEffect::Start)> {
  ...
  constexpr static std::size_t addrs = 0x5995490;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairRotationEventEffect::*)()>(&::GlobalNamespace::LightPairRotationEventEffect::Update)> {
  ...
  constexpr static std::size_t addrs = 0x5995840;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairRotationEventEffect::*)(int32_t, ::GlobalNamespace::LightPairRotationEventEffect_RotationData*, float_t,
  ...
  constexpr static std::size_t addrs = 0x5995eb4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{},
        (::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightPairRotationEventEffect*>(),
                            { "UpdateRotationData",
                              {},
                              { ::i2c::type_of<int32_t>(), ::i2c::type_of<::GlobalNamespace::LightPairRotationEventEffect_RotationData*>(), ::i2c::type_of<float_t>(), ::i2c::type_of<float_t>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::LightPairRotationEventEffect::*)()>(&::GlobalNamespace::LightPairRotationEventEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x59960d0;
  ...
  static auto* ___internal_method = THROW_UNLESS(
      ...
      (::i2c::find_method(::i2c::class_of<::GlobalNamespace::LightPairRotationEventEffect*>(),
                          { "UpdateRotationData",
                            {},
                            { ::i2c::type_of<int32_t>(), ::i2c::type_of<::GlobalNamespace::LightPairRotationEventEffect_RotationData*>(), ::i2c::type_of<float_t>(), ::i2c::type_of<float_t>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, beatmapEventDataValue, rotationData, startRotationOffset, direction);
}
...
inline ::GlobalNamespace::LightPairRotationEventEffect* GlobalNamespace::LightPairRotationEventEffect::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::LightPairRotationEventEffect*>());
}
// Ctor Parameters []
