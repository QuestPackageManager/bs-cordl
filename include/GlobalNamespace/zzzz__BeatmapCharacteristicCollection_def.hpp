...
public:
  ...
  /// @brief Method GetBeatmapCharacteristicBySerializedName, addr 0x26b5f0c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b59ec, size 0x520, virtual false, abstract: false, final false
