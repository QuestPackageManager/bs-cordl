...
public:
  ...
  /// @brief Method GetBeatmapCharacteristicBySerializedName, addr 0x13b6d24, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13b67fc, size 0x528, virtual false, abstract: false, final false
