...
public:
  ...
  /// @brief Method GetBeatmapCharacteristicBySerializedName, addr 0x14ac400, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14abed8, size 0x528, virtual false, abstract: false, final false
