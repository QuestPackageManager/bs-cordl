...
public:
  ...
  /// @brief Method GetBeatmapCharacteristicBySerializedName, addr 0x12dee14, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x12de8ec, size 0x528, virtual false, abstract: false, final false
