...
// Write type traits
MARK_REF_T(::GlobalNamespace::ILobbyGameStateControllerBase*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ILobbyGameStateControllerBase*, "", "ILobbyGameStateControllerBase");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
