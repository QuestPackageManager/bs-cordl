...
public:
  // Declarations
  /// @brief Method AutoGenerateMapping, addr 0x403d00c, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoMapBlendshapes, addr 0x403dd20, size 0x2ec, virtual false, abstract: false, final false
  static inline void AutoMapBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method ClearBlendshapes, addr 0x403e174, size 0xbc, virtual false, abstract: false, final false
  static inline void ClearBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method CustomAutoGeneratedMapping, addr 0x403e12c, size 0x48, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::OVRFaceExpressions_FaceExpression, ::Array<::GlobalNamespace::OVRFaceExpressions_FaceExpression>*>
  ...
  /// @brief Method FindBestMatch, addr 0x403d79c, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsLipsToward, addr 0x403db88, size 0xfc, virtual false, abstract: false, final false
  static inline bool IsLipsToward(::StringW blendshapeName);

  /// @brief Method OculusFaceAutoGenerateMapping, addr 0x403e00c, size 0x120, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::OVRFaceExpressions_FaceExpression, ::Array<::GlobalNamespace::OVRFaceExpressions_FaceExpression>*>
  OculusFaceAutoGenerateMapping(::UnityEngine::Mesh* sharedMesh, bool allowDuplicateMapping);

  /// @brief Method SplitCamelCase, addr 0x403dc84, size 0x9c, virtual false, abstract: false, final false
  static inline ::StringW SplitCamelCase(::StringW input);

  /// @brief Method TokenizeString, addr 0x403d27c, size 0x520, virtual false, abstract: false, final false
