...
public:
  // Declarations
  /// @brief Method AutoGenerateMapping, addr 0x5d49cdc, size 0x298, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::OVRFaceExpressions_FaceExpression, ::Array<::GlobalNamespace::OVRFaceExpressions_FaceExpression>*>
  ...
  /// @brief Method AutoMapBlendshapes, addr 0x5d4aa2c, size 0x340, virtual false, abstract: false, final false
  static inline void AutoMapBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method ClearBlendshapes, addr 0x5d4aebc, size 0xc0, virtual false, abstract: false, final false
  static inline void ClearBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method CustomAutoGeneratedMapping, addr 0x5d4ae74, size 0x48, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::OVRFaceExpressions_FaceExpression, ::Array<::GlobalNamespace::OVRFaceExpressions_FaceExpression>*>
  ...
  /// @brief Method FindBestMatch, addr 0x5d4a4ac, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsLipsToward, addr 0x5d4a880, size 0x104, virtual false, abstract: false, final false
  static inline bool IsLipsToward(::StringW blendshapeName);

  /// @brief Method OculusFaceAutoGenerateMapping, addr 0x5d4ad6c, size 0x108, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::OVRFaceExpressions_FaceExpression, ::Array<::GlobalNamespace::OVRFaceExpressions_FaceExpression>*>
  OculusFaceAutoGenerateMapping(::UnityEngine::Mesh* sharedMesh, bool allowDuplicateMapping);

  /// @brief Method SplitCamelCase, addr 0x5d4a984, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW SplitCamelCase(::StringW input);

  /// @brief Method TokenizeString, addr 0x5d49f74, size 0x538, virtual false, abstract: false, final false
