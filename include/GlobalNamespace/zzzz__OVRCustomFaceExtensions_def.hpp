...
public:
  // Declarations
  /// @brief Method AutoGenerateMapping, addr 0x3fb9a14, size 0x270, virtual false, abstract: false, final false
  ...
  /// @brief Method AutoMapBlendshapes, addr 0x3fba728, size 0x2ec, virtual false, abstract: false, final false
  static inline void AutoMapBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method ClearBlendshapes, addr 0x3fbab7c, size 0xbc, virtual false, abstract: false, final false
  static inline void ClearBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method CustomAutoGeneratedMapping, addr 0x3fbab34, size 0x48, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::__OVRFaceExpressions__FaceExpression, ::Array<::GlobalNamespace::__OVRFaceExpressions__FaceExpression>*>
  ...
  /// @brief Method FindBestMatch, addr 0x3fba1a4, size 0x3ec, virtual false, abstract: false, final false
  ...
  /// @brief Method IsLipsToward, addr 0x3fba590, size 0xfc, virtual false, abstract: false, final false
  static inline bool IsLipsToward(::StringW blendshapeName);

  /// @brief Method OculusFaceAutoGenerateMapping, addr 0x3fbaa14, size 0x120, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::__OVRFaceExpressions__FaceExpression, ::Array<::GlobalNamespace::__OVRFaceExpressions__FaceExpression>*>
  OculusFaceAutoGenerateMapping(::UnityEngine::Mesh* sharedMesh, bool allowDuplicateMapping);

  /// @brief Method SplitCamelCase, addr 0x3fba68c, size 0x9c, virtual false, abstract: false, final false
  static inline ::StringW SplitCamelCase(::StringW input);

  /// @brief Method TokenizeString, addr 0x3fb9c84, size 0x520, virtual false, abstract: false, final false
