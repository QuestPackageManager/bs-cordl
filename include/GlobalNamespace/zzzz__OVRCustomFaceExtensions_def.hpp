...
public:
  // Declarations
  /// @brief Method AutoGenerateMapping, addr 0x5ef8198, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method CustomAutoGeneratedMapping, addr 0x5ef9330, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method FindBestMatch, addr 0x5ef8968, size 0x3d4, virtual false, abstract: false, final false
  ...
  /// @brief Method IsLipsToward, addr 0x5ef8d3c, size 0x104, virtual false, abstract: false, final false
  static inline bool IsLipsToward(::StringW blendshapeName);

  /// @brief Method OculusFaceAutoGenerateMapping, addr 0x5ef9228, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method SplitCamelCase, addr 0x5ef8e40, size 0xa8, virtual false, abstract: false, final false
  static inline ::StringW SplitCamelCase(::StringW input);

  /// @brief Method TokenizeString, addr 0x5ef8430, size 0x538, virtual false, abstract: false, final false
