...
public:
  // Declarations
  /// @brief Method AutoGenerateMapping, addr 0x27a8e9c, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method FindBestMatch, addr 0x27a9608, size 0x3f0, virtual false, abstract: false, final false
  ...
  /// @brief Method IsLipsToward, addr 0x27a99f8, size 0xfc, virtual false, abstract: false, final false
  static inline bool IsLipsToward(::StringW blendshapeName);

  /// @brief Method TokenizeString, addr 0x27a9108, size 0x500, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::HashSet_1<::StringW>* TokenizeString(::StringW s);

  /// @brief Method SplitCamelCase, addr 0x27a9af4, size 0x9c, virtual false, abstract: false, final false
  static inline ::StringW SplitCamelCase(::StringW input);

  /// @brief Method AutoMapBlendshapes, addr 0x27a9b90, size 0x2f4, virtual false, abstract: false, final false
  static inline void AutoMapBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method ClearBlendshapes, addr 0x27a9fec, size 0xbc, virtual false, abstract: false, final false
  static inline void ClearBlendshapes(::GlobalNamespace::OVRCustomFace* customFace);

  /// @brief Method OculusFaceAutoGenerateMapping, addr 0x27a9e84, size 0x120, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::__OVRFaceExpressions__FaceExpression, ::Array<::GlobalNamespace::__OVRFaceExpressions__FaceExpression>*>
  OculusFaceAutoGenerateMapping(::UnityEngine::Mesh* sharedMesh, bool allowDuplicateMapping);

  /// @brief Method CustomAutoGeneratedMapping, addr 0x27a9fa4, size 0x48, virtual false, abstract: false, final false
  static inline ::ArrayW<::GlobalNamespace::__OVRFaceExpressions__FaceExpression, ::Array<::GlobalNamespace::__OVRFaceExpressions__FaceExpression>*>
