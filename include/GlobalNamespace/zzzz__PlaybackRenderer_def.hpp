...
public:
  ...
  /// @brief Method CreateTexture, addr 0x5755be0, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57565b8, size 0x18, virtual false, abstract: false, final false
  ...
  /// @brief Method get_backgroundColor, addr 0x57565ac, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_backgroundColor();

  /// @brief Method get_layerMask, addr 0x575658c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_layerMask();

  /// @brief Method get_name, addr 0x575657c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_path, addr 0x575659c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_path();

  /// @brief Method get_texture, addr 0x5756584, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> get_texture();

  /// @brief Method get_type, addr 0x5756594, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlaybackScreenshot_PlaybackRenderer_Type get_type();

  /// @brief Method set_path, addr 0x57565a4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateClipQuad, addr 0x57558ec, size 0x28c, virtual false, abstract: false, final false
  inline void CreateClipQuad();

  /// @brief Method CreateTextures, addr 0x5755b78, size 0x68, virtual false, abstract: false, final false
  inline void CreateTextures(int32_t width, int32_t height);

  /// @brief Method GetDistanceToHMD, addr 0x5755ca8, size 0x32c, virtual false, abstract: false, final false
  inline float_t GetDistanceToHMD();

  /// @brief Method InitCamera, addr 0x5755804, size 0xe8, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x57564c8, size 0xb0, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::PlaybackRenderer* New_ctor();

  /// @brief Method OrientClipQuad, addr 0x5755fd4, size 0x13c, virtual false, abstract: false, final false
  inline void OrientClipQuad();

  /// @brief Method RenderBackground, addr 0x5756338, size 0x190, virtual false, abstract: false, final false
  inline void RenderBackground(::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot* screenshot);

  /// @brief Method RenderForeground, addr 0x5756110, size 0x228, virtual false, abstract: false, final false
  inline void RenderForeground(::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot* screenshot);

  /// @brief Method Setup, addr 0x5754d1c, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5756578, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_texturesReadyEvent, addr 0x57556a4, size 0xac, virtual false, abstract: false, final false
  inline void add_texturesReadyEvent(::System::Action* value);

  /// @brief Method get_screenshots, addr 0x57557fc, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_texturesReadyEvent, addr 0x5755750, size 0xac, virtual false, abstract: false, final false
