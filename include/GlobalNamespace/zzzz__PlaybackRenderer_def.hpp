...
/// @brief Method CreateTexture, addr 0x5756514, size 0xc8, virtual false, abstract: false, final false
inline void CreateTexture(int32_t  width, int32_t  height) ;

static inline ::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot* New_ctor(::StringW  name, ::UnityEngine::LayerMask  layerMask, ::GlobalNamespace::PlaybackScreenshot_PlaybackRenderer_Type  type, ::UnityEngine::Color  backgroundColor) ;
...
/// @brief Method .ctor, addr 0x5756eec, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method get_backgroundColor, addr 0x5756ee0, size 0xc, virtual false, abstract: false, final false
inline ::UnityEngine::Color get_backgroundColor() ;

/// @brief Method get_layerMask, addr 0x5756ec0, size 0x8, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask get_layerMask() ;

/// @brief Method get_name, addr 0x5756eb0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_name() ;

/// @brief Method get_path, addr 0x5756ed0, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_path() ;

/// @brief Method get_texture, addr 0x5756eb8, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::RenderTexture> get_texture() ;

/// @brief Method get_type, addr 0x5756ec8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::PlaybackScreenshot_PlaybackRenderer_Type get_type() ;

/// @brief Method set_path, addr 0x5756ed8, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _cameraCalibration, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__cameraCalibration, put=__cordl_internal_set__cameraCalibration)) ::GlobalNamespace::PosesRecordingData_ExternalCameraCalibration*  _cameraCalibration;
...
/// @brief Field _screenshots, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__screenshots, put=__cordl_internal_set__screenshots)) ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*,::Array<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>*>  _screenshots;
...
/// @brief Method CreateClipQuad, addr 0x5756220, size 0x28c, virtual false, abstract: false, final false
inline void CreateClipQuad() ;

/// @brief Method CreateTextures, addr 0x57564ac, size 0x68, virtual false, abstract: false, final false
inline void CreateTextures(int32_t  width, int32_t  height) ;

/// @brief Method GetDistanceToHMD, addr 0x57565dc, size 0x32c, virtual false, abstract: false, final false
inline float_t GetDistanceToHMD() ;

/// @brief Method InitCamera, addr 0x5756138, size 0xe8, virtual false, abstract: false, final false
...
/// @brief Method LateUpdate, addr 0x5756dfc, size 0xb0, virtual false, abstract: false, final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::PlaybackRenderer* New_ctor() ;

/// @brief Method OrientClipQuad, addr 0x5756908, size 0x13c, virtual false, abstract: false, final false
inline void OrientClipQuad() ;

/// @brief Method RenderBackground, addr 0x5756c6c, size 0x190, virtual false, abstract: false, final false
inline void RenderBackground(::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*  screenshot) ;

/// @brief Method RenderForeground, addr 0x5756a44, size 0x228, virtual false, abstract: false, final false
inline void RenderForeground(::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*  screenshot) ;

/// @brief Method Setup, addr 0x5755650, size 0x88, virtual false, abstract: false, final false
inline void Setup(::UnityEngine::Camera*  hmdCamera, ::UnityEngine::Camera*  camera, ::GlobalNamespace::PosesRecordingData_ExternalCameraCalibration*  cameraCalibration, int32_t  textureWidth, int32_t  textureHeight, ::ArrayW<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*,::Array<::GlobalNamespace::PlaybackRenderer_PlaybackScreenshot*>*>  screenshots) ;
...
/// @brief Method .ctor, addr 0x5756eac, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_texturesReadyEvent, addr 0x5755fd8, size 0xac, virtual false, abstract: false, final false
inline void add_texturesReadyEvent(::System::Action*  value) ;

/// @brief Method get_screenshots, addr 0x5756130, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method remove_texturesReadyEvent, addr 0x5756084, size 0xac, virtual false, abstract: false, final false
