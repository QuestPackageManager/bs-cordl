...
public:
  ...
  /// @brief Method CreateTexture, addr 0x23f76c4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f7f30, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method get_backgroundColor, addr 0x23f7f24, size 0xc, virtual false, abstract: false, final false
  inline ::UnityEngine::Color get_backgroundColor();

  /// @brief Method get_layerMask, addr 0x23f7f04, size 0x8, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask get_layerMask();

  /// @brief Method get_name, addr 0x23f7ef4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_name();

  /// @brief Method get_path, addr 0x23f7f14, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_path();

  /// @brief Method get_texture, addr 0x23f7efc, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::RenderTexture> get_texture();

  /// @brief Method get_type, addr 0x23f7f0c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot__Type get_type();

  /// @brief Method set_path, addr 0x23f7f1c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateClipQuad, addr 0x23f73d0, size 0x280, virtual false, abstract: false, final false
  inline void CreateClipQuad();

  /// @brief Method CreateTextures, addr 0x23f7650, size 0x74, virtual false, abstract: false, final false
  inline void CreateTextures(int32_t width, int32_t height);

  /// @brief Method GetDistanceToHMD, addr 0x23f7788, size 0x26c, virtual false, abstract: false, final false
  inline float_t GetDistanceToHMD();

  /// @brief Method InitCamera, addr 0x23f72c0, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method LateUpdate, addr 0x23f7e48, size 0xa4, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::PlaybackRenderer* New_ctor();

  /// @brief Method OrientClipQuad, addr 0x23f79f4, size 0x140, virtual false, abstract: false, final false
  inline void OrientClipQuad();

  /// @brief Method RenderBackground, addr 0x23f7cf4, size 0x154, virtual false, abstract: false, final false
  inline void RenderBackground(::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot* screenshot);

  /// @brief Method RenderForeground, addr 0x23f7b34, size 0x1c0, virtual false, abstract: false, final false
  inline void RenderForeground(::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot* screenshot);

  /// @brief Method Setup, addr 0x23f6848, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23f7eec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_texturesReadyEvent, addr 0x23f7180, size 0x9c, virtual false, abstract: false, final false
  inline void add_texturesReadyEvent(::System::Action* value);

  /// @brief Method get_screenshots, addr 0x23f72b8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_texturesReadyEvent, addr 0x23f721c, size 0x9c, virtual false, abstract: false, final false
