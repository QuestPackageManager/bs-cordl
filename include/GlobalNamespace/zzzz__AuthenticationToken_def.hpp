...
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AuthenticationToken_PlatformType, "", "AuthenticationToken/PlatformType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AuthenticationToken, "", "AuthenticationToken");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
public:
  ...
  /// @brief Method CreateFromSerializedData, addr 0x32a66dc, size 0x2c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::AuthenticationToken CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Deserialize, addr 0x32a6708, size 0x104, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::AuthenticationToken Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method FromHex, addr 0x32a65e0, size 0xfc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> FromHex(::StringW str);

  /// @brief Method FromUtf8, addr 0x32a65b0, size 0x30, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> FromUtf8(::StringW str);

  /// @brief Method GetHexVal, addr 0x32a68b8, size 0xc0, virtual false, abstract: false, final false
  static inline uint8_t GetHexVal(char16_t c);

  /// @brief Method Serialize, addr 0x32a6520, size 0x90, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToHex, addr 0x32a683c, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW ToHex(::ArrayW<uint8_t> bytes);

  /// @brief Method ToUtf8, addr 0x32a680c, size 0x30, virtual false, abstract: false, final false
  static inline ::StringW ToUtf8(::ArrayW<uint8_t> bytes);

  /// @brief Method .ctor, addr 0x32a6510, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::AuthenticationToken) == 0x20, "Size mismatch!");
