...
public:
  ...
  /// @brief Method CreateFromSerializedData, addr 0x32a4f54, size 0x2c, virtual true, abstract: false, final true
  inline ::GlobalNamespace::AuthenticationToken CreateFromSerializedData(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Deserialize, addr 0x32a4f80, size 0x104, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::AuthenticationToken Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method FromHex, addr 0x32a4e58, size 0xfc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> FromHex(::StringW str);

  /// @brief Method FromUtf8, addr 0x32a4e28, size 0x30, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> FromUtf8(::StringW str);

  /// @brief Method GetHexVal, addr 0x32a5130, size 0xc0, virtual false, abstract: false, final false
  static inline uint8_t GetHexVal(char16_t c);

  /// @brief Method Serialize, addr 0x32a4d98, size 0x90, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method ToHex, addr 0x32a50b4, size 0x7c, virtual false, abstract: false, final false
  static inline ::StringW ToHex(::ArrayW<uint8_t> bytes);

  /// @brief Method ToUtf8, addr 0x32a5084, size 0x30, virtual false, abstract: false, final false
  static inline ::StringW ToUtf8(::ArrayW<uint8_t> bytes);

  /// @brief Method .ctor, addr 0x32a4d88, size 0x10, virtual false, abstract: false, final false
