...
public:
  ...
  /// @brief Method MoveNext, addr 0x2a95ea4, size 0x11c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::__OVRScreenFade___Fade_d__25* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x2a95fc0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x2a95fc8, size 0x40, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x2a96008, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x2a95ea0, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2a95e4c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Fade, addr 0x2a95ae8, size 0x7c, virtual false, abstract: false, final false
  inline ::System::Collections::IEnumerator* Fade(float_t startAlpha, float_t endAlpha);

  /// @brief Method FadeIn, addr 0x2a95ac0, size 0x28, virtual false, abstract: false, final false
  inline void FadeIn();

  /// @brief Method FadeOut, addr 0x2a95b64, size 0x28, virtual false, abstract: false, final false
  inline void FadeOut();

  static inline ::GlobalNamespace::OVRScreenFade* New_ctor();

  /// @brief Method OnDestroy, addr 0x2a95bcc, size 0x154, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnEnable, addr 0x2a95bb4, size 0x18, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method OnLevelFinishedLoading, addr 0x2a95b8c, size 0x28, virtual false, abstract: false, final false
  inline void OnLevelFinishedLoading(int32_t level);

  /// @brief Method SetExplicitFade, addr 0x2a95e44, size 0x8, virtual false, abstract: false, final false
  inline void SetExplicitFade(float_t level);

  /// @brief Method SetMaterialAlpha, addr 0x2a95d3c, size 0x108, virtual false, abstract: false, final false
  inline void SetMaterialAlpha();

  /// @brief Method SetUIFade, addr 0x2a95d20, size 0x1c, virtual false, abstract: false, final false
  inline void SetUIFade(float_t level);

  /// @brief Method Start, addr 0x2a95624, size 0x49c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2a95e74, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::GlobalNamespace::OVRScreenFade> getStaticF__instance_k__BackingField();

  /// @brief Method get_currentAlpha, addr 0x2a95568, size 0xbc, virtual false, abstract: false, final false
  inline float_t get_currentAlpha();

  /// @brief Method get_instance, addr 0x2a954d4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_instance, addr 0x2a9551c, size 0x4c, virtual false, abstract: false, final false
