...
public:
  ...
  /// @brief Method .ctor, addr 0x3ad8730, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_menuEnvironmentType, addr 0x3ad8720, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType get_menuEnvironmentType();

  /// @brief Method get_wrapper, addr 0x3ad8728, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ShowEnvironmentType, addr 0x3ad8590, size 0x188, virtual false, abstract: false, final false
  inline void ShowEnvironmentType(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType menuEnvironmentType);

  /// @brief Method Start, addr 0x3ad8588, size 0x8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3ad8718, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
