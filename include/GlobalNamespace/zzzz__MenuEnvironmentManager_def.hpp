...
public:
  ...
  /// @brief Method .ctor, addr 0x5783a28, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_menuEnvironmentType, addr 0x5783a18, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType get_menuEnvironmentType();

  /// @brief Method get_wrapper, addr 0x5783a20, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ShowEnvironmentType, addr 0x5783888, size 0x18c, virtual false, abstract: false, final false
  inline void ShowEnvironmentType(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType menuEnvironmentType);

  /// @brief Method Start, addr 0x5783880, size 0x8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5783a14, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
