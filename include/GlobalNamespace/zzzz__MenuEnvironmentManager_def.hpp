...
public:
  ...
  /// @brief Method .ctor, addr 0x23890c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_menuEnvironmentType, addr 0x23890b8, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType get_menuEnvironmentType();

  /// @brief Method get_wrapper, addr 0x23890c0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ShowEnvironmentType, addr 0x2388f30, size 0x180, virtual false, abstract: false, final false
  inline void ShowEnvironmentType(::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType menuEnvironmentType);

  /// @brief Method Start, addr 0x2388f28, size 0x8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x23890b0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
