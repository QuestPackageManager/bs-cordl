...
/// @brief Field _menuEnvironmentType, offset 0x10, size 0x4 
 __declspec(property(get=__cordl_internal_get__menuEnvironmentType, put=__cordl_internal_set__menuEnvironmentType)) ::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType  _menuEnvironmentType;
...
/// @brief Method .ctor, addr 0x5714180, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_menuEnvironmentType, addr 0x5714170, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType get_menuEnvironmentType() ;

/// @brief Method get_wrapper, addr 0x5714178, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field _data, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__data, put=__cordl_internal_set__data)) ::ArrayW<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*,::Array<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*>*>  _data;

/// @brief Field _prevMenuEnvironmentType, offset 0x28, size 0x4 
 __declspec(property(get=__cordl_internal_get__prevMenuEnvironmentType, put=__cordl_internal_set__prevMenuEnvironmentType)) ::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType  _prevMenuEnvironmentType;

static inline ::GlobalNamespace::MenuEnvironmentManager* New_ctor() ;

/// @brief Method ShowEnvironmentType, addr 0x5713fe0, size 0x18c, virtual false, abstract: false, final false
inline void ShowEnvironmentType(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType  menuEnvironmentType) ;

/// @brief Method Start, addr 0x5713fd8, size 0x8, virtual false, abstract: false, final false
inline void Start() ;

constexpr ::ArrayW<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*,::Array<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*>*> const& __cordl_internal_get__data() const;
...
constexpr void __cordl_internal_set__data(::ArrayW<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*,::Array<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*>*>  value) ;
...
/// @brief Method .ctor, addr 0x571416c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
