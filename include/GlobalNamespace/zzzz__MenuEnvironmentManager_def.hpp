...
MARK_REF_T(::GlobalNamespace::MenuEnvironmentManager*);
MARK_REF_T(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType, "", "MenuEnvironmentManager/MenuEnvironmentType");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MenuEnvironmentManager*, "", "MenuEnvironmentManager");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*, "", "MenuEnvironmentManager/MenuEnvironmentObjects");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58c1e0c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_menuEnvironmentType, addr 0x58c1dfc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType get_menuEnvironmentType();

  /// @brief Method get_wrapper, addr 0x58c1e04, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects) == 0x20, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies MenuEnvironmentManager::MenuEnvironmentObjects, MenuEnvironmentManager::MenuEnvironmentType, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__data, put = __cordl_internal_set__data)) ::ArrayW<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*> _data;
  ...
  /// @brief Method ShowEnvironmentType, addr 0x58c1c6c, size 0x18c, virtual false, abstract: false, final false
  inline void ShowEnvironmentType(::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentType menuEnvironmentType);

  /// @brief Method Start, addr 0x58c1c64, size 0x8, virtual false, abstract: false, final false
  inline void Start();

  constexpr ::ArrayW<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*> const& __cordl_internal_get__data() const;

  constexpr ::ArrayW<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*>& __cordl_internal_get__data();
  ...
  constexpr void __cordl_internal_set__data(::ArrayW<::GlobalNamespace::MenuEnvironmentManager_MenuEnvironmentObjects*> value);
  ...
  /// @brief Method .ctor, addr 0x58c1df8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MenuEnvironmentManager) == 0x30, "Size mismatch!");
