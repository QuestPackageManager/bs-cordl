...
public:
  ...
  /// @brief Method .ctor, addr 0x2624eb0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_menuEnvironmentType, addr 0x2624ea0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType get_menuEnvironmentType();

  /// @brief Method get_wrapper, addr 0x2624ea8, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ShowEnvironmentType, addr 0x2624d18, size 0x180, virtual false, abstract: false, final false
  inline void ShowEnvironmentType(::GlobalNamespace::__MenuEnvironmentManager__MenuEnvironmentType menuEnvironmentType);

  /// @brief Method Start, addr 0x2624d10, size 0x8, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2624e98, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
