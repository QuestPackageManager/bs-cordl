...
// Write type traits
MARK_GEN_REF_T_PTR(::GlobalNamespace::AsyncComputeOperation_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::GlobalNamespace::AsyncComputeOperation_1, "", "AsyncComputeOperation`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AsyncComputeOperation_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AsyncComputeOperation_1(AsyncComputeOperation_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AsyncComputeOperation_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AsyncComputeOperation_1(AsyncComputeOperation_1const&) = delete;
