...
// Write type traits
MARK_REF_T(::GlobalNamespace::LanguageFactory*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LanguageFactory*, "", "LanguageFactory");
...
public:
  ...
  /// @brief Method Create, addr 0x3775d60, size 0x154, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3775d54, size 0xc, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LanguageFactory", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LanguageFactory(LanguageFactory&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LanguageFactory", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LanguageFactory(LanguageFactoryconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::LanguageFactory) == 0x28, "Size mismatch!");
