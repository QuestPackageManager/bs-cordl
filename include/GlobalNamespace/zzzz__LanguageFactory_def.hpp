...
/// @brief Method Create, addr 0x36758c4, size 0x154, virtual true, abstract: false, final true
inline ::BGLib::Polyglot::LocalizationLanguage Create() ;

static inline ::GlobalNamespace::LanguageFactory* New_ctor(::GlobalNamespace::PlayerDataModel*  playerDataModel, ::GlobalNamespace::SettingsManager*  settingsManager, ::OculusStudios::Platform::Core::IPlatform*  platform) ;
...
/// @brief Method .ctor, addr 0x36758b8, size 0xc, virtual false, abstract: false, final false
