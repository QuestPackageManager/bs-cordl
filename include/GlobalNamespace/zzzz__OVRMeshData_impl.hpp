...
// Ctor Parameters [CppParam { name: "mesh", ty: "::UnityW<::UnityEngine::Mesh>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "material", ty:
// "::UnityW<::UnityEngine::Material>", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "baseAttributes", ty: "::GlobalNamespace::OVRMeshAttributes", modifiers: "", def_value:
// Some("{}"), comment: None }, CppParam { name: "morphTargets", ty: "::ArrayW<::GlobalNamespace::OVRMeshAttributes>", modifiers: "", def_value: Some("{}"), comment: None }]
