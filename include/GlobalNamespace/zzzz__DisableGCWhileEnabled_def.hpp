...
public:
  ...
  /// @brief Method OnDisable, addr 0x39c1ee0, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39c1ed4, size 0xc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x39c1eec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
