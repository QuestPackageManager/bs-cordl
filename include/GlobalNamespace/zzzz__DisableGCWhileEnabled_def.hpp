...
public:
  ...
  /// @brief Method OnDisable, addr 0x563c54c, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x563c540, size 0xc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x563c558, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
