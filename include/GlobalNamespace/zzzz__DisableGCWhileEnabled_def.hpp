...
public:
  ...
  /// @brief Method OnDisable, addr 0x39c7624, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x39c7618, size 0xc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x39c7630, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
