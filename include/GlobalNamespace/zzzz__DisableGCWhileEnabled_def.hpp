...
public:
  ...
  /// @brief Method OnDisable, addr 0x570efb0, size 0xc, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x570efa4, size 0xc, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method .ctor, addr 0x570efbc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
