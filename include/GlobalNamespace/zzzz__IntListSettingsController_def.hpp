...
public:
  ...
  /// @brief Method ApplyValue, addr 0x253c068, size 0x20, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x253c050, size 0x18, virtual true, abstract: false, final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  /// @brief Method InitValues, addr 0x253c030, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method TextForValue, addr 0x253c088, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x253c0a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueChangedEvent, addr 0x253bed0, size 0xb0, virtual false, abstract: false, final false
  inline void add_valueChangedEvent(::System::Action_1<int32_t>* value);

  /// @brief Method remove_valueChangedEvent, addr 0x253bf80, size 0xb0, virtual false, abstract: false, final false
