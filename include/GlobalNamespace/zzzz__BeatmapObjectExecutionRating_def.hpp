...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapObjectExecutionRating", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapObjectExecutionRating(BeatmapObjectExecutionRating&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapObjectExecutionRating", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapObjectExecutionRating(BeatmapObjectExecutionRatingconst&) = delete;
