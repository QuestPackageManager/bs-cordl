...
public:
  ...
  /// @brief Method Equals, addr 0x5cdbe4c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method Equals, addr 0x5cdbcfc, size 0x6c, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::OVRDynamicObject other);

  /// @brief Method GetHashCode, addr 0x5cdbedc, size 0x70, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IOVRAnchorComponent<OVRDynamicObject>.FromAnchor, addr 0x5cdbacc, size 0x30, virtual true, abstract: false, final true
  ...
  /// @brief Method IOVRAnchorComponent<OVRDynamicObject>.SetEnabledAsync, addr 0x5cdbcb0, size 0x4c, virtual true, abstract: false, final true
  ...
  /// @brief Method IOVRAnchorComponent<OVRDynamicObject>.get_Handle, addr 0x5cdba74, size 0x58, virtual true, abstract: false, final true
  inline uint64_t IOVRAnchorComponent_OVRDynamicObject__get_Handle();

  /// @brief Method IOVRAnchorComponent<OVRDynamicObject>.get_Type, addr 0x5cdba10, size 0x58, virtual true, abstract: false, final true
  inline ::GlobalNamespace::OVRPlugin_SpaceComponentType IOVRAnchorComponent_OVRDynamicObject__get_Type();

  /// @brief Method ToString, addr 0x5cdbf4c, size 0xc0, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method .ctor, addr 0x5cdbafc, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::OVRAnchor anchor);

  static inline ::GlobalNamespace::OVRDynamicObject getStaticF_Null();

  /// @brief Method get_Handle, addr 0x5cdc00c, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_Handle();

  /// @brief Method get_IsEnabled, addr 0x5cdbbc4, size 0xec, virtual true, abstract: false, final true
  inline bool get_IsEnabled();

  /// @brief Method get_IsNull, addr 0x5cdbb64, size 0x60, virtual true, abstract: false, final true
  inline bool get_IsNull();

  /// @brief Method get_TrackableType, addr 0x5cdc014, size 0xb4, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRAnchor_TrackableType get_TrackableType();

  /// @brief Method get_Type, addr 0x5cdba68, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x5cdbd68, size 0x70, virtual false, abstract: false, final false
  static inline bool op_Equality(::GlobalNamespace::OVRDynamicObject lhs, ::GlobalNamespace::OVRDynamicObject rhs);

  /// @brief Method op_Inequality, addr 0x5cdbdd8, size 0x74, virtual false, abstract: false, final false
