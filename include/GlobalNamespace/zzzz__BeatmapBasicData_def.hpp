...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapBasicData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapBasicData*, "", "BeatmapBasicData");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_lighters, put = __cordl_internal_set_lighters)) ::ArrayW<::StringW> lighters;

  /// @brief Field mappers, offset 0x38, size 0x8
  __declspec(property(get = __cordl_internal_get_mappers, put = __cordl_internal_set_mappers)) ::ArrayW<::StringW> mappers;
  ...
  static inline ::GlobalNamespace::BeatmapBasicData* New_ctor(float_t noteJumpMovementSpeed, float_t noteJumpStartBeatOffset, ::GlobalNamespace::EnvironmentName environmentName,
                                                              ...
                                                              int32_t bombsCount, ::ArrayW<::StringW> mappers, ::ArrayW<::StringW> lighters);
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_lighters() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_lighters();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_mappers() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_mappers();
  ...
  constexpr void __cordl_internal_set_lighters(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set_mappers(::ArrayW<::StringW> value);
  ...
  /// @brief Method .ctor, addr 0x3720bb4, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor(float_t noteJumpMovementSpeed, float_t noteJumpStartBeatOffset, ::GlobalNamespace::EnvironmentName environmentName, ::GlobalNamespace::ColorScheme* beatmapColorScheme,
                    int32_t notesCount, int32_t cuttableObjectsCount, int32_t obstaclesCount, int32_t bombsCount, ::ArrayW<::StringW> mappers, ::ArrayW<::StringW> lighters);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapBasicData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapBasicData(BeatmapBasicData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapBasicData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapBasicData(BeatmapBasicDataconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::BeatmapBasicData) == 0x48, "Size mismatch!");
