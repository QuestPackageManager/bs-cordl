...
template <typename TKey, typename TValue> inline bool GlobalNamespace::ExpiringDictionary_2<TKey, TValue>::TryGetValue(TKey key, ::by_ref<TValue> value) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ExpiringDictionary_2<TKey, TValue>*>(),
...
template <typename TKey, typename TValue> inline bool GlobalNamespace::ExpiringDictionary_2<TKey, TValue>::TryGetValueAndResetExpiration(TKey key, ::by_ref<TValue> value) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::ExpiringDictionary_2<TKey, TValue>*>(),
