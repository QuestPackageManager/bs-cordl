...
public:
  ...
  /// @brief Method Start, addr 0x26ff4ec, size 0x38, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x26ff524, size 0x310, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x26ff834, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
