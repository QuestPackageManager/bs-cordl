...
public:
  ...
  /// @brief Method Start, addr 0x5862218, size 0x38, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x5862250, size 0x400, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5862650, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
