...
public:
  // Declarations
  /// @brief Field _environmentLayerMask, offset 0x20, size 0x4
  ...
  /// @brief Field _hitPointDistanceToAlphaCurve, offset 0x40, size 0x8
  ...
  /// @brief Field _hitPointGameObject, offset 0x28, size 0x8
  ...
  /// @brief Field _hitPointLightWithId, offset 0x38, size 0x8
  ...
  /// @brief Field _showHitPoint, offset 0x24, size 0x1
  ...
  /// @brief Method Start, addr 0x26eaff4, size 0x38, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x26eb02c, size 0x314, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x26eb340, size 0x34, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _environmentLayerMask, offset: 0x20, size: 0x4, def value: None
  ::UnityEngine::LayerMask ____environmentLayerMask;

  /// @brief Field _showHitPoint, offset: 0x24, size: 0x1, def value: None
  bool ____showHitPoint;

  /// @brief Field _hitPointGameObject, offset: 0x28, size: 0x8, def value: None
  ::UnityW<::UnityEngine::GameObject> ____hitPointGameObject;

  /// @brief Field _hitPointTransform, offset: 0x30, size: 0x8, def value: None
  ::UnityW<::UnityEngine::Transform> ____hitPointTransform;

  /// @brief Field _hitPointLightWithId, offset: 0x38, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::InstancedMaterialLightWithId> ____hitPointLightWithId;

  /// @brief Field _hitPointDistanceToAlphaCurve, offset: 0x40, size: 0x8, def value: None
  ...
  /// @brief Field _hitPointState, offset: 0x50, size: 0x1, def value: None
  bool ____hitPointState;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, 0x58>, "Size mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____tubeBloomPrePassLight) == 0x18, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____environmentLayerMask) == 0x20, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____showHitPoint) == 0x24, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____hitPointGameObject) == 0x28, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____hitPointTransform) == 0x30, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____hitPointLightWithId) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____hitPointDistanceToAlphaCurve) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____transform) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::TubeBloomPrePassLightCollisionEffect, ____hitPointState) == 0x50, "Offset mismatch!");
