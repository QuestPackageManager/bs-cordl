...
public:
  // Declarations
  /// @brief Field <beatmapKey>k__BackingField, offset 0x48, size 0x20
  ...
  /// @brief Field <originalEnvironmentInfo>k__BackingField, offset 0x98, size 0x8
  ...
  /// @brief Field <targetEnvironmentInfo>k__BackingField, offset 0x90, size 0x8
  ...
  /// @brief Method Finish, addr 0x57223f8, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::LevelCompletionResults* levelCompletionResults);

  /// @brief Method GetColorInfo, addr 0x572235c, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentInfo, addr 0x5722190, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetEnvironmentOverride, addr 0x5722420, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x571cdc0, size 0x3d4, virtual false, abstract: false, final false
  inline void Init(::StringW gameMode, ::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey, ::GlobalNamespace::BeatmapLevel* beatmapLevel,
                   ...
                   bool useTestNoteCutSoundEffects, bool startPaused, ::GlobalNamespace::BeatmapLevelsModel* beatmapLevelsModel, ::GlobalNamespace::IBeatmapLevelData* beatmapLevelData,
  ...
  /// @brief Method .ctor, addr 0x57224e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x571f2fc, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapKey, addr 0x57220f0, size 0x10, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_beatmapLevel, addr 0x5722110, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel();

  /// @brief Method get_colorScheme, addr 0x5722140, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorScheme* get_colorScheme();

  /// @brief Method get_gameMode, addr 0x57220e0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_gameMode();

  /// @brief Method get_gameplayModifiers, addr 0x5722180, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_originalEnvironmentInfo, addr 0x5722170, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_originalEnvironmentInfo();

  /// @brief Method get_practiceSettings, addr 0x5722120, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method get_targetEnvironmentInfo, addr 0x5722160, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_targetEnvironmentInfo();

  /// @brief Method get_usingOverrideColorScheme, addr 0x5722130, size 0x8, virtual false, abstract: false, final false
  inline bool get_usingOverrideColorScheme();

  /// @brief Method get_usingOverrideEnvironment, addr 0x5722150, size 0x8, virtual false, abstract: false, final false
  inline bool get_usingOverrideEnvironment();

  /// @brief Method remove_didFinishEvent, addr 0x571f7f8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_beatmapKey, addr 0x5722100, size 0x10, virtual false, abstract: false, final false
  inline void set_beatmapKey(::GlobalNamespace::BeatmapKey value);

  /// @brief Method set_beatmapLevel, addr 0x5722118, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevel(::GlobalNamespace::BeatmapLevel* value);

  /// @brief Method set_colorScheme, addr 0x5722148, size 0x8, virtual false, abstract: false, final false
  inline void set_colorScheme(::GlobalNamespace::ColorScheme* value);

  /// @brief Method set_gameMode, addr 0x57220e8, size 0x8, virtual false, abstract: false, final false
  inline void set_gameMode(::StringW value);

  /// @brief Method set_gameplayModifiers, addr 0x5722188, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_originalEnvironmentInfo, addr 0x5722178, size 0x8, virtual false, abstract: false, final false
  inline void set_originalEnvironmentInfo(::GlobalNamespace::EnvironmentInfoSO* value);

  /// @brief Method set_practiceSettings, addr 0x5722128, size 0x8, virtual false, abstract: false, final false
  inline void set_practiceSettings(::GlobalNamespace::PracticeSettings* value);

  /// @brief Method set_targetEnvironmentInfo, addr 0x5722168, size 0x8, virtual false, abstract: false, final false
  inline void set_targetEnvironmentInfo(::GlobalNamespace::EnvironmentInfoSO* value);

  /// @brief Method set_usingOverrideColorScheme, addr 0x5722138, size 0x8, virtual false, abstract: false, final false
  inline void set_usingOverrideColorScheme(bool value);

  /// @brief Method set_usingOverrideEnvironment, addr 0x5722158, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field <beatmapKey>k__BackingField, offset: 0x48, size: 0x20, def value: None
  ...
  /// @brief Field <targetEnvironmentInfo>k__BackingField, offset: 0x90, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::EnvironmentInfoSO> ____targetEnvironmentInfo_k__BackingField;

  /// @brief Field <originalEnvironmentInfo>k__BackingField, offset: 0x98, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO, ___didFinishEvent) == 0x38, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO, ____gameMode_k__BackingField) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO, ____beatmapKey_k__BackingField) == 0x48, "Offset mismatch!");
...
static_assert(offsetof(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO, ____targetEnvironmentInfo_k__BackingField) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO, ____originalEnvironmentInfo_k__BackingField) == 0x98, "Offset mismatch!");
