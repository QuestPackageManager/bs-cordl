...
public:
  ...
  /// @brief Method <InitEnvironmentInfo>b__0, addr 0x3b3a630, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3a620, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Finish, addr 0x3b3a5f8, size 0x28, virtual false, abstract: false, final false
  inline void Finish(::GlobalNamespace::LevelCompletionResults* levelCompletionResults);

  /// @brief Method Init, addr 0x3b37d64, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method Init, addr 0x3b3487c, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method InitAndSetupScenes, addr 0x3b3a340, size 0x2b8, virtual false, abstract: false, final false
  ...
  /// @brief Method InitColorInfo, addr 0x3b3a2ec, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method InitEnvironmentInfo, addr 0x3b3a0a8, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b3a628, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b36f44, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_beatmapKey, addr 0x3b39ff8, size 0x14, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapKey get_beatmapKey();

  /// @brief Method get_beatmapLevel, addr 0x3b3a020, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapLevel* get_beatmapLevel();

  /// @brief Method get_colorScheme, addr 0x3b3a054, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorScheme* get_colorScheme();

  /// @brief Method get_gameMode, addr 0x3b39fe8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_gameMode();

  /// @brief Method get_gameplayModifiers, addr 0x3b3a098, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_originalEnvironmentInfo, addr 0x3b3a088, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_originalEnvironmentInfo();

  /// @brief Method get_practiceSettings, addr 0x3b3a030, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method get_targetEnvironmentInfo, addr 0x3b3a078, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_targetEnvironmentInfo();

  /// @brief Method get_usingOverrideColorScheme, addr 0x3b3a040, size 0x8, virtual false, abstract: false, final false
  inline bool get_usingOverrideColorScheme();

  /// @brief Method get_usingOverrideEnvironment, addr 0x3b3a064, size 0x8, virtual false, abstract: false, final false
  inline bool get_usingOverrideEnvironment();

  /// @brief Method remove_didFinishEvent, addr 0x3b37424, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method set_beatmapKey, addr 0x3b3a00c, size 0x14, virtual false, abstract: false, final false
  inline void set_beatmapKey(::GlobalNamespace::BeatmapKey value);

  /// @brief Method set_beatmapLevel, addr 0x3b3a028, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapLevel(::GlobalNamespace::BeatmapLevel* value);

  /// @brief Method set_colorScheme, addr 0x3b3a05c, size 0x8, virtual false, abstract: false, final false
  inline void set_colorScheme(::GlobalNamespace::ColorScheme* value);

  /// @brief Method set_gameMode, addr 0x3b39ff0, size 0x8, virtual false, abstract: false, final false
  inline void set_gameMode(::StringW value);

  /// @brief Method set_gameplayModifiers, addr 0x3b3a0a0, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_originalEnvironmentInfo, addr 0x3b3a090, size 0x8, virtual false, abstract: false, final false
  inline void set_originalEnvironmentInfo(::GlobalNamespace::EnvironmentInfoSO* value);

  /// @brief Method set_practiceSettings, addr 0x3b3a038, size 0x8, virtual false, abstract: false, final false
  inline void set_practiceSettings(::GlobalNamespace::PracticeSettings* value);

  /// @brief Method set_targetEnvironmentInfo, addr 0x3b3a080, size 0x8, virtual false, abstract: false, final false
  inline void set_targetEnvironmentInfo(::GlobalNamespace::EnvironmentInfoSO* value);

  /// @brief Method set_usingOverrideColorScheme, addr 0x3b3a048, size 0xc, virtual false, abstract: false, final false
  inline void set_usingOverrideColorScheme(bool value);

  /// @brief Method set_usingOverrideEnvironment, addr 0x3b3a06c, size 0xc, virtual false, abstract: false, final false
