...
public:
  ...
  /// @brief Method .ctor, addr 0x3b399f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_backButtonText, addr 0x3b399d0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_backButtonText();

  /// @brief Method get_beatmapCharacteristic, addr 0x3b39980, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic();

  /// @brief Method get_beatmapDifficulty, addr 0x3b39990, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty();

  /// @brief Method get_beatmapLevel, addr 0x3b39658, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapLevelSO> get_beatmapLevel();

  /// @brief Method get_colorScheme, addr 0x3b39724, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::ColorSchemeSO> get_colorScheme();

  /// @brief Method get_environmentInfo, addr 0x3b38b6c, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_environmentInfo();

  /// @brief Method get_gameplayModifiers, addr 0x3b399a0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_playerSpecificSettings, addr 0x3b399b0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings();

  /// @brief Method get_practiceSettings, addr 0x3b399c0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method get_useTestNoteCutSoundEffects, addr 0x3b399e0, size 0x8, virtual false, abstract: false, final false
  inline bool get_useTestNoteCutSoundEffects();

  /// @brief Method set_backButtonText, addr 0x3b399d8, size 0x8, virtual false, abstract: false, final false
  inline void set_backButtonText(::StringW value);

  /// @brief Method set_beatmapCharacteristic, addr 0x3b39988, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO* value);

  /// @brief Method set_beatmapDifficulty, addr 0x3b39998, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapDifficulty(::GlobalNamespace::BeatmapDifficulty value);

  /// @brief Method set_gameplayModifiers, addr 0x3b399a8, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_playerSpecificSettings, addr 0x3b399b8, size 0x8, virtual false, abstract: false, final false
  inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method set_practiceSettings, addr 0x3b399c8, size 0x8, virtual false, abstract: false, final false
  inline void set_practiceSettings(::GlobalNamespace::PracticeSettings* value);

  /// @brief Method set_useTestNoteCutSoundEffects, addr 0x3b399e8, size 0xc, virtual false, abstract: false, final false
