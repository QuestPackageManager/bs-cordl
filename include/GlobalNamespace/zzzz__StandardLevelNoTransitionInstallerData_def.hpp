...
public:
  ...
  /// @brief Method .ctor, addr 0x57ebb14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_backButtonText, addr 0x57ebaf4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_backButtonText();

  /// @brief Method get_beatmapCharacteristic, addr 0x57ebaa4, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapCharacteristicSO> get_beatmapCharacteristic();

  /// @brief Method get_beatmapDifficulty, addr 0x57ebab4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty();

  /// @brief Method get_beatmapLevel, addr 0x57eb4d8, size 0xd0, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::BeatmapLevelSO> get_beatmapLevel();

  /// @brief Method get_colorScheme, addr 0x57eb5a8, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::ColorSchemeSO> get_colorScheme();

  /// @brief Method get_environmentInfo, addr 0x57ea414, size 0xd4, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::EnvironmentInfoSO> get_environmentInfo();

  /// @brief Method get_gameplayModifiers, addr 0x57ebac4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_playerSpecificSettings, addr 0x57ebad4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings();

  /// @brief Method get_practiceSettings, addr 0x57ebae4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PracticeSettings* get_practiceSettings();

  /// @brief Method get_useTestNoteCutSoundEffects, addr 0x57ebb04, size 0x8, virtual false, abstract: false, final false
  inline bool get_useTestNoteCutSoundEffects();

  /// @brief Method set_backButtonText, addr 0x57ebafc, size 0x8, virtual false, abstract: false, final false
  inline void set_backButtonText(::StringW value);

  /// @brief Method set_beatmapCharacteristic, addr 0x57ebaac, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO* value);

  /// @brief Method set_beatmapDifficulty, addr 0x57ebabc, size 0x8, virtual false, abstract: false, final false
  inline void set_beatmapDifficulty(::GlobalNamespace::BeatmapDifficulty value);

  /// @brief Method set_gameplayModifiers, addr 0x57ebacc, size 0x8, virtual false, abstract: false, final false
  inline void set_gameplayModifiers(::GlobalNamespace::GameplayModifiers* value);

  /// @brief Method set_playerSpecificSettings, addr 0x57ebadc, size 0x8, virtual false, abstract: false, final false
  inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings* value);

  /// @brief Method set_practiceSettings, addr 0x57ebaec, size 0x8, virtual false, abstract: false, final false
  inline void set_practiceSettings(::GlobalNamespace::PracticeSettings* value);

  /// @brief Method set_useTestNoteCutSoundEffects, addr 0x57ebb0c, size 0x8, virtual false, abstract: false, final false
