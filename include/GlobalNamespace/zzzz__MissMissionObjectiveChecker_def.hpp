...
public:
  ...
  /// @brief Method HandleNoteWasMissed, addr 0x3bb9478, size 0x70, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method Init, addr 0x3bb92a4, size 0x144, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::MissMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x3bb93e8, size 0x90, virtual false, abstract: false, final false
