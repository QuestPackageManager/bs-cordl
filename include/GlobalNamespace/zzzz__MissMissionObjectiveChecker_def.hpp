...
public:
  ...
  /// @brief Method Init, addr 0x23cd194, size 0x14c, virtual true, abstract: false, final false
  inline void Init();

  /// @brief Method OnDestroy, addr 0x23cd2e0, size 0x98, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method HandleNoteWasMissed, addr 0x23cd378, size 0x70, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  static inline ::GlobalNamespace::MissMissionObjectiveChecker* New_ctor();

  /// @brief Method .ctor, addr 0x23cd3e8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
