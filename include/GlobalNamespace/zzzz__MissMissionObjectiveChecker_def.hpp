...
public:
  ...
  /// @brief Method Init addr 0x20eb684 size 0x14c virtual true final false
  inline void Init();

  /// @brief Method OnDestroy addr 0x20eb7d0 size 0x98 virtual false final false
  inline void OnDestroy();

  /// @brief Method HandleNoteWasMissed addr 0x20eb868 size 0x70 virtual false final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  static inline ::GlobalNamespace::MissMissionObjectiveChecker* New_ctor();

  /// @brief Method .ctor addr 0x20eb8d8 size 0x8 virtual false final false
  inline void _ctor();
