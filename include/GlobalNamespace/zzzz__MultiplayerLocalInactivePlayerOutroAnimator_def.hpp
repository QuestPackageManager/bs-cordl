...
public:
  ...
  /// @brief Method Start, addr 0x3bc0cac, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bc0ce8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
