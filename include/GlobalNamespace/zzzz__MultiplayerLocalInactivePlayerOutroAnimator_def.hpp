...
public:
  ...
  /// @brief Method Start, addr 0x26fd9b0, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x26fd9ec, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
