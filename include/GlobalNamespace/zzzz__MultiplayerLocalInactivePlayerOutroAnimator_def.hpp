...
public:
  ...
  /// @brief Method Start, addr 0x581d364, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x581d3a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
