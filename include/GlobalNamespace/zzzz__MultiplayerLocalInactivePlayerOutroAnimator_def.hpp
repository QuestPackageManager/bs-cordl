...
public:
  ...
  /// @brief Method Start, addr 0x59c2288, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x59c22c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
