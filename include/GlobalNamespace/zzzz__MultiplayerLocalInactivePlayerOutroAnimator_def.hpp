...
public:
  ...
  /// @brief Method Start, addr 0x25f7b84, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x25f7bc0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
