...
public:
  ...
  /// @brief Method Start, addr 0x588fbe0, size 0x3c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x588fc1c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
