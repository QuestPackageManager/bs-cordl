...
public:
  ...
  /// @brief Method Update, addr 0x584a20c, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x584a268, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
