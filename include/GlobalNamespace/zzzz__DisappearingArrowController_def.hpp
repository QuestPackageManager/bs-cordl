...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4093)), TypeDefinitionIndex(TypeDefinitionIndex(4095)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4093), inst: 312
// })] Self: TypeDefinitionIndex(TypeDefinitionIndex(4092)) CS Name: ::DisappearingArrowController*
...
public:
  ...
  /// @brief Method get_gameNoteController, addr 0x22cc410, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22cc418, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor();
