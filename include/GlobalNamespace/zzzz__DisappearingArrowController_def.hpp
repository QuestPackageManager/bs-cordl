...
// Write type traits
MARK_REF_T(::GlobalNamespace::DisappearingArrowController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::DisappearingArrowController*, "", "DisappearingArrowController");
...
static_assert(sizeof(::GlobalNamespace::DisappearingArrowController) == 0x60, "Size mismatch!");
