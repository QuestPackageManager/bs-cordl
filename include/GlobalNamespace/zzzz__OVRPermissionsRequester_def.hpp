...
public:
  ...
  /// @brief Method <BuildPermissionCallbacks>b__14_0, addr 0x2a2b360, size 0xa4, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_0(::StringW permissionId);

  /// @brief Method <BuildPermissionCallbacks>b__14_1, addr 0x2a2b404, size 0xa4, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_1(::StringW permissionId);

  /// @brief Method <BuildPermissionCallbacks>b__14_2, addr 0x2a2b4a8, size 0xec, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_2(::StringW permissionId);

  /// @brief Method .ctor, addr 0x2a2b358, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildPermissionCallbacks, addr 0x2a2b0d0, size 0x224, virtual false, abstract: false, final false
  static inline ::UnityEngine::Android::PermissionCallbacks* BuildPermissionCallbacks();

  /// @brief Method GetPermissionId, addr 0x2a2a748, size 0xe4, virtual false, abstract: false, final false
  static inline ::StringW GetPermissionId(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method IsPermissionGranted, addr 0x2a2abc8, size 0x14, virtual false, abstract: false, final false
  static inline bool IsPermissionGranted(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method IsPermissionSupportedByPlatform, addr 0x2a2a82c, size 0x12c, virtual false, abstract: false, final false
  static inline bool IsPermissionSupportedByPlatform(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method Request, addr 0x2a2abdc, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestPermissions, addr 0x2a2abe0, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldRequestPermission, addr 0x2a2afd4, size 0xfc, virtual false, abstract: false, final false
  static inline bool ShouldRequestPermission(::GlobalNamespace::__OVRPermissionsRequester__Permission permission);

  /// @brief Method add_PermissionGranted, addr 0x2a2a5b0, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_PermissionGranted, addr 0x2a2a67c, size 0xcc, virtual false, abstract: false, final false
