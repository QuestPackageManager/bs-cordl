...
/// @brief Method <BuildPermissionCallbacks>b__15_0, addr 0x5cf3fd0, size 0xa8, virtual false, abstract: false, final false
inline void _BuildPermissionCallbacks_b__15_0(::StringW  permissionId) ;

/// @brief Method <BuildPermissionCallbacks>b__15_1, addr 0x5cf4078, size 0xf0, virtual false, abstract: false, final false
inline void _BuildPermissionCallbacks_b__15_1(::StringW  permissionId) ;

/// @brief Method .ctor, addr 0x5cf3fcc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method BuildPermissionCallbacks, addr 0x5cf3dcc, size 0x1ac, virtual false, abstract: false, final false
static inline ::UnityEngine::Android::PermissionCallbacks* BuildPermissionCallbacks() ;

/// @brief Method GetPermissionId, addr 0x5cf3620, size 0x11c, virtual false, abstract: false, final false
static inline ::StringW GetPermissionId(::GlobalNamespace::OVRPermissionsRequester_Permission  permission) ;

/// @brief Method IsPermissionGranted, addr 0x5cf38b0, size 0x14, virtual false, abstract: false, final false
static inline bool IsPermissionGranted(::GlobalNamespace::OVRPermissionsRequester_Permission  permission) ;

/// @brief Method IsPermissionSupportedByPlatform, addr 0x5cf373c, size 0x174, virtual false, abstract: false, final false
static inline bool IsPermissionSupportedByPlatform(::GlobalNamespace::OVRPermissionsRequester_Permission  permission) ;

/// @brief Method Request, addr 0x5cf38c4, size 0x4, virtual false, abstract: false, final false
...
/// @brief Method RequestPermissions, addr 0x5cf38c8, size 0x3d8, virtual false, abstract: false, final false
...
/// @brief Method ShouldRequestPermission, addr 0x5cf3ca0, size 0x12c, virtual false, abstract: false, final false
static inline bool ShouldRequestPermission(::GlobalNamespace::OVRPermissionsRequester_Permission  permission) ;

/// @brief Method add_PermissionGranted, addr 0x5cf3460, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method remove_PermissionGranted, addr 0x5cf3540, size 0xe0, virtual false, abstract: false, final false
