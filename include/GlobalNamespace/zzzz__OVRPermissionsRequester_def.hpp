...
public:
  ...
  /// @brief Method <BuildPermissionCallbacks>b__14_0, addr 0x3fe12d4, size 0xa4, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_0(::StringW permissionId);

  /// @brief Method <BuildPermissionCallbacks>b__14_1, addr 0x3fe1378, size 0xa4, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_1(::StringW permissionId);

  /// @brief Method <BuildPermissionCallbacks>b__14_2, addr 0x3fe141c, size 0xec, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__14_2(::StringW permissionId);

  /// @brief Method .ctor, addr 0x3fe12cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildPermissionCallbacks, addr 0x3fe1048, size 0x228, virtual false, abstract: false, final false
  static inline ::UnityEngine::Android::PermissionCallbacks* BuildPermissionCallbacks();

  /// @brief Method GetPermissionId, addr 0x3fe06b8, size 0xe0, virtual false, abstract: false, final false
  static inline ::StringW GetPermissionId(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method IsPermissionGranted, addr 0x3fe0b40, size 0x14, virtual false, abstract: false, final false
  static inline bool IsPermissionGranted(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method IsPermissionSupportedByPlatform, addr 0x3fe0798, size 0x138, virtual false, abstract: false, final false
  static inline bool IsPermissionSupportedByPlatform(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method Request, addr 0x3fe0b54, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestPermissions, addr 0x3fe0b58, size 0x3f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldRequestPermission, addr 0x3fe0f4c, size 0xfc, virtual false, abstract: false, final false
  static inline bool ShouldRequestPermission(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method add_PermissionGranted, addr 0x3fe0520, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_PermissionGranted, addr 0x3fe05ec, size 0xcc, virtual false, abstract: false, final false
