...
public:
  ...
  /// @brief Method <BuildPermissionCallbacks>b__15_0, addr 0x5d65fb8, size 0xa8, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__15_0(::StringW permissionId);

  /// @brief Method <BuildPermissionCallbacks>b__15_1, addr 0x5d66060, size 0xf0, virtual false, abstract: false, final false
  inline void _BuildPermissionCallbacks_b__15_1(::StringW permissionId);

  /// @brief Method .ctor, addr 0x5d65fb4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildPermissionCallbacks, addr 0x5d65db4, size 0x1ac, virtual false, abstract: false, final false
  static inline ::UnityEngine::Android::PermissionCallbacks* BuildPermissionCallbacks();

  /// @brief Method GetPermissionId, addr 0x5d65608, size 0x11c, virtual false, abstract: false, final false
  static inline ::StringW GetPermissionId(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method IsPermissionGranted, addr 0x5d65898, size 0x14, virtual false, abstract: false, final false
  static inline bool IsPermissionGranted(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method IsPermissionSupportedByPlatform, addr 0x5d65724, size 0x174, virtual false, abstract: false, final false
  static inline bool IsPermissionSupportedByPlatform(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method Request, addr 0x5d658ac, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method RequestPermissions, addr 0x5d658b0, size 0x3d8, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldRequestPermission, addr 0x5d65c88, size 0x12c, virtual false, abstract: false, final false
  static inline bool ShouldRequestPermission(::GlobalNamespace::OVRPermissionsRequester_Permission permission);

  /// @brief Method add_PermissionGranted, addr 0x5d65448, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_PermissionGranted, addr 0x5d65528, size 0xe0, virtual false, abstract: false, final false
