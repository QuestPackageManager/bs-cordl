...
// Write type traits
MARK_REF_T(::GlobalNamespace::GameServerPlayerTableItem*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::GameServerPlayerTableItem*, "", "GameServerPlayerTableItem");
...
public:
  ...
  /// @brief Method .ctor, addr 0x594384c, size 0x10, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GameServerPlayerTableItem", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GameServerPlayerTableItem(GameServerPlayerTableItem&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GameServerPlayerTableItem", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GameServerPlayerTableItem(GameServerPlayerTableItemconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::GameServerPlayerTableItem) == 0x30, "Size mismatch!");
