...
public:
  ...
  /// @brief Method HandleColorOverrideTypeDropdownDidSelectCellWithIdx, addr 0x57fc678, size 0x18, virtual false, abstract: false, final false
  inline void HandleColorOverrideTypeDropdownDidSelectCellWithIdx(::HMUI::DropdownWithTableView* _, int32_t idx);

  /// @brief Method HandleDropDownDidSelectCellWithIdx, addr 0x57fc1c8, size 0x1dc, virtual false, abstract: false, final false
  inline void HandleDropDownDidSelectCellWithIdx(::HMUI::DropdownWithTableView* dropDownWithTableView, int32_t idx);

  /// @brief Method HandleEditColorSchemeButtonWasPressed, addr 0x57fc690, size 0x80, virtual false, abstract: false, final false
  inline void HandleEditColorSchemeButtonWasPressed();

  /// @brief Method HandleEditColorSchemeControllerDidChangeColorScheme, addr 0x57fc778, size 0x2c, virtual false, abstract: false, final false
  inline void HandleEditColorSchemeControllerDidChangeColorScheme(::GlobalNamespace::ColorScheme* colorScheme);

  /// @brief Method HandleEditColorSchemeControllerDidFinish, addr 0x57fc724, size 0x54, virtual false, abstract: false, final false
  inline void HandleEditColorSchemeControllerDidFinish();

  /// @brief Method HandleOverrideColorsToggleValueChanged, addr 0x57fc3a4, size 0x2d4, virtual false, abstract: false, final false
  inline void HandleOverrideColorsToggleValueChanged(bool isOn);

  /// @brief Method HideDropdown, addr 0x57fc17c, size 0x4c, virtual false, abstract: false, final false
  inline void HideDropdown(bool animated);

  static inline ::GlobalNamespace::ColorsOverrideSettingsPanelController* New_ctor();

  /// @brief Method OnDestroy, addr 0x57fbaa0, size 0x338, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnDisable, addr 0x57fbf44, size 0x24, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method OnEnable, addr 0x57fbf68, size 0x10, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method Refresh, addr 0x57fbf78, size 0x204, virtual true, abstract: false, final true
  inline void Refresh();

  /// @brief Method SetData, addr 0x57fb524, size 0x410, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::ColorSchemesSettings* colorSchemesSettings);

  /// @brief Method <HandleOverrideColorsToggleValueChanged>b__23_0, addr 0x57fc7a8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57fc7a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_editColorSchemeModalView, addr 0x57fb51c, size 0x8, virtual false, abstract: false, final false
