...
public:
  ...
  /// @brief Method .ctor, addr 0x253b250, size 0x3c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DidActivate, addr 0x253ad08, size 0x174, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleGameplayModifiersPanelControllerDidChangeGameplayModifiers, addr 0x253b124, size 0x54, virtual false, abstract: false, final false
  inline void HandleGameplayModifiersPanelControllerDidChangeGameplayModifiers();

  /// @brief Method HandlePlayerSettingsPanelControllerDidChangePlayerSettings, addr 0x253b0ec, size 0x38, virtual false, abstract: false, final false
  inline void HandlePlayerSettingsPanelControllerDidChangePlayerSettings();

  /// @brief Method HandleSelectionSegmentedControlDidSelectCell, addr 0x253b034, size 0x8, virtual false, abstract: false, final false
  inline void HandleSelectionSegmentedControlDidSelectCell(::HMUI::SegmentedControl* segmentedControl, int32_t cellIdx);

  /// @brief Method Init, addr 0x253a504, size 0x90, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::GameplaySetupViewController* New_ctor();

  /// @brief Method OnDisable, addr 0x253af18, size 0x11c, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method RefreshActivePanel, addr 0x253b178, size 0xd8, virtual false, abstract: false, final false
  inline void RefreshActivePanel();

  /// @brief Method RefreshContent, addr 0x253a5b8, size 0x72c, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method SetActivePanel, addr 0x253b03c, size 0xb0, virtual false, abstract: false, final false
  inline void SetActivePanel(int32_t panelIdx);

  /// @brief Method Setup, addr 0x253a478, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x253b28c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeGameplayModifiersEvent, addr 0x2539f0c, size 0x9c, virtual false, abstract: false, final false
  inline void add_didChangeGameplayModifiersEvent(::System::Action* value);

  /// @brief Method get_colorSchemesSettings, addr 0x253a454, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorSchemesSettings* get_colorSchemesSettings();

  /// @brief Method get_environmentOverrideSettings, addr 0x253a430, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OverrideEnvironmentSettings* get_environmentOverrideSettings();

  /// @brief Method get_gameplayModifiers, addr 0x253a414, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_playerSettings, addr 0x253a044, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSettings();

  /// @brief Method remove_didChangeGameplayModifiersEvent, addr 0x2539fa8, size 0x9c, virtual false, abstract: false, final false
