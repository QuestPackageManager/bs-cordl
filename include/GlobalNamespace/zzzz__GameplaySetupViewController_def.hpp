...
public:
  ...
  /// @brief Method .ctor, addr 0x58e9a8c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method DidActivate, addr 0x58e94b0, size 0x1e0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleGameplayModifiersPanelControllerDidChangeGameplayModifiers, addr 0x58e9960, size 0x4c, virtual false, abstract: false, final false
  inline void HandleGameplayModifiersPanelControllerDidChangeGameplayModifiers();

  /// @brief Method HandlePlayerSettingsPanelControllerDidChangePlayerSettings, addr 0x58e9930, size 0x30, virtual false, abstract: false, final false
  inline void HandlePlayerSettingsPanelControllerDidChangePlayerSettings();

  /// @brief Method HandleSelectionSegmentedControlDidSelectCell, addr 0x58e986c, size 0x8, virtual false, abstract: false, final false
  inline void HandleSelectionSegmentedControlDidSelectCell(::HMUI::SegmentedControl* segmentedControl, int32_t cellIdx);

  /// @brief Method Init, addr 0x58e8c9c, size 0x90, virtual false, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::GameplaySetupViewController* New_ctor();

  /// @brief Method OnDisable, addr 0x58e973c, size 0x130, virtual false, abstract: false, final false
  inline void OnDisable();

  /// @brief Method RefreshActivePanel, addr 0x58e99ac, size 0xe0, virtual false, abstract: false, final false
  inline void RefreshActivePanel();

  /// @brief Method RefreshContent, addr 0x58e8d44, size 0x6bc, virtual false, abstract: false, final false
  inline void RefreshContent();

  /// @brief Method SetActivePanel, addr 0x58e9874, size 0xbc, virtual false, abstract: false, final false
  inline void SetActivePanel(int32_t panelIdx);

  /// @brief Method SetIsInteractable, addr 0x58e9400, size 0x90, virtual false, abstract: false, final false
  inline void SetIsInteractable(bool interactable);

  /// @brief Method Setup, addr 0x58e8bfc, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e9a98, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_colorSchemesSettings, addr 0x58e8bd8, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::ColorSchemesSettings* get_colorSchemesSettings();

  /// @brief Method get_environmentOverrideSettings, addr 0x58e8bb4, size 0x24, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OverrideEnvironmentSettings* get_environmentOverrideSettings();

  /// @brief Method get_gameplayModifiers, addr 0x58e8b9c, size 0x18, virtual false, abstract: false, final false
  inline ::GlobalNamespace::GameplayModifiers* get_gameplayModifiers();

  /// @brief Method get_playerSettings, addr 0x58e8884, size 0x14, virtual false, abstract: false, final false
