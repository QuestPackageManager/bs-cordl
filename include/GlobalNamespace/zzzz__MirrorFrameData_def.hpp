...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MirrorFrameData", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MirrorFrameData(MirrorFrameData&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MirrorFrameData", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MirrorFrameData(MirrorFrameDataconst&) = delete;
