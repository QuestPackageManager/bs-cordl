...
public:
// Declarations
/// @brief Method GetEscapedURLForFilePath, addr 0x322bd5c, size 0xc8, virtual false, abstract: false, final false
static inline ::StringW GetEscapedURLForFilePath(::StringW  filePath) ;

/// @brief Method GetFileNamesFromFilePaths, addr 0x322c148, size 0xbc, virtual false, abstract: false, final false
...
/// @brief Method GetFilePaths, addr 0x322bef4, size 0x254, virtual false, abstract: false, final false
...
/// @brief Method GetUniqueDirectoryNameByAppendingNumber, addr 0x322be24, size 0xd0, virtual false, abstract: false, final false
static inline ::StringW GetUniqueDirectoryNameByAppendingNumber(::StringW  dirName) ;

/// @brief Method PathIsUrl, addr 0x322bcf0, size 0x6c, virtual false, abstract: false, final false
