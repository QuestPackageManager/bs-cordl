...
public:
  // Declarations
  /// @brief Method GetEscapedURLForFilePath, addr 0x22b45dc, size 0x78, virtual false, abstract: false, final false
  static inline ::StringW GetEscapedURLForFilePath(::StringW filePath);

  /// @brief Method GetFileNamesFromFilePaths, addr 0x22b4944, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFilePaths, addr 0x22b4710, size 0x234, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUniqueDirectoryNameByAppendingNumber, addr 0x22b4654, size 0xbc, virtual false, abstract: false, final false
  static inline ::StringW GetUniqueDirectoryNameByAppendingNumber(::StringW dirName);

  /// @brief Method PathIsUrl, addr 0x22b4588, size 0x54, virtual false, abstract: false, final false
