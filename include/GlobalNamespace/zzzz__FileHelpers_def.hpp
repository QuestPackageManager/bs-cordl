...
public:
  // Declarations
  /// @brief Method GetEscapedURLForFilePath, addr 0x31fb3e0, size 0xc8, virtual false, abstract: false, final false
  static inline ::StringW GetEscapedURLForFilePath(::StringW filePath);

  /// @brief Method GetFileNamesFromFilePaths, addr 0x31fb7cc, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetFilePaths, addr 0x31fb578, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method GetUniqueDirectoryNameByAppendingNumber, addr 0x31fb4a8, size 0xd0, virtual false, abstract: false, final false
  static inline ::StringW GetUniqueDirectoryNameByAppendingNumber(::StringW dirName);

  /// @brief Method PathIsUrl, addr 0x31fb374, size 0x6c, virtual false, abstract: false, final false
