...
public:
  // Declarations
  /// @brief Method StartQuery, addr 0x21e0854, size 0x274, virtual false, abstract: false, final false
  static inline void StartQuery();

  /// @brief Method QueryHoudiniAsset, addr 0x21e0ac8, size 0x1c0, virtual false, abstract: false, final false
  static inline ::UnityW<::HoudiniEngineUnity::HEU_HoudiniAsset> QueryHoudiniAsset(::UnityEngine::GameObject* rootGO);

  /// @brief Method CookAsset, addr 0x21e0c88, size 0x10, virtual false, abstract: false, final false
  static inline void CookAsset(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method ChangeParmsAndCook, addr 0x21e0c98, size 0x390, virtual false, abstract: false, final false
  static inline void ChangeParmsAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method QueryObjects, addr 0x21e1028, size 0x2dc, virtual false, abstract: false, final false
  static inline void QueryObjects(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method QueryGeoParts, addr 0x21e18a8, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryPartAttributeByOwner, addr 0x21e1cd4, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryAttributeByStorageType, addr 0x21e1f58, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryAttribute, addr 0x21e1304, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x21e239c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
