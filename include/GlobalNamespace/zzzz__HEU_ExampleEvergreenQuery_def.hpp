...
public:
  // Declarations
  /// @brief Method StartQuery, addr 0x214af70, size 0x274, virtual false, abstract: false, final false
  ...
  /// @brief Method ChangeParmsAndCook, addr 0x214b3b4, size 0x390, virtual false, abstract: false, final false
  static inline void ChangeParmsAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method QueryObjects, addr 0x214b744, size 0x2dc, virtual false, abstract: false, final false
  static inline void QueryObjects(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method QueryGeoParts, addr 0x214bfc4, size 0x42c, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryPartAttributeByOwner, addr 0x214c3f0, size 0x284, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryAttributeByStorageType, addr 0x214c674, size 0x1d0, virtual false, abstract: false, final false
  ...
  /// @brief Method QueryAttribute, addr 0x214ba20, size 0x444, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x214cab8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
