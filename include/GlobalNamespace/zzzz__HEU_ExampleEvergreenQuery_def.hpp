...
public:
  // Declarations
  /// @brief Method StartQuery addr 0x1ff35d4 size 0x274 virtual false final false
  static inline void StartQuery();

  /// @brief Method QueryHoudiniAsset addr 0x1ff3848 size 0x1c0 virtual false final false
  static inline ::HoudiniEngineUnity::HEU_HoudiniAsset* QueryHoudiniAsset(::UnityEngine::GameObject* rootGO);

  /// @brief Method CookAsset addr 0x1ff3a08 size 0x10 virtual false final false
  static inline void CookAsset(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method ChangeParmsAndCook addr 0x1ff3a18 size 0x390 virtual false final false
  static inline void ChangeParmsAndCook(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method QueryObjects addr 0x1ff3da8 size 0x2dc virtual false final false
  static inline void QueryObjects(::HoudiniEngineUnity::HEU_HoudiniAsset* houdiniAsset);

  /// @brief Method QueryGeoParts addr 0x1ff4628 size 0x42c virtual false final false
  ...
  /// @brief Method QueryPartAttributeByOwner addr 0x1ff4a54 size 0x284 virtual false final false
  ...
  /// @brief Method QueryAttributeByStorageType addr 0x1ff4cd8 size 0x1d0 virtual false final false
  ...
  /// @brief Method QueryAttribute addr 0x1ff4084 size 0x444 virtual false final false
  ...
  /// @brief Method .ctor addr 0x1ff511c size 0x8 virtual false final false
  inline void _ctor();
