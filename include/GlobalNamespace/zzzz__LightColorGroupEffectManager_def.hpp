...
public:
  ...
  /// @brief Method HandleColorBoostBeatmapEvent, addr 0x26f5b2c, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x26f59d0, size 0x15c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x26f5730, size 0x2a0, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x26f5c88, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lightGroups, addr 0x26f5728, size 0x8, virtual false, abstract: false, final false
