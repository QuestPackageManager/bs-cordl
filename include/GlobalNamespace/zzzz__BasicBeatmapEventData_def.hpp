...
public:
  ...
  /// @brief Method GetCopy, addr 0x223eff0, size 0x80, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x223f09c, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method RecalculateSameTypeIndexFromPreviousEvent, addr 0x223f07c, size 0x20, virtual false, abstract: false, final false
  inline void RecalculateSameTypeIndexFromPreviousEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method SetFirstSameTypeIndex, addr 0x223f070, size 0xc, virtual false, abstract: false, final false
  inline void SetFirstSameTypeIndex();

  /// @brief Method SubtypeIdentifier, addr 0x223efa8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x223ef10, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nextSameTypeEventData, addr 0x223ee88, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BasicBeatmapEventData* get_nextSameTypeEventData();

  /// @brief Method get_previousSameTypeEventData, addr 0x223ee10, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BasicBeatmapEventData* get_previousSameTypeEventData();

  /// @brief Method get_sameTypeIndex, addr 0x223ef00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_sameTypeIndex, addr 0x223ef08, size 0x8, virtual false, abstract: false, final false
