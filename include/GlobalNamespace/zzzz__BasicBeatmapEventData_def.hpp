...
public:
  ...
  /// @brief Method GetCopy, addr 0x1035050, size 0x88, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x1035104, size 0x110, virtual true, abstract: false, final false
  ...
  /// @brief Method RecalculateSameTypeIndexFromPreviousEvent, addr 0x10350e4, size 0x20, virtual false, abstract: false, final false
  inline void RecalculateSameTypeIndexFromPreviousEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method SetFirstSameTypeIndex, addr 0x10350d8, size 0xc, virtual false, abstract: false, final false
  inline void SetFirstSameTypeIndex();

  /// @brief Method SubtypeIdentifier, addr 0x1035008, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1034f70, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nextSameTypeEventData, addr 0x1034ee8, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BasicBeatmapEventData* get_nextSameTypeEventData();

  /// @brief Method get_previousSameTypeEventData, addr 0x1034e70, size 0x78, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BasicBeatmapEventData* get_previousSameTypeEventData();

  /// @brief Method get_sameTypeIndex, addr 0x1034f60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_sameTypeIndex, addr 0x1034f68, size 0x8, virtual false, abstract: false, final false
