...
public:
  ...
  /// @brief Method GetCopy, addr 0x3162bf0, size 0x7c, virtual true, abstract: false, final false
  inline ::GlobalNamespace::BeatmapDataItem* GetCopy();

  /// @brief Method GetDefault, addr 0x3162c94, size 0x128, virtual true, abstract: false, final false
  ...
  /// @brief Method RecalculateSameTypeIndexFromPreviousEvent, addr 0x3162c78, size 0x1c, virtual false, abstract: false, final false
  inline void RecalculateSameTypeIndexFromPreviousEvent(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method SetFirstSameTypeIndex, addr 0x3162c6c, size 0xc, virtual false, abstract: false, final false
  inline void SetFirstSameTypeIndex();

  /// @brief Method SubtypeIdentifier, addr 0x3162bd8, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3162b48, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method get_nextSameTypeEventData, addr 0x3162abc, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BasicBeatmapEventData* get_nextSameTypeEventData();

  /// @brief Method get_previousSameTypeEventData, addr 0x3162a40, size 0x7c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BasicBeatmapEventData* get_previousSameTypeEventData();

  /// @brief Method get_sameTypeIndex, addr 0x3162b38, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_sameTypeIndex, addr 0x3162b40, size 0x8, virtual false, abstract: false, final false
