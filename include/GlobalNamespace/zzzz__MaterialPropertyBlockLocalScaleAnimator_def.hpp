...
public:
  ...
  /// @brief Method SetProperty, addr 0x565d8c0, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x565d914, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
