...
public:
  ...
  /// @brief Method SetProperty, addr 0x5874638, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x587468c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MaterialPropertyBlockLocalScaleAnimator) == 0x40, "Size mismatch!");
