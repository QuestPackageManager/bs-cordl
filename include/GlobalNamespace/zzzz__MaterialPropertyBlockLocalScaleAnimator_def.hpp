...
public:
  ...
  /// @brief Method SetProperty, addr 0x56be568, size 0x54, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56be5bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
