...
// Write type traits
MARK_REF_T(::GlobalNamespace::ISliderDidStartDissolvingEvent*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::ISliderDidStartDissolvingEvent*, "", "ISliderDidStartDissolvingEvent");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
