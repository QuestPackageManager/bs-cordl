...
// Write type traits
MARK_REF_T(::GlobalNamespace::LevelListTableCell*);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59fbc04, size 0x548, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x59fc14c, size 0x8, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x59fc154, size 0xa58, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x59fcbac, size 0x8, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
static_assert(sizeof(::GlobalNamespace::LevelListTableCell__SetDataFromLevelAsync_d__21) == 0x50, "Size mismatch!");
...
public:
  ...
  /// @brief Method CancelAsyncOperations, addr 0x59fbae4, size 0x58, virtual false, abstract: false, final false
  inline void CancelAsyncOperations();

  /// @brief Method HighlightDidChange, addr 0x59fbadc, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method RefreshAvailabilityAsync, addr 0x59fbb3c, size 0xb8, virtual false, abstract: false, final false
  inline void RefreshAvailabilityAsync(::GlobalNamespace::IEntitlementModel* entitlementModel, ::StringW levelID);

  /// @brief Method RefreshVisuals, addr 0x59fba18, size 0xc4, virtual false, abstract: false, final false
  inline void RefreshVisuals();

  /// @brief Method SelectionDidChange, addr 0x59fba14, size 0x4, virtual true, abstract: false, final false
  inline void SelectionDidChange(::HMUI::SelectableCell_TransitionType transitionType);

  /// @brief Method SetDataFromLevelAsync, addr 0x59fb924, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method WasPreparedForReuse, addr 0x59fbae0, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59fbbf4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::LevelListTableCell) == 0x138, "Size mismatch!");
