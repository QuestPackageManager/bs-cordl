...
/// @brief Method MoveNext, addr 0x58ccf54, size 0x548, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58cd49c, size 0x8, virtual true, abstract: false, final true
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelListTableCell>", modifiers: "", def_value: None }, CppParam { name: "levelID", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "entitlementModel", ty: "::GlobalNamespace::IEntitlementModel*", modifiers: "", def_value: None }, CppParam { name: "_cancellationToken_5__2", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EntitlementStatus>", modifiers: "", def_value: None }]
constexpr LevelListTableCell__RefreshAvailabilityAsync_d__26(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::LevelListTableCell>  __4__this, ::StringW  levelID, ::GlobalNamespace::IEntitlementModel*  entitlementModel, ::System::Threading::CancellationToken  _cancellationToken_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EntitlementStatus>  __u__1) noexcept;
...
/// @brief Method MoveNext, addr 0x58cd4a4, size 0xa58, virtual true, abstract: false, final true
inline void MoveNext() ;

/// @brief Method SetStateMachine, addr 0x58cdefc, size 0x8, virtual true, abstract: false, final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::UnityW<::GlobalNamespace::LevelListTableCell>", modifiers: "", def_value: None }, CppParam { name: "beatmapLevel", ty: "::GlobalNamespace::BeatmapLevel*", modifiers: "", def_value: None }, CppParam { name: "interactable", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isFavorite", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isPromoted", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isUpdated", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_cancellationToken_5__2", ty: "::System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>", modifiers: "", def_value: None }]
constexpr LevelListTableCell__SetDataFromLevelAsync_d__21(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::UnityW<::GlobalNamespace::LevelListTableCell>  __4__this, ::GlobalNamespace::BeatmapLevel*  beatmapLevel, bool  interactable, bool  isFavorite, bool  isPromoted, bool  isUpdated, ::System::Threading::CancellationToken  _cancellationToken_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::UnityW<::UnityEngine::Sprite>>  __u__1) noexcept;
...
/// @brief Field _backgroundImage, offset 0x78, size 0x8 
...
/// @brief Field _canvasGroup, offset 0x80, size 0x8 
...
/// @brief Field _coverImage, offset 0x88, size 0x8 
...
/// @brief Field _defaultCoverImage, offset 0x100, size 0x8 
...
/// @brief Field _favoritesBadgeImage, offset 0xa0, size 0x8 
...
/// @brief Field _highlightBackgroundColor, offset 0xb8, size 0x10 
...
/// @brief Field _promoBadgeGo, offset 0xf0, size 0x8 
...
/// @brief Field _refreshingAvailabilityCancellationTokenSource, offset 0x108, size 0x8 
 __declspec(property(get=__cordl_internal_get__refreshingAvailabilityCancellationTokenSource, put=__cordl_internal_set__refreshingAvailabilityCancellationTokenSource)) ::System::Threading::CancellationTokenSource*  _refreshingAvailabilityCancellationTokenSource;

/// @brief Field _refreshingAvailabilityLevelID, offset 0x128, size 0x8 
...
/// @brief Field _selectedAndHighlightedBackgroundColor, offset 0xd8, size 0x10 
...
/// @brief Field _selectedBackgroundColor, offset 0xc8, size 0x10 
...
/// @brief Field _settingDataCancellationTokenSource, offset 0x110, size 0x8 
 __declspec(property(get=__cordl_internal_get__settingDataCancellationTokenSource, put=__cordl_internal_set__settingDataCancellationTokenSource)) ::System::Threading::CancellationTokenSource*  _settingDataCancellationTokenSource;

/// @brief Field _settingDataFromLevelId, offset 0x130, size 0x8 
...
/// @brief Field _songAuthorText, offset 0x98, size 0x8 
...
/// @brief Field _songBpmText, offset 0xb0, size 0x8 
...
/// @brief Field _songDurationText, offset 0xa8, size 0x8 
...
/// @brief Method CancelAsyncOperations, addr 0x58cce34, size 0x58, virtual false, abstract: false, final false
inline void CancelAsyncOperations() ;

/// @brief Method HighlightDidChange, addr 0x58cce2c, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method RefreshAvailabilityAsync, addr 0x58cce8c, size 0xb8, virtual false, abstract: false, final false
inline void RefreshAvailabilityAsync(::GlobalNamespace::IEntitlementModel*  entitlementModel, ::StringW  levelID) ;

/// @brief Method RefreshVisuals, addr 0x58ccd68, size 0xc4, virtual false, abstract: false, final false
inline void RefreshVisuals() ;

/// @brief Method SelectionDidChange, addr 0x58ccd64, size 0x4, virtual true, abstract: false, final false
inline void SelectionDidChange(::HMUI::SelectableCell_TransitionType  transitionType) ;

/// @brief Method SetDataFromLevelAsync, addr 0x58ccc74, size 0xf0, virtual false, abstract: false, final false
...
/// @brief Method WasPreparedForReuse, addr 0x58cce30, size 0x4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ccf44, size 0x10, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _refreshingAvailabilityCancellationTokenSource, offset: 0x108, size: 0x8, def value: None
 ::System::Threading::CancellationTokenSource*  ____refreshingAvailabilityCancellationTokenSource;

/// @brief Field _settingDataCancellationTokenSource, offset: 0x110, size: 0x8, def value: None
...
/// @brief Field _notOwned, offset: 0x120, size: 0x1, def value: None
 bool  ____notOwned;

/// @brief Field _refreshingAvailabilityLevelID, offset: 0x128, size: 0x8, def value: None
 ::StringW  ____refreshingAvailabilityLevelID;

/// @brief Field _settingDataFromLevelId, offset: 0x130, size: 0x8, def value: None
 ::StringW  ____settingDataFromLevelId;

static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____backgroundImage) == 0x78, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____canvasGroup) == 0x80, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____coverImage) == 0x88, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____songNameText) == 0x90, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____songAuthorText) == 0x98, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____favoritesBadgeImage) == 0xa0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____songDurationText) == 0xa8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____songBpmText) == 0xb0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____highlightBackgroundColor) == 0xb8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____selectedBackgroundColor) == 0xc8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____selectedAndHighlightedBackgroundColor) == 0xd8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____notOwnedAlpha) == 0xe8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____promoBadgeGo) == 0xf0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____updatedBadgeGo) == 0xf8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____defaultCoverImage) == 0x100, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____refreshingAvailabilityCancellationTokenSource) == 0x108, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____settingDataCancellationTokenSource) == 0x110, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____beatmapLevel) == 0x118, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____notOwned) == 0x120, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____refreshingAvailabilityLevelID) == 0x128, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LevelListTableCell, ____settingDataFromLevelId) == 0x130, "Offset mismatch!");

static_assert(::cordl_internals::size_check_v<::GlobalNamespace::LevelListTableCell, 0x138>, "Size mismatch!");
