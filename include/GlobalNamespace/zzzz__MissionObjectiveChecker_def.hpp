...
public:
  ...
  /// @brief Method SetCheckedMissionObjective, addr 0x3bb8370, size 0x10, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bb79b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_checkedValueDidChangeEvent, addr 0x3bb81dc, size 0xb0, virtual false, abstract: false, final false
  inline void add_checkedValueDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>* value);

  /// @brief Method add_statusDidChangeEvent, addr 0x3bb807c, size 0xb0, virtual false, abstract: false, final false
  inline void add_statusDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>* value);

  /// @brief Method get_checkedValue, addr 0x3bb8368, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_checkedValue();

  /// @brief Method get_disableChecking, addr 0x3bb834c, size 0x8, virtual false, abstract: false, final false
  inline bool get_disableChecking();

  /// @brief Method get_missionObjective, addr 0x3bb8344, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MissionObjective* get_missionObjective();

  /// @brief Method get_missionObjectiveType, addr 0x3bb833c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::GlobalNamespace::MissionObjectiveTypeSO> get_missionObjectiveType();

  /// @brief Method get_status, addr 0x3bb8360, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::MissionObjectiveChecker_Status get_status();

  /// @brief Method remove_checkedValueDidChangeEvent, addr 0x3bb828c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_checkedValueDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>* value);

  /// @brief Method remove_statusDidChangeEvent, addr 0x3bb812c, size 0xb0, virtual false, abstract: false, final false
  inline void remove_statusDidChangeEvent(::System::Action_1<::UnityW<::GlobalNamespace::MissionObjectiveChecker>>* value);

  /// @brief Method set_checkedValue, addr 0x3bb72c4, size 0x3c, virtual false, abstract: false, final false
  inline void set_checkedValue(int32_t value);

  /// @brief Method set_disableChecking, addr 0x3bb8354, size 0xc, virtual false, abstract: false, final false
  inline void set_disableChecking(bool value);

  /// @brief Method set_status, addr 0x3bb716c, size 0x3c, virtual false, abstract: false, final false
