...
public:
  ...
  /// @brief Method Awake, addr 0x2523048, size 0xc4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x25233f0, size 0xd0, virtual true, abstract: false, final true
  inline void HandleNoteControllerDidInit(::GlobalNamespace::NoteControllerBase* noteController);

  /// @brief Method HandleNoteJumpDidUpdateProgress, addr 0x25233ec, size 0x4, virtual false, abstract: false, final false
  inline void HandleNoteJumpDidUpdateProgress(float_t progress);

  static inline ::GlobalNamespace::NoteJumpStartScaleUp* New_ctor();

  /// @brief Method OnDestroy, addr 0x2523264, size 0x188, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UpdateScale, addr 0x252310c, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25234c0, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
