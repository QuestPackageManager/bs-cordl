...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDebrisSpawner::*)()>(&::GlobalNamespace::NoteDebrisSpawner::Start)> {
  ...
  constexpr static std::size_t addrs = 0x57de604;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDebrisSpawner::*)(::GlobalNamespace::NoteData_GameplayType, ::UnityEngine::Vector3, ::UnityEngine::Vector3, float_t, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Quaternion, ::UnityEngine::Vector3, ::GlobalNamespace::ColorType, float_t, ::UnityEngine::Vector3)>(&::GlobalNamespace::NoteDebrisSpawner::SpawnDebris)> {
  constexpr static std::size_t size = 0x8d8;
  constexpr static std::size_t addrs = 0x57dd9c0;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDebrisSpawner::*)(::GlobalNamespace::NoteDebris*)>(&::GlobalNamespace::NoteDebrisSpawner::HandleNoteDebrisDidFinish)> {
  ...
  constexpr static std::size_t addrs = 0x57de870;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDebrisSpawner::*)(::GlobalNamespace::NoteData_GameplayType, ::ByRef<::GlobalNamespace::NoteDebris*>, ::ByRef<::GlobalNamespace::NoteDebris*>)>(&::GlobalNamespace::NoteDebrisSpawner::SpawnNoteDebris)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "SpawnNoteDebris",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::NoteData_GameplayType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::GlobalNamespace::NoteDebris*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ByRef<::GlobalNamespace::NoteDebris*>>::get()}
                    )));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDebrisSpawner::*)(::GlobalNamespace::NoteDebris*)>(&::GlobalNamespace::NoteDebrisSpawner::DespawnNoteDebris)> {
  ...
  constexpr static std::size_t addrs = 0x57de938;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NoteDebrisSpawner::*)()>(&::GlobalNamespace::NoteDebrisSpawner::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x57de9f0;
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteData_GameplayType,::GlobalNamespace::NoteDebris_Pool*>*& GlobalNamespace::NoteDebrisSpawner::__cordl_internal_get__poolForNoteGameplayType()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____poolForNoteGameplayType;
}
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteData_GameplayType,::GlobalNamespace::NoteDebris_Pool*>* const& GlobalNamespace::NoteDebrisSpawner::__cordl_internal_get__poolForNoteGameplayType() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____poolForNoteGameplayType;
}
constexpr void GlobalNamespace::NoteDebrisSpawner::__cordl_internal_set__poolForNoteGameplayType(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteData_GameplayType,::GlobalNamespace::NoteDebris_Pool*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::NoteDebris>,::GlobalNamespace::NoteDebris_Pool*>*& GlobalNamespace::NoteDebrisSpawner::__cordl_internal_get__poolForNoteDebris()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____poolForNoteDebris;
}
constexpr ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::NoteDebris>,::GlobalNamespace::NoteDebris_Pool*>* const& GlobalNamespace::NoteDebrisSpawner::__cordl_internal_get__poolForNoteDebris() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____poolForNoteDebris;
}
constexpr void GlobalNamespace::NoteDebrisSpawner::__cordl_internal_set__poolForNoteDebris(::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::NoteDebris>,::GlobalNamespace::NoteDebris_Pool*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void GlobalNamespace::NoteDebrisSpawner::SpawnNoteDebris(::GlobalNamespace::NoteData_GameplayType  noteGameplayType, ::ByRef<::GlobalNamespace::NoteDebris*>  debris0, ::ByRef<::GlobalNamespace::NoteDebris*>  debris1)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::NoteDebrisSpawner*>::get(),
                        "SpawnNoteDebris",
                        std::span<const Il2CppClass* const, 0>(),
