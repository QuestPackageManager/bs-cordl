...
public:
  ...
  /// @brief Method Awake, addr 0x26e5c20, size 0x8c, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleMissionObjectiveCheckersManagerObjectiveWasCleared, addr 0x26e5d38, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x26e5cac, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26e5db4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
