...
public:
  ...
  /// @brief Method Awake, addr 0x3ba3f4c, size 0x90, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleMissionObjectiveCheckersManagerObjectiveWasCleared, addr 0x3ba406c, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3ba3fdc, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba40e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
