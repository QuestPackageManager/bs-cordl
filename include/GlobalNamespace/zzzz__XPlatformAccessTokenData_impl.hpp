...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::XPlatformAccessTokenData::*)(::StringW, ::GlobalNamespace::PlatformEnvironment)>(&::GlobalNamespace::XPlatformAccessTokenData::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x3243a50;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::XPlatformAccessTokenData::*)()>(&::GlobalNamespace::XPlatformAccessTokenData::IsValid)> {
  ...
  constexpr static std::size_t addrs = 0x3243a5c;
...
// Ctor Parameters [CppParam { name: "token", ty: "::StringW", modifiers: "", def_value: Some("{}") }, CppParam { name: "platformEnvironment", ty: "::GlobalNamespace::PlatformEnvironment", modifiers: "", def_value: Some("{}") }]
