...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::XPlatformAccessTokenData::*)(::StringW)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::XPlatformAccessTokenData*>::get(), "set_token", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::PlatformEnvironment (::GlobalNamespace::XPlatformAccessTokenData::*)()>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::XPlatformAccessTokenData*>::get(),
                                                                               "get_platformEnvironment", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::XPlatformAccessTokenData::*)(::GlobalNamespace::PlatformEnvironment)>(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::XPlatformAccessTokenData*>::get(), "set_platformEnvironment", std::span<Il2CppClass const* const, 0>(),
...
constexpr ::StringW& GlobalNamespace::XPlatformAccessTokenData::__cordl_internal_get__token_k__BackingField() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____token_k__BackingField;
}
constexpr ::StringW const& GlobalNamespace::XPlatformAccessTokenData::__cordl_internal_get__token_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____token_k__BackingField;
}
constexpr void GlobalNamespace::XPlatformAccessTokenData::__cordl_internal_set__token_k__BackingField(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::GlobalNamespace::PlatformEnvironment& GlobalNamespace::XPlatformAccessTokenData::__cordl_internal_get__platformEnvironment_k__BackingField() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____platformEnvironment_k__BackingField;
}
constexpr ::GlobalNamespace::PlatformEnvironment const& GlobalNamespace::XPlatformAccessTokenData::__cordl_internal_get__platformEnvironment_k__BackingField() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____platformEnvironment_k__BackingField;
}
constexpr void GlobalNamespace::XPlatformAccessTokenData::__cordl_internal_set__platformEnvironment_k__BackingField(::GlobalNamespace::PlatformEnvironment value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::GlobalNamespace::XPlatformAccessTokenData* GlobalNamespace::XPlatformAccessTokenData::New_ctor(::StringW token, ::GlobalNamespace::PlatformEnvironment platformEnvironment) {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::XPlatformAccessTokenData*>(token, platformEnvironment));
}
