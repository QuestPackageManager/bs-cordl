...
public:
  ...
  /// @brief Method GetLightColorTypeFromEventDataValue, addr 0x31c52f0, size 0x24, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::EnvironmentColorType GetLightColorTypeFromEventDataValue(int32_t beatmapEventValue);

  /// @brief Method HasFixedDurationLightSwitchEventDataValue, addr 0x31c533c, size 0x2c, virtual false, abstract: false, final false
  static inline bool HasFixedDurationLightSwitchEventDataValue(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method HasFixedDurationLightSwitchEventDataValue, addr 0x31c5368, size 0x1c, virtual false, abstract: false, final false
  static inline bool HasFixedDurationLightSwitchEventDataValue(int32_t beatmapEventValue);

  /// @brief Method HasLightFadeEventDataValue, addr 0x31c5314, size 0x28, virtual false, abstract: false, final false
  static inline bool HasLightFadeEventDataValue(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method LightColorTypeFromEventDataValue, addr 0x31c52dc, size 0x14, virtual false, abstract: false, final false
