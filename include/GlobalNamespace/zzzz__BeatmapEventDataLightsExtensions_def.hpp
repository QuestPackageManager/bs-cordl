...
public:
  ...
  /// @brief Method GetLightColorTypeFromEventDataValue, addr 0xe53f6c, size 0x2c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::EnvironmentColorType GetLightColorTypeFromEventDataValue(int32_t beatmapEventValue);

  /// @brief Method HasFixedDurationLightSwitchEventDataValue, addr 0xe53fcc, size 0x4c, virtual false, abstract: false, final false
  static inline bool HasFixedDurationLightSwitchEventDataValue(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method HasFixedDurationLightSwitchEventDataValue, addr 0xe54018, size 0x3c, virtual false, abstract: false, final false
  static inline bool HasFixedDurationLightSwitchEventDataValue(int32_t beatmapEventValue);

  /// @brief Method HasLightFadeEventDataValue, addr 0xe53f98, size 0x34, virtual false, abstract: false, final false
  static inline bool HasLightFadeEventDataValue(::GlobalNamespace::BasicBeatmapEventData* basicBeatmapEventData);

  /// @brief Method LightColorTypeFromEventDataValue, addr 0xe53f54, size 0x18, virtual false, abstract: false, final false
