...
public:
  ...
  /// @brief Method .ctor, addr 0x599a5b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LightGroupTranslationYTransform", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LightGroupTranslationYTransform(LightGroupTranslationYTransform&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LightGroupTranslationYTransform", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LightGroupTranslationYTransform(LightGroupTranslationYTransformconst&) = delete;
