...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BoolSO::*)()>(&::GlobalNamespace::BoolSO::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1fa2f78;
...
inline ::GlobalNamespace::BoolSO* GlobalNamespace::BoolSO::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::BoolSO*>());
}
inline void GlobalNamespace::BoolSO::_ctor() {
  static auto* ___internal_method = THROW_UNLESS((
      ::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BoolSO*>::get(), ".ctor", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
