...
public:
  ...
  /// @brief Method Awake, addr 0x263628c, size 0xd0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x2636460, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDestroy, addr 0x263635c, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26364d4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
