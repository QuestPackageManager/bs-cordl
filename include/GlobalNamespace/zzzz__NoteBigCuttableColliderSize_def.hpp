...
public:
  ...
  /// @brief Method Awake, addr 0x5796b2c, size 0xd4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method HandleNoteControllerDidInit, addr 0x5796d0c, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method OnDestroy, addr 0x5796c00, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5796d80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
