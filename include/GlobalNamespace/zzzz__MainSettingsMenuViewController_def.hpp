...
public:
  ...
  /// @brief Method DidActivate, addr 0x254f764, size 0x1f0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleSettingsMenuSegmentedControlDidSelectCell, addr 0x254f954, size 0x54, virtual false, abstract: false, final false
  inline void HandleSettingsMenuSegmentedControlDidSelectCell(::HMUI::SegmentedControl* segmentedControl, int32_t cellIdx);

  /// @brief Method Init, addr 0x254f72c, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x254f9a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectSettingsSubMenuEvent, addr 0x254f5a8, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectSettingsSubMenuEvent(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*, int32_t>* value);

  /// @brief Method get_numberOfSubMenus, addr 0x254f708, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_numberOfSubMenus();

  /// @brief Method get_selectedSubMenuInfo, addr 0x254f724, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SettingsSubMenuInfo* get_selectedSubMenuInfo();

  /// @brief Method remove_didSelectSettingsSubMenuEvent, addr 0x254f658, size 0xb0, virtual false, abstract: false, final false
