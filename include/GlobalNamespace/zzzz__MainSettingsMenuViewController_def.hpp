...
public:
  ...
  /// @brief Method add_didSelectSettingsSubMenuEvent, addr 0x22f9110, size 0xb0, virtual false, abstract: false, final false
  inline void add_didSelectSettingsSubMenuEvent(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*, int32_t>* value);

  /// @brief Method remove_didSelectSettingsSubMenuEvent, addr 0x22f91c0, size 0xb0, virtual false, abstract: false, final false
  inline void remove_didSelectSettingsSubMenuEvent(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*, int32_t>* value);

  /// @brief Method get_numberOfSubMenus, addr 0x22f9270, size 0x1c, virtual false, abstract: false, final false
  inline int32_t get_numberOfSubMenus();

  /// @brief Method get_selectedSubMenuInfo, addr 0x22f928c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SettingsSubMenuInfo* get_selectedSubMenuInfo();

  /// @brief Method Init, addr 0x22f9294, size 0x38, virtual false, abstract: false, final false
  inline void Init(int32_t selectedSubMenuInfoIdx);

  /// @brief Method DidActivate, addr 0x22f92cc, size 0x1f0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleSettingsMenuSegmentedControlDidSelectCell, addr 0x22f94bc, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22f9510, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
