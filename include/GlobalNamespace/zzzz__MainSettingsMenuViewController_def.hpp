...
// Write type traits
MARK_REF_T(::GlobalNamespace::MainSettingsMenuViewController*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MainSettingsMenuViewController*, "", "MainSettingsMenuViewController");
// Dependencies HMUI.ViewController, SettingsSubMenuInfo
namespace GlobalNamespace {
// Is value type: false
...
public:
  // Declarations
  /// @brief Field _selectedSubMenuInfo, offset 0x90, size 0x8
  ...
  /// @brief Field _selectedSubMenuInfoIdx, offset 0x98, size 0x4
  ...
  /// @brief Field _settingsMenuSegmentedControl, offset 0x88, size 0x8
  __declspec(property(get = __cordl_internal_get__settingsMenuSegmentedControl, put = __cordl_internal_set__settingsMenuSegmentedControl)) ::UnityW<::HMUI::TextSegmentedControl>
      _settingsMenuSegmentedControl;

  /// @brief Field _settingsSubMenuInfos, offset 0x80, size 0x8
  __declspec(property(get = __cordl_internal_get__settingsSubMenuInfos, put = __cordl_internal_set__settingsSubMenuInfos)) ::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*> _settingsSubMenuInfos;

  /// @brief Field didSelectSettingsSubMenuEvent, offset 0x78, size 0x8
  ...
  /// @brief Method DidActivate, addr 0x5a146d0, size 0x204, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleSettingsMenuSegmentedControlDidSelectCell, addr 0x5a148d4, size 0x54, virtual false, abstract: false, final false
  inline void HandleSettingsMenuSegmentedControlDidSelectCell(::HMUI::SegmentedControl* segmentedControl, int32_t cellIdx);

  /// @brief Method Init, addr 0x5a14698, size 0x38, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*> const& __cordl_internal_get__settingsSubMenuInfos() const;

  constexpr ::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*>& __cordl_internal_get__settingsSubMenuInfos();
  ...
  constexpr void __cordl_internal_set__settingsSubMenuInfos(::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*> value);
  ...
  /// @brief Method .ctor, addr 0x5a14928, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectSettingsSubMenuEvent, addr 0x5a144f8, size 0xc0, virtual false, abstract: false, final false
  inline void add_didSelectSettingsSubMenuEvent(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*, int32_t>* value);

  /// @brief Method get_numberOfSubMenus, addr 0x5a14678, size 0x18, virtual false, abstract: false, final false
  inline int32_t get_numberOfSubMenus();

  /// @brief Method get_selectedSubMenuInfo, addr 0x5a14690, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SettingsSubMenuInfo* get_selectedSubMenuInfo();

  /// @brief Method remove_didSelectSettingsSubMenuEvent, addr 0x5a145b8, size 0xc0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Field _selectedSubMenuInfo, offset: 0x90, size: 0x8, def value: None
...
static_assert(offsetof(::GlobalNamespace::MainSettingsMenuViewController, ____settingsMenuSegmentedControl) == 0x88, "Offset mismatch!");
...
static_assert(sizeof(::GlobalNamespace::MainSettingsMenuViewController) == 0xa0, "Size mismatch!");
