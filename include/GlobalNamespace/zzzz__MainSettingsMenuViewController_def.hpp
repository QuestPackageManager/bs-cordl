...
/// @brief Field _settingsMenuSegmentedControl, offset 0x88, size 0x8 
 __declspec(property(get=__cordl_internal_get__settingsMenuSegmentedControl, put=__cordl_internal_set__settingsMenuSegmentedControl)) ::UnityW<::HMUI::TextSegmentedControl>  _settingsMenuSegmentedControl;

/// @brief Field _settingsSubMenuInfos, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get__settingsSubMenuInfos, put=__cordl_internal_set__settingsSubMenuInfos)) ::ArrayW<::GlobalNamespace::SettingsSubMenuInfo*,::Array<::GlobalNamespace::SettingsSubMenuInfo*>*>  _settingsSubMenuInfos;

/// @brief Field didSelectSettingsSubMenuEvent, offset 0x78, size 0x8 
 __declspec(property(get=__cordl_internal_get_didSelectSettingsSubMenuEvent, put=__cordl_internal_set_didSelectSettingsSubMenuEvent)) ::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*,int32_t>*  didSelectSettingsSubMenuEvent;
...
/// @brief Method DidActivate, addr 0x58788f0, size 0x204, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleSettingsMenuSegmentedControlDidSelectCell, addr 0x5878af4, size 0x54, virtual false, abstract: false, final false
inline void HandleSettingsMenuSegmentedControlDidSelectCell(::HMUI::SegmentedControl*  segmentedControl, int32_t  cellIdx) ;

/// @brief Method Init, addr 0x58644d8, size 0x38, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5878b48, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didSelectSettingsSubMenuEvent, addr 0x5864418, size 0xc0, virtual false, abstract: false, final false
inline void add_didSelectSettingsSubMenuEvent(::System::Action_2<::GlobalNamespace::SettingsSubMenuInfo*,int32_t>*  value) ;

/// @brief Method get_numberOfSubMenus, addr 0x5864510, size 0x18, virtual false, abstract: false, final false
inline int32_t get_numberOfSubMenus() ;

/// @brief Method get_selectedSubMenuInfo, addr 0x58788e8, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::SettingsSubMenuInfo* get_selectedSubMenuInfo() ;

/// @brief Method remove_didSelectSettingsSubMenuEvent, addr 0x58646dc, size 0xc0, virtual false, abstract: false, final false
