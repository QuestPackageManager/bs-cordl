...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeforePlayerSendFrameStarted", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeforePlayerSendFrameStarted(BeforePlayerSendFrameStarted&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeforePlayerSendFrameStarted", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeforePlayerSendFrameStarted(BeforePlayerSendFrameStartedconst&) = delete;
