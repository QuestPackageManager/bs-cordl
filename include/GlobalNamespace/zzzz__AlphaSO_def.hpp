...
public:
  ...
  /// @brief Method .ctor, addr 0x26608bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Implicit, addr 0x26608a4, size 0x18, virtual false, abstract: false, final false
