...
public:
  ...
  /// @brief Method .ctor, addr 0x35d08cc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method op_Implicit, addr 0x35d08b8, size 0x14, virtual false, abstract: false, final false
