...
// Write type traits
MARK_REF_T(::GlobalNamespace::AlphaSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AlphaSO*, "", "AlphaSO");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AlphaSO", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AlphaSO(AlphaSO&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AlphaSO", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AlphaSO(AlphaSOconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::AlphaSO) == 0x20, "Size mismatch!");
