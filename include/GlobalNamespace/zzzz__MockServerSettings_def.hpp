...
public:
  ...
  /// @brief Method .ctor, addr 0x59cf05c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MockServerSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MockServerSettings(MockServerSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MockServerSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MockServerSettings(MockServerSettingsconst&) = delete;
