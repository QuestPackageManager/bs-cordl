...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5289))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2103674 size 0x8 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::MockServerSettings, 0x70>, "Size mismatch!");
