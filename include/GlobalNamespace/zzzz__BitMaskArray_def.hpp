...
public:
  ...
  /// @brief Method Deserialize, addr 0x1410c8c, size 0xcc, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Equals, addr 0x14107bc, size 0x64, virtual true, abstract: false, final true
  inline bool Equals(::GlobalNamespace::BitMaskArray* other);

  /// @brief Method GetBits, addr 0x141091c, size 0x11c, virtual true, abstract: false, final true
  inline uint64_t GetBits(int32_t offset, int32_t count);

  static inline ::GlobalNamespace::BitMaskArray* New_ctor(int32_t bitCount);

  /// @brief Method Serialize, addr 0x1410b30, size 0x15c, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method SetBits, addr 0x1410820, size 0xfc, virtual true, abstract: false, final true
  inline ::GlobalNamespace::BitMaskArray* SetBits(int32_t offset, uint64_t bits);

  /// @brief Method ToString, addr 0x1410a38, size 0xf8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x1410740, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor(int32_t bitCount);

  /// @brief Method get_bitCount, addr 0x1410738, size 0x8, virtual true, abstract: false, final true
