...
public:
  ...
  /// @brief Method get_bitCount addr 0x12a173c size 0x8 virtual true final true
  inline int32_t get_bitCount();

  static inline ::GlobalNamespace::BitMaskArray* New_ctor(int32_t bitCount);

  /// @brief Method .ctor addr 0x12a1744 size 0x7c virtual false final false
  inline void _ctor(int32_t bitCount);

  /// @brief Method Equals addr 0x12a17c0 size 0x64 virtual true final true
  inline bool Equals(::GlobalNamespace::BitMaskArray* other);

  /// @brief Method SetBits addr 0x12a1824 size 0xfc virtual true final true
  inline ::GlobalNamespace::BitMaskArray* SetBits(int32_t offset, uint64_t bits);

  /// @brief Method GetBits addr 0x12a1920 size 0x11c virtual true final true
  inline uint64_t GetBits(int32_t offset, int32_t count);

  /// @brief Method ToString addr 0x12a1a3c size 0xf8 virtual true final false
  inline ::StringW ToString();

  /// @brief Method Serialize addr 0x12a1b34 size 0x15c virtual true final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method Deserialize addr 0x12a1c90 size 0xcc virtual true final true
