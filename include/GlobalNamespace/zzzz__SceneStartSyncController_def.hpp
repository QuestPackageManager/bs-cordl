...
/// @brief Method HandleSceneSetupDidFinish, addr 0x5b1fc9c, size 0x4c, virtual false, abstract: false, final false
inline void HandleSceneSetupDidFinish(::StringW  sessionGameId) ;

/// @brief Method HandleSceneSetupDidReceiveTooLate, addr 0x5b1fce8, size 0x4c, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x5b1fa20, size 0x104, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method Start, addr 0x5b1f988, size 0x18, virtual false, abstract: false, final false
inline void Start() ;

/// @brief Method StartSceneLoadSync, addr 0x5b1fb24, size 0x178, virtual false, abstract: false, final false
inline void StartSceneLoadSync(::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel*  playersAtGameStartModel) ;

/// @brief Method Update, addr 0x5b1f9a0, size 0x80, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5b1fd34, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_syncStartDidFailEvent, addr 0x5b1f830, size 0xac, virtual false, abstract: false, final false
inline void add_syncStartDidFailEvent(::System::Action*  value) ;

/// @brief Method add_syncStartDidReceiveTooLateEvent, addr 0x5b1f6b0, size 0xc0, virtual false, abstract: false, final false
inline void add_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method add_syncStartDidSuccessEvent, addr 0x5b1f530, size 0xc0, virtual false, abstract: false, final false
inline void add_syncStartDidSuccessEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_syncStartDidFailEvent, addr 0x5b1f8dc, size 0xac, virtual false, abstract: false, final false
inline void remove_syncStartDidFailEvent(::System::Action*  value) ;

/// @brief Method remove_syncStartDidReceiveTooLateEvent, addr 0x5b1f770, size 0xc0, virtual false, abstract: false, final false
inline void remove_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_syncStartDidSuccessEvent, addr 0x5b1f5f0, size 0xc0, virtual false, abstract: false, final false
