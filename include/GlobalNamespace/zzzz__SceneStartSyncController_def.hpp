...
public:
  ...
  /// @brief Method HandleSceneSetupDidFinish, addr 0x3e77798, size 0x4c, virtual false, abstract: false, final false
  inline void HandleSceneSetupDidFinish(::StringW sessionGameId);

  /// @brief Method HandleSceneSetupDidReceiveTooLate, addr 0x3e777e4, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x3e77540, size 0xf8, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3e774d0, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method StartSceneLoadSync, addr 0x3e77638, size 0x160, virtual false, abstract: false, final false
  inline void StartSceneLoadSync(::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel* playersAtGameStartModel);

  /// @brief Method Update, addr 0x3e774e8, size 0x58, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3e77830, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_syncStartDidFailEvent, addr 0x3e77398, size 0x9c, virtual false, abstract: false, final false
  inline void add_syncStartDidFailEvent(::System::Action* value);

  /// @brief Method add_syncStartDidReceiveTooLateEvent, addr 0x3e77238, size 0xb0, virtual false, abstract: false, final false
  inline void add_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_syncStartDidSuccessEvent, addr 0x3e770d8, size 0xb0, virtual false, abstract: false, final false
  inline void add_syncStartDidSuccessEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_syncStartDidFailEvent, addr 0x3e77434, size 0x9c, virtual false, abstract: false, final false
  inline void remove_syncStartDidFailEvent(::System::Action* value);

  /// @brief Method remove_syncStartDidReceiveTooLateEvent, addr 0x3e772e8, size 0xb0, virtual false, abstract: false, final false
  inline void remove_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_syncStartDidSuccessEvent, addr 0x3e77188, size 0xb0, virtual false, abstract: false, final false
