...
public:
  ...
  /// @brief Method add_syncStartDidSuccessEvent, addr 0x265dec4, size 0xb0, virtual false, abstract: false, final false
  inline void add_syncStartDidSuccessEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_syncStartDidSuccessEvent, addr 0x265df74, size 0xb0, virtual false, abstract: false, final false
  inline void remove_syncStartDidSuccessEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_syncStartDidReceiveTooLateEvent, addr 0x265e024, size 0xb0, virtual false, abstract: false, final false
  inline void add_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>* value);

  /// @brief Method remove_syncStartDidReceiveTooLateEvent, addr 0x265e0d4, size 0xb0, virtual false, abstract: false, final false
  inline void remove_syncStartDidReceiveTooLateEvent(::System::Action_1<::StringW>* value);

  /// @brief Method add_syncStartDidFailEvent, addr 0x265e184, size 0x9c, virtual false, abstract: false, final false
  inline void add_syncStartDidFailEvent(::System::Action* value);

  /// @brief Method remove_syncStartDidFailEvent, addr 0x265e220, size 0x9c, virtual false, abstract: false, final false
  inline void remove_syncStartDidFailEvent(::System::Action* value);

  /// @brief Method Start, addr 0x265e2bc, size 0x18, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x265e2d4, size 0x58, virtual false, abstract: false, final false
  inline void Update();

  /// @brief Method OnDestroy, addr 0x265e32c, size 0x100, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method StartSceneLoadSync, addr 0x265e42c, size 0x160, virtual false, abstract: false, final false
  inline void StartSceneLoadSync(::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel* playersAtGameStartModel);

  /// @brief Method HandleSceneSetupDidFinish, addr 0x265e58c, size 0x4c, virtual false, abstract: false, final false
  inline void HandleSceneSetupDidFinish(::StringW sessionGameId);

  /// @brief Method HandleSceneSetupDidReceiveTooLate, addr 0x265e5d8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x265e624, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
