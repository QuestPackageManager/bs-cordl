...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x365f4bc, size 0xac, virtual true, abstract: false, final false
inline ::System::IAsyncResult* BeginInvoke(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult  result, ::ArrayW<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*,::Array<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>*>  scores, int32_t  referencePlayerScoreIndex, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke, addr 0x365f568, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x365f4a8, size 0x14, virtual true, abstract: false, final false
inline void Invoke(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult  result, ::ArrayW<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*,::Array<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>*>  scores, int32_t  referencePlayerScoreIndex) ;
...
/// @brief Method .ctor, addr 0x365f43c, size 0x6c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method BeginInvoke, addr 0x365f5f4, size 0x88, virtual true, abstract: false, final false
...
/// @brief Method EndInvoke, addr 0x365f67c, size 0xc, virtual true, abstract: false, final false
inline void EndInvoke(::System::IAsyncResult*  result) ;

/// @brief Method Invoke, addr 0x365f5e0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x365f574, size 0x6c, virtual false, abstract: false, final false
inline void _ctor(::System::Object*  object, ::System::IntPtr  method) ;
...
/// @brief Method CompareTo, addr 0x365f694, size 0x24, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x365f688, size 0xc, virtual false, abstract: false, final false
...
constexpr ::System::IComparable_1<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>* i___System__IComparable_1___GlobalNamespace__PlatformLeaderboardsModel_LeaderboardScore__() noexcept;
...
/// @brief Method <GetScores>b__26_2, addr 0x365f710, size 0x1c, virtual false, abstract: false, final false
inline bool _GetScores_b__26_2(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*  entry) ;

/// @brief Method .ctor, addr 0x365f70c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method <GetScores>b__0, addr 0x365f730, size 0x28, virtual false, abstract: false, final false
inline void _GetScores_b__0(::GlobalNamespace::HMAsyncRequest*  _) ;

/// @brief Method <GetScores>b__3, addr 0x365fcdc, size 0x2c, virtual false, abstract: false, final false
inline bool _GetScores_b__3(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*  entry) ;

/// @brief Method <GetScores>g__HandleGetScoresCompleted|1, addr 0x365f758, size 0x584, virtual false, abstract: false, final false
inline void _GetScores_g__HandleGetScoresCompleted_1(::GlobalNamespace::PlatformLeaderboardsModel_GetScoresResult  result, ::ArrayW<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*,::Array<::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore*>*>  entries, int32_t  referencePlayerScoreIndex) ;
...
/// @brief Method .ctor, addr 0x365f72c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method GetFriendsScores, addr 0x365f218, size 0x2c, virtual false, abstract: false, final false
inline ::GlobalNamespace::HMAsyncRequest* GetFriendsScores(::ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, int32_t  count, int32_t  fromRank, ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method GetScores, addr 0x365f1bc, size 0x2c, virtual false, abstract: false, final false
inline ::GlobalNamespace::HMAsyncRequest* GetScores(::ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, int32_t  count, int32_t  fromRank, ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method GetScores, addr 0x365eecc, size 0x2d4, virtual false, abstract: false, final false
inline ::GlobalNamespace::HMAsyncRequest* GetScores(::GlobalNamespace::BeatmapKey  beatmapKey, int32_t  count, int32_t  fromRank, ::GlobalNamespace::PlatformLeaderboardsModel_ScoresScope  scope, ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method GetScoresAroundPlayer, addr 0x365f1e8, size 0x30, virtual false, abstract: false, final false
inline ::GlobalNamespace::HMAsyncRequest* GetScoresAroundPlayer(::ByRef<::GlobalNamespace::BeatmapKey>  beatmapKey, int32_t  count, ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method HandleAllScoresDidUpload, addr 0x365f1a0, size 0x1c, virtual false, abstract: false, final false
inline void HandleAllScoresDidUpload() ;

/// @brief Method Initialize, addr 0x365e9f8, size 0x148, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method InitializeForUserInfo, addr 0x365ec58, size 0x1f4, virtual false, abstract: false, final false
inline void InitializeForUserInfo(uint64_t  userId) ;

static inline ::GlobalNamespace::PlatformLeaderboardsModel* New_ctor() ;

/// @brief Method OnDestroy, addr 0x365eb40, size 0x118, virtual false, abstract: false, final false
inline void OnDestroy() ;

/// @brief Method UploadScore, addr 0x365ee4c, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method UploadScore, addr 0x365f244, size 0x160, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x365f3a4, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_allScoresDidUploadEvent, addr 0x365e870, size 0xac, virtual false, abstract: false, final false
inline void add_allScoresDidUploadEvent(::System::Action*  value) ;

/// @brief Method get_initialized, addr 0x365e9d0, size 0x28, virtual false, abstract: false, final false
inline bool get_initialized() ;

/// @brief Method get_playerId, addr 0x365e9c8, size 0x8, virtual false, abstract: false, final false
inline uint64_t get_playerId() ;

/// @brief Method remove_allScoresDidUploadEvent, addr 0x365e91c, size 0xac, virtual false, abstract: false, final false
