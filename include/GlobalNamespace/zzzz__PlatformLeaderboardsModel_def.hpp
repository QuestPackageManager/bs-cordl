...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x369b454, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x369b500, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x369b440, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369b1cc, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x369b520, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x369b5a8, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x369b50c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3696d28, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method CompareTo, addr 0x369b5b4, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x369a73c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetScores>b__26_2, addr 0x369b630, size 0x1c, virtual false, abstract: false, final false
  inline bool _GetScores_b__26_2(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method .ctor, addr 0x369b62c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetScores>b__0, addr 0x369b64c, size 0x28, virtual false, abstract: false, final false
  inline void _GetScores_b__0(::GlobalNamespace::HMAsyncRequest* _);

  /// @brief Method <GetScores>b__3, addr 0x369bbf8, size 0xc0, virtual false, abstract: false, final false
  inline bool _GetScores_b__3(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method <GetScores>g__HandleGetScoresCompleted|1, addr 0x369b674, size 0x584, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method .ctor, addr 0x369b1c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetFriendsScores, addr 0x369b2b0, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x369b254, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x369aef4, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScoresAroundPlayer, addr 0x369b280, size 0x30, virtual false, abstract: false, final false
  inline ::GlobalNamespace::HMAsyncRequest* GetScoresAroundPlayer(::ByRef<::GlobalNamespace::BeatmapKey> beatmapKey, int32_t count,
                                                                  ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler* completionHandler);

  /// @brief Method HandleAllScoresDidUpload, addr 0x369b238, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAllScoresDidUpload();

  /// @brief Method Initialize, addr 0x369aa20, size 0x148, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeForUserInfo, addr 0x369ac80, size 0x1f4, virtual false, abstract: false, final false
  inline void InitializeForUserInfo(uint64_t userId);

  static inline ::GlobalNamespace::PlatformLeaderboardsModel* New_ctor();

  /// @brief Method OnDestroy, addr 0x369ab68, size 0x118, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UploadScore, addr 0x369ae74, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadScore, addr 0x369b2dc, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369b43c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allScoresDidUploadEvent, addr 0x369a898, size 0xac, virtual false, abstract: false, final false
  inline void add_allScoresDidUploadEvent(::System::Action* value);

  /// @brief Method get_initialized, addr 0x369a9f8, size 0x28, virtual false, abstract: false, final false
  inline bool get_initialized();

  /// @brief Method get_playerId, addr 0x369a9f0, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_playerId();

  /// @brief Method remove_allScoresDidUploadEvent, addr 0x369a944, size 0xac, virtual false, abstract: false, final false
