...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3758858, size 0xac, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3758904, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x3758844, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x37587d8, size 0x6c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x3758990, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x3758a18, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x375897c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3758910, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::System::Object* object, ::System::IntPtr method);
...
public:
  ...
  /// @brief Method CompareTo, addr 0x3758a30, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3758a24, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <GetScores>b__26_2, addr 0x3758aac, size 0x1c, virtual false, abstract: false, final false
  inline bool _GetScores_b__26_2(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method .ctor, addr 0x3758aa8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetScores>b__0, addr 0x3758acc, size 0x28, virtual false, abstract: false, final false
  inline void _GetScores_b__0(::GlobalNamespace::HMAsyncRequest* _);

  /// @brief Method <GetScores>b__3, addr 0x3759078, size 0x2c, virtual false, abstract: false, final false
  inline bool _GetScores_b__3(::GlobalNamespace::PlatformLeaderboardsModel_LeaderboardScore* entry);

  /// @brief Method <GetScores>g__HandleGetScoresCompleted|1, addr 0x3758af4, size 0x584, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3758ac8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetFriendsScores, addr 0x37585c4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x3758294, size 0x2d4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScores, addr 0x3758584, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method GetScoresAroundPlayer, addr 0x37585a4, size 0x20, virtual false, abstract: false, final false
  inline ::GlobalNamespace::HMAsyncRequest* GetScoresAroundPlayer(::by_ref<::GlobalNamespace::BeatmapKey> beatmapKey, int32_t count,
                                                                  ::GlobalNamespace::PlatformLeaderboardsModel_GetScoresCompletionHandler* completionHandler);

  /// @brief Method HandleAllScoresDidUpload, addr 0x3758568, size 0x1c, virtual false, abstract: false, final false
  inline void HandleAllScoresDidUpload();

  /// @brief Method Initialize, addr 0x3757dc0, size 0x148, virtual false, abstract: false, final false
  inline void Initialize();

  /// @brief Method InitializeForUserInfo, addr 0x3758020, size 0x1f4, virtual false, abstract: false, final false
  inline void InitializeForUserInfo(uint64_t userId);

  static inline ::GlobalNamespace::PlatformLeaderboardsModel* New_ctor();

  /// @brief Method OnDestroy, addr 0x3757f08, size 0x118, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method UploadScore, addr 0x3758214, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method UploadScore, addr 0x37585e4, size 0x15c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3758740, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_allScoresDidUploadEvent, addr 0x3757c38, size 0xac, virtual false, abstract: false, final false
  inline void add_allScoresDidUploadEvent(::System::Action* value);

  /// @brief Method get_initialized, addr 0x3757d98, size 0x28, virtual false, abstract: false, final false
  inline bool get_initialized();

  /// @brief Method get_playerId, addr 0x3757d90, size 0x8, virtual false, abstract: false, final false
  inline uint64_t get_playerId();

  /// @brief Method remove_allScoresDidUploadEvent, addr 0x3757ce4, size 0xac, virtual false, abstract: false, final false
