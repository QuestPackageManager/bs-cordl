...
/// @brief Field _beatDistributionParamType, offset 0x1c, size 0x4 
 __declspec(property(get=__cordl_internal_get__beatDistributionParamType, put=__cordl_internal_set__beatDistributionParamType)) ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  _beatDistributionParamType;
...
/// @brief Field _eventDistributionParamType, offset 0x24, size 0x4 
 __declspec(property(get=__cordl_internal_get__eventDistributionParamType, put=__cordl_internal_set__eventDistributionParamType)) ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  _eventDistributionParamType;
...
/// @brief Method BeatDistributionParamToStep, addr 0x36177a4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method EventDistributionParamToStep, addr 0x3617738, size 0x6c, virtual false, abstract: false, final false
static inline float_t EventDistributionParamToStep(int32_t  index, float_t  distributionParam, ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  distributionParamType, int32_t  count, ::GlobalNamespace::EaseType  easeType) ;

/// @brief Method GetBeatStep, addr 0x36176bc, size 0x50, virtual false, abstract: false, final false
static inline float_t GetBeatStep(::GlobalNamespace::IndexFilter*  indexFilter, ::GlobalNamespace::BeatmapEventDataBox_DistributionParamType  distributionParamType, float_t  distributionParam, float_t  lastBaseEventRelativeBeat) ;

/// @brief Method GetBeatStep, addr 0x361769c, size 0x20, virtual false, abstract: false, final false
inline float_t GetBeatStep(float_t  lastBaseEventRelativeBeat) ;

/// @brief Method GetDistribution, addr 0x361770c, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3617648, size 0x48, virtual false, abstract: false, final false
...
/// @brief Method get_indexFilter, addr 0x3617640, size 0x8, virtual false, abstract: false, final false
