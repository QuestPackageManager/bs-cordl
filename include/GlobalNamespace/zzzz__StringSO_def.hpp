...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15622)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15622), inst: 398 })]
...
public:
  ...
  /// @brief Method .ctor, addr 0xe52d3c, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
