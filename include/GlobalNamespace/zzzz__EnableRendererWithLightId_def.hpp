...
// Write type traits
MARK_REF_T(::GlobalNamespace::EnableRendererWithLightId*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::EnableRendererWithLightId*, "", "EnableRendererWithLightId");
...
public:
  // Declarations
  /// @brief Field _hideAlphaRangeMax, offset 0x4c, size 0x4
  ...
  /// @brief Field _hideAlphaRangeMin, offset 0x48, size 0x4
...
static_assert(offsetof(::GlobalNamespace::EnableRendererWithLightId, ____renderer) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EnableRendererWithLightId, ____hideAlphaRangeMin) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::EnableRendererWithLightId, ____hideAlphaRangeMax) == 0x4c, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::EnableRendererWithLightId) == 0x50, "Size mismatch!");
