...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x586f654, size 0x3c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x586f690, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::EnableRendererWithLightId) == 0x48, "Size mismatch!");
