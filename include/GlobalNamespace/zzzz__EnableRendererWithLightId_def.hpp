...
/// @brief Method ColorWasSet, addr 0x56b94f4, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56b9530, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;
