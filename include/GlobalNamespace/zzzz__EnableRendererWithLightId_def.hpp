...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x21a39c4, size 0x44, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  static inline ::GlobalNamespace::EnableRendererWithLightId* New_ctor();

  /// @brief Method .ctor, addr 0x21a3a08, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();
