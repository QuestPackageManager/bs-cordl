...
public:
  ...
  /// @brief Method <InstallBindings>b__10_0, addr 0x58c2b44, size 0x80, virtual false, abstract: false, final false
  inline bool _InstallBindings_b__10_0(::Zenject::BindingId t);

  /// @brief Method .ctor, addr 0x58c2b40, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method InstallBindings, addr 0x58c258c, size 0x55c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58c2ae8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_mirroredGameNoteControllerPrefab, addr 0x58c2584, size 0x8, virtual false, abstract: false, final false
