...
/// @brief Method <InstallBindings>b__10_0, addr 0x584e53c, size 0x80, virtual false, abstract: false, final false
inline bool _InstallBindings_b__10_0(::Zenject::BindingId  t) ;

/// @brief Method .ctor, addr 0x584e538, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _mirrorRendererGraphicsSettingsPresets, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__mirrorRendererGraphicsSettingsPresets, put=__cordl_internal_set__mirrorRendererGraphicsSettingsPresets)) ::UnityW<::GlobalNamespace::MirrorRendererGraphicsSettingsPresets>  _mirrorRendererGraphicsSettingsPresets;

/// @brief Field _mirroredBombNoteControllerPrefab, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__mirroredBombNoteControllerPrefab, put=__cordl_internal_set__mirroredBombNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MirroredBombNoteController>  _mirroredBombNoteControllerPrefab;

/// @brief Field _mirroredBurstSliderGameNoteControllerPrefab, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__mirroredBurstSliderGameNoteControllerPrefab, put=__cordl_internal_set__mirroredBurstSliderGameNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MirroredGameNoteController>  _mirroredBurstSliderGameNoteControllerPrefab;

/// @brief Field _mirroredBurstSliderHeadGameNoteControllerPrefab, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__mirroredBurstSliderHeadGameNoteControllerPrefab, put=__cordl_internal_set__mirroredBurstSliderHeadGameNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MirroredGameNoteController>  _mirroredBurstSliderHeadGameNoteControllerPrefab;

/// @brief Field _mirroredGameNoteControllerPrefab, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__mirroredGameNoteControllerPrefab, put=__cordl_internal_set__mirroredGameNoteControllerPrefab)) ::UnityW<::GlobalNamespace::MirroredGameNoteController>  _mirroredGameNoteControllerPrefab;

/// @brief Field _mirroredObstacleControllerPrefab, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__mirroredObstacleControllerPrefab, put=__cordl_internal_set__mirroredObstacleControllerPrefab)) ::UnityW<::GlobalNamespace::MirroredObstacleController>  _mirroredObstacleControllerPrefab;

/// @brief Field _mirroredSliderControllerPrefab, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get__mirroredSliderControllerPrefab, put=__cordl_internal_set__mirroredSliderControllerPrefab)) ::UnityW<::GlobalNamespace::MirroredSliderController>  _mirroredSliderControllerPrefab;
...
/// @brief Method InstallBindings, addr 0x584df84, size 0x55c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x584e4e0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_mirroredGameNoteControllerPrefab, addr 0x584df7c, size 0x8, virtual false, abstract: false, final false
