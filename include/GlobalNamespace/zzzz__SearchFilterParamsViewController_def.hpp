...
public:
  ...
  /// @brief Method DidActivate, addr 0x5824a08, size 0x2bc, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5824cc4, size 0x23c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleFilterByNotOwnedValueValueChanged, addr 0x58252d8, size 0x24, virtual false, abstract: false, final false
  inline void HandleFilterByNotOwnedValueValueChanged(bool isOn);

  /// @brief Method HandleFilterByOwnedValueValueChanged, addr 0x58252b4, size 0x24, virtual false, abstract: false, final false
  inline void HandleFilterByOwnedValueValueChanged(bool isOn);

  /// @brief Method MaxBpmControllerValueDidChange, addr 0x58251f0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method MinBpmControllerValueDidChange, addr 0x582512c, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OkButtonPressed, addr 0x5824f00, size 0x22c, virtual false, abstract: false, final false
  inline void OkButtonPressed();

  /// @brief Method Refresh, addr 0x582462c, size 0x3dc, virtual false, abstract: false, final false
  inline void Refresh(::ByRef<::GlobalNamespace::LevelFilter> filter);

  /// @brief Method Setup, addr 0x58245ec, size 0x40, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58252fc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x582446c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x582452c, size 0xc0, virtual false, abstract: false, final false
