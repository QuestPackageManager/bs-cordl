...
public:
  ...
  /// @brief Method DidActivate, addr 0x57b3bd8, size 0x2bc, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x57b3e94, size 0x23c, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleFilterByNotOwnedValueValueChanged, addr 0x57b449c, size 0x24, virtual false, abstract: false, final false
  inline void HandleFilterByNotOwnedValueValueChanged(bool isOn);

  /// @brief Method HandleFilterByOwnedValueValueChanged, addr 0x57b4478, size 0x24, virtual false, abstract: false, final false
  inline void HandleFilterByOwnedValueValueChanged(bool isOn);

  /// @brief Method MaxBpmControllerValueDidChange, addr 0x57b43b4, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method MinBpmControllerValueDidChange, addr 0x57b42f0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method OkButtonPressed, addr 0x57b40d0, size 0x220, virtual false, abstract: false, final false
  inline void OkButtonPressed();

  /// @brief Method Refresh, addr 0x57b3808, size 0x3d0, virtual false, abstract: false, final false
  inline void Refresh(::ByRef<::GlobalNamespace::LevelFilter> filter);

  /// @brief Method Setup, addr 0x57b37e4, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b44c0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x57b3664, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x57b3724, size 0xc0, virtual false, abstract: false, final false
