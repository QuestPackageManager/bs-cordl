...
public:
  ...
  /// @brief Method DidActivate, addr 0x3b6a2f0, size 0x24c, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x3b6a53c, size 0x1b8, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method HandleFilterByNotOwnedValueValueChanged, addr 0x3b6aa04, size 0x2c, virtual false, abstract: false, final false
  inline void HandleFilterByNotOwnedValueValueChanged(bool isOn);

  /// @brief Method HandleFilterByOwnedValueValueChanged, addr 0x3b6a9d8, size 0x2c, virtual false, abstract: false, final false
  inline void HandleFilterByOwnedValueValueChanged(bool isOn);

  /// @brief Method MaxBpmControllerValueDidChange, addr 0x3b6a950, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method MinBpmControllerValueDidChange, addr 0x3b6a8c8, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method OkButtonPressed, addr 0x3b6a6f4, size 0x1d4, virtual false, abstract: false, final false
  inline void OkButtonPressed();

  /// @brief Method Refresh, addr 0x3b69f90, size 0x360, virtual false, abstract: false, final false
  inline void Refresh(::ByRef<::GlobalNamespace::LevelFilter> filter);

  /// @brief Method Setup, addr 0x3b69f60, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b6aa30, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b69df8, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x3b69eac, size 0xb4, virtual false, abstract: false, final false
