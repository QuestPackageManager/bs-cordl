...
/// @brief Method .ctor, addr 0x5704f38, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _compoundSins, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__compoundSins, put=__cordl_internal_set__compoundSins)) ::System::Collections::Generic::List_1<::GlobalNamespace::ClothRandomFluctuation_SineLayer*>*  _compoundSins;
...
/// @brief Method FluctuateCloth, addr 0x5704c60, size 0x1c4, virtual false, abstract: false, final false
inline void FluctuateCloth(::UnityEngine::Cloth*  cloth) ;

/// @brief Method GetNoise, addr 0x5704e24, size 0x110, virtual false, abstract: false, final false
inline float_t GetNoise(float_t  time, float_t  offset) ;

static inline ::GlobalNamespace::ClothRandomFluctuation* New_ctor() ;

/// @brief Method Update, addr 0x5704c58, size 0x8, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5704f34, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
