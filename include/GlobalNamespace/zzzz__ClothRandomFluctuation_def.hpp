...
public:
  ...
  /// @brief Method .ctor, addr 0x3ad00b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FluctuateCloth, addr 0x3acfe38, size 0x170, virtual false, abstract: false, final false
  inline void FluctuateCloth(::UnityEngine::Cloth* cloth);

  /// @brief Method GetNoise, addr 0x3acffa8, size 0x104, virtual false, abstract: false, final false
  inline float_t GetNoise(float_t time, float_t offset);

  static inline ::GlobalNamespace::ClothRandomFluctuation* New_ctor();

  /// @brief Method Update, addr 0x3acfe30, size 0x8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ad00ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
