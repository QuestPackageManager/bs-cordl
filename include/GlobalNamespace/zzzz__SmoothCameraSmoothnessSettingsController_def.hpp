...
public:
  ...
  /// @brief Method ApplyValue, addr 0x58e460c, size 0xa4, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x58e44f8, size 0x114, virtual true, abstract: false, final false
  inline bool GetInitValues(::ByRef<int32_t> idx, ::ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::SmoothCameraSmoothnessSettingsController* New_ctor();

  /// @brief Method TextForValue, addr 0x58e46b0, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e47bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
