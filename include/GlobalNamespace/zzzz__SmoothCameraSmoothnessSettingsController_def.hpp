...
public:
  ...
  /// @brief Method ApplyValue, addr 0x5a0fb28, size 0xa4, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x5a0fa14, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method TextForValue, addr 0x5a0fbcc, size 0x10c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a0fcd8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
