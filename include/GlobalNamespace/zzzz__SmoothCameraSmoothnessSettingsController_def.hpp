...
public:
  ...
  /// @brief Method ApplyValue, addr 0x3c14628, size 0xa4, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x3c14518, size 0x110, virtual true, abstract: false, final false
  inline bool GetInitValues(::ByRef<int32_t> idx, ::ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::SmoothCameraSmoothnessSettingsController* New_ctor();

  /// @brief Method TextForValue, addr 0x3c146cc, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c147c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
