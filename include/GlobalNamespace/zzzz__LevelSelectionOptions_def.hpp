...
// Ctor Parameters [CppParam { name: "preferredCharacteristic", ty: "::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>", modifiers: "", def_value: None }, CppParam { name: "preferredDifficulty", ty: "::System::Nullable_1<::GlobalNamespace::BeatmapDifficulty>", modifiers: "", def_value: None }, CppParam { name: "sortAlphabetically", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "isFiltered", ty: "bool", modifiers: "", def_value: None }]
constexpr LevelSelectionOptions(::UnityW<::GlobalNamespace::BeatmapCharacteristicSO>  preferredCharacteristic, ::System::Nullable_1<::GlobalNamespace::BeatmapDifficulty>  preferredDifficulty, bool  sortAlphabetically, bool  isFiltered) noexcept;
