...
template<typename T>
constexpr ::System::Func_2<::System::Action_1<T>*,::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>*& GlobalNamespace::DelegateList_1<T>::__cordl_internal_get_m_acquireFunc()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_acquireFunc;
}
template<typename T>
constexpr ::System::Func_2<::System::Action_1<T>*,::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>* const& GlobalNamespace::DelegateList_1<T>::__cordl_internal_get_m_acquireFunc() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_acquireFunc;
}
template<typename T>
constexpr void GlobalNamespace::DelegateList_1<T>::__cordl_internal_set_m_acquireFunc(::System::Func_2<::System::Action_1<T>*,::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename T>
constexpr ::System::Collections::Generic::LinkedList_1<::System::Action_1<T>*>*& GlobalNamespace::DelegateList_1<T>::__cordl_internal_get_m_callbacks()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_callbacks;
}
template<typename T>
constexpr ::System::Collections::Generic::LinkedList_1<::System::Action_1<T>*>* const& GlobalNamespace::DelegateList_1<T>::__cordl_internal_get_m_callbacks() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_callbacks;
}
template<typename T>
constexpr void GlobalNamespace::DelegateList_1<T>::__cordl_internal_set_m_callbacks(::System::Collections::Generic::LinkedList_1<::System::Action_1<T>*>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->___m_callbacks, value);
}
template<typename T>
constexpr bool& GlobalNamespace::DelegateList_1<T>::__cordl_internal_get_m_invoking()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_invoking;
}
template<typename T>
constexpr bool const& GlobalNamespace::DelegateList_1<T>::__cordl_internal_get_m_invoking() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->___m_invoking;
}
template<typename T>
constexpr void GlobalNamespace::DelegateList_1<T>::__cordl_internal_set_m_invoking(bool  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
// Ctor Parameters []
template<typename T>
constexpr ::GlobalNamespace::DelegateList_1<T>::DelegateList_1()   {
}
