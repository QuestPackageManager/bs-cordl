...
GlobalNamespace::DelegateList_1<T>::__get_m_acquireFunc() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_acquireFunc;
}
template <typename T>
...
template <typename T> constexpr ::System::Action_1<::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>*& GlobalNamespace::DelegateList_1<T>::__get_m_releaseFunc() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::DelegateList_1<T>::__get_m_releaseFunc() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_releaseFunc;
}
template <typename T> constexpr void GlobalNamespace::DelegateList_1<T>::__set_m_releaseFunc(::System::Action_1<::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename T> constexpr ::System::Collections::Generic::LinkedList_1<::System::Action_1<T>*>*& GlobalNamespace::DelegateList_1<T>::__get_m_callbacks() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_callbacks;
}
template <typename T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::LinkedList_1<::System::Action_1<T>*>*> const& GlobalNamespace::DelegateList_1<T>::__get_m_callbacks() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_callbacks;
}
template <typename T> constexpr void GlobalNamespace::DelegateList_1<T>::__set_m_callbacks(::System::Collections::Generic::LinkedList_1<::System::Action_1<T>*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename T> constexpr bool& GlobalNamespace::DelegateList_1<T>::__get_m_invoking() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_invoking;
}
template <typename T> constexpr bool const& GlobalNamespace::DelegateList_1<T>::__get_m_invoking() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___m_invoking;
}
template <typename T> constexpr void GlobalNamespace::DelegateList_1<T>::__set_m_invoking(bool value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline void GlobalNamespace::DelegateList_1<T>::_ctor(::System::Func_2<::System::Action_1<T>*, ::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>* acquireFunc,
  ...
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DelegateList_1<T>*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
template <typename T> inline void GlobalNamespace::DelegateList_1<T>::Add(::System::Action_1<T>* action) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DelegateList_1<T>*>::get(), "Add", std::vector<Il2CppClass*>{},
...
template <typename T> inline void GlobalNamespace::DelegateList_1<T>::Remove(::System::Action_1<T>* action) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DelegateList_1<T>*>::get(), "Remove", std::vector<Il2CppClass*>{},
                                               ::std::vector<Il2CppType const*>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Action_1<T>*>::get() })));
  return ::cordl_internals::RunMethodRethrow<void, false>(this, ___internal_method, action);
}
template <typename T> inline void GlobalNamespace::DelegateList_1<T>::Invoke(T res) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DelegateList_1<T>*>::get(), "Invoke", std::vector<Il2CppClass*>{},
...
template <typename T> inline ::GlobalNamespace::DelegateList_1<T>* GlobalNamespace::DelegateList_1<T>::CreateWithGlobalCache() {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DelegateList_1<T>*>::get(),
                                                                             "CreateWithGlobalCache", std::vector<Il2CppClass*>{}, ::std::vector<Il2CppType const*>{})));
