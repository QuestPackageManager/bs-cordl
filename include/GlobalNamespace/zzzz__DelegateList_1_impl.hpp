...
inline void GlobalNamespace::DelegateList_1<T>::_ctor(::System::Func_2<::System::Action_1<T>*, ::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>* acquireFunc,
  ...
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DelegateList_1<T>*>(),
                                                           { ".ctor",
                                                             {},
                                                             { ::i2c::type_of<::System::Func_2<::System::Action_1<T>*, ::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>*>(),
                                                               ::i2c::type_of<::System::Action_1<::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, acquireFunc, releaseFunc);
}
template <typename T> inline int32_t GlobalNamespace::DelegateList_1<T>::get_Count() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DelegateList_1<T>*>(), { "get_Count", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method);
}
template <typename T> inline void GlobalNamespace::DelegateList_1<T>::Add(::System::Action_1<T>* action) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DelegateList_1<T>*>(), { "Add", {}, { ::i2c::type_of<::System::Action_1<T>*>() } })));
...
template <typename T> inline void GlobalNamespace::DelegateList_1<T>::Remove(::System::Action_1<T>* action) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DelegateList_1<T>*>(), { "Remove", {}, { ::i2c::type_of<::System::Action_1<T>*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, action);
}
template <typename T> inline void GlobalNamespace::DelegateList_1<T>::Invoke(T res) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DelegateList_1<T>*>(), { "Invoke", {}, { ::i2c::type_of<T>() } })));
...
template <typename T> inline void GlobalNamespace::DelegateList_1<T>::Clear() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DelegateList_1<T>*>(), { "Clear", {}, {} })));
...
template <typename T> inline ::GlobalNamespace::DelegateList_1<T>* GlobalNamespace::DelegateList_1<T>::CreateWithGlobalCache() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::GlobalNamespace::DelegateList_1<T>*>(), { "CreateWithGlobalCache", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::DelegateList_1<T>*>(nullptr, ___internal_method);
}
template <typename T>
...
GlobalNamespace::DelegateList_1<T>::New_ctor(::System::Func_2<::System::Action_1<T>*, ::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>* acquireFunc,
                                             ::System::Action_1<::System::Collections::Generic::LinkedListNode_1<::System::Action_1<T>*>*>* releaseFunc) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::DelegateList_1<T>*>(acquireFunc, releaseFunc));
}
// Ctor Parameters []
