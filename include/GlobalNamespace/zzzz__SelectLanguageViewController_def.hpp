...
public:
  ...
  /// @brief Method DidActivate, addr 0x5831cb0, size 0x138, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleLanguageSettingsControllerOndropDownValueDidChange, addr 0x5831f04, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5831de8, size 0x11c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5831f34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didChangeLanguageEvent, addr 0x5831b30, size 0xc0, virtual false, abstract: false, final false
  inline void add_didChangeLanguageEvent(::System::Action_1<::BGLib::Polyglot::LocalizationLanguage>* value);

  /// @brief Method remove_didChangeLanguageEvent, addr 0x5831bf0, size 0xc0, virtual false, abstract: false, final false
