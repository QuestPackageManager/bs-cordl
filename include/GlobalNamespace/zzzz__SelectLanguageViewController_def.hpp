...
/// @brief Field didChangeLanguageEvent, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_didChangeLanguageEvent, put=__cordl_internal_set_didChangeLanguageEvent)) ::System::Action_1<::BGLib::Polyglot::LocalizationLanguage>*  didChangeLanguageEvent;

/// @brief Method DidActivate, addr 0x57c1ab4, size 0x138, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleLanguageSettingsControllerOndropDownValueDidChange, addr 0x57c1d08, size 0x30, virtual false, abstract: false, final false
...
/// @brief Method OnDestroy, addr 0x57c1bec, size 0x11c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x57c1d38, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didChangeLanguageEvent, addr 0x57c1934, size 0xc0, virtual false, abstract: false, final false
inline void add_didChangeLanguageEvent(::System::Action_1<::BGLib::Polyglot::LocalizationLanguage>*  value) ;

/// @brief Method remove_didChangeLanguageEvent, addr 0x57c19f4, size 0xc0, virtual false, abstract: false, final false
