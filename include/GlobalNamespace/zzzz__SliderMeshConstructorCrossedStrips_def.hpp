...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SliderMeshConstructorCrossedStrips", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SliderMeshConstructorCrossedStrips(SliderMeshConstructorCrossedStrips&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SliderMeshConstructorCrossedStrips", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SliderMeshConstructorCrossedStrips(SliderMeshConstructorCrossedStripsconst&) = delete;
