...
public:
  ...
  /// @brief Method CreateSliderMeshInternal, addr 0x3b80398, size 0x480, virtual true, abstract: false, final false
  ...
  /// @brief Method GetTrianglesCount, addr 0x3b80834, size 0x24, virtual true, abstract: false, final false
  inline int32_t GetTrianglesCount(::GlobalNamespace::VertexPath* path);

  /// @brief Method GetVertexCount, addr 0x3b80818, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b80858, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
