...
public:
  ...
  /// @brief Method .ctor, addr 0x58b86c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Start, addr 0x58b858c, size 0x138, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58b86c4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
