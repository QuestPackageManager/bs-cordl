...
public:
  ...
  /// @brief Method .ctor, addr 0x3bf0a8c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Start, addr 0x3bf0980, size 0x104, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bf0a84, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
