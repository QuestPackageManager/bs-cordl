...
/// @brief Method .ctor, addr 0x58460e0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _propertyTintColorPairs, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__propertyTintColorPairs, put=__cordl_internal_set__propertyTintColorPairs)) ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>*>  _propertyTintColorPairs;
...
/// @brief Method Start, addr 0x5845fa4, size 0x138, virtual false, abstract: false, final false
inline void Start() ;
...
constexpr ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>*> const& __cordl_internal_get__propertyTintColorPairs() const;

constexpr ::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>*>& __cordl_internal_get__propertyTintColorPairs() ;
...
constexpr void __cordl_internal_set__propertyTintColorPairs(::ArrayW<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*,::Array<::GlobalNamespace::SetSaberBladeParams_PropertyTintColorPair*>*>  value) ;

constexpr void __cordl_internal_set__saber(::UnityW<::GlobalNamespace::SaberTypeObject>  value) ;

/// @brief Method .ctor, addr 0x58460dc, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
