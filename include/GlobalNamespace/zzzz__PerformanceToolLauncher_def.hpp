...
public:
  ...
  /// @brief Method <Run>g__HandleSongControllerSongDidFinish|1, addr 0x576548c, size 0xec, virtual false, abstract: false, final false
  inline void _Run_g__HandleSongControllerSongDidFinish_1();

  /// @brief Method <Run>g__HandleSongControllerSongDidStart|0, addr 0x57653e8, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5765390, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Initialize, addr 0x5764fb4, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x5765220, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5765394, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
