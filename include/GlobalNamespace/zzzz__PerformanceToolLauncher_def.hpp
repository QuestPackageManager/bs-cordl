...
public:
  ...
  /// @brief Method <Run>g__HandleSongControllerSongDidFinish|1, addr 0x57d5ecc, size 0xec, virtual false, abstract: false, final false
  inline void _Run_g__HandleSongControllerSongDidFinish_1();

  /// @brief Method <Run>g__HandleSongControllerSongDidStart|0, addr 0x57d5e28, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d5dd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Initialize, addr 0x57d59f4, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x57d5c60, size 0x170, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57d5dd4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
