...
public:
  ...
  /// @brief Method <Run>g__HandleSongControllerSongDidFinish|1, addr 0x258e100, size 0xa0, virtual false, abstract: false, final false
  inline void _Run_g__HandleSongControllerSongDidFinish_1();

  /// @brief Method <Run>g__HandleSongControllerSongDidStart|0, addr 0x258e060, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x258e004, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Initialize, addr 0x258dc30, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method Run, addr 0x258def4, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x258e00c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
