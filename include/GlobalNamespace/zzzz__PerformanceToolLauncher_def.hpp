...
public:
  // Declarations
  // Ctor Parameters [CppParam { name: "enableRecording", ty: "::UnityW<::GlobalNamespace::BoolSO>", modifiers: "", def_value: None }, CppParam { name: "enableFpsVisualization", ty:
  // "::UnityW<::GlobalNamespace::BoolSO>", modifiers: "", def_value: None }, CppParam { name: "enableMemoryVisualization", ty: "::UnityW<::GlobalNamespace::BoolSO>", modifiers: "", def_value: None }]
  constexpr __PerformanceToolLauncher__Config(::UnityW<::GlobalNamespace::BoolSO> enableRecording, ::UnityW<::GlobalNamespace::BoolSO> enableFpsVisualization,
                                              ::UnityW<::GlobalNamespace::BoolSO> enableMemoryVisualization) noexcept;
  ...
  ::UnityW<::GlobalNamespace::BoolSO> enableRecording;

  /// @brief Field enableFpsVisualization, offset: 0x8, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::BoolSO> enableFpsVisualization;

  /// @brief Field enableMemoryVisualization, offset: 0x10, size: 0x8, def value: None
  ::UnityW<::GlobalNamespace::BoolSO> enableMemoryVisualization;
...
static_assert(offsetof(::GlobalNamespace::__PerformanceToolLauncher__Config, enableRecording) == 0x0, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__PerformanceToolLauncher__Config, enableFpsVisualization) == 0x8, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::__PerformanceToolLauncher__Config, enableMemoryVisualization) == 0x10, "Offset mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__config, put = __cordl_internal_set__config))::GlobalNamespace::__PerformanceToolLauncher__Config _config;
  ...
  constexpr ::GlobalNamespace::__PerformanceToolLauncher__Config& __cordl_internal_get__config();

  constexpr ::GlobalNamespace::__PerformanceToolLauncher__Config const& __cordl_internal_get__config() const;

  constexpr void __cordl_internal_set__config(::GlobalNamespace::__PerformanceToolLauncher__Config value);
  ...
  /// @brief Method .ctor, addr 0x2304f10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(offsetof(::GlobalNamespace::PerformanceToolLauncher, ____config) == 0x28, "Offset mismatch!");
