...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ColorStateTransition_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ColorStateTransition_1(ColorStateTransition_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ColorStateTransition_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ColorStateTransition_1(ColorStateTransition_1const&) = delete;
