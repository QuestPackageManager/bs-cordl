...
public:
  ...
  /// @brief Method add_playerActiveStateChangedEvent addr 0x22cc348 size 0xb0 virtual false final false
  inline void add_playerActiveStateChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_playerActiveStateChangedEvent addr 0x22cc3f8 size 0xb0 virtual false final false
  inline void remove_playerActiveStateChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method SetLevelGameplaySetupData addr 0x22cc4a8 size 0x13c virtual false final false
  inline void SetLevelGameplaySetupData(::GlobalNamespace::ILevelGameplaySetupData* levelGameplaySetupData);

  /// @brief Method SetLobbyPlayerData addr 0x22cc5e4 size 0xc0 virtual true final false
  inline void SetLobbyPlayerData(::GlobalNamespace::ILobbyPlayerData* lobbyPlayerData);

  /// @brief Method DidActivate addr 0x22cc6a4 size 0x9c virtual true final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate addr 0x22cc740 size 0x1c virtual true final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method OnDestroy addr 0x22cc75c size 0x1c virtual true final false
  inline void OnDestroy();

  static inline ::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController* New_ctor();

  /// @brief Method .ctor addr 0x22cc778 size 0x68 virtual false final false
  inline void _ctor();

  /// @brief Method <DidActivate>b__9_0 addr 0x22cc7e0 size 0x24 virtual false final false
