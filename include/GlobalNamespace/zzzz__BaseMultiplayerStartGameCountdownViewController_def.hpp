...
public:
  ...
  /// @brief Method DidActivate, addr 0x587983c, size 0xa0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x58798dc, size 0x18, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  static inline ::GlobalNamespace::BaseMultiplayerStartGameCountdownViewController* New_ctor();

  /// @brief Method OnDestroy, addr 0x58798f4, size 0x18, virtual true, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetLevelGameplaySetupData, addr 0x5879618, size 0x158, virtual false, abstract: false, final false
  inline void SetLevelGameplaySetupData(::GlobalNamespace::ILevelGameplaySetupData* levelGameplaySetupData);

  /// @brief Method SetLobbyPlayerData, addr 0x5879770, size 0xcc, virtual true, abstract: false, final false
  inline void SetLobbyPlayerData(::GlobalNamespace::ILobbyPlayerData* lobbyPlayerData);

  /// @brief Method <DidActivate>b__9_0, addr 0x5879970, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x587990c, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_playerActiveStateChangedEvent, addr 0x5879498, size 0xc0, virtual false, abstract: false, final false
  inline void add_playerActiveStateChangedEvent(::System::Action_1<bool>* value);

  /// @brief Method remove_playerActiveStateChangedEvent, addr 0x5879558, size 0xc0, virtual false, abstract: false, final false
