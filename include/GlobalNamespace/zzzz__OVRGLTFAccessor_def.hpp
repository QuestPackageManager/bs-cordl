...
public:
  ...
  /// @brief Method Dispose, addr 0x5ce8524, size 0x20, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GetDataCount, addr 0x5ce8544, size 0x8, virtual false, abstract: false, final false
  inline int32_t GetDataCount();

  /// @brief Method GetMaxValueForType, addr 0x5ce7694, size 0x100, virtual false, abstract: false, final false
  inline float_t GetMaxValueForType(::GlobalNamespace::OVRGLTFComponentType type);

  /// @brief Method GetStrideForType, addr 0x5ce614c, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadAsFloat, addr 0x5ce6800, size 0x194, virtual false, abstract: false, final false
  static inline float_t ReadAsFloat(::System::IO::BinaryReader* reader, ::GlobalNamespace::OVRGLTFComponentType type);

  /// @brief Method ReadAsInt, addr 0x5ce6a3c, size 0x19c, virtual false, abstract: false, final false
  static inline int32_t ReadAsInt(::System::IO::BinaryReader* reader, ::GlobalNamespace::OVRGLTFComponentType type);

  /// @brief Method ReadBuffer, addr 0x5ce8428, size 0xfc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ReadBuffer(int32_t bufferViewIndex);

  /// @brief Method ReadColor, addr 0x5ce7284, size 0x410, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Color, ::Array<::UnityEngine::Color>*> ReadColor();

  /// @brief Method ReadFloat, addr 0x5ce667c, size 0x184, virtual false, abstract: false, final false
  inline ::ArrayW<float_t, ::Array<float_t>*> ReadFloat();

  /// @brief Method ReadInt, addr 0x5ce6994, size 0xa8, virtual false, abstract: false, final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> ReadInt();

  /// @brief Method ReadJoints, addr 0x5ce7a7c, size 0x1b8, virtual false, abstract: false, final false
  inline void ReadJoints(::ByRef<::ArrayW<::UnityEngine::BoneWeight, ::Array<::UnityEngine::BoneWeight>*>> resultsBoneWeights);

  /// @brief Method ReadMatrix4x4, addr 0x5ce7f74, size 0x4b4, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Matrix4x4, ::Array<::UnityEngine::Matrix4x4>*> ReadMatrix4x4(::UnityEngine::Vector3 conversionScale);

  /// @brief Method ReadQuaterion, addr 0x5ce7c34, size 0x340, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadVector2, addr 0x5ce6bd8, size 0x1b4, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector2, ::Array<::UnityEngine::Vector2>*> ReadVector2();

  /// @brief Method ReadVector3, addr 0x5ce6d8c, size 0x274, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector3, ::Array<::UnityEngine::Vector3>*> ReadVector3(::UnityEngine::Vector3 conversionScale);

  /// @brief Method ReadVector4, addr 0x5ce7000, size 0x284, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityEngine::Vector4, ::Array<::UnityEngine::Vector4>*> ReadVector4(::UnityEngine::Vector4 conversionScale);

  /// @brief Method ReadWeights, addr 0x5ce7794, size 0x2e8, virtual false, abstract: false, final false
  inline void ReadWeights(::ByRef<::ArrayW<::UnityEngine::BoneWeight, ::Array<::UnityEngine::BoneWeight>*>> resultsBoneWeights);

  /// @brief Method Seek, addr 0x5ce63b8, size 0x1e0, virtual false, abstract: false, final false
  inline void Seek(int32_t accessorIndex, bool onlyBufferView);

  /// @brief Method SeekStride, addr 0x5ce6598, size 0xe4, virtual false, abstract: false, final false
  inline void SeekStride(int32_t strideIndex);

  /// @brief Method ToOVRType, addr 0x5ce624c, size 0x16c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRGLTFType ToOVRType(::StringW type);

  /// @brief Method TryCreate, addr 0x5ce4f18, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ce50c0, size 0x108c, virtual false, abstract: false, final false
