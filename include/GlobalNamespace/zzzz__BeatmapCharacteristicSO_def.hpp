...
public:
  ...
  /// @brief Method get_icon, addr 0x1274c6c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Sprite> get_icon();

  /// @brief Method get_descriptionLocalizationKey, addr 0x1274c74, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_descriptionLocalizationKey();

  /// @brief Method get_characteristicNameLocalizationKey, addr 0x1274c7c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_characteristicNameLocalizationKey();

  /// @brief Method get_serializedName, addr 0x1274c84, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_serializedName();

  /// @brief Method get_compoundIdPartName, addr 0x1274c8c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_compoundIdPartName();

  /// @brief Method get_sortingOrder, addr 0x1274c94, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_sortingOrder();

  /// @brief Method get_containsRotationEvents, addr 0x1274c9c, size 0x8, virtual false, abstract: false, final false
  inline bool get_containsRotationEvents();

  /// @brief Method get_requires360Movement, addr 0x1274ca4, size 0x8, virtual false, abstract: false, final false
  inline bool get_requires360Movement();

  /// @brief Method get_numberOfColors, addr 0x1274cac, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_numberOfColors();

  static inline ::GlobalNamespace::BeatmapCharacteristicSO* New_ctor();

  /// @brief Method .ctor, addr 0x1274cb4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
