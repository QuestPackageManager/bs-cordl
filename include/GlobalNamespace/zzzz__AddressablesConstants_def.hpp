...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AddressablesConstants", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AddressablesConstants(AddressablesConstants&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AddressablesConstants", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AddressablesConstants(AddressablesConstantsconst&) = delete;
