...
public:
  ...
  /// @brief Method .ctor addr 0x228bab4 size 0x8 virtual false final false
  ...
  /// @brief Method get_saberAColor addr 0x228babc size 0x14 virtual false final false
  inline ::UnityEngine::Color get_saberAColor();

  /// @brief Method set_saberAColor addr 0x228bad0 size 0x4 virtual false final false
  inline void set_saberAColor(::UnityEngine::Color value);

  /// @brief Method get_saberBColor addr 0x228bad4 size 0x14 virtual false final false
  inline ::UnityEngine::Color get_saberBColor();

  /// @brief Method set_saberBColor addr 0x228bae8 size 0x4 virtual false final false
  inline void set_saberBColor(::UnityEngine::Color value);

  /// @brief Method get_obstaclesColor addr 0x228baec size 0x14 virtual false final false
  inline ::UnityEngine::Color get_obstaclesColor();

  /// @brief Method set_obstaclesColor addr 0x228bb00 size 0x4 virtual false final false
  inline void set_obstaclesColor(::UnityEngine::Color value);

  /// @brief Method get_leftHanded addr 0x228bb04 size 0x8 virtual false final false
  inline bool get_leftHanded();

  /// @brief Method set_leftHanded addr 0x228bb0c size 0x4 virtual false final false
  inline void set_leftHanded(bool value);

  /// @brief Method get_inactiveByDefault addr 0x228bb10 size 0x8 virtual false final false
  inline bool get_inactiveByDefault();

  /// @brief Method set_inactiveByDefault addr 0x228bb18 size 0x4 virtual false final false
  inline void set_inactiveByDefault(bool value);

  /// @brief Method get_gamePoseGenerator addr 0x228bb1c size 0x8 virtual false final false
  inline ::GlobalNamespace::MockPlayerGamePoseGenerator* get_gamePoseGenerator();

  /// @brief Method Tick addr 0x228bb24 size 0x4 virtual false final false
  inline void Tick();

  /// @brief Method Dispose addr 0x228bb28 size 0x4 virtual true final true
  inline void Dispose();

  /// @brief Method SetIsReady addr 0x228bb2c size 0x4 virtual false final false
