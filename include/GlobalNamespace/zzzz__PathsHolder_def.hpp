...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PathsHolder", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PathsHolder(PathsHolder&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PathsHolder", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PathsHolder(PathsHolderconst&) = delete;
