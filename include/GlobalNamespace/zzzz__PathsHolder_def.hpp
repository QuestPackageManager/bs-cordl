...
// Write type traits
MARK_REF_T(::GlobalNamespace::PathsHolder*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::PathsHolder*, "", "PathsHolder");
...
public:
  ...
  /// @brief Method UpdateVertexPathByBezierPath, addr 0x5902f5c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59028dc, size 0x120, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfFixedVertexPathSegments, bool updateVertexPath);

  /// @brief Method get_bezierPath, addr 0x59028cc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BezierPath* get_bezierPath();

  /// @brief Method get_vertexPath, addr 0x59028d4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::PathsHolder) == 0x20, "Size mismatch!");
