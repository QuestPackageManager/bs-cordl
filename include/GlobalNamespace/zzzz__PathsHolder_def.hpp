...
public:
  ...
  /// @brief Method UpdateVertexPathByBezierPath, addr 0x3b36e3c, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b367d4, size 0x12c, virtual false, abstract: false, final false
  inline void _ctor(int32_t numberOfFixedVertexPathSegments, bool updateVertexPath);

  /// @brief Method get_bezierPath, addr 0x3b367c4, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::BezierPath* get_bezierPath();

  /// @brief Method get_vertexPath, addr 0x3b367cc, size 0x8, virtual false, abstract: false, final false
