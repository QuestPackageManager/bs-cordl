...
/// @brief Field didFinishEvent, offset 0xb0, size 0x8 
 __declspec(property(get=__cordl_internal_get_didFinishEvent, put=__cordl_internal_set_didFinishEvent)) ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton>*  didFinishEvent;

/// @brief Method DidActivate, addr 0x57be2c0, size 0x388, virtual true, abstract: false, final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method HandleMenuButton, addr 0x57be8f8, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method SetData, addr 0x57be648, size 0x2b0, virtual false, abstract: false, final false
inline void SetData(::GlobalNamespace::MultiplayerStatusData*  multiplayerStatusData) ;

/// @brief Method <DidActivate>b__11_0, addr 0x57be924, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__11_0() ;

/// @brief Method <DidActivate>b__11_1, addr 0x57be948, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__11_1() ;

/// @brief Method <DidActivate>b__11_2, addr 0x57be96c, size 0x24, virtual false, abstract: false, final false
inline void _DidActivate_b__11_2() ;

/// @brief Method <DidActivate>b__11_3, addr 0x57be990, size 0x24, virtual false, abstract: false, final false
...
constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton>* const& __cordl_internal_get_didFinishEvent() const;

constexpr ::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton>*& __cordl_internal_get_didFinishEvent() ;
...
constexpr void __cordl_internal_set_didFinishEvent(::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton>*  value) ;

/// @brief Method .ctor, addr 0x57be920, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_didFinishEvent, addr 0x57be140, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method remove_didFinishEvent, addr 0x57be200, size 0xc0, virtual false, abstract: false, final false
inline void remove_didFinishEvent(::System::Action_2<::UnityW<::GlobalNamespace::MultiplayerModeSelectionViewController>,::GlobalNamespace::MultiplayerModeSelectionViewController_MenuButton>*  value) ;
