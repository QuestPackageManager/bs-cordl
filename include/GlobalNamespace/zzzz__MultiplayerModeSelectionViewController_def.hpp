...
public:
  ...
  /// @brief Method add_didFinishEvent addr 0x218c748 size 0xb0 virtual false final false
  ...
  /// @brief Method remove_didFinishEvent addr 0x218c7f8 size 0xb0 virtual false final false
  ...
  /// @brief Method DidActivate addr 0x218c8a8 size 0x2dc virtual true final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method SetData addr 0x218cb84 size 0x26c virtual false final false
  inline void SetData(::GlobalNamespace::MultiplayerStatusData* multiplayerStatusData);

  /// @brief Method HandleMenuButton addr 0x218cdf0 size 0x28 virtual false final false
  ...
  /// @brief Method .ctor addr 0x218ce18 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <DidActivate>b__11_0 addr 0x218ce20 size 0x24 virtual false final false
  inline void _DidActivate_b__11_0();

  /// @brief Method <DidActivate>b__11_1 addr 0x218ce44 size 0x24 virtual false final false
  inline void _DidActivate_b__11_1();

  /// @brief Method <DidActivate>b__11_2 addr 0x218ce68 size 0x24 virtual false final false
  inline void _DidActivate_b__11_2();

  /// @brief Method <DidActivate>b__11_3 addr 0x218ce8c size 0x24 virtual false final false
