...
public:
  ...
  /// @brief Method DidActivate, addr 0x3b68594, size 0x2cc, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method HandleMenuButton, addr 0x3b68afc, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method SetData, addr 0x3b68860, size 0x29c, virtual false, abstract: false, final false
  inline void SetData(::GlobalNamespace::MultiplayerStatusData* multiplayerStatusData);

  /// @brief Method <DidActivate>b__11_0, addr 0x3b68b2c, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__11_0();

  /// @brief Method <DidActivate>b__11_1, addr 0x3b68b50, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__11_1();

  /// @brief Method <DidActivate>b__11_2, addr 0x3b68b74, size 0x24, virtual false, abstract: false, final false
  inline void _DidActivate_b__11_2();

  /// @brief Method <DidActivate>b__11_3, addr 0x3b68b98, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b68b24, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didFinishEvent, addr 0x3b68434, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method remove_didFinishEvent, addr 0x3b684e4, size 0xb0, virtual false, abstract: false, final false
  inline void
