...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3652668, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__3_0, addr 0x3652e84, size 0x1c, virtual false, abstract: false, final false
  inline bool __ctor_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::EventData* e);

  /// @brief Method .ctor, addr 0x3652e80, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateTime, addr 0x3652674, size 0x1c, virtual false, abstract: false, final false
  static inline float_t CalculateTime(::GlobalNamespace::BpmTimeProcessor_BpmChangeData prevBpmChangeData, float_t beat);

  /// @brief Method ConvertBeatToTime, addr 0x3652d14, size 0x110, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x3652e24, size 0x8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x3652b90, size 0x184, virtual false, abstract: false, final false
  inline void _ctor(::BeatmapLevelSaveDataVersion4::AudioSaveData* audioSaveData);

  /// @brief Method .ctor, addr 0x3652690, size 0x500, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36522c8, size 0x3a0, virtual false, abstract: false, final false
