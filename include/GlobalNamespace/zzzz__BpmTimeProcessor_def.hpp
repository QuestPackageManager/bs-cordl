...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x26b7bf8, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__3_0, addr 0x26b7c68, size 0x20, virtual false, abstract: false, final false
  inline bool __ctor_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::EventData* e);

  /// @brief Method .ctor, addr 0x26b7c60, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateTime, addr 0x26b73ec, size 0x1c, virtual false, abstract: false, final false
  static inline float_t CalculateTime(::GlobalNamespace::BpmTimeProcessor_BpmChangeData prevBpmChangeData, float_t beat);

  /// @brief Method ConvertBeatToTime, addr 0x26b7ae8, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x26b7bf0, size 0x8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x26b793c, size 0x1ac, virtual false, abstract: false, final false
  inline void _ctor(::BeatmapLevelSaveDataVersion4::AudioSaveData* audioSaveData);

  /// @brief Method .ctor, addr 0x26b7408, size 0x534, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26b702c, size 0x3c0, virtual false, abstract: false, final false
