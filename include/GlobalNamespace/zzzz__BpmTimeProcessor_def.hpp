...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x14afee0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__3_0, addr 0x14b06fc, size 0x20, virtual false, abstract: false, final false
  inline bool __ctor_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::EventData* e);

  /// @brief Method .ctor, addr 0x14b06f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CalculateTime, addr 0x14afeec, size 0x1c, virtual false, abstract: false, final false
  static inline float_t CalculateTime(::GlobalNamespace::__BpmTimeProcessor__BpmChangeData prevBpmChangeData, float_t beat);

  /// @brief Method ConvertBeatToTime, addr 0x14b0580, size 0x108, virtual true, abstract: false, final true
  ...
  /// @brief Method Reset, addr 0x14b0688, size 0x8, virtual false, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x14b03fc, size 0x184, virtual false, abstract: false, final false
  inline void _ctor(::BeatmapLevelSaveDataVersion4::AudioSaveData* audioSaveData);

  /// @brief Method .ctor, addr 0x14aff08, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14afb58, size 0x388, virtual false, abstract: false, final false
