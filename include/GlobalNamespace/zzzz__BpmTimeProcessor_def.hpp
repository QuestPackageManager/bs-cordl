...
public:
// Declarations
/// @brief Method .ctor, addr 0x3615f68, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method <.ctor>b__3_0, addr 0x3616784, size 0x1c, virtual false, abstract: false, final false
inline bool __ctor_b__3_0(::BeatmapSaveDataVersion2_6_0AndEarlier::EventData*  e) ;

/// @brief Method .ctor, addr 0x3616780, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _bpmChangeDataList, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__bpmChangeDataList, put=__cordl_internal_set__bpmChangeDataList)) ::System::Collections::Generic::List_1<::GlobalNamespace::BpmTimeProcessor_BpmChangeData>*  _bpmChangeDataList;
...
/// @brief Method CalculateTime, addr 0x3615f74, size 0x1c, virtual false, abstract: false, final false
static inline float_t CalculateTime(::GlobalNamespace::BpmTimeProcessor_BpmChangeData  prevBpmChangeData, float_t  beat) ;

/// @brief Method ConvertBeatToTime, addr 0x3616614, size 0x110, virtual true, abstract: false, final true
...
/// @brief Method Reset, addr 0x3616724, size 0x8, virtual false, abstract: false, final false
inline void Reset() ;
...
/// @brief Method .ctor, addr 0x3616490, size 0x184, virtual false, abstract: false, final false
inline void _ctor(::BeatmapLevelSaveDataVersion4::AudioSaveData*  audioSaveData) ;

/// @brief Method .ctor, addr 0x3615f90, size 0x500, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3615bc8, size 0x3a0, virtual false, abstract: false, final false
