...
/// @brief Method .ctor, addr 0x57dba40, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x57dba44, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field recordingConfigurations, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_recordingConfigurations, put=__cordl_internal_set_recordingConfigurations)) ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*>*>  recordingConfigurations;

static inline ::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingToolConfiguration* New_ctor() ;

constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*>*> const& __cordl_internal_get_recordingConfigurations() const;

constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*>*>& __cordl_internal_get_recordingConfigurations() ;

constexpr void __cordl_internal_set_recordingConfigurations(::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*>*>  value) ;

/// @brief Method .ctor, addr 0x57da170, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field recordingConfigurations, offset: 0x10, size: 0x8, def value: None
 ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*>*>  ___recordingConfigurations;
...
/// @brief Field playbackScreenshots, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_playbackScreenshots, put=__cordl_internal_set_playbackScreenshots)) ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*>*>  playbackScreenshots;
...
constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*>*> const& __cordl_internal_get_playbackScreenshots() const;

constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*>*>& __cordl_internal_get_playbackScreenshots() ;
...
constexpr void __cordl_internal_set_playbackScreenshots(::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*,::Array<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*>*>  value) ;
...
/// @brief Method .ctor, addr 0x57dba48, size 0x98, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method CreateMenuDestinationFromConfiguration, addr 0x57db6d8, size 0x368, virtual false, abstract: false, final false
...
/// @brief Method CreateObjectsMovementRecorderInitDataFromConfiguration, addr 0x57db5f8, size 0xe0, virtual false, abstract: false, final false
...
/// @brief Method CreateRecordingToolSettingsFromConfiguration, addr 0x57da480, size 0x10e0, virtual false, abstract: false, final false
inline ::GlobalNamespace::RecordingToolSettings* CreateRecordingToolSettingsFromConfiguration(::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingToolConfiguration*  recordingToolConfiguration, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection) ;

/// @brief Method DeserializeConfigurationFile, addr 0x57d9f38, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method GetConfigFilePath, addr 0x57d9cdc, size 0x7c, virtual false, abstract: false, final false
inline ::StringW GetConfigFilePath() ;

/// @brief Method GetDefaultMrcLayersMask, addr 0x57da190, size 0xc, virtual false, abstract: false, final false
static inline ::UnityEngine::LayerMask GetDefaultMrcLayersMask() ;

/// @brief Method GetLayerMask, addr 0x57da19c, size 0x1e0, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask GetLayerMask(::StringW  layerName) ;

/// @brief Method GetLayersMask, addr 0x57da37c, size 0x7c, virtual false, abstract: false, final false
inline ::UnityEngine::LayerMask GetLayersMask(::ArrayW<::StringW,::Array<::StringW>*>  layerNames) ;

/// @brief Method GetLevelPackAndLevelPreviewForLevelId, addr 0x57da3f8, size 0x88, virtual false, abstract: false, final false
static inline ::System::ValueTuple_2<::GlobalNamespace::BeatmapLevelPack*,::GlobalNamespace::BeatmapLevel*> GetLevelPackAndLevelPreviewForLevelId(::StringW  packId, ::StringW  levelId, ::GlobalNamespace::BeatmapLevelsModel*  beatmapLevelsModel) ;

/// @brief Method IsRecordingToolEnabled, addr 0x57d9c5c, size 0x80, virtual false, abstract: false, final false
inline bool IsRecordingToolEnabled() ;

/// @brief Method LoadConfiguration, addr 0x57da174, size 0x1c, virtual false, abstract: false, final false
inline ::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingToolConfiguration* LoadConfiguration(::StringW  filePath) ;

/// @brief Method LoadConfigurationFile, addr 0x57d9d58, size 0x1e0, virtual false, abstract: false, final false
inline ::StringW LoadConfigurationFile(::StringW  filePath) ;

static inline ::GlobalNamespace::RecordingToolConfigurationProcessor* New_ctor(::BGLib::DotnetExtension::CommandLine::CommandLineParserResult  commandLineParserResult, ::GlobalNamespace::IBeatSaberLogger*  logger, ::GlobalNamespace::IPosesSerializer*  posesSerializer, ::GlobalNamespace::EnvironmentsListModel*  environmentListModel, ::GlobalNamespace::BeatmapLevelsModel*  beatmapLevelsModel) ;
...
/// @brief Method .ctor, addr 0x57d9c40, size 0x1c, virtual false, abstract: false, final false
inline void _ctor(::BGLib::DotnetExtension::CommandLine::CommandLineParserResult  commandLineParserResult, ::GlobalNamespace::IBeatSaberLogger*  logger, ::GlobalNamespace::IPosesSerializer*  posesSerializer, ::GlobalNamespace::EnvironmentsListModel*  environmentListModel, ::GlobalNamespace::BeatmapLevelsModel*  beatmapLevelsModel) ;
