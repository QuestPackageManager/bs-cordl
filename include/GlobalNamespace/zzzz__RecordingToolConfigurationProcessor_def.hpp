...
// Write type traits
MARK_REF_T(::GlobalNamespace::RecordingToolConfigurationProcessor*);
MARK_REF_T(::GlobalNamespace::RecordingToolConfigurationProcessor_ColorSaveData*);
MARK_REF_T(::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*);
MARK_REF_T(::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*);
MARK_REF_T(::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingToolConfiguration*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolConfigurationProcessor*, "", "RecordingToolConfigurationProcessor");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolConfigurationProcessor_ColorSaveData*, "", "RecordingToolConfigurationProcessor/ColorSaveData");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*, "", "RecordingToolConfigurationProcessor/PlaybackScreenshot");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*, "", "RecordingToolConfigurationProcessor/RecordingConfiguration");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingToolConfiguration*, "", "RecordingToolConfigurationProcessor/RecordingToolConfiguration");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58fc0a0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RecordingToolConfigurationProcessor_ColorSaveData) == 0x20, "Size mismatch!");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_excludedLayers, put = __cordl_internal_set_excludedLayers)) ::ArrayW<::StringW> excludedLayers;

  /// @brief Field includedLayers, offset 0x20, size 0x8
  __declspec(property(get = __cordl_internal_get_includedLayers, put = __cordl_internal_set_includedLayers)) ::ArrayW<::StringW> includedLayers;
  ...
  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_excludedLayers() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_excludedLayers();

  constexpr ::ArrayW<::StringW> const& __cordl_internal_get_includedLayers() const;

  constexpr ::ArrayW<::StringW>& __cordl_internal_get_includedLayers();
  ...
  constexpr void __cordl_internal_set_excludedLayers(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set_includedLayers(::ArrayW<::StringW> value);

  constexpr void __cordl_internal_set_name(::StringW value);

  constexpr void __cordl_internal_set_type(::StringW value);

  /// @brief Method .ctor, addr 0x58fc0a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::StringW> ___includedLayers;

  /// @brief Field excludedLayers, offset: 0x28, size: 0x8, def value: None
  ::ArrayW<::StringW> ___excludedLayers;
...
static_assert(sizeof(::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot) == 0x38, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies RecordingToolConfigurationProcessor::PlaybackScreenshot, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*> const& __cordl_internal_get_playbackScreenshots() const;

  constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*>& __cordl_internal_get_playbackScreenshots();
  ...
  constexpr void __cordl_internal_set_playbackScreenshots(::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*> value);
  ...
  /// @brief Method .ctor, addr 0x58fc0a8, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_PlaybackScreenshot*> ___playbackScreenshots;
...
static_assert(sizeof(::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration) == 0x98, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies RecordingToolConfigurationProcessor::RecordingConfiguration, System.Object
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*> const& __cordl_internal_get_recordingConfigurations() const;

  constexpr ::ArrayW<::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingConfiguration*>& __cordl_internal_get_recordingConfigurations();
  ...
  /// @brief Method .ctor, addr 0x58fa83c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingToolConfiguration) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method CreateMenuDestinationFromConfiguration, addr 0x58fbd8c, size 0x314, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateObjectsMovementRecorderInitDataFromConfiguration, addr 0x58fbcac, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateRecordingToolSettingsFromConfiguration, addr 0x58fab4c, size 0x10cc, virtual false, abstract: false, final false
  ...
  /// @brief Method DeserializeConfigurationFile, addr 0x58fa604, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method GetConfigFilePath, addr 0x58fa3d8, size 0x4c, virtual false, abstract: false, final false
  inline ::StringW GetConfigFilePath();

  /// @brief Method GetDefaultMrcLayersMask, addr 0x58fa85c, size 0xc, virtual false, abstract: false, final false
  static inline ::UnityEngine::LayerMask GetDefaultMrcLayersMask();

  /// @brief Method GetLayerMask, addr 0x58fa868, size 0x1e0, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask GetLayerMask(::StringW layerName);

  /// @brief Method GetLayersMask, addr 0x58faa48, size 0x7c, virtual false, abstract: false, final false
  inline ::UnityEngine::LayerMask GetLayersMask(::ArrayW<::StringW> layerNames);

  /// @brief Method GetLevelPackAndLevelPreviewForLevelId, addr 0x58faac4, size 0x88, virtual false, abstract: false, final false
  ...
  /// @brief Method IsRecordingToolEnabled, addr 0x58fa38c, size 0x4c, virtual false, abstract: false, final false
  inline bool IsRecordingToolEnabled();

  /// @brief Method LoadConfiguration, addr 0x58fa840, size 0x1c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::RecordingToolConfigurationProcessor_RecordingToolConfiguration* LoadConfiguration(::StringW filePath);

  /// @brief Method LoadConfigurationFile, addr 0x58fa424, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58fa370, size 0x1c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::RecordingToolConfigurationProcessor) == 0x48, "Size mismatch!");
