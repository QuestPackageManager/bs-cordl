...
// Write type traits
MARK_REF_T(::GlobalNamespace::SongPackMasksModel*);
...
public:
  ...
  /// @brief Method .ctor, addr 0x373a8c0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_text, addr 0x373ab24, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x373a8cc, size 0x10, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SongPackMasksModel_MaskInfo) == 0x30, "Size mismatch!");
...
public:
  ...
  /// @brief Method GetSongPackMaskText, addr 0x373a994, size 0x88, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SongPackMasksModel_LocalizedText GetSongPackMaskText(::GlobalNamespace::SongPackMask songPackMask);

  /// @brief Method Init, addr 0x373a0d8, size 0x564, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method ToLocalizedName, addr 0x373a8dc, size 0xb8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SongPackMasksModel_LocalizedText ToLocalizedName(::StringW serializedName);

  /// @brief Method ToSerializedName, addr 0x373aa1c, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ToSerializedName(::GlobalNamespace::SongPackMask songPackMask);

  /// @brief Method ToSongPackMask, addr 0x373a63c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x373a03c, size 0x9c, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::SongPackMasksModel) == 0x50, "Size mismatch!");
