...
/// @brief Method .ctor, addr 0x3641448, size 0xc, virtual false, abstract: false, final false
...
/// @brief Method get_text, addr 0x36416ac, size 0xc, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x3641454, size 0x10, virtual false, abstract: false, final false
...
// Ctor Parameters [CppParam { name: "localizedText", ty: "::GlobalNamespace::SongPackMasksModel_LocalizedText", modifiers: "", def_value: None }, CppParam { name: "mask", ty: "::GlobalNamespace::SongPackMask", modifiers: "", def_value: None }]
...
/// @brief Field _songPackMaskToSerializedNameDict, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__songPackMaskToSerializedNameDict, put=__cordl_internal_set__songPackMaskToSerializedNameDict)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SongPackMask,::StringW>*  _songPackMaskToSerializedNameDict;

/// @brief Field _songPackSerializedNameToMaskInfoDict, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__songPackSerializedNameToMaskInfoDict, put=__cordl_internal_set__songPackSerializedNameToMaskInfoDict)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::SongPackMasksModel_MaskInfo>*  _songPackSerializedNameToMaskInfoDict;
...
/// @brief Method GetSongPackMaskText, addr 0x364151c, size 0x88, virtual false, abstract: false, final false
inline ::GlobalNamespace::SongPackMasksModel_LocalizedText GetSongPackMaskText(::GlobalNamespace::SongPackMask  songPackMask) ;

/// @brief Method Init, addr 0x3640c60, size 0x564, virtual false, abstract: false, final false
inline void Init() ;
...
/// @brief Method ToLocalizedName, addr 0x3641464, size 0xb8, virtual false, abstract: false, final false
inline ::GlobalNamespace::SongPackMasksModel_LocalizedText ToLocalizedName(::StringW  serializedName) ;

/// @brief Method ToSerializedName, addr 0x36415a4, size 0x80, virtual false, abstract: false, final false
inline ::StringW ToSerializedName(::GlobalNamespace::SongPackMask  songPackMask) ;

/// @brief Method ToSongPackMask, addr 0x36411c4, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x3640bc4, size 0x9c, virtual false, abstract: false, final false
