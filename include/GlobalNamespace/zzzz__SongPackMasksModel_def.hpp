...
public:
  ...
  /// @brief Method .ctor, addr 0x364140c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method get_text, addr 0x3641670, size 0xc, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x3641418, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method GetSongPackMaskText, addr 0x36414e0, size 0x88, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SongPackMasksModel_LocalizedText GetSongPackMaskText(::GlobalNamespace::SongPackMask songPackMask);

  /// @brief Method Init, addr 0x3640c24, size 0x564, virtual false, abstract: false, final false
  inline void Init();
  ...
  /// @brief Method ToLocalizedName, addr 0x3641428, size 0xb8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SongPackMasksModel_LocalizedText ToLocalizedName(::StringW serializedName);

  /// @brief Method ToSerializedName, addr 0x3641568, size 0x80, virtual false, abstract: false, final false
  inline ::StringW ToSerializedName(::GlobalNamespace::SongPackMask songPackMask);

  /// @brief Method ToSongPackMask, addr 0x3641188, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3640b88, size 0x9c, virtual false, abstract: false, final false
