...
GlobalNamespace::PreviewBeatmapLevelCollectionSO::__cordl_internal_get__beatmapLevels() {
...
GlobalNamespace::PreviewBeatmapLevelCollectionSO::__cordl_internal_get__beatmapLevels() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____beatmapLevels;
}
constexpr void GlobalNamespace::PreviewBeatmapLevelCollectionSO::__cordl_internal_set__beatmapLevels(
...
inline ::GlobalNamespace::PreviewBeatmapLevelCollectionSO* GlobalNamespace::PreviewBeatmapLevelCollectionSO::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::PreviewBeatmapLevelCollectionSO*>());
}
