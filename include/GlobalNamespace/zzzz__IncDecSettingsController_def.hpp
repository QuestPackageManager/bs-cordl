...
public:
  ...
  /// @brief Method set_enableDec, addr 0x2404858, size 0x28, virtual false, abstract: false, final false
  inline void set_enableDec(bool value);

  /// @brief Method set_enableInc, addr 0x24048a0, size 0x28, virtual false, abstract: false, final false
  inline void set_enableInc(bool value);

  /// @brief Method set_text, addr 0x24048e8, size 0x2c, virtual false, abstract: false, final false
  inline void set_text(::StringW value);

  /// @brief Method Awake, addr 0x2404938, size 0xb8, virtual true, abstract: false, final false
  inline void Awake();

  /// @brief Method OnDestroy, addr 0x2404b28, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2404d64, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
