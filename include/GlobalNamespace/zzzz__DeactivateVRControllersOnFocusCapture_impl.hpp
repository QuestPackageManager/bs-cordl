...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::GlobalNamespace::DeactivateVRControllersOnFocusCapture::*)()>(
  ...
  constexpr static std::size_t addrs = 0x39be7c4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DeactivateVRControllersOnFocusCapture::*)()>(
  ...
  constexpr static std::size_t addrs = 0x39be804;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DeactivateVRControllersOnFocusCapture::*)()>(
  ...
  constexpr static std::size_t addrs = 0x39bec88;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DeactivateVRControllersOnFocusCapture::*)()>(
  ...
  constexpr static std::size_t addrs = 0x39bee1c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DeactivateVRControllersOnFocusCapture::*)()>(
  ...
  constexpr static std::size_t addrs = 0x39bea28;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DeactivateVRControllersOnFocusCapture*>::get(),
                                                                               "UpdateVRControllerActiveState", std::span<Il2CppClass const* const, 0>(), ::std::span<Il2CppType const* const, 0>())));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DeactivateVRControllersOnFocusCapture::*)()>(
  ...
  constexpr static std::size_t addrs = 0x39bee20;
...
constexpr ::ArrayW<::UnityW<::GlobalNamespace::VRController>, ::Array<::UnityW<::GlobalNamespace::VRController>>*>&
GlobalNamespace::DeactivateVRControllersOnFocusCapture::__cordl_internal_get__vrControllers() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____vrControllers;
}
constexpr ::ArrayW<::UnityW<::GlobalNamespace::VRController>, ::Array<::UnityW<::GlobalNamespace::VRController>>*> const&
GlobalNamespace::DeactivateVRControllersOnFocusCapture::__cordl_internal_get__vrControllers() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____vrControllers;
}
constexpr void GlobalNamespace::DeactivateVRControllersOnFocusCapture::__cordl_internal_set__vrControllers(
    ::ArrayW<::UnityW<::GlobalNamespace::VRController>, ::Array<::UnityW<::GlobalNamespace::VRController>>*> value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::DeactivateVRControllersOnFocusCapture::__cordl_internal_get__vrControllerGameObjects() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
GlobalNamespace::DeactivateVRControllersOnFocusCapture::__cordl_internal_get__vrControllerGameObjects() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____vrControllerGameObjects;
}
constexpr void GlobalNamespace::DeactivateVRControllersOnFocusCapture::__cordl_internal_set__vrControllerGameObjects(
