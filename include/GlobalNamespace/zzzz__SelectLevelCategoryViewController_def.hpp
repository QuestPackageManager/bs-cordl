...
MARK_REF_T(::GlobalNamespace::SelectLevelCategoryViewController*);
MARK_REF_T(::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*);
MARK_REF_T(::GlobalNamespace::SelectLevelCategoryViewController___c*);
MARK_REF_T(::GlobalNamespace::SelectLevelCategoryViewController___c__DisplayClass12_0*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory, "", "SelectLevelCategoryViewController/LevelCategory");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectLevelCategoryViewController*, "", "SelectLevelCategoryViewController");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*, "", "SelectLevelCategoryViewController/LevelCategoryInfo");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectLevelCategoryViewController___c*, "", "SelectLevelCategoryViewController/<>c");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SelectLevelCategoryViewController___c__DisplayClass12_0*, "", "SelectLevelCategoryViewController/<>c__DisplayClass12_0");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory) == 0x4, "Size mismatch!");
...
public:
  ...
  /// @brief Method .ctor, addr 0x5955aa8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Setup>b__12_1, addr 0x5955b04, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method <Setup>b__12_2, addr 0x5955b78, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5955b00, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <Setup>b__0, addr 0x5955b8c, size 0x64, virtual false, abstract: false, final false
  inline bool _Setup_b__0(::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo* data);

  constexpr ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory> const& __cordl_internal_get_enabledLevelCategories() const;

  constexpr ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory>& __cordl_internal_get_enabledLevelCategories();

  constexpr void __cordl_internal_set_enabledLevelCategories(::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory> value);

  /// @brief Method .ctor, addr 0x59556d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory> ___enabledLevelCategories;
...
static_assert(sizeof(::GlobalNamespace::SelectLevelCategoryViewController___c__DisplayClass12_0) == 0x18, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies HMUI.ViewController, SelectLevelCategoryViewController::LevelCategory, SelectLevelCategoryViewController::LevelCategoryInfo
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__levelCategoryInfos, put = __cordl_internal_set__levelCategoryInfos)) ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*>
      _levelCategoryInfos;
  ...
  /// @brief Method DidActivate, addr 0x59556d8, size 0xb0, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x5955788, size 0xb0, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method LevelFilterCategoryIconSegmentedControlDidSelectCell, addr 0x5955838, size 0x26c, virtual false, abstract: false, final false
  ...
  /// @brief Method Setup, addr 0x594f5ac, size 0x354, virtual false, abstract: false, final false
  inline void Setup(::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory selectedCategory,
                    ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory> enabledLevelCategories);

  constexpr ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*> const& __cordl_internal_get__allLevelCategoryInfos() const;

  constexpr ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*>& __cordl_internal_get__allLevelCategoryInfos();

  constexpr ::GlobalNamespace::IAnalyticsModel* const& __cordl_internal_get__analyticsModel() const;

  constexpr ::GlobalNamespace::IAnalyticsModel*& __cordl_internal_get__analyticsModel();

  constexpr ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*> const& __cordl_internal_get__levelCategoryInfos() const;

  constexpr ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*>& __cordl_internal_get__levelCategoryInfos();
  ...
  constexpr void __cordl_internal_set__allLevelCategoryInfos(::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*> value);

  constexpr void __cordl_internal_set__analyticsModel(::GlobalNamespace::IAnalyticsModel* value);

  constexpr void __cordl_internal_set__levelCategoryInfos(::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*> value);
  ...
  /// @brief Method .ctor, addr 0x5955aa4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didSelectLevelCategoryEvent, addr 0x594fd6c, size 0xc0, virtual false, abstract: false, final false
  inline void
  ...
  /// @brief Method get_selectedLevelCategory, addr 0x594f0e0, size 0x4c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::SelectLevelCategoryViewController_LevelCategory get_selectedLevelCategory();

  /// @brief Method remove_didSelectLevelCategoryEvent, addr 0x59505a0, size 0xc0, virtual false, abstract: false, final false
  inline void
...
public:
  ...
  ::ArrayW<::GlobalNamespace::SelectLevelCategoryViewController_LevelCategoryInfo*> ____levelCategoryInfos;
...
static_assert(sizeof(::GlobalNamespace::SelectLevelCategoryViewController) == 0xa8, "Size mismatch!");
