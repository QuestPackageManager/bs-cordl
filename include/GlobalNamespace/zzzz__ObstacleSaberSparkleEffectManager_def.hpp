...
public:
  ...
  /// @brief Method FindBoxSurfaceRotation, addr 0x57df4e8, size 0x1ac, virtual false, abstract: false, final false
  static inline ::UnityEngine::Quaternion FindBoxSurfaceRotation(::ByRef<::UnityEngine::Bounds> bounds, ::UnityEngine::Vector3 position);

  /// @brief Method IntersectBounds, addr 0x57def5c, size 0x1e0, virtual false, abstract: false, final false
  static inline bool IntersectBounds(::UnityEngine::Bounds bounds, ::UnityEngine::Vector3 start, ::UnityEngine::Vector3 end);

  /// @brief Method IntersectBoxSurfacePose, addr 0x57def18, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectBoxSurfacePosition, addr 0x57df13c, size 0x3ac, virtual false, abstract: false, final false
  ...
  /// @brief Method IntersectSaberWithObstacles, addr 0x57dea20, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x57de468, size 0x25c, virtual false, abstract: false, final false
  inline void Start();

  /// @brief Method Update, addr 0x57de76c, size 0x278, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x57df694, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_sparkleEffectDidEndEvent, addr 0x57de2e8, size 0xc0, virtual false, abstract: false, final false
  inline void add_sparkleEffectDidEndEvent(::System::Action_1<::GlobalNamespace::SaberType>* value);

  /// @brief Method add_sparkleEffectDidStartEvent, addr 0x57de168, size 0xc0, virtual false, abstract: false, final false
  inline void add_sparkleEffectDidStartEvent(::System::Action_1<::GlobalNamespace::SaberType>* value);

  /// @brief Method remove_sparkleEffectDidEndEvent, addr 0x57de3a8, size 0xc0, virtual false, abstract: false, final false
  inline void remove_sparkleEffectDidEndEvent(::System::Action_1<::GlobalNamespace::SaberType>* value);

  /// @brief Method remove_sparkleEffectDidStartEvent, addr 0x57de228, size 0xc0, virtual false, abstract: false, final false
