...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4907)), TypeDefinitionIndex(TypeDefinitionIndex(11039)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4907), inst:
// 4731 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(4911)) CS Name: ::NoteJumpDurationTypeSettingsDropdown*
...
public:
  // Declarations
  /// @brief Method GetNamedValues, addr 0x22dec80, size 0xf4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x22ded74, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
