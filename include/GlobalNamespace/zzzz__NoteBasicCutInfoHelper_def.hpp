...
public:
  // Declarations
  /// @brief Method GetBasicCutInfo, addr 0x377eaf4, size 0x18c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NoteBasicCutInfoHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NoteBasicCutInfoHelper(NoteBasicCutInfoHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NoteBasicCutInfoHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NoteBasicCutInfoHelper(NoteBasicCutInfoHelperconst&) = delete;
