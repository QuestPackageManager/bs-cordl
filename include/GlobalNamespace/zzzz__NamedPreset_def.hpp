...
public:
  ...
  /// @brief Method .ctor, addr 0x372d010, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_presetNameLocalizationKey, addr 0x372d068, size 0x8, virtual false, abstract: false, final false
