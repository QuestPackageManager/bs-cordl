...
public:
  ...
  /// @brief Method .ctor, addr 0x26d2a7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_presetNameLocalizationKey, addr 0x26d2b00, size 0x8, virtual false, abstract: false, final false
