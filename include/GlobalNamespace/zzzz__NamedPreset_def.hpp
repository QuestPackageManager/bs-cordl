...
/// @brief Method .ctor, addr 0x3633078, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_presetNameLocalizationKey, addr 0x36330d0, size 0x8, virtual false, abstract: false, final false
