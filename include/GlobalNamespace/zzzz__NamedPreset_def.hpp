...
public:
  ...
  /// @brief Method .ctor, addr 0x13d46bc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_presetNameLocalizationKey, addr 0x13d6b74, size 0x8, virtual false, abstract: false, final false
