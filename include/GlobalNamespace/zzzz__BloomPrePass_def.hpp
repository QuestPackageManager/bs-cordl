...
public:
  ...
  /// @brief Method Awake, addr 0x564bf18, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LazyInit, addr 0x564bf1c, size 0xc4, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::GlobalNamespace::BloomPrePass* New_ctor();

  /// @brief Method OnDestroy, addr 0x564c150, size 0xb0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPostRender, addr 0x564d2c0, size 0x9c, virtual false, abstract: false, final false
  inline void OnPostRender();

  /// @brief Method OnPreRender, addr 0x564c200, size 0x1d8, virtual false, abstract: false, final false
  inline void OnPreRender();

  /// @brief Method SetMode, addr 0x564d380, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x564d388, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
