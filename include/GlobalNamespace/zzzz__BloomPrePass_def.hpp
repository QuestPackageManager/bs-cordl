...
public:
  ...
  /// @brief Method Awake, addr 0x56acb60, size 0x4, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LazyInit, addr 0x56acb64, size 0xc4, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::GlobalNamespace::BloomPrePass* New_ctor();

  /// @brief Method OnDestroy, addr 0x56acd98, size 0xb0, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method OnPostRender, addr 0x56adf08, size 0x9c, virtual false, abstract: false, final false
  inline void OnPostRender();

  /// @brief Method OnPreRender, addr 0x56ace48, size 0x1d8, virtual false, abstract: false, final false
  inline void OnPreRender();

  /// @brief Method SetMode, addr 0x56adfc8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x56adfd0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
