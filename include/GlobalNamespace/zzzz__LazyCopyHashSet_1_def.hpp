...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LazyCopyHashSet_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LazyCopyHashSet_1(LazyCopyHashSet_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LazyCopyHashSet_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LazyCopyHashSet_1(LazyCopyHashSet_1const&) = delete;
