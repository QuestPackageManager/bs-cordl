...
public:
  ...
  /// @brief Method Awake, addr 0x5866c18, size 0x98, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LazyInit, addr 0x5866cb0, size 0x34, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::GlobalNamespace::SpectrogramRowPropertyAnimator* New_ctor();

  /// @brief Method SetMultiplier, addr 0x5866d8c, size 0x8, virtual false, abstract: false, final false
  inline void SetMultiplier(float_t value);

  /// @brief Method SetProperty, addr 0x5866be8, size 0x30, virtual true, abstract: false, final false
  inline void SetProperty();

  /// @brief Method Update, addr 0x5866ce4, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5866d94, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
