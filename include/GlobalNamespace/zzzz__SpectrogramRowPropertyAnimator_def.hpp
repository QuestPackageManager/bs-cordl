...
// Write type traits
MARK_REF_T(::GlobalNamespace::SpectrogramRowPropertyAnimator*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SpectrogramRowPropertyAnimator*, "", "SpectrogramRowPropertyAnimator");
...
public:
  ...
  /// @brief Method Awake, addr 0x59a7d78, size 0x98, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method LazyInit, addr 0x59a7e10, size 0x34, virtual false, abstract: false, final false
  inline void LazyInit();

  static inline ::GlobalNamespace::SpectrogramRowPropertyAnimator* New_ctor();

  /// @brief Method SetMultiplier, addr 0x59a7eec, size 0x8, virtual false, abstract: false, final false
  inline void SetMultiplier(float_t value);

  /// @brief Method SetProperty, addr 0x59a7d48, size 0x30, virtual true, abstract: false, final false
  inline void SetProperty();

  /// @brief Method Update, addr 0x59a7e44, size 0xa8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x59a7ef4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SpectrogramRowPropertyAnimator", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SpectrogramRowPropertyAnimator(SpectrogramRowPropertyAnimator&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SpectrogramRowPropertyAnimator", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SpectrogramRowPropertyAnimator(SpectrogramRowPropertyAnimatorconst&) = delete;
...
static_assert(sizeof(::GlobalNamespace::SpectrogramRowPropertyAnimator) == 0x60, "Size mismatch!");
