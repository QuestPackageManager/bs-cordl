...
public:
  ...
  /// @brief Method .ctor, addr 0x3259bfc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "BeatmapDataItemExecutionOrderConstants", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  BeatmapDataItemExecutionOrderConstants(BeatmapDataItemExecutionOrderConstants&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "BeatmapDataItemExecutionOrderConstants", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  BeatmapDataItemExecutionOrderConstants(BeatmapDataItemExecutionOrderConstantsconst&) = delete;
