...
public:
  ...
  /// @brief Method .ctor addr 0x222e390 size 0x4 virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::PS5LevelProductsModelSO, 0x30>, "Size mismatch!");
