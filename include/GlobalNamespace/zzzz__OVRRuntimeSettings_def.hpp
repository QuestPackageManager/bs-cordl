...
public:
  ...
  /// @brief Method GetRuntimeSettings, addr 0x5d83790, size 0x174, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRRuntimeSettings> GetRuntimeSettings();

  /// @brief Method HandleSettingsCreated, addr 0x5d83a00, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5d83a04, size 0x70, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_BodyTrackingFidelity, addr 0x5d839e0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_BodyTrackingFidelity2 get_BodyTrackingFidelity();

  /// @brief Method get_BodyTrackingJointSet, addr 0x5d839f0, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRPlugin_BodyJointSet get_BodyTrackingJointSet();

  /// @brief Method get_EnableFaceTrackingVisemesOutput, addr 0x5d83924, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnableFaceTrackingVisemesOutput();

  /// @brief Method get_HandSkeletonVersion, addr 0x5d836dc, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::OVRHandSkeletonVersion get_HandSkeletonVersion();

  /// @brief Method get_Instance, addr 0x5d836ec, size 0xa4, virtual false, abstract: false, final false
  static inline ::UnityW<::GlobalNamespace::OVRRuntimeSettings> get_Instance();

  /// @brief Method get_RequestsAudioFaceTracking, addr 0x5d83914, size 0x8, virtual false, abstract: false, final false
  inline bool get_RequestsAudioFaceTracking();

  /// @brief Method get_RequestsVisualFaceTracking, addr 0x5d83904, size 0x8, virtual false, abstract: false, final false
  inline bool get_RequestsVisualFaceTracking();

  /// @brief Method get_TelemetryProjectGuid, addr 0x5d8399c, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method set_BodyTrackingFidelity, addr 0x5d839e8, size 0x8, virtual false, abstract: false, final false
  inline void set_BodyTrackingFidelity(::GlobalNamespace::OVRPlugin_BodyTrackingFidelity2 value);

  /// @brief Method set_BodyTrackingJointSet, addr 0x5d839f8, size 0x8, virtual false, abstract: false, final false
  inline void set_BodyTrackingJointSet(::GlobalNamespace::OVRPlugin_BodyJointSet value);

  /// @brief Method set_EnableFaceTrackingVisemesOutput, addr 0x5d8392c, size 0x70, virtual false, abstract: false, final false
  inline void set_EnableFaceTrackingVisemesOutput(bool value);

  /// @brief Method set_HandSkeletonVersion, addr 0x5d836e4, size 0x8, virtual false, abstract: false, final false
  inline void set_HandSkeletonVersion(::GlobalNamespace::OVRHandSkeletonVersion value);

  /// @brief Method set_RequestsAudioFaceTracking, addr 0x5d8391c, size 0x8, virtual false, abstract: false, final false
  inline void set_RequestsAudioFaceTracking(bool value);

  /// @brief Method set_RequestsVisualFaceTracking, addr 0x5d8390c, size 0x8, virtual false, abstract: false, final false
