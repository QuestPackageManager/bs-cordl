...
public:
  ...
  /// @brief Method get_Instance, addr 0x277f4c0, size 0x9c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::OVRRuntimeSettings* get_Instance();

  /// @brief Method OnEnable, addr 0x277f670, size 0x4c, virtual false, abstract: false, final false
  inline void OnEnable();

  /// @brief Method get_HasSetTelemetryEnabled, addr 0x277f6bc, size 0x8, virtual false, abstract: false, final false
  inline bool get_HasSetTelemetryEnabled();

  /// @brief Method get_TelemetryEnabled, addr 0x277f6c4, size 0x20, virtual false, abstract: false, final false
  inline bool get_TelemetryEnabled();

  /// @brief Method GetRuntimeSettings, addr 0x277f55c, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x277f6e4, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
