...
/// @brief Method ToConstructorString, addr 0x322abcc, size 0x118, virtual false, abstract: false, final false
static inline ::StringW ToConstructorString(::UnityEngine::Pose  pose) ;

/// @brief Method ToConstructorString, addr 0x322aa28, size 0x1a4, virtual false, abstract: false, final false
static inline ::StringW ToConstructorString(::UnityEngine::Quaternion  quaternion) ;

/// @brief Method ToConstructorString, addr 0x322a94c, size 0xdc, virtual false, abstract: false, final false
