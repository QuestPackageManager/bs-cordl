...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14741)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14741), inst: 951 }),
// TypeDefinitionIndex(TypeDefinitionIndex(14734))} Self: TypeDefinitionIndex(TypeDefinitionIndex(14745)) CS Name: ::LightColorBeatmapEventDataProcessor*
