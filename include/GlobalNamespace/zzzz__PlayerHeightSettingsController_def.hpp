...
public:
  ...
  /// @brief Method AutoSetHeight, addr 0x58e43dc, size 0x118, virtual false, abstract: false, final false
  inline void AutoSetHeight();

  /// @brief Method Awake, addr 0x58e4250, size 0xc8, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Init, addr 0x58e4318, size 0x8, virtual false, abstract: false, final false
  inline void Init(float_t playerHeight);

  static inline ::GlobalNamespace::PlayerHeightSettingsController* New_ctor();

  /// @brief Method RefreshUI, addr 0x58e4320, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e44f4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_valueDidChangeEvent, addr 0x58e40c8, size 0xc0, virtual false, abstract: false, final false
  inline void add_valueDidChangeEvent(::System::Action_1<float_t>* value);

  /// @brief Method get_value, addr 0x58e4248, size 0x8, virtual false, abstract: false, final false
  inline float_t get_value();

  /// @brief Method remove_valueDidChangeEvent, addr 0x58e4188, size 0xc0, virtual false, abstract: false, final false
