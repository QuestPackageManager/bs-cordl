...
public:
  ...
  /// @brief Method Update, addr 0x22bb330, size 0x44, virtual false, abstract: false, final false
  inline void Update();

  static inline ::GlobalNamespace::SongTimeAnimationPlayer* New_ctor();

  /// @brief Method .ctor, addr 0x22bb374, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
