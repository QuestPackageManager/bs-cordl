...
public:
  ...
  /// @brief Method Update, addr 0x2623748, size 0x44, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x262378c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
