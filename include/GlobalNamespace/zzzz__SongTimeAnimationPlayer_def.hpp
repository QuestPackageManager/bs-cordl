...
// Write type traits
MARK_REF_T(::GlobalNamespace::SongTimeAnimationPlayer*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::SongTimeAnimationPlayer*, "", "SongTimeAnimationPlayer");
...
public:
  ...
  /// @brief Method Update, addr 0x58bb9a8, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58bba04, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::SongTimeAnimationPlayer) == 0x30, "Size mismatch!");
