...
public:
  ...
  /// @brief Method Update, addr 0x250c83c, size 0x44, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x250c880, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
