...
public:
  ...
  /// @brief Method Update, addr 0x3ad5a60, size 0x44, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3ad5aa4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
