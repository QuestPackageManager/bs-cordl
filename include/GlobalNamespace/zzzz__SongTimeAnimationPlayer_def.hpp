...
public:
  ...
  /// @brief Method Update, addr 0x56afc68, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x56afcc4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
