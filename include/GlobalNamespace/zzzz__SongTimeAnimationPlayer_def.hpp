...
public:
  ...
  /// @brief Method Update, addr 0x571091c, size 0x5c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5710978, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
