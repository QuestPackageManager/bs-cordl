...
public:
  // Declarations
  /// @brief Method AnyContains, addr 0x229ecc0, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x229eca0, size 0x20, virtual false, abstract: false, final false
  static inline bool Contains(::StringW source, ::StringW substring, ::System::StringComparison comp);

  /// @brief Method Truncate, addr 0x229ebd8, size 0xc8, virtual false, abstract: false, final false
