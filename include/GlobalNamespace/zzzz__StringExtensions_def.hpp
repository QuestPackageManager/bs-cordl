...
public:
  // Declarations
  /// @brief Method AnyContains, addr 0x229fea4, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x229fe84, size 0x20, virtual false, abstract: false, final false
  static inline bool Contains(::StringW source, ::StringW substring, ::System::StringComparison comp);

  /// @brief Method Truncate, addr 0x229fdbc, size 0xc8, virtual false, abstract: false, final false
