...
public:
// Declarations
/// @brief Method AnyContains, addr 0x32165e4, size 0x88, virtual false, abstract: false, final false
...
/// @brief Method Contains, addr 0x32165bc, size 0x28, virtual false, abstract: false, final false
static inline bool Contains(::StringW  source, ::StringW  substring, ::System::StringComparison  comp) ;

/// @brief Method Truncate, addr 0x3216500, size 0xbc, virtual false, abstract: false, final false
