...
public:
  // Declarations
  /// @brief Method AnyContains, addr 0x229ff34, size 0x8c, virtual false, abstract: false, final false
  ...
  /// @brief Method Contains, addr 0x229ff14, size 0x20, virtual false, abstract: false, final false
  static inline bool Contains(::StringW source, ::StringW substring, ::System::StringComparison comp);

  /// @brief Method Truncate, addr 0x229fe4c, size 0xc8, virtual false, abstract: false, final false
