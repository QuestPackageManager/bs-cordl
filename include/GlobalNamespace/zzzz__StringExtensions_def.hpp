...
public:
  // Declarations
  /// @brief Method Contains, addr 0x107b6c8, size 0x20, virtual false, abstract: false, final false
  static inline bool Contains(::StringW source, ::StringW substring, ::System::StringComparison comp);

  /// @brief Method Truncate, addr 0x107b600, size 0xc8, virtual false, abstract: false, final false
