...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RunLevelMenuDestination", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RunLevelMenuDestination(RunLevelMenuDestination&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RunLevelMenuDestination", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  RunLevelMenuDestination(RunLevelMenuDestinationconst&) = delete;
