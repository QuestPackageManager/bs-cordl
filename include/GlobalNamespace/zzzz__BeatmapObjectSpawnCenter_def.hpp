...
public:
  ...
  /// @brief Method .ctor, addr 0x578d7b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_distance, addr 0x578d7ac, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_playerCount, addr 0x578d7a4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CalculateSpawnCenterPosition, addr 0x578d5f4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReportAndSaveSpawnCenterDistance, addr 0x578d770, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x578d798, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_spawnCenterDistanceWasFoundEvent, addr 0x578d474, size 0xc0, virtual false, abstract: false, final false
  inline void add_spawnCenterDistanceWasFoundEvent(::System::Action_1<float_t>* value);

  /// @brief Method get_spawnCenterDistance, addr 0x578d464, size 0x8, virtual false, abstract: false, final false
  inline float_t get_spawnCenterDistance();

  /// @brief Method get_spawnCenterDistanceWasFound, addr 0x578d46c, size 0x8, virtual false, abstract: false, final false
  inline bool get_spawnCenterDistanceWasFound();

  /// @brief Method remove_spawnCenterDistanceWasFoundEvent, addr 0x578d534, size 0xc0, virtual false, abstract: false, final false
