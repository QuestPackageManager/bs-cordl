...
// Write type traits
MARK_REF_T(::GlobalNamespace::BeatmapObjectSpawnCenter*);
MARK_REF_T(::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapObjectSpawnCenter*, "", "BeatmapObjectSpawnCenter");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance*, "", "BeatmapObjectSpawnCenter/PlayerCountToDistance");
...
public:
  ...
  /// @brief Method .ctor, addr 0x58cbe74, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_distance, addr 0x58cbe6c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_distance();

  /// @brief Method get_playerCount, addr 0x58cbe64, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance) == 0x18, "Size mismatch!");

} // namespace GlobalNamespace
// Dependencies BeatmapObjectSpawnCenter::PlayerCountToDistance, UnityEngine.MonoBehaviour
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get__distances, put = __cordl_internal_set__distances)) ::ArrayW<::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance*> _distances;
  ...
  /// @brief Method CalculateSpawnCenterPosition, addr 0x58cbcb4, size 0x17c, virtual false, abstract: false, final false
  ...
  /// @brief Method ReportAndSaveSpawnCenterDistance, addr 0x58cbe30, size 0x28, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance*> const& __cordl_internal_get__distances() const;

  constexpr ::ArrayW<::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance*>& __cordl_internal_get__distances();
  ...
  constexpr void __cordl_internal_set__distances(::ArrayW<::GlobalNamespace::BeatmapObjectSpawnCenter_PlayerCountToDistance*> value);
  ...
  /// @brief Method .ctor, addr 0x58cbe58, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_spawnCenterDistanceWasFoundEvent, addr 0x58cbb34, size 0xc0, virtual false, abstract: false, final false
  inline void add_spawnCenterDistanceWasFoundEvent(::System::Action_1<float_t>* value);

  /// @brief Method get_spawnCenterDistance, addr 0x58cbb24, size 0x8, virtual false, abstract: false, final false
  inline float_t get_spawnCenterDistance();

  /// @brief Method get_spawnCenterDistanceWasFound, addr 0x58cbb2c, size 0x8, virtual false, abstract: false, final false
  inline bool get_spawnCenterDistanceWasFound();

  /// @brief Method remove_spawnCenterDistanceWasFoundEvent, addr 0x58cbbf4, size 0xc0, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::BeatmapObjectSpawnCenter) == 0x40, "Size mismatch!");
