...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompositeTransformTarget", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompositeTransformTarget(CompositeTransformTarget&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompositeTransformTarget", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompositeTransformTarget(CompositeTransformTargetconst&) = delete;
