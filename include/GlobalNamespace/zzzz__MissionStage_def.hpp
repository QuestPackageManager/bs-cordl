...
public:
  ...
  /// @brief Method get_minimumMissionsToUnlock, addr 0x1294540, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_minimumMissionsToUnlock();

  /// @brief Method get_position, addr 0x1294548, size 0x1c, virtual false, abstract: false, final false
  inline ::UnityEngine::Vector2 get_position();

  static inline ::GlobalNamespace::MissionStage* New_ctor();

  /// @brief Method .ctor, addr 0x1294564, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
