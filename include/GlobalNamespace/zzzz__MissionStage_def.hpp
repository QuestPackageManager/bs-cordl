...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MissionStage", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MissionStage(MissionStage&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MissionStage", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MissionStage(MissionStageconst&) = delete;
