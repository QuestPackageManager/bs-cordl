...
public:
  ...
  /// @brief Method get_minimumMissionsToUnlock, addr 0x3608b8c, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_minimumMissionsToUnlock();

  /// @brief Method get_position, addr 0x3608b94, size 0x18, virtual false, abstract: false, final false
