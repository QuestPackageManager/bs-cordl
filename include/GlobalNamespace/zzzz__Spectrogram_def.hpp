...
/// @brief Field _meshRenderers, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__meshRenderers, put=__cordl_internal_set__meshRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>,::Array<::UnityW<::UnityEngine::MeshRenderer>>*>  _meshRenderers;

/// @brief Field _setAsGlobal, offset 0x20, size 0x1 
...
/// @brief Method Awake, addr 0x57f4754, size 0x118, virtual false, abstract: false, final false
inline void Awake() ;

static inline ::GlobalNamespace::Spectrogram* New_ctor() ;

/// @brief Method Update, addr 0x57f486c, size 0x1b0, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x57f4a1c, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_materialPropertyBlock, addr 0x57f4698, size 0xbc, virtual false, abstract: false, final false
