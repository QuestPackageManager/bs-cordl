...
public:
  ...
  /// @brief Method Awake, addr 0x27037e8, size 0xf0, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::Spectrogram* New_ctor();

  /// @brief Method Update, addr 0x27038d8, size 0x1a8, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x2703a80, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_materialPropertyBlock, addr 0x2703734, size 0xb4, virtual false, abstract: false, final false
