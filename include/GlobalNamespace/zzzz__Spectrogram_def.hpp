...
public:
  ...
  __declspec(property(get = __cordl_internal_get__meshRenderers, put = __cordl_internal_set__meshRenderers)) ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> _meshRenderers;
  ...
  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> const& __cordl_internal_get__meshRenderers() const;

  constexpr ::ArrayW<::UnityW<::UnityEngine::MeshRenderer>>& __cordl_internal_get__meshRenderers();
  ...
  constexpr void __cordl_internal_set__meshRenderers(::ArrayW<::UnityW<::UnityEngine::MeshRenderer>> value);
...
static_assert(sizeof(::GlobalNamespace::Spectrogram) == 0x40, "Size mismatch!");
