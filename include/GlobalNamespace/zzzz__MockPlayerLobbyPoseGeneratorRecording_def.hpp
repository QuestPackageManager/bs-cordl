...
public:
  ...
  /// @brief Method .ctor addr 0x2101b14 size 0x8 virtual false final false
  inline void _ctor(::GlobalNamespace::IMultiplayerSessionManager* multiplayerSessionManager);

  /// @brief Method Init addr 0x2103428 size 0x68 virtual true final false
  inline void Init();

  /// @brief Method Tick addr 0x2103490 size 0x68 virtual true final false
  inline void Tick();
