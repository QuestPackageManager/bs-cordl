...
public:
// Declarations
/// @brief Method Init, addr 0x58244d4, size 0x70, virtual true, abstract: false, final false
inline void Init() ;
...
/// @brief Method Tick, addr 0x5824544, size 0x70, virtual true, abstract: false, final false
inline void Tick() ;

/// @brief Method .ctor, addr 0x58224bc, size 0x8, virtual false, abstract: false, final false
