...
public:
  ...
  /// @brief Method .ctor, addr 0x58e682c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_component, addr 0x58e681c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::UI::Button> get_component();

  /// @brief Method get_label, addr 0x58e6824, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <Init>b__12_0, addr 0x58e6888, size 0x8, virtual false, abstract: false, final false
  inline ::StringW _Init_b__12_0(::System::ValueTuple_2<::StringW, int32_t> e);

  /// @brief Method .ctor, addr 0x58e6884, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <DidActivate>b__0, addr 0x58e6890, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e66e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method DidActivate, addr 0x58e6570, size 0x178, virtual true, abstract: false, final false
  inline void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling);

  /// @brief Method DidDeactivate, addr 0x58e66ec, size 0xc, virtual true, abstract: false, final false
  inline void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling);

  /// @brief Method Init, addr 0x58d8c24, size 0x27c, virtual false, abstract: false, final false
  ...
  /// @brief Method OnButtonClick, addr 0x58e66f8, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e6778, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add__didFinishAction, addr 0x58e63f0, size 0xc0, virtual false, abstract: false, final false
  inline void add__didFinishAction(::System::Action_1<::System::ValueTuple_2<int32_t, int32_t>>* value);

  /// @brief Method get_selectedValue, addr 0x58e63b4, size 0x3c, virtual false, abstract: false, final false
  inline int32_t get_selectedValue();

  /// @brief Method remove__didFinishAction, addr 0x58e64b0, size 0xc0, virtual false, abstract: false, final false
