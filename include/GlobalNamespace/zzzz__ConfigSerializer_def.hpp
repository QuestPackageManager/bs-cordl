...
public:
  // Declarations
  /// @brief Method LoadConfig, addr 0x570e5ac, size 0x498, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveConfig, addr 0x570e1e4, size 0x3c8, virtual false, abstract: false, final false
  static inline void SaveConfig(::System::Object* config, ::StringW filePath);

  /// @brief Method .ctor, addr 0x570ea44, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
