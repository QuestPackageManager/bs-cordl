...
public:
  // Declarations
  /// @brief Method LoadConfig, addr 0x39c4358, size 0x560, virtual false, abstract: false, final false
  ...
  /// @brief Method SaveConfig, addr 0x39c3f24, size 0x434, virtual false, abstract: false, final false
  static inline void SaveConfig(::System::Object* config, ::StringW filePath);

  /// @brief Method .ctor, addr 0x39c48b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
