...
template<typename T>
constexpr  GlobalNamespace::EnumTableViewDataSource_1<T>::operator ::HMUI::TableView_IDataSource*() noexcept {
return static_cast<::HMUI::TableView_IDataSource*>(static_cast<void*>(this));
}
/// @brief Convert to "::HMUI::TableView_IDataSource"
template<typename T>
constexpr ::HMUI::TableView_IDataSource* GlobalNamespace::EnumTableViewDataSource_1<T>::i___HMUI__TableView_IDataSource() noexcept {
return static_cast<::HMUI::TableView_IDataSource*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename T>
