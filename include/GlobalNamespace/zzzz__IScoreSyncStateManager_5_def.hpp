...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IScoreSyncStateManager_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IScoreSyncStateManager_5(IScoreSyncStateManager_5const&) = delete;
