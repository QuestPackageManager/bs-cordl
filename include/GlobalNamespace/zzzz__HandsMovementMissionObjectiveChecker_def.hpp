...
public:
  ...
  /// @brief Method HandleTotalDistanceDidChange, addr 0x271824c, size 0x60, virtual false, abstract: false, final false
  inline void HandleTotalDistanceDidChange(float_t distance);

  /// @brief Method Init, addr 0x27182ac, size 0x108, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::HandsMovementMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x2718178, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27183b4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
