...
public:
  ...
  /// @brief Method HandleTotalDistanceDidChange, addr 0x24c0168, size 0x60, virtual false, abstract: false, final false
  inline void HandleTotalDistanceDidChange(float_t distance);

  /// @brief Method Init, addr 0x24c01c8, size 0x108, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::HandsMovementMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x24c0094, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x24c02d0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
