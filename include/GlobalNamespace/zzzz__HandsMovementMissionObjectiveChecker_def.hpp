...
public:
  ...
  /// @brief Method HandleTotalDistanceDidChange, addr 0x587ce58, size 0x60, virtual false, abstract: false, final false
  inline void HandleTotalDistanceDidChange(float_t distance);

  /// @brief Method Init, addr 0x587ceb8, size 0x10c, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::HandsMovementMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x587cd44, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x587cfc4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
