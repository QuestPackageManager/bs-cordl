...
public:
  ...
  /// @brief Method HandleTotalDistanceDidChange, addr 0x25ec658, size 0x60, virtual false, abstract: false, final false
  inline void HandleTotalDistanceDidChange(float_t distance);

  /// @brief Method Init, addr 0x25ec6b8, size 0x108, virtual true, abstract: false, final false
  inline void Init();

  static inline ::GlobalNamespace::HandsMovementMissionObjectiveChecker* New_ctor();

  /// @brief Method OnDestroy, addr 0x25ec584, size 0xd4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25ec7c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
