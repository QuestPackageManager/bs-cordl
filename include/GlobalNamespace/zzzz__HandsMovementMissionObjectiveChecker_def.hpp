...
/// @brief Method HandleTotalDistanceDidChange, addr 0x580af0c, size 0x60, virtual false, abstract: false, final false
inline void HandleTotalDistanceDidChange(float_t  distance) ;

/// @brief Method Init, addr 0x580af6c, size 0x10c, virtual true, abstract: false, final false
inline void Init() ;

static inline ::GlobalNamespace::HandsMovementMissionObjectiveChecker* New_ctor() ;

/// @brief Method OnDestroy, addr 0x580adf8, size 0x114, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x580b078, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
