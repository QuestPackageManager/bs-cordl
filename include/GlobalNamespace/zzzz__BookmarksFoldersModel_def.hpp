...
public:
  ...
  /// @brief Method .ctor, addr 0x3647824, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_bookmarksFolders>b__3_0, addr 0x3647828, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x36477c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bookmarksFolders, addr 0x3647230, size 0x58c, virtual false, abstract: false, final false
