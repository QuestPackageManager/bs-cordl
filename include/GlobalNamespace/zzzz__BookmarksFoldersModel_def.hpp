...
public:
  ...
  /// @brief Method .ctor, addr 0x26af474, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_bookmarksFolders>b__3_0, addr 0x26af47c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26af410, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bookmarksFolders, addr 0x26aee10, size 0x5c0, virtual false, abstract: false, final false
