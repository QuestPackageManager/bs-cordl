...
public:
  ...
  /// @brief Method .ctor addr 0x21ce1dc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method <get_bookmarksFolders>b__3_0 addr 0x21ce1e4 size 0xc virtual false final false
...
public:
  ...
  /// @brief Method get_bookmarksFolders addr 0x21cdb9c size 0x594 virtual false final false
  ...
  /// @brief Method .ctor addr 0x21ce170 size 0x8 virtual false final false
  inline void _ctor();
