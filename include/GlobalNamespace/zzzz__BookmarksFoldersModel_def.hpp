...
public:
  ...
  /// @brief Method .ctor, addr 0x12cfab8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_bookmarksFolders>b__3_0, addr 0x12cfac0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x12cfa4c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bookmarksFolders, addr 0x12cf478, size 0x594, virtual false, abstract: false, final false
