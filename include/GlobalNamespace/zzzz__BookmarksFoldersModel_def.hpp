...
public:
  ...
  /// @brief Method .ctor, addr 0x26ac82c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <get_bookmarksFolders>b__3_0, addr 0x26ac834, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26ac7c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_bookmarksFolders, addr 0x26ac1c8, size 0x5c0, virtual false, abstract: false, final false
