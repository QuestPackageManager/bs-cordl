...
static_assert(offsetof(::GlobalNamespace::LightColorBaseData, ___transitionType) == 0x14, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::LightColorBaseData, ___colorType) == 0x18, "Offset mismatch!");
