...
static inline ::GlobalNamespace::LightColorBaseData* New_ctor(float_t  beat, bool  usePreviousValue, ::GlobalNamespace::EaseType  easeType, ::GlobalNamespace::EnvironmentColorType  colorType, float_t  brightness, int32_t  strobeBeatFrequency, float_t  strobeBrightness, bool  strobeFade) ;
...
/// @brief Method .ctor, addr 0x361b9c4, size 0x20, virtual false, abstract: false, final false
inline void _ctor(float_t  beat, bool  usePreviousValue, ::GlobalNamespace::EaseType  easeType, ::GlobalNamespace::EnvironmentColorType  colorType, float_t  brightness, int32_t  strobeBeatFrequency, float_t  strobeBrightness, bool  strobeFade) ;
