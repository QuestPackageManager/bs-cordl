...
// Write type traits
MARK_REF_T(::GlobalNamespace::LightColorBaseData*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::LightColorBaseData*, "", "LightColorBaseData");
...
public:
  ...
  /// @brief Method .ctor, addr 0x371ab48, size 0x20, virtual false, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::LightColorBaseData) == 0x30, "Size mismatch!");
