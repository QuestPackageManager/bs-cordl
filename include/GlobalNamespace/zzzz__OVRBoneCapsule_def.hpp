...
/// @brief Method Cleanup, addr 0x5dd6e38, size 0xa8, virtual false, abstract: false, final false
inline void Cleanup() ;
...
/// @brief Method .ctor, addr 0x5dd6ee0, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x5dd798c, size 0xc, virtual false, abstract: false, final false
inline void _ctor(int16_t  boneIndex, ::UnityEngine::Rigidbody*  capsuleRigidBody, ::UnityEngine::CapsuleCollider*  capsuleCollider) ;

/// @brief Method get_BoneIndex, addr 0x5dd795c, size 0x8, virtual false, abstract: false, final false
inline int16_t get_BoneIndex() ;

/// @brief Method get_CapsuleCollider, addr 0x5dd797c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::CapsuleCollider> get_CapsuleCollider() ;

/// @brief Method get_CapsuleRigidbody, addr 0x5dd796c, size 0x8, virtual false, abstract: false, final false
inline ::UnityW<::UnityEngine::Rigidbody> get_CapsuleRigidbody() ;

/// @brief Method set_BoneIndex, addr 0x5dd7964, size 0x8, virtual false, abstract: false, final false
inline void set_BoneIndex(int16_t  value) ;

/// @brief Method set_CapsuleCollider, addr 0x5dd7984, size 0x8, virtual false, abstract: false, final false
inline void set_CapsuleCollider(::UnityEngine::CapsuleCollider*  value) ;

/// @brief Method set_CapsuleRigidbody, addr 0x5dd7974, size 0x8, virtual false, abstract: false, final false
