...
public:
  ...
  /// @brief Method MoveNext, addr 0x5885888, size 0xf4, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::GlobalNamespace::LightsAnimator__DisableDirectionalLightsCoroutine_d__11* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current, addr 0x588597c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5885984, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x58859bc, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x5885884, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5885878, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AnimateToColor, addr 0x5882944, size 0x114, virtual false, abstract: false, final false
  inline void AnimateToColor(::UnityEngine::Color color, float_t duration, ::GlobalNamespace::EaseType easeType);

  /// @brief Method Awake, addr 0x5885588, size 0xe0, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method DisableDirectionalLights, addr 0x58857e0, size 0x34, virtual false, abstract: false, final false
  inline void DisableDirectionalLights(float_t delay);

  /// @brief Method DisableDirectionalLightsCoroutine, addr 0x5885814, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method OnDestroy, addr 0x5885668, size 0x8c, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method SetColor, addr 0x58856f4, size 0x1c, virtual false, abstract: false, final false
  inline void SetColor(::UnityEngine::Color color);

  /// @brief Method SetLightsColor, addr 0x5885710, size 0xd0, virtual false, abstract: false, final false
  inline void SetLightsColor(::UnityEngine::Color color);

  /// @brief Method SetLightsWidth, addr 0x5882df8, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5885880, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
