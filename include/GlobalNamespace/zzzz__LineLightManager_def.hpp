...
public:
  ...
  __declspec(property(get = __cordl_internal_get__colors, put = __cordl_internal_set__colors)) ::ArrayW<::UnityEngine::Vector4> _colors;

  /// @brief Field _dirLengths, offset 0x30, size 0x8
  __declspec(property(get = __cordl_internal_get__dirLengths, put = __cordl_internal_set__dirLengths)) ::ArrayW<float_t> _dirLengths;

  /// @brief Field _dirs, offset 0x28, size 0x8
  __declspec(property(get = __cordl_internal_get__dirs, put = __cordl_internal_set__dirs)) ::ArrayW<::UnityEngine::Vector4> _dirs;
  ...
  __declspec(property(get = __cordl_internal_get__points, put = __cordl_internal_set__points)) ::ArrayW<::UnityEngine::Vector4> _points;

  static inline ::GlobalNamespace::LineLightManager* New_ctor();

  /// @brief Method Update, addr 0x58735b4, size 0x3b0, virtual false, abstract: false, final false
  inline void Update();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__colors() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__colors();

  constexpr ::ArrayW<float_t> const& __cordl_internal_get__dirLengths() const;

  constexpr ::ArrayW<float_t>& __cordl_internal_get__dirLengths();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__dirs() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__dirs();

  constexpr ::ArrayW<::UnityEngine::Vector4> const& __cordl_internal_get__points() const;

  constexpr ::ArrayW<::UnityEngine::Vector4>& __cordl_internal_get__points();

  constexpr void __cordl_internal_set__colors(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__dirLengths(::ArrayW<float_t> value);

  constexpr void __cordl_internal_set__dirs(::ArrayW<::UnityEngine::Vector4> value);

  constexpr void __cordl_internal_set__points(::ArrayW<::UnityEngine::Vector4> value);

  /// @brief Method .ctor, addr 0x5873964, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  ::ArrayW<::UnityEngine::Vector4> ____points;

  /// @brief Field _dirs, offset: 0x28, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector4> ____dirs;

  /// @brief Field _dirLengths, offset: 0x30, size: 0x8, def value: None
  ::ArrayW<float_t> ____dirLengths;

  /// @brief Field _colors, offset: 0x38, size: 0x8, def value: None
  ::ArrayW<::UnityEngine::Vector4> ____colors;
...
static_assert(sizeof(::GlobalNamespace::LineLightManager) == 0x40, "Size mismatch!");
