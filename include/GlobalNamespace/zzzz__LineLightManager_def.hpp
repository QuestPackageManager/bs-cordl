...
public:
  ...
  /// @brief Method Update, addr 0x565c83c, size 0x3b0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x565cbec, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();
