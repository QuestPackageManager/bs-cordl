...
public:
  ...
  /// @brief Method Update, addr 0x39eaa7c, size 0x37c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x39eadf8, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
