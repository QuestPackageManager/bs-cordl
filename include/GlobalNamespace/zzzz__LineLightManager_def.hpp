...
public:
  ...
  /// @brief Method Update, addr 0x39f352c, size 0x37c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x39f38a8, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
