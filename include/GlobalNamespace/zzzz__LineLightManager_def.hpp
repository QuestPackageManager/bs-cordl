...
public:
  ...
  /// @brief Method Update, addr 0x22d715c, size 0x370, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x22d74cc, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
