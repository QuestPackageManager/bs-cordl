...
public:
  ...
  /// @brief Method Update, addr 0x58713a0, size 0x3b0, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x5871750, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor();
