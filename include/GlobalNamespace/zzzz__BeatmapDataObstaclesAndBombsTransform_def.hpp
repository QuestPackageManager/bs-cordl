...
public:
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0, addr 0x26abac4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ab9c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateTransformedData, addr 0x26ab890, size 0x130, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldUseBeatmapDataItem, addr 0x26ab9c8, size 0xfc, virtual false, abstract: false, final false
