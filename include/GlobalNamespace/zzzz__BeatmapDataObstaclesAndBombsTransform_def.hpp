...
public:
  ...
  /// @brief Method <CreateTransformedData>g__ProcessData|0, addr 0x36091ec, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36090e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CreateTransformedData, addr 0x3608fa8, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldUseBeatmapDataItem, addr 0x36090e4, size 0x108, virtual false, abstract: false, final false
