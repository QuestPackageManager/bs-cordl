...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(14872))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x12638dc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method <CreateTransformedData>g__ProcessData|0, addr 0x12639ec, size 0x2c, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CreateTransformedData, addr 0x12637a8, size 0x134, virtual false, abstract: false, final false
  ...
  /// @brief Method ShouldUseBeatmapDataItem, addr 0x12638e4, size 0x108, virtual false, abstract: false, final false
