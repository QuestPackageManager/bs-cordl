...
public:
// Declarations
/// @brief Method DBToNormalizedVolume, addr 0x32297c4, size 0x18, virtual false, abstract: false, final false
static inline float_t DBToNormalizedVolume(float_t  db) ;

/// @brief Method NormalizedVolumeToDB, addr 0x3229740, size 0x84, virtual false, abstract: false, final false
