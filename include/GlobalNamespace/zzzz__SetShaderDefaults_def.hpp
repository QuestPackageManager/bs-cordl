...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SetShaderDefaults", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SetShaderDefaults(SetShaderDefaults&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SetShaderDefaults", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SetShaderDefaults(SetShaderDefaultsconst&) = delete;
