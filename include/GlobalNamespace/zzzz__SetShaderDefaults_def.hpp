...
public:
  ...
  /// @brief Method AddRenderPasses, addr 0x5f493b8, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Create, addr 0x5f492ec, size 0x5c, virtual true, abstract: false, final false
  inline void Create();
  ...
  /// @brief Method .ctor, addr 0x5f493d8, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();
