...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HelpConsoleCommand::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::HelpConsoleCommand*>::get(), "GetCommandUsage", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::HelpConsoleCommand::*)(
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::HelpConsoleCommand*>::get(), "GetListOfCommands", std::span<Il2CppClass const* const, 0>(),
...
constexpr ::GlobalNamespace::DebugConsoleController*& GlobalNamespace::HelpConsoleCommand::__cordl_internal_get__console() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____console;
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DebugConsoleController*> const& GlobalNamespace::HelpConsoleCommand::__cordl_internal_get__console() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____console;
}
constexpr void GlobalNamespace::HelpConsoleCommand::__cordl_internal_set__console(::GlobalNamespace::DebugConsoleController* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OptionalArgument_1<::StringW>*> const& GlobalNamespace::HelpConsoleCommand::__cordl_internal_get__commandName() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____commandName;
}
...
inline ::GlobalNamespace::HelpConsoleCommand* GlobalNamespace::HelpConsoleCommand::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::HelpConsoleCommand*>());
}
