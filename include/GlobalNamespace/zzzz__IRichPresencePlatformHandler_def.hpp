...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IRichPresencePlatformHandler", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IRichPresencePlatformHandler(IRichPresencePlatformHandlerconst&) = delete;
