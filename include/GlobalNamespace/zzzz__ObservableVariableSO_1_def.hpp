...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ObservableVariableSO_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ObservableVariableSO_1(ObservableVariableSO_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ObservableVariableSO_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ObservableVariableSO_1(ObservableVariableSO_1const&) = delete;
