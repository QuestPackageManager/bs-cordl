...
public:
  ...
  /// @brief Method .ctor, addr 0x59a6378, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x59a62e4, size 0xc, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  static inline ::GlobalNamespace::SpawnRotationChevron* New_ctor();

  /// @brief Method SetLightAmount, addr 0x59a635c, size 0x8, virtual false, abstract: false, final false
  inline void SetLightAmount(float_t amount);

  /// @brief Method UpdateLights, addr 0x59a62f0, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59a6364, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Field _lightAmount, offset: 0x58, size: 0x4, def value: None
  float_t ____lightAmount;

  static constexpr bool __IL2CPP_IS_VALUE_TYPE = false;
};
// Non member Declarations
static_assert(offsetof(::GlobalNamespace::SpawnRotationChevron, ____lights) == 0x40, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SpawnRotationChevron, ____color) == 0x48, "Offset mismatch!");

static_assert(offsetof(::GlobalNamespace::SpawnRotationChevron, ____lightAmount) == 0x58, "Offset mismatch!");

static_assert(sizeof(::GlobalNamespace::SpawnRotationChevron) == 0x60, "Size mismatch!");
