...
public:
  ...
  /// @brief Method .ctor, addr 0x3baafdc, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ColorWasSet, addr 0x3baaf50, size 0xc, virtual true, abstract: false, final false
  inline void ColorWasSet(::UnityEngine::Color color);

  static inline ::GlobalNamespace::SpawnRotationChevron* New_ctor();

  /// @brief Method SetLightAmount, addr 0x3baafcc, size 0x8, virtual false, abstract: false, final false
  inline void SetLightAmount(float_t amount);

  /// @brief Method UpdateLights, addr 0x3baaf5c, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3baafd4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
