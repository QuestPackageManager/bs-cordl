...
public:
  ...
  /// @brief Method SetData, addr 0x3ba384c, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3ba3b18, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_hide, addr 0x3ba35d8, size 0x2c, virtual false, abstract: false, final false
