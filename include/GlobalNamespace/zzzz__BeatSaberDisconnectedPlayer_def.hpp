...
/// @brief Method .ctor, addr 0x320f3b8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  userId, ::StringW  userName, int32_t  sortIndex) ;

/// @brief Method get_multiplayerAvatarsData, addr 0x320f3c4, size 0x14, virtual true, abstract: false, final true
