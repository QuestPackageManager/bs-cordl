...
public:
  ...
  /// @brief Method Deserialize, addr 0x13ab9f0, size 0x274, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x13ab51c, size 0x244, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x13ab4b8, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SliderSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x13ab7b8, size 0x238, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x13ab760, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
