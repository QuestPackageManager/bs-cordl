...
public:
  ...
  /// @brief Method Deserialize, addr 0x36c08d0, size 0x2e8, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x36c0388, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x36c031c, size 0x6c, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SliderSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x36c04ec, size 0x3e4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36c0494, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
