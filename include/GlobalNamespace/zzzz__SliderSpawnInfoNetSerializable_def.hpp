...
public:
  ...
  /// @brief Method Deserialize, addr 0x272b65c, size 0x224, virtual true, abstract: false, final false
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Init, addr 0x272b244, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method Obtain, addr 0x272b1e0, size 0x64, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SliderSpawnInfoNetSerializable* Obtain();

  /// @brief Method Serialize, addr 0x272b3b4, size 0x2a8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x272b35c, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
