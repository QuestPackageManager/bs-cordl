...
// Ctor Parameters [CppParam { name: "vertices", ty: "::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "normals", ty:
// "::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "tangents", ty:
// "::ArrayW<::UnityEngine::Vector4,::Array<::UnityEngine::Vector4>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "texcoords", ty:
// "::ArrayW<::UnityEngine::Vector2,::Array<::UnityEngine::Vector2>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "colors", ty:
// "::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>", modifiers: "", def_value: Some("{}") }, CppParam { name: "boneWeights", ty:
// "::ArrayW<::UnityEngine::BoneWeight,::Array<::UnityEngine::BoneWeight>*>", modifiers: "", def_value: Some("{}") }]
