...
public:
  ...
  /// @brief Method DespawnNoteDebris, addr 0x3b98930, size 0xa4, virtual false, abstract: false, final false
  inline void DespawnNoteDebris(::GlobalNamespace::NoteDebris* noteDebris);

  /// @brief Method HandleNoteDebrisDidFinish, addr 0x3b98874, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method SpawnDebris, addr 0x3b97e8c, size 0x8dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteDebris, addr 0x3b98768, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x3b97dc0, size 0xcc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b989d4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
