...
public:
  ...
  /// @brief Method DespawnNoteDebris, addr 0x26dac18, size 0xa4, virtual false, abstract: false, final false
  inline void DespawnNoteDebris(::GlobalNamespace::NoteDebris* noteDebris);

  /// @brief Method HandleNoteDebrisDidFinish, addr 0x26dab5c, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method SpawnDebris, addr 0x26d9db4, size 0x890, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteDebris, addr 0x26daa50, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x26da98c, size 0xc4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x26dacbc, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
