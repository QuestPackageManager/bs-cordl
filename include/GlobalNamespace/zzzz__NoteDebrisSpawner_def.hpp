...
public:
  ...
  /// @brief Method DespawnNoteDebris, addr 0x5850830, size 0xb8, virtual false, abstract: false, final false
  inline void DespawnNoteDebris(::GlobalNamespace::NoteDebris* noteDebris);

  /// @brief Method HandleNoteDebrisDidFinish, addr 0x5850768, size 0xc8, virtual true, abstract: false, final true
  ...
  /// @brief Method SpawnDebris, addr 0x584f8b8, size 0x8d8, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteDebris, addr 0x5850624, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x58504fc, size 0x128, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x58508e8, size 0xa8, virtual false, abstract: false, final false
  inline void _ctor();
