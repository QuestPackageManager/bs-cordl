...
public:
  ...
  /// @brief Method DespawnNoteDebris, addr 0x3b8b300, size 0xa4, virtual false, abstract: false, final false
  inline void DespawnNoteDebris(::GlobalNamespace::NoteDebris* noteDebris);

  /// @brief Method HandleNoteDebrisDidFinish, addr 0x3b8b244, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method SpawnDebris, addr 0x3b8a464, size 0x8dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteDebris, addr 0x3b8b138, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x3b8b06c, size 0xcc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b8b3a4, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
