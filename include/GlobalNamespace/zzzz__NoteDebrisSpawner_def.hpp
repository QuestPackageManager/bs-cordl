...
public:
  ...
  /// @brief Method DespawnNoteDebris, addr 0x3b863b4, size 0xa4, virtual false, abstract: false, final false
  inline void DespawnNoteDebris(::GlobalNamespace::NoteDebris* noteDebris);

  /// @brief Method HandleNoteDebrisDidFinish, addr 0x3b862f8, size 0xbc, virtual true, abstract: false, final true
  ...
  /// @brief Method SpawnDebris, addr 0x3b85518, size 0x8dc, virtual false, abstract: false, final false
  ...
  /// @brief Method SpawnNoteDebris, addr 0x3b861ec, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method Start, addr 0x3b86120, size 0xcc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3b86458, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();
