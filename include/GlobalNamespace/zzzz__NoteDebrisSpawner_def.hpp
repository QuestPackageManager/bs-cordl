...
/// @brief Field _burstSliderElementNotesDebrisPool, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderElementNotesDebrisPool, put=__cordl_internal_set__burstSliderElementNotesDebrisPool)) ::GlobalNamespace::NoteDebris_Pool*  _burstSliderElementNotesDebrisPool;

/// @brief Field _burstSliderHeadNotesDebrisPool, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__burstSliderHeadNotesDebrisPool, put=__cordl_internal_set__burstSliderHeadNotesDebrisPool)) ::GlobalNamespace::NoteDebris_Pool*  _burstSliderHeadNotesDebrisPool;
...
/// @brief Field _poolForNoteDebris, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get__poolForNoteDebris, put=__cordl_internal_set__poolForNoteDebris)) ::System::Collections::Generic::Dictionary_2<::UnityW<::GlobalNamespace::NoteDebris>,::GlobalNamespace::NoteDebris_Pool*>*  _poolForNoteDebris;

/// @brief Field _poolForNoteGameplayType, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get__poolForNoteGameplayType, put=__cordl_internal_set__poolForNoteGameplayType)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteData_GameplayType,::GlobalNamespace::NoteDebris_Pool*>*  _poolForNoteGameplayType;
...
/// @brief Method DespawnNoteDebris, addr 0x57de938, size 0xb8, virtual false, abstract: false, final false
inline void DespawnNoteDebris(::GlobalNamespace::NoteDebris*  noteDebris) ;

/// @brief Method HandleNoteDebrisDidFinish, addr 0x57de870, size 0xc8, virtual true, abstract: false, final true
...
/// @brief Method SpawnDebris, addr 0x57dd9c0, size 0x8d8, virtual false, abstract: false, final false
...
/// @brief Method SpawnNoteDebris, addr 0x57de72c, size 0x144, virtual false, abstract: false, final false
...
/// @brief Method Start, addr 0x57de604, size 0x128, virtual false, abstract: false, final false
inline void Start() ;
...
/// @brief Method .ctor, addr 0x57de9f0, size 0xa8, virtual false, abstract: false, final false
inline void _ctor() ;
