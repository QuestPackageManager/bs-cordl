...
public:
  ...
  /// @brief Method Awake, addr 0x58f3dfc, size 0x134, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method CalculateHideAfterMessage, addr 0x58f427c, size 0x74, virtual false, abstract: false, final false
  inline void CalculateHideAfterMessage();

  /// @brief Method ClearMessage, addr 0x58f4204, size 0x60, virtual false, abstract: false, final false
  inline void ClearMessage();

  /// @brief Method FollowCamera, addr 0x58f42f0, size 0x2d8, virtual false, abstract: false, final false
  inline void FollowCamera();

  /// @brief Method Hide, addr 0x58f3f30, size 0x1c, virtual false, abstract: false, final false
  inline void Hide();

  static inline ::GlobalNamespace::AlertViewHUD* New_ctor();

  /// @brief Method Post, addr 0x58f4048, size 0x168, virtual false, abstract: false, final false
  inline void Post(::StringW message, ::GlobalNamespace::AlertViewHUD_MessageType type);

  /// @brief Method PostMessage, addr 0x58f3f4c, size 0xfc, virtual false, abstract: false, final false
  static inline void PostMessage(::StringW message, ::GlobalNamespace::AlertViewHUD_MessageType messageType);

  /// @brief Method Reset, addr 0x58f41b0, size 0x54, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Update, addr 0x58f4264, size 0x18, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x58f45c8, size 0x1c, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::UnityW<::GlobalNamespace::AlertViewHUD> getStaticF__Instance_k__BackingField();

  /// @brief Method get_CenterInCamera, addr 0x58f3dc4, size 0x8, virtual false, abstract: false, final false
  inline bool get_CenterInCamera();

  /// @brief Method get_Hidden, addr 0x58f3dd4, size 0x28, virtual false, abstract: false, final false
  inline bool get_Hidden();

  /// @brief Method get_HideAfterSec, addr 0x58f3db4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_HideAfterSec();

  /// @brief Method get_Instance, addr 0x58f3d18, size 0x4c, virtual false, abstract: false, final false
  ...
  /// @brief Method set_CenterInCamera, addr 0x58f3dcc, size 0x8, virtual false, abstract: false, final false
  inline void set_CenterInCamera(bool value);

  /// @brief Method set_HideAfterSec, addr 0x58f3dbc, size 0x8, virtual false, abstract: false, final false
  inline void set_HideAfterSec(int32_t value);

  /// @brief Method set_Instance, addr 0x58f3d64, size 0x50, virtual false, abstract: false, final false
