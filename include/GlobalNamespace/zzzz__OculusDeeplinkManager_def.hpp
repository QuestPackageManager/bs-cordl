...
public:
  ...
  /// @brief Method Init, addr 0x3647b38, size 0x80, virtual false, abstract: false, final false
  inline void Init();

  /// @brief Method IsAtLeastOneFieldPopulated, addr 0x3647f24, size 0x6c, virtual false, abstract: false, final false
  inline bool IsAtLeastOneFieldPopulated(::GlobalNamespace::Deeplink* deeplink);

  /// @brief Method Log, addr 0x3647c8c, size 0x5c, virtual false, abstract: false, final false
  static inline void Log(::StringW message);

  static inline ::GlobalNamespace::OculusDeeplinkManager* New_ctor();

  /// @brief Method OculusPlatformWasInitialized, addr 0x3647bb8, size 0x18, virtual false, abstract: false, final false
  inline void OculusPlatformWasInitialized();

  /// @brief Method SetJoinIntentReceivedNotificationCallback, addr 0x3647bd0, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDeeplinkMessage, addr 0x3647ce8, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3647f90, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_didReceiveDeeplinkEvent, addr 0x36479b0, size 0xc0, virtual true, abstract: false, final true
  inline void add_didReceiveDeeplinkEvent(::System::Action_1<::GlobalNamespace::Deeplink*>* value);

  /// @brief Method get_currentDeeplink, addr 0x3647b30, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method remove_didReceiveDeeplinkEvent, addr 0x3647a70, size 0xc0, virtual true, abstract: false, final true
