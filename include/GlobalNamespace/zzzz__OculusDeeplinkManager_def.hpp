...
public:
  ...
  /// @brief Method OculusPlatformWasInitialized, addr 0x3708224, size 0x18, virtual false, abstract: false, final false
  inline void OculusPlatformWasInitialized();

  /// @brief Method SetJoinIntentReceivedNotificationCallback, addr 0x370823c, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method UpdateDeeplinkMessage, addr 0x3708354, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_currentDeeplink, addr 0x370819c, size 0x8, virtual true, abstract: false, final true
