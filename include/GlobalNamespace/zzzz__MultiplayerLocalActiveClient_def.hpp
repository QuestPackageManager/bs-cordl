...
public:
  ...
  /// @brief Method HandleComboDidChange, addr 0x3bc277c, size 0xcc, virtual false, abstract: false, final false
  inline void HandleComboDidChange(int32_t combo);

  /// @brief Method HandleMultiplierDidChange, addr 0x3bc2848, size 0xcc, virtual false, abstract: false, final false
  inline void HandleMultiplierDidChange(int32_t multiplier, float_t multiplierProgress);

  /// @brief Method HandleNoteWasAdded, addr 0x3bc20bc, size 0x158, virtual false, abstract: false, final false
  inline void HandleNoteWasAdded(::GlobalNamespace::NoteData* noteData, ::GlobalNamespace::NoteSpawnData noteSpawnData);

  /// @brief Method HandleNoteWasCut, addr 0x3bc25b8, size 0x1c4, virtual false, abstract: false, final false
  inline void HandleNoteWasCut(::GlobalNamespace::NoteController* noteController, ::ByRef<::GlobalNamespace::NoteCutInfo> noteCutInfo);

  /// @brief Method HandleNoteWasMissed, addr 0x3bc24bc, size 0xfc, virtual false, abstract: false, final false
  inline void HandleNoteWasMissed(::GlobalNamespace::NoteController* noteController);

  /// @brief Method HandleObstacleWasAdded, addr 0x3bc2214, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleScoreDidChange, addr 0x3bc2914, size 0x254, virtual false, abstract: false, final false
  inline void HandleScoreDidChange(int32_t multipliedScore, int32_t modifiedScore);

  /// @brief Method HandleSliderWasAdded, addr 0x3bc2338, size 0x184, virtual false, abstract: false, final false
  inline void HandleSliderWasAdded(::GlobalNamespace::SliderData* sliderData, ::GlobalNamespace::SliderSpawnData sliderSpawnData);

  /// @brief Method LateUpdate, addr 0x3bc1d74, size 0x348, virtual false, abstract: false, final false
  inline void LateUpdate();

  static inline ::GlobalNamespace::MultiplayerLocalActiveClient* New_ctor();

  /// @brief Method OnDestroy, addr 0x3bc1954, size 0x420, virtual false, abstract: false, final false
  inline void OnDestroy();

  /// @brief Method Start, addr 0x3bc1288, size 0x6cc, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x3bc2b68, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
