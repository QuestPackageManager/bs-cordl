...
public:
  ...
  /// @brief Method Start, addr 0x2ad52ec, size 0x1c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2ad5308, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
