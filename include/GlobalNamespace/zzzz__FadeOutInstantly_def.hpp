...
public:
  ...
  /// @brief Method Start, addr 0x28f04a4, size 0x1c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x28f04c0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
