...
public:
  ...
  /// @brief Method Start, addr 0x5d2c6c8, size 0x1c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x5d2c6e4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
