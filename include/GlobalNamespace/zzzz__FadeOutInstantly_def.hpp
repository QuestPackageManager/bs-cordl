...
public:
  ...
  /// @brief Method Start, addr 0x2bf521c, size 0x1c, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x2bf5238, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
