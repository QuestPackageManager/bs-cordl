...
public:
  ...
  /// @brief Method .ctor, addr 0x57ed0f4, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Init, addr 0x57ec538, size 0x2c, virtual false, abstract: false, final false
  inline void Init(float_t startTime);

  /// @brief Method InitSpeed, addr 0x57ecfe4, size 0x54, virtual false, abstract: false, final false
  inline void InitSpeed(float_t simulationSpeedMultiplier);

  /// @brief Method ManualUpdate, addr 0x57ec8f8, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method Pause, addr 0x57ecdc0, size 0x18, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method Play, addr 0x57ecf0c, size 0x18, virtual false, abstract: false, final false
  inline void Play();

  /// @brief Method Stop, addr 0x57ec214, size 0x1c, virtual false, abstract: false, final false
  inline void Stop();
  ...
  /// @brief Method get_endTime, addr 0x57ec8ec, size 0xc, virtual false, abstract: false, final false
  inline float_t get_endTime();

  /// @brief Method get_startTime, addr 0x57ed0e0, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startTime();

  /// @brief Method set_startTime, addr 0x57ed0e8, size 0x8, virtual false, abstract: false, final false
