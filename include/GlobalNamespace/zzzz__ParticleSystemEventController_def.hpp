...
public:
  ...
  /// @brief Method get_startTime, addr 0x23703f8, size 0x8, virtual false, abstract: false, final false
  inline float_t get_startTime();

  /// @brief Method set_startTime, addr 0x2370400, size 0x8, virtual false, abstract: false, final false
  inline void set_startTime(float_t value);

  /// @brief Method get_endTime, addr 0x236fc18, size 0xc, virtual false, abstract: false, final false
  inline float_t get_endTime();

  /// @brief Method Init, addr 0x236f87c, size 0x30, virtual false, abstract: false, final false
  inline void Init(float_t startTime);

  /// @brief Method InitSpeed, addr 0x23702fc, size 0x4c, virtual false, abstract: false, final false
  inline void InitSpeed(float_t simulationSpeedMultiplier);

  /// @brief Method Play, addr 0x2370224, size 0x1c, virtual false, abstract: false, final false
  inline void Play();

  /// @brief Method Pause, addr 0x2370090, size 0x1c, virtual false, abstract: false, final false
  inline void Pause();

  /// @brief Method Stop, addr 0x236f590, size 0x1c, virtual false, abstract: false, final false
  inline void Stop();

  /// @brief Method ManualUpdate, addr 0x236fc24, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2370408, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(4320)), TypeDefinitionIndex(TypeDefinitionIndex(10192)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10192), inst:
// 2795 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(4319)) CS Name: ::ParticleSystemEventController::Pool*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2370410, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
