...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(16173))
...
public:
  ...
  /// @brief Method Awake, addr 0x21815a4, size 0x78, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::ConditionalMaterialSwitcher* New_ctor();

  /// @brief Method .ctor, addr 0x218161c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
