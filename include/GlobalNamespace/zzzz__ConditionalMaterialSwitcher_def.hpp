...
public:
  ...
  /// @brief Method Awake, addr 0x3b33918, size 0x78, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x3b33990, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
