...
public:
  ...
  /// @brief Method Awake, addr 0x576cdd8, size 0x78, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x576ce50, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
