...
public:
  ...
  /// @brief Method Awake, addr 0x26af314, size 0x78, virtual false, abstract: false, final false
  inline void Awake();
  ...
  /// @brief Method .ctor, addr 0x26af38c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
