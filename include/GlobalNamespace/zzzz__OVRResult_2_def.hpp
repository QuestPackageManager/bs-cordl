...
// Ctor Parameters [CppParam { name: "_initialized", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "_value", ty: "TValue", modifiers: "", def_value: None }, CppParam { name: "_statusCode", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "_status", ty: "TStatus", modifiers: "", def_value: None }]
