...
/// @brief Method InstallBindings, addr 0x5778da4, size 0x4a0, virtual true, abstract: false, final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::GameCoreSceneSetup* New_ctor() ;

/// @brief Method OnDestroy, addr 0x5779244, size 0x4c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5779290, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
