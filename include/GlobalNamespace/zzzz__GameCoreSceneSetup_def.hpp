...
public:
  ...
  /// @brief Method InstallBindings, addr 0x259d188, size 0x46c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x259d5f4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
