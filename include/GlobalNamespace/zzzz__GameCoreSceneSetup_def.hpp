...
public:
  ...
  /// @brief Method InstallBindings, addr 0x57e8e20, size 0x4a0, virtual true, abstract: false, final false
  inline void InstallBindings();

  static inline ::GlobalNamespace::GameCoreSceneSetup* New_ctor();

  /// @brief Method OnDestroy, addr 0x57e92c0, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57e930c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
