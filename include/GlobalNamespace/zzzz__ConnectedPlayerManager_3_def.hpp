...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::ConnectedPlayerManager_3<TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>*", modifiers: "", def_value: None }, CppParam { name: "player", ty: "TConnectedPlayerImpl", modifiers: "", def_value: None }, CppParam { name: "_isClient_5__2", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EncryptionUtility_IEncryptionState*>", modifiers: "", def_value: None }]
constexpr ConnectedPlayerManager_3__InitializePlayerEncryption_d__119(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::ConnectedPlayerManager_3<TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>*  __4__this, TConnectedPlayerImpl  player, bool  _isClient_5__2, ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>>  __u__1, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::EncryptionUtility_IEncryptionState*>  __u__2) noexcept;
...
/// @brief Field _connectedPlayerFactory, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get__connectedPlayerFactory, put=__cordl_internal_set__connectedPlayerFactory)) ::GlobalNamespace::IConnectedPlayerFactory_3<TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>*  _connectedPlayerFactory;
...
/// @brief Field _messageSerializer, offset 0x100, size 0x8 
 __declspec(property(get=__cordl_internal_get__messageSerializer, put=__cordl_internal_set__messageSerializer)) ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::ConnectedPlayerManager_InternalMessageType,TConnectedPlayer>*  _messageSerializer;
...
/// @brief Field playerLatencyInitializedEvent, offset 0x50, size 0x8 
 __declspec(property(get=__cordl_internal_get_playerLatencyInitializedEvent, put=__cordl_internal_set_playerLatencyInitializedEvent)) ::System::Action_1<TConnectedPlayer>*  playerLatencyInitializedEvent;
...
inline ::LiteNetLib::Utils::NetDataWriter* WriteOneEncrypted(::GlobalNamespace::EncryptionUtility_IEncryptionState*  encryptionState, uint8_t  senderId, uint8_t  receiverId, ::LiteNetLib::Utils::INetSerializable*  message) ;
...
inline void _ctor(::BGNet::Core::ITimeProvider*  timeProvider, ::BGNet::Core::ITaskUtility*  taskUtility, ::GlobalNamespace::IConnectionManager*  connectionManager, ::GlobalNamespace::IConnectedPlayerFactory_3<TConnectedPlayer,TConnectedPlayerImpl,TGameSpecificIdentityData>*  connectedPlayerFactory) ;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_STRUCT(::GlobalNamespace::ConnectedPlayerManager_3__InitializePlayerEncryption_d__119, "", "ConnectedPlayerManager`3/<InitializePlayerEncryption>d__119");
