...
public:
  ...
  /// @brief Method RefreshPropertyId, addr 0x572c990, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x572c9c4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_propertyId, addr 0x572c9b4, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_propertyId();

  /// @brief Method set_propertyId, addr 0x572c9bc, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x572c9e4, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x572ca04, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x572ca24, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method .ctor, addr 0x572ca44, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyParams, addr 0x572c744, size 0x1ac, virtual false, abstract: false, final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyValuesSetter* New_ctor();

  /// @brief Method OnValidate, addr 0x572c8f0, size 0xa0, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyIds, addr 0x572c5dc, size 0x168, virtual false, abstract: false, final false
  inline void RefreshPropertyIds();

  /// @brief Method Start, addr 0x572c5c4, size 0x18, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x572c9b0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
