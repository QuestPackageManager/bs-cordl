...
public:
  ...
  /// @brief Method RefreshPropertyId, addr 0x39e6aa4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method get_propertyId, addr 0x39e6acc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_propertyId();

  /// @brief Method set_propertyId, addr 0x39e6ad4, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x39e6b7c, size 0x28, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method ApplyParams, addr 0x39e6868, size 0x1a4, virtual false, abstract: false, final false
  inline void ApplyParams();

  static inline ::GlobalNamespace::MaterialPropertyValuesSetter* New_ctor();

  /// @brief Method OnValidate, addr 0x39e6a0c, size 0x98, virtual false, abstract: false, final false
  inline void OnValidate();

  /// @brief Method RefreshPropertyIds, addr 0x39e6710, size 0x158, virtual false, abstract: false, final false
  inline void RefreshPropertyIds();

  /// @brief Method Start, addr 0x39e66f8, size 0x18, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method .ctor, addr 0x39e6ac4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
