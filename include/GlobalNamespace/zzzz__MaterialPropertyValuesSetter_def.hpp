...
/// @brief Method RefreshPropertyId, addr 0x56beaa4, size 0x20, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56bead8, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_propertyId, addr 0x56beac8, size 0x8, virtual false, abstract: false, final false
inline int32_t get_propertyId() ;

/// @brief Method set_propertyId, addr 0x56bead0, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x56beaf8, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x56beb18, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x56beb38, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method .ctor, addr 0x56beb58, size 0x20, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field _colors, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get__colors, put=__cordl_internal_set__colors)) ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*>*>  _colors;

/// @brief Field _floats, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get__floats, put=__cordl_internal_set__floats)) ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*>*>  _floats;

/// @brief Field _ints, offset 0x40, size 0x8 
 __declspec(property(get=__cordl_internal_get__ints, put=__cordl_internal_set__ints)) ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*>*>  _ints;
...
/// @brief Field _vectors, offset 0x30, size 0x8 
 __declspec(property(get=__cordl_internal_get__vectors, put=__cordl_internal_set__vectors)) ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*>*>  _vectors;

/// @brief Method ApplyParams, addr 0x56be858, size 0x1ac, virtual false, abstract: false, final false
inline void ApplyParams() ;

static inline ::GlobalNamespace::MaterialPropertyValuesSetter* New_ctor() ;

/// @brief Method OnValidate, addr 0x56bea04, size 0xa0, virtual false, abstract: false, final false
inline void OnValidate() ;

/// @brief Method RefreshPropertyIds, addr 0x56be6f0, size 0x168, virtual false, abstract: false, final false
inline void RefreshPropertyIds() ;

/// @brief Method Start, addr 0x56be6d8, size 0x18, virtual false, abstract: false, final false
inline void Start() ;

constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*>*> const& __cordl_internal_get__colors() const;

constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*>*>& __cordl_internal_get__colors() ;

constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*>*> const& __cordl_internal_get__floats() const;

constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*>*>& __cordl_internal_get__floats() ;

constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*>*> const& __cordl_internal_get__ints() const;

constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*>*>& __cordl_internal_get__ints() ;
...
constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*>*> const& __cordl_internal_get__vectors() const;

constexpr ::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*>*>& __cordl_internal_get__vectors() ;

constexpr void __cordl_internal_set__colors(::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameColorValuePair*>*>  value) ;

constexpr void __cordl_internal_set__floats(::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameFloatValuePair*>*>  value) ;

constexpr void __cordl_internal_set__ints(::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameIntValuePair*>*>  value) ;

constexpr void __cordl_internal_set__materialPropertyBlockController(::UnityW<::GlobalNamespace::MaterialPropertyBlockController>  value) ;

constexpr void __cordl_internal_set__vectors(::ArrayW<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*,::Array<::GlobalNamespace::MaterialPropertyValuesSetter_PropertyNameVectorValuePair*>*>  value) ;

/// @brief Method .ctor, addr 0x56beac4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
