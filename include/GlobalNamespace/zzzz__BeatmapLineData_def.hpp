...
public:
  ...
  /// @brief Method AddBeatmapObjectData, addr 0x31955c0, size 0xb4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x31955b8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapObjectData*>* beatmapObjectData);

  /// @brief Method .ctor, addr 0x3195534, size 0x84, virtual false, abstract: false, final false
  inline void _ctor(int32_t initialCapacity);

  /// @brief Method get_beatmapObjectsData, addr 0x319552c, size 0x8, virtual true, abstract: false, final true
