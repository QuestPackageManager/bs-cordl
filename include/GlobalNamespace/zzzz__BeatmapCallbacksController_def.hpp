...
public:
  ...
  /// @brief Method .ctor, addr 0x3ae0ffc, size 0x40, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method CallCallbacks, addr 0x3ae103c, size 0x18, virtual true, abstract: false, final true
  inline void CallCallbacks(::GlobalNamespace::CallbacksInTime* callbacksInTime, ::GlobalNamespace::BeatmapDataItem* beatmapDataItem);

  static inline ::GlobalNamespace::BeatmapCallbacksController_CallCallbacksBehavior* New_ctor();

  /// @brief Method Replay, addr 0x3ae1054, size 0x4, virtual true, abstract: false, final true
  inline void Replay(::System::Collections::Generic::Dictionary_2<float_t, ::GlobalNamespace::CallbacksInTime*>* callbacksInTimes);

  /// @brief Method .ctor, addr 0x3adf788, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method CallCallbacks, addr 0x3ae1058, size 0xc4, virtual true, abstract: false, final true
  inline void CallCallbacks(::GlobalNamespace::CallbacksInTime* callbacksInTime, ::GlobalNamespace::BeatmapDataItem* beatmapDataItem);

  static inline ::GlobalNamespace::BeatmapCallbacksController_CallCallbacksBehaviorWithLastState* New_ctor();

  /// @brief Method Replay, addr 0x3ae111c, size 0x288, virtual true, abstract: false, final true
  inline void Replay(::System::Collections::Generic::Dictionary_2<float_t, ::GlobalNamespace::CallbacksInTime*>* callbacksInTimes);
  ...
  /// @brief Method .ctor, addr 0x3adf790, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Dispose, addr 0x3adf80c, size 0x254, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method HandleBeatmapEventDataWasInserted, addr 0x3ae05a8, size 0x5f4, virtual false, abstract: false, final false
  ...
  /// @brief Method HandleBeatmapEventDataWasRemoved, addr 0x3ae0df0, size 0x20c, virtual false, abstract: false, final false
  inline void HandleBeatmapEventDataWasRemoved(::GlobalNamespace::BeatmapEventData* beatmapEventData);

  /// @brief Method HandleBeatmapEventDataWillBeRemoved, addr 0x3ae0b9c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method ManualUpdate, addr 0x3adfb0c, size 0x5f8, virtual false, abstract: false, final false
  ...
  /// @brief Method RemoveBeatmapCallback, addr 0x3adcf20, size 0xc0, virtual false, abstract: false, final false
  inline void RemoveBeatmapCallback(::GlobalNamespace::BeatmapDataCallbackWrapper* callbackWrapper);

  /// @brief Method ReplayState, addr 0x3adfa60, size 0xac, virtual false, abstract: false, final false
  inline void ReplayState();

  /// @brief Method TriggerBeatmapEvent, addr 0x3ae037c, size 0x160, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3adf47c, size 0x30c, virtual false, abstract: false, final false
  inline void _ctor(::GlobalNamespace::BeatmapCallbacksController_InitData* initData);

  /// @brief Method add_didProcessAllCallbacksThisFrameEvent, addr 0x3adf344, size 0x9c, virtual false, abstract: false, final false
  inline void add_didProcessAllCallbacksThisFrameEvent(::System::Action* value);

  /// @brief Method add_willStartProcessingCallbacksThisFrameEvent, addr 0x3adf1e4, size 0xb0, virtual false, abstract: false, final false
  inline void add_willStartProcessingCallbacksThisFrameEvent(::System::Action_1<float_t>* value);

  /// @brief Method get_sendCallbacksOnBeatmapDataChange, addr 0x3adf1c8, size 0x8, virtual false, abstract: false, final false
  inline bool get_sendCallbacksOnBeatmapDataChange();

  /// @brief Method get_songTime, addr 0x3adf1dc, size 0x8, virtual false, abstract: false, final false
  inline float_t get_songTime();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method remove_didProcessAllCallbacksThisFrameEvent, addr 0x3adf3e0, size 0x9c, virtual false, abstract: false, final false
  inline void remove_didProcessAllCallbacksThisFrameEvent(::System::Action* value);

  /// @brief Method remove_willStartProcessingCallbacksThisFrameEvent, addr 0x3adf294, size 0xb0, virtual false, abstract: false, final false
  inline void remove_willStartProcessingCallbacksThisFrameEvent(::System::Action_1<float_t>* value);

  /// @brief Method set_sendCallbacksOnBeatmapDataChange, addr 0x3adf1d0, size 0xc, virtual false, abstract: false, final false
