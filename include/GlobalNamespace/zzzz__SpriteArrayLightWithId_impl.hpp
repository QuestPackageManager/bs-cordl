...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::SpriteArrayLightWithId::*)()>(&::GlobalNamespace::SpriteArrayLightWithId::get_color)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x56bcafc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SpriteArrayLightWithId*>::get(),
                        "get_color",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpriteArrayLightWithId::*)(::UnityEngine::Color)>(&::GlobalNamespace::SpriteArrayLightWithId::ColorWasSet)> {
  constexpr static std::size_t size = 0x1a4;
  constexpr static std::size_t addrs = 0x56bcb2c;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpriteArrayLightWithId::*)()>(&::GlobalNamespace::SpriteArrayLightWithId::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x56bccd0;
...
constexpr ::ArrayW<::UnityW<::UnityEngine::SpriteRenderer>,::Array<::UnityW<::UnityEngine::SpriteRenderer>>*> const& GlobalNamespace::SpriteArrayLightWithId::__cordl_internal_get__spriteRenderers() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____spriteRenderers;
}
constexpr void GlobalNamespace::SpriteArrayLightWithId::__cordl_internal_set__spriteRenderers(::ArrayW<::UnityW<::UnityEngine::SpriteRenderer>,::Array<::UnityW<::UnityEngine::SpriteRenderer>>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
