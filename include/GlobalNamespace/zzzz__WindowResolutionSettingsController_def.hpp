...
public:
  ...
  /// @brief Method ApplyValue, addr 0x58e4b60, size 0x74, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x58e4858, size 0x308, virtual true, abstract: false, final false
  inline bool GetInitValues(::ByRef<int32_t> idx, ::ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::WindowResolutionSettingsController* New_ctor();

  /// @brief Method TextForValue, addr 0x58e4bd4, size 0xd0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58e4ca4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
