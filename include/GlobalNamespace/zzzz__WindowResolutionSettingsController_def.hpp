...
public:
  ...
  /// @brief Method ApplyValue, addr 0x23ae66c, size 0x74, virtual true, abstract: false, final false
  inline void ApplyValue(int32_t idx);

  /// @brief Method GetInitValues, addr 0x23ae458, size 0x214, virtual true, abstract: false, final false
  inline bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements);

  static inline ::GlobalNamespace::WindowResolutionSettingsController* New_ctor();

  /// @brief Method TextForValue, addr 0x23ae6e0, size 0xcc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x23ae7ac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
