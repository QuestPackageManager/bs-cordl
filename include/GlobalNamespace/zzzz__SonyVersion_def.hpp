...
public:
  ...
  /// @brief Method CopyValueFrom, addr 0x26e70f8, size 0x1c, virtual false, abstract: false, final false
  inline void CopyValueFrom(::GlobalNamespace::SonyVersion* other);

  /// @brief Method Get, addr 0x26ecef0, size 0x228, virtual false, abstract: false, final false
  inline ::StringW Get(::GlobalNamespace::SonyVersion_VersionFormat format);

  /// @brief Method GetFromString, addr 0x26ec910, size 0x550, virtual false, abstract: false, final false
  static inline ::GlobalNamespace::SonyVersion* GetFromString(::StringW versionString);

  /// @brief Method IncreaseVersion, addr 0x26e714c, size 0x24, virtual false, abstract: false, final false
  inline void IncreaseVersion();

  /// @brief Method IsVersionFormatValid, addr 0x26ece60, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x26ed118, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x26ec8e4, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(uint32_t majorVersion, uint32_t minorVersion);

  /// @brief Method get_majorVersion, addr 0x26ec8d4, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_majorVersion();

  /// @brief Method get_minorVersion, addr 0x26ec8dc, size 0x8, virtual false, abstract: false, final false
  inline uint32_t get_minorVersion();

  /// @brief Method op_Implicit, addr 0x26ed120, size 0x14, virtual false, abstract: false, final false
