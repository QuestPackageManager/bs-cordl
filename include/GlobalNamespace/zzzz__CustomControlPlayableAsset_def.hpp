...
public:
  ...
  /// @brief Method .ctor, addr 0x3b42334, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x3b4232c, size 0x8, virtual true, abstract: false, final true
