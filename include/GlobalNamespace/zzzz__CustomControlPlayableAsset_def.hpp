...
public:
  ...
  /// @brief Method .ctor, addr 0x26b4ff0, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x26b4fe8, size 0x8, virtual true, abstract: false, final true
