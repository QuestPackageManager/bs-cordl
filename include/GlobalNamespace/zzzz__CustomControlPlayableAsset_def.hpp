...
public:
  ...
  /// @brief Method .ctor, addr 0x5773530, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x5773528, size 0x8, virtual true, abstract: false, final true
