...
public:
  ...
  /// @brief Method .ctor, addr 0x3b342ac, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_clipCaps, addr 0x3b342a4, size 0x8, virtual true, abstract: false, final true
