...
public:
  ...
  /// @brief Method AbSplit, addr 0x57b6d8c, size 0x20c, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group AbSplit(::StringW userId);

  /// @brief Method ComputeCurrentUserTreatment, addr 0x57b6d74, size 0x18, virtual false, abstract: false, final false
  inline void ComputeCurrentUserTreatment(::StringW userId);

  /// @brief Method ForceSetTreatmentGroup, addr 0x57b6f98, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidate, addr 0x57b6d40, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x57b6fa0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentUserTreatmentGroup, addr 0x57b6d38, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group get_currentUserTreatmentGroup();

  /// @brief Method get_experimentName, addr 0x57b6d30, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_experimentName();

  /// @brief Method get_test1GroupSize, addr 0x57b6d20, size 0x8, virtual false, abstract: false, final false
  inline float_t get_test1GroupSize();

  /// @brief Method get_test2GroupSize, addr 0x57b6d28, size 0x8, virtual false, abstract: false, final false
