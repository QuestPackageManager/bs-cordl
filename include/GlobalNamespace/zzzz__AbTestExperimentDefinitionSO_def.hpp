...
public:
  ...
  /// @brief Method AbSplit, addr 0x3b07aa8, size 0x258, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group AbSplit(::StringW userId);

  /// @brief Method ComputeCurrentUserTreatment, addr 0x3b07a90, size 0x18, virtual false, abstract: false, final false
  inline void ComputeCurrentUserTreatment(::StringW userId);

  /// @brief Method ForceSetTreatmentGroup, addr 0x3b07d00, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidate, addr 0x3b07a64, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b07d08, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentUserTreatmentGroup, addr 0x3b07a5c, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group get_currentUserTreatmentGroup();

  /// @brief Method get_experimentName, addr 0x3b07a54, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_experimentName();

  /// @brief Method get_test1GroupSize, addr 0x3b07a44, size 0x8, virtual false, abstract: false, final false
  inline float_t get_test1GroupSize();

  /// @brief Method get_test2GroupSize, addr 0x3b07a4c, size 0x8, virtual false, abstract: false, final false
