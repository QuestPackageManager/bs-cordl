...
MARK_REF_T(::GlobalNamespace::AbTestExperimentDefinitionSO*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AbTestExperimentDefinitionSO_Group, "", "AbTestExperimentDefinitionSO/Group");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::AbTestExperimentDefinitionSO*, "", "AbTestExperimentDefinitionSO");
// Dependencies
namespace GlobalNamespace {
// Is value type: true
...
static_assert(sizeof(::GlobalNamespace::AbTestExperimentDefinitionSO_Group) == 0x4, "Size mismatch!");
...
static_assert(sizeof(::GlobalNamespace::AbTestExperimentDefinitionSO) == 0x40, "Size mismatch!");
