...
/// @brief Field _currentUserTreatmentGroup, offset 0x38, size 0x4 
 __declspec(property(get=__cordl_internal_get__currentUserTreatmentGroup, put=__cordl_internal_set__currentUserTreatmentGroup)) ::GlobalNamespace::AbTestExperimentDefinitionSO_Group  _currentUserTreatmentGroup;
...
/// @brief Method AbSplit, addr 0x5746cf0, size 0x20c, virtual false, abstract: false, final false
inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group AbSplit(::StringW  userId) ;

/// @brief Method ComputeCurrentUserTreatment, addr 0x5746cd8, size 0x18, virtual false, abstract: false, final false
inline void ComputeCurrentUserTreatment(::StringW  userId) ;

/// @brief Method ForceSetTreatmentGroup, addr 0x5746efc, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method OnValidate, addr 0x5746ca4, size 0x34, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5746f04, size 0x18, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_currentUserTreatmentGroup, addr 0x5746c9c, size 0x8, virtual false, abstract: false, final false
inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group get_currentUserTreatmentGroup() ;

/// @brief Method get_experimentName, addr 0x5746c94, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_experimentName() ;

/// @brief Method get_test1GroupSize, addr 0x5746c84, size 0x8, virtual false, abstract: false, final false
inline float_t get_test1GroupSize() ;

/// @brief Method get_test2GroupSize, addr 0x5746c8c, size 0x8, virtual false, abstract: false, final false
