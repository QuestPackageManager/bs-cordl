...
public:
  ...
  /// @brief Method AbSplit, addr 0x3b07a80, size 0x258, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group AbSplit(::StringW userId);

  /// @brief Method ComputeCurrentUserTreatment, addr 0x3b07a68, size 0x18, virtual false, abstract: false, final false
  inline void ComputeCurrentUserTreatment(::StringW userId);

  /// @brief Method ForceSetTreatmentGroup, addr 0x3b07cd8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method OnValidate, addr 0x3b07a3c, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3b07ce0, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_currentUserTreatmentGroup, addr 0x3b07a34, size 0x8, virtual false, abstract: false, final false
  inline ::GlobalNamespace::AbTestExperimentDefinitionSO_Group get_currentUserTreatmentGroup();

  /// @brief Method get_experimentName, addr 0x3b07a2c, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_experimentName();

  /// @brief Method get_test1GroupSize, addr 0x3b07a1c, size 0x8, virtual false, abstract: false, final false
  inline float_t get_test1GroupSize();

  /// @brief Method get_test2GroupSize, addr 0x3b07a24, size 0x8, virtual false, abstract: false, final false
