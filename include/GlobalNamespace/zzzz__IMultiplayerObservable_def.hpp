...
// Write type traits
MARK_REF_T(::GlobalNamespace::IMultiplayerObservable*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::IMultiplayerObservable*, "", "IMultiplayerObservable");
// Dependencies
namespace GlobalNamespace {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IMultiplayerObservable", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMultiplayerObservable(IMultiplayerObservableconst&) = delete;
