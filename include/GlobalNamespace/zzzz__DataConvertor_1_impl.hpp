...
template <typename T>
constexpr ::System::Collections::Generic::Dictionary_2<::System::Type*, ::GlobalNamespace::DataItemConvertor_1<T>*>*& GlobalNamespace::DataConvertor_1<T>::__cordl_internal_get__convertors() {
...
GlobalNamespace::DataConvertor_1<T>::__cordl_internal_get__convertors() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____convertors;
}
template <typename T>
constexpr void GlobalNamespace::DataConvertor_1<T>::__cordl_internal_set__convertors(::System::Collections::Generic::Dictionary_2<::System::Type*, ::GlobalNamespace::DataItemConvertor_1<T>*>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template <typename T> inline T GlobalNamespace::DataConvertor_1<T>::ProcessItem(::System::Object* item) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DataConvertor_1<T>*>::get(), "ProcessItem", std::span<Il2CppClass const* const, 0>(),
...
template <typename T> inline void GlobalNamespace::DataConvertor_1<T>::AddConvertor(::GlobalNamespace::DataItemConvertor_1<T>* dataItemConvertor) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DataConvertor_1<T>*>::get(), "AddConvertor", std::span<Il2CppClass const* const, 0>(),
                                  ::std::array<Il2CppType const*, 1>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::DataItemConvertor_1<T>*>::get() })));
...
template <typename T> inline ::GlobalNamespace::DataConvertor_1<T>* GlobalNamespace::DataConvertor_1<T>::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::GlobalNamespace::DataConvertor_1<T>*>());
}
