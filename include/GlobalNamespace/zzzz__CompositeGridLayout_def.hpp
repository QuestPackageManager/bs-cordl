...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CompositeGridLayout", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CompositeGridLayout(CompositeGridLayout&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CompositeGridLayout", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CompositeGridLayout(CompositeGridLayoutconst&) = delete;
