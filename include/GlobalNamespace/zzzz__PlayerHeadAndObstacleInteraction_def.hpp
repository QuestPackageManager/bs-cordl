...
public:
  ...
  /// @brief Method RefreshIntersectingObstacles, addr 0x3be785c, size 0x310, virtual false, abstract: false, final false
  inline void RefreshIntersectingObstacles(::UnityEngine::Vector3 worldPos);

  /// @brief Method Update, addr 0x3be7b6c, size 0x8c, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3be7bf8, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method add_headDidEnterObstacleEvent, addr 0x3be76fc, size 0xb0, virtual false, abstract: false, final false
  inline void add_headDidEnterObstacleEvent(::System::Action_1<::UnityW<::GlobalNamespace::ObstacleController>>* value);

  /// @brief Method add_headDidEnterObstaclesEvent, addr 0x3be75c4, size 0x9c, virtual false, abstract: false, final false
  inline void add_headDidEnterObstaclesEvent(::System::Action* value);

  /// @brief Method get_playerHeadIsInObstacle, addr 0x3be6cec, size 0x50, virtual false, abstract: false, final false
  inline bool get_playerHeadIsInObstacle();

  /// @brief Method remove_headDidEnterObstacleEvent, addr 0x3be77ac, size 0xb0, virtual false, abstract: false, final false
  inline void remove_headDidEnterObstacleEvent(::System::Action_1<::UnityW<::GlobalNamespace::ObstacleController>>* value);

  /// @brief Method remove_headDidEnterObstaclesEvent, addr 0x3be7660, size 0x9c, virtual false, abstract: false, final false
