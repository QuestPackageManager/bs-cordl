...
public:
  ...
  /// @brief Method Awake, addr 0x58d9f20, size 0xcc, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::GuestNameButtonsListItem* New_ctor();

  /// @brief Method <Awake>b__7_0, addr 0x58d9ff0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58d9fec, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_buttonPressed, addr 0x58d9f18, size 0x8, virtual false, abstract: false, final false
  inline void set_buttonPressed(::System::Action* value);

  /// @brief Method set_nameText, addr 0x58d9ef8, size 0x20, virtual false, abstract: false, final false
