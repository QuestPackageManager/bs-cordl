...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "INoteVisualModifierTypeProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  INoteVisualModifierTypeProvider(INoteVisualModifierTypeProviderconst&) = delete;
