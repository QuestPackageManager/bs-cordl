...
public:
  ...
  /// @brief Method ActivateMultiplayerLobby, addr 0x58df704, size 0xc0, virtual false, abstract: false, final false
  inline void ActivateMultiplayerLobby();

  /// @brief Method DeactivateMultiplayerLobby, addr 0x58df7c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58df844, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lobbyActivated, addr 0x58df6f4, size 0x8, virtual false, abstract: false, final false
  inline bool get_lobbyActivated();

  /// @brief Method set_lobbyActivated, addr 0x58df6fc, size 0x8, virtual false, abstract: false, final false
