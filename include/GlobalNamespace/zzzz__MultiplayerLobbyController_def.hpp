...
public:
  ...
  /// @brief Method ActivateMultiplayerLobby, addr 0x3c13fe4, size 0xcc, virtual false, abstract: false, final false
  inline void ActivateMultiplayerLobby();

  /// @brief Method DeactivateMultiplayerLobby, addr 0x3c140b0, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c14134, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_lobbyActivated, addr 0x3c13fd0, size 0x8, virtual false, abstract: false, final false
  inline bool get_lobbyActivated();

  /// @brief Method set_lobbyActivated, addr 0x3c13fd8, size 0xc, virtual false, abstract: false, final false
