...
public:
  ...
  /// @brief Method GetAuthenticationToken, addr 0x253b2c4, size 0xa0, virtual true, abstract: false, final true
  inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::AuthenticationToken>* GetAuthenticationToken();

  /// @brief Method GetTokenPlatform, addr 0x253b364, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method GetXPlatformAccessToken, addr 0x253b36c, size 0x74, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x253b1c4, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method get_hashedUserId, addr 0x253b1ac, size 0x8, virtual true, abstract: false, final true
  inline ::StringW get_hashedUserId();

  /// @brief Method get_platform, addr 0x253b1bc, size 0x8, virtual true, abstract: false, final true
  inline ::GlobalNamespace::__AuthenticationToken__Platform get_platform();

  /// @brief Method get_userName, addr 0x253b1b4, size 0x8, virtual true, abstract: false, final true
