...
/// @brief Field <platformType>k__BackingField, offset 0x30, size 0x1 
 __declspec(property(get=__cordl_internal_get__platformType_k__BackingField, put=__cordl_internal_set__platformType_k__BackingField)) ::GlobalNamespace::AuthenticationToken_PlatformType  _platformType_k__BackingField;
...
/// @brief Method GetAuthenticationToken, addr 0x58d45e4, size 0xa8, virtual true, abstract: false, final true
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::AuthenticationToken>* GetAuthenticationToken() ;

/// @brief Method GetTokenPlatform, addr 0x58d468c, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method GetXPlatformAccessToken, addr 0x58d4694, size 0x7c, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x58d4508, size 0xdc, virtual false, abstract: false, final false
...
/// @brief Method get_hashedUserId, addr 0x58d44f0, size 0x8, virtual true, abstract: false, final true
inline ::StringW get_hashedUserId() ;

/// @brief Method get_platformType, addr 0x58d4500, size 0x8, virtual true, abstract: false, final true
inline ::GlobalNamespace::AuthenticationToken_PlatformType get_platformType() ;

/// @brief Method get_userName, addr 0x58d44f8, size 0x8, virtual true, abstract: false, final true
