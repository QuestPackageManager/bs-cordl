...
public:
  ...
  /// @brief Method Awake, addr 0x3bf53b8, size 0x7c, virtual false, abstract: false, final false
  inline void Awake();

  static inline ::GlobalNamespace::TextFadeTransitions* New_ctor();

  /// @brief Method RefreshState, addr 0x3bf5508, size 0x120, virtual false, abstract: false, final false
  inline void RefreshState();

  /// @brief Method RefreshTextAlpha, addr 0x3bf5434, size 0xd0, virtual false, abstract: false, final false
  inline void RefreshTextAlpha();

  /// @brief Method ShowText, addr 0x3becb30, size 0x88, virtual false, abstract: false, final false
  inline void ShowText(::StringW text, float_t delay);

  /// @brief Method Update, addr 0x3bf5504, size 0x4, virtual false, abstract: false, final false
  inline void Update();
  ...
  /// @brief Method .ctor, addr 0x3bf5628, size 0x14, virtual false, abstract: false, final false
  inline void _ctor();
