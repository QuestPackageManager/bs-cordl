...
public:
  ...
  /// @brief Method .ctor, addr 0x26b386c, size 0x28, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x26b3864, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_jumpOffsetY, addr 0x26b3848, size 0x1c, virtual true, abstract: false, final true
