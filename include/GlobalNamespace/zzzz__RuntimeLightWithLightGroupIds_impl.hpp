...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId::*)()>(&::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId::get_intensity)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x56bcadc;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*>::get(),
                        "get_intensity",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId::*)(float_t)>(&::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId::set_intensity)> {
  constexpr static std::size_t size = 0x8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId::*)(int32_t, float_t)>(&::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId::_ctor)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x56bcaec;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RuntimeLightWithLightGroupIds::*)()>(&::GlobalNamespace::RuntimeLightWithLightGroupIds::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x56bc7d8;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RuntimeLightWithLightGroupIds::*)()>(&::GlobalNamespace::RuntimeLightWithLightGroupIds::ProcessNewColorData)> {
  ...
  constexpr static std::size_t addrs = 0x56bc988;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::LightWithIds_LightWithId*>* (::GlobalNamespace::RuntimeLightWithLightGroupIds::*)()>(&::GlobalNamespace::RuntimeLightWithLightGroupIds::GetLightWithIds)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x56bcad4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::RuntimeLightWithLightGroupIds::*)(::UnityEngine::Color, float_t)>(&::GlobalNamespace::RuntimeLightWithLightGroupIds::ProcessColor)> {
  ...
  constexpr static std::size_t addrs = 0x56bcab4;
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RuntimeLightWithLightGroupIds::*)()>(&::GlobalNamespace::RuntimeLightWithLightGroupIds::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x56b94e0;
...
constexpr ::ArrayW<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*>*>& GlobalNamespace::RuntimeLightWithLightGroupIds::__cordl_internal_get__lightIntensityData()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightIntensityData;
}
constexpr ::ArrayW<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*>*> const& GlobalNamespace::RuntimeLightWithLightGroupIds::__cordl_internal_get__lightIntensityData() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____lightIntensityData;
}
constexpr void GlobalNamespace::RuntimeLightWithLightGroupIds::__cordl_internal_set__lightIntensityData(::ArrayW<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*,::Array<::GlobalNamespace::RuntimeLightWithLightGroupIds_LightIntensitiesWithId*>*>  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
