...
/// @brief Method RenderIntoCubemap, addr 0x5d4948c, size 0x578, virtual false, abstract: false, final false
static inline void RenderIntoCubemap(::UnityEngine::Camera*  ownerCamera, ::UnityEngine::Cubemap*  outCubemap) ;

/// @brief Method SaveCubemapCapture, addr 0x5d49a04, size 0x7bc, virtual false, abstract: false, final false
static inline bool SaveCubemapCapture(::UnityEngine::Cubemap*  cubemap, ::StringW  pathName) ;

/// @brief Method TriggerCubemapCapture, addr 0x5d491d0, size 0x2bc, virtual false, abstract: false, final false
static inline void TriggerCubemapCapture(::UnityEngine::Vector3  capturePos, int32_t  cubemapSize, ::StringW  pathName) ;

/// @brief Method Update, addr 0x5d490e4, size 0xec, virtual false, abstract: false, final false
inline void Update() ;
...
/// @brief Method .ctor, addr 0x5d4a1c0, size 0x24, virtual false, abstract: false, final false
inline void _ctor() ;
