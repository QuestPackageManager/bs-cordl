...
public:
  ...
  /// @brief Method Deserialize, addr 0x32a74a0, size 0x80, virtual true, abstract: false, final true
  inline void Deserialize(::LiteNetLib::Utils::NetDataReader* reader);

  /// @brief Method Serialize, addr 0x32a7420, size 0x80, virtual true, abstract: false, final true
  inline void Serialize(::LiteNetLib::Utils::NetDataWriter* writer);

  /// @brief Method .ctor, addr 0x32a73e4, size 0x3c, virtual false, abstract: false, final false
