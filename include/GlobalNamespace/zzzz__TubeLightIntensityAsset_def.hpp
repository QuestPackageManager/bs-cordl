...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TubeLightIntensityAsset", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TubeLightIntensityAsset(TubeLightIntensityAsset&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TubeLightIntensityAsset", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TubeLightIntensityAsset(TubeLightIntensityAssetconst&) = delete;
