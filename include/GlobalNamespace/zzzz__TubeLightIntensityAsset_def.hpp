...
public:
  ...
  /// @brief Method get_clipCaps addr 0x21c5478 size 0x8 virtual true final true
  inline ::UnityEngine::Timeline::ClipCaps get_clipCaps();

  /// @brief Method CreatePlayable addr 0x21c5480 size 0xa8 virtual true final false
  inline ::UnityEngine::Playables::Playable CreatePlayable(::UnityEngine::Playables::PlayableGraph graph, ::UnityEngine::GameObject* go);

  static inline ::GlobalNamespace::TubeLightIntensityAsset* New_ctor();

  /// @brief Method .ctor addr 0x21c5528 size 0x8 virtual false final false
  inline void _ctor();
