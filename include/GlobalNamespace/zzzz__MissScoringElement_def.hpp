...
// Write type traits
MARK_REF_T(::GlobalNamespace::MissScoringElement*);
MARK_REF_T(::GlobalNamespace::MissScoringElement_Pool*);
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissScoringElement*, "", "MissScoringElement");
DEFINE_IL2CPP_CLASS(::GlobalNamespace::MissScoringElement_Pool*, "", "MissScoringElement/Pool");
...
public:
  ...
  /// @brief Method .ctor, addr 0x59efff8, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::GlobalNamespace::MissScoringElement_Pool) == 0x38, "Size mismatch!");
...
public:
  ...
  /// @brief Method Init, addr 0x59ef9a4, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x59efff4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_cutScore, addr 0x59effd0, size 0x8, virtual true, abstract: false, final false
  inline int32_t get_cutScore();

  /// @brief Method get_executionOrder, addr 0x59effe8, size 0xc, virtual true, abstract: false, final false
  inline int32_t get_executionOrder();

  /// @brief Method get_multiplierEventType, addr 0x59effe0, size 0x8, virtual true, abstract: false, final false
  inline ::GlobalNamespace::ScoreMultiplierCounter_MultiplierEventType get_multiplierEventType();

  /// @brief Method get_wouldBeCorrectCutBestPossibleMultiplierEventType, addr 0x59effd8, size 0x8, virtual true, abstract: false, final false
...
static_assert(sizeof(::GlobalNamespace::MissScoringElement) == 0x30, "Size mismatch!");
