...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::GlobalNamespace::PrivacyPolicyDisplayViewController::*)(bool, bool, bool)>(
  ...
  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::GlobalNamespace::PrivacyPolicyDisplayViewController*>(),
                                                                                          { ::i2c::class_of<::GlobalNamespace::PrivacyPolicyDisplayViewController*>(), 5 }));
...
inline void GlobalNamespace::PrivacyPolicyDisplayViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::GlobalNamespace::PrivacyPolicyDisplayViewController*>(), 5 })));
...
inline ::GlobalNamespace::PrivacyPolicyDisplayViewController* GlobalNamespace::PrivacyPolicyDisplayViewController::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::GlobalNamespace::PrivacyPolicyDisplayViewController*>());
}
// Ctor Parameters []
