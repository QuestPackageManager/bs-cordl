...
public:
  ...
  /// @brief Method .ctor addr 0x2d63cf4 size 0x2c virtual false final false
  inline void _ctor(::Zenject::SubContainerCreatorBindInfo* subContainerBindInfo, ::Zenject::BindInfo* bindInfo);

  /// @brief Method get_SubContainerCreatorBindInfo addr 0x2d63d20 size 0x8 virtual false final false
  inline ::Zenject::SubContainerCreatorBindInfo* get_SubContainerCreatorBindInfo();

  /// @brief Method set_SubContainerCreatorBindInfo addr 0x2d63d28 size 0x8 virtual false final false
  inline void set_SubContainerCreatorBindInfo(::Zenject::SubContainerCreatorBindInfo* value);

  /// @brief Method WithDefaultGameObjectParent addr 0x2d63d30 size 0x1c virtual false final false
