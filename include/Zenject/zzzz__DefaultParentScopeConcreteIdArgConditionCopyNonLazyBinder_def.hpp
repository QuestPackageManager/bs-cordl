...
public:
  ...
  /// @brief Method WithDefaultGameObjectParent, addr 0x362071c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36206e0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::SubContainerCreatorBindInfo* subContainerBindInfo, ::Zenject::BindInfo* bindInfo);

  /// @brief Method get_SubContainerCreatorBindInfo, addr 0x362070c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SubContainerCreatorBindInfo* get_SubContainerCreatorBindInfo();

  /// @brief Method set_SubContainerCreatorBindInfo, addr 0x3620714, size 0x8, virtual false, abstract: false, final false
