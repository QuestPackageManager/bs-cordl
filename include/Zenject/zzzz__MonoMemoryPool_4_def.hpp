...
// Dependencies UnityEngine.Component, Zenject.MemoryPool`4<TParam1, TParam2, TParam3, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::UnityEngine::Component*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoMemoryPool_4(MonoMemoryPool_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoMemoryPool_4(MonoMemoryPool_4const&) = delete;
