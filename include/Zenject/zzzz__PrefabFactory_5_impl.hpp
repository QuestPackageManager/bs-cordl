...
template <typename P1, typename P2, typename P3, typename P4, typename T> constexpr ::Zenject::DiContainer*& Zenject::PrefabFactory_5<P1, P2, P3, P4, T>::__get__container() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____container;
}
template <typename P1, typename P2, typename P3, typename P4, typename T>
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> const& Zenject::PrefabFactory_5<P1, P2, P3, P4, T>::__get__container() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____container;
}
template <typename P1, typename P2, typename P3, typename P4, typename T> constexpr void Zenject::PrefabFactory_5<P1, P2, P3, P4, T>::__set__container(::Zenject::DiContainer* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline T Zenject::PrefabFactory_5<P1, P2, P3, P4, T>::Create(::UnityEngine::Object* prefab, P1 param, P2 param2, P3 param3, P4 param4) {
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabFactory_5<P1, P2, P3, P4, T>*>::get(), "Create", std::vector<Il2CppClass*>{},
...
template <typename P1, typename P2, typename P3, typename P4, typename T> inline ::Zenject::PrefabFactory_5<P1, P2, P3, P4, T>* Zenject::PrefabFactory_5<P1, P2, P3, P4, T>::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::New<::Zenject::PrefabFactory_5<P1, P2, P3, P4, T>*>());
}
...
inline ::System::Object* Zenject::PrefabFactory_5<P1, P2, P3, P4, T>::__zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabFactory_5<P1, P2, P3, P4, T>*>::get(), "__zenCreate", std::vector<Il2CppClass*>{},
...
template <typename P1, typename P2, typename P3, typename P4, typename T> inline void Zenject::PrefabFactory_5<P1, P2, P3, P4, T>::__zenFieldSetter0(::System::Object* P_0, ::System::Object* P_1) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabFactory_5<P1, P2, P3, P4, T>*>::get(), "__zenFieldSetter0", std::vector<Il2CppClass*>{},
