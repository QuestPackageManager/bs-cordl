...
/// @brief Method GetAllInstancesWithInjectSplit, addr 0x6cbac80, size 0x10c, virtual true, abstract: false, final true
...
/// @brief Method GetInstanceType, addr 0x6cbac20, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6cbac08, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Zenject::DiContainer*  container, ::Zenject::GameObjectCreationParameters*  gameObjectBindInfo) ;

/// @brief Method get_IsCached, addr 0x6cbac10, size 0x8, virtual true, abstract: false, final true
inline bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6cbac18, size 0x8, virtual true, abstract: false, final true
