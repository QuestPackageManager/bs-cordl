...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableMemoryPoolProvider_2(PoolableMemoryPoolProvider_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableMemoryPoolProvider_2(PoolableMemoryPoolProvider_2const&) = delete;
