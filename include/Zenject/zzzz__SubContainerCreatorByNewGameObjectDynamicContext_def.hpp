...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x307299c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3072948, size 0x2c, virtual false, abstract: false, final false
