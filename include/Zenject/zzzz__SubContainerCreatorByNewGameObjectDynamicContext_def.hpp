...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x6cbe600, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cbe5f0, size 0x8, virtual false, abstract: false, final false
