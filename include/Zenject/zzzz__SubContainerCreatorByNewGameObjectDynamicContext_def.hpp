...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x4b3bd10, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b3bcbc, size 0x2c, virtual false, abstract: false, final false
