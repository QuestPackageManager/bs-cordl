...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x6c5577c, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c5576c, size 0x8, virtual false, abstract: false, final false
