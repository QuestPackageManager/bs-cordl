...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x6d30f04, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d30ef4, size 0x8, virtual false, abstract: false, final false
