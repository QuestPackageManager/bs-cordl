...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x6e8acc4, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e8acb4, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectDynamicContext", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByNewGameObjectDynamicContext(SubContainerCreatorByNewGameObjectDynamicContext&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectDynamicContext", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByNewGameObjectDynamicContext(SubContainerCreatorByNewGameObjectDynamicContextconst&) = delete;
