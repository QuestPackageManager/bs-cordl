#pragma once
// IWYU pragma private; include "Zenject/PlaceholderFactory_6.hpp"
...
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue> class PlaceholderFactory_6__get_ParamTypes_d__2;
}
// Forward declare root types
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue> class PlaceholderFactory_6;
}
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue> class PlaceholderFactory_6__get_ParamTypes_d__2;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_6);
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_6__get_ParamTypes_d__2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_6, "Zenject", "PlaceholderFactory`6");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_6__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`6/<get_ParamTypes>d__2");
// [CompilerGenerated]
...
// Is value type: false
// CS Name: Zenject.PlaceholderFactory`6/<get_ParamTypes>d__2<TParam1,TParam2,TParam3,TParam4,TParam5,TValue>
class CORDL_TYPE PlaceholderFactory_6__get_ParamTypes_d__2 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::PlaceholderFactory_6__get_ParamTypes_d__2<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* New_ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_6__get_ParamTypes_d__2();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6__get_ParamTypes_d__2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_6__get_ParamTypes_d__2(PlaceholderFactory_6__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6__get_ParamTypes_d__2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_6__get_ParamTypes_d__2(PlaceholderFactory_6__get_ParamTypes_d__2 const&) = delete;
...
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue>
// Is value type: false
// CS Name: Zenject.PlaceholderFactory`6<TParam1,TParam2,TParam3,TParam4,TParam5,TValue>
class CORDL_TYPE PlaceholderFactory_6 : public ::Zenject::PlaceholderFactoryBase_1<TValue> {
public:
  // Declarations
  using _get_ParamTypes_d__2 = ::Zenject::PlaceholderFactory_6__get_ParamTypes_d__2<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>;
  ...
  static inline ::Zenject::PlaceholderFactory_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* New_ctor();
  ...
  /// [IteratorStateMachine(typeof(Zenject.PlaceholderFactory`6::<get_ParamTypes>d__2<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>))]
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_6();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_6(PlaceholderFactory_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_6(PlaceholderFactory_6 const&) = delete;
