...
// Write type traits
MARK_GEN_REF_PTR_T(::Zenject::PlaceholderFactory_6);
MARK_GEN_REF_PTR_T(::Zenject::PlaceholderFactory_6__get_ParamTypes_d__2);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6__get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_6__get_ParamTypes_d__2(PlaceholderFactory_6__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6__get_ParamTypes_d__2", modifiers: "const&", def_value: None }]
...
// Dependencies Zenject.IFactory, Zenject.IFactory`6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>, Zenject.PlaceholderFactoryBase`1<TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue>
// Is value type: false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_6(PlaceholderFactory_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_6", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::PlaceholderFactory_6__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`6/<get_ParamTypes>d__2");
