...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MonoInstaller_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MonoInstaller_5, "Zenject", "MonoInstaller`5");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoInstaller_5", modifiers: "&&", def_value: None, comment: None }]
