...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_3(MemoryPool_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_3(MemoryPool_3const&) = delete;
