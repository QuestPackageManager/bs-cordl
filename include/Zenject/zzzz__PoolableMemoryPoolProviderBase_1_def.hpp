...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PoolableMemoryPoolProviderBase_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PoolableMemoryPoolProviderBase_1, "Zenject", "PoolableMemoryPoolProviderBase`1");
