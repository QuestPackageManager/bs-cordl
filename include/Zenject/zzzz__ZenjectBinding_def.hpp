...
public:
  ...
  /// @brief Method Start, addr 0x6d1cab4, size 0x4, virtual false, abstract: false, final false
  inline void Start();
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6d1cad0, size 0x148, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6d1cab8, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_BindType, addr 0x6d1caac, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ZenjectBinding_BindTypes get_BindType();

  /// @brief Method get_Components, addr 0x6d1ca9c, size 0x8, virtual false, abstract: false, final false
  inline ::ArrayW<::UnityW<::UnityEngine::Component>, ::Array<::UnityW<::UnityEngine::Component>>*> get_Components();

  /// @brief Method get_Context, addr 0x6d1ca8c, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::Zenject::Context> get_Context();

  /// @brief Method get_Identifier, addr 0x6d1caa4, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Identifier();

  /// @brief Method get_IfNotBound, addr 0x6d1ca84, size 0x8, virtual false, abstract: false, final false
  inline bool get_IfNotBound();

  /// @brief Method get_UseSceneContext, addr 0x6d1ca7c, size 0x8, virtual false, abstract: false, final false
  inline bool get_UseSceneContext();

  /// @brief Method set_Context, addr 0x6d1ca94, size 0x8, virtual false, abstract: false, final false
