...
public:
  ...
  /// @brief [Inject]
  static inline ::Zenject::MonoPoolableMemoryPool_9<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TValue>* New_ctor();
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr MonoPoolableMemoryPool_9();

public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoPoolableMemoryPool_9", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoPoolableMemoryPool_9(MonoPoolableMemoryPool_9&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoPoolableMemoryPool_9", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoPoolableMemoryPool_9(MonoPoolableMemoryPool_9 const&) = delete;
