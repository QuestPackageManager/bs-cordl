...
inline void Zenject::PoolableMemoryPoolProvider_5<TParam1, TParam2, TParam3, TContract, TMemoryPool>::GetAllInstancesWithInjectSplit(
  ...
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{},
      (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Zenject::PoolableMemoryPoolProvider_5<TParam1, TParam2, TParam3, TContract, TMemoryPool>*>(), 8 })));
