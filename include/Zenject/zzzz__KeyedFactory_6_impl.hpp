...
inline ::System::Collections::Generic::IEnumerable_1<::System::Type*>* Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>::get_ProvidedTypes() {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>*>(), 5 })));
...
inline TBase Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>::Create(TKey key, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4) {
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>*>(), 7 })));
  return ::cordl_internals::RunMethodRethrow<TBase>(this, ___internal_method, key, param1, param2, param3, param4);
}
template <typename TBase, typename TKey, typename TParam1, typename TParam2, typename TParam3, typename TParam4>
inline void Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename TBase, typename TKey, typename TParam1, typename TParam2, typename TParam3, typename TParam4>
inline ::System::Object* Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>::__zenCreate(::ArrayW<::System::Object*> P_0) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>*>(),
...
inline ::Zenject::InjectTypeInfo* Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>::__zenCreateInjectTypeInfo() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>*>(), { "__zenCreateInjectTypeInfo", {}, {} })));
...
inline ::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>* Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::KeyedFactory_6<TBase, TKey, TParam1, TParam2, TParam3, TParam4>*>());
}
// Ctor Parameters []
template <typename TBase, typename TKey, typename TParam1, typename TParam2, typename TParam3, typename TParam4>
