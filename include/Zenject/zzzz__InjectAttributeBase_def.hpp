...
namespace Zenject {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(15857)), TypeDefinitionIndex(TypeDefinitionIndex(15862))]
...
public:
  ...
  /// @brief Method get_Optional, addr 0x2ed58f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_Optional();

  /// @brief Method set_Optional, addr 0x2ed5900, size 0xc, virtual false, abstract: false, final false
  inline void set_Optional(bool value);

  /// @brief Method get_Id, addr 0x2ed590c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Id();

  /// @brief Method set_Id, addr 0x2ed5914, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::System::Object* value);

  /// @brief Method get_Source, addr 0x2ed591c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::InjectSources get_Source();

  /// @brief Method set_Source, addr 0x2ed5924, size 0x8, virtual false, abstract: false, final false
  inline void set_Source(::Zenject::InjectSources value);

  static inline ::Zenject::InjectAttributeBase* New_ctor();

  /// @brief Method .ctor, addr 0x2ed592c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
