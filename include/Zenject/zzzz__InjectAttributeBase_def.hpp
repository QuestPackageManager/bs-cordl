...
public:
  ...
  /// @brief Method .ctor, addr 0x4af2bc4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Id, addr 0x4af2ba4, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Id();

  /// @brief Method get_Optional, addr 0x4af2b90, size 0x8, virtual false, abstract: false, final false
  inline bool get_Optional();

  /// @brief Method get_Source, addr 0x4af2bb4, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::InjectSources get_Source();

  /// @brief Method set_Id, addr 0x4af2bac, size 0x8, virtual false, abstract: false, final false
  inline void set_Id(::System::Object* value);

  /// @brief Method set_Optional, addr 0x4af2b98, size 0xc, virtual false, abstract: false, final false
  inline void set_Optional(bool value);

  /// @brief Method set_Source, addr 0x4af2bbc, size 0x8, virtual false, abstract: false, final false
