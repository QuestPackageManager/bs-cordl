...
/// @brief Method CreateGameObject, addr 0x6cbf528, size 0x1d4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cbf51c, size 0xc, virtual false, abstract: false, final false
