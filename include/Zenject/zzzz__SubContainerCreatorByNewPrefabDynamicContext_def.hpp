...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x6e87fa4, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e87f98, size 0xc, virtual false, abstract: false, final false
