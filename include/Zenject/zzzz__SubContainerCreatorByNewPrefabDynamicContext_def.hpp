...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x4b425c8, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b4258c, size 0x3c, virtual false, abstract: false, final false
