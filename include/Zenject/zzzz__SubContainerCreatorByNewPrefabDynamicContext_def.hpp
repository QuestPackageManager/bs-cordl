...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x4b3c5e0, size 0x1c0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b3c5a4, size 0x3c, virtual false, abstract: false, final false
