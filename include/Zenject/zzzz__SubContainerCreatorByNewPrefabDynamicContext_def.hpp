...
public:
  ...
  /// @brief Method CreateGameObject, addr 0x6d3176c, size 0x1d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d31760, size 0xc, virtual false, abstract: false, final false
