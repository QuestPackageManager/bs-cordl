...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_6(MemoryPool_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_6(MemoryPool_6const&) = delete;
