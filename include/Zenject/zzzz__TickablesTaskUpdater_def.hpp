...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11265)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11265), inst: 3035 }),
// TypeDefinitionIndex(TypeDefinitionIndex(15682))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11266)) CS Name: ::Zenject::TickablesTaskUpdater*
class CORDL_TYPE TickablesTaskUpdater : public ::Zenject::TaskUpdater_1<::Zenject::ITickable*> {
public:
  // Declarations
  /// @brief Method UpdateItem addr 0x2db1054 size 0x9c virtual true final false
  inline void UpdateItem(::Zenject::ITickable* task);

  static inline ::Zenject::TickablesTaskUpdater* New_ctor();

  /// @brief Method .ctor addr 0x2db10f0 size 0x48 virtual false final false
  inline void _ctor();

  /// @brief Method __zenCreate addr 0x2db1138 size 0x58 virtual false final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo addr 0x2db1190 size 0x1c0 virtual false final false
