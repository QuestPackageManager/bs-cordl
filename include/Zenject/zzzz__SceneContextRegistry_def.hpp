...
public:
  ...
  /// @brief Method Add, addr 0x4b4e948, size 0xd0, virtual false, abstract: false, final false
  inline void Add(::Zenject::SceneContext* context);

  /// @brief Method GetContainerForScene, addr 0x4b4ec40, size 0xa4, virtual false, abstract: false, final false
  inline ::Zenject::DiContainer* GetContainerForScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method GetSceneContextForScene, addr 0x4b4ea18, size 0xac, virtual false, abstract: false, final false
  inline ::UnityW<::Zenject::SceneContext> GetSceneContextForScene(::StringW name);

  /// @brief Method GetSceneContextForScene, addr 0x4b4eac4, size 0x58, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x4b4edd0, size 0x10c, virtual false, abstract: false, final false
  inline void Remove(::Zenject::SceneContext* context);

  /// @brief Method TryGetContainerForScene, addr 0x4b4ece4, size 0xec, virtual false, abstract: false, final false
  inline ::Zenject::DiContainer* TryGetContainerForScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method TryGetSceneContextForScene, addr 0x4b4eb1c, size 0xac, virtual false, abstract: false, final false
  inline ::UnityW<::Zenject::SceneContext> TryGetSceneContextForScene(::StringW name);

  /// @brief Method TryGetSceneContextForScene, addr 0x4b4ebc8, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreate, addr 0x4b4ef58, size 0x50, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x4b4efa8, size 0x1b8, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x4b4eedc, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SceneContexts, addr 0x4b4cc64, size 0x50, virtual false, abstract: false, final false
