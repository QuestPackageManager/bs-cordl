...
public:
  ...
  /// @brief Method Add, addr 0x6cca29c, size 0xf8, virtual false, abstract: false, final false
  inline void Add(::Zenject::SceneContext* context);

  /// @brief Method GetContainerForScene, addr 0x6cca60c, size 0xa4, virtual false, abstract: false, final false
  inline ::Zenject::DiContainer* GetContainerForScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method GetSceneContextForScene, addr 0x6cca394, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::Zenject::SceneContext> GetSceneContextForScene(::StringW name);

  /// @brief Method GetSceneContextForScene, addr 0x6cca460, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x6cca798, size 0x12c, virtual false, abstract: false, final false
  inline void Remove(::Zenject::SceneContext* context);

  /// @brief Method TryGetContainerForScene, addr 0x6cca6b0, size 0xe8, virtual false, abstract: false, final false
  inline ::Zenject::DiContainer* TryGetContainerForScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method TryGetSceneContextForScene, addr 0x6cca4c4, size 0xcc, virtual false, abstract: false, final false
  inline ::UnityW<::Zenject::SceneContext> TryGetSceneContextForScene(::StringW name);

  /// @brief Method TryGetSceneContextForScene, addr 0x6cca590, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreate, addr 0x6cca95c, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6cca9b0, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6cca8c4, size 0x98, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_SceneContexts, addr 0x6cc86dc, size 0x54, virtual false, abstract: false, final false
