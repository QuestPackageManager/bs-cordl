...
/// @brief Method GetAllInstancesWithInjectSplit, addr 0x6cba2c4, size 0x1d4, virtual true, abstract: false, final true
...
/// @brief Method GetInstanceType, addr 0x6cba2bc, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6cba2a0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  componentType, ::UnityEngine::GameObject*  gameObject, bool  matchSingle) ;

/// @brief Method get_IsCached, addr 0x6cba2ac, size 0x8, virtual true, abstract: false, final true
inline bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6cba2b4, size 0x8, virtual true, abstract: false, final true
