...
public:
  ...
  /// @brief Method FinalizeBinding, addr 0x4b25ce4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method get_BindingInheritanceMethod, addr 0x4b25cdc, size 0x8, virtual true, abstract: false, final true
