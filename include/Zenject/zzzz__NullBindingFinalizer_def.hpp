...
/// @brief Method FinalizeBinding, addr 0x6c9785c, size 0x4, virtual true, abstract: false, final true
inline void FinalizeBinding(::Zenject::DiContainer*  container) ;

static inline ::Zenject::NullBindingFinalizer* New_ctor() ;

/// @brief Method .ctor, addr 0x6c97860, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_BindingInheritanceMethod, addr 0x6c97854, size 0x8, virtual true, abstract: false, final true
