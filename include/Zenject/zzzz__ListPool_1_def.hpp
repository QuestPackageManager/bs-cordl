...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::ListPool_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ListPool_1, "Zenject", "ListPool`1");
...
public:
  ...
  __declspec(property(get = getStaticF__instance, put = setStaticF__instance)) ::Zenject::ListPool_1<T>* _instance;
...
public:
  ...
  ListPool_1(ListPool_1const&) = delete;
