...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::FactoryFromBinderUntyped::*)(
  ...
  constexpr static std::size_t addrs = 0x2ecbacc;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::FactoryFromBinderUntyped*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
inline ::Zenject::FactoryFromBinderUntyped* Zenject::FactoryFromBinderUntyped::New_ctor(::Zenject::DiContainer* bindContainer, ::System::Type* contractType, ::Zenject::BindInfo* bindInfo,
  ...
  return THROW_UNLESS(::il2cpp_utils::New<::Zenject::FactoryFromBinderUntyped*>(bindContainer, contractType, bindInfo, factoryBindInfo));
}
