...
public:
  ...
  /// @brief Method WithId, addr 0x3042224, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* WithId(::System::Object* identifier);

  /// @brief Method .ctor, addr 0x3042214, size 0x8, virtual false, abstract: false, final false
