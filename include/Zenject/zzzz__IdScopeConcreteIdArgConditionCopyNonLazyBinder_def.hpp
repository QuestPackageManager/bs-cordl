...
public:
  ...
  /// @brief Method WithId, addr 0x6c27d6c, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* WithId(::System::Object* identifier);

  /// @brief Method .ctor, addr 0x6c27d64, size 0x8, virtual false, abstract: false, final false
