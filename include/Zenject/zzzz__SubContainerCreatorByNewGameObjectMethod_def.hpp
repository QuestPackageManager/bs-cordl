...
public:
  ...
  /// @brief Method AddInstallers, addr 0x6cbebc8, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cbebbc, size 0xc, virtual false, abstract: false, final false
