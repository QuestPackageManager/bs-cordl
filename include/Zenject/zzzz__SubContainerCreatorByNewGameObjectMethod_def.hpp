...
public:
  ...
  /// @brief Method AddInstallers, addr 0x6e87d04, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e87cf8, size 0xc, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SubContainerCreatorByNewGameObjectMethod) == 0x28, "Size mismatch!");
