...
public:
  ...
  /// @brief Method AddInstallers, addr 0x6c55d44, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c55d38, size 0xc, virtual false, abstract: false, final false
