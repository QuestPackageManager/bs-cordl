...
public:
  ...
  /// @brief Method AddInstallers, addr 0x6d314cc, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d314c0, size 0xc, virtual false, abstract: false, final false
