...
public:
  ...
  /// @brief Method AddInstallers, addr 0x3072fe0, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3072fa4, size 0x3c, virtual false, abstract: false, final false
