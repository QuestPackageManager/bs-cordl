...
public:
  ...
  /// @brief Method AddInstallers, addr 0x345ae68, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345ae2c, size 0x3c, virtual false, abstract: false, final false
