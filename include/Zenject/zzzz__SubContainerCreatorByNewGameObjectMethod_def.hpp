...
public:
  ...
  /// @brief Method AddInstallers, addr 0x368c32c, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368c2f0, size 0x3c, virtual false, abstract: false, final false
