...
public:
  ...
  /// @brief Method AddInstallers, addr 0x4b3f834, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b3f7f8, size 0x3c, virtual false, abstract: false, final false
