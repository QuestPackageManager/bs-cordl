...
// Dependencies Zenject.IDespawnableMemoryPool`1<TValue>, Zenject.IMemoryPool, Zenject.IMemoryPool`4<TParam1, TParam2, TParam3, TValue>, Zenject.StaticMemoryPoolBase`1<TValue>
namespace Zenject {
// cpp template
