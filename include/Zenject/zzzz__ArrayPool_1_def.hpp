...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::ArrayPool_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ArrayPool_1, "Zenject", "ArrayPool`1");
...
class CORDL_TYPE ArrayPool_1 : public ::Zenject::StaticMemoryPoolBaseBase_1<::ArrayW<T>> {
public:
  // Declarations
