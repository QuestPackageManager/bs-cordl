...
public:
  ...
  /// @brief Method UnderTransform, addr 0x4b133f0, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* UnderTransform(::UnityEngine::Transform* parent);

  /// @brief Method UnderTransform, addr 0x4b1340c, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method UnderTransformGroup, addr 0x4b13428, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b133b0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::BindInfo* bindInfo, ::Zenject::GameObjectCreationParameters* gameObjectInfo);

  /// @brief Method get_GameObjectInfo, addr 0x4b133e0, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::GameObjectCreationParameters* get_GameObjectInfo();

  /// @brief Method set_GameObjectInfo, addr 0x4b133e8, size 0x8, virtual false, abstract: false, final false
