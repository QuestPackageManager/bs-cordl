...
public:
  ...
  /// @brief Method get_Container addr 0x2ef4bbc size 0x8 virtual false final false
  inline ::Zenject::DiContainer* get_Container();

  /// @brief Method get_IsEnabled addr 0x2ef4bc4 size 0x8 virtual true final false
  ...
  /// @brief Method .ctor addr 0x2ef4a3c size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method __zenFieldSetter0 addr 0x2ef4bcc size 0x134 virtual false final false
  static inline void __zenFieldSetter0(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method __zenCreateInjectTypeInfo addr 0x2ef4d00 size 0x2b0 virtual false final false
