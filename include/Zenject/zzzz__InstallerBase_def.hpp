...
// Write type traits
MARK_REF_T(::Zenject::InstallerBase*);
DEFINE_IL2CPP_CLASS(::Zenject::InstallerBase*, "Zenject", "InstallerBase");
...
static_assert(sizeof(::Zenject::InstallerBase) == 0x18, "Size mismatch!");
