...
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TValue> class PlaceholderFactory_4__get_ParamTypes_d__2;
}
// Forward declare root types
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TValue> class PlaceholderFactory_4;
}
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TValue> class PlaceholderFactory_4__get_ParamTypes_d__2;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_4);
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_4__get_ParamTypes_d__2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_4, "Zenject", "PlaceholderFactory`4");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_4__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`4/<get_ParamTypes>d__2");
// [CompilerGenerated]
...
// Is value type: false
// CS Name: Zenject.PlaceholderFactory`4/<get_ParamTypes>d__2<TParam1,TParam2,TParam3,TValue>
class CORDL_TYPE PlaceholderFactory_4__get_ParamTypes_d__2 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::PlaceholderFactory_4__get_ParamTypes_d__2<TParam1, TParam2, TParam3, TValue>* New_ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_4__get_ParamTypes_d__2();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_4__get_ParamTypes_d__2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_4__get_ParamTypes_d__2(PlaceholderFactory_4__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_4__get_ParamTypes_d__2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_4__get_ParamTypes_d__2(PlaceholderFactory_4__get_ParamTypes_d__2 const&) = delete;
...
public:
  // Declarations
  using _get_ParamTypes_d__2 = ::Zenject::PlaceholderFactory_4__get_ParamTypes_d__2<TParam1, TParam2, TParam3, TValue>;
  ...
  static inline ::Zenject::PlaceholderFactory_4<TParam1, TParam2, TParam3, TValue>* New_ctor();
  ...
  /// [IteratorStateMachine(typeof(Zenject.PlaceholderFactory`4::<get_ParamTypes>d__2<TParam1, TParam2, TParam3, TValue>))]
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_4();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_4(PlaceholderFactory_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_4(PlaceholderFactory_4 const&) = delete;
