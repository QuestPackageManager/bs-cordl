...
MARK_GEN_REF_PTR_T(::Zenject::__PlaceholderFactory_4___get_ParamTypes_d__2);
...
// CS Name: ::PlaceholderFactory`4::<get_ParamTypes>d__2<TParam1,TParam2,TParam3,TValue>*
class CORDL_TYPE __PlaceholderFactory_4___get_ParamTypes_d__2 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::__PlaceholderFactory_4___get_ParamTypes_d__2<TParam1, TParam2, TParam3, TValue>* New_ctor(int32_t __1__state);
  ...
  // Ctor Parameters [CppParam { name: "", ty: "__PlaceholderFactory_4___get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __PlaceholderFactory_4___get_ParamTypes_d__2(__PlaceholderFactory_4___get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__PlaceholderFactory_4___get_ParamTypes_d__2", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __PlaceholderFactory_4___get_ParamTypes_d__2(__PlaceholderFactory_4___get_ParamTypes_d__2 const&) = delete;

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __PlaceholderFactory_4___get_ParamTypes_d__2();
...
template <typename TParam1, typename TParam2, typename TParam3, typename TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10954), inst: 4726 }), TypeDefinitionIndex(TypeDefinitionIndex(10954))}
...
public:
  // Declarations
  using _get_ParamTypes_d__2 = ::Zenject::__PlaceholderFactory_4___get_ParamTypes_d__2<TParam1, TParam2, TParam3, TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::__PlaceholderFactory_4___get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`4/<get_ParamTypes>d__2");
