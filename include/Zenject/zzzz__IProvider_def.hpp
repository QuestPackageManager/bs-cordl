...
// Write type traits
MARK_REF_T(::Zenject::IProvider*);
DEFINE_IL2CPP_CLASS(::Zenject::IProvider*, "Zenject", "IProvider");
// Dependencies
namespace Zenject {
// Is value type: false
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IProvider(IProviderconst&) = delete;
