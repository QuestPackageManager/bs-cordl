...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::Factory_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::Factory_5, "Zenject", "Factory`5");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Factory_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Factory_5(Factory_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Factory_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Factory_5(Factory_5const&) = delete;
