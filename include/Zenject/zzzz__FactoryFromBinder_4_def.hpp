...
class FactoryFromBinder_4___c__2_1;
}
namespace Zenject {
...
// [CompilerGenerated]
// Dependencies System.Object, Zenject.IFactory`4<TParam1, TParam2, TParam3, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TContract, typename TSubFactory>
  requires(::cordl_internals::type_constraint<TSubFactory, ::Zenject::IFactory_4<TParam1, TParam2, TParam3, TContract>*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_4___c__2_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_4___c__2_1(FactoryFromBinder_4___c__2_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_4___c__2_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryFromBinder_4___c__2_1(FactoryFromBinder_4___c__2_1const&) = delete;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_4___c__DisplayClass1_0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_4___c__DisplayClass1_0(FactoryFromBinder_4___c__DisplayClass1_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_4___c__DisplayClass1_0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryFromBinder_4___c__DisplayClass1_0(FactoryFromBinder_4___c__DisplayClass1_0const&) = delete;
...
// [NoReflectionBaking]
// Dependencies Zenject.FactoryFromBinderBase, Zenject.IFactory`4<TParam1, TParam2, TParam3, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TContract>
// Is value type: false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_4(FactoryFromBinder_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryFromBinder_4(FactoryFromBinder_4const&) = delete;
