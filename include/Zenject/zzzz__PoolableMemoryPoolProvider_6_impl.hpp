...
inline void Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>::_ctor(::Zenject::DiContainer* container, ::System::Guid poolId) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>*>(),
...
inline void Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>::Validate() {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>*>(), { "Validate", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TContract, typename TMemoryPool>
inline void Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>::GetAllInstancesWithInjectSplit(
  ...
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass,
                                                           { ::i2c::class_of<::Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>*>(), 8 })));
...
Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>::New_ctor(::Zenject::DiContainer* container, ::System::Guid poolId) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::PoolableMemoryPoolProvider_6<TParam1, TParam2, TParam3, TParam4, TContract, TMemoryPool>*>(container, poolId));
}
