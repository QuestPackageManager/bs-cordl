...
namespace Zenject {
template<typename TParam1,typename TContract>
class FactoryFromBinder1Extensions___c__DisplayClass0_0_2;
}
namespace Zenject {
template<typename TParam1,typename TContract,typename TMemoryPool>
...
template<typename TParam1,typename TContract>
using __c__DisplayClass0_0_2 = ::Zenject::FactoryFromBinder1Extensions___c__DisplayClass0_0_2<TParam1, TContract>;
