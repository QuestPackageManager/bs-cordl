...
public:
  ...
  /// @brief Method Dispose, addr 0x36327c8, size 0x58, virtual true, abstract: false, final true
  inline void Dispose();

  static inline ::Zenject::BindInfo* New_ctor();

  /// @brief Method Reset, addr 0x36326cc, size 0xfc, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method SetContextInfo, addr 0x3632820, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x36325e0, size 0xec, virtual false, abstract: false, final false
  inline void _ctor();
