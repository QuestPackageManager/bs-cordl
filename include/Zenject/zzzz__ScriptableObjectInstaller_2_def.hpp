...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScriptableObjectInstaller_2(ScriptableObjectInstaller_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScriptableObjectInstaller_2(ScriptableObjectInstaller_2const&) = delete;
