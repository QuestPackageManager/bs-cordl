...
public:
  ...
  /// @brief Method .ctor, addr 0x4afb2a0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* signalType);

  /// @brief Method get_Identifier, addr 0x4afb2c8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Identifier();

  /// @brief Method get_SignalType, addr 0x4afb2d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_SignalType();

  /// @brief Method set_Identifier, addr 0x4afb2d0, size 0x8, virtual false, abstract: false, final false
  inline void set_Identifier(::System::Object* value);

  /// @brief Method set_SignalType, addr 0x4afb2e0, size 0x8, virtual false, abstract: false, final false
