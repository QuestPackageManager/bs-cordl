...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IDisposable*>)
constexpr ::Zenject::IMemoryPool_1<T>* const& Zenject::PoolWrapperFactory_1<T>::__cordl_internal_get__pool() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____pool;
}
template <typename T>
...
template <typename T>
  requires(::cordl_internals::type_constraint<T, ::System::IDisposable*>)
inline ::System::Object* Zenject::PoolWrapperFactory_1<T>::__zenCreate(::ArrayW<::System::Object*> P_0) {
  static auto* ___internal_method =
