...
public:
  ...
  /// @brief Method Dispose, addr 0x369ea60, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method Start, addr 0x369ea40, size 0x8, virtual false, abstract: false, final false
  static inline ::Zenject::ProfileBlock* Start();

  /// @brief Method Start, addr 0x369ea58, size 0x8, virtual false, abstract: false, final false
  static inline ::Zenject::ProfileBlock* Start(::StringW sampleName);

  /// @brief Method Start, addr 0x369ea50, size 0x8, virtual false, abstract: false, final false
  static inline ::Zenject::ProfileBlock* Start(::StringW sampleNameFormat, ::System::Object* obj);

  /// @brief Method Start, addr 0x369ea48, size 0x8, virtual false, abstract: false, final false
  static inline ::Zenject::ProfileBlock* Start(::StringW sampleNameFormat, ::System::Object* obj1, ::System::Object* obj2);

  /// @brief Method .ctor, addr 0x369e9a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW sampleName);

  /// @brief Method .ctor, addr 0x369e99c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ProfilePattern, addr 0x369e9ac, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method set_ProfilePattern, addr 0x369e9f4, size 0x4c, virtual false, abstract: false, final false
