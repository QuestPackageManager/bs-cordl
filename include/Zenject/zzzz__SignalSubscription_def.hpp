...
// Write type traits
MARK_REF_T(::Zenject::SignalSubscription*);
MARK_REF_T(::Zenject::SignalSubscription_Pool*);
DEFINE_IL2CPP_CLASS(::Zenject::SignalSubscription*, "Zenject", "SignalSubscription");
DEFINE_IL2CPP_CLASS(::Zenject::SignalSubscription_Pool*, "Zenject", "SignalSubscription/Pool");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignalSubscription_Pool", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignalSubscription_Pool(SignalSubscription_Pool&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignalSubscription_Pool", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignalSubscription_Pool(SignalSubscription_Poolconst&) = delete;
...
static_assert(sizeof(::Zenject::SignalSubscription_Pool) == 0x38, "Size mismatch!");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SignalSubscription", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SignalSubscription(SignalSubscription&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SignalSubscription", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SignalSubscription(SignalSubscriptionconst&) = delete;
...
static_assert(sizeof(::Zenject::SignalSubscription) == 0x38, "Size mismatch!");
