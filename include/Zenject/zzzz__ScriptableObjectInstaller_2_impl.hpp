...
inline TDerived Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>::InstallFromResource(::Zenject::DiContainer*  container, TParam1  p1)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>*>::get(),
                        "InstallFromResource",
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "InstallFromResource",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 3>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::DiContainer*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<TParam1>::get()}
                    )));
return ::cordl_internals::RunMethodRethrow<TDerived, false>(nullptr, ___internal_method, resourcePath, container, p1);
}
template<typename TParam1,typename TDerived>
inline void Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TParam1,typename TDerived>
inline ::Zenject::InjectTypeInfo* Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>*>::get(),
...
template<typename TParam1,typename TDerived>
inline ::Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>* Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>*>());
}
// Ctor Parameters []
template<typename TParam1,typename TDerived>
constexpr ::Zenject::ScriptableObjectInstaller_2<TParam1,TDerived>::ScriptableObjectInstaller_2()   {
}
