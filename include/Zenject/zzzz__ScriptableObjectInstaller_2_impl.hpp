...
template <typename TParam1, typename TDerived> inline TDerived Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>::InstallFromResource(::Zenject::DiContainer* container, TParam1 p1) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>*>(),
...
inline TDerived Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>::InstallFromResource(::StringW resourcePath, ::Zenject::DiContainer* container, TParam1 p1) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>*>(),
...
template <typename TParam1, typename TDerived> inline void Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename TParam1, typename TDerived> inline ::System::Object* Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>::__zenCreate(::ArrayW<::System::Object*> P_0) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>*>(), { "__zenCreate", {}, { ::i2c::type_of<::ArrayW<::System::Object*>>() } })));
...
template <typename TParam1, typename TDerived> inline ::Zenject::InjectTypeInfo* Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>::__zenCreateInjectTypeInfo() {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>*>(), { "__zenCreateInjectTypeInfo", {}, {} })));
...
template <typename TParam1, typename TDerived> inline ::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>* Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::ScriptableObjectInstaller_2<TParam1, TDerived>*>());
}
// Ctor Parameters []
