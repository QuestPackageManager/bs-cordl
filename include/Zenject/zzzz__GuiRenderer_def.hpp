...
public:
  ...
  /// @brief Method Construct, addr 0x345eeb8, size 0x8, virtual false, abstract: false, final false
  inline void Construct(::Zenject::GuiRenderableManager* renderableManager);

  static inline ::Zenject::GuiRenderer* New_ctor();

  /// @brief Method OnGUI, addr 0x345eec0, size 0x18, virtual false, abstract: false, final false
  inline void OnGUI();
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x345efbc, size 0x2f8, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenInjectMethod0, addr 0x345eee0, size 0xdc, virtual false, abstract: false, final false
  static inline void __zenInjectMethod0(::System::Object* P_0, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_1);

  /// @brief Method .ctor, addr 0x345eed8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
