...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DecoratorProvider_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DecoratorProvider_1(DecoratorProvider_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DecoratorProvider_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DecoratorProvider_1(DecoratorProvider_1const&) = delete;
