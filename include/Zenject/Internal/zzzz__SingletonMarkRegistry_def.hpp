...
public:
  ...
  /// @brief Method MarkNonSingleton, addr 0x4b514f8, size 0xac, virtual false, abstract: false, final false
  inline void MarkNonSingleton(::System::Type* type);

  /// @brief Method MarkSingleton, addr 0x4b515a4, size 0xd4, virtual false, abstract: false, final false
  inline void MarkSingleton(::System::Type* type);

  static inline ::Zenject::Internal::SingletonMarkRegistry* New_ctor();

  /// @brief Method Unmark, addr 0x4b51678, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b516e4, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();
