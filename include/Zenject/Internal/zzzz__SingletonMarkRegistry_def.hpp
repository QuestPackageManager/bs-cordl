...
public:
  ...
  /// @brief Method MarkNonSingleton addr 0x2f214b0 size 0xac virtual false final false
  inline void MarkNonSingleton(::System::Type* type);

  /// @brief Method MarkSingleton addr 0x2f2155c size 0xd4 virtual false final false
  inline void MarkSingleton(::System::Type* type);

  /// @brief Method Unmark addr 0x2f21630 size 0x6c virtual false final false
  inline void Unmark(::System::Type* type);

  static inline ::Zenject::Internal::SingletonMarkRegistry* New_ctor();

  /// @brief Method .ctor addr 0x2f2169c size 0xa0 virtual false final false
  inline void _ctor();
