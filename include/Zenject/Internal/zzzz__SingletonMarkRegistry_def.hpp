...
public:
  ...
  /// @brief Method MarkNonSingleton addr 0x2db96e0 size 0xac virtual false final false
  inline void MarkNonSingleton(::System::Type* type);

  /// @brief Method MarkSingleton addr 0x2db978c size 0xd4 virtual false final false
  inline void MarkSingleton(::System::Type* type);

  static inline ::Zenject::Internal::SingletonMarkRegistry* New_ctor();

  /// @brief Method .ctor addr 0x2db9860 size 0xa0 virtual false final false
  inline void _ctor();
