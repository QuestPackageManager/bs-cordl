...
/// @brief Method MarkNonSingleton, addr 0x6cd3b00, size 0xcc, virtual false, abstract: false, final false
inline void MarkNonSingleton(::System::Type*  type) ;

/// @brief Method MarkSingleton, addr 0x6cd3bcc, size 0xf8, virtual false, abstract: false, final false
inline void MarkSingleton(::System::Type*  type) ;

static inline ::Zenject::Internal::SingletonMarkRegistry* New_ctor() ;

/// @brief Method Unmark, addr 0x6cd3cc4, size 0x78, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cd3d3c, size 0x94, virtual false, abstract: false, final false
inline void _ctor() ;
