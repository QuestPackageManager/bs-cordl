...
public:
  ...
  /// @brief Method MarkNonSingleton, addr 0x346d524, size 0xac, virtual false, abstract: false, final false
  inline void MarkNonSingleton(::System::Type* type);

  /// @brief Method MarkSingleton, addr 0x346d5d0, size 0xd4, virtual false, abstract: false, final false
  inline void MarkSingleton(::System::Type* type);

  static inline ::Zenject::Internal::SingletonMarkRegistry* New_ctor();

  /// @brief Method Unmark, addr 0x346d6a4, size 0x6c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346d710, size 0xa0, virtual false, abstract: false, final false
  inline void _ctor();
