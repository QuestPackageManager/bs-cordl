...
public:
  ...
  /// @brief Method <GetAllSceneContexts>b__3_0, addr 0x6cd98d8, size 0x54, virtual false, abstract: false, final false
  ...
  /// @brief Method <GetRootGameObjects>b__10_0, addr 0x6cd992c, size 0x94, virtual false, abstract: false, final false
  inline bool _GetRootGameObjects_b__10_0(::UnityEngine::GameObject* x);

  /// @brief Method __zenCreate, addr 0x6cd99c0, size 0x44, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6cd9a04, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6cd98d4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <GetRootGameObjects>b__1, addr 0x6cd9b98, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cd987c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x6cd9cbc, size 0x48c, virtual true, abstract: false, final true
  inline bool MoveNext();

  static inline ::Zenject::Internal::ZenUtilInternal__GetAllSceneContexts_d__3* New_ctor(int32_t __1__state);

  /// @brief Method System.Collections.Generic.IEnumerable<Zenject.SceneContext>.GetEnumerator, addr 0x6cda244, size 0x8c, virtual true, abstract: false, final true
  ...
  /// @brief Method System.Collections.Generic.IEnumerator<Zenject.SceneContext>.get_Current, addr 0x6cda1fc, size 0x8, virtual true, abstract: false, final true
  inline ::UnityW<::Zenject::SceneContext> System_Collections_Generic_IEnumerator_Zenject_SceneContext__get_Current();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x6cda2d0, size 0x4, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x6cda204, size 0x38, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x6cda23c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.IDisposable.Dispose, addr 0x6cd9ca0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method <>m__Finally1, addr 0x6cda148, size 0xb4, virtual false, abstract: false, final false
  inline void __m__Finally1();

  /// @brief Method .ctor, addr 0x6cd8acc, size 0x20, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method AddStateMachineBehaviourAutoInjectersInScene, addr 0x6cd8aec, size 0x2fc, virtual false, abstract: false, final false
  static inline void AddStateMachineBehaviourAutoInjectersInScene(::UnityEngine::SceneManagement::Scene scene);

  /// @brief Method AddStateMachineBehaviourAutoInjectersUnderGameObject, addr 0x6cd8fd0, size 0x158, virtual false, abstract: false, final false
  static inline void AddStateMachineBehaviourAutoInjectersUnderGameObject(::UnityEngine::GameObject* root);

  /// @brief Method AreFunctionsEqual, addr 0x6cd8870, size 0xe0, virtual false, abstract: false, final false
  static inline bool AreFunctionsEqual(::System::Delegate* left, ::System::Delegate* right);

  /// @brief Method GetAllSceneContexts, addr 0x6cd8a64, size 0x68, virtual false, abstract: false, final false
  static inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::SceneContext>>* GetAllSceneContexts();

  /// @brief Method GetInheritanceDelta, addr 0x6cd8950, size 0x114, virtual false, abstract: false, final false
  static inline int32_t GetInheritanceDelta(::System::Type* derived, ::System::Type* parent);

  /// @brief Method GetInjectableMonoBehavioursInScene, addr 0x6cd9128, size 0x304, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInjectableMonoBehavioursUnderGameObject, addr 0x6cd979c, size 0x4, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInjectableMonoBehavioursUnderGameObjectInternal, addr 0x6cd942c, size 0x370, virtual false, abstract: false, final false
  static inline void GetInjectableMonoBehavioursUnderGameObjectInternal(::UnityEngine::GameObject* gameObject,
                                                                        ::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MonoBehaviour>>* injectableComponents);

  /// @brief Method GetRootGameObjects, addr 0x6cd8de8, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method IsInjectableMonoBehaviourType, addr 0x6cd97a0, size 0xdc, virtual false, abstract: false, final false
  static inline bool IsInjectableMonoBehaviourType(::System::Type* type);

  /// @brief Method IsNull, addr 0x6cd8854, size 0x1c, virtual false, abstract: false, final false
