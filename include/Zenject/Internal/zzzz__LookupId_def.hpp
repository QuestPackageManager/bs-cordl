...
public:
  ...
  /// @brief Method GetHashCode, addr 0x4b57128, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b57084, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4b5708c, size 0x9c, virtual false, abstract: false, final false
