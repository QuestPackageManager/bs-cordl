...
public:
  ...
  /// @brief Method GetHashCode, addr 0x6d45cf4, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d45c5c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6d45c60, size 0x94, virtual false, abstract: false, final false
