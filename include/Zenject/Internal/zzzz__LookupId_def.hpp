...
public:
  ...
  /// @brief Method GetHashCode, addr 0x6e9c878, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e9c7e0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x6e9c7e4, size 0x94, virtual false, abstract: false, final false
