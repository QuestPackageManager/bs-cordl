...
public:
  ...
  /// @brief Method GetHashCode, addr 0x346d4d4, size 0x50, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x346d430, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x346d438, size 0x9c, virtual false, abstract: false, final false
