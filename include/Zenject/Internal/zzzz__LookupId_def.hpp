...
/// @brief Method GetHashCode, addr 0x6cd3ab0, size 0x50, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cd3a18, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x6cd3a1c, size 0x94, virtual false, abstract: false, final false
