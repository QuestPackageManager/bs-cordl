...
/// @brief Method .ctor, addr 0x6cd5748, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cd5750, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cd5758, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field Parameters, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_Parameters, put=__cordl_internal_set_Parameters)) ::System::Collections::Generic::List_1<::Zenject::Internal::ReflectionTypeInfo_InjectParameterInfo*>*  Parameters;

static inline ::Zenject::Internal::ReflectionTypeInfo_InjectMethodInfo* New_ctor(::System::Reflection::MethodInfo*  methodInfo, ::System::Collections::Generic::List_1<::Zenject::Internal::ReflectionTypeInfo_InjectParameterInfo*>*  parameters) ;
...
/// @brief Method .ctor, addr 0x6cd5760, size 0x8, virtual false, abstract: false, final false
...
static inline ::Zenject::Internal::ReflectionTypeInfo_InjectConstructorInfo* New_ctor(::System::Reflection::ConstructorInfo*  constructorInfo, ::System::Collections::Generic::List_1<::Zenject::Internal::ReflectionTypeInfo_InjectParameterInfo*>*  parameters) ;
...
/// @brief Method .ctor, addr 0x6cd5768, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field InjectFields, offset 0x28, size 0x8 
 __declspec(property(get=__cordl_internal_get_InjectFields, put=__cordl_internal_set_InjectFields)) ::System::Collections::Generic::List_1<::Zenject::Internal::ReflectionTypeInfo_InjectFieldInfo*>*  InjectFields;

/// @brief Field InjectMethods, offset 0x38, size 0x8 
 __declspec(property(get=__cordl_internal_get_InjectMethods, put=__cordl_internal_set_InjectMethods)) ::System::Collections::Generic::List_1<::Zenject::Internal::ReflectionTypeInfo_InjectMethodInfo*>*  InjectMethods;

/// @brief Field InjectProperties, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_InjectProperties, put=__cordl_internal_set_InjectProperties)) ::System::Collections::Generic::List_1<::Zenject::Internal::ReflectionTypeInfo_InjectPropertyInfo*>*  InjectProperties;
...
/// @brief Method .ctor, addr 0x6cd5738, size 0x10, virtual false, abstract: false, final false
