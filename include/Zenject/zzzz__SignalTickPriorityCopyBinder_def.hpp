...
public:
  ...
  /// @brief Method WithTickPriority, addr 0x4b07e6c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b0790c, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::SignalDeclarationBindInfo* signalBindInfo);

  /// @brief Method get_SignalBindInfo, addr 0x4b07e5c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SignalDeclarationBindInfo* get_SignalBindInfo();

  /// @brief Method set_SignalBindInfo, addr 0x4b07e64, size 0x8, virtual false, abstract: false, final false
