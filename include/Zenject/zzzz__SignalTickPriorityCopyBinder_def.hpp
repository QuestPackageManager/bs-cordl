...
public:
  ...
  /// @brief Method WithTickPriority, addr 0x6cecef4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cec9f0, size 0x24, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::SignalDeclarationBindInfo* signalBindInfo);

  /// @brief Method get_SignalBindInfo, addr 0x6cecee4, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SignalDeclarationBindInfo* get_SignalBindInfo();

  /// @brief Method set_SignalBindInfo, addr 0x6ceceec, size 0x8, virtual false, abstract: false, final false
