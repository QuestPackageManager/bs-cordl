...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyedFactory_2(KeyedFactory_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyedFactory_2(KeyedFactory_2const&) = delete;
