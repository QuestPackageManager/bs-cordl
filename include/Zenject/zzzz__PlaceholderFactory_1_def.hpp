...
namespace Zenject {
template <typename TValue> class PlaceholderFactory_1__get_ParamTypes_d__2;
}
// Forward declare root types
namespace Zenject {
template <typename TValue> class PlaceholderFactory_1;
}
namespace Zenject {
template <typename TValue> class PlaceholderFactory_1__get_ParamTypes_d__2;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_1);
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_1__get_ParamTypes_d__2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_1, "Zenject", "PlaceholderFactory`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_1__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`1/<get_ParamTypes>d__2");
// [CompilerGenerated]
...
// Is value type: false
// CS Name: Zenject.PlaceholderFactory`1/<get_ParamTypes>d__2<TValue>
class CORDL_TYPE PlaceholderFactory_1__get_ParamTypes_d__2 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::PlaceholderFactory_1__get_ParamTypes_d__2<TValue>* New_ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_1__get_ParamTypes_d__2();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_1__get_ParamTypes_d__2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_1__get_ParamTypes_d__2(PlaceholderFactory_1__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_1__get_ParamTypes_d__2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_1__get_ParamTypes_d__2(PlaceholderFactory_1__get_ParamTypes_d__2const&) = delete;
...
public:
  // Declarations
  using _get_ParamTypes_d__2 = ::Zenject::PlaceholderFactory_1__get_ParamTypes_d__2<TValue>;
  ...
  static inline ::Zenject::PlaceholderFactory_1<TValue>* New_ctor();
  ...
  /// [IteratorStateMachine(typeof(Zenject.PlaceholderFactory`1::<get_ParamTypes>d__2<TValue>))]
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_1(PlaceholderFactory_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_1(PlaceholderFactory_1const&) = delete;
