...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::ScriptableObjectInstaller_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ScriptableObjectInstaller_4, "Zenject", "ScriptableObjectInstaller`4");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScriptableObjectInstaller_4(ScriptableObjectInstaller_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScriptableObjectInstaller_4(ScriptableObjectInstaller_4const&) = delete;
