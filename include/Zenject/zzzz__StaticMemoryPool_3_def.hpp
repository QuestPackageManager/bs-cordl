...
// Dependencies Zenject.IDespawnableMemoryPool`1<TValue>, Zenject.IMemoryPool, Zenject.IMemoryPool`3<TParam1, TParam2, TValue>, Zenject.StaticMemoryPoolBase`1<TValue>
namespace Zenject {
// cpp template
