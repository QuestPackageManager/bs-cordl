...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::StaticMemoryPool_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::StaticMemoryPool_3, "Zenject", "StaticMemoryPool`3");
// [NoReflectionBaking]
...
public:
  ...
  constexpr ::System::Action_3<TParam1, TParam2, TValue>* const& __cordl_internal_get__onSpawnMethod() const;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StaticMemoryPool_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StaticMemoryPool_3(StaticMemoryPool_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StaticMemoryPool_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StaticMemoryPool_3(StaticMemoryPool_3const&) = delete;
