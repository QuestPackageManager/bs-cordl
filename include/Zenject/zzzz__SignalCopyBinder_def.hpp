...
public:
  ...
  /// @brief Method .ctor, addr 0x2ede610, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Zenject::SignalCopyBinder* New_ctor(::Zenject::BindInfo* bindInfo);

  /// @brief Method .ctor, addr 0x2ede690, size 0xf8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::BindInfo* bindInfo);

  /// @brief Method AddCopyBindInfo, addr 0x2ede788, size 0xa8, virtual false, abstract: false, final false
  inline void AddCopyBindInfo(::Zenject::BindInfo* bindInfo);

  /// @brief Method CopyIntoAllSubContainers, addr 0x2ede830, size 0x8, virtual false, abstract: false, final false
  inline void CopyIntoAllSubContainers();

  /// @brief Method CopyIntoDirectSubContainers, addr 0x2ede8cc, size 0x8, virtual false, abstract: false, final false
  inline void CopyIntoDirectSubContainers();

  /// @brief Method MoveIntoAllSubContainers, addr 0x2ede8d4, size 0x8, virtual false, abstract: false, final false
  inline void MoveIntoAllSubContainers();

  /// @brief Method MoveIntoDirectSubContainers, addr 0x2ede8dc, size 0x8, virtual false, abstract: false, final false
  inline void MoveIntoDirectSubContainers();

  /// @brief Method SetInheritanceMethod, addr 0x2ede838, size 0x94, virtual false, abstract: false, final false
