...
public:
  ...
  /// @brief Method AddCopyBindInfo, addr 0x4b07c64, size 0xa4, virtual false, abstract: false, final false
  inline void AddCopyBindInfo(::Zenject::BindInfo* bindInfo);

  /// @brief Method CopyIntoAllSubContainers, addr 0x4b07d08, size 0x8, virtual false, abstract: false, final false
  inline void CopyIntoAllSubContainers();

  /// @brief Method CopyIntoDirectSubContainers, addr 0x4b07da4, size 0x8, virtual false, abstract: false, final false
  inline void CopyIntoDirectSubContainers();

  /// @brief Method MoveIntoAllSubContainers, addr 0x4b07dac, size 0x8, virtual false, abstract: false, final false
  inline void MoveIntoAllSubContainers();

  /// @brief Method MoveIntoDirectSubContainers, addr 0x4b07db4, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method SetInheritanceMethod, addr 0x4b07d10, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b07af0, size 0x80, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4b07b70, size 0xf4, virtual false, abstract: false, final false
