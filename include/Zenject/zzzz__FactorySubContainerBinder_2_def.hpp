...
public:
  ...
  __declspec(property(get = __get___4__this, put = __set___4__this))::Zenject::FactorySubContainerBinder_2<TParam1, TContract>* __4__this;
  ...
  __declspec(property(get = __get_installerMethod, put = __set_installerMethod))::System::Action_2<::Zenject::DiContainer*, TParam1>* installerMethod;

  constexpr ::Zenject::FactorySubContainerBinder_2<TParam1, TContract>*& __get___4__this();

  constexpr ::cordl_internals::to_const_pointer<::Zenject::FactorySubContainerBinder_2<TParam1, TContract>*> const& __get___4__this() const;
  ...
  constexpr ::System::Action_2<::Zenject::DiContainer*, TParam1>*& __get_installerMethod();

  constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::Zenject::DiContainer*, TParam1>*> const& __get_installerMethod() const;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(10791))
...
template <typename TParam1, typename TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10830)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10830), inst: 1857 })}
