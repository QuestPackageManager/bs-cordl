...
namespace Zenject {
template <typename TParam1, typename TContract> class FactorySubContainerBinder_2___c__DisplayClass1_0;
}
namespace Zenject {
template <typename TParam1, typename TContract> class FactorySubContainerBinder_2___c__DisplayClass2_0;
}
namespace Zenject {
template <typename TParam1, typename TContract> class FactorySubContainerBinder_2___c__DisplayClass3_0;
}
namespace Zenject {
template <typename TParam1, typename TContract> class FactorySubContainerBinder_2___c__DisplayClass4_0;
}
namespace Zenject {
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_2);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass1_0);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass2_0);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass3_0);
MARK_GEN_REF_T_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass4_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_2, "Zenject", "FactorySubContainerBinder`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass1_0, "Zenject", "FactorySubContainerBinder`2/<>c__DisplayClass1_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass2_0, "Zenject", "FactorySubContainerBinder`2/<>c__DisplayClass2_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass3_0, "Zenject", "FactorySubContainerBinder`2/<>c__DisplayClass3_0");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactorySubContainerBinder_2___c__DisplayClass4_0, "Zenject", "FactorySubContainerBinder`2/<>c__DisplayClass4_0");
// [CompilerGenerated]
...
// Is value type: false
// CS Name: Zenject.FactorySubContainerBinder`2/<>c__DisplayClass1_0<TParam1,TContract>
class CORDL_TYPE FactorySubContainerBinder_2___c__DisplayClass1_0 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::FactorySubContainerBinder_2___c__DisplayClass1_0<TParam1, TContract>* New_ctor();
  ...
  constexpr ::Zenject::FactorySubContainerBinder_2<TParam1, TContract>* const& __cordl_internal_get___4__this() const;

  constexpr ::Zenject::FactorySubContainerBinder_2<TParam1, TContract>*& __cordl_internal_get___4__this();

  constexpr ::System::Action_2<::Zenject::DiContainer*, TParam1>* const& __cordl_internal_get_installerMethod() const;
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactorySubContainerBinder_2___c__DisplayClass1_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass1_0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactorySubContainerBinder_2___c__DisplayClass1_0(FactorySubContainerBinder_2___c__DisplayClass1_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass1_0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactorySubContainerBinder_2___c__DisplayClass1_0(FactorySubContainerBinder_2___c__DisplayClass1_0const&) = delete;
...
template <typename TParam1, typename TContract>
// Is value type: false
// CS Name: Zenject.FactorySubContainerBinder`2/<>c__DisplayClass2_0<TParam1,TContract>
class CORDL_TYPE FactorySubContainerBinder_2___c__DisplayClass2_0 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>4__this, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this)) ::Zenject::FactorySubContainerBinder_2<TParam1, TContract>* __4__this;
  ...
  static inline ::Zenject::FactorySubContainerBinder_2___c__DisplayClass2_0<TParam1, TContract>* New_ctor();
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactorySubContainerBinder_2___c__DisplayClass2_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass2_0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactorySubContainerBinder_2___c__DisplayClass2_0(FactorySubContainerBinder_2___c__DisplayClass2_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass2_0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactorySubContainerBinder_2___c__DisplayClass2_0(FactorySubContainerBinder_2___c__DisplayClass2_0const&) = delete;
...
template <typename TParam1, typename TContract>
// Is value type: false
// CS Name: Zenject.FactorySubContainerBinder`2/<>c__DisplayClass3_0<TParam1,TContract>
class CORDL_TYPE FactorySubContainerBinder_2___c__DisplayClass3_0 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>4__this, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this)) ::Zenject::FactorySubContainerBinder_2<TParam1, TContract>* __4__this;
  ...
  static inline ::Zenject::FactorySubContainerBinder_2___c__DisplayClass3_0<TParam1, TContract>* New_ctor();
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactorySubContainerBinder_2___c__DisplayClass3_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass3_0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactorySubContainerBinder_2___c__DisplayClass3_0(FactorySubContainerBinder_2___c__DisplayClass3_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass3_0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactorySubContainerBinder_2___c__DisplayClass3_0(FactorySubContainerBinder_2___c__DisplayClass3_0const&) = delete;
...
template <typename TParam1, typename TContract>
// Is value type: false
// CS Name: Zenject.FactorySubContainerBinder`2/<>c__DisplayClass4_0<TParam1,TContract>
class CORDL_TYPE FactorySubContainerBinder_2___c__DisplayClass4_0 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>4__this, offset 0x10, size 0x8
  __declspec(property(get = __cordl_internal_get___4__this, put = __cordl_internal_set___4__this)) ::Zenject::FactorySubContainerBinder_2<TParam1, TContract>* __4__this;
  ...
  static inline ::Zenject::FactorySubContainerBinder_2___c__DisplayClass4_0<TParam1, TContract>* New_ctor();
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactorySubContainerBinder_2___c__DisplayClass4_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass4_0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactorySubContainerBinder_2___c__DisplayClass4_0(FactorySubContainerBinder_2___c__DisplayClass4_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2___c__DisplayClass4_0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactorySubContainerBinder_2___c__DisplayClass4_0(FactorySubContainerBinder_2___c__DisplayClass4_0const&) = delete;
...
public:
  // Declarations
  using __c__DisplayClass1_0 = ::Zenject::FactorySubContainerBinder_2___c__DisplayClass1_0<TParam1, TContract>;

  using __c__DisplayClass2_0 = ::Zenject::FactorySubContainerBinder_2___c__DisplayClass2_0<TParam1, TContract>;

  using __c__DisplayClass3_0 = ::Zenject::FactorySubContainerBinder_2___c__DisplayClass3_0<TParam1, TContract>;

  using __c__DisplayClass4_0 = ::Zenject::FactorySubContainerBinder_2___c__DisplayClass4_0<TParam1, TContract>;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactorySubContainerBinder_2(FactorySubContainerBinder_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactorySubContainerBinder_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactorySubContainerBinder_2(FactorySubContainerBinder_2const&) = delete;
