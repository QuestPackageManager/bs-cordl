...
template <typename TParam1, typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Func_3<::Zenject::DiContainer*, TParam1, TValue>*> const&
Zenject::MethodProviderWithContainer_2<TParam1, TValue>::__cordl_internal_get__method() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____method;
}
template <typename TParam1, typename TValue>
