...
// Write type traits
MARK_REF_T(::Zenject::MethodMultipleProviderUntyped*);
DEFINE_IL2CPP_CLASS(::Zenject::MethodMultipleProviderUntyped*, "Zenject", "MethodMultipleProviderUntyped");
// [NoReflectionBaking]
...
public:
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x6e87a38, size 0x534, virtual true, abstract: false, final true
  ...
  /// @brief Method GetInstanceType, addr 0x6e87a24, size 0x14, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e87a0c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsCached, addr 0x6e87a14, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6e87a1c, size 0x8, virtual true, abstract: false, final true
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodMultipleProviderUntyped", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodMultipleProviderUntyped(MethodMultipleProviderUntyped&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodMultipleProviderUntyped", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodMultipleProviderUntyped(MethodMultipleProviderUntypedconst&) = delete;
...
static_assert(sizeof(::Zenject::MethodMultipleProviderUntyped) == 0x20, "Size mismatch!");
