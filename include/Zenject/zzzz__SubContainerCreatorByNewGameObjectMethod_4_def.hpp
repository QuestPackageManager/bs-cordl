...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorByNewGameObjectMethod_4<TParam1, TParam2, TParam3, TParam4>*> const& __cordl_internal_get___4__this() const;
