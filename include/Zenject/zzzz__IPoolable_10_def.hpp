...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IPoolable_10);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IPoolable_10, "Zenject", "IPoolable`10");
// Dependencies
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TParam6, typename TParam7, typename TParam8, typename TParam9, typename TParam10>
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPoolable_10", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPoolable_10(IPoolable_10const&) = delete;
