...
public:
  ...
  /// @brief Method IfNotBound, addr 0x365b338, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365b300, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::BindInfo* bindInfo);

  /// @brief Method get_BindInfo, addr 0x365b328, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::BindInfo* get_BindInfo();

  /// @brief Method set_BindInfo, addr 0x365b330, size 0x8, virtual false, abstract: false, final false
