...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MemoryPool_8);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MemoryPool_8, "Zenject", "MemoryPool`8");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_8", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_8(MemoryPool_8&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_8", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_8(MemoryPool_8const&) = delete;
