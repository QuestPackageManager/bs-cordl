...
public:
  ...
  /// @brief Method Awake, addr 0x6cd1b10, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Construct, addr 0x6cd1ad0, size 0x40, virtual false, abstract: false, final false
  inline void Construct();

  /// @brief Method GetContainerForCurrentScene, addr 0x6cd1c9c, size 0x94, virtual false, abstract: false, final false
  inline ::Zenject::DiContainer* GetContainerForCurrentScene();

  /// @brief Method LookupContainer, addr 0x6cd1b58, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6cd1dc0, size 0x22c, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenInjectMethod0, addr 0x6cd1d3c, size 0x84, virtual false, abstract: false, final false
  static inline void __zenInjectMethod0(::System::Object* P_0, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_1);

  /// @brief Method .ctor, addr 0x6cd1d30, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ContainerSource, addr 0x6cd1ac0, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ZenAutoInjecter_ContainerSources get_ContainerSource();

  /// @brief Method set_ContainerSource, addr 0x6cd1ac8, size 0x8, virtual false, abstract: false, final false
