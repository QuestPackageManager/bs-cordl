...
public:
  ...
  /// @brief Method Awake, addr 0x4b53060, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Construct, addr 0x4b5301c, size 0x44, virtual false, abstract: false, final false
  inline void Construct();

  /// @brief Method GetContainerForCurrentScene, addr 0x4b53200, size 0x90, virtual false, abstract: false, final false
  inline ::Zenject::DiContainer* GetContainerForCurrentScene();

  /// @brief Method LookupContainer, addr 0x4b530a8, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x4b53320, size 0x250, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenInjectMethod0, addr 0x4b532a0, size 0x80, virtual false, abstract: false, final false
  static inline void __zenInjectMethod0(::System::Object* P_0, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_1);

  /// @brief Method .ctor, addr 0x4b53290, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ContainerSource, addr 0x4b5300c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ZenAutoInjecter_ContainerSources get_ContainerSource();

  /// @brief Method set_ContainerSource, addr 0x4b53014, size 0x8, virtual false, abstract: false, final false
