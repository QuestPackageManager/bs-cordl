...
public:
  ...
  /// @brief Method Awake, addr 0x3086d68, size 0x48, virtual false, abstract: false, final false
  inline void Awake();

  /// @brief Method Construct, addr 0x3086d24, size 0x44, virtual false, abstract: false, final false
  inline void Construct();

  /// @brief Method GetContainerForCurrentScene, addr 0x3086f08, size 0x90, virtual false, abstract: false, final false
  inline ::Zenject::DiContainer* GetContainerForCurrentScene();

  /// @brief Method LookupContainer, addr 0x3086db0, size 0x158, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x3087028, size 0x254, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method __zenInjectMethod0, addr 0x3086fa8, size 0x80, virtual false, abstract: false, final false
  static inline void __zenInjectMethod0(::System::Object* P_0, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_1);

  /// @brief Method .ctor, addr 0x3086f98, size 0x10, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_ContainerSource, addr 0x3086d14, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::__ZenAutoInjecter__ContainerSources get_ContainerSource();

  /// @brief Method set_ContainerSource, addr 0x3086d1c, size 0x8, virtual false, abstract: false, final false
