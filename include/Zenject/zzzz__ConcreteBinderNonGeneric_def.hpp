...
public:
  ...
  /// @brief Method To, addr 0x2fd667c, size 0x4, virtual false, abstract: false, final false
  inline ::Zenject::FromBinderNonGeneric* To(::ArrayW<::System::Type*, ::Array<::System::Type*>*> concreteTypes);

  /// @brief Method To, addr 0x2fd6680, size 0x10c, virtual false, abstract: false, final false
  inline ::Zenject::FromBinderNonGeneric* To(::System::Collections::Generic::IEnumerable_1<::System::Type*>* concreteTypes);

  /// @brief Method To, addr 0x2fd678c, size 0x144, virtual false, abstract: false, final false
  inline ::Zenject::FromBinderNonGeneric* To(::System::Action_1<::Zenject::ConventionSelectTypesBinder*>* generator);

  /// @brief Method ToSelf, addr 0x2fd653c, size 0x124, virtual false, abstract: false, final false
  inline ::Zenject::FromBinderNonGeneric* ToSelf();

  /// @brief Method <ToSelf>b__1_0, addr 0x2fd6b68, size 0xa4, virtual false, abstract: false, final false
  inline ::Zenject::IProvider* _ToSelf_b__1_0(::Zenject::DiContainer* container, ::System::Type* type);

  /// @brief Method .ctor, addr 0x2fd64d8, size 0x34, virtual false, abstract: false, final false
