...
public:
  ...
  /// @brief Method WithId, addr 0x365a2b8, size 0x101c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x365a290, size 0x28, virtual false, abstract: false, final false
