...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IFactoryProvider_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IFactoryProvider_2(IFactoryProvider_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IFactoryProvider_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFactoryProvider_2(IFactoryProvider_2const&) = delete;
