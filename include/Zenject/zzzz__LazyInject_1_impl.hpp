...
template <typename T> inline void Zenject::LazyInject_1<T>::_ctor(::Zenject::DiContainer* container, ::Zenject::InjectContext* context) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{},
                   (::i2c::find_method(::i2c::class_of<::Zenject::LazyInject_1<T>*>(), { ".ctor", {}, { ::i2c::type_of<::Zenject::DiContainer*>(), ::i2c::type_of<::Zenject::InjectContext*>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, container, context);
}
template <typename T> inline void Zenject::LazyInject_1<T>::Zenject_IValidatable_Validate() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::LazyInject_1<T>*>(), { "Zenject.IValidatable.Validate", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename T> inline T Zenject::LazyInject_1<T>::get_Value() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::LazyInject_1<T>*>(), { "get_Value", {}, {} })));
...
template <typename T> inline ::Zenject::LazyInject_1<T>* Zenject::LazyInject_1<T>::New_ctor(::Zenject::DiContainer* container, ::Zenject::InjectContext* context) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::LazyInject_1<T>*>(container, context));
}
