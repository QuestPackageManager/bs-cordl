...
template<typename T>
constexpr ::Zenject::DiContainer* const& Zenject::LazyInject_1<T>::__cordl_internal_get__container() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename T>
...
template<typename T>
constexpr ::Zenject::InjectContext* const& Zenject::LazyInject_1<T>::__cordl_internal_get__context() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____context;
}
template<typename T>
