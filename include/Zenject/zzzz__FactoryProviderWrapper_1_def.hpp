...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactoryProviderWrapper_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryProviderWrapper_1, "Zenject", "FactoryProviderWrapper`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryProviderWrapper_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryProviderWrapper_1(FactoryProviderWrapper_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryProviderWrapper_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryProviderWrapper_1(FactoryProviderWrapper_1const&) = delete;
