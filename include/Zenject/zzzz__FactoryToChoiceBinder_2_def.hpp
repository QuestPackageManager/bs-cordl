...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactoryToChoiceBinder_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryToChoiceBinder_2, "Zenject", "FactoryToChoiceBinder`2");
// [NoReflectionBaking]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryToChoiceBinder_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryToChoiceBinder_2(FactoryToChoiceBinder_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryToChoiceBinder_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryToChoiceBinder_2(FactoryToChoiceBinder_2const&) = delete;
