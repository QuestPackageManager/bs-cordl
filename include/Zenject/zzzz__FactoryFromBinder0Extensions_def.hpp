...
namespace Zenject {
template<typename TContract>
class FactoryFromBinder0Extensions___c__DisplayClass6_0_1;
}
namespace Zenject {
template<typename TContract>
...
template<typename TContract>
using __c__DisplayClass6_0_1 = ::Zenject::FactoryFromBinder0Extensions___c__DisplayClass6_0_1<TContract>;
