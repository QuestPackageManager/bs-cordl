...
namespace Zenject {
template <typename TContract> class __FactoryFromBinder0Extensions____c__1_1;
}
namespace Zenject {
template <typename TContract> class __FactoryFromBinder0Extensions____c__DisplayClass6_0_1;
}
namespace Zenject {
...
namespace Zenject {
template <typename TContract, typename TMemoryPool> class __FactoryFromBinder0Extensions____c__5_2;
}
namespace Zenject {
template <typename TContract, typename TMemoryPool> class __FactoryFromBinder0Extensions____c__DisplayClass0_0_2;
}
namespace Zenject {
...
namespace Zenject {
template <typename TContract> class __FactoryFromBinder0Extensions____c__3_1;
}
namespace Zenject {
...
public:
  // Declarations
  template <typename TContract> using __c__DisplayClass6_0_1 = ::Zenject::__FactoryFromBinder0Extensions____c__DisplayClass6_0_1<TContract>;

  template <typename TContract, typename TMemoryPool> using __c__5_2 = ::Zenject::__FactoryFromBinder0Extensions____c__5_2<TContract, TMemoryPool>;

  template <typename TContract> using __c__3_1 = ::Zenject::__FactoryFromBinder0Extensions____c__3_1<TContract>;

  template <typename TContract> using __c__1_1 = ::Zenject::__FactoryFromBinder0Extensions____c__1_1<TContract>;

  template <typename TContract, typename TMemoryPool> using __c__DisplayClass0_0_2 = ::Zenject::__FactoryFromBinder0Extensions____c__DisplayClass0_0_2<TContract, TMemoryPool>;
