...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::Zenject::FactorySubContainerBinderWithParams_1<TContract>*> const& __get___4__this() const;
...
template <typename TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10755), inst: 1785 }), TypeDefinitionIndex(TypeDefinitionIndex(10755))}
