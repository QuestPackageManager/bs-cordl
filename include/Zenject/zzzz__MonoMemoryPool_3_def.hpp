#pragma once
// IWYU pragma private; include "Zenject/MonoMemoryPool_3.hpp"
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MonoMemoryPool_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MonoMemoryPool_3, "Zenject", "MonoMemoryPool`3");
// Dependencies UnityEngine.Component, Zenject.MemoryPool`3<TParam1, TParam2, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::UnityEngine::Component*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoMemoryPool_3(MonoMemoryPool_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoMemoryPool_3(MonoMemoryPool_3const&) = delete;
