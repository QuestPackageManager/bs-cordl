...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactoryBindingFinalizer_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactoryBindingFinalizer_1(PlaceholderFactoryBindingFinalizer_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactoryBindingFinalizer_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactoryBindingFinalizer_1(PlaceholderFactoryBindingFinalizer_1const&) = delete;
