...
/// @brief Method GetAllInstancesWithInjectSplit, addr 0x6cbd4d8, size 0x1e8, virtual true, abstract: false, final true
...
/// @brief Method GetInstanceType, addr 0x6cbd4d0, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6cbd4b4, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  resourcePath, ::System::Type*  resourceType, bool  matchSingle) ;

/// @brief Method get_IsCached, addr 0x6cbd4c0, size 0x8, virtual true, abstract: false, final true
inline bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6cbd4c8, size 0x8, virtual true, abstract: false, final true
