...
public:
  ...
  /// @brief Method .ctor addr 0x2da227c size 0x3c virtual false final false
  inline void _ctor(::StringW resourcePath, ::System::Type* resourceType, bool matchSingle);

  /// @brief Method get_IsCached addr 0x2da22b8 size 0x8 virtual true final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType addr 0x2da22c0 size 0x8 virtual true final true
  inline bool get_TypeVariesBasedOnMemberType();

  /// @brief Method GetInstanceType addr 0x2da22c8 size 0x8 virtual true final true
  inline ::System::Type* GetInstanceType(::Zenject::InjectContext* context);

  /// @brief Method GetAllInstancesWithInjectSplit addr 0x2da22d0 size 0x1d8 virtual true final true
