...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IPoolable_9);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IPoolable_9, "Zenject", "IPoolable`9");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPoolable_9", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPoolable_9(IPoolable_9const&) = delete;
