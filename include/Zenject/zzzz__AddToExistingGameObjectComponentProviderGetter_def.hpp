...
public:
  ...
  /// @brief Method GetGameObject, addr 0x6d2bcb4, size 0x84, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d2bc74, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShouldToggleActive, addr 0x6d2bcac, size 0x8, virtual true, abstract: false, final false
