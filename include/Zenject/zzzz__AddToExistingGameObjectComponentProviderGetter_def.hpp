...
public:
  ...
  /// @brief Method GetGameObject, addr 0x3455320, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34552e0, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShouldToggleActive, addr 0x3455318, size 0x8, virtual true, abstract: false, final false
