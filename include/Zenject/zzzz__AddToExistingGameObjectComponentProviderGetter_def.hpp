...
public:
  ...
  /// @brief Method GetGameObject, addr 0x3452324, size 0x78, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x34522e4, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShouldToggleActive, addr 0x345231c, size 0x8, virtual true, abstract: false, final false
