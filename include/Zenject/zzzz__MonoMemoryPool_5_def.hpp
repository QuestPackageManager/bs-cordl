...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MonoMemoryPool_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MonoMemoryPool_5, "Zenject", "MonoMemoryPool`5");
// Dependencies UnityEngine.Component, Zenject.MemoryPool`5<TParam1, TParam2, TParam3, TParam4, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::UnityEngine::Component*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoMemoryPool_5(MonoMemoryPool_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoMemoryPool_5(MonoMemoryPool_5const&) = delete;
