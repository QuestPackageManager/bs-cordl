...
inline void Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>::_ctor(::Zenject::DiContainer* bindContainer, ::Zenject::BindInfo* bindInfo, ::Zenject::FactoryBindInfo* factoryBindInfo) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>*>(),
...
inline ::Zenject::FactoryArgumentsToChoiceBinder_2<TParam1, TContract>* Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>::WithId(::System::Object* identifier) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>*>(), { "WithId", {}, { ::i2c::type_of<::System::Object*>() } })));
  return ::cordl_internals::RunMethodRethrow<::Zenject::FactoryArgumentsToChoiceBinder_2<TParam1, TContract>*>(this, ___internal_method, identifier);
}
template <typename TParam1, typename TContract>
inline ::Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>* Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>::New_ctor(::Zenject::DiContainer* bindContainer, ::Zenject::BindInfo* bindInfo,
  ...
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::FactoryToChoiceIdBinder_2<TParam1, TContract>*>(bindContainer, bindInfo, factoryBindInfo));
}
// Ctor Parameters []
