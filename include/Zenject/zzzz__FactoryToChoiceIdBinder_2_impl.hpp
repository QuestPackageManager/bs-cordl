...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::FactoryToChoiceIdBinder_2<TParam1,TContract>*>::get(),
                        ".ctor",
...
template<typename TParam1,typename TContract>
inline ::Zenject::FactoryToChoiceIdBinder_2<TParam1,TContract>* Zenject::FactoryToChoiceIdBinder_2<TParam1,TContract>::New_ctor(::Zenject::DiContainer*  bindContainer, ::Zenject::BindInfo*  bindInfo, ::Zenject::FactoryBindInfo*  factoryBindInfo)  {
...
// Ctor Parameters []
template<typename TParam1,typename TContract>
constexpr ::Zenject::FactoryToChoiceIdBinder_2<TParam1,TContract>::FactoryToChoiceIdBinder_2()   {
}
