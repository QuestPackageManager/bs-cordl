...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IFactory_11);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IFactory_11, "Zenject", "IFactory`11");
// Dependencies
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TParam6, typename TParam7, typename TParam8, typename TParam9, typename TParam10,
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IFactory_11", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFactory_11(IFactory_11const&) = delete;
