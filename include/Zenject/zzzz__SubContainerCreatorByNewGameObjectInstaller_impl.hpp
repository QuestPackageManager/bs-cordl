...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::*)()>(
    &::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x301b374;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method =
        THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0*>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::*)(::Zenject::DiContainer*)>(
    &::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::_AddInstallers_b__0)> {
  constexpr static std::size_t size = 0x178;
  constexpr static std::size_t addrs = 0x301b3d8;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0*>::get(), "<AddInstallers>b__0",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (*)(::ArrayW<::System::Object*, ::Array<::System::Object*>*>)>(
    &::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__zenCreate)> {
  constexpr static std::size_t size = 0x5c;
  constexpr static std::size_t addrs = 0x301b550;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS(
        (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0*>::get(), "__zenCreate",
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Zenject::InjectTypeInfo* (*)()>(
    &::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__zenCreateInjectTypeInfo)> {
  constexpr static std::size_t size = 0x1c0;
  constexpr static std::size_t addrs = 0x301b5ac;
...
constexpr ::Zenject::SubContainerCreatorByNewGameObjectInstaller*& Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__cordl_internal_get___4__this() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->_____4__this;
}
constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorByNewGameObjectInstaller*> const&
Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__cordl_internal_get___4__this() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->_____4__this;
}
constexpr void Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__cordl_internal_set___4__this(::Zenject::SubContainerCreatorByNewGameObjectInstaller* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  il2cpp_functions::gc_wbarrier_set_field(this, static_cast<void**>(static_cast<void*>(&this->_____4__this)), cordl_internals::convert(std::forward<decltype(value)>(value)));
}
constexpr ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*& Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__cordl_internal_get_args() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___args;
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*> const&
Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__cordl_internal_get_args() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___args;
}
constexpr void Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__cordl_internal_set_args(::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0* Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0*>());
}
inline void Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::_ctor() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0*>::get(), ".ctor",
...
// Ctor Parameters []
constexpr ::Zenject::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0::__SubContainerCreatorByNewGameObjectInstaller____c__DisplayClass3_0() {}
//  Writing Method size for method: ::Zenject::SubContainerCreatorByNewGameObjectInstaller._ctor
template <>

struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::SubContainerCreatorByNewGameObjectInstaller::*)(
  ...
  constexpr static std::size_t addrs = 0x301b1b0;

  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::SubContainerCreatorByNewGameObjectInstaller*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::SubContainerCreatorByNewGameObjectInstaller::*)(
  ...
  constexpr static std::size_t addrs = 0x301b280;

  inline static ::MethodInfo const* methodInfo() {

    static auto* ___internal_method =
        THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::SubContainerCreatorByNewGameObjectInstaller*>::get(),
                                                       ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::SubContainerCreatorByNewGameObjectInstaller*>::get(), 5));
    return ___internal_method;
  }
};
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> const& Zenject::SubContainerCreatorByNewGameObjectInstaller::__cordl_internal_get__installerType() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____installerType;
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*> const&
Zenject::SubContainerCreatorByNewGameObjectInstaller::__cordl_internal_get__extraArgs() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____extraArgs;
}
...
Zenject::SubContainerCreatorByNewGameObjectInstaller::New_ctor(::Zenject::DiContainer* container, ::Zenject::GameObjectCreationParameters* gameObjectBindInfo, ::System::Type* installerType,
  ...
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::SubContainerCreatorByNewGameObjectInstaller*>(container, gameObjectBindInfo, installerType, extraArgs));
}
