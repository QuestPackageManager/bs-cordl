...
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
inline void Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>::OnDespawned(TValue item) {
...
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
inline void Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>::Reinitialize(TParam1 p1, TParam2 p2, TValue item) {
  auto* ___internal_method =
...
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
inline void Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>::_ctor() {
...
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
inline ::System::Object* Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>::__zenCreate(::ArrayW<::System::Object*> P_0) {
...
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
inline ::Zenject::InjectTypeInfo* Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>::__zenCreateInjectTypeInfo() {
  static auto* ___internal_method =
...
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
inline ::Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>* Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>*>());
}
// Ctor Parameters []
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
constexpr ::Zenject::PoolableMemoryPool_3<TParam1, TParam2, TValue>::PoolableMemoryPool_3() {}
