...
namespace Zenject {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(10279))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2f10b7c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x2f10b8c, size 0x178, virtual false, abstract: false, final false
