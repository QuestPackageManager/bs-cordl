...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScriptableObjectInstaller_3(ScriptableObjectInstaller_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScriptableObjectInstaller_3(ScriptableObjectInstaller_3const&) = delete;
