...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByMethod_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByMethod_5, "Zenject", "SubContainerCreatorByMethod`5");
// [NoReflectionBaking]
...
public:
  ...
  constexpr ::System::Action_6<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5>* const& __cordl_internal_get__installMethod() const;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByMethod_5(SubContainerCreatorByMethod_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByMethod_5(SubContainerCreatorByMethod_5const&) = delete;
