...
namespace Zenject {
template <typename P1, typename T> class PrefabResourceFactory_2;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PrefabResourceFactory_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PrefabResourceFactory_2, "Zenject", "PrefabResourceFactory`2");
...
public:
  ...
  constexpr operator ::Zenject::IFactory_3<::StringW, P1, T>*() noexcept;
  ...
  constexpr ::Zenject::IFactory_3<::StringW, P1, T>* i___Zenject__IFactory_3___StringW_P1_T_() noexcept;
