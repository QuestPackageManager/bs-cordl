...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByMethod_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByMethod_1, "Zenject", "SubContainerCreatorByMethod`1");
// [NoReflectionBaking]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByMethod_1(SubContainerCreatorByMethod_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByMethod_1(SubContainerCreatorByMethod_1const&) = delete;
