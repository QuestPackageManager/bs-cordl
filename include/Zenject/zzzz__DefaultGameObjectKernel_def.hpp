...
public:
  ...
  /// @brief Method .ctor addr 0x2dacc44 size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method __zenCreateInjectTypeInfo addr 0x2dacc54 size 0x178 virtual false final false
