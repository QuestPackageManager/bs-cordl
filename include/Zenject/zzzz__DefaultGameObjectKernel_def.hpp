...
public:
  ...
  /// @brief Method .ctor, addr 0x2f14a14, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x2f14a24, size 0x178, virtual false, abstract: false, final false
