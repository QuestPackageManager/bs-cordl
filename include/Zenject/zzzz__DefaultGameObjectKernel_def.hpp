...
public:
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x307bacc, size 0x178, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x307babc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
