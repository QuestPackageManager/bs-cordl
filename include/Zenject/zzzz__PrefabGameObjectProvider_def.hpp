...
/// @brief Method GetAllInstancesWithInjectSplit, addr 0x6cbae04, size 0x154, virtual true, abstract: false, final true
...
/// @brief Method GetInstanceType, addr 0x6cbada4, size 0x60, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6cbad8c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Zenject::IPrefabInstantiator*  prefabCreator) ;

/// @brief Method get_IsCached, addr 0x6cbad94, size 0x8, virtual true, abstract: false, final true
inline bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6cbad9c, size 0x8, virtual true, abstract: false, final true
