...
public:
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x4b4a0d8, size 0x14c, virtual true, abstract: false, final true
  inline void GetAllInstancesWithInjectSplit(::Zenject::InjectContext* context, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* args, ::ByRef<::System::Action*> injectAction,
                                             ::System::Collections::Generic::List_1<::System::Object*>* buffer);

  /// @brief Method GetInstanceType, addr 0x4b4a06c, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b4a034, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::IPrefabInstantiator* prefabCreator);

  /// @brief Method get_IsCached, addr 0x4b4a05c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x4b4a064, size 0x8, virtual true, abstract: false, final true
