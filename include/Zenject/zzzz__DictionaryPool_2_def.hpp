...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11086)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3824), inst: 1186 }), GenericInstantiation(GenericInstantiation
// { tdi: TypeDefinitionIndex(11086), inst: 2802 }), TypeDefinitionIndex(TypeDefinitionIndex(3824))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11095)) CS Name:
