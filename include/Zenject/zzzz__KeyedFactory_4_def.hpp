...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::KeyedFactory_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::KeyedFactory_4, "Zenject", "KeyedFactory`4");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyedFactory_4(KeyedFactory_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyedFactory_4(KeyedFactory_4const&) = delete;
