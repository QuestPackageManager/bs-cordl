...
template <typename TParam1, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_1<TParam1>*>)
...
template <typename TParam1, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_1<TParam1>*>)
inline ::System::Object* Zenject::PoolableMemoryPool_2<TParam1, TValue>::__zenCreate(::ArrayW<::System::Object*> P_0) {
...
template <typename TParam1, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_1<TParam1>*>)
constexpr ::Zenject::PoolableMemoryPool_2<TParam1, TValue>::PoolableMemoryPool_2() {}
