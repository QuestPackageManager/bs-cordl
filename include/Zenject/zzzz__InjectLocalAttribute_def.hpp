...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3d778, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InjectLocalAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InjectLocalAttribute(InjectLocalAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InjectLocalAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InjectLocalAttribute(InjectLocalAttributeconst&) = delete;
