...
constexpr ::System::Collections::Generic::Stack_1<TValue>*& Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_get__stack()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____stack;
}
template<typename TValue>
constexpr ::System::Collections::Generic::Stack_1<TValue>* const& Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_get__stack() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____stack;
}
template<typename TValue>
constexpr void Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_set__stack(::System::Collections::Generic::Stack_1<TValue>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____stack, value);
}
template<typename TValue>
constexpr ::System::Action_1<TValue>*& Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_get__onDespawnedMethod()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____onDespawnedMethod;
}
template<typename TValue>
constexpr ::System::Action_1<TValue>* const& Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_get__onDespawnedMethod() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____onDespawnedMethod;
}
template<typename TValue>
constexpr void Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_set__onDespawnedMethod(::System::Action_1<TValue>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____onDespawnedMethod, value);
}
template<typename TValue>
constexpr int32_t& Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_get__activeCount()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____activeCount;
}
template<typename TValue>
constexpr int32_t const& Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_get__activeCount() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____activeCount;
}
template<typename TValue>
constexpr void Zenject::StaticMemoryPoolBaseBase_1<TValue>::__cordl_internal_set__activeCount(int32_t  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Action_1<TValue>*>::get()}
                    )));
...
template<typename TValue>
constexpr ::Zenject::IDespawnableMemoryPool_1<TValue>* Zenject::StaticMemoryPoolBaseBase_1<TValue>::i___Zenject__IDespawnableMemoryPool_1_TValue_() noexcept {
return static_cast<::Zenject::IDespawnableMemoryPool_1<TValue>*>(static_cast<void*>(this));
}
...
template<typename TValue>
constexpr ::Zenject::IMemoryPool* Zenject::StaticMemoryPoolBaseBase_1<TValue>::i___Zenject__IMemoryPool() noexcept {
return static_cast<::Zenject::IMemoryPool*>(static_cast<void*>(this));
}
...
template<typename TValue>
constexpr ::System::IDisposable* Zenject::StaticMemoryPoolBaseBase_1<TValue>::i___System__IDisposable() noexcept {
return static_cast<::System::IDisposable*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename TValue>
constexpr ::Zenject::StaticMemoryPoolBaseBase_1<TValue>::StaticMemoryPoolBaseBase_1()   {
}
