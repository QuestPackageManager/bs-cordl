...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x4b54274, size 0x20, virtual true, abstract: false, final false
  inline ::System::IAsyncResult* BeginInvoke(::System::AsyncCallback* callback, ::System::Object* object);

  /// @brief Method EndInvoke, addr 0x4b54294, size 0xc, virtual true, abstract: false, final false
  inline ::Zenject::InjectTypeInfo* EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x4b54260, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b541d8, size 0x88, virtual false, abstract: false, final false
