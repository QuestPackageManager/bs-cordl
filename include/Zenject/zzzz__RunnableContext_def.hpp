...
public:
  ...
  /// @brief Method Initialize, addr 0x366e9a8, size 0x9c, virtual false, abstract: false, final false
  inline void Initialize();

  static inline ::Zenject::RunnableContext* New_ctor();

  /// @brief Method Run, addr 0x36717b4, size 0x70, virtual true, abstract: false, final false
  inline void Run();
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x3671870, size 0x178, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x366f32c, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();

  static inline bool getStaticF__staticAutoRun();

  /// @brief Method get_Initialized, addr 0x36717a0, size 0x8, virtual false, abstract: false, final false
  inline bool get_Initialized();

  static inline void setStaticF__staticAutoRun(bool value);

  /// @brief Method set_Initialized, addr 0x36717a8, size 0xc, virtual false, abstract: false, final false
