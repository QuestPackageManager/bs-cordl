...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::ScriptableObjectInstaller_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ScriptableObjectInstaller_1, "Zenject", "ScriptableObjectInstaller`1");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ScriptableObjectInstaller_1(ScriptableObjectInstaller_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ScriptableObjectInstaller_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ScriptableObjectInstaller_1(ScriptableObjectInstaller_1const&) = delete;
