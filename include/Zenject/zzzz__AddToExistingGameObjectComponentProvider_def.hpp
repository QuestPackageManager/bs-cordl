...
public:
  ...
  /// @brief Method GetGameObject, addr 0x4b3fc60, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b3fb40, size 0x38, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShouldToggleActive, addr 0x4b3fc58, size 0x8, virtual true, abstract: false, final false
