...
public:
  ...
  /// @brief Method WithKernel, addr 0x6d06664, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d03a78, size 0xc, virtual false, abstract: false, final false
