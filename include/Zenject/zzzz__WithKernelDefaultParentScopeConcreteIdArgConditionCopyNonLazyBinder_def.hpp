...
public:
  ...
  /// @brief Method WithKernel, addr 0x2fee178, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2feb088, size 0x8, virtual false, abstract: false, final false
