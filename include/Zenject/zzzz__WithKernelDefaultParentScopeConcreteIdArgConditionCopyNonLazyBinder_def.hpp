...
public:
  ...
  /// @brief Method WithKernel, addr 0x6e5c830, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e59c44, size 0xc, virtual false, abstract: false, final false
