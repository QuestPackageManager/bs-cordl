...
public:
  ...
  /// @brief Method WithKernel, addr 0x4b15fac, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b13018, size 0x8, virtual false, abstract: false, final false
