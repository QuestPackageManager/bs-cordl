...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoInstaller_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoInstaller_6(MonoInstaller_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoInstaller_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoInstaller_6(MonoInstaller_6const&) = delete;
