...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::KeyedFactory_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::KeyedFactory_5, "Zenject", "KeyedFactory`5");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyedFactory_5(KeyedFactory_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyedFactory_5(KeyedFactory_5const&) = delete;
