...
public:
  ...
  /// @brief Method GetInjectableMonoBehaviours, addr 0x6e6fb20, size 0x248, virtual true, abstract: false, final false
  ...
  /// @brief Method GetRootGameObjects, addr 0x6e6f368, size 0x80, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::GameObject>>* GetRootGameObjects();

  /// @brief Method InstallBindings, addr 0x6e6f88c, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method RunInternal, addr 0x6e6f4d8, size 0x39c, virtual true, abstract: false, final false
  ...
  /// @brief Method __zenInjectMethod0, addr 0x6e6fde4, size 0xf8, virtual false, abstract: false, final false
