...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10603))}
...
public:
  ...
  /// @brief Method .ctor addr 0x2d733f4 size 0x8 virtual false final false
  inline void _ctor(::Zenject::BindInfo* bindInfo);

  /// @brief Method AsCached addr 0x2d734f8 size 0x20 virtual false final false
  inline ::Zenject::ConcreteIdArgConditionCopyNonLazyBinder* AsCached();

  /// @brief Method AsSingle addr 0x2d73518 size 0x28 virtual false final false
  inline ::Zenject::ConcreteIdArgConditionCopyNonLazyBinder* AsSingle();

  /// @brief Method AsTransient addr 0x2d73540 size 0x20 virtual false final false
