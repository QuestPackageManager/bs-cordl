...
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11088)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11088), inst: 3627 })]
// Self: TypeDefinitionIndex(TypeDefinitionIndex(11078))
