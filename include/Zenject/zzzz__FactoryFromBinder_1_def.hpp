...
class FactoryFromBinder_1___c__DisplayClass3_0_1;
}
namespace Zenject {
template<typename TContract>
class FactoryFromBinder_1___c__DisplayClass4_0;
}
namespace Zenject {
template<typename TContract>
class FactoryFromBinder_1___c__DisplayClass8_0;
}
namespace Zenject {
template<typename TContract>
class FactoryFromBinder_1___c;
}
namespace Zenject {
template<typename TContract>
...
using __c__5_1 = ::Zenject::FactoryFromBinder_1___c__5_1<TContract, TSubFactory>;

template<typename TObj>
using __c__DisplayClass3_0_1 = ::Zenject::FactoryFromBinder_1___c__DisplayClass3_0_1<TContract, TObj>;
