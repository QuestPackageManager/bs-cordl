...
public:
  ...
  /// @brief Method GetPrefab, addr 0x6d2f334, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d2f308, size 0x2c, virtual false, abstract: false, final false
