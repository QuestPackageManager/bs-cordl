...
public:
  ...
  /// @brief Method GetPrefab, addr 0x3070cdc, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3070ca8, size 0x34, virtual false, abstract: false, final false
