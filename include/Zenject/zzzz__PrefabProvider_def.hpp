...
public:
  ...
  /// @brief Method GetPrefab, addr 0x4b3d5d0, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b3d59c, size 0x34, virtual false, abstract: false, final false
