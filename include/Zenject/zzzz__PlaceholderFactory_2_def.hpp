...
MARK_GEN_REF_PTR_T(::Zenject::PlaceholderFactory_2__get_ParamTypes_d__2);
...
// Dependencies Zenject.IFactory, Zenject.IFactory`2<TParam1, TValue>, Zenject.PlaceholderFactoryBase`1<TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TValue>
// Is value type: false
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::PlaceholderFactory_2__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`2/<get_ParamTypes>d__2");
