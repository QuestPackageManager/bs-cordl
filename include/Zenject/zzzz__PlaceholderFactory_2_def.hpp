...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_2__get_ParamTypes_d__2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_2__get_ParamTypes_d__2(PlaceholderFactory_2__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_2__get_ParamTypes_d__2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_2__get_ParamTypes_d__2(PlaceholderFactory_2__get_ParamTypes_d__2const&) = delete;
...
public:
  ...
  /// [IteratorStateMachine(typeof(Zenject.PlaceholderFactory`2::<get_ParamTypes>d__2<TParam1, TValue>))]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_2(PlaceholderFactory_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_2(PlaceholderFactory_2const&) = delete;
