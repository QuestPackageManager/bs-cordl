...
template<typename TContract>
constexpr ::Zenject::MemoryPoolBindInfo* const& Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_get__poolBindInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____poolBindInfo;
}
template<typename TContract>
...
template<typename TContract>
constexpr ::Zenject::FactoryBindInfo* const& Zenject::MemoryPoolBindingFinalizer_1<TContract>::__cordl_internal_get__factoryBindInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____factoryBindInfo;
}
template<typename TContract>
