...
template <typename TContract> inline void Zenject::MemoryPoolBindingFinalizer_1<TContract>::OnFinalizeBinding(::Zenject::DiContainer* container) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPoolBindingFinalizer_1<TContract>*>::get(), "OnFinalizeBinding", std::vector<Il2CppClass*>{},
