...
public:
  ...
  /// @brief Method WithArguments, addr 0x6e4a37c, size 0x184, virtual false, abstract: false, final false
  inline ::Zenject::InstantiateCallbackConditionCopyNonLazyBinder* WithArguments(::ArrayW<::System::Object*> args);
  ...
  /// @brief Method WithArgumentsExplicit, addr 0x6e4a500, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e4a374, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::ArgConditionCopyNonLazyBinder) == 0x20, "Size mismatch!");
