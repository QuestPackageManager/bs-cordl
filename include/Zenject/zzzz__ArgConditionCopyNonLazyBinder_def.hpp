...
public:
  ...
  /// @brief Method WithArguments, addr 0x4af98c0, size 0x188, virtual false, abstract: false, final false
  ...
  /// @brief Method WithArgumentsExplicit, addr 0x4af9a48, size 0x39c, virtual false, abstract: false, final false
