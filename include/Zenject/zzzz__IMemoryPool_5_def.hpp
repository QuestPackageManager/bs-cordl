...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IMemoryPool_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IMemoryPool_5, "Zenject", "IMemoryPool`5");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IMemoryPool_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMemoryPool_5(IMemoryPool_5const&) = delete;
