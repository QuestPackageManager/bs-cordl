...
public:
  // Ctor Parameters [CppParam { name: "", ty: "GetFromGameObjectGetterComponentProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  GetFromGameObjectGetterComponentProvider(GetFromGameObjectGetterComponentProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "GetFromGameObjectGetterComponentProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  GetFromGameObjectGetterComponentProvider(GetFromGameObjectGetterComponentProviderconst&) = delete;
