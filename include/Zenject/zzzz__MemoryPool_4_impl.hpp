...
template<typename TParam1,typename TParam2,typename TParam3,typename TValue>
inline void Zenject::MemoryPool_4<TParam1,TParam2,TParam3,TValue>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPool_4<TParam1,TParam2,TParam3,TValue>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::MemoryPool_4<TParam1,TParam2,TParam3,TValue>*>());
}
...
template<typename TParam1,typename TParam2,typename TParam3,typename TValue>
constexpr  Zenject::MemoryPool_4<TParam1,TParam2,TParam3,TValue>::operator ::Zenject::IMemoryPool*() noexcept {
...
template<typename TParam1,typename TParam2,typename TParam3,typename TValue>
constexpr  Zenject::MemoryPool_4<TParam1,TParam2,TParam3,TValue>::operator ::Zenject::IFactory*() noexcept {
...
// Ctor Parameters []
template<typename TParam1,typename TParam2,typename TParam3,typename TValue>
constexpr ::Zenject::MemoryPool_4<TParam1,TParam2,TParam3,TValue>::MemoryPool_4()   {
}
