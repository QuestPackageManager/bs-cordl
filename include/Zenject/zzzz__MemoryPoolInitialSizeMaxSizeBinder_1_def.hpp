...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1, "Zenject", "MemoryPoolInitialSizeMaxSizeBinder`1");
// [NoReflectionBaking]
// Dependencies Zenject.MemoryPoolMaxSizeBinder`1<TContract>
namespace Zenject {
// cpp template
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPoolInitialSizeMaxSizeBinder_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPoolInitialSizeMaxSizeBinder_1(MemoryPoolInitialSizeMaxSizeBinder_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPoolInitialSizeMaxSizeBinder_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPoolInitialSizeMaxSizeBinder_1(MemoryPoolInitialSizeMaxSizeBinder_1const&) = delete;
