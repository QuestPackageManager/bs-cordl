...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::StaticMemoryPool_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::StaticMemoryPool_1, "Zenject", "StaticMemoryPool`1");
// [NoReflectionBaking]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "StaticMemoryPool_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  StaticMemoryPool_1(StaticMemoryPool_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "StaticMemoryPool_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  StaticMemoryPool_1(StaticMemoryPool_1const&) = delete;
