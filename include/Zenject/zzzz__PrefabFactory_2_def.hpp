...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrefabFactory_2(PrefabFactory_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrefabFactory_2(PrefabFactory_2const&) = delete;
