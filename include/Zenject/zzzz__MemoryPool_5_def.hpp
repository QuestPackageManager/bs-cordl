...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MemoryPool_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MemoryPool_5, "Zenject", "MemoryPool`5");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_5(MemoryPool_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_5(MemoryPool_5const&) = delete;
