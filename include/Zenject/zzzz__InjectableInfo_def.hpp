...
// Write type traits
MARK_REF_T(::Zenject::InjectableInfo*);
DEFINE_IL2CPP_CLASS(::Zenject::InjectableInfo*, "Zenject", "InjectableInfo");
// [NoReflectionBaking]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InjectableInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InjectableInfo(InjectableInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InjectableInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InjectableInfo(InjectableInfoconst&) = delete;
...
static_assert(sizeof(::Zenject::InjectableInfo) == 0x40, "Size mismatch!");
