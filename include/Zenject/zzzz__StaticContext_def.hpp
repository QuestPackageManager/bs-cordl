...
public:
  ...
  /// @brief Method Clear, addr 0x6e722b0, size 0x4c, virtual false, abstract: false, final false
  static inline void Clear();

  /// @brief Method NoDomainReloadInit, addr 0x6e72264, size 0x4c, virtual false, abstract: false, final false
  static inline void NoDomainReloadInit();

  static inline ::Zenject::DiContainer* getStaticF__container();

  /// @brief Method get_Container, addr 0x6e6dd98, size 0x90, virtual false, abstract: false, final false
  static inline ::Zenject::DiContainer* get_Container();

  /// @brief Method get_HasContainer, addr 0x6e722fc, size 0x54, virtual false, abstract: false, final false
