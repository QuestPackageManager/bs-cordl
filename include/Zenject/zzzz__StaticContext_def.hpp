...
public:
  ...
  /// @brief Method Clear addr 0x2ef4914 size 0x48 virtual false final false
  static inline void Clear();

  /// @brief Method get_HasContainer addr 0x2ef495c size 0x50 virtual false final false
  static inline bool get_HasContainer();

  /// @brief Method get_Container addr 0x2ef0390 size 0x90 virtual false final false
