...
public:
  ...
  /// @brief Method Clear, addr 0x3441848, size 0x48, virtual false, abstract: false, final false
  static inline void Clear();

  static inline ::Zenject::DiContainer* getStaticF__container();

  /// @brief Method get_Container, addr 0x343d2c4, size 0x90, virtual false, abstract: false, final false
  static inline ::Zenject::DiContainer* get_Container();

  /// @brief Method get_HasContainer, addr 0x3441890, size 0x50, virtual false, abstract: false, final false
