...
// [NoReflectionBaking]
// Dependencies Zenject.IPoolable`4<TParam1, TParam2, TParam3, TParam4>, Zenject.MemoryPool`5<TParam1, TParam2, TParam3, TParam4, TValue>, Zenject.PoolableMemoryPoolProviderBase`1<TContract>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TContract, typename TMemoryPool>
  requires(::cordl_internals::type_constraint<TContract, ::Zenject::IPoolable_4<TParam1, TParam2, TParam3, ::Zenject::IMemoryPool*>*> &&
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableMemoryPoolProvider_5(PoolableMemoryPoolProvider_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableMemoryPoolProvider_5(PoolableMemoryPoolProvider_5const&) = delete;
