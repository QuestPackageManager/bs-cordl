...
DEFINE_IL2CPP_CLASS(::Zenject::BindingInheritanceMethods, "Zenject", "BindingInheritanceMethods");
// Dependencies
namespace Zenject {
// Is value type: true
...
static_assert(sizeof(::Zenject::BindingInheritanceMethods) == 0x4, "Size mismatch!");
