...
/// @brief Method .ctor, addr 0x6c727f4, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c727fc, size 0x8, virtual false, abstract: false, final false
...
static inline ::Zenject::InjectTypeInfo_InjectMethodInfo* New_ctor(::Zenject::ZenInjectMethod*  action, ::ArrayW<::Zenject::InjectableInfo*,::Array<::Zenject::InjectableInfo*>*>  parameters, ::StringW  name) ;
...
/// @brief Method .ctor, addr 0x6c72804, size 0xc, virtual false, abstract: false, final false
...
/// @brief Field CS$<>9__CachedAnonymousMethodDelegate2, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_CS$__9__CachedAnonymousMethodDelegate2, put=setStaticF_CS$__9__CachedAnonymousMethodDelegate2)) ::System::Func_2<::Zenject::InjectTypeInfo_InjectMemberInfo*,::Zenject::InjectableInfo*>*  CS$__9__CachedAnonymousMethodDelegate2;

/// @brief Field CS$<>9__CachedAnonymousMethodDelegate3, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_CS$__9__CachedAnonymousMethodDelegate3, put=setStaticF_CS$__9__CachedAnonymousMethodDelegate3)) ::System::Func_2<::Zenject::InjectTypeInfo_InjectMethodInfo*,::System::Collections::Generic::IEnumerable_1<::Zenject::InjectableInfo*>*>*  CS$__9__CachedAnonymousMethodDelegate3;
...
/// @brief Field InjectMembers, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get_InjectMembers, put=__cordl_internal_set_InjectMembers)) ::ArrayW<::Zenject::InjectTypeInfo_InjectMemberInfo*,::Array<::Zenject::InjectTypeInfo_InjectMemberInfo*>*>  InjectMembers;

/// @brief Field InjectMethods, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get_InjectMethods, put=__cordl_internal_set_InjectMethods)) ::ArrayW<::Zenject::InjectTypeInfo_InjectMethodInfo*,::Array<::Zenject::InjectTypeInfo_InjectMethodInfo*>*>  InjectMethods;
...
/// @brief Method .ctor, addr 0x6c725ec, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  type, ::Zenject::InjectTypeInfo_InjectConstructorInfo*  injectConstructor, ::ArrayW<::Zenject::InjectTypeInfo_InjectMethodInfo*,::Array<::Zenject::InjectTypeInfo_InjectMethodInfo*>*>  injectMethods, ::ArrayW<::Zenject::InjectTypeInfo_InjectMemberInfo*,::Array<::Zenject::InjectTypeInfo_InjectMemberInfo*>*>  injectMembers) ;

/// @brief Method <get_AllInjectables>b__0, addr 0x6c727cc, size 0x14, virtual false, abstract: false, final false
static inline ::Zenject::InjectableInfo* _get_AllInjectables_b__0(::Zenject::InjectTypeInfo_InjectMemberInfo*  x) ;

/// @brief Method <get_AllInjectables>b__1, addr 0x6c727e0, size 0x14, virtual false, abstract: false, final false
...
static inline ::System::Func_2<::Zenject::InjectTypeInfo_InjectMethodInfo*,::System::Collections::Generic::IEnumerable_1<::Zenject::InjectableInfo*>*>* getStaticF_CS$__9__CachedAnonymousMethodDelegate3() ;

/// @brief Method get_AllInjectables, addr 0x6c72608, size 0x1c4, virtual false, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::Zenject::InjectableInfo*>* get_AllInjectables() ;

/// @brief Method get_BaseTypeInfo, addr 0x6c725f8, size 0x8, virtual false, abstract: false, final false
...
static inline void setStaticF_CS$__9__CachedAnonymousMethodDelegate3(::System::Func_2<::Zenject::InjectTypeInfo_InjectMethodInfo*,::System::Collections::Generic::IEnumerable_1<::Zenject::InjectableInfo*>*>*  value) ;

/// @brief Method set_BaseTypeInfo, addr 0x6c72600, size 0x8, virtual false, abstract: false, final false
