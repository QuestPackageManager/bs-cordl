...
// Write type traits
MARK_REF_T(::Zenject::InjectTypeInfo*);
MARK_REF_T(::Zenject::InjectTypeInfo_InjectConstructorInfo*);
MARK_REF_T(::Zenject::InjectTypeInfo_InjectMemberInfo*);
MARK_REF_T(::Zenject::InjectTypeInfo_InjectMethodInfo*);
DEFINE_IL2CPP_CLASS(::Zenject::InjectTypeInfo*, "Zenject", "InjectTypeInfo");
...
public:
  ...
  /// @brief Method .ctor, addr 0x6e3de3c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_Parameters, put = __cordl_internal_set_Parameters)) ::ArrayW<::Zenject::InjectableInfo*> Parameters;

  static inline ::Zenject::InjectTypeInfo_InjectConstructorInfo* New_ctor(::Zenject::ZenFactoryMethod* factory, ::ArrayW<::Zenject::InjectableInfo*> parameters);
  ...
  constexpr ::ArrayW<::Zenject::InjectableInfo*> const& __cordl_internal_get_Parameters() const;

  constexpr ::ArrayW<::Zenject::InjectableInfo*>& __cordl_internal_get_Parameters();
  ...
  /// @brief Method .ctor, addr 0x6e3de44, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::Zenject::InjectableInfo*> ___Parameters;
...
public:
  ...
  static inline ::Zenject::InjectTypeInfo_InjectMethodInfo* New_ctor(::Zenject::ZenInjectMethod* action, ::ArrayW<::Zenject::InjectableInfo*> parameters, ::StringW name);
  ...
  /// @brief Method .ctor, addr 0x6e3de4c, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_InjectMembers, put = __cordl_internal_set_InjectMembers)) ::ArrayW<::Zenject::InjectTypeInfo_InjectMemberInfo*> InjectMembers;

  /// @brief Field InjectMethods, offset 0x18, size 0x8
  __declspec(property(get = __cordl_internal_get_InjectMethods, put = __cordl_internal_set_InjectMethods)) ::ArrayW<::Zenject::InjectTypeInfo_InjectMethodInfo*> InjectMethods;
  ...
  constexpr ::ArrayW<::Zenject::InjectTypeInfo_InjectMemberInfo*> const& __cordl_internal_get_InjectMembers() const;

  constexpr ::ArrayW<::Zenject::InjectTypeInfo_InjectMemberInfo*>& __cordl_internal_get_InjectMembers();

  constexpr ::ArrayW<::Zenject::InjectTypeInfo_InjectMethodInfo*> const& __cordl_internal_get_InjectMethods() const;

  constexpr ::ArrayW<::Zenject::InjectTypeInfo_InjectMethodInfo*>& __cordl_internal_get_InjectMethods();
  ...
  constexpr void __cordl_internal_set_InjectMembers(::ArrayW<::Zenject::InjectTypeInfo_InjectMemberInfo*> value);

  constexpr void __cordl_internal_set_InjectMethods(::ArrayW<::Zenject::InjectTypeInfo_InjectMethodInfo*> value);

  constexpr void __cordl_internal_set_Type(::System::Type* value);

  constexpr void __cordl_internal_set__BaseTypeInfo_k__BackingField(::Zenject::InjectTypeInfo* value);

  /// @brief Method .ctor, addr 0x6e3dc34, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  ::ArrayW<::Zenject::InjectTypeInfo_InjectMethodInfo*> ___InjectMethods;

  /// @brief Field InjectMembers, offset: 0x20, size: 0x8, def value: None
  ::ArrayW<::Zenject::InjectTypeInfo_InjectMemberInfo*> ___InjectMembers;
...
static_assert(sizeof(::Zenject::InjectTypeInfo) == 0x38, "Size mismatch!");
