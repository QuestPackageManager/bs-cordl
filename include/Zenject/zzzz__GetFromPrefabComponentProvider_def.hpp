...
public:
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x369e3b0, size 0x304, virtual true, abstract: false, final true
  inline void GetAllInstancesWithInjectSplit(::Zenject::InjectContext* context, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* args, ByRef<::System::Action*> injectAction,
                                             ::System::Collections::Generic::List_1<::System::Object*>* buffer);

  /// @brief Method GetInstanceType, addr 0x369e3a8, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x369e35c, size 0x3c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* componentType, ::Zenject::IPrefabInstantiator* prefabInstantiator, bool matchSingle);

  /// @brief Method get_IsCached, addr 0x369e398, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x369e3a0, size 0x8, virtual true, abstract: false, final true
