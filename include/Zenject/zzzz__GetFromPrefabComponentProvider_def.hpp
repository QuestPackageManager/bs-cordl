...
/// @brief Method GetAllInstancesWithInjectSplit, addr 0x6d2e51c, size 0x31c, virtual true, abstract: false, final true
...
/// @brief Method GetInstanceType, addr 0x6d2e514, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6d2e4f8, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  componentType, ::Zenject::IPrefabInstantiator*  prefabInstantiator, bool  matchSingle) ;

/// @brief Method get_IsCached, addr 0x6d2e504, size 0x8, virtual true, abstract: false, final true
inline bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6d2e50c, size 0x8, virtual true, abstract: false, final true
