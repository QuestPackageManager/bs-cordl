...
public:
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x6e8313c, size 0x31c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetInstanceType, addr 0x6e83134, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e83118, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* componentType, ::Zenject::IPrefabInstantiator* prefabInstantiator, bool matchSingle);

  /// @brief Method get_IsCached, addr 0x6e83124, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6e8312c, size 0x8, virtual true, abstract: false, final true
...
static_assert(sizeof(::Zenject::GetFromPrefabComponentProvider) == 0x28, "Size mismatch!");
