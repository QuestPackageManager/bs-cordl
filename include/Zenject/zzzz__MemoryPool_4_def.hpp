...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MemoryPool_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MemoryPool_4, "Zenject", "MemoryPool`4");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_4(MemoryPool_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_4(MemoryPool_4const&) = delete;
