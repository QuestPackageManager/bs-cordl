...
public:
  ...
  /// @brief Method CreateEmptySubContainer, addr 0x4b3f0cc, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b3f0a0, size 0x2c, virtual false, abstract: false, final false
