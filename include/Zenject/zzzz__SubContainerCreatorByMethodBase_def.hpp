...
public:
  ...
  /// @brief Method CreateEmptySubContainer, addr 0x6cbe50c, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cbe504, size 0x8, virtual false, abstract: false, final false
