...
public:
  ...
  /// @brief Method CreateEmptySubContainer, addr 0x4b3bbac, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b3bb80, size 0x2c, virtual false, abstract: false, final false
