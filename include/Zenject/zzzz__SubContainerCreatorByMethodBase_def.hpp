...
public:
  ...
  /// @brief Method CreateEmptySubContainer, addr 0x345a6c0, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345a694, size 0x2c, virtual false, abstract: false, final false
