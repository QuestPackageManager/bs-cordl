...
public:
  ...
  /// @brief Method CreateEmptySubContainer, addr 0x4b41b94, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b41b68, size 0x2c, virtual false, abstract: false, final false
