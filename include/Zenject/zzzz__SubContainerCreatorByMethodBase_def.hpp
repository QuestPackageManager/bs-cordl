...
public:
  ...
  /// @brief Method CreateEmptySubContainer, addr 0x368bb84, size 0x3c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368bb58, size 0x2c, virtual false, abstract: false, final false
