...
class TaskUpdater_1_TaskInfo;
}
namespace Zenject {
template<typename TTask>
class TaskUpdater_1___c__DisplayClass8_0;
}
namespace Zenject {
template<typename TTask>
class TaskUpdater_1___c;
}
...
/// @brief Field _queuedTasks, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__queuedTasks, put=__cordl_internal_set__queuedTasks)) ::System::Collections::Generic::List_1<::Zenject::TaskUpdater_1_TaskInfo<TTask>*>*  _queuedTasks;
