...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::TaskUpdater_1);
MARK_GEN_REF_T_PTR(::Zenject::TaskUpdater_1_TaskInfo);
MARK_GEN_REF_T_PTR(::Zenject::TaskUpdater_1___c);
MARK_GEN_REF_T_PTR(::Zenject::TaskUpdater_1___c__DisplayClass8_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::TaskUpdater_1, "Zenject", "TaskUpdater`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::TaskUpdater_1_TaskInfo, "Zenject", "TaskUpdater`1/TaskInfo");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::TaskUpdater_1___c, "Zenject", "TaskUpdater`1/<>c");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::TaskUpdater_1___c__DisplayClass8_0, "Zenject", "TaskUpdater`1/<>c__DisplayClass8_0");
