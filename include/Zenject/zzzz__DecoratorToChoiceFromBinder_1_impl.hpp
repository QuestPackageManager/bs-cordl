...
template<typename TContract>
constexpr ::Zenject::DiContainer* const& Zenject::DecoratorToChoiceFromBinder_1<TContract>::__cordl_internal_get__bindContainer() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____bindContainer;
}
template<typename TContract>
...
template<typename TContract>
constexpr ::Zenject::BindInfo* const& Zenject::DecoratorToChoiceFromBinder_1<TContract>::__cordl_internal_get__bindInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____bindInfo;
}
template<typename TContract>
...
template<typename TContract>
constexpr ::Zenject::FactoryBindInfo* const& Zenject::DecoratorToChoiceFromBinder_1<TContract>::__cordl_internal_get__factoryBindInfo() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____factoryBindInfo;
}
template<typename TContract>
