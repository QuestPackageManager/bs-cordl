...
public:
  ...
  /// @brief Method <Instantiate>b__0, addr 0x6e88588, size 0x538, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e88584, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method GetPrefab, addr 0x6e88324, size 0xa4, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> GetPrefab();

  /// @brief Method Instantiate, addr 0x6e883c8, size 0x1bc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e8824c, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ArgumentTarget, addr 0x6e88314, size 0x8, virtual true, abstract: false, final true
  inline ::System::Type* get_ArgumentTarget();

  /// @brief Method get_ExtraArguments, addr 0x6e8831c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* get_ExtraArguments();

  /// @brief Method get_GameObjectCreationParameters, addr 0x6e8830c, size 0x8, virtual true, abstract: false, final true
