...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_3);
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_3__get_ParamTypes_d__2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_3, "Zenject", "PlaceholderFactory`3");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_3__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`3/<get_ParamTypes>d__2");
// [CompilerGenerated]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_3__get_ParamTypes_d__2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_3__get_ParamTypes_d__2(PlaceholderFactory_3__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_3__get_ParamTypes_d__2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_3__get_ParamTypes_d__2(PlaceholderFactory_3__get_ParamTypes_d__2const&) = delete;
...
public:
  ...
  /// [IteratorStateMachine(typeof(Zenject.PlaceholderFactory`3::<get_ParamTypes>d__2<TParam1, TParam2, TValue>))]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_3(PlaceholderFactory_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_3(PlaceholderFactory_3const&) = delete;
