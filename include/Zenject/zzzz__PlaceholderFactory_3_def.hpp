...
MARK_GEN_REF_PTR_T(::Zenject::__PlaceholderFactory_3___get_ParamTypes_d__2);
...
public:
  ...
  static inline ::Zenject::__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1, TParam2, TValue>* New_ctor(int32_t __1__state);
  ...
  // Ctor Parameters [CppParam { name: "", ty: "__PlaceholderFactory_3___get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  __PlaceholderFactory_3___get_ParamTypes_d__2(__PlaceholderFactory_3___get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "__PlaceholderFactory_3___get_ParamTypes_d__2", modifiers: "const&", def_value: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  __PlaceholderFactory_3___get_ParamTypes_d__2(__PlaceholderFactory_3___get_ParamTypes_d__2 const&) = delete;

protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr __PlaceholderFactory_3___get_ParamTypes_d__2();
...
public:
  // Declarations
  using _get_ParamTypes_d__2 = ::Zenject::__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1, TParam2, TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::__PlaceholderFactory_3___get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`3/<get_ParamTypes>d__2");
