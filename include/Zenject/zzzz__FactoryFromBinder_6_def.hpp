...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Func_7<::Zenject::DiContainer*, TParam1, TParam2, TParam3, TParam4, TParam5, TContract>*> const& __get_method() const;
...
public:
  ...
  static __declspec(
      property(get = getStaticF___9__2_0,
...
public:
  // Declarations
  template <typename TSubFactory> using __c__2_1 = ::Zenject::__FactoryFromBinder_6____c__2_1<TParam1, TParam2, TParam3, TParam4, TParam5, TContract, TSubFactory>;
