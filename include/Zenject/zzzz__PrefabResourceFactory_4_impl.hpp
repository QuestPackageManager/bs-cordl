...
constexpr ::Zenject::DiContainer*& Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::__cordl_internal_get__container()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename P1,typename P2,typename P3,typename T>
constexpr ::Zenject::DiContainer* const& Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::__cordl_internal_get__container() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____container;
}
template<typename P1,typename P2,typename P3,typename T>
constexpr void Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::__cordl_internal_set__container(::Zenject::DiContainer*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____container, value);
}
template<typename P1,typename P2,typename P3,typename T>
inline ::Zenject::DiContainer* Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::get_Container()  {
...
template<typename P1,typename P2,typename P3,typename T>
inline T Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::Create(::StringW  prefabResourceName, P1  param, P2  param2, P3  param3)  {
...
template<typename P1,typename P2,typename P3,typename T>
inline void Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabResourceFactory_4<P1,P2,P3,T>*>::get(),
                        ".ctor",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename P1,typename P2,typename P3,typename T>
inline void Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::__zenFieldSetter0(::System::Object*  P_0, ::System::Object*  P_1)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabResourceFactory_4<P1,P2,P3,T>*>::get(),
                        "__zenFieldSetter0",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename P1,typename P2,typename P3,typename T>
inline ::Zenject::InjectTypeInfo* Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::__zenCreateInjectTypeInfo()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PrefabResourceFactory_4<P1,P2,P3,T>*>::get(),
...
template<typename P1,typename P2,typename P3,typename T>
inline ::Zenject::PrefabResourceFactory_4<P1,P2,P3,T>* Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::New_ctor()  {
...
template<typename P1,typename P2,typename P3,typename T>
constexpr  Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::operator ::Zenject::IFactory_5<::StringW,P1,P2,P3,T>*() noexcept {
...
template<typename P1,typename P2,typename P3,typename T>
constexpr  Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::operator ::Zenject::IFactory*() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
/// @brief Convert to "::Zenject::IFactory"
template<typename P1,typename P2,typename P3,typename T>
constexpr ::Zenject::IFactory* Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename P1,typename P2,typename P3,typename T>
constexpr ::Zenject::PrefabResourceFactory_4<P1,P2,P3,T>::PrefabResourceFactory_4()   {
}
