...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::GetFromGameObjectComponentProvider::*)(::System::Type*, ::UnityEngine::GameObject*, bool)>(
  ...
  constexpr static std::size_t addrs = 0x6e82c7c;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::GetFromGameObjectComponentProvider*>(),
                                                             { ".ctor", {}, { ::i2c::type_of<::System::Type*>(), ::i2c::type_of<::UnityEngine::GameObject*>(), ::i2c::type_of<bool>() } })));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Zenject::GetFromGameObjectComponentProvider::*)()>(&::Zenject::GetFromGameObjectComponentProvider::get_IsCached)> {
  ...
  constexpr static std::size_t addrs = 0x6e82c88;
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Zenject::GetFromGameObjectComponentProvider::*)()>(&::Zenject::GetFromGameObjectComponentProvider::get_TypeVariesBasedOnMemberType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e82c90;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method =
        THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::GetFromGameObjectComponentProvider*>(), { "get_TypeVariesBasedOnMemberType", {}, {} })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::System::Type* (::Zenject::GetFromGameObjectComponentProvider::*)(::Zenject::InjectContext*)>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x6e82c98;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::GetFromGameObjectComponentProvider*>(), { "GetInstanceType", {}, { ::i2c::type_of<::Zenject::InjectContext*>() } })));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Zenject::GetFromGameObjectComponentProvider::*)(
  ...
  constexpr static std::size_t addrs = 0x6e82ca0;
...
inline void Zenject::GetFromGameObjectComponentProvider::_ctor(::System::Type* componentType, ::UnityEngine::GameObject* gameObject, bool matchSingle) {
  static auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::GetFromGameObjectComponentProvider*>(),
                                                           { ".ctor", {}, { ::i2c::type_of<::System::Type*>(), ::i2c::type_of<::UnityEngine::GameObject*>(), ::i2c::type_of<bool>() } })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method, componentType, gameObject, matchSingle);
}
...
inline ::Zenject::GetFromGameObjectComponentProvider* Zenject::GetFromGameObjectComponentProvider::New_ctor(::System::Type* componentType, ::UnityEngine::GameObject* gameObject, bool matchSingle) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::GetFromGameObjectComponentProvider*>(componentType, gameObject, matchSingle));
}
