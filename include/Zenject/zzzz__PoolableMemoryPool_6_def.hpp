...
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_5<TParam1, TParam2, TParam3, TParam4, TParam5>*>)
class PoolableMemoryPool_6;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PoolableMemoryPool_6);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PoolableMemoryPool_6, "Zenject", "PoolableMemoryPool`6");
// Dependencies Zenject.IPoolable`5<TParam1, TParam2, TParam3, TParam4, TParam5>, Zenject.MemoryPool`6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_5<TParam1, TParam2, TParam3, TParam4, TParam5>*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPool_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableMemoryPool_6(PoolableMemoryPool_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPool_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableMemoryPool_6(PoolableMemoryPool_6const&) = delete;
