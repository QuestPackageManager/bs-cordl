...
template <typename TInstaller> inline ::StringW Zenject::ScriptableObjectInstallerUtil::GetDefaultResourcePath() {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstallerUtil*>::get(), "GetDefaultResourcePath",
...
template <typename TInstaller> inline TInstaller Zenject::ScriptableObjectInstallerUtil::CreateInstaller(::StringW resourcePath, ::Zenject::DiContainer* container) {
  static auto* ___internal_method_base =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::ScriptableObjectInstallerUtil*>::get(), "CreateInstaller",
