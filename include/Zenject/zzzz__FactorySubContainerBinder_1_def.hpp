...
class FactorySubContainerBinder_1___c__DisplayClass1_0;
}
namespace Zenject {
template<typename TContract>
class FactorySubContainerBinder_1___c__DisplayClass2_0;
}
namespace Zenject {
template<typename TContract>
class FactorySubContainerBinder_1___c__DisplayClass3_0;
}
namespace Zenject {
template<typename TContract>
class FactorySubContainerBinder_1___c__DisplayClass4_0;
}
namespace Zenject {
template<typename TContract>
class FactorySubContainerBinder_1___c__DisplayClass6_0;
}
namespace Zenject {
template<typename TContract>
class FactorySubContainerBinder_1___c__DisplayClass8_0;
}
namespace Zenject {
...
static inline ::Zenject::FactorySubContainerBinder_1<TContract>* New_ctor(::Zenject::DiContainer*  bindContainer, ::Zenject::BindInfo*  bindInfo, ::Zenject::FactoryBindInfo*  factoryBindInfo, ::System::Object*  subIdentifier) ;
