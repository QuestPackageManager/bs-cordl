...
public:
  // Declarations
  /// @brief Method BeginInvoke, addr 0x6e3a678, size 0x28, virtual true, abstract: false, final false
  ...
  /// @brief Method EndInvoke, addr 0x6e3a6a0, size 0xc, virtual true, abstract: false, final false
  inline void EndInvoke(::System::IAsyncResult* result);

  /// @brief Method Invoke, addr 0x6e3a664, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e3a51c, size 0x148, virtual false, abstract: false, final false
