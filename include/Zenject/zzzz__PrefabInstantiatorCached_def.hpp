...
public:
  ...
  /// @brief Method GetPrefab, addr 0x6e8590c, size 0xa8, virtual true, abstract: false, final true
  inline ::UnityW<::UnityEngine::Object> GetPrefab();

  /// @brief Method Instantiate, addr 0x6e859b4, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e85710, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::IPrefabInstantiator* subInstantiator);

  /// @brief Method get_ArgumentTarget, addr 0x6e857c0, size 0xa4, virtual true, abstract: false, final true
  inline ::System::Type* get_ArgumentTarget();

  /// @brief Method get_ExtraArguments, addr 0x6e85718, size 0xa8, virtual true, abstract: false, final true
  inline ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* get_ExtraArguments();

  /// @brief Method get_GameObjectCreationParameters, addr 0x6e85864, size 0xa8, virtual true, abstract: false, final true
