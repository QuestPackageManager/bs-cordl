...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::Factory_7);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::Factory_7, "Zenject", "Factory`7");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Factory_7", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Factory_7(Factory_7&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Factory_7", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Factory_7(Factory_7const&) = delete;
