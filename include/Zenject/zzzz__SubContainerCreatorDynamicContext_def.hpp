...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6e89274, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e87734, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::DiContainer* container);

  /// @brief Method get_Container, addr 0x6e8926c, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SubContainerCreatorDynamicContext) == 0x18, "Size mismatch!");
