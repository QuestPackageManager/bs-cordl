...
/// @brief Method CreateSubContainer, addr 0x6d345b4, size 0xe8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6d32a74, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::Zenject::DiContainer*  container) ;

/// @brief Method get_Container, addr 0x6d345ac, size 0x8, virtual false, abstract: false, final false
