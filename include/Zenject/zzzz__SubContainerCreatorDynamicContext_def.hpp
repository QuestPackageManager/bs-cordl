...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6d32a3c, size 0xe8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d30efc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::DiContainer* container);

  /// @brief Method get_Container, addr 0x6d32a34, size 0x8, virtual false, abstract: false, final false
