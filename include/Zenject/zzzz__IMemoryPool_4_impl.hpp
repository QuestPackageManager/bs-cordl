...
inline TValue Zenject::IMemoryPool_4<TParam1, TParam2, TParam3, TValue>::Spawn(TParam1 param1, TParam2 param2, TParam3 param3) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Zenject::IMemoryPool_4<TParam1, TParam2, TParam3, TValue>*>(), 0 })));
