...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IFactory_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IFactory_3, "Zenject", "IFactory`3");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IFactory_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFactory_3(IFactory_3const&) = delete;
