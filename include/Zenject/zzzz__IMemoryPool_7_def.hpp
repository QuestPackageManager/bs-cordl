...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IMemoryPool_7);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IMemoryPool_7, "Zenject", "IMemoryPool`7");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IMemoryPool_7", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMemoryPool_7(IMemoryPool_7const&) = delete;
