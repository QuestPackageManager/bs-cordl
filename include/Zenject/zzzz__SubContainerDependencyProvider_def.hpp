...
public:
  ...
  /// @brief Method CreateSubContext, addr 0x4b3da38, size 0x3c, virtual false, abstract: false, final false
  inline ::Zenject::InjectContext* CreateSubContext(::Zenject::InjectContext* parent, ::Zenject::DiContainer* subContainer);

  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x4b3da74, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b3d9dc, size 0x44, virtual false, abstract: false, final false
