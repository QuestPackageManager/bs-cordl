...
constexpr ::Zenject::IMemoryPool_2<TParam1,TValue>*& Zenject::PoolWrapperFactory_2<TParam1,TValue>::__cordl_internal_get__pool()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____pool;
}
template<typename TParam1,typename TValue>
constexpr ::Zenject::IMemoryPool_2<TParam1,TValue>* const& Zenject::PoolWrapperFactory_2<TParam1,TValue>::__cordl_internal_get__pool() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____pool;
}
template<typename TParam1,typename TValue>
constexpr void Zenject::PoolWrapperFactory_2<TParam1,TValue>::__cordl_internal_set__pool(::Zenject::IMemoryPool_2<TParam1,TValue>*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::IMemoryPool_2<TParam1,TValue>*>::get()}
                    )));
...
template<typename TParam1,typename TValue>
constexpr ::Zenject::IFactory_2<TParam1,TValue>* Zenject::PoolWrapperFactory_2<TParam1,TValue>::i___Zenject__IFactory_2_TParam1_TValue_() noexcept {
return static_cast<::Zenject::IFactory_2<TParam1,TValue>*>(static_cast<void*>(this));
}
...
template<typename TParam1,typename TValue>
constexpr ::Zenject::IFactory* Zenject::PoolWrapperFactory_2<TParam1,TValue>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename TParam1,typename TValue>
constexpr ::Zenject::PoolWrapperFactory_2<TParam1,TValue>::PoolWrapperFactory_2()   {
}
