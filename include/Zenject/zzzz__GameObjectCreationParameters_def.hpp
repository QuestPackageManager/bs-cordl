...
public:
  ...
  /// @brief Method Equals, addr 0x4b16af8, size 0xd0, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* other);

  /// @brief Method Equals, addr 0x4b16c20, size 0x64, virtual false, abstract: false, final false
  inline bool Equals(::Zenject::GameObjectCreationParameters* that);

  /// @brief Method GetHashCode, addr 0x4b1686c, size 0x28c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b13318, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::Zenject::GameObjectCreationParameters* getStaticF_Default();

  /// @brief Method get_GroupName, addr 0x4b16800, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_GroupName();

  /// @brief Method get_Name, addr 0x4b167f0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_ParentTransform, addr 0x4b16810, size 0x8, virtual false, abstract: false, final false
  inline ::UnityW<::UnityEngine::Transform> get_ParentTransform();

  /// @brief Method get_ParentTransformGetter, addr 0x4b16820, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::Zenject::InjectContext*, ::UnityW<::UnityEngine::Transform>>* get_ParentTransformGetter();

  /// @brief Method get_Position, addr 0x4b16830, size 0xc, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::Vector3> get_Position();

  /// @brief Method get_Rotation, addr 0x4b16844, size 0x14, virtual false, abstract: false, final false
  inline ::System::Nullable_1<::UnityEngine::Quaternion> get_Rotation();

  /// @brief Method op_Equality, addr 0x4b16bc8, size 0x58, virtual false, abstract: false, final false
  static inline bool op_Equality(::Zenject::GameObjectCreationParameters* left, ::Zenject::GameObjectCreationParameters* right);

  /// @brief Method op_Inequality, addr 0x4b16c84, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method set_GroupName, addr 0x4b16808, size 0x8, virtual false, abstract: false, final false
  inline void set_GroupName(::StringW value);

  /// @brief Method set_Name, addr 0x4b167f8, size 0x8, virtual false, abstract: false, final false
  inline void set_Name(::StringW value);

  /// @brief Method set_ParentTransform, addr 0x4b16818, size 0x8, virtual false, abstract: false, final false
  inline void set_ParentTransform(::UnityEngine::Transform* value);

  /// @brief Method set_ParentTransformGetter, addr 0x4b16828, size 0x8, virtual false, abstract: false, final false
  inline void set_ParentTransformGetter(::System::Func_2<::Zenject::InjectContext*, ::UnityW<::UnityEngine::Transform>>* value);

  /// @brief Method set_Position, addr 0x4b1683c, size 0x8, virtual false, abstract: false, final false
  inline void set_Position(::System::Nullable_1<::UnityEngine::Vector3> value);

  /// @brief Method set_Rotation, addr 0x4b16858, size 0x14, virtual false, abstract: false, final false
