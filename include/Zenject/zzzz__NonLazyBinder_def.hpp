...
public:
  // Declarations
  /// @brief Method Lazy, addr 0x6d03584, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::IfNotBoundBinder* Lazy();

  static inline ::Zenject::NonLazyBinder* New_ctor(::Zenject::BindInfo* bindInfo);

  /// @brief Method NonLazy, addr 0x6d03568, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::IfNotBoundBinder* NonLazy();

  /// @brief Method .ctor, addr 0x6d03560, size 0x8, virtual false, abstract: false, final false
