...
public:
  ...
  /// @brief Method .ctor, addr 0x2edb214, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::BindInfo* bindInfo);

  /// @brief Method NonLazy, addr 0x2edb23c, size 0x20, virtual false, abstract: false, final false
  inline ::Zenject::IfNotBoundBinder* NonLazy();

  /// @brief Method Lazy, addr 0x2edb25c, size 0x1c, virtual false, abstract: false, final false
