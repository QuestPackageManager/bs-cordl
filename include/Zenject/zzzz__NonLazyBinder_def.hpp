...
public:
// Declarations
/// @brief Method Lazy, addr 0x6c91340, size 0x18, virtual false, abstract: false, final false
inline ::Zenject::IfNotBoundBinder* Lazy() ;

static inline ::Zenject::NonLazyBinder* New_ctor(::Zenject::BindInfo*  bindInfo) ;

/// @brief Method NonLazy, addr 0x6c91324, size 0x1c, virtual false, abstract: false, final false
inline ::Zenject::IfNotBoundBinder* NonLazy() ;

/// @brief Method .ctor, addr 0x6c9131c, size 0x8, virtual false, abstract: false, final false
