...
// Write type traits
MARK_REF_T(::Zenject::SceneContextRegistryAdderAndRemover*);
DEFINE_IL2CPP_CLASS(::Zenject::SceneContextRegistryAdderAndRemover*, "Zenject", "SceneContextRegistryAdderAndRemover");
...
public:
  ...
  /// @brief Method Dispose, addr 0x6e9722c, size 0x1c, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Initialize, addr 0x6e97210, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method __zenCreate, addr 0x6e97248, size 0x110, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// [Preserve]
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e97358, size 0x2d8, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e97208, size 0x8, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SceneContextRegistryAdderAndRemover", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SceneContextRegistryAdderAndRemover(SceneContextRegistryAdderAndRemover&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SceneContextRegistryAdderAndRemover", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SceneContextRegistryAdderAndRemover(SceneContextRegistryAdderAndRemoverconst&) = delete;
...
static_assert(sizeof(::Zenject::SceneContextRegistryAdderAndRemover) == 0x20, "Size mismatch!");
