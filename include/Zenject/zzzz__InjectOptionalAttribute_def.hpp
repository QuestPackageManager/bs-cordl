...
public:
  // Ctor Parameters [CppParam { name: "", ty: "InjectOptionalAttribute", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  InjectOptionalAttribute(InjectOptionalAttribute&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "InjectOptionalAttribute", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  InjectOptionalAttribute(InjectOptionalAttributeconst&) = delete;
