...
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11085), inst: 188 }), TypeDefinitionIndex(TypeDefinitionIndex(11085))}
...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Action_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>*> const& __get__onSpawnMethod() const;
  ...
  inline void _ctor(::System::Action_6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>* onSpawnMethod, ::System::Action_1<TValue>* onDespawnedMethod = nullptr);
