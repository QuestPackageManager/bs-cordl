...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByMethod_6);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByMethod_6, "Zenject", "SubContainerCreatorByMethod`6");
// [NoReflectionBaking]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByMethod_6(SubContainerCreatorByMethod_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByMethod_6(SubContainerCreatorByMethod_6const&) = delete;
