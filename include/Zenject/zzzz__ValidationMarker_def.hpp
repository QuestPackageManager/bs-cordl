...
public:
  ...
  /// @brief Method .ctor addr 0x2db9594 size 0x34 virtual false final false
  ...
  /// @brief Method .ctor addr 0x2d9e118 size 0x2c virtual false final false
  inline void _ctor(::System::Type* markedType);

  /// @brief Method get_InstantiateFailed addr 0x2db95c8 size 0x8 virtual false final false
  inline bool get_InstantiateFailed();

  /// @brief Method set_InstantiateFailed addr 0x2db95d0 size 0xc virtual false final false
  inline void set_InstantiateFailed(bool value);

  /// @brief Method get_MarkedType addr 0x2db95dc size 0x8 virtual false final false
  inline ::System::Type* get_MarkedType();

  /// @brief Method set_MarkedType addr 0x2db95e4 size 0x8 virtual false final false
