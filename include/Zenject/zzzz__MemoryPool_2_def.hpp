...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_2(MemoryPool_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_2(MemoryPool_2const&) = delete;
