...
public:
  ...
  /// @brief Method __zenCreate, addr 0x4b47108, size 0x6c, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x4b47174, size 0x1b8, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x4b47044, size 0x30, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4b47000, size 0x44, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DefaultAsyncTickPriority, addr 0x4b47074, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_DefaultAsyncTickPriority();

  /// @brief Method get_DefaultSyncMode, addr 0x4b4707c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SignalDefaultSyncModes get_DefaultSyncMode();

  /// @brief Method get_MissingHandlerDefaultResponse, addr 0x4b47084, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::SignalMissingHandlerResponses get_MissingHandlerDefaultResponse();

  /// @brief Method get_RequireStrictUnsubscribe, addr 0x4b4708c, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x4b46f54, size 0x18, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x4b46eb4, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_DisplayWarningWhenResolvingDuringInstall, addr 0x4b46f84, size 0x8, virtual false, abstract: false, final false
  inline bool get_DisplayWarningWhenResolvingDuringInstall();

  /// @brief Method get_EnsureDeterministicDestructionOrderOnApplicationQuit, addr 0x4b46f8c, size 0x8, virtual false, abstract: false, final false
  inline bool get_EnsureDeterministicDestructionOrderOnApplicationQuit();

  /// @brief Method get_Signals, addr 0x4b46f6c, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ZenjectSettings_SignalSettings* get_Signals();

  /// @brief Method get_ValidationErrorResponse, addr 0x4b46f74, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::ValidationErrorResponses get_ValidationErrorResponse();

  /// @brief Method get_ValidationRootResolveMethod, addr 0x4b46f7c, size 0x8, virtual false, abstract: false, final false
