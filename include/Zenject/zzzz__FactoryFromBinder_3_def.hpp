...
template <typename TParam1, typename TParam2, typename TContract, typename TSubFactory>
  requires(::cordl_internals::type_constraint<TSubFactory, ::Zenject::IFactory_3<TParam1, TParam2, TContract>*>)
class FactoryFromBinder_3___c__2_1;
}
namespace Zenject {
template <typename TParam1, typename TParam2, typename TContract> class FactoryFromBinder_3___c__DisplayClass1_0;
}
namespace Zenject {
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FactoryFromBinder_3);
MARK_GEN_REF_T_PTR(::Zenject::FactoryFromBinder_3___c__2_1);
MARK_GEN_REF_T_PTR(::Zenject::FactoryFromBinder_3___c__DisplayClass1_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryFromBinder_3, "Zenject", "FactoryFromBinder`3");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryFromBinder_3___c__2_1, "Zenject", "FactoryFromBinder`3/<>c__2`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FactoryFromBinder_3___c__DisplayClass1_0, "Zenject", "FactoryFromBinder`3/<>c__DisplayClass1_0");
// [CompilerGenerated]
// Dependencies System.Object, Zenject.IFactory`3<TParam1, TParam2, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TContract, typename TSubFactory>
  requires(::cordl_internals::type_constraint<TSubFactory, ::Zenject::IFactory_3<TParam1, TParam2, TContract>*>)
// Is value type: false
// CS Name: Zenject.FactoryFromBinder`3/<>c__2`1<TParam1,TParam2,TContract,TSubFactory>
class CORDL_TYPE FactoryFromBinder_3___c__2_1 : public ::System::Object {
public:
  // Declarations
  /// @brief Field <>9, offset 0xffffffff, size 0x8
  __declspec(property(get = getStaticF___9, put = setStaticF___9)) ::Zenject::FactoryFromBinder_3___c__2_1<TParam1, TParam2, TContract, TSubFactory>* __9;
  ...
  static inline ::Zenject::FactoryFromBinder_3___c__2_1<TParam1, TParam2, TContract, TSubFactory>* New_ctor();
  ...
  static inline ::Zenject::FactoryFromBinder_3___c__2_1<TParam1, TParam2, TContract, TSubFactory>* getStaticF___9();
  ...
  static inline void setStaticF___9(::Zenject::FactoryFromBinder_3___c__2_1<TParam1, TParam2, TContract, TSubFactory>* value);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactoryFromBinder_3___c__2_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_3___c__2_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_3___c__2_1(FactoryFromBinder_3___c__2_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_3___c__2_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryFromBinder_3___c__2_1(FactoryFromBinder_3___c__2_1const&) = delete;
...
// Is value type: false
// CS Name: Zenject.FactoryFromBinder`3/<>c__DisplayClass1_0<TParam1,TParam2,TContract>
class CORDL_TYPE FactoryFromBinder_3___c__DisplayClass1_0 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::FactoryFromBinder_3___c__DisplayClass1_0<TParam1, TParam2, TContract>* New_ctor();
  ...
  constexpr ::System::Func_4<::Zenject::DiContainer*, TParam1, TParam2, TContract>* const& __cordl_internal_get_method() const;
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr FactoryFromBinder_3___c__DisplayClass1_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_3___c__DisplayClass1_0", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_3___c__DisplayClass1_0(FactoryFromBinder_3___c__DisplayClass1_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_3___c__DisplayClass1_0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryFromBinder_3___c__DisplayClass1_0(FactoryFromBinder_3___c__DisplayClass1_0const&) = delete;
...
// [NoReflectionBaking]
// Dependencies Zenject.FactoryFromBinderBase, Zenject.IFactory`3<TParam1, TParam2, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TContract>
// Is value type: false
...
public:
  // Declarations
  template <typename TSubFactory> using __c__2_1 = ::Zenject::FactoryFromBinder_3___c__2_1<TParam1, TParam2, TContract, TSubFactory>;

  using __c__DisplayClass1_0 = ::Zenject::FactoryFromBinder_3___c__DisplayClass1_0<TParam1, TParam2, TContract>;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  FactoryFromBinder_3(FactoryFromBinder_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "FactoryFromBinder_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  FactoryFromBinder_3(FactoryFromBinder_3const&) = delete;
