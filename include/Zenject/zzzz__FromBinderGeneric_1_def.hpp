...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::FromBinderGeneric_1);
MARK_GEN_REF_T_PTR(::Zenject::FromBinderGeneric_1___c__1_1);
MARK_GEN_REF_T_PTR(::Zenject::FromBinderGeneric_1___c__DisplayClass14_0);
MARK_GEN_REF_T_PTR(::Zenject::FromBinderGeneric_1___c__DisplayClass15_0);
MARK_GEN_REF_T_PTR(::Zenject::FromBinderGeneric_1___c__DisplayClass3_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FromBinderGeneric_1, "Zenject", "FromBinderGeneric`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::FromBinderGeneric_1___c__1_1, "Zenject", "FromBinderGeneric`1/<>c__1`1");
