...
namespace Zenject {
template<typename TContract>
class FromBinderGeneric_1___c__DisplayClass14_0;
}
namespace Zenject {
template<typename TContract>
class FromBinderGeneric_1___c__DisplayClass15_0;
}
namespace Zenject {
template<typename TContract>
class FromBinderGeneric_1___c__DisplayClass3_0;
}
namespace Zenject {
...
using __c__1_1 = ::Zenject::FromBinderGeneric_1___c__1_1<TContract, TFactory>;
