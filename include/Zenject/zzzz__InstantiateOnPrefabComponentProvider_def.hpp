...
public:
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x4b3d8fc, size 0x168, virtual true, abstract: false, final true
  inline void GetAllInstancesWithInjectSplit(::Zenject::InjectContext* context, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* args, ::ByRef<::System::Action*> injectAction,
                                             ::System::Collections::Generic::List_1<::System::Object*>* buffer);

  /// @brief Method GetInstanceType, addr 0x4b3d8f4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b3d8b8, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* componentType, ::Zenject::IPrefabInstantiator* prefabInstantiator);

  /// @brief Method get_IsCached, addr 0x4b3d8e4, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x4b3d8ec, size 0x8, virtual true, abstract: false, final true
