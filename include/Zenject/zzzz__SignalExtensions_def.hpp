...
public:
  ...
  /// @brief Method CreateDefaultSignalDeclarationBindInfo, addr 0x6e42f60, size 0x8c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::SignalExtensions) == 0x10, "Size mismatch!");
