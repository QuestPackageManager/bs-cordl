...
namespace Zenject {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11132), inst: 3907 }), TypeDefinitionIndex(TypeDefinitionIndex(11132)),
// TypeDefinitionIndex(TypeDefinitionIndex(14882))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11301)) CS Name: ::Zenject::AnimatorInstaller*
