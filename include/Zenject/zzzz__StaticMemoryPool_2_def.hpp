...
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(10227)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10227), inst: 179 })]
...
public:
  ...
  constexpr ::cordl_internals::to_const_pointer<::System::Action_2<TParam1, TValue>*> const& __cordl_internal_get__onSpawnMethod() const;
