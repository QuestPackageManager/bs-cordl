...
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11085), inst: 180 }), TypeDefinitionIndex(TypeDefinitionIndex(11085))}
...
public:
  ...
  __declspec(property(get = __get__onSpawnMethod, put = __set__onSpawnMethod))::System::Action_2<TParam1, TValue>* _onSpawnMethod;
  ...
  constexpr ::System::Action_2<TParam1, TValue>*& __get__onSpawnMethod();

  constexpr ::cordl_internals::to_const_pointer<::System::Action_2<TParam1, TValue>*> const& __get__onSpawnMethod() const;
