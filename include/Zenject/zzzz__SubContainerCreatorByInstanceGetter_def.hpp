...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x3457614, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x34575ec, size 0x28, virtual false, abstract: false, final false
