...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6d30d80, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d30d78, size 0x8, virtual false, abstract: false, final false
