...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6cbe47c, size 0x88, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6cbe474, size 0x8, virtual false, abstract: false, final false
