...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x3072788, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3072760, size 0x28, virtual false, abstract: false, final false
