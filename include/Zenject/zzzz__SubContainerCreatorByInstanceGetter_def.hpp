...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x4b3f01c, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b3eff4, size 0x28, virtual false, abstract: false, final false
