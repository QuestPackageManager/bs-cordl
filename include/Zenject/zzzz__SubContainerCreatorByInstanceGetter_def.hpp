...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x4b42280, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b42258, size 0x28, virtual false, abstract: false, final false
