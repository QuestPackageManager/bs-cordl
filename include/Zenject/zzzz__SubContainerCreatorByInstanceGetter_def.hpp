...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x4b44ed8, size 0x84, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b44eb0, size 0x28, virtual false, abstract: false, final false
