...
public:
  ...
  /// @brief Method AddInstance, addr 0x3013a60, size 0x58, virtual false, abstract: false, final false
  inline void AddInstance(::System::Object* instance);

  /// @brief Method AddInstances, addr 0x3013ab8, size 0x58, virtual false, abstract: false, final false
  inline void AddInstances(::System::Collections::Generic::IEnumerable_1<::System::Object*>* instances);

  /// @brief Method LazyInject, addr 0x3013b10, size 0x7c, virtual false, abstract: false, final false
  inline void LazyInject(::System::Object* instance);

  /// @brief Method LazyInjectAll, addr 0x3013b8c, size 0x21c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x30139c8, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::DiContainer* container);

  /// @brief Method get_Instances, addr 0x3013a58, size 0x8, virtual false, abstract: false, final false
