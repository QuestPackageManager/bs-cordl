...
public:
  ...
  /// @brief Method AddInstance, addr 0x6d29bfc, size 0x70, virtual false, abstract: false, final false
  inline void AddInstance(::System::Object* instance);

  /// @brief Method AddInstances, addr 0x6d29c6c, size 0x64, virtual false, abstract: false, final false
  inline void AddInstances(::System::Collections::Generic::IEnumerable_1<::System::Object*>* instances);

  /// @brief Method LazyInject, addr 0x6d29cd0, size 0x8c, virtual false, abstract: false, final false
  inline void LazyInject(::System::Object* instance);

  /// @brief Method LazyInjectAll, addr 0x6d29d5c, size 0x1fc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d29b74, size 0x80, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::DiContainer* container);

  /// @brief Method get_Instances, addr 0x6d29bf4, size 0x8, virtual false, abstract: false, final false
