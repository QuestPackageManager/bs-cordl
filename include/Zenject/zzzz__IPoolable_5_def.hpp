...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IPoolable_5);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IPoolable_5, "Zenject", "IPoolable`5");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPoolable_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPoolable_5(IPoolable_5const&) = delete;
