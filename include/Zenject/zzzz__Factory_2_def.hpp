...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::Factory_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::Factory_2, "Zenject", "Factory`2");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Factory_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Factory_2(Factory_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Factory_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Factory_2(Factory_2const&) = delete;
