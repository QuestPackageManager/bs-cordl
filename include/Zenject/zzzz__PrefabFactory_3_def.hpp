...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PrefabFactory_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PrefabFactory_3, "Zenject", "PrefabFactory`3");
...
public:
  ...
  constexpr operator ::Zenject::IFactory_4<::UnityW<::UnityEngine::Object>, P1, P2, T>*() noexcept;
  ...
  constexpr ::Zenject::IFactory_4<::UnityW<::UnityEngine::Object>, P1, P2, T>* i___Zenject__IFactory_4___UnityW___UnityEngine__Object__P1_P2_T_() noexcept;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrefabFactory_3(PrefabFactory_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrefabFactory_3(PrefabFactory_3const&) = delete;
