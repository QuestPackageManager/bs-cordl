...
public:
  ...
  /// @brief Method UpdateItem, addr 0x6e97bd8, size 0xa0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e97c78, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
