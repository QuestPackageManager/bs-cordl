...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15733)), TypeDefinitionIndex(TypeDefinitionIndex(11337)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11337), inst:
// 4196 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(11340)) CS Name: ::Zenject::FixedTickablesTaskUpdater*
class CORDL_TYPE FixedTickablesTaskUpdater : public ::Zenject::TaskUpdater_1<::Zenject::IFixedTickable*> {
public:
  // Declarations
  /// @brief Method UpdateItem addr 0x2f1941c size 0x9c virtual true final false
  inline void UpdateItem(::Zenject::IFixedTickable* task);

  static inline ::Zenject::FixedTickablesTaskUpdater* New_ctor();

  /// @brief Method .ctor addr 0x2f194b8 size 0x48 virtual false final false
  inline void _ctor();

  /// @brief Method __zenCreate addr 0x2f19500 size 0x58 virtual false final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo addr 0x2f19558 size 0x1c0 virtual false final false
