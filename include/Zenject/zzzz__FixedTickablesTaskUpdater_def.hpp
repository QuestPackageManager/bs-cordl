...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15683)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11265), inst: 4100 }),
// TypeDefinitionIndex(TypeDefinitionIndex(11265))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11268)) CS Name: ::Zenject::FixedTickablesTaskUpdater*
class CORDL_TYPE FixedTickablesTaskUpdater : public ::Zenject::TaskUpdater_1<::Zenject::IFixedTickable*> {
public:
  // Declarations
  /// @brief Method UpdateItem addr 0x2db164c size 0x9c virtual true final false
  inline void UpdateItem(::Zenject::IFixedTickable* task);

  static inline ::Zenject::FixedTickablesTaskUpdater* New_ctor();

  /// @brief Method .ctor addr 0x2db16e8 size 0x48 virtual false final false
  inline void _ctor();

  /// @brief Method __zenCreate addr 0x2db1730 size 0x58 virtual false final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo addr 0x2db1788 size 0x1c0 virtual false final false
