...
public:
  ...
  /// @brief Method WithId, addr 0x6e47a04, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::ConcreteBinderNonGeneric* WithId(::System::Object* identifier);

  /// @brief Method .ctor, addr 0x6e479f8, size 0xc, virtual false, abstract: false, final false
