...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrefabFactory_1(PrefabFactory_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrefabFactory_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrefabFactory_1(PrefabFactory_1const&) = delete;
