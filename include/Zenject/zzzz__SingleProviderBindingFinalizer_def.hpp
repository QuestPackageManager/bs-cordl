...
public:
  ...
  /// @brief Method OnFinalizeBinding, addr 0x34336ac, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3433680, size 0x2c, virtual false, abstract: false, final false
