...
public:
  ...
  /// @brief Method OnFinalizeBinding, addr 0x6c9b3a4, size 0xd8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c9b39c, size 0x8, virtual false, abstract: false, final false
