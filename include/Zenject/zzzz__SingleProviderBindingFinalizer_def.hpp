...
public:
  ...
  /// @brief Method OnFinalizeBinding, addr 0x363a3e4, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x363a3b8, size 0x2c, virtual false, abstract: false, final false
