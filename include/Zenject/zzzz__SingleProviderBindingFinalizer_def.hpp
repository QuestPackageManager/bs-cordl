...
public:
  ...
  /// @brief Method OnFinalizeBinding, addr 0x4b1e060, size 0xc4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b1e034, size 0x2c, virtual false, abstract: false, final false
