...
public:
  ...
  /// @brief Method WithGameObjectName, addr 0x4b15e80, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::TransformScopeConcreteIdArgConditionCopyNonLazyBinder* WithGameObjectName(::StringW gameObjectName);

  /// @brief Method .ctor, addr 0x4b087a0, size 0x8, virtual false, abstract: false, final false
