...
public:
  ...
  /// @brief Method WithGameObjectName, addr 0x6d03454, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::TransformScopeConcreteIdArgConditionCopyNonLazyBinder* WithGameObjectName(::StringW gameObjectName);

  /// @brief Method .ctor, addr 0x6d0343c, size 0xc, virtual false, abstract: false, final false
