...
public:
  ...
  /// @brief Method WithGameObjectName, addr 0x3426fdc, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::TransformScopeConcreteIdArgConditionCopyNonLazyBinder* WithGameObjectName(::StringW gameObjectName);

  /// @brief Method .ctor, addr 0x341933c, size 0x28, virtual false, abstract: false, final false
