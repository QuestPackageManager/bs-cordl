...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6e87090, size 0x18c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e86ff0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e86f00, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::DiContainer* container, ::Zenject::SubContainerCreatorBindInfo* containerBindInfo, ::System::Type* installerType,
                    ::System::Collections::Generic::IEnumerable_1<::Zenject::TypeValuePair>* extraArgs);
