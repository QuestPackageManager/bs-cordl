...
/// @brief Method CreateSubContainer, addr 0x6cc0660, size 0x190, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x6cc0658, size 0x8, virtual false, abstract: false, final false
