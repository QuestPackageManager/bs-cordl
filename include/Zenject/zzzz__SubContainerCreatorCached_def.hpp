...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6e890dc, size 0x190, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e890d4, size 0x8, virtual false, abstract: false, final false
