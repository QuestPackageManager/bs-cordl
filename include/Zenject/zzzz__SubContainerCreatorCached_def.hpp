...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6d328a4, size 0x190, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d3289c, size 0x8, virtual false, abstract: false, final false
