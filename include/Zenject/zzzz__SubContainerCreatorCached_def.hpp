...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x3459348, size 0x180, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3459320, size 0x28, virtual false, abstract: false, final false
