...
public:
  ...
  /// @brief Method .ctor, addr 0x2f32e54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x2f32e5c, size 0x178, virtual false, abstract: false, final false
