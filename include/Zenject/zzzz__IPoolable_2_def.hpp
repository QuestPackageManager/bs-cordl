...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IPoolable_2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IPoolable_2, "Zenject", "IPoolable`2");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPoolable_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPoolable_2(IPoolable_2const&) = delete;
