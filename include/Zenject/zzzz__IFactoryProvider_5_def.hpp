...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IFactoryProvider_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IFactoryProvider_5(IFactoryProvider_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IFactoryProvider_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFactoryProvider_5(IFactoryProvider_5const&) = delete;
