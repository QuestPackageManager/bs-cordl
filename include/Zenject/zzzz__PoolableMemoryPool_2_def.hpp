...
// Dependencies Zenject.IPoolable`1<TParam1>, Zenject.MemoryPool`2<TParam1, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_1<TParam1>*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPool_2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableMemoryPool_2(PoolableMemoryPool_2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPool_2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableMemoryPool_2(PoolableMemoryPool_2const&) = delete;
