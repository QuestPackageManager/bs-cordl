...
namespace Zenject {
template<typename T>
class InstantiateCallbackConditionCopyNonLazyBinder___c__DisplayClass2_0_1;
}
...
// Declarations
template<typename T>
using __c__DisplayClass2_0_1 = ::Zenject::InstantiateCallbackConditionCopyNonLazyBinder___c__DisplayClass2_0_1<T>;

static inline ::Zenject::InstantiateCallbackConditionCopyNonLazyBinder* New_ctor(::Zenject::BindInfo*  bindInfo) ;

/// @brief Method OnInstantiated, addr 0x6c91304, size 0x18, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6c912fc, size 0x8, virtual false, abstract: false, final false
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::InstantiateCallbackConditionCopyNonLazyBinder___c__DisplayClass2_0_1, "Zenject", "InstantiateCallbackConditionCopyNonLazyBinder/<>c__DisplayClass2_0`1");
