...
public:
  ...
  /// @brief Method OnInstantiated, addr 0x4b12de8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b12de0, size 0x8, virtual false, abstract: false, final false
