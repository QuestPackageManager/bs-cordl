...
public:
  ...
  /// @brief Method OnInstantiated, addr 0x4b102a8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b102a0, size 0x8, virtual false, abstract: false, final false
