...
public:
  ...
  /// @brief Method Equals, addr 0x4afd52c, size 0x90, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* that);

  /// @brief Method Equals, addr 0x4afd5bc, size 0xb0, virtual true, abstract: false, final true
  inline bool Equals(::Zenject::SignalSubscriptionId that);

  /// @brief Method GetHashCode, addr 0x4afd4e4, size 0x48, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method .ctor, addr 0x4afd4c4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::BindingId signalId, ::System::Object* callback);

  /// @brief Method get_Callback, addr 0x4afd4dc, size 0x8, virtual false, abstract: false, final false
  inline ::System::Object* get_Callback();

  /// @brief Method get_SignalId, addr 0x4afd4d0, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method op_Equality, addr 0x4afd66c, size 0x30, virtual false, abstract: false, final false
  static inline bool op_Equality(::Zenject::SignalSubscriptionId left, ::Zenject::SignalSubscriptionId right);

  /// @brief Method op_Inequality, addr 0x4afd69c, size 0x34, virtual false, abstract: false, final false
