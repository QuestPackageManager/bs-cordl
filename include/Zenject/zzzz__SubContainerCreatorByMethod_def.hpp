...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x30728b0, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3072874, size 0x3c, virtual false, abstract: false, final false
