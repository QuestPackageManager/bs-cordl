...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6c556d0, size 0x9c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c556c4, size 0xc, virtual false, abstract: false, final false
