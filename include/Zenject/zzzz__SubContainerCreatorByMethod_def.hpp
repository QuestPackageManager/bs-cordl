...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x4b423a8, size 0x98, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b4236c, size 0x3c, virtual false, abstract: false, final false
