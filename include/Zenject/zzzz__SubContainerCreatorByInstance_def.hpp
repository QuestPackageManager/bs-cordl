...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6cbe408, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6cbe400, size 0x8, virtual false, abstract: false, final false
