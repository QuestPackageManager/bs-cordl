...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6e87544, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e8753c, size 0x8, virtual false, abstract: false, final false
