...
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TParam6, typename TParam7, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::UnityEngine::Component*> &&
           ::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>*>)
...
// Dependencies UnityEngine.Component, Zenject.IPoolable`7<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>, Zenject.MemoryPool`8<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6,
// TParam7, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TParam6, typename TParam7, typename TValue>
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoPoolableMemoryPool_8", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoPoolableMemoryPool_8(MonoPoolableMemoryPool_8&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoPoolableMemoryPool_8", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoPoolableMemoryPool_8(MonoPoolableMemoryPool_8const&) = delete;
