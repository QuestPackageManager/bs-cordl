...
// Write type traits
MARK_GEN_REF_PTR_T(::Zenject::PlaceholderFactory_5);
MARK_GEN_REF_PTR_T(::Zenject::PlaceholderFactory_5__get_ParamTypes_d__2);
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_5__get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_5__get_ParamTypes_d__2(PlaceholderFactory_5__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_5__get_ParamTypes_d__2", modifiers: "const&", def_value: None }]
...
// Dependencies Zenject.IFactory, Zenject.IFactory`5<TParam1, TParam2, TParam3, TParam4, TValue>, Zenject.PlaceholderFactoryBase`1<TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TValue>
// Is value type: false
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::PlaceholderFactory_5__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`5/<get_ParamTypes>d__2");
