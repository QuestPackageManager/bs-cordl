#pragma once
// IWYU pragma private; include "Zenject/PlaceholderFactory_5.hpp"
...
#include <cstdint>
CORDL_MODULE_EXPORT(PlaceholderFactory_5)
...
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TValue> class PlaceholderFactory_5__get_ParamTypes_d__2;
}
// Forward declare root types
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TValue> class PlaceholderFactory_5;
}
namespace Zenject {
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TValue> class PlaceholderFactory_5__get_ParamTypes_d__2;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_5);
MARK_GEN_REF_T_PTR(::Zenject::PlaceholderFactory_5__get_ParamTypes_d__2);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_5, "Zenject", "PlaceholderFactory`5");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PlaceholderFactory_5__get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`5/<get_ParamTypes>d__2");
// [CompilerGenerated]
...
// Is value type: false
// CS Name: Zenject.PlaceholderFactory`5/<get_ParamTypes>d__2<TParam1,TParam2,TParam3,TParam4,TValue>
class CORDL_TYPE PlaceholderFactory_5__get_ParamTypes_d__2 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::PlaceholderFactory_5__get_ParamTypes_d__2<TParam1, TParam2, TParam3, TParam4, TValue>* New_ctor(int32_t __1__state);
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_5__get_ParamTypes_d__2();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_5__get_ParamTypes_d__2", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_5__get_ParamTypes_d__2(PlaceholderFactory_5__get_ParamTypes_d__2&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_5__get_ParamTypes_d__2", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_5__get_ParamTypes_d__2(PlaceholderFactory_5__get_ParamTypes_d__2 const&) = delete;
...
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TValue>
// Is value type: false
// CS Name: Zenject.PlaceholderFactory`5<TParam1,TParam2,TParam3,TParam4,TValue>
class CORDL_TYPE PlaceholderFactory_5 : public ::Zenject::PlaceholderFactoryBase_1<TValue> {
public:
  // Declarations
  using _get_ParamTypes_d__2 = ::Zenject::PlaceholderFactory_5__get_ParamTypes_d__2<TParam1, TParam2, TParam3, TParam4, TValue>;
  ...
  static inline ::Zenject::PlaceholderFactory_5<TParam1, TParam2, TParam3, TParam4, TValue>* New_ctor();
  ...
  /// [IteratorStateMachine(typeof(Zenject.PlaceholderFactory`5::<get_ParamTypes>d__2<TParam1, TParam2, TParam3, TParam4, TValue>))]
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PlaceholderFactory_5();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PlaceholderFactory_5(PlaceholderFactory_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PlaceholderFactory_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PlaceholderFactory_5(PlaceholderFactory_5 const&) = delete;
