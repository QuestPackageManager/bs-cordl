...
public:
  // Declarations
  /// @brief Method InstallBindings, addr 0x2f04cb0, size 0x4, virtual true, abstract: false, final false
  inline void InstallBindings(::Zenject::DiContainer* container);

  /// @brief Method PostInstall, addr 0x2f04cb4, size 0x4, virtual true, abstract: false, final false
  inline void PostInstall(::Zenject::DiContainer* container);

  static inline ::Zenject::NoTransitionInstaller* New_ctor();

  /// @brief Method .ctor, addr 0x2f04cb8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x2f04cc0, size 0x178, virtual false, abstract: false, final false
