...
template <typename TBase, typename TKey> inline TBase Zenject::KeyedFactory_2<TBase, TKey>::Create(TKey key) {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::KeyedFactory_2<TBase, TKey>*>::get(), "Create", std::vector<Il2CppClass*>{},
