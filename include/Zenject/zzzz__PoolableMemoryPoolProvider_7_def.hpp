...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_7", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableMemoryPoolProvider_7(PoolableMemoryPoolProvider_7&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_7", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableMemoryPoolProvider_7(PoolableMemoryPoolProvider_7const&) = delete;
