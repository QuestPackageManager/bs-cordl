...
template <typename TParam1, typename TParam2, typename TValue>
constexpr ::cordl_internals::to_const_pointer<::System::Action_3<TParam1, TParam2, TValue>*> const& Zenject::StaticMemoryPool_3<TParam1, TParam2, TValue>::__cordl_internal_get__onSpawnMethod() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->____onSpawnMethod;
}
template <typename TParam1, typename TParam2, typename TValue>
