...
public:
  ...
  /// @brief Method GetAllInstances, addr 0x6d2d570, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllInstances, addr 0x6d2d4f4, size 0x7c, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x6d2d3f0, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x6d2d8f0, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Object* GetInstance(::Zenject::IProvider* creator, ::Zenject::InjectContext* context);

  /// @brief Method GetInstance, addr 0x6d2d964, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetInstance, addr 0x6d2d66c, size 0x74, virtual false, abstract: false, final false
  static inline ::System::Object* TryGetInstance(::Zenject::IProvider* creator, ::Zenject::InjectContext* context);

  /// @brief Method TryGetInstance, addr 0x6d2d6e0, size 0x210, virtual false, abstract: false, final false
