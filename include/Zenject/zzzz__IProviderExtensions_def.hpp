...
public:
  ...
  /// @brief Method GetAllInstances, addr 0x3688144, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllInstances, addr 0x36880cc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x3687fd0, size 0xfc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetInstance, addr 0x3688498, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Object* GetInstance(::Zenject::IProvider* creator, ::Zenject::InjectContext* context);

  /// @brief Method GetInstance, addr 0x3688508, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method TryGetInstance, addr 0x368823c, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Object* TryGetInstance(::Zenject::IProvider* creator, ::Zenject::InjectContext* context);

  /// @brief Method TryGetInstance, addr 0x36882ac, size 0x1ec, virtual false, abstract: false, final false
