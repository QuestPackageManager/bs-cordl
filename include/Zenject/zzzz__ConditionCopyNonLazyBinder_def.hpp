...
// Write type traits
MARK_REF_T(::Zenject::ConditionCopyNonLazyBinder*);
MARK_GEN_REF_T_PTR(::Zenject::ConditionCopyNonLazyBinder___c__4_1);
MARK_GEN_REF_T_PTR(::Zenject::ConditionCopyNonLazyBinder___c__5_1);
MARK_REF_T(::Zenject::ConditionCopyNonLazyBinder___c__DisplayClass2_0*);
MARK_REF_T(::Zenject::ConditionCopyNonLazyBinder___c__DisplayClass3_0*);
MARK_REF_T(::Zenject::ConditionCopyNonLazyBinder___c__DisplayClass3_1*);
DEFINE_IL2CPP_CLASS(::Zenject::ConditionCopyNonLazyBinder*, "Zenject", "ConditionCopyNonLazyBinder");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ConditionCopyNonLazyBinder___c__4_1, "Zenject", "ConditionCopyNonLazyBinder/<>c__4`1");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::ConditionCopyNonLazyBinder___c__5_1, "Zenject", "ConditionCopyNonLazyBinder/<>c__5`1");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_targets, put = __cordl_internal_set_targets)) ::ArrayW<::System::Type*> targets;
  ...
  constexpr ::ArrayW<::System::Type*>& __cordl_internal_get_targets();
...
// Non member Declarations
static_assert(sizeof(::Zenject::ConditionCopyNonLazyBinder) == 0x20, "Size mismatch!");
