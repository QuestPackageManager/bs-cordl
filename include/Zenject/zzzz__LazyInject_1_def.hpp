...
public:
  // Ctor Parameters [CppParam { name: "", ty: "LazyInject_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  LazyInject_1(LazyInject_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "LazyInject_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  LazyInject_1(LazyInject_1const&) = delete;
