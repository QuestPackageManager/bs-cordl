...
inline void Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>::AddInstallers(::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* args,
  ...
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::SubContainerCreatorByNewPrefabMethod_2<TParam1, TParam2>*>::get(), "AddInstallers", std::vector<Il2CppClass*>{},
