...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IPoolable_8);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IPoolable_8, "Zenject", "IPoolable`8");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IPoolable_8", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IPoolable_8(IPoolable_8const&) = delete;
