...
// Write type traits
MARK_GEN_REF_PTR_T(::Zenject::MonoMemoryPool_2);
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11039)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11039), inst: 3482 })}
