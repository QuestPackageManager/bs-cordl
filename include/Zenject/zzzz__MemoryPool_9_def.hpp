...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::MemoryPool_9);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::MemoryPool_9, "Zenject", "MemoryPool`9");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_9", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_9(MemoryPool_9&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_9", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_9(MemoryPool_9const&) = delete;
