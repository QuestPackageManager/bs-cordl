...
public:
  ...
  /// @brief Method WithId, addr 0x4b079b4, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder* WithId(::System::Object* identifier);

  /// @brief Method .ctor, addr 0x4b0796c, size 0x24, virtual false, abstract: false, final false
