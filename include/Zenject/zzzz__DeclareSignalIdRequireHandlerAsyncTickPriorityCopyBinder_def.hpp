...
public:
  ...
  /// @brief Method WithId, addr 0x6c7a18c, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::DeclareSignalRequireHandlerAsyncTickPriorityCopyBinder* WithId(::System::Object* identifier);

  /// @brief Method .ctor, addr 0x6c7a144, size 0x24, virtual false, abstract: false, final false
