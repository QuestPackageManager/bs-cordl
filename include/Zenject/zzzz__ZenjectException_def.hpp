...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ZenjectException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ZenjectException(ZenjectException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ZenjectException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ZenjectException(ZenjectExceptionconst&) = delete;
