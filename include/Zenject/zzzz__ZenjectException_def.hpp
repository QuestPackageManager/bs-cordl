...
public:
  ...
  /// @brief Method .ctor, addr 0x36b744c, size 0x68, virtual false, abstract: false, final false
  inline void _ctor(::StringW message);

  /// @brief Method .ctor, addr 0x36b74b4, size 0x70, virtual false, abstract: false, final false
