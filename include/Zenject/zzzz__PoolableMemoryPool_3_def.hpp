...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PoolableMemoryPool_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PoolableMemoryPool_3, "Zenject", "PoolableMemoryPool`3");
// Dependencies Zenject.IPoolable`2<TParam1, TParam2>, Zenject.MemoryPool`3<TParam1, TParam2, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::Zenject::IPoolable_2<TParam1, TParam2>*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPool_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableMemoryPool_3(PoolableMemoryPool_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPool_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableMemoryPool_3(PoolableMemoryPool_3const&) = delete;
