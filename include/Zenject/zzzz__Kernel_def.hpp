...
public:
  ...
  /// @brief Method Dispose, addr 0x6e93628, size 0x14, virtual true, abstract: false, final false
  inline void Dispose();

  /// @brief Method FixedTick, addr 0x6e937d8, size 0x14, virtual true, abstract: false, final false
  inline void FixedTick();

  /// @brief Method Initialize, addr 0x6e93614, size 0x14, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method LateDispose, addr 0x6e9363c, size 0x14, virtual true, abstract: false, final false
  inline void LateDispose();

  /// @brief Method LateTick, addr 0x6e93714, size 0x14, virtual true, abstract: false, final false
  inline void LateTick();

  static inline ::Zenject::Kernel* New_ctor();

  /// @brief Method Tick, addr 0x6e93650, size 0x14, virtual true, abstract: false, final false
  inline void Tick();
  ...
  /// @brief Method __zenFieldSetter0, addr 0x6e938e4, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter0(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method __zenFieldSetter1, addr 0x6e93a08, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter1(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method __zenFieldSetter2, addr 0x6e93b2c, size 0x124, virtual false, abstract: false, final false
  static inline void __zenFieldSetter2(::System::Object* P_0, ::System::Object* P_1);

  /// @brief Method .ctor, addr 0x6e9389c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
