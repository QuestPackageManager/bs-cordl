...
// Dependencies UnityEngine.Component, Zenject.MemoryPool`6<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2, typename TParam3, typename TParam4, typename TParam5, typename TValue>
  requires(::cordl_internals::type_constraint<TValue, ::UnityEngine::Component*>)
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoMemoryPool_6(MonoMemoryPool_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoMemoryPool_6(MonoMemoryPool_6const&) = delete;
