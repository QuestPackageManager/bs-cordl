...
public:
  ...
  /// @brief Method <FinalizeBinding>b__8_0, addr 0x304cdcc, size 0x58, virtual false, abstract: false, final false
  inline ::StringW _FinalizeBinding_b__8_0(::System::Type* x);

  /// @brief Method <GetScope>b__7_0, addr 0x304cd74, size 0x58, virtual false, abstract: false, final false
  inline ::StringW _GetScope_b__7_0(::System::Type* x);

  /// @brief Method __zenCreate, addr 0x304ce24, size 0x5c, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x304ce80, size 0x1c0, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x304cd6c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method FinalizeBinding, addr 0x304beec, size 0x370, virtual true, abstract: false, final true
  inline void FinalizeBinding(::Zenject::DiContainer* container);

  /// @brief Method GetScope, addr 0x304971c, size 0x24c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterProvider, addr 0x304c25c, size 0x254, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterProviderForAllContracts, addr 0x304c674, size 0x1e8, virtual false, abstract: false, final false
  inline void RegisterProviderForAllContracts(::Zenject::DiContainer* container, ::Zenject::IProvider* provider);

  /// @brief Method RegisterProviderPerContract, addr 0x3049f14, size 0x214, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterProvidersForAllContractsPerConcreteType, addr 0x3049968, size 0x59c, virtual false, abstract: false, final false
  ...
  /// @brief Method RegisterProvidersPerContractAndConcreteType, addr 0x304c85c, size 0x2cc, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateBindTypes, addr 0x304cb28, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3049004, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::BindInfo* bindInfo);

  /// @brief Method get_BindInfo, addr 0x304bedc, size 0x8, virtual false, abstract: false, final false
  inline ::Zenject::BindInfo* get_BindInfo();

  /// @brief Method get_BindingInheritanceMethod, addr 0x304bec0, size 0x1c, virtual true, abstract: false, final true
  ...
  /// @brief Method set_BindInfo, addr 0x304bee4, size 0x8, virtual false, abstract: false, final false
