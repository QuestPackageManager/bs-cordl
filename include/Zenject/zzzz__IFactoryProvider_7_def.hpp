...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IFactoryProvider_7);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IFactoryProvider_7, "Zenject", "IFactoryProvider`7");
// [NoReflectionBaking]
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "IFactoryProvider_7", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  IFactoryProvider_7(IFactoryProvider_7&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "IFactoryProvider_7", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IFactoryProvider_7(IFactoryProvider_7const&) = delete;
