...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodProviderWithContainer_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodProviderWithContainer_1(MethodProviderWithContainer_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodProviderWithContainer_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodProviderWithContainer_1(MethodProviderWithContainer_1const&) = delete;
