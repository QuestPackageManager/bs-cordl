...
public:
  ...
  /// @brief Method .ctor, addr 0x3046148, size 0x90, virtual false, abstract: false, final false
  inline void _ctor(::System::Type* factoryType);

  /// @brief Method get_Arguments, addr 0x30461f8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* get_Arguments();

  /// @brief Method get_FactoryType, addr 0x30461d8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Type* get_FactoryType();

  /// @brief Method get_ProviderFunc, addr 0x30461e8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Func_2<::Zenject::DiContainer*, ::Zenject::IProvider*>* get_ProviderFunc();

  /// @brief Method set_Arguments, addr 0x3046200, size 0x8, virtual false, abstract: false, final false
  inline void set_Arguments(::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* value);

  /// @brief Method set_FactoryType, addr 0x30461e0, size 0x8, virtual false, abstract: false, final false
  inline void set_FactoryType(::System::Type* value);

  /// @brief Method set_ProviderFunc, addr 0x30461f0, size 0x8, virtual false, abstract: false, final false
