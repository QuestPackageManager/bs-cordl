...
/// @brief Field <Arguments>k__BackingField, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__Arguments_k__BackingField, put=__cordl_internal_set__Arguments_k__BackingField)) ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*  _Arguments_k__BackingField;
...
/// @brief Field <ProviderFunc>k__BackingField, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__ProviderFunc_k__BackingField, put=__cordl_internal_set__ProviderFunc_k__BackingField)) ::System::Func_2<::Zenject::DiContainer*,::Zenject::IProvider*>*  _ProviderFunc_k__BackingField;
...
/// @brief Method .ctor, addr 0x6d08980, size 0x84, virtual false, abstract: false, final false
inline void _ctor(::System::Type*  factoryType) ;

/// @brief Method get_Arguments, addr 0x6d08a24, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* get_Arguments() ;

/// @brief Method get_FactoryType, addr 0x6d08a04, size 0x8, virtual false, abstract: false, final false
inline ::System::Type* get_FactoryType() ;

/// @brief Method get_ProviderFunc, addr 0x6d08a14, size 0x8, virtual false, abstract: false, final false
inline ::System::Func_2<::Zenject::DiContainer*,::Zenject::IProvider*>* get_ProviderFunc() ;

/// @brief Method set_Arguments, addr 0x6d08a2c, size 0x8, virtual false, abstract: false, final false
inline void set_Arguments(::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*  value) ;

/// @brief Method set_FactoryType, addr 0x6d08a0c, size 0x8, virtual false, abstract: false, final false
inline void set_FactoryType(::System::Type*  value) ;

/// @brief Method set_ProviderFunc, addr 0x6d08a1c, size 0x8, virtual false, abstract: false, final false
