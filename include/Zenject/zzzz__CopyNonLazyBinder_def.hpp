...
public:
  ...
  /// @brief Method AddSecondaryCopyBindInfo, addr 0x4b04f50, size 0xec, virtual false, abstract: false, final false
  inline void AddSecondaryCopyBindInfo(::Zenject::BindInfo* bindInfo);

  /// @brief Method CopyIntoAllSubContainers, addr 0x4aff890, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::NonLazyBinder* CopyIntoAllSubContainers();

  /// @brief Method CopyIntoDirectSubContainers, addr 0x4b05180, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::NonLazyBinder* CopyIntoDirectSubContainers();

  /// @brief Method MoveIntoAllSubContainers, addr 0x4b0519c, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::NonLazyBinder* MoveIntoAllSubContainers();

  /// @brief Method MoveIntoDirectSubContainers, addr 0x4b051b8, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method SetInheritanceMethod, addr 0x4b0503c, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b00d20, size 0x8, virtual false, abstract: false, final false
