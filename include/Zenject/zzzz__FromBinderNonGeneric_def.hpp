...
public:
  ...
  /// @brief Method .ctor, addr 0x2ec6c9c, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method FromInstance, addr 0x2eda054, size 0x4, virtual false, abstract: false, final false
