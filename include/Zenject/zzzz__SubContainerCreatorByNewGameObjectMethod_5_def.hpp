...
class SubContainerCreatorByNewGameObjectMethod_5___c__DisplayClass2_0;
}
namespace Zenject {
...
MARK_GEN_REF_PTR_T(::Zenject::SubContainerCreatorByNewGameObjectMethod_5___c__DisplayClass2_0);
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(::Zenject::SubContainerCreatorByNewGameObjectMethod_5___c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewGameObjectMethod`5/<>c__DisplayClass2_0");
