...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Installer_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Installer_6(Installer_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Installer_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Installer_6(Installer_6const&) = delete;
