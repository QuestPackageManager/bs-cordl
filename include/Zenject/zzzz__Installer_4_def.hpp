...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Installer_4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Installer_4(Installer_4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Installer_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Installer_4(Installer_4const&) = delete;
