...
public:
  ...
  /// @brief Method GetPrefab, addr 0x6d2f344, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d2f33c, size 0x8, virtual false, abstract: false, final false
