...
public:
  ...
  /// @brief Method GetPrefab, addr 0x4b434bc, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b43494, size 0x28, virtual false, abstract: false, final false
