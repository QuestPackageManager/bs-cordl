...
public:
  ...
  /// @brief Method GetPrefab, addr 0x3455b98, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3455b70, size 0x28, virtual false, abstract: false, final false
