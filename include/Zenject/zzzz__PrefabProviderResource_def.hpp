...
public:
  ...
  /// @brief Method GetPrefab, addr 0x3458b94, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3458b6c, size 0x28, virtual false, abstract: false, final false
