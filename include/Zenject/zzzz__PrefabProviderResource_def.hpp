...
public:
  ...
  /// @brief Method GetPrefab, addr 0x4b3a0e0, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b3a0b8, size 0x28, virtual false, abstract: false, final false
