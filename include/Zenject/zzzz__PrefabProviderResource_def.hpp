...
public:
  ...
  /// @brief Method GetPrefab, addr 0x4b400c8, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b400a0, size 0x28, virtual false, abstract: false, final false
