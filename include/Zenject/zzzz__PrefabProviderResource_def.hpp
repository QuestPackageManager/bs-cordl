...
public:
  ...
  /// @brief Method GetPrefab, addr 0x6e85b7c, size 0xd8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e85b74, size 0x8, virtual false, abstract: false, final false
