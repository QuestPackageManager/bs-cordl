...
public:
  ...
  /// @brief Method GetPrefab, addr 0x3070d0c, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3070ce4, size 0x28, virtual false, abstract: false, final false
