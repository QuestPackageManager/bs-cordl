...
public:
  ...
  /// @brief Method GetPrefab, addr 0x4b4c4ec, size 0xcc, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b4c4c4, size 0x28, virtual false, abstract: false, final false
