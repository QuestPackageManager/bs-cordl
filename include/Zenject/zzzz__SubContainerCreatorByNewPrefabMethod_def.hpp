...
public:
  ...
  /// @brief Method AddInstallers, addr 0x6d31e7c, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d31e70, size 0xc, virtual false, abstract: false, final false
