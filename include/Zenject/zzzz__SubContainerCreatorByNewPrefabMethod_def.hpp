...
public:
  ...
  /// @brief Method AddInstallers, addr 0x4ac7200, size 0xb0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4ac71c0, size 0x40, virtual false, abstract: false, final false
