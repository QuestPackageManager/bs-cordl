...
public:
  ...
  /// @brief Method AddInstallers, addr 0x368cd64, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x368cd24, size 0x40, virtual false, abstract: false, final false
