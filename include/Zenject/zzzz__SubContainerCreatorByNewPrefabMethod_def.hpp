...
public:
  ...
  /// @brief Method AddInstallers, addr 0x6cbf578, size 0xd4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6cbf56c, size 0xc, virtual false, abstract: false, final false
