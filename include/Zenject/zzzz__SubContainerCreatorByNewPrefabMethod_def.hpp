...
public:
  ...
  /// @brief Method AddInstallers, addr 0x345b8a0, size 0xb4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x345b860, size 0x40, virtual false, abstract: false, final false
