...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByMethod_3);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByMethod_3, "Zenject", "SubContainerCreatorByMethod`3");
// [NoReflectionBaking]
...
public:
  ...
  constexpr ::System::Action_4<::Zenject::DiContainer*, TParam1, TParam2, TParam3>* const& __cordl_internal_get__installMethod() const;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByMethod_3(SubContainerCreatorByMethod_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByMethod_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByMethod_3(SubContainerCreatorByMethod_3const&) = delete;
