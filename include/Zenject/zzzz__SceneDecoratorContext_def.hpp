...
public:
  ...
  /// @brief Method GetInjectableMonoBehaviours, addr 0x6d1b600, size 0x4c, virtual true, abstract: false, final false
  ...
  /// @brief Method GetRootGameObjects, addr 0x6d1b5d8, size 0x28, virtual true, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::GameObject>>* GetRootGameObjects();

  /// @brief Method Initialize, addr 0x6d19e48, size 0x170, virtual false, abstract: false, final false
  inline void Initialize(::Zenject::DiContainer* container);

  /// @brief Method InstallDecoratorInstallers, addr 0x6d1a62c, size 0xc, virtual false, abstract: false, final false
  inline void InstallDecoratorInstallers();

  /// @brief Method InstallDecoratorSceneBindings, addr 0x6d1a5a8, size 0x84, virtual false, abstract: false, final false
  inline void InstallDecoratorSceneBindings();

  /// @brief Method InstallLateDecoratorInstallers, addr 0x6d1a638, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6d1b774, size 0x148, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6d1b64c, size 0x128, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Container, addr 0x6d1b5b8, size 0x20, virtual true, abstract: false, final false
  inline ::Zenject::DiContainer* get_Container();

  /// @brief Method get_DecoratedContractName, addr 0x6d1b5b0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_DecoratedContractName();

  /// @brief Method get_LateInstallerPrefabs, addr 0x6d1b428, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* get_LateInstallerPrefabs();

  /// @brief Method get_LateInstallers, addr 0x6d1b364, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* get_LateInstallers();

  /// @brief Method get_LateScriptableObjectInstallers, addr 0x6d1b4ec, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_LateInstallerPrefabs, addr 0x6d1b430, size 0xbc, virtual false, abstract: false, final false
  inline void set_LateInstallerPrefabs(::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* value);

  /// @brief Method set_LateInstallers, addr 0x6d1b36c, size 0xbc, virtual false, abstract: false, final false
  inline void set_LateInstallers(::System::Collections::Generic::IEnumerable_1<::UnityW<::Zenject::MonoInstaller>>* value);

  /// @brief Method set_LateScriptableObjectInstallers, addr 0x6d1b4f4, size 0xbc, virtual false, abstract: false, final false
