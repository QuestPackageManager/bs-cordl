...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x301b898, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x301b85c, size 0x3c, virtual false, abstract: false, final false
