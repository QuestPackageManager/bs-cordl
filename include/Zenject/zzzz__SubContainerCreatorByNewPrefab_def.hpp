...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x4b423e8, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b423ac, size 0x3c, virtual false, abstract: false, final false
