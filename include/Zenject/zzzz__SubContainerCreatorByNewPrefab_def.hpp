...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6cbeca8, size 0x1b4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6cbec9c, size 0xc, virtual false, abstract: false, final false
