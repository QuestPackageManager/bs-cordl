...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6d315ac, size 0x1b4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6d315a0, size 0xc, virtual false, abstract: false, final false
