...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x4b3c400, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4b3c3c4, size 0x3c, virtual false, abstract: false, final false
