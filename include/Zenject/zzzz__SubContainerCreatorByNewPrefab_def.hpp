...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x4adb010, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4adafd4, size 0x3c, virtual false, abstract: false, final false
