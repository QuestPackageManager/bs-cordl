...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x6e87de4, size 0x1b4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e87dd8, size 0xc, virtual false, abstract: false, final false
