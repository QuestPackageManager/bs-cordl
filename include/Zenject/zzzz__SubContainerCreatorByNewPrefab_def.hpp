...
public:
  ...
  /// @brief Method CreateSubContainer, addr 0x345af58, size 0x1a4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x345af1c, size 0x3c, virtual false, abstract: false, final false
