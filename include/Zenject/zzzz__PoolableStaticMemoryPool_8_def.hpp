...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableStaticMemoryPool_8", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableStaticMemoryPool_8(PoolableStaticMemoryPool_8&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableStaticMemoryPool_8", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableStaticMemoryPool_8(PoolableStaticMemoryPool_8const&) = delete;
