...
namespace Zenject {
template <typename TParam1, typename TParam2> class SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0;
}
namespace Zenject {
...
namespace Zenject {
template <typename TParam1, typename TParam2> class SubContainerCreatorByNewGameObjectMethod_2;
}
namespace Zenject {
template <typename TParam1, typename TParam2> class SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_2);
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_2, "Zenject", "SubContainerCreatorByNewGameObjectMethod`2");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewGameObjectMethod`2/<>c__DisplayClass2_0");
// Dependencies System.Object
namespace Zenject {
// cpp template
template <typename TParam1, typename TParam2>
// Is value type: false
// CS Name: Zenject.SubContainerCreatorByNewGameObjectMethod`2/<>c__DisplayClass2_0<TParam1,TParam2>
class CORDL_TYPE SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0 : public ::System::Object {
public:
  // Declarations
  ...
  static inline ::Zenject::SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0<TParam1, TParam2>* New_ctor();
  ...
  constexpr ::Zenject::SubContainerCreatorByNewGameObjectMethod_2<TParam1, TParam2>* const& __cordl_internal_get___4__this() const;
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0();

public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0", modifiers: "&&", def_value: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0(SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0", modifiers: "const&", def_value: None }]
...
public:
  // Declarations
  using __c__DisplayClass2_0 = ::Zenject::SubContainerCreatorByNewGameObjectMethod_2___c__DisplayClass2_0<TParam1, TParam2>;
