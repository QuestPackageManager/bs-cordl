...
template <typename TContract> inline void Zenject::FactoryProviderWrapper_1<TContract>::_ctor(::Zenject::IProvider* provider, ::Zenject::InjectContext* injectContext) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryProviderWrapper_1<TContract>*>(),
                                                                                         { ".ctor", {}, { ::i2c::type_of<::Zenject::IProvider*>(), ::i2c::type_of<::Zenject::InjectContext*>() } })));
...
template <typename TContract> inline TContract Zenject::FactoryProviderWrapper_1<TContract>::Create() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryProviderWrapper_1<TContract>*>(), { "Create", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<TContract>(this, ___internal_method);
}
template <typename TContract> inline ::System::Object* Zenject::FactoryProviderWrapper_1<TContract>::__zenCreate(::ArrayW<::System::Object*> P_0) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryProviderWrapper_1<TContract>*>(), { "__zenCreate", {}, { ::i2c::type_of<::ArrayW<::System::Object*>>() } })));
...
template <typename TContract> inline ::Zenject::InjectTypeInfo* Zenject::FactoryProviderWrapper_1<TContract>::__zenCreateInjectTypeInfo() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::FactoryProviderWrapper_1<TContract>*>(), { "__zenCreateInjectTypeInfo", {}, {} })));
...
inline ::Zenject::FactoryProviderWrapper_1<TContract>* Zenject::FactoryProviderWrapper_1<TContract>::New_ctor(::Zenject::IProvider* provider, ::Zenject::InjectContext* injectContext) {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::FactoryProviderWrapper_1<TContract>*>(provider, injectContext));
}
