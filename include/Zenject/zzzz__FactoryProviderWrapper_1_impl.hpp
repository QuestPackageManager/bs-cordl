...
constexpr ::Zenject::IProvider*& Zenject::FactoryProviderWrapper_1<TContract>::__cordl_internal_get__provider()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____provider;
}
template<typename TContract>
constexpr ::Zenject::IProvider* const& Zenject::FactoryProviderWrapper_1<TContract>::__cordl_internal_get__provider() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____provider;
}
template<typename TContract>
constexpr void Zenject::FactoryProviderWrapper_1<TContract>::__cordl_internal_set__provider(::Zenject::IProvider*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____provider, value);
}
template<typename TContract>
constexpr ::Zenject::InjectContext*& Zenject::FactoryProviderWrapper_1<TContract>::__cordl_internal_get__injectContext()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____injectContext;
}
template<typename TContract>
constexpr ::Zenject::InjectContext* const& Zenject::FactoryProviderWrapper_1<TContract>::__cordl_internal_get__injectContext() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____injectContext;
}
template<typename TContract>
constexpr void Zenject::FactoryProviderWrapper_1<TContract>::__cordl_internal_set__injectContext(::Zenject::InjectContext*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
template<typename TContract>
constexpr ::Zenject::IFactory_1<TContract>* Zenject::FactoryProviderWrapper_1<TContract>::i___Zenject__IFactory_1_TContract_() noexcept {
return static_cast<::Zenject::IFactory_1<TContract>*>(static_cast<void*>(this));
}
...
template<typename TContract>
constexpr ::Zenject::IFactory* Zenject::FactoryProviderWrapper_1<TContract>::i___Zenject__IFactory() noexcept {
return static_cast<::Zenject::IFactory*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename TContract>
constexpr ::Zenject::FactoryProviderWrapper_1<TContract>::FactoryProviderWrapper_1()   {
}
