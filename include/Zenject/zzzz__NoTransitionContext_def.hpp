...
/// @brief Field _noScenesTransitionInstaller, offset 0x20, size 0x8 
 __declspec(property(get=__cordl_internal_get__noScenesTransitionInstaller, put=__cordl_internal_set__noScenesTransitionInstaller)) ::UnityW<::Zenject::NoTransitionInstaller>  _noScenesTransitionInstaller;
...
/// @brief Method Awake, addr 0x6d2bfb4, size 0x7c, virtual false, abstract: false, final false
inline void Awake() ;
...
/// @brief Method __zenCreateInjectTypeInfo, addr 0x6d2c034, size 0x148, virtual false, abstract: false, final false
static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() ;

/// @brief Method .ctor, addr 0x6d2c030, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_installMethod, addr 0x6d2becc, size 0x74, virtual false, abstract: false, final false
inline ::System::Action_1<::Zenject::DiContainer*>* get_installMethod() ;

/// @brief Method get_postInstallMethod, addr 0x6d2bf40, size 0x74, virtual false, abstract: false, final false
