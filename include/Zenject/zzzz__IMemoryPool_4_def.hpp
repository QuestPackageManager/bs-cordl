...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::IMemoryPool_4);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::IMemoryPool_4, "Zenject", "IMemoryPool`4");
// Dependencies
namespace Zenject {
// cpp template
...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "IMemoryPool_4", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  IMemoryPool_4(IMemoryPool_4const&) = delete;
