...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr MonoMemoryPool_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoMemoryPool_1(MonoMemoryPool_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoMemoryPool_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoMemoryPool_1(MonoMemoryPool_1const&) = delete;
