...
template <typename T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11086), inst: 2803 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14315), inst: 2578
// }), TypeDefinitionIndex(TypeDefinitionIndex(14315)), TypeDefinitionIndex(TypeDefinitionIndex(11086))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11096)) CS Name: ::Zenject::HashSetPool`1<T>*
