...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11337)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11337), inst: 4201 }),
// TypeDefinitionIndex(TypeDefinitionIndex(15734))} Self: TypeDefinitionIndex(TypeDefinitionIndex(11339)) CS Name: ::Zenject::LateTickablesTaskUpdater*
