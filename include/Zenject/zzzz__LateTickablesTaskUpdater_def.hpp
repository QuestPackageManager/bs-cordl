...
namespace Zenject {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(11337)), TypeDefinitionIndex(TypeDefinitionIndex(15734)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11337), inst:
