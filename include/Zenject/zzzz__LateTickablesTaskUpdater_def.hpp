...
public:
  ...
  /// @brief Method UpdateItem, addr 0x6e9437c, size 0xa0, virtual true, abstract: false, final false
  inline void UpdateItem(::Zenject::ILateTickable* task);

  /// @brief Method __zenCreate, addr 0x6e94468, size 0x54, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e944bc, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e9441c, size 0x4c, virtual false, abstract: false, final false
  inline void _ctor();
