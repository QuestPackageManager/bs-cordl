...
namespace Zenject {
template <typename T> class PrefabResourceFactory_1;
}
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::PrefabResourceFactory_1);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::PrefabResourceFactory_1, "Zenject", "PrefabResourceFactory`1");
...
protected:
  // Ctor Parameters []
  // @brief default ctor
  constexpr PrefabResourceFactory_1();

public:
  // Ctor Parameters [CppParam { name: "", ty: "PrefabResourceFactory_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrefabResourceFactory_1(PrefabResourceFactory_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrefabResourceFactory_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrefabResourceFactory_1(PrefabResourceFactory_1const&) = delete;
