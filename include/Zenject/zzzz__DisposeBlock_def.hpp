...
public:
  ...
  /// @brief Method Add, addr 0x6d42554, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x6d42734, size 0x88, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method LazyInitializeDisposableList, addr 0x6d42444, size 0x110, virtual false, abstract: false, final false
  inline void LazyInitializeDisposableList();

  static inline ::Zenject::DisposeBlock* New_ctor();

  /// @brief Method OnDespawned, addr 0x6d4208c, size 0x3b8, virtual false, abstract: false, final false
  static inline void OnDespawned(::Zenject::DisposeBlock* that);

  /// @brief Method OnSpawned, addr 0x6d42060, size 0x2c, virtual false, abstract: false, final false
  static inline void OnSpawned(::Zenject::DisposeBlock* that);

  /// @brief Method Remove, addr 0x6d4264c, size 0x68, virtual false, abstract: false, final false
  inline void Remove(::System::IDisposable* disposable);

  /// @brief Method Spawn, addr 0x6d426b4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6d427bc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
