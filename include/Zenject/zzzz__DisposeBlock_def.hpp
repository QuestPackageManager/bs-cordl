...
/// @brief Field _objectPoolPairs, offset 0x18, size 0x8 
 __declspec(property(get=__cordl_internal_get__objectPoolPairs, put=__cordl_internal_set__objectPoolPairs)) ::System::Collections::Generic::List_1<::Zenject::DisposeBlock_SpawnedObjectPoolPair>*  _objectPoolPairs;
...
/// @brief Method Add, addr 0x6cd0310, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x6cd04f0, size 0x88, virtual true, abstract: false, final true
inline void Dispose() ;

/// @brief Method LazyInitializeDisposableList, addr 0x6cd0200, size 0x110, virtual false, abstract: false, final false
inline void LazyInitializeDisposableList() ;

static inline ::Zenject::DisposeBlock* New_ctor() ;

/// @brief Method OnDespawned, addr 0x6ccfe48, size 0x3b8, virtual false, abstract: false, final false
static inline void OnDespawned(::Zenject::DisposeBlock*  that) ;

/// @brief Method OnSpawned, addr 0x6ccfe1c, size 0x2c, virtual false, abstract: false, final false
static inline void OnSpawned(::Zenject::DisposeBlock*  that) ;

/// @brief Method Remove, addr 0x6cd0408, size 0x68, virtual false, abstract: false, final false
inline void Remove(::System::IDisposable*  disposable) ;

/// @brief Method Spawn, addr 0x6cd0470, size 0x80, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x6cd0578, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
