...
public:
  ...
  /// @brief Method RunAsync, addr 0x6ceca14, size 0x1c, virtual false, abstract: false, final false
  inline ::Zenject::SignalTickPriorityCopyBinder* RunAsync();

  /// @brief Method RunSync, addr 0x6ceca30, size 0x18, virtual false, abstract: false, final false
  inline ::Zenject::SignalCopyBinder* RunSync();

  /// @brief Method .ctor, addr 0x6cec9cc, size 0x24, virtual false, abstract: false, final false
