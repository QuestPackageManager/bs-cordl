...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CachedProvider", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CachedProvider(CachedProvider&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CachedProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CachedProvider(CachedProviderconst&) = delete;
