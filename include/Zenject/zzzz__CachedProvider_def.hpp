...
public:
  ...
  /// @brief Method ClearCache, addr 0x6e8194c, size 0x8, virtual false, abstract: false, final false
  inline void ClearCache();

  /// @brief Method GetAllInstancesWithInjectSplit, addr 0x6e813d0, size 0x26c, virtual true, abstract: false, final true
  ...
  /// @brief Method GetInstanceType, addr 0x6e81954, size 0xb8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x6e813c8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::IProvider* creator);

  /// @brief Method get_IsCached, addr 0x6e8191c, size 0x8, virtual true, abstract: false, final true
  inline bool get_IsCached();

  /// @brief Method get_NumInstances, addr 0x6e816f0, size 0x54, virtual false, abstract: false, final false
  inline int32_t get_NumInstances();

  /// @brief Method get_TypeVariesBasedOnMemberType, addr 0x6e81924, size 0x28, virtual true, abstract: false, final true
