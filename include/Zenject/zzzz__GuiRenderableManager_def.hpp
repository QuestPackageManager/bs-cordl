...
// Write type traits
MARK_REF_T(::Zenject::GuiRenderableManager*);
MARK_REF_T(::Zenject::GuiRenderableManager_RenderableInfo*);
MARK_REF_T(::Zenject::GuiRenderableManager___c*);
MARK_REF_T(::Zenject::GuiRenderableManager___c__DisplayClass1_0*);
DEFINE_IL2CPP_CLASS(::Zenject::GuiRenderableManager*, "Zenject", "GuiRenderableManager");
DEFINE_IL2CPP_CLASS(::Zenject::GuiRenderableManager_RenderableInfo*, "Zenject", "GuiRenderableManager/RenderableInfo");
DEFINE_IL2CPP_CLASS(::Zenject::GuiRenderableManager___c*, "Zenject", "GuiRenderableManager/<>c");
DEFINE_IL2CPP_CLASS(::Zenject::GuiRenderableManager___c__DisplayClass1_0*, "Zenject", "GuiRenderableManager/<>c__DisplayClass1_0");
...
public:
  ...
  /// @brief Method __zenCreate, addr 0x6e8dd70, size 0xf4, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e8de64, size 0x2c8, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e8d6a0, size 0xc, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method <.ctor>b__1_0, addr 0x6e8e198, size 0x14, virtual false, abstract: false, final false
  inline int32_t __ctor_b__1_0(::Zenject::GuiRenderableManager_RenderableInfo* x);

  /// @brief Method <.ctor>b__1_2, addr 0x6e8e184, size 0x14, virtual false, abstract: false, final false
  inline int32_t __ctor_b__1_2(::ModestTree::Util::ValuePair_2<::System::Type*, int32_t>* x);

  /// @brief Method __zenCreate, addr 0x6e8e1ac, size 0x44, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e8e1f0, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e8e180, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method <.ctor>b__1, addr 0x6e8e384, size 0x90, virtual false, abstract: false, final false
  inline bool __ctor_b__1(::ModestTree::Util::ValuePair_2<::System::Type*, int32_t>* x);

  /// @brief Method __zenCreate, addr 0x6e8e414, size 0x44, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e8e458, size 0x194, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e8d69c, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
static_assert(sizeof(::Zenject::GuiRenderableManager___c__DisplayClass1_0) == 0x18, "Size mismatch!");
...
public:
  ...
  /// @brief Method OnGui, addr 0x6e8d6ac, size 0x2c0, virtual false, abstract: false, final false
  inline void OnGui();
  ...
  /// @brief Method __zenCreate, addr 0x6e8d96c, size 0x124, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x6e8da90, size 0x2e0, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x6e8d170, size 0x52c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::GuiRenderableManager) == 0x18, "Size mismatch!");
