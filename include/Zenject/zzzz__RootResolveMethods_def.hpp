...
DEFINE_IL2CPP_CLASS(::Zenject::RootResolveMethods, "Zenject", "RootResolveMethods");
// Dependencies
namespace Zenject {
// Is value type: true
...
public:
  ...
  /// @brief Field NonLazyOnly value: I32(0)
...
static_assert(sizeof(::Zenject::RootResolveMethods) == 0x4, "Size mismatch!");
