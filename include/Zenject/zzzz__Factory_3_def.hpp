...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Factory_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Factory_3(Factory_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Factory_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Factory_3(Factory_3const&) = delete;
