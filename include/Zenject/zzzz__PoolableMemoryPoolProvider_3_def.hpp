...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PoolableMemoryPoolProvider_3(PoolableMemoryPoolProvider_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PoolableMemoryPoolProvider_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PoolableMemoryPoolProvider_3(PoolableMemoryPoolProvider_3const&) = delete;
