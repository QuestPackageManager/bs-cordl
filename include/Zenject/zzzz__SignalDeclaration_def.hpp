...
public:
  ...
  /// @brief Method __zenCreate, addr 0x3643adc, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x3643b34, size 0x1c0, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x3643a94, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x3643540, size 0xdc, virtual false, abstract: false, final false
  inline void Add(::Zenject::SignalSubscription* subscription);

  /// @brief Method Dispose, addr 0x3642b88, size 0x154, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Fire, addr 0x3642ce4, size 0x2dc, virtual false, abstract: false, final false
  inline void Fire(::System::Object* signal);

  /// @brief Method FireInternal, addr 0x3642fc0, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x364361c, size 0x58, virtual false, abstract: false, final false
  inline void Remove(::Zenject::SignalSubscription* subscription);

  /// @brief Method Tick, addr 0x3643220, size 0x320, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method __zenCreate, addr 0x3643674, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x3643790, size 0x304, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x36429dc, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::SignalDeclarationBindInfo* bindInfo, ::Zenject::ZenjectSettings* zenjectSettings);

  /// @brief Method get_BindingId, addr 0x3642b7c, size 0xc, virtual false, abstract: false, final false
  inline ::Zenject::BindingId get_BindingId();

  /// @brief Method get_IsAsync, addr 0x3642b74, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAsync();

  /// @brief Method get_TickPriority, addr 0x3642b64, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_TickPriority, addr 0x3642b6c, size 0x8, virtual false, abstract: false, final false
