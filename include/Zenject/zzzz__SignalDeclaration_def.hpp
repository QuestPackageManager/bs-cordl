...
public:
  ...
  /// @brief Method __zenCreate, addr 0x365a960, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x365a9b8, size 0x1c0, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x365a918, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Add, addr 0x365a3c4, size 0xdc, virtual false, abstract: false, final false
  inline void Add(::Zenject::SignalSubscription* subscription);

  /// @brief Method Dispose, addr 0x3659a0c, size 0x154, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Fire, addr 0x3659b68, size 0x2dc, virtual false, abstract: false, final false
  inline void Fire(::System::Object* signal);

  /// @brief Method FireInternal, addr 0x3659e44, size 0x23c, virtual false, abstract: false, final false
  ...
  /// @brief Method Remove, addr 0x365a4a0, size 0x58, virtual false, abstract: false, final false
  inline void Remove(::Zenject::SignalSubscription* subscription);

  /// @brief Method Tick, addr 0x365a0a4, size 0x320, virtual true, abstract: false, final true
  inline void Tick();
  ...
  /// @brief Method __zenCreate, addr 0x365a4f8, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x365a614, size 0x304, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();

  /// @brief Method .ctor, addr 0x3659860, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::SignalDeclarationBindInfo* bindInfo, ::Zenject::ZenjectSettings* zenjectSettings);

  /// @brief Method get_BindingId, addr 0x3659a00, size 0xc, virtual false, abstract: false, final false
  inline ::Zenject::BindingId get_BindingId();

  /// @brief Method get_IsAsync, addr 0x36599f8, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAsync();

  /// @brief Method get_TickPriority, addr 0x36599e8, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_TickPriority, addr 0x36599f0, size 0x8, virtual false, abstract: false, final false
