...
namespace Zenject {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(10300)), TypeDefinitionIndex(TypeDefinitionIndex(10314))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x2ede9bc, size 0x188, virtual false, abstract: false, final false
  inline void _ctor(::Zenject::SignalDeclarationBindInfo* bindInfo, ::Zenject::ZenjectSettings* zenjectSettings);

  /// @brief Method get_TickPriority, addr 0x2edeb44, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_TickPriority();

  /// @brief Method set_TickPriority, addr 0x2edeb4c, size 0x8, virtual false, abstract: false, final false
  inline void set_TickPriority(int32_t value);

  /// @brief Method get_IsAsync, addr 0x2edeb54, size 0x8, virtual false, abstract: false, final false
  inline bool get_IsAsync();

  /// @brief Method get_BindingId, addr 0x2edeb5c, size 0xc, virtual false, abstract: false, final false
  inline ::Zenject::BindingId get_BindingId();

  /// @brief Method Dispose, addr 0x2edeb68, size 0x154, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Fire, addr 0x2edecc4, size 0x2dc, virtual false, abstract: false, final false
  inline void Fire(::System::Object* signal);

  /// @brief Method FireInternal, addr 0x2edefa0, size 0x23c, virtual false, abstract: false, final false
  inline void FireInternal(::System::Collections::Generic::List_1<::Zenject::SignalSubscription*>* subscriptions, ::System::Object* signal);

  /// @brief Method Tick, addr 0x2edf200, size 0x320, virtual true, abstract: false, final true
  inline void Tick();

  /// @brief Method Add, addr 0x2edf520, size 0xdc, virtual false, abstract: false, final false
  inline void Add(::Zenject::SignalSubscription* subscription);

  /// @brief Method Remove, addr 0x2edf5fc, size 0x58, virtual false, abstract: false, final false
  inline void Remove(::Zenject::SignalSubscription* subscription);

  /// @brief Method __zenCreate, addr 0x2edf654, size 0x11c, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x2edf770, size 0x304, virtual false, abstract: false, final false
...
namespace Zenject {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(9796)), TypeDefinitionIndex(TypeDefinitionIndex(9801)), TypeDefinitionIndex(TypeDefinitionIndex(10147)),
// GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10147), inst: 3464 })] Self: TypeDefinitionIndex(TypeDefinitionIndex(9800)) CS Name: ::SignalDeclaration::Factory*
...
public:
  ...
  /// @brief Method .ctor, addr 0x2edfa74, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method __zenCreate, addr 0x2edfabc, size 0x58, virtual false, abstract: false, final false
  static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*, ::Array<::System::Object*>*> P_0);

  /// @brief Method __zenCreateInjectTypeInfo, addr 0x2edfb14, size 0x1c0, virtual false, abstract: false, final false
  static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo();
