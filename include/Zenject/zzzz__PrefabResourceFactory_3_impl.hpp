...
template <typename P1, typename P2, typename T> inline ::Zenject::DiContainer* Zenject::PrefabResourceFactory_3<P1, P2, T>::get_Container() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::PrefabResourceFactory_3<P1, P2, T>*>(), { "get_Container", {}, {} })));
...
template <typename P1, typename P2, typename T> inline T Zenject::PrefabResourceFactory_3<P1, P2, T>::Create(::StringW prefabResourceName, P1 param, P2 param2) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Zenject::PrefabResourceFactory_3<P1, P2, T>*>(), 5 })));
  return ::cordl_internals::RunMethodRethrow<T>(this, ___internal_method, prefabResourceName, param, param2);
}
template <typename P1, typename P2, typename T> inline void Zenject::PrefabResourceFactory_3<P1, P2, T>::_ctor() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::PrefabResourceFactory_3<P1, P2, T>*>(), { ".ctor", {}, {} })));
  return ::cordl_internals::RunMethodRethrow<void>(this, ___internal_method);
}
template <typename P1, typename P2, typename T> inline ::System::Object* Zenject::PrefabResourceFactory_3<P1, P2, T>::__zenCreate(::ArrayW<::System::Object*> P_0) {
  static auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::PrefabResourceFactory_3<P1, P2, T>*>(), { "__zenCreate", {}, { ::i2c::type_of<::ArrayW<::System::Object*>>() } })));
...
template <typename P1, typename P2, typename T> inline void Zenject::PrefabResourceFactory_3<P1, P2, T>::__zenFieldSetter0(::System::Object* P_0, ::System::Object* P_1) {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::PrefabResourceFactory_3<P1, P2, T>*>(),
...
template <typename P1, typename P2, typename T> inline ::Zenject::InjectTypeInfo* Zenject::PrefabResourceFactory_3<P1, P2, T>::__zenCreateInjectTypeInfo() {
  static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Zenject::PrefabResourceFactory_3<P1, P2, T>*>(), { "__zenCreateInjectTypeInfo", {}, {} })));
...
template <typename P1, typename P2, typename T> inline ::Zenject::PrefabResourceFactory_3<P1, P2, T>* Zenject::PrefabResourceFactory_3<P1, P2, T>::New_ctor() {
  return THROW_UNLESS(::i2c::no_logger{}, ::i2c::new_ctor<::Zenject::PrefabResourceFactory_3<P1, P2, T>*>());
}
