...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ConcreteIdBinderGeneric_1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ConcreteIdBinderGeneric_1(ConcreteIdBinderGeneric_1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ConcreteIdBinderGeneric_1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ConcreteIdBinderGeneric_1(ConcreteIdBinderGeneric_1const&) = delete;
