...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::KeyedFactory_6);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::KeyedFactory_6, "Zenject", "KeyedFactory`6");
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyedFactory_6(KeyedFactory_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyedFactory_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyedFactory_6(KeyedFactory_6const&) = delete;
