...
template <typename TContract, typename TMemoryPool> constexpr TMemoryPool& Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>::__get__pool() {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____pool;
}
template <typename TContract, typename TMemoryPool> constexpr TMemoryPool const& Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>::__get__pool() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
  return this->____pool;
}
template <typename TContract, typename TMemoryPool> constexpr void Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>::__set__pool(TMemoryPool value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void*>(this));
...
inline ::Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>* Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>::New_ctor(::Zenject::DiContainer* container,
                                                                                                                                                ::System::Guid poolId) {
  return THROW_UNLESS(::il2cpp_utils::New<::Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>*>(container, poolId));
}
template <typename TContract, typename TMemoryPool> inline void Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>::_ctor(::Zenject::DiContainer* container, ::System::Guid poolId) {
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>*>::get(), ".ctor", std::vector<Il2CppClass*>{},
...
template <typename TContract, typename TMemoryPool> inline void Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>::Validate() {
  static auto* ___internal_method =
      THROW_UNLESS((::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>*>::get(), "Validate",
...
inline void Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>::GetAllInstancesWithInjectSplit(::Zenject::InjectContext* context,
  ...
  static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
      ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::PoolableMemoryPoolProvider_2<TContract, TMemoryPool>*>::get(), "GetAllInstancesWithInjectSplit", std::vector<Il2CppClass*>{},
