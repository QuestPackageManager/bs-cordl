...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PrefabResourceFactory_3", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PrefabResourceFactory_3(PrefabResourceFactory_3&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PrefabResourceFactory_3", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PrefabResourceFactory_3(PrefabResourceFactory_3const&) = delete;
