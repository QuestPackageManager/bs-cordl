...
constexpr ::Zenject::IProvider*& Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_get__provider()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____provider;
}
template<typename TValue>
constexpr ::Zenject::IProvider* const& Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_get__provider() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____provider;
}
template<typename TValue>
constexpr void Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_set__provider(::Zenject::IProvider*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
::cordl_internals::setInstanceField(this, &this->____provider, value);
}
template<typename TValue>
constexpr ::Zenject::InjectContext*& Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_get__injectContext()  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____injectContext;
}
template<typename TValue>
constexpr ::Zenject::InjectContext* const& Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_get__injectContext() const {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
return this->____injectContext;
}
template<typename TValue>
constexpr void Zenject::PlaceholderFactoryBase_1<TValue>::__cordl_internal_set__injectContext(::Zenject::InjectContext*  value)  {
CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        ::std::array<const Il2CppType*, 2>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::IProvider*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::InjectContext*>::get()}
                    )));
...
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ...
                        "CreateInternal",
                        std::span<const Il2CppClass* const, 0>(),
                        ::std::array<const Il2CppType*, 1>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*>::get()}
                    )));
...
template<typename TValue>
constexpr ::Zenject::IPlaceholderFactory* Zenject::PlaceholderFactoryBase_1<TValue>::i___Zenject__IPlaceholderFactory() noexcept {
return static_cast<::Zenject::IPlaceholderFactory*>(static_cast<void*>(this));
}
...
template<typename TValue>
constexpr ::Zenject::IValidatable* Zenject::PlaceholderFactoryBase_1<TValue>::i___Zenject__IValidatable() noexcept {
return static_cast<::Zenject::IValidatable*>(static_cast<void*>(this));
}
// Ctor Parameters []
template<typename TValue>
constexpr ::Zenject::PlaceholderFactoryBase_1<TValue>::PlaceholderFactoryBase_1()   {
}
