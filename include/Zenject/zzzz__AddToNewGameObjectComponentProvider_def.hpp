...
public:
  ...
  /// @brief Method GetGameObject, addr 0x3659af0, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3659abc, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ShouldToggleActive, addr 0x3659ae8, size 0x8, virtual true, abstract: false, final false
