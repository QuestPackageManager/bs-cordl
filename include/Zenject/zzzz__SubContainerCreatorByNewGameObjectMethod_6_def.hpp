#pragma once
// IWYU pragma private; include "Zenject/SubContainerCreatorByNewGameObjectMethod_6.hpp"
...
// Write type traits
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_6);
MARK_GEN_REF_T_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_6___c__DisplayClass2_0);
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_6, "Zenject", "SubContainerCreatorByNewGameObjectMethod`6");
DEFINE_IL2CPP_GEN_CLASS_PTR(::Zenject::SubContainerCreatorByNewGameObjectMethod_6___c__DisplayClass2_0, "Zenject", "SubContainerCreatorByNewGameObjectMethod`6/<>c__DisplayClass2_0");
// [CompilerGenerated]
...
public:
  ...
  __declspec(property(get = __cordl_internal_get___4__this,
                      put = __cordl_internal_set___4__this)) ::Zenject::SubContainerCreatorByNewGameObjectMethod_6<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>* __4__this;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_6___c__DisplayClass2_0", modifiers: "&&", def_value: None, comment: None }]
  ...
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_6___c__DisplayClass2_0", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByNewGameObjectMethod_6___c__DisplayClass2_0(SubContainerCreatorByNewGameObjectMethod_6___c__DisplayClass2_0const&) = delete;
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_6", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SubContainerCreatorByNewGameObjectMethod_6(SubContainerCreatorByNewGameObjectMethod_6&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SubContainerCreatorByNewGameObjectMethod_6", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SubContainerCreatorByNewGameObjectMethod_6(SubContainerCreatorByNewGameObjectMethod_6const&) = delete;
