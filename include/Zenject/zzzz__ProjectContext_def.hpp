...
/// @brief Method Awake, addr 0x6ca51a4, size 0xc8, virtual false, abstract: false, final false
inline void Awake() ;

/// @brief Method EnsureIsInitialized, addr 0x6ca51a0, size 0x4, virtual false, abstract: false, final false
inline void EnsureIsInitialized() ;

/// @brief Method GetInjectableMonoBehaviours, addr 0x6ca6034, size 0x3c, virtual true, abstract: false, final false
...
/// @brief Method GetRootGameObjects, addr 0x6ca4b40, size 0x80, virtual true, abstract: false, final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityW<::UnityEngine::GameObject>>* GetRootGameObjects() ;

/// @brief Method Initialize, addr 0x6ca4d48, size 0x448, virtual false, abstract: false, final false
inline void Initialize() ;

/// @brief Method InstallBindings, addr 0x6ca5cf0, size 0x344, virtual false, abstract: false, final false
inline void InstallBindings(::System::Collections::Generic::List_1<::UnityW<::UnityEngine::MonoBehaviour>>*  injectableMonoBehaviours) ;

/// @brief Method InstantiateAndInitialize, addr 0x6ca47d4, size 0x2cc, virtual false, abstract: false, final false
static inline void InstantiateAndInitialize() ;

static inline ::Zenject::ProjectContext* New_ctor() ;

/// @brief Method NoDomainReloadInit, addr 0x6ca4654, size 0x4c, virtual false, abstract: false, final false
static inline void NoDomainReloadInit() ;

/// @brief Method TryGetPrefab, addr 0x6ca4bc0, size 0x188, virtual false, abstract: false, final false
...
/// @brief Method __zenCreateInjectTypeInfo, addr 0x6ca6100, size 0x148, virtual false, abstract: false, final false
static inline ::Zenject::InjectTypeInfo* __zenCreateInjectTypeInfo() ;

/// @brief Method .ctor, addr 0x6ca60f4, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method add_PostInstall, addr 0x6ca424c, size 0xac, virtual false, abstract: false, final false
inline void add_PostInstall(::System::Action*  value) ;

/// @brief Method add_PostResolve, addr 0x6ca44fc, size 0xac, virtual false, abstract: false, final false
inline void add_PostResolve(::System::Action*  value) ;

/// @brief Method add_PreInstall, addr 0x6ca40f4, size 0xac, virtual false, abstract: false, final false
inline void add_PreInstall(::System::Action*  value) ;

/// @brief Method add_PreResolve, addr 0x6ca43a4, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method get_Container, addr 0x6ca46a0, size 0x8, virtual true, abstract: false, final false
inline ::Zenject::DiContainer* get_Container() ;

/// @brief Method get_HasInstance, addr 0x6ca46a8, size 0x80, virtual false, abstract: false, final false
static inline bool get_HasInstance() ;

/// @brief Method get_Instance, addr 0x6ca4728, size 0xac, virtual false, abstract: false, final false
static inline ::UnityW<::Zenject::ProjectContext> get_Instance() ;

/// @brief Method get_ParentNewObjectsUnderContext, addr 0x6ca5190, size 0x8, virtual false, abstract: false, final false
inline bool get_ParentNewObjectsUnderContext() ;

/// @brief Method get_ValidateOnNextRun, addr 0x6ca4aa0, size 0x4c, virtual false, abstract: false, final false
static inline bool get_ValidateOnNextRun() ;

/// @brief Method remove_PostInstall, addr 0x6ca42f8, size 0xac, virtual false, abstract: false, final false
inline void remove_PostInstall(::System::Action*  value) ;

/// @brief Method remove_PostResolve, addr 0x6ca45a8, size 0xac, virtual false, abstract: false, final false
inline void remove_PostResolve(::System::Action*  value) ;

/// @brief Method remove_PreInstall, addr 0x6ca41a0, size 0xac, virtual false, abstract: false, final false
inline void remove_PreInstall(::System::Action*  value) ;

/// @brief Method remove_PreResolve, addr 0x6ca4450, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method set_ParentNewObjectsUnderContext, addr 0x6ca5198, size 0x8, virtual false, abstract: false, final false
inline void set_ParentNewObjectsUnderContext(bool  value) ;

/// @brief Method set_ValidateOnNextRun, addr 0x6ca4aec, size 0x54, virtual false, abstract: false, final false
