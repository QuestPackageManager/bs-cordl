...
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TParam5,typename TContract,typename TMemoryPool>
inline void Zenject::PoolableMemoryPoolProvider_7<TParam1,TParam2,TParam3,TParam4,TParam5,TContract,TMemoryPool>::GetAllInstancesWithInjectSplit(::Zenject::InjectContext*  context, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*  args, ::ByRef<::System::Action*>  injectAction, ::System::Collections::Generic::List_1<::System::Object*>*  buffer)  {
...
template<typename TParam1,typename TParam2,typename TParam3,typename TParam4,typename TParam5,typename TContract,typename TMemoryPool>
inline ::Zenject::PoolableMemoryPoolProvider_7<TParam1,TParam2,TParam3,TParam4,TParam5,TContract,TMemoryPool>* Zenject::PoolableMemoryPoolProvider_7<TParam1,TParam2,TParam3,TParam4,TParam5,TContract,TMemoryPool>::New_ctor(::Zenject::DiContainer*  container, ::System::Guid  poolId)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::PoolableMemoryPoolProvider_7<TParam1,TParam2,TParam3,TParam4,TParam5,TContract,TMemoryPool>*>(container, poolId));
}
