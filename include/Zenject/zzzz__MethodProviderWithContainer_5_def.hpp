...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MethodProviderWithContainer_5", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MethodProviderWithContainer_5(MethodProviderWithContainer_5&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MethodProviderWithContainer_5", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MethodProviderWithContainer_5(MethodProviderWithContainer_5const&) = delete;
