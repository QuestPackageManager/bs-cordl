...
public:
  ...
  /// @brief Method WithKernel, addr 0x4b163d8, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4b163ac, size 0x2c, virtual false, abstract: false, final false
