...
public:
  ...
  /// @brief Method WithKernel, addr 0x6e5c858, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e5c84c, size 0xc, virtual false, abstract: false, final false
