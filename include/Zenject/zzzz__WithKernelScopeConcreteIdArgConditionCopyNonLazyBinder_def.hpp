...
public:
  ...
  /// @brief Method WithKernel, addr 0x6e5fde0, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6e5fdd4, size 0xc, virtual false, abstract: false, final false
