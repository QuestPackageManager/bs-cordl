...
public:
  ...
  /// @brief Method WithKernel, addr 0x6c2af04, size 0x1c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x6c2aef8, size 0xc, virtual false, abstract: false, final false
