...
public:
  ...
  /// @brief Method WithKernel, addr 0x2fee1c4, size 0x20, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2fee198, size 0x2c, virtual false, abstract: false, final false
