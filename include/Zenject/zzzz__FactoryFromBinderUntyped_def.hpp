...
public:
  ...
  /// @brief Method .ctor, addr 0x6e4bd74, size 0x4, virtual false, abstract: false, final false
...
static_assert(sizeof(::Zenject::FactoryFromBinderUntyped) == 0x38, "Size mismatch!");
