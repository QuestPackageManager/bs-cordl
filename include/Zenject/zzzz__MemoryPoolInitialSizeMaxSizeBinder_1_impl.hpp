...
inline void Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>::_ctor(::Zenject::DiContainer*  bindContainer, ::Zenject::BindInfo*  bindInfo, ::Zenject::FactoryBindInfo*  factoryBindInfo, ::Zenject::MemoryPoolBindInfo*  poolBindInfo)  {
...
template<typename TContract>
inline ::Zenject::MemoryPoolMaxSizeBinder_1<TContract>* Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>::WithInitialSize(int32_t  size)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>::get(),
                        "WithInitialSize",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TContract>
inline ::Zenject::FactoryArgumentsToChoiceBinder_1<TContract>* Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>::WithFixedSize(int32_t  size)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>::get(),
                        "WithFixedSize",
                        std::span<const Il2CppClass* const, 0>(),
...
template<typename TContract>
inline ::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>* Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>::New_ctor(::Zenject::DiContainer*  bindContainer, ::Zenject::BindInfo*  bindInfo, ::Zenject::FactoryBindInfo*  factoryBindInfo, ::Zenject::MemoryPoolBindInfo*  poolBindInfo)  {
return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>*>(bindContainer, bindInfo, factoryBindInfo, poolBindInfo));
}
// Ctor Parameters []
template<typename TContract>
constexpr ::Zenject::MemoryPoolInitialSizeMaxSizeBinder_1<TContract>::MemoryPoolInitialSizeMaxSizeBinder_1()   {
}
