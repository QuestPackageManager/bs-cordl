...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_7", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MemoryPool_7(MemoryPool_7&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MemoryPool_7", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MemoryPool_7(MemoryPool_7const&) = delete;
