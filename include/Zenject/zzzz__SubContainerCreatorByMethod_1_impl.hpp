...
inline ::Zenject::DiContainer* Zenject::SubContainerCreatorByMethod_1<TParam1>::CreateSubContainer(::System::Collections::Generic::List_1<::Zenject::TypeValuePair>* args,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::SubContainerCreatorByMethod_1<TParam1>*>::get(), "CreateSubContainer", std::vector<Il2CppClass*>{},
