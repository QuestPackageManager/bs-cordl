...
inline void Zenject::SubContainerCreatorByMethod_1<TParam1>::_ctor(::Zenject::DiContainer* container, ::Zenject::SubContainerCreatorBindInfo* containerBindInfo,
  ...
  static auto* ___internal_method = THROW_UNLESS(
      (::il2cpp_utils::FindMethod(::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::SubContainerCreatorByMethod_1<TParam1>*>::get(), ".ctor", std::span<Il2CppClass const* const, 0>(),
