...
// Write type traits
MARK_REF_PTR_T(::DataModels::PlayerAvatar::RandomizeAvatarColorMap);
...
public:
  ...
  /// @brief Method get_totalIndices addr 0x21e6d80 size 0x8 virtual false final false
  inline int32_t get_totalIndices();

  /// @brief Method get_colorIndices addr 0x21e6d88 size 0x8 virtual false final false
  inline ::ArrayW<int32_t, ::Array<int32_t>*> get_colorIndices();

  static inline ::DataModels::PlayerAvatar::RandomizeAvatarColorMap* New_ctor(int32_t headTopPrimaryColorIndex, int32_t headTopSecondaryColorIndex, int32_t glassesColorIndex,
  ...
  /// @brief Method .ctor addr 0x21e6794 size 0x188 virtual false final false
...
static_assert(::cordl_internals::size_check_v<::DataModels::PlayerAvatar::RandomizeAvatarColorMap, 0x20>, "Size mismatch!");

static_assert(offsetof(::DataModels::PlayerAvatar::RandomizeAvatarColorMap, ____totalIndices_k__BackingField) == 0x10, "Offset mismatch!");

static_assert(offsetof(::DataModels::PlayerAvatar::RandomizeAvatarColorMap, ____colorIndices_k__BackingField) == 0x18, "Offset mismatch!");
