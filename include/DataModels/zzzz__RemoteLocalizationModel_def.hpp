...
public:
  ...
  /// @brief Method MoveNext, addr 0x369e788, size 0x898, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x369f020, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method HandleDidCatalogLoadOrUpdate, addr 0x369e76c, size 0x1c, virtual false, abstract: false, final false
  inline void HandleDidCatalogLoadOrUpdate();

  /// @brief Method Initialize, addr 0x369e680, size 0x28, virtual true, abstract: false, final true
  inline void Initialize();

  /// @brief Method LoadAdditionalLocalizationAsync, addr 0x369e6a8, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369e5e0, size 0xa0, virtual false, abstract: false, final false
