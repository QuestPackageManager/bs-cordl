...
public:
  ...
  /// @brief Method .ctor, addr 0x39d3738, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_hasOculusHapticsClip, addr 0x39c7d24, size 0xe4, virtual false, abstract: false, final false
  inline bool get_hasOculusHapticsClip();

  /// @brief Method get_hasPS5HapticsClip, addr 0x39cae54, size 0xe4, virtual false, abstract: false, final false
