...
public:
  ...
  /// @brief Method CopyFrom addr 0x1fac200 size 0x2c virtual false final false
  ...
  /// @brief Method .ctor addr 0x1fac22c size 0x1c virtual false final false
  inline void _ctor();
...
static_assert(::cordl_internals::size_check_v<::Libraries::HM::HMLib::VR::HapticPresetSO, 0x28>, "Size mismatch!");
