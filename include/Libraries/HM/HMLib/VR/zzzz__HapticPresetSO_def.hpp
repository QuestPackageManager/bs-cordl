...
/// @brief Field _touchControllerOverrideHapticsClip, offset 0x48, size 0x8 
 __declspec(property(get=__cordl_internal_get__touchControllerOverrideHapticsClip, put=__cordl_internal_set__touchControllerOverrideHapticsClip)) ::UnityW<::Oculus::Haptics::HapticClip>  _touchControllerOverrideHapticsClip;

/// @brief Field _useAdvancedHapticsOnSupportedPlatforms, offset 0x25, size 0x1 
 __declspec(property(get=__cordl_internal_get__useAdvancedHapticsOnSupportedPlatforms, put=__cordl_internal_set__useAdvancedHapticsOnSupportedPlatforms)) bool  _useAdvancedHapticsOnSupportedPlatforms;
...
/// @brief Method .ctor, addr 0x571a8e8, size 0x2c, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method get_hasOculusHapticsClip, addr 0x5717154, size 0xe4, virtual false, abstract: false, final false
inline bool get_hasOculusHapticsClip() ;

/// @brief Method get_hasPS5HapticsClip, addr 0x571a804, size 0xe4, virtual false, abstract: false, final false
