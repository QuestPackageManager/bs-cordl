...
public:
  ...
  /// @brief Method get_CustomDocument addr 0x2802f60 size 0x8 virtual false final false
  inline ::Polyglot::LocalizationDocument* get_CustomDocument();

  /// @brief Method get_InputFiles addr 0x2802f68 size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::Polyglot::LocalizationAsset*>* get_InputFiles();

  /// @brief Method get_Instance addr 0x2802ac4 size 0x94 virtual false final false
  static inline ::Polyglot::Localization* get_Instance();

  /// @brief Method set_Instance addr 0x2803010 size 0x4c virtual false final false
  static inline void set_Instance(::Polyglot::Localization* value);

  /// @brief Method get_HasInstance addr 0x2802f70 size 0xa0 virtual false final false
  static inline bool get_HasInstance();

  /// @brief Method get_SupportedLanguages addr 0x280305c size 0x8 virtual false final false
  inline ::System::Collections::Generic::List_1<::Polyglot::Language>* get_SupportedLanguages();

  /// @brief Method get_SelectedLanguageDirection addr 0x2803064 size 0x14 virtual false final false
  inline ::Polyglot::LanguageDirection get_SelectedLanguageDirection();

  /// @brief Method GetLanguageDirection addr 0x2803078 size 0x1c virtual false final false
  inline ::Polyglot::LanguageDirection GetLanguageDirection(::Polyglot::Language language);

  /// @brief Method get_SelectedLanguageIndex addr 0x2802d9c size 0x74 virtual false final false
  inline int32_t get_SelectedLanguageIndex();

  /// @brief Method get_SelectedCultureInfo addr 0x2803094 size 0x8 virtual false final false
  inline ::System::Globalization::CultureInfo* get_SelectedCultureInfo();

  /// @brief Method get_SelectedLanguage addr 0x280309c size 0x8 virtual false final false
  inline ::Polyglot::Language get_SelectedLanguage();

  /// @brief Method set_SelectedLanguage addr 0x28030a4 size 0x104 virtual false final false
  inline void set_SelectedLanguage(::Polyglot::Language value);

  /// @brief Method IsLanguageSupported addr 0x28031a8 size 0x78 virtual false final false
  inline bool IsLanguageSupported(::Polyglot::Language language);

  /// @brief Method InvokeOnLocalize addr 0x28032c4 size 0x14 virtual false final false
  inline void InvokeOnLocalize();

  /// @brief Method get_EnglishLanguageNames addr 0x2802d2c size 0x70 virtual false final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_EnglishLanguageNames();

  /// @brief Method get_LocalizedLanguageNames addr 0x28035e8 size 0x70 virtual false final false
  inline ::System::Collections::Generic::List_1<::StringW>* get_LocalizedLanguageNames();

  /// @brief Method get_EnglishLanguageName addr 0x2803658 size 0x40 virtual false final false
  inline ::StringW get_EnglishLanguageName();

  /// @brief Method get_LocalizedLanguageName addr 0x28036bc size 0x40 virtual false final false
  inline ::StringW get_LocalizedLanguageName();

  /// @brief Method SelectLanguage addr 0x28036fc size 0x78 virtual false final false
  inline void SelectLanguage(int32_t selected);

  /// @brief Method SelectLanguage addr 0x2803774 size 0x4 virtual false final false
  inline void SelectLanguage(::Polyglot::Language selected);

  /// @brief Method SelectCultureInfo addr 0x2803220 size 0xa4 virtual false final false
  inline void SelectCultureInfo();

  /// @brief Method ConvertSystemLanguage addr 0x2803778 size 0x38 virtual false final false
  inline ::Polyglot::Language ConvertSystemLanguage(::UnityEngine::SystemLanguage selected);

  /// @brief Method AddOnLocalizeEvent addr 0x2802b58 size 0x1d4 virtual false final false
  inline void AddOnLocalizeEvent(::Polyglot::ILocalize* localize);

  /// @brief Method RemoveOnLocalizeEvent addr 0x28037b0 size 0xec virtual false final false
  inline void RemoveOnLocalizeEvent(::Polyglot::ILocalize* localize);

  /// @brief Method Get addr 0x2803698 size 0x24 virtual false final false
  static inline ::StringW Get(::StringW key);

  /// @brief Method Get addr 0x280389c size 0x3b4 virtual false final false
  static inline ::StringW Get(::StringW key, ::Polyglot::Language language);

  /// @brief Method KeyExist addr 0x2803ce0 size 0xb0 virtual false final false
  static inline bool KeyExist(::StringW key);

  /// @brief Method GetKeys addr 0x2803d90 size 0x4c virtual false final false
  static inline ::System::Collections::Generic::List_1<::StringW>* GetKeys();

  /// @brief Method GetFormat addr 0x2803e70 size 0x6c virtual false final false
  static inline ::StringW GetFormat(::StringW key, ::ArrayW<::System::Object*, ::Array<::System::Object*>*> arguments);

  /// @brief Method InputFilesContains addr 0x2803edc size 0x1c4 virtual false final false
  inline bool InputFilesContains(::Polyglot::LocalizationDocument* doc);

  static inline ::Polyglot::Localization* New_ctor();

  /// @brief Method .ctor addr 0x28040a0 size 0x98 virtual false final false
  inline void _ctor();
