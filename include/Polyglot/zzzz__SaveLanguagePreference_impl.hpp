...
constexpr ::Polyglot::ILocalize* Polyglot::SaveLanguagePreference::i___Polyglot__ILocalize() noexcept {
  return static_cast<::Polyglot::ILocalize*>(static_cast<void*>(this));
}
constexpr ::StringW& Polyglot::SaveLanguagePreference::__cordl_internal_get_preferenceKey() {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___preferenceKey;
}
constexpr ::StringW const& Polyglot::SaveLanguagePreference::__cordl_internal_get_preferenceKey() const {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
  return this->___preferenceKey;
}
constexpr void Polyglot::SaveLanguagePreference::__cordl_internal_set_preferenceKey(::StringW value) {
  CORDL_FIELD_NULL_CHECK(static_cast<void const*>(this));
...
inline ::Polyglot::SaveLanguagePreference* Polyglot::SaveLanguagePreference::New_ctor() {
  return THROW_UNLESS(::il2cpp_utils::NewSpecific<::Polyglot::SaveLanguagePreference*>());
}
