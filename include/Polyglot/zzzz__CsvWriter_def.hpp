...
public:
  // Declarations
  /// @brief Method AppendRow, addr 0x2801274, size 0x3b4, virtual false, abstract: false, final false
  static inline void AppendRow(::StringW filePath, ::System::Collections::Generic::List_1<::StringW>* row);

  /// @brief Method AppendElement, addr 0x28016dc, size 0x84, virtual false, abstract: false, final false
  static inline void AppendElement(::System::Text::StringBuilder* buffer, ::StringW element);

  /// @brief Method HasEscapeChars, addr 0x2801628, size 0xb4, virtual false, abstract: false, final false
  static inline bool HasEscapeChars(::StringW element);

  static inline ::Polyglot::CsvWriter* New_ctor();

  /// @brief Method .ctor, addr 0x2801760, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
