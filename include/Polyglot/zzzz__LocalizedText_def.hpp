...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13128)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15565), inst: 2606 }),
// TypeDefinitionIndex(TypeDefinitionIndex(15565))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15564)) CS Name: ::Polyglot::LocalizedText*
class CORDL_TYPE LocalizedText : public ::Polyglot::LocalizedTextComponent_1<::UnityEngine::UI::Text*> {
public:
  // Declarations
  /// @brief Method SetText addr 0x28057fc size 0x134 virtual true final false
  inline void SetText(::UnityEngine::UI::Text* text, ::StringW value);

  /// @brief Method UpdateAlignment addr 0x2805930 size 0xe4 virtual true final false
  inline void UpdateAlignment(::UnityEngine::UI::Text* text, ::Polyglot::LanguageDirection direction);

  /// @brief Method IsOppositeDirection addr 0x2805a14 size 0x58 virtual false final false
  inline bool IsOppositeDirection(::UnityEngine::TextAnchor alignment, ::Polyglot::LanguageDirection direction);

  /// @brief Method IsAlignmentRight addr 0x2805a6c size 0x28 virtual false final false
  inline bool IsAlignmentRight(::UnityEngine::TextAnchor alignment);

  /// @brief Method IsAlignmentLeft addr 0x2805a94 size 0x28 virtual false final false
  inline bool IsAlignmentLeft(::UnityEngine::TextAnchor alignment);

  static inline ::Polyglot::LocalizedText* New_ctor();

  /// @brief Method .ctor addr 0x2805abc size 0x48 virtual false final false
  inline void _ctor();
