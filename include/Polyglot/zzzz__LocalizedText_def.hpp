...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15549)), TypeDefinitionIndex(TypeDefinitionIndex(13133)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15549), inst:
// 2551 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(15548)) CS Name: ::Polyglot::LocalizedText*
class CORDL_TYPE LocalizedText : public ::Polyglot::LocalizedTextComponent_1<::UnityEngine::UI::Text*> {
public:
  // Declarations
  /// @brief Method SetText addr 0x268ab74 size 0x134 virtual true final false
  inline void SetText(::UnityEngine::UI::Text* text, ::StringW value);

  /// @brief Method UpdateAlignment addr 0x268aca8 size 0xe4 virtual true final false
  inline void UpdateAlignment(::UnityEngine::UI::Text* text, ::Polyglot::LanguageDirection direction);

  /// @brief Method IsOppositeDirection addr 0x268ad8c size 0x58 virtual false final false
  inline bool IsOppositeDirection(::UnityEngine::TextAnchor alignment, ::Polyglot::LanguageDirection direction);

  /// @brief Method IsAlignmentRight addr 0x268ade4 size 0x28 virtual false final false
  inline bool IsAlignmentRight(::UnityEngine::TextAnchor alignment);

  /// @brief Method IsAlignmentLeft addr 0x268ae0c size 0x28 virtual false final false
  inline bool IsAlignmentLeft(::UnityEngine::TextAnchor alignment);

  static inline ::Polyglot::LocalizedText* New_ctor();

  /// @brief Method .ctor addr 0x268ae34 size 0x48 virtual false final false
  inline void _ctor();
