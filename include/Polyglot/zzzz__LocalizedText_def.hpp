...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15565)), TypeDefinitionIndex(TypeDefinitionIndex(13128)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15565), inst:
// 2606 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(15564)) CS Name: ::Polyglot::LocalizedText*
