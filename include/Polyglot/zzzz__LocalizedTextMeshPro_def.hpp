...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15565)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15565), inst: 4463 }),
// TypeDefinitionIndex(TypeDefinitionIndex(12307))} Self: TypeDefinitionIndex(TypeDefinitionIndex(15567)) CS Name: ::Polyglot::LocalizedTextMeshPro*
...
public:
  ...
  /// @brief Method UpdateAlignment, addr 0x2805cec, size 0xf4, virtual true, abstract: false, final false
  inline void UpdateAlignment(::TMPro::TextMeshPro* text, ::Polyglot::LanguageDirection direction);

  /// @brief Method IsOppositeDirection, addr 0x2805de0, size 0x58, virtual false, abstract: false, final false
  inline bool IsOppositeDirection(::TMPro::TextAlignmentOptions alignment, ::Polyglot::LanguageDirection direction);

  /// @brief Method IsAlignmentRight, addr 0x2805e38, size 0x28, virtual false, abstract: false, final false
  inline bool IsAlignmentRight(::TMPro::TextAlignmentOptions alignment);

  /// @brief Method IsAlignmentLeft, addr 0x2805e60, size 0x28, virtual false, abstract: false, final false
  inline bool IsAlignmentLeft(::TMPro::TextAlignmentOptions alignment);

  static inline ::Polyglot::LocalizedTextMeshPro* New_ctor();

  /// @brief Method .ctor, addr 0x2805e88, size 0x48, virtual false, abstract: false, final false
  inline void _ctor();
