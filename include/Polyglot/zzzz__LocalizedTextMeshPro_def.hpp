...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15565)), TypeDefinitionIndex(TypeDefinitionIndex(12307)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15565), inst:
