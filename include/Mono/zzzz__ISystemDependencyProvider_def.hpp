...
public:
  ...
  // Ctor Parameters [CppParam { name: "", ty: "ISystemDependencyProvider", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ISystemDependencyProvider(ISystemDependencyProviderconst&) = delete;
