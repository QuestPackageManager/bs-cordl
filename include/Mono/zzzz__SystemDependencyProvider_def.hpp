...
/// @brief Method Initialize, addr 0x5e1bcbc, size 0x144, virtual false, abstract: false, final false
static inline void Initialize() ;

/// @brief Method Mono.ISystemDependencyProvider.get_CertificateProvider, addr 0x5e1be84, size 0x8, virtual true, abstract: false, final true
...
/// @brief Method .ctor, addr 0x5e1be00, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_CertificateProvider, addr 0x5e1be8c, size 0x8, virtual false, abstract: false, final false
inline ::Mono::SystemCertificateProvider* get_CertificateProvider() ;

/// @brief Method get_Instance, addr 0x5e1bc5c, size 0x60, virtual false, abstract: false, final false
static inline ::Mono::SystemDependencyProvider* get_Instance() ;

/// @brief Method get_X509Pal, addr 0x5e1be94, size 0x14, virtual false, abstract: false, final false
