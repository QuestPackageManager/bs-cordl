...
public:
  ...
  /// @brief Method Initialize, addr 0x5e1b5fc, size 0x144, virtual false, abstract: false, final false
  static inline void Initialize();

  /// @brief Method Mono.ISystemDependencyProvider.get_CertificateProvider, addr 0x5e1b7c4, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5e1b740, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_CertificateProvider, addr 0x5e1b7cc, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::SystemCertificateProvider* get_CertificateProvider();

  /// @brief Method get_Instance, addr 0x5e1b59c, size 0x60, virtual false, abstract: false, final false
  static inline ::Mono::SystemDependencyProvider* get_Instance();

  /// @brief Method get_X509Pal, addr 0x5e1b7d4, size 0x14, virtual false, abstract: false, final false
