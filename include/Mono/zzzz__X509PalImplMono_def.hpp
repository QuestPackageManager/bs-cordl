...
public:
  // Declarations
  /// @brief Method Import, addr 0x5e8df8c, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x5e8df88, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x5e8df84, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e8d560, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
