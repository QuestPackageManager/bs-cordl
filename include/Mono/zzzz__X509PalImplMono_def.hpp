...
public:
  // Declarations
  /// @brief Method Import, addr 0x410b8bc, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x410b8b8, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x410b8b4, size 0x4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x410ae88, size 0x58, virtual false, abstract: false, final false
  inline void _ctor();
