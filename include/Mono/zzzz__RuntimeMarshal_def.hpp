...
public:
  // Declarations
  /// @brief Method AsciHexDigitValue, addr 0x59718ec, size 0x2c, virtual false, abstract: false, final false
  static inline int32_t AsciHexDigitValue(int32_t c);

  /// @brief Method DecodeBlobArray, addr 0x5971830, size 0xbc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> DecodeBlobArray(::System::IntPtr ptr);

  /// @brief Method DecodeBlobSize, addr 0x59717d4, size 0x5c, virtual false, abstract: false, final false
  static inline int32_t DecodeBlobSize(::System::IntPtr in_ptr, ::ByRef<::System::IntPtr> out_ptr);

  /// @brief Method FreeAssemblyName, addr 0x5971918, size 0x50, virtual false, abstract: false, final false
  static inline void FreeAssemblyName(::ByRef<::Mono::MonoAssemblyName> name, bool freeStruct);

  /// @brief Method MarshalString, addr 0x59717c4, size 0x8, virtual false, abstract: false, final false
  static inline ::Mono::SafeStringMarshal MarshalString(::StringW str);

  /// @brief Method PtrToUtf8String, addr 0x5971758, size 0x6c, virtual false, abstract: false, final false
