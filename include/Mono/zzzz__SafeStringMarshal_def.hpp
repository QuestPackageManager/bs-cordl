...
public:
  ...
  /// @brief Method Dispose, addr 0x3c51230, size 0x30, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method GFree, addr 0x3c511e4, size 0x4, virtual false, abstract: false, final false
  static inline void GFree(::System::IntPtr ptr);

  /// @brief Method StringToUtf8, addr 0x3c511cc, size 0x18, virtual false, abstract: false, final false
  static inline ::System::IntPtr StringToUtf8(::StringW str);

  /// @brief Method StringToUtf8_icall, addr 0x3c511c8, size 0x4, virtual false, abstract: false, final false
  static inline ::System::IntPtr StringToUtf8_icall(::ByRef<::StringW> str);

  /// @brief Method .ctor, addr 0x3c50ffc, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::StringW str);

  /// @brief Method get_Value, addr 0x3c511e8, size 0x48, virtual false, abstract: false, final false
