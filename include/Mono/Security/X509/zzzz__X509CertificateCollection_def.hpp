...
public:
  ...
  /// @brief Method MoveNext, addr 0x5a8f318, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x5a97434, size 0xa4, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x5a974d8, size 0xa8, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x5a9738c, size 0xa8, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5a9722c, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509CertificateCollection* mappings);

  /// @brief Method get_Current, addr 0x5a8ef8c, size 0xf8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x5a8ba0c, size 0x70, virtual false, abstract: false, final false
  inline int32_t Add(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method AddRange, addr 0x5a96ff8, size 0xd0, virtual false, abstract: false, final false
  inline void AddRange(::Mono::Security::X509::X509CertificateCollection* value);

  /// @brief Method Compare, addr 0x5a9731c, size 0x70, virtual false, abstract: false, final false
  inline bool Compare(::ArrayW<uint8_t> array1, ::ArrayW<uint8_t> array2);

  /// @brief Method Contains, addr 0x5a970c8, size 0x18, virtual false, abstract: false, final false
  inline bool Contains(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method GetEnumerator, addr 0x5a8ef30, size 0x5c, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection_X509CertificateEnumerator* GetEnumerator();

  /// @brief Method GetHashCode, addr 0x5a97300, size 0x1c, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IndexOf, addr 0x5a970e0, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x5a972e0, size 0x20, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x5a8b86c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x5a96f54, size 0xa4, virtual false, abstract: false, final false
