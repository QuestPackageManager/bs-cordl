...
public:
  ...
  /// @brief Method MoveNext, addr 0x2547a7c, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerator.MoveNext, addr 0x255009c, size 0xa0, virtual true, abstract: false, final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset, addr 0x255013c, size 0xa4, virtual true, abstract: false, final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method System.Collections.IEnumerator.get_Current, addr 0x254fff8, size 0xa4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x254fe84, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509CertificateCollection* mappings);

  /// @brief Method get_Current, addr 0x25476f0, size 0xf0, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Add, addr 0x2543fec, size 0x74, virtual false, abstract: false, final false
  inline int32_t Add(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method AddRange, addr 0x254fc4c, size 0xd4, virtual false, abstract: false, final false
  inline void AddRange(::Mono::Security::X509::X509CertificateCollection* value);

  /// @brief Method Compare, addr 0x254ff7c, size 0x7c, virtual false, abstract: false, final false
  inline bool Compare(::ArrayW<uint8_t, ::Array<uint8_t>*> array1, ::ArrayW<uint8_t, ::Array<uint8_t>*> array2);

  /// @brief Method Contains, addr 0x254fd20, size 0x18, virtual false, abstract: false, final false
  inline bool Contains(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method GetEnumerator, addr 0x2547690, size 0x60, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::__X509CertificateCollection__X509CertificateEnumerator* GetEnumerator();

  /// @brief Method GetHashCode, addr 0x254ff5c, size 0x20, virtual true, abstract: false, final false
  inline int32_t GetHashCode();

  /// @brief Method IndexOf, addr 0x254fd38, size 0x14c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x254ff38, size 0x24, virtual true, abstract: false, final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method .ctor, addr 0x2543e50, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Item, addr 0x254fbb4, size 0x98, virtual false, abstract: false, final false
