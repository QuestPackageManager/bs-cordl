...
public:
  ...
  /// @brief Method .ctor addr 0x23fbb30 size 0xb4 virtual false final false
  inline void _ctor(::Mono::Security::X509::X509CertificateCollection* mappings);

  /// @brief Method get_Current addr 0x23f339c size 0xf0 virtual false final false
  inline ::Mono::Security::X509::X509Certificate* get_Current();

  /// @brief Method System.Collections.IEnumerator.get_Current addr 0x23fbca4 size 0xa4 virtual true final true
  inline ::System::Object* System_Collections_IEnumerator_get_Current();

  /// @brief Method System.Collections.IEnumerator.MoveNext addr 0x23fbd48 size 0xa0 virtual true final true
  inline bool System_Collections_IEnumerator_MoveNext();

  /// @brief Method System.Collections.IEnumerator.Reset addr 0x23fbde8 size 0xa4 virtual true final true
  inline void System_Collections_IEnumerator_Reset();

  /// @brief Method MoveNext addr 0x23f3728 size 0xa0 virtual false final false
...
public:
  ...
  /// @brief Method .ctor addr 0x23efafc size 0x8 virtual false final false
  inline void _ctor();

  /// @brief Method get_Item addr 0x23fb860 size 0x98 virtual false final false
  inline ::Mono::Security::X509::X509Certificate* get_Item(int32_t index);

  /// @brief Method Add addr 0x23efc98 size 0x74 virtual false final false
  inline int32_t Add(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method AddRange addr 0x23fb8f8 size 0xd4 virtual false final false
  inline void AddRange(::Mono::Security::X509::X509CertificateCollection* value);

  /// @brief Method Contains addr 0x23fb9cc size 0x18 virtual false final false
  inline bool Contains(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method GetEnumerator addr 0x23f333c size 0x60 virtual false final false
  inline ::Mono::Security::X509::__X509CertificateCollection__X509CertificateEnumerator* GetEnumerator();

  /// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x23fbbe4 size 0x24 virtual true final true
  inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator();

  /// @brief Method GetHashCode addr 0x23fbc08 size 0x20 virtual true final false
  inline int32_t GetHashCode();

  /// @brief Method IndexOf addr 0x23fb9e4 size 0x14c virtual false final false
  inline int32_t IndexOf(::Mono::Security::X509::X509Certificate* value);

  /// @brief Method Compare addr 0x23fbc28 size 0x7c virtual false final false
