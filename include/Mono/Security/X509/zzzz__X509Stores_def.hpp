...
/// @brief Method Open, addr 0x58eb044, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58eaee0, size 0xc, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  newFormat) ;

/// @brief Method get_TrustedRoot, addr 0x58eaf7c, size 0xc8, virtual false, abstract: false, final false
