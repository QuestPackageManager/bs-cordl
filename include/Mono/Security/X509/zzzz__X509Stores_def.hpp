...
public:
  ...
  /// @brief Method Open, addr 0x58eab38, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ea9d4, size 0xc, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool newFormat);

  /// @brief Method get_TrustedRoot, addr 0x58eaa70, size 0xc8, virtual false, abstract: false, final false
