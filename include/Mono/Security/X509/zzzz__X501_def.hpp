...
public:
  ...
  /// @brief Method AppendEntry, addr 0x5a93124, size 0x878, virtual false, abstract: false, final false
  static inline void AppendEntry(::System::Text::StringBuilder* sb, ::Mono::Security::ASN1* entry, bool quotes);

  /// @brief Method ToString, addr 0x5a8c07c, size 0x148, virtual false, abstract: false, final false
  static inline ::StringW ToString(::Mono::Security::ASN1* seq);

  /// @brief Method ToString, addr 0x5a9399c, size 0x1bc, virtual false, abstract: false, final false
