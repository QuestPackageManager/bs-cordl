...
public:
  ...
  /// @brief Method AppendEntry, addr 0x5956940, size 0x878, virtual false, abstract: false, final false
  static inline void AppendEntry(::System::Text::StringBuilder* sb, ::Mono::Security::ASN1* entry, bool quotes);

  /// @brief Method ToString, addr 0x594f898, size 0x148, virtual false, abstract: false, final false
  static inline ::StringW ToString(::Mono::Security::ASN1* seq);

  /// @brief Method ToString, addr 0x59571b8, size 0x1bc, virtual false, abstract: false, final false
