...
/// @brief Method get_CurrentUser, addr 0x58eae50, size 0x90, virtual false, abstract: false, final false
static inline ::Mono::Security::X509::X509Stores* get_CurrentUser() ;

/// @brief Method get_CurrentUserPath, addr 0x58eac60, size 0x104, virtual false, abstract: false, final false
static inline ::StringW get_CurrentUserPath() ;

/// @brief Method get_LocalMachine, addr 0x58eaeec, size 0x90, virtual false, abstract: false, final false
static inline ::Mono::Security::X509::X509Stores* get_LocalMachine() ;

/// @brief Method get_LocalMachinePath, addr 0x58ead64, size 0xec, virtual false, abstract: false, final false
static inline ::StringW get_LocalMachinePath() ;

/// @brief Method get_TrustedRootCertificates, addr 0x58e8f0c, size 0xd0, virtual false, abstract: false, final false
