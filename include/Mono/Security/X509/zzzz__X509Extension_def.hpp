...
public:
  ...
  /// @brief Method Decode, addr 0x2794828, size 0x4, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x279482c, size 0x4, virtual true, abstract: false, final false
  inline void Encode();

  /// @brief Method Equals, addr 0x2794840, size 0x144, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x2794984, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x2794bcc, size 0xd8, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method WriteLine, addr 0x27949a4, size 0x228, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27943e4, size 0x2cc, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method .ctor, addr 0x27946b0, size 0x14c, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_Critical, addr 0x2794838, size 0x8, virtual false, abstract: false, final false
  inline bool get_Critical();

  /// @brief Method get_Oid, addr 0x2794830, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Oid();

  /// @brief Method get_Value, addr 0x27947fc, size 0x2c, virtual false, abstract: false, final false
