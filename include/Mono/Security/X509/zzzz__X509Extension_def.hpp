...
public:
  ...
  /// @brief Method Decode, addr 0x5a962d4, size 0x4, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x5a962d8, size 0x4, virtual true, abstract: false, final false
  inline void Encode();

  /// @brief Method Equals, addr 0x5a962ec, size 0x12c, virtual true, abstract: false, final false
  inline bool Equals(::System::Object* obj);

  /// @brief Method GetHashCode, addr 0x5a96418, size 0x1c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5a96674, size 0xdc, virtual true, abstract: false, final false
  inline ::StringW ToString();

  /// @brief Method WriteLine, addr 0x5a96434, size 0x240, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a95eb4, size 0x2bc, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method .ctor, addr 0x5a96170, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_Critical, addr 0x5a962e4, size 0x8, virtual false, abstract: false, final false
  inline bool get_Critical();

  /// @brief Method get_Oid, addr 0x5a962dc, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_Oid();

  /// @brief Method get_Value, addr 0x5a962a8, size 0x2c, virtual false, abstract: false, final false
