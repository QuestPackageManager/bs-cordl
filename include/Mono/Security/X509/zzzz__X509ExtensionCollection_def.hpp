...
public:
  ...
  /// @brief Method IndexOf, addr 0x3c3bc34, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3c3bd6c, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c3bc2c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3c379e0, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_Item, addr 0x3c3b2cc, size 0xb0, virtual false, abstract: false, final false
