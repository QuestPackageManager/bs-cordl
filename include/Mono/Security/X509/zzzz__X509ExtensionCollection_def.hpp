...
public:
  ...
  /// @brief Method IndexOf, addr 0x267d244, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x267d380, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x267d23c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x2678f68, size 0x13c, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_Item, addr 0x267c8c8, size 0xb0, virtual false, abstract: false, final false
