...
public:
  ...
  /// @brief Method IndexOf, addr 0x58e9dfc, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x58e9f34, size 0x20, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x58e9df4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x58e5bb4, size 0x138, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_Item, addr 0x58e9498, size 0xbc, virtual false, abstract: false, final false
