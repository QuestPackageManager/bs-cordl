...
public:
  ...
  /// @brief Method IndexOf, addr 0x3c4e138, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Collections.IEnumerable.GetEnumerator, addr 0x3c4e270, size 0x24, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c4e130, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x3c49ee4, size 0x134, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::ASN1* asn1);

  /// @brief Method get_Item, addr 0x3c4d7d0, size 0xb0, virtual false, abstract: false, final false
