...
public:
  ...
  /// @brief Method Decode, addr 0x3c4f404, size 0x134, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x3c4f538, size 0x128, virtual true, abstract: false, final false
  inline void Encode();
  ...
  /// @brief Method ToString, addr 0x3c4f668, size 0x1a0, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c4d880, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_CertificateAuthority, addr 0x3c4f660, size 0x8, virtual false, abstract: false, final false
