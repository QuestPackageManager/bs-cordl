...
public:
  ...
  /// @brief Method Decode, addr 0x277c54c, size 0x118, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x277c664, size 0x124, virtual true, abstract: false, final false
  inline void Encode();
  ...
  /// @brief Method ToString, addr 0x277c7fc, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x277c548, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_Identifier, addr 0x277c788, size 0x74, virtual false, abstract: false, final false
