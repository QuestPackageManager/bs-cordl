...
public:
  ...
  /// @brief Method Decode, addr 0x27a95cc, size 0x118, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x27a96e4, size 0x124, virtual true, abstract: false, final false
  inline void Encode();
  ...
  /// @brief Method ToString, addr 0x27a987c, size 0x168, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27a95c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_Identifier, addr 0x27a9808, size 0x74, virtual false, abstract: false, final false
