...
// Write type traits
MARK_REF_T(::Mono::Security::X509::Extensions::AuthorityKeyIdentifierExtension*);
DEFINE_IL2CPP_CLASS(::Mono::Security::X509::Extensions::AuthorityKeyIdentifierExtension*, "Mono.Security.X509.Extensions", "AuthorityKeyIdentifierExtension");
...
public:
  ...
  /// @brief Method Decode, addr 0x5a998a8, size 0x118, virtual true, abstract: false, final false
  inline void Decode();

  /// @brief Method Encode, addr 0x5a999c0, size 0xf0, virtual true, abstract: false, final false
  inline void Encode();
  ...
  /// @brief Method ToString, addr 0x5a99b24, size 0x194, virtual true, abstract: false, final false
  inline ::StringW ToString();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_aki() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_aki();

  constexpr void __cordl_internal_set_aki(::ArrayW<uint8_t> value);

  /// @brief Method .ctor, addr 0x5a998a4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::X509::X509Extension* extension);

  /// @brief Method get_Identifier, addr 0x5a99ab0, size 0x74, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::X509::Extensions::AuthorityKeyIdentifierExtension) == 0x30, "Size mismatch!");
