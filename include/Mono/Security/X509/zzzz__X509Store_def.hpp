...
/// @brief Method BuildCertificatesCollection, addr 0x58ea498, size 0x1ec, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* BuildCertificatesCollection(::StringW  storeName) ;

/// @brief Method BuildCrlsCollection, addr 0x58ea710, size 0x1cc, virtual false, abstract: false, final false
inline ::System::Collections::ArrayList* BuildCrlsCollection(::StringW  storeName) ;

/// @brief Method CheckStore, addr 0x58eab88, size 0xd8, virtual false, abstract: false, final false
inline bool CheckStore(::StringW  path, bool  throwException) ;

/// @brief Method Load, addr 0x58ea8dc, size 0x1d4, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Load(::StringW  filename) ;

/// @brief Method LoadCertificate, addr 0x58eaab0, size 0x6c, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* LoadCertificate(::StringW  filename) ;

/// @brief Method LoadCrl, addr 0x58eab1c, size 0x6c, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ea460, size 0x10, virtual false, abstract: false, final false
inline void _ctor(::StringW  path, bool  crl, bool  newFormat) ;

/// @brief Method get_Certificates, addr 0x58ea470, size 0x28, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates() ;

/// @brief Method get_Crls, addr 0x58ea684, size 0x8c, virtual false, abstract: false, final false
