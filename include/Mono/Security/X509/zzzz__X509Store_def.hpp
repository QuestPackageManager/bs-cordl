...
public:
  ...
  /// @brief Method BuildCertificatesCollection, addr 0x3c40d6c, size 0x1dc, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection* BuildCertificatesCollection(::StringW storeName);

  /// @brief Method BuildCrlsCollection, addr 0x3c40fd0, size 0x1c8, virtual false, abstract: false, final false
  inline ::System::Collections::ArrayList* BuildCrlsCollection(::StringW storeName);

  /// @brief Method CheckStore, addr 0x3c41470, size 0xdc, virtual false, abstract: false, final false
  inline bool CheckStore(::StringW path, bool throwException);

  /// @brief Method Load, addr 0x3c41198, size 0x208, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Load(::StringW filename);

  /// @brief Method LoadCertificate, addr 0x3c413a0, size 0x68, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* LoadCertificate(::StringW filename);

  /// @brief Method LoadCrl, addr 0x3c41408, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c40d04, size 0x40, virtual false, abstract: false, final false
  inline void _ctor(::StringW path, bool crl, bool newFormat);

  /// @brief Method get_Certificates, addr 0x3c40d44, size 0x28, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509CertificateCollection* get_Certificates();

  /// @brief Method get_Crls, addr 0x3c40f48, size 0x88, virtual false, abstract: false, final false
