...
public:
  ...
  /// @brief Method GetObjectData, addr 0x58818dc, size 0x68, virtual true, abstract: false, final false
  inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo* info, ::System::Runtime::Serialization::StreamingContext context);

  /// @brief Method GetUnsignedBigInteger, addr 0x5880820, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method PEM, addr 0x5880688, size 0x198, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PEM(::StringW type, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method Parse, addr 0x587fd70, size 0x918, virtual false, abstract: false, final false
  inline void Parse(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method VerifySignature, addr 0x5881650, size 0x188, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::AsymmetricAlgorithm* aa);

  /// @brief Method VerifySignature, addr 0x5881454, size 0xd0, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::DSA* dsa);

  /// @brief Method VerifySignature, addr 0x5881524, size 0x12c, virtual false, abstract: false, final false
  inline bool VerifySignature(::System::Security::Cryptography::RSA* rsa);

  /// @brief Method WasCurrent, addr 0x5881378, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58762cc, size 0x198, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  static inline ::StringW getStaticF_encoding_error();

  /// @brief Method get_DSA, addr 0x5879adc, size 0x294, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::DSA* get_DSA();

  /// @brief Method get_Extensions, addr 0x58808c8, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions();

  /// @brief Method get_Hash, addr 0x58808d0, size 0x240, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Hash();

  /// @brief Method get_IsCurrent, addr 0x5881314, size 0x64, virtual false, abstract: false, final false
  inline bool get_IsCurrent();

  /// @brief Method get_IsSelfSigned, addr 0x58817d8, size 0x104, virtual false, abstract: false, final false
  inline bool get_IsSelfSigned();

  /// @brief Method get_IssuerName, addr 0x5880b10, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_IssuerName();

  /// @brief Method get_KeyAlgorithm, addr 0x5880b18, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_KeyAlgorithm();

  /// @brief Method get_KeyAlgorithmParameters, addr 0x5880b20, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_KeyAlgorithmParameters();

  /// @brief Method get_PublicKey, addr 0x5880b9c, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_PublicKey();

  /// @brief Method get_RSA, addr 0x5880c10, size 0x180, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSA* get_RSA();

  /// @brief Method get_RawData, addr 0x5880da0, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_RawData();

  /// @brief Method get_SerialNumber, addr 0x5880e14, size 0x74, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_SerialNumber();

  /// @brief Method get_Signature, addr 0x5880e88, size 0x46c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Signature();

  /// @brief Method get_SubjectName, addr 0x58812f4, size 0x8, virtual true, abstract: false, final false
  inline ::StringW get_SubjectName();

  /// @brief Method get_ValidFrom, addr 0x58812fc, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValidFrom();

  /// @brief Method get_ValidUntil, addr 0x5881304, size 0x8, virtual true, abstract: false, final false
  inline ::System::DateTime get_ValidUntil();

  /// @brief Method get_Version, addr 0x588130c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method set_DSA, addr 0x58808b8, size 0x10, virtual false, abstract: false, final false
  inline void set_DSA(::System::Security::Cryptography::DSA* value);

  /// @brief Method set_KeyAlgorithmParameters, addr 0x5880b94, size 0x8, virtual true, abstract: false, final false
  inline void set_KeyAlgorithmParameters(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method set_RSA, addr 0x5880d90, size 0x10, virtual true, abstract: false, final false
