...
public:
  ...
  /// @brief Method CheckSignature, addr 0x27a28fc, size 0x2f4, virtual false, abstract: false, final false
  inline bool CheckSignature();

  /// @brief Method CompareIssuerSerial, addr 0x27a3640, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x27a2858, size 0xa4, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifyCounterSignature, addr 0x27a3734, size 0xa00, virtual false, abstract: false, final false
  inline bool VerifyCounterSignature(::Mono::Security::__PKCS7__SignerInfo* cs, ::ArrayW<uint8_t, ::Array<uint8_t>*> signature);

  /// @brief Method VerifySignature, addr 0x27a2bf8, size 0xa48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27a26d4, size 0x8c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x27a2760, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> rawData);

  /// @brief Method get_SigningCertificate, addr 0x27a2bf0, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_SigningCertificate();

  /// @brief Method set_RawData, addr 0x27a2788, size 0xd0, virtual false, abstract: false, final false
