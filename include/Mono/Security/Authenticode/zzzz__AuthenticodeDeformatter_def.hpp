...
// Write type traits
MARK_REF_T(::Mono::Security::Authenticode::AuthenticodeDeformatter*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Authenticode::AuthenticodeDeformatter*, "Mono.Security.Authenticode", "AuthenticodeDeformatter");
...
public:
  // Declarations
  __declspec(property(put = set_RawData)) ::ArrayW<uint8_t> RawData;
  ...
  __declspec(property(get = __cordl_internal_get_entry, put = __cordl_internal_set_entry)) ::ArrayW<uint8_t> entry;
  ...
  __declspec(property(get = __cordl_internal_get_hash, put = __cordl_internal_set_hash)) ::ArrayW<uint8_t> hash;
  ...
  /// @brief Method CheckSignature, addr 0x5aa42f4, size 0x2fc, virtual false, abstract: false, final false
  inline bool CheckSignature();

  /// @brief Method CompareIssuerSerial, addr 0x5aa4fac, size 0x104, virtual false, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5aa424c, size 0xa8, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method VerifyCounterSignature, addr 0x5aa50b0, size 0x97c, virtual false, abstract: false, final false
  inline bool VerifyCounterSignature(::Mono::Security::PKCS7_SignerInfo* cs, ::ArrayW<uint8_t> signature);

  /// @brief Method VerifySignature, addr 0x5aa45f8, size 0x9b4, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_entry() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_entry();

  constexpr ::StringW const& __cordl_internal_get_filename() const;

  constexpr ::StringW& __cordl_internal_get_filename();

  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_hash() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_hash();
  ...
  constexpr void __cordl_internal_set_entry(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_filename(::StringW value);

  constexpr void __cordl_internal_set_hash(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x5aa40d0, size 0x84, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5aa4154, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t> rawData);

  /// @brief Method get_SigningCertificate, addr 0x5aa45f0, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::X509::X509Certificate* get_SigningCertificate();

  /// @brief Method set_RawData, addr 0x5aa417c, size 0xd0, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Authenticode::AuthenticodeDeformatter) == 0x98, "Size mismatch!");
