...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AuthenticodeDeformatter", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AuthenticodeDeformatter(AuthenticodeDeformatter&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AuthenticodeDeformatter", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AuthenticodeDeformatter(AuthenticodeDeformatterconst&) = delete;
