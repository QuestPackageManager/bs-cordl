...
/// @brief Method CheckSignature, addr 0x58f7ea4, size 0x2fc, virtual false, abstract: false, final false
inline bool CheckSignature() ;

/// @brief Method CompareIssuerSerial, addr 0x58f8b5c, size 0x104, virtual false, abstract: false, final false
...
/// @brief Method Reset, addr 0x58f7dfc, size 0xa8, virtual false, abstract: false, final false
inline void Reset() ;

/// @brief Method VerifyCounterSignature, addr 0x58f8c60, size 0x97c, virtual false, abstract: false, final false
inline bool VerifyCounterSignature(::Mono::Security::PKCS7_SignerInfo*  cs, ::ArrayW<uint8_t,::Array<uint8_t>*>  signature) ;

/// @brief Method VerifySignature, addr 0x58f81a8, size 0x9b4, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58f7c80, size 0x84, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x58f7d04, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  rawData) ;

/// @brief Method get_SigningCertificate, addr 0x58f81a0, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Security::X509::X509Certificate* get_SigningCertificate() ;

/// @brief Method set_RawData, addr 0x58f7d2c, size 0xd0, virtual false, abstract: false, final false
