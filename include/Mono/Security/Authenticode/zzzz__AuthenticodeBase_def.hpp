...
public:
  ...
  /// @brief Method Close, addr 0x589057c, size 0x2c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method GetHash, addr 0x589095c, size 0x4cc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetHash(::System::Security::Cryptography::HashAlgorithm* hash);

  /// @brief Method GetSecurityEntry, addr 0x5890888, size 0xd4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSecurityEntry();

  static inline ::Mono::Security::Authenticode::AuthenticodeBase* New_ctor();

  /// @brief Method Open, addr 0x58904d4, size 0xa8, virtual false, abstract: false, final false
  inline void Open(::StringW filename);

  /// @brief Method Open, addr 0x58905a8, size 0x90, virtual false, abstract: false, final false
  inline void Open(::ArrayW<uint8_t, ::Array<uint8_t>*> rawdata);

  /// @brief Method ProcessFirstBlock, addr 0x5890638, size 0x250, virtual false, abstract: false, final false
  inline int32_t ProcessFirstBlock();

  /// @brief Method ReadFirstBlock, addr 0x5890408, size 0xcc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x589038c, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PEOffset, addr 0x58903e0, size 0x28, virtual false, abstract: false, final false
