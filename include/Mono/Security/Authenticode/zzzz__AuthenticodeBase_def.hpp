...
public:
  ...
  /// @brief Method Close, addr 0x3c52178, size 0x2c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method GetHash, addr 0x3c52530, size 0x488, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetHash(::System::Security::Cryptography::HashAlgorithm* hash);

  /// @brief Method GetSecurityEntry, addr 0x3c52460, size 0xd0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetSecurityEntry();

  static inline ::Mono::Security::Authenticode::AuthenticodeBase* New_ctor();

  /// @brief Method Open, addr 0x3c520ec, size 0x8c, virtual false, abstract: false, final false
  inline void Open(::StringW filename);

  /// @brief Method Open, addr 0x3c521a4, size 0x84, virtual false, abstract: false, final false
  inline void Open(::ArrayW<uint8_t, ::Array<uint8_t>*> rawdata);

  /// @brief Method ProcessFirstBlock, addr 0x3c52228, size 0x238, virtual false, abstract: false, final false
  inline int32_t ProcessFirstBlock();

  /// @brief Method ReadFirstBlock, addr 0x3c5201c, size 0xd0, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c51f98, size 0x5c, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PEOffset, addr 0x3c51ff4, size 0x28, virtual false, abstract: false, final false
