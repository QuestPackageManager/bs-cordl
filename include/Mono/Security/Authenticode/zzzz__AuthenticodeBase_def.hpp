...
// Write type traits
MARK_REF_T(::Mono::Security::Authenticode::AuthenticodeBase*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Authenticode::AuthenticodeBase*, "Mono.Security.Authenticode", "AuthenticodeBase");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_fileblock, put = __cordl_internal_set_fileblock)) ::ArrayW<uint8_t> fileblock;
  ...
  /// @brief Method Close, addr 0x5aa5b24, size 0x2c, virtual false, abstract: false, final false
  inline void Close();

  /// @brief Method GetHash, addr 0x5aa5f04, size 0x4cc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetHash(::System::Security::Cryptography::HashAlgorithm* hash);

  /// @brief Method GetSecurityEntry, addr 0x5aa5e30, size 0xd4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetSecurityEntry();

  static inline ::Mono::Security::Authenticode::AuthenticodeBase* New_ctor();

  /// @brief Method Open, addr 0x5aa5a7c, size 0xa8, virtual false, abstract: false, final false
  inline void Open(::StringW filename);

  /// @brief Method Open, addr 0x5aa5b50, size 0x90, virtual false, abstract: false, final false
  inline void Open(::ArrayW<uint8_t> rawdata);

  /// @brief Method ProcessFirstBlock, addr 0x5aa5be0, size 0x250, virtual false, abstract: false, final false
  inline int32_t ProcessFirstBlock();

  /// @brief Method ReadFirstBlock, addr 0x5aa59b0, size 0xcc, virtual false, abstract: false, final false
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_fileblock() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_fileblock();

  constexpr ::System::IO::Stream* const& __cordl_internal_get_fs() const;
  ...
  constexpr void __cordl_internal_set_fileblock(::ArrayW<uint8_t> value);
  ...
  /// @brief Method .ctor, addr 0x5aa5934, size 0x54, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_PEOffset, addr 0x5aa5988, size 0x28, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "AuthenticodeBase", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  AuthenticodeBase(AuthenticodeBase&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "AuthenticodeBase", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  AuthenticodeBase(AuthenticodeBaseconst&) = delete;
...
static_assert(sizeof(::Mono::Security::Authenticode::AuthenticodeBase) == 0x40, "Size mismatch!");
