...
public:
  ...
  /// @brief Method CreateFromFile, addr 0x27a4788, size 0x8, virtual false, abstract: false, final false
  static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW filename);

  /// @brief Method CreateFromFile, addr 0x27a4790, size 0x2bc, virtual false, abstract: false, final false
  static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW filename, ::StringW password);

  /// @brief Method Decode, addr 0x27a4218, size 0x450, virtual false, abstract: false, final false
  inline bool Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> pvk, ::StringW password);

  /// @brief Method DeriveKey, addr 0x27a4670, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27a4134, size 0xe4, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::StringW password);

  /// @brief Method get_RSA, addr 0x27a4668, size 0x8, virtual false, abstract: false, final false
