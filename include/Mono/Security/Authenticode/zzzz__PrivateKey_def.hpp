...
public:
  ...
  /// @brief Method CreateFromFile, addr 0x3c4ffc4, size 0x8, virtual false, abstract: false, final false
  static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW filename);

  /// @brief Method CreateFromFile, addr 0x3c4ffcc, size 0x2ac, virtual false, abstract: false, final false
  static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW filename, ::StringW password);

  /// @brief Method Decode, addr 0x3c4fa58, size 0x44c, virtual false, abstract: false, final false
  inline bool Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> pvk, ::StringW password);

  /// @brief Method DeriveKey, addr 0x3c4feac, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c4f980, size 0xd8, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::StringW password);

  /// @brief Method get_RSA, addr 0x3c4fea4, size 0x8, virtual false, abstract: false, final false
