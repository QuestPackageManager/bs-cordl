...
public:
  ...
  /// @brief Method CreateFromFile, addr 0x596bb68, size 0x8, virtual false, abstract: false, final false
  static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW filename);

  /// @brief Method CreateFromFile, addr 0x596bb70, size 0x27c, virtual false, abstract: false, final false
  static inline ::Mono::Security::Authenticode::PrivateKey* CreateFromFile(::StringW filename, ::StringW password);

  /// @brief Method Decode, addr 0x596b5f8, size 0x424, virtual false, abstract: false, final false
  inline bool Decode(::ArrayW<uint8_t, ::Array<uint8_t>*> pvk, ::StringW password);

  /// @brief Method DeriveKey, addr 0x596ba24, size 0x144, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x596b548, size 0xb0, virtual false, abstract: false, final false
  inline void _ctor(::ArrayW<uint8_t, ::Array<uint8_t>*> data, ::StringW password);

  /// @brief Method get_RSA, addr 0x596ba1c, size 0x8, virtual false, abstract: false, final false
