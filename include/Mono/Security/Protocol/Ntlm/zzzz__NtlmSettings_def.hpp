...
namespace Mono::Security::Protocol::Ntlm {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2611)), TypeDefinitionIndex(TypeDefinitionIndex(14037))}
...
public:
  ...
  /// @brief Method get_DefaultAuthLevel addr 0x22a7068 size 0x58 virtual false final false
