...
public:
  ...
  /// @brief Method get_DefaultAuthLevel, addr 0x5a9c8a8, size 0x5c, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NtlmSettings", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NtlmSettings(NtlmSettings&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NtlmSettings", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NtlmSettings(NtlmSettingsconst&) = delete;
