...
/// @brief Method Decode, addr 0x58ee7cc, size 0x184, virtual true, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  message) ;

/// @brief Method Finalize, addr 0x58ee76c, size 0x58, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GetBytes, addr 0x58ee950, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58ee6c8, size 0xa4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  message) ;

/// @brief Method get_Nonce, addr 0x58ed7cc, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Nonce() ;

/// @brief Method get_TargetInfo, addr 0x58ed754, size 0x78, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_TargetInfo() ;

/// @brief Method get_TargetName, addr 0x58ee7c4, size 0x8, virtual false, abstract: false, final false
