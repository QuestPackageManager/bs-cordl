...
DEFINE_IL2CPP_CLASS(::Mono::Security::Protocol::Ntlm::NtlmAuthLevel, "Mono.Security.Protocol.Ntlm", "NtlmAuthLevel");
// Dependencies
namespace Mono::Security::Protocol::Ntlm {
// Is value type: true
...
static_assert(sizeof(::Mono::Security::Protocol::Ntlm::NtlmAuthLevel) == 0x4, "Size mismatch!");
