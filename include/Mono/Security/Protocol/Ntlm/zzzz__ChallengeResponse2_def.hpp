...
public:
  ...
  /// @brief Method Compute, addr 0x3c440dc, size 0x1f8, virtual false, abstract: false, final false
  ...
  /// @brief Method Compute_LM, addr 0x3c430f4, size 0x32c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_LM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLM, addr 0x3c43980, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLM_Password, addr 0x3c4387c, size 0x104, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM_Password(::StringW password);

  /// @brief Method Compute_NTLMv2, addr 0x3c43bb8, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method Compute_NTLMv2_Session, addr 0x3c439ec, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResponse, addr 0x3c43588, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method PasswordToKey, addr 0x3c43420, size 0x168, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PasswordToKey(::StringW password, int32_t position);

  /// @brief Method PrepareDESKey, addr 0x3c442d4, size 0x1f8, virtual false, abstract: false, final false
