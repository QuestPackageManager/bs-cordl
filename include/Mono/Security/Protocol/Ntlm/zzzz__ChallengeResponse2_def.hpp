...
/// @brief Method Compute, addr 0x5961328, size 0x1e4, virtual false, abstract: false, final false
static inline void Compute(::Mono::Security::Protocol::Ntlm::Type2Message*  type2, ::Mono::Security::Protocol::Ntlm::NtlmAuthLevel  level, ::StringW  username, ::StringW  password, ::StringW  domain, ::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  lm, ::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  ntlm) ;

/// @brief Method Compute_LM, addr 0x5960300, size 0x338, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Compute_LM(::StringW  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  challenge) ;

/// @brief Method Compute_NTLM, addr 0x5960bb8, size 0x70, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Compute_NTLM(::StringW  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  challenge) ;

/// @brief Method Compute_NTLM_Password, addr 0x5960ab0, size 0x108, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Compute_NTLM_Password(::StringW  password) ;

/// @brief Method Compute_NTLMv2, addr 0x5960df4, size 0x444, virtual false, abstract: false, final false
...
/// @brief Method Compute_NTLMv2_Session, addr 0x5960c28, size 0x1cc, virtual false, abstract: false, final false
static inline void Compute_NTLMv2_Session(::StringW  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  challenge, ::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  lm, ::ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  ntlm) ;

/// @brief Method GetResponse, addr 0x59607ac, size 0x304, virtual false, abstract: false, final false
...
/// @brief Method PasswordToKey, addr 0x5960638, size 0x174, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> PasswordToKey(::StringW  password, int32_t  position) ;

/// @brief Method PrepareDESKey, addr 0x596150c, size 0x1fc, virtual false, abstract: false, final false
