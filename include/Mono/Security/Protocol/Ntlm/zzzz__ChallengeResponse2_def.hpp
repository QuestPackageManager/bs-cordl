...
public:
  ...
  /// @brief Method Compute, addr 0x2679878, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method Compute_LM, addr 0x2678890, size 0x32c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_LM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLM, addr 0x267911c, size 0x6c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLM_Password, addr 0x2679018, size 0x104, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM_Password(::StringW password);

  /// @brief Method Compute_NTLMv2, addr 0x2679354, size 0x434, virtual false, abstract: false, final false
  ...
  /// @brief Method Compute_NTLMv2_Session, addr 0x2679188, size 0x1cc, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResponse, addr 0x2678d24, size 0x2f4, virtual false, abstract: false, final false
  ...
  /// @brief Method PasswordToKey, addr 0x2678bbc, size 0x168, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PasswordToKey(::StringW password, int32_t position);

  /// @brief Method PrepareDESKey, addr 0x2679a60, size 0x1f8, virtual false, abstract: false, final false
