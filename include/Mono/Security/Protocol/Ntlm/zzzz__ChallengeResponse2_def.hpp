...
public:
  ...
  /// @brief Method Compute_LM addr 0x23ffa50 size 0x32c virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_LM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLM_Password addr 0x24001d8 size 0x104 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM_Password(::StringW password);

  /// @brief Method Compute_NTLM addr 0x24002dc size 0x6c virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Compute_NTLM(::StringW password, ::ArrayW<uint8_t, ::Array<uint8_t>*> challenge);

  /// @brief Method Compute_NTLMv2_Session addr 0x2400348 size 0x1cc virtual false final false
  ...
  /// @brief Method Compute_NTLMv2 addr 0x2400514 size 0x434 virtual false final false
  ...
  /// @brief Method Compute addr 0x2400a38 size 0x1e8 virtual false final false
  ...
  /// @brief Method GetResponse addr 0x23ffee4 size 0x2f4 virtual false final false
  ...
  /// @brief Method PrepareDESKey addr 0x2400c20 size 0x1f8 virtual false final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PrepareDESKey(::ArrayW<uint8_t, ::Array<uint8_t>*> key56bits, int32_t position);

  /// @brief Method PasswordToKey addr 0x23ffd7c size 0x168 virtual false final false
