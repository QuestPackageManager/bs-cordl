...
public:
  ...
  /// @brief Method Decode, addr 0x5a9a7d0, size 0xf0, virtual true, abstract: false, final false
  inline void Decode(::ArrayW<uint8_t> message);

  /// @brief Method GetBytes, addr 0x5a9a8c0, size 0x258, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a9a654, size 0x74, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method set_Domain, addr 0x5a9a6c8, size 0x84, virtual false, abstract: false, final false
  inline void set_Domain(::StringW value);

  /// @brief Method set_Host, addr 0x5a9a74c, size 0x84, virtual false, abstract: false, final false
