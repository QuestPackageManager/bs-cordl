...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5a9e158, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5a9e0d8, size 0x80, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "MonoLocalCertificateSelectionCallback", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  MonoLocalCertificateSelectionCallback(MonoLocalCertificateSelectionCallback&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "MonoLocalCertificateSelectionCallback", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  MonoLocalCertificateSelectionCallback(MonoLocalCertificateSelectionCallbackconst&) = delete;
