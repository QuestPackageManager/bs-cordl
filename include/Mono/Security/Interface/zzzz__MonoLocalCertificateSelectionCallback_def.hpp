...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x25580c4, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2557fec, size 0xd8, virtual false, abstract: false, final false
