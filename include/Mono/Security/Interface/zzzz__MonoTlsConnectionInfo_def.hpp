...
public:
  ...
  /// @brief Method ToString, addr 0x267b928, size 0xbc, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267b9e4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CipherSuiteCode, addr 0x267b900, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::CipherSuiteCode get_CipherSuiteCode();

  /// @brief Method get_ProtocolVersion, addr 0x267b910, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::TlsProtocols get_ProtocolVersion();

  /// @brief Method set_CipherSuiteCode, addr 0x267b908, size 0x8, virtual false, abstract: false, final false
  inline void set_CipherSuiteCode(::Mono::Security::Interface::CipherSuiteCode value);

  /// @brief Method set_PeerDomainName, addr 0x267b920, size 0x8, virtual false, abstract: false, final false
  inline void set_PeerDomainName(::StringW value);

  /// @brief Method set_ProtocolVersion, addr 0x267b918, size 0x8, virtual false, abstract: false, final false
