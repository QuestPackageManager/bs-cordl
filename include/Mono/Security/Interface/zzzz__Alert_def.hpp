...
public:
  // Ctor Parameters [CppParam { name: "", ty: "Alert", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  Alert(Alert&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "Alert", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  Alert(Alertconst&) = delete;
