...
public:
  ...
  /// @brief Method .ctor, addr 0x58ef2b8, size 0x14, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Trusted, addr 0x58ef2cc, size 0x8, virtual false, abstract: false, final false
  inline bool get_Trusted();

  /// @brief Method get_UserDenied, addr 0x58ef2d4, size 0x8, virtual false, abstract: false, final false
