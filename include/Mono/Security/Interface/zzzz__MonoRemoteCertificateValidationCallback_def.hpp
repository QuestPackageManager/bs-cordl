...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3c46390, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c462f0, size 0xa0, virtual false, abstract: false, final false
