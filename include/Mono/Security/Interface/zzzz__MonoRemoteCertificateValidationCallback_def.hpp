...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x3bd03bc, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3bd031c, size 0xa0, virtual false, abstract: false, final false
