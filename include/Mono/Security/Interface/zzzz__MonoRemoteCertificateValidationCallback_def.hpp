...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x267bac4, size 0x1014, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x267b9ec, size 0xd8, virtual false, abstract: false, final false
