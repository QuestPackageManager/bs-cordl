...
public:
  ...
  /// @brief Method .ctor, addr 0x3c482bc, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Security::Interface::Alert* alert, ::StringW message);

  /// @brief Method .ctor, addr 0x3c48330, size 0x74, virtual false, abstract: false, final false
