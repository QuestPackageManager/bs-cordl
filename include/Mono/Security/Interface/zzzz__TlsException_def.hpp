...
/// @brief Method .ctor, addr 0x58efe34, size 0x74, virtual false, abstract: false, final false
inline void _ctor(::Mono::Security::Interface::Alert*  alert, ::StringW  message) ;

/// @brief Method .ctor, addr 0x58efea8, size 0xb4, virtual false, abstract: false, final false
