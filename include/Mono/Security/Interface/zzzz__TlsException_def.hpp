...
// Write type traits
MARK_REF_T(::Mono::Security::Interface::TlsException*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Interface::TlsException*, "Mono.Security.Interface", "TlsException");
...
static_assert(sizeof(::Mono::Security::Interface::TlsException) == 0x98, "Size mismatch!");
