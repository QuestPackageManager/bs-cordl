...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Mono::Security::Interface::MonoRemoteCertificateValidationCallback::*)(::System::Object*, ::System::IntPtr)>(
    &::Mono::Security::Interface::MonoRemoteCertificateValidationCallback::_ctor)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x5a9e044;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(::i2c::class_of<::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*>(),
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<bool (::Mono::Security::Interface::MonoRemoteCertificateValidationCallback::*)(
  ...
  constexpr static std::size_t addrs = 0x5a9e0c4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*>(),
                                                                                          { ::i2c::class_of<::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*>(), 13 }));
    return ___internal_method;
  }
};
...
inline bool Mono::Security::Interface::MonoRemoteCertificateValidationCallback::Invoke(::StringW targetHost, ::System::Security::Cryptography::X509Certificates::X509Certificate* certificate,
  ...
  auto* ___internal_method = THROW_UNLESS(
      ::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*>(), 13 })));
