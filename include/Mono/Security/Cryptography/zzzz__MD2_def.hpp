...
public:
  // Declarations
  /// @brief Method Create, addr 0x27afaf8, size 0x58, virtual false, abstract: false, final false
  static inline ::Mono::Security::Cryptography::MD2* Create();

  static inline ::Mono::Security::Cryptography::MD2* New_ctor();

  /// @brief Method .ctor, addr 0x27afad8, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();
