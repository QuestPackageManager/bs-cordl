...
public:
  ...
  /// @brief Method .ctor, addr 0x2404820, size 0x20, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method Create, addr 0x2404840, size 0x58, virtual false, abstract: false, final false
