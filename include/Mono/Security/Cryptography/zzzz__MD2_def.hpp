...
public:
// Declarations
/// @brief Method Create, addr 0x58f14a4, size 0x54, virtual false, abstract: false, final false
static inline ::Mono::Security::Cryptography::MD2* Create() ;

static inline ::Mono::Security::Cryptography::MD2* New_ctor() ;

/// @brief Method .ctor, addr 0x58f1498, size 0xc, virtual false, abstract: false, final false
inline void _ctor() ;
