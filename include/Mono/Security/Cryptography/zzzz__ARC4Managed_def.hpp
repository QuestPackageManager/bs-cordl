...
// Write type traits
MARK_REF_T(::Mono::Security::Cryptography::ARC4Managed*);
DEFINE_IL2CPP_CLASS(::Mono::Security::Cryptography::ARC4Managed*, "Mono.Security.Cryptography", "ARC4Managed");
...
public:
  ...
  __declspec(property(get = __cordl_internal_get_state, put = __cordl_internal_set_state)) ::ArrayW<uint8_t> state;
  ...
  /// @brief Method CheckInput, addr 0x5a9c95c, size 0x13c, virtual false, abstract: false, final false
  inline void CheckInput(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method CreateDecryptor, addr 0x5a9c824, size 0x2c, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateDecryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgvIV);

  /// @brief Method CreateEncryptor, addr 0x5a9c804, size 0x20, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::ICryptoTransform* CreateEncryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgvIV);

  /// @brief Method Dispose, addr 0x5a9c504, size 0xb0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x5a9c4b4, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GenerateIV, addr 0x5a9c850, size 0x60, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x5a9c8b0, size 0x20, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method InternalTransformBlock, addr 0x5a9cbf4, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method KeySetup, addr 0x5a9c724, size 0xe0, virtual false, abstract: false, final false
  inline void KeySetup(::ArrayW<uint8_t> key);

  static inline ::Mono::Security::Cryptography::ARC4Managed* New_ctor();

  /// @brief Method TransformBlock, addr 0x5a9ca98, size 0x15c, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x5a9cd2c, size 0xa0, virtual true, abstract: false, final true
  ...
  constexpr ::ArrayW<uint8_t> const& __cordl_internal_get_state() const;

  constexpr ::ArrayW<uint8_t>& __cordl_internal_get_state();
  ...
  constexpr void __cordl_internal_set_state(::ArrayW<uint8_t> value);

  constexpr void __cordl_internal_set_x(uint8_t value);

  constexpr void __cordl_internal_set_y(uint8_t value);

  /// @brief Method .ctor, addr 0x5a9c3ac, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanTransformMultipleBlocks, addr 0x5a9c944, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x5a9c94c, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_Key, addr 0x5a9c5b4, size 0x94, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> get_Key();

  /// @brief Method get_OutputBlockSize, addr 0x5a9c954, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Key, addr 0x5a9c648, size 0xdc, virtual true, abstract: false, final false
...
static_assert(sizeof(::Mono::Security::Cryptography::ARC4Managed) == 0x60, "Size mismatch!");
