...
public:
  ...
  /// @brief Method CheckInput, addr 0x5962478, size 0x13c, virtual false, abstract: false, final false
  inline void CheckInput(::ArrayW<uint8_t, ::Array<uint8_t>*> inputBuffer, int32_t inputOffset, int32_t inputCount);

  /// @brief Method CreateDecryptor, addr 0x5962340, size 0x2c, virtual true, abstract: false, final false
  ...
  /// @brief Method CreateEncryptor, addr 0x5962320, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5962020, size 0xb0, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x5961fd0, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GenerateIV, addr 0x596236c, size 0x60, virtual true, abstract: false, final false
  inline void GenerateIV();

  /// @brief Method GenerateKey, addr 0x59623cc, size 0x20, virtual true, abstract: false, final false
  inline void GenerateKey();

  /// @brief Method InternalTransformBlock, addr 0x5962710, size 0x138, virtual false, abstract: false, final false
  ...
  /// @brief Method KeySetup, addr 0x5962240, size 0xe0, virtual false, abstract: false, final false
  inline void KeySetup(::ArrayW<uint8_t, ::Array<uint8_t>*> key);

  static inline ::Mono::Security::Cryptography::ARC4Managed* New_ctor();

  /// @brief Method TransformBlock, addr 0x59625b4, size 0x15c, virtual true, abstract: false, final true
  ...
  /// @brief Method TransformFinalBlock, addr 0x5962848, size 0xa0, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5961ec8, size 0x88, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_CanTransformMultipleBlocks, addr 0x5962460, size 0x8, virtual true, abstract: false, final true
  inline bool get_CanTransformMultipleBlocks();

  /// @brief Method get_InputBlockSize, addr 0x5962468, size 0x8, virtual true, abstract: false, final true
  inline int32_t get_InputBlockSize();

  /// @brief Method get_Key, addr 0x59620d0, size 0x94, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_Key();

  /// @brief Method get_OutputBlockSize, addr 0x5962470, size 0x8, virtual true, abstract: false, final true
  ...
  /// @brief Method set_Key, addr 0x5962164, size 0xdc, virtual true, abstract: false, final false
