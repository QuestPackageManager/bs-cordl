...
public:
  ...
  /// @brief Method .ctor addr 0x2403330 size 0x7c virtual false final false
  inline void _ctor();

  /// @brief Method get_IV addr 0x2407ea4 size 0x44 virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> get_IV();

  /// @brief Method set_IV addr 0x2407ee8 size 0x4 virtual true final false
  inline void set_IV(::ArrayW<uint8_t, ::Array<uint8_t>*> value);

  /// @brief Method Create addr 0x2407eec size 0x58 virtual false final false
