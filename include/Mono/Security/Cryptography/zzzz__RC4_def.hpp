...
public:
  // Ctor Parameters [CppParam { name: "", ty: "RC4", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  RC4(RC4&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "RC4", modifiers: "const&", def_value: None, comment: None }]
