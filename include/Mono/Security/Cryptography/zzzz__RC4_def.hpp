...
public:
  ...
  /// @brief Method Create, addr 0x3c58ac4, size 0x50, virtual false, abstract: false, final false
  static inline ::Mono::Security::Cryptography::RC4* Create();

  static inline ::Mono::Security::Cryptography::RC4* New_ctor();

  /// @brief Method .ctor, addr 0x3c53f80, size 0x7c, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_IV, addr 0x3c58a7c, size 0x44, virtual true, abstract: false, final false
  ...
  /// @brief Method set_IV, addr 0x3c58ac0, size 0x4, virtual true, abstract: false, final false
