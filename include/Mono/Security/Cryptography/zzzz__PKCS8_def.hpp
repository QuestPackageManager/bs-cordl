...
/// @brief Method Decode, addr 0x58f3cfc, size 0x264, virtual false, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method DecodeDSA, addr 0x58f46fc, size 0x11c, virtual false, abstract: false, final false
...
/// @brief Method DecodeRSA, addr 0x58f412c, size 0x3dc, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::RSA* DecodeRSA(::ArrayW<uint8_t,::Array<uint8_t>*>  keypair) ;

/// @brief Method Encode, addr 0x58f4864, size 0x12c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode(::System::Security::Cryptography::AsymmetricAlgorithm*  aa) ;

/// @brief Method Encode, addr 0x58f4818, size 0x4c, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode(::System::Security::Cryptography::DSA*  dsa) ;

/// @brief Method Encode, addr 0x58f4508, size 0x1f4, virtual false, abstract: false, final false
...
/// @brief Method Normalize, addr 0x58f407c, size 0xb0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Normalize(::ArrayW<uint8_t,::Array<uint8_t>*>  bigInt, int32_t  length) ;

/// @brief Method RemoveLeadingZero, addr 0x58f3fdc, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58f3c74, size 0x60, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x58f3cd4, size 0x28, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method get_Algorithm, addr 0x58f3f60, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_PrivateKey, addr 0x58f3f68, size 0x74, virtual false, abstract: false, final false
...
/// @brief Method Decode, addr 0x58f4998, size 0x2a0, virtual false, abstract: false, final false
inline void Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;
...
/// @brief Method .ctor, addr 0x58f4990, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x58f4994, size 0x4, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

/// @brief Method get_Algorithm, addr 0x58f4c38, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_Algorithm() ;

/// @brief Method get_EncryptedData, addr 0x58f4c40, size 0x74, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_EncryptedData() ;

/// @brief Method get_IterationCount, addr 0x58f4d68, size 0x8, virtual false, abstract: false, final false
inline int32_t get_IterationCount() ;

/// @brief Method get_Salt, addr 0x58f4cb4, size 0xb4, virtual false, abstract: false, final false
