...
public:
  ...
  /// @brief Method IV, addr 0x597d8b8, size 0x74, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> IV(int32_t size);

  /// @brief Method Key, addr 0x597d844, size 0x74, virtual false, abstract: false, final false
  ...
  /// @brief Method get_Rng, addr 0x597d7d8, size 0x6c, virtual false, abstract: false, final false
