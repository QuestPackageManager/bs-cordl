...
public:
  // Declarations
  /// @brief Method FromCapiPrivateKeyBlob, addr 0x5a9cf70, size 0x8, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* FromCapiPrivateKeyBlob(::ArrayW<uint8_t> blob);

  /// @brief Method FromCapiPrivateKeyBlob, addr 0x5a9cf78, size 0x224, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::RSA* FromCapiPrivateKeyBlob(::ArrayW<uint8_t> blob, int32_t offset);

  /// @brief Method GetParametersFromCapiPrivateKeyBlob, addr 0x5a9d19c, size 0x590, virtual false, abstract: false, final false
  ...
  /// @brief Method ToHex, addr 0x5a9d72c, size 0x150, virtual false, abstract: false, final false
  static inline ::StringW ToHex(::ArrayW<uint8_t> input);

  /// @brief Method ToInt32LE, addr 0x5a9cdcc, size 0x74, virtual false, abstract: false, final false
  static inline int32_t ToInt32LE(::ArrayW<uint8_t> bytes, int32_t offset);

  /// @brief Method ToUInt32LE, addr 0x5a9ce40, size 0x74, virtual false, abstract: false, final false
  static inline uint32_t ToUInt32LE(::ArrayW<uint8_t> bytes, int32_t offset);

  /// @brief Method Trim, addr 0x5a9ceb4, size 0xbc, virtual false, abstract: false, final false
