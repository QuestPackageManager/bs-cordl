...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5ac1520, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ac13d8, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x5ac10ac, size 0x1d4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExportParameters, addr 0x5ac06e0, size 0x268, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::DSAParameters ExportParameters(bool includePrivateParameters);

  /// @brief Method Finalize, addr 0x5abf9d4, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method Generate, addr 0x5abfa24, size 0x4c, virtual false, abstract: false, final false
  inline void Generate();

  /// @brief Method GenerateKeyPair, addr 0x5abffa0, size 0xe4, virtual false, abstract: false, final false
  inline void GenerateKeyPair();

  /// @brief Method GenerateParams, addr 0x5abfa70, size 0x530, virtual false, abstract: false, final false
  inline void GenerateParams(int32_t keyLength);

  /// @brief Method ImportParameters, addr 0x5ac09b4, size 0x270, virtual true, abstract: false, final false
  ...
  /// @brief Method NormalizeArray, addr 0x5ac063c, size 0xa4, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> NormalizeArray(::ArrayW<uint8_t> array);

  /// @brief Method VerifySignature, addr 0x5ac0c24, size 0x488, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5abf920, size 0xb4, virtual false, abstract: false, final false
  inline void _ctor(int32_t dwKeySize);

  /// @brief Method add, addr 0x5ac01c8, size 0x98, virtual false, abstract: false, final false
  inline void add(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b, int32_t value);

  /// @brief Method add_KeyGenerated, addr 0x5ac1280, size 0xac, virtual false, abstract: false, final false
  inline void add_KeyGenerated(::Mono::Security::Cryptography::DSAManaged_KeyGeneratedEventHandler* value);

  /// @brief Method get_KeySize, addr 0x5ac05a0, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_PublicOnly, addr 0x5ac05c4, size 0x78, virtual false, abstract: false, final false
  inline bool get_PublicOnly();

  /// @brief Method get_Random, addr 0x5ac0260, size 0x20, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::RandomNumberGenerator* get_Random();

  /// @brief Method remove_KeyGenerated, addr 0x5ac132c, size 0xac, virtual false, abstract: false, final false
