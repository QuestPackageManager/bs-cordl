...
public:
  ...
  /// @brief Method Decode, addr 0x3c64b18, size 0xc8, virtual false, abstract: false, final false
  inline void Decode(::ArrayW<uint32_t, ::Array<uint32_t>*> output, ::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t index);

  /// @brief Method Encode, addr 0x3c648dc, size 0xf8, virtual false, abstract: false, final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> output, ::ArrayW<uint32_t, ::Array<uint32_t>*> input);

  /// @brief Method F, addr 0x3c64a4c, size 0x10, virtual false, abstract: false, final false
  inline uint32_t F(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method FF, addr 0x3c64a88, size 0x28, virtual false, abstract: false, final false
  inline void FF(::ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method G, addr 0x3c64a5c, size 0x14, virtual false, abstract: false, final false
  inline uint32_t G(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method GG, addr 0x3c64ab0, size 0x38, virtual false, abstract: false, final false
  inline void GG(::ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method H, addr 0x3c64a70, size 0xc, virtual false, abstract: false, final false
  inline uint32_t H(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method HH, addr 0x3c64ae8, size 0x30, virtual false, abstract: false, final false
  inline void HH(::ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method HashCore, addr 0x3c64044, size 0x124, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x3c647e0, size 0xfc, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x3c63f90, size 0xb4, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method MD4Transform, addr 0x3c64168, size 0x678, virtual false, abstract: false, final false
  ...
  /// @brief Method Padding, addr 0x3c649d4, size 0x78, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Padding(int32_t nLength);

  /// @brief Method ROL, addr 0x3c64a7c, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c63ec0, size 0xd0, virtual false, abstract: false, final false
  inline void _ctor();
