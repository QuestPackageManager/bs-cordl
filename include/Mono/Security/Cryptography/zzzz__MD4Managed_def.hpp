...
public:
  ...
  /// @brief Method .ctor addr 0x2404f68 size 0xd0 virtual false final false
  inline void _ctor();

  /// @brief Method Initialize addr 0x2405038 size 0xb4 virtual true final false
  inline void Initialize();

  /// @brief Method HashCore addr 0x24050ec size 0x124 virtual true final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal addr 0x2405888 size 0xfc virtual true final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Padding addr 0x2405a7c size 0x78 virtual false final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> Padding(int32_t nLength);

  /// @brief Method F addr 0x2405af4 size 0x10 virtual false final false
  inline uint32_t F(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method G addr 0x2405b04 size 0x14 virtual false final false
  inline uint32_t G(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method H addr 0x2405b18 size 0xc virtual false final false
  inline uint32_t H(uint32_t x, uint32_t y, uint32_t z);

  /// @brief Method ROL addr 0x2405b24 size 0x10 virtual false final false
  inline uint32_t ROL(uint32_t x, uint8_t n);

  /// @brief Method FF addr 0x2405b34 size 0x2c virtual false final false
  inline void FF(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method GG addr 0x2405b60 size 0x3c virtual false final false
  inline void GG(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method HH addr 0x2405b9c size 0x34 virtual false final false
  inline void HH(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s);

  /// @brief Method Encode addr 0x2405984 size 0xf8 virtual false final false
  inline void Encode(::ArrayW<uint8_t, ::Array<uint8_t>*> output, ::ArrayW<uint32_t, ::Array<uint32_t>*> input);

  /// @brief Method Decode addr 0x2405bd0 size 0xb4 virtual false final false
  inline void Decode(::ArrayW<uint32_t, ::Array<uint32_t>*> output, ::ArrayW<uint8_t, ::Array<uint8_t>*> input, int32_t index);

  /// @brief Method MD4Transform addr 0x2405210 size 0x678 virtual false final false
