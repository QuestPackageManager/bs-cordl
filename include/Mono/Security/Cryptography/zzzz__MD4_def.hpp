...
public:
  // Declarations
  /// @brief Method Create, addr 0x588af4c, size 0x54, virtual false, abstract: false, final false
  static inline ::Mono::Security::Cryptography::MD4* Create();

  static inline ::Mono::Security::Cryptography::MD4* New_ctor();

  /// @brief Method .ctor, addr 0x588af40, size 0xc, virtual false, abstract: false, final false
  inline void _ctor();
