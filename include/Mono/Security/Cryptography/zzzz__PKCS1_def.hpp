...
public:
  ...
  /// @brief Method Compare, addr 0x25127ec, size 0x74, virtual false, abstract: false, final false
  static inline bool Compare(::ArrayW<uint8_t, ::Array<uint8_t>*> array1, ::ArrayW<uint8_t, ::Array<uint8_t>*> array2);

  /// @brief Method CreateFromName, addr 0x2512e00, size 0x410, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromName(::StringW name);

  /// @brief Method Encode_v15, addr 0x2513210, size 0x350, virtual false, abstract: false, final false
  ...
  /// @brief Method I2OSP, addr 0x2512860, size 0x8c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> I2OSP(::ArrayW<uint8_t, ::Array<uint8_t>*> x, int32_t size);

  /// @brief Method OS2IP, addr 0x25128ec, size 0xbc, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> OS2IP(::ArrayW<uint8_t, ::Array<uint8_t>*> x);

  /// @brief Method RSAVP1, addr 0x25129a8, size 0x1c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> RSAVP1(::System::Security::Cryptography::RSA* rsa, ::ArrayW<uint8_t, ::Array<uint8_t>*> s);

  /// @brief Method Verify_v15, addr 0x25129c4, size 0x80, virtual false, abstract: false, final false
  ...
  /// @brief Method Verify_v15, addr 0x2512a44, size 0x1e0, virtual false, abstract: false, final false
  static inline bool Verify_v15(::System::Security::Cryptography::RSA* rsa, ::System::Security::Cryptography::HashAlgorithm* hash, ::ArrayW<uint8_t, ::Array<uint8_t>*> hashValue,
                                ::ArrayW<uint8_t, ::Array<uint8_t>*> signature, bool tryNonStandardEncoding);

  /// @brief Method Verify_v15, addr 0x2512c24, size 0x1dc, virtual false, abstract: false, final false
