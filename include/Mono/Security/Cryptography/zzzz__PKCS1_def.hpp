...
/// @brief Method Compare, addr 0x59824c0, size 0x70, virtual false, abstract: false, final false
static inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  array1, ::ArrayW<uint8_t,::Array<uint8_t>*>  array2) ;

/// @brief Method CreateFromName, addr 0x5982ad8, size 0x43c, virtual false, abstract: false, final false
static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromName(::StringW  name) ;

/// @brief Method Encode_v15, addr 0x5982f14, size 0x308, virtual false, abstract: false, final false
...
/// @brief Method I2OSP, addr 0x5982530, size 0x90, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> I2OSP(::ArrayW<uint8_t,::Array<uint8_t>*>  x, int32_t  size) ;

/// @brief Method OS2IP, addr 0x59825c0, size 0xd0, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> OS2IP(::ArrayW<uint8_t,::Array<uint8_t>*>  x) ;

/// @brief Method RSAVP1, addr 0x5982690, size 0x18, virtual false, abstract: false, final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> RSAVP1(::System::Security::Cryptography::RSA*  rsa, ::ArrayW<uint8_t,::Array<uint8_t>*>  s) ;

/// @brief Method Verify_v15, addr 0x59826a8, size 0x84, virtual false, abstract: false, final false
...
/// @brief Method Verify_v15, addr 0x598272c, size 0x218, virtual false, abstract: false, final false
...
/// @brief Method Verify_v15, addr 0x5982944, size 0x194, virtual false, abstract: false, final false
