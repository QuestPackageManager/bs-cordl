...
public:
  ...
  /// @brief Method Compare, addr 0x5aa1258, size 0x70, virtual false, abstract: false, final false
  static inline bool Compare(::ArrayW<uint8_t> array1, ::ArrayW<uint8_t> array2);

  /// @brief Method CreateFromName, addr 0x5aa1e30, size 0x43c, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromName(::StringW name);

  /// @brief Method CreateFromOid, addr 0x5aa1dd0, size 0x60, virtual false, abstract: false, final false
  static inline ::System::Security::Cryptography::HashAlgorithm* CreateFromOid(::StringW oid);

  /// @brief Method Encode_v15, addr 0x5aa1658, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method HashNameFromOid, addr 0x5aa1974, size 0x41c, virtual false, abstract: false, final false
  static inline ::StringW HashNameFromOid(::StringW oid, bool throwOnError);

  /// @brief Method I2OSP, addr 0x5aa12c8, size 0x90, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> I2OSP(::ArrayW<uint8_t> x, int32_t size);

  /// @brief Method OS2IP, addr 0x5aa1358, size 0xd0, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> OS2IP(::ArrayW<uint8_t> x);

  /// @brief Method RSAVP1, addr 0x5aa1428, size 0x18, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> RSAVP1(::System::Security::Cryptography::RSA* rsa, ::ArrayW<uint8_t> s);

  /// @brief Method Verify_v15, addr 0x5aa1440, size 0x218, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "PKCS1", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  PKCS1(PKCS1&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "PKCS1", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  PKCS1(PKCS1const&) = delete;
