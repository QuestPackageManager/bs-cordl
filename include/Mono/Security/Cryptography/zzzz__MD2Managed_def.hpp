...
public:
  ...
  /// @brief Method HashCore, addr 0x5ab9bf0, size 0xdc, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t> array, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x5ab9f34, size 0xf0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> HashFinal();

  /// @brief Method Initialize, addr 0x5ab9b90, size 0x60, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method MD2Transform, addr 0x5ab9ccc, size 0x268, virtual false, abstract: false, final false
  ...
  /// @brief Method Padding, addr 0x5ab98c8, size 0x2c8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ab981c, size 0xac, virtual false, abstract: false, final false
  inline void _ctor();
