...
public:
  ...
  /// @brief Method HashCore, addr 0x2575d9c, size 0xdc, virtual true, abstract: false, final false
  inline void HashCore(::ArrayW<uint8_t, ::Array<uint8_t>*> array, int32_t ibStart, int32_t cbSize);

  /// @brief Method HashFinal, addr 0x25760d0, size 0xf0, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> HashFinal();

  /// @brief Method Initialize, addr 0x2575d3c, size 0x60, virtual true, abstract: false, final false
  inline void Initialize();

  /// @brief Method MD2Transform, addr 0x2575e78, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method Padding, addr 0x2575ca0, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2575bfc, size 0xa4, virtual false, abstract: false, final false
  inline void _ctor();
