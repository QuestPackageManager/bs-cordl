...
public:
// Declarations
/// @brief Method Invoke, addr 0x58f71d0, size 0x14, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58f7088, size 0x148, virtual false, abstract: false, final false
...
/// @brief Method Dispose, addr 0x58f67ac, size 0x208, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method EncryptValue, addr 0x58f5a5c, size 0x114, virtual true, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> EncryptValue(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb) ;

/// @brief Method ExportParameters, addr 0x58f5f0c, size 0x32c, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::RSAParameters ExportParameters(bool  includePrivateParameters) ;

/// @brief Method Finalize, addr 0x58f4ff0, size 0x50, virtual true, abstract: false, final false
inline void Finalize() ;

/// @brief Method GenerateKeyPair, addr 0x58f5040, size 0x26c, virtual false, abstract: false, final false
inline void GenerateKeyPair() ;

/// @brief Method GetPaddedValue, addr 0x58f5dfc, size 0xbc, virtual false, abstract: false, final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPaddedValue(::Mono::Math::BigInteger*  value, int32_t  length) ;

/// @brief Method ImportParameters, addr 0x58f6378, size 0x434, virtual true, abstract: false, final false
...
/// @brief Method ToXmlString, addr 0x58f69b4, size 0x6d4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x58f4f20, size 0x8, virtual false, abstract: false, final false
inline void _ctor() ;

/// @brief Method .ctor, addr 0x58f4f28, size 0xc8, virtual false, abstract: false, final false
inline void _ctor(int32_t  keySize) ;

/// @brief Method get_KeySize, addr 0x58f5868, size 0x94, virtual true, abstract: false, final false
inline int32_t get_KeySize() ;

/// @brief Method get_PublicOnly, addr 0x58f58fc, size 0xa4, virtual false, abstract: false, final false
