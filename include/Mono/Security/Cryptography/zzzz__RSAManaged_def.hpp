...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x2516b28, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25169f8, size 0x130, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x2516038, size 0x204, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EncryptValue, addr 0x25152ac, size 0x10c, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> EncryptValue(::ArrayW<uint8_t, ::Array<uint8_t>*> rgb);

  /// @brief Method ExportParameters, addr 0x251576c, size 0x334, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSAParameters ExportParameters(bool includePrivateParameters);

  /// @brief Method Finalize, addr 0x25147a0, size 0xa0, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GenerateKeyPair, addr 0x2514840, size 0x268, virtual false, abstract: false, final false
  inline void GenerateKeyPair();

  /// @brief Method GetPaddedValue, addr 0x251566c, size 0xb0, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t, ::Array<uint8_t>*> GetPaddedValue(::Mono::Math::BigInteger* value, int32_t length);

  /// @brief Method ImportParameters, addr 0x2515bcc, size 0x46c, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXmlString, addr 0x2516374, size 0x684, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x25146b0, size 0xf0, virtual false, abstract: false, final false
  inline void _ctor(int32_t keySize);

  /// @brief Method add_KeyGenerated, addr 0x251623c, size 0x9c, virtual false, abstract: false, final false
  inline void add_KeyGenerated(::Mono::Security::Cryptography::__RSAManaged__KeyGeneratedEventHandler* value);

  /// @brief Method get_KeySize, addr 0x25150b8, size 0xa4, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_PublicOnly, addr 0x251515c, size 0xa0, virtual false, abstract: false, final false
  inline bool get_PublicOnly();

  /// @brief Method remove_KeyGenerated, addr 0x25162d8, size 0x9c, virtual false, abstract: false, final false
