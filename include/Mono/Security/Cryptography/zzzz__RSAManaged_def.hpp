...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5aa5920, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5aa57d8, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x5aa4efc, size 0x208, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EncryptValue, addr 0x5aa41ac, size 0x114, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> EncryptValue(::ArrayW<uint8_t> rgb);

  /// @brief Method ExportParameters, addr 0x5aa465c, size 0x32c, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSAParameters ExportParameters(bool includePrivateParameters);

  /// @brief Method Finalize, addr 0x5aa3740, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GenerateKeyPair, addr 0x5aa3790, size 0x26c, virtual false, abstract: false, final false
  inline void GenerateKeyPair();

  /// @brief Method GetPaddedValue, addr 0x5aa454c, size 0xbc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetPaddedValue(::Mono::Math::BigInteger* value, int32_t length);

  /// @brief Method ImportParameters, addr 0x5aa4ac8, size 0x434, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXmlString, addr 0x5aa5104, size 0x6d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5aa3670, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method .ctor, addr 0x5aa3678, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(int32_t keySize);

  /// @brief Method get_KeySize, addr 0x5aa3fb8, size 0x94, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_PublicOnly, addr 0x5aa404c, size 0xa4, virtual false, abstract: false, final false
