...
public:
  // Declarations
  /// @brief Method Invoke, addr 0x5abe20c, size 0x14, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5abe0c4, size 0x148, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Dispose, addr 0x5abd690, size 0x208, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method EncryptValue, addr 0x5abc940, size 0x114, virtual true, abstract: false, final false
  inline ::ArrayW<uint8_t> EncryptValue(::ArrayW<uint8_t> rgb);

  /// @brief Method ExportParameters, addr 0x5abcdf0, size 0x32c, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::RSAParameters ExportParameters(bool includePrivateParameters);

  /// @brief Method Finalize, addr 0x5abbed4, size 0x50, virtual true, abstract: false, final false
  inline void Finalize();

  /// @brief Method GenerateKeyPair, addr 0x5abbf24, size 0x26c, virtual false, abstract: false, final false
  inline void GenerateKeyPair();

  /// @brief Method GetPaddedValue, addr 0x5abcce0, size 0xbc, virtual false, abstract: false, final false
  inline ::ArrayW<uint8_t> GetPaddedValue(::Mono::Math::BigInteger* value, int32_t length);

  /// @brief Method ImportParameters, addr 0x5abd25c, size 0x434, virtual true, abstract: false, final false
  ...
  /// @brief Method ToXmlString, addr 0x5abd9f0, size 0x6d4, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5abbe0c, size 0xc8, virtual false, abstract: false, final false
  inline void _ctor(int32_t keySize);

  /// @brief Method add_KeyGenerated, addr 0x5abd898, size 0xac, virtual false, abstract: false, final false
  inline void add_KeyGenerated(::Mono::Security::Cryptography::RSAManaged_KeyGeneratedEventHandler* value);

  /// @brief Method get_KeySize, addr 0x5abc74c, size 0x94, virtual true, abstract: false, final false
  inline int32_t get_KeySize();

  /// @brief Method get_PublicOnly, addr 0x5abc7e0, size 0xa4, virtual false, abstract: false, final false
  inline bool get_PublicOnly();

  /// @brief Method remove_KeyGenerated, addr 0x5abd944, size 0xac, virtual false, abstract: false, final false
