...
public:
  ...
  /// @brief Method CanSecure, addr 0x5abb9b0, size 0x84, virtual false, abstract: false, final false
  static inline bool CanSecure(::StringW path);

  /// @brief Method Copy, addr 0x5aba188, size 0x98, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::CspParameters* Copy(::System::Security::Cryptography::CspParameters* p);

  /// @brief Method FromXml, addr 0x5abb16c, size 0x124, virtual false, abstract: false, final false
  inline void FromXml(::StringW xml);

  /// @brief Method IsMachineProtected, addr 0x5abb914, size 0x74, virtual false, abstract: false, final false
  static inline bool IsMachineProtected(::StringW path);

  /// @brief Method IsUserProtected, addr 0x5abb8a0, size 0x74, virtual false, abstract: false, final false
  static inline bool IsUserProtected(::StringW path);

  /// @brief Method Load, addr 0x5abb00c, size 0x160, virtual false, abstract: false, final false
  inline bool Load();
  ...
  /// @brief Method ProtectMachine, addr 0x5abb7a4, size 0x74, virtual false, abstract: false, final false
  static inline bool ProtectMachine(::StringW path);

  /// @brief Method ProtectUser, addr 0x5abb818, size 0x74, virtual false, abstract: false, final false
  static inline bool ProtectUser(::StringW path);

  /// @brief Method Remove, addr 0x5abb88c, size 0x14, virtual false, abstract: false, final false
  inline void Remove();

  /// @brief Method Save, addr 0x5abb290, size 0x220, virtual false, abstract: false, final false
  inline void Save();

  /// @brief Method ToXml, addr 0x5abb4b0, size 0x2f4, virtual false, abstract: false, final false
  inline ::StringW ToXml();

  /// @brief Method _CanSecure, addr 0x5abb988, size 0x8, virtual false, abstract: false, final false
  static inline bool _CanSecure(char16_t* root);

  /// @brief Method _IsMachineProtected, addr 0x5abb9a8, size 0x8, virtual false, abstract: false, final false
  static inline bool _IsMachineProtected(char16_t* path);

  /// @brief Method _IsUserProtected, addr 0x5abb9a0, size 0x8, virtual false, abstract: false, final false
  static inline bool _IsUserProtected(char16_t* path);

  /// @brief Method _ProtectMachine, addr 0x5abb998, size 0x8, virtual false, abstract: false, final false
  static inline bool _ProtectMachine(char16_t* path);

  /// @brief Method _ProtectUser, addr 0x5abb990, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5aba110, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(::System::Security::Cryptography::CspParameters* parameters);

  /// @brief Method .ctor, addr 0x5aba118, size 0x70, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanChange, addr 0x5abaffc, size 0x10, virtual false, abstract: false, final false
  inline bool get_CanChange();

  /// @brief Method get_ContainerName, addr 0x5aba3d4, size 0x100, virtual false, abstract: false, final false
  inline ::StringW get_ContainerName();

  /// @brief Method get_Filename, addr 0x5aba220, size 0x1b4, virtual false, abstract: false, final false
  inline ::StringW get_Filename();

  /// @brief Method get_KeyValue, addr 0x5abafe0, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_KeyValue();

  /// @brief Method get_MachinePath, addr 0x5aba4f0, size 0x578, virtual false, abstract: false, final false
  static inline ::StringW get_MachinePath();

  /// @brief Method get_UseDefaultKeyContainer, addr 0x5abba34, size 0x1c, virtual false, abstract: false, final false
  inline bool get_UseDefaultKeyContainer();

  /// @brief Method get_UseMachineKeyStore, addr 0x5aba4d4, size 0x1c, virtual false, abstract: false, final false
  inline bool get_UseMachineKeyStore();

  /// @brief Method get_UserPath, addr 0x5abaa68, size 0x578, virtual false, abstract: false, final false
  ...
  /// @brief Method set_KeyValue, addr 0x5abafe8, size 0x14, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "KeyPairPersistence", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  KeyPairPersistence(KeyPairPersistence&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "KeyPairPersistence", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  KeyPairPersistence(KeyPairPersistenceconst&) = delete;
