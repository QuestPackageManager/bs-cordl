...
/// @brief Method CanSecure, addr 0x590d260, size 0x84, virtual false, abstract: false, final false
static inline bool CanSecure(::StringW  path) ;

/// @brief Method Copy, addr 0x590ba38, size 0x98, virtual false, abstract: false, final false
inline ::System::Security::Cryptography::CspParameters* Copy(::System::Security::Cryptography::CspParameters*  p) ;

/// @brief Method FromXml, addr 0x590ca1c, size 0x124, virtual false, abstract: false, final false
inline void FromXml(::StringW  xml) ;

/// @brief Method IsMachineProtected, addr 0x590d1c4, size 0x74, virtual false, abstract: false, final false
static inline bool IsMachineProtected(::StringW  path) ;

/// @brief Method IsUserProtected, addr 0x590d150, size 0x74, virtual false, abstract: false, final false
static inline bool IsUserProtected(::StringW  path) ;

/// @brief Method Load, addr 0x590c8bc, size 0x160, virtual false, abstract: false, final false
inline bool Load() ;
...
/// @brief Method ProtectMachine, addr 0x590d054, size 0x74, virtual false, abstract: false, final false
static inline bool ProtectMachine(::StringW  path) ;

/// @brief Method ProtectUser, addr 0x590d0c8, size 0x74, virtual false, abstract: false, final false
static inline bool ProtectUser(::StringW  path) ;

/// @brief Method Remove, addr 0x590d13c, size 0x14, virtual false, abstract: false, final false
inline void Remove() ;

/// @brief Method Save, addr 0x590cb40, size 0x220, virtual false, abstract: false, final false
inline void Save() ;

/// @brief Method ToXml, addr 0x590cd60, size 0x2f4, virtual false, abstract: false, final false
inline ::StringW ToXml() ;

/// @brief Method _CanSecure, addr 0x590d238, size 0x8, virtual false, abstract: false, final false
static inline bool _CanSecure(char16_t*  root) ;

/// @brief Method _IsMachineProtected, addr 0x590d258, size 0x8, virtual false, abstract: false, final false
static inline bool _IsMachineProtected(char16_t*  path) ;

/// @brief Method _IsUserProtected, addr 0x590d250, size 0x8, virtual false, abstract: false, final false
static inline bool _IsUserProtected(char16_t*  path) ;

/// @brief Method _ProtectMachine, addr 0x590d248, size 0x8, virtual false, abstract: false, final false
static inline bool _ProtectMachine(char16_t*  path) ;

/// @brief Method _ProtectUser, addr 0x590d240, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x590b9c0, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::System::Security::Cryptography::CspParameters*  parameters) ;

/// @brief Method .ctor, addr 0x590b9c8, size 0x70, virtual false, abstract: false, final false
...
/// @brief Method get_CanChange, addr 0x590c8ac, size 0x10, virtual false, abstract: false, final false
inline bool get_CanChange() ;

/// @brief Method get_ContainerName, addr 0x590bc84, size 0x100, virtual false, abstract: false, final false
inline ::StringW get_ContainerName() ;

/// @brief Method get_Filename, addr 0x590bad0, size 0x1b4, virtual false, abstract: false, final false
inline ::StringW get_Filename() ;

/// @brief Method get_KeyValue, addr 0x590c890, size 0x8, virtual false, abstract: false, final false
inline ::StringW get_KeyValue() ;

/// @brief Method get_MachinePath, addr 0x590bda0, size 0x578, virtual false, abstract: false, final false
static inline ::StringW get_MachinePath() ;

/// @brief Method get_UseDefaultKeyContainer, addr 0x590d2e4, size 0x1c, virtual false, abstract: false, final false
inline bool get_UseDefaultKeyContainer() ;

/// @brief Method get_UseMachineKeyStore, addr 0x590bd84, size 0x1c, virtual false, abstract: false, final false
inline bool get_UseMachineKeyStore() ;

/// @brief Method get_UserPath, addr 0x590c318, size 0x578, virtual false, abstract: false, final false
...
/// @brief Method set_KeyValue, addr 0x590c898, size 0x14, virtual false, abstract: false, final false
