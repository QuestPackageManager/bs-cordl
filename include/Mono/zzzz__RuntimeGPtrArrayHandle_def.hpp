...
public:
  ...
  /// @brief Method DestroyAndFree, addr 0x3c55e84, size 0x1c, virtual false, abstract: false, final false
  static inline void DestroyAndFree(::ByRef<::Mono::RuntimeGPtrArrayHandle> h);

  /// @brief Method GPtrArrayFree, addr 0x3c55e80, size 0x4, virtual false, abstract: false, final false
  static inline void GPtrArrayFree(::cordl_internals::Ptr<::Mono::RuntimeStructs_GPtrArray> value);

  /// @brief Method Lookup, addr 0x3c55e1c, size 0x64, virtual false, abstract: false, final false
  inline ::System::IntPtr Lookup(int32_t i);

  /// @brief Method .ctor, addr 0x3c55ddc, size 0x20, virtual false, abstract: false, final false
  inline void _ctor(::System::IntPtr ptr);

  /// @brief Method get_Item, addr 0x3c55e18, size 0x4, virtual false, abstract: false, final false
  inline ::System::IntPtr get_Item(int32_t i);

  /// @brief Method get_Length, addr 0x3c55dfc, size 0x1c, virtual false, abstract: false, final false
