...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x2c7e7b8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x2c7e858, size 0xd8, virtual false, abstract: false, final false
