...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x4118088, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x4118120, size 0xd0, virtual false, abstract: false, final false
