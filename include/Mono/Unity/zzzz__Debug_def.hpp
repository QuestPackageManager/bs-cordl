...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x5e1c460, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x5e1c4f8, size 0xd0, virtual false, abstract: false, final false
