...
public:
  // Declarations
  /// @brief Method CheckAndThrow addr 0x269ca50 size 0xa0 virtual false final false
  ...
  /// @brief Method CheckAndThrow addr 0x269caf0 size 0xd8 virtual false final false
