...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x4105c48, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x4105ce0, size 0xd0, virtual false, abstract: false, final false
