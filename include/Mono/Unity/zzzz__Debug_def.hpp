...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x410f058, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x410f0f0, size 0xd0, virtual false, abstract: false, final false
