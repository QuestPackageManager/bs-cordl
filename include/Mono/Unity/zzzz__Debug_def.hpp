...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x2b5e7cc, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x2b5e86c, size 0xd8, virtual false, abstract: false, final false
