...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x2963ef8, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x2963f98, size 0xd8, virtual false, abstract: false, final false
