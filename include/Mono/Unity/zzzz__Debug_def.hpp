...
public:
  // Declarations
  /// @brief Method CheckAndThrow addr 0x2817a5c size 0xa0 virtual false final false
  ...
  /// @brief Method CheckAndThrow addr 0x2817afc size 0xd8 virtual false final false
