...
public:
  // Declarations
  /// @brief Method CheckAndThrow, addr 0x5fcb7a0, size 0x98, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckAndThrow, addr 0x5fcb838, size 0xd0, virtual false, abstract: false, final false
