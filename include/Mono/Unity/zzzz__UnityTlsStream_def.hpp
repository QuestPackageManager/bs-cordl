...
public:
// Declarations
/// @brief Method CreateContext, addr 0x5e21c24, size 0x6c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e2111c, size 0x98, virtual false, abstract: false, final false
