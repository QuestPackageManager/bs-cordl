...
public:
  ...
  /// @brief Method .ctor, addr 0x281cccc, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateContext, addr 0x281d81c, size 0x70, virtual true, abstract: false, final false
