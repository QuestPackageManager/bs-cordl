...
public:
  // Declarations
  /// @brief Method CreateContext, addr 0x5e93c30, size 0x6c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e93128, size 0x98, virtual false, abstract: false, final false
