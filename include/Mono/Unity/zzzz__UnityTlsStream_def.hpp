...
public:
  // Declarations
  /// @brief Method CreateContext, addr 0x2b6458c, size 0x70, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b63a3c, size 0x94, virtual false, abstract: false, final false
