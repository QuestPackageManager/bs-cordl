...
public:
  // Ctor Parameters [CppParam { name: "", ty: "UnityTlsStream", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  UnityTlsStream(UnityTlsStream&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "UnityTlsStream", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  UnityTlsStream(UnityTlsStreamconst&) = delete;
