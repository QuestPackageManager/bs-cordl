...
public:
  // Declarations
  /// @brief Method CreateContext, addr 0x41145c4, size 0x68, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4113aa4, size 0x94, virtual false, abstract: false, final false
