...
namespace Mono::Unity {
// Is value type: false
// Dependencies: [TypeDefinitionIndex(TypeDefinitionIndex(6846))]
...
public:
  ...
  /// @brief Method .ctor, addr 0x28214b4, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method CreateContext, addr 0x2822004, size 0x70, virtual true, abstract: false, final false
