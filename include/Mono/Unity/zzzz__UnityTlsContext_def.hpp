...
/// @brief Method CertificateCallback, addr 0x5e20674, size 0x2d0, virtual false, abstract: false, final false
...
/// @brief Method CertificateCallback, addr 0x5e1e5c0, size 0x110, virtual false, abstract: false, final false
static inline void CertificateCallback(void*  userData, ::Mono::Unity::UnityTls_unitytls_tlsctx*  ctx, uint8_t*  cn, ::System::IntPtr  cnLen, ::Mono::Unity::UnityTls_unitytls_x509name*  caList, ::System::IntPtr  caListLen, ::Mono::Unity::UnityTls_unitytls_x509list_ref*  chain, ::Mono::Unity::UnityTls_unitytls_key_ref*  key, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState) ;

/// @brief Method Dispose, addr 0x5e1f648, size 0x78, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExtractNativeKeyAndChainFromManagedCertificate, addr 0x5e1eef4, size 0x31c, virtual false, abstract: false, final false
...
/// @brief Method FinishHandshake, addr 0x5e1f9dc, size 0x114, virtual true, abstract: false, final false
...
/// @brief Method PendingRenegotiation, addr 0x5e1f530, size 0x8, virtual true, abstract: false, final false
inline bool PendingRenegotiation() ;

/// @brief Method ProcessHandshake, addr 0x5e1f824, size 0x168, virtual true, abstract: false, final false
inline bool ProcessHandshake() ;

/// @brief Method Read, addr 0x5e1f228, size 0x16c, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadCallback, addr 0x5e1fee8, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method ReadCallback, addr 0x5e1e3b8, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Renegotiate, addr 0x5e1f4f8, size 0x38, virtual true, abstract: false, final false
inline void Renegotiate() ;

/// @brief Method Shutdown, addr 0x5e1f538, size 0xf8, virtual true, abstract: false, final false
inline void Shutdown() ;

/// @brief Method StartHandshake, addr 0x5e1f6c0, size 0x164, virtual true, abstract: false, final false
inline void StartHandshake() ;

/// @brief Method VerifyCallback, addr 0x5e2029c, size 0x364, virtual false, abstract: false, final false
...
/// @brief Method VerifyCallback, addr 0x5e1e4c8, size 0xf8, virtual false, abstract: false, final false
...
/// @brief Method Write, addr 0x5e1f394, size 0x164, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteCallback, addr 0x5e1fb10, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method WriteCallback, addr 0x5e1e2a8, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e1e6d0, size 0x68c, virtual false, abstract: false, final false
...
/// @brief Method get_IsAuthenticated, addr 0x5e1f210, size 0x8, virtual true, abstract: false, final false
inline bool get_IsAuthenticated() ;

/// @brief Method get_LocalClientCertificate, addr 0x5e1f218, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalClientCertificate() ;

/// @brief Method get_RemoteCertificate, addr 0x5e1f220, size 0x8, virtual true, abstract: false, final false
