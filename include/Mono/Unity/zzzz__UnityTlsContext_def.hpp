...
public:
  ...
  /// @brief Method CertificateCallback, addr 0x5e1ffb4, size 0x2d0, virtual false, abstract: false, final false
  ...
  /// @brief Method CertificateCallback, addr 0x5e1df00, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5e1ef88, size 0x78, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExtractNativeKeyAndChainFromManagedCertificate, addr 0x5e1e834, size 0x31c, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishHandshake, addr 0x5e1f31c, size 0x114, virtual true, abstract: false, final false
  ...
  /// @brief Method PendingRenegotiation, addr 0x5e1ee70, size 0x8, virtual true, abstract: false, final false
  inline bool PendingRenegotiation();

  /// @brief Method ProcessHandshake, addr 0x5e1f164, size 0x168, virtual true, abstract: false, final false
  inline bool ProcessHandshake();

  /// @brief Method Read, addr 0x5e1eb68, size 0x16c, virtual true, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadCallback, addr 0x5e1f828, size 0x298, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCallback, addr 0x5e1dcf8, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method Renegotiate, addr 0x5e1ee38, size 0x38, virtual true, abstract: false, final false
  inline void Renegotiate();

  /// @brief Method Shutdown, addr 0x5e1ee78, size 0xf8, virtual true, abstract: false, final false
  inline void Shutdown();

  /// @brief Method StartHandshake, addr 0x5e1f000, size 0x164, virtual true, abstract: false, final false
  inline void StartHandshake();

  /// @brief Method VerifyCallback, addr 0x5e1fbdc, size 0x364, virtual false, abstract: false, final false
  ...
  /// @brief Method VerifyCallback, addr 0x5e1de08, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5e1ecd4, size 0x164, virtual true, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteCallback, addr 0x5e1f450, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteCallback, addr 0x5e1dbe8, size 0x110, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e1e010, size 0x68c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsAuthenticated, addr 0x5e1eb50, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsAuthenticated();

  /// @brief Method get_LocalClientCertificate, addr 0x5e1eb58, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalClientCertificate();

  /// @brief Method get_RemoteCertificate, addr 0x5e1eb60, size 0x8, virtual true, abstract: false, final false
