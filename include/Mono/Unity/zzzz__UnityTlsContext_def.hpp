...
/// @brief Field certificateCallback, offset 0x80, size 0x8 
 __declspec(property(get=__cordl_internal_get_certificateCallback, put=__cordl_internal_set_certificateCallback)) ::Mono::Unity::UnityTls_unitytls_tlsctx_certificate_callback*  certificateCallback;
...
/// @brief Field localClientCertificate, offset 0x90, size 0x8 
 __declspec(property(get=__cordl_internal_get_localClientCertificate, put=__cordl_internal_set_localClientCertificate)) ::System::Security::Cryptography::X509Certificates::X509Certificate*  localClientCertificate;
...
/// @brief Field requestedClientCertChain, offset 0x60, size 0x8 
 __declspec(property(get=__cordl_internal_get_requestedClientCertChain, put=__cordl_internal_set_requestedClientCertChain)) ::Mono::Unity::UnityTls_unitytls_x509list*  requestedClientCertChain;

/// @brief Field requestedClientKey, offset 0x68, size 0x8 
 __declspec(property(get=__cordl_internal_get_requestedClientKey, put=__cordl_internal_set_requestedClientKey)) ::Mono::Unity::UnityTls_unitytls_key*  requestedClientKey;

/// @brief Field tlsContext, offset 0x58, size 0x8 
 __declspec(property(get=__cordl_internal_get_tlsContext, put=__cordl_internal_set_tlsContext)) ::Mono::Unity::UnityTls_unitytls_tlsctx*  tlsContext;
...
/// @brief Method CertificateCallback, addr 0x5e941f8, size 0x2d0, virtual false, abstract: false, final false
inline void CertificateCallback(::Mono::Unity::UnityTls_unitytls_tlsctx*  ctx, uint8_t*  cn, ::System::IntPtr  cnLen, ::Mono::Unity::UnityTls_unitytls_x509name*  caList, ::System::IntPtr  caListLen, ::Mono::Unity::UnityTls_unitytls_x509list_ref*  chain, ::Mono::Unity::UnityTls_unitytls_key_ref*  key, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState) ;

/// @brief Method CertificateCallback, addr 0x5e92144, size 0x110, virtual false, abstract: false, final false
static inline void CertificateCallback(void*  userData, ::Mono::Unity::UnityTls_unitytls_tlsctx*  ctx, uint8_t*  cn, ::System::IntPtr  cnLen, ::Mono::Unity::UnityTls_unitytls_x509name*  caList, ::System::IntPtr  caListLen, ::Mono::Unity::UnityTls_unitytls_x509list_ref*  chain, ::Mono::Unity::UnityTls_unitytls_key_ref*  key, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState) ;

/// @brief Method Dispose, addr 0x5e931cc, size 0x78, virtual true, abstract: false, final false
inline void Dispose(bool  disposing) ;

/// @brief Method ExtractNativeKeyAndChainFromManagedCertificate, addr 0x5e92a78, size 0x31c, virtual false, abstract: false, final false
static inline void ExtractNativeKeyAndChainFromManagedCertificate(::System::Security::Cryptography::X509Certificates::X509Certificate*  cert, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState, ::ByRef<::Mono::Unity::UnityTls_unitytls_x509list*>  nativeCertChain, ::ByRef<::Mono::Unity::UnityTls_unitytls_key*>  nativeKey) ;

/// @brief Method FinishHandshake, addr 0x5e93560, size 0x114, virtual true, abstract: false, final false
...
/// @brief Method PendingRenegotiation, addr 0x5e930b4, size 0x8, virtual true, abstract: false, final false
inline bool PendingRenegotiation() ;

/// @brief Method ProcessHandshake, addr 0x5e933a8, size 0x168, virtual true, abstract: false, final false
inline bool ProcessHandshake() ;

/// @brief Method Read, addr 0x5e92dac, size 0x16c, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method ReadCallback, addr 0x5e93a6c, size 0x298, virtual false, abstract: false, final false
...
/// @brief Method ReadCallback, addr 0x5e91f3c, size 0x110, virtual false, abstract: false, final false
...
/// @brief Method Renegotiate, addr 0x5e9307c, size 0x38, virtual true, abstract: false, final false
inline void Renegotiate() ;

/// @brief Method Shutdown, addr 0x5e930bc, size 0xf8, virtual true, abstract: false, final false
inline void Shutdown() ;

/// @brief Method StartHandshake, addr 0x5e93244, size 0x164, virtual true, abstract: false, final false
inline void StartHandshake() ;

/// @brief Method VerifyCallback, addr 0x5e93e20, size 0x364, virtual false, abstract: false, final false
...
/// @brief Method VerifyCallback, addr 0x5e9204c, size 0xf8, virtual false, abstract: false, final false
static inline ::Mono::Unity::UnityTls_unitytls_x509verify_result VerifyCallback(void*  userData, ::Mono::Unity::UnityTls_unitytls_x509list_ref  chain, ::Mono::Unity::UnityTls_unitytls_errorstate*  errorState) ;

/// @brief Method Write, addr 0x5e92f18, size 0x164, virtual true, abstract: false, final false
inline ::System::ValueTuple_2<int32_t,bool> Write(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  count) ;

/// @brief Method WriteCallback, addr 0x5e93694, size 0x1f0, virtual false, abstract: false, final false
...
/// @brief Method WriteCallback, addr 0x5e91e2c, size 0x110, virtual false, abstract: false, final false
...
constexpr ::Mono::Unity::UnityTls_unitytls_x509list* const& __cordl_internal_get_requestedClientCertChain() const;

constexpr ::Mono::Unity::UnityTls_unitytls_x509list*& __cordl_internal_get_requestedClientCertChain() ;

constexpr ::Mono::Unity::UnityTls_unitytls_key* const& __cordl_internal_get_requestedClientKey() const;

constexpr ::Mono::Unity::UnityTls_unitytls_key*& __cordl_internal_get_requestedClientKey() ;

constexpr ::Mono::Unity::UnityTls_unitytls_tlsctx* const& __cordl_internal_get_tlsContext() const;

constexpr ::Mono::Unity::UnityTls_unitytls_tlsctx*& __cordl_internal_get_tlsContext() ;
...
constexpr void __cordl_internal_set_requestedClientCertChain(::Mono::Unity::UnityTls_unitytls_x509list*  value) ;

constexpr void __cordl_internal_set_requestedClientKey(::Mono::Unity::UnityTls_unitytls_key*  value) ;

constexpr void __cordl_internal_set_tlsContext(::Mono::Unity::UnityTls_unitytls_tlsctx*  value) ;
...
/// @brief Method .ctor, addr 0x5e92254, size 0x68c, virtual false, abstract: false, final false
...
/// @brief Method get_IsAuthenticated, addr 0x5e92d94, size 0x8, virtual true, abstract: false, final false
inline bool get_IsAuthenticated() ;

/// @brief Method get_LocalClientCertificate, addr 0x5e92d9c, size 0x8, virtual true, abstract: false, final false
inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalClientCertificate() ;

/// @brief Method get_RemoteCertificate, addr 0x5e92da4, size 0x8, virtual true, abstract: false, final false
...
/// @brief Field requestedClientCertChain, offset: 0x60, size: 0x8, def value: None
 ::Mono::Unity::UnityTls_unitytls_x509list*  ___requestedClientCertChain;

/// @brief Field requestedClientKey, offset: 0x68, size: 0x8, def value: None
 ::Mono::Unity::UnityTls_unitytls_key*  ___requestedClientKey;
