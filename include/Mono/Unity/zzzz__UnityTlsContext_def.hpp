...
public:
  ...
  /// @brief Method CertificateCallback, addr 0x410ebbc, size 0x2c4, virtual false, abstract: false, final false
  ...
  /// @brief Method CertificateCallback, addr 0x410c870, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x410d9d4, size 0x78, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method ExtractNativeKeyAndChainFromManagedCertificate, addr 0x410d1b4, size 0x354, virtual false, abstract: false, final false
  ...
  /// @brief Method FinishHandshake, addr 0x410dd88, size 0x124, virtual true, abstract: false, final false
  ...
  /// @brief Method PendingRenegotiation, addr 0x410d8b8, size 0x8, virtual true, abstract: false, final false
  inline bool PendingRenegotiation();

  /// @brief Method ProcessHandshake, addr 0x410dbcc, size 0x16c, virtual true, abstract: false, final false
  inline bool ProcessHandshake();

  /// @brief Method Read, addr 0x410d520, size 0x1b4, virtual true, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadCallback, addr 0x410e314, size 0x2f8, virtual false, abstract: false, final false
  ...
  /// @brief Method ReadCallback, addr 0x410c6f8, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method Renegotiate, addr 0x410d880, size 0x38, virtual true, abstract: false, final false
  inline void Renegotiate();

  /// @brief Method Shutdown, addr 0x410d8c0, size 0xf8, virtual true, abstract: false, final false
  inline void Shutdown();

  /// @brief Method StartHandshake, addr 0x410da4c, size 0x180, virtual true, abstract: false, final false
  inline void StartHandshake();

  /// @brief Method VerifyCallback, addr 0x410e718, size 0x424, virtual false, abstract: false, final false
  inline ::Mono::Unity::UnityTls_unitytls_x509verify_result VerifyCallback(::Mono::Unity::UnityTls_unitytls_x509list_ref chain,
                                                                           ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate> errorState);

  /// @brief Method VerifyCallback, addr 0x410c7c0, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x410d6d4, size 0x1ac, virtual true, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteCallback, addr 0x410decc, size 0x260, virtual false, abstract: false, final false
  ...
  /// @brief Method WriteCallback, addr 0x410c630, size 0xc8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x410c938, size 0x6d0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsAuthenticated, addr 0x410d508, size 0x8, virtual true, abstract: false, final false
  inline bool get_IsAuthenticated();

  /// @brief Method get_LocalClientCertificate, addr 0x410d510, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalClientCertificate();

  /// @brief Method get_RemoteCertificate, addr 0x410d518, size 0x8, virtual true, abstract: false, final false
