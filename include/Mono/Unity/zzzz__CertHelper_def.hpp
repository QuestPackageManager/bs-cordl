...
public:
  // Ctor Parameters [CppParam { name: "", ty: "CertHelper", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  CertHelper(CertHelper&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "CertHelper", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  CertHelper(CertHelperconst&) = delete;
