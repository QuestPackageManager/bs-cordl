...
public:
  // Declarations
  /// @brief Method AddCertificateToNativeChain, addr 0x41059d0, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCertificatesToNativeChain, addr 0x41057f8, size 0x1d8, virtual false, abstract: false, final false
