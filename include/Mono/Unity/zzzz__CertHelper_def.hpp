...
public:
  // Declarations
  /// @brief Method AddCertificateToNativeChain, addr 0x2b5e528, size 0x1c0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCertificatesToNativeChain, addr 0x2b5e350, size 0x1d8, virtual false, abstract: false, final false
