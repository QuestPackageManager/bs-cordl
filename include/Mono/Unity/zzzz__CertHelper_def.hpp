...
public:
  // Declarations
  /// @brief Method AddCertificatesToNativeChain addr 0x28175e0 size 0x1d8 virtual false final false
  ...
  /// @brief Method AddCertificateToNativeChain addr 0x28177b8 size 0x1c0 virtual false final false
