...
public:
  // Declarations
  /// @brief Method AddCertificateToNativeChain, addr 0x410c188, size 0x1b0, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCertificatesToNativeChain, addr 0x410bfb0, size 0x1d8, virtual false, abstract: false, final false
