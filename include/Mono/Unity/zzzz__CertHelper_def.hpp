...
public:
  // Declarations
  /// @brief Method AddCertificateToNativeChain, addr 0x5e8e8c0, size 0x1a4, virtual false, abstract: false, final false
  ...
  /// @brief Method AddCertificatesToNativeChain, addr 0x5e8e720, size 0x1a0, virtual false, abstract: false, final false
