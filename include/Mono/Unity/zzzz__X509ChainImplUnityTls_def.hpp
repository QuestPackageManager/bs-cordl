...
public:
  // Ctor Parameters [CppParam { name: "", ty: "X509ChainImplUnityTls", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  X509ChainImplUnityTls(X509ChainImplUnityTls&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "X509ChainImplUnityTls", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  X509ChainImplUnityTls(X509ChainImplUnityTlsconst&) = delete;
