...
public:
  ...
  /// @brief Method AddStatus, addr 0x5e93f8c, size 0x11c, virtual true, abstract: false, final false
  inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error);

  /// @brief Method Build, addr 0x5e940b0, size 0x8, virtual true, abstract: false, final false
  inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Dispose, addr 0x5e94138, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5e940b8, size 0x80, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5e9260c, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Unity::UnityTls_unitytls_x509list_ref nativeCertificateChain, bool reverseOrder);

  /// @brief Method .ctor, addr 0x5e93a50, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ChainElements, addr 0x5e93ccc, size 0x2c0, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements();

  /// @brief Method get_ChainPolicy, addr 0x5e940a8, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy();

  /// @brief Method get_IsValid, addr 0x5e93c9c, size 0x28, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_NativeCertificateChain, addr 0x5e93cc4, size 0x8, virtual false, abstract: false, final false
