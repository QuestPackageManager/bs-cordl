...
public:
  ...
  /// @brief Method AddStatus, addr 0x5e218c0, size 0x11c, virtual true, abstract: false, final false
  inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error);

  /// @brief Method Build, addr 0x5e219e4, size 0x8, virtual true, abstract: false, final false
  inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Dispose, addr 0x5e21a6c, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5e219ec, size 0x80, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5e1ff40, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Unity::UnityTls_unitytls_x509list_ref nativeCertificateChain, bool reverseOrder);

  /// @brief Method .ctor, addr 0x5e21384, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ChainElements, addr 0x5e21600, size 0x2c0, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements();

  /// @brief Method get_ChainPolicy, addr 0x5e219dc, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy();

  /// @brief Method get_IsValid, addr 0x5e215d0, size 0x28, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_NativeCertificateChain, addr 0x5e215f8, size 0x8, virtual false, abstract: false, final false
