...
public:
  ...
  /// @brief Method AddStatus, addr 0x5db9d34, size 0x11c, virtual true, abstract: false, final false
  inline void AddStatus(::System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error);

  /// @brief Method Build, addr 0x5db9e58, size 0x8, virtual true, abstract: false, final false
  inline bool Build(::System::Security::Cryptography::X509Certificates::X509Certificate2* certificate);

  /// @brief Method Dispose, addr 0x5db9ee0, size 0xc, virtual true, abstract: false, final false
  ...
  /// @brief Method Reset, addr 0x5db9e60, size 0x80, virtual true, abstract: false, final false
  inline void Reset();
  ...
  /// @brief Method .ctor, addr 0x5db83b4, size 0x74, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Unity::UnityTls_unitytls_x509list_ref nativeCertificateChain, bool reverseOrder);

  /// @brief Method .ctor, addr 0x5db97f8, size 0xb0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ChainElements, addr 0x5db9a74, size 0x2c0, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainElementCollection* get_ChainElements();

  /// @brief Method get_ChainPolicy, addr 0x5db9e50, size 0x8, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509ChainPolicy* get_ChainPolicy();

  /// @brief Method get_IsValid, addr 0x5db9a44, size 0x28, virtual true, abstract: false, final false
  inline bool get_IsValid();

  /// @brief Method get_NativeCertificateChain, addr 0x5db9a6c, size 0x8, virtual false, abstract: false, final false
...
static_assert(::cordl_internals::size_check_v<::Mono::Unity::X509ChainImplUnityTls, 0x40>, "Size mismatch!");
