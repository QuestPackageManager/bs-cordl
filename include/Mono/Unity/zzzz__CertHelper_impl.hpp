...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
    static_cast<void (*)(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>, ::System::Security::Cryptography::X509Certificates::X509CertificateCollection*,
                         ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>)>(&::Mono::Unity::CertHelper::AddCertificatesToNativeChain)> {
  constexpr static std::size_t size = 0x1d8;
  constexpr static std::size_t addrs = 0x41057f8;
  ...
  inline static ::MethodInfo const* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
        ...
        ::std::array<Il2CppType const*, 3>{ ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>>::get(),
...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<
    static_cast<void (*)(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list>, ::System::Security::Cryptography::X509Certificates::X509Certificate*,
                         ::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_errorstate>)>(&::Mono::Unity::CertHelper::AddCertificateToNativeChain)> {
  constexpr static std::size_t size = 0x1b0;
  constexpr static std::size_t addrs = 0x41059d0;
...
inline void Mono::Unity::CertHelper::AddCertificatesToNativeChain(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list> nativeCertificateChain,
...
inline void Mono::Unity::CertHelper::AddCertificateToNativeChain(::cordl_internals::Ptr<::Mono::Unity::UnityTls_unitytls_x509list> nativeCertificateChain,
