...
// CppParam { name: "public_key_token", ty: "::Mono::__MonoAssemblyName___public_key_token_e__FixedBuffer", modifiers: "", def_value: Some("{}") }, CppParam { name: "hash_alg", ty: "uint32_t",
// modifiers: "", def_value: Some("{}") }, CppParam { name: "hash_len", ty: "uint32_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "flags", ty: "uint32_t", modifiers: "", def_value:
// Some("{}") }, CppParam { name: "major", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "minor", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name:
// "build", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "revision", ty: "uint16_t", modifiers: "", def_value: Some("{}") }, CppParam { name: "arch", ty: "uint16_t",
...
constexpr ::Mono::MonoAssemblyName::MonoAssemblyName(::System::IntPtr name, ::System::IntPtr culture, ::System::IntPtr hash_value, ::System::IntPtr public_key,
                                                     ::Mono::__MonoAssemblyName___public_key_token_e__FixedBuffer public_key_token, uint32_t hash_alg, uint32_t hash_len, uint32_t flags,
                                                     uint16_t major, uint16_t minor, uint16_t build, uint16_t revision, uint16_t arch) noexcept {
  this->name = name;
