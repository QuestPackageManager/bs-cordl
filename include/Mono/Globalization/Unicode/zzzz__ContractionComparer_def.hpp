...
// Write type traits
MARK_REF_T(::Mono::Globalization::Unicode::ContractionComparer*);
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::ContractionComparer*, "Mono.Globalization.Unicode", "ContractionComparer");
...
public:
  ...
  /// @brief Method Compare, addr 0x5ab07a4, size 0x9c, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x5ab0840, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "ContractionComparer", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  ContractionComparer(ContractionComparer&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "ContractionComparer", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  ContractionComparer(ContractionComparerconst&) = delete;
...
static_assert(sizeof(::Mono::Globalization::Unicode::ContractionComparer) == 0x10, "Size mismatch!");
