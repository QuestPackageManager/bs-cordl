...
public:
  ...
  /// @brief Method Compare, addr 0x3c586c4, size 0x94, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x3c58758, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
