...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5978054, size 0x1c, virtual false, abstract: false, final false
...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5979d04, size 0x10, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method Category, addr 0x5976bb0, size 0xa4, virtual false, abstract: false, final false
  inline uint8_t Category(int32_t cp);

  /// @brief Method ClearBuffer, addr 0x5977df0, size 0x264, virtual false, abstract: false, final false
  inline void ClearBuffer(uint8_t* buffer, int32_t size);

  /// @brief Method Compare, addr 0x59786e0, size 0xac, virtual false, abstract: false, final false
  ...
  /// @brief Method CompareFlagPair, addr 0x5979d14, size 0x1c, virtual false, abstract: false, final false
  inline int32_t CompareFlagPair(bool b1, bool b2);

  /// @brief Method CompareInternal, addr 0x597878c, size 0x1578, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSortKeyRaw, addr 0x5978070, size 0x370, virtual false, abstract: false, final false
  ...
  /// @brief Method FillSurrogateSortKeyRaw, addr 0x5978594, size 0xb4, virtual false, abstract: false, final false
  inline void FillSurrogateSortKeyRaw(int32_t i, ::Mono::Globalization::Unicode::SortKeyBuffer* buf);

  /// @brief Method FilterExtender, addr 0x59774f0, size 0x220, virtual false, abstract: false, final false
  ...
  /// @brief Method FilterOptions, addr 0x59772cc, size 0x100, virtual false, abstract: false, final false
  inline int32_t FilterOptions(int32_t i, ::System::Globalization::CompareOptions opt);

  /// @brief Method GetContraction, addr 0x5976eb0, size 0xd0, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW s, int32_t start, int32_t end);

  /// @brief Method GetContraction, addr 0x5976f80, size 0xd4, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW s, int32_t start, int32_t end,
                                                                     ::ArrayW<::Mono::Globalization::Unicode::Contraction*, ::Array<::Mono::Globalization::Unicode::Contraction*>*> clist);

  /// @brief Method GetExtenderType, addr 0x59773cc, size 0xfc, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType GetExtenderType(int32_t i);

  /// @brief Method GetNeutralCulture, addr 0x5976b40, size 0x70, virtual false, abstract: false, final false
  static inline ::System::Globalization::CultureInfo* GetNeutralCulture(::System::Globalization::CultureInfo* info);

  /// @brief Method GetSortKey, addr 0x59777ec, size 0x1c, virtual true, abstract: false, final true
  inline ::System::Globalization::SortKey* GetSortKey(::StringW s, ::System::Globalization::CompareOptions options);

  /// @brief Method GetSortKey, addr 0x5977808, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method GetSortKey, addr 0x5977a48, size 0x384, virtual false, abstract: false, final false
  ...
  /// @brief Method GetTailContraction, addr 0x5977054, size 0xd0, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW s, int32_t start, int32_t end);

  /// @brief Method GetTailContraction, addr 0x5977124, size 0x1a8, virtual false, abstract: false, final false
  inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW s, int32_t start, int32_t end,
                                                                         ::ArrayW<::Mono::Globalization::Unicode::Contraction*, ::Array<::Mono::Globalization::Unicode::Contraction*>*> clist);

  /// @brief Method IndexOf, addr 0x597a214, size 0x200, virtual true, abstract: false, final true
  inline int32_t IndexOf(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method IndexOf, addr 0x597a414, size 0x518, virtual false, abstract: false, final false
  ...
  /// @brief Method IndexOfOrdinal, addr 0x597a92c, size 0xc8, virtual false, abstract: false, final false
  inline int32_t IndexOfOrdinal(::StringW s, ::StringW target, int32_t start, int32_t length);

  /// @brief Method IndexOfOrdinal, addr 0x597a9f4, size 0x5c, virtual false, abstract: false, final false
  inline int32_t IndexOfOrdinal(::StringW s, char16_t target, int32_t start, int32_t length);

  /// @brief Method IndexOfSortKey, addr 0x597aa50, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method IsHalfKana, addr 0x5976e34, size 0x7c, virtual false, abstract: false, final false
  static inline bool IsHalfKana(int32_t cp, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsIgnorable, addr 0x5977710, size 0x80, virtual false, abstract: false, final false
  static inline bool IsIgnorable(int32_t i, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsPrefix, addr 0x5979d4c, size 0xf0, virtual false, abstract: false, final false
  inline bool IsPrefix(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsPrefix, addr 0x5979e3c, size 0x68, virtual false, abstract: false, final false
  ...
  /// @brief Method IsPrefix, addr 0x5979d30, size 0x1c, virtual true, abstract: false, final true
  inline bool IsPrefix(::StringW src, ::StringW target, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsSafe, addr 0x5977790, size 0x5c, virtual false, abstract: false, final false
  inline bool IsSafe(int32_t i);

  /// @brief Method IsSuffix, addr 0x5979ec0, size 0x94, virtual false, abstract: false, final false
  inline bool IsSuffix(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method IsSuffix, addr 0x5979ea4, size 0x1c, virtual true, abstract: false, final true
  inline bool IsSuffix(::StringW src, ::StringW target, ::System::Globalization::CompareOptions opt);

  /// @brief Method LastIndexOf, addr 0x5979f54, size 0x198, virtual true, abstract: false, final true
  inline int32_t LastIndexOf(::StringW s, ::StringW target, int32_t start, int32_t length, ::System::Globalization::CompareOptions opt);

  /// @brief Method LastIndexOf, addr 0x597ac84, size 0x580, virtual false, abstract: false, final false
  ...
  /// @brief Method LastIndexOfOrdinal, addr 0x597b204, size 0x104, virtual false, abstract: false, final false
  inline int32_t LastIndexOfOrdinal(::StringW s, ::StringW target, int32_t start, int32_t length);

  /// @brief Method LastIndexOfSortKey, addr 0x597b308, size 0x9c, virtual false, abstract: false, final false
  ...
  /// @brief Method Level1, addr 0x5976c54, size 0xa4, virtual false, abstract: false, final false
  inline uint8_t Level1(int32_t cp);

  /// @brief Method Level2, addr 0x5976cf8, size 0x13c, virtual false, abstract: false, final false
  inline uint8_t Level2(int32_t cp, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType ext);

  /// @brief Method MatchesBackward, addr 0x597b3a4, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesBackwardCore, addr 0x597bb20, size 0x4e8, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesForward, addr 0x597aae4, size 0x1a0, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesForwardCore, addr 0x597b54c, size 0x39c, virtual false, abstract: false, final false
  ...
  /// @brief Method MatchesPrimitive, addr 0x597b8e8, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method QuickIndexOf, addr 0x597a0ec, size 0x128, virtual false, abstract: false, final false
  inline int32_t QuickIndexOf(::StringW s, ::StringW target, int32_t start, int32_t length, ::ByRef<bool> testWasUnable);

  /// @brief Method SetCJKTable, addr 0x5976a64, size 0xdc, virtual false, abstract: false, final false
  ...
  /// @brief Method System.Globalization.ISimpleCollator.Compare, addr 0x59786dc, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method ToDashTypeValue, addr 0x59774c8, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5976734, size 0x330, virtual false, abstract: false, final false
