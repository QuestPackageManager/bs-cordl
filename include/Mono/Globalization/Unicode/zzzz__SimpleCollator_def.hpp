...
public:
// Declarations
/// @brief Method .ctor, addr 0x59060e8, size 0x1c, virtual false, abstract: false, final false
...
public:
// Declarations
/// @brief Method .ctor, addr 0x5907d98, size 0x10, virtual false, abstract: false, final false
...
/// @brief Method Category, addr 0x5904c44, size 0xa4, virtual false, abstract: false, final false
inline uint8_t Category(int32_t  cp) ;

/// @brief Method ClearBuffer, addr 0x5905e84, size 0x264, virtual false, abstract: false, final false
inline void ClearBuffer(uint8_t*  buffer, int32_t  size) ;

/// @brief Method Compare, addr 0x5906774, size 0xac, virtual false, abstract: false, final false
...
/// @brief Method CompareFlagPair, addr 0x5907da8, size 0x1c, virtual false, abstract: false, final false
inline int32_t CompareFlagPair(bool  b1, bool  b2) ;

/// @brief Method CompareInternal, addr 0x5906820, size 0x1578, virtual false, abstract: false, final false
...
/// @brief Method FillSortKeyRaw, addr 0x5906104, size 0x370, virtual false, abstract: false, final false
...
/// @brief Method FillSurrogateSortKeyRaw, addr 0x5906628, size 0xb4, virtual false, abstract: false, final false
inline void FillSurrogateSortKeyRaw(int32_t  i, ::Mono::Globalization::Unicode::SortKeyBuffer*  buf) ;

/// @brief Method FilterExtender, addr 0x5905584, size 0x220, virtual false, abstract: false, final false
...
/// @brief Method FilterOptions, addr 0x5905360, size 0x100, virtual false, abstract: false, final false
inline int32_t FilterOptions(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method GetContraction, addr 0x5904f44, size 0xd0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetContraction, addr 0x5905014, size 0xd4, virtual false, abstract: false, final false
...
/// @brief Method GetExtenderType, addr 0x5905460, size 0xfc, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType GetExtenderType(int32_t  i) ;

/// @brief Method GetNeutralCulture, addr 0x5904bd4, size 0x70, virtual false, abstract: false, final false
static inline ::System::Globalization::CultureInfo* GetNeutralCulture(::System::Globalization::CultureInfo*  info) ;

/// @brief Method GetSortKey, addr 0x5905880, size 0x1c, virtual true, abstract: false, final true
inline ::System::Globalization::SortKey* GetSortKey(::StringW  s, ::System::Globalization::CompareOptions  options) ;

/// @brief Method GetSortKey, addr 0x590589c, size 0xc0, virtual false, abstract: false, final false
...
/// @brief Method GetSortKey, addr 0x5905adc, size 0x384, virtual false, abstract: false, final false
...
/// @brief Method GetTailContraction, addr 0x59050e8, size 0xd0, virtual false, abstract: false, final false
inline ::Mono::Globalization::Unicode::Contraction* GetTailContraction(::StringW  s, int32_t  start, int32_t  end) ;

/// @brief Method GetTailContraction, addr 0x59051b8, size 0x1a8, virtual false, abstract: false, final false
...
/// @brief Method IndexOf, addr 0x59082a8, size 0x200, virtual true, abstract: false, final true
inline int32_t IndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IndexOf, addr 0x59084a8, size 0x518, virtual false, abstract: false, final false
...
/// @brief Method IndexOfOrdinal, addr 0x59089c0, size 0xc8, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfOrdinal, addr 0x5908a88, size 0x5c, virtual false, abstract: false, final false
inline int32_t IndexOfOrdinal(::StringW  s, char16_t  target, int32_t  start, int32_t  length) ;

/// @brief Method IndexOfSortKey, addr 0x5908ae4, size 0x94, virtual false, abstract: false, final false
inline int32_t IndexOfSortKey(::StringW  s, int32_t  start, int32_t  length, uint8_t*  sortkey, char16_t  target, int32_t  ti, bool  noLv4, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method IsHalfKana, addr 0x5904ec8, size 0x7c, virtual false, abstract: false, final false
static inline bool IsHalfKana(int32_t  cp, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsIgnorable, addr 0x59057a4, size 0x80, virtual false, abstract: false, final false
static inline bool IsIgnorable(int32_t  i, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x5907de0, size 0xf0, virtual false, abstract: false, final false
inline bool IsPrefix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsPrefix, addr 0x5907ed0, size 0x68, virtual false, abstract: false, final false
...
/// @brief Method IsPrefix, addr 0x5907dc4, size 0x1c, virtual true, abstract: false, final true
inline bool IsPrefix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSafe, addr 0x5905824, size 0x5c, virtual false, abstract: false, final false
inline bool IsSafe(int32_t  i) ;

/// @brief Method IsSuffix, addr 0x5907f54, size 0x94, virtual false, abstract: false, final false
inline bool IsSuffix(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method IsSuffix, addr 0x5907f38, size 0x1c, virtual true, abstract: false, final true
inline bool IsSuffix(::StringW  src, ::StringW  target, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x5907fe8, size 0x198, virtual true, abstract: false, final true
inline int32_t LastIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::System::Globalization::CompareOptions  opt) ;

/// @brief Method LastIndexOf, addr 0x5908d18, size 0x580, virtual false, abstract: false, final false
...
/// @brief Method LastIndexOfOrdinal, addr 0x5909298, size 0x104, virtual false, abstract: false, final false
inline int32_t LastIndexOfOrdinal(::StringW  s, ::StringW  target, int32_t  start, int32_t  length) ;

/// @brief Method LastIndexOfSortKey, addr 0x590939c, size 0x9c, virtual false, abstract: false, final false
inline int32_t LastIndexOfSortKey(::StringW  s, int32_t  start, int32_t  orgStart, int32_t  length, uint8_t*  sortkey, int32_t  ti, bool  noLv4, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method Level1, addr 0x5904ce8, size 0xa4, virtual false, abstract: false, final false
inline uint8_t Level1(int32_t  cp) ;

/// @brief Method Level2, addr 0x5904d8c, size 0x13c, virtual false, abstract: false, final false
inline uint8_t Level2(int32_t  cp, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext) ;

/// @brief Method MatchesBackward, addr 0x5909438, size 0x1a8, virtual false, abstract: false, final false
inline bool MatchesBackward(::StringW  s, ::ByRef<int32_t>  idx, int32_t  end, int32_t  orgStart, int32_t  ti, uint8_t*  sortkey, bool  noLv4, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesBackwardCore, addr 0x5909bb4, size 0x4e8, virtual false, abstract: false, final false
inline bool MatchesBackwardCore(::StringW  s, ::ByRef<int32_t>  idx, int32_t  end, int32_t  orgStart, int32_t  ti, uint8_t*  sortkey, bool  noLv4, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, ::ByRef<::Mono::Globalization::Unicode::Contraction*>  ct, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesForward, addr 0x5908b78, size 0x1a0, virtual false, abstract: false, final false
...
/// @brief Method MatchesForwardCore, addr 0x59095e0, size 0x39c, virtual false, abstract: false, final false
inline bool MatchesForwardCore(::StringW  s, ::ByRef<int32_t>  idx, int32_t  end, int32_t  ti, uint8_t*  sortkey, bool  noLv4, ::Mono::Globalization::Unicode::SimpleCollator_ExtenderType  ext, ::ByRef<::Mono::Globalization::Unicode::Contraction*>  ct, ::ByRef<::Mono::Globalization::Unicode::SimpleCollator_Context>  ctx) ;

/// @brief Method MatchesPrimitive, addr 0x590997c, size 0x238, virtual false, abstract: false, final false
...
/// @brief Method QuickIndexOf, addr 0x5908180, size 0x128, virtual false, abstract: false, final false
inline int32_t QuickIndexOf(::StringW  s, ::StringW  target, int32_t  start, int32_t  length, ::ByRef<bool>  testWasUnable) ;

/// @brief Method SetCJKTable, addr 0x5904af8, size 0xdc, virtual false, abstract: false, final false
inline void SetCJKTable(::System::Globalization::CultureInfo*  culture, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkIndexer, ::ByRef<uint8_t*>  catTable, ::ByRef<uint8_t*>  lv1Table, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  lv2Indexer, ::ByRef<uint8_t*>  lv2Table) ;

/// @brief Method System.Globalization.ISimpleCollator.Compare, addr 0x5906770, size 0x4, virtual true, abstract: false, final true
...
/// @brief Method ToDashTypeValue, addr 0x590555c, size 0x28, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x59047c8, size 0x330, virtual false, abstract: false, final false
