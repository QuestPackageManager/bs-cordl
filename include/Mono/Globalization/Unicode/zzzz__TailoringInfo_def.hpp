...
public:
  // Ctor Parameters [CppParam { name: "", ty: "TailoringInfo", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  TailoringInfo(TailoringInfo&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "TailoringInfo", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  TailoringInfo(TailoringInfoconst&) = delete;
