...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x27acd44, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ToIndex, addr 0x27acd5c, size 0x84, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x27acbf0, size 0x154, virtual false, abstract: false, final false
