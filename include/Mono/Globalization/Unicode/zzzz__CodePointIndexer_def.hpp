...
public:
  // Declarations
  /// @brief Method .ctor, addr 0x5973f24, size 0x18, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method ToIndex, addr 0x5973f3c, size 0x64, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5973ddc, size 0x148, virtual false, abstract: false, final false
