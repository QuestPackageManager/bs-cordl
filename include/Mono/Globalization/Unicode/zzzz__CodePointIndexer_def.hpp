...
public:
// Declarations
/// @brief Method .ctor, addr 0x5901fb8, size 0x18, virtual false, abstract: false, final false
...
/// @brief Field ranges, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_ranges, put=__cordl_internal_set_ranges)) ::ArrayW<::Mono::Globalization::Unicode::CodePointIndexer_TableRange,::Array<::Mono::Globalization::Unicode::CodePointIndexer_TableRange>*>  ranges;
...
/// @brief Method ToIndex, addr 0x5901fd0, size 0x64, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5901e70, size 0x148, virtual false, abstract: false, final false
