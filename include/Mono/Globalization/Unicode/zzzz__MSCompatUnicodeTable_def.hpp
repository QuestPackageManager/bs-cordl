...
/// @brief Method <BuildTailoringTables>b__17_0, addr 0x5903ee8, size 0x24, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5903ee4, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Field tailoringInfos, offset 0xffffffff, size 0x8 
 __declspec(property(get=getStaticF_tailoringInfos, put=setStaticF_tailoringInfos)) ::ArrayW<::Mono::Globalization::Unicode::TailoringInfo*,::Array<::Mono::Globalization::Unicode::TailoringInfo*>*>  tailoringInfos;

/// @brief Method BuildTailoringTables, addr 0x590225c, size 0x74c, virtual false, abstract: false, final false
static inline void BuildTailoringTables(::System::Globalization::CultureInfo*  culture, ::Mono::Globalization::Unicode::TailoringInfo*  t, ::ByRef<::ArrayW<::Mono::Globalization::Unicode::Contraction*,::Array<::Mono::Globalization::Unicode::Contraction*>*>>  contractions, ::ByRef<::ArrayW<::Mono::Globalization::Unicode::Level2Map*,::Array<::Mono::Globalization::Unicode::Level2Map*>*>>  diacriticals) ;

/// @brief Method Category, addr 0x5902c00, size 0xac, virtual false, abstract: false, final false
static inline uint8_t Category(int32_t  cp) ;

/// @brief Method FillCJK, addr 0x59038b0, size 0x168, virtual false, abstract: false, final false
static inline void FillCJK(::StringW  culture, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkIndexer, ::ByRef<uint8_t*>  catTable, ::ByRef<uint8_t*>  lv1Table, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  lv2Indexer, ::ByRef<uint8_t*>  lv2Table) ;

/// @brief Method FillCJKCore, addr 0x5903a18, size 0x478, virtual false, abstract: false, final false
static inline void FillCJKCore(::StringW  culture, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkIndexer, ::ByRef<uint8_t*>  catTable, ::ByRef<uint8_t*>  lv1Table, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkLv2Indexer, ::ByRef<uint8_t*>  lv2Table) ;

/// @brief Method GetResource, addr 0x59033cc, size 0xc8, virtual false, abstract: false, final false
static inline ::System::IntPtr GetResource(::StringW  name) ;

/// @brief Method GetTailoringInfo, addr 0x5902154, size 0x108, virtual false, abstract: false, final false
static inline ::Mono::Globalization::Unicode::TailoringInfo* GetTailoringInfo(int32_t  lcid) ;

/// @brief Method HasSpecialWeight, addr 0x59031c4, size 0x84, virtual false, abstract: false, final false
static inline bool HasSpecialWeight(char16_t  c) ;

/// @brief Method IsHalfWidthKana, addr 0x5903248, size 0x14, virtual false, abstract: false, final false
static inline bool IsHalfWidthKana(char16_t  c) ;

/// @brief Method IsHiragana, addr 0x590325c, size 0x14, virtual false, abstract: false, final false
static inline bool IsHiragana(char16_t  c) ;

/// @brief Method IsIgnorable, addr 0x5902eb0, size 0x120, virtual false, abstract: false, final false
static inline bool IsIgnorable(int32_t  cp, uint8_t  flag) ;

/// @brief Method IsIgnorableNonSpacing, addr 0x5902fd0, size 0x5c, virtual false, abstract: false, final false
static inline bool IsIgnorableNonSpacing(int32_t  cp) ;

/// @brief Method IsJapaneseSmallLetter, addr 0x5903270, size 0x100, virtual false, abstract: false, final false
static inline bool IsJapaneseSmallLetter(char16_t  c) ;

/// @brief Method Level1, addr 0x5902cac, size 0xac, virtual false, abstract: false, final false
static inline uint8_t Level1(int32_t  cp) ;

/// @brief Method Level2, addr 0x5902d58, size 0xac, virtual false, abstract: false, final false
static inline uint8_t Level2(int32_t  cp) ;

/// @brief Method Level3, addr 0x5902e04, size 0xac, virtual false, abstract: false, final false
static inline uint8_t Level3(int32_t  cp) ;

/// @brief Method SetCJKReferences, addr 0x59029a8, size 0x258, virtual false, abstract: false, final false
static inline void SetCJKReferences(::StringW  name, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  cjkIndexer, ::ByRef<uint8_t*>  catTable, ::ByRef<uint8_t*>  lv1Table, ::ByRef<::Mono::Globalization::Unicode::CodePointIndexer*>  lv2Indexer, ::ByRef<uint8_t*>  lv2Table) ;

/// @brief Method ToKanaTypeInsensitive, addr 0x590302c, size 0x18, virtual false, abstract: false, final false
static inline int32_t ToKanaTypeInsensitive(int32_t  i) ;

/// @brief Method ToWidthCompat, addr 0x5903044, size 0x180, virtual false, abstract: false, final false
static inline int32_t ToWidthCompat(int32_t  i) ;

/// @brief Method UInt32FromBytePtr, addr 0x5903494, size 0x2c, virtual false, abstract: false, final false
...
/// @brief Method get_IsReady, addr 0x5903370, size 0x5c, virtual false, abstract: false, final false
