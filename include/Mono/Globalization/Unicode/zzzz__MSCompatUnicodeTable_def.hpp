...
public:
  ...
  /// @brief Method <BuildTailoringTables>b__17_0, addr 0x5ab2638, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5ab2634, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildTailoringTables, addr 0x5ab09ac, size 0x74c, virtual false, abstract: false, final false
  ...
  /// @brief Method Category, addr 0x5ab1350, size 0xac, virtual false, abstract: false, final false
  static inline uint8_t Category(int32_t cp);

  /// @brief Method FillCJK, addr 0x5ab2000, size 0x168, virtual false, abstract: false, final false
  ...
  /// @brief Method FillCJKCore, addr 0x5ab2168, size 0x478, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResource, addr 0x5ab1b1c, size 0xc8, virtual false, abstract: false, final false
  static inline ::System::IntPtr GetResource(::StringW name);

  /// @brief Method GetTailoringInfo, addr 0x5ab08a4, size 0x108, virtual false, abstract: false, final false
  static inline ::Mono::Globalization::Unicode::TailoringInfo* GetTailoringInfo(int32_t lcid);

  /// @brief Method HasSpecialWeight, addr 0x5ab1914, size 0x84, virtual false, abstract: false, final false
  static inline bool HasSpecialWeight(char16_t c);

  /// @brief Method IsHalfWidthKana, addr 0x5ab1998, size 0x14, virtual false, abstract: false, final false
  static inline bool IsHalfWidthKana(char16_t c);

  /// @brief Method IsHiragana, addr 0x5ab19ac, size 0x14, virtual false, abstract: false, final false
  static inline bool IsHiragana(char16_t c);

  /// @brief Method IsIgnorable, addr 0x5ab1600, size 0x120, virtual false, abstract: false, final false
  static inline bool IsIgnorable(int32_t cp, uint8_t flag);

  /// @brief Method IsIgnorableNonSpacing, addr 0x5ab1720, size 0x5c, virtual false, abstract: false, final false
  static inline bool IsIgnorableNonSpacing(int32_t cp);

  /// @brief Method IsJapaneseSmallLetter, addr 0x5ab19c0, size 0x100, virtual false, abstract: false, final false
  static inline bool IsJapaneseSmallLetter(char16_t c);

  /// @brief Method Level1, addr 0x5ab13fc, size 0xac, virtual false, abstract: false, final false
  static inline uint8_t Level1(int32_t cp);

  /// @brief Method Level2, addr 0x5ab14a8, size 0xac, virtual false, abstract: false, final false
  static inline uint8_t Level2(int32_t cp);

  /// @brief Method Level3, addr 0x5ab1554, size 0xac, virtual false, abstract: false, final false
  static inline uint8_t Level3(int32_t cp);

  /// @brief Method SetCJKReferences, addr 0x5ab10f8, size 0x258, virtual false, abstract: false, final false
  ...
  /// @brief Method ToKanaTypeInsensitive, addr 0x5ab177c, size 0x18, virtual false, abstract: false, final false
  static inline int32_t ToKanaTypeInsensitive(int32_t i);

  /// @brief Method ToWidthCompat, addr 0x5ab1794, size 0x180, virtual false, abstract: false, final false
  static inline int32_t ToWidthCompat(int32_t i);

  /// @brief Method UInt32FromBytePtr, addr 0x5ab1be4, size 0x2c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsReady, addr 0x5ab1ac0, size 0x5c, virtual false, abstract: false, final false
