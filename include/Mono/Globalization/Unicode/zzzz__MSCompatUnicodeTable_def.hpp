...
public:
  ...
  /// @brief Method <BuildTailoringTables>b__17_0, addr 0x250809c, size 0x24, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2508094, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method BuildTailoringTables, addr 0x2506350, size 0x750, virtual false, abstract: false, final false
  ...
  /// @brief Method Category, addr 0x2506cd8, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Category(int32_t cp);

  /// @brief Method FillCJK, addr 0x2507a04, size 0x164, virtual false, abstract: false, final false
  ...
  /// @brief Method FillCJKCore, addr 0x2507b68, size 0x4c8, virtual false, abstract: false, final false
  ...
  /// @brief Method GetResource, addr 0x2507470, size 0xb8, virtual false, abstract: false, final false
  static inline void* GetResource(::StringW name);

  /// @brief Method GetTailoringInfo, addr 0x250624c, size 0x104, virtual false, abstract: false, final false
  static inline ::Mono::Globalization::Unicode::TailoringInfo* GetTailoringInfo(int32_t lcid);

  /// @brief Method HasSpecialWeight, addr 0x2507284, size 0x80, virtual false, abstract: false, final false
  static inline bool HasSpecialWeight(char16_t c);

  /// @brief Method IsHalfWidthKana, addr 0x2507304, size 0x14, virtual false, abstract: false, final false
  static inline bool IsHalfWidthKana(char16_t c);

  /// @brief Method IsHiragana, addr 0x2507318, size 0x18, virtual false, abstract: false, final false
  static inline bool IsHiragana(char16_t c);

  /// @brief Method IsIgnorable, addr 0x2506f68, size 0x118, virtual false, abstract: false, final false
  static inline bool IsIgnorable(int32_t cp, uint8_t flag);

  /// @brief Method IsIgnorableNonSpacing, addr 0x2507080, size 0x58, virtual false, abstract: false, final false
  static inline bool IsIgnorableNonSpacing(int32_t cp);

  /// @brief Method IsJapaneseSmallLetter, addr 0x2507330, size 0xe8, virtual false, abstract: false, final false
  static inline bool IsJapaneseSmallLetter(char16_t c);

  /// @brief Method Level1, addr 0x2506d7c, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Level1(int32_t cp);

  /// @brief Method Level2, addr 0x2506e20, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Level2(int32_t cp);

  /// @brief Method Level3, addr 0x2506ec4, size 0xa4, virtual false, abstract: false, final false
  static inline uint8_t Level3(int32_t cp);

  /// @brief Method SetCJKReferences, addr 0x2506aa0, size 0x238, virtual false, abstract: false, final false
  ...
  /// @brief Method ToKanaTypeInsensitive, addr 0x25070d8, size 0x20, virtual false, abstract: false, final false
  static inline int32_t ToKanaTypeInsensitive(int32_t i);

  /// @brief Method ToWidthCompat, addr 0x25070f8, size 0x18c, virtual false, abstract: false, final false
  static inline int32_t ToWidthCompat(int32_t i);

  /// @brief Method UInt32FromBytePtr, addr 0x2507528, size 0x30, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsReady, addr 0x2507418, size 0x58, virtual false, abstract: false, final false
