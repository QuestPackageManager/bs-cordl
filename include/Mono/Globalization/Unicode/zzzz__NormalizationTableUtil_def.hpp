...
// Write type traits
MARK_REF_T(::Mono::Globalization::Unicode::NormalizationTableUtil*);
DEFINE_IL2CPP_CLASS(::Mono::Globalization::Unicode::NormalizationTableUtil*, "Mono.Globalization.Unicode", "NormalizationTableUtil");
...
public:
  ...
  /// @brief Method MapIdx, addr 0x5ab2eac, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t MapIdx(int32_t cp);

  /// @brief Method PropIdx, addr 0x5ab2e40, size 0x6c, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::Globalization::Unicode::NormalizationTableUtil) == 0x10, "Size mismatch!");
