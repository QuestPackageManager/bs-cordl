...
public:
  ...
  /// @brief Method MapIdx, addr 0x59766c8, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t MapIdx(int32_t cp);

  /// @brief Method PropIdx, addr 0x597665c, size 0x6c, virtual false, abstract: false, final false
