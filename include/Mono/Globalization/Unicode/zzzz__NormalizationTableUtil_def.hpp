...
public:
  ...
  /// @brief Method MapIdx, addr 0x589d904, size 0x6c, virtual false, abstract: false, final false
  static inline int32_t MapIdx(int32_t cp);

  /// @brief Method PropIdx, addr 0x589d898, size 0x6c, virtual false, abstract: false, final false
