...
public:
  ...
  /// @brief Method MapIdx, addr 0x3c5ae10, size 0x68, virtual false, abstract: false, final false
  static inline int32_t MapIdx(int32_t cp);

  /// @brief Method PropIdx, addr 0x3c5ada8, size 0x68, virtual false, abstract: false, final false
