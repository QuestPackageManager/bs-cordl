...
public:
  ...
  /// @brief Method .ctor, addr 0x2438e10, size 0x8, virtual false, abstract: false, final false
  inline void _ctor(int32_t lcid);

  /// @brief Method Reset, addr 0x243d16c, size 0x14, virtual false, abstract: false, final false
  inline void Reset();

  /// @brief Method Initialize, addr 0x2438e18, size 0x178, virtual false, abstract: false, final false
  inline void Initialize(::System::Globalization::CompareOptions options, int32_t lcid, ::StringW s, bool frenchSort);

  /// @brief Method AppendCJKExtension, addr 0x243984c, size 0x94, virtual false, abstract: false, final false
  inline void AppendCJKExtension(uint8_t lv1msb, uint8_t lv1lsb);

  /// @brief Method AppendKana, addr 0x2439994, size 0x94, virtual false, abstract: false, final false
  ...
  /// @brief Method AppendNormal, addr 0x2439708, size 0x144, virtual false, abstract: false, final false
  inline void AppendNormal(uint8_t category, uint8_t lv1, uint8_t lv2, uint8_t lv3);

  /// @brief Method AppendLevel5, addr 0x243d248, size 0x98, virtual false, abstract: false, final false
  inline void AppendLevel5(uint8_t category, uint8_t lv1);

  /// @brief Method AppendBufferPrimitive, addr 0x243d180, size 0xc8, virtual false, abstract: false, final false
  inline void AppendBufferPrimitive(uint8_t value, ByRef<::ArrayW<uint8_t, ::Array<uint8_t>*>> buf, ByRef<int32_t> bidx);

  /// @brief Method GetResultAndReset, addr 0x243930c, size 0x24, virtual false, abstract: false, final false
  inline ::System::Globalization::SortKey* GetResultAndReset();

  /// @brief Method GetOptimizedLength, addr 0x243d7bc, size 0x60, virtual false, abstract: false, final false
  inline int32_t GetOptimizedLength(::ArrayW<uint8_t, ::Array<uint8_t>*> data, int32_t len, uint8_t defaultValue);

  /// @brief Method GetResult, addr 0x243d2e0, size 0x4dc, virtual false, abstract: false, final false
