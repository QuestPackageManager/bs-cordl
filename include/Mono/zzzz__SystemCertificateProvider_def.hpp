...
public:
  ...
  /// @brief Method EnsureInitialized, addr 0x410aee0, size 0x150, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method GetX509Pal, addr 0x410ae38, size 0x50, virtual false, abstract: false, final false
  static inline ::Mono::X509PalImpl* GetX509Pal();

  /// @brief Method Import, addr 0x410b3f8, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x410b2f0, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x410b08c, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x410b3f4, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x410b2ec, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x410b50c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_X509Pal, addr 0x410b030, size 0x5c, virtual false, abstract: false, final false
