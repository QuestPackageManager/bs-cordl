...
public:
  ...
  /// @brief Method EnsureInitialized, addr 0x4104728, size 0x150, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method GetX509Pal, addr 0x4104680, size 0x50, virtual false, abstract: false, final false
  static inline ::Mono::X509PalImpl* GetX509Pal();

  /// @brief Method Import, addr 0x4104c40, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x4104b38, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x41048d4, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x4104c3c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x4104b34, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4104d54, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_X509Pal, addr 0x4104878, size 0x5c, virtual false, abstract: false, final false
