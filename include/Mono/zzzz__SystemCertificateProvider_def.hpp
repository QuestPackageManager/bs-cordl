...
// Dependencies Mono.ISystemCertificateProvider, System.Object
namespace Mono {
// Is value type: false
...
public:
  ...
  /// @brief Method EnsureInitialized, addr 0x4116b68, size 0x150, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method GetX509Pal, addr 0x4116ac0, size 0x50, virtual false, abstract: false, final false
  static inline ::Mono::X509PalImpl* GetX509Pal();

  /// @brief Method Import, addr 0x4117080, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x4116f78, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x4116d14, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x411707c, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x4116f74, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x4117194, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_X509Pal, addr 0x4116cb8, size 0x5c, virtual false, abstract: false, final false
