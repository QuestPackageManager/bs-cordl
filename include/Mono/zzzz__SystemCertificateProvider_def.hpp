...
public:
  ...
  /// @brief Method EnsureInitialized, addr 0x296296c, size 0x154, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method GetX509Pal, addr 0x29628bc, size 0x58, virtual false, abstract: false, final false
  static inline ::Mono::X509PalImpl* GetX509Pal();

  /// @brief Method Import, addr 0x2962e98, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x2962d88, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x2962b1c, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x2962e94, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x2962d84, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x2962fac, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_X509Pal, addr 0x2962ac0, size 0x5c, virtual false, abstract: false, final false
