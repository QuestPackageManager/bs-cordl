...
public:
  ...
  /// @brief Method EnsureInitialized, addr 0x4107c7c, size 0x150, virtual false, abstract: false, final false
  static inline void EnsureInitialized();

  /// @brief Method GetX509Pal, addr 0x4107bd4, size 0x50, virtual false, abstract: false, final false
  static inline ::Mono::X509PalImpl* GetX509Pal();

  /// @brief Method Import, addr 0x4108194, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x410808c, size 0x90, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0x4107e28, size 0x6c, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x4108190, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method Mono.ISystemCertificateProvider.Import, addr 0x4108088, size 0x4, virtual true, abstract: false, final true
  ...
  /// @brief Method .ctor, addr 0x41082a8, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_X509Pal, addr 0x4107dcc, size 0x5c, virtual false, abstract: false, final false
