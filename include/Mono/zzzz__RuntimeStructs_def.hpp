...
// Ctor Parameters [CppParam { name: "default_vtable", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "xdomain_vtable", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "proxy_class", ty: "::Mono::RuntimeStructs_MonoClass*", modifiers: "", def_value: None }, CppParam { name: "proxy_class_name", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "interface_count", ty: "uint32_t", modifiers: "", def_value: None }]
constexpr RuntimeStructs_RemoteClass(::System::IntPtr  default_vtable, ::System::IntPtr  xdomain_vtable, ::Mono::RuntimeStructs_MonoClass*  proxy_class, ::System::IntPtr  proxy_class_name, uint32_t  interface_count) noexcept;
...
// Ctor Parameters [CppParam { name: "pklass", ty: "::Mono::RuntimeStructs_MonoClass*", modifiers: "", def_value: None }, CppParam { name: "name", ty: "::System::IntPtr", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "uint16_t", modifiers: "", def_value: None }, CppParam { name: "token", ty: "uint32_t", modifiers: "", def_value: None }, CppParam { name: "constraints", ty: "::Mono::RuntimeStructs_MonoClass*", modifiers: "", def_value: None }]
