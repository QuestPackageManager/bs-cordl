...
DEFINE_IL2CPP_CLASS(::Mono::RuntimeStructs_GPtrArray, "Mono", "RuntimeStructs/GPtrArray");
DEFINE_IL2CPP_CLASS(::Mono::RuntimeStructs_GenericParamInfo, "Mono", "RuntimeStructs/GenericParamInfo");
DEFINE_IL2CPP_CLASS(::Mono::RuntimeStructs_MonoClass, "Mono", "RuntimeStructs/MonoClass");
DEFINE_IL2CPP_CLASS(::Mono::RuntimeStructs_RemoteClass, "Mono", "RuntimeStructs/RemoteClass");
...
static_assert(sizeof(::Mono::RuntimeStructs_RemoteClass) == 0x28, "Size mismatch!");
...
#pragma pack(pop)
// Non member Declarations
static_assert(sizeof(::Mono::RuntimeStructs_MonoClass) == 0x1, "Size mismatch!");
...
static_assert(sizeof(::Mono::RuntimeStructs_GenericParamInfo) == 0x20, "Size mismatch!");
...
static_assert(sizeof(::Mono::RuntimeStructs_GPtrArray) == 0x10, "Size mismatch!");
