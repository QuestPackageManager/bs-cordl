...
public:
  ...
  /// @brief Method Authenticate, addr 0x5dc26ec, size 0x468, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5dc26e8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
