...
public:
  // Ctor Parameters [CppParam { name: "", ty: "NtlmSession", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  NtlmSession(NtlmSession&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "NtlmSession", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  NtlmSession(NtlmSessionconst&) = delete;
