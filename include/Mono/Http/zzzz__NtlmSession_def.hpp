...
/// @brief Method Authenticate, addr 0x5e2a938, size 0x468, virtual false, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e2a934, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
