...
public:
  ...
  /// @brief Method Authenticate, addr 0x5fd95b8, size 0x468, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fd95b4, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
