...
public:
  ...
  /// @brief Method Authenticate, addr 0x2b6cc4c, size 0x48c, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2b6cc44, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
