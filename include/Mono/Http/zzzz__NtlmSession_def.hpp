...
public:
  ...
  /// @brief Method Authenticate, addr 0x4118aa8, size 0x478, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x4118aa0, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
