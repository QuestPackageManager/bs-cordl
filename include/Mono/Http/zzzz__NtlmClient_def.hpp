...
public:
  ...
  /// @brief Method <Authenticate>b__1_0, addr 0x2b6d5a4, size 0x5c, virtual false, abstract: false, final false
  inline ::Mono::Http::NtlmSession* _Authenticate_b__1_0(::System::Net::HttpWebRequest* x);

  /// @brief Method .ctor, addr 0x2b6d59c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method Authenticate, addr 0x2b6d0d8, size 0x384, virtual true, abstract: false, final true
  ...
  /// @brief Method PreAuthenticate, addr 0x2b6d45c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Net::Authorization* PreAuthenticate(::System::Net::WebRequest* webRequest, ::System::Net::ICredentials* credentials);

  /// @brief Method .ctor, addr 0x2b6d4a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_AuthenticationType, addr 0x2b6d464, size 0x40, virtual true, abstract: false, final true
