...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Mono::ISystemCertificateProvider* (::Mono::ISystemDependencyProvider::*)()>(&::Mono::ISystemDependencyProvider::get_CertificateProvider)> {
