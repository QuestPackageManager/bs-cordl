...
public:
  ...
  /// @brief Method MoveNext, addr 0x4119488, size 0x920, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x4119da8, size 0x68, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x4119e10, size 0x7a8, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x411a5b8, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method <InnerRead>b__0, addr 0x411a63c, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x411a634, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x411a684, size 0x4a4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x411ab28, size 0x7c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x411aba4, size 0x2fc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x411aea0, size 0x68, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AuthenticateAsClient, addr 0x4117fcc, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method AuthenticateAsClientAsync, addr 0x4118534, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method AuthenticateAsServer, addr 0x41182f8, size 0x1d8, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckThrow, addr 0x4117cf8, size 0xc0, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x4118d8c, size 0x1d4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Flush, addr 0x4118fd0, size 0x24, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method GetIOException, addr 0x4117db8, size 0x17c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetIOException(::System::Exception* e, ::StringW message);

  /// @brief Method GetInternalError, addr 0x4117f34, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetInternalError();

  /// @brief Method GetInvalidNestedCallException, addr 0x4117f80, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetInvalidNestedCallException();

  /// @brief Method GetSSPIException, addr 0x4115d40, size 0x194, virtual false, abstract: false, final false
  static inline ::System::Exception* GetSSPIException(::System::Exception* e);

  /// @brief Method InnerRead, addr 0x41163b8, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method InnerWrite, addr 0x4115ed4, size 0xe0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* InnerWrite(bool sync, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method InternalRead, addr 0x4118a38, size 0x178, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalRead, addr 0x4112b20, size 0x10c, virtual false, abstract: false, final false
  inline int32_t InternalRead(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size, ::ByRef<bool> outWantMore);

  /// @brief Method InternalWrite, addr 0x4118bb0, size 0xf4, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalWrite, addr 0x4112640, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAuthentication, addr 0x4118208, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessHandshake, addr 0x4116570, size 0x3c4, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessRead, addr 0x4116ab4, size 0x160, virtual false, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> ProcessRead(::Mono::Net::Security::BufferOffsetSize* userBuffer);

  /// @brief Method ProcessWrite, addr 0x4116c94, size 0x160, virtual false, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> ProcessWrite(::Mono::Net::Security::BufferOffsetSize* userBuffer);

  /// @brief Method Read, addr 0x4118650, size 0xe0, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadAsync, addr 0x4118910, size 0x94, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Seek, addr 0x41191d0, size 0x38, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetException, addr 0x4115768, size 0x40, virtual false, abstract: false, final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* SetException(::System::Exception* e);

  /// @brief Method SetLength, addr 0x4119208, size 0x24, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method StartOperation, addr 0x4118730, size 0x114, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x4118844, size 0xcc, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteAsync, addr 0x41189a4, size 0x94, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method <InnerWrite>b__67_0, addr 0x4119454, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x41144a0, size 0x124, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanRead, addr 0x411922c, size 0x44, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x41192f4, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x4119270, size 0x20, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite, addr 0x4119290, size 0x64, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_InternalLocalCertificate, addr 0x41190d0, size 0x100, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_InternalLocalCertificate();

  /// @brief Method get_IsAuthenticated, addr 0x4118ca4, size 0xe8, virtual true, abstract: false, final false
  inline bool get_IsAuthenticated();

  /// @brief Method get_Length, addr 0x41192fc, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_LocalCertificate, addr 0x4118ff4, size 0xdc, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalCertificate();

  /// @brief Method get_Position, addr 0x411931c, size 0x24, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_Provider, addr 0x4117ce0, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::MobileTlsProvider* get_Provider();

  /// @brief Method get_ReadTimeout, addr 0x4119378, size 0x24, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_Settings, addr 0x4117cd8, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoTlsSettings* get_Settings();

  /// @brief Method get_SslStream, addr 0x4117cd0, size 0x8, virtual true, abstract: false, final true
  inline ::System::Net::Security::SslStream* get_SslStream();

  /// @brief Method get_TargetHost, addr 0x4117ce8, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TargetHost();

  /// @brief Method get_WriteTimeout, addr 0x41193c0, size 0x24, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Position, addr 0x4119340, size 0x38, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x411939c, size 0x24, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_TargetHost, addr 0x4117cf0, size 0x8, virtual false, abstract: false, final false
  inline void set_TargetHost(::StringW value);

  /// @brief Method set_WriteTimeout, addr 0x41193e4, size 0x24, virtual true, abstract: false, final false
