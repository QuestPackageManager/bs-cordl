...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e98ba8, size 0x9b4, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e9955c, size 0x6c, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e995c8, size 0x7ec, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e99db4, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method <InnerRead>b__0, addr 0x5e99e38, size 0x48, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e99e34, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e99e80, size 0x538, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e9a3b8, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e9a438, size 0x34c, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e9a784, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method AuthenticateAsClient, addr 0x5e97730, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method AuthenticateAsClientAsync, addr 0x5e97c80, size 0x11c, virtual true, abstract: false, final true
  ...
  /// @brief Method AuthenticateAsServer, addr 0x5e97a48, size 0x1e0, virtual false, abstract: false, final false
  ...
  /// @brief Method CheckThrow, addr 0x5e97434, size 0xbc, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5e984d0, size 0x1d8, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Flush, addr 0x5e9871c, size 0x20, virtual true, abstract: false, final false
  inline void Flush();

  /// @brief Method GetIOException, addr 0x5e974f0, size 0x1a8, virtual false, abstract: false, final false
  static inline ::System::Exception* GetIOException(::System::Exception* e, ::StringW message);

  /// @brief Method GetInternalError, addr 0x5e97698, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetInternalError();

  /// @brief Method GetInvalidNestedCallException, addr 0x5e976e4, size 0x4c, virtual false, abstract: false, final false
  static inline ::System::Exception* GetInvalidNestedCallException();

  /// @brief Method GetSSPIException, addr 0x5e953e0, size 0x1a8, virtual false, abstract: false, final false
  static inline ::System::Exception* GetSSPIException(::System::Exception* e);

  /// @brief Method InnerRead, addr 0x5e95a90, size 0x10c, virtual false, abstract: false, final false
  ...
  /// @brief Method InnerWrite, addr 0x5e95588, size 0xd0, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* InnerWrite(bool sync, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method InternalRead, addr 0x5e981b8, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalRead, addr 0x5e9218c, size 0x11c, virtual false, abstract: false, final false
  inline int32_t InternalRead(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t size, ::ByRef<bool> outWantMore);

  /// @brief Method InternalWrite, addr 0x5e982f4, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method InternalWrite, addr 0x5e91d0c, size 0x1e8, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessAuthentication, addr 0x5e97968, size 0xe0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessHandshake, addr 0x5e95c38, size 0x3dc, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessRead, addr 0x5e961c4, size 0x14c, virtual false, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> ProcessRead(::Mono::Net::Security::BufferOffsetSize* userBuffer);

  /// @brief Method ProcessWrite, addr 0x5e9638c, size 0x14c, virtual false, abstract: false, final false
  inline ::System::ValueTuple_2<int32_t, bool> ProcessWrite(::Mono::Net::Security::BufferOffsetSize* userBuffer);

  /// @brief Method Read, addr 0x5e97d9c, size 0x114, virtual true, abstract: false, final false
  inline int32_t Read(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method ReadAsync, addr 0x5e98088, size 0x98, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task_1<int32_t>* ReadAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method Seek, addr 0x5e9890c, size 0x38, virtual true, abstract: false, final false
  inline int64_t Seek(int64_t offset, ::System::IO::SeekOrigin origin);

  /// @brief Method SetException, addr 0x5e94d64, size 0x4c, virtual false, abstract: false, final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* SetException(::System::Exception* e);

  /// @brief Method SetLength, addr 0x5e98944, size 0x20, virtual true, abstract: false, final false
  inline void SetLength(int64_t value);

  /// @brief Method StartOperation, addr 0x5e97eb0, size 0x108, virtual false, abstract: false, final false
  ...
  /// @brief Method Write, addr 0x5e97fb8, size 0xd0, virtual true, abstract: false, final false
  inline void Write(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count);

  /// @brief Method WriteAsync, addr 0x5e98120, size 0x98, virtual true, abstract: false, final false
  inline ::System::Threading::Tasks::Task* WriteAsync(::ArrayW<uint8_t, ::Array<uint8_t>*> buffer, int32_t offset, int32_t count, ::System::Threading::CancellationToken cancellationToken);

  /// @brief Method <InnerWrite>b__67_0, addr 0x5e98b74, size 0x34, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e93b08, size 0x128, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CanRead, addr 0x5e98964, size 0x44, virtual true, abstract: false, final false
  inline bool get_CanRead();

  /// @brief Method get_CanSeek, addr 0x5e98a28, size 0x8, virtual true, abstract: false, final false
  inline bool get_CanSeek();

  /// @brief Method get_CanTimeout, addr 0x5e989a8, size 0x1c, virtual true, abstract: false, final false
  inline bool get_CanTimeout();

  /// @brief Method get_CanWrite, addr 0x5e989c4, size 0x64, virtual true, abstract: false, final false
  inline bool get_CanWrite();

  /// @brief Method get_InternalLocalCertificate, addr 0x5e98810, size 0xfc, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_InternalLocalCertificate();

  /// @brief Method get_IsAuthenticated, addr 0x5e983ec, size 0xe4, virtual true, abstract: false, final false
  inline bool get_IsAuthenticated();

  /// @brief Method get_Length, addr 0x5e98a30, size 0x1c, virtual true, abstract: false, final false
  inline int64_t get_Length();

  /// @brief Method get_LocalCertificate, addr 0x5e9873c, size 0xd4, virtual true, abstract: false, final true
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalCertificate();

  /// @brief Method get_Position, addr 0x5e98a4c, size 0x20, virtual true, abstract: false, final false
  inline int64_t get_Position();

  /// @brief Method get_Provider, addr 0x5e9741c, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::MobileTlsProvider* get_Provider();

  /// @brief Method get_ReadTimeout, addr 0x5e98aa4, size 0x20, virtual true, abstract: false, final false
  inline int32_t get_ReadTimeout();

  /// @brief Method get_Settings, addr 0x5e97414, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoTlsSettings* get_Settings();

  /// @brief Method get_SslStream, addr 0x5e9740c, size 0x8, virtual true, abstract: false, final true
  inline ::System::Net::Security::SslStream* get_SslStream();

  /// @brief Method get_TargetHost, addr 0x5e97424, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TargetHost();

  /// @brief Method get_WriteTimeout, addr 0x5e98ae4, size 0x20, virtual true, abstract: false, final false
  ...
  /// @brief Method set_Position, addr 0x5e98a6c, size 0x38, virtual true, abstract: false, final false
  inline void set_Position(int64_t value);

  /// @brief Method set_ReadTimeout, addr 0x5e98ac4, size 0x20, virtual true, abstract: false, final false
  inline void set_ReadTimeout(int32_t value);

  /// @brief Method set_TargetHost, addr 0x5e9742c, size 0x8, virtual false, abstract: false, final false
  inline void set_TargetHost(::StringW value);

  /// @brief Method set_WriteTimeout, addr 0x5e98b04, size 0x20, virtual true, abstract: false, final false
