...
public:
  ...
  /// @brief Method Run, addr 0x296c1e4, size 0x78, virtual true, abstract: false, final false
  inline ::Mono::Net::Security::AsyncOperationStatus Run(::Mono::Net::Security::AsyncOperationStatus status);

  /// @brief Method .ctor, addr 0x296c1dc, size 0x8, virtual false, abstract: false, final false
