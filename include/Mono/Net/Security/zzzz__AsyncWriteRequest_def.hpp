...
public:
  ...
  /// @brief Method Run, addr 0x5dbc0bc, size 0x78, virtual true, abstract: false, final false
  inline ::Mono::Net::Security::AsyncOperationStatus Run(::Mono::Net::Security::AsyncOperationStatus status);

  /// @brief Method .ctor, addr 0x5dbc0b8, size 0x4, virtual false, abstract: false, final false
