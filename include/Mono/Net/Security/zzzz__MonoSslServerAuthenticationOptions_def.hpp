...
public:
  ...
  /// @brief Method get_Options addr 0x26a9174 size 0x8 virtual false final false
  inline ::System::Net::Security::SslServerAuthenticationOptions* get_Options();

  /// @brief Method get_ServerMode addr 0x26a917c size 0x8 virtual true final false
  inline bool get_ServerMode();

  static inline ::Mono::Net::Security::MonoSslServerAuthenticationOptions* New_ctor();

  /// @brief Method .ctor addr 0x26a6638 size 0x6c virtual false final false
  inline void _ctor();

  /// @brief Method set_CertificateRevocationCheckMode addr 0x26a9184 size 0x1c virtual true final false
  inline void set_CertificateRevocationCheckMode(::System::Security::Cryptography::X509Certificates::X509RevocationMode value);

  /// @brief Method set_EncryptionPolicy addr 0x26a91a0 size 0x1c virtual true final false
  inline void set_EncryptionPolicy(::System::Net::Security::EncryptionPolicy value);

  /// @brief Method get_EnabledSslProtocols addr 0x26a91bc size 0x1c virtual true final false
  inline ::System::Security::Authentication::SslProtocols get_EnabledSslProtocols();

  /// @brief Method set_EnabledSslProtocols addr 0x26a91d8 size 0x1c virtual true final false
  inline void set_EnabledSslProtocols(::System::Security::Authentication::SslProtocols value);

  /// @brief Method get_ClientCertificateRequired addr 0x26a91f4 size 0x1c virtual true final false
  inline bool get_ClientCertificateRequired();

  /// @brief Method set_ClientCertificateRequired addr 0x26a9210 size 0x20 virtual true final false
  inline void set_ClientCertificateRequired(bool value);

  /// @brief Method get_TargetHost addr 0x26a9230 size 0x40 virtual true final false
  inline ::StringW get_TargetHost();

  /// @brief Method set_TargetHost addr 0x26a9270 size 0x40 virtual true final false
  inline void set_TargetHost(::StringW value);

  /// @brief Method get_ServerCertificate addr 0x26a92b0 size 0x1c virtual true final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_ServerCertificate();

  /// @brief Method set_ServerCertificate addr 0x26a92cc size 0x1c virtual true final false
  inline void set_ServerCertificate(::System::Security::Cryptography::X509Certificates::X509Certificate* value);

  /// @brief Method get_ClientCertificates addr 0x26a92e8 size 0x40 virtual true final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateCollection* get_ClientCertificates();

  /// @brief Method set_ClientCertificates addr 0x26a9328 size 0x40 virtual true final false
