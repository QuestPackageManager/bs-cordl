...
/// @brief Method ToString, addr 0x5e22238, size 0xb4, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e22168, size 0xd0, virtual false, abstract: false, final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  offset, int32_t  size) ;

/// @brief Method get_EndOffset, addr 0x5e22138, size 0xc, virtual false, abstract: false, final false
inline int32_t get_EndOffset() ;

/// @brief Method get_Remaining, addr 0x5e22144, size 0x24, virtual false, abstract: false, final false
