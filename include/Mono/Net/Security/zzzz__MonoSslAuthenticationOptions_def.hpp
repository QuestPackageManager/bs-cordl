...
/// @brief Method .ctor, addr 0x5e9c408, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ServerCertSelectionDelegate, addr 0x5e9c400, size 0x8, virtual false, abstract: false, final false
