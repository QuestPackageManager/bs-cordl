...
/// @brief Field <ServerCertSelectionDelegate>k__BackingField, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get__ServerCertSelectionDelegate_k__BackingField, put=__cordl_internal_set__ServerCertSelectionDelegate_k__BackingField)) ::System::Net::Security::ServerCertSelectionCallback*  _ServerCertSelectionDelegate_k__BackingField;
...
/// @brief Method .ctor, addr 0x5e28884, size 0x4, virtual false, abstract: false, final false
inline void _ctor() ;
...
/// @brief Method get_ServerCertSelectionDelegate, addr 0x5e2887c, size 0x8, virtual false, abstract: false, final false
