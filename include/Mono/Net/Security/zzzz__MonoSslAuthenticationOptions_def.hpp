...
public:
  ...
  /// @brief Method .ctor, addr 0x4116ae4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ServerCertSelectionDelegate, addr 0x4116adc, size 0x8, virtual false, abstract: false, final false
