...
public:
  ...
  /// @brief Method .ctor, addr 0x411677c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
  ...
  /// @brief Method get_ServerCertSelectionDelegate, addr 0x4116774, size 0x8, virtual false, abstract: false, final false
