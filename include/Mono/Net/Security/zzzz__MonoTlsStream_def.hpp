...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e9c0b0, size 0x724, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e9c7d4, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method CloseSslStream, addr 0x5e9bfdc, size 0xd4, virtual false, abstract: false, final false
  inline void CloseSslStream();

  /// @brief Method CreateStream, addr 0x5e9bee0, size 0xf8, virtual false, abstract: false, final false
  ...
  /// @brief Method Dispose, addr 0x5e9bfd8, size 0x4, virtual true, abstract: false, final true
  inline void Dispose();
  ...
  /// @brief Method .ctor, addr 0x5e9bd34, size 0xfc, virtual false, abstract: false, final false
  inline void _ctor(::System::Net::HttpWebRequest* request, ::System::Net::Sockets::NetworkStream* networkStream);

  /// @brief Method get_CertificateValidationFailed, addr 0x5e9bd24, size 0x8, virtual false, abstract: false, final false
  inline bool get_CertificateValidationFailed();

  /// @brief Method get_ExceptionStatus, addr 0x5e9bd1c, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::WebExceptionStatus get_ExceptionStatus();

  /// @brief Method get_Request, addr 0x5e9bd14, size 0x8, virtual false, abstract: false, final false
  inline ::System::Net::HttpWebRequest* get_Request();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_CertificateValidationFailed, addr 0x5e9bd2c, size 0x8, virtual false, abstract: false, final false
