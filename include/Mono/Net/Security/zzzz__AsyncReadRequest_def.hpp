...
namespace Mono::Net::Security {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7661))}
...
public:
  ...
  /// @brief Method .ctor addr 0x26a4b64 size 0x8 virtual false final false
  ...
  /// @brief Method Run addr 0x26a4b6c size 0x68 virtual true final false
