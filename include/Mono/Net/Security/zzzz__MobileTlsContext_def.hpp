...
public:
  ...
  /// @brief Method Dispose, addr 0x4121f90, size 0x70, virtual true, abstract: false, final true
  inline void Dispose();

  /// @brief Method Dispose, addr 0x4123f78, size 0x4, virtual true, abstract: false, final false
  inline void Dispose(bool disposing);

  /// @brief Method Finalize, addr 0x4123f7c, size 0xa4, virtual true, abstract: false, final false
  ...
  /// @brief Method SelectClientCertificate, addr 0x411c3c4, size 0x4f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ValidateCertificate, addr 0x411b27c, size 0x50, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x411a54c, size 0x13c, virtual false, abstract: false, final false
  ...
  /// @brief Method get_AskForClientCertificate, addr 0x4123f58, size 0x8, virtual false, abstract: false, final false
  inline bool get_AskForClientCertificate();

  /// @brief Method get_ClientCertificates, addr 0x4123f60, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_IsServer, addr 0x4123f40, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_LocalServerCertificate, addr 0x4123f68, size 0x8, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate* get_LocalServerCertificate();

  /// @brief Method get_Parent, addr 0x4123f38, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_ServerName, addr 0x4123f50, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_ServerName();

  /// @brief Method get_Settings, addr 0x411aefc, size 0x1c, virtual false, abstract: false, final false
  inline ::Mono::Security::Interface::MonoTlsSettings* get_Settings();

  /// @brief Method get_TargetHost, addr 0x4123f48, size 0x8, virtual false, abstract: false, final false
  inline ::StringW get_TargetHost();

  /// @brief Convert to "::System::IDisposable"
  constexpr ::System::IDisposable* i___System__IDisposable() noexcept;

  /// @brief Method set_LocalServerCertificate, addr 0x4123f70, size 0x8, virtual false, abstract: false, final false
