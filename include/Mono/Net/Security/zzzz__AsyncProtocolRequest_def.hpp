...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e949b8, size 0x3ac, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e94db0, size 0x80, virtual true, abstract: false, final true
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e94e30, size 0x5b0, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e95658, size 0x6c, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method MoveNext, addr 0x5e956c4, size 0x3cc, virtual true, abstract: false, final true
  inline void MoveNext();

  /// @brief Method SetStateMachine, addr 0x5e95b9c, size 0x80, virtual true, abstract: false, final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method InnerRead, addr 0x5e94840, size 0xf0, virtual false, abstract: false, final false
  ...
  /// @brief Method ProcessOperation, addr 0x5e94778, size 0xc8, virtual false, abstract: false, final false
  inline ::System::Threading::Tasks::Task* ProcessOperation(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method RequestRead, addr 0x5e945c0, size 0xc0, virtual false, abstract: false, final false
  inline void RequestRead(int32_t size);

  /// @brief Method RequestWrite, addr 0x5e94680, size 0xc, virtual false, abstract: false, final false
  ...
  /// @brief Method StartOperation, addr 0x5e9468c, size 0xec, virtual false, abstract: false, final false
  ...
  /// @brief Method ToString, addr 0x5e94930, size 0x88, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5e94554, size 0x6c, virtual false, abstract: false, final false
  inline void _ctor(::Mono::Net::Security::MobileAuthenticatedStream* parent, bool sync);

  /// @brief Method get_Name, addr 0x5e9451c, size 0x28, virtual false, abstract: false, final false
  inline ::StringW get_Name();

  /// @brief Method get_Parent, addr 0x5e9450c, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Parent();

  /// @brief Method get_RunSynchronously, addr 0x5e94514, size 0x8, virtual false, abstract: false, final false
  inline bool get_RunSynchronously();

  /// @brief Method get_UserResult, addr 0x5e94544, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_UserResult();

  /// @brief Method set_UserResult, addr 0x5e9454c, size 0x8, virtual false, abstract: false, final false
