...
namespace Mono::Net::Security {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3390)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 859 }),
// TypeDefinitionIndex(TypeDefinitionIndex(7655)), TypeDefinitionIndex(TypeDefinitionIndex(3397)), TypeDefinitionIndex(TypeDefinitionIndex(2675))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7656))
...
public:
  ...
  /// @brief Method MoveNext addr 0x26a3684 size 0x358 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x26a3a1c size 0x58 virtual true final true
...
namespace Mono::Net::Security {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2675)), TypeDefinitionIndex(TypeDefinitionIndex(2446)), TypeDefinitionIndex(TypeDefinitionIndex(3396)),
// TypeDefinitionIndex(TypeDefinitionIndex(7654)), TypeDefinitionIndex(TypeDefinitionIndex(3390)), TypeDefinitionIndex(TypeDefinitionIndex(3392)), GenericInstantiation(GenericInstantiation { tdi:
// TypeDefinitionIndex(3392), inst: 855 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2446), inst: 101 })} Self: TypeDefinitionIndex(TypeDefinitionIndex(7657)) CS Name:
...
public:
  ...
  /// @brief Method MoveNext addr 0x26a3a74 size 0x494 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x26a4180 size 0xc virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
namespace Mono::Net::Security {
// Is value type: true
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3392), inst: 101 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2446), inst: 101 }),
// TypeDefinitionIndex(TypeDefinitionIndex(3392)), TypeDefinitionIndex(TypeDefinitionIndex(3397)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3397), inst: 855 }),
// TypeDefinitionIndex(TypeDefinitionIndex(2675)), TypeDefinitionIndex(TypeDefinitionIndex(2446))} Self: TypeDefinitionIndex(TypeDefinitionIndex(7658)) CS Name:
...
public:
  ...
  /// @brief Method MoveNext addr 0x26a418c size 0x350 virtual true final true
  inline void MoveNext();

  /// @brief Method SetStateMachine addr 0x26a45f8 size 0x58 virtual true final true
  inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine* stateMachine);
...
public:
  ...
  /// @brief Method get_Parent addr 0x26a31b4 size 0x8 virtual false final false
  inline ::Mono::Net::Security::MobileAuthenticatedStream* get_Parent();

  /// @brief Method get_RunSynchronously addr 0x26a31bc size 0x8 virtual false final false
  inline bool get_RunSynchronously();

  /// @brief Method get_Name addr 0x26a31c4 size 0x24 virtual false final false
  inline ::StringW get_Name();

  /// @brief Method get_UserResult addr 0x26a31e8 size 0x8 virtual false final false
  inline int32_t get_UserResult();

  /// @brief Method set_UserResult addr 0x26a31f0 size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26a31f8 size 0x88 virtual false final false
  inline void _ctor(::Mono::Net::Security::MobileAuthenticatedStream* parent, bool sync);

  /// @brief Method RequestRead addr 0x26a3280 size 0xc4 virtual false final false
  inline void RequestRead(int32_t size);

  /// @brief Method RequestWrite addr 0x26a3344 size 0xc virtual false final false
  inline void RequestWrite();

  /// @brief Method StartOperation addr 0x26a3350 size 0xf8 virtual false final false
  ...
  /// @brief Method ProcessOperation addr 0x26a3448 size 0xe0 virtual false final false
  inline ::System::Threading::Tasks::Task* ProcessOperation(::System::Threading::CancellationToken cancellationToken);

  /// @brief Method InnerRead addr 0x26a3528 size 0x104 virtual false final false
  ...
  /// @brief Method ToString addr 0x26a362c size 0x58 virtual true final false
