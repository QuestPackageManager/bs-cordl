...
public:
  ...
  /// @brief Method .ctor, addr 0x41122c0, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(::System::Runtime::ExceptionServices::ExceptionDispatchInfo* error);

  /// @brief Method .ctor, addr 0x4112298, size 0x28, virtual false, abstract: false, final false
  inline void _ctor(int32_t result);

  /// @brief Method get_Error, addr 0x4112290, size 0x8, virtual false, abstract: false, final false
  inline ::System::Runtime::ExceptionServices::ExceptionDispatchInfo* get_Error();

  /// @brief Method get_UserResult, addr 0x4112288, size 0x8, virtual false, abstract: false, final false
