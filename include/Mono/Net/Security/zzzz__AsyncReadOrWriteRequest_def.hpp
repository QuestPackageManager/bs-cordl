...
/// @brief Method ToString, addr 0x5e97c44, size 0x8c, virtual true, abstract: false, final false
...
/// @brief Method .ctor, addr 0x5e97ba4, size 0xa0, virtual false, abstract: false, final false
...
/// @brief Method get_CurrentSize, addr 0x5e97b94, size 0x8, virtual false, abstract: false, final false
inline int32_t get_CurrentSize() ;

/// @brief Method get_UserBuffer, addr 0x5e97b8c, size 0x8, virtual false, abstract: false, final false
inline ::Mono::Net::Security::BufferOffsetSize* get_UserBuffer() ;

/// @brief Method set_CurrentSize, addr 0x5e97b9c, size 0x8, virtual false, abstract: false, final false
