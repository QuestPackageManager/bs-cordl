...
public:
  ...
  /// @brief Method ToString, addr 0x5fd2d40, size 0x8c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5fd2ca0, size 0xa0, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentSize, addr 0x5fd2c90, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrentSize();

  /// @brief Method get_UserBuffer, addr 0x5fd2c88, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::BufferOffsetSize* get_UserBuffer();

  /// @brief Method set_CurrentSize, addr 0x5fd2c98, size 0x8, virtual false, abstract: false, final false
