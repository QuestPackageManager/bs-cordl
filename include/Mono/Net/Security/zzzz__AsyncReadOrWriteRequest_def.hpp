...
public:
  ...
  /// @brief Method get_UserBuffer addr 0x26a4a4c size 0x8 virtual false final false
  inline ::Mono::Net::Security::BufferOffsetSize* get_UserBuffer();

  /// @brief Method get_CurrentSize addr 0x26a4a54 size 0x8 virtual false final false
  inline int32_t get_CurrentSize();

  /// @brief Method set_CurrentSize addr 0x26a4a5c size 0x8 virtual false final false
  ...
  /// @brief Method .ctor addr 0x26a4a64 size 0xa4 virtual false final false
  ...
  /// @brief Method ToString addr 0x26a4b08 size 0x5c virtual true final false
