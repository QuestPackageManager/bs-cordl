...
public:
  ...
  /// @brief Method ToString, addr 0x296bfb0, size 0x5c, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x296bf0c, size 0xa4, virtual false, abstract: false, final false
  ...
  /// @brief Method get_CurrentSize, addr 0x296befc, size 0x8, virtual false, abstract: false, final false
  inline int32_t get_CurrentSize();

  /// @brief Method get_UserBuffer, addr 0x296bef4, size 0x8, virtual false, abstract: false, final false
  inline ::Mono::Net::Security::BufferOffsetSize* get_UserBuffer();

  /// @brief Method set_CurrentSize, addr 0x296bf04, size 0x8, virtual false, abstract: false, final false
