...
public:
  ...
  /// @brief Method ReflectionLoad, addr 0x2567464, size 0x14c, virtual false, abstract: false, final false
  static inline ::Mono::ISystemDependencyProvider* ReflectionLoad();

  /// @brief Method Register, addr 0x25675b0, size 0x1a8, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SystemProvider, addr 0x2567260, size 0x204, virtual false, abstract: false, final false
