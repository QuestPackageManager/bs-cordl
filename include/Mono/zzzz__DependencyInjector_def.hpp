...
public:
  ...
  /// @brief Method ReflectionLoad, addr 0x3c5052c, size 0x14c, virtual false, abstract: false, final false
  static inline ::Mono::ISystemDependencyProvider* ReflectionLoad();

  /// @brief Method Register, addr 0x3c50678, size 0x198, virtual false, abstract: false, final false
  ...
  /// @brief Method get_SystemProvider, addr 0x3c50334, size 0x1f8, virtual false, abstract: false, final false
