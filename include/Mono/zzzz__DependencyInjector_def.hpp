...
public:
  // Ctor Parameters [CppParam { name: "", ty: "DependencyInjector", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  DependencyInjector(DependencyInjector&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "DependencyInjector", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  DependencyInjector(DependencyInjectorconst&) = delete;
