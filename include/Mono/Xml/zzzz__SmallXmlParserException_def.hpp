...
public:
  ...
  /// @brief Method .ctor, addr 0x5aaeac0, size 0xe0, virtual false, abstract: false, final false
...
public:
  // Ctor Parameters [CppParam { name: "", ty: "SmallXmlParserException", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  SmallXmlParserException(SmallXmlParserException&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "SmallXmlParserException", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  SmallXmlParserException(SmallXmlParserExceptionconst&) = delete;
