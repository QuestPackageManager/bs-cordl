...
public:
  ...
  /// @brief Method LoadXml, addr 0x5971bcc, size 0x94, virtual false, abstract: false, final false
  inline void LoadXml(::StringW xml);

  static inline ::Mono::Xml::SecurityParser* New_ctor();

  /// @brief Method OnChars, addr 0x597214c, size 0x84, virtual true, abstract: false, final true
  inline void OnChars(::StringW ch);

  /// @brief Method OnEndElement, addr 0x59720c0, size 0x8c, virtual true, abstract: false, final true
  inline void OnEndElement(::StringW name);

  /// @brief Method OnEndParsing, addr 0x59721d0, size 0x4, virtual true, abstract: false, final true
  inline void OnEndParsing(::Mono::Xml::SmallXmlParser* parser);

  /// @brief Method OnIgnorableWhitespace, addr 0x5971e3c, size 0x4, virtual true, abstract: false, final true
  inline void OnIgnorableWhitespace(::StringW s);

  /// @brief Method OnProcessingInstruction, addr 0x5971e38, size 0x4, virtual true, abstract: false, final true
  inline void OnProcessingInstruction(::StringW name, ::StringW text);

  /// @brief Method OnStartElement, addr 0x5971e40, size 0x280, virtual true, abstract: false, final true
  inline void OnStartElement(::StringW name, ::Mono::Xml::SmallXmlParser_IAttrList* attrs);

  /// @brief Method OnStartParsing, addr 0x5971e34, size 0x4, virtual true, abstract: false, final true
  inline void OnStartParsing(::Mono::Xml::SmallXmlParser* parser);

  /// @brief Method ToXml, addr 0x5971e2c, size 0x8, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x5971a60, size 0x64, virtual false, abstract: false, final false
  inline void _ctor();
