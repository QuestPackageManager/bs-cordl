...
public:
  ...
  /// @brief Method Add, addr 0x59015c8, size 0x110, virtual false, abstract: false, final false
  inline void Add(::StringW name, ::StringW value);

  /// @brief Method Clear, addr 0x59010c4, size 0xa4, virtual false, abstract: false, final false
  inline void Clear();

  /// @brief Method GetName, addr 0x5901728, size 0x64, virtual true, abstract: false, final true
  inline ::StringW GetName(int32_t i);

  /// @brief Method GetValue, addr 0x590178c, size 0x64, virtual true, abstract: false, final true
  inline ::StringW GetValue(int32_t i);

  /// @brief Method GetValue, addr 0x59017f0, size 0xc8, virtual true, abstract: false, final true
  inline ::StringW GetValue(::StringW name);
  ...
  /// @brief Method .ctor, addr 0x58ffd5c, size 0x94, virtual false, abstract: false, final false
  inline void _ctor();

  /// @brief Method get_Length, addr 0x59016d8, size 0x50, virtual true, abstract: false, final true
  inline int32_t get_Length();

  /// @brief Method get_Names, addr 0x59018b8, size 0x54, virtual true, abstract: false, final true
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Names();

  /// @brief Method get_Values, addr 0x590190c, size 0x54, virtual true, abstract: false, final true
  inline ::ArrayW<::StringW, ::Array<::StringW>*> get_Values();
...
public:
  ...
  /// @brief Method Cleanup, addr 0x5901048, size 0x7c, virtual false, abstract: false, final false
  inline void Cleanup();

  /// @brief Method Error, addr 0x58ffdf0, size 0x74, virtual false, abstract: false, final false
  inline ::System::Exception* Error(::StringW msg);

  /// @brief Method Expect, addr 0x5900338, size 0xb8, virtual false, abstract: false, final false
  inline void Expect(int32_t c);

  /// @brief Method HandleBufferedContent, addr 0x5900efc, size 0x14c, virtual false, abstract: false, final false
  inline void HandleBufferedContent();

  /// @brief Method HandleWhitespaces, addr 0x5900204, size 0xbc, virtual false, abstract: false, final false
  inline void HandleWhitespaces();

  /// @brief Method IsNameChar, addr 0x590005c, size 0xd8, virtual false, abstract: false, final false
  inline bool IsNameChar(char16_t c, bool start);

  /// @brief Method IsWhitespace, addr 0x5900134, size 0x1c, virtual false, abstract: false, final false
  inline bool IsWhitespace(int32_t c);

  static inline ::Mono::Xml::SmallXmlParser* New_ctor();

  /// @brief Method Parse, addr 0x58ff7e8, size 0x1cc, virtual false, abstract: false, final false
  inline void Parse(::System::IO::TextReader* input, ::Mono::Xml::SmallXmlParser_IContentHandler* handler);

  /// @brief Method Peek, addr 0x590031c, size 0x1c, virtual false, abstract: false, final false
  inline int32_t Peek();

  /// @brief Method Read, addr 0x59002c0, size 0x5c, virtual false, abstract: false, final false
  inline int32_t Read();

  /// @brief Method ReadAttribute, addr 0x59012ec, size 0x164, virtual false, abstract: false, final false
  inline void ReadAttribute(::Mono::Xml::SmallXmlParser_AttrListImpl* a);

  /// @brief Method ReadCDATASection, addr 0x5901168, size 0xfc, virtual false, abstract: false, final false
  inline void ReadCDATASection();

  /// @brief Method ReadCharacterReference, addr 0x59014d8, size 0xf0, virtual false, abstract: false, final false
  inline int32_t ReadCharacterReference();

  /// @brief Method ReadCharacters, addr 0x5901450, size 0x88, virtual false, abstract: false, final false
  inline void ReadCharacters();

  /// @brief Method ReadComment, addr 0x5901264, size 0x88, virtual false, abstract: false, final false
  inline void ReadComment();

  /// @brief Method ReadContent, addr 0x5900838, size 0x6c4, virtual false, abstract: false, final false
  inline void ReadContent();

  /// @brief Method ReadName, addr 0x5900694, size 0x1a4, virtual false, abstract: false, final false
  inline ::StringW ReadName();

  /// @brief Method ReadReference, addr 0x59004cc, size 0x1c8, virtual false, abstract: false, final false
  inline void ReadReference();

  /// @brief Method ReadUntil, addr 0x59003f0, size 0xdc, virtual false, abstract: false, final false
  inline ::StringW ReadUntil(char16_t until, bool handleReferences);

  /// @brief Method SkipWhitespaces, addr 0x5900150, size 0x8, virtual false, abstract: false, final false
  inline void SkipWhitespaces();

  /// @brief Method SkipWhitespaces, addr 0x5900158, size 0xac, virtual false, abstract: false, final false
  inline void SkipWhitespaces(bool expected);

  /// @brief Method UnexpectedEndError, addr 0x58fff44, size 0x118, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x58ff64c, size 0x108, virtual false, abstract: false, final false
  inline void _ctor();
