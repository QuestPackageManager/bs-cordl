...
// Ctor Parameters [CppParam { name: "default_vtable", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "xdomain_vtable", ty: "::System::IntPtr",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "proxy_class", ty: "::Mono::RuntimeStructs_MonoClass*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam {
// name: "proxy_class_name", ty: "::System::IntPtr", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "interface_count", ty: "uint32_t", modifiers: "", def_value: Some("{}"),
// comment: None }]
...
// Ctor Parameters [CppParam { name: "pklass", ty: "::Mono::RuntimeStructs_MonoClass*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "name", ty: "::System::IntPtr",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "flags", ty: "uint16_t", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "token", ty: "uint32_t",
// modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "constraints", ty: "::Mono::RuntimeStructs_MonoClass*", modifiers: "", def_value: Some("{}"), comment: None }]
...
// Ctor Parameters [CppParam { name: "data", ty: "::System::IntPtr*", modifiers: "", def_value: Some("{}"), comment: None }, CppParam { name: "len", ty: "int32_t", modifiers: "", def_value:
// Some("{}"), comment: None }]
