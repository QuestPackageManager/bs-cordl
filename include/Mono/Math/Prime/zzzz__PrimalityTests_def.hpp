...
public:
  // Declarations
  /// @brief Method GetSPPRounds addr 0x242b42c size 0x194 virtual false final false
  static inline int32_t GetSPPRounds(::Mono::Math::BigInteger* bi, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method Test addr 0x242a578 size 0x4c virtual false final false
  static inline bool Test(::Mono::Math::BigInteger* n, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method RabinMillerTest addr 0x242b78c size 0x290 virtual false final false
  static inline bool RabinMillerTest(::Mono::Math::BigInteger* n, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method SmallPrimeSppTest addr 0x242b5c0 size 0x1cc virtual false final false
