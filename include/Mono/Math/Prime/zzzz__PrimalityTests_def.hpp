...
public:
  // Declarations
  /// @brief Method GetSPPRounds addr 0x22b64e8 size 0x194 virtual false final false
  static inline int32_t GetSPPRounds(::Mono::Math::BigInteger* bi, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method RabinMillerTest addr 0x22b667c size 0x290 virtual false final false
