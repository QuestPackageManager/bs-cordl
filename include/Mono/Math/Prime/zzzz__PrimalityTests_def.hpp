...
public:
  // Declarations
  /// @brief Method GetSPPRounds, addr 0x240ff68, size 0x194, virtual false, abstract: false, final false
  static inline int32_t GetSPPRounds(::Mono::Math::BigInteger* bi, ::Mono::Math::Prime::ConfidenceFactor confidence);

  /// @brief Method RabinMillerTest, addr 0x24100fc, size 0x290, virtual false, abstract: false, final false
