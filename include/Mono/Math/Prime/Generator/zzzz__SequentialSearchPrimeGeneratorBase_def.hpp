...
public:
  // Declarations
  /// @brief Method GenerateNewPrime, addr 0x3c4ea24, size 0x10, virtual true, abstract: false, final false
  inline ::Mono::Math::BigInteger* GenerateNewPrime(int32_t bits);

  /// @brief Method GenerateNewPrime, addr 0x3c4ea34, size 0x2e4, virtual true, abstract: false, final false
  inline ::Mono::Math::BigInteger* GenerateNewPrime(int32_t bits, ::System::Object* context);

  /// @brief Method GenerateSearchBase, addr 0x3c4e9b0, size 0x74, virtual true, abstract: false, final false
  inline ::Mono::Math::BigInteger* GenerateSearchBase(int32_t bits, ::System::Object* context);

  /// @brief Method IsPrimeAcceptable, addr 0x3c4ed18, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x3c4d690, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
