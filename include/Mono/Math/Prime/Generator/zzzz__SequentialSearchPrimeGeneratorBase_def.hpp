...
public:
  // Declarations
  /// @brief Method GenerateSearchBase addr 0x2410418 size 0x74 virtual true final false
  inline ::Mono::Math::BigInteger* GenerateSearchBase(int32_t bits, ::System::Object* context);

  /// @brief Method GenerateNewPrime addr 0x241048c size 0x10 virtual true final false
  inline ::Mono::Math::BigInteger* GenerateNewPrime(int32_t bits);

  /// @brief Method GenerateNewPrime addr 0x241049c size 0x2e4 virtual true final false
  inline ::Mono::Math::BigInteger* GenerateNewPrime(int32_t bits, ::System::Object* context);

  /// @brief Method IsPrimeAcceptable addr 0x2410780 size 0x8 virtual true final false
  ...
  /// @brief Method .ctor addr 0x240f100 size 0x8 virtual false final false
  inline void _ctor();
