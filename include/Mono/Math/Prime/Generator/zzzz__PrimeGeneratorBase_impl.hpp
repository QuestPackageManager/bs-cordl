...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Mono::Math::Prime::ConfidenceFactor (::Mono::Math::Prime::Generator::PrimeGeneratorBase::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5ac4abc;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 4 }));
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Mono::Math::Prime::PrimalityTest* (::Mono::Math::Prime::Generator::PrimeGeneratorBase::*)()>(
  ...
  constexpr static std::size_t addrs = 0x5ac4ac4;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 5 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<int32_t (::Mono::Math::Prime::Generator::PrimeGeneratorBase::*)()>(
  ...
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x5ac4b38;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 6 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<::Mono::Math::BigInteger* (::Mono::Math::Prime::Generator::PrimeGeneratorBase::*)(int32_t)>(
    &::Mono::Math::Prime::Generator::PrimeGeneratorBase::GenerateNewPrime)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0xffffffffffffffff;

  inline static ::MethodInfo const* method_info() {
    static auto* ___internal_method = THROW_UNLESS(
        ::i2c::no_logger{}, ::i2c::find_method(::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 7 }));
    return ___internal_method;
  }
};
...
struct CORDL_HIDDEN ::i2c::metadata_getter<static_cast<void (::Mono::Math::Prime::Generator::PrimeGeneratorBase::*)()>(&::Mono::Math::Prime::Generator::PrimeGeneratorBase::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x5ac4b40;
...
inline ::Mono::Math::Prime::ConfidenceFactor Mono::Math::Prime::Generator::PrimeGeneratorBase::get_Confidence() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 4 })));
...
inline ::Mono::Math::Prime::PrimalityTest* Mono::Math::Prime::Generator::PrimeGeneratorBase::get_PrimalityTest() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 5 })));
...
inline int32_t Mono::Math::Prime::Generator::PrimeGeneratorBase::get_TrialDivisionBounds() {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 6 })));
  return ::cordl_internals::RunMethodRethrow<int32_t>(this, ___internal_method);
}
inline ::Mono::Math::BigInteger* Mono::Math::Prime::Generator::PrimeGeneratorBase::GenerateNewPrime(int32_t bits) {
  auto* ___internal_method =
      THROW_UNLESS(::i2c::no_logger{}, (::i2c::find_method(reinterpret_cast<Il2CppObject*>(this)->klass, { ::i2c::class_of<::Mono::Math::Prime::Generator::PrimeGeneratorBase*>(), 7 })));
