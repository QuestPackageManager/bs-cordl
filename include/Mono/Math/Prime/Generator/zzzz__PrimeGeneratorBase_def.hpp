...
public:
  ...
  /// @brief Method get_Confidence, addr 0x24301ec, size 0x8, virtual true, abstract: false, final false
  inline ::Mono::Math::Prime::ConfidenceFactor get_Confidence();

  /// @brief Method get_PrimalityTest, addr 0x24301f4, size 0x74, virtual true, abstract: false, final false
  inline ::Mono::Math::Prime::PrimalityTest* get_PrimalityTest();

  /// @brief Method get_TrialDivisionBounds, addr 0x2430268, size 0x8, virtual true, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x2430270, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
