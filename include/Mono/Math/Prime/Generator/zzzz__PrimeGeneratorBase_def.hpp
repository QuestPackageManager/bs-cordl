...
public:
  ...
  /// @brief Method get_Confidence addr 0x22d1fa8 size 0x8 virtual true final false
  inline ::Mono::Math::Prime::ConfidenceFactor get_Confidence();

  /// @brief Method get_PrimalityTest addr 0x22d1fb0 size 0x74 virtual true final false
  inline ::Mono::Math::Prime::PrimalityTest* get_PrimalityTest();

  /// @brief Method get_TrialDivisionBounds addr 0x22d2024 size 0x8 virtual true final false
  ...
  /// @brief Method .ctor addr 0x22d202c size 0x8 virtual false final false
  inline void _ctor();
