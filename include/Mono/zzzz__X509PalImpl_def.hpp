...
public:
  ...
  /// @brief Method ConvertData, addr 0x5e1ba64, size 0x110, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method GetCertContentType, addr 0x5e1bb7c, size 0x43c, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportFallback, addr 0x5e1b108, size 0x1f0, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportFallback, addr 0x5e1b38c, size 0x78, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* ImportFallback(::ArrayW<uint8_t, ::Array<uint8_t>*> data,
  ...
  /// @brief Method PEM, addr 0x5e1b8cc, size 0x198, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PEM(::StringW type, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x5e1b8c8, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_signedData();

  /// @brief Method get_SupportsLegacyBasicConstraintsExtension, addr 0x5e1bb74, size 0x8, virtual false, abstract: false, final false
