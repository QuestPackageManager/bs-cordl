...
public:
  ...
  /// @brief Method ConvertData, addr 0x410ba00, size 0x10c, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> ConvertData(::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method GetCertContentType, addr 0x410bb14, size 0x400, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportFallback, addr 0x410b0f8, size 0x1f4, virtual false, abstract: false, final false
  ...
  /// @brief Method ImportFallback, addr 0x410b380, size 0x74, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* ImportFallback(::ArrayW<uint8_t, ::Array<uint8_t>*> data,
  ...
  /// @brief Method PEM, addr 0x410b8cc, size 0x134, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> PEM(::StringW type, ::ArrayW<uint8_t, ::Array<uint8_t>*> data);

  /// @brief Method .ctor, addr 0x410b8c4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t, ::Array<uint8_t>*> getStaticF_signedData();

  /// @brief Method get_SupportsLegacyBasicConstraintsExtension, addr 0x410bb0c, size 0x8, virtual false, abstract: false, final false
