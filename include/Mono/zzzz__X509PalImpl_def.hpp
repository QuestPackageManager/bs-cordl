...
// Write type traits
MARK_REF_T(::Mono::X509PalImpl*);
DEFINE_IL2CPP_CLASS(::Mono::X509PalImpl*, "Mono", "X509PalImpl");
...
public:
  ...
  /// @brief Method ConvertData, addr 0x5fcada4, size 0x110, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> ConvertData(::ArrayW<uint8_t> data);

  /// @brief Method GetCertContentType, addr 0x5fcaebc, size 0x43c, virtual false, abstract: false, final false
  ...
  /// @brief Method Import, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* Import(::ArrayW<uint8_t> data, ::Microsoft::Win32::SafeHandles::SafePasswordHandle* password,
                                                                                          ::System::Security::Cryptography::X509Certificates::X509KeyStorageFlags keyStorageFlags);

  /// @brief Method Import, addr 0xffffffffffffffff, size 0xffffffffffffffff, virtual true, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509CertificateImpl* Import(::ArrayW<uint8_t> data);

  /// @brief Method ImportFallback, addr 0x5fca448, size 0x1f0, virtual false, abstract: false, final false
  inline ::System::Security::Cryptography::X509Certificates::X509Certificate2Impl* ImportFallback(::ArrayW<uint8_t> data);

  /// @brief Method ImportFallback, addr 0x5fca6cc, size 0x78, virtual false, abstract: false, final false
  ...
  /// @brief Method PEM, addr 0x5fcac0c, size 0x198, virtual false, abstract: false, final false
  static inline ::ArrayW<uint8_t> PEM(::StringW type, ::ArrayW<uint8_t> data);

  /// @brief Method .ctor, addr 0x5fcac08, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();

  static inline ::ArrayW<uint8_t> getStaticF_signedData();

  /// @brief Method get_SupportsLegacyBasicConstraintsExtension, addr 0x5fcaeb4, size 0x8, virtual false, abstract: false, final false
...
static_assert(sizeof(::Mono::X509PalImpl) == 0x10, "Size mismatch!");
