...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::BeatmapEventType, "BeatmapSaveDataCommon", "BeatmapEventType");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::BeatmapEventType) == 0x4, "Size mismatch!");
