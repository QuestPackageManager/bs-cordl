...
public:
  // Declarations
  /// @brief Method GetSpecialEventTypes, addr 0x369e1f0, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x369e2f0, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
