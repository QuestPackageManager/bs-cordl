...
public:
  // Declarations
  /// @brief Method GetSpecialEventTypes, addr 0x375b5dc, size 0x100, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x375b6dc, size 0x4, virtual false, abstract: false, final false
  inline void _ctor();
