...
public:
  // Declarations
  /// @brief Method GetSpecialEventTypes, addr 0x14fa8e0, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x14fa9a4, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
