...
public:
  // Declarations
  /// @brief Method GetSpecialEventTypes, addr 0x270b368, size 0xc4, virtual false, abstract: false, final false
  ...
  /// @brief Method .ctor, addr 0x270b42c, size 0x8, virtual false, abstract: false, final false
  inline void _ctor();
