...
// Write type traits
MARK_REF_T(::BeatmapSaveDataCommon::IBeat*);
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::IBeat*, "BeatmapSaveDataCommon", "IBeat");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: false
...
public:
  ...
  /// @brief Method System.IComparable<BeatmapSaveDataCommon.IBeat>.CompareTo, addr 0x375b724, size 0x168, virtual true, abstract: false, final true
