...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::IndexFilterType, "BeatmapSaveDataCommon", "IndexFilterType");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::IndexFilterType) == 0x4, "Size mismatch!");
