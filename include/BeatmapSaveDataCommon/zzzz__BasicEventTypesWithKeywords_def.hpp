...
static inline ::BeatmapSaveDataCommon::BasicEventTypesWithKeywords_BasicEventTypesForKeyword* New_ctor(::StringW  keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  eventTypes) ;
...
/// @brief Method .ctor, addr 0x366235c, size 0x8, virtual false, abstract: false, final false
inline void _ctor(::StringW  keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>*  eventTypes) ;

/// @brief Method get_eventTypes, addr 0x3662354, size 0x8, virtual false, abstract: false, final false
inline ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* get_eventTypes() ;

/// @brief Method get_keyword, addr 0x366234c, size 0x8, virtual false, abstract: false, final false
...
/// @brief Field d, offset 0x10, size 0x8 
 __declspec(property(get=__cordl_internal_get_d, put=__cordl_internal_set_d)) ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BasicEventTypesWithKeywords_BasicEventTypesForKeyword*>*  d;
...
static inline ::BeatmapSaveDataCommon::BasicEventTypesWithKeywords* New_ctor(::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BasicEventTypesWithKeywords_BasicEventTypesForKeyword*>*  data) ;
...
/// @brief Method .ctor, addr 0x3660b74, size 0x8, virtual false, abstract: false, final false
...
/// @brief Method get_data, addr 0x3662344, size 0x8, virtual false, abstract: false, final false
