...
public:
  ...
  /// @brief Method .ctor, addr 0x270b0b0, size 0x2c, virtual false, abstract: false, final false
  inline void _ctor(::StringW keyword, ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* eventTypes);

  /// @brief Method get_eventTypes, addr 0x270b0a8, size 0x8, virtual false, abstract: false, final false
  inline ::System::Collections::Generic::List_1<::BeatmapSaveDataCommon::BeatmapEventType>* get_eventTypes();

  /// @brief Method get_keyword, addr 0x270b0a0, size 0x8, virtual false, abstract: false, final false
...
public:
  ...
  /// @brief Method .ctor, addr 0x2709138, size 0x28, virtual false, abstract: false, final false
  ...
  /// @brief Method get_data, addr 0x270b098, size 0x8, virtual false, abstract: false, final false
