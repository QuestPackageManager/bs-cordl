...
public:
  // Ctor Parameters [CppParam { name: "", ty: "EaseTypeConvertor", modifiers: "&&", def_value: None, comment: None }]
  // @brief delete move ctor to prevent accidental deref moves
  EaseTypeConvertor(EaseTypeConvertor&&) = delete;

  // Ctor Parameters [CppParam { name: "", ty: "EaseTypeConvertor", modifiers: "const&", def_value: None, comment: None }]
  // @brief delete copy ctor to prevent accidental deref copies
  EaseTypeConvertor(EaseTypeConvertorconst&) = delete;
