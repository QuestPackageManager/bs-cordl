...
DEFINE_IL2CPP_CLASS(::BeatmapSaveDataCommon::RotationDirection, "BeatmapSaveDataCommon", "RotationDirection");
// Dependencies
namespace BeatmapSaveDataCommon {
// Is value type: true
...
static_assert(sizeof(::BeatmapSaveDataCommon::RotationDirection) == 0x4, "Size mismatch!");
