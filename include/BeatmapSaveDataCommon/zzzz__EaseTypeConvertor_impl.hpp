...
struct CORDL_HIDDEN ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatmapSaveDataCommon::EaseType (*)(::GlobalNamespace::EaseType)>(&::BeatmapSaveDataCommon::EaseTypeConvertor::Convert)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x3662364;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::BeatmapSaveDataCommon::EaseTypeConvertor*>::get(),
                        "Convert",
